-- ═══════════════════════════════════════════════════════════════════
-- CRM Imobiliário — Migração 002 v2 (ordem corrigida)
-- EXECUTE ESTE, não o 002 original
-- ═══════════════════════════════════════════════════════════════════
...
-- ─── 4. ADICIONAR tenant_id AOS PROFILES PRIMEIRO ────────────────────────────
-- (deve vir ANTES de qualquer política que referencie profiles.tenant_id)
...
-- (agora profiles.tenant_id já existe — políticas podem referenciá-la)
...
-- ─── 6. ADICIONAR tenant_id ÀS TABELAS DE DADOS ──────────────────────────────
...
-- ─── 12. ATUALIZAR POLICIES DAS TABELAS EXISTENTES ────────────────────────────
