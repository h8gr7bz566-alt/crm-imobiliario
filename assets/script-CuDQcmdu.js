import{s as y}from"./supabase-BcuJ3xoD.js";const U="00000000-0000-0000-0000-000000000000";let ie={},ye={},ee=U;function ge(e){ee=e||U,ie={},ye={}}const z=()=>ee;async function Ft(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",ee),y.from("site_content").select("*").eq("tenant_id",ee)]);if(e.data&&e.data.forEach(n=>{ie[n.key]=n.value}),t.data&&t.data.forEach(n=>{ye[n.key]=n}),(!t.data||t.data.length===0)&&ee!==U){const[n,a]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",U),y.from("site_content").select("*").eq("tenant_id",U)]);n.data&&n.data.forEach(o=>{ie[o.key]===void 0&&(ie[o.key]=o.value)}),a.data&&a.data.forEach(o=>{ye[o.key]||(ye[o.key]=o)})}}const G=(e,t=null)=>ie[e]!==void 0?ie[e]:t,ke=(e,t="pt")=>{const n=ye[e];return n&&(n["value_"+t]||n.value_pt)||null};async function be(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ee,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{ie[o]=i}),!a}async function Me(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ee,updated_at:o},{error:d}=await y.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(ye[e]=i),ee!==U&&await y.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:U,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Fe(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function at(){const e=document.documentElement,t=G("visual.accent_color","#b8962e"),n=G("visual.primary_bg","#0f1c2e"),a=G("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=G("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=G("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=G("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function ct(e){e=e||"pt";const t=b=>ke(b,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),m=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),c=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),m&&t("inst.stat2_num")&&(m.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const v=document.getElementById("dep-grid");if(v){const b=ke("testimonials",e)||ke("testimonials","pt");if(b)try{const E=JSON.parse(b);if(Array.isArray(E)&&E.length>0){let k=function($){return String($||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function($){let I=0;for(const w of $||"?")I=I*31+w.charCodeAt(0)&4294967295;return B[Math.abs(I)%B.length]};const B=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];v.innerHTML=E.map($=>`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio");t.innerHTML=[a("Imóveis "+(document.title.split("|")[0].trim()||"Isaac Omar").split(" ").pop(),"#8B4513",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","#8B4513",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","#8B4513",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","#8B4513",d,"imoveis.html?collection=casas-condominio"):""].join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",Bt))}async function de(){var p,u,v,h,x,b;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await kt();_=n,((p=document.getElementById("selecao-carousel"))==null?void 0:p.innerHTML)===""&&ea(n);const a=((u=document.getElementById("city-filter"))==null?void 0:u.value)||"",o=((v=document.getElementById("neighborhood-filter"))==null?void 0:v.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",d=((x=document.getElementById("parking-filter"))==null?void 0:x.value)||"",l=((b=document.getElementById("construction-filter"))==null?void 0:b.value)||"",{min:s,max:m}=ta(),r=n.filter(E=>{if(a&&E.city!==a||o&&E.neighborhood!==o||i&&(i==="4+"&&Number(E.bedrooms)<4||i!=="4+"&&Number(E.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(E.parking)<4||d!=="4+"&&Number(E.parking)!==Number(d))||l&&E.construction_status!==l)return!1;const B=String(E.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),k=parseInt(B,10)||0;return!(k<s||m!==1/0&&k>m)});if(e){Zt(n);return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=r.map(E=>St(E)).join("");const c=document.getElementById("properties");c&&!c._carouselDelegated&&(c._carouselDelegated=!0,c.addEventListener("click",Bt))}function ea(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var p;const s=l.cover_image||((p=l.images)==null?void 0:p[0])||le[0],m=[l.neighborhood,l.city].filter(Boolean).join(", "),r=`https://omarcorretor.com.br/og/${l.id}`,c=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?
${r}`);return`
...
${d}`),s=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",m=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",r=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",c=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",p=n>1?`<div class="icard-dots">${Array.from({length:Math.min(n,6)},(h,x)=>`<span class="icard-dot${x===0?" active":""}"></span>`).join("")}</div>`:"";return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body">
        ...
        ${s||m||r||c?`<div class="icard-specs">${s}${m}${r}${c}</div>`:""}
  ...
  `}let Z=[],W=0;function la(e){var c,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((c=e.images)==null?void 0:c[0])||le[0];document.getElementById("view-thumb-preview").src=i,Z=(p=e.images)!=null&&p.length?e.images:le,W=0,He(),document.getElementById("view-price").textContent=we(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,m=document.getElementById("share-link-input");m&&(m.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function qe(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function He(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Z[W],e.alt=`Foto ${W+1}`;const i=Z.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${W+1} / ${Z.length}`:"",o.innerHTML=i?Z.map((d,l)=>`<img src="${d}" class="view-thumb${l===W?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{W=+d.dataset.i,He()})})}async function pt(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function De(e){var c,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((c=i[0])==null?void 0:c.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),m=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&m?(m.src=e.avatar_url,m.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",r.style.display=""),m&&(m.style.display="none"))}async function ut(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==U,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await y.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}const Ae={empresa:()=>zt(),visual:()=>Nt(),"site-config":()=>jt(),"crm-config":()=>Rt(),integracoes:()=>Ht(),midia:()=>Dt(),depoimentos:()=>Mt()};function re(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Ae<"u"&&Ae[e]){const o=Ae[e];Ae[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),J(),e==="contatos"&&ha(),e==="funil"&&ca(),e==="tarefas"&&pa()}function gt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:zt,visual:Nt,"site-config":jt,"crm-config":Rt,integracoes:Ht,midia:Dt,depoimentos:Mt}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>Sa(),{once:!0}),window.lucide&&lucide.createIcons()}}function J(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function da(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(d=document.getElementById("cph-close"))==null||d.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",r=>{r.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",r=>{const c=r.target.files[0];if(!c)return;const p=URL.createObjectURL(c),u=document.getElementById("cph-preview"),v=document.getElementById("cph-initial");u&&(u.src=p,u.style.display=""),v&&(v.style.display="none"),document.getElementById("cph-save").disabled=!1}),(m=document.getElementById("cph-save"))==null||m.addEventListener("click",async()=>{var u;const r=(u=document.getElementById("cph-file"))==null?void 0:u.files[0];if(!r)return;const c=document.getElementById("cph-save"),p=document.getElementById("cph-msg");c.disabled=!0,c.textContent="Salvando…";try{const v=await Te(r,400,.85),h=`avatars/${f.id}-${Date.now()}.jpg`,{error:x}=await y.storage.from("imoveis").upload(h,v,{contentType:"image/jpeg",upsert:!0});if(x)throw x;const{data:{publicUrl:b}}=y.storage.from("imoveis").getPublicUrl(h);await y.from("profiles").update({avatar_url:b}).eq("id",f.id),f={...f,avatar_url:b},De(f),o()}catch(v){p.style.color="#ef4444",p.textContent="Erro: "+v.message,p.style.display="",c.disabled=!1,c.textContent="Salvar Foto"}})}function We(e,t){var i,d,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=_t(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await y.from("tasks").update({status:d}).eq("id",i);const l=j.find(s=>String(s.id)===i);l&&(l.status=d),Ee()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),j=j.filter(i=>String(i.id)!==String(a.dataset.id)),Ee())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=j.find(l=>String(l.id)===i);d&&Ct(d)})})}function Ct(e=null){var s,m,r,c;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=_t(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
...
`+$);window.open("mailto:?subject="+w+"&body="+S,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var I;const $=document.getElementById("share-link-input");$&&((I=navigator.clipboard)==null||I.writeText($.value).then(()=>{const w=document.getElementById("share-copy"),S=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=S},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var M;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(q=>q.id===$);if(!I)return;qe(),R=I.id;const w=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=I.title||"",w.querySelector('[name="rua"]').value=I.rua||"",w.querySelector('[name="numero"]').value=I.numero||"",w.querySelector('[name="city"]').value=I.city||"",w.querySelector('[name="price"]').value=I.price||"",w.querySelector('[name="bedrooms"]').value=I.bedrooms||"",w.querySelector('[name="suites"]').value=I.suites||"",w.querySelector('[name="parking"]').value=I.parking||"",w.querySelector('[name="description"]').value=I.description||"",w.querySelector('[name="construction_status"]').value=I.construction_status||"",w.querySelector('[name="owner_name"]').value=I.owner_name||"",w.querySelector('[name="owner_phone"]').value=I.owner_phone||"",w.querySelector('[name="owner_email"]').value=I.owner_email||"",w.querySelector('[name="owner_notes"]').value=I.owner_notes||"",w.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const q=document.getElementById("adminNeighborhood");q&&(q.value=I.neighborhood||"")},50)),se=I.cover_image||((M=I.images)==null?void 0:M[0])||"",Re(I.images||[]),Ve("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(I=document.getElementById(`tab-${$.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const I=$.target.closest("tr");if(!I)return;const w=Number(I.dataset.id);if(!w)return;const S=_.find(T=>T.id===w);S&&la(S)})}async function Mt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",z()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const m of d||"?")s=s*31+m.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
  ...
  `;function s(r,c,p){const u=document.getElementById(r),v=document.getElementById(c);u==null||u.addEventListener("input",h=>{v.value=h.target.value,p()}),v==null||v.addEventListener("input",h=>{/^#[0-9a-fA-F]{6}$/.test(h.target.value)&&(u.value=h.target.value,p())})}function m(){var c,p,u,v;const r=((c=document.getElementById("col-accent-hex"))==null?void 0:c.value)||"#b8962e";(p=document.getElementById("vp-bar"))==null||p.style.setProperty("background",r),(u=document.getElementById("vp-dot"))==null||u.style.setProperty("background",r),(v=document.getElementById("vp-btn"))==null||v.style.setProperty("background",r),document.documentElement.style.setProperty("--accent",r)}s("col-accent","col-accent-hex",m),s("col-primary","col-primary-hex",()=>{}),s("col-secondary","col-secondary-hex",()=>{}),m(),document.getElementById("vis-hero-file").addEventListener("change",async r=>{const c=r.target.files[0];if(c)try{const p=await lt(c,"hero");document.getElementById("vis-hero-url").value=p;const u=document.getElementById("vis-hero-preview");u.innerHTML=`<img src="${p}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,u.style.display=""}catch(p){alert("Erro no upload: "+p.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const r=document.getElementById("visual-save-colors");r.disabled=!0,r.textContent="Salvando…";const c=await be([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);c&&at(),r.disabled=!1,r.textContent="Salvar Cores",P(document.getElementById("visual-colors-msg"),c)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",m())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const r=document.getElementById("visual-save-images");r.disabled=!0,r.textContent="Salvando…";const c=await be([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);r.disabled=!1,r.textContent="Salvar Imagens",P(document.getElementById("visual-images-msg"),c)})}async function jt(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("site_content").select("*").eq("tenant_id",z()),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=(s,m)=>{var r;return g(((r=n[s])==null?void 0:r[`value_${m}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},d=s=>o.map(m=>`<button class="content-tab${m===s?" active":""}" data-lang="${m}">${i[m]}</button>`).join(""),l=s=>`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:m})=>{const r=document.getElementById("nt-plan");r&&m&&(r.innerHTML='<option value="">Sem plano</option>'+m.map(c=>`<option value="${c.id}">${g(c.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",m=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=Ca(m.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",m=>{m.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const m=document.getElementById("nt-admin-password");m.type=m.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",m=>{m.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var L,$,I,w,S,T,C,M,q,F,H,D;const m=($=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:$.trim(),r=(w=(I=document.getElementById("nt-slug"))==null?void 0:I.value)==null?void 0:w.trim(),c=(T=(S=document.getElementById("nt-domain"))==null?void 0:S.value)==null?void 0:T.trim(),p=(C=document.getElementById("nt-plan"))==null?void 0:C.value,u=(q=(M=document.getElementById("nt-admin-email"))==null?void 0:M.value)==null?void 0:q.trim(),v=(H=(F=document.getElementById("nt-admin-password"))==null?void 0:F.value)==null?void 0:H.trim(),h=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!m||!r){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!v||v.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:b,error:E}=await y.from("tenants").insert({name:m,slug:r,domain:c||null,plan_id:p||null,active:!0}).select();if(E){x.disabled=!1,x.textContent="Criar Imobiliária",h.textContent="❌ "+E.message,h.style.color="#ef4444";return}const B=(D=b==null?void 0:b[0])==null?void 0:D.id;h.textContent="⏳ Criando usuário admin…";const k=await me({email:u,password:v,role:"admin",tenant_id:B});if(!(k!=null&&k.success)){x.disabled=!1,x.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g((k==null?void 0:k.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),ae()},3e3);return}B&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await y.from("profiles").update({tenant_id:B}).eq("id",k.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",k.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Ot(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",tt(e,o.dataset.tab)})}),tt(e,"properties")}function Aa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,m,r="text",c="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${r.map(p=>{const[u,v]=c(p.stage||p.status||"").split(","),h=(p.phone||"").replace(/\D/g,"");return`<tr data-lid="${p.id}" style="border-top:1px solid #f1f5f9;">
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var E;(E=navigator.clipboard)==null||E.writeText(e.id);const x=document.getElementById("tp-copy-key"),b=x.textContent;x.textContent="✅ Copiada!",setTimeout(()=>{x.textContent=b},2e3)})}if(t==="config"){const{data:r}=await y.from("settings").select("key,value").eq("tenant_id",e.id),c={};r==null||r.forEach(u=>{c[u.key]=u.value});const p=(u,v)=>`
      ...
      </div>`,(m=document.getElementById("tp-open-edit"))==null||m.addEventListener("click",()=>Ot(e))}}function Ot(e){var m,r,c,p,u,v,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:b})=>{const E=document.getElementById("et-plan");E&&b&&(E.innerHTML='<option value="">Sem plano</option>'+b.map(B=>`<option value="${B.id}"${String(B.id)===String(e.plan_id)?" selected":""}>${g(B.name)}</option>`).join(""))}),(m=document.getElementById("et-logo-input"))==null||m.addEventListener("change",b=>{const E=b.target.files[0];if(!E)return;const B=URL.createObjectURL(E),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${B}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var b;(b=document.getElementById("et-logo-input"))==null||b.click()}),(c=document.getElementById("et-pwd-toggle"))==null||c.addEventListener("click",()=>{const b=document.getElementById("et-admin-password");b.type=b.type==="password"?"text":"password"}),(p=document.getElementById("et-copy-key"))==null||p.addEventListener("click",()=>{var k,L;const b=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!b)return;(L=navigator.clipboard)==null||L.writeText(b);const E=document.getElementById("et-copy-key"),B=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=B},2e3)});const o=["dados","config","api"];function i(b){o.forEach(E=>{document.getElementById(`et-pane-${E}`).style.display=E===b?"":"none";const B=document.getElementById(`et-tab-${E}`);B.style.borderBottomColor=E===b?"#2563eb":"transparent",B.style.color=E===b?"#2563eb":"#64748b",B.style.fontWeight=E===b?"600":"500"}),b==="config"&&l()}o.forEach(b=>{var E;return(E=document.getElementById(`et-tab-${b}`))==null?void 0:E.addEventListener("click",()=>i(b))});let d=!1;async function l(){var B;if(d)return;d=!0;const{data:b}=await y.from("settings").select("key,value").eq("tenant_id",e.id),E={};b==null||b.forEach(k=>{E[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
