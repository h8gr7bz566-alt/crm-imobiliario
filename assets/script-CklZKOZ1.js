import{s as y}from"./supabase-BcuJ3xoD.js";const mt="00000000-0000-0000-0000-000000000000";let ue={},Se={},te=mt;function Ye(e){te=e||mt,ue={},Se={}}const Ne=()=>te;async function It(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",te),y.from("site_content").select("*").eq("tenant_id",te)]);e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{Se[n.key]=n})}const G=(e,t=null)=>ue[e]!==void 0?ue[e]:t,_e=(e,t="pt")=>{const n=Se[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Z(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:te,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{ue[o]=i}),!a}async function Ce(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:te,updated_at:new Date().toISOString()},{error:i}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(Se[e]=o),!i}async function Te(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function je(){const e=document.documentElement,t=G("visual.accent_color","#b8962e"),n=G("visual.primary_bg","#0f1c2e"),a=G("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=G("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=G("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=G("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero");s&&(s.style.backgroundImage=`url('${l}')`)}}function Bt(e="pt"){const t=f=>_e(f,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),c=document.querySelector('[data-i18n="inst.stat2"]'),p=document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat2_num")&&(s.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),c&&t("inst.stat2_label")&&(c.innerHTML=t("inst.stat2_label")),p&&t("inst.stat3_label")&&(p.innerHTML=t("inst.stat3_label"));const m=_e("seo.title_pt",e);m&&document.title&&(document.title=m);const h=_e("seo.description_pt",e);if(h){const f=document.querySelector('meta[name="description"]');f&&(f.content=h)}}function Lt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const kt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",pe=`https://wa.me/${K}`;const W=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],$t=5.7;function ge(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/$t).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let C=[],v=null,ve=[],ut=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(ut=!0)});async function St(){const e=window.location.hostname;let t=null;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:i}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();i!=null&&i.id&&(t=i.id)}let n=y.from("properties").select("*").eq("published",!0);t&&(n=n.eq("tenant_id",t));const{data:a,error:o}=await n.order("created_at",{ascending:!1});return o?(console.error("Supabase select error:",o),[]):a||[]}async function _t(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="super_admin"||(v!=null&&v.tenant_id?e=e.eq("tenant_id",v.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(C=t||[],oa(),ia(),C)}async function Ct(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=C.findIndex(d=>d.id===t);i>=0&&(C[i]={...C[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&C.unshift(t[0])}}async function Tt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;C=C.filter(n=>n.id!==e)}async function At(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function he(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,r=i.height;s>t&&(r=Math.round(r*t/s),s=t),l.width=s,l.height=r;const c=l.getContext("2d");c.drawImage(i,0,0,s,r);const p=new Image;p.crossOrigin="anonymous",p.onload=()=>{const m=Math.round(s*.18),h=Math.round(p.naturalHeight*m/p.naturalWidth),f=Math.round(s*.02),E=s-m-f,x=r-h-f;c.globalAlpha=.45,c.drawImage(p,E,x,m,h),c.globalAlpha=1,l.toBlob(u=>u?a(u):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.onerror=()=>{l.toBlob(m=>m?a(m):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.src="/logo.png"},i.onerror=o,i.src=d})}async function qt(e){const t=await he(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Mt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await qt(n[o]));return a}async function fe(){var p,m,h,f,E,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await St();C=n,((p=document.getElementById("selecao-carousel"))==null?void 0:p.innerHTML)===""&&zt(n);const a=((m=document.getElementById("city-filter"))==null?void 0:m.value)||"",o=((h=document.getElementById("neighborhood-filter"))==null?void 0:h.value)||"",i=((f=document.getElementById("bedrooms-filter"))==null?void 0:f.value)||"",d=((E=document.getElementById("parking-filter"))==null?void 0:E.value)||"",l=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",s=document.getElementById("price-slider"),r=s?parseInt(s.value,10):13e7,c=n.filter(u=>{if(a&&u.city!==a||o&&u.neighborhood!==o||i&&(i==="4+"&&Number(u.bedrooms)<4||i!=="4+"&&Number(u.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(u.parking)<4||d!=="4+"&&Number(u.parking)!==Number(d))||l&&u.construction_status!==l)return!1;const b=String(u.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),I=parseInt(b,10)||0;return!(I<0||I>r)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(u=>{var w;const b=u.cover_image||((w=u.images)==null?void 0:w[0])||W[0],I=[u.neighborhood,u.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          <img src="${b}" alt="${g(u.title)}" class="selecao-card-img">
          <div class="selecao-card-body">
            <div class="selecao-card-title">${g(u.title)}</div>
            <div class="selecao-card-loc">${g(I)}</div>
            <div class="selecao-card-price">${g(ge(u.price,window.currentLang||"pt"))}</div>
      ...
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${I}" data-idx="0" data-pid="${u.id}">
          <img src="${u.cover_image||b[0]}" alt="${g(u.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${I>1?`
        ...
        <div class="property-info">
          <strong>${g(u.title)}</strong>
          <div class="muted">${g(u.neighborhood||"")}, ${g(u.city||"")}</div>
          <div><strong>${g(ge(u.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${u.bedrooms||"--"} | 🚗 ${u.parking||"--"} ${I>1?"| 📸 "+I:""}</div>
          <p class="muted">${g((u.description||"").slice(0,110))}</p>
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(u=>{u.removeEventListener("click",Ke),u.addEventListener("click",Ke)})}function zt(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var c;const s=l.cover_image||((c=l.images)==null?void 0:c[0])||W[0],r=[l.neighborhood,l.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
...
`+((s==null?void 0:s.message)||JSON.stringify(s)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Tt(o),await we()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((v==null?void 0:v.role)!=="admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=C.find(s=>s.id===o);if(!i)return;N=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const d=document.getElementById("adminPublished");d&&(d.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),V=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Ie(i.images||[]),qe("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let O=[],j=0;function Ut(e){var c,p;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((c=e.images)==null?void 0:c[0])||W[0];document.getElementById("view-thumb-preview").src=o,O=(p=e.images)!=null&&p.length?e.images:W,j=0,Be(),document.getElementById("view-price").textContent=ge(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const i=document.getElementById("view-condominium-item"),d=document.getElementById("view-condominium");d&&(d.textContent=e.condominium||""),i&&(i.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(m=>m.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(m=>m.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const l="https://omarcorretor.com.br/property.html?id="+e.id,s=document.getElementById("share-link-input");s&&(s.value=l);const r=document.getElementById("share-panel");r&&(r.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function xe(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Be(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=O[j],e.alt=`Foto ${j+1}`;const i=O.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${j+1} / ${O.length}`:"",o.innerHTML=i?O.map((d,l)=>`<img src="${d}" class="view-thumb${l===j?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{j=+d.dataset.i,Be()})})}async function Qe(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Le(e){var p,m;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",c.style.display=""),r&&(r.style.display="none"))}function J(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),R(),e==="contatos"&&Zt(),e==="funil"&&Ft(),e==="tarefas"&&Gt()}function Ze(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:da,visual:la,"site-config":ra,"crm-config":ca,integracoes:ma,midia:ua}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>pa(),{once:!0}),window.lucide&&lucide.createIcons()}}function R(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Dt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(d=document.getElementById("cph-close"))==null||d.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",c=>{c.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",c=>{const p=c.target.files[0];if(!p)return;const m=URL.createObjectURL(p),h=document.getElementById("cph-preview"),f=document.getElementById("cph-initial");h&&(h.src=m,h.style.display=""),f&&(f.style.display="none"),document.getElementById("cph-save").disabled=!1}),(r=document.getElementById("cph-save"))==null||r.addEventListener("click",async()=>{var h;const c=(h=document.getElementById("cph-file"))==null?void 0:h.files[0];if(!c)return;const p=document.getElementById("cph-save"),m=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const f=await he(c,400,.85),E=`avatars/${v.id}-${Date.now()}.jpg`,{error:x}=await y.storage.from("imoveis").upload(E,f,{contentType:"image/jpeg",upsert:!0});if(x)throw x;const{data:{publicUrl:u}}=y.storage.from("imoveis").getPublicUrl(E);await y.from("profiles").update({avatar_url:u}).eq("id",v.id),v={...v,avatar_url:u},Le(v),o()}catch(f){m.style.color="#ef4444",m.textContent="Erro: "+f.message,m.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function Ot(){var a,o,i;const e=document.getElementById("add-corretor-modal-root");e&&e.remove();const t=document.createElement("div");t.id="add-corretor-modal-root",t.className="modal-backdrop",t.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=vt(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await y.from("tasks").update({status:d}).eq("id",i);const l=M.find(s=>String(s.id)===i);l&&(l.status=d),ae()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),M=M.filter(i=>String(i.id)!==String(a.dataset.id)),ae())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=M.find(l=>String(l.id)===i);d&&ft(d)})})}function ft(e=null){var s,r,c,p;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=vt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",l),d.addEventListener("click",m=>{m.target===d&&l()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const m=a?"pending":"done";await y.from("tasks").update({status:m}).eq("id",e.id);const h=M.find(f=>String(f.id)===String(e.id));h&&(h.status=m),l(),m==="done"&&(Q="done",document.querySelectorAll(".tarefa-filter-btn").forEach(f=>{f.classList.toggle("active",f.dataset.filter==="done")})),ae()}),(p=document.getElementById("tm-save"))==null||p.addEventListener("click",async()=>{var u,b;const m=document.getElementById("tarefa-form");if(!m.checkValidity()){m.reportValidity();return}const h=new FormData(m),f=document.getElementById("tm-save");f.disabled=!0,f.textContent="Salvando…";const E={title:(u=h.get("title"))==null?void 0:u.trim(),description:((b=h.get("description"))==null?void 0:b.trim())||null,due_date:h.get("due_date")||null,priority:h.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null};let x;if(n){if({error:x}=await y.from("tasks").update(E).eq("id",e.id),!x){const I=M.findIndex(w=>String(w.id)===String(e.id));I>=0&&(M[I]={...M[I],...E})}}else{const{data:I,error:w}=await y.from("tasks").insert(E).select();x=w,!x&&(I!=null&&I[0])&&M.unshift(I[0])}if(f.disabled=!1,f.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}l(),ae()})}async function Wt(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;v==null||v.role,v==null||v.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,m=new Blob([p],{type:"text/csv"}),h=document.createElement("a");h.href=URL.createObjectURL(m),h.download="modelo_contatos.csv",h.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",ea),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",ta)))}async function yt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:a}=await t;F=a||[],ne()}function ne(){var l,s,r;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?F.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/ce));q>a&&(q=a);const o=t.slice((q-1)*ce,q*ce),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const c=n===0?0:(q-1)*ce+1,p=Math.min(q*ce,n);d.innerHTML=`
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{q--,ne()}),(r=d.querySelector("#pag-next"))==null||r.addEventListener("click",()=>{q++,ne()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(c=>{c.addEventListener("click",p=>{p.preventDefault();const m=c.dataset.id,h=F.find(f=>String(f.id)===String(m));h&&bt(h)})})}function bt(e=null){var i,d,l;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=document.createElement("div");a.id="contato-modal-root",a.className="modal-backdrop",a.innerHTML=`
  ...
  `,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("cm-close"))==null||i.addEventListener("click",o),(d=document.getElementById("cm-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(l=document.getElementById("cm-save"))==null||l.addEventListener("click",async()=>{var h,f,E,x,u,b,I;const s=document.getElementById("contato-form");if(!s.checkValidity()){s.reportValidity();return}const r=new FormData(s),c=document.getElementById("cm-save");c.disabled=!0,c.textContent="Salvando…";const p={name:(h=r.get("name"))==null?void 0:h.trim(),company:((f=r.get("company"))==null?void 0:f.trim())||null,email:((E=r.get("email"))==null?void 0:E.trim())||null,phone:((x=r.get("phone"))==null?void 0:x.trim())||null,job_title:((u=r.get("job_title"))==null?void 0:u.trim())||null,city_interest:((b=r.get("city_interest"))==null?void 0:b.trim())||null,notes:((I=r.get("notes"))==null?void 0:I.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null,source:"manual"};let m;if(n){if({error:m}=await y.from("leads").update(p).eq("id",e.id),!m){const w=F.findIndex(S=>String(S.id)===String(e.id));w>=0&&(F[w]={...F[w],...p})}}else{const{data:w,error:S}=await y.from("leads").insert(p).select();m=S,!m&&(w!=null&&w[0])&&F.unshift(w[0])}if(c.disabled=!1,c.textContent=n?"Salvar":"Criar Contato",m){alert("Erro: "+m.message);return}o(),ne()})}let ee=[];function ea(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{ee=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,r,c,p,m]=l.split(",").map(h=>h.trim().replace(/^"|"$/g,""));return{name:s,email:r,phone:c,company:p,job_title:m}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${ee.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=ee.length===0)},n.readAsText(t)}async function ta(){if(!ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Me(),await yt(),alert(`${t.length} contato(s) importados com sucesso!`)}function aa(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Me(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const na="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function oe(e){return(await fetch(na,{method:"POST",headers:{Authorization:`Bearer ${kt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function it(e){var s,r,c,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await y.auth.getUser();n.value=(m==null?void 0:m.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const h=m.target.files[0];if(!h)return;const f=URL.createObjectURL(h);a&&(a.src=f,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var u,b;const m=((u=document.getElementById("change-password-new"))==null?void 0:u.value)||"",h=((b=document.getElementById("change-password-confirm"))==null?void 0:b.value)||"",f=document.getElementById("change-password-msg"),E=document.getElementById("btn-change-password");if(f&&(f.style.display="none"),m.length<6){f&&(f.textContent="Mínimo 6 caracteres.",f.style.display="");return}if(m!==h){f&&(f.textContent="As senhas não coincidem.",f.style.display="");return}E&&(E.disabled=!0,E.textContent="Salvando…");const{error:x}=await y.auth.updateUser({password:m});E&&(E.disabled=!1,E.textContent="Salvar Nova Senha"),x?f&&(f.textContent="Erro: "+x.message,f.style.display=""):(f&&(f.style.color="#16a34a",f.textContent="Senha alterada com sucesso!",f.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var b;const m=t.value.trim();let h=(v==null?void 0:v.avatar_url)||"";const f=i==null?void 0:i.files[0],E=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",f)try{const I=await he(f,400,.85),w=`avatars/${v.id}-${Date.now()}.jpg`,{error:S}=await y.storage.from("imoveis").upload(w,I,{contentType:"image/jpeg",upsert:!0});if(!S){const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(w);h=B}}catch(I){console.error("Avatar upload:",I)}const{error:x}=await y.from("profiles").update({name:m,avatar_url:h}).eq("id",v.id);if(d.disabled=!1,d.textContent=E,x){alert("Erro ao salvar perfil.");return}v={...v,name:m,avatar_url:h},Le(v);const u=document.getElementById("settings-avatar-initial");u&&(u.textContent=((b=m[0])==null?void 0:b.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await $e(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var b,I;const f=(b=document.getElementById("invite-email"))==null?void 0:b.value.trim(),E=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),x=document.getElementById("btn-invite-corretor"),u=document.getElementById("invite-note");if(!f){alert("Informe o e-mail do corretor.");return}if(!E||E.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),u&&(u.style.display="none");try{const w=await oe({email:f,password:E,tenant_id:(v==null?void 0:v.tenant_id)||null});if(w.success){const S=document.getElementById("invite-email"),B=document.getElementById("invite-password");S&&(S.value=""),B&&(B.value=""),await $e(),u&&(w.email_sent===!1?(u.innerHTML=`
                ✅ Acesso criado!
...
`+B);window.open("mailto:?subject="+L+"&body="+$,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var k;const B=document.getElementById("share-link-input");B&&((k=navigator.clipboard)==null||k.writeText(B.value).then(()=>{const L=document.getElementById("share-copy"),$=L.textContent;L.textContent="✅ Copiado!",setTimeout(()=>{L.textContent=$},2e3)}))}),(w=document.getElementById("view-modal-edit"))==null||w.addEventListener("click",()=>{var D;if((v==null?void 0:v.role)!=="admin")return;const B=document.getElementById("view-modal-title").textContent,k=C.find(z=>z.title===B);if(!k)return;xe(),N=k.id;const L=document.getElementById("property-form"),$=document.getElementById("form-submit-btn");$.textContent="Salvar Alterações",L.querySelector('[name="title"]').value=k.title||"",L.querySelector('[name="rua"]').value=k.rua||"",L.querySelector('[name="numero"]').value=k.numero||"",L.querySelector('[name="city"]').value=k.city||"",L.querySelector('[name="price"]').value=k.price||"",L.querySelector('[name="bedrooms"]').value=k.bedrooms||"",L.querySelector('[name="suites"]').value=k.suites||"",L.querySelector('[name="parking"]').value=k.parking||"",L.querySelector('[name="description"]').value=k.description||"",L.querySelector('[name="construction_status"]').value=k.construction_status||"",L.querySelector('[name="owner_name"]').value=k.owner_name||"",L.querySelector('[name="owner_phone"]').value=k.owner_phone||"",L.querySelector('[name="owner_email"]').value=k.owner_email||"",L.querySelector('[name="owner_notes"]').value=k.owner_notes||"",L.querySelector('[name="condominium"]').value=k.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=k.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=k.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const z=document.getElementById("adminNeighborhood");z&&(z.value=k.neighborhood||"")},50)),V=k.cover_image||((D=k.images)==null?void 0:D[0])||"",Ie(k.images||[]),qe("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(B=>{B.addEventListener("click",()=>{var k;document.querySelectorAll(".tab-btn").forEach(L=>L.classList.remove("active")),B.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(L=>L.classList.add("hidden")),(k=document.getElementById(`tab-${B.dataset.tab}`))==null||k.classList.remove("hidden")})}),(S=document.getElementById("admin-properties"))==null||S.addEventListener("click",B=>{if(B.target.closest(".action-btns"))return;const k=B.target.closest("tr");if(!k)return;const L=Number(k.dataset.id);if(!L)return;const $=C.find(_=>_.id===L);$&&Ut($)})}document.addEventListener("DOMContentLoaded",async()=>{var i,d,l;await Promise.all([It(),ht()]),K=G("company.whatsapp",K),pe=`https://wa.me/${K}`,je(),Nt(),jt();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(Ue(),e.addEventListener("change",()=>{const s=Y().find(c=>c.name===e.value),r=s?Re(s.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(c=>`<option value="${c.name}">${g(c.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const s=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),c=s.get("type")||r.get("type")||"",p=ut||c==="recovery"||c==="invite"||window.location.hash.includes("access_token")||r.has("code"),m=document.getElementById("password-reset-overlay");if(p){n.style.display="none",a&&a.classList.add("hidden"),m&&(m.style.display="flex"),(i=document.getElementById("password-reset-form"))==null||i.addEventListener("submit",async f=>{var w,S;f.preventDefault();const E=((w=document.getElementById("new-password"))==null?void 0:w.value)||"",x=((S=document.getElementById("confirm-password"))==null?void 0:S.value)||"",u=document.getElementById("password-reset-msg"),b=f.target.querySelector('button[type="submit"]');if(u&&(u.style.display="none"),E!==x){u&&(u.textContent="As senhas não coincidem.",u.style.display="");return}b&&(b.disabled=!0,b.textContent="Salvando…");const{error:I}=await y.auth.updateUser({password:E});if(I){u&&(u.textContent="Erro: "+I.message,u.style.display=""),b&&(b.disabled=!1,b.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await y.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:h}}=await y.auth.getSession();if(h){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),Ae(),st(),et(),window.lucide&&lucide.createIcons(),v=await Qe(h.user.id),!v){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(v.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const f=document.getElementById("password-reset-overlay");f&&(f.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async E=>{var S,B;E.preventDefault();const x=((S=document.getElementById("new-password"))==null?void 0:S.value)||"",u=((B=document.getElementById("confirm-password"))==null?void 0:B.value)||"",b=document.getElementById("password-reset-msg"),I=E.target.querySelector('button[type="submit"]');if(b&&(b.style.display="none"),x!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}if(x.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}I&&(I.disabled=!0,I.textContent="Salvando…");const{error:w}=await y.auth.updateUser({password:x});if(w){b&&(b.textContent="Erro: "+w.message,b.style.display=""),I&&(I.disabled=!1,I.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}Ye((v==null?void 0:v.tenant_id)||null),Le(v),Ze(v.role),await we(),await it(v),window.lucide&&lucide.createIcons(),Qt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const f=document.getElementById("login-form");f&&((l=document.getElementById("forgot-password-btn"))==null||l.addEventListener("click",async()=>{var u,b;const E=(b=(u=f.querySelector('input[name="email"]'))==null?void 0:u.value)==null?void 0:b.trim();if(!E){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:x}=await y.auth.resetPasswordForEmail(E,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(x?"Erro: "+x.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),f.addEventListener("submit",async E=>{E.preventDefault();const x=new FormData(f),u=x.get("email"),b=x.get("password");if(await At(u,b)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),Ae(),st(),window.lucide&&lucide.createIcons();const{data:{session:w}}=await y.auth.getSession();if(v=w?await Qe(w.user.id):null,!v){await y.auth.signOut();return}if(v.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}et(),Ye((v==null?void 0:v.tenant_id)||null),Le(v),Ze(v.role),await we(),await it(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else Ae();await fe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Bt(o),Lt(K)});async function oa(){const e=C.filter(o=>!o.reference);if(!e.length)return;const t=C.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=C.findIndex(s=>s.id===o.id);l>=0&&(C[l].reference=i),n++}}ye(He(C))}async function ia(){const e=C.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await sa(i);a.push(d),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=C.findIndex(d=>d.id===t.id);i>=0&&(C[i].images=a)}}ye(He(C))}}async function sa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),c=1200;let p=s.width,m=s.height;p>c&&(m=Math.round(m*c/p),p=c),r.width=p,r.height=m;const h=r.getContext("2d");h.drawImage(s,0,0,p,m);const f=E=>{if(E){const x=Math.round(p*.18),u=Math.round(E.naturalHeight*x/E.naturalWidth),b=Math.round(p*.02);h.globalAlpha=.45,h.drawImage(E,p-x-b,m-u-b,x,u),h.globalAlpha=1}r.toBlob(async x=>{try{const u=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:b}=await y.storage.from("imoveis").upload(u,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(b){console.error("Upload watermark error:",b),l(e);return}const{data:{publicUrl:I}}=y.storage.from("imoveis").getPublicUrl(u);l(I)}catch(u){console.error("Watermark upload exception:",u),l(e)}},"image/jpeg",.82)};if(d){const E=new Image;E.onload=()=>{URL.revokeObjectURL(d),f(E)},E.onerror=()=>{URL.revokeObjectURL(d),f(null)},E.src=d}else f(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function H(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function De(e,t="assets"){const n=await he(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function da(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",Ne()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const l=e.querySelector(`#sa-panel-${d.dataset.tab}`);l&&l.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&X(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&ga(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&dt(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&lt(),d.dataset.tab==="platform"&&rt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",dt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",X),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",lt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>ya()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",va),X(),rt())}async function X(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=y.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(r=>{var c,p;return!t||((c=r.name)==null?void 0:c.toLowerCase().includes(t))||((p=r.slug)==null?void 0:p.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=r=>r.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(r=>{var c;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const p=r.dataset.active==="true";await y.from("tenants").update({active:!p}).eq("id",r.dataset.id),X()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(r=>{r.addEventListener("click",()=>{const c=(i||[]).find(p=>String(p.id)===String(r.dataset.id));c&&ba(c)})})}async function ga(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
    ...
    <div class="sa-list-row">
      <div class="sa-list-info">
        <div>
          ...
          <div class="sa-list-sub">${g(((c=s.plans)==null?void 0:c.name)||"—")} · R$ ${Number(((p=s.plans)==null?void 0:p.price_brl)||0).toLocaleString("pt-BR",{minimumFractionDigits:2})}/mês</div>
        </div>
      </div>
      <div class="sa-list-actions">
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:r})=>{const c=document.getElementById("nt-plan");c&&r&&(c.innerHTML='<option value="">Sem plano</option>'+r.map(p=>`<option value="${p.id}">${g(p.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const c=document.getElementById("nt-slug");c&&!c.dataset.manual&&(c.value=fa(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var S,B,k,L,$,_,T,D,z,ie,se,de;const r=(B=(S=document.getElementById("nt-name"))==null?void 0:S.value)==null?void 0:B.trim(),c=(L=(k=document.getElementById("nt-slug"))==null?void 0:k.value)==null?void 0:L.trim(),p=(_=($=document.getElementById("nt-domain"))==null?void 0:$.value)==null?void 0:_.trim(),m=(T=document.getElementById("nt-plan"))==null?void 0:T.value,h=(z=(D=document.getElementById("nt-admin-email"))==null?void 0:D.value)==null?void 0:z.trim(),f=(se=(ie=document.getElementById("nt-admin-password"))==null?void 0:ie.value)==null?void 0:se.trim(),E=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!r||!c){E.textContent="❌ Nome e slug são obrigatórios.",E.style.color="#ef4444";return}if(!h){E.textContent="❌ Informe o e-mail do admin.",E.style.color="#ef4444";return}if(!f||f.length<6){E.textContent="❌ A senha precisa ter mínimo 6 caracteres.",E.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",E.textContent="⏳ Criando imobiliária…",E.style.color="#64748b";const{data:u,error:b}=await y.from("tenants").insert({name:r,slug:c,domain:p||null,plan_id:m||null,active:!0}).select();if(b){x.disabled=!1,x.textContent="Criar Imobiliária",E.textContent="❌ "+b.message,E.style.color="#ef4444";return}const I=(de=u==null?void 0:u[0])==null?void 0:de.id;E.textContent="⏳ Criando usuário admin…";const w=await oe({email:h,password:f,role:"admin",tenant_id:I});if(!(w!=null&&w.success)){x.disabled=!1,x.textContent="Criar Imobiliária",E.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g((w==null?void 0:w.error)||"Desconhecido"),E.style.color="#f59e0b",setTimeout(()=>{n(),X()},3e3);return}I&&(w!=null&&w.user_id)&&!(w!=null&&w.linked)&&await y.from("profiles").update({tenant_id:I}).eq("id",w.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",w.email_sent===!1?(E.innerHTML=`
        ✅ Imobiliária e admin criados!<br>
        <span style="color:#ef4444;">⚠️ E-mail não enviado (${g(w.email_error||"erro desconhecido")}).</span><br>
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>xt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ct(e,o.dataset.tab)})}),ct(e,"properties")}async function ct(e,t){var a,o,i;const n=document.getElementById("tp-content");if(n){if(n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;font-size:14px;">Carregando…</div>',t==="properties"){const{data:d}=await y.from("properties").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1});if(!(d!=null&&d.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">🏠</div><p style="font-size:14px;">Nenhum imóvel cadastrado ainda.</p></div>';return}n.innerHTML=`
      ...
      </div>`}if(t==="leads"){const{data:d}=await y.from("leads").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}).limit(100);if(!(d!=null&&d.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">📋</div><p style="font-size:14px;">Nenhum lead ainda.</p></div>';return}const l=r=>({novo:"Novo",contato:"Contato",proposta:"Proposta",fechado:"Fechado"})[r]||r||"Novo",s=r=>({novo:"#dbeafe,#1d4ed8",contato:"#fef3c7,#92400e",proposta:"#ede9fe,#6d28d9",fechado:"#dcfce7,#15803d"})[r]||"#f1f5f9,#64748b";n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:500px;">
          ...
          <tbody>${d.map(r=>{const[c,p]=s(r.stage).split(",");return`<tr style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${c};color:${p};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${l(r.stage)}</span></td>
      ...
      </div>`,(i=document.getElementById("tp-open-edit"))==null||i.addEventListener("click",()=>xt(e))}}}function xt(e){var r,c,p,m,h,f,E,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
