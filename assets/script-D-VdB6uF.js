import{s as v}from"./supabase-BcuJ3xoD.js";let he={},Me={};async function dt(){const[e,t]=await Promise.all([v.from("settings").select("key,value"),v.from("site_content").select("*")]);e.data&&e.data.forEach(n=>{he[n.key]=n.value}),t.data&&t.data.forEach(n=>{Me[n.key]=n})}const V=(e,t=null)=>he[e]!==void 0?he[e]:t,Se=(e,t="pt")=>{const n=Me[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Q(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,updated_at:t})),{error:a}=await v.from("settings").upsert(n,{onConflict:"key"});return a||e.forEach(([o,i])=>{he[o]=i}),!a}async function $e(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,updated_at:new Date().toISOString()},{error:i}=await v.from("site_content").upsert(o,{onConflict:"key"});return i||(Me[e]=o),!i}async function ke(e,t,n){const{error:a}=await v.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function Ne(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=i);const d=V("visual.hero_bg_url","");if(d){const s=document.querySelector(".hero");s&&(s.style.backgroundImage=`url('${d}')`)}}function rt(e="pt"){const t=p=>Se(p,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n-num="inst.stat2num"]'),c=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat2_num")&&(s.innerHTML=t("inst.stat2_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const r=Se("seo.title_pt",e);r&&document.title&&(document.title=r);const b=Se("seo.description_pt",e);if(b){const p=document.querySelector('meta[name="description"]');p&&(p.content=b)}}function ct(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const mt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",re=`https://wa.me/${K}`;const Y=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],ut=5.7;function ce(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/ut).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let k=[],g=null,me=[],et=!1;v.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(et=!0)});async function pt(){const{data:e,error:t}=await v.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function vt(){const{data:e,error:t}=await v.from("properties").select("*").order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):(k=e||[],Ot(),Ft(),k)}async function gt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await v.from("properties").update(a).eq("id",t);if(o)throw o;const i=k.findIndex(l=>l.id===t);i>=0&&(k[i]={...k[i],...a})}else{if(!e.reference){const a=k.map(i=>i.reference||"").filter(i=>/^IO-\d+$/.test(i)).map(i=>parseInt(i.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await v.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&k.unshift(t[0])}}async function ft(e){const{error:t}=await v.from("properties").delete().eq("id",e);if(t)throw t;k=k.filter(n=>n.id!==e)}async function yt(e,t){const{error:n}=await v.auth.signInWithPassword({email:e,password:t});return!n}function Le(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,l=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let s=i.width,c=i.height;s>t&&(c=Math.round(c*t/s),s=t),d.width=s,d.height=c;const m=d.getContext("2d");m.drawImage(i,0,0,s,c);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const r=Math.round(s*.18),b=Math.round(u.naturalHeight*r/u.naturalWidth),p=Math.round(s*.02),f=s-r-p,w=c-b-p;m.globalAlpha=.45,m.drawImage(u,f,w,r,b),m.globalAlpha=1,d.toBlob(h=>h?a(h):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{d.toBlob(r=>r?a(r):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},i.onerror=o,i.src=l})}async function bt(e){const t=await Le(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await v.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=v.storage.from("imoveis").getPublicUrl(n);return o}async function ht(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await bt(n[o]));return a}async function ue(){var u,r,b,p,f,w;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await pt();k=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&Et(n);const a=((r=document.getElementById("city-filter"))==null?void 0:r.value)||"",o=((b=document.getElementById("neighborhood-filter"))==null?void 0:b.value)||"",i=((p=document.getElementById("bedrooms-filter"))==null?void 0:p.value)||"",l=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",d=((w=document.getElementById("construction-filter"))==null?void 0:w.value)||"",s=document.getElementById("price-slider"),c=s?parseInt(s.value,10):13e7,m=n.filter(h=>{if(a&&h.city!==a||o&&h.neighborhood!==o||i&&(i==="4+"&&Number(h.bedrooms)<4||i!=="4+"&&Number(h.bedrooms)!==Number(i))||l&&(l==="4+"&&Number(h.parking)<4||l!=="4+"&&Number(h.parking)!==Number(l))||d&&h.construction_status!==d)return!1;const E=String(h.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),S=parseInt(E,10)||0;return!(S<0||S>c)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(h=>{var B;const E=h.cover_image||((B=h.images)==null?void 0:B[0])||Y[0],S=[h.neighborhood,h.city].filter(Boolean).join(", ");return`
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(h=>{h.removeEventListener("click",Oe),h.addEventListener("click",Oe)})}function Et(e){var o,i,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(d=>{var m;const s=d.cover_image||((m=d.images)==null?void 0:m[0])||Y[0],c=[d.neighborhood,d.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
        <img src="${s}" alt="${y(d.title)}" class="selecao-card-img">
        <div class="selecao-card-body">
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(n=>{n.addEventListener("change",async()=>{const a=n.dataset.id,o=n.checked?"done":"pending";await v.from("tasks").update({status:o}).eq("id",a);const i=M.find(l=>String(l.id)===a);i&&(i.status=o),ge()})}),e.querySelectorAll(".tarefa-del-btn").forEach(n=>{n.addEventListener("click",async()=>{confirm("Excluir esta tarefa?")&&(await v.from("tasks").delete().eq("id",n.dataset.id),M=M.filter(a=>String(a.id)!==String(n.dataset.id)),ge())})})}function qt(e=null){var i,l,d;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=document.createElement("div");a.id="tarefa-modal-root",a.className="modal-backdrop",a.innerHTML=`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,r=new Blob([u],{type:"text/csv"}),b=document.createElement("a");b.href=URL.createObjectURL(r),b.download="modelo_contatos.csv",b.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",jt),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Ut)))}async function nt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=v.from("leads").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="corretor"?t=t.eq("assigned_to",g.id):g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:a}=await t;F=a||[],ee()}function ee(){var d,s,c;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?F.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/se));A>a&&(A=a);const o=t.slice((A-1)*se,A*se),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(m=>`
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const l=document.getElementById("contatos-pagination");if(l){const m=n===0?0:(A-1)*se+1,u=Math.min(A*se,n);l.innerHTML=`
    ...
    `,(s=l.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{A--,ee()}),(c=l.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{A++,ee()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(m=>{m.addEventListener("click",u=>{u.preventDefault();const r=m.dataset.id,b=F.find(p=>String(p.id)===String(r));b&&ot(b)})})}function ot(e=null){var i,l,d;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=document.createElement("div");a.id="contato-modal-root",a.className="modal-backdrop",a.innerHTML=`
...
`+I);window.open("mailto:?subject="+L+"&body="+$,"_blank")}),(S=document.getElementById("share-copy"))==null||S.addEventListener("click",()=>{var x;const I=document.getElementById("share-link-input");I&&((x=navigator.clipboard)==null||x.writeText(I.value).then(()=>{const L=document.getElementById("share-copy"),$=L.textContent;L.textContent="✅ Copiado!",setTimeout(()=>{L.textContent=$},2e3)}))}),(B=document.getElementById("view-modal-edit"))==null||B.addEventListener("click",()=>{var P;if((g==null?void 0:g.role)!=="admin")return;const I=document.getElementById("view-modal-title").textContent,x=k.find(N=>N.title===I);if(!x)return;ye(),R=x.id;const L=document.getElementById("property-form"),$=document.getElementById("form-submit-btn");$.textContent="Salvar Alterações",L.querySelector('[name="title"]').value=x.title||"",L.querySelector('[name="rua"]').value=x.rua||"",L.querySelector('[name="numero"]').value=x.numero||"",L.querySelector('[name="city"]').value=x.city||"",L.querySelector('[name="price"]').value=x.price||"",L.querySelector('[name="bedrooms"]').value=x.bedrooms||"",L.querySelector('[name="suites"]').value=x.suites||"",L.querySelector('[name="parking"]').value=x.parking||"",L.querySelector('[name="description"]').value=x.description||"",L.querySelector('[name="construction_status"]').value=x.construction_status||"",L.querySelector('[name="owner_name"]').value=x.owner_name||"",L.querySelector('[name="owner_phone"]').value=x.owner_phone||"",L.querySelector('[name="owner_email"]').value=x.owner_email||"",L.querySelector('[name="owner_notes"]').value=x.owner_notes||"",L.querySelector('[name="condominium"]').value=x.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=x.published===!0?"true":"false");const q=document.getElementById("adminCitySelect");q&&(q.value=x.city||"",q.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=x.neighborhood||"")},50)),W=x.cover_image||((P=x.images)==null?void 0:P[0])||"",we(x.images||[]),Ce("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(I=>{I.addEventListener("click",()=>{var x;document.querySelectorAll(".tab-btn").forEach(L=>L.classList.remove("active")),I.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(L=>L.classList.add("hidden")),(x=document.getElementById(`tab-${I.dataset.tab}`))==null||x.classList.remove("hidden")})}),(C=document.getElementById("admin-properties"))==null||C.addEventListener("click",I=>{if(I.target.closest(".action-btns"))return;const x=I.target.closest("tr");if(!x)return;const L=Number(x.dataset.id);if(!L)return;const $=k.find(_=>_.id===L);$&&Lt($)})}document.addEventListener("DOMContentLoaded",async()=>{var i,l,d;await Promise.all([dt(),it()]),K=V("company.whatsapp",K),re=`https://wa.me/${K}`,Ne(),wt(),It();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(je(),e.addEventListener("change",()=>{const s=J().find(m=>m.name===e.value),c=s?He(s.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${y(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const s=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=s.get("type")||c.get("type")||"",u=et||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),r=document.getElementById("password-reset-overlay");if(u){n.style.display="none",a&&a.classList.add("hidden"),r&&(r.style.display="flex"),(i=document.getElementById("password-reset-form"))==null||i.addEventListener("submit",async p=>{var B,C;p.preventDefault();const f=((B=document.getElementById("new-password"))==null?void 0:B.value)||"",w=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",h=document.getElementById("password-reset-msg"),E=p.target.querySelector('button[type="submit"]');if(h&&(h.style.display="none"),f!==w){h&&(h.textContent="As senhas não coincidem.",h.style.display="");return}E&&(E.disabled=!0,E.textContent="Salvando…");const{error:S}=await v.auth.updateUser({password:f});if(S){h&&(h.textContent="Erro: "+S.message,h.style.display=""),E&&(E.disabled=!1,E.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await v.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:b}}=await v.auth.getSession();if(b){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ee(),_e(),Je(),St(),window.lucide&&lucide.createIcons(),g=await Fe(b.user.id),!g){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(g.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(g.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const p=document.getElementById("password-reset-overlay");p&&(p.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async f=>{var C,I;f.preventDefault();const w=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",h=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",E=document.getElementById("password-reset-msg"),S=f.target.querySelector('button[type="submit"]');if(E&&(E.style.display="none"),w!==h){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}if(w.length<6){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:B}=await v.auth.updateUser({password:w});if(B){E&&(E.textContent="Erro: "+B.message,E.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}await v.from("profiles").update({needs_password_reset:!1}).eq("id",g.id),window.location.href=window.location.pathname});return}qe(g),ze(g.role),await Ye(g),window.lucide&&lucide.createIcons(),Rt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const p=document.getElementById("login-form");p&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var h,E;const f=(E=(h=p.querySelector('input[name="email"]'))==null?void 0:h.value)==null?void 0:E.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:w}=await v.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(w?"Erro: "+w.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),p.addEventListener("submit",async f=>{f.preventDefault();const w=new FormData(p),h=w.get("email"),E=w.get("password");if(await yt(h,E)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ee(),_e(),Je(),window.lucide&&lucide.createIcons();const{data:{session:B}}=await v.auth.getSession();if(g=B?await Fe(B.user.id):null,!g){await v.auth.signOut();return}if(g.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}qe(g),ze(g.role),await Ye(g),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else _e();await ue();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();rt(o),ct(K)});async function Ot(){const e=k.filter(o=>!o.reference);if(!e.length)return;const t=k.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:l}=await v.from("properties").update({reference:i}).eq("id",o.id);if(!l){const d=k.findIndex(s=>s.id===o.id);d>=0&&(k[d].reference=i),n++}}pe(Re(k))}async function Ft(){const e=k.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const l=await zt(i);a.push(l),o=!0}catch{a.push(i)}if(o){await v.from("properties").update({images:a}).eq("id",t.id);const i=k.findIndex(l=>l.id===t.id);i>=0&&(k[i].images=a)}}pe(Re(k))}}async function zt(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,l=i?URL.createObjectURL(i):null;return new Promise(d=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),m=1200;let u=s.width,r=s.height;u>m&&(r=Math.round(r*m/u),u=m),c.width=u,c.height=r;const b=c.getContext("2d");b.drawImage(s,0,0,u,r);const p=f=>{if(f){const w=Math.round(u*.18),h=Math.round(f.naturalHeight*w/f.naturalWidth),E=Math.round(u*.02);b.globalAlpha=.45,b.drawImage(f,u-w-E,r-h-E,w,h),b.globalAlpha=1}c.toBlob(async w=>{try{const h=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:E}=await v.storage.from("imoveis").upload(h,w,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(E){console.error("Upload watermark error:",E),d(e);return}const{data:{publicUrl:S}}=v.storage.from("imoveis").getPublicUrl(h);d(S)}catch(h){console.error("Watermark upload exception:",h),d(e)}},"image/jpeg",.82)};if(l){const f=new Image;f.onload=()=>{URL.revokeObjectURL(l),p(f)},f.onerror=()=>{URL.revokeObjectURL(l),p(null)},f.src=l}else p(null)},s.onerror=()=>{URL.revokeObjectURL(a),d(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function j(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Ue(e,t="assets"){const n=await Le(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await v.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=v.storage.from("imoveis").getPublicUrl(a);return i}async function Xt(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("settings").select("key,value"),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>y(String(n[o]||""));e.innerHTML=`
  ...
  `;e.innerHTML=`
    ...
    <div class="cfg-card">
      ...
      <div id="sc-panels">
        ${o.map(s=>`<div class="content-panel${s==="pt"?" active":""}" data-panel="${s}">${d(s)}</div>`).join("")}
      </div>
      <div class="cfg-save-row">
  ...
  `,document.getElementById("sc-tabs").addEventListener("click",s=>{var m;const c=s.target.closest(".content-tab");c&&(document.querySelectorAll("#sc-tabs .content-tab").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#sc-panels .content-panel").forEach(u=>u.classList.remove("active")),c.classList.add("active"),(m=document.querySelector(`#sc-panels [data-panel="${c.dataset.lang}"]`))==null||m.classList.add("active"))}),document.getElementById("sc-save-btn").addEventListener("click",async()=>{const s=document.getElementById("sc-save-btn");s.disabled=!0,s.textContent="Salvando…";const c={};document.querySelectorAll(".sc-field").forEach(u=>{const r=u.dataset.key,b=u.dataset.lang;c[r]||(c[r]={}),c[r][b]=u.value});let m=!0;for(const[u,r]of Object.entries(c))await $e(u,{pt:r.pt,en:r.en,es:r.es})||(m=!1);s.disabled=!1,s.textContent="Salvar Conteúdo",j(document.getElementById("sc-save-msg"),m)}),document.getElementById("seo-save-btn").addEventListener("click",async()=>{const s=document.getElementById("seo-save-btn");s.disabled=!0,s.textContent="Salvando…";const c=document.getElementById("seo-title").value.trim(),m=document.getElementById("seo-desc").value.trim(),u=await $e("seo.title_pt",{pt:c,en:c,es:c})&&await $e("seo.description_pt",{pt:m,en:m,es:m});s.disabled=!1,s.textContent="Salvar SEO",j(document.getElementById("seo-save-msg"),u)})}async function Wt(){const e=document.getElementById("section-crm-config");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await Ae(),document.getElementById("media-file-input").addEventListener("change",async n=>{var s,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let d=0;for(const m of a){l.textContent=`Enviando ${d+1}/${a.length}…`,i.style.width=`${Math.round(d/a.length*100)}%`;try{const u=await Ue(m,"media"),r=m.name.replace(/\.[^.]+$/,"").slice(0,60);await v.from("media_library").insert({name:r,url:u,type:"image",size:m.size,created_by:(c=(s=(await v.auth.getUser()).data)==null?void 0:s.user)==null?void 0:c.id})}catch(u){console.error("Media upload error:",u)}d++}i.style.width="100%",l.textContent=`✓ ${d} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await Ae(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Ae(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await v.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&z(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Qt(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ke(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Qe(),l.dataset.tab==="platform"&&Ze()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ke),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",z),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Qe),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>ta()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",Zt),z(),Ze())}async function z(){var d,s;const e=document.getElementById("sa-tenants-list"),t=((s=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=v.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var m,u;return!t||((m=c.name)==null?void 0:m.toLowerCase().includes(t))||((u=c.slug)==null?void 0:u.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var m;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async()=>{const m=c.dataset.active==="true";await v.from("tenants").update({active:!m}).eq("id",c.dataset.id),z()})}),e.querySelectorAll('[data-action="edit-tenant"]').forEach(c=>{c.addEventListener("click",()=>{const m=(i||[]).find(u=>String(u.id)===String(c.dataset.id));m&&aa(m)})})}async function Qt(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await v.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),v.from("plans").select("id, name").then(({data:c})=>{const m=document.getElementById("nt-plan");m&&c&&(m.innerHTML='<option value="">Sem plano</option>'+c.map(u=>`<option value="${u.id}">${y(u.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const m=document.getElementById("nt-slug");m&&!m.dataset.manual&&(m.value=ea(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var C,I,x,L,$,_,q,P,N,te,ae,ne;const c=(I=(C=document.getElementById("nt-name"))==null?void 0:C.value)==null?void 0:I.trim(),m=(L=(x=document.getElementById("nt-slug"))==null?void 0:x.value)==null?void 0:L.trim(),u=(_=($=document.getElementById("nt-domain"))==null?void 0:$.value)==null?void 0:_.trim(),r=(q=document.getElementById("nt-plan"))==null?void 0:q.value,b=(N=(P=document.getElementById("nt-admin-email"))==null?void 0:P.value)==null?void 0:N.trim(),p=(ae=(te=document.getElementById("nt-admin-password"))==null?void 0:te.value)==null?void 0:ae.trim(),f=document.getElementById("nt-msg"),w=document.getElementById("nt-save");if(!c||!m){f.textContent="❌ Nome e slug são obrigatórios.",f.style.color="#ef4444";return}if(!b){f.textContent="❌ Informe o e-mail do admin.",f.style.color="#ef4444";return}if(!p||p.length<6){f.textContent="❌ A senha precisa ter mínimo 6 caracteres.",f.style.color="#ef4444";return}w.disabled=!0,w.textContent="Criando…",f.textContent="⏳ Criando imobiliária…",f.style.color="#64748b";const{data:h,error:E}=await v.from("tenants").insert({name:c,slug:m,domain:u||null,plan_id:r||null,active:!0}).select();if(E){w.disabled=!1,w.textContent="Criar Imobiliária",f.textContent="❌ "+E.message,f.style.color="#ef4444";return}const S=(ne=h==null?void 0:h[0])==null?void 0:ne.id;f.textContent="⏳ Criando usuário admin…";const B=await fe({email:b,password:p,role:"admin",tenant_id:S});if(!(B!=null&&B.success)){w.disabled=!1,w.textContent="Criar Imobiliária",f.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+y((B==null?void 0:B.error)||"Desconhecido"),f.style.color="#f59e0b",setTimeout(()=>{n(),z()},3e3);return}S&&(B!=null&&B.user_id)&&!(B!=null&&B.linked)&&await v.from("profiles").update({tenant_id:S}).eq("id",B.user_id),w.disabled=!1,w.textContent="Criar Imobiliária",B.email_sent===!1?(f.innerHTML=`
        ...
        </div>`,f.style.color="#0f172a"):(f.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",f.style.color="#22c55e",setTimeout(()=>{n(),z()},1500))})}function aa(e){var o,i,l,d,s,c,m;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop",n.innerHTML=`
