import{s as b}from"./supabase-BcuJ3xoD.js";const lt="00000000-0000-0000-0000-000000000000";let ue={},$e={},te=lt;function We(e){te=e||lt,ue={},$e={}}const Re=()=>te;async function bt(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",te),b.from("site_content").select("*").eq("tenant_id",te)]);e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{$e[n.key]=n})}const V=(e,t=null)=>ue[e]!==void 0?ue[e]:t,_e=(e,t="pt")=>{const n=$e[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Z(e){const t=new Date().toISOString(),n=e.map(([o,s])=>({key:o,value:s,tenant_id:te,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,s])=>{ue[o]=s}),!a}async function Ce(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:te,updated_at:new Date().toISOString()},{error:s}=await b.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return s||($e[e]=o),!s}async function Te(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function je(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=o});const s=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=s);const d=V("visual.hero_bg_url","");if(d){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${d}')`)}}function ht(e="pt"){const t=g=>_e(g,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const s=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');s&&t("inst.bio_p1")&&(s.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');i&&t("inst.stat2_num")&&(i.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const c=_e("seo.title_pt",e);c&&document.title&&(document.title=c);const E=_e("seo.description_pt",e);if(E){const g=document.querySelector('meta[name="description"]');g&&(g.content=E)}}function Et(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const wt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",pe=`https://wa.me/${K}`;const W=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],It=5.7;function ve(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/It).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let $=[],p=null,ge=[],dt=!1;b.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(dt=!0)});async function xt(){const{data:e,error:t}=await b.from("properties").select("*").eq("published",!0).is("tenant_id",null).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function Bt(){let e=b.from("properties").select("*").order("created_at",{ascending:!1});(p==null?void 0:p.role)==="super_admin"?e=e.is("tenant_id",null):p!=null&&p.tenant_id?e=e.eq("tenant_id",p.tenant_id):p!=null&&p.id&&(e=e.is("tenant_id",null));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):($=t||[],ea(),ta(),$)}async function Lt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await b.from("properties").update(a).eq("id",t);if(o)throw o;const s=$.findIndex(l=>l.id===t);s>=0&&($[s]={...$[s],...a})}else{if(!e.reference){const a=$.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await b.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&$.unshift(t[0])}}async function St(e){const{error:t}=await b.from("properties").delete().eq("id",e);if(t)throw t;$=$.filter(n=>n.id!==e)}async function kt(e,t){const{error:n}=await b.auth.signInWithPassword({email:e,password:t});return!n}function he(e,t=1200,n=.78){return new Promise((a,o)=>{const s=new Image,l=URL.createObjectURL(e);s.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let i=s.width,r=s.height;i>t&&(r=Math.round(r*t/i),i=t),d.width=i,d.height=r;const m=d.getContext("2d");m.drawImage(s,0,0,i,r);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const c=Math.round(i*.18),E=Math.round(u.naturalHeight*c/u.naturalWidth),g=Math.round(i*.02),f=i-c-g,y=r-E-g;m.globalAlpha=.45,m.drawImage(u,f,y,c,E),m.globalAlpha=1,d.toBlob(v=>v?a(v):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{d.toBlob(c=>c?a(c):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},s.onerror=o,s.src=l})}async function $t(e){const t=await he(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await b.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=b.storage.from("imoveis").getPublicUrl(n);return o}async function _t(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await $t(n[o]));return a}async function fe(){var u,c,E,g,f,y;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await xt();$=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&Ct(n);const a=((c=document.getElementById("city-filter"))==null?void 0:c.value)||"",o=((E=document.getElementById("neighborhood-filter"))==null?void 0:E.value)||"",s=((g=document.getElementById("bedrooms-filter"))==null?void 0:g.value)||"",l=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",d=((y=document.getElementById("construction-filter"))==null?void 0:y.value)||"",i=document.getElementById("price-slider"),r=i?parseInt(i.value,10):13e7,m=n.filter(v=>{if(a&&v.city!==a||o&&v.neighborhood!==o||s&&(s==="4+"&&Number(v.bedrooms)<4||s!=="4+"&&Number(v.bedrooms)!==Number(s))||l&&(l==="4+"&&Number(v.parking)<4||l!=="4+"&&Number(v.parking)!==Number(l))||d&&v.construction_status!==d)return!1;const w=String(v.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(w,10)||0;return!(L<0||L>r)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(v=>{var x;const w=v.cover_image||((x=v.images)==null?void 0:x[0])||W[0],L=[v.neighborhood,v.city].filter(Boolean).join(", ");return`
...
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(R){const i=$.find(r=>r.id===R);i!=null&&i.images&&(s=i.images)}s.length||(s=[...W]);const d={...R?{id:R}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:s,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:G||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||""};try{await Lt(d),R=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const i=document.getElementById("adminPublished");i&&(i.value="true");const r=document.getElementById("adminNeighborhood");r&&(r.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),G="",xe([]),we(),await Ie()}catch(i){console.error(i),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert("Erro ao salvar imóvel. Verifique o console.")}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await St(o),await Ie()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((p==null?void 0:p.role)!=="admin")return;const o=Number(n.target.dataset.id);if(!o)return;const s=$.find(i=>i.id===o);if(!s)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=s.title||"",e.querySelector('[name="rua"]').value=s.rua||"",e.querySelector('[name="numero"]').value=s.numero||"",e.querySelector('[name="city"]').value=s.city||"",e.querySelector('[name="price"]').value=s.price||"",e.querySelector('[name="bedrooms"]').value=s.bedrooms||"",e.querySelector('[name="suites"]').value=s.suites||"",e.querySelector('[name="area"]').value=s.area||"",e.querySelector('[name="parking"]').value=s.parking||"",e.querySelector('[name="description"]').value=s.description||"",e.querySelector('[name="construction_status"]').value=s.construction_status||"",e.querySelector('[name="owner_name"]').value=s.owner_name||"",e.querySelector('[name="owner_phone"]').value=s.owner_phone||"",e.querySelector('[name="owner_email"]').value=s.owner_email||"",e.querySelector('[name="owner_notes"]').value=s.owner_notes||"",e.querySelector('[name="condominium"]').value=s.condominium||"";const l=document.getElementById("adminPublished");l&&(l.value=s.published===!0?"true":"false");const d=document.getElementById("adminCitySelect");d&&(d.value=s.city||"",d.dispatchEvent(new Event("change")),setTimeout(()=>{const i=document.getElementById("adminNeighborhood");i&&(i.value=s.neighborhood||"")},50)),G=s.cover_image||((a=s.images)==null?void 0:a[0])||"",xe(s.images||[]),Ae("Editar Imóvel")}})}function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let O=[],j=0;function Nt(e){var m,u;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((m=e.images)==null?void 0:m[0])||W[0];document.getElementById("view-thumb-preview").src=o,O=(u=e.images)!=null&&u.length?e.images:W,j=0,Be(),document.getElementById("view-price").textContent=ve(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(c=>c.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(c=>c.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,i=document.getElementById("share-link-input");i&&(i.value=d);const r=document.getElementById("share-panel");r&&(r.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ee(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Be(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=O[j],e.alt=`Foto ${j+1}`;const s=O.length>1;n.style.display=s?"flex":"none",a.style.display=s?"flex":"none",t.textContent=s?`${j+1} / ${O.length}`:"",o.innerHTML=s?O.map((l,d)=>`<img src="${l}" class="view-thumb${d===j?" active":""}" data-i="${d}" alt="Foto ${d+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{j=+l.dataset.i,Be()})})}async function Je(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Le(e){var u,c;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const s=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=s,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((u=s[0])==null?void 0:u.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const d=document.getElementById("avatar-dd-name"),i=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),m=document.getElementById("avatar-dd-initial");d&&(d.textContent=s),i&&(i.textContent=l),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",m&&(m.style.display="none")):(m&&(m.textContent=((c=s[0])==null?void 0:c.toUpperCase())||"?",m.style.display=""),r&&(r.style.display="none"))}function Y(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),U(),e==="contatos"&&Yt(),e==="funil"&&Pt(),e==="tarefas"&&Dt()}function Ke(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:na,visual:oa,"site-config":sa,"crm-config":ia,integracoes:la,midia:da}).forEach(([a,o])=>{const s=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);s&&s.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>ra(),{once:!0}),window.lucide&&lucide.createIcons()}}function U(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Rt(){var a,o,s;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(l=document.getElementById("cph-close"))==null||l.addEventListener("click",o),(d=document.getElementById("cph-cancel"))==null||d.addEventListener("click",o),t.addEventListener("click",m=>{m.target===t&&o()}),(i=document.getElementById("cph-file"))==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const c=URL.createObjectURL(u),E=document.getElementById("cph-preview"),g=document.getElementById("cph-initial");E&&(E.src=c,E.style.display=""),g&&(g.style.display="none"),document.getElementById("cph-save").disabled=!1}),(r=document.getElementById("cph-save"))==null||r.addEventListener("click",async()=>{var E;const m=(E=document.getElementById("cph-file"))==null?void 0:E.files[0];if(!m)return;const u=document.getElementById("cph-save"),c=document.getElementById("cph-msg");u.disabled=!0,u.textContent="Salvando…";try{const g=await he(m,400,.85),f=`avatars/${p.id}-${Date.now()}.jpg`,{error:y}=await b.storage.from("imoveis").upload(f,g,{contentType:"image/jpeg",upsert:!0});if(y)throw y;const{data:{publicUrl:v}}=b.storage.from("imoveis").getPublicUrl(f);await b.from("profiles").update({avatar_url:v}).eq("id",p.id),p={...p,avatar_url:v},Le(p),o()}catch(g){c.style.color="#ef4444",c.textContent="Erro: "+g.message,c.style.display="",u.disabled=!1,u.textContent="Salvar Foto"}})}function Ht(){var a,o,s;const e=document.getElementById("add-corretor-modal-root");e&&e.remove();const t=document.createElement("div");t.id="add-corretor-modal-root",t.className="modal-backdrop",t.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(l);const d=()=>l.remove();(i=document.getElementById("tm-close"))==null||i.addEventListener("click",d),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",d),l.addEventListener("click",c=>{c.target===l&&d()}),(m=document.getElementById("tm-toggle-done"))==null||m.addEventListener("click",async()=>{const c=a?"pending":"done";await b.from("tasks").update({status:c}).eq("id",e.id);const E=M.find(g=>String(g.id)===String(e.id));E&&(E.status=c),d(),c==="done"&&(Q="done",document.querySelectorAll(".tarefa-filter-btn").forEach(g=>{g.classList.toggle("active",g.dataset.filter==="done")})),ae()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var v,w;const c=document.getElementById("tarefa-form");if(!c.checkValidity()){c.reportValidity();return}const E=new FormData(c),g=document.getElementById("tm-save");g.disabled=!0,g.textContent="Salvando…";const f={title:(v=E.get("title"))==null?void 0:v.trim(),description:((w=E.get("description"))==null?void 0:w.trim())||null,due_date:E.get("due_date")||null,priority:E.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(p==null?void 0:p.id)||null,tenant_id:(p==null?void 0:p.tenant_id)||null};let y;if(n){if({error:y}=await b.from("tasks").update(f).eq("id",e.id),!y){const L=M.findIndex(x=>String(x.id)===String(e.id));L>=0&&(M[L]={...M[L],...f})}}else{const{data:L,error:x}=await b.from("tasks").insert(f).select();y=x,!y&&(L!=null&&L[0])&&M.unshift(L[0])}if(g.disabled=!1,g.textContent=n?"Salvar":"Criar Tarefa",y){alert("Erro: "+y.message);return}d(),ae()})}async function Ft(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;p==null||p.role,p==null||p.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),s=[];a!=null&&a.length&&(s.push('<div class="search-group-label">Imóveis</div>'),s.push(...a.map(l=>`
      ...
      </div>`))),t.innerHTML=s.length?s.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(l=>{l.addEventListener("click",()=>{var d;(d=document.getElementById("search-overlay"))==null||d.classList.add("hidden"),l.dataset.type==="lead"?Y("contatos"):Y("properties")})})}let P=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function Xt(){var l;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=b.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);p!=null&&p.tenant_id&&(t=t.eq("tenant_id",p.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(d=>!P.includes(String(d.id))),s=document.getElementById("notif-badge");if(s&&(s.textContent=o.length,o.length>0?s.classList.remove("hidden"):s.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(d=>{const i=Gt(d.created_at);return`
      <div class="notif-item${!P.includes(String(d.id))?" unread":""}" data-id="${d.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${h(d.name||"—")}</div>
          <div class="notif-item-sub">${h(d.phone||d.source||"")} · ${i}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",d=>{d.preventDefault(),U(),Y("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{P.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(P)),d.classList.remove("unread"),U(),Y("contatos")})})}function Vt(){var e;document.querySelectorAll(".notif-item").forEach(t=>P.push(t.dataset.id)),P=[...new Set(P)],localStorage.setItem("crm_notifs_read",JSON.stringify(P)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Gt(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Wt(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);p!=null&&p.tenant_id&&(e=e.eq("tenant_id",p.tenant_id));const{data:t}=await e,a=(t||[]).filter(s=>!P.includes(String(s.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let F=[],A=1;const ce=10;let tt=!1;async function Yt(){var t,n,a,o,s,l,d,i,r;document.getElementById("section-contatos")&&(tt||(tt=!0,await pt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{A=1,ne()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",m=>{m.key==="Enter"&&(A=1,ne())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>vt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Qt),(s=document.getElementById("import-modal-close"))==null||s.addEventListener("click",Me),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",Me),(d=document.getElementById("download-template"))==null||d.addEventListener("click",m=>{m.preventDefault();const u=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,c=new Blob([u],{type:"text/csv"}),E=document.createElement("a");E.href=URL.createObjectURL(c),E.download="modelo_contatos.csv",E.click()}),(i=document.getElementById("import-csv-file"))==null||i.addEventListener("change",Jt),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",Kt)))}async function pt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(p==null?void 0:p.role)==="corretor"?t=t.eq("assigned_to",p.id):p!=null&&p.tenant_id&&(t=t.eq("tenant_id",p.tenant_id));const{data:a}=await t;F=a||[],ne()}function ne(){var d,i,r;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?F.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/ce));A>a&&(A=a);const o=t.slice((A-1)*ce,A*ce),s=document.getElementById("contatos-tbody");if(!s)return;o.length?s.innerHTML=o.map(m=>`
      <tr>
...
`+I);window.open("mailto:?subject="+S+"&body="+k,"_blank")}),(L=document.getElementById("share-copy"))==null||L.addEventListener("click",()=>{var B;const I=document.getElementById("share-link-input");I&&((B=navigator.clipboard)==null||B.writeText(I.value).then(()=>{const S=document.getElementById("share-copy"),k=S.textContent;S.textContent="✅ Copiado!",setTimeout(()=>{S.textContent=k},2e3)}))}),(x=document.getElementById("view-modal-edit"))==null||x.addEventListener("click",()=>{var z;if((p==null?void 0:p.role)!=="admin")return;const I=document.getElementById("view-modal-title").textContent,B=$.find(N=>N.title===I);if(!B)return;Ee(),R=B.id;const S=document.getElementById("property-form"),k=document.getElementById("form-submit-btn");k.textContent="Salvar Alterações",S.querySelector('[name="title"]').value=B.title||"",S.querySelector('[name="rua"]').value=B.rua||"",S.querySelector('[name="numero"]').value=B.numero||"",S.querySelector('[name="city"]').value=B.city||"",S.querySelector('[name="price"]').value=B.price||"",S.querySelector('[name="bedrooms"]').value=B.bedrooms||"",S.querySelector('[name="suites"]').value=B.suites||"",S.querySelector('[name="parking"]').value=B.parking||"",S.querySelector('[name="description"]').value=B.description||"",S.querySelector('[name="construction_status"]').value=B.construction_status||"",S.querySelector('[name="owner_name"]').value=B.owner_name||"",S.querySelector('[name="owner_phone"]').value=B.owner_phone||"",S.querySelector('[name="owner_email"]').value=B.owner_email||"",S.querySelector('[name="owner_notes"]').value=B.owner_notes||"",S.querySelector('[name="condominium"]').value=B.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=B.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=B.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=B.neighborhood||"")},50)),G=B.cover_image||((z=B.images)==null?void 0:z[0])||"",xe(B.images||[]),Ae("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(I=>{I.addEventListener("click",()=>{var B;document.querySelectorAll(".tab-btn").forEach(S=>S.classList.remove("active")),I.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(S=>S.classList.add("hidden")),(B=document.getElementById(`tab-${I.dataset.tab}`))==null||B.classList.remove("hidden")})}),(C=document.getElementById("admin-properties"))==null||C.addEventListener("click",I=>{if(I.target.closest(".action-btns"))return;const B=I.target.closest("tr");if(!B)return;const S=Number(B.dataset.id);if(!S)return;const k=$.find(_=>_.id===S);k&&Nt(k)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;await Promise.all([bt(),gt()]),K=V("company.whatsapp",K),pe=`https://wa.me/${K}`,je(),Tt(),qt();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(Pe(),e.addEventListener("change",()=>{const i=J().find(m=>m.name===e.value),r=i?Ue(i.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(m=>`<option value="${m.name}">${h(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),m=i.get("type")||r.get("type")||"",u=dt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||r.has("code"),c=document.getElementById("password-reset-overlay");if(u){n.style.display="none",a&&a.classList.add("hidden"),c&&(c.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async g=>{var x,C;g.preventDefault();const f=((x=document.getElementById("new-password"))==null?void 0:x.value)||"",y=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",v=document.getElementById("password-reset-msg"),w=g.target.querySelector('button[type="submit"]');if(v&&(v.style.display="none"),f!==y){v&&(v.textContent="As senhas não coincidem.",v.style.display="");return}w&&(w.disabled=!0,w.textContent="Salvando…");const{error:L}=await b.auth.updateUser({password:f});if(L){v&&(v.textContent="Erro: "+L.message,v.style.display=""),w&&(w.disabled=!1,w.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await b.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:E}}=await b.auth.getSession();if(E){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),nt(),Ut(),window.lucide&&lucide.createIcons(),p=await Je(E.user.id),!p){await b.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(p.active===!1){await b.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(p.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const g=document.getElementById("password-reset-overlay");g&&(g.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async f=>{var C,I;f.preventDefault();const y=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",v=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",w=document.getElementById("password-reset-msg"),L=f.target.querySelector('button[type="submit"]');if(w&&(w.style.display="none"),y!==v){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}if(y.length<6){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:x}=await b.auth.updateUser({password:y});if(x){w&&(w.textContent="Erro: "+x.message,w.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",p.id),window.location.href=window.location.pathname});return}We((p==null?void 0:p.tenant_id)||null),Le(p),Ke(p.role),await Ie(),await at(p),window.lucide&&lucide.createIcons(),Wt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const g=document.getElementById("login-form");g&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var v,w;const f=(w=(v=g.querySelector('input[name="email"]'))==null?void 0:v.value)==null?void 0:w.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:y}=await b.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(y?"Erro: "+y.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),g.addEventListener("submit",async f=>{f.preventDefault();const y=new FormData(g),v=y.get("email"),w=y.get("password");if(await kt(v,w)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),nt(),window.lucide&&lucide.createIcons();const{data:{session:x}}=await b.auth.getSession();if(p=x?await Je(x.user.id):null,!p){await b.auth.signOut();return}if(p.active===!1){await b.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}We((p==null?void 0:p.tenant_id)||null),Le(p),Ke(p.role),await Ie(),await at(p),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else qe();await fe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();ht(o),Et(K)});async function ea(){const e=$.filter(o=>!o.reference);if(!e.length)return;const t=$.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,s)=>o.id-s.id);for(const o of a){const s="IO-"+String(n).padStart(4,"0"),{error:l}=await b.from("properties").update({reference:s}).eq("id",o.id);if(!l){const d=$.findIndex(i=>i.id===o.id);d>=0&&($[d].reference=s),n++}}ye(He($))}async function ta(){const e=$.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(s=>!s.includes("/wm-")))continue;const a=[];let o=!1;for(const s of t.images)if(s.includes("/wm-"))a.push(s);else try{const l=await aa(s);a.push(l),o=!0}catch{a.push(s)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const s=$.findIndex(l=>l.id===t.id);s>=0&&($[s].images=a)}}ye(He($))}}async function aa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),s=o.ok?await o.blob():null,l=s?URL.createObjectURL(s):null;return new Promise(d=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),m=1200;let u=i.width,c=i.height;u>m&&(c=Math.round(c*m/u),u=m),r.width=u,r.height=c;const E=r.getContext("2d");E.drawImage(i,0,0,u,c);const g=f=>{if(f){const y=Math.round(u*.18),v=Math.round(f.naturalHeight*y/f.naturalWidth),w=Math.round(u*.02);E.globalAlpha=.45,E.drawImage(f,u-y-w,c-v-w,y,v),E.globalAlpha=1}r.toBlob(async y=>{try{const v=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await b.storage.from("imoveis").upload(v,y,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),d(e);return}const{data:{publicUrl:L}}=b.storage.from("imoveis").getPublicUrl(v);d(L)}catch(v){console.error("Watermark upload exception:",v),d(e)}},"image/jpeg",.82)};if(l){const f=new Image;f.onload=()=>{URL.revokeObjectURL(l),g(f)},f.onerror=()=>{URL.revokeObjectURL(l),g(null)},f.src=l}else g(null)},i.onerror=()=>{URL.revokeObjectURL(a),d(e)},i.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function H(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function ze(e,t="assets"){const n=await he(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:s}}=b.storage.from("imoveis").getPublicUrl(a);return s}async function na(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",Re()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>h(String(n[o]||""));e.innerHTML=`
  ...
  `,await D())}async function D(){const e=document.getElementById("crm-body");if(!e)return;const[{data:t},{data:n},{data:a},{data:o}]=await Promise.all([b.from("crm_pipelines").select("*").order("sort_order"),b.from("crm_stages").select("*").order("sort_order"),b.from("crm_tags").select("*").order("name"),b.from("crm_lead_statuses").select("*").order("sort_order")]),s=t||[],l=s.find(c=>c.is_default)||s[0],d=s.map(c=>`<option value="${c.id}"${c.id===(l==null?void 0:l.id)?" selected":""}>${h(c.name)}</option>`).join(""),r=(n||[]).filter(c=>c.pipeline_id===(l==null?void 0:l.id)).map(c=>`
    ...
    </span>`).join("")||'<p style="color:#9ca3af;font-size:13px;margin:0">Nenhuma tag cadastrada.</p>',u=(o||[]).map(c=>`
    <div class="stage-item" data-id="${c.id}">
      <div class="stage-color-dot" style="background:${c.color}"></div>
      <span class="stage-name">${h(c.name)}</span>
  ...
  `,await Ne(),document.getElementById("media-file-input").addEventListener("change",async n=>{var i,r;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),s=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let d=0;for(const m of a){l.textContent=`Enviando ${d+1}/${a.length}…`,s.style.width=`${Math.round(d/a.length*100)}%`;try{const u=await ze(m,"media"),c=m.name.replace(/\.[^.]+$/,"").slice(0,60);await b.from("media_library").insert({name:c,url:u,type:"image",size:m.size,created_by:(r=(i=(await b.auth.getUser()).data)==null?void 0:i.user)==null?void 0:r.id})}catch(u){console.error("Media upload error:",u)}d++}s.style.width="100%",l.textContent=`✓ ${d} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",s.style.width="0"},2e3),await Ne(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Ne(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await b.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(i=>i.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&X(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&ca(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&ot(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&st(),l.dataset.tab==="platform"&&it()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",ot),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",X),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",st),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>pa()),(s=e.querySelector("#sa-plat-save"))==null||s.addEventListener("click",ma),X(),it())}async function X(){var d,i;const e=document.getElementById("sa-tenants-list"),t=((i=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=b.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const s=(a||[]).filter(r=>{var m,u;return!t||((m=r.name)==null?void 0:m.toLowerCase().includes(t))||((u=r.slug)==null?void 0:u.toLowerCase().includes(t))});if(!s.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=r=>r.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=s.map(r=>{var m;return`
