import{s as b}from"./supabase-BcuJ3xoD.js";const F="00000000-0000-0000-0000-000000000000";let le={},xe={},se=F;function ye(e){se=e||F,le={},xe={}}const z=()=>se;async function ua(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",se),b.from("site_content").select("*").eq("tenant_id",se)]);if(e.data&&e.data.forEach(n=>{le[n.key]=n.value}),t.data&&t.data.forEach(n=>{xe[n.key]=n}),(!t.data||t.data.length===0)&&se!==F){const[n,a]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",F),b.from("site_content").select("*").eq("tenant_id",F)]);n.data&&n.data.forEach(o=>{le[o.key]===void 0&&(le[o.key]=o.value)}),a.data&&a.data.forEach(o=>{xe[o.key]||(xe[o.key]=o)})}}const W=(e,t=null)=>le[e]!==void 0?le[e]:t,Le=(e,t="pt")=>{const n=xe[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Ee(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:se,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{le[o]=i}),!a}async function Oe(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:se,updated_at:o},{error:s}=await b.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return s||(xe[e]=i),se!==F&&await b.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:F,updated_at:o},{onConflict:"key,tenant_id"}),!s}async function Ze(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function pt(){const e=document.documentElement,t=W("visual.accent_color","#b8962e"),n=W("visual.primary_bg","#0f1c2e"),a=W("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=W("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=W("company.favicon_url","/favicon.ico"),s=document.querySelector('link[rel="shortcut icon"]');s&&(s.href=i);const l=W("visual.hero_bg_url","");if(l){const d=document.querySelector(".hero, .hero-v2");d&&(d.style.backgroundImage="url('"+l+"')")}}function Et(e){e=e||"pt";const t=g=>Le(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),s=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),s&&t("inst.bio_p2")&&(s.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),h=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat1_num")&&(d.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),h&&t("inst.stat3_label")&&(h.innerHTML=t("inst.stat3_label"));const E=document.getElementById("dep-grid");if(E){const g=Le("testimonials",e)||Le("testimonials","pt");if(g)try{const v=JSON.parse(g);if(Array.isArray(v)&&v.length>0){let S=function(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(k){let w=0;for(const $ of k||"?")w=w*31+$.charCodeAt(0)&4294967295;return I[Math.abs(w)%I.length]};const I=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];E.innerHTML=v.map(k=>`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),s=n("casas-condominio"),l=Ft(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",s.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",s,"imoveis.html?collection=casas-condominio"):""].join(""),Xt(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",ut),t.addEventListener("touchend",function(d){const c=d.target.closest(".carousel-btn");c&&(d.preventDefault(),d.stopPropagation(),Vt(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ce(){var h,E,x,u,g,v;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Pt();C=n,((h=document.getElementById("selecao-carousel"))==null?void 0:h.innerHTML)===""&&ka(n);const a=((E=document.getElementById("city-filter"))==null?void 0:E.value)||"",o=((x=document.getElementById("neighborhood-filter"))==null?void 0:x.value)||"",i=((u=document.getElementById("bedrooms-filter"))==null?void 0:u.value)||"",s=((g=document.getElementById("parking-filter"))==null?void 0:g.value)||"",l=((v=document.getElementById("construction-filter"))==null?void 0:v.value)||"",{min:d,max:c}=Sa(),r=n.filter(I=>{if(a&&I.city!==a||o&&I.neighborhood!==o||i&&(i==="4+"&&Number(I.bedrooms)<4||i!=="4+"&&Number(I.bedrooms)!==Number(i))||s&&(s==="4+"&&Number(I.parking)<4||s!=="4+"&&Number(I.parking)!==Number(s))||l&&I.construction_status!==l)return!1;const S=String(I.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(S,10)||0;return!(L<d||c!==1/0&&L>c)});if(e){$a(n);return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=Ft(t);t.innerHTML=r.map(I=>ft(I)).join(""),Xt(t,m);const p=document.getElementById("properties");p&&!p._carouselDelegated&&(p._carouselDelegated=!0,p.addEventListener("click",ut))}function ka(e){var o,i,s;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>ft(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",ut));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(s=a==null?void 0:a.querySelector(".selecao-next"))==null||s.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ce()};function Vt(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const s=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(s.length&&s[a]){const l=Ae(s[a]),d=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");d&&(d.src=l),c&&(c.src=l)}}catch{const l=C.find(p=>String(p.id)===String(e.dataset.pid)),d=(i=l==null?void 0:l.images)!=null&&i.length?l.images:Ie,c=e.querySelector(".carousel-img"),r=e.querySelector(".carousel-img-bg"),m=d[a]?Ae(d[a]):"";c&&m&&(c.src=m),r&&m&&(r.src=m)}const o=e.querySelectorAll(".icard-dot");if(o.length){const s=a%o.length;o.forEach((l,d)=>l.classList.toggle("active",d===s))}}function ut(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&Vt(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Sa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function La(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ce())}function Ba(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ge();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ge().find(i=>i.name===e.value),o=a?vt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${f(i.name)}</option>`).join(""),ce()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ce)})}function Me(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var s;const a=n.cover_image||((s=n.images)==null?void 0:s[0])||Ie[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
      ...
      <td class="cell-price">${f(Ne(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
...
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",r=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",m=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",p=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",h=Math.max(1,Math.min(a,6)),E=`<div class="icard-dots">${Array.from({length:h},(u,g)=>`<span class="icard-dot${g===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ${(()=>{const u=e.furnishing_status||(e.furnished===!0?"mobiliado":"");return u==="mobiliado"?'<span class="icard-badge badge-furn-mob">Mobiliado</span>':u==="semimobiliado"?'<span class="icard-badge badge-furn-semi">Semimobiliado</span>':u==="vazio"?'<span class="icard-badge badge-furn-vazio">Vazio</span>':""})()}
  ...
  `}let ie=[],K=0;function Ta(e){var m,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||Ie[0];document.getElementById("view-thumb-preview").src=i,ie=(p=e.images)!=null&&p.length?e.images:Ie,K=0,Ve(),document.getElementById("view-price").textContent=Ne(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(h=>h.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(h=>h.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=d);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Re(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ve(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ie[K],e.alt=`Foto ${K+1}`;const i=ie.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${K+1} / ${ie.length}`:"",o.innerHTML=i?ie.map((s,l)=>`<img src="${s}" class="view-thumb${l===K?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(s=>{s.addEventListener("click",()=>{K=+s.dataset.i,Ve()})})}async function kt(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ge(e){var m,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",s=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=s),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),d&&(d.textContent=s),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",r.style.display=""),c&&(c.style.display="none"))}async function St(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==F,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:s}=await b.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),d=((s==null?void 0:s.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();d&&d!==l&&(t.href=`https://${d}`)}catch{}}const je={dashboard:()=>fn(),empresa:()=>ea(),visual:()=>ta(),"site-config":()=>aa(),"crm-config":()=>na(),integracoes:()=>oa(),midia:()=>ia(),depoimentos:()=>Zt()};function ae(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof je<"u"&&je[e]){const o=je[e];je[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),Z(),e==="contatos"&&Xa(),e==="funil"&&Na(),e==="tarefas"&&Ra()}function Lt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ea,visual:ta,"site-config":aa,"crm-config":na,integracoes:oa,midia:ia,depoimentos:Zt}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>Za(),{once:!0}),window.lucide&&lucide.createIcons()}}function Z(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Ma(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(s=document.getElementById("cph-close"))==null||s.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",r=>{r.target===t&&o()}),(d=document.getElementById("cph-file"))==null||d.addEventListener("change",r=>{const m=r.target.files[0];if(!m)return;const p=URL.createObjectURL(m),h=document.getElementById("cph-preview"),E=document.getElementById("cph-initial");h&&(h.src=p,h.style.display=""),E&&(E.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var h;const r=(h=document.getElementById("cph-file"))==null?void 0:h.files[0];if(!r)return;const m=document.getElementById("cph-save"),p=document.getElementById("cph-msg");m.disabled=!0,m.textContent="Salvando…";try{const E=await De(r,400,.85),x=`avatars/${y.id}-${Date.now()}.jpg`,{error:u}=await b.storage.from("imoveis").upload(x,E,{contentType:"image/jpeg",upsert:!0});if(u)throw u;const{data:{publicUrl:g}}=b.storage.from("imoveis").getPublicUrl(x);await b.from("profiles").update({avatar_url:g}).eq("id",y.id),y={...y,avatar_url:g},Ge(y),o()}catch(E){p.style.color="#ef4444",p.textContent="Erro: "+E.message,p.style.display="",m.disabled=!1,m.textContent="Salvar Foto"}})}function ot(e,t){var i,s,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(s=document.getElementById("ac-cancel"))==null||s.addEventListener("click",o),a.addEventListener("click",d=>{d.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var p,h,E;const d=(p=document.getElementById("ac-email"))==null?void 0:p.value.trim(),c=(h=document.getElementById("ac-password"))==null?void 0:h.value.trim(),r=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!d){alert("Informe o e-mail do corretor.");return}if(!c||c.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}r.disabled=!0,r.textContent="Criando…",m.style.display="none";try{const x=e||(y==null?void 0:y.tenant_id)||null,u=((E=document.getElementById("ac-role"))==null?void 0:E.value)||"corretor",g=await ue({email:d,password:c,role:u,tenant_id:x});r.disabled=!1,r.textContent="+ Criar Acesso",g.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",g.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${f(d)}<br><strong>Senha:</strong> ${f(c)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(g.error||"Falha desconhecida"))}catch(x){r.disabled=!1,r.textContent="+ Criar Acesso",alert("Erro: "+x.message)}})}function Bt(){var i,s,l,d,c,r,m,p,h,E,x;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",u=>{var v;u.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(v=document.getElementById("notif-dropdown"))==null||v.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",u=>{u.stopPropagation(),Z(),za()}),(s=document.getElementById("avatar-dd-change-pass"))==null||s.addEventListener("click",u=>{u.stopPropagation(),Z(),Ma()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",u=>{u.stopPropagation(),Z(),ot()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",u=>{u.stopPropagation(),Z(),ae("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async u=>{u.stopPropagation(),await b.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",u=>{var v;u.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((v=document.getElementById("avatar-dropdown"))==null||v.classList.add("hidden"),Ha())}),(r=document.getElementById("notif-mark-all"))==null||r.addEventListener("click",()=>{Pa(),Z()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var u,g;(u=document.getElementById("search-overlay"))==null||u.classList.remove("hidden"),(g=document.getElementById("search-input"))==null||g.focus()}),(p=document.getElementById("search-overlay-close"))==null||p.addEventListener("click",()=>{var u;(u=document.getElementById("search-overlay"))==null||u.classList.add("hidden")}),(h=document.getElementById("search-overlay"))==null||h.addEventListener("click",u=>{u.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(E=document.getElementById("search-input"))==null||E.addEventListener("input",u=>{clearTimeout(o),o=setTimeout(()=>Oa(u.target.value.trim()),280)}),(x=document.getElementById("search-input"))==null||x.addEventListener("keydown",u=>{var g;u.key==="Escape"&&((g=document.getElementById("search-overlay"))==null||g.classList.add("hidden"))}),document.addEventListener("click",Z)}let it=!1,J=[],Je=[],We=[],me={},Gt=[],Q=null,Be=null,G={search:"",tags:new Set,status:""};async function Na(){var t;if(it){await _t();return}it=!0,await _t(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>dt()),dn();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{Q=parseInt(e.value,10),await Ye()})}function st(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+Gt.map(s=>`<option value="${f(s.name)}">${f(s.name)}</option>`).join(""),n.value=G.status,n.onchange=()=>{G.status=n.value,be()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(s=>`<button class="kf-tag-btn${G.tags.has(s.name)?" active":""}" data-tag="${f(s.name)}"
          style="--kf-tc:${s.color}">
          ${f(s.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(s=>{s.addEventListener("click",()=>{const l=s.dataset.tag;G.tags.has(l)?G.tags.delete(l):G.tags.add(l),st(e),be()})})}const o=document.getElementById("kf-search");o&&(o.value=G.search,o.oninput=()=>{G.search=o.value.toLowerCase(),be()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{G={search:"",tags:new Set,status:""},st(e),be()})}async function _t(){const e=z(),[{data:t},{data:n},{data:a}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",e).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);J=t||[],Gt=a||[],me={},(n||[]).forEach(l=>{me[l.name]=l});const o=J.map(l=>l.id),{data:i}=o.length?await b.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};Je=i||[],st(n||[]);const s=document.getElementById("funil-pipe-sel");if(s){const l=Q;s.innerHTML=J.length?J.map(c=>`<option value="${c.id}">${f(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const d=J.find(c=>c.id===l)||J.find(c=>c.is_default)||J[0];d?(s.value=d.id,Q=d.id):Q=null}await Ye()}async function Ye(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),Q&&(t=t.eq("pipeline_id",Q));const{data:n}=await t;We=n||[],be()}function be(){const e=document.getElementById("kanban-board");if(!e)return;const t=Je.filter(i=>i.pipeline_id===Q);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=G,a=We.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const s=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>s.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,d,c,r;const s=i.stage||((l=t[0])==null?void 0:l.name);o[s]||(o[((d=t[0])==null?void 0:d.name)||""]=[]),(r=o[s]||o[(c=t[0])==null?void 0:c.name])==null||r.push(i)}),e.innerHTML=t.map(i=>{const s=o[i.name]||[],l=s.length?s.map(d=>{const c=(d.phone||"").replace(/\D/g,""),r=encodeURIComponent(`Olá ${d.name}! Aqui é da ${W("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
        <div class="kanban-card" draggable="true" data-id="${d.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:4px;">
            <div class="kanban-card-name" style="flex:1;">${f(d.name||"—")}</div>
          ...
          ${d.phone?`<div class="kanban-card-info">📞 ${f(d.phone)}</div>`:""}
          ${d.email?`<div class="kanban-card-info" style="font-size:11px;color:#94a3b8;">✉ ${f(d.email)}</div>`:""}
          ${d.notes?`<div class="kanban-card-info" style="font-size:11px;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:200px;">📝 ${f(d.notes)}</div>`:""}
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ${d.source?`<span class="kanban-card-tag">${f(d.source)}</span>`:""}
            ${Array.isArray(d.tags)?d.tags.map(m=>{const p=me[m],h=(p==null?void 0:p.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${h}18;color:${h};border:1px solid ${h}44;">${f(m)}</span>`}).join(""):""}
          </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(g=>{const I=(me[g]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(g)}" style="background:${I}18;color:${I};border-color:${I}55;">${f(g)}<span class="ldp-tag-rm" data-tag="${f(g)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform="translateX(0)"}),gn(r,a||[],me);const m=r.querySelector("#ldp-pipe"),p=r.querySelector("#ldp-stage");m&&p&&m.addEventListener("change",()=>{const g=m.value,v=Je.filter(I=>I.pipeline_id===g);p.innerHTML=v.map(I=>`<option value="${I.name}">${I.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const h=()=>{r.style.transform="translateX(100%)",setTimeout(()=>r.remove(),250)};document.getElementById("ldp-close").addEventListener("click",h),document.getElementById("ldp-save").addEventListener("click",async()=>{var A,_;const g=document.getElementById("ldp-save"),v=document.getElementById("ldp-msg"),I=document.getElementById("ldp-name").value.trim();if(!I){v.style.color="#ef4444",v.textContent="Nome é obrigatório.";return}g.disabled=!0,g.textContent="Salvando…";const S=[...r.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(q=>q.dataset.tag),L=document.getElementById("ldp-pipe"),k=L?L.value:i||Q,w=t?typeof $t=="function"?$t():{}:{},$={name:I,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:k||null,stage:((A=document.getElementById("ldp-stage"))==null?void 0:A.value)||null,status:((_=document.getElementById("ldp-status"))==null?void 0:_.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:S,tenant_id:z(),...t?{utm_source:w.utm_source||null,utm_medium:w.utm_medium||null,utm_campaign:w.utm_campaign||null,utm_content:w.utm_content||null,utm_term:w.utm_term||null,fbclid:w.fbclid||null,gclid:w.gclid||null,fbp:w.fbp||null,fbc:w.fbc||null,landing_url:w.landing_url||null,user_agent:navigator.userAgent||null}:{}};let B;if(t?{error:B}=await b.from("leads").insert($):{error:B}=await b.from("leads").update($).eq("id",e.id),g.disabled=!1,g.textContent="💾 Salvar",B){v.style.color="#ef4444",v.textContent="Erro: "+B.message;return}v.style.color="#22c55e",v.textContent="✅ Salvo!",t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:$.name,email:$.email,phone:$.phone,tracking:w}).then(async q=>{if(q!=null&&q.ok){console.log("[CAPI] Lead enviado ao Meta:",q.event_id);try{await b.from("leads").update({capi_event_id:q.event_id,capi_sent_at:new Date().toISOString()}).eq("name",$.name).eq("phone",$.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(T){console.warn("[CAPI] falha ao salvar event_id:",T)}}else console.warn("[CAPI] não confirmado pelo Meta:",q)}).catch(q=>console.warn("[CAPI] erro:",q)),setTimeout(()=>{h(),Ye()},700)}),(u=document.getElementById("ldp-delete"))==null||u.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await b.from("leads").delete().eq("id",e.id),h(),Ye())})}let R=[],Ct=!1,he="pending";async function Ra(){var e;Ct||(Ct=!0,await ja(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Wt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),he=t.dataset.filter,$e()})}))}async function ja(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=b.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(s);const l=()=>s.remove();(d=document.getElementById("tm-close"))==null||d.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),s.addEventListener("click",p=>{p.target===s&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const p=a?"pending":"done";await b.from("tasks").update({status:p}).eq("id",e.id);const h=R.find(E=>String(E.id)===String(e.id));h&&(h.status=p),l(),p==="done"&&(he="done",document.querySelectorAll(".tarefa-filter-btn").forEach(E=>{E.classList.toggle("active",E.dataset.filter==="done")})),$e()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var g,v;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const h=new FormData(p),E=document.getElementById("tm-save");E.disabled=!0,E.textContent="Salvando…";const x={title:(g=h.get("title"))==null?void 0:g.trim(),description:((v=h.get("description"))==null?void 0:v.trim())||null,due_date:h.get("due_date")||null,priority:h.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null};let u;if(n){if({error:u}=await b.from("tasks").update(x).eq("id",e.id),!u){const I=R.findIndex(S=>String(S.id)===String(e.id));I>=0&&(R[I]={...R[I],...x})}}else{const{data:I,error:S}=await b.from("tasks").insert(x).select();u=S,!u&&(I!=null&&I[0])&&R.unshift(I[0])}if(E.disabled=!1,E.textContent=n?"Salvar":"Criar Tarefa",u){alert("Erro: "+u.message);return}l(),$e()})}async function Oa(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(s=>`
      <div class="search-result-item" data-type="property" data-id="${s.id}">
        <div class="search-result-icon">🏠</div>
        <div>
          <div class="search-result-title">${f(s.title||"—")}</div>
          <div class="search-result-sub">${f(s.reference||"")} · ${f(s.city||"")}</div>
        </div>
      ...
      <div class="search-result-item" data-type="lead" data-id="${s.id}">
        <div class="search-result-icon">👤</div>
        <div>
          <div class="search-result-title">${f(s.name||"—")}</div>
          <div class="search-result-sub">${f(s.email||s.phone||"")}</div>
        </div>
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(s=>{s.addEventListener("click",()=>{var l;(l=document.getElementById("search-overlay"))==null||l.classList.add("hidden"),s.dataset.type==="lead"?ae("contatos"):ae("properties")})})}let te=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function Ha(){var s;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=b.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(l=>!te.includes(String(l.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(l=>{const d=Ua(l.created_at);return`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(s=document.getElementById("notif-see-all"))==null||s.addEventListener("click",l=>{l.preventDefault(),Z(),ae("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{te.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(te)),l.classList.remove("unread"),Z(),ae("contatos")})})}function Pa(){var e;document.querySelectorAll(".notif-item").forEach(t=>te.push(t.dataset.id)),te=[...new Set(te)],localStorage.setItem("crm_notifs_read",JSON.stringify(te)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Ua(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Fa(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!te.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let Y=[],D=1;const _e=10;let qt=!1;async function Xa(){var t,n,a,o,i,s,l,d,c;document.getElementById("section-contatos")&&(qt||(qt=!0,await Yt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{D=1,pe()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(D=1,pe())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>Kt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Ja),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",rt),(s=document.getElementById("import-modal-cancel"))==null||s.addEventListener("click",rt),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),h=document.createElement("a");h.href=URL.createObjectURL(p),h.download="modelo_contatos.csv",h.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",Va),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Ga)))}async function Yt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;Y=a||[],pe()}function pe(){var l,d,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Y.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):Y,n=t.length,a=Math.max(1,Math.ceil(n/_e));D>a&&(D=a);const o=t.slice((D-1)*_e,D*_e),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
        <td><input type="checkbox" class="contato-check" data-id="${r.id}"></td>
        <td>
          <a href="#" class="contato-name-link" data-id="${r.id}" style="color:#2563eb;font-weight:500;text-decoration:none;">${f(r.name||"—")}</a>
        </td>
        <td>${f(r.company||"")}</td>
        <td style="color:#64748b;font-size:13px;">${r.email?f(r.email):"—"}</td>
        <td style="font-size:13px;">${r.phone?f(r.phone):"—"}</td>
        <td style="font-size:13px;color:#64748b;">${f(r.job_title||"")}</td>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const m=(r.phone||"").replace(/\D/g,"");if(!m)return"";const p=encodeURIComponent(`Olá ${(r.name||"").split(" ")[0]}! Aqui é da ${W("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${m}?text=${p}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const s=document.getElementById("contatos-pagination");if(s){const r=n===0?0:(D-1)*_e+1,m=Math.min(D*_e,n);s.innerHTML=`
    ...
    `,(d=s.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{D--,pe()}),(c=s.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{D++,pe()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",m=>{m.preventDefault();const p=r.dataset.id,h=Y.find(E=>String(E.id)===String(p));h&&Kt(h)})})}async function Kt(e=null){var g,v,I,S,L,k;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:s}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",a).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],d=i||[],c=s||[],r=l.map(w=>w.id),{data:m}=r.length?await b.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},p=m||[],h=(e==null?void 0:e.pipeline_id)||((g=l[0])==null?void 0:g.id)||"";function E(w){const $=p.filter(B=>B.pipeline_id===w);return $.length?'<option value="">— Selecionar etapa —</option>'+$.map(B=>`<option value="${f(B.name)}" ${(e==null?void 0:e.stage)===B.name?"selected":""}>${f(B.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const x=document.createElement("div");x.id="contato-modal-root",x.className="modal-backdrop",x.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${l.map(w=>`<option value="${w.id}" ${String(e==null?void 0:e.pipeline_id)===String(w.id)?"selected":""}>${f(w.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
          ...
          <div class="form-row single">
            <div class="form-group">
              ...
              <select name="status" class="form-control">
                <option value="">— Sem status —</option>
                ${c.map(w=>`<option value="${f(w.name)}" ${(e==null?void 0:e.status)===w.name?"selected":""}>${f(w.name)}</option>`).join("")}
              </select>
            </div>
          </div>`:""}
              ...
              <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px;">
                ${d.map(w=>`
                  <label style="display:flex;align-items:center;gap:5px;cursor:pointer;padding:5px 12px;border-radius:20px;background:${w.color}18;border:1.5px solid ${w.color}55;font-size:12px;font-weight:600;color:${w.color};transition:opacity .15s;">
                    <input type="checkbox" name="tag" value="${f(w.name)}" style="margin:0;accent-color:${w.color};" ${((e==null?void 0:e.tags)||[]).includes(w.name)?"checked":""}>
                    ${f(w.name)}
                  </label>`).join("")}
              </div>
            </div>
  ...
  `,document.body.appendChild(x);const u=()=>x.remove();(v=document.getElementById("cm-close"))==null||v.addEventListener("click",u),(I=document.getElementById("cm-cancel"))==null||I.addEventListener("click",u),x.addEventListener("click",w=>{w.target===x&&u()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",w=>{const $=document.getElementById("cm-stage");$&&($.innerHTML=E(w.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await b.from("leads").delete().eq("id",e.id);const w=Y.findIndex($=>String($.id)===String(e.id));w>=0&&Y.splice(w,1),u(),pe()}),(k=document.getElementById("cm-save"))==null||k.addEventListener("click",async()=>{var V,O,H,ne,re,ke,Se;const w=document.getElementById("contato-form");if(!w.checkValidity()){w.reportValidity();return}const $=new FormData(w),B=document.getElementById("cm-save");B.disabled=!0,B.textContent="Salvando…";const A=$.getAll("tag"),_=$.get("pipeline_id")||null,q={name:(V=$.get("name"))==null?void 0:V.trim(),company:((O=$.get("company"))==null?void 0:O.trim())||null,email:((H=$.get("email"))==null?void 0:H.trim())||null,phone:((ne=$.get("phone"))==null?void 0:ne.trim())||null,job_title:((re=$.get("job_title"))==null?void 0:re.trim())||null,city_interest:((ke=$.get("city_interest"))==null?void 0:ke.trim())||null,notes:((Se=$.get("notes"))==null?void 0:Se.trim())||null,pipeline_id:_,stage:$.get("stage")||null,status:$.get("status")||null,tags:A,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let T;if(n){if({error:T}=await b.from("leads").update(q).eq("id",e.id),!T){const P=Y.findIndex(ve=>String(ve.id)===String(e.id));P>=0&&(Y[P]={...Y[P],...q})}}else{const{data:P,error:ve}=await b.from("leads").insert(q).select();T=ve,!T&&(P!=null&&P[0])&&Y.unshift(P[0])}if(B.disabled=!1,B.textContent=n?"Salvar":"Criar Contato",T){alert("Erro: "+T.message);return}u(),pe()})}let we=[];function Va(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{we=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[d,c,r,m,p]=l.split(",").map(h=>h.trim().replace(/^"|"$/g,""));return{name:d,email:c,phone:r,company:m,job_title:p}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${we.length} contato(s) encontrados para importar.`);const s=document.getElementById("import-modal-confirm");s&&(s.disabled=we.length===0)},n.readAsText(t)}async function Ga(){if(!we.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=we.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}rt(),await Yt(),alert(`${t.length} contato(s) importados com sucesso!`)}function Ja(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),we=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function rt(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Wa="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ue(e){return(await fetch(Wa,{method:"POST",headers:{Authorization:`Bearer ${ga}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function At(e){var d,c,r,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),s=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:p}}=await b.auth.getUser();n.value=(p==null?void 0:p.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",p=>{const h=p.target.files[0];if(!h)return;const E=URL.createObjectURL(h);a&&(a.src=E,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var g,v;const p=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",h=((v=document.getElementById("change-password-confirm"))==null?void 0:v.value)||"",E=document.getElementById("change-password-msg"),x=document.getElementById("btn-change-password");if(E&&(E.style.display="none"),p.length<6){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}if(p!==h){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}x&&(x.disabled=!0,x.textContent="Salvando…");const{error:u}=await b.auth.updateUser({password:p});x&&(x.disabled=!1,x.textContent="Salvar Nova Senha"),u?E&&(E.textContent="Erro: "+u.message,E.style.display=""):(E&&(E.style.color="#16a34a",E.textContent="Senha alterada com sucesso!",E.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),s==null||s.addEventListener("click",async()=>{var v;const p=t.value.trim();let h=(y==null?void 0:y.avatar_url)||"";const E=i==null?void 0:i.files[0],x=s.textContent;if(s.disabled=!0,s.textContent="Salvando…",E)try{const I=await De(E,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:L}=await b.storage.from("imoveis").upload(S,I,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:k}}=b.storage.from("imoveis").getPublicUrl(S);h=k}}catch(I){console.error("Avatar upload:",I)}const{error:u}=await b.from("profiles").update({name:p,avatar_url:h}).eq("id",y.id);if(s.disabled=!1,s.textContent=x,u){alert("Erro ao salvar perfil.");return}y={...y,name:p,avatar_url:h},Ge(y);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=((v=p[0])==null?void 0:v.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const p=document.getElementById("settings-corretores-section");p&&(p.style.display=""),await Ke(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var v,I;const E=(v=document.getElementById("invite-email"))==null?void 0:v.value.trim(),x=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),u=document.getElementById("btn-invite-corretor"),g=document.getElementById("invite-note");if(!E){alert("Informe o e-mail do corretor.");return}if(!x||x.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}u&&(u.disabled=!0,u.textContent="Criando…"),g&&(g.style.display="none");try{const S=await ue({email:E,password:x,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const L=document.getElementById("invite-email"),k=document.getElementById("invite-password");L&&(L.value=""),k&&(k.value=""),await Ke(),g&&(S.email_sent===!1?(g.innerHTML=`
                ✅ Acesso criado!
                <span style="color:#ef4444;">⚠️ E-mail não enviado automaticamente.</span><br>
                Compartilhe manualmente:<br>
                <strong>E-mail:</strong> ${f(E)}<br>
                <strong>Senha:</strong> ${f(x)}`,g.style.color="#0f172a"):(g.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",g.style.color="#16a34a"),g.style.display="")}else alert("Erro: "+(S.error||"Falha desconhecida"))}catch(S){alert("Erro ao criar acesso: "+S.message)}finally{u&&(u.disabled=!1,u.textContent="+ Criar Acesso")}});const h=document.getElementById("settings-locations-section");h&&(h.style.display=""),await qe(),(r=document.getElementById("loc-add-city-btn"))==null||r.addEventListener("click",async()=>{const E=document.getElementById("loc-new-city"),x=E==null?void 0:E.value.trim();if(!x)return;const{error:u}=await b.from("locations").insert({type:"cidade",name:x});if(u){alert("Erro ao adicionar cidade.");return}E&&(E.value=""),await qe(),yt()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var v;const E=parseInt((v=document.getElementById("loc-new-neighborhood-city"))==null?void 0:v.value,10),x=document.getElementById("loc-new-neighborhood"),u=x==null?void 0:x.value.trim();if(!E||!u){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:g}=await b.from("locations").insert({type:"bairro",name:u,parent_id:E});if(g){alert("Erro ao adicionar bairro.");return}x&&(x.value=""),await qe()})}}async function Ke(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),s=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${f(i)}</div>`,l=o.id===(y==null?void 0:y.id),d=o.active!==!1,c=d?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',r=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            <div>
              ...
              ${s?`<div class="loc-item-sub">${f(s.name)}</div>`:""}
            </div>
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${f(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const s=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${s}" e todos os bairros vinculados?`))return;const{error:l}=await b.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await qe(),yt()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:s}=await b.from("locations").delete().eq("id",i.dataset.id);if(s){alert("Erro ao excluir.");return}await qe()})})}function Tt(){var n,a,o,i,s,l,d,c,r,m,p,h,E,x,u,g,v,I,S,L;document.querySelectorAll(".filter-btn").forEach(k=>{k.addEventListener("click",()=>{const w=k.closest(".filter-btns"),$=k.classList.contains("active");w.querySelectorAll(".filter-btn").forEach(B=>B.classList.remove("active")),$||k.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var A;const k=(A=document.getElementById("f-city"))==null?void 0:A.value,w=ge().find(_=>_.name===k),$=w?vt(w.id):[],B=document.getElementById("f-neighborhood");B&&(B.innerHTML='<option value="">Todos</option>'+$.map(_=>`<option value="${_.name}">${f(_.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Me(gt(C))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const k=document.querySelector(".admin-filter-panel");if(k){k.querySelectorAll('input[type="text"], input[type="number"]').forEach($=>{$.value=""}),k.querySelectorAll("select").forEach($=>{$.selectedIndex=0});const w=document.getElementById("f-neighborhood");w&&(w.innerHTML='<option value="">Todos</option>'),k.querySelectorAll(".filter-btn.active").forEach($=>$.classList.remove("active"))}Me(C)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{ae(k.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{ae(k.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(k=>{k.addEventListener("click",w=>{w.stopPropagation();const $=k.closest(".topnav-dropdown");$==null||$.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(B=>{B!==$&&B.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(k=>k.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Pe),(s=document.getElementById("modal-cancel"))==null||s.addEventListener("click",Pe),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",k=>{k.target.id==="property-modal"&&Pe()}),(d=document.getElementById("btn-new-property"))==null||d.addEventListener("click",()=>{U=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",ee="",ze([]),nt("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await b.auth.signOut(),location.reload()}),(r=document.getElementById("view-prev"))==null||r.addEventListener("click",()=>{K=(K-1+ie.length)%ie.length,Ve()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{K=(K+1)%ie.length,Ve()}),(p=document.getElementById("view-modal-close"))==null||p.addEventListener("click",Re),(h=document.getElementById("view-modal-close2"))==null||h.addEventListener("click",Re),(E=document.getElementById("view-modal"))==null||E.addEventListener("click",k=>{k.target.id==="view-modal"&&Re()}),(x=document.getElementById("view-modal-share"))==null||x.addEventListener("click",()=>{const k=document.getElementById("share-panel");if(!k)return;const w=k.style.display!=="none";k.style.display=w?"none":"block"}),(u=document.getElementById("share-whatsapp"))==null||u.addEventListener("click",()=>{var O,H,ne;const k=(O=document.getElementById("share-link-input"))==null?void 0:O.value;if(!k)return;const w=Number((H=document.getElementById("share-panel"))==null?void 0:H.dataset.pid),$=C.find(re=>re.id===w),B=($==null?void 0:$.title)||((ne=document.getElementById("view-modal-title"))==null?void 0:ne.textContent)||"Imóvel",A=$!=null&&$.price?` — ${Ne($.price,"pt")}`:"",_=$!=null&&$.reference?` | Ref: ${$.reference}`:"",q=[$==null?void 0:$.neighborhood,$==null?void 0:$.city].filter(Boolean).join(", "),T=q?`
📍 ${q}`:"",V=encodeURIComponent(`Olha esse imóvel que encontrei: *${B}*${A}${_}${T}

${k}`);window.open("https://wa.me/?text="+V,"_blank")}),(g=document.getElementById("share-instagram"))==null||g.addEventListener("click",()=>{var w,$;const k=(w=document.getElementById("share-link-input"))==null?void 0:w.value;k&&(($=navigator.clipboard)==null||$.writeText(k),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(v=document.getElementById("share-email"))==null||v.addEventListener("click",()=>{var A,_;const k=(A=document.getElementById("share-link-input"))==null?void 0:A.value;if(!k)return;const w=((_=document.getElementById("view-modal-title"))==null?void 0:_.textContent)||"Imóvel",$=encodeURIComponent("Imóvel: "+w),B=encodeURIComponent(`Olá! Segue o link do imóvel:

`+k);window.open("mailto:?subject="+$+"&body="+B,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const k=document.getElementById("share-link-input");k&&((w=navigator.clipboard)==null||w.writeText(k.value).then(()=>{const $=document.getElementById("share-copy"),B=$.textContent;$.textContent="✅ Copiado!",setTimeout(()=>{$.textContent=B},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var q;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),w=C.find(T=>T.id===k);if(!w)return;Re(),U=w.id;const $=document.getElementById("property-form"),B=document.getElementById("form-submit-btn");B.textContent="Salvar Alterações",$.querySelector('[name="title"]').value=w.title||"",$.querySelector('[name="rua"]').value=w.rua||"",$.querySelector('[name="numero"]').value=w.numero||"",$.querySelector('[name="city"]').value=w.city||"",$.querySelector('[name="price"]').value=w.price||"",$.querySelector('[name="bedrooms"]').value=w.bedrooms||"",$.querySelector('[name="suites"]').value=w.suites||"",$.querySelector('[name="parking"]').value=w.parking||"",$.querySelector('[name="description"]').value=w.description||"",$.querySelector('[name="construction_status"]').value=w.construction_status||"",$.querySelector('[name="owner_name"]').value=w.owner_name||"",$.querySelector('[name="owner_phone"]').value=w.owner_phone||"",$.querySelector('[name="owner_email"]').value=w.owner_email||"",$.querySelector('[name="owner_notes"]').value=w.owner_notes||"",$.querySelector('[name="condominium"]').value=w.condominium||"";const A=document.getElementById("adminPublished");A&&(A.value=w.published===!0?"true":"false");const _=document.getElementById("adminCitySelect");_&&(_.value=w.city||"",_.dispatchEvent(new Event("change")),setTimeout(()=>{const T=document.getElementById("adminNeighborhood");T&&(T.value=w.neighborhood||"")},50)),ee=w.cover_image||((q=w.images)==null?void 0:q[0])||"",ze(w.images||[]),nt("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach($=>$.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach($=>$.classList.add("hidden")),(w=document.getElementById(`tab-${k.dataset.tab}`))==null||w.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const w=k.target.closest("tr");if(!w)return;const $=Number(w.dataset.id);if(!$)return;const B=C.find(A=>A.id===$);B&&Ta(B)})}async function Zt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",z()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(s){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let d=0;for(const c of s||"?")d=d*31+c.charCodeAt(0)&4294967295;return l[Math.abs(d)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let s=-1;function l(d=-1){s=d;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=d>=0?"Editar Depoimento":"Novo Depoimento";const r=d>=0?n[d]:{};e.querySelector("#dep-stars").value=String(r.stars||5),e.querySelector("#dep-text").value=r.text||"",e.querySelector("#dep-name").value=r.name||"",e.querySelector("#dep-role").value=r.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",s=-1}),e.addEventListener("click",d=>{const c=d.target.closest("[data-edit]"),r=d.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),r){const m=parseInt(r.dataset.del);confirm("Remover este depoimento?")&&(n.splice(m,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const d=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),r=e.querySelector("#dep-text").value.trim(),m=e.querySelector("#dep-name").value.trim(),p=e.querySelector("#dep-role").value.trim(),h=parseInt(e.querySelector("#dep-stars").value);if(!r||!m){alert("Preencha o depoimento e o nome.");return}d.disabled=!0,d.textContent="Salvando…";const E={stars:h,text:r,name:m,role:p};s>=0?n[s]=E:n.push(E);const x=await i();d.disabled=!1,d.textContent="Salvar",X(c,x),x&&(e.querySelector("#dep-form-wrap").style.display="none",s=-1,o())})}async function i(){const s=JSON.stringify(n);return await Oe("testimonials",{pt:s,en:s,es:s})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,d,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,m=He(r);if(m)ye(m);else{let p=null;for(const h of[t,"www."+t]){const{data:E}=await b.from("tenants").select("id").eq("domain",h).maybeSingle();if(E!=null&&E.id){p=E;break}}p!=null&&p.id&&(ye(p.id),at(r,p.id,24*60*60*1e3))}}await Promise.all([ua(),Qt()]),Ce=W("company.whatsapp",Ce),pt(),La(),Ba();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(yt(),n.addEventListener("change",()=>{const r=ge().find(p=>p.name===n.value),m=r?vt(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+m.map(p=>`<option value="${p.name}">${f(p.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),m=new URLSearchParams(window.location.search),p=r.get("type")||m.get("type")||"",h=Ht||p==="recovery"||p==="invite"||window.location.hash.includes("access_token")||m.has("code"),E=document.getElementById("password-reset-overlay");if(h){o.style.display="none",i&&i.classList.add("hidden"),E&&(E.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async u=>{var k,w;u.preventDefault();const g=((k=document.getElementById("new-password"))==null?void 0:k.value)||"",v=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",I=document.getElementById("password-reset-msg"),S=u.target.querySelector('button[type="submit"]');if(I&&(I.style.display="none"),g!==v){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:L}=await b.auth.updateUser({password:g});if(L){I&&(I.textContent="Erro: "+L.message,I.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}window.location.href=window.location.pathname}),m.has("code")&&await b.auth.exchangeCodeForSession(m.get("code")??"");return}const{data:{session:x}}=await b.auth.getSession();if(x){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),et(),Tt(),Bt(),window.lucide&&lucide.createIcons(),y=await kt(x.user.id),!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(y.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const u=document.getElementById("password-reset-overlay");u&&(u.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async g=>{var w,$;g.preventDefault();const v=((w=document.getElementById("new-password"))==null?void 0:w.value)||"",I=(($=document.getElementById("confirm-password"))==null?void 0:$.value)||"",S=document.getElementById("password-reset-msg"),L=g.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),v!==I){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}if(v.length<6){S&&(S.textContent="Mínimo 6 caracteres.",S.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:k}=await b.auth.updateUser({password:v});if(k){S&&(S.textContent="Erro: "+k.message,S.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",y.id),window.location.href=window.location.pathname});return}ye((y==null?void 0:y.tenant_id)||null),Ge(y),St(y),Lt(y.role),await Xe(),await At(y),window.lucide&&lucide.createIcons(),Fa(),ae("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const u=document.getElementById("login-form");u&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var I,S;const g=(S=(I=u.querySelector('input[name="email"]'))==null?void 0:I.value)==null?void 0:S.trim();if(!g){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:v}=await b.auth.resetPasswordForEmail(g,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(v?"Erro: "+v.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),u.addEventListener("submit",async g=>{g.preventDefault();const v=u.querySelector('button[type="submit"]'),I=new FormData(u),S=I.get("email"),L=I.get("password");v&&(v.disabled=!0,v.textContent="Entrando…");try{if(await Ea(S,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),et(),Tt(),window.lucide&&lucide.createIcons();const{data:{session:w}}=await b.auth.getSession();if(y=w?await kt(w.user.id):null,!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Bt(),ye((y==null?void 0:y.tenant_id)||null),Ge(y),St(y),Lt(y.role),await Xe(),await At(y),window.lucide&&lucide.createIcons(),ae("dashboard")}else alert("E-mail ou senha incorretos")}catch(k){alert("Erro ao fazer login: "+((k==null?void 0:k.message)||String(k)))}finally{v&&(v.disabled=!1,v.textContent="Entrar")}}))}}else et();await ce();const s=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Et(s),wt(Ce),window._applyDynamicContent=Et,window._applyWhatsAppLinks=wt,document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var p;const m=(p=r.closest(".nav-dropdown"))==null?void 0:p.querySelector(".nav-dropdown-menu");m&&r.addEventListener("click",h=>{h.stopPropagation(),m.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(E=>{E!==m&&E.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function Ya(){const e=C.filter(o=>!o.reference);if(!e.length)return;const t=C.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:s}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!s){const l=C.findIndex(d=>d.id===o.id);l>=0&&(C[l].reference=i),n++}}Me(gt(C))}async function Ka(){const e=C.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const s=await Qa(i);a.push(s),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=C.findIndex(s=>s.id===t.id);i>=0&&(C[i].images=a)}}Me(gt(C))}}async function Qa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,s=i?URL.createObjectURL(i):null;return new Promise(l=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),r=1200;let m=d.width,p=d.height;m>r&&(p=Math.round(p*r/m),m=r),c.width=m,c.height=p;const h=c.getContext("2d");h.drawImage(d,0,0,m,p);const E=x=>{if(x){const u=Math.round(m*.18),g=Math.round(x.naturalHeight*u/x.naturalWidth),v=Math.round(m*.02);h.globalAlpha=.45,h.drawImage(x,m-u-v,p-g-v,u,g),h.globalAlpha=1}c.toBlob(async u=>{try{const g=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:v}=await b.storage.from("imoveis").upload(g,u,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(v){console.error("Upload watermark error:",v),l(e);return}const{data:{publicUrl:I}}=b.storage.from("imoveis").getPublicUrl(g);l(I)}catch(g){console.error("Watermark upload exception:",g),l(e)}},"image/jpeg",.82)};if(s){const x=new Image;x.onload=()=>{URL.revokeObjectURL(s),E(x)},x.onerror=()=>{URL.revokeObjectURL(s),E(null)},x.src=s}else E(null)},d.onerror=()=>{URL.revokeObjectURL(a),l(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function X(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function bt(e,t="assets"){const n=await De(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function ea(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>f(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("co-logo-url").addEventListener("input",o=>{document.getElementById("co-logo-preview").src=o.target.value||"/logo.png"}),document.getElementById("co-logo-file").addEventListener("change",async o=>{const i=o.target.files[0];if(i)try{const s=await bt(i,"logos");document.getElementById("co-logo-url").value=s,document.getElementById("co-logo-preview").src=s}catch(s){alert("Erro no upload: "+s.message)}}),document.getElementById("co-save-identity").addEventListener("click",async()=>{const o=document.getElementById("co-save-identity");o.disabled=!0,o.textContent="Salvando…";const i=await Ee([["company.name",document.getElementById("co-name").value.trim()],["company.creci",document.getElementById("co-creci").value.trim()],["company.logo_url",document.getElementById("co-logo-url").value.trim()],["company.favicon_url",document.getElementById("co-favicon-url").value.trim()]]);i&&pt(),o.disabled=!1,o.textContent="Salvar Identidade",X(document.getElementById("co-identity-msg"),i)}),document.getElementById("co-save-contacts").addEventListener("click",async()=>{const o=document.getElementById("co-save-contacts");o.disabled=!0,o.textContent="Salvando…";const i=document.getElementById("co-whatsapp").value.trim(),s=await Ee([["company.whatsapp",i],["company.phone",document.getElementById("co-phone").value.trim()],["company.email",document.getElementById("co-email").value.trim()],["company.address",document.getElementById("co-address").value.trim()]]);s&&i&&(Ce=i),o.disabled=!1,o.textContent="Salvar Contatos",X(document.getElementById("co-contacts-msg"),s)}),document.getElementById("co-save-social").addEventListener("click",async()=>{const o=document.getElementById("co-save-social");o.disabled=!0,o.textContent="Salvando…";const i=await Ee([["company.instagram_url",document.getElementById("co-instagram").value.trim()],["company.facebook_url",document.getElementById("co-facebook").value.trim()],["company.youtube_url",document.getElementById("co-youtube").value.trim()],["company.tiktok_url",document.getElementById("co-tiktok").value.trim()],["company.linkedin_url",document.getElementById("co-linkedin").value.trim()]]);o.disabled=!1,o.textContent="Salvar Redes Sociais",X(document.getElementById("co-social-msg"),i)})}async function ta(){const e=document.getElementById("section-visual");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(r=>{n[r.key]=r.value||""});const a=n["visual.accent_color"]||"#b8962e",o=n["visual.primary_bg"]||"#0f1c2e",i=n["visual.secondary_bg"]||"#1a2f4a",s=n["visual.hero_bg_url"]||"",l=n["visual.price_max_slider"]||13e7;e.innerHTML=`
    ...
    <div class="cfg-card">
      ...
      <div class="form-group" style="margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px">
          <input id="vis-hero-url" class="form-control" value="${f(s)}" placeholder="https://... ou deixe vazio para padrão">
          <label class="btn-secondary" style="cursor:pointer;white-space:nowrap;padding:8px 14px;font-size:13px">
        ...
        <div id="vis-hero-preview" style="margin-top:10px;display:${s?"":"none"}">
          <img src="${f(s)}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">
        </div>
      </div>
      <div class="form-group" style="margin-bottom:0">
  ...
  `,await j())}async function j(){var E,x;const e=document.getElementById("crm-body");if(!e)return;const t=z(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",t).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),s=n||[],l=s.find(u=>u.is_default)||s[0],d=s.map(u=>`<option value="${u.id}"${u.id===(l==null?void 0:l.id)?" selected":""}>${f(u.name)}</option>`).join(""),c=(a||[]).filter(u=>u.pipeline_id===(l==null?void 0:l.id)),r=c.map((u,g)=>`
    <div class="stage-item stage-draggable" data-id="${u.id}" data-idx="${g}" draggable="true">
      ...
      <input type="text" class="stage-name-input" value="${f(u.name)}" data-sid="${u.id}" data-orig="${f(u.name)}" placeholder="Nome da etapa">
    ...
    <div class="stage-item" data-id="${u.id}">
      <div class="stage-color-dot" style="background:${u.color}"></div>
      <span class="stage-name">${f(u.name)}</span>
    ...
    <div class="cfg-card">
      ...
      <div class="tm-list" id="crm-tags-list">
        ...
        <div class="tm-row" data-id="${u.id}">
          ...
          <input class="tm-name-input form-control" type="text" value="${f(u.name)}" data-id="${u.id}" data-orig="${f(u.name)}" placeholder="Nome da tag">
      ...
      <div class="tm-templates">
        ...
        <div class="tm-tpl-grid" id="tm-tpl-grid">
          ${[{name:"🔴 Quente",color:"#EF4444"},{name:"🟡 Morno",color:"#F59E0B"},{name:"🔵 Frio",color:"#3B82F6"},{name:"💰 Investidor",color:"#8B5CF6"},{name:"⭐ Alto Padrão",color:"#C9A227"},{name:"🏦 Financiamento",color:"#0EA5E9"},{name:"🔄 Permuta",color:"#374151"},{name:"🏠 Comprador",color:"#10B981"},{name:"📋 Proprietário",color:"#F97316"}].filter(u=>!(o||[]).some(g=>g.name===u.name)).map(u=>`<button class="tm-tpl-btn" data-name="${f(u.name)}" data-color="${u.color}" style="border-color:${u.color};color:${u.color};background:${u.color}15;">${f(u.name)}</button>`).join("")}
        </div>
      </div>
    </div>
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,v=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await b.from("crm_stages").insert({pipeline_id:v,name:u,color:g,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-stage").value="",await j())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await b.from("crm_stages").delete().eq("id",u.dataset.id),await j())})}),e.querySelectorAll(".stage-name-input").forEach(u=>{u.addEventListener("blur",async()=>{const g=u.value.trim(),v=u.dataset.orig;if(!g||g===v){u.value=v;return}await b.from("crm_stages").update({name:g}).eq("id",u.dataset.sid),u.dataset.orig=g}),u.addEventListener("keydown",g=>{g.key==="Enter"&&(g.preventDefault(),u.blur()),g.key==="Escape"&&(u.value=u.dataset.orig,u.blur())})}),document.getElementById("crm-stages-list");let p=null;e.querySelectorAll(".stage-draggable").forEach(u=>{u.addEventListener("dragstart",g=>{p=u,u.classList.add("stage-dragging"),g.dataTransfer.effectAllowed="move";try{g.dataTransfer.setData("text/plain",u.dataset.id)}catch{}}),u.addEventListener("dragend",()=>{u.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(g=>g.classList.remove("stage-drop-over"))}),u.addEventListener("dragover",g=>{g.preventDefault(),g.dataTransfer.dropEffect="move",u!==p&&(e.querySelectorAll(".stage-drop-over").forEach(v=>v.classList.remove("stage-drop-over")),u.classList.add("stage-drop-over"))}),u.addEventListener("dragleave",()=>{u.classList.remove("stage-drop-over")}),u.addEventListener("drop",async g=>{if(g.preventDefault(),!p||u===p)return;const v=p.dataset.id,I=u.dataset.id,S=c.findIndex($=>String($.id)===String(v)),L=c.findIndex($=>String($.id)===String(I));if(S<0||L<0)return;const k=c.splice(S,1)[0];c.splice(L,0,k);const w=c.map(($,B)=>b.from("crm_stages").update({sort_order:B}).eq("id",$.id));p=null,await Promise.all(w).catch($=>console.warn("[stages] erro reordenar:",$)),await j()})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async g=>{await b.from("crm_stages").update({color:g.target.value}).eq("id",u.dataset.sid);const v=u.closest(".stage-item").querySelector(".stage-color-dot");v&&(v.style.background=g.target.value)})});const h=async()=>{const u=document.getElementById("crm-new-tag"),g=document.getElementById("crm-new-tag-color"),v=u==null?void 0:u.value.trim(),I=(g==null?void 0:g.value)||"#6366F1";if(!v){u==null||u.focus();return}await b.from("crm_tags").insert({name:v,color:I,tenant_id:z()}),u&&(u.value=""),await j()};(E=document.getElementById("crm-add-tag"))==null||E.addEventListener("click",h),(x=document.getElementById("crm-new-tag"))==null||x.addEventListener("keydown",u=>{u.key==="Enter"&&h()}),e.querySelectorAll(".tm-del-btn").forEach(u=>{u.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await b.from("crm_tags").delete().eq("id",u.dataset.id),await j())})}),e.querySelectorAll(".tm-name-input").forEach(u=>{const g=u.closest(".tm-row"),v=g==null?void 0:g.querySelector(".tm-save-btn");v&&(v.style.display="none"),u.addEventListener("input",()=>{const I=u.value.trim()!==u.dataset.orig;v&&(v.style.display=I?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(u=>{const g=u.closest(".tm-row"),v=g==null?void 0:g.querySelector(".tm-color-swatch"),I=g==null?void 0:g.querySelector(".tm-save-btn");u.addEventListener("input",S=>{v&&(v.style.background=S.target.value),I&&(I.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(u=>{u.style.display="none",u.addEventListener("click",async()=>{var S,L;const g=u.closest(".tm-row"),v=(S=g.querySelector(".tm-name-input"))==null?void 0:S.value.trim(),I=(L=g.querySelector(".tm-color-input"))==null?void 0:L.value;v&&(u.disabled=!0,u.textContent="✓ Salvando…",await b.from("crm_tags").update({name:v,color:I}).eq("id",u.dataset.id),await j())})}),e.querySelectorAll(".tm-tpl-btn").forEach(u=>{u.addEventListener("click",async()=>{const g=u.dataset.name,v=u.dataset.color;u.disabled=!0,u.innerHTML="✓",await b.from("crm_tags").insert({name:g,color:v,tenant_id:z()}),await j()})}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await b.from("crm_tags").delete().eq("id",u.dataset.id),await j()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,v=document.getElementById("crm-new-status-final").checked;u&&(await b.from("crm_lead_statuses").insert({name:u,color:g,is_final:v,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-status").value="",await j())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await b.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await j())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var v;const u=(v=prompt("Nome do novo funil:"))==null?void 0:v.trim();if(!u)return;const{error:g}=await b.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:z()});if(g){alert("Erro ao criar funil: "+g.message);return}it=!1,await j()})}async function oa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var d;return f(((d=n[l])==null?void 0:d.value)||"")},o=l=>{var d;return(d=n[l])!=null&&d.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],s=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `).join(""),e.querySelectorAll(".media-copy-btn").forEach(a=>{a.addEventListener("click",o=>{var i;o.stopPropagation(),(i=navigator.clipboard)==null||i.writeText(a.dataset.url).then(()=>{const s=a.textContent;a.textContent="✓ Copiado!",setTimeout(()=>{a.textContent=s},1500)})})}),e.querySelectorAll(".media-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta imagem da biblioteca?")&&(await b.from("media_library").delete().eq("id",a.dataset.id),await lt())})})}async function Za(){var t,n,a,o,i;const e=document.getElementById("section-super-admin");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="cfg-card">
    ...
    <div class="sa-list-row" data-action="open-panel" data-id="${c.id}" style="cursor:pointer;" title="Clique para gerenciar">
      <div class="sa-list-info">
        ...
        <div>
          ...
          <div class="sa-list-sub">${f(c.slug||"")} · ${f(((r=c.plans)==null?void 0:r.name)||"Sem plano")}</div>
        </div>
      </div>
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async r=>{r.stopPropagation();const m=c.dataset.active==="true";await b.from("tenants").update({active:!m}).eq("id",c.dataset.id),de()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const r=(i||[]).find(m=>String(m.id)===String(c.dataset.id));r&&on(r)})})}async function en(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await b.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),b.from("plans").select("id, name").then(({data:c})=>{const r=document.getElementById("nt-plan");r&&c&&(r.innerHTML='<option value="">Sem plano</option>'+c.map(m=>`<option value="${m.id}">${f(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=an(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(s=document.getElementById("sa-modal-close-btn"))==null||s.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(d=document.getElementById("nt-save"))==null||d.addEventListener("click",async()=>{var L,k,w,$,B,A,_,q,T,V,O,H;const c=(k=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:k.trim(),r=($=(w=document.getElementById("nt-slug"))==null?void 0:w.value)==null?void 0:$.trim(),m=(A=(B=document.getElementById("nt-domain"))==null?void 0:B.value)==null?void 0:A.trim(),p=(_=document.getElementById("nt-plan"))==null?void 0:_.value,h=(T=(q=document.getElementById("nt-admin-email"))==null?void 0:q.value)==null?void 0:T.trim(),E=(O=(V=document.getElementById("nt-admin-password"))==null?void 0:V.value)==null?void 0:O.trim(),x=document.getElementById("nt-msg"),u=document.getElementById("nt-save");if(!c||!r){x.textContent="❌ Nome e slug são obrigatórios.",x.style.color="#ef4444";return}if(!h){x.textContent="❌ Informe o e-mail do admin.",x.style.color="#ef4444";return}if(!E||E.length<6){x.textContent="❌ A senha precisa ter mínimo 6 caracteres.",x.style.color="#ef4444";return}u.disabled=!0,u.textContent="Criando…",x.textContent="⏳ Criando imobiliária…",x.style.color="#64748b";const{data:g,error:v}=await b.from("tenants").insert({name:c,slug:r,domain:m||null,plan_id:p||null,active:!0}).select();if(v){u.disabled=!1,u.textContent="Criar Imobiliária",x.textContent="❌ "+v.message,x.style.color="#ef4444";return}const I=(H=g==null?void 0:g[0])==null?void 0:H.id;x.textContent="⏳ Criando usuário admin…";const S=await ue({email:h,password:E,role:"admin",tenant_id:I});if(!(S!=null&&S.success)){u.disabled=!1,u.textContent="Criar Imobiliária",x.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+f((S==null?void 0:S.error)||"Desconhecido"),x.style.color="#f59e0b",setTimeout(()=>{n(),de()},3e3);return}I&&(S!=null&&S.user_id)&&!(S!=null&&S.linked)&&await b.from("profiles").update({tenant_id:I}).eq("id",S.user_id),u.disabled=!1,u.textContent="Criar Imobiliária",S.email_sent===!1?(x.innerHTML=`
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px;margin-top:8px;font-size:12px;">
          E-mail: <strong>${f(h)}</strong><br>
          Senha: <strong>${f(E)}</strong>
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>sa(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ct(e,o.dataset.tab)})}),ct(e,"properties")}function sn(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,d,c,r="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
      ...
      <input id="${l}" type="${r}" value="${f(String(c||""))}" ${m}
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${r.map(m=>{var p;return`
            <tr data-pid="${m.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${f(Ne(m.price,"pt"))}</td>
      ...
      </div>`,n.querySelectorAll(".tp-prop-edit").forEach(m=>{m.addEventListener("click",()=>{const p=Number(m.dataset.pid),h=r.find(E=>E.id===p);h&&sn(h,a)})}),n.querySelectorAll(".tp-prop-toggle").forEach(m=>{m.addEventListener("click",async()=>{const p=Number(m.dataset.pid),h=m.dataset.pub==="1";m.disabled=!0,m.textContent="…",await b.from("properties").update({published:!h}).eq("id",p),a()})}),n.querySelectorAll(".tp-prop-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir este imóvel permanentemente?")&&(m.disabled=!0,m.textContent="…",await b.from("properties").delete().eq("id",Number(m.dataset.pid)),a())})})}if(t==="leads"){const{data:r}=await b.from("leads").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}).limit(200);if(!(r!=null&&r.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">📋</div><p style="font-size:14px;">Nenhum lead ainda.</p></div>';return}const m=p=>({novo:"#dbeafe,#1d4ed8",contato:"#fef3c7,#92400e",proposta:"#ede9fe,#6d28d9",fechado:"#dcfce7,#15803d"})[p]||"#f1f5f9,#64748b";n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${r.map(p=>{const[h,E]=m(p.stage||p.status||"").split(","),x=(p.phone||"").replace(/\D/g,"");return`<tr data-lid="${p.id}" style="border-top:1px solid #f1f5f9;">
              <td style="padding:12px 16px;font-weight:600;font-size:13px;color:#0f172a;">${f(p.name||"")}</td>
              <td style="padding:12px 16px;">
                <div style="font-size:13px;color:#475569;">${f(p.phone||"—")}</div>
                <div style="font-size:11px;color:#94a3b8;">${f(p.email||"")}</div>
              </td>
              <td style="padding:12px 16px;"><span style="background:${h};color:${E};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${f(p.stage||p.status||"Novo")}</span></td>
        ...
        <table style="width:100%;border-collapse:collapse;min-width:520px;">
          ...
          <tbody>${r.map(p=>`
            <tr data-uid="${p.id}" style="border-top:1px solid #f1f5f9;">
              <td style="padding:12px 16px;"><div style="font-weight:600;font-size:13px;color:#0f172a;">${f(p.name||p.email||"—")}</div><div style="font-size:11px;color:#94a3b8;">${f(p.email||"")}</div></td>
              <td style="padding:12px 16px;">
      ...
      </div>`,(s=n.querySelector("#tp-add-corretor"))==null||s.addEventListener("click",()=>ot(e.id,a)),n.querySelectorAll(".tp-role-sel").forEach(p=>{p.addEventListener("change",async()=>{const h=p.dataset.uid;p.disabled=!0,await b.from("profiles").update({role:p.value}).eq("id",h),p.disabled=!1})}),n.querySelectorAll(".tp-user-toggle").forEach(p=>{p.addEventListener("click",async()=>{const h=p.dataset.uid,E=p.dataset.active==="1";p.disabled=!0,p.textContent="…",await b.from("profiles").update({active:!E}).eq("id",h),a()})}),n.querySelectorAll(".tp-user-del").forEach(p=>{p.addEventListener("click",async()=>{confirm("Remover este usuário da imobiliária? O acesso ao sistema será excluído permanentemente.")&&(p.disabled=!0,p.textContent="…",await ue({action:"delete",userId:p.dataset.uid}),a())})})}if(t==="api"){const r="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api",m=(e.domain||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim(),p=m?`https://${m}`:`https://omarcorretor.com.br/demo.html?key=${e.id}`,h=m?"🌐 Site da Imobiliária":"🌐 Site Demonstração",E=m?"Site oficial da imobiliária integrado ao CRM.":"Mostre ao cliente como o site integrado funciona com os imóveis desta imobiliária.",x=m?"Abrir site →":"Abrir site demo →";n.innerHTML=`
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          <h3 style="font-size:15px;font-weight:700;color:#0f172a;margin:0 0 4px;">${h}</h3>
          <p style="font-size:13px;color:#64748b;margin:0 0 16px;">${E}</p>
          <a href="${f(p)}" target="_blank" style="display:inline-block;background:#c9a84c;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;">${x}</a>
          <p style="font-size:11px;color:#94a3b8;margin:10px 0 0;word-break:break-all;">${f(p)}</p>
        </div>
        <div style="background:#0f172a;border-radius:12px;padding:24px;">
          ...
          <div style="font-family:monospace;font-size:12px;color:#94a3b8;line-height:2.2;">
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${r}/properties?key=${f(e.id)}</div>
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${r}/properties/{id}?key=${f(e.id)}</div>
            <div><span style="color:#fb923c;margin-right:8px;">POST</span>${r}/leads?key=${f(e.id)}</div>
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${r}/settings?key=${f(e.id)}</div>
          </div>
        </div>
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var v;(v=navigator.clipboard)==null||v.writeText(e.id);const u=document.getElementById("tp-copy-key"),g=u.textContent;u.textContent="✅ Copiada!",setTimeout(()=>{u.textContent=g},2e3)})}if(t==="config"){const{data:r}=await b.from("settings").select("key,value").eq("tenant_id",e.id),m={};r==null||r.forEach(h=>{m[h.key]=h.value});const p=(h,E)=>`
      <div style="margin-bottom:14px;">
        <div style="font-size:11px;font-weight:700;color:#94a3b8;letter-spacing:.06em;margin-bottom:4px;">${h}</div>
        <div style="font-size:14px;color:#0f172a;">${f(String(E||"—"))}</div>
      </div>`;n.innerHTML=`
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>sa(e))}}function sa(e){var c,r,m,p,h,E,x,u;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([g,v,I])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:g})=>{const v=document.getElementById("et-plan");v&&g&&(v.innerHTML='<option value="">Sem plano</option>'+g.map(I=>`<option value="${I.id}"${String(I.id)===String(e.plan_id)?" selected":""}>${f(I.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",g=>{const v=g.target.files[0];if(!v)return;const I=URL.createObjectURL(v),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${I}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var g;(g=document.getElementById("et-logo-input"))==null||g.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const g=document.getElementById("et-admin-password");g.type=g.type==="password"?"text":"password"}),(p=document.getElementById("et-copy-key"))==null||p.addEventListener("click",()=>{var S,L;const g=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!g)return;(L=navigator.clipboard)==null||L.writeText(g);const v=document.getElementById("et-copy-key"),I=v.textContent;v.textContent="✅ Copiada!",setTimeout(()=>{v.textContent=I},2e3)});const o=["dados","config","api"];function i(g){o.forEach(v=>{document.getElementById(`et-pane-${v}`).style.display=v===g?"":"none";const I=document.getElementById(`et-tab-${v}`);I.style.borderBottomColor=v===g?"#2563eb":"transparent",I.style.color=v===g?"#2563eb":"#64748b",I.style.fontWeight=v===g?"600":"500"}),g==="config"&&l()}o.forEach(g=>{var v;return(v=document.getElementById(`et-tab-${g}`))==null?void 0:v.addEventListener("click",()=>i(g))});let s=!1;async function l(){var I;if(s)return;s=!0;const{data:g}=await b.from("settings").select("key,value").eq("tenant_id",e.id),v={};g==null||g.forEach(S=>{v[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${f(v["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${f(v["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${f(v["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${f(v["company.city"]||v["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${f(v["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
    ...
    `,(I=document.getElementById("et-cfg-save"))==null||I.addEventListener("click",async()=>{const S=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");S.disabled=!0,S.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const k=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),w=document.getElementById("et-cfg-phone").value.trim(),$=document.getElementById("et-cfg-email").value.trim(),B=document.getElementById("et-cfg-city").value.trim(),A=document.getElementById("et-cfg-slogan").value.trim(),{error:_}=await b.from("settings").upsert([{key:"company.whatsapp",value:k,tenant_id:e.id},{key:"company.phone",value:w,tenant_id:e.id},{key:"company.email",value:$,tenant_id:e.id},{key:"company.city",value:B,tenant_id:e.id},{key:"company.address",value:B,tenant_id:e.id},{key:"company.slogan",value:A,tenant_id:e.id}],{onConflict:"tenant_id,key"});S.disabled=!1,S.textContent="💾 Salvar configurações",_?(L.textContent="❌ "+_.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const d=()=>n.remove();(h=document.getElementById("et-close"))==null||h.addEventListener("click",d),(E=document.getElementById("et-cancel"))==null||E.addEventListener("click",d),n.addEventListener("click",g=>{g.target===n&&d()}),(x=document.getElementById("et-delete"))==null||x.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const v=document.getElementById("et-delete");v.disabled=!0,v.textContent="Excluindo…";const{error:I}=await b.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),v.disabled=!1,v.textContent="🗑️ Excluir";return}d(),de()}),(u=document.getElementById("et-save"))==null||u.addEventListener("click",async()=>{var q,T,V,O,H,ne,re,ke,Se,P,ve,ht;const g=(T=(q=document.getElementById("et-name"))==null?void 0:q.value)==null?void 0:T.trim(),v=(O=(V=document.getElementById("et-slug"))==null?void 0:V.value)==null?void 0:O.trim(),I=(ne=(H=document.getElementById("et-domain"))==null?void 0:H.value)==null?void 0:ne.trim(),S=(re=document.getElementById("et-plan"))==null?void 0:re.value,L=(Se=(ke=document.getElementById("et-admin-email"))==null?void 0:ke.value)==null?void 0:Se.trim(),k=(ve=(P=document.getElementById("et-admin-password"))==null?void 0:P.value)==null?void 0:ve.trim(),w=(ht=document.getElementById("et-logo-input"))==null?void 0:ht.files[0],$=document.getElementById("et-msg"),B=document.getElementById("et-save");if(!g){$.textContent="❌ Nome é obrigatório.",$.style.color="#ef4444";return}B.disabled=!0,B.textContent="Salvando…",$.textContent="⏳ Salvando…",$.style.color="#64748b";let A=e.logo_url;if(w)try{const M=await De(w,256,.85),xt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:ma}=await b.storage.from("imoveis").upload(xt,M,{contentType:"image/jpeg",upsert:!0});if(!ma){const{data:{publicUrl:pa}}=b.storage.from("imoveis").getPublicUrl(xt);A=pa}}catch(M){console.error("Logo upload:",M)}const{error:_}=await b.from("tenants").update({name:g,slug:v||e.slug,domain:I||null,plan_id:S||null,logo_url:A}).eq("id",e.id);if(_){B.disabled=!1,B.textContent="Salvar",$.textContent="❌ "+_.message,$.style.color="#ef4444";return}if(L&&k&&k.length>=6){$.textContent="⏳ Criando usuário admin…";const M=await ue({email:L,password:k,role:"admin",tenant_id:e.id});M!=null&&M.success?(M!=null&&M.user_id&&!(M!=null&&M.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",M.user_id),$.textContent="✅ Salvo e admin criado!",$.style.color="#22c55e"):($.textContent="⚠️ Salvo, mas erro ao criar admin: "+((M==null?void 0:M.error)||"Tente novamente"),$.style.color="#f59e0b")}else $.textContent="✅ Imobiliária atualizada!",$.style.color="#22c55e";B.disabled=!1,B.textContent="Salvar",setTimeout(()=>{d(),de()},1200)})}const Dt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Qe=[],fe=[],Ue={};function dn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",rn)}function rn(){Qe=[],fe=[],Ue={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const d=[];let c="",r=!1;for(let m=0;m<l.length;m++){const p=l[m];p==='"'?r&&l[m+1]==='"'?(c+='"',m++):r=!r:p===n&&!r?(d.push(c.trim()),c=""):c+=p}return d.push(c.trim()),d}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),s=a.slice(1).map(o);return{headers:i,rows:s}}async function cn(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,s)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=s,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}fe=o[0].map(String),Qe=o.slice(1),ra()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function mn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function ra(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+fe.map((a,o)=>`<option value="${o}">${f(a)}</option>`).join("");e.innerHTML=Dt.map(a=>{const o=mn(fe,t[a.key]||[]);return Ue[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Dt.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Ue[a.key]!==""&&(o.value=Ue[a.key])}),pn(),da()}function pn(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=Qe.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${fe.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${f(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${fe.map((i,s)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${f(String(o[s]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function un(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function gn(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),s=e.querySelector("#ldp-tag-search"),l=e.querySelector("#ldp-tag-opt-list"),d=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),r=e.querySelector("#ldp-tag-new-name"),m=e.querySelector("#ldp-tag-new-color"),p=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function h(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map(I=>I.dataset.tag)}function E(I){if(!I.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=I.map(S=>{const k=(n[S]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(S)}" style="background:${k}18;color:${k};border-color:${k}55;">
        ${f(S)}<span class="ldp-tag-rm" data-tag="${f(S)}">×</span>
      </span>`}).join("")}function x(I=""){const S=h(),L=I.toLowerCase().trim(),k=t.filter(w=>!L||w.name.toLowerCase().includes(L));if(!k.length){l.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}l.innerHTML=k.map(w=>{const $=S.includes(w.name);return`<div class="ldp-tag-opt${$?" active":""}" data-tag="${f(w.name)}" style="--tc:${w.color}">
        <span class="ldp-tag-opt-dot" style="background:${w.color}"></span>
        <span class="ldp-tag-opt-name">${f(w.name)}</span>
        ${$?'<span class="ldp-tag-opt-check">✓</span>':""}
      </div>`}).join("")}function u(){i.classList.remove("hidden"),x(""),s.value="",c.classList.add("hidden"),s.focus()}function g(){i.classList.add("hidden")}o.addEventListener("click",I=>{I.stopPropagation(),i.classList.contains("hidden")?u():g()}),document.addEventListener("mousedown",function I(S){e.contains(S.target)||(g(),document.removeEventListener("mousedown",I))}),i.addEventListener("mousedown",I=>I.stopPropagation()),s.addEventListener("input",()=>x(s.value)),l.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-opt");if(!S)return;const L=S.dataset.tag,k=h();k.includes(L)?E(k.filter(w=>w!==L)):E([...k,L]),x(s.value)}),a.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-rm");if(!S)return;const L=S.dataset.tag;E(h().filter(k=>k!==L))}),d.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||r.focus()});async function v(){const I=r.value.trim();if(!I){r.focus();return}const S=m.value||"#6366F1";if(t.some(L=>L.name.toLowerCase()===I.toLowerCase())){r.style.borderColor="#ef4444",setTimeout(()=>{r.style.borderColor=""},1500);return}p.disabled=!0,p.textContent="Criando…";try{const{data:L,error:k}=await b.from("crm_tags").insert({name:I,color:S,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(k)throw k;const w={id:L.id,name:L.name,color:L.color};t.push(w),n[w.name]=w,typeof me<"u"&&(me[w.name]=w),E([...h(),w.name]),x(s.value),r.value="",m.value="#6366F1",c.classList.add("hidden")}catch(L){console.error("Error creating tag:",L),alert("Erro ao criar tag: "+(L.message||L))}finally{p.disabled=!1,p.textContent="Criar e adicionar"}}p.addEventListener("click",v),r.addEventListener("keydown",I=>{I.key==="Enter"&&v()})}async function fn(){var u;const e=document.getElementById("section-dashboard");if(!e)return;e.dataset.dbInit==="1"&&(window._dbLeadsChartInstance&&(window.window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null),window._dbOriginChartInstance&&(window.window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)),e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <!-- KPI Cards -->
  <div class="db-kpis">
    ${["db-kpi-indigo","db-kpi-emerald","db-kpi-amber","db-kpi-sky"].map((g,v)=>`
    <div class="db-kpi ${g}" id="db-kpi-${v}">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],s=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${s[n.getMonth()]} de ${n.getFullYear()}`,d=((u=y==null?void 0:y.name)==null?void 0:u.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${N(d)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${l}`);let m=[],p=[];try{const[g,v]=await Promise.all([Ut(),vn()]);m=g||[],p=v||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}yn(m,p,n);const h=m.filter(g=>g.published).length,E=p.filter(g=>mt(g.created_at)===mt(n.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${l.split(",")[0]}
    </span>`),hn(p,m),xn(m),En(m,p,n),wn(m,p);try{await un(),jt(p,7),bn(p),document.querySelectorAll(".db-ptab").forEach(g=>{g.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach(I=>I.classList.remove("active")),g.classList.add("active");const v=parseInt(g.dataset.p);window._dbSelectedDays=v,jt(p,v)})})}catch(g){console.warn("[Dashboard] Chart.js não carregou:",g)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const g=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!g||g.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function N(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function mt(e){return(e||"").slice(0,10)}function la(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function ca(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function vn(){let e=b.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(y==null?void 0:y.role)==="corretor"?e=e.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function yn(e,t,n){const a=e.length,o=e.filter(x=>x.published).length,i=t.length,s=t.filter(x=>x.stage&&x.stage!=="perdido"&&x.stage!=="fechado").length,l=new Date(n);l.setDate(l.getDate()-30);const d=new Date(n);d.setDate(d.getDate()-60);const c=e.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,r=e.filter(x=>x.created_at&&new Date(x.created_at)>=d&&new Date(x.created_at)<l).length,m=t.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,p=t.filter(x=>x.created_at&&new Date(x.created_at)>=d&&new Date(x.created_at)<l).length;function h(x,u,g){if(u===0&&x===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(u===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const v=Math.round((x-u)/u*100);return v===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':v>0?`<span class="db-kpi-trend db-trend-up">▲ +${v}% ${g}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${v}% ${g}</span>`}[{idx:0,val:a,label:"Total de Imóveis",trend:h(c,r,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:o,label:"Publicados no Site",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:2,val:i,label:"Leads Recebidos",trend:h(m,p,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:3,val:s,label:"Em Negociação",trend:s===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'}].forEach(({idx:x,val:u,label:g,trend:v,icon:I})=>{const S=document.getElementById(`db-kpi-${x}`);S&&(S.innerHTML=`
      <div class="db-kpi-icon">${I}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${ca(u)}</div>
        <div class="db-kpi-lbl">${N(g)}</div>
        ${v}
