import{s as b}from"./supabase-BcuJ3xoD.js";const ve="00000000-0000-0000-0000-000000000000";let Be={},Ue={},he=ve;function ue(e){he=e||ve,Be={},Ue={}}const z=()=>he;async function qt(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",he),b.from("site_content").select("*").eq("tenant_id",he)]);e.data&&e.data.forEach(n=>{Be[n.key]=n.value}),t.data&&t.data.forEach(n=>{Ue[n.key]=n})}const F=(e,t=null)=>Be[e]!==void 0?Be[e]:t,Oe=(e,t="pt")=>{const n=Ue[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function ye(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:he,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{Be[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:he,updated_at:new Date().toISOString()},{error:i}=await b.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(Ue[e]=o),!i}async function Pe(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function tt(){const e=document.documentElement,t=F("visual.accent_color","#b8962e"),n=F("visual.primary_bg","#0f1c2e"),a=F("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=F("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=F("company.favicon_url","/favicon.ico"),c=document.querySelector('link[rel="shortcut icon"]');c&&(c.href=i);const l=F("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero");s&&(s.style.backgroundImage=`url('${l}')`)}}function Mt(e="pt"){const t=v=>Oe(v,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),c=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),c&&t("inst.bio_p2")&&(c.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n-num="inst.stat2num"]'),p=document.querySelector('[data-i18n="inst.stat1"]'),r=document.querySelector('[data-i18n="inst.stat2"]'),d=document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat2_num")&&(s.innerHTML=t("inst.stat2_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),r&&t("inst.stat2_label")&&(r.innerHTML=t("inst.stat2_label")),d&&t("inst.stat3_label")&&(d.innerHTML=t("inst.stat3_label"));const m=Oe("seo.title_pt",e);m&&document.title&&(document.title=m);const u=Oe("seo.description_pt",e);if(u){const v=document.querySelector('meta[name="description"]');v&&(v.content=u)}}function zt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Nt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let oe="5547999701743";const te=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],jt=5.7;function se(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/jt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],f=null,Le=[],wt=!1;b.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(wt=!0)});function Xe(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Te(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function It({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:r,error:d}=await b.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return d&&console.error("Supabase select error:",d),r||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=z();if(!o||o===ve){const r=Te(a);if(r)o=r,ue(o);else{const d=t.replace(/^www\./,"");for(const m of[d,"www."+d]){const{data:u}=await b.from("tenants").select("id").eq("domain",m).maybeSingle();if(u!=null&&u.id){o=u.id,ue(o);break}}o&&o!==ve&&Xe(a,o,24*60*60*1e3)}}if(!o||o===ve)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,c=5*60*1e3;if(!e){const r=Te(i);if(r)return setTimeout(()=>It({background:!0}),100),r}const{data:l,error:s}=await b.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),Te(i)||[];const p=l||[];return Xe(i,p,c),e&&typeof le=="function"&&le().catch(()=>{}),p}async function Rt(){let e=b.from("properties").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="super_admin"||(f!=null&&f.tenant_id?e=e.eq("tenant_id",f.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ua(),ga(),_)}async function Ht(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await b.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(c=>c.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await b.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Ut(e){const{error:t}=await b.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Ot(e,t){const{error:n}=await b.auth.signInWithPassword({email:e,password:t});return!n}function _e(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,c=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(c);const l=document.createElement("canvas");let s=i.width,p=i.height;s>t&&(p=Math.round(p*t/s),s=t),l.width=s,l.height=p;const r=l.getContext("2d");r.drawImage(i,0,0,s,p);const d=new Image;d.crossOrigin="anonymous",d.onload=()=>{const m=Math.round(s*.18),u=Math.round(d.naturalHeight*m/d.naturalWidth),v=Math.round(s*.02),h=s-m-v,E=p-u-v;r.globalAlpha=.45,r.drawImage(d,h,E,m,u),r.globalAlpha=1,l.toBlob(x=>x?a(x):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},d.onerror=()=>{l.toBlob(m=>m?a(m):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},d.src="/logo.png"},i.onerror=o,i.src=c})}async function Dt(e){const t=await _e(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await b.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=b.storage.from("imoveis").getPublicUrl(n);return o}async function Pt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Dt(n[o]));return a}async function le(){var m,u,v,h,E,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await It();_=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&Ft(n);const a=((u=document.getElementById("city-filter"))==null?void 0:u.value)||"",o=((v=document.getElementById("neighborhood-filter"))==null?void 0:v.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",c=((E=document.getElementById("parking-filter"))==null?void 0:E.value)||"",l=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",{min:s,max:p}=Xt(),r=n.filter(y=>{if(a&&y.city!==a||o&&y.neighborhood!==o||i&&(i==="4+"&&Number(y.bedrooms)<4||i!=="4+"&&Number(y.bedrooms)!==Number(i))||c&&(c==="4+"&&Number(y.parking)<4||c!=="4+"&&Number(y.parking)!==Number(c))||l&&y.construction_status!==l)return!1;const B=String(y.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),k=parseInt(B,10)||0;return!(k<s||p!==1/0&&k>p)});if(e){if(!r.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=r.map(y=>{var $;const B=y.cover_image||(($=y.images)==null?void 0:$[0])||te[0],k=[y.neighborhood,y.city].filter(Boolean).join(", "),L=encodeURIComponent(`Olá! Tenho interesse no imóvel *${y.title}*${y.reference?` (Ref: ${y.reference})`:""}. Poderia me dar mais informações?`);return`
        <div class="selecao-card">
          <div class="img-wm-wrap"><img src="${B}" alt="${g(y.title)}" class="selecao-card-img"></div>
          <div class="selecao-card-body">
            <div class="selecao-card-title">${g(y.title)}</div>
            <div class="selecao-card-loc">${g(k)}</div>
            <div class="selecao-card-price">${g(se(y.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${y.id}" class="btn-det">Ver Detalhes</a>
              <a href="https://wa.me/${oe}?text=${L}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=r.map(y=>{var $;const B=($=y.images)!=null&&$.length?y.images:te,k=B.length,L=encodeURIComponent(`Olá! Tenho interesse no imóvel *${y.title}*${y.reference?` (Ref: ${y.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${k}" data-idx="0" data-pid="${y.id}" data-images="${encodeURIComponent(JSON.stringify(B))}">
          <img src="${y.cover_image||B[0]}" alt="${g(y.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${k>1?`
        ...
        <div class="property-info">
          <strong>${g(y.title)}</strong>
          <div class="muted">${g(y.neighborhood||"")}, ${g(y.city||"")}</div>
          <div><strong>${g(se(y.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${y.bedrooms||"--"} | 🚗 ${y.parking||"--"} ${k>1?"| 📸 "+k:""}</div>
          <p class="muted">${g((y.description||"").slice(0,110))}</p>
          <div style="display:flex;gap:8px;margin-top:6px">
            <a class="btn btn-outline" href="property.html?id=${y.id}" style="flex:1;justify-content:center">Ver Detalhes</a>
            <a class="btn hero-whatsapp-btn" href="https://wa.me/${oe}?text=${L}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join("");const d=document.getElementById("properties");d&&!d._carouselDelegated&&(d._carouselDelegated=!0,d.addEventListener("click",rt),d.addEventListener("touchstart",function(y){y.target.closest(".carousel-btn")&&rt(y)},{passive:!1}))}function Ft(e){var o,i,c;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var d;const s=l.cover_image||((d=l.images)==null?void 0:d[0])||te[0],p=[l.neighborhood,l.city].filter(Boolean).join(", "),r=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="selecao-card">
    ...
    </tr>`}).join("")}}function Wt(){const e=document.getElementById("f-city");if(!e)return;const t=me(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),n&&(e.value=n)}function Jt(){var e,t,n,a,o,i,c,l,s,p,r,d,m,u,v;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((c=document.getElementById("f-price-min"))==null?void 0:c.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((s=document.getElementById("f-area-min"))==null?void 0:s.value)||0,areaMax:parseFloat((p=document.getElementById("f-area-max"))==null?void 0:p.value)||1/0,construction:((r=document.getElementById("f-construction"))==null?void 0:r.value)||"",published:((d=document.getElementById("f-published"))==null?void 0:d.value)||"",bedrooms:((m=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:m.dataset.val)||"",suites:((u=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:u.dataset.val)||"",parking:((v=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:v.dataset.val)||""}}function at(e){const t=Jt();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function qe(){if(!document.getElementById("admin-properties"))return;const e=await Rt(),t=e.length,n=e.filter(c=>c.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Wt(),Se(_)}let R=null,ie="";function Ge(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ae(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow=""}function Me(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(!e.length){t.style.display="none";return}t.style.display="",n.innerHTML=e.map(a=>`
    <div class="cover-thumb-wrap${a===ie?" selected":""}" data-url="${a}">
      <img src="${a}" class="cover-thumb" alt="">
      <span class="cover-star">★</span>
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",()=>{ie=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(o=>o.classList.remove("selected")),a.classList.add("selected")})})}}function Fe(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var s;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const c=o.filter(p=>p.size>0);if(c.length){t.disabled=!0,t.textContent=`Enviando 0/${c.length} foto…`;try{i=await Pt(c,(p,r)=>{t.textContent=`Enviando ${p}/${r} foto…`})}catch(p){console.error("Erro no upload:",p),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(R){const p=_.find(r=>r.id===R);p!=null&&p.images&&(i=p.images)}i.length||(i=[...te]);const l={...R?{id:R}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:ie||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",tenant_id:R?((s=_.find(p=>p.id===R))==null?void 0:s.tenant_id)??(f==null?void 0:f.tenant_id)??null:(f==null?void 0:f.tenant_id)??null};try{await Ht(l),R=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const p=document.getElementById("adminPublished");p&&(p.value="true");const r=document.getElementById("adminNeighborhood");r&&(r.innerHTML='<option value="">Selecione a cidade primeiro</option>');const d=document.getElementById("adminConstructionStatus");d&&(d.value=""),ie="",Me([]),Ae(),await qe()}catch(p){console.error(p),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((p==null?void 0:p.message)||JSON.stringify(p)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ut(o),await qe()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(s=>s.id===o);if(!i)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const c=document.getElementById("adminPublished");c&&(c.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),ie=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Me(i.images||[]),Ge("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Q=[],G=0;function Yt(e){var d,m;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((d=e.images)==null?void 0:d[0])||te[0];document.getElementById("view-thumb-preview").src=i,Q=(m=e.images)!=null&&m.length?e.images:te,G=0,ze(),document.getElementById("view-price").textContent=se(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const c=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),c&&(c.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,p=document.getElementById("share-link-input");p&&(p.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ce(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function ze(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Q[G],e.alt=`Foto ${G+1}`;const i=Q.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${G+1} / ${Q.length}`:"",o.innerHTML=i?Q.map((c,l)=>`<img src="${c}" class="view-thumb${l===G?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(c=>{c.addEventListener("click",()=>{G=+c.dataset.i,ze()})})}async function ct(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ne(e){var d,m;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",c=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=c),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((d=i[0])==null?void 0:d.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),p=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=c),e!=null&&e.avatar_url&&p?(p.src=e.avatar_url,p.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",r.style.display=""),p&&(p.style.display="none"))}async function mt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==ve,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:c}=await b.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((c==null?void 0:c.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}function de(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),W(),e==="contatos"&&da(),e==="funil"&&Zt(),e==="tarefas"&&ta()}function pt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:Ea}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>wa(),{once:!0}),window.lucide&&lucide.createIcons()}}function W(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Kt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var d,m;const c=((d=document.getElementById("cp-new"))==null?void 0:d.value)||"",l=((m=document.getElementById("cp-confirm"))==null?void 0:m.value)||"",s=document.getElementById("cp-msg"),p=document.getElementById("cp-save");if(s.style.display="none",c.length<6){s.style.color="#ef4444",s.textContent="Mínimo 6 caracteres.",s.style.display="";return}if(c!==l){s.style.color="#ef4444",s.textContent="As senhas não coincidem.",s.style.display="";return}p.disabled=!0,p.textContent="Salvando…";const{error:r}=await b.auth.updateUser({password:c});if(p.disabled=!1,p.textContent="Salvar Senha",r){s.style.color="#ef4444",s.textContent="Erro: "+r.message,s.style.display="";return}s.style.color="#16a34a",s.textContent="✅ Senha alterada com sucesso!",s.style.display="",setTimeout(n,1500)})}function Qt(){var i,c,l,s,p;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(c=document.getElementById("cph-close"))==null||c.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",r=>{r.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",r=>{const d=r.target.files[0];if(!d)return;const m=URL.createObjectURL(d),u=document.getElementById("cph-preview"),v=document.getElementById("cph-initial");u&&(u.src=m,u.style.display=""),v&&(v.style.display="none"),document.getElementById("cph-save").disabled=!1}),(p=document.getElementById("cph-save"))==null||p.addEventListener("click",async()=>{var u;const r=(u=document.getElementById("cph-file"))==null?void 0:u.files[0];if(!r)return;const d=document.getElementById("cph-save"),m=document.getElementById("cph-msg");d.disabled=!0,d.textContent="Salvando…";try{const v=await _e(r,400,.85),h=`avatars/${f.id}-${Date.now()}.jpg`,{error:E}=await b.storage.from("imoveis").upload(h,v,{contentType:"image/jpeg",upsert:!0});if(E)throw E;const{data:{publicUrl:x}}=b.storage.from("imoveis").getPublicUrl(h);await b.from("profiles").update({avatar_url:x}).eq("id",f.id),f={...f,avatar_url:x},Ne(f),o()}catch(v){m.style.color="#ef4444",m.textContent="Erro: "+v.message,m.style.display="",d.disabled=!1,d.textContent="Salvar Foto"}})}function Ve(e,t){var i,c,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(c=document.getElementById("ac-cancel"))==null||c.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var m,u,v;const s=(m=document.getElementById("ac-email"))==null?void 0:m.value.trim(),p=(u=document.getElementById("ac-password"))==null?void 0:u.value.trim(),r=document.getElementById("ac-save"),d=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!p||p.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}r.disabled=!0,r.textContent="Criando…",d.style.display="none";try{const h=e||(f==null?void 0:f.tenant_id)||null,E=((v=document.getElementById("ac-role"))==null?void 0:v.value)||"corretor",x=await ce({email:s,password:p,role:E,tenant_id:h});r.disabled=!1,r.textContent="+ Criar Acesso",x.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",x.email_sent===!1?(d.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${g(s)}<br><strong>Senha:</strong> ${g(p)}`,d.style.color="#0f172a"):(d.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",d.style.color="#16a34a"),d.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(x.error||"Falha desconhecida"))}catch(h){r.disabled=!1,r.textContent="+ Criar Acesso",alert("Erro: "+h.message)}})}function ut(){var i,c,l,s,p,r,d,m,u,v,h;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",E=>{var y;E.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(y=document.getElementById("notif-dropdown"))==null||y.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",E=>{E.stopPropagation(),W(),Qt()}),(c=document.getElementById("avatar-dd-change-pass"))==null||c.addEventListener("click",E=>{E.stopPropagation(),W(),Kt()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",E=>{E.stopPropagation(),W(),Ve()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",E=>{E.stopPropagation(),W(),de("settings")}),(p=document.getElementById("avatar-dd-logout"))==null||p.addEventListener("click",async E=>{E.stopPropagation(),await b.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",E=>{var y;E.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((y=document.getElementById("avatar-dropdown"))==null||y.classList.add("hidden"),oa())}),(r=document.getElementById("notif-mark-all"))==null||r.addEventListener("click",()=>{ia(),W()}),(d=document.getElementById("btn-search-open"))==null||d.addEventListener("click",()=>{var E,x;(E=document.getElementById("search-overlay"))==null||E.classList.remove("hidden"),(x=document.getElementById("search-input"))==null||x.focus()}),(m=document.getElementById("search-overlay-close"))==null||m.addEventListener("click",()=>{var E;(E=document.getElementById("search-overlay"))==null||E.classList.add("hidden")}),(u=document.getElementById("search-overlay"))==null||u.addEventListener("click",E=>{E.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(v=document.getElementById("search-input"))==null||v.addEventListener("input",E=>{clearTimeout(o),o=setTimeout(()=>na(E.target.value.trim()),280)}),(h=document.getElementById("search-input"))==null||h.addEventListener("keydown",E=>{var x;E.key==="Escape"&&((x=document.getElementById("search-overlay"))==null||x.classList.add("hidden"))}),document.addEventListener("click",W)}let We=!1,ne=[],nt=[],je=[],Je={},$t=[],Z=null,Ie=null,P={search:"",tags:new Set,status:""};async function Zt(){var t;if(We){await gt();return}We=!0,await gt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>Ke()),_a();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{Z=parseInt(e.value,10),await Re()})}function Ye(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+$t.map(c=>`<option value="${g(c.name)}">${g(c.name)}</option>`).join(""),n.value=P.status,n.onchange=()=>{P.status=n.value,ge()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML=e.map(c=>{const l=P.tags.has(c.name);return`<button class="kf-tag-btn" data-tag="${g(c.name)}"
        style="padding:4px 12px;border-radius:20px;border:1.5px solid ${c.color};
               background:${l?c.color:c.color+"18"};
               color:${l?"#fff":c.color};
               font-size:12px;font-weight:600;cursor:pointer;transition:all .15s;">
        ${g(c.name)}
      </button>`}).join(""),a.querySelectorAll(".kf-tag-btn").forEach(c=>{c.addEventListener("click",()=>{const l=c.dataset.tag;P.tags.has(l)?P.tags.delete(l):P.tags.add(l),Ye(e),ge()})})}const o=document.getElementById("kf-search");o&&(o.value=P.search,o.oninput=()=>{P.search=o.value.toLowerCase(),ge()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{P={search:"",tags:new Set,status:""},Ye(e),ge()})}async function gt(){const e=z(),[{data:t},{data:n},{data:a}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",e).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);ne=t||[],$t=a||[],Je={},(n||[]).forEach(l=>{Je[l.name]=l});const o=ne.map(l=>l.id),{data:i}=o.length?await b.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};nt=i||[],Ye(n||[]);const c=document.getElementById("funil-pipe-sel");if(c){const l=Z;c.innerHTML=ne.length?ne.map(p=>`<option value="${p.id}">${g(p.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=ne.find(p=>p.id===l)||ne.find(p=>p.is_default)||ne[0];s?(c.value=s.id,Z=s.id):Z=null}await Re()}async function Re(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=b.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id)),Z&&(t=t.eq("pipeline_id",Z));const{data:n}=await t;je=n||[],ge()}function ge(){const e=document.getElementById("kanban-board");if(!e)return;const t=nt.filter(i=>i.pipeline_id===Z);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=P,a=je.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const c=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>c.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,s,p,r;const c=i.stage||((l=t[0])==null?void 0:l.name);o[c]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(r=o[c]||o[(p=t[0])==null?void 0:p.name])==null||r.push(i)}),e.innerHTML=t.map(i=>{const c=o[i.name]||[],l=c.length?c.map(s=>{const p=(s.phone||"").replace(/\D/g,""),r=encodeURIComponent(`Olá ${s.name}! Aqui é da ${F("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${g(i.name)}" style="cursor:pointer;">
          ...
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map(d=>{const m=Je[d],u=(m==null?void 0:m.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${u}18;color:${u};border:1px solid ${u}44;">${g(d)}</span>`}).join(""):""}
          </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div>
        ...
        <select id="ldp-status" class="form-input">
          ...
          ${o.map(d=>`<option value="${d.name}" ${(e==null?void 0:e.status)===d.name?"selected":""}>${g(d.name)}</option>`).join("")}
        </select>
      </div>`:""}
      ${a!=null&&a.length?`
      <div>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:6px;">
          ${a.map(d=>`
            <label style="display:flex;align-items:center;gap:5px;cursor:pointer;padding:4px 10px;border-radius:20px;background:${d.color}18;border:1px solid ${d.color}44;font-size:12px;font-weight:600;color:${d.color};">
              <input type="checkbox" value="${d.name}" style="margin:0;" ${((e==null?void 0:e.tags)||[]).includes(d.name)?"checked":""}>
              ${g(d.name)}
            </label>`).join("")}
        </div>
      </div>`:""}
      ...
      ${c?(()=>{const d=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${F("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${c}?text=${d}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>{l.style.transform="translateX(0)"});const s=()=>{l.style.transform="translateX(100%)",setTimeout(()=>l.remove(),250)};document.getElementById("ldp-close").addEventListener("click",s),document.getElementById("ldp-save").addEventListener("click",async()=>{var x,y;const d=document.getElementById("ldp-save"),m=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){m.style.color="#ef4444",m.textContent="Nome é obrigatório.";return}d.disabled=!0,d.textContent="Salvando…";const v=[...l.querySelectorAll("input[type=checkbox]:checked")].map(B=>B.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((x=document.getElementById("ldp-stage"))==null?void 0:x.value)||null,status:((y=document.getElementById("ldp-status"))==null?void 0:y.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:v,tenant_id:z()};let E;if(t?{error:E}=await b.from("leads").insert(h):{error:E}=await b.from("leads").update(h).eq("id",e.id),d.disabled=!1,d.textContent="💾 Salvar",E){m.style.color="#ef4444",m.textContent="Erro: "+E.message;return}m.style.color="#22c55e",m.textContent="✅ Salvo!",setTimeout(()=>{s(),Re()},700)}),(r=document.getElementById("ldp-delete"))==null||r.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await b.from("leads").delete().eq("id",e.id),s(),Re())})}let j=[],ft=!1,fe="pending";async function ta(){var e;ft||(ft=!0,await aa(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Bt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),fe=t.dataset.filter,xe()})}))}async function aa(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=b.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,c=a.checked?"done":"pending";await b.from("tasks").update({status:c}).eq("id",i);const l=j.find(s=>String(s.id)===i);l&&(l.status=c),xe()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await b.from("tasks").delete().eq("id",a.dataset.id),j=j.filter(i=>String(i.id)!==String(a.dataset.id)),xe())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,c=j.find(l=>String(l.id)===i);c&&Bt(c)})})}function Bt(e=null){var s,p,r,d;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=kt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",c=document.createElement("div");c.id="tarefa-modal-root",c.className="modal-backdrop",c.innerHTML=`
  ...
  `,document.body.appendChild(c);const l=()=>c.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(p=document.getElementById("tm-cancel"))==null||p.addEventListener("click",l),c.addEventListener("click",m=>{m.target===c&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const m=a?"pending":"done";await b.from("tasks").update({status:m}).eq("id",e.id);const u=j.find(v=>String(v.id)===String(e.id));u&&(u.status=m),l(),m==="done"&&(fe="done",document.querySelectorAll(".tarefa-filter-btn").forEach(v=>{v.classList.toggle("active",v.dataset.filter==="done")})),xe()}),(d=document.getElementById("tm-save"))==null||d.addEventListener("click",async()=>{var x,y;const m=document.getElementById("tarefa-form");if(!m.checkValidity()){m.reportValidity();return}const u=new FormData(m),v=document.getElementById("tm-save");v.disabled=!0,v.textContent="Salvando…";const h={title:(x=u.get("title"))==null?void 0:x.trim(),description:((y=u.get("description"))==null?void 0:y.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let E;if(n){if({error:E}=await b.from("tasks").update(h).eq("id",e.id),!E){const B=j.findIndex(k=>String(k.id)===String(e.id));B>=0&&(j[B]={...j[B],...h})}}else{const{data:B,error:k}=await b.from("tasks").insert(h).select();E=k,!E&&(B!=null&&B[0])&&j.unshift(B[0])}if(v.disabled=!1,v.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}l(),xe()})}async function na(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(c=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(c=document.getElementById("notif-see-all"))==null||c.addEventListener("click",l=>{l.preventDefault(),W(),de("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{J.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(J)),l.classList.remove("unread"),W(),de("contatos")})})}function ia(){var e;document.querySelectorAll(".notif-item").forEach(t=>J.push(t.dataset.id)),J=[...new Set(J)],localStorage.setItem("crm_notifs_read",JSON.stringify(J)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function sa(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function la(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);f!=null&&f.tenant_id&&(e=e.eq("tenant_id",f.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!J.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let X=[],N=1;const $e=10;let vt=!1;async function da(){var t,n,a,o,i,c,l,s,p;document.getElementById("section-contatos")&&(vt||(vt=!0,await Lt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{N=1,re()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(N=1,re())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>St()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",ma),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",Qe),(c=document.getElementById("import-modal-cancel"))==null||c.addEventListener("click",Qe),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const d=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,m=new Blob([d],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(m),u.download="modelo_contatos.csv",u.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",ra),(p=document.getElementById("import-modal-confirm"))==null||p.addEventListener("click",ca)))}async function Lt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;X=a||[],re()}function re(){var l,s,p;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?X.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):X,n=t.length,a=Math.max(1,Math.ceil(n/$e));N>a&&(N=a);const o=t.slice((N-1)*$e,N*$e),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const d=(r.phone||"").replace(/\D/g,"");if(!d)return"";const m=encodeURIComponent(`Olá ${(r.name||"").split(" ")[0]}! Aqui é da ${F("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${d}?text=${m}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const c=document.getElementById("contatos-pagination");if(c){const r=n===0?0:(N-1)*$e+1,d=Math.min(N*$e,n);c.innerHTML=`
      <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;font-size:13px;color:#64748b;">
        <span>Exibindo <strong>${r}–${d}</strong> de <strong>${n}</strong> contatos</span>
        <div style="display:flex;gap:8px;">
    ...
    `,(s=c.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{N--,re()}),(p=c.querySelector("#pag-next"))==null||p.addEventListener("click",()=>{N++,re()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",d=>{d.preventDefault();const m=r.dataset.id,u=X.find(v=>String(v.id)===String(m));u&&St(u)})})}async function St(e=null){var x,y,B,k,L,$;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:c}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",a).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],p=c||[],r=l.map(I=>I.id),{data:d}=r.length?await b.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},m=d||[],u=(e==null?void 0:e.pipeline_id)||((x=l[0])==null?void 0:x.id)||"";function v(I){const w=m.filter(S=>S.pipeline_id===I);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(S=>`<option value="${g(S.name)}" ${(e==null?void 0:e.stage)===S.name?"selected":""}>${g(S.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
  ...
  `,document.body.appendChild(h);const E=()=>h.remove();(y=document.getElementById("cm-close"))==null||y.addEventListener("click",E),(B=document.getElementById("cm-cancel"))==null||B.addEventListener("click",E),h.addEventListener("click",I=>{I.target===h&&E()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",I=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=v(I.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await b.from("leads").delete().eq("id",e.id);const I=X.findIndex(w=>String(w.id)===String(e.id));I>=0&&X.splice(I,1),E(),re()}),($=document.getElementById("cm-save"))==null||$.addEventListener("click",async()=>{var D,H,U,Y,ae,Ee,we;const I=document.getElementById("contato-form");if(!I.checkValidity()){I.reportValidity();return}const w=new FormData(I),S=document.getElementById("cm-save");S.disabled=!0,S.textContent="Salvando…";const T=w.getAll("tag"),C=w.get("pipeline_id")||null,M={name:(D=w.get("name"))==null?void 0:D.trim(),company:((H=w.get("company"))==null?void 0:H.trim())||null,email:((U=w.get("email"))==null?void 0:U.trim())||null,phone:((Y=w.get("phone"))==null?void 0:Y.trim())||null,job_title:((ae=w.get("job_title"))==null?void 0:ae.trim())||null,city_interest:((Ee=w.get("city_interest"))==null?void 0:Ee.trim())||null,notes:((we=w.get("notes"))==null?void 0:we.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:T,assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await b.from("leads").update(M).eq("id",e.id),!A){const O=X.findIndex(pe=>String(pe.id)===String(e.id));O>=0&&(X[O]={...X[O],...M})}}else{const{data:O,error:pe}=await b.from("leads").insert(M).select();A=pe,!A&&(O!=null&&O[0])&&X.unshift(O[0])}if(S.disabled=!1,S.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}E(),re()})}let be=[];function ra(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{be=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,p,r,d,m]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:s,email:p,phone:r,company:d,job_title:m}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${be.length} contato(s) encontrados para importar.`);const c=document.getElementById("import-modal-confirm");c&&(c.disabled=be.length===0)},n.readAsText(t)}async function ca(){if(!be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Qe(),await Lt(),alert(`${t.length} contato(s) importados com sucesso!`)}function ma(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Qe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const pa="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ce(e){return(await fetch(pa,{method:"POST",headers:{Authorization:`Bearer ${Nt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function yt(e){var s,p,r,d;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),c=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await b.auth.getUser();n.value=(m==null?void 0:m.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const v=URL.createObjectURL(u);a&&(a.src=v,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var x,y;const m=((x=document.getElementById("change-password-new"))==null?void 0:x.value)||"",u=((y=document.getElementById("change-password-confirm"))==null?void 0:y.value)||"",v=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(v&&(v.style.display="none"),m.length<6){v&&(v.textContent="Mínimo 6 caracteres.",v.style.display="");return}if(m!==u){v&&(v.textContent="As senhas não coincidem.",v.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:E}=await b.auth.updateUser({password:m});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),E?v&&(v.textContent="Erro: "+E.message,v.style.display=""):(v&&(v.style.color="#16a34a",v.textContent="Senha alterada com sucesso!",v.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),c==null||c.addEventListener("click",async()=>{var y;const m=t.value.trim();let u=(f==null?void 0:f.avatar_url)||"";const v=i==null?void 0:i.files[0],h=c.textContent;if(c.disabled=!0,c.textContent="Salvando…",v)try{const B=await _e(v,400,.85),k=`avatars/${f.id}-${Date.now()}.jpg`,{error:L}=await b.storage.from("imoveis").upload(k,B,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:$}}=b.storage.from("imoveis").getPublicUrl(k);u=$}}catch(B){console.error("Avatar upload:",B)}const{error:E}=await b.from("profiles").update({name:m,avatar_url:u}).eq("id",f.id);if(c.disabled=!1,c.textContent=h,E){alert("Erro ao salvar perfil.");return}f={...f,name:m,avatar_url:u},Ne(f);const x=document.getElementById("settings-avatar-initial");x&&(x.textContent=((y=m[0])==null?void 0:y.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await He(),(p=document.getElementById("btn-invite-corretor"))==null||p.addEventListener("click",async()=>{var y,B;const v=(y=document.getElementById("invite-email"))==null?void 0:y.value.trim(),h=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),E=document.getElementById("btn-invite-corretor"),x=document.getElementById("invite-note");if(!v){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),x&&(x.style.display="none");try{const k=await ce({email:v,password:h,tenant_id:(f==null?void 0:f.tenant_id)||null});if(k.success){const L=document.getElementById("invite-email"),$=document.getElementById("invite-password");L&&(L.value=""),$&&($.value=""),await He(),x&&(k.email_sent===!1?(x.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${g(h)}`,x.style.color="#0f172a"):(x.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",x.style.color="#16a34a"),x.style.display="")}else alert("Erro: "+(k.error||"Falha desconhecida"))}catch(k){alert("Erro ao criar acesso: "+k.message)}finally{E&&(E.disabled=!1,E.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await ke(),(r=document.getElementById("loc-add-city-btn"))==null||r.addEventListener("click",async()=>{const v=document.getElementById("loc-new-city"),h=v==null?void 0:v.value.trim();if(!h)return;const{error:E}=await b.from("locations").insert({type:"cidade",name:h});if(E){alert("Erro ao adicionar cidade.");return}v&&(v.value=""),await ke(),it()}),(d=document.getElementById("loc-add-neighborhood-btn"))==null||d.addEventListener("click",async()=>{var y;const v=parseInt((y=document.getElementById("loc-new-neighborhood-city"))==null?void 0:y.value,10),h=document.getElementById("loc-new-neighborhood"),E=h==null?void 0:h.value.trim();if(!v||!E){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:x}=await b.from("locations").insert({type:"bairro",name:E,parent_id:v});if(x){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await ke()})}}async function He(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),c=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,l=o.id===(f==null?void 0:f.id),s=o.active!==!1,p=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',r=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{await b.from("profiles").update({role:o.value}).eq("id",o.dataset.uid)})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,c=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const l=await ce({action:"toggle",userId:i,active:!c});l.success||alert("Erro: "+(l.error||"Falha desconhecida"))}catch(l){alert("Erro: "+l.message)}await He()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var l,s;const i=o.dataset.uid,c=((s=(l=o.closest(".corretor-item"))==null?void 0:l.querySelector(".corretor-name"))==null?void 0:s.textContent)||"este corretor";if(confirm(`Excluir "${c}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const p=await ce({action:"delete",userId:i});p.success||alert("Erro ao excluir: "+(p.error||"Falha desconhecida"))}catch(p){alert("Erro: "+p.message)}await He()}})})}async function _t(){const{data:e,error:t}=await b.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(Le=e||[],Le)}function me(){return Le.filter(e=>e.type==="cidade")}function ot(e){return Le.filter(t=>t.type==="bairro"&&t.parent_id===e)}function it(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=me();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),t&&(e.value=t)}async function ke(){await _t();const e=me(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${g(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=Le.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const c=e.find(l=>l.id===i.parent_id);return`
          <div class="loc-item">
            <div>
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${g(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const c=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${c}" e todos os bairros vinculados?`))return;const{error:l}=await b.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await ke(),it()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:c}=await b.from("locations").delete().eq("id",i.dataset.id);if(c){alert("Erro ao excluir.");return}await ke()})})}function bt(){var n,a,o,i,c,l,s,p,r,d,m,u,v,h,E,x,y,B,k,L;document.querySelectorAll(".filter-btn").forEach($=>{$.addEventListener("click",()=>{const I=$.closest(".filter-btns"),w=$.classList.contains("active");I.querySelectorAll(".filter-btn").forEach(S=>S.classList.remove("active")),w||$.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var T;const $=(T=document.getElementById("f-city"))==null?void 0:T.value,I=me().find(C=>C.name===$),w=I?ot(I.id):[],S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'+w.map(C=>`<option value="${C.name}">${g(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Se(at(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const $=document.querySelector(".admin-filter-panel");if($){$.querySelectorAll('input[type="text"], input[type="number"]').forEach(w=>{w.value=""}),$.querySelectorAll("select").forEach(w=>{w.selectedIndex=0});const I=document.getElementById("f-neighborhood");I&&(I.innerHTML='<option value="">Todos</option>'),$.querySelectorAll(".filter-btn.active").forEach(w=>w.classList.remove("active"))}Se(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach($=>{$.addEventListener("click",()=>{de($.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach($=>{$.addEventListener("click",()=>{de($.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach($=>{$.addEventListener("click",I=>{I.stopPropagation();const w=$.closest(".topnav-dropdown");w==null||w.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(S=>{S!==w&&S.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach($=>$.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ae),(c=document.getElementById("modal-cancel"))==null||c.addEventListener("click",Ae),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",$=>{$.target.id==="property-modal"&&Ae()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",ie="",Me([]),Ge("Novo Imóvel")}),(p=document.getElementById("logout-btn"))==null||p.addEventListener("click",async()=>{await b.auth.signOut(),location.reload()}),(r=document.getElementById("view-prev"))==null||r.addEventListener("click",()=>{G=(G-1+Q.length)%Q.length,ze()}),(d=document.getElementById("view-next"))==null||d.addEventListener("click",()=>{G=(G+1)%Q.length,ze()}),(m=document.getElementById("view-modal-close"))==null||m.addEventListener("click",Ce),(u=document.getElementById("view-modal-close2"))==null||u.addEventListener("click",Ce),(v=document.getElementById("view-modal"))==null||v.addEventListener("click",$=>{$.target.id==="view-modal"&&Ce()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const $=document.getElementById("share-panel");if(!$)return;const I=$.style.display!=="none";$.style.display=I?"none":"block"}),(E=document.getElementById("share-whatsapp"))==null||E.addEventListener("click",()=>{var H,U,Y;const $=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!$)return;const I=Number((U=document.getElementById("share-panel"))==null?void 0:U.dataset.pid),w=_.find(ae=>ae.id===I),S=(w==null?void 0:w.title)||((Y=document.getElementById("view-modal-title"))==null?void 0:Y.textContent)||"Imóvel",T=w!=null&&w.price?` — ${se(w.price,"pt")}`:"",C=w!=null&&w.reference?` | Ref: ${w.reference}`:"",M=[w==null?void 0:w.neighborhood,w==null?void 0:w.city].filter(Boolean).join(", "),A=M?`
📍 ${M}`:"",D=encodeURIComponent(`Olha esse imóvel que encontrei: *${S}*${T}${C}${A}

${$}`);window.open("https://wa.me/?text="+D,"_blank")}),(x=document.getElementById("share-instagram"))==null||x.addEventListener("click",()=>{var I,w;const $=(I=document.getElementById("share-link-input"))==null?void 0:I.value;$&&((w=navigator.clipboard)==null||w.writeText($),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(y=document.getElementById("share-email"))==null||y.addEventListener("click",()=>{var T,C;const $=(T=document.getElementById("share-link-input"))==null?void 0:T.value;if(!$)return;const I=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",w=encodeURIComponent("Imóvel: "+I),S=encodeURIComponent(`Olá! Segue o link do imóvel:

`+$);window.open("mailto:?subject="+w+"&body="+S,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var I;const $=document.getElementById("share-link-input");$&&((I=navigator.clipboard)==null||I.writeText($.value).then(()=>{const w=document.getElementById("share-copy"),S=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=S},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var M;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===$);if(!I)return;Ce(),R=I.id;const w=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=I.title||"",w.querySelector('[name="rua"]').value=I.rua||"",w.querySelector('[name="numero"]').value=I.numero||"",w.querySelector('[name="city"]').value=I.city||"",w.querySelector('[name="price"]').value=I.price||"",w.querySelector('[name="bedrooms"]').value=I.bedrooms||"",w.querySelector('[name="suites"]').value=I.suites||"",w.querySelector('[name="parking"]').value=I.parking||"",w.querySelector('[name="description"]').value=I.description||"",w.querySelector('[name="construction_status"]').value=I.construction_status||"",w.querySelector('[name="owner_name"]').value=I.owner_name||"",w.querySelector('[name="owner_phone"]').value=I.owner_phone||"",w.querySelector('[name="owner_email"]').value=I.owner_email||"",w.querySelector('[name="owner_notes"]').value=I.owner_notes||"",w.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),ie=I.cover_image||((M=I.images)==null?void 0:M[0])||"",Me(I.images||[]),Ge("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(I=document.getElementById(`tab-${$.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const I=$.target.closest("tr");if(!I)return;const w=Number(I.dataset.id);if(!w)return;const S=_.find(T=>T.id===w);S&&Yt(S)})}document.addEventListener("DOMContentLoaded",async()=>{var l,s,p;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,d=Te(r);if(d)ue(d);else{let m=null;for(const u of[t,"www."+t]){const{data:v}=await b.from("tenants").select("id").eq("domain",u).maybeSingle();if(v!=null&&v.id){m=v;break}}m!=null&&m.id&&(ue(m.id),Xe(r,m.id,24*60*60*1e3))}}await Promise.all([qt(),_t()]),oe=F("company.whatsapp",oe),tt(),Gt(),Vt();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(it(),n.addEventListener("change",()=>{const r=me().find(m=>m.name===n.value),d=r?ot(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+d.map(m=>`<option value="${m.name}">${g(m.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),d=new URLSearchParams(window.location.search),m=r.get("type")||d.get("type")||"",u=wt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||d.has("code"),v=document.getElementById("password-reset-overlay");if(u){o.style.display="none",i&&i.classList.add("hidden"),v&&(v.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async E=>{var $,I;E.preventDefault();const x=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",y=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",B=document.getElementById("password-reset-msg"),k=E.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),x!==y){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:L}=await b.auth.updateUser({password:x});if(L){B&&(B.textContent="Erro: "+L.message,B.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}window.location.href=window.location.pathname}),d.has("code")&&await b.auth.exchangeCodeForSession(d.get("code")??"");return}const{data:{session:h}}=await b.auth.getSession();if(h){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),bt(),ut(),window.lucide&&lucide.createIcons(),f=await ct(h.user.id),!f){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(f.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(f.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const E=document.getElementById("password-reset-overlay");E&&(E.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async x=>{var I,w;x.preventDefault();const y=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",B=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",k=document.getElementById("password-reset-msg"),L=x.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),y!==B){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}if(y.length<6){k&&(k.textContent="Mínimo 6 caracteres.",k.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:$}=await b.auth.updateUser({password:y});if($){k&&(k.textContent="Erro: "+$.message,k.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",f.id),window.location.href=window.location.pathname});return}ue((f==null?void 0:f.tenant_id)||null),Ne(f),mt(f),pt(f.role),await qe(),await yt(f),window.lucide&&lucide.createIcons(),la()}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const E=document.getElementById("login-form");E&&((p=document.getElementById("forgot-password-btn"))==null||p.addEventListener("click",async()=>{var B,k;const x=(k=(B=E.querySelector('input[name="email"]'))==null?void 0:B.value)==null?void 0:k.trim();if(!x){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:y}=await b.auth.resetPasswordForEmail(x,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(y?"Erro: "+y.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),E.addEventListener("submit",async x=>{x.preventDefault();const y=E.querySelector('button[type="submit"]'),B=new FormData(E),k=B.get("email"),L=B.get("password");y&&(y.disabled=!0,y.textContent="Entrando…");try{if(await Ot(k,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),bt(),window.lucide&&lucide.createIcons();const{data:{session:I}}=await b.auth.getSession();if(f=I?await ct(I.user.id):null,!f){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(f.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}ut(),ue((f==null?void 0:f.tenant_id)||null),Ne(f),mt(f),pt(f.role),await qe(),await yt(f),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}catch($){alert("Erro ao fazer login: "+(($==null?void 0:$.message)||String($)))}finally{y&&(y.disabled=!1,y.textContent="Entrar")}}))}}else Fe();await le();const c=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Mt(c),zt(oe),document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var m;const d=(m=r.closest(".nav-dropdown"))==null?void 0:m.querySelector(".nav-dropdown-menu");d&&r.addEventListener("click",u=>{u.stopPropagation(),d.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(v=>{v!==d&&v.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function ua(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:c}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!c){const l=_.findIndex(s=>s.id===o.id);l>=0&&(_[l].reference=i),n++}}Se(at(_))}async function ga(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const c=await fa(i);a.push(c),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(c=>c.id===t.id);i>=0&&(_[i].images=a)}}Se(at(_))}}async function fa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,c=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const p=document.createElement("canvas"),r=1200;let d=s.width,m=s.height;d>r&&(m=Math.round(m*r/d),d=r),p.width=d,p.height=m;const u=p.getContext("2d");u.drawImage(s,0,0,d,m);const v=h=>{if(h){const E=Math.round(d*.18),x=Math.round(h.naturalHeight*E/h.naturalWidth),y=Math.round(d*.02);u.globalAlpha=.45,u.drawImage(h,d-E-y,m-x-y,E,x),u.globalAlpha=1}p.toBlob(async E=>{try{const x=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:y}=await b.storage.from("imoveis").upload(x,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(y){console.error("Upload watermark error:",y),l(e);return}const{data:{publicUrl:B}}=b.storage.from("imoveis").getPublicUrl(x);l(B)}catch(x){console.error("Watermark upload exception:",x),l(e)}},"image/jpeg",.82)};if(c){const h=new Image;h.onload=()=>{URL.revokeObjectURL(c),v(h)},h.onerror=()=>{URL.revokeObjectURL(c),v(null)},h.src=c}else v(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function st(e,t="assets"){const n=await _e(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `;function s(r,d,m){const u=document.getElementById(r),v=document.getElementById(d);u==null||u.addEventListener("input",h=>{v.value=h.target.value,m()}),v==null||v.addEventListener("input",h=>{/^#[0-9a-fA-F]{6}$/.test(h.target.value)&&(u.value=h.target.value,m())})}function p(){var d,m,u,v;const r=((d=document.getElementById("col-accent-hex"))==null?void 0:d.value)||"#b8962e";(m=document.getElementById("vp-bar"))==null||m.style.setProperty("background",r),(u=document.getElementById("vp-dot"))==null||u.style.setProperty("background",r),(v=document.getElementById("vp-btn"))==null||v.style.setProperty("background",r),document.documentElement.style.setProperty("--accent",r)}s("col-accent","col-accent-hex",p),s("col-primary","col-primary-hex",()=>{}),s("col-secondary","col-secondary-hex",()=>{}),p(),document.getElementById("vis-hero-file").addEventListener("change",async r=>{const d=r.target.files[0];if(d)try{const m=await st(d,"hero");document.getElementById("vis-hero-url").value=m;const u=document.getElementById("vis-hero-preview");u.innerHTML=`<img src="${m}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,u.style.display=""}catch(m){alert("Erro no upload: "+m.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const r=document.getElementById("visual-save-colors");r.disabled=!0,r.textContent="Salvando…";const d=await ye([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);d&&tt(),r.disabled=!1,r.textContent="Salvar Cores",V(document.getElementById("visual-colors-msg"),d)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",p())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const r=document.getElementById("visual-save-images");r.disabled=!0,r.textContent="Salvando…";const d=await ye([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);r.disabled=!1,r.textContent="Salvar Imagens",V(document.getElementById("visual-images-msg"),d)})}async function ba(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("*").eq("tenant_id",z()),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=(s,p)=>{var r;return g(((r=n[s])==null?void 0:r[`value_${p}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},c=s=>o.map(p=>`<button class="content-tab${p===s?" active":""}" data-lang="${p}">${i[p]}</button>`).join(""),l=s=>`
  ...
  `,document.getElementById("sc-tabs").addEventListener("click",s=>{var r;const p=s.target.closest(".content-tab");p&&(document.querySelectorAll("#sc-tabs .content-tab").forEach(d=>d.classList.remove("active")),document.querySelectorAll("#sc-panels .content-panel").forEach(d=>d.classList.remove("active")),p.classList.add("active"),(r=document.querySelector(`#sc-panels [data-panel="${p.dataset.lang}"]`))==null||r.classList.add("active"))}),document.getElementById("sc-save-btn").addEventListener("click",async()=>{const s=document.getElementById("sc-save-btn");s.disabled=!0,s.textContent="Salvando…";const p={};document.querySelectorAll(".sc-field").forEach(d=>{const m=d.dataset.key,u=d.dataset.lang;p[m]||(p[m]={}),p[m][u]=d.value});let r=!0;for(const[d,m]of Object.entries(p))await De(d,{pt:m.pt,en:m.en,es:m.es})||(r=!1);s.disabled=!1,s.textContent="Salvar Conteúdo",V(document.getElementById("sc-save-msg"),r)}),document.getElementById("seo-save-btn").addEventListener("click",async()=>{const s=document.getElementById("seo-save-btn");s.disabled=!0,s.textContent="Salvando…";const p=document.getElementById("seo-title").value.trim(),r=document.getElementById("seo-desc").value.trim(),d=await De("seo.title_pt",{pt:p,en:p,es:p})&&await De("seo.description_pt",{pt:r,en:r,es:r});s.disabled=!1,s.textContent="Salvar SEO",V(document.getElementById("seo-save-msg"),d)})}async function ha(){const e=document.getElementById("section-crm-config");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await K())}async function K(){const e=document.getElementById("crm-body");if(!e)return;const t=z(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",t).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),c=n||[],l=c.find(u=>u.is_default)||c[0],s=c.map(u=>`<option value="${u.id}"${u.id===(l==null?void 0:l.id)?" selected":""}>${g(u.name)}</option>`).join(""),r=(a||[]).filter(u=>u.pipeline_id===(l==null?void 0:l.id)).map(u=>`
    ...
    </div>`).join("")||'<p style="color:#9ca3af;font-size:14px;margin:0">Nenhuma etapa cadastrada.</p>',d=(o||[]).map(u=>`<span class="tag-chip" style="background:${u.color}" data-id="${u.id}">
      ${g(u.name)}
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,h=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await b.from("crm_stages").insert({pipeline_id:h,name:u,color:v,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-stage").value="",await K())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await b.from("crm_stages").delete().eq("id",u.dataset.id),await K())})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async v=>{await b.from("crm_stages").update({color:v.target.value}).eq("id",u.dataset.sid);const h=u.closest(".stage-item").querySelector(".stage-color-dot");h&&(h.style.background=v.target.value)})}),document.getElementById("crm-add-tag").addEventListener("click",async()=>{const u=document.getElementById("crm-new-tag").value.trim(),v=document.getElementById("crm-new-tag-color").value;u&&(await b.from("crm_tags").insert({name:u,color:v,tenant_id:z()}),document.getElementById("crm-new-tag").value="",await K())}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await b.from("crm_tags").delete().eq("id",u.dataset.id),await K()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,h=document.getElementById("crm-new-status-final").checked;u&&(await b.from("crm_lead_statuses").insert({name:u,color:v,is_final:h,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-status").value="",await K())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await b.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await K())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var h;const u=(h=prompt("Nome do novo funil:"))==null?void 0:h.trim();if(!u)return;const{error:v}=await b.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:z()});if(v){alert("Erro ao criar funil: "+v.message);return}We=!1,await K()})}async function xa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var s;return g(((s=n[l])==null?void 0:s.value)||"")},o=l=>{var s;return(s=n[l])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],c=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var d;const l=document.getElementById("intg-save-tracking");l.disabled=!0,l.textContent="Salvando…";let s=!0;const p=document.querySelectorAll(".intg-val"),r=document.querySelectorAll(".intg-toggle");for(let m=0;m<p.length;m++){const u=p[m].dataset.key,v=p[m].value.trim(),h=((d=r[m])==null?void 0:d.checked)??!1;await Pe(u,v,h)||(s=!1)}l.disabled=!1,l.textContent="Salvar Integrações",V(document.getElementById("intg-tracking-msg"),s)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const l=document.getElementById("intg-save-smtp");l.disabled=!0,l.textContent="Salvando…";const s=document.querySelectorAll(".smtp-field");let p=!0;for(const d of s)await Pe(d.dataset.key,d.value.trim(),!0)||(p=!1);const r=document.getElementById("smtp-pass").value;r&&(await Pe("smtp_pass",r,!0)||(p=!1)),l.disabled=!1,l.textContent="Salvar SMTP",V(document.getElementById("intg-smtp-msg"),p)})}async function Ea(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(c=>{c.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),c.classList.add("active");const l=e.querySelector(`#sa-panel-${c.dataset.tab}`);l&&l.classList.remove("hidden"),c.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&ee(),c.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Ia(),c.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&ht(),c.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&xt(),c.dataset.tab==="platform"&&Et()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",ht),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",ee),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",xt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Ba()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",$a),ee(),Et())}async function ee(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=b.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(p=>{var r,d;return!t||((r=p.name)==null?void 0:r.toLowerCase().includes(t))||((d=p.slug)==null?void 0:d.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const c=p=>p.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(p=>{var r;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(p=>{p.addEventListener("click",async r=>{r.stopPropagation();const d=p.dataset.active==="true";await b.from("tenants").update({active:!d}).eq("id",p.dataset.id),ee()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(p=>{p.addEventListener("click",()=>{const r=(i||[]).find(d=>String(d.id)===String(p.dataset.id));r&&La(r)})})}async function Ia(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await b.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `}).join("")}async function Et(){const[e,t,n,a]=await Promise.all([b.from("tenants").select("id",{count:"exact",head:!0}),b.from("profiles").select("id",{count:"exact",head:!0}),b.from("subscriptions").select("id",{count:"exact",head:!0}).eq("status","active"),b.from("properties").select("id",{count:"exact",head:!0}).eq("published",!0)]),o=(i,c)=>{const l=document.getElementById(i);l&&(l.textContent=c??"—")};o("sa-stat-tenants",e.count),o("sa-stat-users",t.count),o("sa-stat-subs",n.count),o("sa-stat-props",a.count)}async function $a(){var n,a,o;const e=document.getElementById("sa-plat-save"),t=document.getElementById("sa-plat-msg");e&&(e.disabled=!0,e.textContent="Salvando…"),await ye([{key:"platform.name",value:((n=document.getElementById("sa-plat-name"))==null?void 0:n.value)||""},{key:"platform.support_email",value:((a=document.getElementById("sa-plat-email"))==null?void 0:a.value)||""},{key:"platform.trial_days",value:((o=document.getElementById("sa-plat-trial"))==null?void 0:o.value)||"14"}]),e&&(e.disabled=!1,e.textContent="Salvar Configurações"),V(t,!0)}function ka(e){return e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function Ba(){var a,o,i,c,l,s;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const t=document.createElement("div");t.id="sa-new-tenant-modal",t.className="sa-modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(t),b.from("plans").select("id, name").then(({data:p})=>{const r=document.getElementById("nt-plan");r&&p&&(r.innerHTML='<option value="">Sem plano</option>'+p.map(d=>`<option value="${d.id}">${g(d.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",p=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=ka(p.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",p=>{p.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const p=document.getElementById("nt-admin-password");p.type=p.type==="password"?"text":"password"});const n=()=>t.remove();(c=document.getElementById("sa-modal-close-btn"))==null||c.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",p=>{p.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var L,$,I,w,S,T,C,M,A,D,H,U;const p=($=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:$.trim(),r=(w=(I=document.getElementById("nt-slug"))==null?void 0:I.value)==null?void 0:w.trim(),d=(T=(S=document.getElementById("nt-domain"))==null?void 0:S.value)==null?void 0:T.trim(),m=(C=document.getElementById("nt-plan"))==null?void 0:C.value,u=(A=(M=document.getElementById("nt-admin-email"))==null?void 0:M.value)==null?void 0:A.trim(),v=(H=(D=document.getElementById("nt-admin-password"))==null?void 0:D.value)==null?void 0:H.trim(),h=document.getElementById("nt-msg"),E=document.getElementById("nt-save");if(!p||!r){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!v||v.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}E.disabled=!0,E.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:x,error:y}=await b.from("tenants").insert({name:p,slug:r,domain:d||null,plan_id:m||null,active:!0}).select();if(y){E.disabled=!1,E.textContent="Criar Imobiliária",h.textContent="❌ "+y.message,h.style.color="#ef4444";return}const B=(U=x==null?void 0:x[0])==null?void 0:U.id;h.textContent="⏳ Criando usuário admin…";const k=await ce({email:u,password:v,role:"admin",tenant_id:B});if(!(k!=null&&k.success)){E.disabled=!1,E.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g((k==null?void 0:k.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),ee()},3e3);return}B&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await b.from("profiles").update({tenant_id:B}).eq("id",k.user_id),E.disabled=!1,E.textContent="Criar Imobiliária",k.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Ct(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",et(e,o.dataset.tab)})}),et(e,"properties")}function Sa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,p,r="text",d="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
      <label style="font-size:11px;font-weight:700;color:#64748b;letter-spacing:.05em;">${s}</label>
      <input id="${l}" type="${r}" value="${g(String(p||""))}" ${d}
        style="border:1px solid #e2e8f0;border-radius:8px;padding:9px 12px;font-size:14px;color:#0f172a;outline:none;">
    </div>`,i=(l,s,p,r)=>`<div style="display:flex;flex-direction:column;gap:4px;">
      <label style="font-size:11px;font-weight:700;color:#64748b;letter-spacing:.05em;">${s}</label>
      <select id="${l}" style="border:1px solid #e2e8f0;border-radius:8px;padding:9px 12px;font-size:14px;color:#0f172a;background:#fff;">
        ${p.map(([d,m])=>`<option value="${d}"${r===d?" selected":""}>${m}</option>`).join("")}
      </select>
    </div>`;a.innerHTML=`
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
    ...
    </div>`,document.body.appendChild(a);const c=()=>a.remove();document.getElementById("tpe-close").addEventListener("click",c),document.getElementById("tpe-cancel").addEventListener("click",c),a.addEventListener("click",l=>{l.target===a&&c()}),document.getElementById("tpe-save").addEventListener("click",async()=>{const l=document.getElementById("tpe-save"),s=document.getElementById("tpe-msg"),p=document.getElementById("tpe-title").value.trim();if(!p){s.style.color="#ef4444",s.textContent="Título é obrigatório.";return}l.disabled=!0,l.textContent="Salvando…";const r={title:p,price:document.getElementById("tpe-price").value.trim()||null,area:document.getElementById("tpe-area").value.trim()||null,bedrooms:document.getElementById("tpe-bedrooms").value||null,suites:document.getElementById("tpe-suites").value||null,parking:document.getElementById("tpe-parking").value||null,reference:document.getElementById("tpe-reference").value.trim()||null,city:document.getElementById("tpe-city").value.trim()||null,neighborhood:document.getElementById("tpe-neighborhood").value.trim()||null,rua:document.getElementById("tpe-rua").value.trim()||null,numero:document.getElementById("tpe-numero").value.trim()||null,construction_status:document.getElementById("tpe-construction").value||null,published:document.getElementById("tpe-published").value==="true",description:document.getElementById("tpe-description").value.trim()||null},{error:d}=await b.from("properties").update(r).eq("id",e.id);if(d){s.style.color="#ef4444",s.textContent="Erro: "+d.message,l.disabled=!1,l.textContent="💾 Salvar";return}s.style.color="#16a34a",s.textContent="✅ Salvo!",setTimeout(()=>{c(),typeof t=="function"&&t()},800)})}async function et(e,t){var i,c,l,s,p;const n=document.getElementById("tp-content");if(!n)return;n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;font-size:14px;">Carregando…</div>';const a=()=>et(e,t),o=(r,d)=>`background:${r};color:${d};border:none;border-radius:6px;padding:5px 12px;cursor:pointer;font-size:12px;font-weight:600;white-space:nowrap;`;if(t==="properties"){const{data:r}=await b.from("properties").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1});if(!(r!=null&&r.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">🏠</div><p style="font-size:14px;">Nenhum imóvel cadastrado ainda.</p></div>';return}n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${r.map(d=>{var m;return`
            <tr data-pid="${d.id}" style="border-top:1px solid #f1f5f9;">
              <td style="padding:12px 16px;">
                <div style="display:flex;align-items:center;gap:10px;">
                  ${(m=d.images)!=null&&m[0]?`<img src="${d.images[0]}" style="width:52px;height:38px;object-fit:cover;border-radius:6px;flex-shrink:0;">`:'<div style="width:52px;height:38px;background:#e2e8f0;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0;">🏠</div>'}
                  <div><div style="font-weight:600;font-size:13px;color:#0f172a;">${g(d.title||"")}</div><div style="font-size:11px;color:#94a3b8;">${g(d.reference||"")}</div></div>
                </div>
              </td>
              <td style="padding:12px 16px;font-size:13px;color:#475569;">${g([d.neighborhood,d.city].filter(Boolean).join(", "))}</td>
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${g(se(d.price,"pt"))}</td>
              ...
              <td style="padding:12px 16px;text-align:center;">
                <div style="display:flex;gap:6px;justify-content:center;">
                  <button class="tp-prop-edit" data-pid="${d.id}" style="${o("#eff6ff","#1d4ed8")}">✏️ Editar</button>
                  <button class="tp-prop-toggle" data-pid="${d.id}" data-pub="${d.published?"1":"0"}" style="${o(d.published?"#fef3c7":"#dcfce7",d.published?"#92400e":"#15803d")}">${d.published?"Despublicar":"Publicar"}</button>
                  <button class="tp-prop-del" data-pid="${d.id}" style="${o("#fee2e2","#dc2626")}">Excluir</button>
                </div>
              </td>
            </tr>`}).join("")}
          </tbody>
        </table></div>
      </div>`,n.querySelectorAll(".tp-prop-edit").forEach(d=>{d.addEventListener("click",()=>{const m=Number(d.dataset.pid),u=r.find(v=>v.id===m);u&&Sa(u,a)})}),n.querySelectorAll(".tp-prop-toggle").forEach(d=>{d.addEventListener("click",async()=>{const m=Number(d.dataset.pid),u=d.dataset.pub==="1";d.disabled=!0,d.textContent="…",await b.from("properties").update({published:!u}).eq("id",m),a()})}),n.querySelectorAll(".tp-prop-del").forEach(d=>{d.addEventListener("click",async()=>{confirm("Excluir este imóvel permanentemente?")&&(d.disabled=!0,d.textContent="…",await b.from("properties").delete().eq("id",Number(d.dataset.pid)),a())})})}if(t==="leads"){const{data:r}=await b.from("leads").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}).limit(200);if(!(r!=null&&r.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">📋</div><p style="font-size:14px;">Nenhum lead ainda.</p></div>';return}const d=m=>({novo:"#dbeafe,#1d4ed8",contato:"#fef3c7,#92400e",proposta:"#ede9fe,#6d28d9",fechado:"#dcfce7,#15803d"})[m]||"#f1f5f9,#64748b";n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${r.map(m=>{const[u,v]=d(m.stage||m.status||"").split(","),h=(m.phone||"").replace(/\D/g,"");return`<tr data-lid="${m.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${u};color:${v};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${g(m.stage||m.status||"Novo")}</span></td>
      ...
      </div>`,n.querySelectorAll(".tp-lead-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir este lead permanentemente?")&&(m.disabled=!0,m.textContent="…",await b.from("leads").delete().eq("id",m.dataset.lid),a())})})}if(t==="users"){const{data:r}=await b.from("profiles").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}),d='<button id="tp-add-corretor" style="background:#0a1628;color:#fff;border:none;border-radius:8px;padding:8px 16px;cursor:pointer;font-size:13px;font-weight:600;">+ Adicionar Usuário</button>';if(!(r!=null&&r.length)){n.innerHTML=`<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">👥</div><p style="font-size:14px;margin-bottom:16px;">Nenhum corretor cadastrado ainda.</p>${d}</div>`,(i=n.querySelector("#tp-add-corretor"))==null||i.addEventListener("click",()=>Ve(e.id,a));return}n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        <div style="padding:16px 20px;border-bottom:1px solid #e2e8f0;display:flex;justify-content:space-between;align-items:center;">
      ...
      </div>`,(c=n.querySelector("#tp-add-corretor"))==null||c.addEventListener("click",()=>Ve(e.id,a)),n.querySelectorAll(".tp-role-sel").forEach(m=>{m.addEventListener("change",async()=>{const u=m.dataset.uid;m.disabled=!0,await b.from("profiles").update({role:m.value}).eq("id",u),m.disabled=!1})}),n.querySelectorAll(".tp-user-toggle").forEach(m=>{m.addEventListener("click",async()=>{const u=m.dataset.uid,v=m.dataset.active==="1";m.disabled=!0,m.textContent="…",await b.from("profiles").update({active:!v}).eq("id",u),a()})}),n.querySelectorAll(".tp-user-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover este usuário da imobiliária? O acesso ao sistema será excluído permanentemente.")&&(m.disabled=!0,m.textContent="…",await ce({action:"delete",userId:m.dataset.uid}),a())})})}if(t==="api"){const r="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api",d=(e.domain||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim(),m=d?`https://${d}`:`https://omarcorretor.com.br/demo.html?key=${e.id}`,u=d?"🌐 Site da Imobiliária":"🌐 Site Demonstração",v=d?"Site oficial da imobiliária integrado ao CRM.":"Mostre ao cliente como o site integrado funciona com os imóveis desta imobiliária.",h=d?"Abrir site →":"Abrir site demo →";n.innerHTML=`
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var y;(y=navigator.clipboard)==null||y.writeText(e.id);const E=document.getElementById("tp-copy-key"),x=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=x},2e3)})}if(t==="config"){const{data:r}=await b.from("settings").select("key,value").eq("tenant_id",e.id),d={};r==null||r.forEach(u=>{d[u.key]=u.value});const m=(u,v)=>`
      ...
      <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);max-width:560px;">
        ...
        ${m("NOME DA EMPRESA",d["company.name"]||e.name)}
        ${m("TELEFONE",d["company.phone"])}
        ${m("E-MAIL",d["company.email"])}
        ${m("WHATSAPP",d["company.whatsapp"])}
        ${m("CIDADE",d["company.city"])}
      ...
      </div>`,(p=document.getElementById("tp-open-edit"))==null||p.addEventListener("click",()=>Ct(e))}}function Ct(e){var p,r,d,m,u,v,h,E;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([x,y,B])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:x})=>{const y=document.getElementById("et-plan");y&&x&&(y.innerHTML='<option value="">Sem plano</option>'+x.map(B=>`<option value="${B.id}"${String(B.id)===String(e.plan_id)?" selected":""}>${g(B.name)}</option>`).join(""))}),(p=document.getElementById("et-logo-input"))==null||p.addEventListener("change",x=>{const y=x.target.files[0];if(!y)return;const B=URL.createObjectURL(y),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${B}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var x;(x=document.getElementById("et-logo-input"))==null||x.click()}),(d=document.getElementById("et-pwd-toggle"))==null||d.addEventListener("click",()=>{const x=document.getElementById("et-admin-password");x.type=x.type==="password"?"text":"password"}),(m=document.getElementById("et-copy-key"))==null||m.addEventListener("click",()=>{var k,L;const x=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!x)return;(L=navigator.clipboard)==null||L.writeText(x);const y=document.getElementById("et-copy-key"),B=y.textContent;y.textContent="✅ Copiada!",setTimeout(()=>{y.textContent=B},2e3)});const o=["dados","config","api"];function i(x){o.forEach(y=>{document.getElementById(`et-pane-${y}`).style.display=y===x?"":"none";const B=document.getElementById(`et-tab-${y}`);B.style.borderBottomColor=y===x?"#2563eb":"transparent",B.style.color=y===x?"#2563eb":"#64748b",B.style.fontWeight=y===x?"600":"500"}),x==="config"&&l()}o.forEach(x=>{var y;return(y=document.getElementById(`et-tab-${x}`))==null?void 0:y.addEventListener("click",()=>i(x))});let c=!1;async function l(){var B;if(c)return;c=!0;const{data:x}=await b.from("settings").select("key,value").eq("tenant_id",e.id),y={};x==null||x.forEach(k=>{y[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${g(y["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${g(y["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${g(y["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${g(y["company.city"]||y["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${g(y["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
    ...
    `,(B=document.getElementById("et-cfg-save"))==null||B.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const $=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),I=document.getElementById("et-cfg-phone").value.trim(),w=document.getElementById("et-cfg-email").value.trim(),S=document.getElementById("et-cfg-city").value.trim(),T=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await b.from("settings").upsert([{key:"company.whatsapp",value:$,tenant_id:e.id},{key:"company.phone",value:I,tenant_id:e.id},{key:"company.email",value:w,tenant_id:e.id},{key:"company.city",value:S,tenant_id:e.id},{key:"company.address",value:S,tenant_id:e.id},{key:"company.slogan",value:T,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const s=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",s),(v=document.getElementById("et-cancel"))==null||v.addEventListener("click",s),n.addEventListener("click",x=>{x.target===n&&s()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const y=document.getElementById("et-delete");y.disabled=!0,y.textContent="Excluindo…";const{error:B}=await b.from("tenants").delete().eq("id",e.id);if(B){alert("Erro ao excluir: "+B.message),y.disabled=!1,y.textContent="🗑️ Excluir";return}s(),ee()}),(E=document.getElementById("et-save"))==null||E.addEventListener("click",async()=>{var M,A,D,H,U,Y,ae,Ee,we,O,pe,lt;const x=(A=(M=document.getElementById("et-name"))==null?void 0:M.value)==null?void 0:A.trim(),y=(H=(D=document.getElementById("et-slug"))==null?void 0:D.value)==null?void 0:H.trim(),B=(Y=(U=document.getElementById("et-domain"))==null?void 0:U.value)==null?void 0:Y.trim(),k=(ae=document.getElementById("et-plan"))==null?void 0:ae.value,L=(we=(Ee=document.getElementById("et-admin-email"))==null?void 0:Ee.value)==null?void 0:we.trim(),$=(pe=(O=document.getElementById("et-admin-password"))==null?void 0:O.value)==null?void 0:pe.trim(),I=(lt=document.getElementById("et-logo-input"))==null?void 0:lt.files[0],w=document.getElementById("et-msg"),S=document.getElementById("et-save");if(!x){w.textContent="❌ Nome é obrigatório.",w.style.color="#ef4444";return}S.disabled=!0,S.textContent="Salvando…",w.textContent="⏳ Salvando…",w.style.color="#64748b";let T=e.logo_url;if(I)try{const q=await _e(I,256,.85),dt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Tt}=await b.storage.from("imoveis").upload(dt,q,{contentType:"image/jpeg",upsert:!0});if(!Tt){const{data:{publicUrl:At}}=b.storage.from("imoveis").getPublicUrl(dt);T=At}}catch(q){console.error("Logo upload:",q)}const{error:C}=await b.from("tenants").update({name:x,slug:y||e.slug,domain:B||null,plan_id:k||null,logo_url:T}).eq("id",e.id);if(C){S.disabled=!1,S.textContent="Salvar",w.textContent="❌ "+C.message,w.style.color="#ef4444";return}if(L&&$&&$.length>=6){w.textContent="⏳ Criando usuário admin…";const q=await ce({email:L,password:$,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),w.textContent="✅ Salvo e admin criado!",w.style.color="#22c55e"):(w.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),w.style.color="#f59e0b")}else w.textContent="✅ Imobiliária atualizada!",w.style.color="#22c55e";S.disabled=!1,S.textContent="Salvar",setTimeout(()=>{s(),ee()},1200)})}function _a(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ca)}function Ca(){const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
