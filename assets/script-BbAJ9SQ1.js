...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}U=n||[],qe()}function pa(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function qe(){const e=document.getElementById("tarefas-list");if(!e)return;let t=U;if($e==="pending"&&(t=U.filter(a=>a.status!=="done")),$e==="done"&&(t=U.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),E=document.createElement("a");E.href=URL.createObjectURL(u),E.download="modelo_contatos.csv",E.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",mn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",un)))}async function gt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;te=a||[],be()}function be(){var l,d,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?te.filter(s=>(s.name||"").toLowerCase().includes(e)||(s.email||"").toLowerCase().includes(e)||(s.phone||"").toLowerCase().includes(e)):te,n=t.length,a=Math.max(1,Math.ceil(n/De));P>a&&(P=a);const o=t.slice((P-1)*De,P*De),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(s=>`
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const r=document.getElementById("contatos-pagination");if(r){const s=n===0?0:(P-1)*De+1,p=Math.min(P*De,n);r.innerHTML=`
  ...
  `,document.body.appendChild($);const y=()=>$.remove();(k=document.getElementById("cm-close"))==null||k.addEventListener("click",y),(S=document.getElementById("cm-cancel"))==null||S.addEventListener("click",y),$.addEventListener("click",v=>{v.target===$&&y()}),(I=document.getElementById("cm-pipe"))==null||I.addEventListener("change",v=>{const x=document.getElementById("cm-stage");x&&(x.innerHTML=w(v.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const v=te.findIndex(x=>String(x.id)===String(e.id));v>=0&&te.splice(v,1),y(),be()}),(m=document.getElementById("cm-save"))==null||m.addEventListener("click",async()=>{var z,O,G,re,ge,Te,Ae;const v=document.getElementById("contato-form");if(!v.checkValidity()){v.reportValidity();return}const x=new FormData(v),_=document.getElementById("cm-save");_.disabled=!0,_.textContent="Salvando…";const B=x.getAll("tag"),C=x.get("pipeline_id")||null,q={name:(z=x.get("name"))==null?void 0:z.trim(),company:((O=x.get("company"))==null?void 0:O.trim())||null,email:((G=x.get("email"))==null?void 0:G.trim())||null,phone:((re=x.get("phone"))==null?void 0:re.trim())||null,job_title:((ge=x.get("job_title"))==null?void 0:ge.trim())||null,city_interest:((Te=x.get("city_interest"))==null?void 0:Te.trim())||null,notes:((Ae=x.get("notes"))==null?void 0:Ae.trim())||null,pipeline_id:C,stage:x.get("stage")||null,status:x.get("status")||null,tags:B,assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await h.from("leads").update(q).eq("id",e.id),!A){const W=te.findIndex(Ee=>String(Ee.id)===String(e.id));W>=0&&(te[W]={...te[W],...q})}}else{const{data:W,error:Ee}=await h.from("leads").insert(q).select();A=Ee,!A&&(W!=null&&W[0])&&te.unshift(W[0])}if(_.disabled=!1,_.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}y(),be()})}let Be=[];function mn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Be=a.target.result.split(`
