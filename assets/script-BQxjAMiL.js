        ...
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-actions">
              ...
              <a href="https://wa.me/${ne}?text=${B}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(f=>{var L;const w=(L=f.images)!=null&&L.length?f.images:ie,k=w.length,B=encodeURIComponent(`Olá! Tenho interesse no imóvel *${f.title}*${f.reference?` (Ref: ${f.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="card property-card">
        ...
        <div class="property-info">
          ...
          <div style="display:flex;gap:8px;margin-top:6px">
            ...
            <a class="btn hero-whatsapp-btn" href="https://wa.me/${ne}?text=${B}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
