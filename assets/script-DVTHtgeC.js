...
`+((p==null?void 0:p.message)||JSON.stringify(p)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await jt(o),await Ae()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((v==null?void 0:v.role)!=="admin"&&(v==null?void 0:v.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(l=>l.id===o);if(!i)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const d=document.getElementById("adminPublished");d&&(d.value=i.published===!0?"true":"false");const s=document.getElementById("adminCitySelect");s&&(s.value=i.city||"",s.dispatchEvent(new Event("change")),setTimeout(()=>{const l=document.getElementById("adminNeighborhood");l&&(l.value=i.neighborhood||"")},50)),oe=i.cover_image||((a=i.images)==null?void 0:a[0])||"",qe(i.images||[]),Fe("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Q=[],G=0;function Vt(e){var r,m;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((r=e.images)==null?void 0:r[0])||ie[0];document.getElementById("view-thumb-preview").src=i,Q=(m=e.images)!=null&&m.length?e.images:ie,G=0,Me(),document.getElementById("view-price").textContent=se(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),s=document.getElementById("view-condominium");s&&(s.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const l="https://omarcorretor.com.br/property.html?id="+e.id,p=document.getElementById("share-link-input");p&&(p.value=l);const c=document.getElementById("share-panel");c&&(c.style.display="none",c.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function _e(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Me(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Q[G],e.alt=`Foto ${G+1}`;const i=Q.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${G+1} / ${Q.length}`:"",o.innerHTML=i?Q.map((d,s)=>`<img src="${d}" class="view-thumb${s===G?" active":""}" data-i="${s}" alt="Foto ${s+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{G=+d.dataset.i,Me()})})}async function dt(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function ze(e){var r,m;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((r=i[0])==null?void 0:r.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const s=document.getElementById("avatar-dd-name"),l=document.getElementById("avatar-dd-role"),p=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");s&&(s.textContent=i),l&&(l.textContent=d),e!=null&&e.avatar_url&&p?(p.src=e.avatar_url,p.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",c.style.display=""),p&&(p.style.display="none"))}async function Wt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==Ie,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await y.from("tenants").select("domain").eq("id",n).maybeSingle(),s=window.location.hostname.replace(/^www\./,""),l=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();l&&l!==s&&(t.href=`https://${l}`)}catch{}}function le(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),W(),e==="contatos"&&sa(),e==="funil"&&Kt(),e==="tarefas"&&Zt()}function rt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ga,visual:fa,"site-config":va,"crm-config":ya,integracoes:ba,midia:ha}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>xa(),{once:!0}),window.lucide&&lucide.createIcons()}}function W(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Jt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
      ...
      <div class="modal-footer">
        ...
        <div class="kanban-card" draggable="true" data-id="${l.id}" data-stage="${g(i.name)}" style="cursor:pointer;">
          ...
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(l.tags)?l.tags.map(r=>{const m=Ve[r],u=(m==null?void 0:m.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${u}18;color:${u};border:1px solid ${u}44;">${g(r)}</span>`}).join(""):""}
          </div>
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>{s.style.transform="translateX(0)"});const l=()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),250)};document.getElementById("ldp-close").addEventListener("click",l),document.getElementById("ldp-save").addEventListener("click",async()=>{var f,w;const r=document.getElementById("ldp-save"),m=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){m.style.color="#ef4444",m.textContent="Nome é obrigatório.";return}r.disabled=!0,r.textContent="Salvando…";const b=[...s.querySelectorAll("input[type=checkbox]:checked")].map(B=>B.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((f=document.getElementById("ldp-stage"))==null?void 0:f.value)||null,status:((w=document.getElementById("ldp-status"))==null?void 0:w.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:b,tenant_id:z()};let x;if(t?{error:x}=await y.from("leads").insert(h):{error:x}=await y.from("leads").update(h).eq("id",e.id),r.disabled=!1,r.textContent="💾 Salvar",x){m.style.color="#ef4444",m.textContent="Erro: "+x.message;return}m.style.color="#22c55e",m.textContent="✅ Salvo!",setTimeout(()=>{l(),je()},700)}),(c=document.getElementById("ldp-delete"))==null||c.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await y.from("leads").delete().eq("id",e.id),l(),je())})}let j=[],pt=!1,ue="pending";async function Zt(){var e;pt||(pt=!0,await ea(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>wt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),ue=t.dataset.filter,ye()})}))}async function ea(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=y.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(d);const s=()=>d.remove();(l=document.getElementById("tm-close"))==null||l.addEventListener("click",s),(p=document.getElementById("tm-cancel"))==null||p.addEventListener("click",s),d.addEventListener("click",m=>{m.target===d&&s()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const m=a?"pending":"done";await y.from("tasks").update({status:m}).eq("id",e.id);const u=j.find(b=>String(b.id)===String(e.id));u&&(u.status=m),s(),m==="done"&&(ue="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),ye()}),(r=document.getElementById("tm-save"))==null||r.addEventListener("click",async()=>{var f,w;const m=document.getElementById("tarefa-form");if(!m.checkValidity()){m.reportValidity();return}const u=new FormData(m),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const h={title:(f=u.get("title"))==null?void 0:f.trim(),description:((w=u.get("description"))==null?void 0:w.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null};let x;if(n){if({error:x}=await y.from("tasks").update(h).eq("id",e.id),!x){const B=j.findIndex($=>String($.id)===String(e.id));B>=0&&(j[B]={...j[B],...h})}}else{const{data:B,error:$}=await y.from("tasks").insert(h).select();x=$,!x&&(B!=null&&B[0])&&j.unshift(B[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}s(),ye()})}async function ta(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;v==null||v.role,v==null||v.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,m=new Blob([r],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(m),u.download="modelo_contatos.csv",u.click()}),(l=document.getElementById("import-csv-file"))==null||l.addEventListener("change",la),(p=document.getElementById("import-modal-confirm"))==null||p.addEventListener("click",da)))}async function It(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:a}=await t;X=a||[],de()}function de(){var s,l,p;const e=(((s=document.getElementById("contato-search"))==null?void 0:s.value)||"").toLowerCase(),t=e?X.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):X,n=t.length,a=Math.max(1,Math.ceil(n/Ee));N>a&&(N=a);const o=t.slice((N-1)*Ee,N*Ee),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const c=n===0?0:(N-1)*Ee+1,r=Math.min(N*Ee,n);d.innerHTML=`
    ...
    `,(l=d.querySelector("#pag-prev"))==null||l.addEventListener("click",()=>{N--,de()}),(p=d.querySelector("#pag-next"))==null||p.addEventListener("click",()=>{N++,de()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(c=>{c.addEventListener("click",r=>{r.preventDefault();const m=c.dataset.id,u=X.find(b=>String(b.id)===String(m));u&&$t(u)})})}async function $t(e=null){var f,w,B,$,L,k;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:d}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",a).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),s=o||[],l=i||[],p=d||[],c=s.map(I=>I.id),{data:r}=c.length?await y.from("crm_stages").select("*").in("pipeline_id",c).order("sort_order"):{data:[]},m=r||[],u=(e==null?void 0:e.pipeline_id)||((f=s[0])==null?void 0:f.id)||"";function b(I){const E=m.filter(S=>S.pipeline_id===I);return E.length?'<option value="">— Selecionar etapa —</option>'+E.map(S=>`<option value="${g(S.name)}" ${(e==null?void 0:e.stage)===S.name?"selected":""}>${g(S.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${s.map(I=>`<option value="${I.id}" ${String(e==null?void 0:e.pipeline_id)===String(I.id)?"selected":""}>${g(I.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
  ...
  `,document.body.appendChild(h);const x=()=>h.remove();(w=document.getElementById("cm-close"))==null||w.addEventListener("click",x),(B=document.getElementById("cm-cancel"))==null||B.addEventListener("click",x),h.addEventListener("click",I=>{I.target===h&&x()}),($=document.getElementById("cm-pipe"))==null||$.addEventListener("change",I=>{const E=document.getElementById("cm-stage");E&&(E.innerHTML=b(I.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await y.from("leads").delete().eq("id",e.id);const I=X.findIndex(E=>String(E.id)===String(e.id));I>=0&&X.splice(I,1),x(),de()}),(k=document.getElementById("cm-save"))==null||k.addEventListener("click",async()=>{var D,H,U,Y,te,be,he;const I=document.getElementById("contato-form");if(!I.checkValidity()){I.reportValidity();return}const E=new FormData(I),S=document.getElementById("cm-save");S.disabled=!0,S.textContent="Salvando…";const T=E.getAll("tag"),C=E.get("pipeline_id")||null,M={name:(D=E.get("name"))==null?void 0:D.trim(),company:((H=E.get("company"))==null?void 0:H.trim())||null,email:((U=E.get("email"))==null?void 0:U.trim())||null,phone:((Y=E.get("phone"))==null?void 0:Y.trim())||null,job_title:((te=E.get("job_title"))==null?void 0:te.trim())||null,city_interest:((be=E.get("city_interest"))==null?void 0:be.trim())||null,notes:((he=E.get("notes"))==null?void 0:he.trim())||null,pipeline_id:C,stage:E.get("stage")||null,status:E.get("status")||null,tags:T,assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await y.from("leads").update(M).eq("id",e.id),!A){const O=X.findIndex(me=>String(me.id)===String(e.id));O>=0&&(X[O]={...X[O],...M})}}else{const{data:O,error:me}=await y.from("leads").insert(M).select();A=me,!A&&(O!=null&&O[0])&&X.unshift(O[0])}if(S.disabled=!1,S.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}x(),de()})}let fe=[];function la(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{fe=a.target.result.split(`
`).filter(s=>s.trim()).slice(1).map(s=>{const[l,p,c,r,m]=s.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:l,email:p,phone:c,company:r,job_title:m}}).filter(s=>s.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${fe.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=fe.length===0)},n.readAsText(t)}async function da(){if(!fe.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=fe.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Ye(),await It(),alert(`${t.length} contato(s) importados com sucesso!`)}function ra(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),fe=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Ye(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ca="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function re(e){return(await fetch(ca,{method:"POST",headers:{Authorization:`Bearer ${At}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function gt(e){var l,p,c,r;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await y.auth.getUser();n.value=(m==null?void 0:m.email)||""}const s=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=s),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const b=URL.createObjectURL(u);a&&(a.src=b,a.style.display=""),o&&(o.style.display="none")}),(l=document.getElementById("btn-change-password"))==null||l.addEventListener("click",async()=>{var f,w;const m=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",u=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",b=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(b&&(b.style.display="none"),m.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}if(m!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:x}=await y.auth.updateUser({password:m});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),x?b&&(b.textContent="Erro: "+x.message,b.style.display=""):(b&&(b.style.color="#16a34a",b.textContent="Senha alterada com sucesso!",b.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var w;const m=t.value.trim();let u=(v==null?void 0:v.avatar_url)||"";const b=i==null?void 0:i.files[0],h=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",b)try{const B=await Se(b,400,.85),$=`avatars/${v.id}-${Date.now()}.jpg`,{error:L}=await y.storage.from("imoveis").upload($,B,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:k}}=y.storage.from("imoveis").getPublicUrl($);u=k}}catch(B){console.error("Avatar upload:",B)}const{error:x}=await y.from("profiles").update({name:m,avatar_url:u}).eq("id",v.id);if(d.disabled=!1,d.textContent=h,x){alert("Erro ao salvar perfil.");return}v={...v,name:m,avatar_url:u},ze(v);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((w=m[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await Re(),(p=document.getElementById("btn-invite-corretor"))==null||p.addEventListener("click",async()=>{var w,B;const b=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),h=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),x=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!b){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),f&&(f.style.display="none");try{const $=await re({email:b,password:h,tenant_id:(v==null?void 0:v.tenant_id)||null});if($.success){const L=document.getElementById("invite-email"),k=document.getElementById("invite-password");L&&(L.value=""),k&&(k.value=""),await Re(),f&&($.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${g(h)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+($.error||"Falha desconhecida"))}catch($){alert("Erro ao criar acesso: "+$.message)}finally{x&&(x.disabled=!1,x.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await we(),(c=document.getElementById("loc-add-city-btn"))==null||c.addEventListener("click",async()=>{const b=document.getElementById("loc-new-city"),h=b==null?void 0:b.value.trim();if(!h)return;const{error:x}=await y.from("locations").insert({type:"cidade",name:h});if(x){alert("Erro ao adicionar cidade.");return}b&&(b.value=""),await we(),nt()}),(r=document.getElementById("loc-add-neighborhood-btn"))==null||r.addEventListener("click",async()=>{var w;const b=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),h=document.getElementById("loc-new-neighborhood"),x=h==null?void 0:h.value.trim();if(!b||!x){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await y.from("locations").insert({type:"bairro",name:x,parent_id:b});if(f){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await we()})}}async function Re(){const e=document.getElementById("corretores-list");if(!e)return;let t=y.from("profiles").select("*").order("created_at");v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,s=o.id===(v==null?void 0:v.id),l=o.active!==!1,p=l?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',c=s?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
           <option value="corretor"${o.role==="corretor"?" selected":""}>Corretor</option>
           <option value="admin"${o.role==="admin"?" selected":""}>Admin</option>
         </select>`,r=s?"":l?`<button class="corretor-toggle-btn" data-uid="${o.id}" data-active="true">Pausar acesso</button>`:`<button class="corretor-toggle-btn btn-liberar" data-uid="${o.id}" data-active="false">Liberar acesso</button>`,m=s?"":`<button class="corretor-del-btn icon-btn" data-uid="${o.id}" title="Excluir corretor">🗑️</button>`;return`<div class="corretor-item">
...
`+k);window.open("mailto:?subject="+E+"&body="+S,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var I;const k=document.getElementById("share-link-input");k&&((I=navigator.clipboard)==null||I.writeText(k.value).then(()=>{const E=document.getElementById("share-copy"),S=E.textContent;E.textContent="✅ Copiado!",setTimeout(()=>{E.textContent=S},2e3)}))}),($=document.getElementById("view-modal-edit"))==null||$.addEventListener("click",()=>{var M;if((v==null?void 0:v.role)!=="admin"&&(v==null?void 0:v.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===k);if(!I)return;_e(),R=I.id;const E=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",E.querySelector('[name="title"]').value=I.title||"",E.querySelector('[name="rua"]').value=I.rua||"",E.querySelector('[name="numero"]').value=I.numero||"",E.querySelector('[name="city"]').value=I.city||"",E.querySelector('[name="price"]').value=I.price||"",E.querySelector('[name="bedrooms"]').value=I.bedrooms||"",E.querySelector('[name="suites"]').value=I.suites||"",E.querySelector('[name="parking"]').value=I.parking||"",E.querySelector('[name="description"]').value=I.description||"",E.querySelector('[name="construction_status"]').value=I.construction_status||"",E.querySelector('[name="owner_name"]').value=I.owner_name||"",E.querySelector('[name="owner_phone"]').value=I.owner_phone||"",E.querySelector('[name="owner_email"]').value=I.owner_email||"",E.querySelector('[name="owner_notes"]').value=I.owner_notes||"",E.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),oe=I.cover_image||((M=I.images)==null?void 0:M[0])||"",qe(I.images||[]),Fe("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(E=>E.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(E=>E.classList.add("hidden")),(I=document.getElementById(`tab-${k.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const I=k.target.closest("tr");if(!I)return;const E=Number(I.dataset.id);if(!E)return;const S=_.find(T=>T.id===E);S&&Vt(S)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,p;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){let c=null;for(const r of[t,"www."+t]){const{data:m}=await y.from("tenants").select("id").eq("domain",r).maybeSingle();if(m!=null&&m.id){c=m;break}}c!=null&&c.id&&Ce(c.id)}await Promise.all([_t(),Bt()]),ne=F("company.whatsapp",ne),Ze(),Pt(),Ft();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(nt(),n.addEventListener("change",()=>{const c=ce().find(m=>m.name===n.value),r=c?at(c.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(m=>`<option value="${m.name}">${g(m.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const c=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),m=c.get("type")||r.get("type")||"",u=ht||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||r.has("code"),b=document.getElementById("password-reset-overlay");if(u){o.style.display="none",i&&i.classList.add("hidden"),b&&(b.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async x=>{var k,I;x.preventDefault();const f=((k=document.getElementById("new-password"))==null?void 0:k.value)||"",w=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",B=document.getElementById("password-reset-msg"),$=x.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),f!==w){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}$&&($.disabled=!0,$.textContent="Salvando…");const{error:L}=await y.auth.updateUser({password:f});if(L){B&&(B.textContent="Erro: "+L.message,B.style.display=""),$&&($.disabled=!1,$.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await y.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:h}}=await y.auth.getSession();if(h){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),Pe(),ft(),ct(),window.lucide&&lucide.createIcons(),v=await dt(h.user.id),!v){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(v.active===!1){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const x=document.getElementById("password-reset-overlay");x&&(x.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async f=>{var I,E;f.preventDefault();const w=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",B=((E=document.getElementById("confirm-password"))==null?void 0:E.value)||"",$=document.getElementById("password-reset-msg"),L=f.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),w!==B){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}if(w.length<6){$&&($.textContent="Mínimo 6 caracteres.",$.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:k}=await y.auth.updateUser({password:w});if(k){$&&($.textContent="Erro: "+k.message,$.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}Ce((v==null?void 0:v.tenant_id)||null),ze(v),Wt(v),rt(v.role),await Ae(),await gt(v),window.lucide&&lucide.createIcons(),ia()}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const x=document.getElementById("login-form");x&&((p=document.getElementById("forgot-password-btn"))==null||p.addEventListener("click",async()=>{var B,$;const f=($=(B=x.querySelector('input[name="email"]'))==null?void 0:B.value)==null?void 0:$.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:w}=await y.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(w?"Erro: "+w.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),x.addEventListener("submit",async f=>{f.preventDefault();const w=new FormData(x),B=w.get("email"),$=w.get("password");if(await Rt(B,$)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),Pe(),ft(),window.lucide&&lucide.createIcons();const{data:{session:k}}=await y.auth.getSession();if(v=k?await dt(k.user.id):null,!v){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(v.active===!1){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}ct(),Ce((v==null?void 0:v.tenant_id)||null),ze(v),rt(v.role),await Ae(),await gt(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else Pe();await ke();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Ct(d),Tt(ne)});async function ma(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!d){const s=_.findIndex(l=>l.id===o.id);s>=0&&(_[s].reference=i),n++}}Le(et(_))}async function pa(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await ua(i);a.push(d),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(d=>d.id===t.id);i>=0&&(_[i].images=a)}}Le(et(_))}}async function ua(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(s=>{const l=new Image;l.onload=()=>{URL.revokeObjectURL(a);const p=document.createElement("canvas"),c=1200;let r=l.width,m=l.height;r>c&&(m=Math.round(m*c/r),r=c),p.width=r,p.height=m;const u=p.getContext("2d");u.drawImage(l,0,0,r,m);const b=h=>{if(h){const x=Math.round(r*.18),f=Math.round(h.naturalHeight*x/h.naturalWidth),w=Math.round(r*.02);u.globalAlpha=.45,u.drawImage(h,r-x-w,m-f-w,x,f),u.globalAlpha=1}p.toBlob(async x=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await y.storage.from("imoveis").upload(f,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),s(e);return}const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(f);s(B)}catch(f){console.error("Watermark upload exception:",f),s(e)}},"image/jpeg",.82)};if(d){const h=new Image;h.onload=()=>{URL.revokeObjectURL(d),b(h)},h.onerror=()=>{URL.revokeObjectURL(d),b(null)},h.src=d}else b(null)},l.onerror=()=>{URL.revokeObjectURL(a),s(e)},l.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function ot(e,t="assets"){const n=await Se(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function ga(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `;function l(c,r,m){const u=document.getElementById(c),b=document.getElementById(r);u==null||u.addEventListener("input",h=>{b.value=h.target.value,m()}),b==null||b.addEventListener("input",h=>{/^#[0-9a-fA-F]{6}$/.test(h.target.value)&&(u.value=h.target.value,m())})}function p(){var r,m,u,b;const c=((r=document.getElementById("col-accent-hex"))==null?void 0:r.value)||"#b8962e";(m=document.getElementById("vp-bar"))==null||m.style.setProperty("background",c),(u=document.getElementById("vp-dot"))==null||u.style.setProperty("background",c),(b=document.getElementById("vp-btn"))==null||b.style.setProperty("background",c),document.documentElement.style.setProperty("--accent",c)}l("col-accent","col-accent-hex",p),l("col-primary","col-primary-hex",()=>{}),l("col-secondary","col-secondary-hex",()=>{}),p(),document.getElementById("vis-hero-file").addEventListener("change",async c=>{const r=c.target.files[0];if(r)try{const m=await ot(r,"hero");document.getElementById("vis-hero-url").value=m;const u=document.getElementById("vis-hero-preview");u.innerHTML=`<img src="${m}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,u.style.display=""}catch(m){alert("Erro no upload: "+m.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const c=document.getElementById("visual-save-colors");c.disabled=!0,c.textContent="Salvando…";const r=await ge([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);r&&Ze(),c.disabled=!1,c.textContent="Salvar Cores",V(document.getElementById("visual-colors-msg"),r)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",p())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const c=document.getElementById("visual-save-images");c.disabled=!0,c.textContent="Salvando…";const r=await ge([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);c.disabled=!1,c.textContent="Salvar Imagens",V(document.getElementById("visual-images-msg"),r)})}async function va(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("site_content").select("*").eq("tenant_id",z()),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=(l,p)=>{var c;return g(((c=n[l])==null?void 0:c[`value_${p}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},d=l=>o.map(p=>`<button class="content-tab${p===l?" active":""}" data-lang="${p}">${i[p]}</button>`).join(""),s=l=>`
  ...
  `,document.getElementById("sc-tabs").addEventListener("click",l=>{var c;const p=l.target.closest(".content-tab");p&&(document.querySelectorAll("#sc-tabs .content-tab").forEach(r=>r.classList.remove("active")),document.querySelectorAll("#sc-panels .content-panel").forEach(r=>r.classList.remove("active")),p.classList.add("active"),(c=document.querySelector(`#sc-panels [data-panel="${p.dataset.lang}"]`))==null||c.classList.add("active"))}),document.getElementById("sc-save-btn").addEventListener("click",async()=>{const l=document.getElementById("sc-save-btn");l.disabled=!0,l.textContent="Salvando…";const p={};document.querySelectorAll(".sc-field").forEach(r=>{const m=r.dataset.key,u=r.dataset.lang;p[m]||(p[m]={}),p[m][u]=r.value});let c=!0;for(const[r,m]of Object.entries(p))await Oe(r,{pt:m.pt,en:m.en,es:m.es})||(c=!1);l.disabled=!1,l.textContent="Salvar Conteúdo",V(document.getElementById("sc-save-msg"),c)}),document.getElementById("seo-save-btn").addEventListener("click",async()=>{const l=document.getElementById("seo-save-btn");l.disabled=!0,l.textContent="Salvando…";const p=document.getElementById("seo-title").value.trim(),c=document.getElementById("seo-desc").value.trim(),r=await Oe("seo.title_pt",{pt:p,en:p,es:p})&&await Oe("seo.description_pt",{pt:c,en:c,es:c});l.disabled=!1,l.textContent="Salvar SEO",V(document.getElementById("seo-save-msg"),r)})}async function ya(){const e=document.getElementById("section-crm-config");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var r;const s=document.getElementById("intg-save-tracking");s.disabled=!0,s.textContent="Salvando…";let l=!0;const p=document.querySelectorAll(".intg-val"),c=document.querySelectorAll(".intg-toggle");for(let m=0;m<p.length;m++){const u=p[m].dataset.key,b=p[m].value.trim(),h=((r=c[m])==null?void 0:r.checked)??!1;await De(u,b,h)||(l=!1)}s.disabled=!1,s.textContent="Salvar Integrações",V(document.getElementById("intg-tracking-msg"),l)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const s=document.getElementById("intg-save-smtp");s.disabled=!0,s.textContent="Salvando…";const l=document.querySelectorAll(".smtp-field");let p=!0;for(const r of l)await De(r.dataset.key,r.value.trim(),!0)||(p=!1);const c=document.getElementById("smtp-pass").value;c&&(await De("smtp_pass",c,!0)||(p=!1)),s.disabled=!1,s.textContent="Salvar SMTP",V(document.getElementById("intg-smtp-msg"),p)})}async function ha(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(p=>{p.addEventListener("click",async c=>{c.stopPropagation();const r=p.dataset.active==="true";await y.from("tenants").update({active:!r}).eq("id",p.dataset.id),ee()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(p=>{p.addEventListener("click",()=>{const c=(i||[]).find(r=>String(r.id)===String(p.dataset.id));c&&Ba(c)})})}async function Ea(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
    ...
    <div class="sa-list-row">
      <div class="sa-list-info">
        <div>
          ...
          <div class="sa-list-sub">${g(((c=l.plans)==null?void 0:c.name)||"—")} · R$ ${Number(((r=l.plans)==null?void 0:r.price_brl)||0).toLocaleString("pt-BR",{minimumFractionDigits:2})}/mês</div>
        </div>
      </div>
      <div class="sa-list-actions">
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>kt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",Qe(e,o.dataset.tab)})}),Qe(e,"properties")}function ka(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(s,l,p,c="text",r="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,n.querySelectorAll(".tp-prop-edit").forEach(r=>{r.addEventListener("click",()=>{const m=Number(r.dataset.pid),u=c.find(b=>b.id===m);u&&ka(u,a)})}),n.querySelectorAll(".tp-prop-toggle").forEach(r=>{r.addEventListener("click",async()=>{const m=Number(r.dataset.pid),u=r.dataset.pub==="1";r.disabled=!0,r.textContent="…",await y.from("properties").update({published:!u}).eq("id",m),a()})}),n.querySelectorAll(".tp-prop-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Excluir este imóvel permanentemente?")&&(r.disabled=!0,r.textContent="…",await y.from("properties").delete().eq("id",Number(r.dataset.pid)),a())})})}if(t==="leads"){const{data:c}=await y.from("leads").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}).limit(200);if(!(c!=null&&c.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">📋</div><p style="font-size:14px;">Nenhum lead ainda.</p></div>';return}const r=m=>({novo:"#dbeafe,#1d4ed8",contato:"#fef3c7,#92400e",proposta:"#ede9fe,#6d28d9",fechado:"#dcfce7,#15803d"})[m]||"#f1f5f9,#64748b";n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${c.map(m=>{const[u,b]=r(m.stage||m.status||"").split(","),h=(m.phone||"").replace(/\D/g,"");return`<tr data-lid="${m.id}" style="border-top:1px solid #f1f5f9;">
      ...
      </div>`,(s=document.getElementById("tp-copy-key"))==null||s.addEventListener("click",()=>{var w;(w=navigator.clipboard)==null||w.writeText(e.id);const x=document.getElementById("tp-copy-key"),f=x.textContent;x.textContent="✅ Copiada!",setTimeout(()=>{x.textContent=f},2e3)})}if(t==="config"){const{data:c}=await y.from("settings").select("key,value").eq("tenant_id",e.id),r={};c==null||c.forEach(u=>{r[u.key]=u.value});const m=(u,b)=>`
      ...
      </div>`,(p=document.getElementById("tp-open-edit"))==null||p.addEventListener("click",()=>kt(e))}}function kt(e){var p,c,r,m,u,b,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
