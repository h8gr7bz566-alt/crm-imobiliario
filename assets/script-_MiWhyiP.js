import{s as h}from"./supabase-BcuJ3xoD.js";const F="00000000-0000-0000-0000-000000000000";let de={},he={},oe=F;function fe(e){oe=e||F,de={},he={}}const M=()=>oe;async function sa(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",oe),h.from("site_content").select("*").eq("tenant_id",oe)]);if(e.data&&e.data.forEach(n=>{de[n.key]=n.value}),t.data&&t.data.forEach(n=>{he[n.key]=n}),(!t.data||t.data.length===0)&&oe!==F){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",F),h.from("site_content").select("*").eq("tenant_id",F)]);n.data&&n.data.forEach(o=>{de[o.key]===void 0&&(de[o.key]=o.value)}),a.data&&a.data.forEach(o=>{he[o.key]||(he[o.key]=o)})}}const J=(e,t=null)=>de[e]!==void 0?de[e]:t,Se=(e,t="pt")=>{const n=he[e];return n&&(n["value_"+t]||n.value_pt)||null};async function xe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:oe,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{de[o]=i}),!a}async function je(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:oe,updated_at:o},{error:d}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(he[e]=i),oe!==F&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:F,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Ye(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function lt(){const e=document.documentElement,t=J("visual.accent_color","#b8962e"),n=J("visual.primary_bg","#0f1c2e"),a=J("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=J("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=J("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=J("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function yt(e){e=e||"pt";const t=g=>Se(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),b=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),b&&t("inst.stat3_label")&&(b.innerHTML=t("inst.stat3_label"));const x=document.getElementById("dep-grid");if(x){const g=Se("testimonials",e)||Se("testimonials","pt");if(g)try{const E=JSON.parse(g);if(Array.isArray(E)&&E.length>0){let S=function(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(k){let w=0;for(const $ of k||"?")w=w*31+$.charCodeAt(0)&4294967295;return I[Math.abs(w)%I.length]};const I=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];x.innerHTML=E.map(k=>`
            ...
            </div>`).join("")}}catch{}}const u=Se("seo.title_pt",e);u&&(document.title=u);const y=Se("seo.description_pt",e);if(y){const g=document.querySelector('meta[name="description"]');g&&(g.content=y)}}function bt(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const da="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let _e="5547999701743";const we=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],la=5.7;function Ae(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/la).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],f=null,qe=[],Mt=!1;h.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Mt=!0)});function Qe(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function De(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function zt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:r,error:m}=await h.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return m&&console.error("Supabase select error:",m),r||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=M();if(!o||o===F){const r=De(a);if(r)o=r,fe(o);else{const m=t.replace(/^www\./,"");for(const p of[m,"www."+m]){const{data:b}=await h.from("tenants").select("id").eq("domain",p).maybeSingle();if(b!=null&&b.id){o=b.id,fe(o);break}}o&&o!==F&&Qe(a,o,24*60*60*1e3)}}if(!o||o===F)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const r=De(i);if(r)return setTimeout(()=>zt({background:!0}),100),r}const{data:l,error:s}=await h.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),De(i)||[];const c=l||[];return Qe(i,c,d),e&&typeof re=="function"&&re().catch(()=>{}),c}async function Nt(){let e=h.from("properties").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="super_admin"||(f!=null&&f.tenant_id?e=e.eq("tenant_id",f.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],Ra(),Ha(),_)}async function ra(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await h.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await h.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function ca(e){const{error:t}=await h.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function ma(e,t){const{error:n}=await h.auth.signInWithPassword({email:e,password:t});return!n}function Me(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,c=i.height;s>t&&(c=Math.round(c*t/s),s=t),l.width=s,l.height=c;const r=l.getContext("2d");r.drawImage(i,0,0,s,c);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const p=Math.round(s*.18),b=Math.round(m.naturalHeight*p/m.naturalWidth),x=Math.round(s*.02),u=s-p-x,y=c-b-x;r.globalAlpha=.45,r.drawImage(m,u,y,p,b),r.globalAlpha=1,l.toBlob(g=>g?a(g):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{l.toBlob(p=>p?a(p):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=d})}async function pa(e){const t=await Me(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await h.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=h.storage.from("imoveis").getPublicUrl(n);return o}async function ua(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await pa(n[o]));return a}function jt(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function Dt(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const d=a%i;o.dataset.idx=d;try{const s=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(s[d]){const c=o.querySelector(".carousel-img"),r=o.querySelector(".carousel-img-bg");c&&(c.src=s[d]),r&&(r.src=s[d])}}catch{}const l=o.querySelectorAll(".icard-dot");if(l.length){const s=d%l.length;l.forEach((c,r)=>c.classList.toggle("active",r===s))}})}function ga(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=s=>e.filter(c=>{if(c.collection){try{const m=JSON.parse(c.collection);if(Array.isArray(m))return m.includes(s)}catch{}if(c.collection===s)return!0}const r=((c.title||"")+" "+(c.description||"")).toLowerCase();return s==="frente-mar"?r.includes("frente mar")||r.includes("frente ao mar"):s==="decorados"?r.includes("decorad")||r.includes("mobiliado"):s==="casas-condominio"?(c.condominium||"").length>2:!1});function a(s,c,r,m){if(!r.length)return"";const p=r.slice(0,8).map(b=>mt(b)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio"),l=jt(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",d,"imoveis.html?collection=casas-condominio"):""].join(""),Dt(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",rt),t.addEventListener("touchend",function(s){const c=s.target.closest(".carousel-btn");c&&(s.preventDefault(),s.stopPropagation(),Rt(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function re(){var b,x,u,y,g,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await zt();_=n,((b=document.getElementById("selecao-carousel"))==null?void 0:b.innerHTML)===""&&va(n);const a=((x=document.getElementById("city-filter"))==null?void 0:x.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((y=document.getElementById("bedrooms-filter"))==null?void 0:y.value)||"",d=((g=document.getElementById("parking-filter"))==null?void 0:g.value)||"",l=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",{min:s,max:c}=fa(),r=n.filter(I=>{if(a&&I.city!==a||o&&I.neighborhood!==o||i&&(i==="4+"&&Number(I.bedrooms)<4||i!=="4+"&&Number(I.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(I.parking)<4||d!=="4+"&&Number(I.parking)!==Number(d))||l&&I.construction_status!==l)return!1;const S=String(I.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(S,10)||0;return!(L<s||c!==1/0&&L>c)});if(e){ga(n);return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=jt(t);t.innerHTML=r.map(I=>mt(I)).join(""),Dt(t,m);const p=document.getElementById("properties");p&&!p._carouselDelegated&&(p._carouselDelegated=!0,p.addEventListener("click",rt))}function va(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>mt(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",rt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(d=a==null?void 0:a.querySelector(".selecao-next"))==null||d.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),re()};function Rt(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const d=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(d.length&&d[a]){const l=e.querySelector(".carousel-img"),s=e.querySelector(".carousel-img-bg");l&&(l.src=d[a]),s&&(s.src=d[a])}}catch{const l=_.find(m=>String(m.id)===String(e.dataset.pid)),s=(i=l==null?void 0:l.images)!=null&&i.length?l.images:we,c=e.querySelector(".carousel-img"),r=e.querySelector(".carousel-img-bg");c&&s[a]&&(c.src=s[a]),r&&s[a]&&(r.src=s[a])}const o=e.querySelectorAll(".icard-dot");if(o.length){const d=a%o.length;o.forEach((l,s)=>l.classList.toggle("active",s===d))}}function rt(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&Rt(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function fa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function ya(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>re())}function ba(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ue();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ue().find(i=>i.name===e.value),o=a?pt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${v(i.name)}</option>`).join(""),re()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",re)})}function Te(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var d;const a=n.cover_image||((d=n.images)==null?void 0:d[0])||we[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
${d}`),s=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",c=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",r=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",m=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",p=Math.max(1,Math.min(n,6)),b=`<div class="icard-dots">${Array.from({length:p},(u,y)=>`<span class="icard-dot${y===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ...
        ${s||c||r||m?`<div class="icard-specs">${s}${c}${r}${m}</div>`:""}
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await h.from("tasks").update({status:d}).eq("id",i);const l=D.find(s=>String(s.id)===i);l&&(l.status=d),Ie()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await h.from("tasks").delete().eq("id",a.dataset.id),D=D.filter(i=>String(i.id)!==String(a.dataset.id)),Ie())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=D.find(l=>String(l.id)===i);d&&Ut(d)})})}function Ut(e=null){var s,c,r,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=Ot(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),d.addEventListener("click",p=>{p.target===d&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const p=a?"pending":"done";await h.from("tasks").update({status:p}).eq("id",e.id);const b=D.find(x=>String(x.id)===String(e.id));b&&(b.status=p),l(),p==="done"&&(be="done",document.querySelectorAll(".tarefa-filter-btn").forEach(x=>{x.classList.toggle("active",x.dataset.filter==="done")})),Ie()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var g,E;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const b=new FormData(p),x=document.getElementById("tm-save");x.disabled=!0,x.textContent="Salvando…";const u={title:(g=b.get("title"))==null?void 0:g.trim(),description:((E=b.get("description"))==null?void 0:E.trim())||null,due_date:b.get("due_date")||null,priority:b.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let y;if(n){if({error:y}=await h.from("tasks").update(u).eq("id",e.id),!y){const I=D.findIndex(S=>String(S.id)===String(e.id));I>=0&&(D[I]={...D[I],...u})}}else{const{data:I,error:S}=await h.from("tasks").insert(u).select();y=S,!y&&(I!=null&&I[0])&&D.unshift(I[0])}if(x.disabled=!1,x.textContent=n?"Salvar":"Criar Tarefa",y){alert("Erro: "+y.message);return}l(),Ie()})}async function _a(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",l=>{l.preventDefault(),Z(),te("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{ee.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(ee)),l.classList.remove("unread"),Z(),te("contatos")})})}function qa(){var e;document.querySelectorAll(".notif-item").forEach(t=>ee.push(t.dataset.id)),ee=[...new Set(ee)],localStorage.setItem("crm_notifs_read",JSON.stringify(ee)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Ta(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Aa(){let e=h.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);f!=null&&f.tenant_id&&(e=e.eq("tenant_id",f.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!ee.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let Y=[],j=1;const Be=10;let kt=!1;async function Ma(){var t,n,a,o,i,d,l,s,c;document.getElementById("section-contatos")&&(kt||(kt=!0,await Pt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{j=1,me()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(j=1,me())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>Ft()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",ja),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",ot),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",ot),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),b=document.createElement("a");b.href=URL.createObjectURL(p),b.download="modelo_contatos.csv",b.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",za),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Na)))}async function Pt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;Y=a||[],me()}function me(){var l,s,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Y.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):Y,n=t.length,a=Math.max(1,Math.ceil(n/Be));j>a&&(j=a);const o=t.slice((j-1)*Be,j*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const r=n===0?0:(j-1)*Be+1,m=Math.min(j*Be,n);d.innerHTML=`
...
`+k);window.open("mailto:?subject="+$+"&body="+B,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const k=document.getElementById("share-link-input");k&&((w=navigator.clipboard)==null||w.writeText(k.value).then(()=>{const $=document.getElementById("share-copy"),B=$.textContent;$.textContent="✅ Copiado!",setTimeout(()=>{$.textContent=B},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var N;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(T=>T.id===k);if(!w)return;ze(),R=w.id;const $=document.getElementById("property-form"),B=document.getElementById("form-submit-btn");B.textContent="Salvar Alterações",$.querySelector('[name="title"]').value=w.title||"",$.querySelector('[name="rua"]').value=w.rua||"",$.querySelector('[name="numero"]').value=w.numero||"",$.querySelector('[name="city"]').value=w.city||"",$.querySelector('[name="price"]').value=w.price||"",$.querySelector('[name="bedrooms"]').value=w.bedrooms||"",$.querySelector('[name="suites"]').value=w.suites||"",$.querySelector('[name="parking"]').value=w.parking||"",$.querySelector('[name="description"]').value=w.description||"",$.querySelector('[name="construction_status"]').value=w.construction_status||"",$.querySelector('[name="owner_name"]').value=w.owner_name||"",$.querySelector('[name="owner_phone"]').value=w.owner_phone||"",$.querySelector('[name="owner_email"]').value=w.owner_email||"",$.querySelector('[name="owner_notes"]').value=w.owner_notes||"",$.querySelector('[name="condominium"]').value=w.condominium||"";const q=document.getElementById("adminPublished");q&&(q.value=w.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=w.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const T=document.getElementById("adminNeighborhood");T&&(T.value=w.neighborhood||"")},50)),le=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Ue(w.images||[]),Ze("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach($=>$.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach($=>$.classList.add("hidden")),(w=document.getElementById(`tab-${k.dataset.tab}`))==null||w.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const w=k.target.closest("tr");if(!w)return;const $=Number(w.dataset.id);if(!$)return;const B=_.find(q=>q.id===$);B&&wa(B)})}async function Vt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async r=>{r.stopPropagation();const m=c.dataset.active==="true";await h.from("tenants").update({active:!m}).eq("id",c.dataset.id),ie()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const r=(i||[]).find(m=>String(m.id)===String(c.dataset.id));r&&Ga(r)})})}async function Pa(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Zt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",st(e,o.dataset.tab)})}),st(e,"properties")}function Wa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,c,r="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>Zt(e))}}function Zt(e){var c,r,m,p,b,x,u,y;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:I}=await h.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}s(),ie()}),(y=document.getElementById("et-save"))==null||y.addEventListener("click",async()=>{var N,T,V,H,O,ae,se,$e,ke,U,ve,vt;const g=(T=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:T.trim(),E=(H=(V=document.getElementById("et-slug"))==null?void 0:V.value)==null?void 0:H.trim(),I=(ae=(O=document.getElementById("et-domain"))==null?void 0:O.value)==null?void 0:ae.trim(),S=(se=document.getElementById("et-plan"))==null?void 0:se.value,L=(ke=($e=document.getElementById("et-admin-email"))==null?void 0:$e.value)==null?void 0:ke.trim(),k=(ve=(U=document.getElementById("et-admin-password"))==null?void 0:U.value)==null?void 0:ve.trim(),w=(vt=document.getElementById("et-logo-input"))==null?void 0:vt.files[0],$=document.getElementById("et-msg"),B=document.getElementById("et-save");if(!g){$.textContent="❌ Nome é obrigatório.",$.style.color="#ef4444";return}B.disabled=!0,B.textContent="Salvando…",$.textContent="⏳ Salvando…",$.style.color="#64748b";let q=e.logo_url;if(w)try{const A=await Me(w,256,.85),ft=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:oa}=await h.storage.from("imoveis").upload(ft,A,{contentType:"image/jpeg",upsert:!0});if(!oa){const{data:{publicUrl:ia}}=h.storage.from("imoveis").getPublicUrl(ft);q=ia}}catch(A){console.error("Logo upload:",A)}const{error:C}=await h.from("tenants").update({name:g,slug:E||e.slug,domain:I||null,plan_id:S||null,logo_url:q}).eq("id",e.id);if(C){B.disabled=!1,B.textContent="Salvar",$.textContent="❌ "+C.message,$.style.color="#ef4444";return}if(L&&k&&k.length>=6){$.textContent="⏳ Criando usuário admin…";const A=await pe({email:L,password:k,role:"admin",tenant_id:e.id});A!=null&&A.success?(A!=null&&A.user_id&&!(A!=null&&A.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",A.user_id),$.textContent="✅ Salvo e admin criado!",$.style.color="#22c55e"):($.textContent="⚠️ Salvo, mas erro ao criar admin: "+((A==null?void 0:A.error)||"Tente novamente"),$.style.color="#f59e0b")}else $.textContent="✅ Imobiliária atualizada!",$.style.color="#22c55e";B.disabled=!1,B.textContent="Salvar",setTimeout(()=>{s(),ie()},1200)})}const qt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Je=[],ge=[],He={};function Ja(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ya)}function Ya(){Je=[],ge=[],He={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),ea();const t=document.getElementById("import-drop-zone"),n=document.getElementById("import-file-input");function a(i){i.preventDefault()}document.addEventListener("dragover",a),document.addEventListener("drop",a),t.addEventListener("click",()=>n.click()),t.addEventListener("dragenter",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragover",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragleave",i=>{t.contains(i.relatedTarget)||(t.style.borderColor="#c7d2e0",t.style.background="")}),t.addEventListener("drop",i=>{var l,s;i.preventDefault(),t.style.borderColor="#c7d2e0",t.style.background="";const d=(s=(l=i.dataTransfer)==null?void 0:l.files)==null?void 0:s[0];d&&Tt(d)}),n.addEventListener("change",i=>{var l;const d=(l=i.target.files)==null?void 0:l[0];d&&Tt(d),i.target.value=""});const o=new MutationObserver(()=>{document.getElementById("import-leads-overlay")||(document.removeEventListener("dragover",a),document.removeEventListener("drop",a),o.disconnect())});o.observe(document.body,{childList:!0})}async function ea(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Tt(e){if(!e)return;const t=document.getElementById("import-file-status"),n=document.getElementById("import-upload-error");n.style.display="none";const a=e.name.toLowerCase();if(t.textContent=`📄 ${e.name} (${(e.size/1024).toFixed(1)} KB)`,a.endsWith(".csv")){const o=new FileReader;o.onload=i=>{const d=Ka(i.target.result);if(d.error){n.textContent=d.error,n.style.display="";return}ge=d.headers,Je=d.rows,ta()},o.readAsText(e,"UTF-8")}else if(a.endsWith(".xlsx")||a.endsWith(".xls")){const o=new FileReader;o.onload=i=>Qa(i.target.result),o.readAsArrayBuffer(e)}else n.textContent="Formato não suportado. Use CSV ou XLSX.",n.style.display=""}function Ka(e){const t=e.split(`
`)[0]||"",n=t.split(";").length>t.split(",").length?";":",",a=e.split(`
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const s=[];let c="",r=!1;for(let m=0;m<l.length;m++){const p=l[m];p==='"'?r&&l[m+1]==='"'?(c+='"',m++):r=!r:p===n&&!r?(s.push(c.trim()),c=""):c+=p}return s.push(c.trim()),s}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),d=a.slice(1).map(o);return{headers:i,rows:d}}async function Qa(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,d)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=d,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}ge=o[0].map(String),Je=o.slice(1),ta()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function Za(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function ta(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+ge.map((a,o)=>`<option value="${o}">${v(a)}</option>`).join("");e.innerHTML=qt.map(a=>{const o=Za(ge,t[a.key]||[]);return He[a.key]=o!==""?parseInt(o):"",`
...
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],d=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${d[n.getMonth()]} de ${n.getFullYear()}`,s=((y=f==null?void 0:f.name)==null?void 0:y.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${z(s)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${l}`);let m=[],p=[];try{const[g,E]=await Promise.all([Nt(),on()]);m=g||[],p=E||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}sn(m,p,n);const b=m.filter(g=>g.published).length,x=p.filter(g=>dt(g.created_at)===dt(n.toISOString())).length,u=document.getElementById("db-header-chips");u&&(u.innerHTML=`
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-time">${aa(d.time,n)}</div>
    ...
    <div class="db-port-card">
      ...
      <div class="db-port-val">${na(c.val)}</div>
