import{s as b}from"./supabase-BcuJ3xoD.js";const V="00000000-0000-0000-0000-000000000000";let le={},xe={},se=V;function ye(e){se=e||V,le={},xe={}}const N=()=>se;async function xa(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",se),b.from("site_content").select("*").eq("tenant_id",se)]);if(e.data&&e.data.forEach(n=>{le[n.key]=n.value}),t.data&&t.data.forEach(n=>{xe[n.key]=n}),(!t.data||t.data.length===0)&&se!==V){const[n,a]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",V),b.from("site_content").select("*").eq("tenant_id",V)]);n.data&&n.data.forEach(o=>{le[o.key]===void 0&&(le[o.key]=o.value)}),a.data&&a.data.forEach(o=>{xe[o.key]||(xe[o.key]=o)})}}const K=(e,t=null)=>le[e]!==void 0?le[e]:t,Le=(e,t="pt")=>{const n=xe[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Ee(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:se,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{le[o]=i}),!a}async function Oe(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:se,updated_at:o},{error:d}=await b.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(xe[e]=i),se!==V&&await b.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:V,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Ze(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function gt(){const e=document.documentElement,t=K("visual.accent_color","#b8962e"),n=K("visual.primary_bg","#0f1c2e"),a=K("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=K("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=K("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=K("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function kt(e){e=e||"pt";const t=f=>Le(f,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),E=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),E&&t("inst.stat3_label")&&(E.innerHTML=t("inst.stat3_label"));const w=document.getElementById("dep-grid");if(w){const f=Le("testimonials",e)||Le("testimonials","pt");if(f)try{const I=JSON.parse(f);if(Array.isArray(I)&&I.length>0){let S=function(u){return String(u||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(u){let g=0;for(const h of u||"?")g=g*31+h.charCodeAt(0)&4294967295;return $[Math.abs(g)%$.length]};const $=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];w.innerHTML=I.map(u=>`
            ...
            </div>`).join("")}}catch{}}const x=Le("seo.title_pt",e);x&&(document.title=x);const k=Le("seo.description_pt",e);if(k){const f=document.querySelector('meta[name="description"]');f&&(f.content=k)}}function $t(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Ea="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let Ce="5547999701743";const wa="onknpbzdcrhbfozzvxtz.supabase.co",St="/storage/v1/object/public/";function Te(e){if(!e||typeof e!="string"||!window.__USE_CF_PROXY||!e.includes(wa)||!e.includes(St))return e;const t=window.location.hostname;if(t!=="omarcorretor.com.br"&&t!=="www.omarcorretor.com.br")return e;try{const n=new URL(e);return"https://omarcorretor.com.br"+n.pathname.replace(St,"/img/")+n.search}catch{return e}}(function(){typeof window>"u"||window.location.hostname!=="omarcorretor.com.br"&&window.location.hostname!=="www.omarcorretor.com.br"||fetch("/img/healthz",{method:"HEAD",cache:"no-store"}).then(t=>{(t.headers.get("cf-ray")||t.headers.get("Cf-Ray"))&&(window.__USE_CF_PROXY=!0)}).catch(()=>{})})();function Ia(e){return Array.isArray(e)?e.map(Te):e}const Ie=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],ka=5.7;function Ne(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/ka).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let T=[],y=null,Ae=[];const at="imobi_lead_tracking",Pt=90*24*60*60*1e3;function Fe(e){try{const t=document.cookie?document.cookie.split("; "):[];for(const n of t){const a=n.indexOf("=");if(a<0)continue;if(n.slice(0,a)===e)return decodeURIComponent(n.slice(a+1))}return null}catch{return null}}function $a(){if(typeof window>"u")return null;try{const e=new URLSearchParams(window.location.search),t={utm_source:e.get("utm_source"),utm_medium:e.get("utm_medium"),utm_campaign:e.get("utm_campaign"),utm_content:e.get("utm_content"),utm_term:e.get("utm_term"),fbclid:e.get("fbclid"),gclid:e.get("gclid"),fbp:Fe("_fbp"),fbc:Fe("_fbc"),landing_url:window.location.href,captured_at:Date.now()};if(t.fbclid&&!t.fbc){const i=Math.floor(Date.now()/1e3);t.fbc=`fb.1.${i}.${t.fbclid}`}const n=t.utm_source||t.utm_campaign||t.fbclid||t.gclid,a=localStorage.getItem(at);let o=t;if(a)try{const i=JSON.parse(a);i&&i.captured_at&&Date.now()-i.captured_at<Pt&&!n&&(o={...i,fbp:t.fbp||i.fbp,fbc:t.fbc||i.fbc})}catch{}return localStorage.setItem(at,JSON.stringify(o)),o}catch{return null}}function Lt(){try{const e=localStorage.getItem(at);if(!e)return{};const t=JSON.parse(e);if(!t||!t.captured_at||Date.now()-t.captured_at>Pt)return{};const n=Fe("_fbp"),a=Fe("_fbc");return{utm_source:t.utm_source||null,utm_medium:t.utm_medium||null,utm_campaign:t.utm_campaign||null,utm_content:t.utm_content||null,utm_term:t.utm_term||null,fbclid:t.fbclid||null,gclid:t.gclid||null,fbp:n||t.fbp||null,fbc:a||t.fbc||null,landing_url:t.landing_url||null}}catch{return{}}}typeof window<"u"&&setTimeout($a,100);let Ft=!1;b.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Ft=!0)});function nt(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function He(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function Xt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:r,error:m}=await b.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return m&&console.error("Supabase select error:",m),r||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=N();if(!o||o===V){const r=He(a);if(r)o=r,ye(o);else{const m=t.replace(/^www\./,"");for(const p of[m,"www."+m]){const{data:E}=await b.from("tenants").select("id").eq("domain",p).maybeSingle();if(E!=null&&E.id){o=E.id,ye(o);break}}o&&o!==V&&nt(a,o,24*60*60*1e3)}}if(!o||o===V)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const r=He(i);if(r)return setTimeout(()=>Xt({background:!0}),100),r}const{data:l,error:s}=await b.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),He(i)||[];const c=l||[];return nt(i,c,d),e&&typeof ce=="function"&&ce().catch(()=>{}),c}async function Vt(){let e=b.from("properties").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="super_admin"||(y!=null&&y.tenant_id?e=e.eq("tenant_id",y.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(T=t||[],ln(),cn(),T)}async function Sa(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await b.from("properties").update(a).eq("id",t);if(o)throw o;const i=T.findIndex(d=>d.id===t);i>=0&&(T[i]={...T[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await b.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&T.unshift(t[0])}}async function La(e){const{error:t}=await b.from("properties").delete().eq("id",e);if(t)throw t;T=T.filter(n=>n.id!==e)}const Gt="imobi_sec_login_attempts",Jt=5,_a=15*60*1e3,Wt=2*60*60*1e3;function Kt(){try{const e=localStorage.getItem(Gt);return e?JSON.parse(e):{count:0,blockedUntil:0}}catch{return{count:0,blockedUntil:0}}}function ft(e){try{localStorage.setItem(Gt,JSON.stringify(e))}catch{}}function Ba(){const e=Kt();return e.blockedUntil&&Date.now()<e.blockedUntil?{blocked:!0,minutesLeft:Math.ceil((e.blockedUntil-Date.now())/6e4)}:(e.blockedUntil&&Date.now()>=e.blockedUntil&&ft({count:0,blockedUntil:0}),{blocked:!1})}function Ca(){const e=Kt();return e.count=(e.count||0)+1,e.count>=Jt&&(e.blockedUntil=Date.now()+_a,e.count=0),ft(e),e}function qa(){ft({count:0,blockedUntil:0})}async function Ta(e,t){const n=Ba();if(n.blocked)return alert(`🔒 Muitas tentativas falhas. Tente novamente em ${n.minutesLeft} minuto(s).`),!1;const{error:a}=await b.auth.signInWithPassword({email:e,password:t});if(a){const o=Ca();if(o.blockedUntil)alert("🔒 Login bloqueado por 15 minutos após 5 tentativas erradas.");else{const i=Jt-o.count;console.warn(`[SEC] Login falhou. ${i} tentativa(s) restante(s) antes do bloqueio.`)}return!1}return qa(),ot(),!0}let et=null;function ot(){try{localStorage.setItem("imobi_sec_last_activity",String(Date.now()))}catch{}et&&clearTimeout(et),et=setTimeout(async()=>{console.warn("[SEC] Inativo por 2h — fazendo logout automático.");try{await b.auth.signOut()}catch{}try{localStorage.removeItem("imobi_sec_last_activity")}catch{}alert("🔒 Sua sessão expirou por inatividade. Faça login de novo."),location.reload()},Wt)}function Aa(){if(!(typeof window>"u")){["click","keydown","mousemove","touchstart","scroll"].forEach(e=>{window.addEventListener(e,()=>ot(),{passive:!0})});try{const e=parseInt(localStorage.getItem("imobi_sec_last_activity")||"0",10);if(e&&Date.now()-e>Wt){console.warn("[SEC] Sessão já estava expirada ao carregar — fazendo logout."),b.auth.signOut().finally(()=>location.reload());return}}catch{}ot()}}b.auth.onAuthStateChange((e,t)=>{t&&t.user&&Aa()});function De(e,t=1e3,n=.7){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,c=i.height;s>t&&(c=Math.round(c*t/s),s=t),l.width=s,l.height=c;const r=l.getContext("2d");r.drawImage(i,0,0,s,c);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const p=Math.round(s*.18),E=Math.round(m.naturalHeight*p/m.naturalWidth),w=Math.round(s*.02),x=s-p-w,k=c-E-w;r.globalAlpha=.45,r.drawImage(m,x,k,p,E),r.globalAlpha=1,l.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{l.toBlob(p=>p?a(p):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=d})}async function Ma(e){const t=await De(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await b.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=b.storage.from("imoveis").getPublicUrl(n);return o}async function za(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Ma(n[o]));return a}function Yt(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function Qt(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const d=a%i;o.dataset.idx=d;try{const s=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(s[d]){const c=o.querySelector(".carousel-img"),r=o.querySelector(".carousel-img-bg"),m=Te(s[d]);c&&(c.src=m),r&&(r.src=m)}}catch{}const l=o.querySelectorAll(".icard-dot");if(l.length){const s=d%l.length;l.forEach((c,r)=>c.classList.toggle("active",r===s))}})}function Na(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=s=>e.filter(c=>{if(c.collection){try{const m=JSON.parse(c.collection);if(Array.isArray(m))return m.includes(s)}catch{}if(c.collection===s)return!0}const r=((c.title||"")+" "+(c.description||"")).toLowerCase();return s==="frente-mar"?r.includes("frente mar")||r.includes("frente ao mar"):s==="decorados"?r.includes("decorad")||r.includes("mobiliado"):s==="casas-condominio"?(c.condominium||"").length>2:!1});function a(s,c,r,m){if(!r.length)return"";const p=r.slice(0,8).map(E=>bt(E)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio"),l=Yt(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",d,"imoveis.html?collection=casas-condominio"):""].join(""),Qt(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",vt),t.addEventListener("touchend",function(s){const c=s.target.closest(".carousel-btn");c&&(s.preventDefault(),s.stopPropagation(),Zt(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ce(){var E,w,x,k,f,I;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Xt();T=n,((E=document.getElementById("selecao-carousel"))==null?void 0:E.innerHTML)===""&&Da(n);const a=((w=document.getElementById("city-filter"))==null?void 0:w.value)||"",o=((x=document.getElementById("neighborhood-filter"))==null?void 0:x.value)||"",i=((k=document.getElementById("bedrooms-filter"))==null?void 0:k.value)||"",d=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",l=((I=document.getElementById("construction-filter"))==null?void 0:I.value)||"",{min:s,max:c}=Ra(),r=n.filter($=>{if(a&&$.city!==a||o&&$.neighborhood!==o||i&&(i==="4+"&&Number($.bedrooms)<4||i!=="4+"&&Number($.bedrooms)!==Number(i))||d&&(d==="4+"&&Number($.parking)<4||d!=="4+"&&Number($.parking)!==Number(d))||l&&$.construction_status!==l)return!1;const S=String($.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(S,10)||0;return!(L<s||c!==1/0&&L>c)});if(e){Na(n);return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=Yt(t);t.innerHTML=r.map($=>bt($)).join(""),Qt(t,m);const p=document.getElementById("properties");p&&!p._carouselDelegated&&(p._carouselDelegated=!0,p.addEventListener("click",vt))}function Da(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>bt(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",vt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(d=a==null?void 0:a.querySelector(".selecao-next"))==null||d.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ce()};function Zt(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const d=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(d.length&&d[a]){const l=Te(d[a]),s=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");s&&(s.src=l),c&&(c.src=l)}}catch{const l=T.find(p=>String(p.id)===String(e.dataset.pid)),s=(i=l==null?void 0:l.images)!=null&&i.length?l.images:Ie,c=e.querySelector(".carousel-img"),r=e.querySelector(".carousel-img-bg"),m=s[a]?Te(s[a]):"";c&&m&&(c.src=m),r&&m&&(r.src=m)}const o=e.querySelectorAll(".icard-dot");if(o.length){const d=a%o.length;o.forEach((l,s)=>l.classList.toggle("active",s===d))}}function vt(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&Zt(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Ra(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function ja(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ce())}function Oa(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ge();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ge().find(i=>i.name===e.value),o=a?ht(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${v(i.name)}</option>`).join(""),ce()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ce)})}function Me(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var d;const a=n.cover_image||((d=n.images)==null?void 0:d[0])||Ie[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",r=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",m=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",p=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",E=Math.max(1,Math.min(a,6)),w=`<div class="icard-dots">${Array.from({length:E},(k,f)=>`<span class="icard-dot${f===0?" active":""}"></span>`).join("")}</div>`;return`
  ...
  `}let ie=[],Q=0;function Xa(e){var m,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||Ie[0];document.getElementById("view-thumb-preview").src=i,ie=(p=e.images)!=null&&p.length?e.images:Ie,Q=0,Ve(),document.getElementById("view-price").textContent=Ne(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(E=>E.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(E=>E.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Re(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ve(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ie[Q],e.alt=`Foto ${Q+1}`;const i=ie.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Q+1} / ${ie.length}`:"",o.innerHTML=i?ie.map((d,l)=>`<img src="${d}" class="view-thumb${l===Q?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{Q=+d.dataset.i,Ve()})})}async function _t(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ge(e){var m,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",r.style.display=""),c&&(c.style.display="none"))}async function Bt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||N(),a=n&&n!==V,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await b.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}const je={dashboard:()=>Ln(),empresa:()=>da(),visual:()=>ra(),"site-config":()=>la(),"crm-config":()=>ca(),integracoes:()=>ma(),midia:()=>pa(),depoimentos:()=>sa()};function ae(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof je<"u"&&je[e]){const o=je[e];je[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),Z(),e==="contatos"&&nn(),e==="funil"&&Ja(),e==="tarefas"&&Ka()}function Ct(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:da,visual:ra,"site-config":la,"crm-config":ca,integracoes:ma,midia:pa,depoimentos:sa}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>pn(),{once:!0}),window.lucide&&lucide.createIcons()}}function Z(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Va(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",d=>{d.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var m,p;const d=((m=document.getElementById("cp-new"))==null?void 0:m.value)||"",l=((p=document.getElementById("cp-confirm"))==null?void 0:p.value)||"",s=document.getElementById("cp-msg"),c=document.getElementById("cp-save");if(s.style.display="none",d.length<12){s.style.color="#ef4444",s.textContent="Mínimo 6 caracteres.",s.style.display="";return}if(d!==l){s.style.color="#ef4444",s.textContent="As senhas não coincidem.",s.style.display="";return}c.disabled=!0,c.textContent="Salvando…";const{error:r}=await b.auth.updateUser({password:d});if(c.disabled=!1,c.textContent="Salvar Senha",r){s.style.color="#ef4444",s.textContent="Erro: "+r.message,s.style.display="";return}s.style.color="#16a34a",s.textContent="✅ Senha alterada com sucesso!",s.style.display="",setTimeout(n,1500)})}function Ga(){var i,d,l,s,c;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(f=>{const $=(me[f]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(f)}" style="background:${$}18;color:${$};border-color:${$}55;">${v(f)}<span class="ldp-tag-rm" data-tag="${v(f)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform="translateX(0)"}),Sn(r,a||[],me);const m=r.querySelector("#ldp-pipe"),p=r.querySelector("#ldp-stage");m&&p&&m.addEventListener("change",()=>{const f=m.value,I=Je.filter($=>$.pipeline_id===f);p.innerHTML=I.map($=>`<option value="${$.name}">${$.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const E=()=>{r.style.transform="translateX(100%)",setTimeout(()=>r.remove(),250)};document.getElementById("ldp-close").addEventListener("click",E),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const f=document.getElementById("ldp-save"),I=document.getElementById("ldp-msg"),$=document.getElementById("ldp-name").value.trim();if(!$){I.style.color="#ef4444",I.textContent="Nome é obrigatório.";return}f.disabled=!0,f.textContent="Salvando…";const S=[...r.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(q=>q.dataset.tag),L=document.getElementById("ldp-pipe"),u=L?L.value:i||j,g=t?typeof Lt=="function"?Lt():{}:{},h={name:$,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:u||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:S,tenant_id:N(),...t?{utm_source:g.utm_source||null,utm_medium:g.utm_medium||null,utm_campaign:g.utm_campaign||null,utm_content:g.utm_content||null,utm_term:g.utm_term||null,fbclid:g.fbclid||null,gclid:g.gclid||null,fbp:g.fbp||null,fbc:g.fbc||null,landing_url:g.landing_url||null,user_agent:navigator.userAgent||null}:{}};let _;if(t?{error:_}=await b.from("leads").insert(h):{error:_}=await b.from("leads").update(h).eq("id",e.id),f.disabled=!1,f.textContent="💾 Salvar",_){I.style.color="#ef4444",I.textContent="Erro: "+_.message;return}I.style.color="#22c55e",I.textContent="✅ Salvo!",t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:h.name,email:h.email,phone:h.phone,tracking:g}).then(async q=>{if(q!=null&&q.ok){console.log("[CAPI] Lead enviado ao Meta:",q.event_id);try{await b.from("leads").update({capi_event_id:q.event_id,capi_sent_at:new Date().toISOString()}).eq("name",h.name).eq("phone",h.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(A){console.warn("[CAPI] falha ao salvar event_id:",A)}}else console.warn("[CAPI] não confirmado pelo Meta:",q)}).catch(q=>console.warn("[CAPI] erro:",q)),setTimeout(()=>{E(),Ke()},700)}),(k=document.getElementById("ldp-delete"))==null||k.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await b.from("leads").delete().eq("id",e.id),E(),Ke())})}let U=[],At=!1,he="pending";async function Ka(){var e;At||(At=!0,await Ya(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>aa()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),he=t.dataset.filter,ke()})}))}async function Ya(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=b.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}U=n||[],ke()}function ta(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function ke(){const e=document.getElementById("tarefas-list");if(!e)return;let t=U;if(he==="pending"&&(t=U.filter(a=>a.status!=="done")),he==="done"&&(t=U.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${he==="done"?"✅":"📋"}</div>
      <p>${he==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=ta(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await b.from("tasks").update({status:d}).eq("id",i);const l=U.find(s=>String(s.id)===i);l&&(l.status=d),ke()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await b.from("tasks").delete().eq("id",a.dataset.id),U=U.filter(i=>String(i.id)!==String(a.dataset.id)),ke())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=U.find(l=>String(l.id)===i);d&&aa(d)})})}function aa(e=null){var s,c,r,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=ta(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),d.addEventListener("click",p=>{p.target===d&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const p=a?"pending":"done";await b.from("tasks").update({status:p}).eq("id",e.id);const E=U.find(w=>String(w.id)===String(e.id));E&&(E.status=p),l(),p==="done"&&(he="done",document.querySelectorAll(".tarefa-filter-btn").forEach(w=>{w.classList.toggle("active",w.dataset.filter==="done")})),ke()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var f,I;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const E=new FormData(p),w=document.getElementById("tm-save");w.disabled=!0,w.textContent="Salvando…";const x={title:(f=E.get("title"))==null?void 0:f.trim(),description:((I=E.get("description"))==null?void 0:I.trim())||null,due_date:E.get("due_date")||null,priority:E.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null};let k;if(n){if({error:k}=await b.from("tasks").update(x).eq("id",e.id),!k){const $=U.findIndex(S=>String(S.id)===String(e.id));$>=0&&(U[$]={...U[$],...x})}}else{const{data:$,error:S}=await b.from("tasks").insert(x).select();k=S,!k&&($!=null&&$[0])&&U.unshift($[0])}if(w.disabled=!1,w.textContent=n?"Salvar":"Criar Tarefa",k){alert("Erro: "+k.message);return}l(),ke()})}async function Qa(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",l=>{l.preventDefault(),Z(),ae("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{te.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(te)),l.classList.remove("unread"),Z(),ae("contatos")})})}function en(){var e;document.querySelectorAll(".notif-item").forEach(t=>te.push(t.dataset.id)),te=[...new Set(te)],localStorage.setItem("crm_notifs_read",JSON.stringify(te)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function tn(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function an(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!te.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let Y=[],H=1;const Be=10;let Mt=!1;async function nn(){var t,n,a,o,i,d,l,s,c;document.getElementById("section-contatos")&&(Mt||(Mt=!0,await na(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{H=1,pe()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(H=1,pe())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>oa()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",dn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",ct),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",ct),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),E=document.createElement("a");E.href=URL.createObjectURL(p),E.download="modelo_contatos.csv",E.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",on),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",sn)))}async function na(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;Y=a||[],pe()}function pe(){var l,s,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Y.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):Y,n=t.length,a=Math.max(1,Math.ceil(n/Be));H>a&&(H=a);const o=t.slice((H-1)*Be,H*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{H--,pe()}),(c=d.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{H++,pe()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",m=>{m.preventDefault();const p=r.dataset.id,E=Y.find(w=>String(w.id)===String(p));E&&oa(E)})})}async function oa(e=null){var f,I,$,S,L,u;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=N(),[{data:o},{data:i},{data:d}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",a).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],c=d||[],r=l.map(g=>g.id),{data:m}=r.length?await b.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},p=m||[],E=(e==null?void 0:e.pipeline_id)||((f=l[0])==null?void 0:f.id)||"";function w(g){const h=p.filter(_=>_.pipeline_id===g);return h.length?'<option value="">— Selecionar etapa —</option>'+h.map(_=>`<option value="${v(_.name)}" ${(e==null?void 0:e.stage)===_.name?"selected":""}>${v(_.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const x=document.createElement("div");x.id="contato-modal-root",x.className="modal-backdrop",x.innerHTML=`
  ...
  `,document.body.appendChild(x);const k=()=>x.remove();(I=document.getElementById("cm-close"))==null||I.addEventListener("click",k),($=document.getElementById("cm-cancel"))==null||$.addEventListener("click",k),x.addEventListener("click",g=>{g.target===x&&k()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",g=>{const h=document.getElementById("cm-stage");h&&(h.innerHTML=w(g.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await b.from("leads").delete().eq("id",e.id);const g=Y.findIndex(h=>String(h.id)===String(e.id));g>=0&&Y.splice(g,1),k(),pe()}),(u=document.getElementById("cm-save"))==null||u.addEventListener("click",async()=>{var M,O,P,ne,re,$e,Se;const g=document.getElementById("contato-form");if(!g.checkValidity()){g.reportValidity();return}const h=new FormData(g),_=document.getElementById("cm-save");_.disabled=!0,_.textContent="Salvando…";const B=h.getAll("tag"),C=h.get("pipeline_id")||null,q={name:(M=h.get("name"))==null?void 0:M.trim(),company:((O=h.get("company"))==null?void 0:O.trim())||null,email:((P=h.get("email"))==null?void 0:P.trim())||null,phone:((ne=h.get("phone"))==null?void 0:ne.trim())||null,job_title:((re=h.get("job_title"))==null?void 0:re.trim())||null,city_interest:(($e=h.get("city_interest"))==null?void 0:$e.trim())||null,notes:((Se=h.get("notes"))==null?void 0:Se.trim())||null,pipeline_id:C,stage:h.get("stage")||null,status:h.get("status")||null,tags:B,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await b.from("leads").update(q).eq("id",e.id),!A){const F=Y.findIndex(ve=>String(ve.id)===String(e.id));F>=0&&(Y[F]={...Y[F],...q})}}else{const{data:F,error:ve}=await b.from("leads").insert(q).select();A=ve,!A&&(F!=null&&F[0])&&Y.unshift(F[0])}if(_.disabled=!1,_.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}k(),pe()})}let we=[];function on(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{we=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,c,r,m,p]=l.split(",").map(E=>E.trim().replace(/^"|"$/g,""));return{name:s,email:c,phone:r,company:m,job_title:p}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${we.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=we.length===0)},n.readAsText(t)}async function sn(){if(!we.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=we.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}ct(),await na(),alert(`${t.length} contato(s) importados com sucesso!`)}function dn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),we=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function ct(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const rn="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ue(e){return(await fetch(rn,{method:"POST",headers:{Authorization:`Bearer ${Ea}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function zt(e){var s,c,r,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:p}}=await b.auth.getUser();n.value=(p==null?void 0:p.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",p=>{const E=p.target.files[0];if(!E)return;const w=URL.createObjectURL(E);a&&(a.src=w,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var f,I;const p=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",E=((I=document.getElementById("change-password-confirm"))==null?void 0:I.value)||"",w=document.getElementById("change-password-msg"),x=document.getElementById("btn-change-password");if(w&&(w.style.display="none"),p.length<12){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}if(p!==E){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}x&&(x.disabled=!0,x.textContent="Salvando…");const{error:k}=await b.auth.updateUser({password:p});x&&(x.disabled=!1,x.textContent="Salvar Nova Senha"),k?w&&(w.textContent="Erro: "+k.message,w.style.display=""):(w&&(w.style.color="#16a34a",w.textContent="Senha alterada com sucesso!",w.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var I;const p=t.value.trim();let E=(y==null?void 0:y.avatar_url)||"";const w=i==null?void 0:i.files[0],x=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",w)try{const $=await De(w,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:L}=await b.storage.from("imoveis").upload(S,$,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:u}}=b.storage.from("imoveis").getPublicUrl(S);E=u}}catch($){console.error("Avatar upload:",$)}const{error:k}=await b.from("profiles").update({name:p,avatar_url:E}).eq("id",y.id);if(d.disabled=!1,d.textContent=x,k){alert("Erro ao salvar perfil.");return}y={...y,name:p,avatar_url:E},Ge(y);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((I=p[0])==null?void 0:I.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const p=document.getElementById("settings-corretores-section");p&&(p.style.display=""),await Ye(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var I,$;const w=(I=document.getElementById("invite-email"))==null?void 0:I.value.trim(),x=($=document.getElementById("invite-password"))==null?void 0:$.value.trim(),k=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!w){alert("Informe o e-mail do corretor.");return}if(!x||x.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}k&&(k.disabled=!0,k.textContent="Criando…"),f&&(f.style.display="none");try{const S=await ue({email:w,password:x,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const L=document.getElementById("invite-email"),u=document.getElementById("invite-password");L&&(L.value=""),u&&(u.value=""),await Ye(),f&&(S.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${v(x)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(S.error||"Falha desconhecida"))}catch(S){alert("Erro ao criar acesso: "+S.message)}finally{k&&(k.disabled=!1,k.textContent="+ Criar Acesso")}});const E=document.getElementById("settings-locations-section");E&&(E.style.display=""),await qe(),(r=document.getElementById("loc-add-city-btn"))==null||r.addEventListener("click",async()=>{const w=document.getElementById("loc-new-city"),x=w==null?void 0:w.value.trim();if(!x)return;const{error:k}=await b.from("locations").insert({type:"cidade",name:x});if(k){alert("Erro ao adicionar cidade.");return}w&&(w.value=""),await qe(),xt()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var I;const w=parseInt((I=document.getElementById("loc-new-neighborhood-city"))==null?void 0:I.value,10),x=document.getElementById("loc-new-neighborhood"),k=x==null?void 0:x.value.trim();if(!w||!k){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await b.from("locations").insert({type:"bairro",name:k,parent_id:w});if(f){alert("Erro ao adicionar bairro.");return}x&&(x.value=""),await qe()})}}async function Ye(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${v(i)}</div>`,l=o.id===(y==null?void 0:y.id),s=o.active!==!1,c=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',r=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const d=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${d}" e todos os bairros vinculados?`))return;const{error:l}=await b.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await qe(),xt()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:d}=await b.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await qe()})})}function Nt(){var n,a,o,i,d,l,s,c,r,m,p,E,w,x,k,f,I,$,S,L;document.querySelectorAll(".filter-btn").forEach(u=>{u.addEventListener("click",()=>{const g=u.closest(".filter-btns"),h=u.classList.contains("active");g.querySelectorAll(".filter-btn").forEach(_=>_.classList.remove("active")),h||u.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var B;const u=(B=document.getElementById("f-city"))==null?void 0:B.value,g=ge().find(C=>C.name===u),h=g?ht(g.id):[],_=document.getElementById("f-neighborhood");_&&(_.innerHTML='<option value="">Todos</option>'+h.map(C=>`<option value="${C.name}">${v(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Me(yt(T))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const u=document.querySelector(".admin-filter-panel");if(u){u.querySelectorAll('input[type="text"], input[type="number"]').forEach(h=>{h.value=""}),u.querySelectorAll("select").forEach(h=>{h.selectedIndex=0});const g=document.getElementById("f-neighborhood");g&&(g.innerHTML='<option value="">Todos</option>'),u.querySelectorAll(".filter-btn.active").forEach(h=>h.classList.remove("active"))}Me(T)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(u=>{u.addEventListener("click",()=>{ae(u.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(u=>{u.addEventListener("click",()=>{ae(u.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(u=>{u.addEventListener("click",g=>{g.stopPropagation();const h=u.closest(".topnav-dropdown");h==null||h.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(_=>{_!==h&&_.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(u=>u.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ue),(d=document.getElementById("modal-cancel"))==null||d.addEventListener("click",Ue),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",u=>{u.target.id==="property-modal"&&Ue()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{X=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",ee="",ze([]),it("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await b.auth.signOut(),location.reload()}),(r=document.getElementById("view-prev"))==null||r.addEventListener("click",()=>{Q=(Q-1+ie.length)%ie.length,Ve()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{Q=(Q+1)%ie.length,Ve()}),(p=document.getElementById("view-modal-close"))==null||p.addEventListener("click",Re),(E=document.getElementById("view-modal-close2"))==null||E.addEventListener("click",Re),(w=document.getElementById("view-modal"))==null||w.addEventListener("click",u=>{u.target.id==="view-modal"&&Re()}),(x=document.getElementById("view-modal-share"))==null||x.addEventListener("click",()=>{const u=document.getElementById("share-panel");if(!u)return;const g=u.style.display!=="none";u.style.display=g?"none":"block"}),(k=document.getElementById("share-whatsapp"))==null||k.addEventListener("click",()=>{var O,P,ne;const u=(O=document.getElementById("share-link-input"))==null?void 0:O.value;if(!u)return;const g=Number((P=document.getElementById("share-panel"))==null?void 0:P.dataset.pid),h=T.find(re=>re.id===g),_=(h==null?void 0:h.title)||((ne=document.getElementById("view-modal-title"))==null?void 0:ne.textContent)||"Imóvel",B=h!=null&&h.price?` — ${Ne(h.price,"pt")}`:"",C=h!=null&&h.reference?` | Ref: ${h.reference}`:"",q=[h==null?void 0:h.neighborhood,h==null?void 0:h.city].filter(Boolean).join(", "),A=q?`
📍 ${q}`:"",M=encodeURIComponent(`Olha esse imóvel que encontrei: *${_}*${B}${C}${A}

${u}`);window.open("https://wa.me/?text="+M,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var g,h;const u=(g=document.getElementById("share-link-input"))==null?void 0:g.value;u&&((h=navigator.clipboard)==null||h.writeText(u),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(I=document.getElementById("share-email"))==null||I.addEventListener("click",()=>{var B,C;const u=(B=document.getElementById("share-link-input"))==null?void 0:B.value;if(!u)return;const g=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",h=encodeURIComponent("Imóvel: "+g),_=encodeURIComponent(`Olá! Segue o link do imóvel:

`+u);window.open("mailto:?subject="+h+"&body="+_,"_blank")}),($=document.getElementById("share-copy"))==null||$.addEventListener("click",()=>{var g;const u=document.getElementById("share-link-input");u&&((g=navigator.clipboard)==null||g.writeText(u.value).then(()=>{const h=document.getElementById("share-copy"),_=h.textContent;h.textContent="✅ Copiado!",setTimeout(()=>{h.textContent=_},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var q;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const u=Number(document.getElementById("view-modal-edit").dataset.pid),g=T.find(A=>A.id===u);if(!g)return;Re(),X=g.id;const h=document.getElementById("property-form"),_=document.getElementById("form-submit-btn");_.textContent="Salvar Alterações",h.querySelector('[name="title"]').value=g.title||"",h.querySelector('[name="rua"]').value=g.rua||"",h.querySelector('[name="numero"]').value=g.numero||"",h.querySelector('[name="city"]').value=g.city||"",h.querySelector('[name="price"]').value=g.price||"",h.querySelector('[name="bedrooms"]').value=g.bedrooms||"",h.querySelector('[name="suites"]').value=g.suites||"",h.querySelector('[name="parking"]').value=g.parking||"",h.querySelector('[name="description"]').value=g.description||"",h.querySelector('[name="construction_status"]').value=g.construction_status||"",h.querySelector('[name="owner_name"]').value=g.owner_name||"",h.querySelector('[name="owner_phone"]').value=g.owner_phone||"",h.querySelector('[name="owner_email"]').value=g.owner_email||"",h.querySelector('[name="owner_notes"]').value=g.owner_notes||"",h.querySelector('[name="condominium"]').value=g.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=g.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=g.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=g.neighborhood||"")},50)),ee=g.cover_image||((q=g.images)==null?void 0:q[0])||"",ze(g.images||[]),it("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(u=>{u.addEventListener("click",()=>{var g;document.querySelectorAll(".tab-btn").forEach(h=>h.classList.remove("active")),u.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(h=>h.classList.add("hidden")),(g=document.getElementById(`tab-${u.dataset.tab}`))==null||g.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",u=>{if(u.target.closest(".action-btns"))return;const g=u.target.closest("tr");if(!g)return;const h=Number(g.dataset.id);if(!h)return;const _=T.find(B=>B.id===h);_&&Xa(_)})}async function sa(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",N()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let d=-1;function l(s=-1){d=s;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=s>=0?"Editar Depoimento":"Novo Depoimento";const r=s>=0?n[s]:{};e.querySelector("#dep-stars").value=String(r.stars||5),e.querySelector("#dep-text").value=r.text||"",e.querySelector("#dep-name").value=r.name||"",e.querySelector("#dep-role").value=r.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",d=-1}),e.addEventListener("click",s=>{const c=s.target.closest("[data-edit]"),r=s.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),r){const m=parseInt(r.dataset.del);confirm("Remover este depoimento?")&&(n.splice(m,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const s=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),r=e.querySelector("#dep-text").value.trim(),m=e.querySelector("#dep-name").value.trim(),p=e.querySelector("#dep-role").value.trim(),E=parseInt(e.querySelector("#dep-stars").value);if(!r||!m){alert("Preencha o depoimento e o nome.");return}s.disabled=!0,s.textContent="Salvando…";const w={stars:E,text:r,name:m,role:p};d>=0?n[d]=w:n.push(w);const x=await i();s.disabled=!1,s.textContent="Salvar",G(c,x),x&&(e.querySelector("#dep-form-wrap").style.display="none",d=-1,o())})}async function i(){const d=JSON.stringify(n);return await Oe("testimonials",{pt:d,en:d,es:d})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,s,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,m=He(r);if(m)ye(m);else{let p=null;for(const E of[t,"www."+t]){const{data:w}=await b.from("tenants").select("id").eq("domain",E).maybeSingle();if(w!=null&&w.id){p=w;break}}p!=null&&p.id&&(ye(p.id),nt(r,p.id,24*60*60*1e3))}}await Promise.all([xa(),ia()]),Ce=K("company.whatsapp",Ce),gt(),ja(),Oa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(xt(),n.addEventListener("change",()=>{const r=ge().find(p=>p.name===n.value),m=r?ht(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+m.map(p=>`<option value="${p.name}">${v(p.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),m=new URLSearchParams(window.location.search),p=r.get("type")||m.get("type")||"",E=Ft||p==="recovery"||p==="invite"||window.location.hash.includes("access_token")||m.has("code"),w=document.getElementById("password-reset-overlay");if(E){o.style.display="none",i&&i.classList.add("hidden"),w&&(w.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async k=>{var u,g;k.preventDefault();const f=((u=document.getElementById("new-password"))==null?void 0:u.value)||"",I=((g=document.getElementById("confirm-password"))==null?void 0:g.value)||"",$=document.getElementById("password-reset-msg"),S=k.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),f!==I){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:L}=await b.auth.updateUser({password:f});if(L){$&&($.textContent="Erro: "+L.message,$.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}window.location.href=window.location.pathname}),m.has("code")&&await b.auth.exchangeCodeForSession(m.get("code")??"");return}const{data:{session:x}}=await b.auth.getSession();if(x){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),tt(),Nt(),qt(),window.lucide&&lucide.createIcons(),y=await _t(x.user.id),!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(y.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const k=document.getElementById("password-reset-overlay");k&&(k.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async f=>{var g,h;f.preventDefault();const I=((g=document.getElementById("new-password"))==null?void 0:g.value)||"",$=((h=document.getElementById("confirm-password"))==null?void 0:h.value)||"",S=document.getElementById("password-reset-msg"),L=f.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),I!==$){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}if(I.length<12){S&&(S.textContent="Mínimo 6 caracteres.",S.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:u}=await b.auth.updateUser({password:I});if(u){S&&(S.textContent="Erro: "+u.message,S.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",y.id),window.location.href=window.location.pathname});return}ye((y==null?void 0:y.tenant_id)||null),Ge(y),Bt(y),Ct(y.role),await Xe(),await zt(y),window.lucide&&lucide.createIcons(),an(),ae("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const k=document.getElementById("login-form");k&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var $,S;const f=(S=($=k.querySelector('input[name="email"]'))==null?void 0:$.value)==null?void 0:S.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:I}=await b.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(I?"Erro: "+I.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),k.addEventListener("submit",async f=>{f.preventDefault();const I=k.querySelector('button[type="submit"]'),$=new FormData(k),S=$.get("email"),L=$.get("password");I&&(I.disabled=!0,I.textContent="Entrando…");try{if(await Ta(S,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),tt(),Nt(),window.lucide&&lucide.createIcons();const{data:{session:g}}=await b.auth.getSession();if(y=g?await _t(g.user.id):null,!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}qt(),ye((y==null?void 0:y.tenant_id)||null),Ge(y),Bt(y),Ct(y.role),await Xe(),await zt(y),window.lucide&&lucide.createIcons(),ae("dashboard")}else alert("E-mail ou senha incorretos")}catch(u){alert("Erro ao fazer login: "+((u==null?void 0:u.message)||String(u)))}finally{I&&(I.disabled=!1,I.textContent="Entrar")}}))}}else tt();await ce();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();kt(d),$t(Ce),window._applyDynamicContent=kt,window._applyWhatsAppLinks=$t,document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var p;const m=(p=r.closest(".nav-dropdown"))==null?void 0:p.querySelector(".nav-dropdown-menu");m&&r.addEventListener("click",E=>{E.stopPropagation(),m.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(w=>{w!==m&&w.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function ln(){const e=T.filter(o=>!o.reference);if(!e.length)return;const t=T.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=T.findIndex(s=>s.id===o.id);l>=0&&(T[l].reference=i),n++}}Me(yt(T))}async function cn(){const e=T.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await mn(i);a.push(d),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=T.findIndex(d=>d.id===t.id);i>=0&&(T[i].images=a)}}Me(yt(T))}}async function mn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),r=1200;let m=s.width,p=s.height;m>r&&(p=Math.round(p*r/m),m=r),c.width=m,c.height=p;const E=c.getContext("2d");E.drawImage(s,0,0,m,p);const w=x=>{if(x){const k=Math.round(m*.18),f=Math.round(x.naturalHeight*k/x.naturalWidth),I=Math.round(m*.02);E.globalAlpha=.45,E.drawImage(x,m-k-I,p-f-I,k,f),E.globalAlpha=1}c.toBlob(async k=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:I}=await b.storage.from("imoveis").upload(f,k,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(I){console.error("Upload watermark error:",I),l(e);return}const{data:{publicUrl:$}}=b.storage.from("imoveis").getPublicUrl(f);l($)}catch(f){console.error("Watermark upload exception:",f),l(e)}},"image/jpeg",.82)};if(d){const x=new Image;x.onload=()=>{URL.revokeObjectURL(d),w(x)},x.onerror=()=>{URL.revokeObjectURL(d),w(null)},x.src=d}else w(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function G(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Et(e,t="assets"){const n=await De(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function da(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",N()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>v(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `;const E=document.getElementById("crm-pipe-sel");E&&E.addEventListener("change",async()=>{const u=parseInt(E.value,10);if(!isNaN(u))try{j=u}catch{}await D()});const w=s==null?void 0:s.id;(f=document.getElementById("crm-rename-pipeline"))==null||f.addEventListener("click",async()=>{if(!w)return;const u=prompt("Novo nome do funil:",(s==null?void 0:s.name)||"");if(!u||u.trim()===(s==null?void 0:s.name))return;const{error:g}=await b.from("crm_pipelines").update({name:u.trim()}).eq("id",w);if(g){alert("Erro: "+g.message);return}await D()}),(I=document.getElementById("crm-set-default-pipeline"))==null||I.addEventListener("click",async()=>{if(w){if(s!=null&&s.is_default){alert("Este funil já é o padrão.");return}try{const u=N();await b.from("crm_pipelines").update({is_default:!1}).eq("tenant_id",u),await b.from("crm_pipelines").update({is_default:!0}).eq("id",w),await D()}catch(u){alert("Erro: "+u.message)}}}),($=document.getElementById("crm-delete-pipeline"))==null||$.addEventListener("click",async()=>{if(w){if(d.length===1){alert("Não pode excluir o único funil. Crie outro antes.");return}confirm(`Excluir o funil "${s==null?void 0:s.name}" e todas as suas etapas?

Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await b.from("crm_stages").delete().eq("pipeline_id",w),await b.from("crm_pipelines").delete().eq("id",w),j=null,await D())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,h=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await b.from("crm_stages").insert({pipeline_id:h,name:u,color:g,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-stage").value="",await D())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await b.from("crm_stages").delete().eq("id",u.dataset.id),await D())})}),e.querySelectorAll(".stage-name-input").forEach(u=>{u.addEventListener("blur",async()=>{const g=u.value.trim(),h=u.dataset.orig;if(!g||g===h){u.value=h;return}await b.from("crm_stages").update({name:g}).eq("id",u.dataset.sid),u.dataset.orig=g}),u.addEventListener("keydown",g=>{g.key==="Enter"&&(g.preventDefault(),u.blur()),g.key==="Escape"&&(u.value=u.dataset.orig,u.blur())})}),document.getElementById("crm-stages-list");let x=null;e.querySelectorAll(".stage-draggable").forEach(u=>{u.addEventListener("dragstart",g=>{x=u,u.classList.add("stage-dragging"),g.dataTransfer.effectAllowed="move";try{g.dataTransfer.setData("text/plain",u.dataset.id)}catch{}}),u.addEventListener("dragend",()=>{u.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(g=>g.classList.remove("stage-drop-over"))}),u.addEventListener("dragover",g=>{g.preventDefault(),g.dataTransfer.dropEffect="move",u!==x&&(e.querySelectorAll(".stage-drop-over").forEach(h=>h.classList.remove("stage-drop-over")),u.classList.add("stage-drop-over"))}),u.addEventListener("dragleave",()=>{u.classList.remove("stage-drop-over")}),u.addEventListener("drop",async g=>{if(g.preventDefault(),!x||u===x)return;const h=x.dataset.id,_=u.dataset.id,B=r.findIndex(M=>String(M.id)===String(h)),C=r.findIndex(M=>String(M.id)===String(_));if(B<0||C<0)return;const q=r.splice(B,1)[0];r.splice(C,0,q);const A=r.map((M,O)=>b.from("crm_stages").update({sort_order:O}).eq("id",M.id));x=null,await Promise.all(A).catch(M=>console.warn("[stages] erro reordenar:",M)),await D()})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async g=>{await b.from("crm_stages").update({color:g.target.value}).eq("id",u.dataset.sid);const h=u.closest(".stage-item").querySelector(".stage-color-dot");h&&(h.style.background=g.target.value)})});const k=async()=>{const u=document.getElementById("crm-new-tag"),g=document.getElementById("crm-new-tag-color"),h=u==null?void 0:u.value.trim(),_=(g==null?void 0:g.value)||"#6366F1";if(!h){u==null||u.focus();return}await b.from("crm_tags").insert({name:h,color:_,tenant_id:N()}),u&&(u.value=""),await D()};(S=document.getElementById("crm-add-tag"))==null||S.addEventListener("click",k),(L=document.getElementById("crm-new-tag"))==null||L.addEventListener("keydown",u=>{u.key==="Enter"&&k()}),e.querySelectorAll(".tm-del-btn").forEach(u=>{u.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await b.from("crm_tags").delete().eq("id",u.dataset.id),await D())})}),e.querySelectorAll(".tm-name-input").forEach(u=>{const g=u.closest(".tm-row"),h=g==null?void 0:g.querySelector(".tm-save-btn");h&&(h.style.display="none"),u.addEventListener("input",()=>{const _=u.value.trim()!==u.dataset.orig;h&&(h.style.display=_?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(u=>{const g=u.closest(".tm-row"),h=g==null?void 0:g.querySelector(".tm-color-swatch"),_=g==null?void 0:g.querySelector(".tm-save-btn");u.addEventListener("input",B=>{h&&(h.style.background=B.target.value),_&&(_.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(u=>{u.style.display="none",u.addEventListener("click",async()=>{var B,C;const g=u.closest(".tm-row"),h=(B=g.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),_=(C=g.querySelector(".tm-color-input"))==null?void 0:C.value;h&&(u.disabled=!0,u.textContent="✓ Salvando…",await b.from("crm_tags").update({name:h,color:_}).eq("id",u.dataset.id),await D())})}),e.querySelectorAll(".tm-tpl-btn").forEach(u=>{u.addEventListener("click",async()=>{const g=u.dataset.name,h=u.dataset.color;u.disabled=!0,u.innerHTML="✓",await b.from("crm_tags").insert({name:g,color:h,tenant_id:N()}),await D()})}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await b.from("crm_tags").delete().eq("id",u.dataset.id),await D()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,h=document.getElementById("crm-new-status-final").checked;u&&(await b.from("crm_lead_statuses").insert({name:u,color:g,is_final:h,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-status").value="",await D())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await b.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await D())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var h;const u=(h=prompt("Nome do novo funil:"))==null?void 0:h.trim();if(!u)return;const{error:g}=await b.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:N()});if(g){alert("Erro ao criar funil: "+g.message);return}dt=!1,await D()})}async function ma(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var s;return v(((s=n[l])==null?void 0:s.value)||"")},o=l=>{var s;return(s=n[l])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await mt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var s,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),d=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const r of a){d.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const m=await Et(r,"media"),p=r.name.replace(/\.[^.]+$/,"").slice(0,60);await b.from("media_library").insert({name:p,url:m,type:"image",size:r.size,created_by:(c=(s=(await b.auth.getUser()).data)==null?void 0:s.user)==null?void 0:c.id})}catch(m){console.error("Media upload error:",m)}l++}i.style.width="100%",d.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await mt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function mt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await b.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const l=e.querySelector(`#sa-panel-${d.dataset.tab}`);l&&l.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&de(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&un(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Dt(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Rt(),d.dataset.tab==="platform"&&jt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Dt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",de),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Rt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>vn()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",gn),de(),jt())}async function de(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=b.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var r,m;return!t||((r=c.name)==null?void 0:r.toLowerCase().includes(t))||((m=c.slug)==null?void 0:m.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var r;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async r=>{r.stopPropagation();const m=c.dataset.active==="true";await b.from("tenants").update({active:!m}).eq("id",c.dataset.id),de()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const r=(i||[]).find(m=>String(m.id)===String(c.dataset.id));r&&yn(r)})})}async function un(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await b.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),b.from("plans").select("id, name").then(({data:c})=>{const r=document.getElementById("nt-plan");r&&c&&(r.innerHTML='<option value="">Sem plano</option>'+c.map(m=>`<option value="${m.id}">${v(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=fn(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var L,u,g,h,_,B,C,q,A,M,O,P;const c=(u=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:u.trim(),r=(h=(g=document.getElementById("nt-slug"))==null?void 0:g.value)==null?void 0:h.trim(),m=(B=(_=document.getElementById("nt-domain"))==null?void 0:_.value)==null?void 0:B.trim(),p=(C=document.getElementById("nt-plan"))==null?void 0:C.value,E=(A=(q=document.getElementById("nt-admin-email"))==null?void 0:q.value)==null?void 0:A.trim(),w=(O=(M=document.getElementById("nt-admin-password"))==null?void 0:M.value)==null?void 0:O.trim(),x=document.getElementById("nt-msg"),k=document.getElementById("nt-save");if(!c||!r){x.textContent="❌ Nome e slug são obrigatórios.",x.style.color="#ef4444";return}if(!E){x.textContent="❌ Informe o e-mail do admin.",x.style.color="#ef4444";return}if(!w||w.length<12){x.textContent="❌ A senha precisa ter mínimo 6 caracteres.",x.style.color="#ef4444";return}k.disabled=!0,k.textContent="Criando…",x.textContent="⏳ Criando imobiliária…",x.style.color="#64748b";const{data:f,error:I}=await b.from("tenants").insert({name:c,slug:r,domain:m||null,plan_id:p||null,active:!0}).select();if(I){k.disabled=!1,k.textContent="Criar Imobiliária",x.textContent="❌ "+I.message,x.style.color="#ef4444";return}const $=(P=f==null?void 0:f[0])==null?void 0:P.id;x.textContent="⏳ Criando usuário admin…";const S=await ue({email:E,password:w,role:"admin",tenant_id:$});if(!(S!=null&&S.success)){k.disabled=!1,k.textContent="Criar Imobiliária",x.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+v((S==null?void 0:S.error)||"Desconhecido"),x.style.color="#f59e0b",setTimeout(()=>{n(),de()},3e3);return}$&&(S!=null&&S.user_id)&&!(S!=null&&S.linked)&&await b.from("profiles").update({tenant_id:$}).eq("id",S.user_id),k.disabled=!1,k.textContent="Criar Imobiliária",S.email_sent===!1?(x.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>ua(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",pt(e,o.dataset.tab)})}),pt(e,"properties")}function bn(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,c,r="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var I;(I=navigator.clipboard)==null||I.writeText(e.id);const k=document.getElementById("tp-copy-key"),f=k.textContent;k.textContent="✅ Copiada!",setTimeout(()=>{k.textContent=f},2e3)})}if(t==="config"){const{data:r}=await b.from("settings").select("key,value").eq("tenant_id",e.id),m={};r==null||r.forEach(E=>{m[E.key]=E.value});const p=(E,w)=>`
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>ua(e))}}function ua(e){var c,r,m,p,E,w,x,k;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([f,I,$])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:f})=>{const I=document.getElementById("et-plan");I&&f&&(I.innerHTML='<option value="">Sem plano</option>'+f.map($=>`<option value="${$.id}"${String($.id)===String(e.plan_id)?" selected":""}>${v($.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",f=>{const I=f.target.files[0];if(!I)return;const $=URL.createObjectURL(I),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${$}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(p=document.getElementById("et-copy-key"))==null||p.addEventListener("click",()=>{var S,L;const f=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!f)return;(L=navigator.clipboard)==null||L.writeText(f);const I=document.getElementById("et-copy-key"),$=I.textContent;I.textContent="✅ Copiada!",setTimeout(()=>{I.textContent=$},2e3)});const o=["dados","config","api"];function i(f){o.forEach(I=>{document.getElementById(`et-pane-${I}`).style.display=I===f?"":"none";const $=document.getElementById(`et-tab-${I}`);$.style.borderBottomColor=I===f?"#2563eb":"transparent",$.style.color=I===f?"#2563eb":"#64748b",$.style.fontWeight=I===f?"600":"500"}),f==="config"&&l()}o.forEach(f=>{var I;return(I=document.getElementById(`et-tab-${f}`))==null?void 0:I.addEventListener("click",()=>i(f))});let d=!1;async function l(){var $;if(d)return;d=!0;const{data:f}=await b.from("settings").select("key,value").eq("tenant_id",e.id),I={};f==null||f.forEach(S=>{I[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,($=document.getElementById("et-cfg-save"))==null||$.addEventListener("click",async()=>{const S=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");S.disabled=!0,S.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const u=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),g=document.getElementById("et-cfg-phone").value.trim(),h=document.getElementById("et-cfg-email").value.trim(),_=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await b.from("settings").upsert([{key:"company.whatsapp",value:u,tenant_id:e.id},{key:"company.phone",value:g,tenant_id:e.id},{key:"company.email",value:h,tenant_id:e.id},{key:"company.city",value:_,tenant_id:e.id},{key:"company.address",value:_,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});S.disabled=!1,S.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const s=()=>n.remove();(E=document.getElementById("et-close"))==null||E.addEventListener("click",s),(w=document.getElementById("et-cancel"))==null||w.addEventListener("click",s),n.addEventListener("click",f=>{f.target===n&&s()}),(x=document.getElementById("et-delete"))==null||x.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const I=document.getElementById("et-delete");I.disabled=!0,I.textContent="Excluindo…";const{error:$}=await b.from("tenants").delete().eq("id",e.id);if($){alert("Erro ao excluir: "+$.message),I.disabled=!1,I.textContent="🗑️ Excluir";return}s(),de()}),(k=document.getElementById("et-save"))==null||k.addEventListener("click",async()=>{var q,A,M,O,P,ne,re,$e,Se,F,ve,wt;const f=(A=(q=document.getElementById("et-name"))==null?void 0:q.value)==null?void 0:A.trim(),I=(O=(M=document.getElementById("et-slug"))==null?void 0:M.value)==null?void 0:O.trim(),$=(ne=(P=document.getElementById("et-domain"))==null?void 0:P.value)==null?void 0:ne.trim(),S=(re=document.getElementById("et-plan"))==null?void 0:re.value,L=(Se=($e=document.getElementById("et-admin-email"))==null?void 0:$e.value)==null?void 0:Se.trim(),u=(ve=(F=document.getElementById("et-admin-password"))==null?void 0:F.value)==null?void 0:ve.trim(),g=(wt=document.getElementById("et-logo-input"))==null?void 0:wt.files[0],h=document.getElementById("et-msg"),_=document.getElementById("et-save");if(!f){h.textContent="❌ Nome é obrigatório.",h.style.color="#ef4444";return}_.disabled=!0,_.textContent="Salvando…",h.textContent="⏳ Salvando…",h.style.color="#64748b";let B=e.logo_url;if(g)try{const z=await De(g,256,.85),It=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:ba}=await b.storage.from("imoveis").upload(It,z,{contentType:"image/jpeg",upsert:!0});if(!ba){const{data:{publicUrl:ha}}=b.storage.from("imoveis").getPublicUrl(It);B=ha}}catch(z){console.error("Logo upload:",z)}const{error:C}=await b.from("tenants").update({name:f,slug:I||e.slug,domain:$||null,plan_id:S||null,logo_url:B}).eq("id",e.id);if(C){_.disabled=!1,_.textContent="Salvar",h.textContent="❌ "+C.message,h.style.color="#ef4444";return}if(L&&u&&u.length>=6){h.textContent="⏳ Criando usuário admin…";const z=await ue({email:L,password:u,role:"admin",tenant_id:e.id});z!=null&&z.success?(z!=null&&z.user_id&&!(z!=null&&z.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",z.user_id),h.textContent="✅ Salvo e admin criado!",h.style.color="#22c55e"):(h.textContent="⚠️ Salvo, mas erro ao criar admin: "+((z==null?void 0:z.error)||"Tente novamente"),h.style.color="#f59e0b")}else h.textContent="✅ Imobiliária atualizada!",h.style.color="#22c55e";_.disabled=!1,_.textContent="Salvar",setTimeout(()=>{s(),de()},1200)})}const Ot=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Qe=[],fe=[],Pe={};function hn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",xn)}function xn(){Qe=[],fe=[],Pe={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),ga();const t=document.getElementById("import-drop-zone"),n=document.getElementById("import-file-input");function a(i){i.preventDefault()}document.addEventListener("dragover",a),document.addEventListener("drop",a),t.addEventListener("click",()=>n.click()),t.addEventListener("dragenter",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragover",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragleave",i=>{t.contains(i.relatedTarget)||(t.style.borderColor="#c7d2e0",t.style.background="")}),t.addEventListener("drop",i=>{var l,s;i.preventDefault(),t.style.borderColor="#c7d2e0",t.style.background="";const d=(s=(l=i.dataTransfer)==null?void 0:l.files)==null?void 0:s[0];d&&Ht(d)}),n.addEventListener("change",i=>{var l;const d=(l=i.target.files)==null?void 0:l[0];d&&Ht(d),i.target.value=""});const o=new MutationObserver(()=>{document.getElementById("import-leads-overlay")||(document.removeEventListener("dragover",a),document.removeEventListener("drop",a),o.disconnect())});o.observe(document.body,{childList:!0})}async function ga(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await b.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Ht(e){if(!e)return;const t=document.getElementById("import-file-status"),n=document.getElementById("import-upload-error");n.style.display="none";const a=e.name.toLowerCase();if(t.textContent=`📄 ${e.name} (${(e.size/1024).toFixed(1)} KB)`,a.endsWith(".csv")){const o=new FileReader;o.onload=i=>{const d=En(i.target.result);if(d.error){n.textContent=d.error,n.style.display="";return}fe=d.headers,Qe=d.rows,fa()},o.readAsText(e,"UTF-8")}else if(a.endsWith(".xlsx")||a.endsWith(".xls")){const o=new FileReader;o.onload=i=>wn(i.target.result),o.readAsArrayBuffer(e)}else n.textContent="Formato não suportado. Use CSV ou XLSX.",n.style.display=""}function En(e){const t=e.split(`
`)[0]||"",n=t.split(";").length>t.split(",").length?";":",",a=e.split(`
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const s=[];let c="",r=!1;for(let m=0;m<l.length;m++){const p=l[m];p==='"'?r&&l[m+1]==='"'?(c+='"',m++):r=!r:p===n&&!r?(s.push(c.trim()),c=""):c+=p}return s.push(c.trim()),s}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),d=a.slice(1).map(o);return{headers:i,rows:d}}async function wn(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,d)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=d,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}fe=o[0].map(String),Qe=o.slice(1),fa()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function In(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function fa(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+fe.map((a,o)=>`<option value="${o}">${v(a)}</option>`).join("");e.innerHTML=Ot.map(a=>{const o=In(fe,t[a.key]||[]);return Pe[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Ot.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Pe[a.key]!==""&&(o.value=Pe[a.key])}),kn(),ga()}function kn(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=Qe.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${fe.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${v(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${fe.map((i,d)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${v(String(o[d]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function $n(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Sn(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),d=e.querySelector("#ldp-tag-search"),l=e.querySelector("#ldp-tag-opt-list"),s=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),r=e.querySelector("#ldp-tag-new-name"),m=e.querySelector("#ldp-tag-new-color"),p=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function E(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map($=>$.dataset.tag)}function w($){if(!$.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=$.map(S=>{const u=(n[S]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(S)}" style="background:${u}18;color:${u};border-color:${u}55;">
        ${v(S)}<span class="ldp-tag-rm" data-tag="${v(S)}">×</span>
      </span>`}).join("")}function x($=""){const S=E(),L=$.toLowerCase().trim(),u=t.filter(g=>!L||g.name.toLowerCase().includes(L));if(!u.length){l.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}l.innerHTML=u.map(g=>{const h=S.includes(g.name);return`<div class="ldp-tag-opt${h?" active":""}" data-tag="${v(g.name)}" style="--tc:${g.color}">
      ...
      </div>`}).join("")}function k(){i.classList.remove("hidden"),x(""),d.value="",c.classList.add("hidden"),d.focus()}function f(){i.classList.add("hidden")}o.addEventListener("click",$=>{$.stopPropagation(),i.classList.contains("hidden")?k():f()}),document.addEventListener("mousedown",function $(S){e.contains(S.target)||(f(),document.removeEventListener("mousedown",$))}),i.addEventListener("mousedown",$=>$.stopPropagation()),d.addEventListener("input",()=>x(d.value)),l.addEventListener("click",$=>{const S=$.target.closest(".ldp-tag-opt");if(!S)return;const L=S.dataset.tag,u=E();u.includes(L)?w(u.filter(g=>g!==L)):w([...u,L]),x(d.value)}),a.addEventListener("click",$=>{const S=$.target.closest(".ldp-tag-rm");if(!S)return;const L=S.dataset.tag;w(E().filter(u=>u!==L))}),s.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||r.focus()});async function I(){const $=r.value.trim();if(!$){r.focus();return}const S=m.value||"#6366F1";if(t.some(L=>L.name.toLowerCase()===$.toLowerCase())){r.style.borderColor="#ef4444",setTimeout(()=>{r.style.borderColor=""},1500);return}p.disabled=!0,p.textContent="Criando…";try{const{data:L,error:u}=await b.from("crm_tags").insert({name:$,color:S,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(u)throw u;const g={id:L.id,name:L.name,color:L.color};t.push(g),n[g.name]=g,typeof me<"u"&&(me[g.name]=g),w([...E(),g.name]),x(d.value),r.value="",m.value="#6366F1",c.classList.add("hidden")}catch(L){console.error("Error creating tag:",L),alert("Erro ao criar tag: "+(L.message||L))}finally{p.disabled=!1,p.textContent="Criar e adicionar"}}p.addEventListener("click",I),r.addEventListener("keydown",$=>{$.key==="Enter"&&I()})}async function Ln(){var k;const e=document.getElementById("section-dashboard");if(!e)return;e.dataset.dbInit==="1"&&(window._dbLeadsChartInstance&&(window.window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null),window._dbOriginChartInstance&&(window.window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)),e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],d=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${d[n.getMonth()]} de ${n.getFullYear()}`,s=((k=y==null?void 0:y.name)==null?void 0:k.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${R(s)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${l}`);let m=[],p=[];try{const[f,I]=await Promise.all([Vt(),_n()]);m=f||[],p=I||[]}catch(f){console.warn("[Dashboard] Erro ao carregar dados:",f)}Bn(m,p,n);const E=m.filter(f=>f.published).length,w=p.filter(f=>ut(f.created_at)===ut(n.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${l.split(",")[0]}
    </span>`),qn(p,m),Tn(m),An(m,p,n),Mn(m,p);try{await $n(),Ut(p,7),Cn(p),document.querySelectorAll(".db-ptab").forEach(f=>{f.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach($=>$.classList.remove("active")),f.classList.add("active");const I=parseInt(f.dataset.p);window._dbSelectedDays=I,Ut(p,I)})})}catch(f){console.warn("[Dashboard] Chart.js não carregou:",f)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const f=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!f||f.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function R(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ut(e){return(e||"").slice(0,10)}function va(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function ya(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function _n(){let e=b.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(y==null?void 0:y.role)==="corretor"?e=e.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function Bn(e,t,n){const a=e.length,o=e.filter(x=>x.published).length,i=t.length,d=t.filter(x=>x.stage&&x.stage!=="perdido"&&x.stage!=="fechado").length,l=new Date(n);l.setDate(l.getDate()-30);const s=new Date(n);s.setDate(s.getDate()-60);const c=e.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,r=e.filter(x=>x.created_at&&new Date(x.created_at)>=s&&new Date(x.created_at)<l).length,m=t.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,p=t.filter(x=>x.created_at&&new Date(x.created_at)>=s&&new Date(x.created_at)<l).length;function E(x,k,f){if(k===0&&x===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(k===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const I=Math.round((x-k)/k*100);return I===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':I>0?`<span class="db-kpi-trend db-trend-up">▲ +${I}% ${f}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${I}% ${f}</span>`}[{idx:0,val:a,label:"Total de Imóveis",trend:E(c,r,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:o,label:"Publicados no Site",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:2,val:i,label:"Leads Recebidos",trend:E(m,p,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:3,val:d,label:"Em Negociação",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'}].forEach(({idx:x,val:k,label:f,trend:I,icon:$})=>{const S=document.getElementById(`db-kpi-${x}`);S&&(S.innerHTML=`
      <div class="db-kpi-icon">${$}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${ya(k)}</div>
        <div class="db-kpi-lbl">${R(f)}</div>
        ${I}
      </div>`)})}function Ut(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let l=t-1;l>=0;l--){const s=new Date(i);s.setDate(s.getDate()-l);const c=s.toISOString().slice(0,10),r=t<=7?s.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?s.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):s.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(r),o.push(e.filter(m=>ut(m.created_at)===c).length)}const d=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(l=>l===d&&d>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:l=>` ${l.parsed.y} lead${l.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(d/4))}}}}})}window._dbOriginChartInstance=null;function Cn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const r=c.source||"Direto",m=r.charAt(0).toUpperCase()+r.slice(1);a[m]=(a[m]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),d=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],l=o.map((c,r)=>d[r%d.length]),s=i.reduce((c,r)=>c+r,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:l,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const r=s>0?Math.round(c.parsed/s*100):0;return` ${c.label}: ${c.parsed} (${r}%)`}}}}}}),n&&(s===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,r)=>`
