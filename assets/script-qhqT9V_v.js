import{s as y}from"./supabase-BcuJ3xoD.js";const O="00000000-0000-0000-0000-000000000000";let se={},he={},ee=O;function ve(e){ee=e||O,se={},he={}}const z=()=>ee;async function Ot(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",ee),y.from("site_content").select("*").eq("tenant_id",ee)]);if(e.data&&e.data.forEach(n=>{se[n.key]=n.value}),t.data&&t.data.forEach(n=>{he[n.key]=n}),(!t.data||t.data.length===0)&&ee!==O){const[n,a]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",O),y.from("site_content").select("*").eq("tenant_id",O)]);n.data&&n.data.forEach(o=>{se[o.key]===void 0&&(se[o.key]=o.value)}),a.data&&a.data.forEach(o=>{he[o.key]||(he[o.key]=o)})}}const G=(e,t=null)=>se[e]!==void 0?se[e]:t,ke=(e,t="pt")=>{const n=he[e];return n&&(n["value_"+t]||n.value_pt)||null};async function xe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ee,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{se[o]=i}),!a}async function Me(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ee,updated_at:o},{error:d}=await y.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(he[e]=i),ee!==O&&await y.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:O,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Fe(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function at(){const e=document.documentElement,t=G("visual.accent_color","#b8962e"),n=G("visual.primary_bg","#0f1c2e"),a=G("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=G("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=G("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=G("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function ct(e){e=e||"pt";const t=h=>ke(h,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),m=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),c=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),m&&t("inst.stat2_num")&&(m.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const b=document.getElementById("dep-grid");if(b){const h=ke("testimonials",e)||ke("testimonials","pt");if(h)try{const v=JSON.parse(h);if(Array.isArray(v)&&v.length>0){let k=function($){return String($||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},S=function($){let w=0;for(const I of $||"?")w=w*31+I.charCodeAt(0)&4294967295;return B[Math.abs(w)%B.length]};const B=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];b.innerHTML=v.map($=>`
            ...
            </div>`).join("")}}catch{}}const x=ke("seo.title_pt",e);x&&(document.title=x);const E=ke("seo.description_pt",e);if(E){const h=document.querySelector('meta[name="description"]');h&&(h.content=E)}}function mt(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Pt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let le="5547999701743";const ne=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Ft=5.7;function re(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Ft).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],f=null,_e=[],$t=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&($t=!0)});function Ge(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function ze(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function kt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:r,error:c}=await y.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return c&&console.error("Supabase select error:",c),r||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=z();if(!o||o===O){const r=ze(a);if(r)o=r,ve(o);else{const c=t.replace(/^www\./,"");for(const p of[c,"www."+c]){const{data:u}=await y.from("tenants").select("id").eq("domain",p).maybeSingle();if(u!=null&&u.id){o=u.id,ve(o);break}}o&&o!==O&&Ge(a,o,24*60*60*1e3)}}if(!o||o===O)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const r=ze(i);if(r)return setTimeout(()=>kt({background:!0}),100),r}const{data:l,error:s}=await y.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),ze(i)||[];const m=l||[];return Ge(i,m,d),e&&typeof ce=="function"&&ce().catch(()=>{}),m}async function Xt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="super_admin"||(f!=null&&f.tenant_id?e=e.eq("tenant_id",f.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],Ea(),wa(),_)}async function Gt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Vt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Wt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function Te(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,m=i.height;s>t&&(m=Math.round(m*t/s),s=t),l.width=s,l.height=m;const r=l.getContext("2d");r.drawImage(i,0,0,s,m);const c=new Image;c.crossOrigin="anonymous",c.onload=()=>{const p=Math.round(s*.18),u=Math.round(c.naturalHeight*p/c.naturalWidth),b=Math.round(s*.02),x=s-p-b,E=m-u-b;r.globalAlpha=.45,r.drawImage(c,x,E,p,u),r.globalAlpha=1,l.toBlob(h=>h?a(h):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},c.onerror=()=>{l.toBlob(p=>p?a(p):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},c.src="/logo.png"},i.onerror=o,i.src=d})}async function Jt(e){const t=await Te(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Yt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Jt(n[o]));return a}async function ce(){var p,u,b,x,E,h;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await kt();_=n,((p=document.getElementById("selecao-carousel"))==null?void 0:p.innerHTML)===""&&Kt(n);const a=((u=document.getElementById("city-filter"))==null?void 0:u.value)||"",o=((b=document.getElementById("neighborhood-filter"))==null?void 0:b.value)||"",i=((x=document.getElementById("bedrooms-filter"))==null?void 0:x.value)||"",d=((E=document.getElementById("parking-filter"))==null?void 0:E.value)||"",l=((h=document.getElementById("construction-filter"))==null?void 0:h.value)||"",{min:s,max:m}=Zt(),r=n.filter(v=>{if(a&&v.city!==a||o&&v.neighborhood!==o||i&&(i==="4+"&&Number(v.bedrooms)<4||i!=="4+"&&Number(v.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(v.parking)<4||d!=="4+"&&Number(v.parking)!==Number(d))||l&&v.construction_status!==l)return!1;const B=String(v.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),k=parseInt(B,10)||0;return!(k<s||m!==1/0&&k>m)});if(e){if(!r.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=r.map(v=>{var w;const B=v.cover_image||((w=v.images)==null?void 0:w[0])||ne[0],k=[v.neighborhood,v.city].filter(Boolean).join(", "),S=`https://omarcorretor.com.br/og/${v.id}`,$=encodeURIComponent(`Olá! Tenho interesse no imóvel *${v.title}*${v.reference?` (Ref: ${v.reference})`:""}. Poderia me dar mais informações?
${S}`);return`
...
${S}`);return`
    ...
    `}).join("");const c=document.getElementById("properties");c&&!c._carouselDelegated&&(c._carouselDelegated=!0,c.addEventListener("click",Qt))}function Kt(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var p;const s=l.cover_image||((p=l.images)==null?void 0:p[0])||ne[0],m=[l.neighborhood,l.city].filter(Boolean).join(", "),r=`https://omarcorretor.com.br/og/${l.id}`,c=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?
${r}`);return`
      <div class="selecao-card">
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(m=document.getElementById("tm-cancel"))==null||m.addEventListener("click",l),d.addEventListener("click",p=>{p.target===d&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const p=a?"pending":"done";await y.from("tasks").update({status:p}).eq("id",e.id);const u=j.find(b=>String(b.id)===String(e.id));u&&(u.status=p),l(),p==="done"&&(be="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),we()}),(c=document.getElementById("tm-save"))==null||c.addEventListener("click",async()=>{var h,v;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const u=new FormData(p),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const x={title:(h=u.get("title"))==null?void 0:h.trim(),description:((v=u.get("description"))==null?void 0:v.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let E;if(n){if({error:E}=await y.from("tasks").update(x).eq("id",e.id),!E){const B=j.findIndex(k=>String(k.id)===String(e.id));B>=0&&(j[B]={...j[B],...x})}}else{const{data:B,error:k}=await y.from("tasks").insert(x).select();E=k,!E&&(B!=null&&B[0])&&j.unshift(B[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}l(),we()})}async function ma(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(d=>{d.addEventListener("click",()=>{var l;(l=document.getElementById("search-overlay"))==null||l.classList.add("hidden"),d.dataset.type==="lead"?me("contatos"):me("properties")})})}let Y=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function pa(){var d;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=y.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(l=>!Y.includes(String(l.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(l=>{const s=ga(l.created_at);return`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",l=>{l.preventDefault(),J(),me("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{Y.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(Y)),l.classList.remove("unread"),J(),me("contatos")})})}function ua(){var e;document.querySelectorAll(".notif-item").forEach(t=>Y.push(t.dataset.id)),Y=[...new Set(Y)],localStorage.setItem("crm_notifs_read",JSON.stringify(Y)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function ga(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function fa(){let e=y.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);f!=null&&f.tenant_id&&(e=e.eq("tenant_id",f.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!Y.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let V=[],N=1;const Se=10;let bt=!1;async function va(){var t,n,a,o,i,d,l,s,m;document.getElementById("section-contatos")&&(bt||(bt=!0,await _t(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{N=1,pe()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(N=1,pe())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>Ct()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",ha),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",Ze),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",Ze),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const c=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([c],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(p),u.download="modelo_contatos.csv",u.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",ya),(m=document.getElementById("import-modal-confirm"))==null||m.addEventListener("click",ba)))}async function _t(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;V=a||[],pe()}function pe(){var l,s,m;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?V.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):V,n=t.length,a=Math.max(1,Math.ceil(n/Se));N>a&&(N=a);const o=t.slice((N-1)*Se,N*Se),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
...
`+$);window.open("mailto:?subject="+I+"&body="+L,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var w;const $=document.getElementById("share-link-input");$&&((w=navigator.clipboard)==null||w.writeText($.value).then(()=>{const I=document.getElementById("share-copy"),L=I.textContent;I.textContent="✅ Copiado!",setTimeout(()=>{I.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var M;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(q=>q.id===$);if(!w)return;qe(),R=w.id;const I=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",I.querySelector('[name="title"]').value=w.title||"",I.querySelector('[name="rua"]').value=w.rua||"",I.querySelector('[name="numero"]').value=w.numero||"",I.querySelector('[name="city"]').value=w.city||"",I.querySelector('[name="price"]').value=w.price||"",I.querySelector('[name="bedrooms"]').value=w.bedrooms||"",I.querySelector('[name="suites"]').value=w.suites||"",I.querySelector('[name="parking"]').value=w.parking||"",I.querySelector('[name="description"]').value=w.description||"",I.querySelector('[name="construction_status"]').value=w.construction_status||"",I.querySelector('[name="owner_name"]').value=w.owner_name||"",I.querySelector('[name="owner_phone"]').value=w.owner_phone||"",I.querySelector('[name="owner_email"]').value=w.owner_email||"",I.querySelector('[name="owner_notes"]').value=w.owner_notes||"",I.querySelector('[name="condominium"]').value=w.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=w.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=w.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const q=document.getElementById("adminNeighborhood");q&&(q.value=w.neighborhood||"")},50)),de=w.cover_image||((M=w.images)==null?void 0:M[0])||"",Re(w.images||[]),Ve("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach(I=>I.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(I=>I.classList.add("hidden")),(w=document.getElementById(`tab-${$.dataset.tab}`))==null||w.classList.remove("hidden")})}),(S=document.getElementById("admin-properties"))==null||S.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const w=$.target.closest("tr");if(!w)return;const I=Number(w.dataset.id);if(!I)return;const L=_.find(T=>T.id===I);L&&oa(L)})}async function qt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",z()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const m of d||"?")s=s*31+m.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Ht(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",tt(e,o.dataset.tab)})}),tt(e,"properties")}function Ca(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,m,r="text",c="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(m=document.getElementById("tp-open-edit"))==null||m.addEventListener("click",()=>Ht(e))}}function Ht(e){var m,r,c,p,u,b,x,E;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
Essa ação é irreversível e removerá o registro da plataforma.`))return;const v=document.getElementById("et-delete");v.disabled=!0,v.textContent="Excluindo…";const{error:B}=await y.from("tenants").delete().eq("id",e.id);if(B){alert("Erro ao excluir: "+B.message),v.disabled=!1,v.textContent="🗑️ Excluir";return}s(),ae()}),(E=document.getElementById("et-save"))==null||E.addEventListener("click",async()=>{var M,q,F,H,U,K,oe,Ie,$e,D,fe,dt;const h=(q=(M=document.getElementById("et-name"))==null?void 0:M.value)==null?void 0:q.trim(),v=(H=(F=document.getElementById("et-slug"))==null?void 0:F.value)==null?void 0:H.trim(),B=(K=(U=document.getElementById("et-domain"))==null?void 0:U.value)==null?void 0:K.trim(),k=(oe=document.getElementById("et-plan"))==null?void 0:oe.value,S=($e=(Ie=document.getElementById("et-admin-email"))==null?void 0:Ie.value)==null?void 0:$e.trim(),$=(fe=(D=document.getElementById("et-admin-password"))==null?void 0:D.value)==null?void 0:fe.trim(),w=(dt=document.getElementById("et-logo-input"))==null?void 0:dt.files[0],I=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!h){I.textContent="❌ Nome é obrigatório.",I.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",I.textContent="⏳ Salvando…",I.style.color="#64748b";let T=e.logo_url;if(w)try{const A=await Te(w,256,.85),rt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Ut}=await y.storage.from("imoveis").upload(rt,A,{contentType:"image/jpeg",upsert:!0});if(!Ut){const{data:{publicUrl:Dt}}=y.storage.from("imoveis").getPublicUrl(rt);T=Dt}}catch(A){console.error("Logo upload:",A)}const{error:C}=await y.from("tenants").update({name:h,slug:v||e.slug,domain:B||null,plan_id:k||null,logo_url:T}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",I.textContent="❌ "+C.message,I.style.color="#ef4444";return}if(S&&$&&$.length>=6){I.textContent="⏳ Criando usuário admin…";const A=await ue({email:S,password:$,role:"admin",tenant_id:e.id});A!=null&&A.success?(A!=null&&A.user_id&&!(A!=null&&A.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",A.user_id),I.textContent="✅ Salvo e admin criado!",I.style.color="#22c55e"):(I.textContent="⚠️ Salvo, mas erro ao criar admin: "+((A==null?void 0:A.error)||"Tente novamente"),I.style.color="#f59e0b")}else I.textContent="✅ Imobiliária atualizada!",I.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{s(),ae()},1200)})}function Ta(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",qa)}function qa(){const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
