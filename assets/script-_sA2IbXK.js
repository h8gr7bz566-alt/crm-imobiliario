import{s as y}from"./supabase-BcuJ3xoD.js";const ot="00000000-0000-0000-0000-000000000000";let ue={},$e={},te=ot;function Xe(e){te=e||ot,ue={},$e={}}const Re=()=>te;async function gt(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",te),y.from("site_content").select("*").eq("tenant_id",te)]);e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{$e[n.key]=n})}const V=(e,t=null)=>ue[e]!==void 0?ue[e]:t,_e=(e,t="pt")=>{const n=$e[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Z(e){const t=new Date().toISOString(),n=e.map(([o,s])=>({key:o,value:s,tenant_id:te,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,s])=>{ue[o]=s}),!a}async function Ce(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:te,updated_at:new Date().toISOString()},{error:s}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return s||($e[e]=o),!s}async function Te(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function He(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=o});const s=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=s);const d=V("visual.hero_bg_url","");if(d){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${d}')`)}}function ft(e="pt"){const t=v=>_e(v,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const s=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');s&&t("inst.bio_p1")&&(s.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),c=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');i&&t("inst.stat2_num")&&(i.innerHTML=t("inst.stat2_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const r=_e("seo.title_pt",e);r&&document.title&&(document.title=r);const g=_e("seo.description_pt",e);if(g){const v=document.querySelector('meta[name="description"]');v&&(v.content=g)}}function yt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const bt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",pe=`https://wa.me/${K}`;const W=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],ht=5.7;function ve(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/ht).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let $=[],p=null,ge=[],st=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(st=!0)});async function Et(){const{data:e,error:t}=await y.from("properties").select("*").eq("published",!0).is("tenant_id",null).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function wt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(p==null?void 0:p.role)==="super_admin"?e=e.is("tenant_id",null):p!=null&&p.tenant_id?e=e.eq("tenant_id",p.tenant_id):p!=null&&p.id&&(e=e.is("tenant_id",null));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):($=t||[],Kt(),Qt(),$)}async function It(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const s=$.findIndex(l=>l.id===t);s>=0&&($[s]={...$[s],...a})}else{if(!e.reference){const a=$.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&$.unshift(t[0])}}async function xt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;$=$.filter(n=>n.id!==e)}async function Bt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function he(e,t=1200,n=.78){return new Promise((a,o)=>{const s=new Image,l=URL.createObjectURL(e);s.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let i=s.width,c=s.height;i>t&&(c=Math.round(c*t/i),i=t),d.width=i,d.height=c;const m=d.getContext("2d");m.drawImage(s,0,0,i,c);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const r=Math.round(i*.18),g=Math.round(u.naturalHeight*r/u.naturalWidth),v=Math.round(i*.02),h=i-r-v,E=c-g-v;m.globalAlpha=.45,m.drawImage(u,h,E,r,g),m.globalAlpha=1,d.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{d.toBlob(r=>r?a(r):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},s.onerror=o,s.src=l})}async function Lt(e){const t=await he(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function St(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Lt(n[o]));return a}async function fe(){var u,r,g,v,h,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Et();$=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&kt(n);const a=((r=document.getElementById("city-filter"))==null?void 0:r.value)||"",o=((g=document.getElementById("neighborhood-filter"))==null?void 0:g.value)||"",s=((v=document.getElementById("bedrooms-filter"))==null?void 0:v.value)||"",l=((h=document.getElementById("parking-filter"))==null?void 0:h.value)||"",d=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",i=document.getElementById("price-slider"),c=i?parseInt(i.value,10):13e7,m=n.filter(f=>{if(a&&f.city!==a||o&&f.neighborhood!==o||s&&(s==="4+"&&Number(f.bedrooms)<4||s!=="4+"&&Number(f.bedrooms)!==Number(s))||l&&(l==="4+"&&Number(f.parking)<4||l!=="4+"&&Number(f.parking)!==Number(l))||d&&f.construction_status!==d)return!1;const w=String(f.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),I=parseInt(w,10)||0;return!(I<0||I>c)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(f=>{var x;const w=f.cover_image||((x=f.images)==null?void 0:x[0])||W[0],I=[f.neighborhood,f.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-loc">${b(I)}</div>
            <div class="selecao-card-price">${b(ve(f.price,window.currentLang||"pt"))}</div>
      ...
      `}).join("");return}if(!m.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=m.map(f=>{var x;const w=(x=f.images)!=null&&x.length?f.images:W,I=w.length;return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${I}" data-idx="0" data-pid="${f.id}">
        ...
        <div class="property-info">
          ...
          <div><strong>${b(ve(f.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${f.bedrooms||"--"} | 🚗 ${f.parking||"--"} ${I>1?"| 📸 "+I:""}</div>
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(f=>{f.removeEventListener("click",Ve),f.addEventListener("click",Ve)})}function kt(e){var o,s,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(d=>{var m;const i=d.cover_image||((m=d.images)==null?void 0:m[0])||W[0],c=[d.neighborhood,d.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
...
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(R){const i=$.find(c=>c.id===R);i!=null&&i.images&&(s=i.images)}s.length||(s=[...W]);const d={...R?{id:R}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:s,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:G||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||""};try{await It(d),R=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const i=document.getElementById("adminPublished");i&&(i.value="true");const c=document.getElementById("adminNeighborhood");c&&(c.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),G="",xe([]),we(),await Ie()}catch(i){console.error(i),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert("Erro ao salvar imóvel. Verifique o console.")}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await xt(o),await Ie()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((p==null?void 0:p.role)!=="admin")return;const o=Number(n.target.dataset.id);if(!o)return;const s=$.find(i=>i.id===o);if(!s)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=s.title||"",e.querySelector('[name="rua"]').value=s.rua||"",e.querySelector('[name="numero"]').value=s.numero||"",e.querySelector('[name="city"]').value=s.city||"",e.querySelector('[name="price"]').value=s.price||"",e.querySelector('[name="bedrooms"]').value=s.bedrooms||"",e.querySelector('[name="suites"]').value=s.suites||"",e.querySelector('[name="area"]').value=s.area||"",e.querySelector('[name="parking"]').value=s.parking||"",e.querySelector('[name="description"]').value=s.description||"",e.querySelector('[name="construction_status"]').value=s.construction_status||"",e.querySelector('[name="owner_name"]').value=s.owner_name||"",e.querySelector('[name="owner_phone"]').value=s.owner_phone||"",e.querySelector('[name="owner_email"]').value=s.owner_email||"",e.querySelector('[name="owner_notes"]').value=s.owner_notes||"",e.querySelector('[name="condominium"]').value=s.condominium||"";const l=document.getElementById("adminPublished");l&&(l.value=s.published===!0?"true":"false");const d=document.getElementById("adminCitySelect");d&&(d.value=s.city||"",d.dispatchEvent(new Event("change")),setTimeout(()=>{const i=document.getElementById("adminNeighborhood");i&&(i.value=s.neighborhood||"")},50)),G=s.cover_image||((a=s.images)==null?void 0:a[0])||"",xe(s.images||[]),Ae("Editar Imóvel")}})}function b(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let z=[],H=0;function qt(e){var m,u;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((m=e.images)==null?void 0:m[0])||W[0];document.getElementById("view-thumb-preview").src=o,z=(u=e.images)!=null&&u.length?e.images:W,H=0,Be(),document.getElementById("view-price").textContent=ve(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(r=>r.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(r=>r.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,i=document.getElementById("share-link-input");i&&(i.value=d);const c=document.getElementById("share-panel");c&&(c.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ee(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Be(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=z[H],e.alt=`Foto ${H+1}`;const s=z.length>1;n.style.display=s?"flex":"none",a.style.display=s?"flex":"none",t.textContent=s?`${H+1} / ${z.length}`:"",o.innerHTML=s?z.map((l,d)=>`<img src="${l}" class="view-thumb${d===H?" active":""}" data-i="${d}" alt="Foto ${d+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{H=+l.dataset.i,Be()})})}async function Ge(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Le(e){var u,r;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const s=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=s,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((u=s[0])==null?void 0:u.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const d=document.getElementById("avatar-dd-name"),i=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),m=document.getElementById("avatar-dd-initial");d&&(d.textContent=s),i&&(i.textContent=l),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",m&&(m.style.display="none")):(m&&(m.textContent=((r=s[0])==null?void 0:r.toUpperCase())||"?",m.style.display=""),c&&(c.style.display="none"))}function Y(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),U(),e==="contatos"&&Vt(),e==="funil"&&Ht(),e==="tarefas"&&Ut()}function We(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ea,visual:ta,"site-config":aa,"crm-config":na,integracoes:oa,midia:sa}).forEach(([a,o])=>{const s=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);s&&s.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>ia(),{once:!0}),window.lucide&&lucide.createIcons()}}function U(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function At(){var a,o,s;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("ac-close"))==null||a.addEventListener("click",n),(o=document.getElementById("ac-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",l=>{l.target===t&&n()}),(s=document.getElementById("ac-save"))==null||s.addEventListener("click",async()=>{var m,u;const l=(m=document.getElementById("ac-email"))==null?void 0:m.value.trim(),d=(u=document.getElementById("ac-password"))==null?void 0:u.value.trim(),i=document.getElementById("ac-save"),c=document.getElementById("ac-note");if(!l){alert("Informe o e-mail do corretor.");return}if(!d||d.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}i.disabled=!0,i.textContent="Criando…",c.style.display="none";try{const r=await oe({email:l,password:d,tenant_id:(p==null?void 0:p.tenant_id)||null});i.disabled=!1,i.textContent="+ Criar Acesso",r.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",r.email_sent===!1?(c.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${b(l)}<br><strong>Senha:</strong> ${b(d)}`,c.style.color="#0f172a"):(c.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",c.style.color="#16a34a"),c.style.display=""):alert("Erro: "+(r.error||"Falha desconhecida"))}catch(r){i.disabled=!1,i.textContent="+ Criar Acesso",alert("Erro: "+r.message)}})}function Rt(){var s,l,d,i,c,m,u,r,g,v,h;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",E=>{var w;E.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(w=document.getElementById("notif-dropdown"))==null||w.classList.add("hidden")}),(s=document.getElementById("avatar-dd-change-photo"))==null||s.addEventListener("click",E=>{E.stopPropagation(),U(),Mt()}),(l=document.getElementById("avatar-dd-change-pass"))==null||l.addEventListener("click",E=>{E.stopPropagation(),U(),At()}),(d=document.getElementById("avatar-dd-add-corretor"))==null||d.addEventListener("click",E=>{E.stopPropagation(),U(),Nt()}),(i=document.getElementById("avatar-dd-settings"))==null||i.addEventListener("click",E=>{E.stopPropagation(),U(),Y("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async E=>{E.stopPropagation(),await y.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",E=>{var w;E.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((w=document.getElementById("avatar-dropdown"))==null||w.classList.add("hidden"),Pt())}),(m=document.getElementById("notif-mark-all"))==null||m.addEventListener("click",()=>{zt(),U()}),(u=document.getElementById("btn-search-open"))==null||u.addEventListener("click",()=>{var E,f;(E=document.getElementById("search-overlay"))==null||E.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(r=document.getElementById("search-overlay-close"))==null||r.addEventListener("click",()=>{var E;(E=document.getElementById("search-overlay"))==null||E.classList.add("hidden")}),(g=document.getElementById("search-overlay"))==null||g.addEventListener("click",E=>{E.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(v=document.getElementById("search-input"))==null||v.addEventListener("input",E=>{clearTimeout(o),o=setTimeout(()=>Ot(E.target.value.trim()),280)}),(h=document.getElementById("search-input"))==null||h.addEventListener("keydown",E=>{var f;E.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",U)}let Ye=!1,de=[],it=[],Se=[],be=null,re=null;async function Ht(){var a;if(Ye)return;Ye=!0;const[{data:e},{data:t}]=await Promise.all([y.from("crm_pipelines").select("*").order("sort_order"),y.from("crm_stages").select("*").order("sort_order")]);de=e||[],it=t||[];const n=document.getElementById("funil-pipe-sel");if(n){n.innerHTML=de.length?de.map(s=>`<option value="${s.id}">${b(s.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const o=de.find(s=>s.is_default)||de[0];o&&(n.value=o.id,be=o.id),n.addEventListener("change",async()=>{be=parseInt(n.value,10),await Je()})}(a=document.getElementById("btn-funil-add-lead"))==null||a.addEventListener("click",()=>openLeadModal()),await Je()}async function Je(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=y.from("leads").select("*").order("created_at",{ascending:!1});(p==null?void 0:p.role)==="corretor"?t=t.eq("assigned_to",p.id):p!=null&&p.tenant_id&&(t=t.eq("tenant_id",p.tenant_id)),be&&(t=t.eq("pipeline_id",be));const{data:n}=await t;Se=n||[],lt()}function lt(){const e=document.getElementById("kanban-board");if(!e)return;const t=it.filter(a=>a.pipeline_id===be);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n={};t.forEach(a=>{n[a.name]=[]}),Se.forEach(a=>{var s,l,d,i;const o=a.stage||((s=t[0])==null?void 0:s.name);n[o]||(n[((l=t[0])==null?void 0:l.name)||""]=[]),(i=n[o]||n[(d=t[0])==null?void 0:d.name])==null||i.push(a)}),e.innerHTML=t.map(a=>{const o=n[a.name]||[],s=o.length?o.map(l=>`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(l);const d=()=>l.remove();(i=document.getElementById("tm-close"))==null||i.addEventListener("click",d),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",d),l.addEventListener("click",r=>{r.target===l&&d()}),(m=document.getElementById("tm-toggle-done"))==null||m.addEventListener("click",async()=>{const r=a?"pending":"done";await y.from("tasks").update({status:r}).eq("id",e.id);const g=M.find(v=>String(v.id)===String(e.id));g&&(g.status=r),d(),r==="done"&&(Q="done",document.querySelectorAll(".tarefa-filter-btn").forEach(v=>{v.classList.toggle("active",v.dataset.filter==="done")})),ae()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var f,w;const r=document.getElementById("tarefa-form");if(!r.checkValidity()){r.reportValidity();return}const g=new FormData(r),v=document.getElementById("tm-save");v.disabled=!0,v.textContent="Salvando…";const h={title:(f=g.get("title"))==null?void 0:f.trim(),description:((w=g.get("description"))==null?void 0:w.trim())||null,due_date:g.get("due_date")||null,priority:g.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(p==null?void 0:p.id)||null,tenant_id:(p==null?void 0:p.tenant_id)||null};let E;if(n){if({error:E}=await y.from("tasks").update(h).eq("id",e.id),!E){const I=M.findIndex(x=>String(x.id)===String(e.id));I>=0&&(M[I]={...M[I],...h})}}else{const{data:I,error:x}=await y.from("tasks").insert(h).select();E=x,!E&&(I!=null&&I[0])&&M.unshift(I[0])}if(v.disabled=!1,v.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}d(),ae()})}async function Ot(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;p==null||p.role,p==null||p.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),s=[];a!=null&&a.length&&(s.push('<div class="search-group-label">Imóveis</div>'),s.push(...a.map(l=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",d=>{d.preventDefault(),U(),Y("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{D.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(D)),d.classList.remove("unread"),U(),Y("contatos")})})}function zt(){var e;document.querySelectorAll(".notif-item").forEach(t=>D.push(t.dataset.id)),D=[...new Set(D)],localStorage.setItem("crm_notifs_read",JSON.stringify(D)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Ft(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Xt(){let e=y.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);p!=null&&p.tenant_id&&(e=e.eq("tenant_id",p.tenant_id));const{data:t}=await e,a=(t||[]).filter(s=>!D.includes(String(s.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let F=[],A=1;const ce=10;let Qe=!1;async function Vt(){var t,n,a,o,s,l,d,i,c;document.getElementById("section-contatos")&&(Qe||(Qe=!0,await ct(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{A=1,ne()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",m=>{m.key==="Enter"&&(A=1,ne())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>mt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Yt),(s=document.getElementById("import-modal-close"))==null||s.addEventListener("click",Me),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",Me),(d=document.getElementById("download-template"))==null||d.addEventListener("click",m=>{m.preventDefault();const u=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,r=new Blob([u],{type:"text/csv"}),g=document.createElement("a");g.href=URL.createObjectURL(r),g.download="modelo_contatos.csv",g.click()}),(i=document.getElementById("import-csv-file"))==null||i.addEventListener("change",Gt),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Wt)))}async function ct(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(p==null?void 0:p.role)==="corretor"?t=t.eq("assigned_to",p.id):p!=null&&p.tenant_id&&(t=t.eq("tenant_id",p.tenant_id));const{data:a}=await t;F=a||[],ne()}function ne(){var d,i,c;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?F.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/ce));A>a&&(A=a);const o=t.slice((A-1)*ce,A*ce),s=document.getElementById("contatos-tbody");if(!s)return;o.length?s.innerHTML=o.map(m=>`
      <tr>
  ...
  `,document.body.appendChild(a);const o=()=>a.remove();(s=document.getElementById("cm-close"))==null||s.addEventListener("click",o),(l=document.getElementById("cm-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",i=>{i.target===a&&o()}),(d=document.getElementById("cm-save"))==null||d.addEventListener("click",async()=>{var g,v,h,E,f,w,I;const i=document.getElementById("contato-form");if(!i.checkValidity()){i.reportValidity();return}const c=new FormData(i),m=document.getElementById("cm-save");m.disabled=!0,m.textContent="Salvando…";const u={name:(g=c.get("name"))==null?void 0:g.trim(),company:((v=c.get("company"))==null?void 0:v.trim())||null,email:((h=c.get("email"))==null?void 0:h.trim())||null,phone:((E=c.get("phone"))==null?void 0:E.trim())||null,job_title:((f=c.get("job_title"))==null?void 0:f.trim())||null,city_interest:((w=c.get("city_interest"))==null?void 0:w.trim())||null,notes:((I=c.get("notes"))==null?void 0:I.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(p==null?void 0:p.id)||null,tenant_id:(p==null?void 0:p.tenant_id)||null,source:"manual"};let r;if(n){if({error:r}=await y.from("leads").update(u).eq("id",e.id),!r){const x=F.findIndex(C=>String(C.id)===String(e.id));x>=0&&(F[x]={...F[x],...u})}}else{const{data:x,error:C}=await y.from("leads").insert(u).select();r=C,!r&&(x!=null&&x[0])&&F.unshift(x[0])}if(m.disabled=!1,m.textContent=n?"Salvar":"Criar Contato",r){alert("Erro: "+r.message);return}o(),ne()})}let ee=[];function Gt(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{ee=a.target.result.split(`
`).filter(d=>d.trim()).slice(1).map(d=>{const[i,c,m,u,r]=d.split(",").map(g=>g.trim().replace(/^"|"$/g,""));return{name:i,email:c,phone:m,company:u,job_title:r}}).filter(d=>d.name);const s=document.getElementById("import-preview");s&&(s.textContent=`${ee.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=ee.length===0)},n.readAsText(t)}async function Wt(){if(!ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(p==null?void 0:p.id)||null,tenant_id:(p==null?void 0:p.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Me(),await ct(),alert(`${t.length} contato(s) importados com sucesso!`)}function Yt(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Me(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Jt="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function oe(e){return(await fetch(Jt,{method:"POST",headers:{Authorization:`Bearer ${bt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ze(e){var i,c,m,u;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),s=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:r}}=await y.auth.getUser();n.value=(r==null?void 0:r.email)||""}const d=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=d),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),s==null||s.addEventListener("change",r=>{const g=r.target.files[0];if(!g)return;const v=URL.createObjectURL(g);a&&(a.src=v,a.style.display=""),o&&(o.style.display="none")}),(i=document.getElementById("btn-change-password"))==null||i.addEventListener("click",async()=>{var f,w;const r=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",g=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",v=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(v&&(v.style.display="none"),r.length<6){v&&(v.textContent="Mínimo 6 caracteres.",v.style.display="");return}if(r!==g){v&&(v.textContent="As senhas não coincidem.",v.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:E}=await y.auth.updateUser({password:r});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),E?v&&(v.textContent="Erro: "+E.message,v.style.display=""):(v&&(v.style.color="#16a34a",v.textContent="Senha alterada com sucesso!",v.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var w;const r=t.value.trim();let g=(p==null?void 0:p.avatar_url)||"";const v=s==null?void 0:s.files[0],h=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",v)try{const I=await he(v,400,.85),x=`avatars/${p.id}-${Date.now()}.jpg`,{error:C}=await y.storage.from("imoveis").upload(x,I,{contentType:"image/jpeg",upsert:!0});if(!C){const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(x);g=B}}catch(I){console.error("Avatar upload:",I)}const{error:E}=await y.from("profiles").update({name:r,avatar_url:g}).eq("id",p.id);if(l.disabled=!1,l.textContent=h,E){alert("Erro ao salvar perfil.");return}p={...p,name:r,avatar_url:g},Le(p);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((w=r[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const r=document.getElementById("settings-corretores-section");r&&(r.style.display=""),await ke(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var w,I;const v=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),h=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),E=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!v){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),f&&(f.style.display="none");try{const x=await oe({email:v,password:h,tenant_id:(p==null?void 0:p.tenant_id)||null});if(x.success){const C=document.getElementById("invite-email"),B=document.getElementById("invite-password");C&&(C.value=""),B&&(B.value=""),await ke(),f&&(x.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${b(h)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(x.error||"Falha desconhecida"))}catch(x){alert("Erro ao criar acesso: "+x.message)}finally{E&&(E.disabled=!1,E.textContent="+ Criar Acesso")}});const g=document.getElementById("settings-locations-section");g&&(g.style.display=""),await me(),(m=document.getElementById("loc-add-city-btn"))==null||m.addEventListener("click",async()=>{const v=document.getElementById("loc-new-city"),h=v==null?void 0:v.value.trim();if(!h)return;const{error:E}=await y.from("locations").insert({type:"cidade",name:h});if(E){alert("Erro ao adicionar cidade.");return}v&&(v.value=""),await me(),De()}),(u=document.getElementById("loc-add-neighborhood-btn"))==null||u.addEventListener("click",async()=>{var w;const v=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),h=document.getElementById("loc-new-neighborhood"),E=h==null?void 0:h.value.trim();if(!v||!E){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await y.from("locations").insert({type:"bairro",name:E,parent_id:v});if(f){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await me()})}}async function ke(){const e=document.getElementById("corretores-list");if(!e)return;let t=y.from("profiles").select("*").order("created_at");p!=null&&p.tenant_id&&(t=t.eq("tenant_id",p.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const s=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${b(s)}</div>`,d=o.id===(p==null?void 0:p.id),i=o.active!==!1,c=i?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',m=d?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${s.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(s=>`<option value="${s.id}">${b(s.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{const l=s.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${l}" e todos os bairros vinculados?`))return;const{error:d}=await y.from("locations").delete().eq("id",s.dataset.id);if(d){alert("Erro ao excluir.");return}await me(),De()})}),n.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:l}=await y.from("locations").delete().eq("id",s.dataset.id);if(l){alert("Erro ao excluir.");return}await me()})})}function et(){var n,a,o,s,l,d,i,c,m,u,r,g,v,h,E,f,w,I,x,C;document.querySelectorAll(".filter-btn").forEach(B=>{B.addEventListener("click",()=>{const L=B.closest(".filter-btns"),S=B.classList.contains("active");L.querySelectorAll(".filter-btn").forEach(k=>k.classList.remove("active")),S||B.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var _;const B=(_=document.getElementById("f-city"))==null?void 0:_.value,L=J().find(T=>T.name===B),S=L?Ue(L.id):[],k=document.getElementById("f-neighborhood");k&&(k.innerHTML='<option value="">Todos</option>'+S.map(T=>`<option value="${T.name}">${b(T.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{ye(je($))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{["f-title","f-condominium","f-price-min","f-price-max","f-area-min","f-area-max"].forEach(k=>{const _=document.getElementById(k);_&&(_.value="")}),["f-type","f-city","f-construction","f-published"].forEach(k=>{const _=document.getElementById(k);_&&(_.value="")});const S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'),document.querySelectorAll(".filter-btn.active").forEach(k=>k.classList.remove("active")),ye($)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(B=>{B.addEventListener("click",()=>{Y(B.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(B=>{B.addEventListener("click",()=>{Y(B.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(B=>{B.addEventListener("click",L=>{L.stopPropagation();const S=B.closest(".topnav-dropdown");S==null||S.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(k=>{k!==S&&k.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(B=>B.classList.remove("open"))}),(s=document.getElementById("modal-close"))==null||s.addEventListener("click",we),(l=document.getElementById("modal-cancel"))==null||l.addEventListener("click",we),(d=document.getElementById("property-modal"))==null||d.addEventListener("click",B=>{B.target.id==="property-modal"&&we()}),(i=document.getElementById("btn-new-property"))==null||i.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",G="",xe([]),Ae("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await y.auth.signOut(),location.reload()}),(m=document.getElementById("view-prev"))==null||m.addEventListener("click",()=>{H=(H-1+z.length)%z.length,Be()}),(u=document.getElementById("view-next"))==null||u.addEventListener("click",()=>{H=(H+1)%z.length,Be()}),(r=document.getElementById("view-modal-close"))==null||r.addEventListener("click",Ee),(g=document.getElementById("view-modal-close2"))==null||g.addEventListener("click",Ee),(v=document.getElementById("view-modal"))==null||v.addEventListener("click",B=>{B.target.id==="view-modal"&&Ee()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const B=document.getElementById("share-panel");if(!B)return;const L=B.style.display!=="none";B.style.display=L?"none":"block"}),(E=document.getElementById("share-whatsapp"))==null||E.addEventListener("click",()=>{var k,_;const B=(k=document.getElementById("share-link-input"))==null?void 0:k.value;if(!B)return;const L=((_=document.getElementById("view-modal-title"))==null?void 0:_.textContent)||"Imóvel",S=encodeURIComponent("Olha esse imóvel que encontrei: "+L+`
`+B);window.open("https://wa.me/?text="+S,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var L,S;const B=(L=document.getElementById("share-link-input"))==null?void 0:L.value;B&&((S=navigator.clipboard)==null||S.writeText(B),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(w=document.getElementById("share-email"))==null||w.addEventListener("click",()=>{var _,T;const B=(_=document.getElementById("share-link-input"))==null?void 0:_.value;if(!B)return;const L=((T=document.getElementById("view-modal-title"))==null?void 0:T.textContent)||"Imóvel",S=encodeURIComponent("Imóvel: "+L),k=encodeURIComponent(`Olá! Segue o link do imóvel:

`+B);window.open("mailto:?subject="+S+"&body="+k,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var L;const B=document.getElementById("share-link-input");B&&((L=navigator.clipboard)==null||L.writeText(B.value).then(()=>{const S=document.getElementById("share-copy"),k=S.textContent;S.textContent="✅ Copiado!",setTimeout(()=>{S.textContent=k},2e3)}))}),(x=document.getElementById("view-modal-edit"))==null||x.addEventListener("click",()=>{var O;if((p==null?void 0:p.role)!=="admin")return;const B=document.getElementById("view-modal-title").textContent,L=$.find(N=>N.title===B);if(!L)return;Ee(),R=L.id;const S=document.getElementById("property-form"),k=document.getElementById("form-submit-btn");k.textContent="Salvar Alterações",S.querySelector('[name="title"]').value=L.title||"",S.querySelector('[name="rua"]').value=L.rua||"",S.querySelector('[name="numero"]').value=L.numero||"",S.querySelector('[name="city"]').value=L.city||"",S.querySelector('[name="price"]').value=L.price||"",S.querySelector('[name="bedrooms"]').value=L.bedrooms||"",S.querySelector('[name="suites"]').value=L.suites||"",S.querySelector('[name="parking"]').value=L.parking||"",S.querySelector('[name="description"]').value=L.description||"",S.querySelector('[name="construction_status"]').value=L.construction_status||"",S.querySelector('[name="owner_name"]').value=L.owner_name||"",S.querySelector('[name="owner_phone"]').value=L.owner_phone||"",S.querySelector('[name="owner_email"]').value=L.owner_email||"",S.querySelector('[name="owner_notes"]').value=L.owner_notes||"",S.querySelector('[name="condominium"]').value=L.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=L.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=L.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=L.neighborhood||"")},50)),G=L.cover_image||((O=L.images)==null?void 0:O[0])||"",xe(L.images||[]),Ae("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(B=>{B.addEventListener("click",()=>{var L;document.querySelectorAll(".tab-btn").forEach(S=>S.classList.remove("active")),B.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(S=>S.classList.add("hidden")),(L=document.getElementById(`tab-${B.dataset.tab}`))==null||L.classList.remove("hidden")})}),(C=document.getElementById("admin-properties"))==null||C.addEventListener("click",B=>{if(B.target.closest(".action-btns"))return;const L=B.target.closest("tr");if(!L)return;const S=Number(L.dataset.id);if(!S)return;const k=$.find(_=>_.id===S);k&&qt(k)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;await Promise.all([gt(),ut()]),K=V("company.whatsapp",K),pe=`https://wa.me/${K}`,He(),$t(),_t();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(De(),e.addEventListener("change",()=>{const i=J().find(m=>m.name===e.value),c=i?Ue(i.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${b(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=i.get("type")||c.get("type")||"",u=st||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),r=document.getElementById("password-reset-overlay");if(u){n.style.display="none",a&&a.classList.add("hidden"),r&&(r.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async v=>{var x,C;v.preventDefault();const h=((x=document.getElementById("new-password"))==null?void 0:x.value)||"",E=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",f=document.getElementById("password-reset-msg"),w=v.target.querySelector('button[type="submit"]');if(f&&(f.style.display="none"),h!==E){f&&(f.textContent="As senhas não coincidem.",f.style.display="");return}w&&(w.disabled=!0,w.textContent="Salvando…");const{error:I}=await y.auth.updateUser({password:h});if(I){f&&(f.textContent="Erro: "+I.message,f.style.display=""),w&&(w.disabled=!1,w.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await y.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:g}}=await y.auth.getSession();if(g){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),et(),Rt(),window.lucide&&lucide.createIcons(),p=await Ge(g.user.id),!p){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(p.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(p.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const v=document.getElementById("password-reset-overlay");v&&(v.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async h=>{var C,B;h.preventDefault();const E=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",f=((B=document.getElementById("confirm-password"))==null?void 0:B.value)||"",w=document.getElementById("password-reset-msg"),I=h.target.querySelector('button[type="submit"]');if(w&&(w.style.display="none"),E!==f){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}if(E.length<6){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}I&&(I.disabled=!0,I.textContent="Salvando…");const{error:x}=await y.auth.updateUser({password:E});if(x){w&&(w.textContent="Erro: "+x.message,w.style.display=""),I&&(I.disabled=!1,I.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",p.id),window.location.href=window.location.pathname});return}Xe((p==null?void 0:p.tenant_id)||null),Le(p),We(p.role),await Ie(),await Ze(p),window.lucide&&lucide.createIcons(),Xt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const v=document.getElementById("login-form");v&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var f,w;const h=(w=(f=v.querySelector('input[name="email"]'))==null?void 0:f.value)==null?void 0:w.trim();if(!h){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:E}=await y.auth.resetPasswordForEmail(h,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(E?"Erro: "+E.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),v.addEventListener("submit",async h=>{h.preventDefault();const E=new FormData(v),f=E.get("email"),w=E.get("password");if(await Bt(f,w)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),et(),window.lucide&&lucide.createIcons();const{data:{session:x}}=await y.auth.getSession();if(p=x?await Ge(x.user.id):null,!p){await y.auth.signOut();return}if(p.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Xe((p==null?void 0:p.tenant_id)||null),Le(p),We(p.role),await Ie(),await Ze(p),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else qe();await fe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();ft(o),yt(K)});async function Kt(){const e=$.filter(o=>!o.reference);if(!e.length)return;const t=$.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,s)=>o.id-s.id);for(const o of a){const s="IO-"+String(n).padStart(4,"0"),{error:l}=await y.from("properties").update({reference:s}).eq("id",o.id);if(!l){const d=$.findIndex(i=>i.id===o.id);d>=0&&($[d].reference=s),n++}}ye(je($))}async function Qt(){const e=$.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(s=>!s.includes("/wm-")))continue;const a=[];let o=!1;for(const s of t.images)if(s.includes("/wm-"))a.push(s);else try{const l=await Zt(s);a.push(l),o=!0}catch{a.push(s)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const s=$.findIndex(l=>l.id===t.id);s>=0&&($[s].images=a)}}ye(je($))}}async function Zt(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),s=o.ok?await o.blob():null,l=s?URL.createObjectURL(s):null;return new Promise(d=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),m=1200;let u=i.width,r=i.height;u>m&&(r=Math.round(r*m/u),u=m),c.width=u,c.height=r;const g=c.getContext("2d");g.drawImage(i,0,0,u,r);const v=h=>{if(h){const E=Math.round(u*.18),f=Math.round(h.naturalHeight*E/h.naturalWidth),w=Math.round(u*.02);g.globalAlpha=.45,g.drawImage(h,u-E-w,r-f-w,E,f),g.globalAlpha=1}c.toBlob(async E=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await y.storage.from("imoveis").upload(f,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),d(e);return}const{data:{publicUrl:I}}=y.storage.from("imoveis").getPublicUrl(f);d(I)}catch(f){console.error("Watermark upload exception:",f),d(e)}},"image/jpeg",.82)};if(l){const h=new Image;h.onload=()=>{URL.revokeObjectURL(l),v(h)},h.onerror=()=>{URL.revokeObjectURL(l),v(null)},h.src=l}else v(null)},i.onerror=()=>{URL.revokeObjectURL(a),d(e)},i.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function j(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Oe(e,t="assets"){const n=await he(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:s}}=y.storage.from("imoveis").getPublicUrl(a);return s}async function ea(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",Re()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>b(String(n[o]||""));e.innerHTML=`
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const r=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,v=parseInt(document.getElementById("crm-pipe-sel").value,10);r&&(await y.from("crm_stages").insert({pipeline_id:v,name:r,color:g,sort_order:99}),document.getElementById("crm-new-stage").value="",await P())}),e.querySelectorAll(".stage-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await y.from("crm_stages").delete().eq("id",r.dataset.id),await P())})}),e.querySelectorAll(".stage-color-pick").forEach(r=>{r.addEventListener("change",async g=>{await y.from("crm_stages").update({color:g.target.value}).eq("id",r.dataset.sid);const v=r.closest(".stage-item").querySelector(".stage-color-dot");v&&(v.style.background=g.target.value)})}),document.getElementById("crm-add-tag").addEventListener("click",async()=>{const r=document.getElementById("crm-new-tag").value.trim(),g=document.getElementById("crm-new-tag-color").value;r&&(await y.from("crm_tags").insert({name:r,color:g}),document.getElementById("crm-new-tag").value="",await P())}),e.querySelectorAll(".tag-chip-del").forEach(r=>{r.addEventListener("click",async()=>{await y.from("crm_tags").delete().eq("id",r.dataset.id),await P()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const r=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,v=document.getElementById("crm-new-status-final").checked;r&&(await y.from("crm_lead_statuses").insert({name:r,color:g,is_final:v,sort_order:99}),document.getElementById("crm-new-status").value="",await P())}),e.querySelectorAll(".status-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Remover este status?")&&(await y.from("crm_lead_statuses").delete().eq("id",r.dataset.id),await P())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var g;const r=(g=prompt("Nome do novo funil:"))==null?void 0:g.trim();r&&(await y.from("crm_pipelines").insert({name:r,sort_order:99}),await P())})}async function oa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("integrations").select("*"),n={};t==null||t.forEach(d=>{n[d.key]=d});const a=d=>{var i;return b(((i=n[d])==null?void 0:i.value)||"")},o=d=>{var i;return(i=n[d])!=null&&i.enabled?"checked":""},s=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],l=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await Ne(),document.getElementById("media-file-input").addEventListener("change",async n=>{var i,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),s=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let d=0;for(const m of a){l.textContent=`Enviando ${d+1}/${a.length}…`,s.style.width=`${Math.round(d/a.length*100)}%`;try{const u=await Oe(m,"media"),r=m.name.replace(/\.[^.]+$/,"").slice(0,60);await y.from("media_library").insert({name:r,url:u,type:"image",size:m.size,created_by:(c=(i=(await y.auth.getUser()).data)==null?void 0:i.user)==null?void 0:c.id})}catch(u){console.error("Media upload error:",u)}d++}s.style.width="100%",l.textContent=`✓ ${d} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",s.style.width="0"},2e3),await Ne(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Ne(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await y.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(i=>i.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&X(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&la(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&tt(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&at(),l.dataset.tab==="platform"&&nt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",tt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",X),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",at),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>ca()),(s=e.querySelector("#sa-plat-save"))==null||s.addEventListener("click",da),X(),nt())}async function X(){var d,i;const e=document.getElementById("sa-tenants-list"),t=((i=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=y.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const s=(a||[]).filter(c=>{var m,u;return!t||((m=c.name)==null?void 0:m.toLowerCase().includes(t))||((u=c.slug)==null?void 0:u.toLowerCase().includes(t))});if(!s.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=s.map(c=>{var m;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async()=>{const m=c.dataset.active==="true";await y.from("tenants").update({active:!m}).eq("id",c.dataset.id),X()})}),e.querySelectorAll('[data-action="edit-tenant"]').forEach(c=>{c.addEventListener("click",()=>{const m=(s||[]).find(u=>String(u.id)===String(c.dataset.id));m&&ma(m)})})}async function la(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `}).join("")}async function nt(){const[e,t,n,a]=await Promise.all([y.from("tenants").select("id",{count:"exact",head:!0}),y.from("profiles").select("id",{count:"exact",head:!0}),y.from("subscriptions").select("id",{count:"exact",head:!0}).eq("status","active"),y.from("properties").select("id",{count:"exact",head:!0}).eq("published",!0)]),o=(s,l)=>{const d=document.getElementById(s);d&&(d.textContent=l??"—")};o("sa-stat-tenants",e.count),o("sa-stat-users",t.count),o("sa-stat-subs",n.count),o("sa-stat-props",a.count)}async function da(){var n,a,o;const e=document.getElementById("sa-plat-save"),t=document.getElementById("sa-plat-msg");e&&(e.disabled=!0,e.textContent="Salvando…"),await Z([{key:"platform.name",value:((n=document.getElementById("sa-plat-name"))==null?void 0:n.value)||""},{key:"platform.support_email",value:((a=document.getElementById("sa-plat-email"))==null?void 0:a.value)||""},{key:"platform.trial_days",value:((o=document.getElementById("sa-plat-trial"))==null?void 0:o.value)||"14"}]),e&&(e.disabled=!1,e.textContent="Salvar Configurações"),j(t,!0)}function ra(e){return e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function ca(){var a,o,s,l,d,i;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const t=document.createElement("div");t.id="sa-new-tenant-modal",t.className="sa-modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:c})=>{const m=document.getElementById("nt-plan");m&&c&&(m.innerHTML='<option value="">Sem plano</option>'+c.map(u=>`<option value="${u.id}">${b(u.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const m=document.getElementById("nt-slug");m&&!m.dataset.manual&&(m.value=ra(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(s=document.getElementById("nt-pwd-toggle"))==null||s.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(i=document.getElementById("nt-save"))==null||i.addEventListener("click",async()=>{var C,B,L,S,k,_,T,O,N,se,ie,le;const c=(B=(C=document.getElementById("nt-name"))==null?void 0:C.value)==null?void 0:B.trim(),m=(S=(L=document.getElementById("nt-slug"))==null?void 0:L.value)==null?void 0:S.trim(),u=(_=(k=document.getElementById("nt-domain"))==null?void 0:k.value)==null?void 0:_.trim(),r=(T=document.getElementById("nt-plan"))==null?void 0:T.value,g=(N=(O=document.getElementById("nt-admin-email"))==null?void 0:O.value)==null?void 0:N.trim(),v=(ie=(se=document.getElementById("nt-admin-password"))==null?void 0:se.value)==null?void 0:ie.trim(),h=document.getElementById("nt-msg"),E=document.getElementById("nt-save");if(!c||!m){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!g){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!v||v.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}E.disabled=!0,E.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:f,error:w}=await y.from("tenants").insert({name:c,slug:m,domain:u||null,plan_id:r||null,active:!0}).select();if(w){E.disabled=!1,E.textContent="Criar Imobiliária",h.textContent="❌ "+w.message,h.style.color="#ef4444";return}const I=(le=f==null?void 0:f[0])==null?void 0:le.id;h.textContent="⏳ Criando usuário admin…";const x=await oe({email:g,password:v,role:"admin",tenant_id:I});if(!(x!=null&&x.success)){E.disabled=!1,E.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+b((x==null?void 0:x.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),X()},3e3);return}I&&(x!=null&&x.user_id)&&!(x!=null&&x.linked)&&await y.from("profiles").update({tenant_id:I}).eq("id",x.user_id),E.disabled=!1,E.textContent="Criar Imobiliária",x.email_sent===!1?(h.innerHTML=`
        ...
        </div>`,h.style.color="#0f172a"):(h.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",h.style.color="#22c55e",setTimeout(()=>{n(),X()},1500))})}function ma(e){var o,s,l,d,i,c,m,u;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop",n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div class="sa-modal-body">
        ...
        <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px;">
          <input id="et-api-key" class="form-input" type="text" value="${b(e.id||"")}" readonly style="font-family:monospace;font-size:12px;background:#f8fafc;color:#374151;flex:1;">
        ...
        <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:8px;padding:12px;margin-bottom:4px;">
          ...
          <div style="font-size:11px;font-family:monospace;color:#0f172a;line-height:1.8;word-break:break-all;">
            <div style="color:#64748b">// Listar imóveis publicados</div>
            GET …/public-api/properties?key=${b(e.id)}<br><br>
            <div style="color:#64748b">// Detalhe de um imóvel</div>
            GET …/public-api/properties/ID?key=${b(e.id)}<br><br>
            <div style="color:#64748b">// Enviar lead (formulário de contato)</div>
            POST …/public-api/leads?key=${b(e.id)}<br><br>
            <div style="color:#64748b">// Configurações da empresa</div>
            GET …/public-api/settings?key=${b(e.id)}
          </div>
        </div>
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:r})=>{const g=document.getElementById("et-plan");g&&r&&(g.innerHTML='<option value="">Sem plano</option>'+r.map(v=>`<option value="${v.id}"${String(v.id)===String(e.plan_id)?" selected":""}>${b(v.name)}</option>`).join(""))}),(o=document.getElementById("et-logo-input"))==null||o.addEventListener("change",r=>{const g=r.target.files[0];if(!g)return;const v=URL.createObjectURL(g),h=document.getElementById("et-logo-preview");h&&(h.innerHTML=`<img src="${v}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var r;(r=document.getElementById("et-logo-input"))==null||r.click()}),(l=document.getElementById("et-pwd-toggle"))==null||l.addEventListener("click",()=>{const r=document.getElementById("et-admin-password");r.type=r.type==="password"?"text":"password"}),(d=document.getElementById("et-copy-key"))==null||d.addEventListener("click",()=>{var h,E;const r=(h=document.getElementById("et-api-key"))==null?void 0:h.value;if(!r)return;(E=navigator.clipboard)==null||E.writeText(r);const g=document.getElementById("et-copy-key"),v=g.textContent;g.textContent="✅ Copiada!",setTimeout(()=>{g.textContent=v},2e3)});const a=()=>n.remove();(i=document.getElementById("et-close"))==null||i.addEventListener("click",a),(c=document.getElementById("et-cancel"))==null||c.addEventListener("click",a),n.addEventListener("click",r=>{r.target===n&&a()}),(m=document.getElementById("et-delete"))==null||m.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const g=document.getElementById("et-delete");g.disabled=!0,g.textContent="Excluindo…";const{error:v}=await y.from("tenants").delete().eq("id",e.id);if(v){alert("Erro ao excluir: "+v.message),g.disabled=!1,g.textContent="🗑️ Excluir";return}a(),X()}),(u=document.getElementById("et-save"))==null||u.addEventListener("click",async()=>{var L,S,k,_,T,O,N,se,ie,le,Pe,ze;const r=(S=(L=document.getElementById("et-name"))==null?void 0:L.value)==null?void 0:S.trim(),g=(_=(k=document.getElementById("et-slug"))==null?void 0:k.value)==null?void 0:_.trim(),v=(O=(T=document.getElementById("et-domain"))==null?void 0:T.value)==null?void 0:O.trim(),h=(N=document.getElementById("et-plan"))==null?void 0:N.value,E=(ie=(se=document.getElementById("et-admin-email"))==null?void 0:se.value)==null?void 0:ie.trim(),f=(Pe=(le=document.getElementById("et-admin-password"))==null?void 0:le.value)==null?void 0:Pe.trim(),w=(ze=document.getElementById("et-logo-input"))==null?void 0:ze.files[0],I=document.getElementById("et-msg"),x=document.getElementById("et-save");if(!r){I.textContent="❌ Nome é obrigatório.",I.style.color="#ef4444";return}x.disabled=!0,x.textContent="Salvando…",I.textContent="⏳ Salvando…",I.style.color="#64748b";let C=e.logo_url;if(w)try{const q=await he(w,256,.85),Fe=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:pt}=await y.storage.from("imoveis").upload(Fe,q,{contentType:"image/jpeg",upsert:!0});if(!pt){const{data:{publicUrl:vt}}=y.storage.from("imoveis").getPublicUrl(Fe);C=vt}}catch(q){console.error("Logo upload:",q)}const{error:B}=await y.from("tenants").update({name:r,slug:g||e.slug,domain:v||null,plan_id:h||null,logo_url:C}).eq("id",e.id);if(B){x.disabled=!1,x.textContent="Salvar",I.textContent="❌ "+B.message,I.style.color="#ef4444";return}if(E&&f&&f.length>=6){I.textContent="⏳ Criando usuário admin…";const q=await oe({email:E,password:f,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),I.textContent="✅ Salvo e admin criado!",I.style.color="#22c55e"):(I.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),I.style.color="#f59e0b")}else I.textContent="✅ Imobiliária atualizada!",I.style.color="#22c55e";x.disabled=!1,x.textContent="Salvar",setTimeout(()=>{a(),X()},1200)})}
