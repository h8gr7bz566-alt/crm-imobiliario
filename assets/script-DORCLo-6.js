import{s as y}from"./supabase-BcuJ3xoD.js";const gt="00000000-0000-0000-0000-000000000000";let xe={},Ne={},ce=gt;function je(e){ce=e||gt,xe={},Ne={}}const H=()=>ce;async function $t(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",ce),y.from("site_content").select("*").eq("tenant_id",ce)]);e.data&&e.data.forEach(n=>{xe[n.key]=n.value}),t.data&&t.data.forEach(n=>{Ne[n.key]=n})}const Z=(e,t=null)=>xe[e]!==void 0?xe[e]:t,He=(e,t="pt")=>{const n=Ne[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function de(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ce,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{xe[o]=i}),!a}async function Re(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ce,updated_at:new Date().toISOString()},{error:i}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(Ne[e]=o),!i}async function Ue(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function Ve(){const e=document.documentElement,t=Z("visual.accent_color","#b8962e"),n=Z("visual.primary_bg","#0f1c2e"),a=Z("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=Z("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=Z("company.favicon_url","/favicon.ico"),s=document.querySelector('link[rel="shortcut icon"]');s&&(s.href=i);const l=Z("visual.hero_bg_url","");if(l){const d=document.querySelector(".hero");d&&(d.style.backgroundImage=`url('${l}')`)}}function kt(e="pt"){const t=b=>He(b,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),s=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),s&&t("inst.bio_p2")&&(s.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),c=document.querySelector('[data-i18n="inst.stat2"]'),m=document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat2_num")&&(d.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),c&&t("inst.stat2_label")&&(c.innerHTML=t("inst.stat2_label")),m&&t("inst.stat3_label")&&(m.innerHTML=t("inst.stat3_label"));const f=He("seo.title_pt",e);f&&document.title&&(document.title=f);const u=He("seo.description_pt",e);if(u){const b=document.querySelector('meta[name="description"]');b&&(b.content=u)}}function Lt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const St="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let se="5547999701743",Ee=`https://wa.me/${se}`;const te=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],_t=5.7;function we(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/_t).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let C=[],g=null,Ie=[],vt=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(vt=!0)});async function Ct(){const e=window.location.hostname;let t=null;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:i}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();i!=null&&i.id&&(t=i.id)}let n=y.from("properties").select("*").eq("published",!0);t&&(n=n.eq("tenant_id",t));const{data:a,error:o}=await n.order("created_at",{ascending:!1});return o?(console.error("Supabase select error:",o),[]):a||[]}async function Tt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="super_admin"||(g!=null&&g.tenant_id?e=e.eq("tenant_id",g.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(C=t||[],sa(),la(),C)}async function At(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=C.findIndex(s=>s.id===t);i>=0&&(C[i]={...C[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&C.unshift(t[0])}}async function qt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;C=C.filter(n=>n.id!==e)}async function Mt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function ke(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,s=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(s);const l=document.createElement("canvas");let d=i.width,r=i.height;d>t&&(r=Math.round(r*t/d),d=t),l.width=d,l.height=r;const c=l.getContext("2d");c.drawImage(i,0,0,d,r);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const f=Math.round(d*.18),u=Math.round(m.naturalHeight*f/m.naturalWidth),b=Math.round(d*.02),h=d-f-b,x=r-u-b;c.globalAlpha=.45,c.drawImage(m,h,x,f,u),c.globalAlpha=1,l.toBlob(v=>v?a(v):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{l.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=s})}async function zt(e){const t=await ke(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Nt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await zt(n[o]));return a}async function Be(){var m,f,u,b,h,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Ct();C=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&jt(n);const a=((f=document.getElementById("city-filter"))==null?void 0:f.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((b=document.getElementById("bedrooms-filter"))==null?void 0:b.value)||"",s=((h=document.getElementById("parking-filter"))==null?void 0:h.value)||"",l=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",d=document.getElementById("price-slider"),r=d?parseInt(d.value,10):13e7,c=n.filter(v=>{if(a&&v.city!==a||o&&v.neighborhood!==o||i&&(i==="4+"&&Number(v.bedrooms)<4||i!=="4+"&&Number(v.bedrooms)!==Number(i))||s&&(s==="4+"&&Number(v.parking)<4||s!=="4+"&&Number(v.parking)!==Number(s))||l&&v.construction_status!==l)return!1;const E=String(v.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),I=parseInt(E,10)||0;return!(I<0||I>r)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(v=>{var k;const E=v.cover_image||((k=v.images)==null?void 0:k[0])||te[0],I=[v.neighborhood,v.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-price">${p(we(v.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${v.id}" class="btn-det">Ver Detalhes</a>
              <a href="${Ee}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(v=>{var k;const E=(k=v.images)!=null&&k.length?v.images:te,I=E.length;return`
      <div class="card property-card">
        ...
        <div class="property-info">
          ...
          <div><strong>${p(we(v.price,window.currentLang||"pt"))}</strong></div>
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(v=>{v.removeEventListener("click",tt),v.addEventListener("click",tt)})}function jt(e){var o,i,s;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var c;const d=l.cover_image||((c=l.images)==null?void 0:c[0])||te[0],r=[l.neighborhood,l.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
        ...
        <div class="selecao-card-body">
          ...
          <div class="selecao-card-price">${p(we(l.price,window.currentLang||"pt"))}</div>
          <div class="selecao-card-actions">
    ...
    `}).join("");const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(s=a==null?void 0:a.querySelector(".selecao-next"))==null||s.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),Be()};function tt(e){var l;e.stopPropagation();const t=e.currentTarget.closest(".carousel-wrap");if(!t)return;const n=parseInt(t.dataset.total,10);if(!n)return;let a=parseInt(t.dataset.idx,10)||0;const o=e.currentTarget.classList.contains("carousel-next")?1:-1;a=(a+o+n)%n,t.dataset.idx=a;const i=parseInt(t.dataset.pid,10),s=C.find(d=>d.id===i);(l=s==null?void 0:s.images)!=null&&l.length&&(t.querySelector(".carousel-img").src=s.images[a])}function Ht(){const e=document.getElementById("price-slider"),t=document.getElementById("price-label");!e||!t||(e.min="0",e.max="130000000",e.step="1000000",e.value="130000000",t.textContent="Até R$ 130.000.000",e.addEventListener("input",()=>{const n=parseInt(e.value,10);t.textContent="Até R$ "+n.toLocaleString("pt-BR"),Be()}))}function Rt(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=oe();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=oe().find(i=>i.name===e.value),o=a?Ye(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${p(i.name)}</option>`).join(""),Be()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",Be)})}function $e(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var s;const a=n.cover_image||((s=n.images)==null?void 0:s[0])||te[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
      ...
      <td class="cell-price">${p(we(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
    ...
    </tr>`}).join("")}}function Ut(){const e=document.getElementById("f-city");if(!e)return;const t=oe(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),n&&(e.value=n)}function Dt(){var e,t,n,a,o,i,s,l,d,r,c,m,f,u,b;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((s=document.getElementById("f-price-min"))==null?void 0:s.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((d=document.getElementById("f-area-min"))==null?void 0:d.value)||0,areaMax:parseFloat((r=document.getElementById("f-area-max"))==null?void 0:r.value)||1/0,construction:((c=document.getElementById("f-construction"))==null?void 0:c.value)||"",published:((m=document.getElementById("f-published"))==null?void 0:m.value)||"",bedrooms:((f=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:f.dataset.val)||"",suites:((u=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:u.dataset.val)||"",parking:((b=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:b.dataset.val)||""}}function We(e){const t=Dt();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function _e(){if(!document.getElementById("admin-properties"))return;const e=await Tt(),t=e.length,n=e.filter(s=>s.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Ut(),$e(C)}let j=null,ee="";function Oe(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Se(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow=""}function Ce(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(!e.length){t.style.display="none";return}t.style.display="",n.innerHTML=e.map(a=>`
    <div class="cover-thumb-wrap${a===ee?" selected":""}" data-url="${a}">
      <img src="${a}" class="cover-thumb" alt="">
      <span class="cover-star">★</span>
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",()=>{ee=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(o=>o.classList.remove("selected")),a.classList.add("selected")})})}}function De(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var d;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const s=o.filter(r=>r.size>0);if(s.length){t.disabled=!0,t.textContent=`Enviando 0/${s.length} foto…`;try{i=await Nt(s,(r,c)=>{t.textContent=`Enviando ${r}/${c} foto…`})}catch(r){console.error("Erro no upload:",r),t.disabled=!1,t.textContent=j?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(j){const r=C.find(c=>c.id===j);r!=null&&r.images&&(i=r.images)}i.length||(i=[...te]);const l={...j?{id:j}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:ee||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",tenant_id:j?((d=C.find(r=>r.id===j))==null?void 0:d.tenant_id)??(g==null?void 0:g.tenant_id)??null:(g==null?void 0:g.tenant_id)??null};try{await At(l),j=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const r=document.getElementById("adminPublished");r&&(r.value="true");const c=document.getElementById("adminNeighborhood");c&&(c.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),ee="",Ce([]),Se(),await _e()}catch(r){console.error(r),t.disabled=!1,t.textContent=j?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((r==null?void 0:r.message)||JSON.stringify(r)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await qt(o),await _e()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((g==null?void 0:g.role)!=="admin"&&(g==null?void 0:g.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=C.find(d=>d.id===o);if(!i)return;j=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const s=document.getElementById("adminPublished");s&&(s.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const d=document.getElementById("adminNeighborhood");d&&(d.value=i.neighborhood||"")},50)),ee=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Ce(i.images||[]),Oe("Editar Imóvel")}})}function p(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let J=[],D=0;function Ot(e){var c,m;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((c=e.images)==null?void 0:c[0])||te[0];document.getElementById("view-thumb-preview").src=o,J=(m=e.images)!=null&&m.length?e.images:te,D=0,Te(),document.getElementById("view-price").textContent=we(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const i=document.getElementById("view-condominium-item"),s=document.getElementById("view-condominium");s&&(s.textContent=e.condominium||""),i&&(i.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(f=>f.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(f=>f.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const l="https://omarcorretor.com.br/property.html?id="+e.id,d=document.getElementById("share-link-input");d&&(d.value=l);const r=document.getElementById("share-panel");r&&(r.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Le(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Te(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=J[D],e.alt=`Foto ${D+1}`;const i=J.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${D+1} / ${J.length}`:"",o.innerHTML=i?J.map((s,l)=>`<img src="${s}" class="view-thumb${l===D?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(s=>{s.addEventListener("click",()=>{D=+s.dataset.i,Te()})})}async function at(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ae(e){var m,f;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",s=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=s),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),d&&(d.textContent=s),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((f=i[0])==null?void 0:f.toUpperCase())||"?",c.style.display=""),r&&(r.style.display="none"))}function ae(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),P(),e==="contatos"&&ta(),e==="funil"&&Gt(),e==="tarefas"&&Wt()}function nt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ra,visual:ca,"site-config":ma,"crm-config":pa,integracoes:ua,midia:ga}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>va(),{once:!0}),window.lucide&&lucide.createIcons()}}function P(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Pt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("ac-close"))==null||a.addEventListener("click",n),(o=document.getElementById("ac-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",s=>{s.target===t&&n()}),(i=document.getElementById("ac-save"))==null||i.addEventListener("click",async()=>{var c,m;const s=(c=document.getElementById("ac-email"))==null?void 0:c.value.trim(),l=(m=document.getElementById("ac-password"))==null?void 0:m.value.trim(),d=document.getElementById("ac-save"),r=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!l||l.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}d.disabled=!0,d.textContent="Criando…",r.style.display="none";try{const f=await pe({email:s,password:l,tenant_id:(g==null?void 0:g.tenant_id)||null});d.disabled=!1,d.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(r.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${p(s)}<br><strong>Senha:</strong> ${p(l)}`,r.style.color="#0f172a"):(r.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",r.style.color="#16a34a"),r.style.display=""):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(f){d.disabled=!1,d.textContent="+ Criar Acesso",alert("Erro: "+f.message)}})}function ot(){var i,s,l,d,r,c,m,f,u,b,h;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",x=>{var E;x.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(E=document.getElementById("notif-dropdown"))==null||E.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",x=>{x.stopPropagation(),P(),Ft()}),(s=document.getElementById("avatar-dd-change-pass"))==null||s.addEventListener("click",x=>{x.stopPropagation(),P(),Pt()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",x=>{x.stopPropagation(),P(),Xt()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",x=>{x.stopPropagation(),P(),ae("settings")}),(r=document.getElementById("avatar-dd-logout"))==null||r.addEventListener("click",async x=>{x.stopPropagation(),await y.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",x=>{var E;x.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((E=document.getElementById("avatar-dropdown"))==null||E.classList.add("hidden"),Kt())}),(c=document.getElementById("notif-mark-all"))==null||c.addEventListener("click",()=>{Qt(),P()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var x,v;(x=document.getElementById("search-overlay"))==null||x.classList.remove("hidden"),(v=document.getElementById("search-input"))==null||v.focus()}),(f=document.getElementById("search-overlay-close"))==null||f.addEventListener("click",()=>{var x;(x=document.getElementById("search-overlay"))==null||x.classList.add("hidden")}),(u=document.getElementById("search-overlay"))==null||u.addEventListener("click",x=>{x.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(b=document.getElementById("search-input"))==null||b.addEventListener("input",x=>{clearTimeout(o),o=setTimeout(()=>Yt(x.target.value.trim()),280)}),(h=document.getElementById("search-input"))==null||h.addEventListener("keydown",x=>{var v;x.key==="Escape"&&((v=document.getElementById("search-overlay"))==null||v.classList.add("hidden"))}),document.addEventListener("click",P)}let Pe=!1,Q=[],Je=[],qe=[],Y=null,ye=null;async function Gt(){var t;if(Pe){await it();return}Pe=!0,await it(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>Fe());const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{Y=parseInt(e.value,10),await Me()})}async function it(){const e=H(),{data:t}=await y.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order");Q=t||[];const n=Q.map(i=>i.id),{data:a}=n.length?await y.from("crm_stages").select("*").in("pipeline_id",n).order("sort_order"):{data:[]};Je=a||[];const o=document.getElementById("funil-pipe-sel");if(o){const i=Y;o.innerHTML=Q.length?Q.map(l=>`<option value="${l.id}">${p(l.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=Q.find(l=>l.id===i)||Q.find(l=>l.is_default)||Q[0];s?(o.value=s.id,Y=s.id):Y=null}await Me()}async function Me(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=y.from("leads").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="corretor"?t=t.eq("assigned_to",g.id):g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id)),Y&&(t=t.eq("pipeline_id",Y));const{data:n}=await t;qe=n||[],ft()}function ft(){const e=document.getElementById("kanban-board");if(!e)return;const t=Je.filter(a=>a.pipeline_id===Y);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n={};t.forEach(a=>{n[a.name]=[]}),qe.forEach(a=>{var i,s,l,d;const o=a.stage||((i=t[0])==null?void 0:i.name);n[o]||(n[((s=t[0])==null?void 0:s.name)||""]=[]),(d=n[o]||n[(l=t[0])==null?void 0:l.name])==null||d.push(a)}),e.innerHTML=t.map(a=>{const o=n[a.name]||[],i=o.length?o.map(s=>`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${p(a.name)}" style="cursor:pointer;">
          <div class="kanban-card-name">${p(s.name||"—")}</div>
          ${s.phone?`<div class="kanban-card-info">📞 ${p(s.phone)}</div>`:""}
          ${s.email?`<div class="kanban-card-info" style="font-size:11px;color:#94a3b8;">✉ ${p(s.email)}</div>`:""}
          ${s.notes?`<div class="kanban-card-info" style="font-size:11px;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:200px;">📝 ${p(s.notes)}</div>`:""}
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ${s.source?`<span class="kanban-card-tag">${p(s.source)}</span>`:""}
            ${Array.isArray(s.tags)?s.tags.map(l=>`<span class="kanban-card-tag" style="background:#f0f9ff;color:#0369a1;border:1px solid #bae6fd;">${p(l)}</span>`).join(""):""}
          </div>
        </div>`).join(""):'<div class="kanban-empty-col">Sem leads nesta etapa</div>';return`
      <div class="kanban-col" data-stage="${p(a.name)}">
        ...
        <div class="kanban-cards" data-stage="${p(a.name)}">${i}</div>
        <button class="kanban-add-btn" data-stage="${p(a.name)}">+ Adicionar lead</button>
      </div>`}).join(""),Vt(),window.lucide&&lucide.createIcons()}function Vt(){const e=document.getElementById("kanban-board");e&&(e.querySelectorAll(".kanban-add-btn").forEach(t=>{t.addEventListener("click",()=>Fe())}),e.querySelectorAll(".kanban-card").forEach(t=>{t.addEventListener("click",()=>{const n=qe.find(a=>String(a.id)===String(t.dataset.id));n&&Fe(n)}),t.addEventListener("dragstart",n=>{ye=t.dataset.id,t.classList.add("dragging"),n.dataTransfer.effectAllowed="move"}),t.addEventListener("dragend",()=>t.classList.remove("dragging"))}),e.querySelectorAll(".kanban-cards").forEach(t=>{t.addEventListener("dragover",n=>{n.preventDefault(),t.closest(".kanban-col").classList.add("drag-over")}),t.addEventListener("dragleave",n=>{t.contains(n.relatedTarget)||t.closest(".kanban-col").classList.remove("drag-over")}),t.addEventListener("drop",async n=>{n.preventDefault(),t.closest(".kanban-col").classList.remove("drag-over");const a=t.dataset.stage;if(!ye||!a)return;await y.from("leads").update({stage:a}).eq("id",ye);const o=qe.find(i=>String(i.id)===String(ye));o&&(o.stage=a),ye=null,ft()})}))}async function Fe(e=null){var r,c;(r=document.getElementById("lead-detail-panel"))==null||r.remove();const t=!e,n=H(),{data:a}=await y.from("crm_tags").select("*").eq("tenant_id",n).order("name"),{data:o}=await y.from("crm_lead_statuses").select("*").eq("tenant_id",n).order("sort_order"),i=Je.filter(m=>m.pipeline_id===Y).map(m=>`<option value="${p(m.name)}" ${(e==null?void 0:e.stage)===m.name?"selected":""}>${p(m.name)}</option>`).join(""),s=((e==null?void 0:e.phone)||"").replace(/\D/g,""),l=document.createElement("div");l.id="lead-detail-panel",l.style.cssText="position:fixed;top:0;right:0;bottom:0;width:420px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,.15);z-index:1000;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;",l.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}z=n||[],me()}function yt(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function me(){const e=document.getElementById("tarefas-list");if(!e)return;let t=z;if(le==="pending"&&(t=z.filter(a=>a.status!=="done")),le==="done"&&(t=z.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,s=a.checked?"done":"pending";await y.from("tasks").update({status:s}).eq("id",i);const l=z.find(d=>String(d.id)===i);l&&(l.status=s),me()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),z=z.filter(i=>String(i.id)!==String(a.dataset.id)),me())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,s=z.find(l=>String(l.id)===i);s&&bt(s)})})}function bt(e=null){var d,r,c,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=yt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",s=document.createElement("div");s.id="tarefa-modal-root",s.className="modal-backdrop",s.innerHTML=`
  ...
  `,document.body.appendChild(s);const l=()=>s.remove();(d=document.getElementById("tm-close"))==null||d.addEventListener("click",l),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",l),s.addEventListener("click",f=>{f.target===s&&l()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const f=a?"pending":"done";await y.from("tasks").update({status:f}).eq("id",e.id);const u=z.find(b=>String(b.id)===String(e.id));u&&(u.status=f),l(),f==="done"&&(le="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),me()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var v,E;const f=document.getElementById("tarefa-form");if(!f.checkValidity()){f.reportValidity();return}const u=new FormData(f),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const h={title:(v=u.get("title"))==null?void 0:v.trim(),description:((E=u.get("description"))==null?void 0:E.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null};let x;if(n){if({error:x}=await y.from("tasks").update(h).eq("id",e.id),!x){const I=z.findIndex(k=>String(k.id)===String(e.id));I>=0&&(z[I]={...z[I],...h})}}else{const{data:I,error:k}=await y.from("tasks").insert(h).select();x=k,!x&&(I!=null&&I[0])&&z.unshift(I[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}l(),me()})}async function Yt(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;g==null||g.role,g==null||g.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(s=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(s=>{s.addEventListener("click",()=>{var l;(l=document.getElementById("search-overlay"))==null||l.classList.add("hidden"),s.dataset.type==="lead"?ae("contatos"):ae("properties")})})}let F=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function Kt(){var s;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=y.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(l=>!F.includes(String(l.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(l=>{const d=Zt(l.created_at);return`
      <div class="notif-item${!F.includes(String(l.id))?" unread":""}" data-id="${l.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${p(l.name||"—")}</div>
          <div class="notif-item-sub">${p(l.phone||l.source||"")} · ${d}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(s=document.getElementById("notif-see-all"))==null||s.addEventListener("click",l=>{l.preventDefault(),P(),ae("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{F.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(F)),l.classList.remove("unread"),P(),ae("contatos")})})}function Qt(){var e;document.querySelectorAll(".notif-item").forEach(t=>F.push(t.dataset.id)),F=[...new Set(F)],localStorage.setItem("crm_notifs_read",JSON.stringify(F)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Zt(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function ea(){let e=y.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);g!=null&&g.tenant_id&&(e=e.eq("tenant_id",g.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!F.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let U=[],M=1;const be=10;let lt=!1;async function ta(){var t,n,a,o,i,s,l,d,r;document.getElementById("section-contatos")&&(lt||(lt=!0,await ht(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{M=1,ne()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",c=>{c.key==="Enter"&&(M=1,ne())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>xt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",oa),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",Xe),(s=document.getElementById("import-modal-cancel"))==null||s.addEventListener("click",Xe),(l=document.getElementById("download-template"))==null||l.addEventListener("click",c=>{c.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,f=new Blob([m],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(f),u.download="modelo_contatos.csv",u.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",aa),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",na)))}async function ht(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="corretor"?t=t.eq("assigned_to",g.id):g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:a}=await t;U=a||[],ne()}function ne(){var l,d,r;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?U.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):U,n=t.length,a=Math.max(1,Math.ceil(n/be));M>a&&(M=a);const o=t.slice((M-1)*be,M*be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const s=document.getElementById("contatos-pagination");if(s){const c=n===0?0:(M-1)*be+1,m=Math.min(M*be,n);s.innerHTML=`
    ...
    `,(d=s.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{M--,ne()}),(r=s.querySelector("#pag-next"))==null||r.addEventListener("click",()=>{M++,ne()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(c=>{c.addEventListener("click",m=>{m.preventDefault();const f=c.dataset.id,u=U.find(b=>String(b.id)===String(f));u&&xt(u)})})}async function xt(e=null){var v,E,I,k,S,$;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=H(),[{data:o},{data:i},{data:s}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",a).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],d=i||[],r=s||[],c=l.map(w=>w.id),{data:m}=c.length?await y.from("crm_stages").select("*").in("pipeline_id",c).order("sort_order"):{data:[]},f=m||[],u=(e==null?void 0:e.pipeline_id)||((v=l[0])==null?void 0:v.id)||"";function b(w){const B=f.filter(L=>L.pipeline_id===w);return B.length?'<option value="">— Selecionar etapa —</option>'+B.map(L=>`<option value="${p(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${p(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${l.map(w=>`<option value="${w.id}" ${String(e==null?void 0:e.pipeline_id)===String(w.id)?"selected":""}>${p(w.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
  ...
  `,document.body.appendChild(h);const x=()=>h.remove();(E=document.getElementById("cm-close"))==null||E.addEventListener("click",x),(I=document.getElementById("cm-cancel"))==null||I.addEventListener("click",x),h.addEventListener("click",w=>{w.target===h&&x()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",w=>{const B=document.getElementById("cm-stage");B&&(B.innerHTML=b(w.target.value))}),(S=document.getElementById("cm-delete"))==null||S.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await y.from("leads").delete().eq("id",e.id);const w=U.findIndex(B=>String(B.id)===String(e.id));w>=0&&U.splice(w,1),x(),ne()}),($=document.getElementById("cm-save"))==null||$.addEventListener("click",async()=>{var X,G,V,ue,ge,ve,fe;const w=document.getElementById("contato-form");if(!w.checkValidity()){w.reportValidity();return}const B=new FormData(w),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const _=B.getAll("tag"),T=B.get("pipeline_id")||null,N={name:(X=B.get("name"))==null?void 0:X.trim(),company:((G=B.get("company"))==null?void 0:G.trim())||null,email:((V=B.get("email"))==null?void 0:V.trim())||null,phone:((ue=B.get("phone"))==null?void 0:ue.trim())||null,job_title:((ge=B.get("job_title"))==null?void 0:ge.trim())||null,city_interest:((ve=B.get("city_interest"))==null?void 0:ve.trim())||null,notes:((fe=B.get("notes"))==null?void 0:fe.trim())||null,pipeline_id:T,stage:B.get("stage")||null,status:B.get("status")||null,tags:_,assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await y.from("leads").update(N).eq("id",e.id),!A){const R=U.findIndex(ie=>String(ie.id)===String(e.id));R>=0&&(U[R]={...U[R],...N})}}else{const{data:R,error:ie}=await y.from("leads").insert(N).select();A=ie,!A&&(R!=null&&R[0])&&U.unshift(R[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}x(),ne()})}let re=[];function aa(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{re=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[d,r,c,m,f]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:d,email:r,phone:c,company:m,job_title:f}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${re.length} contato(s) encontrados para importar.`);const s=document.getElementById("import-modal-confirm");s&&(s.disabled=re.length===0)},n.readAsText(t)}async function na(){if(!re.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=re.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Xe(),await ht(),alert(`${t.length} contato(s) importados com sucesso!`)}function oa(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),re=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Xe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ia="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function pe(e){return(await fetch(ia,{method:"POST",headers:{Authorization:`Bearer ${St}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function dt(e){var d,r,c,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),s=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:f}}=await y.auth.getUser();n.value=(f==null?void 0:f.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",f=>{const u=f.target.files[0];if(!u)return;const b=URL.createObjectURL(u);a&&(a.src=b,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var v,E;const f=((v=document.getElementById("change-password-new"))==null?void 0:v.value)||"",u=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",b=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(b&&(b.style.display="none"),f.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}if(f!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:x}=await y.auth.updateUser({password:f});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),x?b&&(b.textContent="Erro: "+x.message,b.style.display=""):(b&&(b.style.color="#16a34a",b.textContent="Senha alterada com sucesso!",b.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),s==null||s.addEventListener("click",async()=>{var E;const f=t.value.trim();let u=(g==null?void 0:g.avatar_url)||"";const b=i==null?void 0:i.files[0],h=s.textContent;if(s.disabled=!0,s.textContent="Salvando…",b)try{const I=await ke(b,400,.85),k=`avatars/${g.id}-${Date.now()}.jpg`,{error:S}=await y.storage.from("imoveis").upload(k,I,{contentType:"image/jpeg",upsert:!0});if(!S){const{data:{publicUrl:$}}=y.storage.from("imoveis").getPublicUrl(k);u=$}}catch(I){console.error("Avatar upload:",I)}const{error:x}=await y.from("profiles").update({name:f,avatar_url:u}).eq("id",g.id);if(s.disabled=!1,s.textContent=h,x){alert("Erro ao salvar perfil.");return}g={...g,name:f,avatar_url:u},Ae(g);const v=document.getElementById("settings-avatar-initial");v&&(v.textContent=((E=f[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const f=document.getElementById("settings-corretores-section");f&&(f.style.display=""),await ze(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var E,I;const b=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),h=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),x=document.getElementById("btn-invite-corretor"),v=document.getElementById("invite-note");if(!b){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),v&&(v.style.display="none");try{const k=await pe({email:b,password:h,tenant_id:(g==null?void 0:g.tenant_id)||null});if(k.success){const S=document.getElementById("invite-email"),$=document.getElementById("invite-password");S&&(S.value=""),$&&($.value=""),await ze(),v&&(k.email_sent===!1?(v.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${p(h)}`,v.style.color="#0f172a"):(v.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",v.style.color="#16a34a"),v.style.display="")}else alert("Erro: "+(k.error||"Falha desconhecida"))}catch(k){alert("Erro ao criar acesso: "+k.message)}finally{x&&(x.disabled=!1,x.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await he(),(c=document.getElementById("loc-add-city-btn"))==null||c.addEventListener("click",async()=>{const b=document.getElementById("loc-new-city"),h=b==null?void 0:b.value.trim();if(!h)return;const{error:x}=await y.from("locations").insert({type:"cidade",name:h});if(x){alert("Erro ao adicionar cidade.");return}b&&(b.value=""),await he(),Ke()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var E;const b=parseInt((E=document.getElementById("loc-new-neighborhood-city"))==null?void 0:E.value,10),h=document.getElementById("loc-new-neighborhood"),x=h==null?void 0:h.value.trim();if(!b||!x){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:v}=await y.from("locations").insert({type:"bairro",name:x,parent_id:b});if(v){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await he()})}}async function ze(){const e=document.getElementById("corretores-list");if(!e)return;let t=y.from("profiles").select("*").order("created_at");g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),s=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${p(i)}</div>`,l=o.id===(g==null?void 0:g.id),d=o.active!==!1,r=d?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',c=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{await y.from("profiles").update({role:o.value}).eq("id",o.dataset.uid)})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,s=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const l=await pe({action:"toggle",userId:i,active:!s});l.success||alert("Erro: "+(l.error||"Falha desconhecida"))}catch(l){alert("Erro: "+l.message)}await ze()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var l,d;const i=o.dataset.uid,s=((d=(l=o.closest(".corretor-item"))==null?void 0:l.querySelector(".corretor-name"))==null?void 0:d.textContent)||"este corretor";if(confirm(`Excluir "${s}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const r=await pe({action:"delete",userId:i});r.success||alert("Erro ao excluir: "+(r.error||"Falha desconhecida"))}catch(r){alert("Erro: "+r.message)}await ze()}})})}async function Et(){const{data:e,error:t}=await y.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(Ie=e||[],Ie)}function oe(){return Ie.filter(e=>e.type==="cidade")}function Ye(e){return Ie.filter(t=>t.type==="bairro"&&t.parent_id===e)}function Ke(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=oe();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),t&&(e.value=t)}async function he(){await Et();const e=oe(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${p(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=Ie.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const s=e.find(l=>l.id===i.parent_id);return`
          <div class="loc-item">
            <div>
...
`+$);window.open("mailto:?subject="+B+"&body="+L,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const $=document.getElementById("share-link-input");$&&((w=navigator.clipboard)==null||w.writeText($.value).then(()=>{const B=document.getElementById("share-copy"),L=B.textContent;B.textContent="✅ Copiado!",setTimeout(()=>{B.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var N;if((g==null?void 0:g.role)!=="admin")return;const $=document.getElementById("view-modal-title").textContent,w=C.find(A=>A.title===$);if(!w)return;Le(),j=w.id;const B=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",B.querySelector('[name="title"]').value=w.title||"",B.querySelector('[name="rua"]').value=w.rua||"",B.querySelector('[name="numero"]').value=w.numero||"",B.querySelector('[name="city"]').value=w.city||"",B.querySelector('[name="price"]').value=w.price||"",B.querySelector('[name="bedrooms"]').value=w.bedrooms||"",B.querySelector('[name="suites"]').value=w.suites||"",B.querySelector('[name="parking"]').value=w.parking||"",B.querySelector('[name="description"]').value=w.description||"",B.querySelector('[name="construction_status"]').value=w.construction_status||"",B.querySelector('[name="owner_name"]').value=w.owner_name||"",B.querySelector('[name="owner_phone"]').value=w.owner_phone||"",B.querySelector('[name="owner_email"]').value=w.owner_email||"",B.querySelector('[name="owner_notes"]').value=w.owner_notes||"",B.querySelector('[name="condominium"]').value=w.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=w.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=w.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=w.neighborhood||"")},50)),ee=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Ce(w.images||[]),Oe("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach(B=>B.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(B=>B.classList.add("hidden")),(w=document.getElementById(`tab-${$.dataset.tab}`))==null||w.classList.remove("hidden")})}),(S=document.getElementById("admin-properties"))==null||S.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const w=$.target.closest("tr");if(!w)return;const B=Number(w.dataset.id);if(!B)return;const L=C.find(_=>_.id===B);L&&Ot(L)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;const e=window.location.hostname;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:r}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();r!=null&&r.id&&je(r.id)}await Promise.all([$t(),Et()]),se=Z("company.whatsapp",se),Ee=`https://wa.me/${se}`,Ve(),Ht(),Rt();const t=document.getElementById("adminCitySelect"),n=document.getElementById("adminNeighborhood");t&&n&&(Ke(),t.addEventListener("change",()=>{const r=oe().find(m=>m.name===t.value),c=r?Ye(r.id):[];n.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${p(m.name)}</option>`).join("")}));const a=document.getElementById("admin-login"),o=document.getElementById("admin-root");if(a){const r=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=r.get("type")||c.get("type")||"",f=vt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),u=document.getElementById("password-reset-overlay");if(f){a.style.display="none",o&&o.classList.add("hidden"),u&&(u.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async h=>{var S,$;h.preventDefault();const x=((S=document.getElementById("new-password"))==null?void 0:S.value)||"",v=(($=document.getElementById("confirm-password"))==null?void 0:$.value)||"",E=document.getElementById("password-reset-msg"),I=h.target.querySelector('button[type="submit"]');if(E&&(E.style.display="none"),x!==v){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}I&&(I.disabled=!0,I.textContent="Salvando…");const{error:k}=await y.auth.updateUser({password:x});if(k){E&&(E.textContent="Erro: "+k.message,E.style.display=""),I&&(I.disabled=!1,I.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await y.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:b}}=await y.auth.getSession();if(b){if(a.classList.add("hidden"),o&&o.classList.remove("hidden"),De(),rt(),ot(),window.lucide&&lucide.createIcons(),g=await at(b.user.id),!g){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden");return}if(g.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(g.needs_password_reset){a.style.display="none",o&&o.classList.add("hidden");const h=document.getElementById("password-reset-overlay");h&&(h.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async x=>{var $,w;x.preventDefault();const v=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",E=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",I=document.getElementById("password-reset-msg"),k=x.target.querySelector('button[type="submit"]');if(I&&(I.style.display="none"),v!==E){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}if(v.length<6){I&&(I.textContent="Mínimo 6 caracteres.",I.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:S}=await y.auth.updateUser({password:v});if(S){I&&(I.textContent="Erro: "+S.message,I.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",g.id),window.location.href=window.location.pathname});return}je((g==null?void 0:g.tenant_id)||null),Ae(g),nt(g.role),await _e(),await dt(g),window.lucide&&lucide.createIcons(),ea()}else{o&&o.classList.add("hidden"),a.classList.remove("hidden");const h=document.getElementById("login-form");h&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var E,I;const x=(I=(E=h.querySelector('input[name="email"]'))==null?void 0:E.value)==null?void 0:I.trim();if(!x){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:v}=await y.auth.resetPasswordForEmail(x,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(v?"Erro: "+v.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),h.addEventListener("submit",async x=>{x.preventDefault();const v=new FormData(h),E=v.get("email"),I=v.get("password");if(await Mt(E,I)){a.classList.add("hidden"),o&&o.classList.remove("hidden"),De(),rt(),window.lucide&&lucide.createIcons();const{data:{session:S}}=await y.auth.getSession();if(g=S?await at(S.user.id):null,!g){await y.auth.signOut();return}if(g.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}ot(),je((g==null?void 0:g.tenant_id)||null),Ae(g),nt(g.role),await _e(),await dt(g),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else De();await Be();const i=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();kt(i),Lt(se)});async function sa(){const e=C.filter(o=>!o.reference);if(!e.length)return;const t=C.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:s}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!s){const l=C.findIndex(d=>d.id===o.id);l>=0&&(C[l].reference=i),n++}}$e(We(C))}async function la(){const e=C.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const s=await da(i);a.push(s),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=C.findIndex(s=>s.id===t.id);i>=0&&(C[i].images=a)}}$e(We(C))}}async function da(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,s=i?URL.createObjectURL(i):null;return new Promise(l=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),c=1200;let m=d.width,f=d.height;m>c&&(f=Math.round(f*c/m),m=c),r.width=m,r.height=f;const u=r.getContext("2d");u.drawImage(d,0,0,m,f);const b=h=>{if(h){const x=Math.round(m*.18),v=Math.round(h.naturalHeight*x/h.naturalWidth),E=Math.round(m*.02);u.globalAlpha=.45,u.drawImage(h,m-x-E,f-v-E,x,v),u.globalAlpha=1}r.toBlob(async x=>{try{const v=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:E}=await y.storage.from("imoveis").upload(v,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(E){console.error("Upload watermark error:",E),l(e);return}const{data:{publicUrl:I}}=y.storage.from("imoveis").getPublicUrl(v);l(I)}catch(v){console.error("Watermark upload exception:",v),l(e)}},"image/jpeg",.82)};if(s){const h=new Image;h.onload=()=>{URL.revokeObjectURL(s),b(h)},h.onerror=()=>{URL.revokeObjectURL(s),b(null)},h.src=s}else b(null)},d.onerror=()=>{URL.revokeObjectURL(a),l(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function O(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Qe(e,t="assets"){const n=await ke(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function ra(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",H()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>p(String(n[o]||""));e.innerHTML=`
  ...
  `,await W())}async function W(){const e=document.getElementById("crm-body");if(!e)return;const t=H(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),y.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",t).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),s=n||[],l=s.find(u=>u.is_default)||s[0],d=s.map(u=>`<option value="${u.id}"${u.id===(l==null?void 0:l.id)?" selected":""}>${p(u.name)}</option>`).join(""),c=(a||[]).filter(u=>u.pipeline_id===(l==null?void 0:l.id)).map(u=>`
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var m;const l=document.getElementById("intg-save-tracking");l.disabled=!0,l.textContent="Salvando…";let d=!0;const r=document.querySelectorAll(".intg-val"),c=document.querySelectorAll(".intg-toggle");for(let f=0;f<r.length;f++){const u=r[f].dataset.key,b=r[f].value.trim(),h=((m=c[f])==null?void 0:m.checked)??!1;await Ue(u,b,h)||(d=!1)}l.disabled=!1,l.textContent="Salvar Integrações",O(document.getElementById("intg-tracking-msg"),d)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const l=document.getElementById("intg-save-smtp");l.disabled=!0,l.textContent="Salvando…";const d=document.querySelectorAll(".smtp-field");let r=!0;for(const m of d)await Ue(m.dataset.key,m.value.trim(),!0)||(r=!1);const c=document.getElementById("smtp-pass").value;c&&(await Ue("smtp_pass",c,!0)||(r=!1)),l.disabled=!1,l.textContent="Salvar SMTP",O(document.getElementById("intg-smtp-msg"),r)})}async function ga(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await Ge(),document.getElementById("media-file-input").addEventListener("change",async n=>{var d,r;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),s=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const c of a){s.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const m=await Qe(c,"media"),f=c.name.replace(/\.[^.]+$/,"").slice(0,60);await y.from("media_library").insert({name:f,url:m,type:"image",size:c.size,created_by:(r=(d=(await y.auth.getUser()).data)==null?void 0:d.user)==null?void 0:r.id})}catch(m){console.error("Media upload error:",m)}l++}i.style.width="100%",s.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await Ge(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Ge(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await y.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const m=r.dataset.active==="true";await y.from("tenants").update({active:!m}).eq("id",r.dataset.id),K()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(r=>{r.addEventListener("click",()=>{const c=(i||[]).find(m=>String(m.id)===String(r.dataset.id));c&&xa(c)})})}async function fa(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:r})=>{const c=document.getElementById("nt-plan");c&&r&&(c.innerHTML='<option value="">Sem plano</option>'+r.map(m=>`<option value="${m.id}">${p(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const c=document.getElementById("nt-slug");c&&!c.dataset.manual&&(c.value=ba(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(s=document.getElementById("sa-modal-close-btn"))==null||s.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(d=document.getElementById("nt-save"))==null||d.addEventListener("click",async()=>{var S,$,w,B,L,_,T,N,A,X,G,V;const r=($=(S=document.getElementById("nt-name"))==null?void 0:S.value)==null?void 0:$.trim(),c=(B=(w=document.getElementById("nt-slug"))==null?void 0:w.value)==null?void 0:B.trim(),m=(_=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:_.trim(),f=(T=document.getElementById("nt-plan"))==null?void 0:T.value,u=(A=(N=document.getElementById("nt-admin-email"))==null?void 0:N.value)==null?void 0:A.trim(),b=(G=(X=document.getElementById("nt-admin-password"))==null?void 0:X.value)==null?void 0:G.trim(),h=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!r||!c){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!b||b.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:v,error:E}=await y.from("tenants").insert({name:r,slug:c,domain:m||null,plan_id:f||null,active:!0}).select();if(E){x.disabled=!1,x.textContent="Criar Imobiliária",h.textContent="❌ "+E.message,h.style.color="#ef4444";return}const I=(V=v==null?void 0:v[0])==null?void 0:V.id;h.textContent="⏳ Criando usuário admin…";const k=await pe({email:u,password:b,role:"admin",tenant_id:I});if(!(k!=null&&k.success)){x.disabled=!1,x.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+p((k==null?void 0:k.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),K()},3e3);return}I&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await y.from("profiles").update({tenant_id:I}).eq("id",k.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",k.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>wt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ut(e,o.dataset.tab)})}),ut(e,"properties")}async function ut(e,t){var a,o,i;const n=document.getElementById("tp-content");if(n){if(n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;font-size:14px;">Carregando…</div>',t==="properties"){const{data:s}=await y.from("properties").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1});if(!(s!=null&&s.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">🏠</div><p style="font-size:14px;">Nenhum imóvel cadastrado ainda.</p></div>';return}n.innerHTML=`
      ...
      </div>`,(i=document.getElementById("tp-open-edit"))==null||i.addEventListener("click",()=>wt(e))}}}function wt(e){var r,c,m,f,u,b,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:v})=>{const E=document.getElementById("et-plan");E&&v&&(E.innerHTML='<option value="">Sem plano</option>'+v.map(I=>`<option value="${I.id}"${String(I.id)===String(e.plan_id)?" selected":""}>${p(I.name)}</option>`).join(""))}),(r=document.getElementById("et-logo-input"))==null||r.addEventListener("change",v=>{const E=v.target.files[0];if(!E)return;const I=URL.createObjectURL(E),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${I}" style="width:100%;height:100%;object-fit:cover;">`)}),(c=document.getElementById("et-logo-preview"))==null||c.addEventListener("click",()=>{var v;(v=document.getElementById("et-logo-input"))==null||v.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const v=document.getElementById("et-admin-password");v.type=v.type==="password"?"text":"password"}),(f=document.getElementById("et-copy-key"))==null||f.addEventListener("click",()=>{var k,S;const v=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!v)return;(S=navigator.clipboard)==null||S.writeText(v);const E=document.getElementById("et-copy-key"),I=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=I},2e3)});const o=["dados","config","api"];function i(v){o.forEach(E=>{document.getElementById(`et-pane-${E}`).style.display=E===v?"":"none";const I=document.getElementById(`et-tab-${E}`);I.style.borderBottomColor=E===v?"#2563eb":"transparent",I.style.color=E===v?"#2563eb":"#64748b",I.style.fontWeight=E===v?"600":"500"}),v==="config"&&l()}o.forEach(v=>{var E;return(E=document.getElementById(`et-tab-${v}`))==null?void 0:E.addEventListener("click",()=>i(v))});let s=!1;async function l(){var I;if(s)return;s=!0;const{data:v}=await y.from("settings").select("key,value").eq("tenant_id",e.id),E={};v==null||v.forEach(k=>{E[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
    ...
    `,(I=document.getElementById("et-cfg-save"))==null||I.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),S=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",S.textContent="",S.style.color="#64748b";const $=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),w=document.getElementById("et-cfg-phone").value.trim(),B=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),_=document.getElementById("et-cfg-slogan").value.trim(),{error:T}=await y.from("settings").upsert([{key:"company.whatsapp",value:$,tenant_id:e.id},{key:"company.phone",value:w,tenant_id:e.id},{key:"company.email",value:B,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:_,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",T?(S.textContent="❌ "+T.message,S.style.color="#ef4444"):(S.textContent="✅ Configurações salvas!",S.style.color="#22c55e")})}const d=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",d),(b=document.getElementById("et-cancel"))==null||b.addEventListener("click",d),n.addEventListener("click",v=>{v.target===n&&d()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:I}=await y.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}d(),K()}),(x=document.getElementById("et-save"))==null||x.addEventListener("click",async()=>{var N,A,X,G,V,ue,ge,ve,fe,R,ie,Ze;const v=(A=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:A.trim(),E=(G=(X=document.getElementById("et-slug"))==null?void 0:X.value)==null?void 0:G.trim(),I=(ue=(V=document.getElementById("et-domain"))==null?void 0:V.value)==null?void 0:ue.trim(),k=(ge=document.getElementById("et-plan"))==null?void 0:ge.value,S=(fe=(ve=document.getElementById("et-admin-email"))==null?void 0:ve.value)==null?void 0:fe.trim(),$=(ie=(R=document.getElementById("et-admin-password"))==null?void 0:R.value)==null?void 0:ie.trim(),w=(Ze=document.getElementById("et-logo-input"))==null?void 0:Ze.files[0],B=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!v){B.textContent="❌ Nome é obrigatório.",B.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",B.textContent="⏳ Salvando…",B.style.color="#64748b";let _=e.logo_url;if(w)try{const q=await ke(w,256,.85),et=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:It}=await y.storage.from("imoveis").upload(et,q,{contentType:"image/jpeg",upsert:!0});if(!It){const{data:{publicUrl:Bt}}=y.storage.from("imoveis").getPublicUrl(et);_=Bt}}catch(q){console.error("Logo upload:",q)}const{error:T}=await y.from("tenants").update({name:v,slug:E||e.slug,domain:I||null,plan_id:k||null,logo_url:_}).eq("id",e.id);if(T){L.disabled=!1,L.textContent="Salvar",B.textContent="❌ "+T.message,B.style.color="#ef4444";return}if(S&&$&&$.length>=6){B.textContent="⏳ Criando usuário admin…";const q=await pe({email:S,password:$,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),B.textContent="✅ Salvo e admin criado!",B.style.color="#22c55e"):(B.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),B.style.color="#f59e0b")}else B.textContent="✅ Imobiliária atualizada!",B.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{d(),K()},1200)})}
