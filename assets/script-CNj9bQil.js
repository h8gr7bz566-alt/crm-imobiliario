import{s as y}from"./supabase-BcuJ3xoD.js";const ht="00000000-0000-0000-0000-000000000000";let we={},He={},pe=ht;function Re(e){pe=e||ht,we={},He={}}const H=()=>pe;async function Ct(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",pe),y.from("site_content").select("*").eq("tenant_id",pe)]);e.data&&e.data.forEach(n=>{we[n.key]=n.value}),t.data&&t.data.forEach(n=>{He[n.key]=n})}const ee=(e,t=null)=>we[e]!==void 0?we[e]:t,Ue=(e,t="pt")=>{const n=He[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function ce(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:pe,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{we[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:pe,updated_at:new Date().toISOString()},{error:i}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(He[e]=o),!i}async function Oe(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function Qe(){const e=document.documentElement,t=ee("visual.accent_color","#b8962e"),n=ee("visual.primary_bg","#0f1c2e"),a=ee("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=ee("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(l=>{l.src=o});const i=ee("company.favicon_url","/favicon.ico"),s=document.querySelector('link[rel="shortcut icon"]');s&&(s.href=i);const d=ee("visual.hero_bg_url","");if(d){const l=document.querySelector(".hero");l&&(l.style.backgroundImage=`url('${d}')`)}}function Tt(e="pt"){const t=b=>Ue(b,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),s=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),s&&t("inst.bio_p2")&&(s.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const l=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),c=document.querySelector('[data-i18n="inst.stat2"]'),m=document.querySelector('[data-i18n="inst.stat3"]');l&&t("inst.stat2_num")&&(l.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),c&&t("inst.stat2_label")&&(c.innerHTML=t("inst.stat2_label")),m&&t("inst.stat3_label")&&(m.innerHTML=t("inst.stat3_label"));const f=Ue("seo.title_pt",e);f&&document.title&&(document.title=f);const u=Ue("seo.description_pt",e);if(u){const b=document.querySelector('meta[name="description"]');b&&(b.content=u)}}function At(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const qt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let le="5547999701743",Ie=`https://wa.me/${le}`;const ae=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Mt=5.7;function Be(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Mt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],g=null,$e=[],xt=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(xt=!0)});async function zt(){const e=window.location.hostname;let t=null;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:i}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();i!=null&&i.id&&(t=i.id)}let n=y.from("properties").select("*").eq("published",!0);t&&(n=n.eq("tenant_id",t));const{data:a,error:o}=await n.order("created_at",{ascending:!1});return o?(console.error("Supabase select error:",o),[]):a||[]}async function Nt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="super_admin"||(g!=null&&g.tenant_id?e=e.eq("tenant_id",g.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ma(),pa(),_)}async function jt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(s=>s.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Ht(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Rt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function Se(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,s=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(s);const d=document.createElement("canvas");let l=i.width,r=i.height;l>t&&(r=Math.round(r*t/l),l=t),d.width=l,d.height=r;const c=d.getContext("2d");c.drawImage(i,0,0,l,r);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const f=Math.round(l*.18),u=Math.round(m.naturalHeight*f/m.naturalWidth),b=Math.round(l*.02),h=l-f-b,x=r-u-b;c.globalAlpha=.45,c.drawImage(m,h,x,f,u),c.globalAlpha=1,d.toBlob(v=>v?a(v):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{d.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=s})}async function Ut(e){const t=await Se(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Dt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Ut(n[o]));return a}async function ke(){var m,f,u,b,h,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await zt();_=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&Ot(n);const a=((f=document.getElementById("city-filter"))==null?void 0:f.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((b=document.getElementById("bedrooms-filter"))==null?void 0:b.value)||"",s=((h=document.getElementById("parking-filter"))==null?void 0:h.value)||"",d=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",l=document.getElementById("price-slider"),r=l?parseInt(l.value,10):13e7,c=n.filter(v=>{if(a&&v.city!==a||o&&v.neighborhood!==o||i&&(i==="4+"&&Number(v.bedrooms)<4||i!=="4+"&&Number(v.bedrooms)!==Number(i))||s&&(s==="4+"&&Number(v.parking)<4||s!=="4+"&&Number(v.parking)!==Number(s))||d&&v.construction_status!==d)return!1;const E=String(v.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(E,10)||0;return!(B<0||B>r)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(v=>{var k;const E=v.cover_image||((k=v.images)==null?void 0:k[0])||ae[0],B=[v.neighborhood,v.city].filter(Boolean).join(", ");return`
      ...
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(v=>{var k;const E=(k=v.images)!=null&&k.length?v.images:ae,B=E.length;return`
    ...
    `}).join("");const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(s=a==null?void 0:a.querySelector(".selecao-next"))==null||s.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ke()};function st(e){var d;e.stopPropagation();const t=e.currentTarget.closest(".carousel-wrap");if(!t)return;const n=parseInt(t.dataset.total,10);if(!n)return;let a=parseInt(t.dataset.idx,10)||0;const o=e.currentTarget.classList.contains("carousel-next")?1:-1;a=(a+o+n)%n,t.dataset.idx=a;const i=parseInt(t.dataset.pid,10),s=_.find(l=>l.id===i);(d=s==null?void 0:s.images)!=null&&d.length&&(t.querySelector(".carousel-img").src=s.images[a])}function Pe(e){if(!e||e===0)return"R$ 0";const t=String(Math.round(e)).split("").reverse();let n="";for(let a=0;a<t.length;a++)a>0&&a%3===0&&(n="."+n),n=t[a]+n;return"R$ "+n}function Pt(){const e=document.getElementById("price-slider"),t=document.getElementById("price-label");!e||!t||(e.min="0",e.max="130000000",e.step="100000",e.value="130000000",t.textContent="Até "+Pe(13e7),e.addEventListener("input",()=>{const n=parseInt(e.value,10);t.textContent="Até "+Pe(n),ke()}))}function Ft(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ie();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ie().find(i=>i.name===e.value),o=a?tt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${p(i.name)}</option>`).join(""),ke()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ke)})}function Le(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var s;const a=n.cover_image||((s=n.images)==null?void 0:s[0])||ae[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
`+((r==null?void 0:r.message)||JSON.stringify(r)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ht(o),await Te()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((g==null?void 0:g.role)!=="admin"&&(g==null?void 0:g.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(l=>l.id===o);if(!i)return;j=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const s=document.getElementById("adminPublished");s&&(s.value=i.published===!0?"true":"false");const d=document.getElementById("adminCitySelect");d&&(d.value=i.city||"",d.dispatchEvent(new Event("change")),setTimeout(()=>{const l=document.getElementById("adminNeighborhood");l&&(l.value=i.neighborhood||"")},50)),te=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Ae(i.images||[]),Xe("Editar Imóvel")}})}function p(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Y=[],O=0;function Vt(e){var m,f;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||ae[0];document.getElementById("view-thumb-preview").src=i,Y=(f=e.images)!=null&&f.length?e.images:ae,O=0,qe(),document.getElementById("view-price").textContent=Be(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),d=document.getElementById("view-condominium");d&&(d.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const l="https://omarcorretor.com.br/property.html?id="+e.id,r=document.getElementById("share-link-input");r&&(r.value=l);const c=document.getElementById("share-panel");c&&(c.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function _e(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function qe(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Y[O],e.alt=`Foto ${O+1}`;const i=Y.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${O+1} / ${Y.length}`:"",o.innerHTML=i?Y.map((s,d)=>`<img src="${s}" class="view-thumb${d===O?" active":""}" data-i="${d}" alt="Foto ${d+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(s=>{s.addEventListener("click",()=>{O=+s.dataset.i,qe()})})}async function lt(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Me(e){var m,f;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",s=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=s),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const d=document.getElementById("avatar-dd-name"),l=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");d&&(d.textContent=i),l&&(l.textContent=s),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((f=i[0])==null?void 0:f.toUpperCase())||"?",c.style.display=""),r&&(r.style.display="none"))}function ne(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),F(),e==="contatos"&&sa(),e==="funil"&&Kt(),e==="tarefas"&&Zt()}function dt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ga,visual:va,"site-config":fa,"crm-config":ya,integracoes:ba,midia:ha}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>xa(),{once:!0}),window.lucide&&lucide.createIcons()}}function F(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Wt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
      ...
      <div class="modal-footer">
        ...
        <div class="kanban-card" draggable="true" data-id="${l.id}" data-stage="${p(i.name)}" style="cursor:pointer;">
          ...
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(l.tags)?l.tags.map(r=>{const c=Ve[r],m=(c==null?void 0:c.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${m}18;color:${m};border:1px solid ${m}44;">${p(r)}</span>`}).join(""):""}
          </div>
  ...
  `,document.body.appendChild(d),requestAnimationFrame(()=>{d.style.transform="translateX(0)"});const l=()=>{d.style.transform="translateX(100%)",setTimeout(()=>d.remove(),250)};document.getElementById("ldp-close").addEventListener("click",l),document.getElementById("ldp-save").addEventListener("click",async()=>{var v,E;const m=document.getElementById("ldp-save"),f=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){f.style.color="#ef4444",f.textContent="Nome é obrigatório.";return}m.disabled=!0,m.textContent="Salvando…";const b=[...d.querySelectorAll("input[type=checkbox]:checked")].map(B=>B.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((v=document.getElementById("ldp-stage"))==null?void 0:v.value)||null,status:((E=document.getElementById("ldp-status"))==null?void 0:E.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:b,tenant_id:H()};let x;if(t?{error:x}=await y.from("leads").insert(h):{error:x}=await y.from("leads").update(h).eq("id",e.id),m.disabled=!1,m.textContent="💾 Salvar",x){f.style.color="#ef4444",f.textContent="Erro: "+x.message;return}f.style.color="#22c55e",f.textContent="✅ Salvo!",setTimeout(()=>{l(),Ne()},700)}),(c=document.getElementById("ldp-delete"))==null||c.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await y.from("leads").delete().eq("id",e.id),l(),Ne())})}let z=[],mt=!1,re="pending";async function Zt(){var e;mt||(mt=!0,await ea(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>It()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),re=t.dataset.filter,ue()})}))}async function ea(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=y.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(g==null?void 0:g.role)==="corretor"?t=t.eq("assigned_to",g.id):g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(s);const d=()=>s.remove();(l=document.getElementById("tm-close"))==null||l.addEventListener("click",d),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",d),s.addEventListener("click",f=>{f.target===s&&d()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const f=a?"pending":"done";await y.from("tasks").update({status:f}).eq("id",e.id);const u=z.find(b=>String(b.id)===String(e.id));u&&(u.status=f),d(),f==="done"&&(re="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),ue()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var v,E;const f=document.getElementById("tarefa-form");if(!f.checkValidity()){f.reportValidity();return}const u=new FormData(f),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const h={title:(v=u.get("title"))==null?void 0:v.trim(),description:((E=u.get("description"))==null?void 0:E.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null};let x;if(n){if({error:x}=await y.from("tasks").update(h).eq("id",e.id),!x){const B=z.findIndex(k=>String(k.id)===String(e.id));B>=0&&(z[B]={...z[B],...h})}}else{const{data:B,error:k}=await y.from("tasks").insert(h).select();x=k,!x&&(B!=null&&B[0])&&z.unshift(B[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}d(),ue()})}async function ta(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;g==null||g.role,g==null||g.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(s=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(s=document.getElementById("notif-see-all"))==null||s.addEventListener("click",d=>{d.preventDefault(),F(),ne("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{X.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(X)),d.classList.remove("unread"),F(),ne("contatos")})})}function na(){var e;document.querySelectorAll(".notif-item").forEach(t=>X.push(t.dataset.id)),X=[...new Set(X)],localStorage.setItem("crm_notifs_read",JSON.stringify(X)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function oa(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function ia(){let e=y.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);g!=null&&g.tenant_id&&(e=e.eq("tenant_id",g.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!X.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let D=[],M=1;const xe=10;let pt=!1;async function sa(){var t,n,a,o,i,s,d,l,r;document.getElementById("section-contatos")&&(pt||(pt=!0,await Bt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{M=1,oe()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",c=>{c.key==="Enter"&&(M=1,oe())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>$t()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",ra),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",Ye),(s=document.getElementById("import-modal-cancel"))==null||s.addEventListener("click",Ye),(d=document.getElementById("download-template"))==null||d.addEventListener("click",c=>{c.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,f=new Blob([m],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(f),u.download="modelo_contatos.csv",u.click()}),(l=document.getElementById("import-csv-file"))==null||l.addEventListener("change",la),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",da)))}async function Bt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(g==null?void 0:g.role)==="corretor"?t=t.eq("assigned_to",g.id):g!=null&&g.tenant_id&&(t=t.eq("tenant_id",g.tenant_id));const{data:a}=await t;D=a||[],oe()}function oe(){var d,l,r;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?D.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):D,n=t.length,a=Math.max(1,Math.ceil(n/xe));M>a&&(M=a);const o=t.slice((M-1)*xe,M*xe),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
      <tr>
  ...
  `,document.body.appendChild(h);const x=()=>h.remove();(E=document.getElementById("cm-close"))==null||E.addEventListener("click",x),(B=document.getElementById("cm-cancel"))==null||B.addEventListener("click",x),h.addEventListener("click",w=>{w.target===h&&x()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",w=>{const I=document.getElementById("cm-stage");I&&(I.innerHTML=b(w.target.value))}),(S=document.getElementById("cm-delete"))==null||S.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await y.from("leads").delete().eq("id",e.id);const w=D.findIndex(I=>String(I.id)===String(e.id));w>=0&&D.splice(w,1),x(),oe()}),($=document.getElementById("cm-save"))==null||$.addEventListener("click",async()=>{var G,V,W,ve,fe,ye,be;const w=document.getElementById("contato-form");if(!w.checkValidity()){w.reportValidity();return}const I=new FormData(w),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const C=I.getAll("tag"),T=I.get("pipeline_id")||null,N={name:(G=I.get("name"))==null?void 0:G.trim(),company:((V=I.get("company"))==null?void 0:V.trim())||null,email:((W=I.get("email"))==null?void 0:W.trim())||null,phone:((ve=I.get("phone"))==null?void 0:ve.trim())||null,job_title:((fe=I.get("job_title"))==null?void 0:fe.trim())||null,city_interest:((ye=I.get("city_interest"))==null?void 0:ye.trim())||null,notes:((be=I.get("notes"))==null?void 0:be.trim())||null,pipeline_id:T,stage:I.get("stage")||null,status:I.get("status")||null,tags:C,assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await y.from("leads").update(N).eq("id",e.id),!A){const R=D.findIndex(se=>String(se.id)===String(e.id));R>=0&&(D[R]={...D[R],...N})}}else{const{data:R,error:se}=await y.from("leads").insert(N).select();A=se,!A&&(R!=null&&R[0])&&D.unshift(R[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}x(),oe()})}let me=[];function la(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{me=a.target.result.split(`
`).filter(d=>d.trim()).slice(1).map(d=>{const[l,r,c,m,f]=d.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:l,email:r,phone:c,company:m,job_title:f}}).filter(d=>d.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${me.length} contato(s) encontrados para importar.`);const s=document.getElementById("import-modal-confirm");s&&(s.disabled=me.length===0)},n.readAsText(t)}async function da(){if(!me.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=me.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(g==null?void 0:g.id)||null,tenant_id:(g==null?void 0:g.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Ye(),await Bt(),alert(`${t.length} contato(s) importados com sucesso!`)}function ra(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),me=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Ye(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ca="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ge(e){return(await fetch(ca,{method:"POST",headers:{Authorization:`Bearer ${qt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function ut(e){var l,r,c,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),s=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:f}}=await y.auth.getUser();n.value=(f==null?void 0:f.email)||""}const d=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=d),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",f=>{const u=f.target.files[0];if(!u)return;const b=URL.createObjectURL(u);a&&(a.src=b,a.style.display=""),o&&(o.style.display="none")}),(l=document.getElementById("btn-change-password"))==null||l.addEventListener("click",async()=>{var v,E;const f=((v=document.getElementById("change-password-new"))==null?void 0:v.value)||"",u=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",b=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(b&&(b.style.display="none"),f.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}if(f!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:x}=await y.auth.updateUser({password:f});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),x?b&&(b.textContent="Erro: "+x.message,b.style.display=""):(b&&(b.style.color="#16a34a",b.textContent="Senha alterada com sucesso!",b.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),s==null||s.addEventListener("click",async()=>{var E;const f=t.value.trim();let u=(g==null?void 0:g.avatar_url)||"";const b=i==null?void 0:i.files[0],h=s.textContent;if(s.disabled=!0,s.textContent="Salvando…",b)try{const B=await Se(b,400,.85),k=`avatars/${g.id}-${Date.now()}.jpg`,{error:S}=await y.storage.from("imoveis").upload(k,B,{contentType:"image/jpeg",upsert:!0});if(!S){const{data:{publicUrl:$}}=y.storage.from("imoveis").getPublicUrl(k);u=$}}catch(B){console.error("Avatar upload:",B)}const{error:x}=await y.from("profiles").update({name:f,avatar_url:u}).eq("id",g.id);if(s.disabled=!1,s.textContent=h,x){alert("Erro ao salvar perfil.");return}g={...g,name:f,avatar_url:u},Me(g);const v=document.getElementById("settings-avatar-initial");v&&(v.textContent=((E=f[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const f=document.getElementById("settings-corretores-section");f&&(f.style.display=""),await je(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var E,B;const b=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),h=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),x=document.getElementById("btn-invite-corretor"),v=document.getElementById("invite-note");if(!b){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),v&&(v.style.display="none");try{const k=await ge({email:b,password:h,tenant_id:(g==null?void 0:g.tenant_id)||null});if(k.success){const S=document.getElementById("invite-email"),$=document.getElementById("invite-password");S&&(S.value=""),$&&($.value=""),await je(),v&&(k.email_sent===!1?(v.innerHTML=`
                ✅ Acesso criado!
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${p(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const s=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${s}" e todos os bairros vinculados?`))return;const{error:d}=await y.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await Ee(),at()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:s}=await y.from("locations").delete().eq("id",i.dataset.id);if(s){alert("Erro ao excluir.");return}await Ee()})})}function gt(){var n,a,o,i,s,d,l,r,c,m,f,u,b,h,x,v,E,B,k,S;document.querySelectorAll(".filter-btn").forEach($=>{$.addEventListener("click",()=>{const w=$.closest(".filter-btns"),I=$.classList.contains("active");w.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),I||$.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var C;const $=(C=document.getElementById("f-city"))==null?void 0:C.value,w=ie().find(T=>T.name===$),I=w?tt(w.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+I.map(T=>`<option value="${T.name}">${p(T.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Le(Ze(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const $=document.querySelector(".admin-filter-panel");if($){$.querySelectorAll('input[type="text"], input[type="number"]').forEach(I=>{I.value=""}),$.querySelectorAll("select").forEach(I=>{I.selectedIndex=0});const w=document.getElementById("f-neighborhood");w&&(w.innerHTML='<option value="">Todos</option>'),$.querySelectorAll(".filter-btn.active").forEach(I=>I.classList.remove("active"))}Le(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach($=>{$.addEventListener("click",()=>{ne($.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach($=>{$.addEventListener("click",()=>{ne($.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach($=>{$.addEventListener("click",w=>{w.stopPropagation();const I=$.closest(".topnav-dropdown");I==null||I.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==I&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach($=>$.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ce),(s=document.getElementById("modal-cancel"))==null||s.addEventListener("click",Ce),(d=document.getElementById("property-modal"))==null||d.addEventListener("click",$=>{$.target.id==="property-modal"&&Ce()}),(l=document.getElementById("btn-new-property"))==null||l.addEventListener("click",()=>{j=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",te="",Ae([]),Xe("Novo Imóvel")}),(r=document.getElementById("logout-btn"))==null||r.addEventListener("click",async()=>{await y.auth.signOut(),location.reload()}),(c=document.getElementById("view-prev"))==null||c.addEventListener("click",()=>{O=(O-1+Y.length)%Y.length,qe()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{O=(O+1)%Y.length,qe()}),(f=document.getElementById("view-modal-close"))==null||f.addEventListener("click",_e),(u=document.getElementById("view-modal-close2"))==null||u.addEventListener("click",_e),(b=document.getElementById("view-modal"))==null||b.addEventListener("click",$=>{$.target.id==="view-modal"&&_e()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const $=document.getElementById("share-panel");if(!$)return;const w=$.style.display!=="none";$.style.display=w?"none":"block"}),(x=document.getElementById("share-whatsapp"))==null||x.addEventListener("click",()=>{var L,C;const $=(L=document.getElementById("share-link-input"))==null?void 0:L.value;if(!$)return;const w=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",I=encodeURIComponent("Olha esse imóvel que encontrei: "+w+`
`+$);window.open("https://wa.me/?text="+I,"_blank")}),(v=document.getElementById("share-instagram"))==null||v.addEventListener("click",()=>{var w,I;const $=(w=document.getElementById("share-link-input"))==null?void 0:w.value;$&&((I=navigator.clipboard)==null||I.writeText($),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(E=document.getElementById("share-email"))==null||E.addEventListener("click",()=>{var C,T;const $=(C=document.getElementById("share-link-input"))==null?void 0:C.value;if(!$)return;const w=((T=document.getElementById("view-modal-title"))==null?void 0:T.textContent)||"Imóvel",I=encodeURIComponent("Imóvel: "+w),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+$);window.open("mailto:?subject="+I+"&body="+L,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var w;const $=document.getElementById("share-link-input");$&&((w=navigator.clipboard)==null||w.writeText($.value).then(()=>{const I=document.getElementById("share-copy"),L=I.textContent;I.textContent="✅ Copiado!",setTimeout(()=>{I.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var N;if((g==null?void 0:g.role)!=="admin"&&(g==null?void 0:g.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(A=>A.id===$);if(!w)return;_e(),j=w.id;const I=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",I.querySelector('[name="title"]').value=w.title||"",I.querySelector('[name="rua"]').value=w.rua||"",I.querySelector('[name="numero"]').value=w.numero||"",I.querySelector('[name="city"]').value=w.city||"",I.querySelector('[name="price"]').value=w.price||"",I.querySelector('[name="bedrooms"]').value=w.bedrooms||"",I.querySelector('[name="suites"]').value=w.suites||"",I.querySelector('[name="parking"]').value=w.parking||"",I.querySelector('[name="description"]').value=w.description||"",I.querySelector('[name="construction_status"]').value=w.construction_status||"",I.querySelector('[name="owner_name"]').value=w.owner_name||"",I.querySelector('[name="owner_phone"]').value=w.owner_phone||"",I.querySelector('[name="owner_email"]').value=w.owner_email||"",I.querySelector('[name="owner_notes"]').value=w.owner_notes||"",I.querySelector('[name="condominium"]').value=w.condominium||"";const C=document.getElementById("adminPublished");C&&(C.value=w.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=w.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=w.neighborhood||"")},50)),te=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Ae(w.images||[]),Xe("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach(I=>I.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(I=>I.classList.add("hidden")),(w=document.getElementById(`tab-${$.dataset.tab}`))==null||w.classList.remove("hidden")})}),(S=document.getElementById("admin-properties"))==null||S.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const w=$.target.closest("tr");if(!w)return;const I=Number(w.dataset.id);if(!I)return;const L=_.find(C=>C.id===I);L&&Vt(L)})}document.addEventListener("DOMContentLoaded",async()=>{var s,d,l;const e=window.location.hostname;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:r}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();r!=null&&r.id&&Re(r.id)}await Promise.all([Ct(),kt()]),le=ee("company.whatsapp",le),Ie=`https://wa.me/${le}`,Qe(),Pt(),Ft();const t=document.getElementById("adminCitySelect"),n=document.getElementById("adminNeighborhood");t&&n&&(at(),t.addEventListener("change",()=>{const r=ie().find(m=>m.name===t.value),c=r?tt(r.id):[];n.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${p(m.name)}</option>`).join("")}));const a=document.getElementById("admin-login"),o=document.getElementById("admin-root");if(a){const r=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=r.get("type")||c.get("type")||"",f=xt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),u=document.getElementById("password-reset-overlay");if(f){a.style.display="none",o&&o.classList.add("hidden"),u&&(u.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async h=>{var S,$;h.preventDefault();const x=((S=document.getElementById("new-password"))==null?void 0:S.value)||"",v=(($=document.getElementById("confirm-password"))==null?void 0:$.value)||"",E=document.getElementById("password-reset-msg"),B=h.target.querySelector('button[type="submit"]');if(E&&(E.style.display="none"),x!==v){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:k}=await y.auth.updateUser({password:x});if(k){E&&(E.textContent="Erro: "+k.message,E.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await y.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:b}}=await y.auth.getSession();if(b){if(a.classList.add("hidden"),o&&o.classList.remove("hidden"),Fe(),gt(),rt(),window.lucide&&lucide.createIcons(),g=await lt(b.user.id),!g){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden");return}if(g.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(g.needs_password_reset){a.style.display="none",o&&o.classList.add("hidden");const h=document.getElementById("password-reset-overlay");h&&(h.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async x=>{var $,w;x.preventDefault();const v=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",E=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",B=document.getElementById("password-reset-msg"),k=x.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),v!==E){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}if(v.length<6){B&&(B.textContent="Mínimo 6 caracteres.",B.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:S}=await y.auth.updateUser({password:v});if(S){B&&(B.textContent="Erro: "+S.message,B.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",g.id),window.location.href=window.location.pathname});return}Re((g==null?void 0:g.tenant_id)||null),Me(g),dt(g.role),await Te(),await ut(g),window.lucide&&lucide.createIcons(),ia()}else{o&&o.classList.add("hidden"),a.classList.remove("hidden");const h=document.getElementById("login-form");h&&((l=document.getElementById("forgot-password-btn"))==null||l.addEventListener("click",async()=>{var E,B;const x=(B=(E=h.querySelector('input[name="email"]'))==null?void 0:E.value)==null?void 0:B.trim();if(!x){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:v}=await y.auth.resetPasswordForEmail(x,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(v?"Erro: "+v.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),h.addEventListener("submit",async x=>{x.preventDefault();const v=new FormData(h),E=v.get("email"),B=v.get("password");if(await Rt(E,B)){a.classList.add("hidden"),o&&o.classList.remove("hidden"),Fe(),gt(),window.lucide&&lucide.createIcons();const{data:{session:S}}=await y.auth.getSession();if(g=S?await lt(S.user.id):null,!g){await y.auth.signOut();return}if(g.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}rt(),Re((g==null?void 0:g.tenant_id)||null),Me(g),dt(g.role),await Te(),await ut(g),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else Fe();await ke();const i=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Tt(i),At(le)});async function ma(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:s}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!s){const d=_.findIndex(l=>l.id===o.id);d>=0&&(_[d].reference=i),n++}}Le(Ze(_))}async function pa(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const s=await ua(i);a.push(s),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(s=>s.id===t.id);i>=0&&(_[i].images=a)}}Le(Ze(_))}}async function ua(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,s=i?URL.createObjectURL(i):null;return new Promise(d=>{const l=new Image;l.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),c=1200;let m=l.width,f=l.height;m>c&&(f=Math.round(f*c/m),m=c),r.width=m,r.height=f;const u=r.getContext("2d");u.drawImage(l,0,0,m,f);const b=h=>{if(h){const x=Math.round(m*.18),v=Math.round(h.naturalHeight*x/h.naturalWidth),E=Math.round(m*.02);u.globalAlpha=.45,u.drawImage(h,m-x-E,f-v-E,x,v),u.globalAlpha=1}r.toBlob(async x=>{try{const v=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:E}=await y.storage.from("imoveis").upload(v,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(E){console.error("Upload watermark error:",E),d(e);return}const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(v);d(B)}catch(v){console.error("Watermark upload exception:",v),d(e)}},"image/jpeg",.82)};if(s){const h=new Image;h.onload=()=>{URL.revokeObjectURL(s),b(h)},h.onerror=()=>{URL.revokeObjectURL(s),b(null)},h.src=s}else b(null)},l.onerror=()=>{URL.revokeObjectURL(a),d(e)},l.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function P(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function nt(e,t="assets"){const n=await Se(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function ga(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",H()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>p(String(n[o]||""));e.innerHTML=`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(r=>{r.addEventListener("click",async c=>{c.stopPropagation();const m=r.dataset.active==="true";await y.from("tenants").update({active:!m}).eq("id",r.dataset.id),Q()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(r=>{r.addEventListener("click",()=>{const c=(i||[]).find(m=>String(m.id)===String(r.dataset.id));c&&$a(c)})})}async function Ea(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:r})=>{const c=document.getElementById("nt-plan");c&&r&&(c.innerHTML='<option value="">Sem plano</option>'+r.map(m=>`<option value="${m.id}">${p(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const c=document.getElementById("nt-slug");c&&!c.dataset.manual&&(c.value=Ia(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(s=document.getElementById("sa-modal-close-btn"))==null||s.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(l=document.getElementById("nt-save"))==null||l.addEventListener("click",async()=>{var S,$,w,I,L,C,T,N,A,G,V,W;const r=($=(S=document.getElementById("nt-name"))==null?void 0:S.value)==null?void 0:$.trim(),c=(I=(w=document.getElementById("nt-slug"))==null?void 0:w.value)==null?void 0:I.trim(),m=(C=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:C.trim(),f=(T=document.getElementById("nt-plan"))==null?void 0:T.value,u=(A=(N=document.getElementById("nt-admin-email"))==null?void 0:N.value)==null?void 0:A.trim(),b=(V=(G=document.getElementById("nt-admin-password"))==null?void 0:G.value)==null?void 0:V.trim(),h=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!r||!c){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!b||b.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:v,error:E}=await y.from("tenants").insert({name:r,slug:c,domain:m||null,plan_id:f||null,active:!0}).select();if(E){x.disabled=!1,x.textContent="Criar Imobiliária",h.textContent="❌ "+E.message,h.style.color="#ef4444";return}const B=(W=v==null?void 0:v[0])==null?void 0:W.id;h.textContent="⏳ Criando usuário admin…";const k=await ge({email:u,password:b,role:"admin",tenant_id:B});if(!(k!=null&&k.success)){x.disabled=!1,x.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+p((k==null?void 0:k.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),Q()},3e3);return}B&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await y.from("profiles").update({tenant_id:B}).eq("id",k.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",k.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Lt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",bt(e,o.dataset.tab)})}),bt(e,"properties")}async function bt(e,t){var a,o,i;const n=document.getElementById("tp-content");if(n){if(n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;font-size:14px;">Carregando…</div>',t==="properties"){const{data:s}=await y.from("properties").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1});if(!(s!=null&&s.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">🏠</div><p style="font-size:14px;">Nenhum imóvel cadastrado ainda.</p></div>';return}n.innerHTML=`
      ...
      </div>`,(i=document.getElementById("tp-open-edit"))==null||i.addEventListener("click",()=>Lt(e))}}}function Lt(e){var r,c,m,f,u,b,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([v,E,B])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:v})=>{const E=document.getElementById("et-plan");E&&v&&(E.innerHTML='<option value="">Sem plano</option>'+v.map(B=>`<option value="${B.id}"${String(B.id)===String(e.plan_id)?" selected":""}>${p(B.name)}</option>`).join(""))}),(r=document.getElementById("et-logo-input"))==null||r.addEventListener("change",v=>{const E=v.target.files[0];if(!E)return;const B=URL.createObjectURL(E),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${B}" style="width:100%;height:100%;object-fit:cover;">`)}),(c=document.getElementById("et-logo-preview"))==null||c.addEventListener("click",()=>{var v;(v=document.getElementById("et-logo-input"))==null||v.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const v=document.getElementById("et-admin-password");v.type=v.type==="password"?"text":"password"}),(f=document.getElementById("et-copy-key"))==null||f.addEventListener("click",()=>{var k,S;const v=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!v)return;(S=navigator.clipboard)==null||S.writeText(v);const E=document.getElementById("et-copy-key"),B=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=B},2e3)});const o=["dados","config","api"];function i(v){o.forEach(E=>{document.getElementById(`et-pane-${E}`).style.display=E===v?"":"none";const B=document.getElementById(`et-tab-${E}`);B.style.borderBottomColor=E===v?"#2563eb":"transparent",B.style.color=E===v?"#2563eb":"#64748b",B.style.fontWeight=E===v?"600":"500"}),v==="config"&&d()}o.forEach(v=>{var E;return(E=document.getElementById(`et-tab-${v}`))==null?void 0:E.addEventListener("click",()=>i(v))});let s=!1;async function d(){var B;if(s)return;s=!0;const{data:v}=await y.from("settings").select("key,value").eq("tenant_id",e.id),E={};v==null||v.forEach(k=>{E[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(B=document.getElementById("et-cfg-save"))==null||B.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),S=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",S.textContent="",S.style.color="#64748b";const $=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),w=document.getElementById("et-cfg-phone").value.trim(),I=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),C=document.getElementById("et-cfg-slogan").value.trim(),{error:T}=await y.from("settings").upsert([{key:"company.whatsapp",value:$,tenant_id:e.id},{key:"company.phone",value:w,tenant_id:e.id},{key:"company.email",value:I,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:C,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",T?(S.textContent="❌ "+T.message,S.style.color="#ef4444"):(S.textContent="✅ Configurações salvas!",S.style.color="#22c55e")})}const l=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",l),(b=document.getElementById("et-cancel"))==null||b.addEventListener("click",l),n.addEventListener("click",v=>{v.target===n&&l()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:B}=await y.from("tenants").delete().eq("id",e.id);if(B){alert("Erro ao excluir: "+B.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}l(),Q()}),(x=document.getElementById("et-save"))==null||x.addEventListener("click",async()=>{var N,A,G,V,W,ve,fe,ye,be,R,se,ot;const v=(A=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:A.trim(),E=(V=(G=document.getElementById("et-slug"))==null?void 0:G.value)==null?void 0:V.trim(),B=(ve=(W=document.getElementById("et-domain"))==null?void 0:W.value)==null?void 0:ve.trim(),k=(fe=document.getElementById("et-plan"))==null?void 0:fe.value,S=(be=(ye=document.getElementById("et-admin-email"))==null?void 0:ye.value)==null?void 0:be.trim(),$=(se=(R=document.getElementById("et-admin-password"))==null?void 0:R.value)==null?void 0:se.trim(),w=(ot=document.getElementById("et-logo-input"))==null?void 0:ot.files[0],I=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!v){I.textContent="❌ Nome é obrigatório.",I.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",I.textContent="⏳ Salvando…",I.style.color="#64748b";let C=e.logo_url;if(w)try{const q=await Se(w,256,.85),it=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:St}=await y.storage.from("imoveis").upload(it,q,{contentType:"image/jpeg",upsert:!0});if(!St){const{data:{publicUrl:_t}}=y.storage.from("imoveis").getPublicUrl(it);C=_t}}catch(q){console.error("Logo upload:",q)}const{error:T}=await y.from("tenants").update({name:v,slug:E||e.slug,domain:B||null,plan_id:k||null,logo_url:C}).eq("id",e.id);if(T){L.disabled=!1,L.textContent="Salvar",I.textContent="❌ "+T.message,I.style.color="#ef4444";return}if(S&&$&&$.length>=6){I.textContent="⏳ Criando usuário admin…";const q=await ge({email:S,password:$,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),I.textContent="✅ Salvo e admin criado!",I.style.color="#22c55e"):(I.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),I.style.color="#f59e0b")}else I.textContent="✅ Imobiliária atualizada!",I.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{l(),Q()},1200)})}
