import{s as b}from"./supabase-BcuJ3xoD.js";const ve="00000000-0000-0000-0000-000000000000";let Be={},Ue={},he=ve;function ue(e){he=e||ve,Be={},Ue={}}const z=()=>he;async function qt(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",he),b.from("site_content").select("*").eq("tenant_id",he)]);e.data&&e.data.forEach(n=>{Be[n.key]=n.value}),t.data&&t.data.forEach(n=>{Ue[n.key]=n})}const F=(e,t=null)=>Be[e]!==void 0?Be[e]:t,Oe=(e,t="pt")=>{const n=Ue[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function ye(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:he,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{Be[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:he,updated_at:new Date().toISOString()},{error:i}=await b.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(Ue[e]=o),!i}async function Pe(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function tt(){const e=document.documentElement,t=F("visual.accent_color","#b8962e"),n=F("visual.primary_bg","#0f1c2e"),a=F("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=F("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=F("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=F("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero");s&&(s.style.backgroundImage=`url('${l}')`)}}function Mt(e="pt"){const t=y=>Oe(y,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n-num="inst.stat2num"]'),p=document.querySelector('[data-i18n="inst.stat1"]'),c=document.querySelector('[data-i18n="inst.stat2"]'),r=document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat2_num")&&(s.innerHTML=t("inst.stat2_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),c&&t("inst.stat2_label")&&(c.innerHTML=t("inst.stat2_label")),r&&t("inst.stat3_label")&&(r.innerHTML=t("inst.stat3_label"));const m=Oe("seo.title_pt",e);m&&document.title&&(document.title=m);const u=Oe("seo.description_pt",e);if(u){const y=document.querySelector('meta[name="description"]');y&&(y.content=u)}}function zt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Nt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let oe="5547999701743";const te=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],jt=5.7;function se(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/jt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],v=null,Le=[],wt=!1;b.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(wt=!0)});function Xe(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Te(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function It({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:c,error:r}=await b.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return r&&console.error("Supabase select error:",r),c||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=z();if(!o||o===ve){const c=Te(a);if(c)o=c,ue(o);else{const r=t.replace(/^www\./,"");for(const m of[r,"www."+r]){const{data:u}=await b.from("tenants").select("id").eq("domain",m).maybeSingle();if(u!=null&&u.id){o=u.id,ue(o);break}}o&&o!==ve&&Xe(a,o,24*60*60*1e3)}}if(!o||o===ve)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const c=Te(i);if(c)return setTimeout(()=>It({background:!0}),100),c}const{data:l,error:s}=await b.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),Te(i)||[];const p=l||[];return Xe(i,p,d),e&&typeof le=="function"&&le().catch(()=>{}),p}async function Rt(){let e=b.from("properties").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="super_admin"||(v!=null&&v.tenant_id?e=e.eq("tenant_id",v.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ua(),ga(),_)}async function Ht(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await b.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await b.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Ut(e){const{error:t}=await b.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Ot(e,t){const{error:n}=await b.auth.signInWithPassword({email:e,password:t});return!n}function _e(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,p=i.height;s>t&&(p=Math.round(p*t/s),s=t),l.width=s,l.height=p;const c=l.getContext("2d");c.drawImage(i,0,0,s,p);const r=new Image;r.crossOrigin="anonymous",r.onload=()=>{const m=Math.round(s*.18),u=Math.round(r.naturalHeight*m/r.naturalWidth),y=Math.round(s*.02),h=s-m-y,x=p-u-y;c.globalAlpha=.45,c.drawImage(r,h,x,m,u),c.globalAlpha=1,l.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},r.onerror=()=>{l.toBlob(m=>m?a(m):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},r.src="/logo.png"},i.onerror=o,i.src=d})}async function Dt(e){const t=await _e(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await b.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=b.storage.from("imoveis").getPublicUrl(n);return o}async function Pt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Dt(n[o]));return a}async function le(){var r,m,u,y,h,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await It();_=n,((r=document.getElementById("selecao-carousel"))==null?void 0:r.innerHTML)===""&&Ft(n);const a=((m=document.getElementById("city-filter"))==null?void 0:m.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((y=document.getElementById("bedrooms-filter"))==null?void 0:y.value)||"",d=((h=document.getElementById("parking-filter"))==null?void 0:h.value)||"",l=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",{min:s,max:p}=Xt(),c=n.filter(f=>{if(a&&f.city!==a||o&&f.neighborhood!==o||i&&(i==="4+"&&Number(f.bedrooms)<4||i!=="4+"&&Number(f.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(f.parking)<4||d!=="4+"&&Number(f.parking)!==Number(d))||l&&f.construction_status!==l)return!1;const w=String(f.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),k=parseInt(w,10)||0;return!(k<s||p!==1/0&&k>p)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(f=>{var L;const w=f.cover_image||((L=f.images)==null?void 0:L[0])||te[0],k=[f.neighborhood,f.city].filter(Boolean).join(", "),B=encodeURIComponent(`Olá! Tenho interesse no imóvel *${f.title}*${f.reference?` (Ref: ${f.reference})`:""}. Poderia me dar mais informações?`);return`
        <div class="selecao-card">
          <div class="img-wm-wrap"><img src="${w}" alt="${g(f.title)}" class="selecao-card-img"></div>
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-actions">
              ...
              <a href="https://wa.me/${oe}?text=${B}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(f=>{var L;const w=(L=f.images)!=null&&L.length?f.images:te,k=w.length,B=encodeURIComponent(`Olá! Tenho interesse no imóvel *${f.title}*${f.reference?` (Ref: ${f.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${k}" data-idx="0" data-pid="${f.id}">
        ...
        <div class="property-info">
          ...
          <div class="muted">🛏️ ${f.bedrooms||"--"} | 🚗 ${f.parking||"--"} ${k>1?"| 📸 "+k:""}</div>
          ...
          <div style="display:flex;gap:8px;margin-top:6px">
            ...
            <a class="btn hero-whatsapp-btn" href="https://wa.me/${oe}?text=${B}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(f=>{f.removeEventListener("click",rt),f.addEventListener("click",rt)})}function Ft(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var r;const s=l.cover_image||((r=l.images)==null?void 0:r[0])||te[0],p=[l.neighborhood,l.city].filter(Boolean).join(", "),c=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="selecao-card">
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=kt(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
...
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,p,c,r,m]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:s,email:p,phone:c,company:r,job_title:m}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${be.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=be.length===0)},n.readAsText(t)}async function ca(){if(!be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Qe(),await Lt(),alert(`${t.length} contato(s) importados com sucesso!`)}function ma(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Qe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const pa="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ce(e){return(await fetch(pa,{method:"POST",headers:{Authorization:`Bearer ${Nt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function yt(e){var s,p,c,r;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await b.auth.getUser();n.value=(m==null?void 0:m.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const y=URL.createObjectURL(u);a&&(a.src=y,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var f,w;const m=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",u=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",y=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(y&&(y.style.display="none"),m.length<6){y&&(y.textContent="Mínimo 6 caracteres.",y.style.display="");return}if(m!==u){y&&(y.textContent="As senhas não coincidem.",y.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:x}=await b.auth.updateUser({password:m});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),x?y&&(y.textContent="Erro: "+x.message,y.style.display=""):(y&&(y.style.color="#16a34a",y.textContent="Senha alterada com sucesso!",y.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var w;const m=t.value.trim();let u=(v==null?void 0:v.avatar_url)||"";const y=i==null?void 0:i.files[0],h=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",y)try{const k=await _e(y,400,.85),B=`avatars/${v.id}-${Date.now()}.jpg`,{error:L}=await b.storage.from("imoveis").upload(B,k,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:$}}=b.storage.from("imoveis").getPublicUrl(B);u=$}}catch(k){console.error("Avatar upload:",k)}const{error:x}=await b.from("profiles").update({name:m,avatar_url:u}).eq("id",v.id);if(d.disabled=!1,d.textContent=h,x){alert("Erro ao salvar perfil.");return}v={...v,name:m,avatar_url:u},Ne(v);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((w=m[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await He(),(p=document.getElementById("btn-invite-corretor"))==null||p.addEventListener("click",async()=>{var w,k;const y=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),h=(k=document.getElementById("invite-password"))==null?void 0:k.value.trim(),x=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!y){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),f&&(f.style.display="none");try{const B=await ce({email:y,password:h,tenant_id:(v==null?void 0:v.tenant_id)||null});if(B.success){const L=document.getElementById("invite-email"),$=document.getElementById("invite-password");L&&(L.value=""),$&&($.value=""),await He(),f&&(B.email_sent===!1?(f.innerHTML=`
                ...
                <strong>Senha:</strong> ${g(h)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(B.error||"Falha desconhecida"))}catch(B){alert("Erro ao criar acesso: "+B.message)}finally{x&&(x.disabled=!1,x.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await ke(),(c=document.getElementById("loc-add-city-btn"))==null||c.addEventListener("click",async()=>{const y=document.getElementById("loc-new-city"),h=y==null?void 0:y.value.trim();if(!h)return;const{error:x}=await b.from("locations").insert({type:"cidade",name:h});if(x){alert("Erro ao adicionar cidade.");return}y&&(y.value=""),await ke(),it()}),(r=document.getElementById("loc-add-neighborhood-btn"))==null||r.addEventListener("click",async()=>{var w;const y=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),h=document.getElementById("loc-new-neighborhood"),x=h==null?void 0:h.value.trim();if(!y||!x){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await b.from("locations").insert({type:"bairro",name:x,parent_id:y});if(f){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await ke()})}}async function He(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,l=o.id===(v==null?void 0:v.id),s=o.active!==!1,p=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',c=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${g(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const d=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${d}" e todos os bairros vinculados?`))return;const{error:l}=await b.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await ke(),it()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:d}=await b.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await ke()})})}function bt(){var n,a,o,i,d,l,s,p,c,r,m,u,y,h,x,f,w,k,B,L;document.querySelectorAll(".filter-btn").forEach($=>{$.addEventListener("click",()=>{const I=$.closest(".filter-btns"),E=$.classList.contains("active");I.querySelectorAll(".filter-btn").forEach(S=>S.classList.remove("active")),E||$.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var T;const $=(T=document.getElementById("f-city"))==null?void 0:T.value,I=me().find(C=>C.name===$),E=I?ot(I.id):[],S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'+E.map(C=>`<option value="${C.name}">${g(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Se(at(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const $=document.querySelector(".admin-filter-panel");if($){$.querySelectorAll('input[type="text"], input[type="number"]').forEach(E=>{E.value=""}),$.querySelectorAll("select").forEach(E=>{E.selectedIndex=0});const I=document.getElementById("f-neighborhood");I&&(I.innerHTML='<option value="">Todos</option>'),$.querySelectorAll(".filter-btn.active").forEach(E=>E.classList.remove("active"))}Se(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach($=>{$.addEventListener("click",()=>{de($.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach($=>{$.addEventListener("click",()=>{de($.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach($=>{$.addEventListener("click",I=>{I.stopPropagation();const E=$.closest(".topnav-dropdown");E==null||E.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(S=>{S!==E&&S.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach($=>$.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ae),(d=document.getElementById("modal-cancel"))==null||d.addEventListener("click",Ae),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",$=>{$.target.id==="property-modal"&&Ae()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",ie="",Me([]),Ge("Novo Imóvel")}),(p=document.getElementById("logout-btn"))==null||p.addEventListener("click",async()=>{await b.auth.signOut(),location.reload()}),(c=document.getElementById("view-prev"))==null||c.addEventListener("click",()=>{G=(G-1+Q.length)%Q.length,ze()}),(r=document.getElementById("view-next"))==null||r.addEventListener("click",()=>{G=(G+1)%Q.length,ze()}),(m=document.getElementById("view-modal-close"))==null||m.addEventListener("click",Ce),(u=document.getElementById("view-modal-close2"))==null||u.addEventListener("click",Ce),(y=document.getElementById("view-modal"))==null||y.addEventListener("click",$=>{$.target.id==="view-modal"&&Ce()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const $=document.getElementById("share-panel");if(!$)return;const I=$.style.display!=="none";$.style.display=I?"none":"block"}),(x=document.getElementById("share-whatsapp"))==null||x.addEventListener("click",()=>{var H,U,Y;const $=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!$)return;const I=Number((U=document.getElementById("share-panel"))==null?void 0:U.dataset.pid),E=_.find(ae=>ae.id===I),S=(E==null?void 0:E.title)||((Y=document.getElementById("view-modal-title"))==null?void 0:Y.textContent)||"Imóvel",T=E!=null&&E.price?` — ${se(E.price,"pt")}`:"",C=E!=null&&E.reference?` | Ref: ${E.reference}`:"",M=[E==null?void 0:E.neighborhood,E==null?void 0:E.city].filter(Boolean).join(", "),A=M?`
📍 ${M}`:"",D=encodeURIComponent(`Olha esse imóvel que encontrei: *${S}*${T}${C}${A}

${$}`);window.open("https://wa.me/?text="+D,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var I,E;const $=(I=document.getElementById("share-link-input"))==null?void 0:I.value;$&&((E=navigator.clipboard)==null||E.writeText($),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(w=document.getElementById("share-email"))==null||w.addEventListener("click",()=>{var T,C;const $=(T=document.getElementById("share-link-input"))==null?void 0:T.value;if(!$)return;const I=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",E=encodeURIComponent("Imóvel: "+I),S=encodeURIComponent(`Olá! Segue o link do imóvel:

`+$);window.open("mailto:?subject="+E+"&body="+S,"_blank")}),(k=document.getElementById("share-copy"))==null||k.addEventListener("click",()=>{var I;const $=document.getElementById("share-link-input");$&&((I=navigator.clipboard)==null||I.writeText($.value).then(()=>{const E=document.getElementById("share-copy"),S=E.textContent;E.textContent="✅ Copiado!",setTimeout(()=>{E.textContent=S},2e3)}))}),(B=document.getElementById("view-modal-edit"))==null||B.addEventListener("click",()=>{var M;if((v==null?void 0:v.role)!=="admin"&&(v==null?void 0:v.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===$);if(!I)return;Ce(),R=I.id;const E=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",E.querySelector('[name="title"]').value=I.title||"",E.querySelector('[name="rua"]').value=I.rua||"",E.querySelector('[name="numero"]').value=I.numero||"",E.querySelector('[name="city"]').value=I.city||"",E.querySelector('[name="price"]').value=I.price||"",E.querySelector('[name="bedrooms"]').value=I.bedrooms||"",E.querySelector('[name="suites"]').value=I.suites||"",E.querySelector('[name="parking"]').value=I.parking||"",E.querySelector('[name="description"]').value=I.description||"",E.querySelector('[name="construction_status"]').value=I.construction_status||"",E.querySelector('[name="owner_name"]').value=I.owner_name||"",E.querySelector('[name="owner_phone"]').value=I.owner_phone||"",E.querySelector('[name="owner_email"]').value=I.owner_email||"",E.querySelector('[name="owner_notes"]').value=I.owner_notes||"",E.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),ie=I.cover_image||((M=I.images)==null?void 0:M[0])||"",Me(I.images||[]),Ge("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(E=>E.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(E=>E.classList.add("hidden")),(I=document.getElementById(`tab-${$.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const I=$.target.closest("tr");if(!I)return;const E=Number(I.dataset.id);if(!E)return;const S=_.find(T=>T.id===E);S&&Yt(S)})}document.addEventListener("DOMContentLoaded",async()=>{var l,s,p;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const c=`imobi_tenant_${t}`,r=Te(c);if(r)ue(r);else{let m=null;for(const u of[t,"www."+t]){const{data:y}=await b.from("tenants").select("id").eq("domain",u).maybeSingle();if(y!=null&&y.id){m=y;break}}m!=null&&m.id&&(ue(m.id),Xe(c,m.id,24*60*60*1e3))}}await Promise.all([qt(),_t()]),oe=F("company.whatsapp",oe),tt(),Gt(),Vt();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(it(),n.addEventListener("change",()=>{const c=me().find(m=>m.name===n.value),r=c?ot(c.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(m=>`<option value="${m.name}">${g(m.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const c=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),m=c.get("type")||r.get("type")||"",u=wt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||r.has("code"),y=document.getElementById("password-reset-overlay");if(u){o.style.display="none",i&&i.classList.add("hidden"),y&&(y.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async x=>{var $,I;x.preventDefault();const f=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",w=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",k=document.getElementById("password-reset-msg"),B=x.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),f!==w){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:L}=await b.auth.updateUser({password:f});if(L){k&&(k.textContent="Erro: "+L.message,k.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await b.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:h}}=await b.auth.getSession();if(h){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),bt(),ut(),window.lucide&&lucide.createIcons(),v=await ct(h.user.id),!v){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(v.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const x=document.getElementById("password-reset-overlay");x&&(x.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async f=>{var I,E;f.preventDefault();const w=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",k=((E=document.getElementById("confirm-password"))==null?void 0:E.value)||"",B=document.getElementById("password-reset-msg"),L=f.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),w!==k){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}if(w.length<6){B&&(B.textContent="Mínimo 6 caracteres.",B.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:$}=await b.auth.updateUser({password:w});if($){B&&(B.textContent="Erro: "+$.message,B.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}ue((v==null?void 0:v.tenant_id)||null),Ne(v),mt(v),pt(v.role),await qe(),await yt(v),window.lucide&&lucide.createIcons(),la()}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const x=document.getElementById("login-form");x&&((p=document.getElementById("forgot-password-btn"))==null||p.addEventListener("click",async()=>{var k,B;const f=(B=(k=x.querySelector('input[name="email"]'))==null?void 0:k.value)==null?void 0:B.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:w}=await b.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(w?"Erro: "+w.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),x.addEventListener("submit",async f=>{f.preventDefault();const w=x.querySelector('button[type="submit"]'),k=new FormData(x),B=k.get("email"),L=k.get("password");w&&(w.disabled=!0,w.textContent="Entrando…");try{if(await Ot(B,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),bt(),window.lucide&&lucide.createIcons();const{data:{session:I}}=await b.auth.getSession();if(v=I?await ct(I.user.id):null,!v){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(v.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}ut(),ue((v==null?void 0:v.tenant_id)||null),Ne(v),mt(v),pt(v.role),await qe(),await yt(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}catch($){alert("Erro ao fazer login: "+(($==null?void 0:$.message)||String($)))}finally{w&&(w.disabled=!1,w.textContent="Entrar")}}))}}else Fe();await le();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Mt(d),zt(oe),document.querySelectorAll(".nav-dropdown-btn").forEach(c=>{var m;const r=(m=c.closest(".nav-dropdown"))==null?void 0:m.querySelector(".nav-dropdown-menu");r&&c.addEventListener("click",u=>{u.stopPropagation(),r.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(y=>{y!==r&&y.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(c=>c.classList.remove("js-open"))})});async function ua(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=_.findIndex(s=>s.id===o.id);l>=0&&(_[l].reference=i),n++}}Se(at(_))}async function ga(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await fa(i);a.push(d),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(d=>d.id===t.id);i>=0&&(_[i].images=a)}}Se(at(_))}}async function fa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const p=document.createElement("canvas"),c=1200;let r=s.width,m=s.height;r>c&&(m=Math.round(m*c/r),r=c),p.width=r,p.height=m;const u=p.getContext("2d");u.drawImage(s,0,0,r,m);const y=h=>{if(h){const x=Math.round(r*.18),f=Math.round(h.naturalHeight*x/h.naturalWidth),w=Math.round(r*.02);u.globalAlpha=.45,u.drawImage(h,r-x-w,m-f-w,x,f),u.globalAlpha=1}p.toBlob(async x=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await b.storage.from("imoveis").upload(f,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),l(e);return}const{data:{publicUrl:k}}=b.storage.from("imoveis").getPublicUrl(f);l(k)}catch(f){console.error("Watermark upload exception:",f),l(e)}},"image/jpeg",.82)};if(d){const h=new Image;h.onload=()=>{URL.revokeObjectURL(d),y(h)},h.onerror=()=>{URL.revokeObjectURL(d),y(null)},h.src=d}else y(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function st(e,t="assets"){const n=await _e(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Ct(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",et(e,o.dataset.tab)})}),et(e,"properties")}function Sa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,p,c="text",r="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(p=document.getElementById("tp-open-edit"))==null||p.addEventListener("click",()=>Ct(e))}}function Ct(e){var p,c,r,m,u,y,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([f,w,k])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:f})=>{const w=document.getElementById("et-plan");w&&f&&(w.innerHTML='<option value="">Sem plano</option>'+f.map(k=>`<option value="${k.id}"${String(k.id)===String(e.plan_id)?" selected":""}>${g(k.name)}</option>`).join(""))}),(p=document.getElementById("et-logo-input"))==null||p.addEventListener("change",f=>{const w=f.target.files[0];if(!w)return;const k=URL.createObjectURL(w),B=document.getElementById("et-logo-preview");B&&(B.innerHTML=`<img src="${k}" style="width:100%;height:100%;object-fit:cover;">`)}),(c=document.getElementById("et-logo-preview"))==null||c.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(r=document.getElementById("et-pwd-toggle"))==null||r.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(m=document.getElementById("et-copy-key"))==null||m.addEventListener("click",()=>{var B,L;const f=(B=document.getElementById("et-api-key"))==null?void 0:B.value;if(!f)return;(L=navigator.clipboard)==null||L.writeText(f);const w=document.getElementById("et-copy-key"),k=w.textContent;w.textContent="✅ Copiada!",setTimeout(()=>{w.textContent=k},2e3)});const o=["dados","config","api"];function i(f){o.forEach(w=>{document.getElementById(`et-pane-${w}`).style.display=w===f?"":"none";const k=document.getElementById(`et-tab-${w}`);k.style.borderBottomColor=w===f?"#2563eb":"transparent",k.style.color=w===f?"#2563eb":"#64748b",k.style.fontWeight=w===f?"600":"500"}),f==="config"&&l()}o.forEach(f=>{var w;return(w=document.getElementById(`et-tab-${f}`))==null?void 0:w.addEventListener("click",()=>i(f))});let d=!1;async function l(){var k;if(d)return;d=!0;const{data:f}=await b.from("settings").select("key,value").eq("tenant_id",e.id),w={};f==null||f.forEach(B=>{w[B.key]=B.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(k=document.getElementById("et-cfg-save"))==null||k.addEventListener("click",async()=>{const B=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");B.disabled=!0,B.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const $=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),I=document.getElementById("et-cfg-phone").value.trim(),E=document.getElementById("et-cfg-email").value.trim(),S=document.getElementById("et-cfg-city").value.trim(),T=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await b.from("settings").upsert([{key:"company.whatsapp",value:$,tenant_id:e.id},{key:"company.phone",value:I,tenant_id:e.id},{key:"company.email",value:E,tenant_id:e.id},{key:"company.city",value:S,tenant_id:e.id},{key:"company.address",value:S,tenant_id:e.id},{key:"company.slogan",value:T,tenant_id:e.id}],{onConflict:"tenant_id,key"});B.disabled=!1,B.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const s=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",s),(y=document.getElementById("et-cancel"))==null||y.addEventListener("click",s),n.addEventListener("click",f=>{f.target===n&&s()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const w=document.getElementById("et-delete");w.disabled=!0,w.textContent="Excluindo…";const{error:k}=await b.from("tenants").delete().eq("id",e.id);if(k){alert("Erro ao excluir: "+k.message),w.disabled=!1,w.textContent="🗑️ Excluir";return}s(),ee()}),(x=document.getElementById("et-save"))==null||x.addEventListener("click",async()=>{var M,A,D,H,U,Y,ae,Ee,we,O,pe,lt;const f=(A=(M=document.getElementById("et-name"))==null?void 0:M.value)==null?void 0:A.trim(),w=(H=(D=document.getElementById("et-slug"))==null?void 0:D.value)==null?void 0:H.trim(),k=(Y=(U=document.getElementById("et-domain"))==null?void 0:U.value)==null?void 0:Y.trim(),B=(ae=document.getElementById("et-plan"))==null?void 0:ae.value,L=(we=(Ee=document.getElementById("et-admin-email"))==null?void 0:Ee.value)==null?void 0:we.trim(),$=(pe=(O=document.getElementById("et-admin-password"))==null?void 0:O.value)==null?void 0:pe.trim(),I=(lt=document.getElementById("et-logo-input"))==null?void 0:lt.files[0],E=document.getElementById("et-msg"),S=document.getElementById("et-save");if(!f){E.textContent="❌ Nome é obrigatório.",E.style.color="#ef4444";return}S.disabled=!0,S.textContent="Salvando…",E.textContent="⏳ Salvando…",E.style.color="#64748b";let T=e.logo_url;if(I)try{const q=await _e(I,256,.85),dt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Tt}=await b.storage.from("imoveis").upload(dt,q,{contentType:"image/jpeg",upsert:!0});if(!Tt){const{data:{publicUrl:At}}=b.storage.from("imoveis").getPublicUrl(dt);T=At}}catch(q){console.error("Logo upload:",q)}const{error:C}=await b.from("tenants").update({name:f,slug:w||e.slug,domain:k||null,plan_id:B||null,logo_url:T}).eq("id",e.id);if(C){S.disabled=!1,S.textContent="Salvar",E.textContent="❌ "+C.message,E.style.color="#ef4444";return}if(L&&$&&$.length>=6){E.textContent="⏳ Criando usuário admin…";const q=await ce({email:L,password:$,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),E.textContent="✅ Salvo e admin criado!",E.style.color="#22c55e"):(E.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),E.style.color="#f59e0b")}else E.textContent="✅ Imobiliária atualizada!",E.style.color="#22c55e";S.disabled=!1,S.textContent="Salvar",setTimeout(()=>{s(),ee()},1200)})}function _a(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ca)}function Ca(){const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
