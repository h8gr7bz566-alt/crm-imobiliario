import{s as h}from"./supabase-BcuJ3xoD.js";const K="00000000-0000-0000-0000-000000000000";let fe={},Se={},pe=K;function ke(e){pe=e||K,fe={},Se={}}const M=()=>pe;async function _a(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",pe),h.from("site_content").select("*").eq("tenant_id",pe)]);if(e.data&&e.data.forEach(n=>{fe[n.key]=n.value}),t.data&&t.data.forEach(n=>{Se[n.key]=n}),(!t.data||t.data.length===0)&&pe!==K){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",K),h.from("site_content").select("*").eq("tenant_id",K)]);n.data&&n.data.forEach(o=>{fe[o.key]===void 0&&(fe[o.key]=o.value)}),a.data&&a.data.forEach(o=>{Se[o.key]||(Se[o.key]=o)})}}const ee=(e,t=null)=>fe[e]!==void 0?fe[e]:t,Me=(e,t="pt")=>{const n=Se[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Le(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:pe,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{fe[o]=i}),!a}async function Ge(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:pe,updated_at:o},{error:r}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return r||(Se[e]=i),pe!==K&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:K,updated_at:o},{onConflict:"key,tenant_id"}),!r}async function nt(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function ht(){const e=document.documentElement,t=ee("visual.accent_color","#b8962e"),n=ee("visual.primary_bg","#0f1c2e"),a=ee("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=ee("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=ee("company.favicon_url","/favicon.ico"),r=document.querySelector('link[rel="shortcut icon"]');r&&(r.href=i);const l=ee("visual.hero_bg_url","");if(l){const d=document.querySelector(".hero, .hero-v2");d&&(d.style.backgroundImage="url('"+l+"')")}}function Bt(e){e=e||"pt";const t=g=>Me(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),r=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),r&&t("inst.bio_p2")&&(r.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),s=document.querySelector('[data-i18n="inst.stat3_num"]'),p=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),E=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat1_num")&&(d.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),s&&t("inst.stat3_num")&&(s.innerHTML=t("inst.stat3_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),E&&t("inst.stat3_label")&&(E.innerHTML=t("inst.stat3_label"));const w=document.getElementById("dep-grid");if(w){const g=Me("testimonials",e)||Me("testimonials","pt");if(g)try{const k=JSON.parse(g);if(Array.isArray(k)&&k.length>0){let I=function(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(m){let v=0;for(const x of m||"?")v=v*31+x.charCodeAt(0)&4294967295;return S[Math.abs(v)%S.length]};const S=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];w.innerHTML=k.map(m=>`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),r=n("casas-condominio"),l=ia(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",r.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",r,"imoveis.html?collection=casas-condominio"):""].join(""),sa(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",wt),t.addEventListener("touchend",function(d){const c=d.target.closest(".carousel-btn");c&&(d.preventDefault(),d.stopPropagation(),da(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ve(){var E,w,$,y,g,k;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Zt();q=n,((E=document.getElementById("selecao-carousel"))==null?void 0:E.innerHTML)===""&&Va(n);const a=((w=document.getElementById("city-filter"))==null?void 0:w.value)||"",o=(($=document.getElementById("neighborhood-filter"))==null?void 0:$.value)||"",i=((y=document.getElementById("bedrooms-filter"))==null?void 0:y.value)||"",r=((g=document.getElementById("parking-filter"))==null?void 0:g.value)||"",l=((k=document.getElementById("construction-filter"))==null?void 0:k.value)||"",{min:d,max:c}=Xa(),s=n.filter(S=>{if(a&&S.city!==a||o&&S.neighborhood!==o||i&&(i==="4+"&&Number(S.bedrooms)<4||i!=="4+"&&Number(S.bedrooms)!==Number(i))||r&&(r==="4+"&&Number(S.parking)<4||r!=="4+"&&Number(S.parking)!==Number(r))||l&&S.construction_status!==l)return!1;const I=String(S.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(I,10)||0;return!(L<d||c!==1/0&&L>c)});if(e){Fa(n);return}if(!s.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const p=ia(t);t.innerHTML=s.map(S=>It(S)).join(""),sa(t,p);const u=document.getElementById("properties");u&&!u._carouselDelegated&&(u._carouselDelegated=!0,u.addEventListener("click",wt))}function Va(e){var o,i,r;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>It(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",wt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(r=a==null?void 0:a.querySelector(".selecao-next"))==null||r.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ve()};function da(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const r=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(r.length&&r[a]){const l=je(r[a]),d=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");d&&(d.src=l),c&&(c.src=l)}}catch{const l=q.find(u=>String(u.id)===String(e.dataset.pid)),d=(i=l==null?void 0:l.images)!=null&&i.length?l.images:Ce,c=e.querySelector(".carousel-img"),s=e.querySelector(".carousel-img-bg"),p=d[a]?je(d[a]):"";c&&p&&(c.src=p),s&&p&&(s.src=p)}const o=e.querySelectorAll(".icard-dot");if(o.length){const r=a%o.length;o.forEach((l,d)=>l.classList.toggle("active",d===r))}}function wt(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&da(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Xa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Ga(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ve())}function Wa(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=xe();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=xe().find(i=>i.name===e.value),o=a?kt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${f(i.name)}</option>`).join(""),ve()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ve)})}function Oe(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var r;const a=n.cover_image||((r=n.images)==null?void 0:r[0])||Ce[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",s=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",p=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",E=Math.max(1,Math.min(a,6)),w=`<div class="icard-dots">${Array.from({length:E},(y,g)=>`<span class="icard-dot${g===0?" active":""}"></span>`).join("")}</div>`;return`
  ...
  `}let ce=[],ae=0;function Za(e){var p,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((p=e.images)==null?void 0:p[0])||Ce[0];document.getElementById("view-thumb-preview").src=i,ce=(u=e.images)!=null&&u.length?e.images:Ce,ae=0,Ze(),document.getElementById("view-price").textContent=Ue(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const r=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),r&&(r.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(E=>E.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(E=>E.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=d);const s=document.getElementById("share-panel");s&&(s.style.display="none",s.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ve(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ze(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ce[ae],e.alt=`Foto ${ae+1}`;const i=ce.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${ae+1} / ${ce.length}`:"",o.innerHTML=i?ce.map((r,l)=>`<img src="${r}" class="view-thumb${l===ae?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(r=>{r.addEventListener("click",()=>{ae=+r.dataset.i,Ze()})})}async function At(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function et(e){var p,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",r=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=r),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),s=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),d&&(d.textContent=r),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",s&&(s.style.display="none")):(s&&(s.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",s.style.display=""),c&&(c.style.display="none"))}async function Mt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==K,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:r}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),d=((r==null?void 0:r.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();d&&d!==l&&(t.href=`https://${d}`)}catch{}}const Xe={dashboard:()=>Mn(),empresa:()=>va(),visual:()=>ya(),"site-config":()=>ba(),"crm-config":()=>ha(),integracoes:()=>xa(),midia:()=>wa(),depoimentos:()=>fa()};function de(e){var n,a;e==="vendas"&&setTimeout(()=>la().catch(()=>{}),50),e==="perdas"&&setTimeout(()=>ca().catch(()=>{}),50),document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Xe<"u"&&Xe[e]){const o=Xe[e];Xe[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),ne(),e==="contatos"&&pn(),e==="funil"&&an(),e==="tarefas"&&on()}function zt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:wa,depoimentos:fa}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>hn(),{once:!0}),window.lucide&&lucide.createIcons()}}function ne(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function en(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(r=document.getElementById("cph-close"))==null||r.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",s=>{s.target===t&&o()}),(d=document.getElementById("cph-file"))==null||d.addEventListener("change",s=>{const p=s.target.files[0];if(!p)return;const u=URL.createObjectURL(p),E=document.getElementById("cph-preview"),w=document.getElementById("cph-initial");E&&(E.src=u,E.style.display=""),w&&(w.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var E;const s=(E=document.getElementById("cph-file"))==null?void 0:E.files[0];if(!s)return;const p=document.getElementById("cph-save"),u=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const w=await Fe(s,400,.85),$=`avatars/${b.id}-${Date.now()}.jpg`,{error:y}=await h.storage.from("imoveis").upload($,w,{contentType:"image/jpeg",upsert:!0});if(y)throw y;const{data:{publicUrl:g}}=h.storage.from("imoveis").getPublicUrl($);await h.from("profiles").update({avatar_url:g}).eq("id",b.id),b={...b,avatar_url:g},et(b),o()}catch(w){u.style.color="#ef4444",u.textContent="Erro: "+w.message,u.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function ct(e,t){var i,r,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(r=document.getElementById("ac-cancel"))==null||r.addEventListener("click",o),a.addEventListener("click",d=>{d.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var u,E,w;const d=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(E=document.getElementById("ac-password"))==null?void 0:E.value.trim(),s=document.getElementById("ac-save"),p=document.getElementById("ac-note");if(!d){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}s.disabled=!0,s.textContent="Criando…",p.style.display="none";try{const $=e||(b==null?void 0:b.tenant_id)||null,y=((w=document.getElementById("ac-role"))==null?void 0:w.value)||"corretor",g=await he({email:d,password:c,role:y,tenant_id:$});s.disabled=!1,s.textContent="+ Criar Acesso",g.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",g.email_sent===!1?(p.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${f(d)}<br><strong>Senha:</strong> ${f(c)}`,p.style.color="#0f172a"):(p.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",p.style.color="#16a34a"),p.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(g.error||"Falha desconhecida"))}catch($){s.disabled=!1,s.textContent="+ Criar Acesso",alert("Erro: "+$.message)}})}function Dt(){var i,r,l,d,c,s,p,u,E,w,$;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",y=>{var k;y.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(k=document.getElementById("notif-dropdown"))==null||k.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",y=>{y.stopPropagation(),ne(),tn()}),(r=document.getElementById("avatar-dd-change-pass"))==null||r.addEventListener("click",y=>{y.stopPropagation(),ne(),en()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",y=>{y.stopPropagation(),ne(),ct()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",y=>{y.stopPropagation(),ne(),de("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async y=>{y.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",y=>{var k;y.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((k=document.getElementById("avatar-dropdown"))==null||k.classList.add("hidden"),dn())}),(s=document.getElementById("notif-mark-all"))==null||s.addEventListener("click",()=>{rn(),ne()}),(p=document.getElementById("btn-search-open"))==null||p.addEventListener("click",()=>{var y,g;(y=document.getElementById("search-overlay"))==null||y.classList.remove("hidden"),(g=document.getElementById("search-input"))==null||g.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var y;(y=document.getElementById("search-overlay"))==null||y.classList.add("hidden")}),(E=document.getElementById("search-overlay"))==null||E.addEventListener("click",y=>{y.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(w=document.getElementById("search-input"))==null||w.addEventListener("input",y=>{clearTimeout(o),o=setTimeout(()=>sn(y.target.value.trim()),280)}),($=document.getElementById("search-input"))==null||$.addEventListener("keydown",y=>{var g;y.key==="Escape"&&((g=document.getElementById("search-overlay"))==null||g.classList.add("hidden"))}),document.addEventListener("click",ne)}let pt=!1,V=[],ue=[],Q=[],ye={},ra=[],O=null,ze=null,Z={search:"",tags:new Set,status:""};async function an(){var t;if(setTimeout(()=>{typeof jt=="function"&&jt()},100),window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||H().catch(()=>{})},3e4),pt){await Nt();return}pt=!0,await Nt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>ut()),Sn();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{O=parseInt(e.value,10),await H()})}function mt(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+ra.map(r=>`<option value="${f(r.name)}">${f(r.name)}</option>`).join(""),n.value=Z.status,n.onchange=()=>{Z.status=n.value,ie()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(r=>`<button class="kf-tag-btn${Z.tags.has(r.name)?" active":""}" data-tag="${f(r.name)}"
          style="--kf-tc:${r.color}">
          ${f(r.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.tag;Z.tags.has(l)?Z.tags.delete(l):Z.tags.add(l),mt(e),ie()})})}const o=document.getElementById("kf-search");o&&(o.value=Z.search,o.oninput=()=>{Z.search=o.value.toLowerCase(),ie()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{Z={search:"",tags:new Set,status:""},mt(e),ie()})}async function Nt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);V=t||[],ra=a||[],ye={},(n||[]).forEach(l=>{ye[l.name]=l});const o=V.map(l=>l.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};ue=i||[],mt(n||[]);const r=document.getElementById("funil-pipe-sel");if(r){const l=O;r.innerHTML=V.length?V.map(c=>`<option value="${c.id}">${f(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const d=V.find(c=>c.id===l)||V.find(c=>c.is_default)||V[0];d?(r.value=d.id,O=d.id):O=null}await H()}async function H(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1}).is("converted_at",null).is("lost_at",null);(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id)),O&&(t=t.eq("pipeline_id",O));const{data:n}=await t;Q=n||[],ie()}function ie(){try{const i=document.getElementById("leads-list-view");i&&!i.classList.contains("hidden")&&_e()}catch{}const e=document.getElementById("kanban-board");if(!e)return;const t=ue.filter(i=>i.pipeline_id===O);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=Z,a=Q.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const r=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>r.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,d,c,s;const r=i.stage||((l=t[0])==null?void 0:l.name);o[r]||(o[((d=t[0])==null?void 0:d.name)||""]=[]),(s=o[r]||o[(c=t[0])==null?void 0:c.name])==null||s.push(i)}),e.innerHTML=t.map(i=>{const r=o[i.name]||[],l=r.length?r.map(s=>{const p=(s.phone||"").replace(/\D/g,""),u=encodeURIComponent(`Olá ${s.name}! Aqui é da ${ee("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`),E=s.status==="quente"?"Quente":s.status==="frio"?"Frio":s.status==="morno"?"Morno":"Em andamento";s.interest;const w=Array.isArray(s.tags)?s.tags.length:0;return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          ...
          ${w>0||s.source?`<div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:2px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map($=>{const y=ye[$],g=(y==null?void 0:y.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${g}18;color:${g};border:1px solid ${g}44;">${f($)}</span>`}).join(""):""}
          </div>`:""}
  ...
  `;const u=typeof b<"u"&&(b==null?void 0:b.full_name)||"Não atribuído";document.getElementById("rd-lp-responsavel").textContent=u,n.querySelectorAll(".rd-leadpage-tab").forEach(y=>{y.onclick=()=>{var g;n.querySelectorAll(".rd-leadpage-tab").forEach(k=>k.classList.remove("active")),y.classList.add("active"),n.querySelectorAll(".rd-leadpage-tab-panel").forEach(k=>k.classList.remove("active")),(g=n.querySelector(`.rd-leadpage-tab-panel[data-panel="${y.dataset.tab}"]`))==null||g.classList.add("active")}});const E=document.getElementById("rd-lp-timeline"),w=[];t.notes&&w.push({author:u,text:t.notes,date:t.updated_at||t.created_at,kind:"note"}),w.push({author:"Sistema",text:`Lead criado na etapa "${t.stage||"—"}"`,date:t.created_at,kind:"system"}),E.innerHTML=w.map(y=>`
  ...
  `).join("")||'<p style="color:#94a3b8;font-size:13px">Sem histórico ainda.</p>',document.getElementById("rd-lp-mark-lost").onclick=async()=>{const y=prompt("Motivo da perda (opcional):")||"",{error:g}=await h.from("leads").update({lost_at:new Date().toISOString(),lost_reason:y}).eq("id",t.id);if(g)return alert("Erro: "+g.message);typeof R=="function"?R("Lead marcado como perda","warn"):alert("Lead marcado como perda"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-mark-won").onclick=async()=>{if(!confirm("Marcar como venda fechada?"))return;const{error:y}=await h.from("leads").update({converted_at:new Date().toISOString()}).eq("id",t.id);if(y)return alert("Erro: "+y.message);typeof R=="function"?R("🎉 Venda confirmada!","success"):alert("Venda confirmada!"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-add-task").onclick=()=>alert("Em breve: criar tarefa direto daqui"),document.getElementById("rd-lp-add-note").onclick=async()=>{const y=prompt("Nova anotação:",t.notes||"");if(y===null)return;const{error:g}=await h.from("leads").update({notes:y}).eq("id",t.id);if(g)return alert("Erro: "+g.message);t.notes=y,window.openLeadDetailPage(t.id)},window.scrollTo({top:0,behavior:"smooth"})};async function la(){const e=document.getElementById("vendas-list"),t=document.getElementById("vendas-total");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';const n=typeof M=="function"?M():null;let a=h.from("leads").select("*").not("converted_at","is",null).order("converted_at",{ascending:!1});n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a;if(i){e.innerHTML='<p style="color:#ef4444">Erro: '+f(i.message)+"</p>";return}const r=o||[];if(t&&(t.textContent=`${r.length} venda${r.length!==1?"s":""}`),!r.length){e.innerHTML=`<div class="rd-empty-card">
      ...
      <tr class="rd-leads-row" data-id="${s.id}">
        ...
        <td style="text-align:center">
          <span class="rd-leads-rating" onclick="event.stopPropagation();window.openRatingPicker?.('${s.id}', event)">
            ${[1,2,3,4,5].map(S=>`<span style="color:${$>=S?"#fbbf24":"#cbd5e1"};font-size:14px">★</span>`).join("")}
            <span style="margin-left:4px;font-size:12px;color:#64748b">${$||0}</span>
          </span>
        </td>
        <td>
          <span class="rd-leads-stage" style="background:${E}18;color:${E};border:1px solid ${E}55">${f(u.toUpperCase())}</span>
        </td>
        <td style="text-align:right">
          ${w?`<strong>${w}</strong>`:`<a class="rd-leads-add-value" onclick="event.stopPropagation();window.openLeadDetailPage?.('`+s.id+`')">Adicionar valor</a>`}
        </td>
      ...
      </tr>`}).join(""),e.querySelectorAll(".rd-leads-row").forEach(s=>{s.addEventListener("click",p=>{var u;p.target.closest("a, button, input")||(u=window.openLeadSidePanel)==null||u.call(window,s.dataset.id)})})}function Rt(e){const t=document.getElementById("kanban-board"),n=document.getElementById("leads-list-view");document.querySelectorAll(".rd-view-btn").forEach(o=>o.classList.toggle("active",o.dataset.view===e)),e==="list"?(t&&t.classList.add("hidden"),n&&n.classList.remove("hidden"),_e()):(t&&t.classList.remove("hidden"),n&&n.classList.add("hidden"));try{localStorage.setItem("imobi_funil_view",e)}catch{}}function jt(){var e,t,n,a;document.querySelectorAll(".rd-view-btn").forEach(o=>{o._wired||(o._wired=!0,o.addEventListener("click",()=>Rt(o.dataset.view)))}),(e=document.getElementById("rd-list-prev"))==null||e.addEventListener("click",()=>{X.page>1&&(X.page--,_e())}),(t=document.getElementById("rd-list-next"))==null||t.addEventListener("click",()=>{X.page++,_e()}),(n=document.getElementById("rd-list-pagesize"))==null||n.addEventListener("change",o=>{X.pageSize=parseInt(o.target.value,10)||10,X.page=1,_e()}),(a=document.getElementById("rd-list-check-all"))==null||a.addEventListener("change",o=>{document.querySelectorAll(".rd-list-check").forEach(i=>i.checked=o.target.checked)});try{localStorage.getItem("imobi_funil_view")==="list"&&Rt("list")}catch{}}typeof window<"u"&&(window._rdRenderLeadsList=_e);window.closeLeadDetailPage=function(){var t;const e=document.getElementById("section-lead-detail");e&&e.classList.add("hidden"),(t=document.getElementById("section-funil"))==null||t.classList.remove("hidden")};window.closeLeadSidePanel=function(){const e=document.getElementById("rd-lead-sidepanel"),t=document.getElementById("rd-lead-sidepanel-backdrop");e&&(e.classList.remove("open"),setTimeout(()=>e.remove(),250)),t&&(t.style.opacity="0",setTimeout(()=>t.remove(),250))};function nn(){const e=document.getElementById("kanban-board");e&&(e._kanbanListenersAttached||(e._kanbanListenersAttached=!0,e.addEventListener("click",t=>{if(t.target.closest(".kanban-add-btn")){ut();return}if(t.target.closest("button, a, input, .rd-card-info-btn, .rd-card-task-btn, .rd-card-stars, .rd-card-status, [onclick]"))return;const a=t.target.closest(".kanban-card");if(a){const o=a.dataset.id;if(typeof window.openLeadSidePanel=="function")window.openLeadSidePanel(o);else{const i=Q.find(r=>String(r.id)===String(o));i&&ut(i)}}}),e.addEventListener("dragstart",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");if(n){ze=n.dataset.id,n.classList.add("dragging");try{t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",ze)}catch{}}}),e.addEventListener("dragend",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");n&&n.classList.remove("dragging"),e.querySelectorAll(".kanban-col.drag-over").forEach(i=>i.classList.remove("drag-over"))}),e.addEventListener("dragover",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");!n||!ze||(t.preventDefault(),t.dataTransfer.dropEffect="move",e.querySelectorAll(".kanban-col.drag-over").forEach(i=>{i!==n&&i.classList.remove("drag-over")}),n.classList.add("drag-over"))}),e.addEventListener("dragleave",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");n&&(n.contains(t.relatedTarget)||n.classList.remove("drag-over"))}),e.addEventListener("drop",async t=>{var d,c;const n=(c=(d=t.target).closest)==null?void 0:c.call(d,".kanban-col");if(!n)return;t.preventDefault(),n.classList.remove("drag-over");const a=n.dataset.stage,o=ze;if(ze=null,!o||!a)return;const i=Q.find(s=>String(s.id)===String(o));if(!i||i.stage===a)return;const r=i.stage;i.stage=a,ie();const{error:l}=await h.from("leads").update({stage:a}).eq("id",o);l?(console.warn("[Kanban] erro ao mover:",l),i.stage=r,ie(),typeof R=="function"?R("Erro ao mover lead: "+l.message,"error"):alert("Erro ao mover lead. Tente de novo.")):typeof R=="function"&&R(`→ ${a}`,"success")})))}async function ut(e=null){var w,$,y;(w=document.getElementById("lead-detail-panel"))==null||w.remove();const t=!e,n=M(),{data:a}=await h.from("crm_tags").select("*").eq("tenant_id",n).order("name"),{data:o}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",n).order("sort_order"),i=e!=null&&e.pipeline_id&&(($=V.find(g=>g.id===e.pipeline_id))==null?void 0:$.id)||O;function r(g){return ue.filter(k=>k.pipeline_id===g).map(k=>`<option value="${f(k.name)}" ${(e==null?void 0:e.stage)===k.name?"selected":""}>${f(k.name)}</option>`).join("")}const l=V.map(g=>`<option value="${g.id}" ${g.id===i?"selected":""}>${f(g.name)}</option>`).join(""),d=r(i),c=((e==null?void 0:e.phone)||"").replace(/\D/g,""),s=document.createElement("div");s.id="lead-detail-panel",s.style.cssText="position:fixed;top:0;right:0;bottom:0;width:420px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,.15);z-index:1000;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;",s.innerHTML=`
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>{s.style.transform="translateX(0)"}),An(s,a||[],ye);const p=s.querySelector("#ldp-pipe"),u=s.querySelector("#ldp-stage");p&&u&&p.addEventListener("change",()=>{const g=p.value,k=ue.filter(S=>S.pipeline_id===g);u.innerHTML=k.map(S=>`<option value="${S.name}">${S.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const E=()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),250)};document.getElementById("ldp-close").addEventListener("click",E),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const g=document.getElementById("ldp-save"),k=document.getElementById("ldp-msg"),S=document.getElementById("ldp-name").value.trim();if(!S){k.style.color="#ef4444",k.textContent="Nome é obrigatório.";return}g.disabled=!0,g.textContent="Salvando…";const I=[...s.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(T=>T.dataset.tag),L=document.getElementById("ldp-pipe"),m=L?L.value:i||O,v=t?typeof qt=="function"?qt():{}:{},x={name:S,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:m||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:I,tenant_id:M(),...t?{utm_source:v.utm_source||null,utm_medium:v.utm_medium||null,utm_campaign:v.utm_campaign||null,utm_content:v.utm_content||null,utm_term:v.utm_term||null,fbclid:v.fbclid||null,gclid:v.gclid||null,fbp:v.fbp||null,fbc:v.fbc||null,landing_url:v.landing_url||null,user_agent:navigator.userAgent||null}:{}};let _;if(t?{error:_}=await h.from("leads").insert(x):{error:_}=await h.from("leads").update(x).eq("id",e.id),g.disabled=!1,g.textContent="💾 Salvar",_){k.style.color="#ef4444",k.textContent="Erro: "+_.message;return}k.style.color="#22c55e",k.textContent="✅ Salvo!",E(),H().catch(T=>console.warn("[Kanban] reload falhou:",T)),t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:x.name,email:x.email,phone:x.phone,tracking:v}).then(async T=>{if(T!=null&&T.ok){console.log("[CAPI] Lead enviado ao Meta:",T.event_id);try{await h.from("leads").update({capi_event_id:T.event_id,capi_sent_at:new Date().toISOString()}).eq("name",x.name).eq("phone",x.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(A){console.warn("[CAPI] falha ao salvar event_id:",A)}}else console.warn("[CAPI] não confirmado pelo Meta:",T)}).catch(T=>console.warn("[CAPI] erro:",T))}),(y=document.getElementById("ldp-delete"))==null||y.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await h.from("leads").delete().eq("id",e.id),E(),H())})}let F=[],Ht=!1,$e="pending";async function on(){var e;window._tarefasRefreshTimer&&clearInterval(window._tarefasRefreshTimer),window._tarefasRefreshTimer=setInterval(()=>{const t=document.querySelector('.section[data-section="tarefas"]');!t||t.offsetParent===null||Ot().catch(()=>{})},3e4),!Ht&&(Ht=!0,await Ot(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>ma()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),$e=t.dataset.filter,Te()})}))}async function Ot(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=h.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,r=a.checked?"done":"pending";await h.from("tasks").update({status:r}).eq("id",i);const l=F.find(d=>String(d.id)===i);l&&(l.status=r),Te()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await h.from("tasks").delete().eq("id",a.dataset.id),F=F.filter(i=>String(i.id)!==String(a.dataset.id)),Te())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,r=F.find(l=>String(l.id)===i);r&&ma(r)})})}function ma(e=null){var d,c,s,p;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=pa(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",r=document.createElement("div");r.id="tarefa-modal-root",r.className="modal-backdrop",r.innerHTML=`
  ...
  `,document.body.appendChild(r);const l=()=>r.remove();(d=document.getElementById("tm-close"))==null||d.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),r.addEventListener("click",u=>{u.target===r&&l()}),(s=document.getElementById("tm-toggle-done"))==null||s.addEventListener("click",async()=>{const u=a?"pending":"done";await h.from("tasks").update({status:u}).eq("id",e.id);const E=F.find(w=>String(w.id)===String(e.id));E&&(E.status=u),l(),u==="done"&&($e="done",document.querySelectorAll(".tarefa-filter-btn").forEach(w=>{w.classList.toggle("active",w.dataset.filter==="done")})),Te()}),(p=document.getElementById("tm-save"))==null||p.addEventListener("click",async()=>{var g,k;const u=document.getElementById("tarefa-form");if(!u.checkValidity()){u.reportValidity();return}const E=new FormData(u),w=document.getElementById("tm-save");w.disabled=!0,w.textContent="Salvando…";const $={title:(g=E.get("title"))==null?void 0:g.trim(),description:((k=E.get("description"))==null?void 0:k.trim())||null,due_date:E.get("due_date")||null,priority:E.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null};let y;if(n){if({error:y}=await h.from("tasks").update($).eq("id",e.id),!y){const S=F.findIndex(I=>String(I.id)===String(e.id));S>=0&&(F[S]={...F[S],...$})}}else{const{data:S,error:I}=await h.from("tasks").insert($).select();y=I,!y&&(S!=null&&S[0])&&F.unshift(S[0])}if(w.disabled=!1,w.textContent=n?"Salvar":"Criar Tarefa",y){alert("Erro: "+y.message);return}l(),Te()})}async function sn(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;b==null||b.role,b==null||b.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(r=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(r=>{r.addEventListener("click",()=>{var l;(l=document.getElementById("search-overlay"))==null||l.classList.add("hidden"),r.dataset.type==="lead"?de("contatos"):de("properties")})})}let se=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function dn(){var r;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=h.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(l=>!se.includes(String(l.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(l=>{const d=ln(l.created_at);return`
      <div class="notif-item${!se.includes(String(l.id))?" unread":""}" data-id="${l.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${f(l.name||"—")}</div>
          <div class="notif-item-sub">${f(l.phone||l.source||"")} · ${d}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(r=document.getElementById("notif-see-all"))==null||r.addEventListener("click",l=>{l.preventDefault(),ne(),de("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{se.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(se)),l.classList.remove("unread"),ne(),de("contatos")})})}function rn(){var e;document.querySelectorAll(".notif-item").forEach(t=>se.push(t.dataset.id)),se=[...new Set(se)],localStorage.setItem("crm_notifs_read",JSON.stringify(se)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function ln(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function cn(){let e=h.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!se.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let te=[],U=1;const De=10;let Pt=!1;async function pn(){var t,n,a,o,i,r,l,d,c;window._contatosRefreshTimer&&clearInterval(window._contatosRefreshTimer),window._contatosRefreshTimer=setInterval(()=>{const s=document.querySelector('.section[data-section="contatos"]');!s||s.offsetParent===null||gt().catch(()=>{})},3e4),document.getElementById("section-contatos")&&(Pt||(Pt=!0,await gt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{U=1,be()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",s=>{s.key==="Enter"&&(U=1,be())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>ua()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",gn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",ft),(r=document.getElementById("import-modal-cancel"))==null||r.addEventListener("click",ft),(l=document.getElementById("download-template"))==null||l.addEventListener("click",s=>{s.preventDefault();const p=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),E=document.createElement("a");E.href=URL.createObjectURL(u),E.download="modelo_contatos.csv",E.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",mn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",un)))}async function gt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;te=a||[],be()}function be(){var l,d,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?te.filter(s=>(s.name||"").toLowerCase().includes(e)||(s.email||"").toLowerCase().includes(e)||(s.phone||"").toLowerCase().includes(e)):te,n=t.length,a=Math.max(1,Math.ceil(n/De));U>a&&(U=a);const o=t.slice((U-1)*De,U*De),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(s=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const r=document.getElementById("contatos-pagination");if(r){const s=n===0?0:(U-1)*De+1,p=Math.min(U*De,n);r.innerHTML=`
    ...
    `,(d=r.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{U--,be()}),(c=r.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{U++,be()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(s=>{s.addEventListener("click",p=>{p.preventDefault();const u=s.dataset.id,E=te.find(w=>String(w.id)===String(u));E&&ua(E)})})}async function ua(e=null){var g,k,S,I,L,m;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=M(),[{data:o},{data:i},{data:r}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",a).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],d=i||[],c=r||[],s=l.map(v=>v.id),{data:p}=s.length?await h.from("crm_stages").select("*").in("pipeline_id",s).order("sort_order"):{data:[]},u=p||[],E=(e==null?void 0:e.pipeline_id)||((g=l[0])==null?void 0:g.id)||"";function w(v){const x=u.filter(_=>_.pipeline_id===v);return x.length?'<option value="">— Selecionar etapa —</option>'+x.map(_=>`<option value="${f(_.name)}" ${(e==null?void 0:e.stage)===_.name?"selected":""}>${f(_.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const $=document.createElement("div");$.id="contato-modal-root",$.className="modal-backdrop",$.innerHTML=`
  ...
  `,document.body.appendChild($);const y=()=>$.remove();(k=document.getElementById("cm-close"))==null||k.addEventListener("click",y),(S=document.getElementById("cm-cancel"))==null||S.addEventListener("click",y),$.addEventListener("click",v=>{v.target===$&&y()}),(I=document.getElementById("cm-pipe"))==null||I.addEventListener("change",v=>{const x=document.getElementById("cm-stage");x&&(x.innerHTML=w(v.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const v=te.findIndex(x=>String(x.id)===String(e.id));v>=0&&te.splice(v,1),y(),be()}),(m=document.getElementById("cm-save"))==null||m.addEventListener("click",async()=>{var z,P,G,re,ge,qe,Ae;const v=document.getElementById("contato-form");if(!v.checkValidity()){v.reportValidity();return}const x=new FormData(v),_=document.getElementById("cm-save");_.disabled=!0,_.textContent="Salvando…";const B=x.getAll("tag"),C=x.get("pipeline_id")||null,T={name:(z=x.get("name"))==null?void 0:z.trim(),company:((P=x.get("company"))==null?void 0:P.trim())||null,email:((G=x.get("email"))==null?void 0:G.trim())||null,phone:((re=x.get("phone"))==null?void 0:re.trim())||null,job_title:((ge=x.get("job_title"))==null?void 0:ge.trim())||null,city_interest:((qe=x.get("city_interest"))==null?void 0:qe.trim())||null,notes:((Ae=x.get("notes"))==null?void 0:Ae.trim())||null,pipeline_id:C,stage:x.get("stage")||null,status:x.get("status")||null,tags:B,assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await h.from("leads").update(T).eq("id",e.id),!A){const W=te.findIndex(Ee=>String(Ee.id)===String(e.id));W>=0&&(te[W]={...te[W],...T})}}else{const{data:W,error:Ee}=await h.from("leads").insert(T).select();A=Ee,!A&&(W!=null&&W[0])&&te.unshift(W[0])}if(_.disabled=!1,_.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}y(),be()})}let Be=[];function mn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Be=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[d,c,s,p,u]=l.split(",").map(E=>E.trim().replace(/^"|"$/g,""));return{name:d,email:c,phone:s,company:p,job_title:u}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Be.length} contato(s) encontrados para importar.`);const r=document.getElementById("import-modal-confirm");r&&(r.disabled=Be.length===0)},n.readAsText(t)}async function un(){if(!Be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}ft(),await gt(),alert(`${t.length} contato(s) importados com sucesso!`)}function gn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function ft(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const fn="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function he(e){return(await fetch(fn,{method:"POST",headers:{Authorization:`Bearer ${Ba}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ut(e){var d,c,s,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),r=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await h.auth.getUser();n.value=(u==null?void 0:u.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const E=u.target.files[0];if(!E)return;const w=URL.createObjectURL(E);a&&(a.src=w,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var g,k;const u=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",E=((k=document.getElementById("change-password-confirm"))==null?void 0:k.value)||"",w=document.getElementById("change-password-msg"),$=document.getElementById("btn-change-password");if(w&&(w.style.display="none"),u.length<12){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}if(u!==E){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}$&&($.disabled=!0,$.textContent="Salvando…");const{error:y}=await h.auth.updateUser({password:u});$&&($.disabled=!1,$.textContent="Salvar Nova Senha"),y?w&&(w.textContent="Erro: "+y.message,w.style.display=""):(w&&(w.style.color="#16a34a",w.textContent="Senha alterada com sucesso!",w.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),r==null||r.addEventListener("click",async()=>{var k;const u=t.value.trim();let E=(b==null?void 0:b.avatar_url)||"";const w=i==null?void 0:i.files[0],$=r.textContent;if(r.disabled=!0,r.textContent="Salvando…",w)try{const S=await Fe(w,400,.85),I=`avatars/${b.id}-${Date.now()}.jpg`,{error:L}=await h.storage.from("imoveis").upload(I,S,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:m}}=h.storage.from("imoveis").getPublicUrl(I);E=m}}catch(S){console.error("Avatar upload:",S)}const{error:y}=await h.from("profiles").update({name:u,avatar_url:E}).eq("id",b.id);if(r.disabled=!1,r.textContent=$,y){alert("Erro ao salvar perfil.");return}b={...b,name:u,avatar_url:E},et(b);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=((k=u[0])==null?void 0:k.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await tt(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var k,S;const w=(k=document.getElementById("invite-email"))==null?void 0:k.value.trim(),$=(S=document.getElementById("invite-password"))==null?void 0:S.value.trim(),y=document.getElementById("btn-invite-corretor"),g=document.getElementById("invite-note");if(!w){alert("Informe o e-mail do corretor.");return}if(!$||$.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}y&&(y.disabled=!0,y.textContent="Criando…"),g&&(g.style.display="none");try{const I=await he({email:w,password:$,tenant_id:(b==null?void 0:b.tenant_id)||null});if(I.success){const L=document.getElementById("invite-email"),m=document.getElementById("invite-password");L&&(L.value=""),m&&(m.value=""),await tt(),g&&(I.email_sent===!1?(g.innerHTML=`
                ✅ Acesso criado!
...
`+m);window.open("mailto:?subject="+x+"&body="+_,"_blank")}),(S=document.getElementById("share-copy"))==null||S.addEventListener("click",()=>{var v;const m=document.getElementById("share-link-input");m&&((v=navigator.clipboard)==null||v.writeText(m.value).then(()=>{const x=document.getElementById("share-copy"),_=x.textContent;x.textContent="✅ Copiado!",setTimeout(()=>{x.textContent=_},2e3)}))}),(I=document.getElementById("view-modal-edit"))==null||I.addEventListener("click",()=>{var T;if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const m=Number(document.getElementById("view-modal-edit").dataset.pid),v=q.find(A=>A.id===m);if(!v)return;Ve(),J=v.id;const x=document.getElementById("property-form"),_=document.getElementById("form-submit-btn");_.textContent="Salvar Alterações",x.querySelector('[name="title"]').value=v.title||"",x.querySelector('[name="rua"]').value=v.rua||"",x.querySelector('[name="numero"]').value=v.numero||"",x.querySelector('[name="city"]').value=v.city||"",x.querySelector('[name="price"]').value=v.price||"",x.querySelector('[name="bedrooms"]').value=v.bedrooms||"",x.querySelector('[name="suites"]').value=v.suites||"",x.querySelector('[name="parking"]').value=v.parking||"",x.querySelector('[name="description"]').value=v.description||"",x.querySelector('[name="construction_status"]').value=v.construction_status||"",x.querySelector('[name="owner_name"]').value=v.owner_name||"",x.querySelector('[name="owner_phone"]').value=v.owner_phone||"",x.querySelector('[name="owner_email"]').value=v.owner_email||"",x.querySelector('[name="owner_notes"]').value=v.owner_notes||"",x.querySelector('[name="condominium"]').value=v.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=v.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=v.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=v.neighborhood||"")},50)),oe=v.cover_image||((T=v.images)==null?void 0:T[0])||"",Pe(v.images||[]),lt("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(m=>{m.addEventListener("click",()=>{var v;document.querySelectorAll(".tab-btn").forEach(x=>x.classList.remove("active")),m.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(x=>x.classList.add("hidden")),(v=document.getElementById(`tab-${m.dataset.tab}`))==null||v.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",m=>{if(m.target.closest(".action-btns"))return;const v=m.target.closest("tr");if(!v)return;const x=Number(v.dataset.id);if(!x)return;const _=q.find(B=>B.id===x);_&&Za(_)})}async function fa(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(r){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let d=0;for(const c of r||"?")d=d*31+c.charCodeAt(0)&4294967295;return l[Math.abs(d)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let r=-1;function l(d=-1){r=d;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=d>=0?"Editar Depoimento":"Novo Depoimento";const s=d>=0?n[d]:{};e.querySelector("#dep-stars").value=String(s.stars||5),e.querySelector("#dep-text").value=s.text||"",e.querySelector("#dep-name").value=s.name||"",e.querySelector("#dep-role").value=s.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",r=-1}),e.addEventListener("click",d=>{const c=d.target.closest("[data-edit]"),s=d.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),s){const p=parseInt(s.dataset.del);confirm("Remover este depoimento?")&&(n.splice(p,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const d=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),s=e.querySelector("#dep-text").value.trim(),p=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),E=parseInt(e.querySelector("#dep-stars").value);if(!s||!p){alert("Preencha o depoimento e o nome.");return}d.disabled=!0,d.textContent="Salvando…";const w={stars:E,text:s,name:p,role:u};r>=0?n[r]=w:n.push(w);const $=await i();d.disabled=!1,d.textContent="Salvar",Y(c,$),$&&(e.querySelector("#dep-form-wrap").style.display="none",r=-1,o())})}async function i(){const r=JSON.stringify(n);return await Ge("testimonials",{pt:r,en:r,es:r})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,d,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const s=`imobi_tenant_${t}`,p=We(s);if(p)ke(p);else{let u=null;for(const E of[t,"www."+t]){const{data:w}=await h.from("tenants").select("id").eq("domain",E).maybeSingle();if(w!=null&&w.id){u=w;break}}u!=null&&u.id&&(ke(u.id),dt(s,u.id,24*60*60*1e3))}}await Promise.all([_a(),ga()]),Ne=ee("company.whatsapp",Ne),ht(),Ga(),Wa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&($t(),n.addEventListener("change",()=>{const s=xe().find(u=>u.name===n.value),p=s?kt(s.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+p.map(u=>`<option value="${u.name}">${f(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const s=new URLSearchParams(window.location.hash.replace("#","")),p=new URLSearchParams(window.location.search),u=s.get("type")||p.get("type")||"",E=Qt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||p.has("code"),w=document.getElementById("password-reset-overlay");if(E){o.style.display="none",i&&i.classList.add("hidden"),w&&(w.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async y=>{var m,v;y.preventDefault();const g=((m=document.getElementById("new-password"))==null?void 0:m.value)||"",k=((v=document.getElementById("confirm-password"))==null?void 0:v.value)||"",S=document.getElementById("password-reset-msg"),I=y.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),g!==k){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}I&&(I.disabled=!0,I.textContent="Salvando…");const{error:L}=await h.auth.updateUser({password:g});if(L){S&&(S.textContent="Erro: "+L.message,S.style.display=""),I&&(I.disabled=!1,I.textContent="Definir Senha");return}window.location.href=window.location.pathname}),p.has("code")&&await h.auth.exchangeCodeForSession(p.get("code")??"");return}const{data:{session:$}}=await h.auth.getSession();if($){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),it(),Ft(),Dt(),window.lucide&&lucide.createIcons(),b=await At($.user.id),!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(b.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const y=document.getElementById("password-reset-overlay");y&&(y.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async g=>{var v,x;g.preventDefault();const k=((v=document.getElementById("new-password"))==null?void 0:v.value)||"",S=((x=document.getElementById("confirm-password"))==null?void 0:x.value)||"",I=document.getElementById("password-reset-msg"),L=g.target.querySelector('button[type="submit"]');if(I&&(I.style.display="none"),k!==S){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}if(k.length<12){I&&(I.textContent="Mínimo 6 caracteres.",I.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:m}=await h.auth.updateUser({password:k});if(m){I&&(I.textContent="Erro: "+m.message,I.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await h.from("profiles").update({needs_password_reset:!1}).eq("id",b.id),window.location.href=window.location.pathname});return}ke((b==null?void 0:b.tenant_id)||null),et(b),Mt(b),zt(b.role),await Qe(),await Ut(b),window.lucide&&lucide.createIcons(),cn(),de("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const y=document.getElementById("login-form");y&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var S,I;const g=(I=(S=y.querySelector('input[name="email"]'))==null?void 0:S.value)==null?void 0:I.trim();if(!g){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:k}=await h.auth.resetPasswordForEmail(g,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(k?"Erro: "+k.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),y.addEventListener("submit",async g=>{g.preventDefault();const k=y.querySelector('button[type="submit"]'),S=new FormData(y),I=S.get("email"),L=S.get("password");k&&(k.disabled=!0,k.textContent="Entrando…");try{if(await Ha(I,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),it(),Ft(),window.lucide&&lucide.createIcons();const{data:{session:v}}=await h.auth.getSession();if(b=v?await At(v.user.id):null,!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Dt(),ke((b==null?void 0:b.tenant_id)||null),et(b),Mt(b),zt(b.role),await Qe(),await Ut(b),window.lucide&&lucide.createIcons(),de("dashboard")}else alert("E-mail ou senha incorretos")}catch(m){alert("Erro ao fazer login: "+((m==null?void 0:m.message)||String(m)))}finally{k&&(k.disabled=!1,k.textContent="Entrar")}}))}}else it();await ve();const r=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Bt(r),Ct(Ne),window._applyDynamicContent=Bt,window._applyWhatsAppLinks=Ct,document.querySelectorAll(".nav-dropdown-btn").forEach(s=>{var u;const p=(u=s.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");p&&s.addEventListener("click",E=>{E.stopPropagation(),p.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(w=>{w!==p&&w.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(s=>s.classList.remove("js-open"))})});async function vn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:r}=await h.from("properties").update({reference:i}).eq("id",o.id);if(!r){const l=q.findIndex(d=>d.id===o.id);l>=0&&(q[l].reference=i),n++}}Oe(Et(q))}async function yn(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const r=await bn(i);a.push(r),o=!0}catch{a.push(i)}if(o){await h.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(r=>r.id===t.id);i>=0&&(q[i].images=a)}}Oe(Et(q))}}async function bn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,r=i?URL.createObjectURL(i):null;return new Promise(l=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),s=1200;let p=d.width,u=d.height;p>s&&(u=Math.round(u*s/p),p=s),c.width=p,c.height=u;const E=c.getContext("2d");E.drawImage(d,0,0,p,u);const w=$=>{if($){const y=Math.round(p*.18),g=Math.round($.naturalHeight*y/$.naturalWidth),k=Math.round(p*.02);E.globalAlpha=.45,E.drawImage($,p-y-k,u-g-k,y,g),E.globalAlpha=1}c.toBlob(async y=>{try{const g=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:k}=await h.storage.from("imoveis").upload(g,y,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(k){console.error("Upload watermark error:",k),l(e);return}const{data:{publicUrl:S}}=h.storage.from("imoveis").getPublicUrl(g);l(S)}catch(g){console.error("Watermark upload exception:",g),l(e)}},"image/jpeg",.82)};if(r){const $=new Image;$.onload=()=>{URL.revokeObjectURL(r),w($)},$.onerror=()=>{URL.revokeObjectURL(r),w(null)},$.src=r}else w(null)},d.onerror=()=>{URL.revokeObjectURL(a),l(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function Y(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function St(e,t="assets"){const n=await Fe(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await h.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=h.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>f(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await j())}async function j(){var g,k,S,I,L;const e=document.getElementById("crm-body");if(!e)return;const t=M(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",t).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),r=n||[],d=(typeof O<"u"&&O?r.find(m=>m.id===O):null)||r.find(m=>m.is_default)||r[0],c=r.map(m=>`<option value="${m.id}"${m.id===(d==null?void 0:d.id)?" selected":""}>${f(m.name)}</option>`).join(""),s=(a||[]).filter(m=>m.pipeline_id===(d==null?void 0:d.id)).sort((m,v)=>(m.sort_order??0)-(v.sort_order??0)),p=s.map((m,v)=>`
...
Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await h.from("crm_stages").delete().eq("pipeline_id",w),await h.from("crm_pipelines").delete().eq("id",w),O=null,await j())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const m=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,x=parseInt(document.getElementById("crm-pipe-sel").value,10);m&&(await h.from("crm_stages").insert({pipeline_id:x,name:m,color:v,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-stage").value="",await j())}),e.querySelectorAll(".stage-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await h.from("crm_stages").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".stage-name-input").forEach(m=>{m.addEventListener("blur",async()=>{const v=m.value.trim(),x=m.dataset.orig;if(!v||v===x){m.value=x;return}m.disabled=!0;const{error:_}=await h.from("crm_stages").update({name:v}).eq("id",m.dataset.sid);if(m.disabled=!1,_){console.warn("[Etapas] erro ao renomear:",_),m.value=x,alert("Erro ao renomear: "+_.message);return}m.dataset.orig=v,m.style.background="#dcfce7",setTimeout(()=>{m.style.background=""},800)}),m.addEventListener("keydown",v=>{v.key==="Enter"&&(v.preventDefault(),m.blur()),v.key==="Escape"&&(m.value=m.dataset.orig,m.blur())})}),document.getElementById("crm-stages-list");let $=null;e.querySelectorAll(".stage-draggable").forEach(m=>{m.addEventListener("dragstart",v=>{$=m,m.classList.add("stage-dragging"),v.dataTransfer.effectAllowed="move";try{v.dataTransfer.setData("text/plain",m.dataset.id)}catch{}}),m.addEventListener("dragend",()=>{m.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(v=>v.classList.remove("stage-drop-over"))}),m.addEventListener("dragover",v=>{v.preventDefault(),v.dataTransfer.dropEffect="move",m!==$&&(e.querySelectorAll(".stage-drop-over").forEach(x=>x.classList.remove("stage-drop-over")),m.classList.add("stage-drop-over"))}),m.addEventListener("dragleave",()=>{m.classList.remove("stage-drop-over")}),m.addEventListener("drop",async v=>{if(v.preventDefault(),!$||m===$)return;const x=$.dataset.id,_=m.dataset.id,B=s.findIndex(z=>String(z.id)===String(x)),C=s.findIndex(z=>String(z.id)===String(_));if(B<0||C<0)return;const T=s.splice(B,1)[0];s.splice(C,0,T);const A=s.map((z,P)=>h.from("crm_stages").update({sort_order:P}).eq("id",z.id));$=null,await Promise.all(A).catch(z=>console.warn("[stages] erro reordenar:",z)),await j()})}),e.querySelectorAll(".stage-color-pick").forEach(m=>{m.addEventListener("change",async v=>{await h.from("crm_stages").update({color:v.target.value}).eq("id",m.dataset.sid);const x=m.closest(".stage-item").querySelector(".stage-color-dot");x&&(x.style.background=v.target.value)})});const y=async()=>{const m=document.getElementById("crm-new-tag"),v=document.getElementById("crm-new-tag-color"),x=m==null?void 0:m.value.trim(),_=(v==null?void 0:v.value)||"#6366F1";if(!x){m==null||m.focus();return}await h.from("crm_tags").insert({name:x,color:_,tenant_id:M()}),m&&(m.value=""),await j()};(I=document.getElementById("crm-add-tag"))==null||I.addEventListener("click",y),(L=document.getElementById("crm-new-tag"))==null||L.addEventListener("keydown",m=>{m.key==="Enter"&&y()}),e.querySelectorAll(".tm-del-btn").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await h.from("crm_tags").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-name-input").forEach(m=>{const v=m.closest(".tm-row"),x=v==null?void 0:v.querySelector(".tm-save-btn");x&&(x.style.display="none"),m.addEventListener("input",()=>{const _=m.value.trim()!==m.dataset.orig;x&&(x.style.display=_?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(m=>{const v=m.closest(".tm-row"),x=v==null?void 0:v.querySelector(".tm-color-swatch"),_=v==null?void 0:v.querySelector(".tm-save-btn");m.addEventListener("input",B=>{x&&(x.style.background=B.target.value),_&&(_.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(m=>{m.style.display="none",m.addEventListener("click",async()=>{var B,C;const v=m.closest(".tm-row"),x=(B=v.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),_=(C=v.querySelector(".tm-color-input"))==null?void 0:C.value;x&&(m.disabled=!0,m.textContent="✓ Salvando…",await h.from("crm_tags").update({name:x,color:_}).eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-tpl-btn").forEach(m=>{m.addEventListener("click",async()=>{const v=m.dataset.name,x=m.dataset.color;m.disabled=!0,m.innerHTML="✓",await h.from("crm_tags").insert({name:v,color:x,tenant_id:M()}),await j()})}),e.querySelectorAll(".tag-chip-del").forEach(m=>{m.addEventListener("click",async()=>{await h.from("crm_tags").delete().eq("id",m.dataset.id),await j()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const m=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,x=document.getElementById("crm-new-status-final").checked;m&&(await h.from("crm_lead_statuses").insert({name:m,color:v,is_final:x,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-status").value="",await j())}),e.querySelectorAll(".status-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover este status?")&&(await h.from("crm_lead_statuses").delete().eq("id",m.dataset.id),await j())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var x;const m=(x=prompt("Nome do novo funil:"))==null?void 0:x.trim();if(!m)return;const{error:v}=await h.from("crm_pipelines").insert({name:m,sort_order:99,tenant_id:M()});if(v){alert("Erro ao criar funil: "+v.message);return}pt=!1,await j()})}async function xa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var d;return f(((d=n[l])==null?void 0:d.value)||"")},o=l=>{var d;return(d=n[l])!=null&&d.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],r=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
  ...
  `,await vt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var d,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),r=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const s of a){r.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const p=await St(s,"media"),u=s.name.replace(/\.[^.]+$/,"").slice(0,60);await h.from("media_library").insert({name:u,url:p,type:"image",size:s.size,created_by:(c=(d=(await h.auth.getUser()).data)==null?void 0:d.user)==null?void 0:c.id})}catch(p){console.error("Media upload error:",p)}l++}i.style.width="100%",r.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await vt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function vt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await h.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Ea(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",yt(e,o.dataset.tab)})}),yt(e,"properties")}function $n(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,d,c,s="text",p="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${s.map(u=>{const[E,w]=p(u.stage||u.status||"").split(","),$=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>Ea(e))}}function Ea(e){var c,s,p,u,E,w,$,y;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),h.from("plans").select("id, name").then(({data:g})=>{const k=document.getElementById("et-plan");k&&g&&(k.innerHTML='<option value="">Sem plano</option>'+g.map(S=>`<option value="${S.id}"${String(S.id)===String(e.plan_id)?" selected":""}>${f(S.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",g=>{const k=g.target.files[0];if(!k)return;const S=URL.createObjectURL(k),I=document.getElementById("et-logo-preview");I&&(I.innerHTML=`<img src="${S}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var g;(g=document.getElementById("et-logo-input"))==null||g.click()}),(p=document.getElementById("et-pwd-toggle"))==null||p.addEventListener("click",()=>{const g=document.getElementById("et-admin-password");g.type=g.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var I,L;const g=(I=document.getElementById("et-api-key"))==null?void 0:I.value;if(!g)return;(L=navigator.clipboard)==null||L.writeText(g);const k=document.getElementById("et-copy-key"),S=k.textContent;k.textContent="✅ Copiada!",setTimeout(()=>{k.textContent=S},2e3)});const o=["dados","config","api"];function i(g){o.forEach(k=>{document.getElementById(`et-pane-${k}`).style.display=k===g?"":"none";const S=document.getElementById(`et-tab-${k}`);S.style.borderBottomColor=k===g?"#2563eb":"transparent",S.style.color=k===g?"#2563eb":"#64748b",S.style.fontWeight=k===g?"600":"500"}),g==="config"&&l()}o.forEach(g=>{var k;return(k=document.getElementById(`et-tab-${g}`))==null?void 0:k.addEventListener("click",()=>i(g))});let r=!1;async function l(){var S;if(r)return;r=!0;const{data:g}=await h.from("settings").select("key,value").eq("tenant_id",e.id),k={};g==null||g.forEach(I=>{k[I.key]=I.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(S=document.getElementById("et-cfg-save"))==null||S.addEventListener("click",async()=>{const I=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");I.disabled=!0,I.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const m=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),v=document.getElementById("et-cfg-phone").value.trim(),x=document.getElementById("et-cfg-email").value.trim(),_=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await h.from("settings").upsert([{key:"company.whatsapp",value:m,tenant_id:e.id},{key:"company.phone",value:v,tenant_id:e.id},{key:"company.email",value:x,tenant_id:e.id},{key:"company.city",value:_,tenant_id:e.id},{key:"company.address",value:_,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});I.disabled=!1,I.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const d=()=>n.remove();(E=document.getElementById("et-close"))==null||E.addEventListener("click",d),(w=document.getElementById("et-cancel"))==null||w.addEventListener("click",d),n.addEventListener("click",g=>{g.target===n&&d()}),($=document.getElementById("et-delete"))==null||$.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const k=document.getElementById("et-delete");k.disabled=!0,k.textContent="Excluindo…";const{error:S}=await h.from("tenants").delete().eq("id",e.id);if(S){alert("Erro ao excluir: "+S.message),k.disabled=!1,k.textContent="🗑️ Excluir";return}d(),me()}),(y=document.getElementById("et-save"))==null||y.addEventListener("click",async()=>{var T,A,z,P,G,re,ge,qe,Ae,W,Ee,Lt;const g=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),k=(P=(z=document.getElementById("et-slug"))==null?void 0:z.value)==null?void 0:P.trim(),S=(re=(G=document.getElementById("et-domain"))==null?void 0:G.value)==null?void 0:re.trim(),I=(ge=document.getElementById("et-plan"))==null?void 0:ge.value,L=(Ae=(qe=document.getElementById("et-admin-email"))==null?void 0:qe.value)==null?void 0:Ae.trim(),m=(Ee=(W=document.getElementById("et-admin-password"))==null?void 0:W.value)==null?void 0:Ee.trim(),v=(Lt=document.getElementById("et-logo-input"))==null?void 0:Lt.files[0],x=document.getElementById("et-msg"),_=document.getElementById("et-save");if(!g){x.textContent="❌ Nome é obrigatório.",x.style.color="#ef4444";return}_.disabled=!0,_.textContent="Salvando…",x.textContent="⏳ Salvando…",x.style.color="#64748b";let B=e.logo_url;if(v)try{const D=await Fe(v,256,.85),_t=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Sa}=await h.storage.from("imoveis").upload(_t,D,{contentType:"image/jpeg",upsert:!0});if(!Sa){const{data:{publicUrl:La}}=h.storage.from("imoveis").getPublicUrl(_t);B=La}}catch(D){console.error("Logo upload:",D)}const{error:C}=await h.from("tenants").update({name:g,slug:k||e.slug,domain:S||null,plan_id:I||null,logo_url:B}).eq("id",e.id);if(C){_.disabled=!1,_.textContent="Salvar",x.textContent="❌ "+C.message,x.style.color="#ef4444";return}if(L&&m&&m.length>=6){x.textContent="⏳ Criando usuário admin…";const D=await he({email:L,password:m,role:"admin",tenant_id:e.id});D!=null&&D.success?(D!=null&&D.user_id&&!(D!=null&&D.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",D.user_id),x.textContent="✅ Salvo e admin criado!",x.style.color="#22c55e"):(x.textContent="⚠️ Salvo, mas erro ao criar admin: "+((D==null?void 0:D.error)||"Tente novamente"),x.style.color="#f59e0b")}else x.textContent="✅ Imobiliária atualizada!",x.style.color="#22c55e";_.disabled=!1,_.textContent="Salvar",setTimeout(()=>{d(),me()},1200)})}const Wt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let at=[],we=[],Ke={};function Sn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ln)}function Ln(){at=[],we=[],Ke={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),Ia();const t=document.getElementById("import-drop-zone"),n=document.getElementById("import-file-input");function a(i){i.preventDefault()}document.addEventListener("dragover",a),document.addEventListener("drop",a),t.addEventListener("click",()=>n.click()),t.addEventListener("dragenter",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragover",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragleave",i=>{t.contains(i.relatedTarget)||(t.style.borderColor="#c7d2e0",t.style.background="")}),t.addEventListener("drop",i=>{var l,d;i.preventDefault(),t.style.borderColor="#c7d2e0",t.style.background="";const r=(d=(l=i.dataTransfer)==null?void 0:l.files)==null?void 0:d[0];r&&Jt(r)}),n.addEventListener("change",i=>{var l;const r=(l=i.target.files)==null?void 0:l[0];r&&Jt(r),i.target.value=""});const o=new MutationObserver(()=>{document.getElementById("import-leads-overlay")||(document.removeEventListener("dragover",a),document.removeEventListener("drop",a),o.disconnect())});o.observe(document.body,{childList:!0})}async function Ia(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Jt(e){if(!e)return;const t=document.getElementById("import-file-status"),n=document.getElementById("import-upload-error");n.style.display="none";const a=e.name.toLowerCase();if(t.textContent=`📄 ${e.name} (${(e.size/1024).toFixed(1)} KB)`,a.endsWith(".csv")){const o=new FileReader;o.onload=i=>{const r=_n(i.target.result);if(r.error){n.textContent=r.error,n.style.display="";return}we=r.headers,at=r.rows,ka()},o.readAsText(e,"UTF-8")}else if(a.endsWith(".xlsx")||a.endsWith(".xls")){const o=new FileReader;o.onload=i=>Bn(i.target.result),o.readAsArrayBuffer(e)}else n.textContent="Formato não suportado. Use CSV ou XLSX.",n.style.display=""}function _n(e){const t=e.split(`
`)[0]||"",n=t.split(";").length>t.split(",").length?";":",",a=e.split(`
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const d=[];let c="",s=!1;for(let p=0;p<l.length;p++){const u=l[p];u==='"'?s&&l[p+1]==='"'?(c+='"',p++):s=!s:u===n&&!s?(d.push(c.trim()),c=""):c+=u}return d.push(c.trim()),d}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),r=a.slice(1).map(o);return{headers:i,rows:r}}async function Bn(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,r)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=r,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}we=o[0].map(String),at=o.slice(1),ka()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function Cn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function ka(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+we.map((a,o)=>`<option value="${o}">${f(a)}</option>`).join("");e.innerHTML=Wt.map(a=>{const o=Cn(we,t[a.key]||[]);return Ke[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Wt.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Ke[a.key]!==""&&(o.value=Ke[a.key])}),Tn(),Ia()}function Tn(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=at.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${we.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${f(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${we.map((i,r)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${f(String(o[r]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function qn(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function An(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),r=e.querySelector("#ldp-tag-search"),l=e.querySelector("#ldp-tag-opt-list"),d=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),s=e.querySelector("#ldp-tag-new-name"),p=e.querySelector("#ldp-tag-new-color"),u=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function E(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map(S=>S.dataset.tag)}function w(S){if(!S.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=S.map(I=>{const m=(n[I]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(I)}" style="background:${m}18;color:${m};border-color:${m}55;">
        ${f(I)}<span class="ldp-tag-rm" data-tag="${f(I)}">×</span>
      </span>`}).join("")}function $(S=""){const I=E(),L=S.toLowerCase().trim(),m=t.filter(v=>!L||v.name.toLowerCase().includes(L));if(!m.length){l.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}l.innerHTML=m.map(v=>{const x=I.includes(v.name);return`<div class="ldp-tag-opt${x?" active":""}" data-tag="${f(v.name)}" style="--tc:${v.color}">
      ...
      </div>`}).join("")}function y(){i.classList.remove("hidden"),$(""),r.value="",c.classList.add("hidden"),r.focus()}function g(){i.classList.add("hidden")}o.addEventListener("click",S=>{S.stopPropagation(),i.classList.contains("hidden")?y():g()}),document.addEventListener("mousedown",function S(I){e.contains(I.target)||(g(),document.removeEventListener("mousedown",S))}),i.addEventListener("mousedown",S=>S.stopPropagation()),r.addEventListener("input",()=>$(r.value)),l.addEventListener("click",S=>{const I=S.target.closest(".ldp-tag-opt");if(!I)return;const L=I.dataset.tag,m=E();m.includes(L)?w(m.filter(v=>v!==L)):w([...m,L]),$(r.value)}),a.addEventListener("click",S=>{const I=S.target.closest(".ldp-tag-rm");if(!I)return;const L=I.dataset.tag;w(E().filter(m=>m!==L))}),d.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||s.focus()});async function k(){const S=s.value.trim();if(!S){s.focus();return}const I=p.value||"#6366F1";if(t.some(L=>L.name.toLowerCase()===S.toLowerCase())){s.style.borderColor="#ef4444",setTimeout(()=>{s.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:L,error:m}=await h.from("crm_tags").insert({name:S,color:I,tenant_id:b==null?void 0:b.tenant_id}).select().single();if(m)throw m;const v={id:L.id,name:L.name,color:L.color};t.push(v),n[v.name]=v,typeof ye<"u"&&(ye[v.name]=v),w([...E(),v.name]),$(r.value),s.value="",p.value="#6366F1",c.classList.add("hidden")}catch(L){console.error("Error creating tag:",L),alert("Erro ao criar tag: "+(L.message||L))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",k),s.addEventListener("keydown",S=>{S.key==="Enter"&&k()})}async function Mn(){var y;const e=document.getElementById("section-dashboard");if(!e)return;if(e.dataset.dbInit==="1"){try{window._dbLeadsChartInstance&&(window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null)}catch{}try{window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)}catch{}}e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],r=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${r[n.getMonth()]} de ${n.getFullYear()}`,d=((y=b==null?void 0:b.name)==null?void 0:y.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${N(d)}</span> 👋`);const s=document.getElementById("db-subline");s&&(s.textContent=`Aqui está o resumo do seu negócio — ${l}`);let p=[],u=[];try{const[g,k]=await Promise.all([ea(),zn()]);p=g||[],u=k||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}Dn(p,u,n);const E=p.filter(g=>g.published).length,w=u.filter(g=>bt(g.created_at)===bt(n.toISOString())).length,$=document.getElementById("db-header-chips");$&&($.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${l.split(",")[0]}
    </span>`),jn(u,p),Hn(p),On(p,u,n),Pn(p,u);try{await qn(),Kt(u,7),Rn(u),document.querySelectorAll(".db-ptab").forEach(g=>{g.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach(S=>S.classList.remove("active")),g.classList.add("active");const k=parseInt(g.dataset.p);window._dbSelectedDays=k,Kt(u,k)})})}catch(g){console.warn("[Dashboard] Chart.js não carregou:",g)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const g=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!g||g.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function N(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function bt(e){return(e||"").slice(0,10)}function $a(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function Ie(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function zn(){let e=h.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(b==null?void 0:b.role)==="corretor"?e=e.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function Dn(e,t,n){const a=e.length,o=e.filter(I=>I.published).length,i=t.length,r=t.filter(I=>!I.converted_at&&!I.lost_at&&I.stage).length;function l(I){if(I==null)return 0;if(typeof I=="number")return I;let m=String(I).trim().replace(/[^\d,.]/g,"");m.includes(",")&&m.lastIndexOf(",")>m.lastIndexOf(".")?m=m.replace(/\./g,"").replace(",","."):m=m.replace(/\./g,"");const v=parseFloat(m);return isNaN(v)?0:v}const d=e.filter(I=>I.published).reduce((I,L)=>I+l(L.price),0),c=new Date(n);c.setDate(c.getDate()-30);const s=t.filter(I=>I.converted_at&&new Date(I.converted_at)>=c).length,p=new Date(n);p.setDate(p.getDate()-30);const u=new Date(n);u.setDate(u.getDate()-60);const E=e.filter(I=>I.created_at&&new Date(I.created_at)>=p).length,w=e.filter(I=>I.created_at&&new Date(I.created_at)>=u&&new Date(I.created_at)<p).length,$=t.filter(I=>I.created_at&&new Date(I.created_at)>=p).length,y=t.filter(I=>I.created_at&&new Date(I.created_at)>=u&&new Date(I.created_at)<p).length;function g(I,L,m){if(L===0&&I===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(L===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const v=Math.round((I-L)/L*100);return v===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':v>0?`<span class="db-kpi-trend db-trend-up">▲ +${v}% ${m}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${v}% ${m}</span>`}function k(I){return I>=1e6?"R$ "+(I/1e6).toFixed(I>=1e7?1:2).replace(".",",")+"M":I>=1e3?"R$ "+Math.round(I/1e3)+"K":"R$ "+Math.round(I).toLocaleString("pt-BR")}[{idx:0,val:Ie(a),label:"Total de Imóveis",trend:g(E,w,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:k(d),label:"VGV Total",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Sem imóveis publicados</span>':`<span class="db-kpi-trend db-trend-up">▲ ${o} imóveis</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'},{idx:2,val:Ie(o),label:"Publicados",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:3,val:Ie(i),label:"Leads Recebidos",trend:g($,y,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:4,val:Ie(r),label:"Em Negociação",trend:r===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos no funil</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>'},{idx:5,val:Ie(s),label:"Vendas (30d)",trend:s===0?'<span class="db-kpi-trend db-trend-neu">Aguardando primeira venda</span>':'<span class="db-kpi-trend db-trend-up">🎯 Fechadas</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>'}].forEach(({idx:I,val:L,label:m,trend:v,icon:x})=>{const _=document.getElementById(`db-kpi-${I}`);_&&(_.innerHTML=`
      <div class="db-kpi-icon">${x}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${L}</div>
        <div class="db-kpi-lbl">${N(m)}</div>
        ${v}
      </div>`)}),Nn(t)}function Nn(e){const t=document.getElementById("db-funnel-stages");if(!t)return;const n=e.filter(l=>!l.converted_at&&!l.lost_at),a={};n.forEach(l=>{const d=l.stage||"Sem etapa";a[d]=(a[d]||0)+1});const o=Object.entries(a).sort((l,d)=>d[1]-l[1]),i=n.length,r=Math.max(...o.map(l=>l[1]),1);if(!o.length){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">💼</div><div class="db-empty-text">Nenhum lead em negociação ainda</div></div>';return}t.innerHTML=o.map(([l,d])=>{const c=Math.round(d/r*100);return`<div class="db-funnel-row" onclick="navigateToSection('funil')">
    ...
    </div>`}).join("")+`<div class="db-funnel-total">Total ativo: <strong>${i}</strong> negociações</div>`}function Kt(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let l=t-1;l>=0;l--){const d=new Date(i);d.setDate(d.getDate()-l);const c=d.toISOString().slice(0,10),s=t<=7?d.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?d.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):d.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(s),o.push(e.filter(p=>bt(p.created_at)===c).length)}const r=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(l=>l===r&&r>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:l=>` ${l.parsed.y} lead${l.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(r/4))}}}}})}window._dbOriginChartInstance=null;function Rn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const s=c.source||"Direto",p=s.charAt(0).toUpperCase()+s.slice(1);a[p]=(a[p]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),r=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],l=o.map((c,s)=>r[s%r.length]),d=i.reduce((c,s)=>c+s,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:l,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const s=d>0?Math.round(c.parsed/d*100):0;return` ${c.label}: ${c.parsed} (${s}%)`}}}}}}),n&&(d===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,s)=>`
    ...
    <tr>
      ...
      <td style="color:#64748B;font-size:12px;">${$a(l.created_at,i)}</td>
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-time">${$a(r.time,n)}</div>
