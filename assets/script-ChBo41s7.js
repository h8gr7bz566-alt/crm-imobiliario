import{s as v}from"./supabase-BcuJ3xoD.js";let he={},Me={};async function ct(){const[e,t]=await Promise.all([v.from("settings").select("key,value"),v.from("site_content").select("*")]);e.data&&e.data.forEach(n=>{he[n.key]=n.value}),t.data&&t.data.forEach(n=>{Me[n.key]=n})}const V=(e,t=null)=>he[e]!==void 0?he[e]:t,Se=(e,t="pt")=>{const n=Me[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Z(e){const t=new Date().toISOString(),n=e.map(([o,s])=>({key:o,value:s,updated_at:t})),{error:a}=await v.from("settings").upsert(n,{onConflict:"key"});return a||e.forEach(([o,s])=>{he[o]=s}),!a}async function $e(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,updated_at:new Date().toISOString()},{error:s}=await v.from("site_content").upsert(o,{onConflict:"key"});return s||(Me[e]=o),!s}async function ke(e,t,n){const{error:a}=await v.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function Ne(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=o});const s=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=s);const d=V("visual.hero_bg_url","");if(d){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${d}')`)}}function mt(e="pt"){const t=p=>Se(p,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const s=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');s&&t("inst.bio_p1")&&(s.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),c=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');i&&t("inst.stat2_num")&&(i.innerHTML=t("inst.stat2_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const r=Se("seo.title_pt",e);r&&document.title&&(document.title=r);const g=Se("seo.description_pt",e);if(g){const p=document.querySelector('meta[name="description"]');p&&(p.content=g)}}function ut(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const pt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",ce=`https://wa.me/${K}`;const Y=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],vt=5.7;function me(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/vt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let k=[],f=null,ue=[],et=!1;v.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(et=!0)});async function gt(){const{data:e,error:t}=await v.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function ft(){const{data:e,error:t}=await v.from("properties").select("*").order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):(k=e||[],Ft(),zt(),k)}async function yt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await v.from("properties").update(a).eq("id",t);if(o)throw o;const s=k.findIndex(l=>l.id===t);s>=0&&(k[s]={...k[s],...a})}else{if(!e.reference){const a=k.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await v.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&k.unshift(t[0])}}async function bt(e){const{error:t}=await v.from("properties").delete().eq("id",e);if(t)throw t;k=k.filter(n=>n.id!==e)}async function ht(e,t){const{error:n}=await v.auth.signInWithPassword({email:e,password:t});return!n}function Le(e,t=1200,n=.78){return new Promise((a,o)=>{const s=new Image,l=URL.createObjectURL(e);s.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let i=s.width,c=s.height;i>t&&(c=Math.round(c*t/i),i=t),d.width=i,d.height=c;const m=d.getContext("2d");m.drawImage(s,0,0,i,c);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const r=Math.round(i*.18),g=Math.round(u.naturalHeight*r/u.naturalWidth),p=Math.round(i*.02),b=i-r-p,w=c-g-p;m.globalAlpha=.45,m.drawImage(u,b,w,r,g),m.globalAlpha=1,d.toBlob(h=>h?a(h):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{d.toBlob(r=>r?a(r):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},s.onerror=o,s.src=l})}async function Et(e){const t=await Le(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await v.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=v.storage.from("imoveis").getPublicUrl(n);return o}async function wt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Et(n[o]));return a}async function pe(){var u,r,g,p,b,w;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await gt();k=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&It(n);const a=((r=document.getElementById("city-filter"))==null?void 0:r.value)||"",o=((g=document.getElementById("neighborhood-filter"))==null?void 0:g.value)||"",s=((p=document.getElementById("bedrooms-filter"))==null?void 0:p.value)||"",l=((b=document.getElementById("parking-filter"))==null?void 0:b.value)||"",d=((w=document.getElementById("construction-filter"))==null?void 0:w.value)||"",i=document.getElementById("price-slider"),c=i?parseInt(i.value,10):13e7,m=n.filter(h=>{if(a&&h.city!==a||o&&h.neighborhood!==o||s&&(s==="4+"&&Number(h.bedrooms)<4||s!=="4+"&&Number(h.bedrooms)!==Number(s))||l&&(l==="4+"&&Number(h.parking)<4||l!=="4+"&&Number(h.parking)!==Number(l))||d&&h.construction_status!==d)return!1;const E=String(h.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(E,10)||0;return!(B<0||B>c)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(h=>{var x;const E=h.cover_image||((x=h.images)==null?void 0:x[0])||Y[0],B=[h.neighborhood,h.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-loc">${y(B)}</div>
            <div class="selecao-card-price">${y(me(h.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${h.id}" class="btn-det">Ver Detalhes</a>
              <a href="${ce}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!m.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=m.map(h=>{var x;const E=(x=h.images)!=null&&x.length?h.images:Y,B=E.length;return`
      <div class="card property-card">
        ...
        <div class="property-info">
          ...
          <div><strong>${y(me(h.price,window.currentLang||"pt"))}</strong></div>
          ...
          <div style="display:flex;gap:8px;margin-top:6px">
            ...
            <a class="btn hero-whatsapp-btn" href="${ce}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(h=>{h.removeEventListener("click",Oe),h.addEventListener("click",Oe)})}function It(e){var o,s,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(d=>{var m;const i=d.cover_image||((m=d.images)==null?void 0:m[0])||Y[0],c=[d.neighborhood,d.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
        ...
        <div class="selecao-card-body">
          ...
          <div class="selecao-card-price">${y(me(d.price,window.currentLang||"pt"))}</div>
          <div class="selecao-card-actions">
    ...
    `}).join("");const a=t.closest(".selecao-carousel-wrap");(s=a==null?void 0:a.querySelector(".selecao-prev"))==null||s.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(l=a==null?void 0:a.querySelector(".selecao-next"))==null||l.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),pe()};function Oe(e){var d;e.stopPropagation();const t=e.currentTarget.closest(".carousel-wrap");if(!t)return;const n=parseInt(t.dataset.total,10);if(!n)return;let a=parseInt(t.dataset.idx,10)||0;const o=e.currentTarget.classList.contains("carousel-next")?1:-1;a=(a+o+n)%n,t.dataset.idx=a;const s=parseInt(t.dataset.pid,10),l=k.find(i=>i.id===s);(d=l==null?void 0:l.images)!=null&&d.length&&(t.querySelector(".carousel-img").src=l.images[a])}function xt(){const e=document.getElementById("price-slider"),t=document.getElementById("price-label");!e||!t||(e.min="0",e.max="130000000",e.step="1000000",e.value="130000000",t.textContent="Até R$ 130.000.000",e.addEventListener("input",()=>{const n=parseInt(e.value,10);t.textContent="Até R$ "+n.toLocaleString("pt-BR"),pe()}))}function Bt(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=J();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${y(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=J().find(s=>s.name===e.value),o=a?He(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(s=>`<option value="${s.name}">${y(s.name)}</option>`).join(""),pe()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",pe)})}function ve(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var l;const a=n.cover_image||((l=n.images)==null?void 0:l[0])||Y[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",s=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}M=n||[],te()}function nt(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function te(){const e=document.getElementById("tarefas-list");if(!e)return;let t=M;if(Q==="pending"&&(t=M.filter(a=>a.status!=="done")),Q==="done"&&(t=M.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${Q==="done"?"✅":"📋"}</div>
      <p>${Q==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=nt(a.due_date),s=o?o.toLocaleDateString("pt-BR"):"",l=o&&a.status!=="done"&&o<n;return`
      <div class="tarefa-item${a.status==="done"?" done":""}" data-id="${a.id}" style="cursor:pointer;">
        ...
        <div class="tarefa-body">
          <div class="tarefa-title">${y(a.title)}</div>
          <div class="tarefa-meta">
            ${s?`<span style="${l?"color:#ef4444;":""}">📅 ${s}${l?" (atrasada)":""}</span>`:""}
            ${a.description?`<span>${y(a.description.substring(0,60))}${a.description.length>60?"…":""}</span>`:""}
          </div>
        </div>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const s=a.dataset.id,l=a.checked?"done":"pending";await v.from("tasks").update({status:l}).eq("id",s);const d=M.find(i=>String(i.id)===s);d&&(d.status=l),te()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await v.from("tasks").delete().eq("id",a.dataset.id),M=M.filter(s=>String(s.id)!==String(a.dataset.id)),te())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const s=a.dataset.id,l=M.find(d=>String(d.id)===s);l&&ot(l)})})}function ot(e=null){var i,c,m,u;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=nt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const s=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",l=document.createElement("div");l.id="tarefa-modal-root",l.className="modal-backdrop",l.innerHTML=`
      ...
      <div class="modal-body" style="padding:24px;">
        ...
        <form id="tarefa-form" style="display:flex;flex-direction:column;gap:16px;">
          ...
          <div class="form-group">
            ...
            <textarea name="description" class="form-control" rows="4" placeholder="Detalhes, observações…">${y((e==null?void 0:e.description)||"")}</textarea>
          </div>
        </form>
      </div>
  ...
  `,document.body.appendChild(l);const d=()=>l.remove();(i=document.getElementById("tm-close"))==null||i.addEventListener("click",d),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",d),l.addEventListener("click",r=>{r.target===l&&d()}),(m=document.getElementById("tm-toggle-done"))==null||m.addEventListener("click",async()=>{const r=a?"pending":"done";await v.from("tasks").update({status:r}).eq("id",e.id);const g=M.find(p=>String(p.id)===String(e.id));g&&(g.status=r),d(),r==="done"&&(Q="done",document.querySelectorAll(".tarefa-filter-btn").forEach(p=>{p.classList.toggle("active",p.dataset.filter==="done")})),te()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var h,E;const r=document.getElementById("tarefa-form");if(!r.checkValidity()){r.reportValidity();return}const g=new FormData(r),p=document.getElementById("tm-save");p.disabled=!0,p.textContent="Salvando…";const b={title:(h=g.get("title"))==null?void 0:h.trim(),description:((E=g.get("description"))==null?void 0:E.trim())||null,due_date:g.get("due_date")||null,priority:g.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let w;if(n){if({error:w}=await v.from("tasks").update(b).eq("id",e.id),!w){const B=M.findIndex(x=>String(x.id)===String(e.id));B>=0&&(M[B]={...M[B],...b})}}else{const{data:B,error:x}=await v.from("tasks").insert(b).select();w=x,!w&&(B!=null&&B[0])&&M.unshift(B[0])}if(p.disabled=!1,p.textContent=n?"Salvar":"Criar Tarefa",w){alert("Erro: "+w.message);return}d(),te()})}async function At(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([v.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),v.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),s=[];a!=null&&a.length&&(s.push('<div class="search-group-label">Imóveis</div>'),s.push(...a.map(l=>`
      ...
      </div>`))),t.innerHTML=s.length?s.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(l=>{l.addEventListener("click",()=>{var d;(d=document.getElementById("search-overlay"))==null||d.classList.add("hidden"),l.dataset.type==="lead"?X("contatos"):X("properties")})})}let U=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function Mt(){var l;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=v.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(d=>!U.includes(String(d.id))),s=document.getElementById("notif-badge");if(s&&(s.textContent=o.length,o.length>0?s.classList.remove("hidden"):s.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(d=>{const i=Rt(d.created_at);return`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",d=>{d.preventDefault(),G(),X("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{U.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(U)),d.classList.remove("unread"),G(),X("contatos")})})}function Nt(){var e;document.querySelectorAll(".notif-item").forEach(t=>U.push(t.dataset.id)),U=[...new Set(U)],localStorage.setItem("crm_notifs_read",JSON.stringify(U)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Rt(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Ht(){let e=v.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);f!=null&&f.tenant_id&&(e=e.eq("tenant_id",f.tenant_id));const{data:t}=await e,a=(t||[]).filter(s=>!U.includes(String(s.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let F=[],A=1;const de=10;let We=!1;async function jt(){var t,n,a,o,s,l,d,i,c;document.getElementById("section-contatos")&&(We||(We=!0,await st(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{A=1,ae()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",m=>{m.key==="Enter"&&(A=1,ae())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>it()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Dt),(s=document.getElementById("import-modal-close"))==null||s.addEventListener("click",qe),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",qe),(d=document.getElementById("download-template"))==null||d.addEventListener("click",m=>{m.preventDefault();const u=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,r=new Blob([u],{type:"text/csv"}),g=document.createElement("a");g.href=URL.createObjectURL(r),g.download="modelo_contatos.csv",g.click()}),(i=document.getElementById("import-csv-file"))==null||i.addEventListener("change",Ut),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Pt)))}async function st(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=v.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;F=a||[],ae()}function ae(){var d,i,c;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?F.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/de));A>a&&(A=a);const o=t.slice((A-1)*de,A*de),s=document.getElementById("contatos-tbody");if(!s)return;o.length?s.innerHTML=o.map(m=>`
      <tr>
    ...
    `).join(""):s.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const l=document.getElementById("contatos-pagination");if(l){const m=n===0?0:(A-1)*de+1,u=Math.min(A*de,n);l.innerHTML=`
    ...
    `,(i=l.querySelector("#pag-prev"))==null||i.addEventListener("click",()=>{A--,ae()}),(c=l.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{A++,ae()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(m=>{m.addEventListener("click",u=>{u.preventDefault();const r=m.dataset.id,g=F.find(p=>String(p.id)===String(r));g&&it(g)})})}function it(e=null){var s,l,d;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=document.createElement("div");a.id="contato-modal-root",a.className="modal-backdrop",a.innerHTML=`
  ...
  `,document.body.appendChild(a);const o=()=>a.remove();(s=document.getElementById("cm-close"))==null||s.addEventListener("click",o),(l=document.getElementById("cm-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",i=>{i.target===a&&o()}),(d=document.getElementById("cm-save"))==null||d.addEventListener("click",async()=>{var g,p,b,w,h,E,B;const i=document.getElementById("contato-form");if(!i.checkValidity()){i.reportValidity();return}const c=new FormData(i),m=document.getElementById("cm-save");m.disabled=!0,m.textContent="Salvando…";const u={name:(g=c.get("name"))==null?void 0:g.trim(),company:((p=c.get("company"))==null?void 0:p.trim())||null,email:((b=c.get("email"))==null?void 0:b.trim())||null,phone:((w=c.get("phone"))==null?void 0:w.trim())||null,job_title:((h=c.get("job_title"))==null?void 0:h.trim())||null,city_interest:((E=c.get("city_interest"))==null?void 0:E.trim())||null,notes:((B=c.get("notes"))==null?void 0:B.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null,source:"manual"};let r;if(n){if({error:r}=await v.from("leads").update(u).eq("id",e.id),!r){const x=F.findIndex(C=>String(C.id)===String(e.id));x>=0&&(F[x]={...F[x],...u})}}else{const{data:x,error:C}=await v.from("leads").insert(u).select();r=C,!r&&(x!=null&&x[0])&&F.unshift(x[0])}if(m.disabled=!1,m.textContent=n?"Salvar":"Criar Contato",r){alert("Erro: "+r.message);return}o(),ae()})}let ee=[];function Ut(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{ee=a.target.result.split(`
`).filter(d=>d.trim()).slice(1).map(d=>{const[i,c,m,u,r]=d.split(",").map(g=>g.trim().replace(/^"|"$/g,""));return{name:i,email:c,phone:m,company:u,job_title:r}}).filter(d=>d.name);const s=document.getElementById("import-preview");s&&(s.textContent=`${ee.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=ee.length===0)},n.readAsText(t)}async function Pt(){if(!ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null})),{error:n}=await v.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}qe(),await st(),alert(`${t.length} contato(s) importados com sucesso!`)}function Dt(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function qe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Ot="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function fe(e){return(await fetch(Ot,{method:"POST",headers:{Authorization:`Bearer ${pt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ye(e){var i,c,m,u;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),s=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:r}}=await v.auth.getUser();n.value=(r==null?void 0:r.email)||""}const d=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=d),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),s==null||s.addEventListener("change",r=>{const g=r.target.files[0];if(!g)return;const p=URL.createObjectURL(g);a&&(a.src=p,a.style.display=""),o&&(o.style.display="none")}),(i=document.getElementById("btn-change-password"))==null||i.addEventListener("click",async()=>{var h,E;const r=((h=document.getElementById("change-password-new"))==null?void 0:h.value)||"",g=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",p=document.getElementById("change-password-msg"),b=document.getElementById("btn-change-password");if(p&&(p.style.display="none"),r.length<6){p&&(p.textContent="Mínimo 6 caracteres.",p.style.display="");return}if(r!==g){p&&(p.textContent="As senhas não coincidem.",p.style.display="");return}b&&(b.disabled=!0,b.textContent="Salvando…");const{error:w}=await v.auth.updateUser({password:r});b&&(b.disabled=!1,b.textContent="Salvar Nova Senha"),w?p&&(p.textContent="Erro: "+w.message,p.style.display=""):(p&&(p.style.color="#16a34a",p.textContent="Senha alterada com sucesso!",p.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var E;const r=t.value.trim();let g=(f==null?void 0:f.avatar_url)||"";const p=s==null?void 0:s.files[0],b=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",p)try{const B=await Le(p,400,.85),x=`avatars/${f.id}-${Date.now()}.jpg`,{error:C}=await v.storage.from("imoveis").upload(x,B,{contentType:"image/jpeg",upsert:!0});if(!C){const{data:{publicUrl:I}}=v.storage.from("imoveis").getPublicUrl(x);g=I}}catch(B){console.error("Avatar upload:",B)}const{error:w}=await v.from("profiles").update({name:r,avatar_url:g}).eq("id",f.id);if(l.disabled=!1,l.textContent=b,w){alert("Erro ao salvar perfil.");return}f={...f,name:r,avatar_url:g},Te(f);const h=document.getElementById("settings-avatar-initial");h&&(h.textContent=((E=r[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const r=document.getElementById("settings-corretores-section");r&&(r.style.display=""),await Be(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var E,B;const p=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),b=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),w=document.getElementById("btn-invite-corretor"),h=document.getElementById("invite-note");if(!p){alert("Informe o e-mail do corretor.");return}if(!b||b.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}w&&(w.disabled=!0,w.textContent="Criando…"),h&&(h.style.display="none");try{const x=await fe({email:p,password:b,tenant_id:(f==null?void 0:f.tenant_id)||null});if(x.success){const C=document.getElementById("invite-email"),I=document.getElementById("invite-password");C&&(C.value=""),I&&(I.value=""),await Be(),h&&(x.email_sent===!1?(h.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${y(b)}`,h.style.color="#0f172a"):(h.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",h.style.color="#16a34a"),h.style.display="")}else alert("Erro: "+(x.error||"Falha desconhecida"))}catch(x){alert("Erro ao criar acesso: "+x.message)}finally{w&&(w.disabled=!1,w.textContent="+ Criar Acesso")}});const g=document.getElementById("settings-locations-section");g&&(g.style.display=""),await re(),(m=document.getElementById("loc-add-city-btn"))==null||m.addEventListener("click",async()=>{const p=document.getElementById("loc-new-city"),b=p==null?void 0:p.value.trim();if(!b)return;const{error:w}=await v.from("locations").insert({type:"cidade",name:b});if(w){alert("Erro ao adicionar cidade.");return}p&&(p.value=""),await re(),je()}),(u=document.getElementById("loc-add-neighborhood-btn"))==null||u.addEventListener("click",async()=>{var E;const p=parseInt((E=document.getElementById("loc-new-neighborhood-city"))==null?void 0:E.value,10),b=document.getElementById("loc-new-neighborhood"),w=b==null?void 0:b.value.trim();if(!p||!w){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:h}=await v.from("locations").insert({type:"bairro",name:w,parent_id:p});if(h){alert("Erro ao adicionar bairro.");return}b&&(b.value=""),await re()})}}async function Be(){const e=document.getElementById("corretores-list");if(!e)return;let t=v.from("profiles").select("*").order("created_at");f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const s=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${y(s)}</div>`,d=o.id===(f==null?void 0:f.id),i=o.active!==!1,c=i?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',m=d?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${s.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(s=>`<option value="${s.id}">${y(s.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{const l=s.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${l}" e todos os bairros vinculados?`))return;const{error:d}=await v.from("locations").delete().eq("id",s.dataset.id);if(d){alert("Erro ao excluir.");return}await re(),je()})}),n.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:l}=await v.from("locations").delete().eq("id",s.dataset.id);if(l){alert("Erro ao excluir.");return}await re()})})}function Je(){var n,a,o,s,l,d,i,c,m,u,r,g,p,b,w,h,E,B,x,C;document.querySelectorAll(".filter-btn").forEach(I=>{I.addEventListener("click",()=>{const L=I.closest(".filter-btns"),S=I.classList.contains("active");L.querySelectorAll(".filter-btn").forEach($=>$.classList.remove("active")),S||I.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var _;const I=(_=document.getElementById("f-city"))==null?void 0:_.value,L=J().find(T=>T.name===I),S=L?He(L.id):[],$=document.getElementById("f-neighborhood");$&&($.innerHTML='<option value="">Todos</option>'+S.map(T=>`<option value="${T.name}">${y(T.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{ve(Re(k))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{["f-title","f-condominium","f-price-min","f-price-max","f-area-min","f-area-max"].forEach($=>{const _=document.getElementById($);_&&(_.value="")}),["f-type","f-city","f-construction","f-published"].forEach($=>{const _=document.getElementById($);_&&(_.value="")});const S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'),document.querySelectorAll(".filter-btn.active").forEach($=>$.classList.remove("active")),ve(k)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(I=>{I.addEventListener("click",()=>{X(I.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(I=>{I.addEventListener("click",()=>{X(I.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(I=>{I.addEventListener("click",L=>{L.stopPropagation();const S=I.closest(".topnav-dropdown");S==null||S.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach($=>{$!==S&&$.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(I=>I.classList.remove("open"))}),(s=document.getElementById("modal-close"))==null||s.addEventListener("click",be),(l=document.getElementById("modal-cancel"))==null||l.addEventListener("click",be),(d=document.getElementById("property-modal"))==null||d.addEventListener("click",I=>{I.target.id==="property-modal"&&be()}),(i=document.getElementById("btn-new-property"))==null||i.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",W="",we([]),Ce("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await v.auth.signOut(),location.reload()}),(m=document.getElementById("view-prev"))==null||m.addEventListener("click",()=>{H=(H-1+O.length)%O.length,Ie()}),(u=document.getElementById("view-next"))==null||u.addEventListener("click",()=>{H=(H+1)%O.length,Ie()}),(r=document.getElementById("view-modal-close"))==null||r.addEventListener("click",ye),(g=document.getElementById("view-modal-close2"))==null||g.addEventListener("click",ye),(p=document.getElementById("view-modal"))==null||p.addEventListener("click",I=>{I.target.id==="view-modal"&&ye()}),(b=document.getElementById("view-modal-share"))==null||b.addEventListener("click",()=>{const I=document.getElementById("share-panel");if(!I)return;const L=I.style.display!=="none";I.style.display=L?"none":"block"}),(w=document.getElementById("share-whatsapp"))==null||w.addEventListener("click",()=>{var $,_;const I=($=document.getElementById("share-link-input"))==null?void 0:$.value;if(!I)return;const L=((_=document.getElementById("view-modal-title"))==null?void 0:_.textContent)||"Imóvel",S=encodeURIComponent("Olha esse imóvel que encontrei: "+L+`
`+I);window.open("https://wa.me/?text="+S,"_blank")}),(h=document.getElementById("share-instagram"))==null||h.addEventListener("click",()=>{var L,S;const I=(L=document.getElementById("share-link-input"))==null?void 0:L.value;I&&((S=navigator.clipboard)==null||S.writeText(I),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(E=document.getElementById("share-email"))==null||E.addEventListener("click",()=>{var _,T;const I=(_=document.getElementById("share-link-input"))==null?void 0:_.value;if(!I)return;const L=((T=document.getElementById("view-modal-title"))==null?void 0:T.textContent)||"Imóvel",S=encodeURIComponent("Imóvel: "+L),$=encodeURIComponent(`Olá! Segue o link do imóvel:

`+I);window.open("mailto:?subject="+S+"&body="+$,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var L;const I=document.getElementById("share-link-input");I&&((L=navigator.clipboard)==null||L.writeText(I.value).then(()=>{const S=document.getElementById("share-copy"),$=S.textContent;S.textContent="✅ Copiado!",setTimeout(()=>{S.textContent=$},2e3)}))}),(x=document.getElementById("view-modal-edit"))==null||x.addEventListener("click",()=>{var P;if((f==null?void 0:f.role)!=="admin")return;const I=document.getElementById("view-modal-title").textContent,L=k.find(N=>N.title===I);if(!L)return;ye(),R=L.id;const S=document.getElementById("property-form"),$=document.getElementById("form-submit-btn");$.textContent="Salvar Alterações",S.querySelector('[name="title"]').value=L.title||"",S.querySelector('[name="rua"]').value=L.rua||"",S.querySelector('[name="numero"]').value=L.numero||"",S.querySelector('[name="city"]').value=L.city||"",S.querySelector('[name="price"]').value=L.price||"",S.querySelector('[name="bedrooms"]').value=L.bedrooms||"",S.querySelector('[name="suites"]').value=L.suites||"",S.querySelector('[name="parking"]').value=L.parking||"",S.querySelector('[name="description"]').value=L.description||"",S.querySelector('[name="construction_status"]').value=L.construction_status||"",S.querySelector('[name="owner_name"]').value=L.owner_name||"",S.querySelector('[name="owner_phone"]').value=L.owner_phone||"",S.querySelector('[name="owner_email"]').value=L.owner_email||"",S.querySelector('[name="owner_notes"]').value=L.owner_notes||"",S.querySelector('[name="condominium"]').value=L.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=L.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=L.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=L.neighborhood||"")},50)),W=L.cover_image||((P=L.images)==null?void 0:P[0])||"",we(L.images||[]),Ce("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(I=>{I.addEventListener("click",()=>{var L;document.querySelectorAll(".tab-btn").forEach(S=>S.classList.remove("active")),I.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(S=>S.classList.add("hidden")),(L=document.getElementById(`tab-${I.dataset.tab}`))==null||L.classList.remove("hidden")})}),(C=document.getElementById("admin-properties"))==null||C.addEventListener("click",I=>{if(I.target.closest(".action-btns"))return;const L=I.target.closest("tr");if(!L)return;const S=Number(L.dataset.id);if(!S)return;const $=k.find(_=>_.id===S);$&&$t($)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;await Promise.all([ct(),lt()]),K=V("company.whatsapp",K),ce=`https://wa.me/${K}`,Ne(),xt(),Bt();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(je(),e.addEventListener("change",()=>{const i=J().find(m=>m.name===e.value),c=i?He(i.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${y(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=i.get("type")||c.get("type")||"",u=et||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),r=document.getElementById("password-reset-overlay");if(u){n.style.display="none",a&&a.classList.add("hidden"),r&&(r.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async p=>{var x,C;p.preventDefault();const b=((x=document.getElementById("new-password"))==null?void 0:x.value)||"",w=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",h=document.getElementById("password-reset-msg"),E=p.target.querySelector('button[type="submit"]');if(h&&(h.style.display="none"),b!==w){h&&(h.textContent="As senhas não coincidem.",h.style.display="");return}E&&(E.disabled=!0,E.textContent="Salvando…");const{error:B}=await v.auth.updateUser({password:b});if(B){h&&(h.textContent="Erro: "+B.message,h.style.display=""),E&&(E.disabled=!1,E.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await v.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:g}}=await v.auth.getSession();if(g){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ee(),_e(),Je(),kt(),window.lucide&&lucide.createIcons(),f=await Fe(g.user.id),!f){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(f.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(f.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const p=document.getElementById("password-reset-overlay");p&&(p.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async b=>{var C,I;b.preventDefault();const w=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",h=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",E=document.getElementById("password-reset-msg"),B=b.target.querySelector('button[type="submit"]');if(E&&(E.style.display="none"),w!==h){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}if(w.length<6){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:x}=await v.auth.updateUser({password:w});if(x){E&&(E.textContent="Erro: "+x.message,E.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}await v.from("profiles").update({needs_password_reset:!1}).eq("id",f.id),window.location.href=window.location.pathname});return}Te(f),ze(f.role),await Ye(f),window.lucide&&lucide.createIcons(),Ht()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const p=document.getElementById("login-form");p&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var h,E;const b=(E=(h=p.querySelector('input[name="email"]'))==null?void 0:h.value)==null?void 0:E.trim();if(!b){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:w}=await v.auth.resetPasswordForEmail(b,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(w?"Erro: "+w.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),p.addEventListener("submit",async b=>{b.preventDefault();const w=new FormData(p),h=w.get("email"),E=w.get("password");if(await ht(h,E)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ee(),_e(),Je(),window.lucide&&lucide.createIcons();const{data:{session:x}}=await v.auth.getSession();if(f=x?await Fe(x.user.id):null,!f){await v.auth.signOut();return}if(f.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Te(f),ze(f.role),await Ye(f),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else _e();await pe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();mt(o),ut(K)});async function Ft(){const e=k.filter(o=>!o.reference);if(!e.length)return;const t=k.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,s)=>o.id-s.id);for(const o of a){const s="IO-"+String(n).padStart(4,"0"),{error:l}=await v.from("properties").update({reference:s}).eq("id",o.id);if(!l){const d=k.findIndex(i=>i.id===o.id);d>=0&&(k[d].reference=s),n++}}ve(Re(k))}async function zt(){const e=k.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(s=>!s.includes("/wm-")))continue;const a=[];let o=!1;for(const s of t.images)if(s.includes("/wm-"))a.push(s);else try{const l=await Xt(s);a.push(l),o=!0}catch{a.push(s)}if(o){await v.from("properties").update({images:a}).eq("id",t.id);const s=k.findIndex(l=>l.id===t.id);s>=0&&(k[s].images=a)}}ve(Re(k))}}async function Xt(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),s=o.ok?await o.blob():null,l=s?URL.createObjectURL(s):null;return new Promise(d=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),m=1200;let u=i.width,r=i.height;u>m&&(r=Math.round(r*m/u),u=m),c.width=u,c.height=r;const g=c.getContext("2d");g.drawImage(i,0,0,u,r);const p=b=>{if(b){const w=Math.round(u*.18),h=Math.round(b.naturalHeight*w/b.naturalWidth),E=Math.round(u*.02);g.globalAlpha=.45,g.drawImage(b,u-w-E,r-h-E,w,h),g.globalAlpha=1}c.toBlob(async w=>{try{const h=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:E}=await v.storage.from("imoveis").upload(h,w,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(E){console.error("Upload watermark error:",E),d(e);return}const{data:{publicUrl:B}}=v.storage.from("imoveis").getPublicUrl(h);d(B)}catch(h){console.error("Watermark upload exception:",h),d(e)}},"image/jpeg",.82)};if(l){const b=new Image;b.onload=()=>{URL.revokeObjectURL(l),p(b)},b.onerror=()=>{URL.revokeObjectURL(l),p(null)},b.src=l}else p(null)},i.onerror=()=>{URL.revokeObjectURL(a),d(e)},i.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function j(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Ue(e,t="assets"){const n=await Le(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await v.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:s}}=v.storage.from("imoveis").getPublicUrl(a);return s}async function Vt(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("settings").select("key,value"),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>y(String(n[o]||""));e.innerHTML=`
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const r=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,p=parseInt(document.getElementById("crm-pipe-sel").value,10);r&&(await v.from("crm_stages").insert({pipeline_id:p,name:r,color:g,sort_order:99}),document.getElementById("crm-new-stage").value="",await D())}),e.querySelectorAll(".stage-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await v.from("crm_stages").delete().eq("id",r.dataset.id),await D())})}),e.querySelectorAll(".stage-color-pick").forEach(r=>{r.addEventListener("change",async g=>{await v.from("crm_stages").update({color:g.target.value}).eq("id",r.dataset.sid);const p=r.closest(".stage-item").querySelector(".stage-color-dot");p&&(p.style.background=g.target.value)})}),document.getElementById("crm-add-tag").addEventListener("click",async()=>{const r=document.getElementById("crm-new-tag").value.trim(),g=document.getElementById("crm-new-tag-color").value;r&&(await v.from("crm_tags").insert({name:r,color:g}),document.getElementById("crm-new-tag").value="",await D())}),e.querySelectorAll(".tag-chip-del").forEach(r=>{r.addEventListener("click",async()=>{await v.from("crm_tags").delete().eq("id",r.dataset.id),await D()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const r=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,p=document.getElementById("crm-new-status-final").checked;r&&(await v.from("crm_lead_statuses").insert({name:r,color:g,is_final:p,sort_order:99}),document.getElementById("crm-new-status").value="",await D())}),e.querySelectorAll(".status-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Remover este status?")&&(await v.from("crm_lead_statuses").delete().eq("id",r.dataset.id),await D())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var g;const r=(g=prompt("Nome do novo funil:"))==null?void 0:g.trim();r&&(await v.from("crm_pipelines").insert({name:r,sort_order:99}),await D())})}async function Jt(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("integrations").select("*"),n={};t==null||t.forEach(d=>{n[d.key]=d});const a=d=>{var i;return y(((i=n[d])==null?void 0:i.value)||"")},o=d=>{var i;return(i=n[d])!=null&&i.enabled?"checked":""},s=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],l=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(i=>i.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&z(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Zt(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ke(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Qe(),l.dataset.tab==="platform"&&Ze()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ke),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",z),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Qe),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>aa()),(s=e.querySelector("#sa-plat-save"))==null||s.addEventListener("click",ea),z(),Ze())}async function z(){var d,i;const e=document.getElementById("sa-tenants-list"),t=((i=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=v.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const s=(a||[]).filter(c=>{var m,u;return!t||((m=c.name)==null?void 0:m.toLowerCase().includes(t))||((u=c.slug)==null?void 0:u.toLowerCase().includes(t))});if(!s.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=s.map(c=>{var m;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async()=>{const m=c.dataset.active==="true";await v.from("tenants").update({active:!m}).eq("id",c.dataset.id),z()})}),e.querySelectorAll('[data-action="edit-tenant"]').forEach(c=>{c.addEventListener("click",()=>{const m=(s||[]).find(u=>String(u.id)===String(c.dataset.id));m&&na(m)})})}async function Zt(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await v.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),v.from("plans").select("id, name").then(({data:c})=>{const m=document.getElementById("nt-plan");m&&c&&(m.innerHTML='<option value="">Sem plano</option>'+c.map(u=>`<option value="${u.id}">${y(u.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const m=document.getElementById("nt-slug");m&&!m.dataset.manual&&(m.value=ta(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(s=document.getElementById("nt-pwd-toggle"))==null||s.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(i=document.getElementById("nt-save"))==null||i.addEventListener("click",async()=>{var C,I,L,S,$,_,T,P,N,ne,oe,se;const c=(I=(C=document.getElementById("nt-name"))==null?void 0:C.value)==null?void 0:I.trim(),m=(S=(L=document.getElementById("nt-slug"))==null?void 0:L.value)==null?void 0:S.trim(),u=(_=($=document.getElementById("nt-domain"))==null?void 0:$.value)==null?void 0:_.trim(),r=(T=document.getElementById("nt-plan"))==null?void 0:T.value,g=(N=(P=document.getElementById("nt-admin-email"))==null?void 0:P.value)==null?void 0:N.trim(),p=(oe=(ne=document.getElementById("nt-admin-password"))==null?void 0:ne.value)==null?void 0:oe.trim(),b=document.getElementById("nt-msg"),w=document.getElementById("nt-save");if(!c||!m){b.textContent="❌ Nome e slug são obrigatórios.",b.style.color="#ef4444";return}if(!g){b.textContent="❌ Informe o e-mail do admin.",b.style.color="#ef4444";return}if(!p||p.length<6){b.textContent="❌ A senha precisa ter mínimo 6 caracteres.",b.style.color="#ef4444";return}w.disabled=!0,w.textContent="Criando…",b.textContent="⏳ Criando imobiliária…",b.style.color="#64748b";const{data:h,error:E}=await v.from("tenants").insert({name:c,slug:m,domain:u||null,plan_id:r||null,active:!0}).select();if(E){w.disabled=!1,w.textContent="Criar Imobiliária",b.textContent="❌ "+E.message,b.style.color="#ef4444";return}const B=(se=h==null?void 0:h[0])==null?void 0:se.id;b.textContent="⏳ Criando usuário admin…";const x=await fe({email:g,password:p,role:"admin",tenant_id:B});if(!(x!=null&&x.success)){w.disabled=!1,w.textContent="Criar Imobiliária",b.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+y((x==null?void 0:x.error)||"Desconhecido"),b.style.color="#f59e0b",setTimeout(()=>{n(),z()},3e3);return}B&&(x!=null&&x.user_id)&&!(x!=null&&x.linked)&&await v.from("profiles").update({tenant_id:B}).eq("id",x.user_id),w.disabled=!1,w.textContent="Criar Imobiliária",x.email_sent===!1?(b.innerHTML=`
        ✅ Imobiliária e admin criados!<br>
        <span style="color:#ef4444;">⚠️ E-mail não enviado (${y(x.email_error||"erro desconhecido")}).</span><br>
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px;margin-top:8px;font-size:12px;">
          E-mail: <strong>${y(g)}</strong><br>
          Senha: <strong>${y(p)}</strong>
        </div>`,b.style.color="#0f172a"):(b.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",b.style.color="#22c55e",setTimeout(()=>{n(),z()},1500))})}function na(e){var o,s,l,d,i,c,m;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop",n.innerHTML=`
  ...
  `,document.body.appendChild(n),v.from("plans").select("id, name").then(({data:u})=>{const r=document.getElementById("et-plan");r&&u&&(r.innerHTML='<option value="">Sem plano</option>'+u.map(g=>`<option value="${g.id}"${String(g.id)===String(e.plan_id)?" selected":""}>${y(g.name)}</option>`).join(""))}),(o=document.getElementById("et-logo-input"))==null||o.addEventListener("change",u=>{const r=u.target.files[0];if(!r)return;const g=URL.createObjectURL(r),p=document.getElementById("et-logo-preview");p&&(p.innerHTML=`<img src="${g}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var u;(u=document.getElementById("et-logo-input"))==null||u.click()}),(l=document.getElementById("et-pwd-toggle"))==null||l.addEventListener("click",()=>{const u=document.getElementById("et-admin-password");u.type=u.type==="password"?"text":"password"});const a=()=>n.remove();(d=document.getElementById("et-close"))==null||d.addEventListener("click",a),(i=document.getElementById("et-cancel"))==null||i.addEventListener("click",a),n.addEventListener("click",u=>{u.target===n&&a()}),(c=document.getElementById("et-delete"))==null||c.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const r=document.getElementById("et-delete");r.disabled=!0,r.textContent="Excluindo…";const{error:g}=await v.from("tenants").delete().eq("id",e.id);if(g){alert("Erro ao excluir: "+g.message),r.disabled=!1,r.textContent="🗑️ Excluir";return}a(),z()}),(m=document.getElementById("et-save"))==null||m.addEventListener("click",async()=>{var I,L,S,$,_,T,P,N,ne,oe,se,Pe;const u=(L=(I=document.getElementById("et-name"))==null?void 0:I.value)==null?void 0:L.trim(),r=($=(S=document.getElementById("et-slug"))==null?void 0:S.value)==null?void 0:$.trim(),g=(T=(_=document.getElementById("et-domain"))==null?void 0:_.value)==null?void 0:T.trim(),p=(P=document.getElementById("et-plan"))==null?void 0:P.value,b=(ne=(N=document.getElementById("et-admin-email"))==null?void 0:N.value)==null?void 0:ne.trim(),w=(se=(oe=document.getElementById("et-admin-password"))==null?void 0:oe.value)==null?void 0:se.trim(),h=(Pe=document.getElementById("et-logo-input"))==null?void 0:Pe.files[0],E=document.getElementById("et-msg"),B=document.getElementById("et-save");if(!u){E.textContent="❌ Nome é obrigatório.",E.style.color="#ef4444";return}B.disabled=!0,B.textContent="Salvando…",E.textContent="⏳ Salvando…",E.style.color="#64748b";let x=e.logo_url;if(h)try{const q=await Le(h,256,.85),De=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:dt}=await v.storage.from("imoveis").upload(De,q,{contentType:"image/jpeg",upsert:!0});if(!dt){const{data:{publicUrl:rt}}=v.storage.from("imoveis").getPublicUrl(De);x=rt}}catch(q){console.error("Logo upload:",q)}const{error:C}=await v.from("tenants").update({name:u,slug:r||e.slug,domain:g||null,plan_id:p||null,logo_url:x}).eq("id",e.id);if(C){B.disabled=!1,B.textContent="Salvar",E.textContent="❌ "+C.message,E.style.color="#ef4444";return}if(b&&w&&w.length>=6){E.textContent="⏳ Criando usuário admin…";const q=await fe({email:b,password:w,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await v.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),E.textContent="✅ Salvo e admin criado!",E.style.color="#22c55e"):(E.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),E.style.color="#f59e0b")}else E.textContent="✅ Imobiliária atualizada!",E.style.color="#22c55e";B.disabled=!1,B.textContent="Salvar",setTimeout(()=>{a(),z()},1200)})}
