import{s as b}from"./supabase-BcuJ3xoD.js";const K="00000000-0000-0000-0000-000000000000";let fe={},$e={},pe=K;function Ie(e){pe=e||K,fe={},$e={}}const z=()=>pe;async function La(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",pe),b.from("site_content").select("*").eq("tenant_id",pe)]);if(e.data&&e.data.forEach(n=>{fe[n.key]=n.value}),t.data&&t.data.forEach(n=>{$e[n.key]=n}),(!t.data||t.data.length===0)&&pe!==K){const[n,a]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",K),b.from("site_content").select("*").eq("tenant_id",K)]);n.data&&n.data.forEach(o=>{fe[o.key]===void 0&&(fe[o.key]=o.value)}),a.data&&a.data.forEach(o=>{$e[o.key]||($e[o.key]=o)})}}const ee=(e,t=null)=>fe[e]!==void 0?fe[e]:t,ze=(e,t="pt")=>{const n=$e[e];return n&&(n["value_"+t]||n.value_pt)||null};async function _e(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:pe,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{fe[o]=i}),!a}async function We(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:pe,updated_at:o},{error:l}=await b.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return l||($e[e]=i),pe!==K&&await b.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:K,updated_at:o},{onConflict:"key,tenant_id"}),!l}async function ot(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function xt(){const e=document.documentElement,t=ee("visual.accent_color","#b8962e"),n=ee("visual.primary_bg","#0f1c2e"),a=ee("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=ee("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(r=>{r.src=o});const i=ee("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=i);const s=ee("visual.hero_bg_url","");if(s){const r=document.querySelector(".hero, .hero-v2");r&&(r.style.backgroundImage="url('"+s+"')")}}function Ct(e){e=e||"pt";const t=f=>ze(f,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),s=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),s&&t("inst.bio_p3")&&(s.innerHTML=t("inst.bio_p3"));const r=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),d=document.querySelector('[data-i18n="inst.stat3_num"]'),p=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),x=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');r&&t("inst.stat1_num")&&(r.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),d&&t("inst.stat3_num")&&(d.innerHTML=t("inst.stat3_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),x&&t("inst.stat3_label")&&(x.innerHTML=t("inst.stat3_label"));const E=document.getElementById("dep-grid");if(E){const f=ze("testimonials",e)||ze("testimonials","pt");if(f)try{const S=JSON.parse(f);if(Array.isArray(S)&&S.length>0){let k=function(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},_=function(m){let v=0;for(const w of m||"?")v=v*31+w.charCodeAt(0)&4294967295;return $[Math.abs(v)%$.length]};const $=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];E.innerHTML=S.map(m=>`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),l=n("casas-condominio"),s=sa(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",l.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",l,"imoveis.html?collection=casas-condominio"):""].join(""),da(t,s),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",Et),t.addEventListener("touchend",function(r){const c=r.target.closest(".carousel-btn");c&&(r.preventDefault(),r.stopPropagation(),ra(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ve(){var x,E,I,h,f,S;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await ea();q=n,((x=document.getElementById("selecao-carousel"))==null?void 0:x.innerHTML)===""&&Va(n);const a=((E=document.getElementById("city-filter"))==null?void 0:E.value)||"",o=((I=document.getElementById("neighborhood-filter"))==null?void 0:I.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",l=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",s=((S=document.getElementById("construction-filter"))==null?void 0:S.value)||"",{min:r,max:c}=Xa(),d=n.filter($=>{if(a&&$.city!==a||o&&$.neighborhood!==o||i&&(i==="4+"&&Number($.bedrooms)<4||i!=="4+"&&Number($.bedrooms)!==Number(i))||l&&(l==="4+"&&Number($.parking)<4||l!=="4+"&&Number($.parking)!==Number(l))||s&&$.construction_status!==s)return!1;const k=String($.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),_=parseInt(k,10)||0;return!(_<r||c!==1/0&&_>c)});if(e){Fa(n);return}if(!d.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const p=sa(t);t.innerHTML=d.map($=>It($)).join(""),da(t,p);const u=document.getElementById("properties");u&&!u._carouselDelegated&&(u._carouselDelegated=!0,u.addEventListener("click",Et))}function Va(e){var o,i,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(s=>It(s)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",Et));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(l=a==null?void 0:a.querySelector(".selecao-next"))==null||l.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ve()};function ra(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const l=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(l.length&&l[a]){const s=He(l[a]),r=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");r&&(r.src=s),c&&(c.src=s)}}catch{const s=q.find(u=>String(u.id)===String(e.dataset.pid)),r=(i=s==null?void 0:s.images)!=null&&i.length?s.images:Ce,c=e.querySelector(".carousel-img"),d=e.querySelector(".carousel-img-bg"),p=r[a]?He(r[a]):"";c&&p&&(c.src=p),d&&p&&(d.src=p)}const o=e.querySelectorAll(".icard-dot");if(o.length){const l=a%o.length;o.forEach((s,r)=>s.classList.toggle("active",r===l))}}function Et(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&ra(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Xa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Ga(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ve())}function Wa(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=xe();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=xe().find(i=>i.name===e.value),o=a?St(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${g(i.name)}</option>`).join(""),ve()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ve)})}function Pe(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var l;const a=n.cover_image||((l=n.images)==null?void 0:l[0])||Ce[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
    ...
    </tr>`}).join("")}}function Ja(){const e=document.getElementById("f-city");if(!e)return;const t=xe(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),n&&(e.value=n)}function Ya(){var e,t,n,a,o,i,l,s,r,c,d,p,u,x,E;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((l=document.getElementById("f-price-min"))==null?void 0:l.value)||0,priceMax:parseFloat((s=document.getElementById("f-price-max"))==null?void 0:s.value)||1/0,areaMin:parseFloat((r=document.getElementById("f-area-min"))==null?void 0:r.value)||0,areaMax:parseFloat((c=document.getElementById("f-area-max"))==null?void 0:c.value)||1/0,construction:((d=document.getElementById("f-construction"))==null?void 0:d.value)||"",published:((p=document.getElementById("f-published"))==null?void 0:p.value)||"",bedrooms:((u=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:u.dataset.val)||"",suites:((x=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:x.dataset.val)||"",parking:((E=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:E.dataset.val)||""}}function kt(e){const t=Ya();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Ze(){if(!document.getElementById("admin-properties"))return;const e=await ta(),t=e.length,n=e.filter(l=>l.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Ja(),Pe(q)}let Y=null,oe="",le=[];function ct(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden",(!history.state||history.state.modal!=="property")&&history.pushState({modal:"property"},"")}function Ye(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow="",history.state&&history.state.modal==="property"&&history.back()}window._modalPopstateBound||(window._modalPopstateBound=!0,window.addEventListener("popstate",()=>{const e=document.getElementById("property-modal");e&&!e.classList.contains("hidden")&&(e.classList.add("hidden"),document.body.style.overflow="")}));function Ue(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(le=Array.isArray(e)?[...e]:[],!le.length){t.style.display="none";return}t.style.display="",n.innerHTML=le.map(a=>`
    ...
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".cover-delete")||(oe=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(i=>i.classList.remove("selected")),a.classList.add("selected"))})}),n.querySelectorAll(".cover-delete").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const i=a.closest(".cover-thumb-wrap"),l=i==null?void 0:i.dataset.url;l&&confirm("Remover esta foto do imóvel?")&&(le=le.filter(s=>s!==l),oe===l&&(oe=le[0]||""),Ue(le))})})}}function st(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var r;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const l=o.filter(c=>c.size>0);if(Y&&(i=[...le]),l.length){t.disabled=!0,t.textContent=`Enviando 0/${l.length} foto…`;try{const c=await Ua(l,(d,p)=>{t.textContent=`Enviando ${d}/${p} foto…`});i=[...i,...c]}catch(c){console.error("Erro no upload:",c),t.disabled=!1,t.textContent=Y?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}i.length||(i=[...Ce]);const s={...Y?{id:Y}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),state:a.get("state")||"",neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:oe||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",furnishing_status:a.get("furnishing_status")||"",furnished:a.get("furnishing_status")==="mobiliado",collection:JSON.stringify(["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].filter(c=>a.get(c)).map(c=>a.get(c))),tenant_id:Y?((r=q.find(c=>c.id===Y))==null?void 0:r.tenant_id)??(y==null?void 0:y.tenant_id)??null:(y==null?void 0:y.tenant_id)??null};try{await Ma(s),Y=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const c=document.getElementById("adminPublished");c&&(c.value="true");const d=document.getElementById("adminNeighborhood");d&&(d.innerHTML='<option value="">Selecione a cidade primeiro</option>');const p=document.getElementById("adminConstructionStatus");p&&(p.value=""),oe="",Ue([]),Ye(),await Ze()}catch(c){console.error(c),t.disabled=!1,t.textContent=Y?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((c==null?void 0:c.message)||JSON.stringify(c)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await za(o),await Ze()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=q.find(d=>d.id===o);if(!i)return;Y=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"";const l=e.querySelector('[name="state"]');l&&(l.value=i.state||""),e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const s=e.querySelector('[name="furnishing_status"]');if(s){const d=i.furnishing_status||(i.furnished===!0?"mobiliado":"vazio");s.value=d}try{const d=JSON.parse(i.collection||"[]");["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].forEach(p=>{const u=e.querySelector('[name="'+p+'"]');u&&(u.checked=d.includes(u.value))})}catch{}const r=document.getElementById("adminPublished");r&&(r.value=i.published===!0?"true":"false");const c=document.getElementById("adminCitySelect");c&&(c.value=i.city||"",c.dispatchEvent(new Event("change")),setTimeout(()=>{const d=document.getElementById("adminNeighborhood");d&&(d.value=i.neighborhood||"")},50)),oe=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Ue(i.images||[]),ct("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Ka(e){return e?String(e).replace(/\s*\([A-Z]{2}\)\s*$/i,"").trim():""}function Qa(e,t,n){const a=[];e&&a.push(e);const o=Ka(t);return o&&a.push(o+(n?"/"+n:"")),a.join(", ")}function It(e){var I;const t=(I=e.images)!=null&&I.length?e.images:Ce,n=Ta(t),a=n.length,o=He(e.cover_image||n[0]),i=Qa(e.neighborhood,e.city,e.state),l=Fe(e.price,window.currentLang||"pt"),s=`https://omarcorretor.com.br/property.html?id=${e.id}`,r=encodeURIComponent(`Olá! Tenho interesse no imóvel *${e.title}*${e.reference?` (Ref: ${e.reference})`:""}. Poderia me dar mais informações?
${s}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",d=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",p=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",x=Math.max(1,Math.min(a,6)),E=`<div class="icard-dots">${Array.from({length:x},(h,f)=>`<span class="icard-dot${f===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ...
        ${c||d||p||u?`<div class="icard-specs">${c}${d}${p}${u}</div>`:""}
        <div class="icard-price-row">
          <div>
            <div class="icard-price-label">Comprar</div>
            <div class="icard-price">${g(l)}</div>
          </div>
        </div>
  ...
  `}let ce=[],ae=0;function Za(e){var p,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((p=e.images)==null?void 0:p[0])||Ce[0];document.getElementById("view-thumb-preview").src=i,ce=(u=e.images)!=null&&u.length?e.images:Ce,ae=0,et(),document.getElementById("view-price").textContent=Fe(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const l=document.getElementById("view-condominium-item"),s=document.getElementById("view-condominium");s&&(s.textContent=e.condominium||""),l&&(l.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(x=>x.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(x=>x.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const r="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=r);const d=document.getElementById("share-panel");d&&(d.style.display="none",d.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Xe(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function et(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ce[ae],e.alt=`Foto ${ae+1}`;const i=ce.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${ae+1} / ${ce.length}`:"",o.innerHTML=i?ce.map((l,s)=>`<img src="${l}" class="view-thumb${s===ae?" active":""}" data-i="${s}" alt="Foto ${s+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{ae=+l.dataset.i,et()})})}async function Mt(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function tt(e){var p,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const s=document.getElementById("avatar-dd-name"),r=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),d=document.getElementById("avatar-dd-initial");s&&(s.textContent=i),r&&(r.textContent=l),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",d&&(d.style.display="none")):(d&&(d.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",d.style.display=""),c&&(c.style.display="none"))}async function zt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==K,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:l}=await b.from("tenants").select("domain").eq("id",n).maybeSingle(),s=window.location.hostname.replace(/^www\./,""),r=((l==null?void 0:l.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();r&&r!==s&&(t.href=`https://${r}`)}catch{}}const Ge={dashboard:()=>zn(),empresa:()=>va(),visual:()=>ya(),"site-config":()=>ba(),"crm-config":()=>ha(),integracoes:()=>xa(),midia:()=>wa(),depoimentos:()=>fa()};function de(e){var n,a;e==="vendas"&&setTimeout(()=>ca().catch(()=>{}),50),e==="perdas"&&setTimeout(()=>pa().catch(()=>{}),50),document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Ge<"u"&&Ge[e]){const o=Ge[e];Ge[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),ne(),e==="contatos"&&mn(),e==="funil"&&an(),e==="tarefas"&&sn()}function Dt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:wa,depoimentos:fa}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>xn(),{once:!0}),window.lucide&&lucide.createIcons()}}function ne(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function en(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",l=>{l.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var p,u;const l=((p=document.getElementById("cp-new"))==null?void 0:p.value)||"",s=((u=document.getElementById("cp-confirm"))==null?void 0:u.value)||"",r=document.getElementById("cp-msg"),c=document.getElementById("cp-save");if(r.style.display="none",l.length<12){r.style.color="#ef4444",r.textContent="Mínimo 6 caracteres.",r.style.display="";return}if(l!==s){r.style.color="#ef4444",r.textContent="As senhas não coincidem.",r.style.display="";return}c.disabled=!0,c.textContent="Salvando…";const{error:d}=await b.auth.updateUser({password:l});if(c.disabled=!1,c.textContent="Salvar Senha",d){r.style.color="#ef4444",r.textContent="Erro: "+d.message,r.style.display="";return}r.style.color="#16a34a",r.textContent="✅ Senha alterada com sucesso!",r.style.display="",setTimeout(n,1500)})}function tn(){var i,l,s,r,c;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(l=document.getElementById("cph-close"))==null||l.addEventListener("click",o),(s=document.getElementById("cph-cancel"))==null||s.addEventListener("click",o),t.addEventListener("click",d=>{d.target===t&&o()}),(r=document.getElementById("cph-file"))==null||r.addEventListener("change",d=>{const p=d.target.files[0];if(!p)return;const u=URL.createObjectURL(p),x=document.getElementById("cph-preview"),E=document.getElementById("cph-initial");x&&(x.src=u,x.style.display=""),E&&(E.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var x;const d=(x=document.getElementById("cph-file"))==null?void 0:x.files[0];if(!d)return;const p=document.getElementById("cph-save"),u=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const E=await Ve(d,400,.85),I=`avatars/${y.id}-${Date.now()}.jpg`,{error:h}=await b.storage.from("imoveis").upload(I,E,{contentType:"image/jpeg",upsert:!0});if(h)throw h;const{data:{publicUrl:f}}=b.storage.from("imoveis").getPublicUrl(I);await b.from("profiles").update({avatar_url:f}).eq("id",y.id),y={...y,avatar_url:f},tt(y),o()}catch(E){u.style.color="#ef4444",u.textContent="Erro: "+E.message,u.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function pt(e,t){var i,l,s;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
    <div class="modal" style="max-width:440px;">
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(l=document.getElementById("ac-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",r=>{r.target===a&&o()}),(s=document.getElementById("ac-save"))==null||s.addEventListener("click",async()=>{var u,x,E;const r=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(x=document.getElementById("ac-password"))==null?void 0:x.value.trim(),d=document.getElementById("ac-save"),p=document.getElementById("ac-note");if(!r){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}d.disabled=!0,d.textContent="Criando…",p.style.display="none";try{const I=e||(y==null?void 0:y.tenant_id)||null,h=((E=document.getElementById("ac-role"))==null?void 0:E.value)||"corretor",f=await he({email:r,password:c,role:h,tenant_id:I});d.disabled=!1,d.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(p.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${g(r)}<br><strong>Senha:</strong> ${g(c)}`,p.style.color="#0f172a"):(p.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",p.style.color="#16a34a"),p.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(I){d.disabled=!1,d.textContent="+ Criar Acesso",alert("Erro: "+I.message)}})}function Nt(){var i,l,s,r,c,d,p,u,x,E,I;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",h=>{var S;h.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(S=document.getElementById("notif-dropdown"))==null||S.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",h=>{h.stopPropagation(),ne(),tn()}),(l=document.getElementById("avatar-dd-change-pass"))==null||l.addEventListener("click",h=>{h.stopPropagation(),ne(),en()}),(s=document.getElementById("avatar-dd-add-corretor"))==null||s.addEventListener("click",h=>{h.stopPropagation(),ne(),pt()}),(r=document.getElementById("avatar-dd-settings"))==null||r.addEventListener("click",h=>{h.stopPropagation(),ne(),de("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async h=>{h.stopPropagation(),await b.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",h=>{var S;h.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((S=document.getElementById("avatar-dropdown"))==null||S.classList.add("hidden"),rn())}),(d=document.getElementById("notif-mark-all"))==null||d.addEventListener("click",()=>{ln(),ne()}),(p=document.getElementById("btn-search-open"))==null||p.addEventListener("click",()=>{var h,f;(h=document.getElementById("search-overlay"))==null||h.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var h;(h=document.getElementById("search-overlay"))==null||h.classList.add("hidden")}),(x=document.getElementById("search-overlay"))==null||x.addEventListener("click",h=>{h.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(E=document.getElementById("search-input"))==null||E.addEventListener("input",h=>{clearTimeout(o),o=setTimeout(()=>dn(h.target.value.trim()),280)}),(I=document.getElementById("search-input"))==null||I.addEventListener("keydown",h=>{var f;h.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",ne)}let mt=!1,V=[],ue=[],G=[],ye={},la=[],O=null,De=null,Z={search:"",tags:new Set,status:""};async function an(){var t;if(setTimeout(()=>{typeof Ht=="function"&&Ht()},100),window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||H().catch(()=>{})},3e4),mt){await Rt();return}mt=!0,await Rt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>gt()),_n();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{O=parseInt(e.value,10),await H()})}function ut(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+la.map(l=>`<option value="${g(l.name)}">${g(l.name)}</option>`).join(""),n.value=Z.status,n.onchange=()=>{Z.status=n.value,ie()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(l=>`<button class="kf-tag-btn${Z.tags.has(l.name)?" active":""}" data-tag="${g(l.name)}"
          style="--kf-tc:${l.color}">
          ${g(l.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(l=>{l.addEventListener("click",()=>{const s=l.dataset.tag;Z.tags.has(s)?Z.tags.delete(s):Z.tags.add(s),ut(e),ie()})})}const o=document.getElementById("kf-search");o&&(o.value=Z.search,o.oninput=()=>{Z.search=o.value.toLowerCase(),ie()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{Z={search:"",tags:new Set,status:""},ut(e),ie()})}async function Rt(){const e=z(),[{data:t},{data:n},{data:a}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",e).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);V=t||[],la=a||[],ye={},(n||[]).forEach(s=>{ye[s.name]=s});const o=V.map(s=>s.id),{data:i}=o.length?await b.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};ue=i||[],ut(n||[]);const l=document.getElementById("funil-pipe-sel");if(l){const s=O;l.innerHTML=V.length?V.map(c=>`<option value="${c.id}">${g(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const r=V.find(c=>c.id===s)||V.find(c=>c.is_default)||V[0];r?(l.value=r.id,O=r.id):O=null}await H()}async function H(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=b.from("leads").select("*").order("created_at",{ascending:!1}).is("converted_at",null).is("lost_at",null);(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),O&&(t=t.eq("pipeline_id",O));const{data:n}=await t;G=n||[],ie()}function ie(){try{const i=document.getElementById("leads-list-view");i&&!i.classList.contains("hidden")&&Le()}catch{}const e=document.getElementById("kanban-board");if(!e)return;const t=ue.filter(i=>i.pipeline_id===O);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=Z,a=G.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const l=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(s=>l.includes(s)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var s,r,c,d;const l=i.stage||((s=t[0])==null?void 0:s.name);o[l]||(o[((r=t[0])==null?void 0:r.name)||""]=[]),(d=o[l]||o[(c=t[0])==null?void 0:c.name])==null||d.push(i)}),e.innerHTML=t.map(i=>{const l=o[i.name]||[],s=l.length?l.map(d=>{const p=(d.phone||"").replace(/\D/g,""),u=encodeURIComponent(`Olá ${d.name}! Aqui é da ${ee("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`),x=d.status==="quente"?"Quente":d.status==="frio"?"Frio":d.status==="morno"?"Morno":"Em andamento";d.interest;const E=Array.isArray(d.tags)?d.tags.length:0;return`
        <div class="kanban-card" draggable="true" data-id="${d.id}" data-stage="${g(i.name)}" style="cursor:pointer;">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:6px;">
            <span class="rd-card-status">${g(x)}</span>
        ...
        </div>`}).join(""):'<div class="kanban-empty-col">Sem leads nesta etapa</div>',r=l.reduce((d,p)=>d+(Number(p.budget_max)||0),0),c=r>0?"R$ "+r.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ 0,00";return`
      <div class="kanban-col" data-stage="${g(i.name)}">
        <div class="kanban-col-header">
          <div class="kanban-col-title">
            <div class="kanban-stage-dot" style="background:${i.color||"#0ea5e9"}"></div>
            ${g(i.name.toUpperCase())} (${l.length})
          </div>
        </div>
  ...
  `,await((E=window._lpLoadTasks)==null?void 0:E.call(window,t.id));const u=typeof y<"u"&&(y==null?void 0:y.full_name)||"Não atribuído";document.getElementById("rd-lp-responsavel").textContent=u,n.querySelectorAll(".rd-leadpage-tab").forEach(h=>{h.onclick=()=>{var f;n.querySelectorAll(".rd-leadpage-tab").forEach(S=>S.classList.remove("active")),h.classList.add("active"),n.querySelectorAll(".rd-leadpage-tab-panel").forEach(S=>S.classList.remove("active")),(f=n.querySelector(`.rd-leadpage-tab-panel[data-panel="${h.dataset.tab}"]`))==null||f.classList.add("active")}}),await((I=window._lpLoadTimeline)==null?void 0:I.call(window,t.id)),document.getElementById("rd-lp-mark-lost").onclick=async()=>{const h=prompt("Motivo da perda (opcional):")||"",{error:f}=await b.from("leads").update({lost_at:new Date().toISOString(),lost_reason:h}).eq("id",t.id);if(f)return alert("Erro: "+f.message);typeof A=="function"?A("Lead marcado como perda","warn"):alert("Lead marcado como perda"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-mark-won").onclick=async()=>{if(!confirm("Marcar como venda fechada?"))return;const{error:h}=await b.from("leads").update({converted_at:new Date().toISOString()}).eq("id",t.id);if(h)return alert("Erro: "+h.message);typeof A=="function"?A("🎉 Venda confirmada!","success"):alert("Venda confirmada!"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-add-task").onclick=()=>{var h;return(h=window.openInlineTaskForm)==null?void 0:h.call(window,t.id)},document.getElementById("rd-lp-add-note").onclick=()=>{var h;return(h=window.openInlineNoteForm)==null?void 0:h.call(window,t.id)},window.scrollTo({top:0,behavior:"smooth"})};async function ca(){const e=document.getElementById("vendas-list"),t=document.getElementById("vendas-total");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';const n=typeof z=="function"?z():null;let a=b.from("leads").select("*").not("converted_at","is",null).order("converted_at",{ascending:!1});n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a;if(i){e.innerHTML='<p style="color:#ef4444">Erro: '+g(i.message)+"</p>";return}const l=o||[];if(t&&(t.textContent=`${l.length} venda${l.length!==1?"s":""}`),!l.length){e.innerHTML=`<div class="rd-empty-card">
    ...
    </div>`;return}e.innerHTML=l.map(s=>{const r=s.converted_at?new Date(s.converted_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=s.budget_max?"R$ "+Number(s.budget_max).toLocaleString("pt-BR"):"—",d=(s.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-won">
    ...
    </div>`;return}e.innerHTML=l.map(s=>{const r=s.lost_at?new Date(s.lost_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=(s.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-lost">
    ...
    </div>`}).join(""),e.querySelectorAll(".rd-result-reopen").forEach(s=>{s.addEventListener("click",async()=>{confirm("Reativar esta negociação? O lead volta para o funil ativo.")&&(await b.from("leads").update({lost_at:null,lost_reason:null}).eq("id",s.dataset.id),typeof A=="function"&&A("Lead reativado","info"),await pa(),typeof H=="function"&&H().catch(()=>{}))})})}window.openRatingPicker=function(e,t){var s,r;t&&t.stopPropagation&&t.stopPropagation();const n=(G||[]).find(c=>String(c.id)===String(e));if(!n)return;(s=document.getElementById("rd-rating-picker"))==null||s.remove(),(r=document.getElementById("rd-rating-backdrop"))==null||r.remove();const a=document.createElement("div");a.id="rd-rating-picker",a.className="rd-rating-picker",a.innerHTML=['<div class="rd-rating-picker-title">Classificação do lead</div>','<div class="rd-rating-picker-stars">',[1,2,3,4,5].map(c=>`<button class="rd-rating-star-btn ${(n.rating||0)>=c?"active":""}" data-value="${c}" title="${c} estrela${c>1?"s":""}"><svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></button>`).join(""),"</div>",'<div class="rd-rating-picker-labels"><span>Frio</span><span>Morno</span><span>Quente</span></div>','<button class="rd-rating-clear" data-value="0">✕ Sem classificação</button>'].join("");const o=t&&t.clientX?Math.min(t.clientX,window.innerWidth-260):100,i=t&&t.clientY?Math.min(t.clientY+8,window.innerHeight-200):100;a.style.left=o+"px",a.style.top=i+"px",document.body.appendChild(a);const l=document.createElement("div");l.id="rd-rating-backdrop",l.style.cssText="position:fixed;inset:0;z-index:1899;background:transparent",l.addEventListener("click",()=>{a.remove(),l.remove()}),document.body.appendChild(l),a.querySelectorAll(".rd-rating-star-btn").forEach(c=>{c.addEventListener("mouseenter",()=>{const d=parseInt(c.dataset.value,10);a.querySelectorAll(".rd-rating-star-btn").forEach(p=>{p.classList.toggle("hover",parseInt(p.dataset.value,10)<=d)})})}),a.addEventListener("mouseleave",()=>{a.querySelectorAll(".rd-rating-star-btn").forEach(c=>c.classList.remove("hover"))}),a.querySelectorAll("[data-value]").forEach(c=>{c.addEventListener("click",async()=>{const d=parseInt(c.dataset.value,10);n.rating=d,a.remove(),l.remove(),typeof ie=="function"&&ie();const p=document.getElementById("section-lead-detail");p&&!p.classList.contains("hidden")&&typeof openLeadDetailPage=="function"&&openLeadDetailPage(n.id);const{error:u}=await b.from("leads").update({rating:d}).eq("id",n.id);u?(console.warn("[Rating] erro:",u),typeof A=="function"&&A("Erro ao salvar","error")):typeof A=="function"&&A(d===0?"Classificação removida":`★ ${d} estrela${d>1?"s":""}`,"success")})})};let X={page:1,pageSize:10};function Le(){const e=document.getElementById("rd-leads-tbody");if(!e)return;const t=typeof G<"u"?G:[],n=typeof ue<"u"?ue:[],a=t.length,o=X.pageSize,i=Math.max(1,Math.ceil(a/o));X.page>i&&(X.page=i);const l=(X.page-1)*o,s=t.slice(l,l+o);if(document.getElementById("rd-list-total").textContent=`de ${a} negociaç${a===1?"ão":"ões"}`,document.getElementById("rd-list-page-info").textContent=`${X.page} / ${i}`,document.getElementById("rd-list-prev").disabled=X.page<=1,document.getElementById("rd-list-next").disabled=X.page>=i,!s.length){e.innerHTML='<tr><td colspan="8" style="text-align:center;padding:40px;color:#94a3b8">Nenhum lead ainda</td></tr>';return}const r=d=>{if(!d)return"—";try{const p=new Date(d);return`${String(p.getDate()).padStart(2,"0")}/${String(p.getMonth()+1).padStart(2,"0")}/${p.getFullYear()}`}catch{return"—"}};function c(d){const p=d.updated_at?Math.floor((Date.now()-new Date(d.updated_at).getTime())/864e5):999;return p<=1?{icon:"🏃",color:"#059669",title:"Ativo (atualizado recentemente)"}:p<=7?{icon:"🚶",color:"#0ea5e9",title:"Em andamento"}:p<=30?{icon:"😴",color:"#f59e0b",title:"Parado há mais de 1 semana"}:{icon:"🔴",color:"#dc2626",title:"Muito tempo sem contato"}}e.innerHTML=s.map(d=>{var S;const p=n.find($=>$.name===d.stage),u=d.stage||"—",x=(p==null?void 0:p.color)||"#94a3b8",E=d.budget_max?"R$ "+Number(d.budget_max).toLocaleString("pt-BR"):null,I=d.rating||0,h=((S=(d.name||"?").trim()[0])==null?void 0:S.toUpperCase())||"?",f=c(d);return`
      <tr class="rd-leads-row" data-id="${d.id}">
        ...
        <td style="text-align:center">
          <span class="rd-leads-rating" onclick="event.stopPropagation();window.openRatingPicker?.('${d.id}', event)">
            ${[1,2,3,4,5].map($=>`<span style="color:${I>=$?"#fbbf24":"#cbd5e1"};font-size:14px">★</span>`).join("")}
            <span style="margin-left:4px;font-size:12px;color:#64748b">${I||0}</span>
          </span>
        </td>
        <td>
          <span class="rd-leads-stage" style="background:${x}18;color:${x};border:1px solid ${x}55">${g(u.toUpperCase())}</span>
        </td>
      ...
      </tr>`}).join(""),e.querySelectorAll(".rd-leads-row").forEach(d=>{d.addEventListener("click",p=>{var u;p.target.closest("a, button, input")||(u=window.openLeadSidePanel)==null||u.call(window,d.dataset.id)})})}function jt(e){const t=document.getElementById("kanban-board"),n=document.getElementById("leads-list-view");document.querySelectorAll(".rd-view-btn").forEach(o=>o.classList.toggle("active",o.dataset.view===e)),e==="list"?(t&&t.classList.add("hidden"),n&&n.classList.remove("hidden"),Le()):(t&&t.classList.remove("hidden"),n&&n.classList.add("hidden"));try{localStorage.setItem("imobi_funil_view",e)}catch{}}function Ht(){var e,t,n,a;document.querySelectorAll(".rd-view-btn").forEach(o=>{o._wired||(o._wired=!0,o.addEventListener("click",()=>jt(o.dataset.view)))}),(e=document.getElementById("rd-list-prev"))==null||e.addEventListener("click",()=>{X.page>1&&(X.page--,Le())}),(t=document.getElementById("rd-list-next"))==null||t.addEventListener("click",()=>{X.page++,Le()}),(n=document.getElementById("rd-list-pagesize"))==null||n.addEventListener("change",o=>{X.pageSize=parseInt(o.target.value,10)||10,X.page=1,Le()}),(a=document.getElementById("rd-list-check-all"))==null||a.addEventListener("change",o=>{document.querySelectorAll(".rd-list-check").forEach(i=>i.checked=o.target.checked)});try{localStorage.getItem("imobi_funil_view")==="list"&&jt("list")}catch{}}typeof window<"u"&&(window._rdRenderLeadsList=Le);setTimeout(()=>{var e;return(e=window.maybePromptPush)==null?void 0:e.call(window)},3e3);window._lpLoadTasks=async function(e){const t=document.getElementById("rd-lp-tarefas");if(!t)return;t.innerHTML='<div style="text-align:center;padding:14px;color:#94a3b8;font-size:13px">Carregando tarefas…</div>';const{data:n,error:a}=await b.from("tasks").select("*").eq("lead_id",e).order("due_date",{ascending:!0,nullsFirst:!1});if(a){t.innerHTML='<div class="rd-leadpage-empty"><div class="rd-leadpage-empty-text">Erro: '+g(a.message)+"</div></div>";return}const i=(n||[]).filter(s=>s.status!=="concluida"&&s.status!=="done"),l=s=>{if(!s)return"";try{const r=new Date(s);return String(r.getDate()).padStart(2,"0")+"/"+String(r.getMonth()+1).padStart(2,"0")+"/"+r.getFullYear()+" "+String(r.getHours()).padStart(2,"0")+":"+String(r.getMinutes()).padStart(2,"0")}catch{return s}};if(!i.length){t.innerHTML=`<div class="rd-leadpage-empty"><div class="rd-leadpage-empty-text">Não existem tarefas pendentes para essa Negociação</div><button class="rd-leadpage-btn-add" onclick="window.openInlineTaskForm('`+e+`')">+ Criar tarefa</button></div>`;return}t.innerHTML=i.map(s=>{const r=s.due_date&&new Date(s.due_date)<new Date;return'<div class="rd-lp-task '+(r?"overdue":"")+'" data-id="'+s.id+'"><input type="checkbox" class="rd-lp-task-check" data-id="'+s.id+'" title="Marcar como concluída"><div class="rd-lp-task-body"><div class="rd-lp-task-title">'+g(s.title)+"</div>"+(s.description?'<div class="rd-lp-task-desc">'+g(s.description)+"</div>":"")+'<div class="rd-lp-task-meta">'+(s.due_date?'<span class="rd-lp-task-date '+(r?"overdue":"")+'">📅 '+l(s.due_date)+(r?" · ATRASADA":"")+"</span>":"")+'<span class="rd-lp-task-prio prio-'+(s.priority||"medium")+'">'+(s.priority||"medium").toUpperCase()+"</span>"+(s.due_date?'<a class="rd-lp-task-gcal" href="'+window.buildGoogleCalendarUrl(s)+'" target="_blank" rel="noopener" title="Adicionar ao Google Agenda">🗓 Google Agenda</a>':"")+'</div></div><button class="rd-lp-task-del" data-id="'+s.id+'" title="Excluir">🗑️</button></div>'}).join(""),t.querySelectorAll(".rd-lp-task-check").forEach(s=>{s.addEventListener("change",async()=>{var c;s.disabled=!0;const{error:r}=await b.from("tasks").update({status:"done"}).eq("id",s.dataset.id);if(r){s.checked=!1,s.disabled=!1,alert("Erro: "+r.message);return}typeof A=="function"&&A("✓ Tarefa concluída","success"),window._lpLoadTasks(e),(c=window._lpLoadTimeline)==null||c.call(window,e)})}),t.querySelectorAll(".rd-lp-task-del").forEach(s=>{s.addEventListener("click",async()=>{confirm("Excluir esta tarefa?")&&(await b.from("tasks").delete().eq("id",s.dataset.id),window._lpLoadTasks(e))})})};window.openInlineTaskForm=function(e){var o;const t=document.getElementById("rd-lp-tarefas");if(!t)return;const n=new Date;n.setDate(n.getDate()+1),n.setHours(9,0,0,0);const a=n.getFullYear()+"-"+String(n.getMonth()+1).padStart(2,"0")+"-"+String(n.getDate()).padStart(2,"0")+"T"+String(n.getHours()).padStart(2,"0")+":"+String(n.getMinutes()).padStart(2,"0");t.innerHTML='<form class="rd-lp-task-form" id="rd-lp-task-form"><div class="rd-lp-task-form-row"><input type="text" id="rd-lp-task-title" placeholder="O que precisa ser feito?" required></div><div class="rd-lp-task-form-row"><textarea id="rd-lp-task-desc" placeholder="Descrição (opcional)" rows="2"></textarea></div><div class="rd-lp-task-form-row rd-lp-task-form-grid"><label><span>Quando</span><input type="datetime-local" id="rd-lp-task-date" value="'+a+'"></label><label><span>Prioridade</span><select id="rd-lp-task-prio"><option value="low">Baixa</option><option value="medium" selected>Média</option><option value="high">Alta</option></select></label></div><div class="rd-lp-task-form-actions"><button type="button" class="rd-lp-task-cancel">Cancelar</button><button type="submit" class="rd-lp-task-save">Criar tarefa</button></div></form>',(o=document.getElementById("rd-lp-task-title"))==null||o.focus(),t.querySelector(".rd-lp-task-cancel").onclick=()=>window._lpLoadTasks(e),document.getElementById("rd-lp-task-form").addEventListener("submit",async i=>{var I;i.preventDefault();const l=i.target.querySelector(".rd-lp-task-save");l.disabled=!0,l.textContent="Salvando…";const s=document.getElementById("rd-lp-task-title").value.trim();if(!s){l.disabled=!1,l.textContent="Criar tarefa";return}const r=document.getElementById("rd-lp-task-desc").value.trim(),c=document.getElementById("rd-lp-task-date").value,d=document.getElementById("rd-lp-task-prio").value,p=typeof y<"u"&&(y==null?void 0:y.tenant_id)||null,u=typeof y<"u"&&(y==null?void 0:y.id)||null,x={lead_id:e,tenant_id:p,assigned_to:u,title:s,description:r||null,due_date:c?new Date(c).toISOString():null,priority:d,status:"pending"},{error:E}=await b.from("tasks").insert(x);if(E){l.disabled=!1,l.textContent="Criar tarefa",alert("Erro: "+E.message);return}typeof A=="function"&&A("✓ Tarefa criada","success"),window._lpLoadTasks(e),(I=window._lpLoadTimeline)==null||I.call(window,e)})};window.openInlineNoteForm=function(e){const t=document.getElementById("rd-lp-timeline");if(!t)return;const n=t.innerHTML;t.innerHTML='<form class="rd-lp-note-form" id="rd-lp-note-form"><textarea id="rd-lp-note-body" rows="3" placeholder="Escreva sua anotação…" required></textarea><div class="rd-lp-note-actions"><button type="button" class="rd-lp-note-cancel">Cancelar</button><button type="submit" class="rd-lp-note-save">Salvar anotação</button></div></form>'+n;const a=document.getElementById("rd-lp-note-body");a==null||a.focus(),t.querySelector(".rd-lp-note-cancel").onclick=()=>window._lpLoadTimeline(e),document.getElementById("rd-lp-note-form").addEventListener("submit",async o=>{o.preventDefault();const i=o.target.querySelector(".rd-lp-note-save");i.disabled=!0,i.textContent="Salvando…";const l=a.value.trim();if(!l){i.disabled=!1,i.textContent="Salvar anotação";return}const s=typeof y<"u"&&(y==null?void 0:y.tenant_id)||null,r=typeof y<"u"&&(y==null?void 0:y.id)||null,c=typeof y<"u"&&((y==null?void 0:y.full_name)||(y==null?void 0:y.email))||"Você",{error:d}=await b.from("lead_notes").insert({lead_id:e,tenant_id:s,author_id:r,author_name:c,body:l});if(d){i.disabled=!1,i.textContent="Salvar anotação",alert("Erro: "+d.message);return}typeof A=="function"&&A("✓ Anotação criada","success"),window._lpLoadTimeline(e)})};window._lpLoadTimeline=async function(e){const t=document.getElementById("rd-lp-timeline");if(!t)return;const n=(G||[]).find(c=>String(c.id)===String(e));if(!n)return;const[a,o]=await Promise.all([b.from("tasks").select("*").eq("lead_id",e).order("created_at",{ascending:!1}),b.from("lead_notes").select("*").eq("lead_id",e).order("created_at",{ascending:!1})]),i=a.data||[],l=o.data||[],s=[];l.forEach(c=>s.push({author:c.author_name||"Anotação",text:c.body,date:c.created_at,icon:"✍️",noteId:c.id})),i.filter(c=>c.status==="concluida"||c.status==="done").forEach(c=>{s.push({author:"Tarefa concluída",text:c.title+(c.description?`
`+c.description:""),date:c.updated_at||c.created_at,icon:"✅"})}),i.filter(c=>c.status!=="concluida"&&c.status!=="done").forEach(c=>{s.push({author:"Tarefa criada",text:c.title,date:c.created_at,icon:"📋"})}),n.notes&&s.push({author:"Anotação (antiga)",text:n.notes,date:n.updated_at||n.created_at,icon:"✍️"}),s.push({author:"Sistema",text:'Lead criado na etapa "'+(n.stage||"—")+'"',date:n.created_at,icon:"🌱"}),s.sort((c,d)=>new Date(d.date)-new Date(c.date));const r=c=>{if(!c)return"";try{const d=new Date(c);return String(d.getDate()).padStart(2,"0")+"/"+String(d.getMonth()+1).padStart(2,"0")+"/"+d.getFullYear()+" "+String(d.getHours()).padStart(2,"0")+":"+String(d.getMinutes()).padStart(2,"0")}catch{return c}};t.innerHTML=s.length?s.map(c=>'<div class="rd-leadpage-timeline-item'+(c.noteId?" is-note":"")+'"><div class="rd-leadpage-timeline-author">'+(c.icon||"")+" "+g(c.author)+(c.noteId?'<button class="rd-lp-note-del" data-note="'+c.noteId+'" title="Excluir anotação">×</button>':"")+'</div><div class="rd-leadpage-timeline-text">'+g(c.text)+'</div><div class="rd-leadpage-timeline-date">'+r(c.date)+"</div></div>").join(""):'<p style="color:#94a3b8;font-size:13px">Sem histórico ainda. Clique em "+ Criar anotação" pra começar.</p>',t.querySelectorAll(".rd-lp-note-del").forEach(c=>{c.onclick=async()=>{if(!confirm("Excluir esta anotação?"))return;const{error:d}=await b.from("lead_notes").delete().eq("id",c.dataset.note);if(d)return alert("Erro: "+d.message);typeof A=="function"&&A("Anotação excluída","success"),window._lpLoadTimeline(e)}})};window.buildGoogleCalendarUrl=function(e){if(!e)return"#";const t=encodeURIComponent(e.title||"Tarefa"),n=encodeURIComponent(e.description||""),a=i=>{const l=new Date(i);return l.getUTCFullYear()+String(l.getUTCMonth()+1).padStart(2,"0")+String(l.getUTCDate()).padStart(2,"0")+"T"+String(l.getUTCHours()).padStart(2,"0")+String(l.getUTCMinutes()).padStart(2,"0")+String(l.getUTCSeconds()).padStart(2,"0")+"Z"};let o="";if(e.due_date){const i=new Date(e.due_date),l=new Date(i.getTime()+30*60*1e3);o=`&dates=${a(i)}/${a(l)}`}return`https://calendar.google.com/calendar/render?action=TEMPLATE&text=${t}&details=${n}${o}`};window.VAPID_PUBLIC_KEY="BJ1ohvwEhxXoiQFU2qzMhRlww6deyPrmVsAxc97HCeQFVrkWoQZZ7ZdgSfYB02cq3Y89JEWWZ9avHBDEL03P-9k";function nn(e){const t="=".repeat((4-e.length%4)%4),n=(e+t).replace(/-/g,"+").replace(/_/g,"/"),a=atob(n);return new Uint8Array([...a].map(o=>o.charCodeAt(0)))}window.enablePushNotifications=async function(){try{if(!("serviceWorker"in navigator)||!("PushManager"in window))return alert("Seu navegador não suporta notificações push. Use Chrome ou Edge."),!1;if(await Notification.requestPermission()!=="granted")return alert("Permissão de notificação negada. Habilite nas configurações do navegador."),!1;const t=await navigator.serviceWorker.register("/sw.js");await navigator.serviceWorker.ready;let n=await t.pushManager.getSubscription();n||(n=await t.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:nn(window.VAPID_PUBLIC_KEY)}));const a={subscription:n.toJSON(),userId:typeof y<"u"&&(y==null?void 0:y.id)||null,tenantId:typeof y<"u"&&(y==null?void 0:y.tenant_id)||null,userAgent:navigator.userAgent};return(await fetch("/api/push-register",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(a)})).ok?(localStorage.setItem("pushEnabled","1"),typeof A=="function"&&A("🔔 Notificações ativadas!","success"),!0):(alert("Erro ao registrar push"),!1)}catch(e){return console.error("[Push] erro:",e),alert("Erro ao ativar notificações: "+e.message),!1}};window.maybePromptPush=function(){if(localStorage.getItem("pushEnabled")==="1"||localStorage.getItem("pushDismissed")==="1"||Notification.permission==="denied"||document.getElementById("push-prompt-banner"))return;const e=document.createElement("div");e.id="push-prompt-banner",e.innerHTML='🔔 <strong>Ative notificações</strong> para receber alertas de tarefas no PC/celular. <button id="push-prompt-yes" style="background:#06b6d4;color:#fff;border:none;padding:6px 14px;border-radius:6px;font-weight:600;cursor:pointer;margin-left:10px">Ativar</button><button id="push-prompt-no" style="background:transparent;border:none;color:#94a3b8;padding:6px 10px;cursor:pointer;margin-left:4px">Depois</button>',e.style.cssText="position:fixed;top:0;left:0;right:0;background:#fef3c7;border-bottom:1px solid #fde68a;padding:12px 20px;text-align:center;font-size:14px;color:#92400e;z-index:9999;box-shadow:0 2px 8px rgba(0,0,0,.05)",document.body.appendChild(e),document.getElementById("push-prompt-yes").onclick=async()=>{await window.enablePushNotifications()&&e.remove()},document.getElementById("push-prompt-no").onclick=()=>{localStorage.setItem("pushDismissed","1"),e.remove()}};window.closeLeadDetailPage=function(){var t;const e=document.getElementById("section-lead-detail");e&&e.classList.add("hidden"),(t=document.getElementById("section-funil"))==null||t.classList.remove("hidden")};window.closeLeadSidePanel=function(){const e=document.getElementById("rd-lead-sidepanel"),t=document.getElementById("rd-lead-sidepanel-backdrop");e&&(e.classList.remove("open"),setTimeout(()=>e.remove(),250)),t&&(t.style.opacity="0",setTimeout(()=>t.remove(),250))};function on(){const e=document.getElementById("kanban-board");e&&(e._kanbanListenersAttached||(e._kanbanListenersAttached=!0,e.addEventListener("click",t=>{var l;if(t.target.closest(".kanban-add-btn")){gt();return}const a=t.target.closest(".rd-card-task-btn");if(a){t.preventDefault();const s=a.dataset.lead;typeof qe=="function"?qe(null,s):console.warn("[Tarefa] openTarefaModal não disponível");return}const o=t.target.closest(".rd-card-info-btn");if(o){t.preventDefault();const s=(l=o.closest(".kanban-card"))==null?void 0:l.dataset.id;s&&typeof window.openLeadSidePanel=="function"&&window.openLeadSidePanel(s);return}if(t.target.closest("button, a, input, .rd-card-info-btn, .rd-card-task-btn, .rd-card-stars, .rd-card-status, [onclick]"))return;const i=t.target.closest(".kanban-card");if(i){const s=i.dataset.id;if(typeof window.openLeadSidePanel=="function")window.openLeadSidePanel(s);else{const r=G.find(c=>String(c.id)===String(s));r&&gt(r)}}}),e.addEventListener("dragstart",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");if(n){De=n.dataset.id,n.classList.add("dragging");try{t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",De)}catch{}}}),e.addEventListener("dragend",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");n&&n.classList.remove("dragging"),e.querySelectorAll(".kanban-col.drag-over").forEach(i=>i.classList.remove("drag-over"))}),e.addEventListener("dragover",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");!n||!De||(t.preventDefault(),t.dataTransfer.dropEffect="move",e.querySelectorAll(".kanban-col.drag-over").forEach(i=>{i!==n&&i.classList.remove("drag-over")}),n.classList.add("drag-over"))}),e.addEventListener("dragleave",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");n&&(n.contains(t.relatedTarget)||n.classList.remove("drag-over"))}),e.addEventListener("drop",async t=>{var r,c;const n=(c=(r=t.target).closest)==null?void 0:c.call(r,".kanban-col");if(!n)return;t.preventDefault(),n.classList.remove("drag-over");const a=n.dataset.stage,o=De;if(De=null,!o||!a)return;const i=G.find(d=>String(d.id)===String(o));if(!i||i.stage===a)return;const l=i.stage;i.stage=a,ie();const{error:s}=await b.from("leads").update({stage:a}).eq("id",o);s?(console.warn("[Kanban] erro ao mover:",s),i.stage=l,ie(),typeof A=="function"?A("Erro ao mover lead: "+s.message,"error"):alert("Erro ao mover lead. Tente de novo.")):typeof A=="function"&&A(`→ ${a}`,"success")})))}async function gt(e=null){var E,I,h;(E=document.getElementById("lead-detail-panel"))==null||E.remove();const t=!e,n=z(),{data:a}=await b.from("crm_tags").select("*").eq("tenant_id",n).order("name"),{data:o}=await b.from("crm_lead_statuses").select("*").eq("tenant_id",n).order("sort_order"),i=e!=null&&e.pipeline_id&&((I=V.find(f=>f.id===e.pipeline_id))==null?void 0:I.id)||O;function l(f){return ue.filter(S=>S.pipeline_id===f).map(S=>`<option value="${g(S.name)}" ${(e==null?void 0:e.stage)===S.name?"selected":""}>${g(S.name)}</option>`).join("")}const s=V.map(f=>`<option value="${f.id}" ${f.id===i?"selected":""}>${g(f.name)}</option>`).join(""),r=l(i),c=((e==null?void 0:e.phone)||"").replace(/\D/g,""),d=document.createElement("div");d.id="lead-detail-panel",d.style.cssText="position:fixed;top:0;right:0;bottom:0;width:420px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,.15);z-index:1000;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;",d.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(f=>{const $=(ye[f]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${g(f)}" style="background:${$}18;color:${$};border-color:${$}55;">${g(f)}<span class="ldp-tag-rm" data-tag="${g(f)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
      ...
      ${c?(()=>{const f=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${ee("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${c}?text=${f}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(d),requestAnimationFrame(()=>{d.style.transform="translateX(0)"}),Mn(d,a||[],ye);const p=d.querySelector("#ldp-pipe"),u=d.querySelector("#ldp-stage");p&&u&&p.addEventListener("change",()=>{const f=p.value,S=ue.filter($=>$.pipeline_id===f);u.innerHTML=S.map($=>`<option value="${$.name}">${$.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const x=()=>{d.style.transform="translateX(100%)",setTimeout(()=>d.remove(),250)};document.getElementById("ldp-close").addEventListener("click",x),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const f=document.getElementById("ldp-save"),S=document.getElementById("ldp-msg"),$=document.getElementById("ldp-name").value.trim();if(!$){S.style.color="#ef4444",S.textContent="Nome é obrigatório.";return}f.disabled=!0,f.textContent="Salvando…";const k=[...d.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(T=>T.dataset.tag),_=document.getElementById("ldp-pipe"),m=_?_.value:i||O,v=t?typeof At=="function"?At():{}:{},w={name:$,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:m||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:k,tenant_id:z(),...t?{utm_source:v.utm_source||null,utm_medium:v.utm_medium||null,utm_campaign:v.utm_campaign||null,utm_content:v.utm_content||null,utm_term:v.utm_term||null,fbclid:v.fbclid||null,gclid:v.gclid||null,fbp:v.fbp||null,fbc:v.fbc||null,landing_url:v.landing_url||null,user_agent:navigator.userAgent||null}:{}};let L;if(t?{error:L}=await b.from("leads").insert(w):{error:L}=await b.from("leads").update(w).eq("id",e.id),f.disabled=!1,f.textContent="💾 Salvar",L){S.style.color="#ef4444",S.textContent="Erro: "+L.message;return}S.style.color="#22c55e",S.textContent="✅ Salvo!",x(),H().catch(T=>console.warn("[Kanban] reload falhou:",T)),t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:w.name,email:w.email,phone:w.phone,tracking:v}).then(async T=>{if(T!=null&&T.ok){console.log("[CAPI] Lead enviado ao Meta:",T.event_id);try{await b.from("leads").update({capi_event_id:T.event_id,capi_sent_at:new Date().toISOString()}).eq("name",w.name).eq("phone",w.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(M){console.warn("[CAPI] falha ao salvar event_id:",M)}}else console.warn("[CAPI] não confirmado pelo Meta:",T)}).catch(T=>console.warn("[CAPI] erro:",T))}),(h=document.getElementById("ldp-delete"))==null||h.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await b.from("leads").delete().eq("id",e.id),x(),H())})}let F=[],Ot=!1,Se="pending";async function sn(){var e;window._tarefasRefreshTimer&&clearInterval(window._tarefasRefreshTimer),window._tarefasRefreshTimer=setInterval(()=>{const t=document.querySelector('.section[data-section="tarefas"]');!t||t.offsetParent===null||Pt().catch(()=>{})},3e4),!Ot&&(Ot=!0,await Pt(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>qe()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),Se=t.dataset.filter,Te()})}))}async function Pt(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=b.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}F=n||[],Te()}function ma(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function Te(){const e=document.getElementById("tarefas-list");if(!e)return;let t=F;if(Se==="pending"&&(t=F.filter(a=>a.status!=="done")),Se==="done"&&(t=F.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${Se==="done"?"✅":"📋"}</div>
      <p>${Se==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,l=a.checked?"done":"pending";await b.from("tasks").update({status:l}).eq("id",i);const s=F.find(r=>String(r.id)===i);s&&(s.status=l),Te()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await b.from("tasks").delete().eq("id",a.dataset.id),F=F.filter(i=>String(i.id)!==String(a.dataset.id)),Te())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,l=F.find(s=>String(s.id)===i);l&&qe(l)})})}function qe(e=null,t=null){var c,d,p,u;const n=document.getElementById("tarefa-modal-root");n&&n.remove();const a=!!e,o=(e==null?void 0:e.status)==="done",i=ma(e==null?void 0:e.due_date);i&&i.toLocaleDateString("pt-BR");let l="";if(e!=null&&e.due_date){const x=new Date(e.due_date);isNaN(x)||(l=x.getFullYear()+"-"+String(x.getMonth()+1).padStart(2,"0")+"-"+String(x.getDate()).padStart(2,"0")+"T"+String(x.getHours()).padStart(2,"0")+":"+String(x.getMinutes()).padStart(2,"0"))}const s=document.createElement("div");s.id="tarefa-modal-root",s.className="modal-backdrop",s.innerHTML=`
    <div class="modal" style="max-width:520px;">
      ...
      <div class="modal-body" style="padding:24px;">
        ...
        <form id="tarefa-form" style="display:flex;flex-direction:column;gap:16px;">
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input name="due_date" type="datetime-local" class="form-control" value="${l}">
            </div>
            <div class="form-group">
        ...
        ${e!=null&&e.due_date?`<div style="margin-top:16px;padding-top:16px;border-top:1px solid #e2e8f0;">
          <a href="${window.buildGoogleCalendarUrl(e)}" target="_blank" rel="noopener" class="btn-cancel" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;">
  ...
  `,document.body.appendChild(s);const r=()=>s.remove();(c=document.getElementById("tm-close"))==null||c.addEventListener("click",r),(d=document.getElementById("tm-cancel"))==null||d.addEventListener("click",r),s.addEventListener("click",x=>{x.target===s&&r()}),(p=document.getElementById("tm-toggle-done"))==null||p.addEventListener("click",async()=>{const x=o?"pending":"done";await b.from("tasks").update({status:x}).eq("id",e.id);const E=F.find(I=>String(I.id)===String(e.id));E&&(E.status=x),r(),x==="done"&&(Se="done",document.querySelectorAll(".tarefa-filter-btn").forEach(I=>{I.classList.toggle("active",I.dataset.filter==="done")})),Te()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var S,$;const x=document.getElementById("tarefa-form");if(!x.checkValidity()){x.reportValidity();return}const E=new FormData(x),I=document.getElementById("tm-save");I.disabled=!0,I.textContent="Salvando…";const h={title:(S=E.get("title"))==null?void 0:S.trim(),description:(($=E.get("description"))==null?void 0:$.trim())||null,due_date:E.get("due_date")?new Date(E.get("due_date")).toISOString():null,priority:E.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,lead_id:(e==null?void 0:e.lead_id)||t||null};let f;if(a){if({error:f}=await b.from("tasks").update(h).eq("id",e.id),!f){const k=F.findIndex(_=>String(_.id)===String(e.id));k>=0&&(F[k]={...F[k],...h})}}else{const{data:k,error:_}=await b.from("tasks").insert(h).select();f=_,!f&&(k!=null&&k[0])&&F.unshift(k[0])}if(I.disabled=!1,I.textContent=a?"Salvar":"Criar Tarefa",f){alert("Erro: "+f.message);return}r(),Te()})}async function dn(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(l=>`
      <div class="search-result-item" data-type="property" data-id="${l.id}">
        <div class="search-result-icon">🏠</div>
        <div>
          <div class="search-result-title">${g(l.title||"—")}</div>
          <div class="search-result-sub">${g(l.reference||"")} · ${g(l.city||"")}</div>
        </div>
      ...
      <div class="search-result-item" data-type="lead" data-id="${l.id}">
        <div class="search-result-icon">👤</div>
        <div>
          <div class="search-result-title">${g(l.name||"—")}</div>
          <div class="search-result-sub">${g(l.email||l.phone||"")}</div>
        </div>
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(l=>{l.addEventListener("click",()=>{var s;(s=document.getElementById("search-overlay"))==null||s.classList.add("hidden"),l.dataset.type==="lead"?de("contatos"):de("properties")})})}let se=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function rn(){var l;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=b.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(s=>!se.includes(String(s.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(s=>{const r=cn(s.created_at);return`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",s=>{s.preventDefault(),ne(),de("contatos")}),e.querySelectorAll(".notif-item").forEach(s=>{s.addEventListener("click",()=>{se.push(s.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(se)),s.classList.remove("unread"),ne(),de("contatos")})})}function ln(){var e;document.querySelectorAll(".notif-item").forEach(t=>se.push(t.dataset.id)),se=[...new Set(se)],localStorage.setItem("crm_notifs_read",JSON.stringify(se)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function cn(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function pn(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!se.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let te=[],U=1;const Ne=10;let Ut=!1;async function mn(){var t,n,a,o,i,l,s,r,c;window._contatosRefreshTimer&&clearInterval(window._contatosRefreshTimer),window._contatosRefreshTimer=setInterval(()=>{const d=document.querySelector('.section[data-section="contatos"]');!d||d.offsetParent===null||ft().catch(()=>{})},3e4),document.getElementById("section-contatos")&&(Ut||(Ut=!0,await ft(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{U=1,be()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",d=>{d.key==="Enter"&&(U=1,be())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>ua()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",fn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",vt),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",vt),(s=document.getElementById("download-template"))==null||s.addEventListener("click",d=>{d.preventDefault();const p=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),x=document.createElement("a");x.href=URL.createObjectURL(u),x.download="modelo_contatos.csv",x.click()}),(r=document.getElementById("import-csv-file"))==null||r.addEventListener("change",un),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",gn)))}async function ft(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;te=a||[],be()}function be(){var s,r,c;const e=(((s=document.getElementById("contato-search"))==null?void 0:s.value)||"").toLowerCase(),t=e?te.filter(d=>(d.name||"").toLowerCase().includes(e)||(d.email||"").toLowerCase().includes(e)||(d.phone||"").toLowerCase().includes(e)):te,n=t.length,a=Math.max(1,Math.ceil(n/Ne));U>a&&(U=a);const o=t.slice((U-1)*Ne,U*Ne),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(d=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const l=document.getElementById("contatos-pagination");if(l){const d=n===0?0:(U-1)*Ne+1,p=Math.min(U*Ne,n);l.innerHTML=`
    ...
    `,(r=l.querySelector("#pag-prev"))==null||r.addEventListener("click",()=>{U--,be()}),(c=l.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{U++,be()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(d=>{d.addEventListener("click",p=>{p.preventDefault();const u=d.dataset.id,x=te.find(E=>String(E.id)===String(u));x&&ua(x)})})}async function ua(e=null){var f,S,$,k,_,m;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:l}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",a).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),s=o||[],r=i||[],c=l||[],d=s.map(v=>v.id),{data:p}=d.length?await b.from("crm_stages").select("*").in("pipeline_id",d).order("sort_order"):{data:[]},u=p||[],x=(e==null?void 0:e.pipeline_id)||((f=s[0])==null?void 0:f.id)||"";function E(v){const w=u.filter(L=>L.pipeline_id===v);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(L=>`<option value="${g(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${g(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const I=document.createElement("div");I.id="contato-modal-root",I.className="modal-backdrop",I.innerHTML=`
  ...
  `,document.body.appendChild(I);const h=()=>I.remove();(S=document.getElementById("cm-close"))==null||S.addEventListener("click",h),($=document.getElementById("cm-cancel"))==null||$.addEventListener("click",h),I.addEventListener("click",v=>{v.target===I&&h()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",v=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=E(v.target.value))}),(_=document.getElementById("cm-delete"))==null||_.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await b.from("leads").delete().eq("id",e.id);const v=te.findIndex(w=>String(w.id)===String(e.id));v>=0&&te.splice(v,1),h(),be()}),(m=document.getElementById("cm-save"))==null||m.addEventListener("click",async()=>{var D,P,W,re,ge,Ae,Me;const v=document.getElementById("contato-form");if(!v.checkValidity()){v.reportValidity();return}const w=new FormData(v),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const B=w.getAll("tag"),C=w.get("pipeline_id")||null,T={name:(D=w.get("name"))==null?void 0:D.trim(),company:((P=w.get("company"))==null?void 0:P.trim())||null,email:((W=w.get("email"))==null?void 0:W.trim())||null,phone:((re=w.get("phone"))==null?void 0:re.trim())||null,job_title:((ge=w.get("job_title"))==null?void 0:ge.trim())||null,city_interest:((Ae=w.get("city_interest"))==null?void 0:Ae.trim())||null,notes:((Me=w.get("notes"))==null?void 0:Me.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:B,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let M;if(n){if({error:M}=await b.from("leads").update(T).eq("id",e.id),!M){const J=te.findIndex(Ee=>String(Ee.id)===String(e.id));J>=0&&(te[J]={...te[J],...T})}}else{const{data:J,error:Ee}=await b.from("leads").insert(T).select();M=Ee,!M&&(J!=null&&J[0])&&te.unshift(J[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",M){alert("Erro: "+M.message);return}h(),be()})}let Be=[];function un(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Be=a.target.result.split(`
`).filter(s=>s.trim()).slice(1).map(s=>{const[r,c,d,p,u]=s.split(",").map(x=>x.trim().replace(/^"|"$/g,""));return{name:r,email:c,phone:d,company:p,job_title:u}}).filter(s=>s.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Be.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=Be.length===0)},n.readAsText(t)}async function gn(){if(!Be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}vt(),await ft(),alert(`${t.length} contato(s) importados com sucesso!`)}function fn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function vt(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const vn="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function he(e){return(await fetch(vn,{method:"POST",headers:{Authorization:`Bearer ${Ba}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ft(e){var r,c,d,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await b.auth.getUser();n.value=(u==null?void 0:u.email)||""}const s=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=s),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const x=u.target.files[0];if(!x)return;const E=URL.createObjectURL(x);a&&(a.src=E,a.style.display=""),o&&(o.style.display="none")}),(r=document.getElementById("btn-change-password"))==null||r.addEventListener("click",async()=>{var f,S;const u=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",x=((S=document.getElementById("change-password-confirm"))==null?void 0:S.value)||"",E=document.getElementById("change-password-msg"),I=document.getElementById("btn-change-password");if(E&&(E.style.display="none"),u.length<12){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}if(u!==x){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}I&&(I.disabled=!0,I.textContent="Salvando…");const{error:h}=await b.auth.updateUser({password:u});I&&(I.disabled=!1,I.textContent="Salvar Nova Senha"),h?E&&(E.textContent="Erro: "+h.message,E.style.display=""):(E&&(E.style.color="#16a34a",E.textContent="Senha alterada com sucesso!",E.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var S;const u=t.value.trim();let x=(y==null?void 0:y.avatar_url)||"";const E=i==null?void 0:i.files[0],I=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",E)try{const $=await Ve(E,400,.85),k=`avatars/${y.id}-${Date.now()}.jpg`,{error:_}=await b.storage.from("imoveis").upload(k,$,{contentType:"image/jpeg",upsert:!0});if(!_){const{data:{publicUrl:m}}=b.storage.from("imoveis").getPublicUrl(k);x=m}}catch($){console.error("Avatar upload:",$)}const{error:h}=await b.from("profiles").update({name:u,avatar_url:x}).eq("id",y.id);if(l.disabled=!1,l.textContent=I,h){alert("Erro ao salvar perfil.");return}y={...y,name:u,avatar_url:x},tt(y);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((S=u[0])==null?void 0:S.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await at(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var S,$;const E=(S=document.getElementById("invite-email"))==null?void 0:S.value.trim(),I=($=document.getElementById("invite-password"))==null?void 0:$.value.trim(),h=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!E){alert("Informe o e-mail do corretor.");return}if(!I||I.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}h&&(h.disabled=!0,h.textContent="Criando…"),f&&(f.style.display="none");try{const k=await he({email:E,password:I,tenant_id:(y==null?void 0:y.tenant_id)||null});if(k.success){const _=document.getElementById("invite-email"),m=document.getElementById("invite-password");_&&(_.value=""),m&&(m.value=""),await at(),f&&(k.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${g(I)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(k.error||"Falha desconhecida"))}catch(k){alert("Erro ao criar acesso: "+k.message)}finally{h&&(h.disabled=!1,h.textContent="+ Criar Acesso")}});const x=document.getElementById("settings-locations-section");x&&(x.style.display=""),await je(),(d=document.getElementById("loc-add-city-btn"))==null||d.addEventListener("click",async()=>{const E=document.getElementById("loc-new-city"),I=E==null?void 0:E.value.trim();if(!I)return;const{error:h}=await b.from("locations").insert({type:"cidade",name:I});if(h){alert("Erro ao adicionar cidade.");return}E&&(E.value=""),await je(),$t()}),(p=document.getElementById("loc-add-neighborhood-btn"))==null||p.addEventListener("click",async()=>{var S;const E=parseInt((S=document.getElementById("loc-new-neighborhood-city"))==null?void 0:S.value,10),I=document.getElementById("loc-new-neighborhood"),h=I==null?void 0:I.value.trim();if(!E||!h){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await b.from("locations").insert({type:"bairro",name:h,parent_id:E});if(f){alert("Erro ao adicionar bairro.");return}I&&(I.value=""),await je()})}}async function at(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,s=o.id===(y==null?void 0:y.id),r=o.active!==!1,c=r?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',d=s?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{var l;(l=o.options[o.selectedIndex])!=null&&l.text,o.disabled=!0;const{error:i}=await b.from("profiles").update({role:o.value}).eq("id",o.dataset.uid);o.disabled=!1,i&&(console.warn("[Profiles] erro ao trocar role:",i),alert("Erro ao salvar: "+i.message))})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,l=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const s=await he({action:"toggle",userId:i,active:!l});s.success||alert("Erro: "+(s.error||"Falha desconhecida"))}catch(s){alert("Erro: "+s.message)}await at()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var s,r;const i=o.dataset.uid,l=((r=(s=o.closest(".corretor-item"))==null?void 0:s.querySelector(".corretor-name"))==null?void 0:r.textContent)||"este corretor";if(confirm(`Excluir "${l}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const c=await he({action:"delete",userId:i});c.success||alert("Erro ao excluir: "+(c.error||"Falha desconhecida"))}catch(c){alert("Erro: "+c.message)}await at()}})})}async function ga(){const{data:e,error:t}=await b.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(Oe=e||[],Oe)}function xe(){return Oe.filter(e=>e.type==="cidade")}function St(e){return Oe.filter(t=>t.type==="bairro"&&t.parent_id===e)}function $t(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=xe();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),t&&(e.value=t)}async function je(){await ga();const e=xe(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${g(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=Oe.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const l=e.find(s=>s.id===i.parent_id);return`
          <div class="loc-item">
            <div>
              <div class="loc-item-name">${g(i.name)}</div>
              ${l?`<div class="loc-item-sub">${g(l.name)}</div>`:""}
            </div>
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${g(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const l=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${l}" e todos os bairros vinculados?`))return;const{error:s}=await b.from("locations").delete().eq("id",i.dataset.id);if(s){alert("Erro ao excluir.");return}await je(),$t()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:l}=await b.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await je()})})}function Vt(){var n,a,o,i,l,s,r,c,d,p,u,x,E,I,h,f,S,$,k,_;document.querySelectorAll(".filter-btn").forEach(m=>{m.addEventListener("click",()=>{const v=m.closest(".filter-btns"),w=m.classList.contains("active");v.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),w||m.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var B;const m=(B=document.getElementById("f-city"))==null?void 0:B.value,v=xe().find(C=>C.name===m),w=v?St(v.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+w.map(C=>`<option value="${C.name}">${g(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Pe(kt(q))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const m=document.querySelector(".admin-filter-panel");if(m){m.querySelectorAll('input[type="text"], input[type="number"]').forEach(w=>{w.value=""}),m.querySelectorAll("select").forEach(w=>{w.selectedIndex=0});const v=document.getElementById("f-neighborhood");v&&(v.innerHTML='<option value="">Todos</option>'),m.querySelectorAll(".filter-btn.active").forEach(w=>w.classList.remove("active"))}Pe(q)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{de(m.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{de(m.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(m=>{m.addEventListener("click",v=>{v.stopPropagation();const w=m.closest(".topnav-dropdown");w==null||w.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==w&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(m=>m.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ye),(l=document.getElementById("modal-cancel"))==null||l.addEventListener("click",Ye),(s=document.getElementById("property-modal"))==null||s.addEventListener("click",m=>{m.target.id==="property-modal"&&Ye()}),(r=document.getElementById("btn-new-property"))==null||r.addEventListener("click",()=>{Y=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",oe="",Ue([]),ct("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await b.auth.signOut(),location.reload()}),(d=document.getElementById("view-prev"))==null||d.addEventListener("click",()=>{ae=(ae-1+ce.length)%ce.length,et()}),(p=document.getElementById("view-next"))==null||p.addEventListener("click",()=>{ae=(ae+1)%ce.length,et()}),(u=document.getElementById("view-modal-close"))==null||u.addEventListener("click",Xe),(x=document.getElementById("view-modal-close2"))==null||x.addEventListener("click",Xe),(E=document.getElementById("view-modal"))==null||E.addEventListener("click",m=>{m.target.id==="view-modal"&&Xe()}),(I=document.getElementById("view-modal-share"))==null||I.addEventListener("click",()=>{const m=document.getElementById("share-panel");if(!m)return;const v=m.style.display!=="none";m.style.display=v?"none":"block"}),(h=document.getElementById("share-whatsapp"))==null||h.addEventListener("click",()=>{var P,W,re;const m=(P=document.getElementById("share-link-input"))==null?void 0:P.value;if(!m)return;const v=Number((W=document.getElementById("share-panel"))==null?void 0:W.dataset.pid),w=q.find(ge=>ge.id===v),L=(w==null?void 0:w.title)||((re=document.getElementById("view-modal-title"))==null?void 0:re.textContent)||"Imóvel",B=w!=null&&w.price?` — ${Fe(w.price,"pt")}`:"",C=w!=null&&w.reference?` | Ref: ${w.reference}`:"",T=[w==null?void 0:w.neighborhood,w==null?void 0:w.city].filter(Boolean).join(", "),M=T?`
📍 ${T}`:"",D=encodeURIComponent(`Olha esse imóvel que encontrei: *${L}*${B}${C}${M}

${m}`);window.open("https://wa.me/?text="+D,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var v,w;const m=(v=document.getElementById("share-link-input"))==null?void 0:v.value;m&&((w=navigator.clipboard)==null||w.writeText(m),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(S=document.getElementById("share-email"))==null||S.addEventListener("click",()=>{var B,C;const m=(B=document.getElementById("share-link-input"))==null?void 0:B.value;if(!m)return;const v=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",w=encodeURIComponent("Imóvel: "+v),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+m);window.open("mailto:?subject="+w+"&body="+L,"_blank")}),($=document.getElementById("share-copy"))==null||$.addEventListener("click",()=>{var v;const m=document.getElementById("share-link-input");m&&((v=navigator.clipboard)==null||v.writeText(m.value).then(()=>{const w=document.getElementById("share-copy"),L=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var T;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const m=Number(document.getElementById("view-modal-edit").dataset.pid),v=q.find(M=>M.id===m);if(!v)return;Xe(),Y=v.id;const w=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=v.title||"",w.querySelector('[name="rua"]').value=v.rua||"",w.querySelector('[name="numero"]').value=v.numero||"",w.querySelector('[name="city"]').value=v.city||"",w.querySelector('[name="price"]').value=v.price||"",w.querySelector('[name="bedrooms"]').value=v.bedrooms||"",w.querySelector('[name="suites"]').value=v.suites||"",w.querySelector('[name="parking"]').value=v.parking||"",w.querySelector('[name="description"]').value=v.description||"",w.querySelector('[name="construction_status"]').value=v.construction_status||"",w.querySelector('[name="owner_name"]').value=v.owner_name||"",w.querySelector('[name="owner_phone"]').value=v.owner_phone||"",w.querySelector('[name="owner_email"]').value=v.owner_email||"",w.querySelector('[name="owner_notes"]').value=v.owner_notes||"",w.querySelector('[name="condominium"]').value=v.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=v.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=v.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const M=document.getElementById("adminNeighborhood");M&&(M.value=v.neighborhood||"")},50)),oe=v.cover_image||((T=v.images)==null?void 0:T[0])||"",Ue(v.images||[]),ct("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(m=>{m.addEventListener("click",()=>{var v;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),m.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(v=document.getElementById(`tab-${m.dataset.tab}`))==null||v.classList.remove("hidden")})}),(_=document.getElementById("admin-properties"))==null||_.addEventListener("click",m=>{if(m.target.closest(".action-btns"))return;const v=m.target.closest("tr");if(!v)return;const w=Number(v.dataset.id);if(!w)return;const L=q.find(B=>B.id===w);L&&Za(L)})}async function fa(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",z()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(l){const s=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let r=0;for(const c of l||"?")r=r*31+c.charCodeAt(0)&4294967295;return s[Math.abs(r)%s.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let l=-1;function s(r=-1){l=r;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=r>=0?"Editar Depoimento":"Novo Depoimento";const d=r>=0?n[r]:{};e.querySelector("#dep-stars").value=String(d.stars||5),e.querySelector("#dep-text").value=d.text||"",e.querySelector("#dep-name").value=d.name||"",e.querySelector("#dep-role").value=d.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>s(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",l=-1}),e.addEventListener("click",r=>{const c=r.target.closest("[data-edit]"),d=r.target.closest("[data-del]");if(c&&s(parseInt(c.dataset.edit)),d){const p=parseInt(d.dataset.del);confirm("Remover este depoimento?")&&(n.splice(p,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const r=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),d=e.querySelector("#dep-text").value.trim(),p=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),x=parseInt(e.querySelector("#dep-stars").value);if(!d||!p){alert("Preencha o depoimento e o nome.");return}r.disabled=!0,r.textContent="Salvando…";const E={stars:x,text:d,name:p,role:u};l>=0?n[l]=E:n.push(E);const I=await i();r.disabled=!1,r.textContent="Salvar",Q(c,I),I&&(e.querySelector("#dep-form-wrap").style.display="none",l=-1,o())})}async function i(){const l=JSON.stringify(n);return await We("testimonials",{pt:l,en:l,es:l})}o()}document.addEventListener("DOMContentLoaded",async()=>{var s,r,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const d=`imobi_tenant_${t}`,p=Je(d);if(p)Ie(p);else{let u=null;for(const x of[t,"www."+t]){const{data:E}=await b.from("tenants").select("id").eq("domain",x).maybeSingle();if(E!=null&&E.id){u=E;break}}u!=null&&u.id&&(Ie(u.id),rt(d,u.id,24*60*60*1e3))}}await Promise.all([La(),ga()]),Re=ee("company.whatsapp",Re),xt(),Ga(),Wa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&($t(),n.addEventListener("change",()=>{const d=xe().find(u=>u.name===n.value),p=d?St(d.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+p.map(u=>`<option value="${u.name}">${g(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const d=new URLSearchParams(window.location.hash.replace("#","")),p=new URLSearchParams(window.location.search),u=d.get("type")||p.get("type")||"",x=Zt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||p.has("code"),E=document.getElementById("password-reset-overlay");if(x){o.style.display="none",i&&i.classList.add("hidden"),E&&(E.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async h=>{var m,v;h.preventDefault();const f=((m=document.getElementById("new-password"))==null?void 0:m.value)||"",S=((v=document.getElementById("confirm-password"))==null?void 0:v.value)||"",$=document.getElementById("password-reset-msg"),k=h.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),f!==S){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:_}=await b.auth.updateUser({password:f});if(_){$&&($.textContent="Erro: "+_.message,$.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}window.location.href=window.location.pathname}),p.has("code")&&await b.auth.exchangeCodeForSession(p.get("code")??"");return}const{data:{session:I}}=await b.auth.getSession();if(I){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),st(),Vt(),Nt(),window.lucide&&lucide.createIcons(),y=await Mt(I.user.id),!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(y.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const h=document.getElementById("password-reset-overlay");h&&(h.style.display="flex"),(r=document.getElementById("password-reset-form"))==null||r.addEventListener("submit",async f=>{var v,w;f.preventDefault();const S=((v=document.getElementById("new-password"))==null?void 0:v.value)||"",$=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",k=document.getElementById("password-reset-msg"),_=f.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),S!==$){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}if(S.length<12){k&&(k.textContent="Mínimo 6 caracteres.",k.style.display="");return}_&&(_.disabled=!0,_.textContent="Salvando…");const{error:m}=await b.auth.updateUser({password:S});if(m){k&&(k.textContent="Erro: "+m.message,k.style.display=""),_&&(_.disabled=!1,_.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",y.id),window.location.href=window.location.pathname});return}Ie((y==null?void 0:y.tenant_id)||null),tt(y),zt(y),Dt(y.role),await Ze(),await Ft(y),window.lucide&&lucide.createIcons(),pn(),de("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const h=document.getElementById("login-form");h&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var $,k;const f=(k=($=h.querySelector('input[name="email"]'))==null?void 0:$.value)==null?void 0:k.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:S}=await b.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(S?"Erro: "+S.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),h.addEventListener("submit",async f=>{f.preventDefault();const S=h.querySelector('button[type="submit"]'),$=new FormData(h),k=$.get("email"),_=$.get("password");S&&(S.disabled=!0,S.textContent="Entrando…");try{if(await Ha(k,_)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),st(),Vt(),window.lucide&&lucide.createIcons();const{data:{session:v}}=await b.auth.getSession();if(y=v?await Mt(v.user.id):null,!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Nt(),Ie((y==null?void 0:y.tenant_id)||null),tt(y),zt(y),Dt(y.role),await Ze(),await Ft(y),window.lucide&&lucide.createIcons(),de("dashboard")}else alert("E-mail ou senha incorretos")}catch(m){alert("Erro ao fazer login: "+((m==null?void 0:m.message)||String(m)))}finally{S&&(S.disabled=!1,S.textContent="Entrar")}}))}}else st();await ve();const l=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Ct(l),Tt(Re),window._applyDynamicContent=Ct,window._applyWhatsAppLinks=Tt,document.querySelectorAll(".nav-dropdown-btn").forEach(d=>{var u;const p=(u=d.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");p&&d.addEventListener("click",x=>{x.stopPropagation(),p.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(E=>{E!==p&&E.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(d=>d.classList.remove("js-open"))})});async function yn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:l}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!l){const s=q.findIndex(r=>r.id===o.id);s>=0&&(q[s].reference=i),n++}}Pe(kt(q))}async function bn(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const l=await hn(i);a.push(l),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(l=>l.id===t.id);i>=0&&(q[i].images=a)}}Pe(kt(q))}}async function hn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,l=i?URL.createObjectURL(i):null;return new Promise(s=>{const r=new Image;r.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),d=1200;let p=r.width,u=r.height;p>d&&(u=Math.round(u*d/p),p=d),c.width=p,c.height=u;const x=c.getContext("2d");x.drawImage(r,0,0,p,u);const E=I=>{if(I){const h=Math.round(p*.18),f=Math.round(I.naturalHeight*h/I.naturalWidth),S=Math.round(p*.02);x.globalAlpha=.45,x.drawImage(I,p-h-S,u-f-S,h,f),x.globalAlpha=1}c.toBlob(async h=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:S}=await b.storage.from("imoveis").upload(f,h,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(S){console.error("Upload watermark error:",S),s(e);return}const{data:{publicUrl:$}}=b.storage.from("imoveis").getPublicUrl(f);s($)}catch(f){console.error("Watermark upload exception:",f),s(e)}},"image/jpeg",.82)};if(l){const I=new Image;I.onload=()=>{URL.revokeObjectURL(l),E(I)},I.onerror=()=>{URL.revokeObjectURL(l),E(null)},I.src=l}else E(null)},r.onerror=()=>{URL.revokeObjectURL(a),s(e)},r.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function Q(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function _t(e,t="assets"){const n=await Ve(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("co-logo-url").addEventListener("input",o=>{document.getElementById("co-logo-preview").src=o.target.value||"/logo.png"}),document.getElementById("co-logo-file").addEventListener("change",async o=>{const i=o.target.files[0];if(i)try{const l=await _t(i,"logos");document.getElementById("co-logo-url").value=l,document.getElementById("co-logo-preview").src=l}catch(l){alert("Erro no upload: "+l.message)}}),document.getElementById("co-save-identity").addEventListener("click",async()=>{const o=document.getElementById("co-save-identity");o.disabled=!0,o.textContent="Salvando…";const i=await _e([["company.name",document.getElementById("co-name").value.trim()],["company.creci",document.getElementById("co-creci").value.trim()],["company.logo_url",document.getElementById("co-logo-url").value.trim()],["company.favicon_url",document.getElementById("co-favicon-url").value.trim()]]);i&&xt(),o.disabled=!1,o.textContent="Salvar Identidade",Q(document.getElementById("co-identity-msg"),i)}),document.getElementById("co-save-contacts").addEventListener("click",async()=>{const o=document.getElementById("co-save-contacts");o.disabled=!0,o.textContent="Salvando…";const i=document.getElementById("co-whatsapp").value.trim(),l=await _e([["company.whatsapp",i],["company.phone",document.getElementById("co-phone").value.trim()],["company.email",document.getElementById("co-email").value.trim()],["company.address",document.getElementById("co-address").value.trim()]]);l&&i&&(Re=i),o.disabled=!1,o.textContent="Salvar Contatos",Q(document.getElementById("co-contacts-msg"),l)}),document.getElementById("co-save-social").addEventListener("click",async()=>{const o=document.getElementById("co-save-social");o.disabled=!0,o.textContent="Salvando…";const i=await _e([["company.instagram_url",document.getElementById("co-instagram").value.trim()],["company.facebook_url",document.getElementById("co-facebook").value.trim()],["company.youtube_url",document.getElementById("co-youtube").value.trim()],["company.tiktok_url",document.getElementById("co-tiktok").value.trim()],["company.linkedin_url",document.getElementById("co-linkedin").value.trim()]]);o.disabled=!1,o.textContent="Salvar Redes Sociais",Q(document.getElementById("co-social-msg"),i)})}async function ya(){const e=document.getElementById("section-visual");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(d=>{n[d.key]=d.value||""});const a=n["visual.accent_color"]||"#b8962e",o=n["visual.primary_bg"]||"#0f1c2e",i=n["visual.secondary_bg"]||"#1a2f4a",l=n["visual.hero_bg_url"]||"",s=n["visual.price_max_slider"]||13e7;e.innerHTML=`
    ...
    <div class="cfg-card">
      ...
      <div class="form-group" style="margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px">
          <input id="vis-hero-url" class="form-control" value="${g(l)}" placeholder="https://... ou deixe vazio para padrão">
          <label class="btn-secondary" style="cursor:pointer;white-space:nowrap;padding:8px 14px;font-size:13px">
        ...
        <div id="vis-hero-preview" style="margin-top:10px;display:${l?"":"none"}">
          <img src="${g(l)}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">
        </div>
      </div>
      <div class="form-group" style="margin-bottom:0">
  ...
  `;function r(d,p,u){const x=document.getElementById(d),E=document.getElementById(p);x==null||x.addEventListener("input",I=>{E.value=I.target.value,u()}),E==null||E.addEventListener("input",I=>{/^#[0-9a-fA-F]{6}$/.test(I.target.value)&&(x.value=I.target.value,u())})}function c(){var p,u,x,E;const d=((p=document.getElementById("col-accent-hex"))==null?void 0:p.value)||"#b8962e";(u=document.getElementById("vp-bar"))==null||u.style.setProperty("background",d),(x=document.getElementById("vp-dot"))==null||x.style.setProperty("background",d),(E=document.getElementById("vp-btn"))==null||E.style.setProperty("background",d),document.documentElement.style.setProperty("--accent",d)}r("col-accent","col-accent-hex",c),r("col-primary","col-primary-hex",()=>{}),r("col-secondary","col-secondary-hex",()=>{}),c(),document.getElementById("vis-hero-file").addEventListener("change",async d=>{const p=d.target.files[0];if(p)try{const u=await _t(p,"hero");document.getElementById("vis-hero-url").value=u;const x=document.getElementById("vis-hero-preview");x.innerHTML=`<img src="${u}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,x.style.display=""}catch(u){alert("Erro no upload: "+u.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const d=document.getElementById("visual-save-colors");d.disabled=!0,d.textContent="Salvando…";const p=await _e([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);p&&xt(),d.disabled=!1,d.textContent="Salvar Cores",Q(document.getElementById("visual-colors-msg"),p)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",c())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const d=document.getElementById("visual-save-images");d.disabled=!0,d.textContent="Salvando…";const p=await _e([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);d.disabled=!1,d.textContent="Salvar Imagens",Q(document.getElementById("visual-images-msg"),p)})}async function ba(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("*").eq("tenant_id",z()),n={};t==null||t.forEach(r=>{n[r.key]=r});const a=(r,c)=>{var d;return g(((d=n[r])==null?void 0:d[`value_${c}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},l=r=>o.map(c=>`<button class="content-tab${c===r?" active":""}" data-lang="${c}">${i[c]}</button>`).join(""),s=r=>`
  ...
  `,document.getElementById("sc-tabs").addEventListener("click",r=>{var d;const c=r.target.closest(".content-tab");c&&(document.querySelectorAll("#sc-tabs .content-tab").forEach(p=>p.classList.remove("active")),document.querySelectorAll("#sc-panels .content-panel").forEach(p=>p.classList.remove("active")),c.classList.add("active"),(d=document.querySelector(`#sc-panels [data-panel="${c.dataset.lang}"]`))==null||d.classList.add("active"))}),document.getElementById("sc-save-btn").addEventListener("click",async()=>{const r=document.getElementById("sc-save-btn");r.disabled=!0,r.textContent="Salvando…";const c={};document.querySelectorAll(".sc-field").forEach(p=>{const u=p.dataset.key,x=p.dataset.lang;c[u]||(c[u]={}),c[u][x]=p.value});let d=!0;for(const[p,u]of Object.entries(c))await We(p,{pt:u.pt,en:u.en,es:u.es})||(d=!1);r.disabled=!1,r.textContent="Salvar Conteúdo",Q(document.getElementById("sc-save-msg"),d)}),document.getElementById("seo-save-btn").addEventListener("click",async()=>{const r=document.getElementById("seo-save-btn");r.disabled=!0,r.textContent="Salvando…";const c=document.getElementById("seo-title").value.trim(),d=document.getElementById("seo-desc").value.trim(),p=await We("seo.title_pt",{pt:c,en:c,es:c})&&await We("seo.description_pt",{pt:d,en:d,es:d});r.disabled=!1,r.textContent="Salvar SEO",Q(document.getElementById("seo-save-msg"),p)})}async function ha(){const e=document.getElementById("section-crm-config");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
...
Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await b.from("crm_stages").delete().eq("pipeline_id",E),await b.from("crm_pipelines").delete().eq("id",E),O=null,await j())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const m=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,w=parseInt(document.getElementById("crm-pipe-sel").value,10);m&&(await b.from("crm_stages").insert({pipeline_id:w,name:m,color:v,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-stage").value="",await j())}),e.querySelectorAll(".stage-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await b.from("crm_stages").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".stage-name-input").forEach(m=>{m.addEventListener("blur",async()=>{const v=m.value.trim(),w=m.dataset.orig;if(!v||v===w){m.value=w;return}m.disabled=!0;const{error:L}=await b.from("crm_stages").update({name:v}).eq("id",m.dataset.sid);if(m.disabled=!1,L){console.warn("[Etapas] erro ao renomear:",L),m.value=w,alert("Erro ao renomear: "+L.message);return}m.dataset.orig=v,m.style.background="#dcfce7",setTimeout(()=>{m.style.background=""},800)}),m.addEventListener("keydown",v=>{v.key==="Enter"&&(v.preventDefault(),m.blur()),v.key==="Escape"&&(m.value=m.dataset.orig,m.blur())})}),document.getElementById("crm-stages-list");let I=null;e.querySelectorAll(".stage-draggable").forEach(m=>{m.addEventListener("dragstart",v=>{I=m,m.classList.add("stage-dragging"),v.dataTransfer.effectAllowed="move";try{v.dataTransfer.setData("text/plain",m.dataset.id)}catch{}}),m.addEventListener("dragend",()=>{m.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(v=>v.classList.remove("stage-drop-over"))}),m.addEventListener("dragover",v=>{v.preventDefault(),v.dataTransfer.dropEffect="move",m!==I&&(e.querySelectorAll(".stage-drop-over").forEach(w=>w.classList.remove("stage-drop-over")),m.classList.add("stage-drop-over"))}),m.addEventListener("dragleave",()=>{m.classList.remove("stage-drop-over")}),m.addEventListener("drop",async v=>{if(v.preventDefault(),!I||m===I)return;const w=I.dataset.id,L=m.dataset.id,B=d.findIndex(D=>String(D.id)===String(w)),C=d.findIndex(D=>String(D.id)===String(L));if(B<0||C<0)return;const T=d.splice(B,1)[0];d.splice(C,0,T);const M=d.map((D,P)=>b.from("crm_stages").update({sort_order:P}).eq("id",D.id));I=null,await Promise.all(M).catch(D=>console.warn("[stages] erro reordenar:",D)),await j()})}),e.querySelectorAll(".stage-color-pick").forEach(m=>{m.addEventListener("change",async v=>{await b.from("crm_stages").update({color:v.target.value}).eq("id",m.dataset.sid);const w=m.closest(".stage-item").querySelector(".stage-color-dot");w&&(w.style.background=v.target.value)})});const h=async()=>{const m=document.getElementById("crm-new-tag"),v=document.getElementById("crm-new-tag-color"),w=m==null?void 0:m.value.trim(),L=(v==null?void 0:v.value)||"#6366F1";if(!w){m==null||m.focus();return}await b.from("crm_tags").insert({name:w,color:L,tenant_id:z()}),m&&(m.value=""),await j()};(k=document.getElementById("crm-add-tag"))==null||k.addEventListener("click",h),(_=document.getElementById("crm-new-tag"))==null||_.addEventListener("keydown",m=>{m.key==="Enter"&&h()}),e.querySelectorAll(".tm-del-btn").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await b.from("crm_tags").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-name-input").forEach(m=>{const v=m.closest(".tm-row"),w=v==null?void 0:v.querySelector(".tm-save-btn");w&&(w.style.display="none"),m.addEventListener("input",()=>{const L=m.value.trim()!==m.dataset.orig;w&&(w.style.display=L?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(m=>{const v=m.closest(".tm-row"),w=v==null?void 0:v.querySelector(".tm-color-swatch"),L=v==null?void 0:v.querySelector(".tm-save-btn");m.addEventListener("input",B=>{w&&(w.style.background=B.target.value),L&&(L.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(m=>{m.style.display="none",m.addEventListener("click",async()=>{var B,C;const v=m.closest(".tm-row"),w=(B=v.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),L=(C=v.querySelector(".tm-color-input"))==null?void 0:C.value;w&&(m.disabled=!0,m.textContent="✓ Salvando…",await b.from("crm_tags").update({name:w,color:L}).eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-tpl-btn").forEach(m=>{m.addEventListener("click",async()=>{const v=m.dataset.name,w=m.dataset.color;m.disabled=!0,m.innerHTML="✓",await b.from("crm_tags").insert({name:v,color:w,tenant_id:z()}),await j()})}),e.querySelectorAll(".tag-chip-del").forEach(m=>{m.addEventListener("click",async()=>{await b.from("crm_tags").delete().eq("id",m.dataset.id),await j()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const m=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,w=document.getElementById("crm-new-status-final").checked;m&&(await b.from("crm_lead_statuses").insert({name:m,color:v,is_final:w,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-status").value="",await j())}),e.querySelectorAll(".status-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover este status?")&&(await b.from("crm_lead_statuses").delete().eq("id",m.dataset.id),await j())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var w;const m=(w=prompt("Nome do novo funil:"))==null?void 0:w.trim();if(!m)return;const{error:v}=await b.from("crm_pipelines").insert({name:m,sort_order:99,tenant_id:z()});if(v){alert("Erro ao criar funil: "+v.message);return}mt=!1,await j()})}async function xa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("integrations").select("*"),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=s=>{var r;return g(((r=n[s])==null?void 0:r.value)||"")},o=s=>{var r;return(r=n[s])!=null&&r.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],l=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var p;const s=document.getElementById("intg-save-tracking");s.disabled=!0,s.textContent="Salvando…";let r=!0;const c=document.querySelectorAll(".intg-val"),d=document.querySelectorAll(".intg-toggle");for(let u=0;u<c.length;u++){const x=c[u].dataset.key,E=c[u].value.trim(),I=((p=d[u])==null?void 0:p.checked)??!1;await ot(x,E,I)||(r=!1)}s.disabled=!1,s.textContent="Salvar Integrações",Q(document.getElementById("intg-tracking-msg"),r)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const s=document.getElementById("intg-save-smtp");s.disabled=!0,s.textContent="Salvando…";const r=document.querySelectorAll(".smtp-field");let c=!0;for(const p of r)await ot(p.dataset.key,p.value.trim(),!0)||(c=!1);const d=document.getElementById("smtp-pass").value;d&&(await ot("smtp_pass",d,!0)||(c=!1)),s.disabled=!1,s.textContent="Salvar SMTP",Q(document.getElementById("intg-smtp-msg"),c)})}async function wa(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await yt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var r,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let s=0;for(const d of a){l.textContent=`Enviando ${s+1}/${a.length}…`,i.style.width=`${Math.round(s/a.length*100)}%`;try{const p=await _t(d,"media"),u=d.name.replace(/\.[^.]+$/,"").slice(0,60);await b.from("media_library").insert({name:u,url:p,type:"image",size:d.size,created_by:(c=(r=(await b.auth.getUser()).data)==null?void 0:r.user)==null?void 0:c.id})}catch(p){console.error("Media upload error:",p)}s++}i.style.width="100%",l.textContent=`✓ ${s} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await yt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function yt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await b.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(r=>r.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(r=>r.classList.add("hidden")),l.classList.add("active");const s=e.querySelector(`#sa-panel-${l.dataset.tab}`);s&&s.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&me(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&wn(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Xt(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Gt(),l.dataset.tab==="platform"&&Wt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Xt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",me),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Gt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>In()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",En),me(),Wt())}async function me(){var s,r;const e=document.getElementById("sa-tenants-list"),t=((r=(s=document.getElementById("sa-tenant-search"))==null?void 0:s.value)==null?void 0:r.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=b.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var d,p;return!t||((d=c.name)==null?void 0:d.toLowerCase().includes(t))||((p=c.slug)==null?void 0:p.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var d;return`
    <div class="sa-list-row" data-action="open-panel" data-id="${c.id}" style="cursor:pointer;" title="Clique para gerenciar">
      <div class="sa-list-info">
        ...
        <div>
          ...
          <div class="sa-list-sub">${g(c.slug||"")} · ${g(((d=c.plans)==null?void 0:d.name)||"Sem plano")}</div>
        </div>
      </div>
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async d=>{d.stopPropagation();const p=c.dataset.active==="true";await b.from("tenants").update({active:!p}).eq("id",c.dataset.id),me()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const d=(i||[]).find(p=>String(p.id)===String(c.dataset.id));d&&Sn(d)})})}async function wn(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await b.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),b.from("plans").select("id, name").then(({data:c})=>{const d=document.getElementById("nt-plan");d&&c&&(d.innerHTML='<option value="">Sem plano</option>'+c.map(p=>`<option value="${p.id}">${g(p.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const d=document.getElementById("nt-slug");d&&!d.dataset.manual&&(d.value=kn(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(s=document.getElementById("nt-cancel"))==null||s.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(r=document.getElementById("nt-save"))==null||r.addEventListener("click",async()=>{var _,m,v,w,L,B,C,T,M,D,P,W;const c=(m=(_=document.getElementById("nt-name"))==null?void 0:_.value)==null?void 0:m.trim(),d=(w=(v=document.getElementById("nt-slug"))==null?void 0:v.value)==null?void 0:w.trim(),p=(B=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:B.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,x=(M=(T=document.getElementById("nt-admin-email"))==null?void 0:T.value)==null?void 0:M.trim(),E=(P=(D=document.getElementById("nt-admin-password"))==null?void 0:D.value)==null?void 0:P.trim(),I=document.getElementById("nt-msg"),h=document.getElementById("nt-save");if(!c||!d){I.textContent="❌ Nome e slug são obrigatórios.",I.style.color="#ef4444";return}if(!x){I.textContent="❌ Informe o e-mail do admin.",I.style.color="#ef4444";return}if(!E||E.length<12){I.textContent="❌ A senha precisa ter mínimo 6 caracteres.",I.style.color="#ef4444";return}h.disabled=!0,h.textContent="Criando…",I.textContent="⏳ Criando imobiliária…",I.style.color="#64748b";const{data:f,error:S}=await b.from("tenants").insert({name:c,slug:d,domain:p||null,plan_id:u||null,active:!0}).select();if(S){h.disabled=!1,h.textContent="Criar Imobiliária",I.textContent="❌ "+S.message,I.style.color="#ef4444";return}const $=(W=f==null?void 0:f[0])==null?void 0:W.id;I.textContent="⏳ Criando usuário admin…";const k=await he({email:x,password:E,role:"admin",tenant_id:$});if(!(k!=null&&k.success)){h.disabled=!1,h.textContent="Criar Imobiliária",I.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g((k==null?void 0:k.error)||"Desconhecido"),I.style.color="#f59e0b",n(),me().catch(()=>{});return}$&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await b.from("profiles").update({tenant_id:$}).eq("id",k.user_id),h.disabled=!1,h.textContent="Criar Imobiliária",k.email_sent===!1?(I.innerHTML=`
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${d.map(u=>{const[x,E]=p(u.stage||u.status||"").split(","),I=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${x};color:${E};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${g(u.stage||u.status||"Novo")}</span></td>
      ...
      </div>`,(l=n.querySelector("#tp-add-corretor"))==null||l.addEventListener("click",()=>pt(e.id,a)),n.querySelectorAll(".tp-role-sel").forEach(u=>{u.addEventListener("change",async()=>{const x=u.dataset.uid;u.disabled=!0,await b.from("profiles").update({role:u.value}).eq("id",x),u.disabled=!1})}),n.querySelectorAll(".tp-user-toggle").forEach(u=>{u.addEventListener("click",async()=>{const x=u.dataset.uid,E=u.dataset.active==="1";u.disabled=!0,u.textContent="…",await b.from("profiles").update({active:!E}).eq("id",x),a()})}),n.querySelectorAll(".tp-user-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este usuário da imobiliária? O acesso ao sistema será excluído permanentemente.")&&(u.disabled=!0,u.textContent="…",await he({action:"delete",userId:u.dataset.uid}),a())})})}if(t==="api"){const d="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api",p=(e.domain||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim(),u=p?`https://${p}`:`https://omarcorretor.com.br/demo.html?key=${e.id}`,x=p?"🌐 Site da Imobiliária":"🌐 Site Demonstração",E=p?"Site oficial da imobiliária integrado ao CRM.":"Mostre ao cliente como o site integrado funciona com os imóveis desta imobiliária.",I=p?"Abrir site →":"Abrir site demo →";n.innerHTML=`
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          <h3 style="font-size:15px;font-weight:700;color:#0f172a;margin:0 0 4px;">${x}</h3>
      ...
      </div>`,(s=document.getElementById("tp-copy-key"))==null||s.addEventListener("click",()=>{var S;(S=navigator.clipboard)==null||S.writeText(e.id);const h=document.getElementById("tp-copy-key"),f=h.textContent;h.textContent="✅ Copiada!",setTimeout(()=>{h.textContent=f},2e3)})}if(t==="config"){const{data:d}=await b.from("settings").select("key,value").eq("tenant_id",e.id),p={};d==null||d.forEach(x=>{p[x.key]=x.value});const u=(x,E)=>`
      <div style="margin-bottom:14px;">
        <div style="font-size:11px;font-weight:700;color:#94a3b8;letter-spacing:.06em;margin-bottom:4px;">${x}</div>
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>Ea(e))}}function Ea(e){var c,d,p,u,x,E,I,h;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
          ...
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([f,S,$])=>`
            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                ...
                <code style="font-size:11px;color:#0f172a;">/public-api/${S}?key=CHAVE</code>
              </div>
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:f})=>{const S=document.getElementById("et-plan");S&&f&&(S.innerHTML='<option value="">Sem plano</option>'+f.map($=>`<option value="${$.id}"${String($.id)===String(e.plan_id)?" selected":""}>${g($.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",f=>{const S=f.target.files[0];if(!S)return;const $=URL.createObjectURL(S),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${$}" style="width:100%;height:100%;object-fit:cover;">`)}),(d=document.getElementById("et-logo-preview"))==null||d.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(p=document.getElementById("et-pwd-toggle"))==null||p.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var k,_;const f=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!f)return;(_=navigator.clipboard)==null||_.writeText(f);const S=document.getElementById("et-copy-key"),$=S.textContent;S.textContent="✅ Copiada!",setTimeout(()=>{S.textContent=$},2e3)});const o=["dados","config","api"];function i(f){o.forEach(S=>{document.getElementById(`et-pane-${S}`).style.display=S===f?"":"none";const $=document.getElementById(`et-tab-${S}`);$.style.borderBottomColor=S===f?"#2563eb":"transparent",$.style.color=S===f?"#2563eb":"#64748b",$.style.fontWeight=S===f?"600":"500"}),f==="config"&&s()}o.forEach(f=>{var S;return(S=document.getElementById(`et-tab-${f}`))==null?void 0:S.addEventListener("click",()=>i(f))});let l=!1;async function s(){var $;if(l)return;l=!0;const{data:f}=await b.from("settings").select("key,value").eq("tenant_id",e.id),S={};f==null||f.forEach(k=>{S[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${g(S["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${g(S["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${g(S["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${g(S["company.city"]||S["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${g(S["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
    ...
    `,($=document.getElementById("et-cfg-save"))==null||$.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),_=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",_.textContent="",_.style.color="#64748b";const m=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),v=document.getElementById("et-cfg-phone").value.trim(),w=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await b.from("settings").upsert([{key:"company.whatsapp",value:m,tenant_id:e.id},{key:"company.phone",value:v,tenant_id:e.id},{key:"company.email",value:w,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",C?(_.textContent="❌ "+C.message,_.style.color="#ef4444"):(_.textContent="✅ Configurações salvas!",_.style.color="#22c55e")})}const r=()=>n.remove();(x=document.getElementById("et-close"))==null||x.addEventListener("click",r),(E=document.getElementById("et-cancel"))==null||E.addEventListener("click",r),n.addEventListener("click",f=>{f.target===n&&r()}),(I=document.getElementById("et-delete"))==null||I.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const S=document.getElementById("et-delete");S.disabled=!0,S.textContent="Excluindo…";const{error:$}=await b.from("tenants").delete().eq("id",e.id);if($){alert("Erro ao excluir: "+$.message),S.disabled=!1,S.textContent="🗑️ Excluir";return}r(),me()}),(h=document.getElementById("et-save"))==null||h.addEventListener("click",async()=>{var T,M,D,P,W,re,ge,Ae,Me,J,Ee,Lt;const f=(M=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:M.trim(),S=(P=(D=document.getElementById("et-slug"))==null?void 0:D.value)==null?void 0:P.trim(),$=(re=(W=document.getElementById("et-domain"))==null?void 0:W.value)==null?void 0:re.trim(),k=(ge=document.getElementById("et-plan"))==null?void 0:ge.value,_=(Me=(Ae=document.getElementById("et-admin-email"))==null?void 0:Ae.value)==null?void 0:Me.trim(),m=(Ee=(J=document.getElementById("et-admin-password"))==null?void 0:J.value)==null?void 0:Ee.trim(),v=(Lt=document.getElementById("et-logo-input"))==null?void 0:Lt.files[0],w=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!f){w.textContent="❌ Nome é obrigatório.",w.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",w.textContent="⏳ Salvando…",w.style.color="#64748b";let B=e.logo_url;if(v)try{const N=await Ve(v,256,.85),Bt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:$a}=await b.storage.from("imoveis").upload(Bt,N,{contentType:"image/jpeg",upsert:!0});if(!$a){const{data:{publicUrl:_a}}=b.storage.from("imoveis").getPublicUrl(Bt);B=_a}}catch(N){console.error("Logo upload:",N)}const{error:C}=await b.from("tenants").update({name:f,slug:S||e.slug,domain:$||null,plan_id:k||null,logo_url:B}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",w.textContent="❌ "+C.message,w.style.color="#ef4444";return}if(_&&m&&m.length>=6){w.textContent="⏳ Criando usuário admin…";const N=await he({email:_,password:m,role:"admin",tenant_id:e.id});N!=null&&N.success?(N!=null&&N.user_id&&!(N!=null&&N.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",N.user_id),w.textContent="✅ Salvo e admin criado!",w.style.color="#22c55e"):(w.textContent="⚠️ Salvo, mas erro ao criar admin: "+((N==null?void 0:N.error)||"Tente novamente"),w.style.color="#f59e0b")}else w.textContent="✅ Imobiliária atualizada!",w.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{r(),me()},1200)})}const Jt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let nt=[],we=[],Ke={};function _n(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ln)}function Ln(){nt=[],we=[],Ke={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),ka();const t=document.getElementById("import-drop-zone"),n=document.getElementById("import-file-input");function a(i){i.preventDefault()}document.addEventListener("dragover",a),document.addEventListener("drop",a),t.addEventListener("click",()=>n.click()),t.addEventListener("dragenter",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragover",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragleave",i=>{t.contains(i.relatedTarget)||(t.style.borderColor="#c7d2e0",t.style.background="")}),t.addEventListener("drop",i=>{var s,r;i.preventDefault(),t.style.borderColor="#c7d2e0",t.style.background="";const l=(r=(s=i.dataTransfer)==null?void 0:s.files)==null?void 0:r[0];l&&Yt(l)}),n.addEventListener("change",i=>{var s;const l=(s=i.target.files)==null?void 0:s[0];l&&Yt(l),i.target.value=""});const o=new MutationObserver(()=>{document.getElementById("import-leads-overlay")||(document.removeEventListener("dragover",a),document.removeEventListener("drop",a),o.disconnect())});o.observe(document.body,{childList:!0})}async function ka(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await b.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${g(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Yt(e){if(!e)return;const t=document.getElementById("import-file-status"),n=document.getElementById("import-upload-error");n.style.display="none";const a=e.name.toLowerCase();if(t.textContent=`📄 ${e.name} (${(e.size/1024).toFixed(1)} KB)`,a.endsWith(".csv")){const o=new FileReader;o.onload=i=>{const l=Bn(i.target.result);if(l.error){n.textContent=l.error,n.style.display="";return}we=l.headers,nt=l.rows,Ia()},o.readAsText(e,"UTF-8")}else if(a.endsWith(".xlsx")||a.endsWith(".xls")){const o=new FileReader;o.onload=i=>Cn(i.target.result),o.readAsArrayBuffer(e)}else n.textContent="Formato não suportado. Use CSV ou XLSX.",n.style.display=""}function Bn(e){const t=e.split(`
`)[0]||"",n=t.split(";").length>t.split(",").length?";":",",a=e.split(`
`).map(s=>s.trimEnd()).filter(s=>s.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(s){const r=[];let c="",d=!1;for(let p=0;p<s.length;p++){const u=s[p];u==='"'?d&&s[p+1]==='"'?(c+='"',p++):d=!d:u===n&&!d?(r.push(c.trim()),c=""):c+=u}return r.push(c.trim()),r}const i=o(a[0]).map(s=>s.replace(/^["']+|["']+$/g,"")),l=a.slice(1).map(o);return{headers:i,rows:l}}async function Cn(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,l)=>{const s=document.createElement("script");s.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",s.onload=i,s.onerror=l,document.head.appendChild(s)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}we=o[0].map(String),nt=o.slice(1),Ia()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function Tn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function Ia(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+we.map((a,o)=>`<option value="${o}">${g(a)}</option>`).join("");e.innerHTML=Jt.map(a=>{const o=Tn(we,t[a.key]||[]);return Ke[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Jt.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Ke[a.key]!==""&&(o.value=Ke[a.key])}),qn(),ka()}function qn(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=nt.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${we.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${g(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${we.map((i,l)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${g(String(o[l]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function An(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Mn(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),l=e.querySelector("#ldp-tag-search"),s=e.querySelector("#ldp-tag-opt-list"),r=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),d=e.querySelector("#ldp-tag-new-name"),p=e.querySelector("#ldp-tag-new-color"),u=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function x(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map($=>$.dataset.tag)}function E($){if(!$.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=$.map(k=>{const m=(n[k]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${g(k)}" style="background:${m}18;color:${m};border-color:${m}55;">
        ${g(k)}<span class="ldp-tag-rm" data-tag="${g(k)}">×</span>
      </span>`}).join("")}function I($=""){const k=x(),_=$.toLowerCase().trim(),m=t.filter(v=>!_||v.name.toLowerCase().includes(_));if(!m.length){s.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}s.innerHTML=m.map(v=>{const w=k.includes(v.name);return`<div class="ldp-tag-opt${w?" active":""}" data-tag="${g(v.name)}" style="--tc:${v.color}">
      ...
      </div>`}).join("")}function h(){i.classList.remove("hidden"),I(""),l.value="",c.classList.add("hidden"),l.focus()}function f(){i.classList.add("hidden")}o.addEventListener("click",$=>{$.stopPropagation(),i.classList.contains("hidden")?h():f()}),document.addEventListener("mousedown",function $(k){e.contains(k.target)||(f(),document.removeEventListener("mousedown",$))}),i.addEventListener("mousedown",$=>$.stopPropagation()),l.addEventListener("input",()=>I(l.value)),s.addEventListener("click",$=>{const k=$.target.closest(".ldp-tag-opt");if(!k)return;const _=k.dataset.tag,m=x();m.includes(_)?E(m.filter(v=>v!==_)):E([...m,_]),I(l.value)}),a.addEventListener("click",$=>{const k=$.target.closest(".ldp-tag-rm");if(!k)return;const _=k.dataset.tag;E(x().filter(m=>m!==_))}),r.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||d.focus()});async function S(){const $=d.value.trim();if(!$){d.focus();return}const k=p.value||"#6366F1";if(t.some(_=>_.name.toLowerCase()===$.toLowerCase())){d.style.borderColor="#ef4444",setTimeout(()=>{d.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:_,error:m}=await b.from("crm_tags").insert({name:$,color:k,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(m)throw m;const v={id:_.id,name:_.name,color:_.color};t.push(v),n[v.name]=v,typeof ye<"u"&&(ye[v.name]=v),E([...x(),v.name]),I(l.value),d.value="",p.value="#6366F1",c.classList.add("hidden")}catch(_){console.error("Error creating tag:",_),alert("Erro ao criar tag: "+(_.message||_))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",S),d.addEventListener("keydown",$=>{$.key==="Enter"&&S()})}async function zn(){var h;const e=document.getElementById("section-dashboard");if(!e)return;if(e.dataset.dbInit==="1"){try{window._dbLeadsChartInstance&&(window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null)}catch{}try{window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)}catch{}}e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-kpis db-kpis-6">
    ${["db-kpi-indigo","db-kpi-vgv","db-kpi-emerald","db-kpi-amber","db-kpi-sky","db-kpi-pink"].map((f,S)=>`
    <div class="db-kpi ${f}" id="db-kpi-${S}">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],l=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],s=`${i[n.getDay()]}, ${n.getDate()} de ${l[n.getMonth()]} de ${n.getFullYear()}`,r=((h=y==null?void 0:y.name)==null?void 0:h.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${R(r)}</span> 👋`);const d=document.getElementById("db-subline");d&&(d.textContent=`Aqui está o resumo do seu negócio — ${s}`);let p=[],u=[];try{const[f,S]=await Promise.all([ta(),Dn()]);p=f||[],u=S||[]}catch(f){console.warn("[Dashboard] Erro ao carregar dados:",f)}Nn(p,u,n);const x=p.filter(f=>f.published).length,E=u.filter(f=>ht(f.created_at)===ht(n.toISOString())).length,I=document.getElementById("db-header-chips");I&&(I.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${s.split(",")[0]}
    </span>`),Hn(u,p),On(p),Pn(p,u,n),Un(p,u);try{await An(),Kt(u,7),jn(u),document.querySelectorAll(".db-ptab").forEach(f=>{f.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach($=>$.classList.remove("active")),f.classList.add("active");const S=parseInt(f.dataset.p);window._dbSelectedDays=S,Kt(u,S)})})}catch(f){console.warn("[Dashboard] Chart.js não carregou:",f)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const f=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!f||f.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function R(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ht(e){return(e||"").slice(0,10)}function Sa(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function ke(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function Dn(){let e=b.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(y==null?void 0:y.role)==="corretor"?e=e.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function Nn(e,t,n){const a=e.length,o=e.filter(k=>k.published).length,i=t.length,l=t.filter(k=>!k.converted_at&&!k.lost_at&&k.stage).length;function s(k){if(k==null)return 0;if(typeof k=="number")return k;let m=String(k).trim().replace(/[^\d,.]/g,"");m.includes(",")&&m.lastIndexOf(",")>m.lastIndexOf(".")?m=m.replace(/\./g,"").replace(",","."):m=m.replace(/\./g,"");const v=parseFloat(m);return isNaN(v)?0:v}const r=e.filter(k=>k.published).reduce((k,_)=>k+s(_.price),0),c=new Date(n);c.setDate(c.getDate()-30);const d=t.filter(k=>k.converted_at&&new Date(k.converted_at)>=c).length,p=new Date(n);p.setDate(p.getDate()-30);const u=new Date(n);u.setDate(u.getDate()-60);const x=e.filter(k=>k.created_at&&new Date(k.created_at)>=p).length,E=e.filter(k=>k.created_at&&new Date(k.created_at)>=u&&new Date(k.created_at)<p).length,I=t.filter(k=>k.created_at&&new Date(k.created_at)>=p).length,h=t.filter(k=>k.created_at&&new Date(k.created_at)>=u&&new Date(k.created_at)<p).length;function f(k,_,m){if(_===0&&k===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(_===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const v=Math.round((k-_)/_*100);return v===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':v>0?`<span class="db-kpi-trend db-trend-up">▲ +${v}% ${m}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${v}% ${m}</span>`}function S(k){return k>=1e6?"R$ "+(k/1e6).toFixed(k>=1e7?1:2).replace(".",",")+"M":k>=1e3?"R$ "+Math.round(k/1e3)+"K":"R$ "+Math.round(k).toLocaleString("pt-BR")}[{idx:0,val:ke(a),label:"Total de Imóveis",trend:f(x,E,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:S(r),label:"VGV Total",trend:r===0?'<span class="db-kpi-trend db-trend-neu">Sem imóveis publicados</span>':`<span class="db-kpi-trend db-trend-up">▲ ${o} imóveis</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'},{idx:2,val:ke(o),label:"Publicados",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:3,val:ke(i),label:"Leads Recebidos",trend:f(I,h,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:4,val:ke(l),label:"Em Negociação",trend:l===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos no funil</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>'},{idx:5,val:ke(d),label:"Vendas (30d)",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Aguardando primeira venda</span>':'<span class="db-kpi-trend db-trend-up">🎯 Fechadas</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>'}].forEach(({idx:k,val:_,label:m,trend:v,icon:w})=>{const L=document.getElementById(`db-kpi-${k}`);L&&(L.innerHTML=`
      <div class="db-kpi-icon">${w}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${_}</div>
        <div class="db-kpi-lbl">${R(m)}</div>
        ${v}
      </div>`)}),Rn(t)}function Rn(e){const t=document.getElementById("db-funnel-stages");if(!t)return;const n=e.filter(s=>!s.converted_at&&!s.lost_at),a={};n.forEach(s=>{const r=s.stage||"Sem etapa";a[r]=(a[r]||0)+1});const o=Object.entries(a).sort((s,r)=>r[1]-s[1]),i=n.length,l=Math.max(...o.map(s=>s[1]),1);if(!o.length){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">💼</div><div class="db-empty-text">Nenhum lead em negociação ainda</div></div>';return}t.innerHTML=o.map(([s,r])=>{const c=Math.round(r/l*100);return`<div class="db-funnel-row" onclick="navigateToSection('funil')">
    ...
    </div>`}).join("")+`<div class="db-funnel-total">Total ativo: <strong>${i}</strong> negociações</div>`}function Kt(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let s=t-1;s>=0;s--){const r=new Date(i);r.setDate(r.getDate()-s);const c=r.toISOString().slice(0,10),d=t<=7?r.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?r.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):r.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(d),o.push(e.filter(p=>ht(p.created_at)===c).length)}const l=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(s=>s===l&&l>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:s=>` ${s.parsed.y} lead${s.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(l/4))}}}}})}window._dbOriginChartInstance=null;function jn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const d=c.source||"Direto",p=d.charAt(0).toUpperCase()+d.slice(1);a[p]=(a[p]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),l=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],s=o.map((c,d)=>l[d%l.length]),r=i.reduce((c,d)=>c+d,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:s,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const d=r>0?Math.round(c.parsed/r*100):0;return` ${c.label}: ${c.parsed} (${d}%)`}}}}}}),n&&(r===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,d)=>`
    ...
    <tr>
      ...
      <td style="color:#64748B;font-size:12px;">${Sa(s.created_at,i)}</td>
      <td><button class="db-btn-view" onclick="navigateToSection('funil')">Ver Lead</button></td>
    </tr>`}).join("")}function On(e){const t=document.getElementById("db-top-props");if(!t)return;const n=[...e].sort((a,o)=>new Date(o.created_at)-new Date(a.created_at)).slice(0,6);if(n.length===0){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">🏠</div><div class="db-empty-text">Nenhum imóvel cadastrado ainda</div></div>';return}t.innerHTML=n.map((a,o)=>{const i=(()=>{try{return Array.isArray(a.images)?a.images:JSON.parse(a.images||"[]")}catch{return[]}})(),l=a.cover_image||i.find(u=>u&&u.startsWith("http"))||"",s=o===0?"rank-1":o===1?"rank-2":o===2?"rank-3":"",r=a.published?"pub":"rascunho",c=a.published?"Publicado":"Rascunho",d=[a.neighborhood,a.city].filter(Boolean).join(", ")||"—",p=a.price?`R$ ${String(a.price).replace(/[^0-9,.]/g,"")}`:"—";return`
    <div class="db-prop-item">
      <div class="db-prop-rank ${s}">${o+1}</div>
      ${l?`<img class="db-prop-thumb" src="${R(l)}" alt="" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">`:""}
    ...
    </div>`}).join("")}function Pn(e,t,n){var i;const a=document.getElementById("db-timeline");if(!a)return;const o=[];o.push({icon:"👤",cls:"tl-login",title:"Você entrou no sistema",meta:`Bem-vindo de volta, ${((i=y==null?void 0:y.name)==null?void 0:i.split(" ")[0])||"Corretor"}`,time:n.toISOString()}),t.slice(0,3).forEach(l=>{o.push({icon:"💬",cls:"tl-lead",title:`Novo lead: ${l.name||"Sem nome"}`,meta:`Origem: ${l.source||"Direto"} · ${l.phone||l.email||""}`,time:l.created_at})}),e.slice(0,3).forEach(l=>{const s=l.published?"Imóvel publicado":"Imóvel cadastrado";o.push({icon:"🏠",cls:"tl-prop",title:`${s}: ${l.title||"Sem título"}`,meta:`${l.city||""} · ${l.reference||""}`,time:l.created_at})}),o.sort((l,s)=>new Date(s.time)-new Date(l.time)),a.innerHTML=o.slice(0,8).map(l=>`
    <div class="db-tl-item">
      <div class="db-tl-icon ${l.cls}">${l.icon}</div>
      <div class="db-tl-body">
        <div class="db-tl-title">${R(l.title)}</div>
        ${l.meta?`<div class="db-tl-meta">${R(l.meta)}</div>`:""}
      </div>
      <div class="db-tl-time">${Sa(l.time,n)}</div>
    </div>`).join(""),o.length===0&&(a.innerHTML='<div class="db-empty"><div class="db-empty-icon">📋</div><div class="db-empty-text">Sem atividades recentes</div></div>')}function Un(e,t){const n=document.getElementById("db-portfolio");if(!n)return;const a=e.length,o=e.filter(c=>c.published).length,i=a-o,l=t.filter(c=>c.stage&&c.stage!=="perdido"&&c.stage!=="fechado").length,s=e.filter(c=>{try{const d=Array.isArray(c.collection)?c.collection:JSON.parse(c.collection||"[]");return d.includes("alto-padrao")||d.includes("lancamentos")||d.includes("decorados")}catch{return!1}}).length,r=[{icon:"✅",val:o,lbl:"Imóveis Ativos"},{icon:"📝",val:i,lbl:"Em Rascunho"},{icon:"🤝",val:l,lbl:"Em Negociação"},{icon:"⭐",val:s,lbl:"Em Coleções"}];n.innerHTML=r.map(c=>`
    <div class="db-port-card">
      <div class="db-port-icon">${c.icon}</div>
      <div class="db-port-val">${ke(c.val)}</div>
