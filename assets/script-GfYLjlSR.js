import{s as h}from"./supabase-BcuJ3xoD.js";const K="00000000-0000-0000-0000-000000000000";let fe={},Se={},pe=K;function ke(e){pe=e||K,fe={},Se={}}const M=()=>pe;async function _a(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",pe),h.from("site_content").select("*").eq("tenant_id",pe)]);if(e.data&&e.data.forEach(n=>{fe[n.key]=n.value}),t.data&&t.data.forEach(n=>{Se[n.key]=n}),(!t.data||t.data.length===0)&&pe!==K){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",K),h.from("site_content").select("*").eq("tenant_id",K)]);n.data&&n.data.forEach(o=>{fe[o.key]===void 0&&(fe[o.key]=o.value)}),a.data&&a.data.forEach(o=>{Se[o.key]||(Se[o.key]=o)})}}const ee=(e,t=null)=>fe[e]!==void 0?fe[e]:t,Me=(e,t="pt")=>{const n=Se[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Le(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:pe,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{fe[o]=i}),!a}async function Ge(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:pe,updated_at:o},{error:l}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return l||(Se[e]=i),pe!==K&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:K,updated_at:o},{onConflict:"key,tenant_id"}),!l}async function ot(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function xt(){const e=document.documentElement,t=ee("visual.accent_color","#b8962e"),n=ee("visual.primary_bg","#0f1c2e"),a=ee("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=ee("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=ee("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=i);const r=ee("visual.hero_bg_url","");if(r){const d=document.querySelector(".hero, .hero-v2");d&&(d.style.backgroundImage="url('"+r+"')")}}function Ct(e){e=e||"pt";const t=g=>Me(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),r=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),r&&t("inst.bio_p3")&&(r.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),s=document.querySelector('[data-i18n="inst.stat3_num"]'),p=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),w=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat1_num")&&(d.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),s&&t("inst.stat3_num")&&(s.innerHTML=t("inst.stat3_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),w&&t("inst.stat3_label")&&(w.innerHTML=t("inst.stat3_label"));const I=document.getElementById("dep-grid");if(I){const g=Me("testimonials",e)||Me("testimonials","pt");if(g)try{const $=JSON.parse(g);if(Array.isArray($)&&$.length>0){let E=function(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(m){let v=0;for(const x of m||"?")v=v*31+x.charCodeAt(0)&4294967295;return S[Math.abs(v)%S.length]};const S=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];I.innerHTML=$.map(m=>`
            <div class="dep-card-v2">
              <div class="dep-stars-v2">${"★".repeat(m.stars||5)}</div>
              <p class="dep-text-v2">"${E(m.text)}"</p>
              <div class="dep-author-v2">
                <div class="dep-avatar-v2" style="background:${L(m.name)}">${(m.name||"?")[0].toUpperCase()}</div>
                <div>
                  <div class="dep-name-v2">${E(m.name)}</div>
                  <div class="dep-role-v2">${E(m.role)}</div>
                </div>
              </div>
            </div>`).join("")}}catch{}}const k=Me("seo.title_pt",e);k&&(document.title=k);const y=Me("seo.description_pt",e);if(y){const g=document.querySelector('meta[name="description"]');g&&(g.content=y)}}function Tt(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Ba="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let Ne="5547999701743";const Ca="onknpbzdcrhbfozzvxtz.supabase.co",qt="/storage/v1/object/public/";function je(e){if(!e||typeof e!="string"||!window.__USE_CF_PROXY||!e.includes(Ca)||!e.includes(qt))return e;const t=window.location.hostname;if(t!=="omarcorretor.com.br"&&t!=="www.omarcorretor.com.br")return e;try{const n=new URL(e);return"https://omarcorretor.com.br"+n.pathname.replace(qt,"/img/")+n.search}catch{return e}}(function(){typeof window>"u"||window.location.hostname!=="omarcorretor.com.br"&&window.location.hostname!=="www.omarcorretor.com.br"||fetch("/img/healthz",{method:"HEAD",cache:"no-store"}).then(t=>{(t.headers.get("cf-ray")||t.headers.get("Cf-Ray"))&&(window.__USE_CF_PROXY=!0)}).catch(()=>{})})();function Ta(e){return Array.isArray(e)?e.map(je):e}const Ce=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],qa=5.7;function Ue(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/qa).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let q=[],b=null,He=[];const dt="imobi_lead_tracking",Qt=90*24*60*60*1e3;function Ye(e){try{const t=document.cookie?document.cookie.split("; "):[];for(const n of t){const a=n.indexOf("=");if(a<0)continue;if(n.slice(0,a)===e)return decodeURIComponent(n.slice(a+1))}return null}catch{return null}}function Aa(){if(typeof window>"u")return null;try{const e=new URLSearchParams(window.location.search),t={utm_source:e.get("utm_source"),utm_medium:e.get("utm_medium"),utm_campaign:e.get("utm_campaign"),utm_content:e.get("utm_content"),utm_term:e.get("utm_term"),fbclid:e.get("fbclid"),gclid:e.get("gclid"),fbp:Ye("_fbp"),fbc:Ye("_fbc"),landing_url:window.location.href,captured_at:Date.now()};if(t.fbclid&&!t.fbc){const i=Math.floor(Date.now()/1e3);t.fbc=`fb.1.${i}.${t.fbclid}`}const n=t.utm_source||t.utm_campaign||t.fbclid||t.gclid,a=localStorage.getItem(dt);let o=t;if(a)try{const i=JSON.parse(a);i&&i.captured_at&&Date.now()-i.captured_at<Qt&&!n&&(o={...i,fbp:t.fbp||i.fbp,fbc:t.fbc||i.fbc})}catch{}return localStorage.setItem(dt,JSON.stringify(o)),o}catch{return null}}function At(){try{const e=localStorage.getItem(dt);if(!e)return{};const t=JSON.parse(e);if(!t||!t.captured_at||Date.now()-t.captured_at>Qt)return{};const n=Ye("_fbp"),a=Ye("_fbc");return{utm_source:t.utm_source||null,utm_medium:t.utm_medium||null,utm_campaign:t.utm_campaign||null,utm_content:t.utm_content||null,utm_term:t.utm_term||null,fbclid:t.fbclid||null,gclid:t.gclid||null,fbp:n||t.fbp||null,fbc:a||t.fbc||null,landing_url:t.landing_url||null}}catch{return{}}}typeof window<"u"&&setTimeout(Aa,100);let Zt=!1;h.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Zt=!0)});function rt(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function We(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function ea({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:s,error:p}=await h.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return p&&console.error("Supabase select error:",p),s||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=M();if(!o||o===K){const s=We(a);if(s)o=s,ke(o);else{const p=t.replace(/^www\./,"");for(const u of[p,"www."+p]){const{data:w}=await h.from("tenants").select("id").eq("domain",u).maybeSingle();if(w!=null&&w.id){o=w.id,ke(o);break}}o&&o!==K&&rt(a,o,24*60*60*1e3)}}if(!o||o===K)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,l=5*60*1e3;if(!e){const s=We(i);if(s)return setTimeout(()=>ea({background:!0}),100),s}const{data:r,error:d}=await h.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(d)return console.error("Supabase select error:",d),We(i)||[];const c=r||[];return rt(i,c,l),e&&typeof ve=="function"&&ve().catch(()=>{}),c}async function ta(){let e=h.from("properties").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="super_admin"||(b!=null&&b.tenant_id?e=e.eq("tenant_id",b.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(q=t||[],vn(),yn(),q)}async function Ma(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await h.from("properties").update(a).eq("id",t);if(o)throw o;const i=q.findIndex(l=>l.id===t);i>=0&&(q[i]={...q[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await h.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&q.unshift(t[0])}}async function za(e){const{error:t}=await h.from("properties").delete().eq("id",e);if(t)throw t;q=q.filter(n=>n.id!==e)}const aa="imobi_sec_login_attempts",na=5,Da=15*60*1e3,oa=2*60*60*1e3;function ia(){try{const e=localStorage.getItem(aa);return e?JSON.parse(e):{count:0,blockedUntil:0}}catch{return{count:0,blockedUntil:0}}}function wt(e){try{localStorage.setItem(aa,JSON.stringify(e))}catch{}}function Na(){const e=ia();return e.blockedUntil&&Date.now()<e.blockedUntil?{blocked:!0,minutesLeft:Math.ceil((e.blockedUntil-Date.now())/6e4)}:(e.blockedUntil&&Date.now()>=e.blockedUntil&&wt({count:0,blockedUntil:0}),{blocked:!1})}function Ra(){const e=ia();return e.count=(e.count||0)+1,e.count>=na&&(e.blockedUntil=Date.now()+Da,e.count=0),wt(e),e}function ja(){wt({count:0,blockedUntil:0})}function R(e,t="info"){if(typeof document>"u")return;const n={info:"#0f172a",success:"#16a34a",error:"#dc2626",warn:"#d97706"},a=document.createElement("div");a.textContent=e,a.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:${n[t]||n.info};color:#fff;padding:12px 22px;border-radius:24px;font-size:14px;font-weight:600;z-index:99999;box-shadow:0 6px 24px rgba(0,0,0,0.25);opacity:0;transition:opacity 0.2s, bottom 0.3s;pointer-events:none;max-width:90vw;text-align:center;`,document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.bottom="40px"}),setTimeout(()=>{a.style.opacity="0",a.style.bottom="24px",setTimeout(()=>a.remove(),300)},3e3)}typeof window<"u"&&(window.toast=R);typeof window<"u"&&!window._shortcutsAttached&&(window._shortcutsAttached=!0,document.addEventListener("keydown",e=>{if(e.key==="Escape"&&(["property-modal","view-modal","lead-modal","tarefa-modal","import-modal","property-modal-create"].forEach(t=>{const n=document.getElementById(t);n&&!n.classList.contains("hidden")&&n.classList.add("hidden")}),document.querySelectorAll('.side-panel.open, [data-panel-open="true"]').forEach(t=>{t.classList.remove("open"),t.dataset.panelOpen="false"}),document.body.style.overflow=""),(e.metaKey||e.ctrlKey)&&e.key==="k"){const t=document.getElementById("global-search")||document.querySelector('input[type="search"]');t&&(e.preventDefault(),t.focus())}if((e.metaKey||e.ctrlKey)&&e.key==="s"){const t=document.querySelector('.modal:not(.hidden) button[type="submit"], .modal:not(.hidden) .btn-primary, .side-panel.open .btn-primary');t&&(e.preventDefault(),t.click())}}));typeof window<"u"&&!window._globalErrHandlerAttached&&(window._globalErrHandlerAttached=!0,window.addEventListener("unhandledrejection",e=>{console.warn("[CRM] Promise sem catch:",e.reason)}),window.addEventListener("error",e=>{e.error&&e.error.message&&console.warn("[CRM] Erro:",e.error.message)}));async function Ha(e,t){const n=Na();if(n.blocked)return alert(`🔒 Muitas tentativas falhas. Tente novamente em ${n.minutesLeft} minuto(s).`),!1;const{error:a}=await h.auth.signInWithPassword({email:e,password:t});if(a){const o=Ra();if(o.blockedUntil)alert("🔒 Login bloqueado por 15 minutos após 5 tentativas erradas.");else{const i=na-o.count;console.warn(`[SEC] Login falhou. ${i} tentativa(s) restante(s) antes do bloqueio.`)}return!1}return ja(),lt(),!0}let it=null;function lt(){try{localStorage.setItem("imobi_sec_last_activity",String(Date.now()))}catch{}it&&clearTimeout(it),it=setTimeout(async()=>{console.warn("[SEC] Inativo por 2h — fazendo logout automático.");try{await h.auth.signOut()}catch{}try{localStorage.removeItem("imobi_sec_last_activity")}catch{}alert("🔒 Sua sessão expirou por inatividade. Faça login de novo."),location.reload()},oa)}function Oa(){if(!(typeof window>"u")){["click","keydown","mousemove","touchstart","scroll"].forEach(e=>{window.addEventListener(e,()=>lt(),{passive:!0})});try{const e=parseInt(localStorage.getItem("imobi_sec_last_activity")||"0",10);if(e&&Date.now()-e>oa){console.warn("[SEC] Sessão já estava expirada ao carregar — fazendo logout."),h.auth.signOut().finally(()=>location.reload());return}}catch{}lt()}}h.auth.onAuthStateChange((e,t)=>{t&&t.user&&Oa()});function Fe(e,t=1e3,n=.7){return new Promise((a,o)=>{const i=new Image,l=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(l);const r=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c=Math.round(c*t/d),d=t),r.width=d,r.height=c;const s=r.getContext("2d");s.drawImage(i,0,0,d,c);const p=new Image;p.crossOrigin="anonymous",p.onload=()=>{const u=Math.round(d*.18),w=Math.round(p.naturalHeight*u/p.naturalWidth),I=Math.round(d*.02),k=d-u-I,y=c-w-I;s.globalAlpha=.45,s.drawImage(p,k,y,u,w),s.globalAlpha=1,r.toBlob(g=>g?a(g):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.onerror=()=>{r.toBlob(u=>u?a(u):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.src="/logo.png"},i.onerror=o,i.src=l})}async function Pa(e){const t=await Fe(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await h.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=h.storage.from("imoveis").getPublicUrl(n);return o}async function Ua(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Pa(n[o]));return a}function sa(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function da(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const l=a%i;o.dataset.idx=l;try{const d=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(d[l]){const c=o.querySelector(".carousel-img"),s=o.querySelector(".carousel-img-bg"),p=je(d[l]);c&&(c.src=p),s&&(s.src=p)}}catch{}const r=o.querySelectorAll(".icard-dot");if(r.length){const d=l%r.length;r.forEach((c,s)=>c.classList.toggle("active",s===d))}})}function Fa(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=d=>e.filter(c=>{if(c.collection){try{const p=JSON.parse(c.collection);if(Array.isArray(p))return p.includes(d)}catch{}if(c.collection===d)return!0}const s=((c.title||"")+" "+(c.description||"")).toLowerCase();return d==="frente-mar"?s.includes("frente mar")||s.includes("frente ao mar"):d==="decorados"?s.includes("decorad")||s.includes("mobiliado"):d==="casas-condominio"?(c.condominium||"").length>2:!1});function a(d,c,s,p){if(!s.length)return"";const u=s.slice(0,8).map(w=>kt(w)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),l=n("casas-condominio"),r=sa(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",l.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",l,"imoveis.html?collection=casas-condominio"):""].join(""),da(t,r),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",Et),t.addEventListener("touchend",function(d){const c=d.target.closest(".carousel-btn");c&&(d.preventDefault(),d.stopPropagation(),ra(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ve(){var w,I,k,y,g,$;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await ea();q=n,((w=document.getElementById("selecao-carousel"))==null?void 0:w.innerHTML)===""&&Va(n);const a=((I=document.getElementById("city-filter"))==null?void 0:I.value)||"",o=((k=document.getElementById("neighborhood-filter"))==null?void 0:k.value)||"",i=((y=document.getElementById("bedrooms-filter"))==null?void 0:y.value)||"",l=((g=document.getElementById("parking-filter"))==null?void 0:g.value)||"",r=(($=document.getElementById("construction-filter"))==null?void 0:$.value)||"",{min:d,max:c}=Xa(),s=n.filter(S=>{if(a&&S.city!==a||o&&S.neighborhood!==o||i&&(i==="4+"&&Number(S.bedrooms)<4||i!=="4+"&&Number(S.bedrooms)!==Number(i))||l&&(l==="4+"&&Number(S.parking)<4||l!=="4+"&&Number(S.parking)!==Number(l))||r&&S.construction_status!==r)return!1;const E=String(S.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(E,10)||0;return!(L<d||c!==1/0&&L>c)});if(e){Fa(n);return}if(!s.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const p=sa(t);t.innerHTML=s.map(S=>kt(S)).join(""),da(t,p);const u=document.getElementById("properties");u&&!u._carouselDelegated&&(u._carouselDelegated=!0,u.addEventListener("click",Et))}function Va(e){var o,i,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(r=>kt(r)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",Et));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(l=a==null?void 0:a.querySelector(".selecao-next"))==null||l.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ve()};function ra(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const l=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(l.length&&l[a]){const r=je(l[a]),d=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");d&&(d.src=r),c&&(c.src=r)}}catch{const r=q.find(u=>String(u.id)===String(e.dataset.pid)),d=(i=r==null?void 0:r.images)!=null&&i.length?r.images:Ce,c=e.querySelector(".carousel-img"),s=e.querySelector(".carousel-img-bg"),p=d[a]?je(d[a]):"";c&&p&&(c.src=p),s&&p&&(s.src=p)}const o=e.querySelectorAll(".icard-dot");if(o.length){const l=a%o.length;o.forEach((r,d)=>r.classList.toggle("active",d===l))}}function Et(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&ra(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Xa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Ga(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ve())}function Wa(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=xe();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=xe().find(i=>i.name===e.value),o=a?$t(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${f(i.name)}</option>`).join(""),ve()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ve)})}function Oe(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var l;const a=n.cover_image||((l=n.images)==null?void 0:l[0])||Ce[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
      ...
      <td class="cell-price">${f(Ue(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
    ...
    </tr>`}).join("")}}function Ja(){const e=document.getElementById("f-city");if(!e)return;const t=xe(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),n&&(e.value=n)}function Ka(){var e,t,n,a,o,i,l,r,d,c,s,p,u,w,I;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((l=document.getElementById("f-price-min"))==null?void 0:l.value)||0,priceMax:parseFloat((r=document.getElementById("f-price-max"))==null?void 0:r.value)||1/0,areaMin:parseFloat((d=document.getElementById("f-area-min"))==null?void 0:d.value)||0,areaMax:parseFloat((c=document.getElementById("f-area-max"))==null?void 0:c.value)||1/0,construction:((s=document.getElementById("f-construction"))==null?void 0:s.value)||"",published:((p=document.getElementById("f-published"))==null?void 0:p.value)||"",bedrooms:((u=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:u.dataset.val)||"",suites:((w=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:w.dataset.val)||"",parking:((I=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:I.dataset.val)||""}}function It(e){const t=Ka();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Qe(){if(!document.getElementById("admin-properties"))return;const e=await ta(),t=e.length,n=e.filter(l=>l.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Ja(),Oe(q)}let J=null,oe="",le=[];function ct(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden",(!history.state||history.state.modal!=="property")&&history.pushState({modal:"property"},"")}function Je(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow="",history.state&&history.state.modal==="property"&&history.back()}window._modalPopstateBound||(window._modalPopstateBound=!0,window.addEventListener("popstate",()=>{const e=document.getElementById("property-modal");e&&!e.classList.contains("hidden")&&(e.classList.add("hidden"),document.body.style.overflow="")}));function Pe(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(le=Array.isArray(e)?[...e]:[],!le.length){t.style.display="none";return}t.style.display="",n.innerHTML=le.map(a=>`
    ...
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".cover-delete")||(oe=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(i=>i.classList.remove("selected")),a.classList.add("selected"))})}),n.querySelectorAll(".cover-delete").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const i=a.closest(".cover-thumb-wrap"),l=i==null?void 0:i.dataset.url;l&&confirm("Remover esta foto do imóvel?")&&(le=le.filter(r=>r!==l),oe===l&&(oe=le[0]||""),Pe(le))})})}}function st(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var d;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const l=o.filter(c=>c.size>0);if(J&&(i=[...le]),l.length){t.disabled=!0,t.textContent=`Enviando 0/${l.length} foto…`;try{const c=await Ua(l,(s,p)=>{t.textContent=`Enviando ${s}/${p} foto…`});i=[...i,...c]}catch(c){console.error("Erro no upload:",c),t.disabled=!1,t.textContent=J?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}i.length||(i=[...Ce]);const r={...J?{id:J}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),state:a.get("state")||"",neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:oe||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",furnishing_status:a.get("furnishing_status")||"",furnished:a.get("furnishing_status")==="mobiliado",collection:JSON.stringify(["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].filter(c=>a.get(c)).map(c=>a.get(c))),tenant_id:J?((d=q.find(c=>c.id===J))==null?void 0:d.tenant_id)??(b==null?void 0:b.tenant_id)??null:(b==null?void 0:b.tenant_id)??null};try{await Ma(r),J=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const c=document.getElementById("adminPublished");c&&(c.value="true");const s=document.getElementById("adminNeighborhood");s&&(s.innerHTML='<option value="">Selecione a cidade primeiro</option>');const p=document.getElementById("adminConstructionStatus");p&&(p.value=""),oe="",Pe([]),Je(),await Qe()}catch(c){console.error(c),t.disabled=!1,t.textContent=J?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((c==null?void 0:c.message)||JSON.stringify(c)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await za(o),await Qe()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=q.find(s=>s.id===o);if(!i)return;J=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"";const l=e.querySelector('[name="state"]');l&&(l.value=i.state||""),e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const r=e.querySelector('[name="furnishing_status"]');if(r){const s=i.furnishing_status||(i.furnished===!0?"mobiliado":"vazio");r.value=s}try{const s=JSON.parse(i.collection||"[]");["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].forEach(p=>{const u=e.querySelector('[name="'+p+'"]');u&&(u.checked=s.includes(u.value))})}catch{}const d=document.getElementById("adminPublished");d&&(d.value=i.published===!0?"true":"false");const c=document.getElementById("adminCitySelect");c&&(c.value=i.city||"",c.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),oe=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Pe(i.images||[]),ct("Editar Imóvel")}})}function f(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Ya(e){return e?String(e).replace(/\s*\([A-Z]{2}\)\s*$/i,"").trim():""}function Qa(e,t,n){const a=[];e&&a.push(e);const o=Ya(t);return o&&a.push(o+(n?"/"+n:"")),a.join(", ")}function kt(e){var k;const t=(k=e.images)!=null&&k.length?e.images:Ce,n=Ta(t),a=n.length,o=je(e.cover_image||n[0]),i=Qa(e.neighborhood,e.city,e.state),l=Ue(e.price,window.currentLang||"pt"),r=`https://omarcorretor.com.br/property.html?id=${e.id}`,d=encodeURIComponent(`Olá! Tenho interesse no imóvel *${e.title}*${e.reference?` (Ref: ${e.reference})`:""}. Poderia me dar mais informações?
${r}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",s=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",p=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",w=Math.max(1,Math.min(a,6)),I=`<div class="icard-dots">${Array.from({length:w},(y,g)=>`<span class="icard-dot${g===0?" active":""}"></span>`).join("")}</div>`;return`
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ...
        <div class="icard-price-row">
          <div>
            ...
            <div class="icard-price">${f(l)}</div>
          </div>
        </div>
        <div class="icard-footer">
          <span class="icard-code">Cód. ${f(String(e.reference||e.id))}</span>
          <a href="https://wa.me/${Ne}?text=${d}" target="_blank" rel="noopener" class="icard-wa" title="WhatsApp" onclick="fbq('track', 'Contact')">
  ...
  `}let ce=[],ae=0;function Za(e){var p,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((p=e.images)==null?void 0:p[0])||Ce[0];document.getElementById("view-thumb-preview").src=i,ce=(u=e.images)!=null&&u.length?e.images:Ce,ae=0,Ze(),document.getElementById("view-price").textContent=Ue(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const l=document.getElementById("view-condominium-item"),r=document.getElementById("view-condominium");r&&(r.textContent=e.condominium||""),l&&(l.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(w=>w.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(w=>w.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=d);const s=document.getElementById("share-panel");s&&(s.style.display="none",s.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ve(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ze(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ce[ae],e.alt=`Foto ${ae+1}`;const i=ce.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${ae+1} / ${ce.length}`:"",o.innerHTML=i?ce.map((l,r)=>`<img src="${l}" class="view-thumb${r===ae?" active":""}" data-i="${r}" alt="Foto ${r+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{ae=+l.dataset.i,Ze()})})}async function Mt(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function et(e){var p,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const r=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),s=document.getElementById("avatar-dd-initial");r&&(r.textContent=i),d&&(d.textContent=l),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",s&&(s.style.display="none")):(s&&(s.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",s.style.display=""),c&&(c.style.display="none"))}async function zt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==K,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:l}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),r=window.location.hostname.replace(/^www\./,""),d=((l==null?void 0:l.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();d&&d!==r&&(t.href=`https://${d}`)}catch{}}const Xe={dashboard:()=>Mn(),empresa:()=>va(),visual:()=>ya(),"site-config":()=>ba(),"crm-config":()=>ha(),integracoes:()=>xa(),midia:()=>wa(),depoimentos:()=>fa()};function de(e){var n,a;e==="vendas"&&setTimeout(()=>ca().catch(()=>{}),50),e==="perdas"&&setTimeout(()=>pa().catch(()=>{}),50),document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Xe<"u"&&Xe[e]){const o=Xe[e];Xe[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),ne(),e==="contatos"&&pn(),e==="funil"&&an(),e==="tarefas"&&on()}function Dt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:wa,depoimentos:fa}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>hn(),{once:!0}),window.lucide&&lucide.createIcons()}}function ne(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function en(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",l=>{l.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var p,u;const l=((p=document.getElementById("cp-new"))==null?void 0:p.value)||"",r=((u=document.getElementById("cp-confirm"))==null?void 0:u.value)||"",d=document.getElementById("cp-msg"),c=document.getElementById("cp-save");if(d.style.display="none",l.length<12){d.style.color="#ef4444",d.textContent="Mínimo 6 caracteres.",d.style.display="";return}if(l!==r){d.style.color="#ef4444",d.textContent="As senhas não coincidem.",d.style.display="";return}c.disabled=!0,c.textContent="Salvando…";const{error:s}=await h.auth.updateUser({password:l});if(c.disabled=!1,c.textContent="Salvar Senha",s){d.style.color="#ef4444",d.textContent="Erro: "+s.message,d.style.display="";return}d.style.color="#16a34a",d.textContent="✅ Senha alterada com sucesso!",d.style.display="",setTimeout(n,1500)})}function tn(){var i,l,r,d,c;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(l=document.getElementById("cph-close"))==null||l.addEventListener("click",o),(r=document.getElementById("cph-cancel"))==null||r.addEventListener("click",o),t.addEventListener("click",s=>{s.target===t&&o()}),(d=document.getElementById("cph-file"))==null||d.addEventListener("change",s=>{const p=s.target.files[0];if(!p)return;const u=URL.createObjectURL(p),w=document.getElementById("cph-preview"),I=document.getElementById("cph-initial");w&&(w.src=u,w.style.display=""),I&&(I.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var w;const s=(w=document.getElementById("cph-file"))==null?void 0:w.files[0];if(!s)return;const p=document.getElementById("cph-save"),u=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const I=await Fe(s,400,.85),k=`avatars/${b.id}-${Date.now()}.jpg`,{error:y}=await h.storage.from("imoveis").upload(k,I,{contentType:"image/jpeg",upsert:!0});if(y)throw y;const{data:{publicUrl:g}}=h.storage.from("imoveis").getPublicUrl(k);await h.from("profiles").update({avatar_url:g}).eq("id",b.id),b={...b,avatar_url:g},et(b),o()}catch(I){u.style.color="#ef4444",u.textContent="Erro: "+I.message,u.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function pt(e,t){var i,l,r;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
    <div class="modal" style="max-width:440px;">
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(l=document.getElementById("ac-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",d=>{d.target===a&&o()}),(r=document.getElementById("ac-save"))==null||r.addEventListener("click",async()=>{var u,w,I;const d=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(w=document.getElementById("ac-password"))==null?void 0:w.value.trim(),s=document.getElementById("ac-save"),p=document.getElementById("ac-note");if(!d){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}s.disabled=!0,s.textContent="Criando…",p.style.display="none";try{const k=e||(b==null?void 0:b.tenant_id)||null,y=((I=document.getElementById("ac-role"))==null?void 0:I.value)||"corretor",g=await he({email:d,password:c,role:y,tenant_id:k});s.disabled=!1,s.textContent="+ Criar Acesso",g.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",g.email_sent===!1?(p.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${f(d)}<br><strong>Senha:</strong> ${f(c)}`,p.style.color="#0f172a"):(p.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",p.style.color="#16a34a"),p.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(g.error||"Falha desconhecida"))}catch(k){s.disabled=!1,s.textContent="+ Criar Acesso",alert("Erro: "+k.message)}})}function Nt(){var i,l,r,d,c,s,p,u,w,I,k;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",y=>{var $;y.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||($=document.getElementById("notif-dropdown"))==null||$.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",y=>{y.stopPropagation(),ne(),tn()}),(l=document.getElementById("avatar-dd-change-pass"))==null||l.addEventListener("click",y=>{y.stopPropagation(),ne(),en()}),(r=document.getElementById("avatar-dd-add-corretor"))==null||r.addEventListener("click",y=>{y.stopPropagation(),ne(),pt()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",y=>{y.stopPropagation(),ne(),de("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async y=>{y.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",y=>{var $;y.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||(($=document.getElementById("avatar-dropdown"))==null||$.classList.add("hidden"),dn())}),(s=document.getElementById("notif-mark-all"))==null||s.addEventListener("click",()=>{rn(),ne()}),(p=document.getElementById("btn-search-open"))==null||p.addEventListener("click",()=>{var y,g;(y=document.getElementById("search-overlay"))==null||y.classList.remove("hidden"),(g=document.getElementById("search-input"))==null||g.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var y;(y=document.getElementById("search-overlay"))==null||y.classList.add("hidden")}),(w=document.getElementById("search-overlay"))==null||w.addEventListener("click",y=>{y.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(I=document.getElementById("search-input"))==null||I.addEventListener("input",y=>{clearTimeout(o),o=setTimeout(()=>sn(y.target.value.trim()),280)}),(k=document.getElementById("search-input"))==null||k.addEventListener("keydown",y=>{var g;y.key==="Escape"&&((g=document.getElementById("search-overlay"))==null||g.classList.add("hidden"))}),document.addEventListener("click",ne)}let mt=!1,V=[],ue=[],Q=[],ye={},la=[],O=null,ze=null,Z={search:"",tags:new Set,status:""};async function an(){var t;if(setTimeout(()=>{typeof Ht=="function"&&Ht()},100),window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||H().catch(()=>{})},3e4),mt){await Rt();return}mt=!0,await Rt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>gt()),Sn();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{O=parseInt(e.value,10),await H()})}function ut(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+la.map(l=>`<option value="${f(l.name)}">${f(l.name)}</option>`).join(""),n.value=Z.status,n.onchange=()=>{Z.status=n.value,ie()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(l=>`<button class="kf-tag-btn${Z.tags.has(l.name)?" active":""}" data-tag="${f(l.name)}"
          style="--kf-tc:${l.color}">
          ${f(l.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(l=>{l.addEventListener("click",()=>{const r=l.dataset.tag;Z.tags.has(r)?Z.tags.delete(r):Z.tags.add(r),ut(e),ie()})})}const o=document.getElementById("kf-search");o&&(o.value=Z.search,o.oninput=()=>{Z.search=o.value.toLowerCase(),ie()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{Z={search:"",tags:new Set,status:""},ut(e),ie()})}async function Rt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);V=t||[],la=a||[],ye={},(n||[]).forEach(r=>{ye[r.name]=r});const o=V.map(r=>r.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};ue=i||[],ut(n||[]);const l=document.getElementById("funil-pipe-sel");if(l){const r=O;l.innerHTML=V.length?V.map(c=>`<option value="${c.id}">${f(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const d=V.find(c=>c.id===r)||V.find(c=>c.is_default)||V[0];d?(l.value=d.id,O=d.id):O=null}await H()}async function H(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1}).is("converted_at",null).is("lost_at",null);(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id)),O&&(t=t.eq("pipeline_id",O));const{data:n}=await t;Q=n||[],ie()}function ie(){try{const i=document.getElementById("leads-list-view");i&&!i.classList.contains("hidden")&&_e()}catch{}const e=document.getElementById("kanban-board");if(!e)return;const t=ue.filter(i=>i.pipeline_id===O);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=Z,a=Q.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const l=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(r=>l.includes(r)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var r,d,c,s;const l=i.stage||((r=t[0])==null?void 0:r.name);o[l]||(o[((d=t[0])==null?void 0:d.name)||""]=[]),(s=o[l]||o[(c=t[0])==null?void 0:c.name])==null||s.push(i)}),e.innerHTML=t.map(i=>{const l=o[i.name]||[],r=l.length?l.map(s=>{const p=(s.phone||"").replace(/\D/g,""),u=encodeURIComponent(`Olá ${s.name}! Aqui é da ${ee("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`),w=s.status==="quente"?"Quente":s.status==="frio"?"Frio":s.status==="morno"?"Morno":"Em andamento";s.interest;const I=Array.isArray(s.tags)?s.tags.length:0;return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:6px;">
            <span class="rd-card-status">${f(w)}</span>
          ...
          ${I>0||s.source?`<div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:2px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map(k=>{const y=ye[k],g=(y==null?void 0:y.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${g}18;color:${g};border:1px solid ${g}44;">${f(k)}</span>`}).join(""):""}
          </div>`:""}
          <div class="rd-card-icons">
            <span title="Avaliação (clique para mudar)" class="rd-card-stars" data-lead="${s.id}" onclick="event.stopPropagation();window.openRatingPicker?.('${s.id}', event)">
              ${[1,2,3,4,5].map(k=>`<svg viewBox="0 0 24 24" fill="${(s.rating||0)>=k?"#fbbf24":"#cbd5e1"}" stroke="none" width="13" height="13"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`).join("")}
            </span>
        ...
        </div>`}).join(""):'<div class="kanban-empty-col">Sem leads nesta etapa</div>',d=l.reduce((s,p)=>s+(Number(p.budget_max)||0),0),c=d>0?"R$ "+d.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ 0,00";return`
      <div class="kanban-col" data-stage="${f(i.name)}">
        <div class="kanban-col-header">
          <div class="kanban-col-title">
            <div class="kanban-stage-dot" style="background:${i.color||"#0ea5e9"}"></div>
            ${f(i.name.toUpperCase())} (${l.length})
          </div>
        </div>
  ...
  `,await((I=window._lpLoadTasks)==null?void 0:I.call(window,t.id));const u=typeof b<"u"&&(b==null?void 0:b.full_name)||"Não atribuído";document.getElementById("rd-lp-responsavel").textContent=u,n.querySelectorAll(".rd-leadpage-tab").forEach(y=>{y.onclick=()=>{var g;n.querySelectorAll(".rd-leadpage-tab").forEach($=>$.classList.remove("active")),y.classList.add("active"),n.querySelectorAll(".rd-leadpage-tab-panel").forEach($=>$.classList.remove("active")),(g=n.querySelector(`.rd-leadpage-tab-panel[data-panel="${y.dataset.tab}"]`))==null||g.classList.add("active")}}),await((k=window._lpLoadTimeline)==null?void 0:k.call(window,t.id)),document.getElementById("rd-lp-mark-lost").onclick=async()=>{const y=prompt("Motivo da perda (opcional):")||"",{error:g}=await h.from("leads").update({lost_at:new Date().toISOString(),lost_reason:y}).eq("id",t.id);if(g)return alert("Erro: "+g.message);typeof R=="function"?R("Lead marcado como perda","warn"):alert("Lead marcado como perda"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-mark-won").onclick=async()=>{if(!confirm("Marcar como venda fechada?"))return;const{error:y}=await h.from("leads").update({converted_at:new Date().toISOString()}).eq("id",t.id);if(y)return alert("Erro: "+y.message);typeof R=="function"?R("🎉 Venda confirmada!","success"):alert("Venda confirmada!"),window.closeLeadDetailPage(),typeof H=="function"&&H().catch(()=>{})},document.getElementById("rd-lp-add-task").onclick=()=>{var y;return(y=window.openInlineTaskForm)==null?void 0:y.call(window,t.id)},document.getElementById("rd-lp-add-note").onclick=async()=>{const y=prompt("Nova anotação:",t.notes||"");if(y===null)return;const{error:g}=await h.from("leads").update({notes:y}).eq("id",t.id);if(g)return alert("Erro: "+g.message);t.notes=y,window.openLeadDetailPage(t.id)},window.scrollTo({top:0,behavior:"smooth"})};async function ca(){const e=document.getElementById("vendas-list"),t=document.getElementById("vendas-total");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';const n=typeof M=="function"?M():null;let a=h.from("leads").select("*").not("converted_at","is",null).order("converted_at",{ascending:!1});n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a;if(i){e.innerHTML='<p style="color:#ef4444">Erro: '+f(i.message)+"</p>";return}const l=o||[];if(t&&(t.textContent=`${l.length} venda${l.length!==1?"s":""}`),!l.length){e.innerHTML=`<div class="rd-empty-card">
    ...
    </div>`;return}e.innerHTML=l.map(r=>{const d=r.converted_at?new Date(r.converted_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=r.budget_max?"R$ "+Number(r.budget_max).toLocaleString("pt-BR"):"—",s=(r.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-won">
      <div class="rd-result-badge rd-badge-won">VENDA</div>
      <div class="rd-result-info">
        <div class="rd-result-name">${f(r.name||"—")}</div>
        <div class="rd-result-meta">
          ${r.phone?`<span>📞 ${f(r.phone)}</span>`:""}
          ${r.email?`<span>✉ ${f(r.email)}</span>`:""}
          ${r.source?`<span>🎯 ${f(r.source)}</span>`:""}
        </div>
      </div>
      ...
      <div class="rd-result-actions">
        ...
        <button class="rd-result-action rd-result-reopen" data-id="${r.id}" title="Reabrir negociação">
    ...
    </div>`}).join(""),e.querySelectorAll(".rd-result-reopen").forEach(r=>{r.addEventListener("click",async()=>{confirm("Reabrir esta negociação? O lead volta para o funil ativo.")&&(await h.from("leads").update({converted_at:null}).eq("id",r.dataset.id),typeof R=="function"&&R("Negociação reaberta","info"),await ca(),typeof H=="function"&&H().catch(()=>{}))})})}async function pa(){const e=document.getElementById("perdas-list"),t=document.getElementById("perdas-total");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';const n=typeof M=="function"?M():null;let a=h.from("leads").select("*").not("lost_at","is",null).order("lost_at",{ascending:!1});n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a;if(i){e.innerHTML='<p style="color:#ef4444">Erro: '+f(i.message)+"</p>";return}const l=o||[];if(t&&(t.textContent=`${l.length} perda${l.length!==1?"s":""}`),!l.length){e.innerHTML=`<div class="rd-empty-card">
    ...
    </div>`;return}e.innerHTML=l.map(r=>{const d=r.lost_at?new Date(r.lost_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=(r.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-lost">
      ...
      <div class="rd-result-info">
        ...
        ${r.lost_reason?`<div class="rd-result-reason">💬 ${f(r.lost_reason)}</div>`:""}
      </div>
      <div class="rd-result-date">
      ...
      <div class="rd-result-actions">
        ...
        <button class="rd-result-action rd-result-reopen" data-id="${r.id}" title="Reativar negociação">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="16" height="16"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"/></svg>
        </button>
      </div>
    </div>`}).join(""),e.querySelectorAll(".rd-result-reopen").forEach(r=>{r.addEventListener("click",async()=>{confirm("Reativar esta negociação? O lead volta para o funil ativo.")&&(await h.from("leads").update({lost_at:null,lost_reason:null}).eq("id",r.dataset.id),typeof R=="function"&&R("Lead reativado","info"),await pa(),typeof H=="function"&&H().catch(()=>{}))})})}window.openRatingPicker=function(e,t){var r,d;t&&t.stopPropagation&&t.stopPropagation();const n=(Q||[]).find(c=>String(c.id)===String(e));if(!n)return;(r=document.getElementById("rd-rating-picker"))==null||r.remove(),(d=document.getElementById("rd-rating-backdrop"))==null||d.remove();const a=document.createElement("div");a.id="rd-rating-picker",a.className="rd-rating-picker",a.innerHTML=['<div class="rd-rating-picker-title">Classificação do lead</div>','<div class="rd-rating-picker-stars">',[1,2,3,4,5].map(c=>`<button class="rd-rating-star-btn ${(n.rating||0)>=c?"active":""}" data-value="${c}" title="${c} estrela${c>1?"s":""}"><svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></button>`).join(""),"</div>",'<div class="rd-rating-picker-labels"><span>Frio</span><span>Morno</span><span>Quente</span></div>','<button class="rd-rating-clear" data-value="0">✕ Sem classificação</button>'].join("");const o=t&&t.clientX?Math.min(t.clientX,window.innerWidth-260):100,i=t&&t.clientY?Math.min(t.clientY+8,window.innerHeight-200):100;a.style.left=o+"px",a.style.top=i+"px",document.body.appendChild(a);const l=document.createElement("div");l.id="rd-rating-backdrop",l.style.cssText="position:fixed;inset:0;z-index:1899;background:transparent",l.addEventListener("click",()=>{a.remove(),l.remove()}),document.body.appendChild(l),a.querySelectorAll(".rd-rating-star-btn").forEach(c=>{c.addEventListener("mouseenter",()=>{const s=parseInt(c.dataset.value,10);a.querySelectorAll(".rd-rating-star-btn").forEach(p=>{p.classList.toggle("hover",parseInt(p.dataset.value,10)<=s)})})}),a.addEventListener("mouseleave",()=>{a.querySelectorAll(".rd-rating-star-btn").forEach(c=>c.classList.remove("hover"))}),a.querySelectorAll("[data-value]").forEach(c=>{c.addEventListener("click",async()=>{const s=parseInt(c.dataset.value,10);n.rating=s,a.remove(),l.remove(),typeof ie=="function"&&ie();const p=document.getElementById("section-lead-detail");p&&!p.classList.contains("hidden")&&typeof openLeadDetailPage=="function"&&openLeadDetailPage(n.id);const{error:u}=await h.from("leads").update({rating:s}).eq("id",n.id);u?(console.warn("[Rating] erro:",u),typeof R=="function"&&R("Erro ao salvar","error")):typeof R=="function"&&R(s===0?"Classificação removida":`★ ${s} estrela${s>1?"s":""}`,"success")})})};let X={page:1,pageSize:10};function _e(){const e=document.getElementById("rd-leads-tbody");if(!e)return;const t=typeof Q<"u"?Q:[],n=typeof ue<"u"?ue:[],a=t.length,o=X.pageSize,i=Math.max(1,Math.ceil(a/o));X.page>i&&(X.page=i);const l=(X.page-1)*o,r=t.slice(l,l+o);if(document.getElementById("rd-list-total").textContent=`de ${a} negociaç${a===1?"ão":"ões"}`,document.getElementById("rd-list-page-info").textContent=`${X.page} / ${i}`,document.getElementById("rd-list-prev").disabled=X.page<=1,document.getElementById("rd-list-next").disabled=X.page>=i,!r.length){e.innerHTML='<tr><td colspan="8" style="text-align:center;padding:40px;color:#94a3b8">Nenhum lead ainda</td></tr>';return}const d=s=>{if(!s)return"—";try{const p=new Date(s);return`${String(p.getDate()).padStart(2,"0")}/${String(p.getMonth()+1).padStart(2,"0")}/${p.getFullYear()}`}catch{return"—"}};function c(s){const p=s.updated_at?Math.floor((Date.now()-new Date(s.updated_at).getTime())/864e5):999;return p<=1?{icon:"🏃",color:"#059669",title:"Ativo (atualizado recentemente)"}:p<=7?{icon:"🚶",color:"#0ea5e9",title:"Em andamento"}:p<=30?{icon:"😴",color:"#f59e0b",title:"Parado há mais de 1 semana"}:{icon:"🔴",color:"#dc2626",title:"Muito tempo sem contato"}}e.innerHTML=r.map(s=>{var $;const p=n.find(S=>S.name===s.stage),u=s.stage||"—",w=(p==null?void 0:p.color)||"#94a3b8",I=s.budget_max?"R$ "+Number(s.budget_max).toLocaleString("pt-BR"):null,k=s.rating||0,y=(($=(s.name||"?").trim()[0])==null?void 0:$.toUpperCase())||"?",g=c(s);return`
      <tr class="rd-leads-row" data-id="${s.id}">
        <td><input type="checkbox" class="rd-list-check" data-id="${s.id}"></td>
        <td class="rd-leads-name-cell">
          <a class="rd-leads-name" onclick="event.stopPropagation();window.openLeadDetailPage?.('${s.id}')">${f(s.name||"—")}</a>
          ${s.phone?`<div class="rd-leads-sub">${f(s.phone)}</div>`:""}
        </td>
        <td style="text-align:center">
          <span class="rd-leads-avatar" title="${f(typeof b<"u"&&(b==null?void 0:b.full_name)||"Você")}">${y}</span>
        </td>
        <td style="text-align:center">
          <span class="rd-leads-rating" onclick="event.stopPropagation();window.openRatingPicker?.('${s.id}', event)">
            ${[1,2,3,4,5].map(S=>`<span style="color:${k>=S?"#fbbf24":"#cbd5e1"};font-size:14px">★</span>`).join("")}
            <span style="margin-left:4px;font-size:12px;color:#64748b">${k||0}</span>
          </span>
        </td>
        <td>
          <span class="rd-leads-stage" style="background:${w}18;color:${w};border:1px solid ${w}55">${f(u.toUpperCase())}</span>
        </td>
        <td style="text-align:right">
          ${I?`<strong>${I}</strong>`:`<a class="rd-leads-add-value" onclick="event.stopPropagation();window.openLeadDetailPage?.('`+s.id+`')">Adicionar valor</a>`}
        </td>
        <td style="text-align:center;color:#64748b;font-size:13px">${d(s.created_at)}</td>
        <td style="text-align:center">
          <span title="${g.title}" style="font-size:18px;cursor:help">${g.icon}</span>
          <button class="rd-list-info-btn" onclick="event.stopPropagation();window.openLeadSidePanel?.('${s.id}')" title="Ver resumo">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" width="14" height="14"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
          </button>
        </td>
      </tr>`}).join(""),e.querySelectorAll(".rd-leads-row").forEach(s=>{s.addEventListener("click",p=>{var u;p.target.closest("a, button, input")||(u=window.openLeadSidePanel)==null||u.call(window,s.dataset.id)})})}function jt(e){const t=document.getElementById("kanban-board"),n=document.getElementById("leads-list-view");document.querySelectorAll(".rd-view-btn").forEach(o=>o.classList.toggle("active",o.dataset.view===e)),e==="list"?(t&&t.classList.add("hidden"),n&&n.classList.remove("hidden"),_e()):(t&&t.classList.remove("hidden"),n&&n.classList.add("hidden"));try{localStorage.setItem("imobi_funil_view",e)}catch{}}function Ht(){var e,t,n,a;document.querySelectorAll(".rd-view-btn").forEach(o=>{o._wired||(o._wired=!0,o.addEventListener("click",()=>jt(o.dataset.view)))}),(e=document.getElementById("rd-list-prev"))==null||e.addEventListener("click",()=>{X.page>1&&(X.page--,_e())}),(t=document.getElementById("rd-list-next"))==null||t.addEventListener("click",()=>{X.page++,_e()}),(n=document.getElementById("rd-list-pagesize"))==null||n.addEventListener("change",o=>{X.pageSize=parseInt(o.target.value,10)||10,X.page=1,_e()}),(a=document.getElementById("rd-list-check-all"))==null||a.addEventListener("change",o=>{document.querySelectorAll(".rd-list-check").forEach(i=>i.checked=o.target.checked)});try{localStorage.getItem("imobi_funil_view")==="list"&&jt("list")}catch{}}typeof window<"u"&&(window._rdRenderLeadsList=_e);window.closeLeadDetailPage=function(){var t;const e=document.getElementById("section-lead-detail");e&&e.classList.add("hidden"),(t=document.getElementById("section-funil"))==null||t.classList.remove("hidden")};window.closeLeadSidePanel=function(){const e=document.getElementById("rd-lead-sidepanel"),t=document.getElementById("rd-lead-sidepanel-backdrop");e&&(e.classList.remove("open"),setTimeout(()=>e.remove(),250)),t&&(t.style.opacity="0",setTimeout(()=>t.remove(),250))};function nn(){const e=document.getElementById("kanban-board");e&&(e._kanbanListenersAttached||(e._kanbanListenersAttached=!0,e.addEventListener("click",t=>{var l;if(t.target.closest(".kanban-add-btn")){gt();return}const a=t.target.closest(".rd-card-task-btn");if(a){t.preventDefault();const r=a.dataset.lead;typeof tt=="function"?tt(null,r):console.warn("[Tarefa] openTarefaModal não disponível");return}const o=t.target.closest(".rd-card-info-btn");if(o){t.preventDefault();const r=(l=o.closest(".kanban-card"))==null?void 0:l.dataset.id;r&&typeof window.openLeadSidePanel=="function"&&window.openLeadSidePanel(r);return}if(t.target.closest("button, a, input, .rd-card-info-btn, .rd-card-task-btn, .rd-card-stars, .rd-card-status, [onclick]"))return;const i=t.target.closest(".kanban-card");if(i){const r=i.dataset.id;if(typeof window.openLeadSidePanel=="function")window.openLeadSidePanel(r);else{const d=Q.find(c=>String(c.id)===String(r));d&&gt(d)}}}),e.addEventListener("dragstart",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");if(n){ze=n.dataset.id,n.classList.add("dragging");try{t.dataTransfer.effectAllowed="move",t.dataTransfer.setData("text/plain",ze)}catch{}}}),e.addEventListener("dragend",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-card");n&&n.classList.remove("dragging"),e.querySelectorAll(".kanban-col.drag-over").forEach(i=>i.classList.remove("drag-over"))}),e.addEventListener("dragover",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");!n||!ze||(t.preventDefault(),t.dataTransfer.dropEffect="move",e.querySelectorAll(".kanban-col.drag-over").forEach(i=>{i!==n&&i.classList.remove("drag-over")}),n.classList.add("drag-over"))}),e.addEventListener("dragleave",t=>{var a,o;const n=(o=(a=t.target).closest)==null?void 0:o.call(a,".kanban-col");n&&(n.contains(t.relatedTarget)||n.classList.remove("drag-over"))}),e.addEventListener("drop",async t=>{var d,c;const n=(c=(d=t.target).closest)==null?void 0:c.call(d,".kanban-col");if(!n)return;t.preventDefault(),n.classList.remove("drag-over");const a=n.dataset.stage,o=ze;if(ze=null,!o||!a)return;const i=Q.find(s=>String(s.id)===String(o));if(!i||i.stage===a)return;const l=i.stage;i.stage=a,ie();const{error:r}=await h.from("leads").update({stage:a}).eq("id",o);r?(console.warn("[Kanban] erro ao mover:",r),i.stage=l,ie(),typeof R=="function"?R("Erro ao mover lead: "+r.message,"error"):alert("Erro ao mover lead. Tente de novo.")):typeof R=="function"&&R(`→ ${a}`,"success")})))}async function gt(e=null){var I,k,y;(I=document.getElementById("lead-detail-panel"))==null||I.remove();const t=!e,n=M(),{data:a}=await h.from("crm_tags").select("*").eq("tenant_id",n).order("name"),{data:o}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",n).order("sort_order"),i=e!=null&&e.pipeline_id&&((k=V.find(g=>g.id===e.pipeline_id))==null?void 0:k.id)||O;function l(g){return ue.filter($=>$.pipeline_id===g).map($=>`<option value="${f($.name)}" ${(e==null?void 0:e.stage)===$.name?"selected":""}>${f($.name)}</option>`).join("")}const r=V.map(g=>`<option value="${g.id}" ${g.id===i?"selected":""}>${f(g.name)}</option>`).join(""),d=l(i),c=((e==null?void 0:e.phone)||"").replace(/\D/g,""),s=document.createElement("div");s.id="lead-detail-panel",s.style.cssText="position:fixed;top:0;right:0;bottom:0;width:420px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,.15);z-index:1000;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;",s.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(g=>{const S=(ye[g]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(g)}" style="background:${S}18;color:${S};border-color:${S}55;">${f(g)}<span class="ldp-tag-rm" data-tag="${f(g)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
      ...
      ${c?(()=>{const g=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${ee("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${c}?text=${g}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(s),requestAnimationFrame(()=>{s.style.transform="translateX(0)"}),An(s,a||[],ye);const p=s.querySelector("#ldp-pipe"),u=s.querySelector("#ldp-stage");p&&u&&p.addEventListener("change",()=>{const g=p.value,$=ue.filter(S=>S.pipeline_id===g);u.innerHTML=$.map(S=>`<option value="${S.name}">${S.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const w=()=>{s.style.transform="translateX(100%)",setTimeout(()=>s.remove(),250)};document.getElementById("ldp-close").addEventListener("click",w),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const g=document.getElementById("ldp-save"),$=document.getElementById("ldp-msg"),S=document.getElementById("ldp-name").value.trim();if(!S){$.style.color="#ef4444",$.textContent="Nome é obrigatório.";return}g.disabled=!0,g.textContent="Salvando…";const E=[...s.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(T=>T.dataset.tag),L=document.getElementById("ldp-pipe"),m=L?L.value:i||O,v=t?typeof At=="function"?At():{}:{},x={name:S,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:m||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:E,tenant_id:M(),...t?{utm_source:v.utm_source||null,utm_medium:v.utm_medium||null,utm_campaign:v.utm_campaign||null,utm_content:v.utm_content||null,utm_term:v.utm_term||null,fbclid:v.fbclid||null,gclid:v.gclid||null,fbp:v.fbp||null,fbc:v.fbc||null,landing_url:v.landing_url||null,user_agent:navigator.userAgent||null}:{}};let _;if(t?{error:_}=await h.from("leads").insert(x):{error:_}=await h.from("leads").update(x).eq("id",e.id),g.disabled=!1,g.textContent="💾 Salvar",_){$.style.color="#ef4444",$.textContent="Erro: "+_.message;return}$.style.color="#22c55e",$.textContent="✅ Salvo!",w(),H().catch(T=>console.warn("[Kanban] reload falhou:",T)),t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:x.name,email:x.email,phone:x.phone,tracking:v}).then(async T=>{if(T!=null&&T.ok){console.log("[CAPI] Lead enviado ao Meta:",T.event_id);try{await h.from("leads").update({capi_event_id:T.event_id,capi_sent_at:new Date().toISOString()}).eq("name",x.name).eq("phone",x.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(A){console.warn("[CAPI] falha ao salvar event_id:",A)}}else console.warn("[CAPI] não confirmado pelo Meta:",T)}).catch(T=>console.warn("[CAPI] erro:",T))}),(y=document.getElementById("ldp-delete"))==null||y.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await h.from("leads").delete().eq("id",e.id),w(),H())})}let F=[],Ot=!1,$e="pending";async function on(){var e;window._tarefasRefreshTimer&&clearInterval(window._tarefasRefreshTimer),window._tarefasRefreshTimer=setInterval(()=>{const t=document.querySelector('.section[data-section="tarefas"]');!t||t.offsetParent===null||Pt().catch(()=>{})},3e4),!Ot&&(Ot=!0,await Pt(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>tt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),$e=t.dataset.filter,Te()})}))}async function Pt(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=h.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=ma(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",l=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,l=a.checked?"done":"pending";await h.from("tasks").update({status:l}).eq("id",i);const r=F.find(d=>String(d.id)===i);r&&(r.status=l),Te()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await h.from("tasks").delete().eq("id",a.dataset.id),F=F.filter(i=>String(i.id)!==String(a.dataset.id)),Te())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,l=F.find(r=>String(r.id)===i);l&&tt(l)})})}function tt(e=null,t=null){var c,s,p,u;const n=document.getElementById("tarefa-modal-root");n&&n.remove();const a=!!e,o=(e==null?void 0:e.status)==="done",i=ma(e==null?void 0:e.due_date);i&&i.toLocaleDateString("pt-BR");const l=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",r=document.createElement("div");r.id="tarefa-modal-root",r.className="modal-backdrop",r.innerHTML=`
        ...
        <form id="tarefa-form" style="display:flex;flex-direction:column;gap:16px;">
          ...
          <div class="form-row">
            <div class="form-group">
              ...
              <input name="due_date" type="date" class="form-control" value="${l}">
            </div>
            <div class="form-group">
  ...
  `,document.body.appendChild(r);const d=()=>r.remove();(c=document.getElementById("tm-close"))==null||c.addEventListener("click",d),(s=document.getElementById("tm-cancel"))==null||s.addEventListener("click",d),r.addEventListener("click",w=>{w.target===r&&d()}),(p=document.getElementById("tm-toggle-done"))==null||p.addEventListener("click",async()=>{const w=o?"pending":"done";await h.from("tasks").update({status:w}).eq("id",e.id);const I=F.find(k=>String(k.id)===String(e.id));I&&(I.status=w),d(),w==="done"&&($e="done",document.querySelectorAll(".tarefa-filter-btn").forEach(k=>{k.classList.toggle("active",k.dataset.filter==="done")})),Te()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var $,S;const w=document.getElementById("tarefa-form");if(!w.checkValidity()){w.reportValidity();return}const I=new FormData(w),k=document.getElementById("tm-save");k.disabled=!0,k.textContent="Salvando…";const y={title:($=I.get("title"))==null?void 0:$.trim(),description:((S=I.get("description"))==null?void 0:S.trim())||null,due_date:I.get("due_date")||null,priority:I.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,lead_id:(e==null?void 0:e.lead_id)||t||null};let g;if(a){if({error:g}=await h.from("tasks").update(y).eq("id",e.id),!g){const E=F.findIndex(L=>String(L.id)===String(e.id));E>=0&&(F[E]={...F[E],...y})}}else{const{data:E,error:L}=await h.from("tasks").insert(y).select();g=L,!g&&(E!=null&&E[0])&&F.unshift(E[0])}if(k.disabled=!1,k.textContent=a?"Salvar":"Criar Tarefa",g){alert("Erro: "+g.message);return}d(),Te()})}async function sn(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;b==null||b.role,b==null||b.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(l=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(l=>{l.addEventListener("click",()=>{var r;(r=document.getElementById("search-overlay"))==null||r.classList.add("hidden"),l.dataset.type==="lead"?de("contatos"):de("properties")})})}let se=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function dn(){var l;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=h.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(r=>!se.includes(String(r.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(r=>{const d=ln(r.created_at);return`
      <div class="notif-item${!se.includes(String(r.id))?" unread":""}" data-id="${r.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${f(r.name||"—")}</div>
          <div class="notif-item-sub">${f(r.phone||r.source||"")} · ${d}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",r=>{r.preventDefault(),ne(),de("contatos")}),e.querySelectorAll(".notif-item").forEach(r=>{r.addEventListener("click",()=>{se.push(r.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(se)),r.classList.remove("unread"),ne(),de("contatos")})})}function rn(){var e;document.querySelectorAll(".notif-item").forEach(t=>se.push(t.dataset.id)),se=[...new Set(se)],localStorage.setItem("crm_notifs_read",JSON.stringify(se)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function ln(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function cn(){let e=h.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!se.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let te=[],U=1;const De=10;let Ut=!1;async function pn(){var t,n,a,o,i,l,r,d,c;window._contatosRefreshTimer&&clearInterval(window._contatosRefreshTimer),window._contatosRefreshTimer=setInterval(()=>{const s=document.querySelector('.section[data-section="contatos"]');!s||s.offsetParent===null||ft().catch(()=>{})},3e4),document.getElementById("section-contatos")&&(Ut||(Ut=!0,await ft(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{U=1,be()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",s=>{s.key==="Enter"&&(U=1,be())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>ua()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",gn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",vt),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",vt),(r=document.getElementById("download-template"))==null||r.addEventListener("click",s=>{s.preventDefault();const p=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),w=document.createElement("a");w.href=URL.createObjectURL(u),w.download="modelo_contatos.csv",w.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",mn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",un)))}async function ft(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;te=a||[],be()}function be(){var r,d,c;const e=(((r=document.getElementById("contato-search"))==null?void 0:r.value)||"").toLowerCase(),t=e?te.filter(s=>(s.name||"").toLowerCase().includes(e)||(s.email||"").toLowerCase().includes(e)||(s.phone||"").toLowerCase().includes(e)):te,n=t.length,a=Math.max(1,Math.ceil(n/De));U>a&&(U=a);const o=t.slice((U-1)*De,U*De),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(s=>`
      <tr>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const p=(s.phone||"").replace(/\D/g,"");if(!p)return"";const u=encodeURIComponent(`Olá ${(s.name||"").split(" ")[0]}! Aqui é da ${ee("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${p}?text=${u}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const l=document.getElementById("contatos-pagination");if(l){const s=n===0?0:(U-1)*De+1,p=Math.min(U*De,n);l.innerHTML=`
    ...
    `,(d=l.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{U--,be()}),(c=l.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{U++,be()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(s=>{s.addEventListener("click",p=>{p.preventDefault();const u=s.dataset.id,w=te.find(I=>String(I.id)===String(u));w&&ua(w)})})}async function ua(e=null){var g,$,S,E,L,m;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=M(),[{data:o},{data:i},{data:l}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",a).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),r=o||[],d=i||[],c=l||[],s=r.map(v=>v.id),{data:p}=s.length?await h.from("crm_stages").select("*").in("pipeline_id",s).order("sort_order"):{data:[]},u=p||[],w=(e==null?void 0:e.pipeline_id)||((g=r[0])==null?void 0:g.id)||"";function I(v){const x=u.filter(_=>_.pipeline_id===v);return x.length?'<option value="">— Selecionar etapa —</option>'+x.map(_=>`<option value="${f(_.name)}" ${(e==null?void 0:e.stage)===_.name?"selected":""}>${f(_.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const k=document.createElement("div");k.id="contato-modal-root",k.className="modal-backdrop",k.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${r.map(v=>`<option value="${v.id}" ${String(e==null?void 0:e.pipeline_id)===String(v.id)?"selected":""}>${f(v.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
  ...
  `,document.body.appendChild(k);const y=()=>k.remove();($=document.getElementById("cm-close"))==null||$.addEventListener("click",y),(S=document.getElementById("cm-cancel"))==null||S.addEventListener("click",y),k.addEventListener("click",v=>{v.target===k&&y()}),(E=document.getElementById("cm-pipe"))==null||E.addEventListener("change",v=>{const x=document.getElementById("cm-stage");x&&(x.innerHTML=I(v.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const v=te.findIndex(x=>String(x.id)===String(e.id));v>=0&&te.splice(v,1),y(),be()}),(m=document.getElementById("cm-save"))==null||m.addEventListener("click",async()=>{var z,P,G,re,ge,qe,Ae;const v=document.getElementById("contato-form");if(!v.checkValidity()){v.reportValidity();return}const x=new FormData(v),_=document.getElementById("cm-save");_.disabled=!0,_.textContent="Salvando…";const B=x.getAll("tag"),C=x.get("pipeline_id")||null,T={name:(z=x.get("name"))==null?void 0:z.trim(),company:((P=x.get("company"))==null?void 0:P.trim())||null,email:((G=x.get("email"))==null?void 0:G.trim())||null,phone:((re=x.get("phone"))==null?void 0:re.trim())||null,job_title:((ge=x.get("job_title"))==null?void 0:ge.trim())||null,city_interest:((qe=x.get("city_interest"))==null?void 0:qe.trim())||null,notes:((Ae=x.get("notes"))==null?void 0:Ae.trim())||null,pipeline_id:C,stage:x.get("stage")||null,status:x.get("status")||null,tags:B,assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await h.from("leads").update(T).eq("id",e.id),!A){const W=te.findIndex(Ee=>String(Ee.id)===String(e.id));W>=0&&(te[W]={...te[W],...T})}}else{const{data:W,error:Ee}=await h.from("leads").insert(T).select();A=Ee,!A&&(W!=null&&W[0])&&te.unshift(W[0])}if(_.disabled=!1,_.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}y(),be()})}let Be=[];function mn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Be=a.target.result.split(`
`).filter(r=>r.trim()).slice(1).map(r=>{const[d,c,s,p,u]=r.split(",").map(w=>w.trim().replace(/^"|"$/g,""));return{name:d,email:c,phone:s,company:p,job_title:u}}).filter(r=>r.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Be.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=Be.length===0)},n.readAsText(t)}async function un(){if(!Be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}vt(),await ft(),alert(`${t.length} contato(s) importados com sucesso!`)}function gn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function vt(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const fn="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function he(e){return(await fetch(fn,{method:"POST",headers:{Authorization:`Bearer ${Ba}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ft(e){var d,c,s,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await h.auth.getUser();n.value=(u==null?void 0:u.email)||""}const r=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=r),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const w=u.target.files[0];if(!w)return;const I=URL.createObjectURL(w);a&&(a.src=I,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var g,$;const u=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",w=(($=document.getElementById("change-password-confirm"))==null?void 0:$.value)||"",I=document.getElementById("change-password-msg"),k=document.getElementById("btn-change-password");if(I&&(I.style.display="none"),u.length<12){I&&(I.textContent="Mínimo 6 caracteres.",I.style.display="");return}if(u!==w){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:y}=await h.auth.updateUser({password:u});k&&(k.disabled=!1,k.textContent="Salvar Nova Senha"),y?I&&(I.textContent="Erro: "+y.message,I.style.display=""):(I&&(I.style.color="#16a34a",I.textContent="Senha alterada com sucesso!",I.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var $;const u=t.value.trim();let w=(b==null?void 0:b.avatar_url)||"";const I=i==null?void 0:i.files[0],k=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",I)try{const S=await Fe(I,400,.85),E=`avatars/${b.id}-${Date.now()}.jpg`,{error:L}=await h.storage.from("imoveis").upload(E,S,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:m}}=h.storage.from("imoveis").getPublicUrl(E);w=m}}catch(S){console.error("Avatar upload:",S)}const{error:y}=await h.from("profiles").update({name:u,avatar_url:w}).eq("id",b.id);if(l.disabled=!1,l.textContent=k,y){alert("Erro ao salvar perfil.");return}b={...b,name:u,avatar_url:w},et(b);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=(($=u[0])==null?void 0:$.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await at(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var $,S;const I=($=document.getElementById("invite-email"))==null?void 0:$.value.trim(),k=(S=document.getElementById("invite-password"))==null?void 0:S.value.trim(),y=document.getElementById("btn-invite-corretor"),g=document.getElementById("invite-note");if(!I){alert("Informe o e-mail do corretor.");return}if(!k||k.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}y&&(y.disabled=!0,y.textContent="Criando…"),g&&(g.style.display="none");try{const E=await he({email:I,password:k,tenant_id:(b==null?void 0:b.tenant_id)||null});if(E.success){const L=document.getElementById("invite-email"),m=document.getElementById("invite-password");L&&(L.value=""),m&&(m.value=""),await at(),g&&(E.email_sent===!1?(g.innerHTML=`
                ✅ Acesso criado!
                <span style="color:#ef4444;">⚠️ E-mail não enviado automaticamente.</span><br>
                Compartilhe manualmente:<br>
                <strong>E-mail:</strong> ${f(I)}<br>
                <strong>Senha:</strong> ${f(k)}`,g.style.color="#0f172a"):(g.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",g.style.color="#16a34a"),g.style.display="")}else alert("Erro: "+(E.error||"Falha desconhecida"))}catch(E){alert("Erro ao criar acesso: "+E.message)}finally{y&&(y.disabled=!1,y.textContent="+ Criar Acesso")}});const w=document.getElementById("settings-locations-section");w&&(w.style.display=""),await Re(),(s=document.getElementById("loc-add-city-btn"))==null||s.addEventListener("click",async()=>{const I=document.getElementById("loc-new-city"),k=I==null?void 0:I.value.trim();if(!k)return;const{error:y}=await h.from("locations").insert({type:"cidade",name:k});if(y){alert("Erro ao adicionar cidade.");return}I&&(I.value=""),await Re(),St()}),(p=document.getElementById("loc-add-neighborhood-btn"))==null||p.addEventListener("click",async()=>{var $;const I=parseInt(($=document.getElementById("loc-new-neighborhood-city"))==null?void 0:$.value,10),k=document.getElementById("loc-new-neighborhood"),y=k==null?void 0:k.value.trim();if(!I||!y){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:g}=await h.from("locations").insert({type:"bairro",name:y,parent_id:I});if(g){alert("Erro ao adicionar bairro.");return}k&&(k.value=""),await Re()})}}async function at(){const e=document.getElementById("corretores-list");if(!e)return;let t=h.from("profiles").select("*").order("created_at");b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${f(i)}</div>`,r=o.id===(b==null?void 0:b.id),d=o.active!==!1,c=d?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',s=r?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
           <option value="corretor"${o.role==="corretor"?" selected":""}>Corretor</option>
           <option value="admin"${o.role==="admin"?" selected":""}>Admin</option>
         </select>`,p=r?"":d?`<button class="corretor-toggle-btn" data-uid="${o.id}" data-active="true">Pausar acesso</button>`:`<button class="corretor-toggle-btn btn-liberar" data-uid="${o.id}" data-active="false">Liberar acesso</button>`,u=r?"":`<button class="corretor-del-btn icon-btn" data-uid="${o.id}" title="Excluir corretor">🗑️</button>`;return`<div class="corretor-item">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{var l;(l=o.options[o.selectedIndex])!=null&&l.text,o.disabled=!0;const{error:i}=await h.from("profiles").update({role:o.value}).eq("id",o.dataset.uid);o.disabled=!1,i&&(console.warn("[Profiles] erro ao trocar role:",i),alert("Erro ao salvar: "+i.message))})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,l=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const r=await he({action:"toggle",userId:i,active:!l});r.success||alert("Erro: "+(r.error||"Falha desconhecida"))}catch(r){alert("Erro: "+r.message)}await at()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var r,d;const i=o.dataset.uid,l=((d=(r=o.closest(".corretor-item"))==null?void 0:r.querySelector(".corretor-name"))==null?void 0:d.textContent)||"este corretor";if(confirm(`Excluir "${l}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const c=await he({action:"delete",userId:i});c.success||alert("Erro ao excluir: "+(c.error||"Falha desconhecida"))}catch(c){alert("Erro: "+c.message)}await at()}})})}async function ga(){const{data:e,error:t}=await h.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(He=e||[],He)}function xe(){return He.filter(e=>e.type==="cidade")}function $t(e){return He.filter(t=>t.type==="bairro"&&t.parent_id===e)}function St(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=xe();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),t&&(e.value=t)}async function Re(){await ga();const e=xe(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${f(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=He.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const l=e.find(r=>r.id===i.parent_id);return`
          <div class="loc-item">
            <div>
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${f(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const l=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${l}" e todos os bairros vinculados?`))return;const{error:r}=await h.from("locations").delete().eq("id",i.dataset.id);if(r){alert("Erro ao excluir.");return}await Re(),St()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:l}=await h.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await Re()})})}function Vt(){var n,a,o,i,l,r,d,c,s,p,u,w,I,k,y,g,$,S,E,L;document.querySelectorAll(".filter-btn").forEach(m=>{m.addEventListener("click",()=>{const v=m.closest(".filter-btns"),x=m.classList.contains("active");v.querySelectorAll(".filter-btn").forEach(_=>_.classList.remove("active")),x||m.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var B;const m=(B=document.getElementById("f-city"))==null?void 0:B.value,v=xe().find(C=>C.name===m),x=v?$t(v.id):[],_=document.getElementById("f-neighborhood");_&&(_.innerHTML='<option value="">Todos</option>'+x.map(C=>`<option value="${C.name}">${f(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Oe(It(q))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const m=document.querySelector(".admin-filter-panel");if(m){m.querySelectorAll('input[type="text"], input[type="number"]').forEach(x=>{x.value=""}),m.querySelectorAll("select").forEach(x=>{x.selectedIndex=0});const v=document.getElementById("f-neighborhood");v&&(v.innerHTML='<option value="">Todos</option>'),m.querySelectorAll(".filter-btn.active").forEach(x=>x.classList.remove("active"))}Oe(q)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{de(m.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{de(m.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(m=>{m.addEventListener("click",v=>{v.stopPropagation();const x=m.closest(".topnav-dropdown");x==null||x.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(_=>{_!==x&&_.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(m=>m.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Je),(l=document.getElementById("modal-cancel"))==null||l.addEventListener("click",Je),(r=document.getElementById("property-modal"))==null||r.addEventListener("click",m=>{m.target.id==="property-modal"&&Je()}),(d=document.getElementById("btn-new-property"))==null||d.addEventListener("click",()=>{J=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",oe="",Pe([]),ct("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await h.auth.signOut(),location.reload()}),(s=document.getElementById("view-prev"))==null||s.addEventListener("click",()=>{ae=(ae-1+ce.length)%ce.length,Ze()}),(p=document.getElementById("view-next"))==null||p.addEventListener("click",()=>{ae=(ae+1)%ce.length,Ze()}),(u=document.getElementById("view-modal-close"))==null||u.addEventListener("click",Ve),(w=document.getElementById("view-modal-close2"))==null||w.addEventListener("click",Ve),(I=document.getElementById("view-modal"))==null||I.addEventListener("click",m=>{m.target.id==="view-modal"&&Ve()}),(k=document.getElementById("view-modal-share"))==null||k.addEventListener("click",()=>{const m=document.getElementById("share-panel");if(!m)return;const v=m.style.display!=="none";m.style.display=v?"none":"block"}),(y=document.getElementById("share-whatsapp"))==null||y.addEventListener("click",()=>{var P,G,re;const m=(P=document.getElementById("share-link-input"))==null?void 0:P.value;if(!m)return;const v=Number((G=document.getElementById("share-panel"))==null?void 0:G.dataset.pid),x=q.find(ge=>ge.id===v),_=(x==null?void 0:x.title)||((re=document.getElementById("view-modal-title"))==null?void 0:re.textContent)||"Imóvel",B=x!=null&&x.price?` — ${Ue(x.price,"pt")}`:"",C=x!=null&&x.reference?` | Ref: ${x.reference}`:"",T=[x==null?void 0:x.neighborhood,x==null?void 0:x.city].filter(Boolean).join(", "),A=T?`
📍 ${T}`:"",z=encodeURIComponent(`Olha esse imóvel que encontrei: *${_}*${B}${C}${A}

${m}`);window.open("https://wa.me/?text="+z,"_blank")}),(g=document.getElementById("share-instagram"))==null||g.addEventListener("click",()=>{var v,x;const m=(v=document.getElementById("share-link-input"))==null?void 0:v.value;m&&((x=navigator.clipboard)==null||x.writeText(m),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),($=document.getElementById("share-email"))==null||$.addEventListener("click",()=>{var B,C;const m=(B=document.getElementById("share-link-input"))==null?void 0:B.value;if(!m)return;const v=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",x=encodeURIComponent("Imóvel: "+v),_=encodeURIComponent(`Olá! Segue o link do imóvel:

`+m);window.open("mailto:?subject="+x+"&body="+_,"_blank")}),(S=document.getElementById("share-copy"))==null||S.addEventListener("click",()=>{var v;const m=document.getElementById("share-link-input");m&&((v=navigator.clipboard)==null||v.writeText(m.value).then(()=>{const x=document.getElementById("share-copy"),_=x.textContent;x.textContent="✅ Copiado!",setTimeout(()=>{x.textContent=_},2e3)}))}),(E=document.getElementById("view-modal-edit"))==null||E.addEventListener("click",()=>{var T;if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const m=Number(document.getElementById("view-modal-edit").dataset.pid),v=q.find(A=>A.id===m);if(!v)return;Ve(),J=v.id;const x=document.getElementById("property-form"),_=document.getElementById("form-submit-btn");_.textContent="Salvar Alterações",x.querySelector('[name="title"]').value=v.title||"",x.querySelector('[name="rua"]').value=v.rua||"",x.querySelector('[name="numero"]').value=v.numero||"",x.querySelector('[name="city"]').value=v.city||"",x.querySelector('[name="price"]').value=v.price||"",x.querySelector('[name="bedrooms"]').value=v.bedrooms||"",x.querySelector('[name="suites"]').value=v.suites||"",x.querySelector('[name="parking"]').value=v.parking||"",x.querySelector('[name="description"]').value=v.description||"",x.querySelector('[name="construction_status"]').value=v.construction_status||"",x.querySelector('[name="owner_name"]').value=v.owner_name||"",x.querySelector('[name="owner_phone"]').value=v.owner_phone||"",x.querySelector('[name="owner_email"]').value=v.owner_email||"",x.querySelector('[name="owner_notes"]').value=v.owner_notes||"",x.querySelector('[name="condominium"]').value=v.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=v.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=v.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=v.neighborhood||"")},50)),oe=v.cover_image||((T=v.images)==null?void 0:T[0])||"",Pe(v.images||[]),ct("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(m=>{m.addEventListener("click",()=>{var v;document.querySelectorAll(".tab-btn").forEach(x=>x.classList.remove("active")),m.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(x=>x.classList.add("hidden")),(v=document.getElementById(`tab-${m.dataset.tab}`))==null||v.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",m=>{if(m.target.closest(".action-btns"))return;const v=m.target.closest("tr");if(!v)return;const x=Number(v.dataset.id);if(!x)return;const _=q.find(B=>B.id===x);_&&Za(_)})}async function fa(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(l){const r=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let d=0;for(const c of l||"?")d=d*31+c.charCodeAt(0)&4294967295;return r[Math.abs(d)%r.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let l=-1;function r(d=-1){l=d;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=d>=0?"Editar Depoimento":"Novo Depoimento";const s=d>=0?n[d]:{};e.querySelector("#dep-stars").value=String(s.stars||5),e.querySelector("#dep-text").value=s.text||"",e.querySelector("#dep-name").value=s.name||"",e.querySelector("#dep-role").value=s.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>r(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",l=-1}),e.addEventListener("click",d=>{const c=d.target.closest("[data-edit]"),s=d.target.closest("[data-del]");if(c&&r(parseInt(c.dataset.edit)),s){const p=parseInt(s.dataset.del);confirm("Remover este depoimento?")&&(n.splice(p,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const d=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),s=e.querySelector("#dep-text").value.trim(),p=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),w=parseInt(e.querySelector("#dep-stars").value);if(!s||!p){alert("Preencha o depoimento e o nome.");return}d.disabled=!0,d.textContent="Salvando…";const I={stars:w,text:s,name:p,role:u};l>=0?n[l]=I:n.push(I);const k=await i();d.disabled=!1,d.textContent="Salvar",Y(c,k),k&&(e.querySelector("#dep-form-wrap").style.display="none",l=-1,o())})}async function i(){const l=JSON.stringify(n);return await Ge("testimonials",{pt:l,en:l,es:l})}o()}document.addEventListener("DOMContentLoaded",async()=>{var r,d,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const s=`imobi_tenant_${t}`,p=We(s);if(p)ke(p);else{let u=null;for(const w of[t,"www."+t]){const{data:I}=await h.from("tenants").select("id").eq("domain",w).maybeSingle();if(I!=null&&I.id){u=I;break}}u!=null&&u.id&&(ke(u.id),rt(s,u.id,24*60*60*1e3))}}await Promise.all([_a(),ga()]),Ne=ee("company.whatsapp",Ne),xt(),Ga(),Wa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(St(),n.addEventListener("change",()=>{const s=xe().find(u=>u.name===n.value),p=s?$t(s.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+p.map(u=>`<option value="${u.name}">${f(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const s=new URLSearchParams(window.location.hash.replace("#","")),p=new URLSearchParams(window.location.search),u=s.get("type")||p.get("type")||"",w=Zt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||p.has("code"),I=document.getElementById("password-reset-overlay");if(w){o.style.display="none",i&&i.classList.add("hidden"),I&&(I.style.display="flex"),(r=document.getElementById("password-reset-form"))==null||r.addEventListener("submit",async y=>{var m,v;y.preventDefault();const g=((m=document.getElementById("new-password"))==null?void 0:m.value)||"",$=((v=document.getElementById("confirm-password"))==null?void 0:v.value)||"",S=document.getElementById("password-reset-msg"),E=y.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),g!==$){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}E&&(E.disabled=!0,E.textContent="Salvando…");const{error:L}=await h.auth.updateUser({password:g});if(L){S&&(S.textContent="Erro: "+L.message,S.style.display=""),E&&(E.disabled=!1,E.textContent="Definir Senha");return}window.location.href=window.location.pathname}),p.has("code")&&await h.auth.exchangeCodeForSession(p.get("code")??"");return}const{data:{session:k}}=await h.auth.getSession();if(k){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),st(),Vt(),Nt(),window.lucide&&lucide.createIcons(),b=await Mt(k.user.id),!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(b.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const y=document.getElementById("password-reset-overlay");y&&(y.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async g=>{var v,x;g.preventDefault();const $=((v=document.getElementById("new-password"))==null?void 0:v.value)||"",S=((x=document.getElementById("confirm-password"))==null?void 0:x.value)||"",E=document.getElementById("password-reset-msg"),L=g.target.querySelector('button[type="submit"]');if(E&&(E.style.display="none"),$!==S){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}if($.length<12){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:m}=await h.auth.updateUser({password:$});if(m){E&&(E.textContent="Erro: "+m.message,E.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await h.from("profiles").update({needs_password_reset:!1}).eq("id",b.id),window.location.href=window.location.pathname});return}ke((b==null?void 0:b.tenant_id)||null),et(b),zt(b),Dt(b.role),await Qe(),await Ft(b),window.lucide&&lucide.createIcons(),cn(),de("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const y=document.getElementById("login-form");y&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var S,E;const g=(E=(S=y.querySelector('input[name="email"]'))==null?void 0:S.value)==null?void 0:E.trim();if(!g){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:$}=await h.auth.resetPasswordForEmail(g,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert($?"Erro: "+$.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),y.addEventListener("submit",async g=>{g.preventDefault();const $=y.querySelector('button[type="submit"]'),S=new FormData(y),E=S.get("email"),L=S.get("password");$&&($.disabled=!0,$.textContent="Entrando…");try{if(await Ha(E,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),st(),Vt(),window.lucide&&lucide.createIcons();const{data:{session:v}}=await h.auth.getSession();if(b=v?await Mt(v.user.id):null,!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Nt(),ke((b==null?void 0:b.tenant_id)||null),et(b),zt(b),Dt(b.role),await Qe(),await Ft(b),window.lucide&&lucide.createIcons(),de("dashboard")}else alert("E-mail ou senha incorretos")}catch(m){alert("Erro ao fazer login: "+((m==null?void 0:m.message)||String(m)))}finally{$&&($.disabled=!1,$.textContent="Entrar")}}))}}else st();await ve();const l=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Ct(l),Tt(Ne),window._applyDynamicContent=Ct,window._applyWhatsAppLinks=Tt,document.querySelectorAll(".nav-dropdown-btn").forEach(s=>{var u;const p=(u=s.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");p&&s.addEventListener("click",w=>{w.stopPropagation(),p.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(I=>{I!==p&&I.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(s=>s.classList.remove("js-open"))})});async function vn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:l}=await h.from("properties").update({reference:i}).eq("id",o.id);if(!l){const r=q.findIndex(d=>d.id===o.id);r>=0&&(q[r].reference=i),n++}}Oe(It(q))}async function yn(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const l=await bn(i);a.push(l),o=!0}catch{a.push(i)}if(o){await h.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(l=>l.id===t.id);i>=0&&(q[i].images=a)}}Oe(It(q))}}async function bn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,l=i?URL.createObjectURL(i):null;return new Promise(r=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),s=1200;let p=d.width,u=d.height;p>s&&(u=Math.round(u*s/p),p=s),c.width=p,c.height=u;const w=c.getContext("2d");w.drawImage(d,0,0,p,u);const I=k=>{if(k){const y=Math.round(p*.18),g=Math.round(k.naturalHeight*y/k.naturalWidth),$=Math.round(p*.02);w.globalAlpha=.45,w.drawImage(k,p-y-$,u-g-$,y,g),w.globalAlpha=1}c.toBlob(async y=>{try{const g=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:$}=await h.storage.from("imoveis").upload(g,y,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if($){console.error("Upload watermark error:",$),r(e);return}const{data:{publicUrl:S}}=h.storage.from("imoveis").getPublicUrl(g);r(S)}catch(g){console.error("Watermark upload exception:",g),r(e)}},"image/jpeg",.82)};if(l){const k=new Image;k.onload=()=>{URL.revokeObjectURL(l),I(k)},k.onerror=()=>{URL.revokeObjectURL(l),I(null)},k.src=l}else I(null)},d.onerror=()=>{URL.revokeObjectURL(a),r(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function Y(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Lt(e,t="assets"){const n=await Fe(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await h.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=h.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>f(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("co-logo-url").addEventListener("input",o=>{document.getElementById("co-logo-preview").src=o.target.value||"/logo.png"}),document.getElementById("co-logo-file").addEventListener("change",async o=>{const i=o.target.files[0];if(i)try{const l=await Lt(i,"logos");document.getElementById("co-logo-url").value=l,document.getElementById("co-logo-preview").src=l}catch(l){alert("Erro no upload: "+l.message)}}),document.getElementById("co-save-identity").addEventListener("click",async()=>{const o=document.getElementById("co-save-identity");o.disabled=!0,o.textContent="Salvando…";const i=await Le([["company.name",document.getElementById("co-name").value.trim()],["company.creci",document.getElementById("co-creci").value.trim()],["company.logo_url",document.getElementById("co-logo-url").value.trim()],["company.favicon_url",document.getElementById("co-favicon-url").value.trim()]]);i&&xt(),o.disabled=!1,o.textContent="Salvar Identidade",Y(document.getElementById("co-identity-msg"),i)}),document.getElementById("co-save-contacts").addEventListener("click",async()=>{const o=document.getElementById("co-save-contacts");o.disabled=!0,o.textContent="Salvando…";const i=document.getElementById("co-whatsapp").value.trim(),l=await Le([["company.whatsapp",i],["company.phone",document.getElementById("co-phone").value.trim()],["company.email",document.getElementById("co-email").value.trim()],["company.address",document.getElementById("co-address").value.trim()]]);l&&i&&(Ne=i),o.disabled=!1,o.textContent="Salvar Contatos",Y(document.getElementById("co-contacts-msg"),l)}),document.getElementById("co-save-social").addEventListener("click",async()=>{const o=document.getElementById("co-save-social");o.disabled=!0,o.textContent="Salvando…";const i=await Le([["company.instagram_url",document.getElementById("co-instagram").value.trim()],["company.facebook_url",document.getElementById("co-facebook").value.trim()],["company.youtube_url",document.getElementById("co-youtube").value.trim()],["company.tiktok_url",document.getElementById("co-tiktok").value.trim()],["company.linkedin_url",document.getElementById("co-linkedin").value.trim()]]);o.disabled=!1,o.textContent="Salvar Redes Sociais",Y(document.getElementById("co-social-msg"),i)})}async function ya(){const e=document.getElementById("section-visual");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(s=>{n[s.key]=s.value||""});const a=n["visual.accent_color"]||"#b8962e",o=n["visual.primary_bg"]||"#0f1c2e",i=n["visual.secondary_bg"]||"#1a2f4a",l=n["visual.hero_bg_url"]||"",r=n["visual.price_max_slider"]||13e7;e.innerHTML=`
    <div class="section-topbar">
  ...
  `;function d(s,p,u){const w=document.getElementById(s),I=document.getElementById(p);w==null||w.addEventListener("input",k=>{I.value=k.target.value,u()}),I==null||I.addEventListener("input",k=>{/^#[0-9a-fA-F]{6}$/.test(k.target.value)&&(w.value=k.target.value,u())})}function c(){var p,u,w,I;const s=((p=document.getElementById("col-accent-hex"))==null?void 0:p.value)||"#b8962e";(u=document.getElementById("vp-bar"))==null||u.style.setProperty("background",s),(w=document.getElementById("vp-dot"))==null||w.style.setProperty("background",s),(I=document.getElementById("vp-btn"))==null||I.style.setProperty("background",s),document.documentElement.style.setProperty("--accent",s)}d("col-accent","col-accent-hex",c),d("col-primary","col-primary-hex",()=>{}),d("col-secondary","col-secondary-hex",()=>{}),c(),document.getElementById("vis-hero-file").addEventListener("change",async s=>{const p=s.target.files[0];if(p)try{const u=await Lt(p,"hero");document.getElementById("vis-hero-url").value=u;const w=document.getElementById("vis-hero-preview");w.innerHTML=`<img src="${u}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,w.style.display=""}catch(u){alert("Erro no upload: "+u.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const s=document.getElementById("visual-save-colors");s.disabled=!0,s.textContent="Salvando…";const p=await Le([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);p&&xt(),s.disabled=!1,s.textContent="Salvar Cores",Y(document.getElementById("visual-colors-msg"),p)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",c())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const s=document.getElementById("visual-save-images");s.disabled=!0,s.textContent="Salvando…";const p=await Le([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);s.disabled=!1,s.textContent="Salvar Imagens",Y(document.getElementById("visual-images-msg"),p)})}async function ba(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("*").eq("tenant_id",M()),n={};t==null||t.forEach(d=>{n[d.key]=d});const a=(d,c)=>{var s;return f(((s=n[d])==null?void 0:s[`value_${c}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},l=d=>o.map(c=>`<button class="content-tab${c===d?" active":""}" data-lang="${c}">${i[c]}</button>`).join(""),r=d=>`
  ...
  `;e.innerHTML=`
    ...
    <div class="cfg-card">
      ...
      <div id="sc-panels">
        ${o.map(d=>`<div class="content-panel${d==="pt"?" active":""}" data-panel="${d}">${r(d)}</div>`).join("")}
      </div>
      <div class="cfg-save-row">
  ...
  `,await j())}async function j(){var g,$,S,E,L;const e=document.getElementById("crm-body");if(!e)return;const t=M(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",t).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),l=n||[],d=(typeof O<"u"&&O?l.find(m=>m.id===O):null)||l.find(m=>m.is_default)||l[0],c=l.map(m=>`<option value="${m.id}"${m.id===(d==null?void 0:d.id)?" selected":""}>${f(m.name)}</option>`).join(""),s=(a||[]).filter(m=>m.pipeline_id===(d==null?void 0:d.id)).sort((m,v)=>(m.sort_order??0)-(v.sort_order??0)),p=s.map((m,v)=>`
  ...
  `;const w=document.getElementById("crm-pipe-sel");w&&w.addEventListener("change",async()=>{const m=parseInt(w.value,10);if(!isNaN(m))try{O=m}catch{}await j()});const I=d==null?void 0:d.id;(g=document.getElementById("crm-rename-pipeline"))==null||g.addEventListener("click",async()=>{if(!I)return;const m=prompt("Novo nome do funil:",(d==null?void 0:d.name)||"");if(!m||m.trim()===(d==null?void 0:d.name))return;const{error:v}=await h.from("crm_pipelines").update({name:m.trim()}).eq("id",I);if(v){alert("Erro: "+v.message);return}await j()}),($=document.getElementById("crm-set-default-pipeline"))==null||$.addEventListener("click",async()=>{if(I){if(d!=null&&d.is_default){alert("Este funil já é o padrão.");return}try{const m=M();await h.from("crm_pipelines").update({is_default:!1}).eq("tenant_id",m),await h.from("crm_pipelines").update({is_default:!0}).eq("id",I),await j()}catch(m){alert("Erro: "+m.message)}}}),(S=document.getElementById("crm-delete-pipeline"))==null||S.addEventListener("click",async()=>{if(I){if(l.length===1){alert("Não pode excluir o único funil. Crie outro antes.");return}confirm(`Excluir o funil "${d==null?void 0:d.name}" e todas as suas etapas?

Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await h.from("crm_stages").delete().eq("pipeline_id",I),await h.from("crm_pipelines").delete().eq("id",I),O=null,await j())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const m=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,x=parseInt(document.getElementById("crm-pipe-sel").value,10);m&&(await h.from("crm_stages").insert({pipeline_id:x,name:m,color:v,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-stage").value="",await j())}),e.querySelectorAll(".stage-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await h.from("crm_stages").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".stage-name-input").forEach(m=>{m.addEventListener("blur",async()=>{const v=m.value.trim(),x=m.dataset.orig;if(!v||v===x){m.value=x;return}m.disabled=!0;const{error:_}=await h.from("crm_stages").update({name:v}).eq("id",m.dataset.sid);if(m.disabled=!1,_){console.warn("[Etapas] erro ao renomear:",_),m.value=x,alert("Erro ao renomear: "+_.message);return}m.dataset.orig=v,m.style.background="#dcfce7",setTimeout(()=>{m.style.background=""},800)}),m.addEventListener("keydown",v=>{v.key==="Enter"&&(v.preventDefault(),m.blur()),v.key==="Escape"&&(m.value=m.dataset.orig,m.blur())})}),document.getElementById("crm-stages-list");let k=null;e.querySelectorAll(".stage-draggable").forEach(m=>{m.addEventListener("dragstart",v=>{k=m,m.classList.add("stage-dragging"),v.dataTransfer.effectAllowed="move";try{v.dataTransfer.setData("text/plain",m.dataset.id)}catch{}}),m.addEventListener("dragend",()=>{m.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(v=>v.classList.remove("stage-drop-over"))}),m.addEventListener("dragover",v=>{v.preventDefault(),v.dataTransfer.dropEffect="move",m!==k&&(e.querySelectorAll(".stage-drop-over").forEach(x=>x.classList.remove("stage-drop-over")),m.classList.add("stage-drop-over"))}),m.addEventListener("dragleave",()=>{m.classList.remove("stage-drop-over")}),m.addEventListener("drop",async v=>{if(v.preventDefault(),!k||m===k)return;const x=k.dataset.id,_=m.dataset.id,B=s.findIndex(z=>String(z.id)===String(x)),C=s.findIndex(z=>String(z.id)===String(_));if(B<0||C<0)return;const T=s.splice(B,1)[0];s.splice(C,0,T);const A=s.map((z,P)=>h.from("crm_stages").update({sort_order:P}).eq("id",z.id));k=null,await Promise.all(A).catch(z=>console.warn("[stages] erro reordenar:",z)),await j()})}),e.querySelectorAll(".stage-color-pick").forEach(m=>{m.addEventListener("change",async v=>{await h.from("crm_stages").update({color:v.target.value}).eq("id",m.dataset.sid);const x=m.closest(".stage-item").querySelector(".stage-color-dot");x&&(x.style.background=v.target.value)})});const y=async()=>{const m=document.getElementById("crm-new-tag"),v=document.getElementById("crm-new-tag-color"),x=m==null?void 0:m.value.trim(),_=(v==null?void 0:v.value)||"#6366F1";if(!x){m==null||m.focus();return}await h.from("crm_tags").insert({name:x,color:_,tenant_id:M()}),m&&(m.value=""),await j()};(E=document.getElementById("crm-add-tag"))==null||E.addEventListener("click",y),(L=document.getElementById("crm-new-tag"))==null||L.addEventListener("keydown",m=>{m.key==="Enter"&&y()}),e.querySelectorAll(".tm-del-btn").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await h.from("crm_tags").delete().eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-name-input").forEach(m=>{const v=m.closest(".tm-row"),x=v==null?void 0:v.querySelector(".tm-save-btn");x&&(x.style.display="none"),m.addEventListener("input",()=>{const _=m.value.trim()!==m.dataset.orig;x&&(x.style.display=_?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(m=>{const v=m.closest(".tm-row"),x=v==null?void 0:v.querySelector(".tm-color-swatch"),_=v==null?void 0:v.querySelector(".tm-save-btn");m.addEventListener("input",B=>{x&&(x.style.background=B.target.value),_&&(_.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(m=>{m.style.display="none",m.addEventListener("click",async()=>{var B,C;const v=m.closest(".tm-row"),x=(B=v.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),_=(C=v.querySelector(".tm-color-input"))==null?void 0:C.value;x&&(m.disabled=!0,m.textContent="✓ Salvando…",await h.from("crm_tags").update({name:x,color:_}).eq("id",m.dataset.id),await j())})}),e.querySelectorAll(".tm-tpl-btn").forEach(m=>{m.addEventListener("click",async()=>{const v=m.dataset.name,x=m.dataset.color;m.disabled=!0,m.innerHTML="✓",await h.from("crm_tags").insert({name:v,color:x,tenant_id:M()}),await j()})}),e.querySelectorAll(".tag-chip-del").forEach(m=>{m.addEventListener("click",async()=>{await h.from("crm_tags").delete().eq("id",m.dataset.id),await j()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const m=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,x=document.getElementById("crm-new-status-final").checked;m&&(await h.from("crm_lead_statuses").insert({name:m,color:v,is_final:x,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-status").value="",await j())}),e.querySelectorAll(".status-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover este status?")&&(await h.from("crm_lead_statuses").delete().eq("id",m.dataset.id),await j())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var x;const m=(x=prompt("Nome do novo funil:"))==null?void 0:x.trim();if(!m)return;const{error:v}=await h.from("crm_pipelines").insert({name:m,sort_order:99,tenant_id:M()});if(v){alert("Erro ao criar funil: "+v.message);return}mt=!1,await j()})}async function xa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("integrations").select("*"),n={};t==null||t.forEach(r=>{n[r.key]=r});const a=r=>{var d;return f(((d=n[r])==null?void 0:d.value)||"")},o=r=>{var d;return(d=n[r])!=null&&d.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],l=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var p;const r=document.getElementById("intg-save-tracking");r.disabled=!0,r.textContent="Salvando…";let d=!0;const c=document.querySelectorAll(".intg-val"),s=document.querySelectorAll(".intg-toggle");for(let u=0;u<c.length;u++){const w=c[u].dataset.key,I=c[u].value.trim(),k=((p=s[u])==null?void 0:p.checked)??!1;await ot(w,I,k)||(d=!1)}r.disabled=!1,r.textContent="Salvar Integrações",Y(document.getElementById("intg-tracking-msg"),d)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const r=document.getElementById("intg-save-smtp");r.disabled=!0,r.textContent="Salvando…";const d=document.querySelectorAll(".smtp-field");let c=!0;for(const p of d)await ot(p.dataset.key,p.value.trim(),!0)||(c=!1);const s=document.getElementById("smtp-pass").value;s&&(await ot("smtp_pass",s,!0)||(c=!1)),r.disabled=!1,r.textContent="Salvar SMTP",Y(document.getElementById("intg-smtp-msg"),c)})}async function wa(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await yt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var d,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let r=0;for(const s of a){l.textContent=`Enviando ${r+1}/${a.length}…`,i.style.width=`${Math.round(r/a.length*100)}%`;try{const p=await Lt(s,"media"),u=s.name.replace(/\.[^.]+$/,"").slice(0,60);await h.from("media_library").insert({name:u,url:p,type:"image",size:s.size,created_by:(c=(d=(await h.auth.getUser()).data)==null?void 0:d.user)==null?void 0:c.id})}catch(p){console.error("Media upload error:",p)}r++}i.style.width="100%",l.textContent=`✓ ${r} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await yt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function yt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await h.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(d=>d.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(d=>d.classList.add("hidden")),l.classList.add("active");const r=e.querySelector(`#sa-panel-${l.dataset.tab}`);r&&r.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&me(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&xn(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Xt(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Gt(),l.dataset.tab==="platform"&&Wt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Xt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",me),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Gt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>In()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",wn),me(),Wt())}async function me(){var r,d;const e=document.getElementById("sa-tenants-list"),t=((d=(r=document.getElementById("sa-tenant-search"))==null?void 0:r.value)==null?void 0:d.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=h.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var s,p;return!t||((s=c.name)==null?void 0:s.toLowerCase().includes(t))||((p=c.slug)==null?void 0:p.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var s;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async s=>{s.stopPropagation();const p=c.dataset.active==="true";await h.from("tenants").update({active:!p}).eq("id",c.dataset.id),me()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const s=(i||[]).find(p=>String(p.id)===String(c.dataset.id));s&&kn(s)})})}async function xn(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `}).join("")}async function Wt(){const[e,t,n,a]=await Promise.all([h.from("tenants").select("id",{count:"exact",head:!0}),h.from("profiles").select("id",{count:"exact",head:!0}),h.from("subscriptions").select("id",{count:"exact",head:!0}).eq("status","active"),h.from("properties").select("id",{count:"exact",head:!0}).eq("published",!0)]),o=(i,l)=>{const r=document.getElementById(i);r&&(r.textContent=l??"—")};o("sa-stat-tenants",e.count),o("sa-stat-users",t.count),o("sa-stat-subs",n.count),o("sa-stat-props",a.count)}async function wn(){var n,a,o;const e=document.getElementById("sa-plat-save"),t=document.getElementById("sa-plat-msg");e&&(e.disabled=!0,e.textContent="Salvando…"),await Le([{key:"platform.name",value:((n=document.getElementById("sa-plat-name"))==null?void 0:n.value)||""},{key:"platform.support_email",value:((a=document.getElementById("sa-plat-email"))==null?void 0:a.value)||""},{key:"platform.trial_days",value:((o=document.getElementById("sa-plat-trial"))==null?void 0:o.value)||"14"}]),e&&(e.disabled=!1,e.textContent="Salvar Configurações"),Y(t,!0)}function En(e){return e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function In(){var a,o,i,l,r,d;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const t=document.createElement("div");t.id="sa-new-tenant-modal",t.className="sa-modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(t),h.from("plans").select("id, name").then(({data:c})=>{const s=document.getElementById("nt-plan");s&&c&&(s.innerHTML='<option value="">Sem plano</option>'+c.map(p=>`<option value="${p.id}">${f(p.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const s=document.getElementById("nt-slug");s&&!s.dataset.manual&&(s.value=En(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(r=document.getElementById("nt-cancel"))==null||r.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(d=document.getElementById("nt-save"))==null||d.addEventListener("click",async()=>{var L,m,v,x,_,B,C,T,A,z,P,G;const c=(m=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:m.trim(),s=(x=(v=document.getElementById("nt-slug"))==null?void 0:v.value)==null?void 0:x.trim(),p=(B=(_=document.getElementById("nt-domain"))==null?void 0:_.value)==null?void 0:B.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,w=(A=(T=document.getElementById("nt-admin-email"))==null?void 0:T.value)==null?void 0:A.trim(),I=(P=(z=document.getElementById("nt-admin-password"))==null?void 0:z.value)==null?void 0:P.trim(),k=document.getElementById("nt-msg"),y=document.getElementById("nt-save");if(!c||!s){k.textContent="❌ Nome e slug são obrigatórios.",k.style.color="#ef4444";return}if(!w){k.textContent="❌ Informe o e-mail do admin.",k.style.color="#ef4444";return}if(!I||I.length<12){k.textContent="❌ A senha precisa ter mínimo 6 caracteres.",k.style.color="#ef4444";return}y.disabled=!0,y.textContent="Criando…",k.textContent="⏳ Criando imobiliária…",k.style.color="#64748b";const{data:g,error:$}=await h.from("tenants").insert({name:c,slug:s,domain:p||null,plan_id:u||null,active:!0}).select();if($){y.disabled=!1,y.textContent="Criar Imobiliária",k.textContent="❌ "+$.message,k.style.color="#ef4444";return}const S=(G=g==null?void 0:g[0])==null?void 0:G.id;k.textContent="⏳ Criando usuário admin…";const E=await he({email:w,password:I,role:"admin",tenant_id:S});if(!(E!=null&&E.success)){y.disabled=!1,y.textContent="Criar Imobiliária",k.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+f((E==null?void 0:E.error)||"Desconhecido"),k.style.color="#f59e0b",n(),me().catch(()=>{});return}S&&(E!=null&&E.user_id)&&!(E!=null&&E.linked)&&await h.from("profiles").update({tenant_id:S}).eq("id",E.user_id),y.disabled=!1,y.textContent="Criar Imobiliária",E.email_sent===!1?(k.innerHTML=`
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px;margin-top:8px;font-size:12px;">
          E-mail: <strong>${f(w)}</strong><br>
          Senha: <strong>${f(I)}</strong>
        </div>`,k.style.color="#0f172a"):(k.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",k.style.color="#22c55e",n(),me().catch(()=>{}))})}function kn(e){var a;(a=document.getElementById("tenant-panel"))==null||a.remove();const t=document.createElement("div");t.id="tenant-panel",t.style.cssText="position:fixed;inset:0;z-index:300;background:#f1f5f9;overflow-y:auto;display:flex;flex-direction:column;";const n=[{id:"properties",label:"🏠 Imóveis"},{id:"leads",label:"📋 Leads"},{id:"users",label:"👥 Corretores"},{id:"api",label:"🔗 Site & API"},{id:"config",label:"⚙️ Configurações"}];t.innerHTML=`
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${s.map(p=>{var u;return`
            <tr data-pid="${p.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${f(Ue(p.price,"pt"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${s.map(u=>{const[w,I]=p(u.stage||u.status||"").split(","),k=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${w};color:${I};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${f(u.stage||u.status||"Novo")}</span></td>
              <td style="padding:12px 16px;font-size:12px;color:#94a3b8;">${new Date(u.created_at).toLocaleDateString("pt-BR")}</td>
              <td style="padding:12px 16px;text-align:center;">
                <div style="display:flex;gap:6px;justify-content:center;align-items:center;">
                  ${k?`<a href="https://wa.me/${k}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;background:#25d366;border-radius:6px;color:#fff;text-decoration:none;flex-shrink:0;" title="WhatsApp" onclick="fbq('track', 'Contact')"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.555 4.116 1.527 5.845L.057 23.882l6.199-1.625A11.934 11.934 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 01-4.992-1.368l-.358-.213-3.685.967.983-3.596-.234-.369A9.79 9.79 0 012.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/></svg></a>`:""}
      ...
      </div>`,(l=n.querySelector("#tp-add-corretor"))==null||l.addEventListener("click",()=>pt(e.id,a)),n.querySelectorAll(".tp-role-sel").forEach(u=>{u.addEventListener("change",async()=>{const w=u.dataset.uid;u.disabled=!0,await h.from("profiles").update({role:u.value}).eq("id",w),u.disabled=!1})}),n.querySelectorAll(".tp-user-toggle").forEach(u=>{u.addEventListener("click",async()=>{const w=u.dataset.uid,I=u.dataset.active==="1";u.disabled=!0,u.textContent="…",await h.from("profiles").update({active:!I}).eq("id",w),a()})}),n.querySelectorAll(".tp-user-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este usuário da imobiliária? O acesso ao sistema será excluído permanentemente.")&&(u.disabled=!0,u.textContent="…",await he({action:"delete",userId:u.dataset.uid}),a())})})}if(t==="api"){const s="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api",p=(e.domain||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim(),u=p?`https://${p}`:`https://omarcorretor.com.br/demo.html?key=${e.id}`,w=p?"🌐 Site da Imobiliária":"🌐 Site Demonstração",I=p?"Site oficial da imobiliária integrado ao CRM.":"Mostre ao cliente como o site integrado funciona com os imóveis desta imobiliária.",k=p?"Abrir site →":"Abrir site demo →";n.innerHTML=`
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          ...
          <a href="${f(u)}" target="_blank" style="display:inline-block;background:#c9a84c;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;">${k}</a>
      ...
      </div>`,(r=document.getElementById("tp-copy-key"))==null||r.addEventListener("click",()=>{var $;($=navigator.clipboard)==null||$.writeText(e.id);const y=document.getElementById("tp-copy-key"),g=y.textContent;y.textContent="✅ Copiada!",setTimeout(()=>{y.textContent=g},2e3)})}if(t==="config"){const{data:s}=await h.from("settings").select("key,value").eq("tenant_id",e.id),p={};s==null||s.forEach(w=>{p[w.key]=w.value});const u=(w,I)=>`
      <div style="margin-bottom:14px;">
        <div style="font-size:11px;font-weight:700;color:#94a3b8;letter-spacing:.06em;margin-bottom:4px;">${w}</div>
        <div style="font-size:14px;color:#0f172a;">${f(String(I||"—"))}</div>
      </div>`;n.innerHTML=`
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>Ea(e))}}function Ea(e){var c,s,p,u,w,I,k,y;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([g,$,S])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),h.from("plans").select("id, name").then(({data:g})=>{const $=document.getElementById("et-plan");$&&g&&($.innerHTML='<option value="">Sem plano</option>'+g.map(S=>`<option value="${S.id}"${String(S.id)===String(e.plan_id)?" selected":""}>${f(S.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",g=>{const $=g.target.files[0];if(!$)return;const S=URL.createObjectURL($),E=document.getElementById("et-logo-preview");E&&(E.innerHTML=`<img src="${S}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var g;(g=document.getElementById("et-logo-input"))==null||g.click()}),(p=document.getElementById("et-pwd-toggle"))==null||p.addEventListener("click",()=>{const g=document.getElementById("et-admin-password");g.type=g.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var E,L;const g=(E=document.getElementById("et-api-key"))==null?void 0:E.value;if(!g)return;(L=navigator.clipboard)==null||L.writeText(g);const $=document.getElementById("et-copy-key"),S=$.textContent;$.textContent="✅ Copiada!",setTimeout(()=>{$.textContent=S},2e3)});const o=["dados","config","api"];function i(g){o.forEach($=>{document.getElementById(`et-pane-${$}`).style.display=$===g?"":"none";const S=document.getElementById(`et-tab-${$}`);S.style.borderBottomColor=$===g?"#2563eb":"transparent",S.style.color=$===g?"#2563eb":"#64748b",S.style.fontWeight=$===g?"600":"500"}),g==="config"&&r()}o.forEach(g=>{var $;return($=document.getElementById(`et-tab-${g}`))==null?void 0:$.addEventListener("click",()=>i(g))});let l=!1;async function r(){var S;if(l)return;l=!0;const{data:g}=await h.from("settings").select("key,value").eq("tenant_id",e.id),$={};g==null||g.forEach(E=>{$[E.key]=E.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${f($["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${f($["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${f($["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${f($["company.city"]||$["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${f($["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
    ...
    `,(S=document.getElementById("et-cfg-save"))==null||S.addEventListener("click",async()=>{const E=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");E.disabled=!0,E.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const m=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),v=document.getElementById("et-cfg-phone").value.trim(),x=document.getElementById("et-cfg-email").value.trim(),_=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await h.from("settings").upsert([{key:"company.whatsapp",value:m,tenant_id:e.id},{key:"company.phone",value:v,tenant_id:e.id},{key:"company.email",value:x,tenant_id:e.id},{key:"company.city",value:_,tenant_id:e.id},{key:"company.address",value:_,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});E.disabled=!1,E.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const d=()=>n.remove();(w=document.getElementById("et-close"))==null||w.addEventListener("click",d),(I=document.getElementById("et-cancel"))==null||I.addEventListener("click",d),n.addEventListener("click",g=>{g.target===n&&d()}),(k=document.getElementById("et-delete"))==null||k.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const $=document.getElementById("et-delete");$.disabled=!0,$.textContent="Excluindo…";const{error:S}=await h.from("tenants").delete().eq("id",e.id);if(S){alert("Erro ao excluir: "+S.message),$.disabled=!1,$.textContent="🗑️ Excluir";return}d(),me()}),(y=document.getElementById("et-save"))==null||y.addEventListener("click",async()=>{var T,A,z,P,G,re,ge,qe,Ae,W,Ee,_t;const g=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),$=(P=(z=document.getElementById("et-slug"))==null?void 0:z.value)==null?void 0:P.trim(),S=(re=(G=document.getElementById("et-domain"))==null?void 0:G.value)==null?void 0:re.trim(),E=(ge=document.getElementById("et-plan"))==null?void 0:ge.value,L=(Ae=(qe=document.getElementById("et-admin-email"))==null?void 0:qe.value)==null?void 0:Ae.trim(),m=(Ee=(W=document.getElementById("et-admin-password"))==null?void 0:W.value)==null?void 0:Ee.trim(),v=(_t=document.getElementById("et-logo-input"))==null?void 0:_t.files[0],x=document.getElementById("et-msg"),_=document.getElementById("et-save");if(!g){x.textContent="❌ Nome é obrigatório.",x.style.color="#ef4444";return}_.disabled=!0,_.textContent="Salvando…",x.textContent="⏳ Salvando…",x.style.color="#64748b";let B=e.logo_url;if(v)try{const D=await Fe(v,256,.85),Bt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Sa}=await h.storage.from("imoveis").upload(Bt,D,{contentType:"image/jpeg",upsert:!0});if(!Sa){const{data:{publicUrl:La}}=h.storage.from("imoveis").getPublicUrl(Bt);B=La}}catch(D){console.error("Logo upload:",D)}const{error:C}=await h.from("tenants").update({name:g,slug:$||e.slug,domain:S||null,plan_id:E||null,logo_url:B}).eq("id",e.id);if(C){_.disabled=!1,_.textContent="Salvar",x.textContent="❌ "+C.message,x.style.color="#ef4444";return}if(L&&m&&m.length>=6){x.textContent="⏳ Criando usuário admin…";const D=await he({email:L,password:m,role:"admin",tenant_id:e.id});D!=null&&D.success?(D!=null&&D.user_id&&!(D!=null&&D.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",D.user_id),x.textContent="✅ Salvo e admin criado!",x.style.color="#22c55e"):(x.textContent="⚠️ Salvo, mas erro ao criar admin: "+((D==null?void 0:D.error)||"Tente novamente"),x.style.color="#f59e0b")}else x.textContent="✅ Imobiliária atualizada!",x.style.color="#22c55e";_.disabled=!1,_.textContent="Salvar",setTimeout(()=>{d(),me()},1200)})}const Jt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let nt=[],we=[],Ke={};function Sn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ln)}function Ln(){nt=[],we=[],Ke={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    ...
    </div>`,document.body.appendChild(e),Ia();const t=document.getElementById("import-drop-zone"),n=document.getElementById("import-file-input");function a(i){i.preventDefault()}document.addEventListener("dragover",a),document.addEventListener("drop",a),t.addEventListener("click",()=>n.click()),t.addEventListener("dragenter",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragover",i=>{i.preventDefault(),t.style.borderColor="#3b82f6",t.style.background="#eff6ff"}),t.addEventListener("dragleave",i=>{t.contains(i.relatedTarget)||(t.style.borderColor="#c7d2e0",t.style.background="")}),t.addEventListener("drop",i=>{var r,d;i.preventDefault(),t.style.borderColor="#c7d2e0",t.style.background="";const l=(d=(r=i.dataTransfer)==null?void 0:r.files)==null?void 0:d[0];l&&Kt(l)}),n.addEventListener("change",i=>{var r;const l=(r=i.target.files)==null?void 0:r[0];l&&Kt(l),i.target.value=""});const o=new MutationObserver(()=>{document.getElementById("import-leads-overlay")||(document.removeEventListener("dragover",a),document.removeEventListener("drop",a),o.disconnect())});o.observe(document.body,{childList:!0})}async function Ia(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${f(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Kt(e){if(!e)return;const t=document.getElementById("import-file-status"),n=document.getElementById("import-upload-error");n.style.display="none";const a=e.name.toLowerCase();if(t.textContent=`📄 ${e.name} (${(e.size/1024).toFixed(1)} KB)`,a.endsWith(".csv")){const o=new FileReader;o.onload=i=>{const l=_n(i.target.result);if(l.error){n.textContent=l.error,n.style.display="";return}we=l.headers,nt=l.rows,ka()},o.readAsText(e,"UTF-8")}else if(a.endsWith(".xlsx")||a.endsWith(".xls")){const o=new FileReader;o.onload=i=>Bn(i.target.result),o.readAsArrayBuffer(e)}else n.textContent="Formato não suportado. Use CSV ou XLSX.",n.style.display=""}function _n(e){const t=e.split(`
`)[0]||"",n=t.split(";").length>t.split(",").length?";":",",a=e.split(`
`).map(r=>r.trimEnd()).filter(r=>r.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(r){const d=[];let c="",s=!1;for(let p=0;p<r.length;p++){const u=r[p];u==='"'?s&&r[p+1]==='"'?(c+='"',p++):s=!s:u===n&&!s?(d.push(c.trim()),c=""):c+=u}return d.push(c.trim()),d}const i=o(a[0]).map(r=>r.replace(/^["']+|["']+$/g,"")),l=a.slice(1).map(o);return{headers:i,rows:l}}async function Bn(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,l)=>{const r=document.createElement("script");r.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",r.onload=i,r.onerror=l,document.head.appendChild(r)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}we=o[0].map(String),nt=o.slice(1),ka()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function Cn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function ka(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+we.map((a,o)=>`<option value="${o}">${f(a)}</option>`).join("");e.innerHTML=Jt.map(a=>{const o=Cn(we,t[a.key]||[]);return Ke[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Jt.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Ke[a.key]!==""&&(o.value=Ke[a.key])}),Tn(),Ia()}function Tn(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=nt.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${we.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${f(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${we.map((i,l)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${f(String(o[l]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function qn(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function An(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),l=e.querySelector("#ldp-tag-search"),r=e.querySelector("#ldp-tag-opt-list"),d=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),s=e.querySelector("#ldp-tag-new-name"),p=e.querySelector("#ldp-tag-new-color"),u=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function w(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map(S=>S.dataset.tag)}function I(S){if(!S.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=S.map(E=>{const m=(n[E]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(E)}" style="background:${m}18;color:${m};border-color:${m}55;">
        ${f(E)}<span class="ldp-tag-rm" data-tag="${f(E)}">×</span>
      </span>`}).join("")}function k(S=""){const E=w(),L=S.toLowerCase().trim(),m=t.filter(v=>!L||v.name.toLowerCase().includes(L));if(!m.length){r.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}r.innerHTML=m.map(v=>{const x=E.includes(v.name);return`<div class="ldp-tag-opt${x?" active":""}" data-tag="${f(v.name)}" style="--tc:${v.color}">
      ...
      </div>`}).join("")}function y(){i.classList.remove("hidden"),k(""),l.value="",c.classList.add("hidden"),l.focus()}function g(){i.classList.add("hidden")}o.addEventListener("click",S=>{S.stopPropagation(),i.classList.contains("hidden")?y():g()}),document.addEventListener("mousedown",function S(E){e.contains(E.target)||(g(),document.removeEventListener("mousedown",S))}),i.addEventListener("mousedown",S=>S.stopPropagation()),l.addEventListener("input",()=>k(l.value)),r.addEventListener("click",S=>{const E=S.target.closest(".ldp-tag-opt");if(!E)return;const L=E.dataset.tag,m=w();m.includes(L)?I(m.filter(v=>v!==L)):I([...m,L]),k(l.value)}),a.addEventListener("click",S=>{const E=S.target.closest(".ldp-tag-rm");if(!E)return;const L=E.dataset.tag;I(w().filter(m=>m!==L))}),d.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||s.focus()});async function $(){const S=s.value.trim();if(!S){s.focus();return}const E=p.value||"#6366F1";if(t.some(L=>L.name.toLowerCase()===S.toLowerCase())){s.style.borderColor="#ef4444",setTimeout(()=>{s.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:L,error:m}=await h.from("crm_tags").insert({name:S,color:E,tenant_id:b==null?void 0:b.tenant_id}).select().single();if(m)throw m;const v={id:L.id,name:L.name,color:L.color};t.push(v),n[v.name]=v,typeof ye<"u"&&(ye[v.name]=v),I([...w(),v.name]),k(l.value),s.value="",p.value="#6366F1",c.classList.add("hidden")}catch(L){console.error("Error creating tag:",L),alert("Erro ao criar tag: "+(L.message||L))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",$),s.addEventListener("keydown",S=>{S.key==="Enter"&&$()})}async function Mn(){var y;const e=document.getElementById("section-dashboard");if(!e)return;if(e.dataset.dbInit==="1"){try{window._dbLeadsChartInstance&&(window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null)}catch{}try{window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)}catch{}}e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-kpis db-kpis-6">
    ${["db-kpi-indigo","db-kpi-vgv","db-kpi-emerald","db-kpi-amber","db-kpi-sky","db-kpi-pink"].map((g,$)=>`
    <div class="db-kpi ${g}" id="db-kpi-${$}">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],l=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],r=`${i[n.getDay()]}, ${n.getDate()} de ${l[n.getMonth()]} de ${n.getFullYear()}`,d=((y=b==null?void 0:b.name)==null?void 0:y.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${N(d)}</span> 👋`);const s=document.getElementById("db-subline");s&&(s.textContent=`Aqui está o resumo do seu negócio — ${r}`);let p=[],u=[];try{const[g,$]=await Promise.all([ta(),zn()]);p=g||[],u=$||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}Dn(p,u,n);const w=p.filter(g=>g.published).length,I=u.filter(g=>ht(g.created_at)===ht(n.toISOString())).length,k=document.getElementById("db-header-chips");k&&(k.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${r.split(",")[0]}
    </span>`),jn(u,p),Hn(p),On(p,u,n),Pn(p,u);try{await qn(),Yt(u,7),Rn(u),document.querySelectorAll(".db-ptab").forEach(g=>{g.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach(S=>S.classList.remove("active")),g.classList.add("active");const $=parseInt(g.dataset.p);window._dbSelectedDays=$,Yt(u,$)})})}catch(g){console.warn("[Dashboard] Chart.js não carregou:",g)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const g=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!g||g.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function N(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ht(e){return(e||"").slice(0,10)}function $a(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function Ie(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function zn(){let e=h.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(b==null?void 0:b.role)==="corretor"?e=e.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function Dn(e,t,n){const a=e.length,o=e.filter(E=>E.published).length,i=t.length,l=t.filter(E=>!E.converted_at&&!E.lost_at&&E.stage).length;function r(E){if(E==null)return 0;if(typeof E=="number")return E;let m=String(E).trim().replace(/[^\d,.]/g,"");m.includes(",")&&m.lastIndexOf(",")>m.lastIndexOf(".")?m=m.replace(/\./g,"").replace(",","."):m=m.replace(/\./g,"");const v=parseFloat(m);return isNaN(v)?0:v}const d=e.filter(E=>E.published).reduce((E,L)=>E+r(L.price),0),c=new Date(n);c.setDate(c.getDate()-30);const s=t.filter(E=>E.converted_at&&new Date(E.converted_at)>=c).length,p=new Date(n);p.setDate(p.getDate()-30);const u=new Date(n);u.setDate(u.getDate()-60);const w=e.filter(E=>E.created_at&&new Date(E.created_at)>=p).length,I=e.filter(E=>E.created_at&&new Date(E.created_at)>=u&&new Date(E.created_at)<p).length,k=t.filter(E=>E.created_at&&new Date(E.created_at)>=p).length,y=t.filter(E=>E.created_at&&new Date(E.created_at)>=u&&new Date(E.created_at)<p).length;function g(E,L,m){if(L===0&&E===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(L===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const v=Math.round((E-L)/L*100);return v===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':v>0?`<span class="db-kpi-trend db-trend-up">▲ +${v}% ${m}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${v}% ${m}</span>`}function $(E){return E>=1e6?"R$ "+(E/1e6).toFixed(E>=1e7?1:2).replace(".",",")+"M":E>=1e3?"R$ "+Math.round(E/1e3)+"K":"R$ "+Math.round(E).toLocaleString("pt-BR")}[{idx:0,val:Ie(a),label:"Total de Imóveis",trend:g(w,I,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:$(d),label:"VGV Total",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Sem imóveis publicados</span>':`<span class="db-kpi-trend db-trend-up">▲ ${o} imóveis</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'},{idx:2,val:Ie(o),label:"Publicados",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:3,val:Ie(i),label:"Leads Recebidos",trend:g(k,y,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:4,val:Ie(l),label:"Em Negociação",trend:l===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos no funil</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>'},{idx:5,val:Ie(s),label:"Vendas (30d)",trend:s===0?'<span class="db-kpi-trend db-trend-neu">Aguardando primeira venda</span>':'<span class="db-kpi-trend db-trend-up">🎯 Fechadas</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>'}].forEach(({idx:E,val:L,label:m,trend:v,icon:x})=>{const _=document.getElementById(`db-kpi-${E}`);_&&(_.innerHTML=`
      <div class="db-kpi-icon">${x}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${L}</div>
        <div class="db-kpi-lbl">${N(m)}</div>
        ${v}
      </div>`)}),Nn(t)}function Nn(e){const t=document.getElementById("db-funnel-stages");if(!t)return;const n=e.filter(r=>!r.converted_at&&!r.lost_at),a={};n.forEach(r=>{const d=r.stage||"Sem etapa";a[d]=(a[d]||0)+1});const o=Object.entries(a).sort((r,d)=>d[1]-r[1]),i=n.length,l=Math.max(...o.map(r=>r[1]),1);if(!o.length){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">💼</div><div class="db-empty-text">Nenhum lead em negociação ainda</div></div>';return}t.innerHTML=o.map(([r,d])=>{const c=Math.round(d/l*100);return`<div class="db-funnel-row" onclick="navigateToSection('funil')">
      <div class="db-funnel-label">${N(r)}</div>
      <div class="db-funnel-bar-wrap"><div class="db-funnel-bar" style="width:${c}%"></div></div>
      <div class="db-funnel-count">${d}</div>
    </div>`}).join("")+`<div class="db-funnel-total">Total ativo: <strong>${i}</strong> negociações</div>`}function Yt(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let r=t-1;r>=0;r--){const d=new Date(i);d.setDate(d.getDate()-r);const c=d.toISOString().slice(0,10),s=t<=7?d.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?d.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):d.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(s),o.push(e.filter(p=>ht(p.created_at)===c).length)}const l=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(r=>r===l&&l>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:r=>` ${r.parsed.y} lead${r.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(l/4))}}}}})}window._dbOriginChartInstance=null;function Rn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const s=c.source||"Direto",p=s.charAt(0).toUpperCase()+s.slice(1);a[p]=(a[p]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),l=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],r=o.map((c,s)=>l[s%l.length]),d=i.reduce((c,s)=>c+s,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:r,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const s=d>0?Math.round(c.parsed/d*100):0;return` ${c.label}: ${c.parsed} (${s}%)`}}}}}}),n&&(d===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,s)=>`
        <div class="db-legend-item">
          <div class="db-legend-dot-row">
            <span class="db-legend-dot" style="background:${r[s]}"></span>
            <span>${N(c)}</span>
          </div>
          <span class="db-legend-val">${i[s]}</span>
        </div>`).join(""))}function jn(e,t){const n=document.getElementById("db-leads-tbody"),a=document.getElementById("db-leads-sub");if(!n)return;const o=e.slice(0,8),i=new Date;if(a&&(a.textContent=`${e.length} lead${e.length!==1?"s":""} no total`),o.length===0){n.innerHTML='<tr><td colspan="5"><div class="db-empty"><div class="db-empty-icon">💬</div><div class="db-empty-text">Nenhum lead recebido ainda</div></div></td></tr>';return}const l={novo:{cls:"db-status-novo",label:"Novo"},contatado:{cls:"db-status-contatado",label:"Contatado"},negociando:{cls:"db-status-negociando",label:"Negociando"},fechado:{cls:"db-status-fechado",label:"Fechado"},perdido:{cls:"db-status-perdido",label:"Perdido"}};n.innerHTML=o.map(r=>{const d=l[r.status]||{cls:"db-status-novo",label:r.status||"Novo"},c=r.property_id?t.find(p=>String(p.id)===String(r.property_id)):null,s=r.source?r.source.charAt(0).toUpperCase()+r.source.slice(1):"Direto";return`
    <tr>
      <td>
        <div class="db-lead-name">${N(r.name||"—")}</div>
        <div class="db-lead-phone">${N(r.phone||r.email||"—")}</div>
    ...
    </div>`}).join("")}function On(e,t,n){var i;const a=document.getElementById("db-timeline");if(!a)return;const o=[];o.push({icon:"👤",cls:"tl-login",title:"Você entrou no sistema",meta:`Bem-vindo de volta, ${((i=b==null?void 0:b.name)==null?void 0:i.split(" ")[0])||"Corretor"}`,time:n.toISOString()}),t.slice(0,3).forEach(l=>{o.push({icon:"💬",cls:"tl-lead",title:`Novo lead: ${l.name||"Sem nome"}`,meta:`Origem: ${l.source||"Direto"} · ${l.phone||l.email||""}`,time:l.created_at})}),e.slice(0,3).forEach(l=>{const r=l.published?"Imóvel publicado":"Imóvel cadastrado";o.push({icon:"🏠",cls:"tl-prop",title:`${r}: ${l.title||"Sem título"}`,meta:`${l.city||""} · ${l.reference||""}`,time:l.created_at})}),o.sort((l,r)=>new Date(r.time)-new Date(l.time)),a.innerHTML=o.slice(0,8).map(l=>`
    <div class="db-tl-item">
      <div class="db-tl-icon ${l.cls}">${l.icon}</div>
      <div class="db-tl-body">
        <div class="db-tl-title">${N(l.title)}</div>
        ${l.meta?`<div class="db-tl-meta">${N(l.meta)}</div>`:""}
      </div>
      <div class="db-tl-time">${$a(l.time,n)}</div>
    </div>`).join(""),o.length===0&&(a.innerHTML='<div class="db-empty"><div class="db-empty-icon">📋</div><div class="db-empty-text">Sem atividades recentes</div></div>')}function Pn(e,t){const n=document.getElementById("db-portfolio");if(!n)return;const a=e.length,o=e.filter(c=>c.published).length,i=a-o,l=t.filter(c=>c.stage&&c.stage!=="perdido"&&c.stage!=="fechado").length,r=e.filter(c=>{try{const s=Array.isArray(c.collection)?c.collection:JSON.parse(c.collection||"[]");return s.includes("alto-padrao")||s.includes("lancamentos")||s.includes("decorados")}catch{return!1}}).length,d=[{icon:"✅",val:o,lbl:"Imóveis Ativos"},{icon:"📝",val:i,lbl:"Em Rascunho"},{icon:"🤝",val:l,lbl:"Em Negociação"},{icon:"⭐",val:r,lbl:"Em Coleções"}];n.innerHTML=d.map(c=>`
    <div class="db-port-card">
      <div class="db-port-icon">${c.icon}</div>
      <div class="db-port-val">${Ie(c.val)}</div>
