import{s as h}from"./supabase-BcuJ3xoD.js";const W="00000000-0000-0000-0000-000000000000";let ue={},ke={},re=W;function Ee(e){re=e||W,ue={},ke={}}const M=()=>re;async function ka(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",re),h.from("site_content").select("*").eq("tenant_id",re)]);if(e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{ke[n.key]=n}),(!t.data||t.data.length===0)&&re!==W){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",W),h.from("site_content").select("*").eq("tenant_id",W)]);n.data&&n.data.forEach(o=>{ue[o.key]===void 0&&(ue[o.key]=o.value)}),a.data&&a.data.forEach(o=>{ke[o.key]||(ke[o.key]=o)})}}const Y=(e,t=null)=>ue[e]!==void 0?ue[e]:t,qe=(e,t="pt")=>{const n=ke[e];return n&&(n["value_"+t]||n.value_pt)||null};async function $e(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:re,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{ue[o]=i}),!a}async function Ve(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:re,updated_at:o},{error:d}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(ke[e]=i),re!==W&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:W,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function tt(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function yt(){const e=document.documentElement,t=Y("visual.accent_color","#b8962e"),n=Y("visual.primary_bg","#0f1c2e"),a=Y("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=Y("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=Y("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=Y("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function _t(e){e=e||"pt";const t=v=>qe(v,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),p=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),I=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),I&&t("inst.stat3_label")&&(I.innerHTML=t("inst.stat3_label"));const E=document.getElementById("dep-grid");if(E){const v=qe("testimonials",e)||qe("testimonials","pt");if(v)try{const $=JSON.parse(v);if(Array.isArray($)&&$.length>0){let k=function(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},_=function(m){let f=0;for(const w of m||"?")f=f*31+w.charCodeAt(0)&4294967295;return S[Math.abs(f)%S.length]};const S=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];E.innerHTML=$.map(m=>`
      ...
      <td class="cell-price">${g(He(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
    ...
    </tr>`}).join("")}}function Va(){const e=document.getElementById("f-city");if(!e)return;const t=be(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),n&&(e.value=n)}function Xa(){var e,t,n,a,o,i,d,l,s,c,r,p,u,I,E;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((d=document.getElementById("f-price-min"))==null?void 0:d.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((s=document.getElementById("f-area-min"))==null?void 0:s.value)||0,areaMax:parseFloat((c=document.getElementById("f-area-max"))==null?void 0:c.value)||1/0,construction:((r=document.getElementById("f-construction"))==null?void 0:r.value)||"",published:((p=document.getElementById("f-published"))==null?void 0:p.value)||"",bedrooms:((u=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:u.dataset.val)||"",suites:((I=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:I.dataset.val)||"",parking:((E=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:E.dataset.val)||""}}function xt(e){const t=Xa();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Ke(){if(!document.getElementById("admin-properties"))return;const e=await Kt(),t=e.length,n=e.filter(d=>d.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Va(),je(q)}let G=null,ae="",se=[];function dt(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden",(!history.state||history.state.modal!=="property")&&history.pushState({modal:"property"},"")}function Ge(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow="",history.state&&history.state.modal==="property"&&history.back()}window._modalPopstateBound||(window._modalPopstateBound=!0,window.addEventListener("popstate",()=>{const e=document.getElementById("property-modal");e&&!e.classList.contains("hidden")&&(e.classList.add("hidden"),document.body.style.overflow="")}));function Oe(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(se=Array.isArray(e)?[...e]:[],!se.length){t.style.display="none";return}t.style.display="",n.innerHTML=se.map(a=>`
    ...
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".cover-delete")||(ae=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(i=>i.classList.remove("selected")),a.classList.add("selected"))})}),n.querySelectorAll(".cover-delete").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const i=a.closest(".cover-thumb-wrap"),d=i==null?void 0:i.dataset.url;d&&confirm("Remover esta foto do imóvel?")&&(se=se.filter(l=>l!==d),ae===d&&(ae=se[0]||""),Oe(se))})})}}function nt(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var s;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const d=o.filter(c=>c.size>0);if(G&&(i=[...se]),d.length){t.disabled=!0,t.textContent=`Enviando 0/${d.length} foto…`;try{const c=await ja(d,(r,p)=>{t.textContent=`Enviando ${r}/${p} foto…`});i=[...i,...c]}catch(c){console.error("Erro no upload:",c),t.disabled=!1,t.textContent=G?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}i.length||(i=[..._e]);const l={...G?{id:G}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),state:a.get("state")||"",neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:ae||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",furnishing_status:a.get("furnishing_status")||"",furnished:a.get("furnishing_status")==="mobiliado",collection:JSON.stringify(["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].filter(c=>a.get(c)).map(c=>a.get(c))),tenant_id:G?((s=q.find(c=>c.id===G))==null?void 0:s.tenant_id)??(b==null?void 0:b.tenant_id)??null:(b==null?void 0:b.tenant_id)??null};try{await Ca(l),G=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const c=document.getElementById("adminPublished");c&&(c.value="true");const r=document.getElementById("adminNeighborhood");r&&(r.innerHTML='<option value="">Selecione a cidade primeiro</option>');const p=document.getElementById("adminConstructionStatus");p&&(p.value=""),ae="",Oe([]),Ge(),await Ke()}catch(c){console.error(c),t.disabled=!1,t.textContent=G?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((c==null?void 0:c.message)||JSON.stringify(c)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ta(o),await Ke()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=q.find(r=>r.id===o);if(!i)return;G=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"";const d=e.querySelector('[name="state"]');d&&(d.value=i.state||""),e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const l=e.querySelector('[name="furnishing_status"]');if(l){const r=i.furnishing_status||(i.furnished===!0?"mobiliado":"vazio");l.value=r}try{const r=JSON.parse(i.collection||"[]");["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].forEach(p=>{const u=e.querySelector('[name="'+p+'"]');u&&(u.checked=r.includes(u.value))})}catch{}const s=document.getElementById("adminPublished");s&&(s.value=i.published===!0?"true":"false");const c=document.getElementById("adminCitySelect");c&&(c.value=i.city||"",c.dispatchEvent(new Event("change")),setTimeout(()=>{const r=document.getElementById("adminNeighborhood");r&&(r.value=i.neighborhood||"")},50)),ae=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Oe(i.images||[]),dt("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Ga(e){return e?String(e).replace(/\s*\([A-Z]{2}\)\s*$/i,"").trim():""}function Wa(e,t,n,a,o){const i=[];e&&i.push(e),n&&i.push(n);const d=Ga(a);return d&&i.push(d+(o?" - "+o:"")),i.join(", ")}function wt(e){var y;const t=(y=e.images)!=null&&y.length?e.images:_e,n=_a(t),a=n.length,o=Ne(e.cover_image||n[0]),i=Wa(e.rua,e.numero,e.neighborhood,e.city,e.state),d=He(e.price,window.currentLang||"pt"),l=`https://omarcorretor.com.br/property.html?id=${e.id}`,s=encodeURIComponent(`Olá! Tenho interesse no imóvel *${e.title}*${e.reference?` (Ref: ${e.reference})`:""}. Poderia me dar mais informações?
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",r=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",p=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",I=Math.max(1,Math.min(a,6)),E=`<div class="icard-dots">${Array.from({length:I},(x,v)=>`<span class="icard-dot${v===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ${(()=>{const x=e.furnishing_status||(e.furnished===!0?"mobiliado":"");return x==="mobiliado"?'<span class="icard-badge badge-furn-mob">Mobiliado</span>':x==="semimobiliado"?'<span class="icard-badge badge-furn-semi">Semimobiliado</span>':x==="vazio"?'<span class="icard-badge badge-furn-vazio">Vazio</span>':""})()}
        <div class="icard-neighborhood">${g(e.neighborhood||e.title)}</div>
        <div class="icard-address">${g(i)}</div>
        ${c||r||p||u?`<div class="icard-specs">${c}${r}${p}${u}</div>`:""}
        ...
        <div class="icard-footer">
          ...
          <a href="https://wa.me/${ze}?text=${s}" target="_blank" rel="noopener" class="icard-wa" title="WhatsApp" onclick="fbq('track', 'Contact')">
  ...
  `}let de=[],Z=0;function Ja(e){var p,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((p=e.images)==null?void 0:p[0])||_e[0];document.getElementById("view-thumb-preview").src=i,de=(u=e.images)!=null&&u.length?e.images:_e,Z=0,Ye(),document.getElementById("view-price").textContent=He(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(I=>I.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(I=>I.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ue(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ye(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=de[Z],e.alt=`Foto ${Z+1}`;const i=de.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Z+1} / ${de.length}`:"",o.innerHTML=i?de.map((d,l)=>`<img src="${d}" class="view-thumb${l===Z?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{Z=+d.dataset.i,Ye()})})}async function Tt(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Qe(e){var p,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",r.style.display=""),c&&(c.style.display="none"))}async function qt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==W,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}const Fe={dashboard:()=>Cn(),empresa:()=>ma(),visual:()=>ua(),"site-config":()=>ga(),"crm-config":()=>fa(),integracoes:()=>va(),midia:()=>ya(),depoimentos:()=>pa()};function oe(e){var n,a;e==="vendas"&&setTimeout(()=>ia().catch(()=>{}),50),e==="perdas"&&setTimeout(()=>sa().catch(()=>{}),50),document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Fe<"u"&&Fe[e]){const o=Fe[e];Fe[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),ee(),e==="contatos"&&dn(),e==="funil"&&Qa(),e==="tarefas"&&en()}function At(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ma,visual:ua,"site-config":ga,"crm-config":fa,integracoes:va,midia:ya,depoimentos:pa}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>fn(),{once:!0}),window.lucide&&lucide.createIcons()}}function ee(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Ka(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",d=>{d.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var p,u;const d=((p=document.getElementById("cp-new"))==null?void 0:p.value)||"",l=((u=document.getElementById("cp-confirm"))==null?void 0:u.value)||"",s=document.getElementById("cp-msg"),c=document.getElementById("cp-save");if(s.style.display="none",d.length<12){s.style.color="#ef4444",s.textContent="Mínimo 6 caracteres.",s.style.display="";return}if(d!==l){s.style.color="#ef4444",s.textContent="As senhas não coincidem.",s.style.display="";return}c.disabled=!0,c.textContent="Salvando…";const{error:r}=await h.auth.updateUser({password:d});if(c.disabled=!1,c.textContent="Salvar Senha",r){s.style.color="#ef4444",s.textContent="Erro: "+r.message,s.style.display="";return}s.style.color="#16a34a",s.textContent="✅ Senha alterada com sucesso!",s.style.display="",setTimeout(n,1500)})}function Ya(){var i,d,l,s,c;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(d=document.getElementById("cph-close"))==null||d.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",r=>{r.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",r=>{const p=r.target.files[0];if(!p)return;const u=URL.createObjectURL(p),I=document.getElementById("cph-preview"),E=document.getElementById("cph-initial");I&&(I.src=u,I.style.display=""),E&&(E.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var I;const r=(I=document.getElementById("cph-file"))==null?void 0:I.files[0];if(!r)return;const p=document.getElementById("cph-save"),u=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const E=await Pe(r,400,.85),y=`avatars/${b.id}-${Date.now()}.jpg`,{error:x}=await h.storage.from("imoveis").upload(y,E,{contentType:"image/jpeg",upsert:!0});if(x)throw x;const{data:{publicUrl:v}}=h.storage.from("imoveis").getPublicUrl(y);await h.from("profiles").update({avatar_url:v}).eq("id",b.id),b={...b,avatar_url:v},Qe(b),o()}catch(E){u.style.color="#ef4444",u.textContent="Erro: "+E.message,u.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function rt(e,t){var i,d,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
    <div class="modal" style="max-width:440px;">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var u,I,E;const s=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(I=document.getElementById("ac-password"))==null?void 0:I.value.trim(),r=document.getElementById("ac-save"),p=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}r.disabled=!0,r.textContent="Criando…",p.style.display="none";try{const y=e||(b==null?void 0:b.tenant_id)||null,x=((E=document.getElementById("ac-role"))==null?void 0:E.value)||"corretor",v=await ye({email:s,password:c,role:x,tenant_id:y});r.disabled=!1,r.textContent="+ Criar Acesso",v.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",v.email_sent===!1?(p.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${g(s)}<br><strong>Senha:</strong> ${g(c)}`,p.style.color="#0f172a"):(p.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",p.style.color="#16a34a"),p.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(v.error||"Falha desconhecida"))}catch(y){r.disabled=!1,r.textContent="+ Criar Acesso",alert("Erro: "+y.message)}})}function Mt(){var i,d,l,s,c,r,p,u,I,E,y;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",x=>{var $;x.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||($=document.getElementById("notif-dropdown"))==null||$.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",x=>{x.stopPropagation(),ee(),Ya()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",x=>{x.stopPropagation(),ee(),Ka()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",x=>{x.stopPropagation(),ee(),rt()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",x=>{x.stopPropagation(),ee(),oe("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async x=>{x.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",x=>{var $;x.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||(($=document.getElementById("avatar-dropdown"))==null||$.classList.add("hidden"),an())}),(r=document.getElementById("notif-mark-all"))==null||r.addEventListener("click",()=>{nn(),ee()}),(p=document.getElementById("btn-search-open"))==null||p.addEventListener("click",()=>{var x,v;(x=document.getElementById("search-overlay"))==null||x.classList.remove("hidden"),(v=document.getElementById("search-input"))==null||v.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var x;(x=document.getElementById("search-overlay"))==null||x.classList.add("hidden")}),(I=document.getElementById("search-overlay"))==null||I.addEventListener("click",x=>{x.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(E=document.getElementById("search-input"))==null||E.addEventListener("input",x=>{clearTimeout(o),o=setTimeout(()=>tn(x.target.value.trim()),280)}),(y=document.getElementById("search-input"))==null||y.addEventListener("keydown",x=>{var v;x.key==="Escape"&&((v=document.getElementById("search-overlay"))==null||v.classList.add("hidden"))}),document.addEventListener("click",ee)}let lt=!1,F=[],Le=[],ce=[],fe={},oa=[],O=null,Ae=null,K={search:"",tags:new Set,status:""};async function Qa(){var t;if(window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||j().catch(()=>{})},3e4),lt){await zt();return}lt=!0,await zt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>pt()),En();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{O=parseInt(e.value,10),await j()})}function ct(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+oa.map(d=>`<option value="${g(d.name)}">${g(d.name)}</option>`).join(""),n.value=K.status,n.onchange=()=>{K.status=n.value,me()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(d=>`<button class="kf-tag-btn${K.tags.has(d.name)?" active":""}" data-tag="${g(d.name)}"
          style="--kf-tc:${d.color}">
          ${g(d.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const l=d.dataset.tag;K.tags.has(l)?K.tags.delete(l):K.tags.add(l),ct(e),me()})})}const o=document.getElementById("kf-search");o&&(o.value=K.search,o.oninput=()=>{K.search=o.value.toLowerCase(),me()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{K={search:"",tags:new Set,status:""},ct(e),me()})}async function zt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);F=t||[],oa=a||[],fe={},(n||[]).forEach(l=>{fe[l.name]=l});const o=F.map(l=>l.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};Le=i||[],ct(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const l=O;d.innerHTML=F.length?F.map(c=>`<option value="${c.id}">${g(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=F.find(c=>c.id===l)||F.find(c=>c.is_default)||F[0];s?(d.value=s.id,O=s.id):O=null}await j()}async function j(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1}).is("converted_at",null).is("lost_at",null);(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id)),O&&(t=t.eq("pipeline_id",O));const{data:n}=await t;ce=n||[],me()}function me(){const e=document.getElementById("kanban-board");if(!e)return;const t=Le.filter(i=>i.pipeline_id===O);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=K,a=ce.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>d.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,s,c,r;const d=i.stage||((l=t[0])==null?void 0:l.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(r=o[d]||o[(c=t[0])==null?void 0:c.name])==null||r.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],l=d.length?d.map(r=>{const p=(r.phone||"").replace(/\D/g,""),u=encodeURIComponent(`Olá ${r.name}! Aqui é da ${Y("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`),I=r.status==="quente"?"Quente":r.status==="frio"?"Frio":r.status==="morno"?"Morno":"Em andamento";r.interest;const E=Array.isArray(r.tags)?r.tags.length:0;return`
        <div class="kanban-card" draggable="true" data-id="${r.id}" data-stage="${g(i.name)}" style="cursor:pointer;">
          <div style="display:flex;align-items:center;justify-content:space-between;gap:6px;">
            <span class="rd-card-status">${g(I)}</span>
            <button class="rd-card-info-btn" data-lead="${r.id}" title="Ver resumo" onclick="event.stopPropagation();window.openLeadSidePanel('${r.id}')">
          ...
          <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:4px;">
            <div class="kanban-card-name" style="flex:1;">${g(r.name||"—")}</div>
          ...
          ${r.phone?`<div class="kanban-card-info">📞 ${g(r.phone)}</div>`:""}
          ${r.email?`<div class="kanban-card-info" style="font-size:11px;color:#94a3b8;">✉ ${g(r.email)}</div>`:""}
          ${r.notes?`<div class="kanban-card-info" style="font-size:11px;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:240px;">📝 ${g(r.notes)}</div>`:""}
          ${E>0||r.source?`<div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:2px;">
            ${r.source?`<span class="kanban-card-tag">${g(r.source)}</span>`:""}
            ${Array.isArray(r.tags)?r.tags.map(y=>{const x=fe[y],v=(x==null?void 0:x.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${v}18;color:${v};border:1px solid ${v}44;">${g(y)}</span>`}).join(""):""}
          </div>`:""}
          ...
          <button class="rd-card-task-btn" data-lead="${r.id}" onclick="event.stopPropagation()">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="14" height="14"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Criar Tarefa
          </button>
        </div>`}).join(""):'<div class="kanban-empty-col">Sem leads nesta etapa</div>',s=d.reduce((r,p)=>r+(Number(p.budget_max)||0),0),c=s>0?"R$ "+s.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ 0,00";return`
      ...
      </div>`}).join(""),Za(),window.lucide&&lucide.createIcons()}window.openLeadSidePanel=function(e){var d,l;const t=(typeof ce<"u"?ce:[]).find(s=>String(s.id)===String(e));if(!t){console.warn("[Sidepanel] lead não encontrado:",e);return}(d=document.getElementById("rd-lead-sidepanel"))==null||d.remove(),(l=document.getElementById("rd-lead-sidepanel-backdrop"))==null||l.remove();const n=document.createElement("div");n.id="rd-lead-sidepanel-backdrop",n.style.cssText="position:fixed;inset:0;background:rgba(15,23,42,0.45);z-index:1400;opacity:0;transition:opacity .2s;",n.addEventListener("click",()=>window.closeLeadSidePanel());const a=document.createElement("div");a.id="rd-lead-sidepanel",a.className="rd-lead-sidepanel";const o=s=>{if(!s)return"—";try{const c=new Date(s),r=String(c.getDate()).padStart(2,"0"),p=String(c.getMonth()+1).padStart(2,"0");return`${r}/${p}/${c.getFullYear()} às ${String(c.getHours()).padStart(2,"0")}:${String(c.getMinutes()).padStart(2,"0")}`}catch{return s}},i=(t.notes?1:0)+(t.updated_at&&t.updated_at!==t.created_at?1:0);a.innerHTML=['<div class="rd-lead-sidepanel-header">','<div class="rd-lead-sidepanel-title">Sobre a Negociação</div>','<button class="rd-lead-sidepanel-close" onclick="window.closeLeadSidePanel()" title="Fechar">','<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',"</button>","</div>",'<div class="rd-lead-sidepanel-body">','<div class="rd-lead-sidepanel-section-label">DADOS GERAIS</div>',`<div class="rd-lead-field"><div class="rd-lead-field-label">Nome</div><div class="rd-lead-field-value">${g(t.name||"—")}</div></div>`,t.phone?`<div class="rd-lead-field"><div class="rd-lead-field-label">Telefone</div><div class="rd-lead-field-value">📞 ${g(t.phone)}</div></div>`:"",t.email?`<div class="rd-lead-field"><div class="rd-lead-field-label">E-mail</div><div class="rd-lead-field-value">✉ ${g(t.email)}</div></div>`:"",`<div class="rd-lead-field"><div class="rd-lead-field-label">Fonte</div><div class="rd-lead-field-value">${g(t.source||"Não informado")}</div></div>`,t.utm_campaign?`<div class="rd-lead-field"><div class="rd-lead-field-label">Campanha</div><div class="rd-lead-field-value">${g(t.utm_campaign)}</div></div>`:"",t.utm_source?`<div class="rd-lead-field"><div class="rd-lead-field-label">UTM Source</div><div class="rd-lead-field-value">${g(t.utm_source)}</div></div>`:"",`<div class="rd-lead-field"><div class="rd-lead-field-label">Interações</div><div class="rd-lead-field-value">${i} interaç${i===1?"ão":"ões"}</div></div>`,t.notes?`<div class="rd-lead-field"><div class="rd-lead-field-label">Última anotação</div><div class="rd-lead-field-value" style="background:#f8fafc;padding:10px 12px;border-radius:6px;border-left:3px solid #06b6d4;">${g(t.notes)}</div></div>`:"",`<div class="rd-lead-field"><div class="rd-lead-field-label">Data de criação</div><div class="rd-lead-field-value">${o(t.created_at)}</div></div>`,t.updated_at&&t.updated_at!==t.created_at?`<div class="rd-lead-field"><div class="rd-lead-field-label">Último contato</div><div class="rd-lead-field-value">${o(t.updated_at)}</div></div>`:"",`<div class="rd-lead-field"><div class="rd-lead-field-label">Previsão de fechamento</div><div class="rd-lead-field-value" style="color:${t.next_contact?"#0f172a":"#94a3b8"}">${t.next_contact?o(t.next_contact):"Não preenchido"}</div></div>`,t.interest?`<div class="rd-lead-field"><div class="rd-lead-field-label">Qualificação / Interesse</div><div class="rd-lead-field-value">${g(t.interest)}</div></div>`:"",Array.isArray(t.tags)&&t.tags.length?`<div class="rd-lead-field"><div class="rd-lead-field-label">Tags</div><div class="rd-lead-field-value" style="display:flex;flex-wrap:wrap;gap:4px">${t.tags.map(s=>`<span style="background:#ecfeff;color:#0e7490;padding:2px 8px;border-radius:10px;font-size:11px;font-weight:600">${g(s)}</span>`).join("")}</div></div>`:"","</div>",'<div class="rd-lead-sidepanel-footer">',t.phone?`<button class="rd-btn-primary" style="background:#25d366;flex:1;" onclick="window.open('https://wa.me/${(t.phone||"").replace(/\D/g,"")}','_blank');if(typeof fbq==='function')fbq('track','Contact')">WhatsApp</button>`:"",`<button class="rd-btn-primary" style="flex:1;" onclick="window.closeLeadSidePanel();window.openLeadDetailPage('${t.id}')">Abrir Negociação</button>`,"</div>"].join(""),document.body.appendChild(n),document.body.appendChild(a),requestAnimationFrame(()=>{n.style.opacity="1",a.classList.add("open")})};window.openLeadDetailPage=function(e){var E;const t=(typeof ce<"u"?ce:[]).find(y=>String(y.id)===String(e));if(!t){console.warn("[LeadPage] não encontrado:",e);return}document.querySelectorAll(".admin-section").forEach(y=>y.classList.add("hidden"));const n=document.getElementById("section-lead-detail");if(!n){console.warn("section-lead-detail não existe no HTML");return}n.classList.remove("hidden"),n.dataset.leadId=t.id,document.getElementById("rd-lp-name").textContent=t.name||"—";const a=(E=(typeof F<"u"?F:[]).find(y=>y.id===t.pipeline_id))==null?void 0:E.name,o=[];a&&o.push(`<span class="rd-lp-tag cyan">${g(a)}</span>`),t.source&&o.push(`<span class="rd-lp-tag">${g(t.source)}</span>`),document.getElementById("rd-lp-tags").innerHTML=o.join("");const i=(typeof Le<"u"?Le:[]).filter(y=>y.pipeline_id===t.pipeline_id),d=i.findIndex(y=>y.name===t.stage),l=document.getElementById("rd-lp-stages");i.length?(l.innerHTML=i.map((y,x)=>{const v=x===d?"active":x<d?"done":"",$=x===d&&t.updated_at?Math.max(1,Math.floor((Date.now()-new Date(t.updated_at).getTime())/864e5)):null;return`<div class="rd-leadpage-stage ${v}" data-stage="${g(y.name)}">
        ${g(y.name.toUpperCase())}
        ${$?`<span class="rd-leadpage-stage-days">(${$} dia${$>1?"s":""})</span>`:""}
      </div>`}).join(""),l.querySelectorAll(".rd-leadpage-stage").forEach(y=>{y.addEventListener("click",async()=>{const x=y.dataset.stage;if(x===t.stage)return;const v=t.stage;t.stage=x,window.openLeadDetailPage(t.id);const{error:$}=await h.from("leads").update({stage:x}).eq("id",t.id);$&&(t.stage=v,window.openLeadDetailPage(t.id),alert("Erro: "+$.message)),typeof j=="function"&&j().catch(()=>{})})})):l.innerHTML="";const s=y=>{if(!y)return null;try{const x=new Date(y);return`${String(x.getDate()).padStart(2,"0")}/${String(x.getMonth()+1).padStart(2,"0")}/${x.getFullYear()} ${String(x.getHours()).padStart(2,"0")}:${String(x.getMinutes()).padStart(2,"0")}`}catch{return y}},c=y=>y?"R$ "+Number(y).toLocaleString("pt-BR"):null,r=[["Nome",t.name],["Qualificação",t.interest||t.status],["Previsão de fechamento",s(t.next_contact)],["Fonte",t.source],["Campanha",t.utm_campaign],["Criada em",s(t.created_at)],["Valor total",c(t.budget_max)],["Orçamento mínimo",c(t.budget_min)],["Cidade de interesse",t.city_interest],["UTM Source",t.utm_source],["UTM Medium",t.utm_medium],["Última atualização",s(t.updated_at)]].filter(([y,x])=>x!=null&&x!=="");document.getElementById("rd-lp-negociacao-fields").innerHTML=r.map(([y,x])=>`
    <div class="rd-leadpage-field-row">
      <span class="rd-leadpage-field-label">${g(y)}</span>
      <span class="rd-leadpage-field-value">${g(String(x))}</span>
    </div>
  ...
  `;const p=typeof b<"u"&&(b==null?void 0:b.full_name)||"Não atribuído";document.getElementById("rd-lp-responsavel").textContent=p,n.querySelectorAll(".rd-leadpage-tab").forEach(y=>{y.onclick=()=>{var x;n.querySelectorAll(".rd-leadpage-tab").forEach(v=>v.classList.remove("active")),y.classList.add("active"),n.querySelectorAll(".rd-leadpage-tab-panel").forEach(v=>v.classList.remove("active")),(x=n.querySelector(`.rd-leadpage-tab-panel[data-panel="${y.dataset.tab}"]`))==null||x.classList.add("active")}});const u=document.getElementById("rd-lp-timeline"),I=[];t.notes&&I.push({author:p,text:t.notes,date:t.updated_at||t.created_at,kind:"note"}),I.push({author:"Sistema",text:`Lead criado na etapa "${t.stage||"—"}"`,date:t.created_at,kind:"system"}),u.innerHTML=I.map(y=>`
    <div class="rd-leadpage-timeline-item">
      <div class="rd-leadpage-timeline-author">${g(y.author)}</div>
      <div class="rd-leadpage-timeline-text">${g(y.text)}</div>
      <div class="rd-leadpage-timeline-date">${s(y.date)||""}</div>
    </div>
  `).join("")||'<p style="color:#94a3b8;font-size:13px">Sem histórico ainda.</p>',document.getElementById("rd-lp-mark-lost").onclick=async()=>{const y=prompt("Motivo da perda (opcional):")||"",{error:x}=await h.from("leads").update({lost_at:new Date().toISOString(),lost_reason:y}).eq("id",t.id);if(x)return alert("Erro: "+x.message);typeof te=="function"?te("Lead marcado como perda","warn"):alert("Lead marcado como perda"),window.closeLeadDetailPage(),typeof j=="function"&&j().catch(()=>{})},document.getElementById("rd-lp-mark-won").onclick=async()=>{if(!confirm("Marcar como venda fechada?"))return;const{error:y}=await h.from("leads").update({converted_at:new Date().toISOString()}).eq("id",t.id);if(y)return alert("Erro: "+y.message);typeof te=="function"?te("🎉 Venda confirmada!","success"):alert("Venda confirmada!"),window.closeLeadDetailPage(),typeof j=="function"&&j().catch(()=>{})},document.getElementById("rd-lp-add-task").onclick=()=>alert("Em breve: criar tarefa direto daqui"),document.getElementById("rd-lp-add-note").onclick=async()=>{const y=prompt("Nova anotação:",t.notes||"");if(y===null)return;const{error:x}=await h.from("leads").update({notes:y}).eq("id",t.id);if(x)return alert("Erro: "+x.message);t.notes=y,window.openLeadDetailPage(t.id)},window.scrollTo({top:0,behavior:"smooth"})};async function ia(){const e=document.getElementById("vendas-list"),t=document.getElementById("vendas-total");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';const n=typeof M=="function"?M():null;let a=h.from("leads").select("*").not("converted_at","is",null).order("converted_at",{ascending:!1});n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a;if(i){e.innerHTML='<p style="color:#ef4444">Erro: '+g(i.message)+"</p>";return}const d=o||[];if(t&&(t.textContent=`${d.length} venda${d.length!==1?"s":""}`),!d.length){e.innerHTML=`<div class="rd-empty-card">
    ...
    </div>`;return}e.innerHTML=d.map(l=>{const s=l.converted_at?new Date(l.converted_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=l.budget_max?"R$ "+Number(l.budget_max).toLocaleString("pt-BR"):"—",r=(l.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-won">
      ...
      <div class="rd-result-actions">
        ${r?`<a href="https://wa.me/${r}" target="_blank" class="rd-result-action rd-result-wa" title="WhatsApp">
    ...
    </div>`;return}e.innerHTML=d.map(l=>{const s=l.lost_at?new Date(l.lost_at).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit",year:"numeric"}):"—",c=(l.phone||"").replace(/\D/g,"");return`<div class="rd-result-card rd-result-lost">
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div>
        ...
        <select id="ldp-status" class="form-input">
          ...
          ${o.map(v=>`<option value="${v.name}" ${(e==null?void 0:e.status)===v.name?"selected":""}>${g(v.name)}</option>`).join("")}
        </select>
      </div>`:""}
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(v=>{const S=(fe[v]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${g(v)}" style="background:${S}18;color:${S};border-color:${S}55;">${g(v)}<span class="ldp-tag-rm" data-tag="${g(v)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
      ...
      ${c?(()=>{const v=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${Y("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${c}?text=${v}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform="translateX(0)"}),Bn(r,a||[],fe);const p=r.querySelector("#ldp-pipe"),u=r.querySelector("#ldp-stage");p&&u&&p.addEventListener("change",()=>{const v=p.value,$=Le.filter(S=>S.pipeline_id===v);u.innerHTML=$.map(S=>`<option value="${S.name}">${S.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const I=()=>{r.style.transform="translateX(100%)",setTimeout(()=>r.remove(),250)};document.getElementById("ldp-close").addEventListener("click",I),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const v=document.getElementById("ldp-save"),$=document.getElementById("ldp-msg"),S=document.getElementById("ldp-name").value.trim();if(!S){$.style.color="#ef4444",$.textContent="Nome é obrigatório.";return}v.disabled=!0,v.textContent="Salvando…";const k=[...r.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(T=>T.dataset.tag),_=document.getElementById("ldp-pipe"),m=_?_.value:i||O,f=t?typeof Ct=="function"?Ct():{}:{},w={name:S,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:m||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:k,tenant_id:M(),...t?{utm_source:f.utm_source||null,utm_medium:f.utm_medium||null,utm_campaign:f.utm_campaign||null,utm_content:f.utm_content||null,utm_term:f.utm_term||null,fbclid:f.fbclid||null,gclid:f.gclid||null,fbp:f.fbp||null,fbc:f.fbc||null,landing_url:f.landing_url||null,user_agent:navigator.userAgent||null}:{}};let L;if(t?{error:L}=await h.from("leads").insert(w):{error:L}=await h.from("leads").update(w).eq("id",e.id),v.disabled=!1,v.textContent="💾 Salvar",L){$.style.color="#ef4444",$.textContent="Erro: "+L.message;return}$.style.color="#22c55e",$.textContent="✅ Salvo!",I(),j().catch(T=>console.warn("[Kanban] reload falhou:",T)),t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:w.name,email:w.email,phone:w.phone,tracking:f}).then(async T=>{if(T!=null&&T.ok){console.log("[CAPI] Lead enviado ao Meta:",T.event_id);try{await h.from("leads").update({capi_event_id:T.event_id,capi_sent_at:new Date().toISOString()}).eq("name",w.name).eq("phone",w.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(A){console.warn("[CAPI] falha ao salvar event_id:",A)}}else console.warn("[CAPI] não confirmado pelo Meta:",T)}).catch(T=>console.warn("[CAPI] erro:",T))}),(x=document.getElementById("ldp-delete"))==null||x.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await h.from("leads").delete().eq("id",e.id),I(),j())})}let U=[],Dt=!1,Ie="pending";async function en(){var e;window._tarefasRefreshTimer&&clearInterval(window._tarefasRefreshTimer),window._tarefasRefreshTimer=setInterval(()=>{const t=document.querySelector('.section[data-section="tarefas"]');!t||t.offsetParent===null||Nt().catch(()=>{})},3e4),!Dt&&(Dt=!0,await Nt(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>ra()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),Ie=t.dataset.filter,Be()})}))}async function Nt(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=h.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=da(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await h.from("tasks").update({status:d}).eq("id",i);const l=U.find(s=>String(s.id)===i);l&&(l.status=d),Be()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await h.from("tasks").delete().eq("id",a.dataset.id),U=U.filter(i=>String(i.id)!==String(a.dataset.id)),Be())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=U.find(l=>String(l.id)===i);d&&ra(d)})})}function ra(e=null){var s,c,r,p;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=da(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),d.addEventListener("click",u=>{u.target===d&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const u=a?"pending":"done";await h.from("tasks").update({status:u}).eq("id",e.id);const I=U.find(E=>String(E.id)===String(e.id));I&&(I.status=u),l(),u==="done"&&(Ie="done",document.querySelectorAll(".tarefa-filter-btn").forEach(E=>{E.classList.toggle("active",E.dataset.filter==="done")})),Be()}),(p=document.getElementById("tm-save"))==null||p.addEventListener("click",async()=>{var v,$;const u=document.getElementById("tarefa-form");if(!u.checkValidity()){u.reportValidity();return}const I=new FormData(u),E=document.getElementById("tm-save");E.disabled=!0,E.textContent="Salvando…";const y={title:(v=I.get("title"))==null?void 0:v.trim(),description:(($=I.get("description"))==null?void 0:$.trim())||null,due_date:I.get("due_date")||null,priority:I.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null};let x;if(n){if({error:x}=await h.from("tasks").update(y).eq("id",e.id),!x){const S=U.findIndex(k=>String(k.id)===String(e.id));S>=0&&(U[S]={...U[S],...y})}}else{const{data:S,error:k}=await h.from("tasks").insert(y).select();x=k,!x&&(S!=null&&S[0])&&U.unshift(S[0])}if(E.disabled=!1,E.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}l(),Be()})}async function tn(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;b==null||b.role,b==null||b.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),I=document.createElement("a");I.href=URL.createObjectURL(u),I.download="modelo_contatos.csv",I.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",rn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",ln)))}async function mt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;Q=a||[],ve()}function ve(){var l,s,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Q.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):Q,n=t.length,a=Math.max(1,Math.ceil(n/Me));P>a&&(P=a);const o=t.slice((P-1)*Me,P*Me),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const p=(r.phone||"").replace(/\D/g,"");if(!p)return"";const u=encodeURIComponent(`Olá ${(r.name||"").split(" ")[0]}! Aqui é da ${Y("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${p}?text=${u}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const r=n===0?0:(P-1)*Me+1,p=Math.min(P*Me,n);d.innerHTML=`
      <div style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;font-size:13px;color:#64748b;">
        <span>Exibindo <strong>${r}–${p}</strong> de <strong>${n}</strong> contatos</span>
        <div style="display:flex;gap:8px;">
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{P--,ve()}),(c=d.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{P++,ve()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",p=>{p.preventDefault();const u=r.dataset.id,I=Q.find(E=>String(E.id)===String(u));I&&la(I)})})}async function la(e=null){var v,$,S,k,_,m;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=M(),[{data:o},{data:i},{data:d}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",a).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],c=d||[],r=l.map(f=>f.id),{data:p}=r.length?await h.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},u=p||[],I=(e==null?void 0:e.pipeline_id)||((v=l[0])==null?void 0:v.id)||"";function E(f){const w=u.filter(L=>L.pipeline_id===f);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(L=>`<option value="${g(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${g(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const y=document.createElement("div");y.id="contato-modal-root",y.className="modal-backdrop",y.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${l.map(f=>`<option value="${f.id}" ${String(e==null?void 0:e.pipeline_id)===String(f.id)?"selected":""}>${g(f.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
          ...
          <div class="form-row single">
            <div class="form-group">
              ...
              <select name="status" class="form-control">
                <option value="">— Sem status —</option>
                ${c.map(f=>`<option value="${g(f.name)}" ${(e==null?void 0:e.status)===f.name?"selected":""}>${g(f.name)}</option>`).join("")}
              </select>
            </div>
          </div>`:""}
          ...
          <div class="form-row single">
            <div class="form-group">
              ...
              <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px;">
                ${s.map(f=>`
                  <label style="display:flex;align-items:center;gap:5px;cursor:pointer;padding:5px 12px;border-radius:20px;background:${f.color}18;border:1.5px solid ${f.color}55;font-size:12px;font-weight:600;color:${f.color};transition:opacity .15s;">
                    <input type="checkbox" name="tag" value="${g(f.name)}" style="margin:0;accent-color:${f.color};" ${((e==null?void 0:e.tags)||[]).includes(f.name)?"checked":""}>
                    ${g(f.name)}
                  </label>`).join("")}
              </div>
            </div>
  ...
  `,document.body.appendChild(y);const x=()=>y.remove();($=document.getElementById("cm-close"))==null||$.addEventListener("click",x),(S=document.getElementById("cm-cancel"))==null||S.addEventListener("click",x),y.addEventListener("click",f=>{f.target===y&&x()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",f=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=E(f.target.value))}),(_=document.getElementById("cm-delete"))==null||_.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const f=Q.findIndex(w=>String(w.id)===String(e.id));f>=0&&Q.splice(f,1),x(),ve()}),(m=document.getElementById("cm-save"))==null||m.addEventListener("click",async()=>{var z,H,V,ie,pe,Ce,Te;const f=document.getElementById("contato-form");if(!f.checkValidity()){f.reportValidity();return}const w=new FormData(f),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const B=w.getAll("tag"),C=w.get("pipeline_id")||null,T={name:(z=w.get("name"))==null?void 0:z.trim(),company:((H=w.get("company"))==null?void 0:H.trim())||null,email:((V=w.get("email"))==null?void 0:V.trim())||null,phone:((ie=w.get("phone"))==null?void 0:ie.trim())||null,job_title:((pe=w.get("job_title"))==null?void 0:pe.trim())||null,city_interest:((Ce=w.get("city_interest"))==null?void 0:Ce.trim())||null,notes:((Te=w.get("notes"))==null?void 0:Te.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:B,assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await h.from("leads").update(T).eq("id",e.id),!A){const X=Q.findIndex(xe=>String(xe.id)===String(e.id));X>=0&&(Q[X]={...Q[X],...T})}}else{const{data:X,error:xe}=await h.from("leads").insert(T).select();A=xe,!A&&(X!=null&&X[0])&&Q.unshift(X[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}x(),ve()})}let Se=[];function rn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Se=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,c,r,p,u]=l.split(",").map(I=>I.trim().replace(/^"|"$/g,""));return{name:s,email:c,phone:r,company:p,job_title:u}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Se.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=Se.length===0)},n.readAsText(t)}async function ln(){if(!Se.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Se.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}ut(),await mt(),alert(`${t.length} contato(s) importados com sucesso!`)}function cn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Se=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function ut(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const pn="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ye(e){return(await fetch(pn,{method:"POST",headers:{Authorization:`Bearer ${$a}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function jt(e){var s,c,r,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await h.auth.getUser();n.value=(u==null?void 0:u.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const I=u.target.files[0];if(!I)return;const E=URL.createObjectURL(I);a&&(a.src=E,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var v,$;const u=((v=document.getElementById("change-password-new"))==null?void 0:v.value)||"",I=(($=document.getElementById("change-password-confirm"))==null?void 0:$.value)||"",E=document.getElementById("change-password-msg"),y=document.getElementById("btn-change-password");if(E&&(E.style.display="none"),u.length<12){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}if(u!==I){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}y&&(y.disabled=!0,y.textContent="Salvando…");const{error:x}=await h.auth.updateUser({password:u});y&&(y.disabled=!1,y.textContent="Salvar Nova Senha"),x?E&&(E.textContent="Erro: "+x.message,E.style.display=""):(E&&(E.style.color="#16a34a",E.textContent="Senha alterada com sucesso!",E.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var $;const u=t.value.trim();let I=(b==null?void 0:b.avatar_url)||"";const E=i==null?void 0:i.files[0],y=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",E)try{const S=await Pe(E,400,.85),k=`avatars/${b.id}-${Date.now()}.jpg`,{error:_}=await h.storage.from("imoveis").upload(k,S,{contentType:"image/jpeg",upsert:!0});if(!_){const{data:{publicUrl:m}}=h.storage.from("imoveis").getPublicUrl(k);I=m}}catch(S){console.error("Avatar upload:",S)}const{error:x}=await h.from("profiles").update({name:u,avatar_url:I}).eq("id",b.id);if(d.disabled=!1,d.textContent=y,x){alert("Erro ao salvar perfil.");return}b={...b,name:u,avatar_url:I},Qe(b);const v=document.getElementById("settings-avatar-initial");v&&(v.textContent=(($=u[0])==null?void 0:$.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await Ze(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var $,S;const E=($=document.getElementById("invite-email"))==null?void 0:$.value.trim(),y=(S=document.getElementById("invite-password"))==null?void 0:S.value.trim(),x=document.getElementById("btn-invite-corretor"),v=document.getElementById("invite-note");if(!E){alert("Informe o e-mail do corretor.");return}if(!y||y.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),v&&(v.style.display="none");try{const k=await ye({email:E,password:y,tenant_id:(b==null?void 0:b.tenant_id)||null});if(k.success){const _=document.getElementById("invite-email"),m=document.getElementById("invite-password");_&&(_.value=""),m&&(m.value=""),await Ze(),v&&(k.email_sent===!1?(v.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${g(y)}`,v.style.color="#0f172a"):(v.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",v.style.color="#16a34a"),v.style.display="")}else alert("Erro: "+(k.error||"Falha desconhecida"))}catch(k){alert("Erro ao criar acesso: "+k.message)}finally{x&&(x.disabled=!1,x.textContent="+ Criar Acesso")}});const I=document.getElementById("settings-locations-section");I&&(I.style.display=""),await De(),(r=document.getElementById("loc-add-city-btn"))==null||r.addEventListener("click",async()=>{const E=document.getElementById("loc-new-city"),y=E==null?void 0:E.value.trim();if(!y)return;const{error:x}=await h.from("locations").insert({type:"cidade",name:y});if(x){alert("Erro ao adicionar cidade.");return}E&&(E.value=""),await De(),It()}),(p=document.getElementById("loc-add-neighborhood-btn"))==null||p.addEventListener("click",async()=>{var $;const E=parseInt(($=document.getElementById("loc-new-neighborhood-city"))==null?void 0:$.value,10),y=document.getElementById("loc-new-neighborhood"),x=y==null?void 0:y.value.trim();if(!E||!x){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:v}=await h.from("locations").insert({type:"bairro",name:x,parent_id:E});if(v){alert("Erro ao adicionar bairro.");return}y&&(y.value=""),await De()})}}async function Ze(){const e=document.getElementById("corretores-list");if(!e)return;let t=h.from("profiles").select("*").order("created_at");b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,l=o.id===(b==null?void 0:b.id),s=o.active!==!1,c=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',r=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
           <option value="corretor"${o.role==="corretor"?" selected":""}>Corretor</option>
           <option value="admin"${o.role==="admin"?" selected":""}>Admin</option>
         </select>`,p=l?"":s?`<button class="corretor-toggle-btn" data-uid="${o.id}" data-active="true">Pausar acesso</button>`:`<button class="corretor-toggle-btn btn-liberar" data-uid="${o.id}" data-active="false">Liberar acesso</button>`,u=l?"":`<button class="corretor-del-btn icon-btn" data-uid="${o.id}" title="Excluir corretor">🗑️</button>`;return`<div class="corretor-item">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${g(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const d=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${d}" e todos os bairros vinculados?`))return;const{error:l}=await h.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await De(),It()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:d}=await h.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await De()})})}function Ot(){var n,a,o,i,d,l,s,c,r,p,u,I,E,y,x,v,$,S,k,_;document.querySelectorAll(".filter-btn").forEach(m=>{m.addEventListener("click",()=>{const f=m.closest(".filter-btns"),w=m.classList.contains("active");f.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),w||m.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var B;const m=(B=document.getElementById("f-city"))==null?void 0:B.value,f=be().find(C=>C.name===m),w=f?Et(f.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+w.map(C=>`<option value="${C.name}">${g(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{je(xt(q))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const m=document.querySelector(".admin-filter-panel");if(m){m.querySelectorAll('input[type="text"], input[type="number"]').forEach(w=>{w.value=""}),m.querySelectorAll("select").forEach(w=>{w.selectedIndex=0});const f=document.getElementById("f-neighborhood");f&&(f.innerHTML='<option value="">Todos</option>'),m.querySelectorAll(".filter-btn.active").forEach(w=>w.classList.remove("active"))}je(q)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{oe(m.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(m=>{m.addEventListener("click",()=>{oe(m.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(m=>{m.addEventListener("click",f=>{f.stopPropagation();const w=m.closest(".topnav-dropdown");w==null||w.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==w&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(m=>m.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Ge),(d=document.getElementById("modal-cancel"))==null||d.addEventListener("click",Ge),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",m=>{m.target.id==="property-modal"&&Ge()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{G=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",ae="",Oe([]),dt("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await h.auth.signOut(),location.reload()}),(r=document.getElementById("view-prev"))==null||r.addEventListener("click",()=>{Z=(Z-1+de.length)%de.length,Ye()}),(p=document.getElementById("view-next"))==null||p.addEventListener("click",()=>{Z=(Z+1)%de.length,Ye()}),(u=document.getElementById("view-modal-close"))==null||u.addEventListener("click",Ue),(I=document.getElementById("view-modal-close2"))==null||I.addEventListener("click",Ue),(E=document.getElementById("view-modal"))==null||E.addEventListener("click",m=>{m.target.id==="view-modal"&&Ue()}),(y=document.getElementById("view-modal-share"))==null||y.addEventListener("click",()=>{const m=document.getElementById("share-panel");if(!m)return;const f=m.style.display!=="none";m.style.display=f?"none":"block"}),(x=document.getElementById("share-whatsapp"))==null||x.addEventListener("click",()=>{var H,V,ie;const m=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!m)return;const f=Number((V=document.getElementById("share-panel"))==null?void 0:V.dataset.pid),w=q.find(pe=>pe.id===f),L=(w==null?void 0:w.title)||((ie=document.getElementById("view-modal-title"))==null?void 0:ie.textContent)||"Imóvel",B=w!=null&&w.price?` — ${He(w.price,"pt")}`:"",C=w!=null&&w.reference?` | Ref: ${w.reference}`:"",T=[w==null?void 0:w.neighborhood,w==null?void 0:w.city].filter(Boolean).join(", "),A=T?`
📍 ${T}`:"",z=encodeURIComponent(`Olha esse imóvel que encontrei: *${L}*${B}${C}${A}

${m}`);window.open("https://wa.me/?text="+z,"_blank")}),(v=document.getElementById("share-instagram"))==null||v.addEventListener("click",()=>{var f,w;const m=(f=document.getElementById("share-link-input"))==null?void 0:f.value;m&&((w=navigator.clipboard)==null||w.writeText(m),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),($=document.getElementById("share-email"))==null||$.addEventListener("click",()=>{var B,C;const m=(B=document.getElementById("share-link-input"))==null?void 0:B.value;if(!m)return;const f=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",w=encodeURIComponent("Imóvel: "+f),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+m);window.open("mailto:?subject="+w+"&body="+L,"_blank")}),(S=document.getElementById("share-copy"))==null||S.addEventListener("click",()=>{var f;const m=document.getElementById("share-link-input");m&&((f=navigator.clipboard)==null||f.writeText(m.value).then(()=>{const w=document.getElementById("share-copy"),L=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var T;if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const m=Number(document.getElementById("view-modal-edit").dataset.pid),f=q.find(A=>A.id===m);if(!f)return;Ue(),G=f.id;const w=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=f.title||"",w.querySelector('[name="rua"]').value=f.rua||"",w.querySelector('[name="numero"]').value=f.numero||"",w.querySelector('[name="city"]').value=f.city||"",w.querySelector('[name="price"]').value=f.price||"",w.querySelector('[name="bedrooms"]').value=f.bedrooms||"",w.querySelector('[name="suites"]').value=f.suites||"",w.querySelector('[name="parking"]').value=f.parking||"",w.querySelector('[name="description"]').value=f.description||"",w.querySelector('[name="construction_status"]').value=f.construction_status||"",w.querySelector('[name="owner_name"]').value=f.owner_name||"",w.querySelector('[name="owner_phone"]').value=f.owner_phone||"",w.querySelector('[name="owner_email"]').value=f.owner_email||"",w.querySelector('[name="owner_notes"]').value=f.owner_notes||"",w.querySelector('[name="condominium"]').value=f.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=f.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=f.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=f.neighborhood||"")},50)),ae=f.cover_image||((T=f.images)==null?void 0:T[0])||"",Oe(f.images||[]),dt("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(m=>{m.addEventListener("click",()=>{var f;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),m.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(f=document.getElementById(`tab-${m.dataset.tab}`))==null||f.classList.remove("hidden")})}),(_=document.getElementById("admin-properties"))==null||_.addEventListener("click",m=>{if(m.target.closest(".action-btns"))return;const f=m.target.closest("tr");if(!f)return;const w=Number(f.dataset.id);if(!w)return;const L=q.find(B=>B.id===w);L&&Ja(L)})}async function pa(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let d=-1;function l(s=-1){d=s;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=s>=0?"Editar Depoimento":"Novo Depoimento";const r=s>=0?n[s]:{};e.querySelector("#dep-stars").value=String(r.stars||5),e.querySelector("#dep-text").value=r.text||"",e.querySelector("#dep-name").value=r.name||"",e.querySelector("#dep-role").value=r.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",d=-1}),e.addEventListener("click",s=>{const c=s.target.closest("[data-edit]"),r=s.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),r){const p=parseInt(r.dataset.del);confirm("Remover este depoimento?")&&(n.splice(p,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const s=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),r=e.querySelector("#dep-text").value.trim(),p=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),I=parseInt(e.querySelector("#dep-stars").value);if(!r||!p){alert("Preencha o depoimento e o nome.");return}s.disabled=!0,s.textContent="Salvando…";const E={stars:I,text:r,name:p,role:u};d>=0?n[d]=E:n.push(E);const y=await i();s.disabled=!1,s.textContent="Salvar",J(c,y),y&&(e.querySelector("#dep-form-wrap").style.display="none",d=-1,o())})}async function i(){const d=JSON.stringify(n);return await Ve("testimonials",{pt:d,en:d,es:d})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,s,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,p=Xe(r);if(p)Ee(p);else{let u=null;for(const I of[t,"www."+t]){const{data:E}=await h.from("tenants").select("id").eq("domain",I).maybeSingle();if(E!=null&&E.id){u=E;break}}u!=null&&u.id&&(Ee(u.id),it(r,u.id,24*60*60*1e3))}}await Promise.all([ka(),ca()]),ze=Y("company.whatsapp",ze),yt(),Ua(),Fa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(It(),n.addEventListener("change",()=>{const r=be().find(u=>u.name===n.value),p=r?Et(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+p.map(u=>`<option value="${u.name}">${g(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),p=new URLSearchParams(window.location.search),u=r.get("type")||p.get("type")||"",I=Wt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||p.has("code"),E=document.getElementById("password-reset-overlay");if(I){o.style.display="none",i&&i.classList.add("hidden"),E&&(E.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async x=>{var m,f;x.preventDefault();const v=((m=document.getElementById("new-password"))==null?void 0:m.value)||"",$=((f=document.getElementById("confirm-password"))==null?void 0:f.value)||"",S=document.getElementById("password-reset-msg"),k=x.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),v!==$){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:_}=await h.auth.updateUser({password:v});if(_){S&&(S.textContent="Erro: "+_.message,S.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}window.location.href=window.location.pathname}),p.has("code")&&await h.auth.exchangeCodeForSession(p.get("code")??"");return}const{data:{session:y}}=await h.auth.getSession();if(y){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),nt(),Ot(),Mt(),window.lucide&&lucide.createIcons(),b=await Tt(y.user.id),!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(b.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const x=document.getElementById("password-reset-overlay");x&&(x.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async v=>{var f,w;v.preventDefault();const $=((f=document.getElementById("new-password"))==null?void 0:f.value)||"",S=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",k=document.getElementById("password-reset-msg"),_=v.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),$!==S){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}if($.length<12){k&&(k.textContent="Mínimo 6 caracteres.",k.style.display="");return}_&&(_.disabled=!0,_.textContent="Salvando…");const{error:m}=await h.auth.updateUser({password:$});if(m){k&&(k.textContent="Erro: "+m.message,k.style.display=""),_&&(_.disabled=!1,_.textContent="Definir Senha");return}await h.from("profiles").update({needs_password_reset:!1}).eq("id",b.id),window.location.href=window.location.pathname});return}Ee((b==null?void 0:b.tenant_id)||null),Qe(b),qt(b),At(b.role),await Ke(),await jt(b),window.lucide&&lucide.createIcons(),sn(),oe("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const x=document.getElementById("login-form");x&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var S,k;const v=(k=(S=x.querySelector('input[name="email"]'))==null?void 0:S.value)==null?void 0:k.trim();if(!v){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:$}=await h.auth.resetPasswordForEmail(v,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert($?"Erro: "+$.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),x.addEventListener("submit",async v=>{v.preventDefault();const $=x.querySelector('button[type="submit"]'),S=new FormData(x),k=S.get("email"),_=S.get("password");$&&($.disabled=!0,$.textContent="Entrando…");try{if(await Da(k,_)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),nt(),Ot(),window.lucide&&lucide.createIcons();const{data:{session:f}}=await h.auth.getSession();if(b=f?await Tt(f.user.id):null,!b){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(b.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Mt(),Ee((b==null?void 0:b.tenant_id)||null),Qe(b),qt(b),At(b.role),await Ke(),await jt(b),window.lucide&&lucide.createIcons(),oe("dashboard")}else alert("E-mail ou senha incorretos")}catch(m){alert("Erro ao fazer login: "+((m==null?void 0:m.message)||String(m)))}finally{$&&($.disabled=!1,$.textContent="Entrar")}}))}}else nt();await ge();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();_t(d),Lt(ze),window._applyDynamicContent=_t,window._applyWhatsAppLinks=Lt,document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var u;const p=(u=r.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");p&&r.addEventListener("click",I=>{I.stopPropagation(),p.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(E=>{E!==p&&E.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function mn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await h.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=q.findIndex(s=>s.id===o.id);l>=0&&(q[l].reference=i),n++}}je(xt(q))}async function un(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await gn(i);a.push(d),o=!0}catch{a.push(i)}if(o){await h.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(d=>d.id===t.id);i>=0&&(q[i].images=a)}}je(xt(q))}}async function gn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),r=1200;let p=s.width,u=s.height;p>r&&(u=Math.round(u*r/p),p=r),c.width=p,c.height=u;const I=c.getContext("2d");I.drawImage(s,0,0,p,u);const E=y=>{if(y){const x=Math.round(p*.18),v=Math.round(y.naturalHeight*x/y.naturalWidth),$=Math.round(p*.02);I.globalAlpha=.45,I.drawImage(y,p-x-$,u-v-$,x,v),I.globalAlpha=1}c.toBlob(async x=>{try{const v=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:$}=await h.storage.from("imoveis").upload(v,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if($){console.error("Upload watermark error:",$),l(e);return}const{data:{publicUrl:S}}=h.storage.from("imoveis").getPublicUrl(v);l(S)}catch(v){console.error("Watermark upload exception:",v),l(e)}},"image/jpeg",.82)};if(d){const y=new Image;y.onload=()=>{URL.revokeObjectURL(d),E(y)},y.onerror=()=>{URL.revokeObjectURL(d),E(null)},y.src=d}else E(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function J(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function kt(e,t="assets"){const n=await Pe(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await h.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=h.storage.from("imoveis").getPublicUrl(a);return i}async function ma(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `;function s(r,p,u){const I=document.getElementById(r),E=document.getElementById(p);I==null||I.addEventListener("input",y=>{E.value=y.target.value,u()}),E==null||E.addEventListener("input",y=>{/^#[0-9a-fA-F]{6}$/.test(y.target.value)&&(I.value=y.target.value,u())})}function c(){var p,u,I,E;const r=((p=document.getElementById("col-accent-hex"))==null?void 0:p.value)||"#b8962e";(u=document.getElementById("vp-bar"))==null||u.style.setProperty("background",r),(I=document.getElementById("vp-dot"))==null||I.style.setProperty("background",r),(E=document.getElementById("vp-btn"))==null||E.style.setProperty("background",r),document.documentElement.style.setProperty("--accent",r)}s("col-accent","col-accent-hex",c),s("col-primary","col-primary-hex",()=>{}),s("col-secondary","col-secondary-hex",()=>{}),c(),document.getElementById("vis-hero-file").addEventListener("change",async r=>{const p=r.target.files[0];if(p)try{const u=await kt(p,"hero");document.getElementById("vis-hero-url").value=u;const I=document.getElementById("vis-hero-preview");I.innerHTML=`<img src="${u}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,I.style.display=""}catch(u){alert("Erro no upload: "+u.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const r=document.getElementById("visual-save-colors");r.disabled=!0,r.textContent="Salvando…";const p=await $e([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);p&&yt(),r.disabled=!1,r.textContent="Salvar Cores",J(document.getElementById("visual-colors-msg"),p)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",c())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const r=document.getElementById("visual-save-images");r.disabled=!0,r.textContent="Salvando…";const p=await $e([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);r.disabled=!1,r.textContent="Salvar Imagens",J(document.getElementById("visual-images-msg"),p)})}async function ga(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("*").eq("tenant_id",M()),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=(s,c)=>{var r;return g(((r=n[s])==null?void 0:r[`value_${c}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},d=s=>o.map(c=>`<button class="content-tab${c===s?" active":""}" data-lang="${c}">${i[c]}</button>`).join(""),l=s=>`
  ...
  `,document.getElementById("sc-tabs").addEventListener("click",s=>{var r;const c=s.target.closest(".content-tab");c&&(document.querySelectorAll("#sc-tabs .content-tab").forEach(p=>p.classList.remove("active")),document.querySelectorAll("#sc-panels .content-panel").forEach(p=>p.classList.remove("active")),c.classList.add("active"),(r=document.querySelector(`#sc-panels [data-panel="${c.dataset.lang}"]`))==null||r.classList.add("active"))}),document.getElementById("sc-save-btn").addEventListener("click",async()=>{const s=document.getElementById("sc-save-btn");s.disabled=!0,s.textContent="Salvando…";const c={};document.querySelectorAll(".sc-field").forEach(p=>{const u=p.dataset.key,I=p.dataset.lang;c[u]||(c[u]={}),c[u][I]=p.value});let r=!0;for(const[p,u]of Object.entries(c))await Ve(p,{pt:u.pt,en:u.en,es:u.es})||(r=!1);s.disabled=!1,s.textContent="Salvar Conteúdo",J(document.getElementById("sc-save-msg"),r)}),document.getElementById("seo-save-btn").addEventListener("click",async()=>{const s=document.getElementById("seo-save-btn");s.disabled=!0,s.textContent="Salvando…";const c=document.getElementById("seo-title").value.trim(),r=document.getElementById("seo-desc").value.trim(),p=await Ve("seo.title_pt",{pt:c,en:c,es:c})&&await Ve("seo.description_pt",{pt:r,en:r,es:r});s.disabled=!1,s.textContent="Salvar SEO",J(document.getElementById("seo-save-msg"),p)})}async function fa(){const e=document.getElementById("section-crm-config");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await R())}async function R(){var v,$,S,k,_;const e=document.getElementById("crm-body");if(!e)return;const t=M(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",t).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),d=n||[],s=(typeof O<"u"&&O?d.find(m=>m.id===O):null)||d.find(m=>m.is_default)||d[0],c=d.map(m=>`<option value="${m.id}"${m.id===(s==null?void 0:s.id)?" selected":""}>${g(m.name)}</option>`).join(""),r=(a||[]).filter(m=>m.pipeline_id===(s==null?void 0:s.id)).sort((m,f)=>(m.sort_order??0)-(f.sort_order??0)),p=r.map((m,f)=>`
    <div class="stage-item stage-draggable" data-id="${m.id}" data-idx="${f}" draggable="true">
      ...
      <div style="background:linear-gradient(to right,#fffbeb,#fef3c7);border:1px solid #fde68a;border-radius:10px;padding:14px 16px;margin-bottom:16px">
        <div style="display:flex;align-items:flex-start;gap:12px">
          ...
          <div style="font-size:13px;color:#78350f;line-height:1.6">
            <div style="font-weight:700;margin-bottom:4px;color:#92400e">Como editar as etapas do funil "${g((s==null?void 0:s.name)||"")}"</div>
  ...
  `;const I=document.getElementById("crm-pipe-sel");I&&I.addEventListener("change",async()=>{const m=parseInt(I.value,10);if(!isNaN(m))try{O=m}catch{}await R()});const E=s==null?void 0:s.id;(v=document.getElementById("crm-rename-pipeline"))==null||v.addEventListener("click",async()=>{if(!E)return;const m=prompt("Novo nome do funil:",(s==null?void 0:s.name)||"");if(!m||m.trim()===(s==null?void 0:s.name))return;const{error:f}=await h.from("crm_pipelines").update({name:m.trim()}).eq("id",E);if(f){alert("Erro: "+f.message);return}await R()}),($=document.getElementById("crm-set-default-pipeline"))==null||$.addEventListener("click",async()=>{if(E){if(s!=null&&s.is_default){alert("Este funil já é o padrão.");return}try{const m=M();await h.from("crm_pipelines").update({is_default:!1}).eq("tenant_id",m),await h.from("crm_pipelines").update({is_default:!0}).eq("id",E),await R()}catch(m){alert("Erro: "+m.message)}}}),(S=document.getElementById("crm-delete-pipeline"))==null||S.addEventListener("click",async()=>{if(E){if(d.length===1){alert("Não pode excluir o único funil. Crie outro antes.");return}confirm(`Excluir o funil "${s==null?void 0:s.name}" e todas as suas etapas?

Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await h.from("crm_stages").delete().eq("pipeline_id",E),await h.from("crm_pipelines").delete().eq("id",E),O=null,await R())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const m=document.getElementById("crm-new-stage").value.trim(),f=document.getElementById("crm-new-stage-color").value,w=parseInt(document.getElementById("crm-pipe-sel").value,10);m&&(await h.from("crm_stages").insert({pipeline_id:w,name:m,color:f,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-stage").value="",await R())}),e.querySelectorAll(".stage-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await h.from("crm_stages").delete().eq("id",m.dataset.id),await R())})}),e.querySelectorAll(".stage-name-input").forEach(m=>{m.addEventListener("blur",async()=>{const f=m.value.trim(),w=m.dataset.orig;if(!f||f===w){m.value=w;return}m.disabled=!0;const{error:L}=await h.from("crm_stages").update({name:f}).eq("id",m.dataset.sid);if(m.disabled=!1,L){console.warn("[Etapas] erro ao renomear:",L),m.value=w,alert("Erro ao renomear: "+L.message);return}m.dataset.orig=f,m.style.background="#dcfce7",setTimeout(()=>{m.style.background=""},800)}),m.addEventListener("keydown",f=>{f.key==="Enter"&&(f.preventDefault(),m.blur()),f.key==="Escape"&&(m.value=m.dataset.orig,m.blur())})}),document.getElementById("crm-stages-list");let y=null;e.querySelectorAll(".stage-draggable").forEach(m=>{m.addEventListener("dragstart",f=>{y=m,m.classList.add("stage-dragging"),f.dataTransfer.effectAllowed="move";try{f.dataTransfer.setData("text/plain",m.dataset.id)}catch{}}),m.addEventListener("dragend",()=>{m.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(f=>f.classList.remove("stage-drop-over"))}),m.addEventListener("dragover",f=>{f.preventDefault(),f.dataTransfer.dropEffect="move",m!==y&&(e.querySelectorAll(".stage-drop-over").forEach(w=>w.classList.remove("stage-drop-over")),m.classList.add("stage-drop-over"))}),m.addEventListener("dragleave",()=>{m.classList.remove("stage-drop-over")}),m.addEventListener("drop",async f=>{if(f.preventDefault(),!y||m===y)return;const w=y.dataset.id,L=m.dataset.id,B=r.findIndex(z=>String(z.id)===String(w)),C=r.findIndex(z=>String(z.id)===String(L));if(B<0||C<0)return;const T=r.splice(B,1)[0];r.splice(C,0,T);const A=r.map((z,H)=>h.from("crm_stages").update({sort_order:H}).eq("id",z.id));y=null,await Promise.all(A).catch(z=>console.warn("[stages] erro reordenar:",z)),await R()})}),e.querySelectorAll(".stage-color-pick").forEach(m=>{m.addEventListener("change",async f=>{await h.from("crm_stages").update({color:f.target.value}).eq("id",m.dataset.sid);const w=m.closest(".stage-item").querySelector(".stage-color-dot");w&&(w.style.background=f.target.value)})});const x=async()=>{const m=document.getElementById("crm-new-tag"),f=document.getElementById("crm-new-tag-color"),w=m==null?void 0:m.value.trim(),L=(f==null?void 0:f.value)||"#6366F1";if(!w){m==null||m.focus();return}await h.from("crm_tags").insert({name:w,color:L,tenant_id:M()}),m&&(m.value=""),await R()};(k=document.getElementById("crm-add-tag"))==null||k.addEventListener("click",x),(_=document.getElementById("crm-new-tag"))==null||_.addEventListener("keydown",m=>{m.key==="Enter"&&x()}),e.querySelectorAll(".tm-del-btn").forEach(m=>{m.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await h.from("crm_tags").delete().eq("id",m.dataset.id),await R())})}),e.querySelectorAll(".tm-name-input").forEach(m=>{const f=m.closest(".tm-row"),w=f==null?void 0:f.querySelector(".tm-save-btn");w&&(w.style.display="none"),m.addEventListener("input",()=>{const L=m.value.trim()!==m.dataset.orig;w&&(w.style.display=L?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(m=>{const f=m.closest(".tm-row"),w=f==null?void 0:f.querySelector(".tm-color-swatch"),L=f==null?void 0:f.querySelector(".tm-save-btn");m.addEventListener("input",B=>{w&&(w.style.background=B.target.value),L&&(L.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(m=>{m.style.display="none",m.addEventListener("click",async()=>{var B,C;const f=m.closest(".tm-row"),w=(B=f.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),L=(C=f.querySelector(".tm-color-input"))==null?void 0:C.value;w&&(m.disabled=!0,m.textContent="✓ Salvando…",await h.from("crm_tags").update({name:w,color:L}).eq("id",m.dataset.id),await R())})}),e.querySelectorAll(".tm-tpl-btn").forEach(m=>{m.addEventListener("click",async()=>{const f=m.dataset.name,w=m.dataset.color;m.disabled=!0,m.innerHTML="✓",await h.from("crm_tags").insert({name:f,color:w,tenant_id:M()}),await R()})}),e.querySelectorAll(".tag-chip-del").forEach(m=>{m.addEventListener("click",async()=>{await h.from("crm_tags").delete().eq("id",m.dataset.id),await R()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const m=document.getElementById("crm-new-status").value.trim(),f=document.getElementById("crm-new-status-color").value,w=document.getElementById("crm-new-status-final").checked;m&&(await h.from("crm_lead_statuses").insert({name:m,color:f,is_final:w,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-status").value="",await R())}),e.querySelectorAll(".status-del").forEach(m=>{m.addEventListener("click",async()=>{confirm("Remover este status?")&&(await h.from("crm_lead_statuses").delete().eq("id",m.dataset.id),await R())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var w;const m=(w=prompt("Nome do novo funil:"))==null?void 0:w.trim();if(!m)return;const{error:f}=await h.from("crm_pipelines").insert({name:m,sort_order:99,tenant_id:M()});if(f){alert("Erro ao criar funil: "+f.message);return}lt=!1,await R()})}async function va(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var s;return g(((s=n[l])==null?void 0:s.value)||"")},o=l=>{var s;return(s=n[l])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var p;const l=document.getElementById("intg-save-tracking");l.disabled=!0,l.textContent="Salvando…";let s=!0;const c=document.querySelectorAll(".intg-val"),r=document.querySelectorAll(".intg-toggle");for(let u=0;u<c.length;u++){const I=c[u].dataset.key,E=c[u].value.trim(),y=((p=r[u])==null?void 0:p.checked)??!1;await tt(I,E,y)||(s=!1)}l.disabled=!1,l.textContent="Salvar Integrações",J(document.getElementById("intg-tracking-msg"),s)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const l=document.getElementById("intg-save-smtp");l.disabled=!0,l.textContent="Salvando…";const s=document.querySelectorAll(".smtp-field");let c=!0;for(const p of s)await tt(p.dataset.key,p.value.trim(),!0)||(c=!1);const r=document.getElementById("smtp-pass").value;r&&(await tt("smtp_pass",r,!0)||(c=!1)),l.disabled=!1,l.textContent="Salvar SMTP",J(document.getElementById("intg-smtp-msg"),c)})}async function ya(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await gt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var s,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),d=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const r of a){d.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const p=await kt(r,"media"),u=r.name.replace(/\.[^.]+$/,"").slice(0,60);await h.from("media_library").insert({name:u,url:p,type:"image",size:r.size,created_by:(c=(s=(await h.auth.getUser()).data)==null?void 0:s.user)==null?void 0:c.id})}catch(p){console.error("Media upload error:",p)}l++}i.style.width="100%",d.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await gt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function gt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await h.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const l=e.querySelector(`#sa-panel-${d.dataset.tab}`);l&&l.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&le(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&vn(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ht(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Pt(),d.dataset.tab==="platform"&&Ut()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ht),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",le),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Pt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>hn()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",yn),le(),Ut())}async function le(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=h.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var r,p;return!t||((r=c.name)==null?void 0:r.toLowerCase().includes(t))||((p=c.slug)==null?void 0:p.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var r;return`
    <div class="sa-list-row" data-action="open-panel" data-id="${c.id}" style="cursor:pointer;" title="Clique para gerenciar">
      <div class="sa-list-info">
        ...
        <div>
          ...
          <div class="sa-list-sub">${g(c.slug||"")} · ${g(((r=c.plans)==null?void 0:r.name)||"Sem plano")}</div>
        </div>
      </div>
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async r=>{r.stopPropagation();const p=c.dataset.active==="true";await h.from("tenants").update({active:!p}).eq("id",c.dataset.id),le()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const r=(i||[]).find(p=>String(p.id)===String(c.dataset.id));r&&xn(r)})})}async function vn(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),h.from("plans").select("id, name").then(({data:c})=>{const r=document.getElementById("nt-plan");r&&c&&(r.innerHTML='<option value="">Sem plano</option>'+c.map(p=>`<option value="${p.id}">${g(p.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=bn(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var _,m,f,w,L,B,C,T,A,z,H,V;const c=(m=(_=document.getElementById("nt-name"))==null?void 0:_.value)==null?void 0:m.trim(),r=(w=(f=document.getElementById("nt-slug"))==null?void 0:f.value)==null?void 0:w.trim(),p=(B=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:B.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,I=(A=(T=document.getElementById("nt-admin-email"))==null?void 0:T.value)==null?void 0:A.trim(),E=(H=(z=document.getElementById("nt-admin-password"))==null?void 0:z.value)==null?void 0:H.trim(),y=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!c||!r){y.textContent="❌ Nome e slug são obrigatórios.",y.style.color="#ef4444";return}if(!I){y.textContent="❌ Informe o e-mail do admin.",y.style.color="#ef4444";return}if(!E||E.length<12){y.textContent="❌ A senha precisa ter mínimo 6 caracteres.",y.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",y.textContent="⏳ Criando imobiliária…",y.style.color="#64748b";const{data:v,error:$}=await h.from("tenants").insert({name:c,slug:r,domain:p||null,plan_id:u||null,active:!0}).select();if($){x.disabled=!1,x.textContent="Criar Imobiliária",y.textContent="❌ "+$.message,y.style.color="#ef4444";return}const S=(V=v==null?void 0:v[0])==null?void 0:V.id;y.textContent="⏳ Criando usuário admin…";const k=await ye({email:I,password:E,role:"admin",tenant_id:S});if(!(k!=null&&k.success)){x.disabled=!1,x.textContent="Criar Imobiliária",y.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g((k==null?void 0:k.error)||"Desconhecido"),y.style.color="#f59e0b",n(),le().catch(()=>{});return}S&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await h.from("profiles").update({tenant_id:S}).eq("id",k.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",k.email_sent===!1?(y.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>ba(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ft(e,o.dataset.tab)})}),ft(e,"properties")}function wn(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,c,r="text",p="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
      <label style="font-size:11px;font-weight:700;color:#64748b;letter-spacing:.05em;">${s}</label>
      <input id="${l}" type="${r}" value="${g(String(c||""))}" ${p}
      ...
      <select id="${l}" style="border:1px solid #e2e8f0;border-radius:8px;padding:9px 12px;font-size:14px;color:#0f172a;background:#fff;">
        ${c.map(([p,u])=>`<option value="${p}"${r===p?" selected":""}>${u}</option>`).join("")}
      </select>
    </div>`;a.innerHTML=`
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${r.map(p=>{var u;return`
            <tr data-pid="${p.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${g(He(p.price,"pt"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${r.map(u=>{const[I,E]=p(u.stage||u.status||"").split(","),y=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${I};color:${E};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${g(u.stage||u.status||"Novo")}</span></td>
              <td style="padding:12px 16px;font-size:12px;color:#94a3b8;">${new Date(u.created_at).toLocaleDateString("pt-BR")}</td>
              <td style="padding:12px 16px;text-align:center;">
                <div style="display:flex;gap:6px;justify-content:center;align-items:center;">
                  ${y?`<a href="https://wa.me/${y}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;background:#25d366;border-radius:6px;color:#fff;text-decoration:none;flex-shrink:0;" title="WhatsApp" onclick="fbq('track', 'Contact')"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.555 4.116 1.527 5.845L.057 23.882l6.199-1.625A11.934 11.934 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 01-4.992-1.368l-.358-.213-3.685.967.983-3.596-.234-.369A9.79 9.79 0 012.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/></svg></a>`:""}
      ...
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          ...
          <a href="${g(u)}" target="_blank" style="display:inline-block;background:#c9a84c;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;">${y}</a>
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var $;($=navigator.clipboard)==null||$.writeText(e.id);const x=document.getElementById("tp-copy-key"),v=x.textContent;x.textContent="✅ Copiada!",setTimeout(()=>{x.textContent=v},2e3)})}if(t==="config"){const{data:r}=await h.from("settings").select("key,value").eq("tenant_id",e.id),p={};r==null||r.forEach(I=>{p[I.key]=I.value});const u=(I,E)=>`
      <div style="margin-bottom:14px;">
      ...
      <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);max-width:560px;">
        ...
        ${u("PLANO",((s=e.plans)==null?void 0:s.name)||"Sem plano")}
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>ba(e))}}function ba(e){var c,r,p,u,I,E,y,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([v,$,S])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),h.from("plans").select("id, name").then(({data:v})=>{const $=document.getElementById("et-plan");$&&v&&($.innerHTML='<option value="">Sem plano</option>'+v.map(S=>`<option value="${S.id}"${String(S.id)===String(e.plan_id)?" selected":""}>${g(S.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",v=>{const $=v.target.files[0];if(!$)return;const S=URL.createObjectURL($),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${S}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var v;(v=document.getElementById("et-logo-input"))==null||v.click()}),(p=document.getElementById("et-pwd-toggle"))==null||p.addEventListener("click",()=>{const v=document.getElementById("et-admin-password");v.type=v.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var k,_;const v=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!v)return;(_=navigator.clipboard)==null||_.writeText(v);const $=document.getElementById("et-copy-key"),S=$.textContent;$.textContent="✅ Copiada!",setTimeout(()=>{$.textContent=S},2e3)});const o=["dados","config","api"];function i(v){o.forEach($=>{document.getElementById(`et-pane-${$}`).style.display=$===v?"":"none";const S=document.getElementById(`et-tab-${$}`);S.style.borderBottomColor=$===v?"#2563eb":"transparent",S.style.color=$===v?"#2563eb":"#64748b",S.style.fontWeight=$===v?"600":"500"}),v==="config"&&l()}o.forEach(v=>{var $;return($=document.getElementById(`et-tab-${v}`))==null?void 0:$.addEventListener("click",()=>i(v))});let d=!1;async function l(){var S;if(d)return;d=!0;const{data:v}=await h.from("settings").select("key,value").eq("tenant_id",e.id),$={};v==null||v.forEach(k=>{$[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(S=document.getElementById("et-cfg-save"))==null||S.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),_=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",_.textContent="",_.style.color="#64748b";const m=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),f=document.getElementById("et-cfg-phone").value.trim(),w=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await h.from("settings").upsert([{key:"company.whatsapp",value:m,tenant_id:e.id},{key:"company.phone",value:f,tenant_id:e.id},{key:"company.email",value:w,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",C?(_.textContent="❌ "+C.message,_.style.color="#ef4444"):(_.textContent="✅ Configurações salvas!",_.style.color="#22c55e")})}const s=()=>n.remove();(I=document.getElementById("et-close"))==null||I.addEventListener("click",s),(E=document.getElementById("et-cancel"))==null||E.addEventListener("click",s),n.addEventListener("click",v=>{v.target===n&&s()}),(y=document.getElementById("et-delete"))==null||y.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const $=document.getElementById("et-delete");$.disabled=!0,$.textContent="Excluindo…";const{error:S}=await h.from("tenants").delete().eq("id",e.id);if(S){alert("Erro ao excluir: "+S.message),$.disabled=!1,$.textContent="🗑️ Excluir";return}s(),le()}),(x=document.getElementById("et-save"))==null||x.addEventListener("click",async()=>{var T,A,z,H,V,ie,pe,Ce,Te,X,xe,$t;const v=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),$=(H=(z=document.getElementById("et-slug"))==null?void 0:z.value)==null?void 0:H.trim(),S=(ie=(V=document.getElementById("et-domain"))==null?void 0:V.value)==null?void 0:ie.trim(),k=(pe=document.getElementById("et-plan"))==null?void 0:pe.value,_=(Te=(Ce=document.getElementById("et-admin-email"))==null?void 0:Ce.value)==null?void 0:Te.trim(),m=(xe=(X=document.getElementById("et-admin-password"))==null?void 0:X.value)==null?void 0:xe.trim(),f=($t=document.getElementById("et-logo-input"))==null?void 0:$t.files[0],w=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!v){w.textContent="❌ Nome é obrigatório.",w.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",w.textContent="⏳ Salvando…",w.style.color="#64748b";let B=e.logo_url;if(f)try{const D=await Pe(f,256,.85),St=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Ea}=await h.storage.from("imoveis").upload(St,D,{contentType:"image/jpeg",upsert:!0});if(!Ea){const{data:{publicUrl:Ia}}=h.storage.from("imoveis").getPublicUrl(St);B=Ia}}catch(D){console.error("Logo upload:",D)}const{error:C}=await h.from("tenants").update({name:v,slug:$||e.slug,domain:S||null,plan_id:k||null,logo_url:B}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",w.textContent="❌ "+C.message,w.style.color="#ef4444";return}if(_&&m&&m.length>=6){w.textContent="⏳ Criando usuário admin…";const D=await ye({email:_,password:m,role:"admin",tenant_id:e.id});D!=null&&D.success?(D!=null&&D.user_id&&!(D!=null&&D.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",D.user_id),w.textContent="✅ Salvo e admin criado!",w.style.color="#22c55e"):(w.textContent="⚠️ Salvo, mas erro ao criar admin: "+((D==null?void 0:D.error)||"Tente novamente"),w.style.color="#f59e0b")}else w.textContent="✅ Imobiliária atualizada!",w.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{s(),le()},1200)})}const Ft=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let et=[],he=[],We={};function En(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",In)}function In(){et=[],he=[],We={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const s=[];let c="",r=!1;for(let p=0;p<l.length;p++){const u=l[p];u==='"'?r&&l[p+1]==='"'?(c+='"',p++):r=!r:u===n&&!r?(s.push(c.trim()),c=""):c+=u}return s.push(c.trim()),s}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),d=a.slice(1).map(o);return{headers:i,rows:d}}async function $n(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,d)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=d,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}he=o[0].map(String),et=o.slice(1),xa()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function Sn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function xa(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+he.map((a,o)=>`<option value="${o}">${g(a)}</option>`).join("");e.innerHTML=Ft.map(a=>{const o=Sn(he,t[a.key]||[]);return We[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Ft.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&We[a.key]!==""&&(o.value=We[a.key])}),_n(),ha()}function _n(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=et.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${he.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${g(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${he.map((i,d)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${g(String(o[d]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function Ln(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Bn(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),d=e.querySelector("#ldp-tag-search"),l=e.querySelector("#ldp-tag-opt-list"),s=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),r=e.querySelector("#ldp-tag-new-name"),p=e.querySelector("#ldp-tag-new-color"),u=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function I(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map(S=>S.dataset.tag)}function E(S){if(!S.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=S.map(k=>{const m=(n[k]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${g(k)}" style="background:${m}18;color:${m};border-color:${m}55;">
        ${g(k)}<span class="ldp-tag-rm" data-tag="${g(k)}">×</span>
      </span>`}).join("")}function y(S=""){const k=I(),_=S.toLowerCase().trim(),m=t.filter(f=>!_||f.name.toLowerCase().includes(_));if(!m.length){l.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}l.innerHTML=m.map(f=>{const w=k.includes(f.name);return`<div class="ldp-tag-opt${w?" active":""}" data-tag="${g(f.name)}" style="--tc:${f.color}">
        <span class="ldp-tag-opt-dot" style="background:${f.color}"></span>
        <span class="ldp-tag-opt-name">${g(f.name)}</span>
        ${w?'<span class="ldp-tag-opt-check">✓</span>':""}
      </div>`}).join("")}function x(){i.classList.remove("hidden"),y(""),d.value="",c.classList.add("hidden"),d.focus()}function v(){i.classList.add("hidden")}o.addEventListener("click",S=>{S.stopPropagation(),i.classList.contains("hidden")?x():v()}),document.addEventListener("mousedown",function S(k){e.contains(k.target)||(v(),document.removeEventListener("mousedown",S))}),i.addEventListener("mousedown",S=>S.stopPropagation()),d.addEventListener("input",()=>y(d.value)),l.addEventListener("click",S=>{const k=S.target.closest(".ldp-tag-opt");if(!k)return;const _=k.dataset.tag,m=I();m.includes(_)?E(m.filter(f=>f!==_)):E([...m,_]),y(d.value)}),a.addEventListener("click",S=>{const k=S.target.closest(".ldp-tag-rm");if(!k)return;const _=k.dataset.tag;E(I().filter(m=>m!==_))}),s.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||r.focus()});async function $(){const S=r.value.trim();if(!S){r.focus();return}const k=p.value||"#6366F1";if(t.some(_=>_.name.toLowerCase()===S.toLowerCase())){r.style.borderColor="#ef4444",setTimeout(()=>{r.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:_,error:m}=await h.from("crm_tags").insert({name:S,color:k,tenant_id:b==null?void 0:b.tenant_id}).select().single();if(m)throw m;const f={id:_.id,name:_.name,color:_.color};t.push(f),n[f.name]=f,typeof fe<"u"&&(fe[f.name]=f),E([...I(),f.name]),y(d.value),r.value="",p.value="#6366F1",c.classList.add("hidden")}catch(_){console.error("Error creating tag:",_),alert("Erro ao criar tag: "+(_.message||_))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",$),r.addEventListener("keydown",S=>{S.key==="Enter"&&$()})}async function Cn(){var x;const e=document.getElementById("section-dashboard");if(!e)return;if(e.dataset.dbInit==="1"){try{window._dbLeadsChartInstance&&(window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null)}catch{}try{window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)}catch{}}e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-kpis db-kpis-6">
    ${["db-kpi-indigo","db-kpi-vgv","db-kpi-emerald","db-kpi-amber","db-kpi-sky","db-kpi-pink"].map((v,$)=>`
    <div class="db-kpi ${v}" id="db-kpi-${$}">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],d=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${d[n.getMonth()]} de ${n.getFullYear()}`,s=((x=b==null?void 0:b.name)==null?void 0:x.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${N(s)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${l}`);let p=[],u=[];try{const[v,$]=await Promise.all([Kt(),Tn()]);p=v||[],u=$||[]}catch(v){console.warn("[Dashboard] Erro ao carregar dados:",v)}qn(p,u,n);const I=p.filter(v=>v.published).length,E=u.filter(v=>vt(v.created_at)===vt(n.toISOString())).length,y=document.getElementById("db-header-chips");y&&(y.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${l.split(",")[0]}
    </span>`),zn(u,p),Dn(p),Nn(p,u,n),Rn(p,u);try{await Ln(),Xt(u,7),Mn(u),document.querySelectorAll(".db-ptab").forEach(v=>{v.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach(S=>S.classList.remove("active")),v.classList.add("active");const $=parseInt(v.dataset.p);window._dbSelectedDays=$,Xt(u,$)})})}catch(v){console.warn("[Dashboard] Chart.js não carregou:",v)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const v=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!v||v.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function N(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function vt(e){return(e||"").slice(0,10)}function wa(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function we(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function Tn(){let e=h.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(b==null?void 0:b.role)==="corretor"?e=e.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function qn(e,t,n){const a=e.length,o=e.filter(k=>k.published).length,i=t.length,d=t.filter(k=>!k.converted_at&&!k.lost_at&&k.stage).length;function l(k){if(k==null)return 0;if(typeof k=="number")return k;let m=String(k).trim().replace(/[^\d,.]/g,"");m.includes(",")&&m.lastIndexOf(",")>m.lastIndexOf(".")?m=m.replace(/\./g,"").replace(",","."):m=m.replace(/\./g,"");const f=parseFloat(m);return isNaN(f)?0:f}const s=e.filter(k=>k.published).reduce((k,_)=>k+l(_.price),0),c=new Date(n);c.setDate(c.getDate()-30);const r=t.filter(k=>k.converted_at&&new Date(k.converted_at)>=c).length,p=new Date(n);p.setDate(p.getDate()-30);const u=new Date(n);u.setDate(u.getDate()-60);const I=e.filter(k=>k.created_at&&new Date(k.created_at)>=p).length,E=e.filter(k=>k.created_at&&new Date(k.created_at)>=u&&new Date(k.created_at)<p).length,y=t.filter(k=>k.created_at&&new Date(k.created_at)>=p).length,x=t.filter(k=>k.created_at&&new Date(k.created_at)>=u&&new Date(k.created_at)<p).length;function v(k,_,m){if(_===0&&k===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(_===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const f=Math.round((k-_)/_*100);return f===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':f>0?`<span class="db-kpi-trend db-trend-up">▲ +${f}% ${m}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${f}% ${m}</span>`}function $(k){return k>=1e6?"R$ "+(k/1e6).toFixed(k>=1e7?1:2).replace(".",",")+"M":k>=1e3?"R$ "+Math.round(k/1e3)+"K":"R$ "+Math.round(k).toLocaleString("pt-BR")}[{idx:0,val:we(a),label:"Total de Imóveis",trend:v(I,E,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:$(s),label:"VGV Total",trend:s===0?'<span class="db-kpi-trend db-trend-neu">Sem imóveis publicados</span>':`<span class="db-kpi-trend db-trend-up">▲ ${o} imóveis</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'},{idx:2,val:we(o),label:"Publicados",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:3,val:we(i),label:"Leads Recebidos",trend:v(y,x,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:4,val:we(d),label:"Em Negociação",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos no funil</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>'},{idx:5,val:we(r),label:"Vendas (30d)",trend:r===0?'<span class="db-kpi-trend db-trend-neu">Aguardando primeira venda</span>':'<span class="db-kpi-trend db-trend-up">🎯 Fechadas</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>'}].forEach(({idx:k,val:_,label:m,trend:f,icon:w})=>{const L=document.getElementById(`db-kpi-${k}`);L&&(L.innerHTML=`
      <div class="db-kpi-icon">${w}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${_}</div>
        <div class="db-kpi-lbl">${N(m)}</div>
        ${f}
      </div>`)}),An(t)}function An(e){const t=document.getElementById("db-funnel-stages");if(!t)return;const n=e.filter(l=>!l.converted_at&&!l.lost_at),a={};n.forEach(l=>{const s=l.stage||"Sem etapa";a[s]=(a[s]||0)+1});const o=Object.entries(a).sort((l,s)=>s[1]-l[1]),i=n.length,d=Math.max(...o.map(l=>l[1]),1);if(!o.length){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">💼</div><div class="db-empty-text">Nenhum lead em negociação ainda</div></div>';return}t.innerHTML=o.map(([l,s])=>{const c=Math.round(s/d*100);return`<div class="db-funnel-row" onclick="navigateToSection('funil')">
      <div class="db-funnel-label">${N(l)}</div>
      <div class="db-funnel-bar-wrap"><div class="db-funnel-bar" style="width:${c}%"></div></div>
      <div class="db-funnel-count">${s}</div>
    </div>`}).join("")+`<div class="db-funnel-total">Total ativo: <strong>${i}</strong> negociações</div>`}function Xt(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let l=t-1;l>=0;l--){const s=new Date(i);s.setDate(s.getDate()-l);const c=s.toISOString().slice(0,10),r=t<=7?s.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?s.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):s.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(r),o.push(e.filter(p=>vt(p.created_at)===c).length)}const d=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(l=>l===d&&d>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:l=>` ${l.parsed.y} lead${l.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(d/4))}}}}})}window._dbOriginChartInstance=null;function Mn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const r=c.source||"Direto",p=r.charAt(0).toUpperCase()+r.slice(1);a[p]=(a[p]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),d=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],l=o.map((c,r)=>d[r%d.length]),s=i.reduce((c,r)=>c+r,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:l,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const r=s>0?Math.round(c.parsed/s*100):0;return` ${c.label}: ${c.parsed} (${r}%)`}}}}}}),n&&(s===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,r)=>`
    ...
    <tr>
      ...
      <td><span class="db-status-badge ${s.cls}">${N(s.label)}</span></td>
    ...
    </tr>`}).join("")}function Dn(e){const t=document.getElementById("db-top-props");if(!t)return;const n=[...e].sort((a,o)=>new Date(o.created_at)-new Date(a.created_at)).slice(0,6);if(n.length===0){t.innerHTML='<div class="db-empty"><div class="db-empty-icon">🏠</div><div class="db-empty-text">Nenhum imóvel cadastrado ainda</div></div>';return}t.innerHTML=n.map((a,o)=>{const i=(()=>{try{return Array.isArray(a.images)?a.images:JSON.parse(a.images||"[]")}catch{return[]}})(),d=a.cover_image||i.find(u=>u&&u.startsWith("http"))||"",l=o===0?"rank-1":o===1?"rank-2":o===2?"rank-3":"",s=a.published?"pub":"rascunho",c=a.published?"Publicado":"Rascunho",r=[a.neighborhood,a.city].filter(Boolean).join(", ")||"—",p=a.price?`R$ ${String(a.price).replace(/[^0-9,.]/g,"")}`:"—";return`
    <div class="db-prop-item">
      <div class="db-prop-rank ${l}">${o+1}</div>
      ${d?`<img class="db-prop-thumb" src="${N(d)}" alt="" loading="lazy" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">`:""}
      ...
      <div class="db-prop-info">
        ...
        <div class="db-prop-city">${N(r)} · ${N(p)}</div>
      </div>
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-body">
        <div class="db-tl-title">${N(d.title)}</div>
        ${d.meta?`<div class="db-tl-meta">${N(d.meta)}</div>`:""}
      </div>
      <div class="db-tl-time">${wa(d.time,n)}</div>
