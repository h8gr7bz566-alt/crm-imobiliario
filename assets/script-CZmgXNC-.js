import{s as h}from"./supabase-BcuJ3xoD.js";const F="00000000-0000-0000-0000-000000000000";let de={},be={},ae=F;function ve(e){ae=e||F,de={},be={}}const M=()=>ae;async function ea(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",ae),h.from("site_content").select("*").eq("tenant_id",ae)]);if(e.data&&e.data.forEach(n=>{de[n.key]=n.value}),t.data&&t.data.forEach(n=>{be[n.key]=n}),(!t.data||t.data.length===0)&&ae!==F){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",F),h.from("site_content").select("*").eq("tenant_id",F)]);n.data&&n.data.forEach(o=>{de[o.key]===void 0&&(de[o.key]=o.value)}),a.data&&a.data.forEach(o=>{be[o.key]||(be[o.key]=o)})}}const J=(e,t=null)=>de[e]!==void 0?de[e]:t,ke=(e,t="pt")=>{const n=be[e];return n&&(n["value_"+t]||n.value_pt)||null};async function he(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ae,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{de[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ae,updated_at:o},{error:d}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(be[e]=i),ae!==F&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:F,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Je(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function st(){const e=document.documentElement,t=J("visual.accent_color","#b8962e"),n=J("visual.primary_bg","#0f1c2e"),a=J("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=J("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=J("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const c=J("visual.hero_bg_url","");if(c){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+c+"')")}}function ft(e){e=e||"pt";const t=f=>ke(f,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),c=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),c&&t("inst.bio_p3")&&(c.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),r=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),l=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),b=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),r&&t("inst.stat2_num")&&(r.innerHTML=t("inst.stat2_num")),l&&t("inst.stat3_num")&&(l.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),b&&t("inst.stat3_label")&&(b.innerHTML=t("inst.stat3_label"));const x=document.getElementById("dep-grid");if(x){const f=ke("testimonials",e)||ke("testimonials","pt");if(f)try{const E=JSON.parse(f);if(Array.isArray(E)&&E.length>0){let S=function(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},B=function(k){let w=0;for(const $ of k||"?")w=w*31+$.charCodeAt(0)&4294967295;return I[Math.abs(w)%I.length]};const I=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];x.innerHTML=E.map(k=>`
            <div class="dep-card-v2">
              <div class="dep-stars-v2">${"★".repeat(k.stars||5)}</div>
              <p class="dep-text-v2">"${S(k.text)}"</p>
              <div class="dep-author-v2">
                <div class="dep-avatar-v2" style="background:${B(k.name)}">${(k.name||"?")[0].toUpperCase()}</div>
                <div>
                  <div class="dep-name-v2">${S(k.name)}</div>
                  <div class="dep-role-v2">${S(k.role)}</div>
                </div>
              </div>
            </div>`).join("")}}catch{}}const u=ke("seo.title_pt",e);u&&(document.title=u);const g=ke("seo.description_pt",e);if(g){const f=document.querySelector('meta[name="description"]');f&&(f.content=g)}}function yt(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const ta="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let Le="5547999701743";const Ee=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],aa=5.7;function Te(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/aa).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],y=null,Ce=[],qt=!1;h.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(qt=!0)});function Ye(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Re(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function Tt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:l,error:m}=await h.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return m&&console.error("Supabase select error:",m),l||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=M();if(!o||o===F){const l=Re(a);if(l)o=l,ve(o);else{const m=t.replace(/^www\./,"");for(const p of[m,"www."+m]){const{data:b}=await h.from("tenants").select("id").eq("domain",p).maybeSingle();if(b!=null&&b.id){o=b.id,ve(o);break}}o&&o!==F&&Ye(a,o,24*60*60*1e3)}}if(!o||o===F)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const l=Re(i);if(l)return setTimeout(()=>Tt({background:!0}),100),l}const{data:c,error:s}=await h.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),Re(i)||[];const r=c||[];return Ye(i,r,d),e&&typeof re=="function"&&re().catch(()=>{}),r}async function At(){let e=h.from("properties").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="super_admin"||(y!=null&&y.tenant_id?e=e.eq("tenant_id",y.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],Aa(),Ma(),_)}async function na(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await h.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await h.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function oa(e){const{error:t}=await h.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function ia(e,t){const{error:n}=await h.auth.signInWithPassword({email:e,password:t});return!n}function Ae(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const c=document.createElement("canvas");let s=i.width,r=i.height;s>t&&(r=Math.round(r*t/s),s=t),c.width=s,c.height=r;const l=c.getContext("2d");l.drawImage(i,0,0,s,r);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const p=Math.round(s*.18),b=Math.round(m.naturalHeight*p/m.naturalWidth),x=Math.round(s*.02),u=s-p-x,g=r-b-x;l.globalAlpha=.45,l.drawImage(m,u,g,p,b),l.globalAlpha=1,c.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{c.toBlob(p=>p?a(p):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=d})}async function sa(e){const t=await Ae(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await h.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=h.storage.from("imoveis").getPublicUrl(n);return o}async function da(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await sa(n[o]));return a}function Mt(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function zt(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const d=a%i;o.dataset.idx=d;try{const s=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(s[d]){const r=o.querySelector(".carousel-img"),l=o.querySelector(".carousel-img-bg");r&&(r.src=s[d]),l&&(l.src=s[d])}}catch{}const c=o.querySelectorAll(".icard-dot");if(c.length){const s=d%c.length;c.forEach((r,l)=>r.classList.toggle("active",l===s))}})}function la(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=s=>e.filter(r=>{if(r.collection){try{const m=JSON.parse(r.collection);if(Array.isArray(m))return m.includes(s)}catch{}if(r.collection===s)return!0}const l=((r.title||"")+" "+(r.description||"")).toLowerCase();return s==="frente-mar"?l.includes("frente mar")||l.includes("frente ao mar"):s==="decorados"?l.includes("decorad")||l.includes("mobiliado"):s==="casas-condominio"?(r.condominium||"").length>2:!1});function a(s,r,l,m){if(!l.length)return"";const p=l.slice(0,8).map(b=>rt(b)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio"),c=Mt(t);t.innerHTML=[a("Imóveis "+(document.title.split("|")[0].trim()||"Isaac Omar").split(" ").pop(),"#8B4513",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","#8B4513",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","#8B4513",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","#8B4513",d,"imoveis.html?collection=casas-condominio"):""].join(""),zt(t,c),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",dt))}async function re(){var b,x,u,g,f,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Tt();_=n,((b=document.getElementById("selecao-carousel"))==null?void 0:b.innerHTML)===""&&ra(n);const a=((x=document.getElementById("city-filter"))==null?void 0:x.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((g=document.getElementById("bedrooms-filter"))==null?void 0:g.value)||"",d=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",c=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",{min:s,max:r}=ca(),l=n.filter(I=>{if(a&&I.city!==a||o&&I.neighborhood!==o||i&&(i==="4+"&&Number(I.bedrooms)<4||i!=="4+"&&Number(I.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(I.parking)<4||d!=="4+"&&Number(I.parking)!==Number(d))||c&&I.construction_status!==c)return!1;const S=String(I.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(S,10)||0;return!(B<s||r!==1/0&&B>r)});if(e){la(n);return}if(!l.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=Mt(t);t.innerHTML=l.map(I=>rt(I)).join(""),zt(t,m);const p=document.getElementById("properties");p&&!p._carouselDelegated&&(p._carouselDelegated=!0,p.addEventListener("click",dt))}function ra(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(c=>rt(c)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",dt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(d=a==null?void 0:a.querySelector(".selecao-next"))==null||d.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),re()};function dt(e){var c;const t=e.target.closest(".carousel-btn");if(!t)return;e.preventDefault(),e.stopPropagation();const n=t.closest(".icard-img-wrap");if(!n)return;const a=parseInt(n.dataset.total,10);if(!a||a<2)return;let o=parseInt(n.dataset.idx,10)||0;const i=t.classList.contains("carousel-next")?1:-1;o=(o+i+a)%a,n.dataset.idx=o;try{const s=JSON.parse(decodeURIComponent(n.dataset.images||"[]"));if(s.length&&s[o]){const r=s[o],l=n.querySelector(".carousel-img"),m=n.querySelector(".carousel-img-bg");l&&(l.src=r),m&&(m.src=r)}}catch{const r=_.find(m=>String(m.id)===String(n.dataset.pid)),l=(c=r==null?void 0:r.images)!=null&&c.length?r.images:Ee;if(l[o]){const m=n.querySelector(".carousel-img"),p=n.querySelector(".carousel-img-bg");m&&(m.src=l[o]),p&&(p.src=l[o])}}const d=n.querySelectorAll(".icard-dot");if(d.length){const s=o%d.length;d.forEach((r,l)=>r.classList.toggle("active",l===s))}}function ca(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function ma(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>re())}function pa(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ue();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ue().find(i=>i.name===e.value),o=a?mt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${v(i.name)}</option>`).join(""),re()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",re)})}function qe(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var d;const a=n.cover_image||((d=n.images)==null?void 0:d[0])||Ee[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
${d}`),s=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",r=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",l=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",m=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",p=Math.max(1,Math.min(n,6)),b=`<div class="icard-dots">${Array.from({length:p},(u,g)=>`<span class="icard-dot${g===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body">
        ...
        <div class="icard-footer">
          ...
          <a href="https://wa.me/${Le}?text=${c}" target="_blank" rel="noopener" class="icard-wa" title="WhatsApp">
  ...
  `}let te=[],Y=0;function fa(e){var m,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||Ee[0];document.getElementById("view-thumb-preview").src=i,te=(p=e.images)!=null&&p.length?e.images:Ee,Y=0,Pe(),document.getElementById("view-price").textContent=Te(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),c=document.getElementById("view-condominium");c&&(c.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(b=>b.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(b=>b.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,r=document.getElementById("share-link-input");r&&(r.value=s);const l=document.getElementById("share-panel");l&&(l.style.display="none",l.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Me(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Pe(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=te[Y],e.alt=`Foto ${Y+1}`;const i=te.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Y+1} / ${te.length}`:"",o.innerHTML=i?te.map((d,c)=>`<img src="${d}" class="view-thumb${c===Y?" active":""}" data-i="${c}" alt="Foto ${c+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{Y=+d.dataset.i,Pe()})})}async function bt(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Fe(e){var m,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const c=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),l=document.getElementById("avatar-dd-initial");c&&(c.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",l&&(l.style.display="none")):(l&&(l.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",l.style.display=""),r&&(r.style.display="none"))}async function ht(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==F,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),c=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==c&&(t.href=`https://${s}`)}catch{}}const ze={dashboard:()=>Ja(),empresa:()=>Pt(),visual:()=>Ft(),"site-config":()=>Vt(),"crm-config":()=>Xt(),integracoes:()=>Gt(),midia:()=>Jt(),depoimentos:()=>Ut()};function Z(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof ze<"u"&&ze[e]){const o=ze[e];ze[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),K(),e==="contatos"&&La(),e==="funil"&&ha(),e==="tarefas"&&Ea()}function xt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:Pt,visual:Ft,"site-config":Vt,"crm-config":Xt,integracoes:Gt,midia:Jt,depoimentos:Ut}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>Na(),{once:!0}),window.lucide&&lucide.createIcons()}}function K(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function ya(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(d=document.getElementById("cph-close"))==null||d.addEventListener("click",o),(c=document.getElementById("cph-cancel"))==null||c.addEventListener("click",o),t.addEventListener("click",l=>{l.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",l=>{const m=l.target.files[0];if(!m)return;const p=URL.createObjectURL(m),b=document.getElementById("cph-preview"),x=document.getElementById("cph-initial");b&&(b.src=p,b.style.display=""),x&&(x.style.display="none"),document.getElementById("cph-save").disabled=!1}),(r=document.getElementById("cph-save"))==null||r.addEventListener("click",async()=>{var b;const l=(b=document.getElementById("cph-file"))==null?void 0:b.files[0];if(!l)return;const m=document.getElementById("cph-save"),p=document.getElementById("cph-msg");m.disabled=!0,m.textContent="Salvando…";try{const x=await Ae(l,400,.85),u=`avatars/${y.id}-${Date.now()}.jpg`,{error:g}=await h.storage.from("imoveis").upload(u,x,{contentType:"image/jpeg",upsert:!0});if(g)throw g;const{data:{publicUrl:f}}=h.storage.from("imoveis").getPublicUrl(u);await h.from("profiles").update({avatar_url:f}).eq("id",y.id),y={...y,avatar_url:f},Fe(y),o()}catch(x){p.style.color="#ef4444",p.textContent="Erro: "+x.message,p.style.display="",m.disabled=!1,m.textContent="Salvar Foto"}})}function Qe(e,t){var i,d,c;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(c=document.getElementById("ac-save"))==null||c.addEventListener("click",async()=>{var p,b,x;const s=(p=document.getElementById("ac-email"))==null?void 0:p.value.trim(),r=(b=document.getElementById("ac-password"))==null?void 0:b.value.trim(),l=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!r||r.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}l.disabled=!0,l.textContent="Criando…",m.style.display="none";try{const u=e||(y==null?void 0:y.tenant_id)||null,g=((x=document.getElementById("ac-role"))==null?void 0:x.value)||"corretor",f=await pe({email:s,password:r,role:g,tenant_id:u});l.disabled=!1,l.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${v(s)}<br><strong>Senha:</strong> ${v(r)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(u){l.disabled=!1,l.textContent="+ Criar Acesso",alert("Erro: "+u.message)}})}function Et(){var i,d,c,s,r,l,m,p,b,x,u;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",g=>{var E;g.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(E=document.getElementById("notif-dropdown"))==null||E.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",g=>{g.stopPropagation(),K(),ba()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",g=>{g.stopPropagation(),K(),ya()}),(c=document.getElementById("avatar-dd-add-corretor"))==null||c.addEventListener("click",g=>{g.stopPropagation(),K(),Qe()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",g=>{g.stopPropagation(),K(),Z("settings")}),(r=document.getElementById("avatar-dd-logout"))==null||r.addEventListener("click",async g=>{g.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",g=>{var E;g.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((E=document.getElementById("avatar-dropdown"))==null||E.classList.add("hidden"),$a())}),(l=document.getElementById("notif-mark-all"))==null||l.addEventListener("click",()=>{ka(),K()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var g,f;(g=document.getElementById("search-overlay"))==null||g.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(p=document.getElementById("search-overlay-close"))==null||p.addEventListener("click",()=>{var g;(g=document.getElementById("search-overlay"))==null||g.classList.add("hidden")}),(b=document.getElementById("search-overlay"))==null||b.addEventListener("click",g=>{g.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(x=document.getElementById("search-input"))==null||x.addEventListener("input",g=>{clearTimeout(o),o=setTimeout(()=>Ia(g.target.value.trim()),280)}),(u=document.getElementById("search-input"))==null||u.addEventListener("keydown",g=>{var f;g.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",K)}let Ze=!1,se=[],ct=[],Ve=[],ce={},Nt=[],ne=null,Se=null,G={search:"",tags:new Set,status:""};async function ha(){var t;if(Ze){await wt();return}Ze=!0,await wt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>tt()),Pa();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{ne=parseInt(e.value,10),await Xe()})}function et(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+Nt.map(d=>`<option value="${v(d.name)}">${v(d.name)}</option>`).join(""),n.value=G.status,n.onchange=()=>{G.status=n.value,fe()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(d=>`<button class="kf-tag-btn${G.tags.has(d.name)?" active":""}" data-tag="${v(d.name)}"
          style="--kf-tc:${d.color}">
          ${v(d.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const c=d.dataset.tag;G.tags.has(c)?G.tags.delete(c):G.tags.add(c),et(e),fe()})})}const o=document.getElementById("kf-search");o&&(o.value=G.search,o.oninput=()=>{G.search=o.value.toLowerCase(),fe()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{G={search:"",tags:new Set,status:""},et(e),fe()})}async function wt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);se=t||[],Nt=a||[],ce={},(n||[]).forEach(c=>{ce[c.name]=c});const o=se.map(c=>c.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};ct=i||[],et(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const c=ne;d.innerHTML=se.length?se.map(r=>`<option value="${r.id}">${v(r.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=se.find(r=>r.id===c)||se.find(r=>r.is_default)||se[0];s?(d.value=s.id,ne=s.id):ne=null}await Xe()}async function Xe(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),ne&&(t=t.eq("pipeline_id",ne));const{data:n}=await t;Ve=n||[],fe()}function fe(){const e=document.getElementById("kanban-board");if(!e)return;const t=ct.filter(i=>i.pipeline_id===ne);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=G,a=Ve.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(c=>d.includes(c)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var c,s,r,l;const d=i.stage||((c=t[0])==null?void 0:c.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(l=o[d]||o[(r=t[0])==null?void 0:r.name])==null||l.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],c=d.length?d.map(s=>{const r=(s.phone||"").replace(/\D/g,""),l=encodeURIComponent(`Olá ${s.name}! Aqui é da ${J("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(m=>{const b=(ce[m]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(m)}" style="background:${b}18;color:${b};border-color:${b}55;">${v(m)}<span class="ldp-tag-rm" data-tag="${v(m)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
      ...
      ${d?(()=>{const m=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${J("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${d}?text=${m}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(c),requestAnimationFrame(()=>{c.style.transform="translateX(0)"}),Ga(c,a||[],ce);const s=()=>{c.style.transform="translateX(100%)",setTimeout(()=>c.remove(),250)};document.getElementById("ldp-close").addEventListener("click",s),document.getElementById("ldp-save").addEventListener("click",async()=>{var f,E;const m=document.getElementById("ldp-save"),p=document.getElementById("ldp-msg"),b=document.getElementById("ldp-name").value.trim();if(!b){p.style.color="#ef4444",p.textContent="Nome é obrigatório.";return}m.disabled=!0,m.textContent="Salvando…";const x=[...c.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(I=>I.dataset.tag),u={name:b,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((f=document.getElementById("ldp-stage"))==null?void 0:f.value)||null,status:((E=document.getElementById("ldp-status"))==null?void 0:E.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:x,tenant_id:M()};let g;if(t?{error:g}=await h.from("leads").insert(u):{error:g}=await h.from("leads").update(u).eq("id",e.id),m.disabled=!1,m.textContent="💾 Salvar",g){p.style.color="#ef4444",p.textContent="Erro: "+g.message;return}p.style.color="#22c55e",p.textContent="✅ Salvo!",setTimeout(()=>{s(),Xe()},700)}),(l=document.getElementById("ldp-delete"))==null||l.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await h.from("leads").delete().eq("id",e.id),s(),Xe())})}let D=[],It=!1,ye="pending";async function Ea(){var e;It||(It=!0,await wa(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Dt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),ye=t.dataset.filter,we()})}))}async function wa(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=h.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}D=n||[],we()}function jt(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function we(){const e=document.getElementById("tarefas-list");if(!e)return;let t=D;if(ye==="pending"&&(t=D.filter(a=>a.status!=="done")),ye==="done"&&(t=D.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${ye==="done"?"✅":"📋"}</div>
      <p>${ye==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await h.from("tasks").update({status:d}).eq("id",i);const c=D.find(s=>String(s.id)===i);c&&(c.status=d),we()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await h.from("tasks").delete().eq("id",a.dataset.id),D=D.filter(i=>String(i.id)!==String(a.dataset.id)),we())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=D.find(c=>String(c.id)===i);d&&Dt(d)})})}function Dt(e=null){var s,r,l,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=jt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const c=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",c),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",c),d.addEventListener("click",p=>{p.target===d&&c()}),(l=document.getElementById("tm-toggle-done"))==null||l.addEventListener("click",async()=>{const p=a?"pending":"done";await h.from("tasks").update({status:p}).eq("id",e.id);const b=D.find(x=>String(x.id)===String(e.id));b&&(b.status=p),c(),p==="done"&&(ye="done",document.querySelectorAll(".tarefa-filter-btn").forEach(x=>{x.classList.toggle("active",x.dataset.filter==="done")})),we()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var f,E;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const b=new FormData(p),x=document.getElementById("tm-save");x.disabled=!0,x.textContent="Salvando…";const u={title:(f=b.get("title"))==null?void 0:f.trim(),description:((E=b.get("description"))==null?void 0:E.trim())||null,due_date:b.get("due_date")||null,priority:b.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null};let g;if(n){if({error:g}=await h.from("tasks").update(u).eq("id",e.id),!g){const I=D.findIndex(S=>String(S.id)===String(e.id));I>=0&&(D[I]={...D[I],...u})}}else{const{data:I,error:S}=await h.from("tasks").insert(u).select();g=S,!g&&(I!=null&&I[0])&&D.unshift(I[0])}if(x.disabled=!1,x.textContent=n?"Salvar":"Criar Tarefa",g){alert("Erro: "+g.message);return}c(),we()})}async function Ia(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(d=>{d.addEventListener("click",()=>{var c;(c=document.getElementById("search-overlay"))==null||c.classList.add("hidden"),d.dataset.type==="lead"?Z("contatos"):Z("properties")})})}let Q=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function $a(){var d;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=h.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(c=>!Q.includes(String(c.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(c=>{const s=Sa(c.created_at);return`
      <div class="notif-item${!Q.includes(String(c.id))?" unread":""}" data-id="${c.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${v(c.name||"—")}</div>
          <div class="notif-item-sub">${v(c.phone||c.source||"")} · ${s}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",c=>{c.preventDefault(),K(),Z("contatos")}),e.querySelectorAll(".notif-item").forEach(c=>{c.addEventListener("click",()=>{Q.push(c.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(Q)),c.classList.remove("unread"),K(),Z("contatos")})})}function ka(){var e;document.querySelectorAll(".notif-item").forEach(t=>Q.push(t.dataset.id)),Q=[...new Set(Q)],localStorage.setItem("crm_notifs_read",JSON.stringify(Q)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Sa(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Ba(){let e=h.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!Q.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let W=[],j=1;const Be=10;let $t=!1;async function La(){var t,n,a,o,i,d,c,s,r;document.getElementById("section-contatos")&&($t||($t=!0,await Rt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{j=1,me()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",l=>{l.key==="Enter"&&(j=1,me())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>Ht()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",qa),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",at),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",at),(c=document.getElementById("download-template"))==null||c.addEventListener("click",l=>{l.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),b=document.createElement("a");b.href=URL.createObjectURL(p),b.download="modelo_contatos.csv",b.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",_a),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",Ca)))}async function Rt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;W=a||[],me()}function me(){var c,s,r;const e=(((c=document.getElementById("contato-search"))==null?void 0:c.value)||"").toLowerCase(),t=e?W.filter(l=>(l.name||"").toLowerCase().includes(e)||(l.email||"").toLowerCase().includes(e)||(l.phone||"").toLowerCase().includes(e)):W,n=t.length,a=Math.max(1,Math.ceil(n/Be));j>a&&(j=a);const o=t.slice((j-1)*Be,j*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(l=>`
      <tr>
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{j--,me()}),(r=d.querySelector("#pag-next"))==null||r.addEventListener("click",()=>{j++,me()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(l=>{l.addEventListener("click",m=>{m.preventDefault();const p=l.dataset.id,b=W.find(x=>String(x.id)===String(p));b&&Ht(b)})})}async function Ht(e=null){var f,E,I,S,B,k;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=M(),[{data:o},{data:i},{data:d}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",a).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),c=o||[],s=i||[],r=d||[],l=c.map(w=>w.id),{data:m}=l.length?await h.from("crm_stages").select("*").in("pipeline_id",l).order("sort_order"):{data:[]},p=m||[],b=(e==null?void 0:e.pipeline_id)||((f=c[0])==null?void 0:f.id)||"";function x(w){const $=p.filter(L=>L.pipeline_id===w);return $.length?'<option value="">— Selecionar etapa —</option>'+$.map(L=>`<option value="${v(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${v(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const u=document.createElement("div");u.id="contato-modal-root",u.className="modal-backdrop",u.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${c.map(w=>`<option value="${w.id}" ${String(e==null?void 0:e.pipeline_id)===String(w.id)?"selected":""}>${v(w.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
          ...
          <div class="form-row single">
            <div class="form-group">
              ...
              <select name="status" class="form-control">
                <option value="">— Sem status —</option>
                ${r.map(w=>`<option value="${v(w.name)}" ${(e==null?void 0:e.status)===w.name?"selected":""}>${v(w.name)}</option>`).join("")}
              </select>
            </div>
          </div>`:""}
  ...
  `,document.body.appendChild(u);const g=()=>u.remove();(E=document.getElementById("cm-close"))==null||E.addEventListener("click",g),(I=document.getElementById("cm-cancel"))==null||I.addEventListener("click",g),u.addEventListener("click",w=>{w.target===u&&g()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",w=>{const $=document.getElementById("cm-stage");$&&($.innerHTML=x(w.target.value))}),(B=document.getElementById("cm-delete"))==null||B.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const w=W.findIndex($=>String($.id)===String(e.id));w>=0&&W.splice(w,1),g(),me()}),(k=document.getElementById("cm-save"))==null||k.addEventListener("click",async()=>{var X,H,O,ee,ie,Ie,$e;const w=document.getElementById("contato-form");if(!w.checkValidity()){w.reportValidity();return}const $=new FormData(w),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const q=$.getAll("tag"),C=$.get("pipeline_id")||null,N={name:(X=$.get("name"))==null?void 0:X.trim(),company:((H=$.get("company"))==null?void 0:H.trim())||null,email:((O=$.get("email"))==null?void 0:O.trim())||null,phone:((ee=$.get("phone"))==null?void 0:ee.trim())||null,job_title:((ie=$.get("job_title"))==null?void 0:ie.trim())||null,city_interest:((Ie=$.get("city_interest"))==null?void 0:Ie.trim())||null,notes:(($e=$.get("notes"))==null?void 0:$e.trim())||null,pipeline_id:C,stage:$.get("stage")||null,status:$.get("status")||null,tags:q,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let T;if(n){if({error:T}=await h.from("leads").update(N).eq("id",e.id),!T){const U=W.findIndex(ge=>String(ge.id)===String(e.id));U>=0&&(W[U]={...W[U],...N})}}else{const{data:U,error:ge}=await h.from("leads").insert(N).select();T=ge,!T&&(U!=null&&U[0])&&W.unshift(U[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",T){alert("Erro: "+T.message);return}g(),me()})}let xe=[];function _a(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{xe=a.target.result.split(`
`).filter(c=>c.trim()).slice(1).map(c=>{const[s,r,l,m,p]=c.split(",").map(b=>b.trim().replace(/^"|"$/g,""));return{name:s,email:r,phone:l,company:m,job_title:p}}).filter(c=>c.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${xe.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=xe.length===0)},n.readAsText(t)}async function Ca(){if(!xe.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=xe.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}at(),await Rt(),alert(`${t.length} contato(s) importados com sucesso!`)}function qa(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),xe=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function at(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Ta="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function pe(e){return(await fetch(Ta,{method:"POST",headers:{Authorization:`Bearer ${ta}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function kt(e){var s,r,l,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:p}}=await h.auth.getUser();n.value=(p==null?void 0:p.email)||""}const c=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=c),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",p=>{const b=p.target.files[0];if(!b)return;const x=URL.createObjectURL(b);a&&(a.src=x,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var f,E;const p=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",b=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",x=document.getElementById("change-password-msg"),u=document.getElementById("btn-change-password");if(x&&(x.style.display="none"),p.length<6){x&&(x.textContent="Mínimo 6 caracteres.",x.style.display="");return}if(p!==b){x&&(x.textContent="As senhas não coincidem.",x.style.display="");return}u&&(u.disabled=!0,u.textContent="Salvando…");const{error:g}=await h.auth.updateUser({password:p});u&&(u.disabled=!1,u.textContent="Salvar Nova Senha"),g?x&&(x.textContent="Erro: "+g.message,x.style.display=""):(x&&(x.style.color="#16a34a",x.textContent="Senha alterada com sucesso!",x.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var E;const p=t.value.trim();let b=(y==null?void 0:y.avatar_url)||"";const x=i==null?void 0:i.files[0],u=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",x)try{const I=await Ae(x,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:B}=await h.storage.from("imoveis").upload(S,I,{contentType:"image/jpeg",upsert:!0});if(!B){const{data:{publicUrl:k}}=h.storage.from("imoveis").getPublicUrl(S);b=k}}catch(I){console.error("Avatar upload:",I)}const{error:g}=await h.from("profiles").update({name:p,avatar_url:b}).eq("id",y.id);if(d.disabled=!1,d.textContent=u,g){alert("Erro ao salvar perfil.");return}y={...y,name:p,avatar_url:b},Fe(y);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((E=p[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const p=document.getElementById("settings-corretores-section");p&&(p.style.display=""),await Ge(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var E,I;const x=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),u=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),g=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!x){alert("Informe o e-mail do corretor.");return}if(!u||u.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}g&&(g.disabled=!0,g.textContent="Criando…"),f&&(f.style.display="none");try{const S=await pe({email:x,password:u,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const B=document.getElementById("invite-email"),k=document.getElementById("invite-password");B&&(B.value=""),k&&(k.value=""),await Ge(),f&&(S.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${v(u)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(S.error||"Falha desconhecida"))}catch(S){alert("Erro ao criar acesso: "+S.message)}finally{g&&(g.disabled=!1,g.textContent="+ Criar Acesso")}});const b=document.getElementById("settings-locations-section");b&&(b.style.display=""),await _e(),(l=document.getElementById("loc-add-city-btn"))==null||l.addEventListener("click",async()=>{const x=document.getElementById("loc-new-city"),u=x==null?void 0:x.value.trim();if(!u)return;const{error:g}=await h.from("locations").insert({type:"cidade",name:u});if(g){alert("Erro ao adicionar cidade.");return}x&&(x.value=""),await _e(),pt()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var E;const x=parseInt((E=document.getElementById("loc-new-neighborhood-city"))==null?void 0:E.value,10),u=document.getElementById("loc-new-neighborhood"),g=u==null?void 0:u.value.trim();if(!x||!g){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await h.from("locations").insert({type:"bairro",name:g,parent_id:x});if(f){alert("Erro ao adicionar bairro.");return}u&&(u.value=""),await _e()})}}async function Ge(){const e=document.getElementById("corretores-list");if(!e)return;let t=h.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${v(i)}</div>`,c=o.id===(y==null?void 0:y.id),s=o.active!==!1,r=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',l=c?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{await h.from("profiles").update({role:o.value}).eq("id",o.dataset.uid)})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,d=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const c=await pe({action:"toggle",userId:i,active:!d});c.success||alert("Erro: "+(c.error||"Falha desconhecida"))}catch(c){alert("Erro: "+c.message)}await Ge()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var c,s;const i=o.dataset.uid,d=((s=(c=o.closest(".corretor-item"))==null?void 0:c.querySelector(".corretor-name"))==null?void 0:s.textContent)||"este corretor";if(confirm(`Excluir "${d}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const r=await pe({action:"delete",userId:i});r.success||alert("Erro ao excluir: "+(r.error||"Falha desconhecida"))}catch(r){alert("Erro: "+r.message)}await Ge()}})})}async function Ot(){const{data:e,error:t}=await h.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(Ce=e||[],Ce)}function ue(){return Ce.filter(e=>e.type==="cidade")}function mt(e){return Ce.filter(t=>t.type==="bairro"&&t.parent_id===e)}function pt(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=ue();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),t&&(e.value=t)}async function _e(){await Ot();const e=ue(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${v(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=Ce.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const d=e.find(c=>c.id===i.parent_id);return`
          <div class="loc-item">
            <div>
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${v(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const d=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${d}" e todos os bairros vinculados?`))return;const{error:c}=await h.from("locations").delete().eq("id",i.dataset.id);if(c){alert("Erro ao excluir.");return}await _e(),pt()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:d}=await h.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await _e()})})}function St(){var n,a,o,i,d,c,s,r,l,m,p,b,x,u,g,f,E,I,S,B;document.querySelectorAll(".filter-btn").forEach(k=>{k.addEventListener("click",()=>{const w=k.closest(".filter-btns"),$=k.classList.contains("active");w.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),$||k.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var q;const k=(q=document.getElementById("f-city"))==null?void 0:q.value,w=ue().find(C=>C.name===k),$=w?mt(w.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+$.map(C=>`<option value="${C.name}">${v(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{qe(lt(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const k=document.querySelector(".admin-filter-panel");if(k){k.querySelectorAll('input[type="text"], input[type="number"]').forEach($=>{$.value=""}),k.querySelectorAll("select").forEach($=>{$.selectedIndex=0});const w=document.getElementById("f-neighborhood");w&&(w.innerHTML='<option value="">Todos</option>'),k.querySelectorAll(".filter-btn.active").forEach($=>$.classList.remove("active"))}qe(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{Z(k.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{Z(k.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(k=>{k.addEventListener("click",w=>{w.stopPropagation();const $=k.closest(".topnav-dropdown");$==null||$.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==$&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(k=>k.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",He),(d=document.getElementById("modal-cancel"))==null||d.addEventListener("click",He),(c=document.getElementById("property-modal"))==null||c.addEventListener("click",k=>{k.target.id==="property-modal"&&He()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",le="",Ue([]),Ke("Novo Imóvel")}),(r=document.getElementById("logout-btn"))==null||r.addEventListener("click",async()=>{await h.auth.signOut(),location.reload()}),(l=document.getElementById("view-prev"))==null||l.addEventListener("click",()=>{Y=(Y-1+te.length)%te.length,Pe()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{Y=(Y+1)%te.length,Pe()}),(p=document.getElementById("view-modal-close"))==null||p.addEventListener("click",Me),(b=document.getElementById("view-modal-close2"))==null||b.addEventListener("click",Me),(x=document.getElementById("view-modal"))==null||x.addEventListener("click",k=>{k.target.id==="view-modal"&&Me()}),(u=document.getElementById("view-modal-share"))==null||u.addEventListener("click",()=>{const k=document.getElementById("share-panel");if(!k)return;const w=k.style.display!=="none";k.style.display=w?"none":"block"}),(g=document.getElementById("share-whatsapp"))==null||g.addEventListener("click",()=>{var H,O,ee;const k=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!k)return;const w=Number((O=document.getElementById("share-panel"))==null?void 0:O.dataset.pid),$=_.find(ie=>ie.id===w),L=($==null?void 0:$.title)||((ee=document.getElementById("view-modal-title"))==null?void 0:ee.textContent)||"Imóvel",q=$!=null&&$.price?` — ${Te($.price,"pt")}`:"",C=$!=null&&$.reference?` | Ref: ${$.reference}`:"",N=[$==null?void 0:$.neighborhood,$==null?void 0:$.city].filter(Boolean).join(", "),T=N?`
📍 ${N}`:"",X=encodeURIComponent(`Olha esse imóvel que encontrei: *${L}*${q}${C}${T}

${k}`);window.open("https://wa.me/?text="+X,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var w,$;const k=(w=document.getElementById("share-link-input"))==null?void 0:w.value;k&&(($=navigator.clipboard)==null||$.writeText(k),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(E=document.getElementById("share-email"))==null||E.addEventListener("click",()=>{var q,C;const k=(q=document.getElementById("share-link-input"))==null?void 0:q.value;if(!k)return;const w=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",$=encodeURIComponent("Imóvel: "+w),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+k);window.open("mailto:?subject="+$+"&body="+L,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const k=document.getElementById("share-link-input");k&&((w=navigator.clipboard)==null||w.writeText(k.value).then(()=>{const $=document.getElementById("share-copy"),L=$.textContent;$.textContent="✅ Copiado!",setTimeout(()=>{$.textContent=L},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var N;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(T=>T.id===k);if(!w)return;Me(),R=w.id;const $=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",$.querySelector('[name="title"]').value=w.title||"",$.querySelector('[name="rua"]').value=w.rua||"",$.querySelector('[name="numero"]').value=w.numero||"",$.querySelector('[name="city"]').value=w.city||"",$.querySelector('[name="price"]').value=w.price||"",$.querySelector('[name="bedrooms"]').value=w.bedrooms||"",$.querySelector('[name="suites"]').value=w.suites||"",$.querySelector('[name="parking"]').value=w.parking||"",$.querySelector('[name="description"]').value=w.description||"",$.querySelector('[name="construction_status"]').value=w.construction_status||"",$.querySelector('[name="owner_name"]').value=w.owner_name||"",$.querySelector('[name="owner_phone"]').value=w.owner_phone||"",$.querySelector('[name="owner_email"]').value=w.owner_email||"",$.querySelector('[name="owner_notes"]').value=w.owner_notes||"",$.querySelector('[name="condominium"]').value=w.condominium||"";const q=document.getElementById("adminPublished");q&&(q.value=w.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=w.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const T=document.getElementById("adminNeighborhood");T&&(T.value=w.neighborhood||"")},50)),le=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Ue(w.images||[]),Ke("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach($=>$.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach($=>$.classList.add("hidden")),(w=document.getElementById(`tab-${k.dataset.tab}`))==null||w.classList.remove("hidden")})}),(B=document.getElementById("admin-properties"))==null||B.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const w=k.target.closest("tr");if(!w)return;const $=Number(w.dataset.id);if(!$)return;const L=_.find(q=>q.id===$);L&&fa(L)})}async function Ut(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const c=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const r of d||"?")s=s*31+r.charCodeAt(0)&4294967295;return c[Math.abs(s)%c.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let d=-1;function c(s=-1){d=s;const r=e.querySelector("#dep-form-wrap");r.style.display="",e.querySelector("#dep-form-title").textContent=s>=0?"Editar Depoimento":"Novo Depoimento";const l=s>=0?n[s]:{};e.querySelector("#dep-stars").value=String(l.stars||5),e.querySelector("#dep-text").value=l.text||"",e.querySelector("#dep-name").value=l.name||"",e.querySelector("#dep-role").value=l.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>c(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",d=-1}),e.addEventListener("click",s=>{const r=s.target.closest("[data-edit]"),l=s.target.closest("[data-del]");if(r&&c(parseInt(r.dataset.edit)),l){const m=parseInt(l.dataset.del);confirm("Remover este depoimento?")&&(n.splice(m,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const s=e.querySelector("#dep-form-save"),r=e.querySelector("#dep-save-msg"),l=e.querySelector("#dep-text").value.trim(),m=e.querySelector("#dep-name").value.trim(),p=e.querySelector("#dep-role").value.trim(),b=parseInt(e.querySelector("#dep-stars").value);if(!l||!m){alert("Preencha o depoimento e o nome.");return}s.disabled=!0,s.textContent="Salvando…";const x={stars:b,text:l,name:m,role:p};d>=0?n[d]=x:n.push(x);const u=await i();s.disabled=!1,s.textContent="Salvar",V(r,u),u&&(e.querySelector("#dep-form-wrap").style.display="none",d=-1,o())})}async function i(){const d=JSON.stringify(n);return await De("testimonials",{pt:d,en:d,es:d})}o()}document.addEventListener("DOMContentLoaded",async()=>{var c,s,r;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const l=`imobi_tenant_${t}`,m=Re(l);if(m)ve(m);else{let p=null;for(const b of[t,"www."+t]){const{data:x}=await h.from("tenants").select("id").eq("domain",b).maybeSingle();if(x!=null&&x.id){p=x;break}}p!=null&&p.id&&(ve(p.id),Ye(l,p.id,24*60*60*1e3))}}await Promise.all([ea(),Ot()]),Le=J("company.whatsapp",Le),st(),ma(),pa();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(pt(),n.addEventListener("change",()=>{const l=ue().find(p=>p.name===n.value),m=l?mt(l.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+m.map(p=>`<option value="${p.name}">${v(p.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const l=new URLSearchParams(window.location.hash.replace("#","")),m=new URLSearchParams(window.location.search),p=l.get("type")||m.get("type")||"",b=qt||p==="recovery"||p==="invite"||window.location.hash.includes("access_token")||m.has("code"),x=document.getElementById("password-reset-overlay");if(b){o.style.display="none",i&&i.classList.add("hidden"),x&&(x.style.display="flex"),(c=document.getElementById("password-reset-form"))==null||c.addEventListener("submit",async g=>{var k,w;g.preventDefault();const f=((k=document.getElementById("new-password"))==null?void 0:k.value)||"",E=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",I=document.getElementById("password-reset-msg"),S=g.target.querySelector('button[type="submit"]');if(I&&(I.style.display="none"),f!==E){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:B}=await h.auth.updateUser({password:f});if(B){I&&(I.textContent="Erro: "+B.message,I.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}window.location.href=window.location.pathname}),m.has("code")&&await h.auth.exchangeCodeForSession(m.get("code")??"");return}const{data:{session:u}}=await h.auth.getSession();if(u){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),We(),St(),Et(),window.lucide&&lucide.createIcons(),y=await bt(u.user.id),!y){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(y.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(y.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const g=document.getElementById("password-reset-overlay");g&&(g.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async f=>{var w,$;f.preventDefault();const E=((w=document.getElementById("new-password"))==null?void 0:w.value)||"",I=(($=document.getElementById("confirm-password"))==null?void 0:$.value)||"",S=document.getElementById("password-reset-msg"),B=f.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),E!==I){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}if(E.length<6){S&&(S.textContent="Mínimo 6 caracteres.",S.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:k}=await h.auth.updateUser({password:E});if(k){S&&(S.textContent="Erro: "+k.message,S.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}await h.from("profiles").update({needs_password_reset:!1}).eq("id",y.id),window.location.href=window.location.pathname});return}ve((y==null?void 0:y.tenant_id)||null),Fe(y),ht(y),xt(y.role),await Oe(),await kt(y),window.lucide&&lucide.createIcons(),Ba(),Z("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const g=document.getElementById("login-form");g&&((r=document.getElementById("forgot-password-btn"))==null||r.addEventListener("click",async()=>{var I,S;const f=(S=(I=g.querySelector('input[name="email"]'))==null?void 0:I.value)==null?void 0:S.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:E}=await h.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(E?"Erro: "+E.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),g.addEventListener("submit",async f=>{f.preventDefault();const E=g.querySelector('button[type="submit"]'),I=new FormData(g),S=I.get("email"),B=I.get("password");E&&(E.disabled=!0,E.textContent="Entrando…");try{if(await ia(S,B)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),We(),St(),window.lucide&&lucide.createIcons();const{data:{session:w}}=await h.auth.getSession();if(y=w?await bt(w.user.id):null,!y){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(y.active===!1){await h.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Et(),ve((y==null?void 0:y.tenant_id)||null),Fe(y),ht(y),xt(y.role),await Oe(),await kt(y),window.lucide&&lucide.createIcons(),Z("dashboard")}else alert("E-mail ou senha incorretos")}catch(k){alert("Erro ao fazer login: "+((k==null?void 0:k.message)||String(k)))}finally{E&&(E.disabled=!1,E.textContent="Entrar")}}))}}else We();await re();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();ft(d),yt(Le),window._applyDynamicContent=ft,window._applyWhatsAppLinks=yt,document.querySelectorAll(".nav-dropdown-btn").forEach(l=>{var p;const m=(p=l.closest(".nav-dropdown"))==null?void 0:p.querySelector(".nav-dropdown-menu");m&&l.addEventListener("click",b=>{b.stopPropagation(),m.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(x=>{x!==m&&x.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(l=>l.classList.remove("js-open"))})});async function Aa(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await h.from("properties").update({reference:i}).eq("id",o.id);if(!d){const c=_.findIndex(s=>s.id===o.id);c>=0&&(_[c].reference=i),n++}}qe(lt(_))}async function Ma(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await za(i);a.push(d),o=!0}catch{a.push(i)}if(o){await h.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(d=>d.id===t.id);i>=0&&(_[i].images=a)}}qe(lt(_))}}async function za(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(c=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),l=1200;let m=s.width,p=s.height;m>l&&(p=Math.round(p*l/m),m=l),r.width=m,r.height=p;const b=r.getContext("2d");b.drawImage(s,0,0,m,p);const x=u=>{if(u){const g=Math.round(m*.18),f=Math.round(u.naturalHeight*g/u.naturalWidth),E=Math.round(m*.02);b.globalAlpha=.45,b.drawImage(u,m-g-E,p-f-E,g,f),b.globalAlpha=1}r.toBlob(async g=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:E}=await h.storage.from("imoveis").upload(f,g,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(E){console.error("Upload watermark error:",E),c(e);return}const{data:{publicUrl:I}}=h.storage.from("imoveis").getPublicUrl(f);c(I)}catch(f){console.error("Watermark upload exception:",f),c(e)}},"image/jpeg",.82)};if(d){const u=new Image;u.onload=()=>{URL.revokeObjectURL(d),x(u)},u.onerror=()=>{URL.revokeObjectURL(d),x(null)},u.src=d}else x(null)},s.onerror=()=>{URL.revokeObjectURL(a),c(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function ut(e,t="assets"){const n=await Ae(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await h.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=h.storage.from("imoveis").getPublicUrl(a);return i}async function Pt(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>v(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,f=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await h.from("crm_stages").insert({pipeline_id:f,name:u,color:g,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-stage").value="",await P())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await h.from("crm_stages").delete().eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async g=>{await h.from("crm_stages").update({color:g.target.value}).eq("id",u.dataset.sid);const f=u.closest(".stage-item").querySelector(".stage-color-dot");f&&(f.style.background=g.target.value)})});const p=async()=>{const u=document.getElementById("crm-new-tag"),g=document.getElementById("crm-new-tag-color"),f=u==null?void 0:u.value.trim(),E=(g==null?void 0:g.value)||"#6366F1";if(!f){u==null||u.focus();return}await h.from("crm_tags").insert({name:f,color:E,tenant_id:M()}),u&&(u.value=""),await P()};(b=document.getElementById("crm-add-tag"))==null||b.addEventListener("click",p),(x=document.getElementById("crm-new-tag"))==null||x.addEventListener("keydown",u=>{u.key==="Enter"&&p()}),e.querySelectorAll(".tm-del-btn").forEach(u=>{u.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await h.from("crm_tags").delete().eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".tm-name-input").forEach(u=>{const g=u.closest(".tm-row"),f=g==null?void 0:g.querySelector(".tm-save-btn");f&&(f.style.display="none"),u.addEventListener("input",()=>{const E=u.value.trim()!==u.dataset.orig;f&&(f.style.display=E?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(u=>{const g=u.closest(".tm-row"),f=g==null?void 0:g.querySelector(".tm-color-swatch"),E=g==null?void 0:g.querySelector(".tm-save-btn");u.addEventListener("input",I=>{f&&(f.style.background=I.target.value),E&&(E.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(u=>{u.style.display="none",u.addEventListener("click",async()=>{var I,S;const g=u.closest(".tm-row"),f=(I=g.querySelector(".tm-name-input"))==null?void 0:I.value.trim(),E=(S=g.querySelector(".tm-color-input"))==null?void 0:S.value;f&&(u.disabled=!0,u.textContent="✓ Salvando…",await h.from("crm_tags").update({name:f,color:E}).eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".tm-tpl-btn").forEach(u=>{u.addEventListener("click",async()=>{const g=u.dataset.name,f=u.dataset.color;u.disabled=!0,u.innerHTML="✓",await h.from("crm_tags").insert({name:g,color:f,tenant_id:M()}),await P()})}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await h.from("crm_tags").delete().eq("id",u.dataset.id),await P()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,f=document.getElementById("crm-new-status-final").checked;u&&(await h.from("crm_lead_statuses").insert({name:u,color:g,is_final:f,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-status").value="",await P())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await h.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await P())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var f;const u=(f=prompt("Nome do novo funil:"))==null?void 0:f.trim();if(!u)return;const{error:g}=await h.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:M()});if(g){alert("Erro ao criar funil: "+g.message);return}Ze=!1,await P()})}async function Gt(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("integrations").select("*"),n={};t==null||t.forEach(c=>{n[c.key]=c});const a=c=>{var s;return v(((s=n[c])==null?void 0:s.value)||"")},o=c=>{var s;return(s=n[c])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var m;const c=document.getElementById("intg-save-tracking");c.disabled=!0,c.textContent="Salvando…";let s=!0;const r=document.querySelectorAll(".intg-val"),l=document.querySelectorAll(".intg-toggle");for(let p=0;p<r.length;p++){const b=r[p].dataset.key,x=r[p].value.trim(),u=((m=l[p])==null?void 0:m.checked)??!1;await Je(b,x,u)||(s=!1)}c.disabled=!1,c.textContent="Salvar Integrações",V(document.getElementById("intg-tracking-msg"),s)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const c=document.getElementById("intg-save-smtp");c.disabled=!0,c.textContent="Salvando…";const s=document.querySelectorAll(".smtp-field");let r=!0;for(const m of s)await Je(m.dataset.key,m.value.trim(),!0)||(r=!1);const l=document.getElementById("smtp-pass").value;l&&(await Je("smtp_pass",l,!0)||(r=!1)),c.disabled=!1,c.textContent="Salvar SMTP",V(document.getElementById("intg-smtp-msg"),r)})}async function Jt(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(r=>{r.addEventListener("click",async l=>{l.stopPropagation();const m=r.dataset.active==="true";await h.from("tenants").update({active:!m}).eq("id",r.dataset.id),oe()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(r=>{r.addEventListener("click",()=>{const l=(i||[]).find(m=>String(m.id)===String(r.dataset.id));l&&Oa(l)})})}async function ja(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `}).join("")}async function _t(){const[e,t,n,a]=await Promise.all([h.from("tenants").select("id",{count:"exact",head:!0}),h.from("profiles").select("id",{count:"exact",head:!0}),h.from("subscriptions").select("id",{count:"exact",head:!0}).eq("status","active"),h.from("properties").select("id",{count:"exact",head:!0}).eq("published",!0)]),o=(i,d)=>{const c=document.getElementById(i);c&&(c.textContent=d??"—")};o("sa-stat-tenants",e.count),o("sa-stat-users",t.count),o("sa-stat-subs",n.count),o("sa-stat-props",a.count)}async function Da(){var n,a,o;const e=document.getElementById("sa-plat-save"),t=document.getElementById("sa-plat-msg");e&&(e.disabled=!0,e.textContent="Salvando…"),await he([{key:"platform.name",value:((n=document.getElementById("sa-plat-name"))==null?void 0:n.value)||""},{key:"platform.support_email",value:((a=document.getElementById("sa-plat-email"))==null?void 0:a.value)||""},{key:"platform.trial_days",value:((o=document.getElementById("sa-plat-trial"))==null?void 0:o.value)||"14"}]),e&&(e.disabled=!1,e.textContent="Salvar Configurações"),V(t,!0)}function Ra(e){return e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function Ha(){var a,o,i,d,c,s;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const t=document.createElement("div");t.id="sa-new-tenant-modal",t.className="sa-modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(t),h.from("plans").select("id, name").then(({data:r})=>{const l=document.getElementById("nt-plan");l&&r&&(l.innerHTML='<option value="">Sem plano</option>'+r.map(m=>`<option value="${m.id}">${v(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const l=document.getElementById("nt-slug");l&&!l.dataset.manual&&(l.value=Ra(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(c=document.getElementById("nt-cancel"))==null||c.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var B,k,w,$,L,q,C,N,T,X,H,O;const r=(k=(B=document.getElementById("nt-name"))==null?void 0:B.value)==null?void 0:k.trim(),l=($=(w=document.getElementById("nt-slug"))==null?void 0:w.value)==null?void 0:$.trim(),m=(q=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:q.trim(),p=(C=document.getElementById("nt-plan"))==null?void 0:C.value,b=(T=(N=document.getElementById("nt-admin-email"))==null?void 0:N.value)==null?void 0:T.trim(),x=(H=(X=document.getElementById("nt-admin-password"))==null?void 0:X.value)==null?void 0:H.trim(),u=document.getElementById("nt-msg"),g=document.getElementById("nt-save");if(!r||!l){u.textContent="❌ Nome e slug são obrigatórios.",u.style.color="#ef4444";return}if(!b){u.textContent="❌ Informe o e-mail do admin.",u.style.color="#ef4444";return}if(!x||x.length<6){u.textContent="❌ A senha precisa ter mínimo 6 caracteres.",u.style.color="#ef4444";return}g.disabled=!0,g.textContent="Criando…",u.textContent="⏳ Criando imobiliária…",u.style.color="#64748b";const{data:f,error:E}=await h.from("tenants").insert({name:r,slug:l,domain:m||null,plan_id:p||null,active:!0}).select();if(E){g.disabled=!1,g.textContent="Criar Imobiliária",u.textContent="❌ "+E.message,u.style.color="#ef4444";return}const I=(O=f==null?void 0:f[0])==null?void 0:O.id;u.textContent="⏳ Criando usuário admin…";const S=await pe({email:b,password:x,role:"admin",tenant_id:I});if(!(S!=null&&S.success)){g.disabled=!1,g.textContent="Criar Imobiliária",u.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+v((S==null?void 0:S.error)||"Desconhecido"),u.style.color="#f59e0b",setTimeout(()=>{n(),oe()},3e3);return}I&&(S!=null&&S.user_id)&&!(S!=null&&S.linked)&&await h.from("profiles").update({tenant_id:I}).eq("id",S.user_id),g.disabled=!1,g.textContent="Criar Imobiliária",S.email_sent===!1?(u.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Wt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ot(e,o.dataset.tab)})}),ot(e,"properties")}function Ua(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(c,s,r,l="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(c=document.getElementById("tp-copy-key"))==null||c.addEventListener("click",()=>{var E;(E=navigator.clipboard)==null||E.writeText(e.id);const g=document.getElementById("tp-copy-key"),f=g.textContent;g.textContent="✅ Copiada!",setTimeout(()=>{g.textContent=f},2e3)})}if(t==="config"){const{data:l}=await h.from("settings").select("key,value").eq("tenant_id",e.id),m={};l==null||l.forEach(b=>{m[b.key]=b.value});const p=(b,x)=>`
      ...
      </div>`,(r=document.getElementById("tp-open-edit"))==null||r.addEventListener("click",()=>Wt(e))}}function Wt(e){var r,l,m,p,b,x,u,g;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([f,E,I])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),h.from("plans").select("id, name").then(({data:f})=>{const E=document.getElementById("et-plan");E&&f&&(E.innerHTML='<option value="">Sem plano</option>'+f.map(I=>`<option value="${I.id}"${String(I.id)===String(e.plan_id)?" selected":""}>${v(I.name)}</option>`).join(""))}),(r=document.getElementById("et-logo-input"))==null||r.addEventListener("change",f=>{const E=f.target.files[0];if(!E)return;const I=URL.createObjectURL(E),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${I}" style="width:100%;height:100%;object-fit:cover;">`)}),(l=document.getElementById("et-logo-preview"))==null||l.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(p=document.getElementById("et-copy-key"))==null||p.addEventListener("click",()=>{var S,B;const f=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!f)return;(B=navigator.clipboard)==null||B.writeText(f);const E=document.getElementById("et-copy-key"),I=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=I},2e3)});const o=["dados","config","api"];function i(f){o.forEach(E=>{document.getElementById(`et-pane-${E}`).style.display=E===f?"":"none";const I=document.getElementById(`et-tab-${E}`);I.style.borderBottomColor=E===f?"#2563eb":"transparent",I.style.color=E===f?"#2563eb":"#64748b",I.style.fontWeight=E===f?"600":"500"}),f==="config"&&c()}o.forEach(f=>{var E;return(E=document.getElementById(`et-tab-${f}`))==null?void 0:E.addEventListener("click",()=>i(f))});let d=!1;async function c(){var I;if(d)return;d=!0;const{data:f}=await h.from("settings").select("key,value").eq("tenant_id",e.id),E={};f==null||f.forEach(S=>{E[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(I=document.getElementById("et-cfg-save"))==null||I.addEventListener("click",async()=>{const S=document.getElementById("et-cfg-save"),B=document.getElementById("et-cfg-msg");S.disabled=!0,S.textContent="Salvando…",B.textContent="",B.style.color="#64748b";const k=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),w=document.getElementById("et-cfg-phone").value.trim(),$=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),q=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await h.from("settings").upsert([{key:"company.whatsapp",value:k,tenant_id:e.id},{key:"company.phone",value:w,tenant_id:e.id},{key:"company.email",value:$,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:q,tenant_id:e.id}],{onConflict:"tenant_id,key"});S.disabled=!1,S.textContent="💾 Salvar configurações",C?(B.textContent="❌ "+C.message,B.style.color="#ef4444"):(B.textContent="✅ Configurações salvas!",B.style.color="#22c55e")})}const s=()=>n.remove();(b=document.getElementById("et-close"))==null||b.addEventListener("click",s),(x=document.getElementById("et-cancel"))==null||x.addEventListener("click",s),n.addEventListener("click",f=>{f.target===n&&s()}),(u=document.getElementById("et-delete"))==null||u.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:I}=await h.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}s(),oe()}),(g=document.getElementById("et-save"))==null||g.addEventListener("click",async()=>{var N,T,X,H,O,ee,ie,Ie,$e,U,ge,gt;const f=(T=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:T.trim(),E=(H=(X=document.getElementById("et-slug"))==null?void 0:X.value)==null?void 0:H.trim(),I=(ee=(O=document.getElementById("et-domain"))==null?void 0:O.value)==null?void 0:ee.trim(),S=(ie=document.getElementById("et-plan"))==null?void 0:ie.value,B=($e=(Ie=document.getElementById("et-admin-email"))==null?void 0:Ie.value)==null?void 0:$e.trim(),k=(ge=(U=document.getElementById("et-admin-password"))==null?void 0:U.value)==null?void 0:ge.trim(),w=(gt=document.getElementById("et-logo-input"))==null?void 0:gt.files[0],$=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!f){$.textContent="❌ Nome é obrigatório.",$.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",$.textContent="⏳ Salvando…",$.style.color="#64748b";let q=e.logo_url;if(w)try{const A=await Ae(w,256,.85),vt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Qt}=await h.storage.from("imoveis").upload(vt,A,{contentType:"image/jpeg",upsert:!0});if(!Qt){const{data:{publicUrl:Zt}}=h.storage.from("imoveis").getPublicUrl(vt);q=Zt}}catch(A){console.error("Logo upload:",A)}const{error:C}=await h.from("tenants").update({name:f,slug:E||e.slug,domain:I||null,plan_id:S||null,logo_url:q}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",$.textContent="❌ "+C.message,$.style.color="#ef4444";return}if(B&&k&&k.length>=6){$.textContent="⏳ Criando usuário admin…";const A=await pe({email:B,password:k,role:"admin",tenant_id:e.id});A!=null&&A.success?(A!=null&&A.user_id&&!(A!=null&&A.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",A.user_id),$.textContent="✅ Salvo e admin criado!",$.style.color="#22c55e"):($.textContent="⚠️ Salvo, mas erro ao criar admin: "+((A==null?void 0:A.error)||"Tente novamente"),$.style.color="#f59e0b")}else $.textContent="✅ Imobiliária atualizada!",$.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{s(),oe()},1200)})}function Pa(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Fa)}function Fa(){const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
    <div id="import-leads-modal" style="background:#fff;border-radius:12px;width:min(680px,96vw);max-height:90vh;overflow-y:auto;box-shadow:0 8px 40px rgba(0,0,0,0.22);padding:32px 28px 24px;position:relative;">
    ...
    </div>`,document.body.appendChild(e),Va()}async function Va(){const e=document.getElementById("import-stage-sel");if(!e)return;const t=await getTenantId(),{data:n}=await h.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("position");n&&n.length?(e.innerHTML=n.map(a=>`<option value="${a.id}">${v(a.name)}</option>`).join(""),n[0].id,e.onchange=()=>{e.value}):e.innerHTML='<option value="">— sem etapas cadastradas —</option>'}function Xa(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Ga(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),d=e.querySelector("#ldp-tag-search"),c=e.querySelector("#ldp-tag-opt-list"),s=e.querySelector("#ldp-tag-show-create"),r=e.querySelector("#ldp-tag-create-row"),l=e.querySelector("#ldp-tag-new-name"),m=e.querySelector("#ldp-tag-new-color"),p=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function b(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map(I=>I.dataset.tag)}function x(I){if(!I.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=I.map(S=>{const k=(n[S]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(S)}" style="background:${k}18;color:${k};border-color:${k}55;">
        ${v(S)}<span class="ldp-tag-rm" data-tag="${v(S)}">×</span>
      </span>`}).join("")}function u(I=""){const S=b(),B=I.toLowerCase().trim(),k=t.filter(w=>!B||w.name.toLowerCase().includes(B));if(!k.length){c.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}c.innerHTML=k.map(w=>{const $=S.includes(w.name);return`<div class="ldp-tag-opt${$?" active":""}" data-tag="${v(w.name)}" style="--tc:${w.color}">
      ...
      </div>`}).join("")}function g(){i.classList.remove("hidden"),u(""),d.value="",r.classList.add("hidden"),d.focus()}function f(){i.classList.add("hidden")}o.addEventListener("click",I=>{I.stopPropagation(),i.classList.contains("hidden")?g():f()}),document.addEventListener("mousedown",function I(S){e.contains(S.target)||(f(),document.removeEventListener("mousedown",I))}),i.addEventListener("mousedown",I=>I.stopPropagation()),d.addEventListener("input",()=>u(d.value)),c.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-opt");if(!S)return;const B=S.dataset.tag,k=b();k.includes(B)?x(k.filter(w=>w!==B)):x([...k,B]),u(d.value)}),a.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-rm");if(!S)return;const B=S.dataset.tag;x(b().filter(k=>k!==B))}),s.addEventListener("click",()=>{r.classList.toggle("hidden"),r.classList.contains("hidden")||l.focus()});async function E(){const I=l.value.trim();if(!I){l.focus();return}const S=m.value||"#6366F1";if(t.some(B=>B.name.toLowerCase()===I.toLowerCase())){l.style.borderColor="#ef4444",setTimeout(()=>{l.style.borderColor=""},1500);return}p.disabled=!0,p.textContent="Criando…";try{const{data:B,error:k}=await h.from("crm_tags").insert({name:I,color:S,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(k)throw k;const w={id:B.id,name:B.name,color:B.color};t.push(w),n[w.name]=w,typeof ce<"u"&&(ce[w.name]=w),x([...b(),w.name]),u(d.value),l.value="",m.value="#6366F1",r.classList.add("hidden")}catch(B){console.error("Error creating tag:",B),alert("Erro ao criar tag: "+(B.message||B))}finally{p.disabled=!1,p.textContent="Criar e adicionar"}}p.addEventListener("click",E),l.addEventListener("keydown",I=>{I.key==="Enter"&&E()})}async function Ja(){var u;const e=document.getElementById("section-dashboard");if(!e||e.dataset.dbInit==="1")return;e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <!-- KPI Cards -->
  <div class="db-kpis">
    ${["db-kpi-indigo","db-kpi-emerald","db-kpi-amber","db-kpi-sky"].map((g,f)=>`
    <div class="db-kpi ${g}" id="db-kpi-${f}">
  ...
  <div class="db-row-third">
...
</div>`;const t=new Date,n=t.getHours(),a=n<12?"Bom dia":n<18?"Boa tarde":"Boa noite",o=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],i=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],d=`${o[t.getDay()]}, ${t.getDate()} de ${i[t.getMonth()]} de ${t.getFullYear()}`,c=((u=y==null?void 0:y.name)==null?void 0:u.split(" ")[0])||"Corretor",s=e.querySelector(".db-greeting");s&&(s.innerHTML=`${a}, <span class="db-greeting-name">${z(c)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${d}`);let l=[],m=[];try{const g=y==null?void 0:y.tenant_id,[f,E]=await Promise.all([At(),Wa(g)]);l=f||[],m=E||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}Ya(l,m,t);const p=l.filter(g=>g.published).length,b=m.filter(g=>it(g.created_at)===it(t.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${d.split(",")[0]}
    </span>`),Qa(m,l),Za(l),en(l,m,t),tn(l,m);try{await Xa(),Ct(m,7),Ka(m),document.querySelectorAll(".db-ptab").forEach(g=>{g.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach(f=>f.classList.remove("active")),g.classList.add("active"),Ct(m,parseInt(g.dataset.p))})})}catch(g){console.warn("[Dashboard] Chart.js não carregou:",g)}window.lucide&&lucide.createIcons()}function z(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function it(e){return(e||"").slice(0,10)}function Yt(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function Kt(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function Wa(e){let t=h.from("leads").select("id,name,phone,email,source,status,stage,created_at,property_id").order("created_at",{ascending:!1}).limit(60);e&&(t=t.eq("tenant_id",e));const{data:n,error:a}=await t;return a?(console.warn("[Dashboard] leads fetch error:",a.message),[]):n||[]}function Ya(e,t,n){const a=e.length,o=e.filter(u=>u.published).length,i=t.length,d=t.filter(u=>u.stage&&u.stage!=="perdido"&&u.stage!=="fechado").length,c=new Date(n);c.setDate(c.getDate()-30);const s=new Date(n);s.setDate(s.getDate()-60);const r=e.filter(u=>u.created_at&&new Date(u.created_at)>=c).length,l=e.filter(u=>u.created_at&&new Date(u.created_at)>=s&&new Date(u.created_at)<c).length,m=t.filter(u=>u.created_at&&new Date(u.created_at)>=c).length,p=t.filter(u=>u.created_at&&new Date(u.created_at)>=s&&new Date(u.created_at)<c).length;function b(u,g,f){if(g===0&&u===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(g===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const E=Math.round((u-g)/g*100);return E===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':E>0?`<span class="db-kpi-trend db-trend-up">▲ +${E}% ${f}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${E}% ${f}</span>`}[{idx:0,val:a,label:"Total de Imóveis",trend:b(r,l,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:o,label:"Publicados no Site",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:2,val:i,label:"Leads Recebidos",trend:b(m,p,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:3,val:d,label:"Em Negociação",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'}].forEach(({idx:u,val:g,label:f,trend:E,icon:I})=>{const S=document.getElementById(`db-kpi-${u}`);S&&(S.innerHTML=`
      <div class="db-kpi-icon">${I}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${Kt(g)}</div>
        <div class="db-kpi-lbl">${z(f)}</div>
        ${E}
      </div>`)})}let Ne=null;function Ct(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;Ne&&(Ne.destroy(),Ne=null);const a=[],o=[],i=new Date;for(let c=t-1;c>=0;c--){const s=new Date(i);s.setDate(s.getDate()-c);const r=s.toISOString().slice(0,10),l=t<=7?s.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?s.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):s.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(l),o.push(e.filter(m=>it(m.created_at)===r).length)}const d=Math.max(...o,1);Ne=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(c=>c===d&&d>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>` ${c.parsed.y} lead${c.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(d/4))}}}}})}let je=null;function Ka(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;je&&(je.destroy(),je=null);const a={};e.forEach(r=>{const l=r.source||"Direto",m=l.charAt(0).toUpperCase()+l.slice(1);a[m]=(a[m]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),d=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],c=o.map((r,l)=>d[l%d.length]),s=i.reduce((r,l)=>r+l,0);je=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:c,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:r=>{const l=s>0?Math.round(r.parsed/s*100):0;return` ${r.label}: ${r.parsed} (${l}%)`}}}}}}),n&&(s===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((r,l)=>`
