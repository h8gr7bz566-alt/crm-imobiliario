import{s as v}from"./supabase-BcuJ3xoD.js";const D="00000000-0000-0000-0000-000000000000";let se={},he={},ee=D;function ve(e){ee=e||D,se={},he={}}const z=()=>ee;async function Mt(){const[e,t]=await Promise.all([v.from("settings").select("key,value").eq("tenant_id",ee),v.from("site_content").select("*").eq("tenant_id",ee)]);if(e.data&&e.data.forEach(n=>{se[n.key]=n.value}),t.data&&t.data.forEach(n=>{he[n.key]=n}),(!t.data||t.data.length===0)&&ee!==D){const[n,a]=await Promise.all([v.from("settings").select("key,value").eq("tenant_id",D),v.from("site_content").select("*").eq("tenant_id",D)]);n.data&&n.data.forEach(o=>{se[o.key]===void 0&&(se[o.key]=o.value)}),a.data&&a.data.forEach(o=>{he[o.key]||(he[o.key]=o)})}}const X=(e,t=null)=>se[e]!==void 0?se[e]:t,Oe=(e,t="pt")=>{const n=he[e];return n&&(n["value_"+t]||n.value_pt)||null};async function xe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ee,updated_at:t})),{error:a}=await v.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{se[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ee,updated_at:o},{error:d}=await v.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(he[e]=i),ee!==D&&await v.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:D,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Pe(e,t,n){const{error:a}=await v.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function tt(){const e=document.documentElement,t=X("visual.accent_color","#b8962e"),n=X("visual.primary_bg","#0f1c2e"),a=X("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=X("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=X("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=X("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function rt(e){e=e||"pt";const t=x=>Oe(x,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),p=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),c=document.querySelector('[data-i18n="inst.stat3_num"]'),r=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),p&&t("inst.stat2_num")&&(p.innerHTML=t("inst.stat2_num")),c&&t("inst.stat3_num")&&(c.innerHTML=t("inst.stat3_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const b=Oe("seo.title_pt",e);b&&(document.title=b);const h=Oe("seo.description_pt",e);if(h){const x=document.querySelector('meta[name="description"]');x&&(x.content=h)}}function ct(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const zt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let le="5547999701743";const ne=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Nt=5.7;function re(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Nt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],f=null,Se=[],It=!1;v.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(It=!0)});function Xe(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Ae(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function $t({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:c,error:r}=await v.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return r&&console.error("Supabase select error:",r),c||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=z();if(!o||o===D){const c=Ae(a);if(c)o=c,ve(o);else{const r=t.replace(/^www\./,"");for(const m of[r,"www."+r]){const{data:u}=await v.from("tenants").select("id").eq("domain",m).maybeSingle();if(u!=null&&u.id){o=u.id,ve(o);break}}o&&o!==D&&Xe(a,o,24*60*60*1e3)}}if(!o||o===D)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const c=Ae(i);if(c)return setTimeout(()=>$t({background:!0}),100),c}const{data:l,error:s}=await v.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),Ae(i)||[];const p=l||[];return Xe(i,p,d),e&&typeof ce=="function"&&ce().catch(()=>{}),p}async function jt(){let e=v.from("properties").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="super_admin"||(f!=null&&f.tenant_id?e=e.eq("tenant_id",f.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ua(),ga(),_)}async function Rt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await v.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await v.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Ht(e){const{error:t}=await v.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Ut(e,t){const{error:n}=await v.auth.signInWithPassword({email:e,password:t});return!n}function Ce(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const l=document.createElement("canvas");let s=i.width,p=i.height;s>t&&(p=Math.round(p*t/s),s=t),l.width=s,l.height=p;const c=l.getContext("2d");c.drawImage(i,0,0,s,p);const r=new Image;r.crossOrigin="anonymous",r.onload=()=>{const m=Math.round(s*.18),u=Math.round(r.naturalHeight*m/r.naturalWidth),b=Math.round(s*.02),h=s-m-b,x=p-u-b;c.globalAlpha=.45,c.drawImage(r,h,x,m,u),c.globalAlpha=1,l.toBlob(E=>E?a(E):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},r.onerror=()=>{l.toBlob(m=>m?a(m):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},r.src="/logo.png"},i.onerror=o,i.src=d})}async function Ot(e){const t=await Ce(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await v.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=v.storage.from("imoveis").getPublicUrl(n);return o}async function Dt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Ot(n[o]));return a}async function ce(){var m,u,b,h,x,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await $t();_=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&Pt(n);const a=((u=document.getElementById("city-filter"))==null?void 0:u.value)||"",o=((b=document.getElementById("neighborhood-filter"))==null?void 0:b.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",d=((x=document.getElementById("parking-filter"))==null?void 0:x.value)||"",l=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",{min:s,max:p}=Xt(),c=n.filter(y=>{if(a&&y.city!==a||o&&y.neighborhood!==o||i&&(i==="4+"&&Number(y.bedrooms)<4||i!=="4+"&&Number(y.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(y.parking)<4||d!=="4+"&&Number(y.parking)!==Number(d))||l&&y.construction_status!==l)return!1;const B=String(y.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),$=parseInt(B,10)||0;return!($<s||p!==1/0&&$>p)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(y=>{var I;const B=y.cover_image||((I=y.images)==null?void 0:I[0])||ne[0],$=[y.neighborhood,y.city].filter(Boolean).join(", "),L=`https://omarcorretor.com.br/og/${y.id}`,k=encodeURIComponent(`Olá! Tenho interesse no imóvel *${y.title}*${y.reference?` (Ref: ${y.reference})`:""}. Poderia me dar mais informações?
${L}`);return`
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-loc">${g($)}</div>
            <div class="selecao-card-price">${g(re(y.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${y.id}" class="btn-det">Ver Detalhes</a>
              <a href="https://wa.me/${le}?text=${k}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(y=>{var I;const B=(I=y.images)!=null&&I.length?y.images:ne,$=B.length,L=`https://omarcorretor.com.br/og/${y.id}`,k=encodeURIComponent(`Olá! Tenho interesse no imóvel *${y.title}*${y.reference?` (Ref: ${y.reference})`:""}. Poderia me dar mais informações?
${L}`);return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${$}" data-idx="0" data-pid="${y.id}" data-images="${encodeURIComponent(JSON.stringify(B))}">
        ...
        <div class="property-info">
          ...
          <div><strong>${g(re(y.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${y.bedrooms||"--"} | 🚗 ${y.parking||"--"} ${$>1?"| 📸 "+$:""}</div>
          ...
          <div style="display:flex;gap:8px;margin-top:6px">
            ...
            <a class="btn hero-whatsapp-btn" href="https://wa.me/${le}?text=${k}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join("");const r=document.getElementById("properties");r&&!r._carouselDelegated&&(r._carouselDelegated=!0,r.addEventListener("click",Ft))}function Pt(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var m;const s=l.cover_image||((m=l.images)==null?void 0:m[0])||ne[0],p=[l.neighborhood,l.city].filter(Boolean).join(", "),c=`https://omarcorretor.com.br/og/${l.id}`,r=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?
${c}`);return`
      <div class="selecao-card">
    ...
    </tr>`}).join("")}}function Wt(){const e=document.getElementById("f-city");if(!e)return;const t=ge(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${g(a.name)}</option>`).join(""),n&&(e.value=n)}function Jt(){var e,t,n,a,o,i,d,l,s,p,c,r,m,u,b;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((d=document.getElementById("f-price-min"))==null?void 0:d.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((s=document.getElementById("f-area-min"))==null?void 0:s.value)||0,areaMax:parseFloat((p=document.getElementById("f-area-max"))==null?void 0:p.value)||1/0,construction:((c=document.getElementById("f-construction"))==null?void 0:c.value)||"",published:((r=document.getElementById("f-published"))==null?void 0:r.value)||"",bedrooms:((m=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:m.dataset.val)||"",suites:((u=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:u.dataset.val)||"",parking:((b=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:b.dataset.val)||""}}function at(e){const t=Jt();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Me(){if(!document.getElementById("admin-properties"))return;const e=await jt(),t=e.length,n=e.filter(d=>d.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Wt(),_e(_)}let R=null,de="";function Ge(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function qe(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow=""}function ze(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(!e.length){t.style.display="none";return}t.style.display="",n.innerHTML=e.map(a=>`
...
`+((p==null?void 0:p.message)||JSON.stringify(p)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ht(o),await Me()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(s=>s.id===o);if(!i)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const d=document.getElementById("adminPublished");d&&(d.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),de=i.cover_image||((a=i.images)==null?void 0:a[0])||"",ze(i.images||[]),Ge("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Z=[],V=0;function Yt(e){var r,m;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((r=e.images)==null?void 0:r[0])||ne[0];document.getElementById("view-thumb-preview").src=i,Z=(m=e.images)!=null&&m.length?e.images:ne,V=0,Ne(),document.getElementById("view-price").textContent=re(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,p=document.getElementById("share-link-input");p&&(p.value=s);const c=document.getElementById("share-panel");c&&(c.style.display="none",c.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Te(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ne(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Z[V],e.alt=`Foto ${V+1}`;const i=Z.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${V+1} / ${Z.length}`:"",o.innerHTML=i?Z.map((d,l)=>`<img src="${d}" class="view-thumb${l===V?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{V=+d.dataset.i,Ne()})})}async function mt(e){const{data:t}=await v.from("profiles").select("*").eq("id",e).maybeSingle();return t}function je(e){var r,m;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((r=i[0])==null?void 0:r.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),p=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&p?(p.src=e.avatar_url,p.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",c.style.display=""),p&&(p.style.display="none"))}async function pt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==D,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await v.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}function me(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),J(),e==="contatos"&&da(),e==="funil"&&Zt(),e==="tarefas"&&ta()}function ut(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:Ea}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>wa(),{once:!0}),window.lucide&&lucide.createIcons()}}function J(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Kt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var m,u,b;const s=(m=document.getElementById("ac-email"))==null?void 0:m.value.trim(),p=(u=document.getElementById("ac-password"))==null?void 0:u.value.trim(),c=document.getElementById("ac-save"),r=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!p||p.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}c.disabled=!0,c.textContent="Criando…",r.style.display="none";try{const h=e||(f==null?void 0:f.tenant_id)||null,x=((b=document.getElementById("ac-role"))==null?void 0:b.value)||"corretor",E=await ue({email:s,password:p,role:x,tenant_id:h});c.disabled=!1,c.textContent="+ Criar Acesso",E.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",E.email_sent===!1?(r.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${g(s)}<br><strong>Senha:</strong> ${g(p)}`,r.style.color="#0f172a"):(r.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",r.style.color="#16a34a"),r.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(E.error||"Falha desconhecida"))}catch(h){c.disabled=!1,c.textContent="+ Criar Acesso",alert("Erro: "+h.message)}})}function gt(){var i,d,l,s,p,c,r,m,u,b,h;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",x=>{var y;x.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(y=document.getElementById("notif-dropdown"))==null||y.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",x=>{x.stopPropagation(),J(),Qt()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",x=>{x.stopPropagation(),J(),Kt()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",x=>{x.stopPropagation(),J(),Ve()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",x=>{x.stopPropagation(),J(),me("settings")}),(p=document.getElementById("avatar-dd-logout"))==null||p.addEventListener("click",async x=>{x.stopPropagation(),await v.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",x=>{var y;x.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((y=document.getElementById("avatar-dropdown"))==null||y.classList.add("hidden"),oa())}),(c=document.getElementById("notif-mark-all"))==null||c.addEventListener("click",()=>{ia(),J()}),(r=document.getElementById("btn-search-open"))==null||r.addEventListener("click",()=>{var x,E;(x=document.getElementById("search-overlay"))==null||x.classList.remove("hidden"),(E=document.getElementById("search-input"))==null||E.focus()}),(m=document.getElementById("search-overlay-close"))==null||m.addEventListener("click",()=>{var x;(x=document.getElementById("search-overlay"))==null||x.classList.add("hidden")}),(u=document.getElementById("search-overlay"))==null||u.addEventListener("click",x=>{x.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(b=document.getElementById("search-input"))==null||b.addEventListener("input",x=>{clearTimeout(o),o=setTimeout(()=>na(x.target.value.trim()),280)}),(h=document.getElementById("search-input"))==null||h.addEventListener("keydown",x=>{var E;x.key==="Escape"&&((E=document.getElementById("search-overlay"))==null||E.classList.add("hidden"))}),document.addEventListener("click",J)}let We=!1,ie=[],nt=[],Re=[],Je={},kt=[],te=null,ke=null,F={search:"",tags:new Set,status:""};async function Zt(){var t;if(We){await ft();return}We=!0,await ft(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>Ke()),_a();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{te=parseInt(e.value,10),await He()})}function Ye(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+kt.map(d=>`<option value="${g(d.name)}">${g(d.name)}</option>`).join(""),n.value=F.status,n.onchange=()=>{F.status=n.value,ye()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML=e.map(d=>{const l=F.tags.has(d.name);return`<button class="kf-tag-btn" data-tag="${g(d.name)}"
        style="padding:4px 12px;border-radius:20px;border:1.5px solid ${d.color};
               background:${l?d.color:d.color+"18"};
               color:${l?"#fff":d.color};
               font-size:12px;font-weight:600;cursor:pointer;transition:all .15s;">
        ${g(d.name)}
      </button>`}).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const l=d.dataset.tag;F.tags.has(l)?F.tags.delete(l):F.tags.add(l),Ye(e),ye()})})}const o=document.getElementById("kf-search");o&&(o.value=F.search,o.oninput=()=>{F.search=o.value.toLowerCase(),ye()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{F={search:"",tags:new Set,status:""},Ye(e),ye()})}async function ft(){const e=z(),[{data:t},{data:n},{data:a}]=await Promise.all([v.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),v.from("crm_tags").select("*").eq("tenant_id",e).order("name"),v.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);ie=t||[],kt=a||[],Je={},(n||[]).forEach(l=>{Je[l.name]=l});const o=ie.map(l=>l.id),{data:i}=o.length?await v.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};nt=i||[],Ye(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const l=te;d.innerHTML=ie.length?ie.map(p=>`<option value="${p.id}">${g(p.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=ie.find(p=>p.id===l)||ie.find(p=>p.is_default)||ie[0];s?(d.value=s.id,te=s.id):te=null}await He()}async function He(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=v.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id)),te&&(t=t.eq("pipeline_id",te));const{data:n}=await t;Re=n||[],ye()}function ye(){const e=document.getElementById("kanban-board");if(!e)return;const t=nt.filter(i=>i.pipeline_id===te);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=F,a=Re.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>d.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,s,p,c;const d=i.stage||((l=t[0])==null?void 0:l.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(c=o[d]||o[(p=t[0])==null?void 0:p.name])==null||c.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],l=d.length?d.map(s=>{const p=(s.phone||"").replace(/\D/g,""),c=encodeURIComponent(`Olá ${s.name}! Aqui é da ${X("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      ${d?(()=>{const r=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${X("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${d}?text=${r}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>{l.style.transform="translateX(0)"});const s=()=>{l.style.transform="translateX(100%)",setTimeout(()=>l.remove(),250)};document.getElementById("ldp-close").addEventListener("click",s),document.getElementById("ldp-save").addEventListener("click",async()=>{var E,y;const r=document.getElementById("ldp-save"),m=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){m.style.color="#ef4444",m.textContent="Nome é obrigatório.";return}r.disabled=!0,r.textContent="Salvando…";const b=[...l.querySelectorAll("input[type=checkbox]:checked")].map(B=>B.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((E=document.getElementById("ldp-stage"))==null?void 0:E.value)||null,status:((y=document.getElementById("ldp-status"))==null?void 0:y.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:b,tenant_id:z()};let x;if(t?{error:x}=await v.from("leads").insert(h):{error:x}=await v.from("leads").update(h).eq("id",e.id),r.disabled=!1,r.textContent="💾 Salvar",x){m.style.color="#ef4444",m.textContent="Erro: "+x.message;return}m.style.color="#22c55e",m.textContent="✅ Salvo!",setTimeout(()=>{s(),He()},700)}),(c=document.getElementById("ldp-delete"))==null||c.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await v.from("leads").delete().eq("id",e.id),s(),He())})}let j=[],vt=!1,be="pending";async function ta(){var e;vt||(vt=!0,await aa(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Lt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),be=t.dataset.filter,we()})}))}async function aa(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=v.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,d=a.checked?"done":"pending";await v.from("tasks").update({status:d}).eq("id",i);const l=j.find(s=>String(s.id)===i);l&&(l.status=d),we()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await v.from("tasks").delete().eq("id",a.dataset.id),j=j.filter(i=>String(i.id)!==String(a.dataset.id)),we())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,d=j.find(l=>String(l.id)===i);d&&Lt(d)})})}function Lt(e=null){var s,p,c,r;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=Bt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",d=document.createElement("div");d.id="tarefa-modal-root",d.className="modal-backdrop",d.innerHTML=`
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(p=document.getElementById("tm-cancel"))==null||p.addEventListener("click",l),d.addEventListener("click",m=>{m.target===d&&l()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const m=a?"pending":"done";await v.from("tasks").update({status:m}).eq("id",e.id);const u=j.find(b=>String(b.id)===String(e.id));u&&(u.status=m),l(),m==="done"&&(be="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),we()}),(r=document.getElementById("tm-save"))==null||r.addEventListener("click",async()=>{var E,y;const m=document.getElementById("tarefa-form");if(!m.checkValidity()){m.reportValidity();return}const u=new FormData(m),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const h={title:(E=u.get("title"))==null?void 0:E.trim(),description:((y=u.get("description"))==null?void 0:y.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let x;if(n){if({error:x}=await v.from("tasks").update(h).eq("id",e.id),!x){const B=j.findIndex($=>String($.id)===String(e.id));B>=0&&(j[B]={...j[B],...h})}}else{const{data:B,error:$}=await v.from("tasks").insert(h).select();x=$,!x&&(B!=null&&B[0])&&j.unshift(B[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",x){alert("Erro: "+x.message);return}l(),we()})}async function na(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([v.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),v.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,m=new Blob([r],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(m),u.download="modelo_contatos.csv",u.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",ra),(p=document.getElementById("import-modal-confirm"))==null||p.addEventListener("click",ca)))}async function St(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=v.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;G=a||[],pe()}function pe(){var l,s,p;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?G.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):G,n=t.length,a=Math.max(1,Math.ceil(n/Be));N>a&&(N=a);const o=t.slice((N-1)*Be,N*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
      <tr>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const r=(c.phone||"").replace(/\D/g,"");if(!r)return"";const m=encodeURIComponent(`Olá ${(c.name||"").split(" ")[0]}! Aqui é da ${X("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${r}?text=${m}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const c=n===0?0:(N-1)*Be+1,r=Math.min(N*Be,n);d.innerHTML=`
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{N--,pe()}),(p=d.querySelector("#pag-next"))==null||p.addEventListener("click",()=>{N++,pe()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(c=>{c.addEventListener("click",r=>{r.preventDefault();const m=c.dataset.id,u=G.find(b=>String(b.id)===String(m));u&&_t(u)})})}async function _t(e=null){var E,y,B,$,L,k;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:d}]=await Promise.all([v.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),v.from("crm_tags").select("*").eq("tenant_id",a).order("name"),v.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],p=d||[],c=l.map(I=>I.id),{data:r}=c.length?await v.from("crm_stages").select("*").in("pipeline_id",c).order("sort_order"):{data:[]},m=r||[],u=(e==null?void 0:e.pipeline_id)||((E=l[0])==null?void 0:E.id)||"";function b(I){const w=m.filter(S=>S.pipeline_id===I);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(S=>`<option value="${g(S.name)}" ${(e==null?void 0:e.stage)===S.name?"selected":""}>${g(S.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
  ...
  `,document.body.appendChild(h);const x=()=>h.remove();(y=document.getElementById("cm-close"))==null||y.addEventListener("click",x),(B=document.getElementById("cm-cancel"))==null||B.addEventListener("click",x),h.addEventListener("click",I=>{I.target===h&&x()}),($=document.getElementById("cm-pipe"))==null||$.addEventListener("change",I=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=b(I.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await v.from("leads").delete().eq("id",e.id);const I=G.findIndex(w=>String(w.id)===String(e.id));I>=0&&G.splice(I,1),x(),pe()}),(k=document.getElementById("cm-save"))==null||k.addEventListener("click",async()=>{var P,H,U,K,oe,Ie,$e;const I=document.getElementById("contato-form");if(!I.checkValidity()){I.reportValidity();return}const w=new FormData(I),S=document.getElementById("cm-save");S.disabled=!0,S.textContent="Salvando…";const T=w.getAll("tag"),C=w.get("pipeline_id")||null,M={name:(P=w.get("name"))==null?void 0:P.trim(),company:((H=w.get("company"))==null?void 0:H.trim())||null,email:((U=w.get("email"))==null?void 0:U.trim())||null,phone:((K=w.get("phone"))==null?void 0:K.trim())||null,job_title:((oe=w.get("job_title"))==null?void 0:oe.trim())||null,city_interest:((Ie=w.get("city_interest"))==null?void 0:Ie.trim())||null,notes:(($e=w.get("notes"))==null?void 0:$e.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:T,assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await v.from("leads").update(M).eq("id",e.id),!A){const O=G.findIndex(fe=>String(fe.id)===String(e.id));O>=0&&(G[O]={...G[O],...M})}}else{const{data:O,error:fe}=await v.from("leads").insert(M).select();A=fe,!A&&(O!=null&&O[0])&&G.unshift(O[0])}if(S.disabled=!1,S.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}x(),pe()})}let Ee=[];function ra(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Ee=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,p,c,r,m]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:s,email:p,phone:c,company:r,job_title:m}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Ee.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=Ee.length===0)},n.readAsText(t)}async function ca(){if(!Ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null})),{error:n}=await v.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Qe(),await St(),alert(`${t.length} contato(s) importados com sucesso!`)}function ma(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Qe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const pa="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ue(e){return(await fetch(pa,{method:"POST",headers:{Authorization:`Bearer ${zt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function bt(e){var s,p,c,r;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await v.auth.getUser();n.value=(m==null?void 0:m.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const b=URL.createObjectURL(u);a&&(a.src=b,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var E,y;const m=((E=document.getElementById("change-password-new"))==null?void 0:E.value)||"",u=((y=document.getElementById("change-password-confirm"))==null?void 0:y.value)||"",b=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(b&&(b.style.display="none"),m.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}if(m!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:x}=await v.auth.updateUser({password:m});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),x?b&&(b.textContent="Erro: "+x.message,b.style.display=""):(b&&(b.style.color="#16a34a",b.textContent="Senha alterada com sucesso!",b.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var y;const m=t.value.trim();let u=(f==null?void 0:f.avatar_url)||"";const b=i==null?void 0:i.files[0],h=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",b)try{const B=await Ce(b,400,.85),$=`avatars/${f.id}-${Date.now()}.jpg`,{error:L}=await v.storage.from("imoveis").upload($,B,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:k}}=v.storage.from("imoveis").getPublicUrl($);u=k}}catch(B){console.error("Avatar upload:",B)}const{error:x}=await v.from("profiles").update({name:m,avatar_url:u}).eq("id",f.id);if(d.disabled=!1,d.textContent=h,x){alert("Erro ao salvar perfil.");return}f={...f,name:m,avatar_url:u},je(f);const E=document.getElementById("settings-avatar-initial");E&&(E.textContent=((y=m[0])==null?void 0:y.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await Ue(),(p=document.getElementById("btn-invite-corretor"))==null||p.addEventListener("click",async()=>{var y,B;const b=(y=document.getElementById("invite-email"))==null?void 0:y.value.trim(),h=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),x=document.getElementById("btn-invite-corretor"),E=document.getElementById("invite-note");if(!b){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}x&&(x.disabled=!0,x.textContent="Criando…"),E&&(E.style.display="none");try{const $=await ue({email:b,password:h,tenant_id:(f==null?void 0:f.tenant_id)||null});if($.success){const L=document.getElementById("invite-email"),k=document.getElementById("invite-password");L&&(L.value=""),k&&(k.value=""),await Ue(),E&&($.email_sent===!1?(E.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${g(h)}`,E.style.color="#0f172a"):(E.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",E.style.color="#16a34a"),E.style.display="")}else alert("Erro: "+($.error||"Falha desconhecida"))}catch($){alert("Erro ao criar acesso: "+$.message)}finally{x&&(x.disabled=!1,x.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await Le(),(c=document.getElementById("loc-add-city-btn"))==null||c.addEventListener("click",async()=>{const b=document.getElementById("loc-new-city"),h=b==null?void 0:b.value.trim();if(!h)return;const{error:x}=await v.from("locations").insert({type:"cidade",name:h});if(x){alert("Erro ao adicionar cidade.");return}b&&(b.value=""),await Le(),it()}),(r=document.getElementById("loc-add-neighborhood-btn"))==null||r.addEventListener("click",async()=>{var y;const b=parseInt((y=document.getElementById("loc-new-neighborhood-city"))==null?void 0:y.value,10),h=document.getElementById("loc-new-neighborhood"),x=h==null?void 0:h.value.trim();if(!b||!x){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:E}=await v.from("locations").insert({type:"bairro",name:x,parent_id:b});if(E){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await Le()})}}async function Ue(){const e=document.getElementById("corretores-list");if(!e)return;let t=v.from("profiles").select("*").order("created_at");f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${g(i)}</div>`,l=o.id===(f==null?void 0:f.id),s=o.active!==!1,p=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',c=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${g(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const d=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${d}" e todos os bairros vinculados?`))return;const{error:l}=await v.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await Le(),it()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:d}=await v.from("locations").delete().eq("id",i.dataset.id);if(d){alert("Erro ao excluir.");return}await Le()})})}function ht(){var n,a,o,i,d,l,s,p,c,r,m,u,b,h,x,E,y,B,$,L;document.querySelectorAll(".filter-btn").forEach(k=>{k.addEventListener("click",()=>{const I=k.closest(".filter-btns"),w=k.classList.contains("active");I.querySelectorAll(".filter-btn").forEach(S=>S.classList.remove("active")),w||k.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var T;const k=(T=document.getElementById("f-city"))==null?void 0:T.value,I=ge().find(C=>C.name===k),w=I?ot(I.id):[],S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'+w.map(C=>`<option value="${C.name}">${g(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{_e(at(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const k=document.querySelector(".admin-filter-panel");if(k){k.querySelectorAll('input[type="text"], input[type="number"]').forEach(w=>{w.value=""}),k.querySelectorAll("select").forEach(w=>{w.selectedIndex=0});const I=document.getElementById("f-neighborhood");I&&(I.innerHTML='<option value="">Todos</option>'),k.querySelectorAll(".filter-btn.active").forEach(w=>w.classList.remove("active"))}_e(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{me(k.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(k=>{k.addEventListener("click",()=>{me(k.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(k=>{k.addEventListener("click",I=>{I.stopPropagation();const w=k.closest(".topnav-dropdown");w==null||w.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(S=>{S!==w&&S.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(k=>k.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",qe),(d=document.getElementById("modal-cancel"))==null||d.addEventListener("click",qe),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",k=>{k.target.id==="property-modal"&&qe()}),(s=document.getElementById("btn-new-property"))==null||s.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",de="",ze([]),Ge("Novo Imóvel")}),(p=document.getElementById("logout-btn"))==null||p.addEventListener("click",async()=>{await v.auth.signOut(),location.reload()}),(c=document.getElementById("view-prev"))==null||c.addEventListener("click",()=>{V=(V-1+Z.length)%Z.length,Ne()}),(r=document.getElementById("view-next"))==null||r.addEventListener("click",()=>{V=(V+1)%Z.length,Ne()}),(m=document.getElementById("view-modal-close"))==null||m.addEventListener("click",Te),(u=document.getElementById("view-modal-close2"))==null||u.addEventListener("click",Te),(b=document.getElementById("view-modal"))==null||b.addEventListener("click",k=>{k.target.id==="view-modal"&&Te()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const k=document.getElementById("share-panel");if(!k)return;const I=k.style.display!=="none";k.style.display=I?"none":"block"}),(x=document.getElementById("share-whatsapp"))==null||x.addEventListener("click",()=>{var H,U,K;const k=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!k)return;const I=Number((U=document.getElementById("share-panel"))==null?void 0:U.dataset.pid),w=_.find(oe=>oe.id===I),S=(w==null?void 0:w.title)||((K=document.getElementById("view-modal-title"))==null?void 0:K.textContent)||"Imóvel",T=w!=null&&w.price?` — ${re(w.price,"pt")}`:"",C=w!=null&&w.reference?` | Ref: ${w.reference}`:"",M=[w==null?void 0:w.neighborhood,w==null?void 0:w.city].filter(Boolean).join(", "),A=M?`
📍 ${M}`:"",P=encodeURIComponent(`Olha esse imóvel que encontrei: *${S}*${T}${C}${A}

${k}`);window.open("https://wa.me/?text="+P,"_blank")}),(E=document.getElementById("share-instagram"))==null||E.addEventListener("click",()=>{var I,w;const k=(I=document.getElementById("share-link-input"))==null?void 0:I.value;k&&((w=navigator.clipboard)==null||w.writeText(k),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(y=document.getElementById("share-email"))==null||y.addEventListener("click",()=>{var T,C;const k=(T=document.getElementById("share-link-input"))==null?void 0:T.value;if(!k)return;const I=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",w=encodeURIComponent("Imóvel: "+I),S=encodeURIComponent(`Olá! Segue o link do imóvel:

`+k);window.open("mailto:?subject="+w+"&body="+S,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var I;const k=document.getElementById("share-link-input");k&&((I=navigator.clipboard)==null||I.writeText(k.value).then(()=>{const w=document.getElementById("share-copy"),S=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=S},2e3)}))}),($=document.getElementById("view-modal-edit"))==null||$.addEventListener("click",()=>{var M;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===k);if(!I)return;Te(),R=I.id;const w=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=I.title||"",w.querySelector('[name="rua"]').value=I.rua||"",w.querySelector('[name="numero"]').value=I.numero||"",w.querySelector('[name="city"]').value=I.city||"",w.querySelector('[name="price"]').value=I.price||"",w.querySelector('[name="bedrooms"]').value=I.bedrooms||"",w.querySelector('[name="suites"]').value=I.suites||"",w.querySelector('[name="parking"]').value=I.parking||"",w.querySelector('[name="description"]').value=I.description||"",w.querySelector('[name="construction_status"]').value=I.construction_status||"",w.querySelector('[name="owner_name"]').value=I.owner_name||"",w.querySelector('[name="owner_phone"]').value=I.owner_phone||"",w.querySelector('[name="owner_email"]').value=I.owner_email||"",w.querySelector('[name="owner_notes"]').value=I.owner_notes||"",w.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),de=I.cover_image||((M=I.images)==null?void 0:M[0])||"",ze(I.images||[]),Ge("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(I=document.getElementById(`tab-${k.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const I=k.target.closest("tr");if(!I)return;const w=Number(I.dataset.id);if(!w)return;const S=_.find(T=>T.id===w);S&&Yt(S)})}document.addEventListener("DOMContentLoaded",async()=>{var l,s,p;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const c=`imobi_tenant_${t}`,r=Ae(c);if(r)ve(r);else{let m=null;for(const u of[t,"www."+t]){const{data:b}=await v.from("tenants").select("id").eq("domain",u).maybeSingle();if(b!=null&&b.id){m=b;break}}m!=null&&m.id&&(ve(m.id),Xe(c,m.id,24*60*60*1e3))}}await Promise.all([Mt(),Ct()]),le=X("company.whatsapp",le),tt(),Gt(),Vt();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(it(),n.addEventListener("change",()=>{const c=ge().find(m=>m.name===n.value),r=c?ot(c.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(m=>`<option value="${m.name}">${g(m.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const c=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),m=c.get("type")||r.get("type")||"",u=It||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||r.has("code"),b=document.getElementById("password-reset-overlay");if(u){o.style.display="none",i&&i.classList.add("hidden"),b&&(b.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async x=>{var k,I;x.preventDefault();const E=((k=document.getElementById("new-password"))==null?void 0:k.value)||"",y=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",B=document.getElementById("password-reset-msg"),$=x.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),E!==y){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}$&&($.disabled=!0,$.textContent="Salvando…");const{error:L}=await v.auth.updateUser({password:E});if(L){B&&(B.textContent="Erro: "+L.message,B.style.display=""),$&&($.disabled=!1,$.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await v.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:h}}=await v.auth.getSession();if(h){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),ht(),gt(),window.lucide&&lucide.createIcons(),f=await mt(h.user.id),!f){await v.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(f.active===!1){await v.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(f.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const x=document.getElementById("password-reset-overlay");x&&(x.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async E=>{var I,w;E.preventDefault();const y=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",B=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",$=document.getElementById("password-reset-msg"),L=E.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),y!==B){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}if(y.length<6){$&&($.textContent="Mínimo 6 caracteres.",$.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:k}=await v.auth.updateUser({password:y});if(k){$&&($.textContent="Erro: "+k.message,$.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await v.from("profiles").update({needs_password_reset:!1}).eq("id",f.id),window.location.href=window.location.pathname});return}ve((f==null?void 0:f.tenant_id)||null),je(f),pt(f),ut(f.role),await Me(),await bt(f),window.lucide&&lucide.createIcons(),la()}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const x=document.getElementById("login-form");x&&((p=document.getElementById("forgot-password-btn"))==null||p.addEventListener("click",async()=>{var B,$;const E=($=(B=x.querySelector('input[name="email"]'))==null?void 0:B.value)==null?void 0:$.trim();if(!E){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:y}=await v.auth.resetPasswordForEmail(E,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(y?"Erro: "+y.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),x.addEventListener("submit",async E=>{E.preventDefault();const y=x.querySelector('button[type="submit"]'),B=new FormData(x),$=B.get("email"),L=B.get("password");y&&(y.disabled=!0,y.textContent="Entrando…");try{if(await Ut($,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),ht(),window.lucide&&lucide.createIcons();const{data:{session:I}}=await v.auth.getSession();if(f=I?await mt(I.user.id):null,!f){await v.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(f.active===!1){await v.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}gt(),ve((f==null?void 0:f.tenant_id)||null),je(f),pt(f),ut(f.role),await Me(),await bt(f),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}catch(k){alert("Erro ao fazer login: "+((k==null?void 0:k.message)||String(k)))}finally{y&&(y.disabled=!1,y.textContent="Entrar")}}))}}else Fe();await ce();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();rt(d),ct(le),window._applyDynamicContent=rt,window._applyWhatsAppLinks=ct,document.querySelectorAll(".nav-dropdown-btn").forEach(c=>{var m;const r=(m=c.closest(".nav-dropdown"))==null?void 0:m.querySelector(".nav-dropdown-menu");r&&c.addEventListener("click",u=>{u.stopPropagation(),r.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(b=>{b!==r&&b.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(c=>c.classList.remove("js-open"))})});async function ua(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await v.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=_.findIndex(s=>s.id===o.id);l>=0&&(_[l].reference=i),n++}}_e(at(_))}async function ga(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await fa(i);a.push(d),o=!0}catch{a.push(i)}if(o){await v.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(d=>d.id===t.id);i>=0&&(_[i].images=a)}}_e(at(_))}}async function fa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const p=document.createElement("canvas"),c=1200;let r=s.width,m=s.height;r>c&&(m=Math.round(m*c/r),r=c),p.width=r,p.height=m;const u=p.getContext("2d");u.drawImage(s,0,0,r,m);const b=h=>{if(h){const x=Math.round(r*.18),E=Math.round(h.naturalHeight*x/h.naturalWidth),y=Math.round(r*.02);u.globalAlpha=.45,u.drawImage(h,r-x-y,m-E-y,x,E),u.globalAlpha=1}p.toBlob(async x=>{try{const E=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:y}=await v.storage.from("imoveis").upload(E,x,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(y){console.error("Upload watermark error:",y),l(e);return}const{data:{publicUrl:B}}=v.storage.from("imoveis").getPublicUrl(E);l(B)}catch(E){console.error("Watermark upload exception:",E),l(e)}},"image/jpeg",.82)};if(d){const h=new Image;h.onload=()=>{URL.revokeObjectURL(d),b(h)},h.onerror=()=>{URL.revokeObjectURL(d),b(null)},h.src=d}else b(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function W(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function st(e,t="assets"){const n=await Ce(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await v.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=v.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `;function s(c,r,m){const u=document.getElementById(c),b=document.getElementById(r);u==null||u.addEventListener("input",h=>{b.value=h.target.value,m()}),b==null||b.addEventListener("input",h=>{/^#[0-9a-fA-F]{6}$/.test(h.target.value)&&(u.value=h.target.value,m())})}function p(){var r,m,u,b;const c=((r=document.getElementById("col-accent-hex"))==null?void 0:r.value)||"#b8962e";(m=document.getElementById("vp-bar"))==null||m.style.setProperty("background",c),(u=document.getElementById("vp-dot"))==null||u.style.setProperty("background",c),(b=document.getElementById("vp-btn"))==null||b.style.setProperty("background",c),document.documentElement.style.setProperty("--accent",c)}s("col-accent","col-accent-hex",p),s("col-primary","col-primary-hex",()=>{}),s("col-secondary","col-secondary-hex",()=>{}),p(),document.getElementById("vis-hero-file").addEventListener("change",async c=>{const r=c.target.files[0];if(r)try{const m=await st(r,"hero");document.getElementById("vis-hero-url").value=m;const u=document.getElementById("vis-hero-preview");u.innerHTML=`<img src="${m}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,u.style.display=""}catch(m){alert("Erro no upload: "+m.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const c=document.getElementById("visual-save-colors");c.disabled=!0,c.textContent="Salvando…";const r=await xe([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);r&&tt(),c.disabled=!1,c.textContent="Salvar Cores",W(document.getElementById("visual-colors-msg"),r)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",p())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const c=document.getElementById("visual-save-images");c.disabled=!0,c.textContent="Salvando…";const r=await xe([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);c.disabled=!1,c.textContent="Salvar Imagens",W(document.getElementById("visual-images-msg"),r)})}async function ba(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("site_content").select("*").eq("tenant_id",z()),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=(s,p)=>{var c;return g(((c=n[s])==null?void 0:c[`value_${p}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},d=s=>o.map(p=>`<button class="content-tab${p===s?" active":""}" data-lang="${p}">${i[p]}</button>`).join(""),l=s=>`
  ...
  `,await Q())}async function Q(){const e=document.getElementById("crm-body");if(!e)return;const t=z(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([v.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),v.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),v.from("crm_tags").select("*").eq("tenant_id",t).order("name"),v.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),d=n||[],l=d.find(u=>u.is_default)||d[0],s=d.map(u=>`<option value="${u.id}"${u.id===(l==null?void 0:l.id)?" selected":""}>${g(u.name)}</option>`).join(""),c=(a||[]).filter(u=>u.pipeline_id===(l==null?void 0:l.id)).map(u=>`
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),b=document.getElementById("crm-new-stage-color").value,h=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await v.from("crm_stages").insert({pipeline_id:h,name:u,color:b,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-stage").value="",await Q())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await v.from("crm_stages").delete().eq("id",u.dataset.id),await Q())})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async b=>{await v.from("crm_stages").update({color:b.target.value}).eq("id",u.dataset.sid);const h=u.closest(".stage-item").querySelector(".stage-color-dot");h&&(h.style.background=b.target.value)})}),document.getElementById("crm-add-tag").addEventListener("click",async()=>{const u=document.getElementById("crm-new-tag").value.trim(),b=document.getElementById("crm-new-tag-color").value;u&&(await v.from("crm_tags").insert({name:u,color:b,tenant_id:z()}),document.getElementById("crm-new-tag").value="",await Q())}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await v.from("crm_tags").delete().eq("id",u.dataset.id),await Q()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),b=document.getElementById("crm-new-status-color").value,h=document.getElementById("crm-new-status-final").checked;u&&(await v.from("crm_lead_statuses").insert({name:u,color:b,is_final:h,sort_order:99,tenant_id:z()}),document.getElementById("crm-new-status").value="",await Q())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await v.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await Q())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var h;const u=(h=prompt("Nome do novo funil:"))==null?void 0:h.trim();if(!u)return;const{error:b}=await v.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:z()});if(b){alert("Erro ao criar funil: "+b.message);return}We=!1,await Q()})}async function xa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await v.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var s;return g(((s=n[l])==null?void 0:s.value)||"")},o=l=>{var s;return(s=n[l])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,document.getElementById("intg-save-tracking").addEventListener("click",async()=>{var r;const l=document.getElementById("intg-save-tracking");l.disabled=!0,l.textContent="Salvando…";let s=!0;const p=document.querySelectorAll(".intg-val"),c=document.querySelectorAll(".intg-toggle");for(let m=0;m<p.length;m++){const u=p[m].dataset.key,b=p[m].value.trim(),h=((r=c[m])==null?void 0:r.checked)??!1;await Pe(u,b,h)||(s=!1)}l.disabled=!1,l.textContent="Salvar Integrações",W(document.getElementById("intg-tracking-msg"),s)}),document.getElementById("intg-save-smtp").addEventListener("click",async()=>{const l=document.getElementById("intg-save-smtp");l.disabled=!0,l.textContent="Salvando…";const s=document.querySelectorAll(".smtp-field");let p=!0;for(const r of s)await Pe(r.dataset.key,r.value.trim(),!0)||(p=!1);const c=document.getElementById("smtp-pass").value;c&&(await Pe("smtp_pass",c,!0)||(p=!1)),l.disabled=!1,l.textContent="Salvar SMTP",W(document.getElementById("intg-smtp-msg"),p)})}async function Ea(){const e=document.getElementById("section-midia");if(!e||e.dataset.loaded)return;e.dataset.loaded="1",e.innerHTML=`
    <div class="section-topbar">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const l=e.querySelector(`#sa-panel-${d.dataset.tab}`);l&&l.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&ae(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Ia(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&xt(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Et(),d.dataset.tab==="platform"&&wt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",xt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",ae),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Et),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Ba()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",$a),ae(),wt())}async function ae(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=v.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(p=>{var c,r;return!t||((c=p.name)==null?void 0:c.toLowerCase().includes(t))||((r=p.slug)==null?void 0:r.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=p=>p.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(p=>{var c;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(p=>{p.addEventListener("click",async c=>{c.stopPropagation();const r=p.dataset.active==="true";await v.from("tenants").update({active:!r}).eq("id",p.dataset.id),ae()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(p=>{p.addEventListener("click",()=>{const c=(i||[]).find(r=>String(r.id)===String(p.dataset.id));c&&La(c)})})}async function Ia(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await v.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),v.from("plans").select("id, name").then(({data:p})=>{const c=document.getElementById("nt-plan");c&&p&&(c.innerHTML='<option value="">Sem plano</option>'+p.map(r=>`<option value="${r.id}">${g(r.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",p=>{const c=document.getElementById("nt-slug");c&&!c.dataset.manual&&(c.value=ka(p.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",p=>{p.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const p=document.getElementById("nt-admin-password");p.type=p.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",p=>{p.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var L,k,I,w,S,T,C,M,A,P,H,U;const p=(k=(L=document.getElementById("nt-name"))==null?void 0:L.value)==null?void 0:k.trim(),c=(w=(I=document.getElementById("nt-slug"))==null?void 0:I.value)==null?void 0:w.trim(),r=(T=(S=document.getElementById("nt-domain"))==null?void 0:S.value)==null?void 0:T.trim(),m=(C=document.getElementById("nt-plan"))==null?void 0:C.value,u=(A=(M=document.getElementById("nt-admin-email"))==null?void 0:M.value)==null?void 0:A.trim(),b=(H=(P=document.getElementById("nt-admin-password"))==null?void 0:P.value)==null?void 0:H.trim(),h=document.getElementById("nt-msg"),x=document.getElementById("nt-save");if(!p||!c){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!b||b.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}x.disabled=!0,x.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:E,error:y}=await v.from("tenants").insert({name:p,slug:c,domain:r||null,plan_id:m||null,active:!0}).select();if(y){x.disabled=!1,x.textContent="Criar Imobiliária",h.textContent="❌ "+y.message,h.style.color="#ef4444";return}const B=(U=E==null?void 0:E[0])==null?void 0:U.id;h.textContent="⏳ Criando usuário admin…";const $=await ue({email:u,password:b,role:"admin",tenant_id:B});if(!($!=null&&$.success)){x.disabled=!1,x.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+g(($==null?void 0:$.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),ae()},3e3);return}B&&($!=null&&$.user_id)&&!($!=null&&$.linked)&&await v.from("profiles").update({tenant_id:B}).eq("id",$.user_id),x.disabled=!1,x.textContent="Criar Imobiliária",$.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Tt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",et(e,o.dataset.tab)})}),et(e,"properties")}function Sa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,p,c="text",r="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${c.map(r=>{var m;return`
            <tr data-pid="${r.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${g(re(r.price,"pt"))}</td>
      ...
      </div>`,n.querySelectorAll(".tp-prop-edit").forEach(r=>{r.addEventListener("click",()=>{const m=Number(r.dataset.pid),u=c.find(b=>b.id===m);u&&Sa(u,a)})}),n.querySelectorAll(".tp-prop-toggle").forEach(r=>{r.addEventListener("click",async()=>{const m=Number(r.dataset.pid),u=r.dataset.pub==="1";r.disabled=!0,r.textContent="…",await v.from("properties").update({published:!u}).eq("id",m),a()})}),n.querySelectorAll(".tp-prop-del").forEach(r=>{r.addEventListener("click",async()=>{confirm("Excluir este imóvel permanentemente?")&&(r.disabled=!0,r.textContent="…",await v.from("properties").delete().eq("id",Number(r.dataset.pid)),a())})})}if(t==="leads"){const{data:c}=await v.from("leads").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1}).limit(200);if(!(c!=null&&c.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">📋</div><p style="font-size:14px;">Nenhum lead ainda.</p></div>';return}const r=m=>({novo:"#dbeafe,#1d4ed8",contato:"#fef3c7,#92400e",proposta:"#ede9fe,#6d28d9",fechado:"#dcfce7,#15803d"})[m]||"#f1f5f9,#64748b";n.innerHTML=`
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var y;(y=navigator.clipboard)==null||y.writeText(e.id);const x=document.getElementById("tp-copy-key"),E=x.textContent;x.textContent="✅ Copiada!",setTimeout(()=>{x.textContent=E},2e3)})}if(t==="config"){const{data:c}=await v.from("settings").select("key,value").eq("tenant_id",e.id),r={};c==null||c.forEach(u=>{r[u.key]=u.value});const m=(u,b)=>`
      ...
      </div>`,(p=document.getElementById("tp-open-edit"))==null||p.addEventListener("click",()=>Tt(e))}}function Tt(e){var p,c,r,m,u,b,h,x;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([E,y,B])=>`
            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px 12px;">
              <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
                <span style="font-size:10px;font-weight:700;padding:2px 7px;border-radius:4px;background:${E==="GET"?"#dcfce7":"#fef9c3"};color:${E==="GET"?"#15803d":"#854d0e"};">${E}</span>
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),v.from("plans").select("id, name").then(({data:E})=>{const y=document.getElementById("et-plan");y&&E&&(y.innerHTML='<option value="">Sem plano</option>'+E.map(B=>`<option value="${B.id}"${String(B.id)===String(e.plan_id)?" selected":""}>${g(B.name)}</option>`).join(""))}),(p=document.getElementById("et-logo-input"))==null||p.addEventListener("change",E=>{const y=E.target.files[0];if(!y)return;const B=URL.createObjectURL(y),$=document.getElementById("et-logo-preview");$&&($.innerHTML=`<img src="${B}" style="width:100%;height:100%;object-fit:cover;">`)}),(c=document.getElementById("et-logo-preview"))==null||c.addEventListener("click",()=>{var E;(E=document.getElementById("et-logo-input"))==null||E.click()}),(r=document.getElementById("et-pwd-toggle"))==null||r.addEventListener("click",()=>{const E=document.getElementById("et-admin-password");E.type=E.type==="password"?"text":"password"}),(m=document.getElementById("et-copy-key"))==null||m.addEventListener("click",()=>{var $,L;const E=($=document.getElementById("et-api-key"))==null?void 0:$.value;if(!E)return;(L=navigator.clipboard)==null||L.writeText(E);const y=document.getElementById("et-copy-key"),B=y.textContent;y.textContent="✅ Copiada!",setTimeout(()=>{y.textContent=B},2e3)});const o=["dados","config","api"];function i(E){o.forEach(y=>{document.getElementById(`et-pane-${y}`).style.display=y===E?"":"none";const B=document.getElementById(`et-tab-${y}`);B.style.borderBottomColor=y===E?"#2563eb":"transparent",B.style.color=y===E?"#2563eb":"#64748b",B.style.fontWeight=y===E?"600":"500"}),E==="config"&&l()}o.forEach(E=>{var y;return(y=document.getElementById(`et-tab-${E}`))==null?void 0:y.addEventListener("click",()=>i(E))});let d=!1;async function l(){var B;if(d)return;d=!0;const{data:E}=await v.from("settings").select("key,value").eq("tenant_id",e.id),y={};E==null||E.forEach($=>{y[$.key]=$.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(B=document.getElementById("et-cfg-save"))==null||B.addEventListener("click",async()=>{const $=document.getElementById("et-cfg-save"),L=document.getElementById("et-cfg-msg");$.disabled=!0,$.textContent="Salvando…",L.textContent="",L.style.color="#64748b";const k=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),I=document.getElementById("et-cfg-phone").value.trim(),w=document.getElementById("et-cfg-email").value.trim(),S=document.getElementById("et-cfg-city").value.trim(),T=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await v.from("settings").upsert([{key:"company.whatsapp",value:k,tenant_id:e.id},{key:"company.phone",value:I,tenant_id:e.id},{key:"company.email",value:w,tenant_id:e.id},{key:"company.city",value:S,tenant_id:e.id},{key:"company.address",value:S,tenant_id:e.id},{key:"company.slogan",value:T,tenant_id:e.id}],{onConflict:"tenant_id,key"});$.disabled=!1,$.textContent="💾 Salvar configurações",C?(L.textContent="❌ "+C.message,L.style.color="#ef4444"):(L.textContent="✅ Configurações salvas!",L.style.color="#22c55e")})}const s=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",s),(b=document.getElementById("et-cancel"))==null||b.addEventListener("click",s),n.addEventListener("click",E=>{E.target===n&&s()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const y=document.getElementById("et-delete");y.disabled=!0,y.textContent="Excluindo…";const{error:B}=await v.from("tenants").delete().eq("id",e.id);if(B){alert("Erro ao excluir: "+B.message),y.disabled=!1,y.textContent="🗑️ Excluir";return}s(),ae()}),(x=document.getElementById("et-save"))==null||x.addEventListener("click",async()=>{var M,A,P,H,U,K,oe,Ie,$e,O,fe,lt;const E=(A=(M=document.getElementById("et-name"))==null?void 0:M.value)==null?void 0:A.trim(),y=(H=(P=document.getElementById("et-slug"))==null?void 0:P.value)==null?void 0:H.trim(),B=(K=(U=document.getElementById("et-domain"))==null?void 0:U.value)==null?void 0:K.trim(),$=(oe=document.getElementById("et-plan"))==null?void 0:oe.value,L=($e=(Ie=document.getElementById("et-admin-email"))==null?void 0:Ie.value)==null?void 0:$e.trim(),k=(fe=(O=document.getElementById("et-admin-password"))==null?void 0:O.value)==null?void 0:fe.trim(),I=(lt=document.getElementById("et-logo-input"))==null?void 0:lt.files[0],w=document.getElementById("et-msg"),S=document.getElementById("et-save");if(!E){w.textContent="❌ Nome é obrigatório.",w.style.color="#ef4444";return}S.disabled=!0,S.textContent="Salvando…",w.textContent="⏳ Salvando…",w.style.color="#64748b";let T=e.logo_url;if(I)try{const q=await Ce(I,256,.85),dt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:At}=await v.storage.from("imoveis").upload(dt,q,{contentType:"image/jpeg",upsert:!0});if(!At){const{data:{publicUrl:qt}}=v.storage.from("imoveis").getPublicUrl(dt);T=qt}}catch(q){console.error("Logo upload:",q)}const{error:C}=await v.from("tenants").update({name:E,slug:y||e.slug,domain:B||null,plan_id:$||null,logo_url:T}).eq("id",e.id);if(C){S.disabled=!1,S.textContent="Salvar",w.textContent="❌ "+C.message,w.style.color="#ef4444";return}if(L&&k&&k.length>=6){w.textContent="⏳ Criando usuário admin…";const q=await ue({email:L,password:k,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await v.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),w.textContent="✅ Salvo e admin criado!",w.style.color="#22c55e"):(w.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),w.style.color="#f59e0b")}else w.textContent="✅ Imobiliária atualizada!",w.style.color="#22c55e";S.disabled=!1,S.textContent="Salvar",setTimeout(()=>{s(),ae()},1200)})}function _a(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ca)}function Ca(){const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
