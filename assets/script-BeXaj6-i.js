import{s as y}from"./supabase-BcuJ3xoD.js";const yt="00000000-0000-0000-0000-000000000000";let Ie={},je={},ge=yt;function Re(e){ge=e||yt,Ie={},je={}}const R=()=>ge;async function St(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",ge),y.from("site_content").select("*").eq("tenant_id",ge)]);e.data&&e.data.forEach(n=>{Ie[n.key]=n.value}),t.data&&t.data.forEach(n=>{je[n.key]=n})}const F=(e,t=null)=>Ie[e]!==void 0?Ie[e]:t,He=(e,t="pt")=>{const n=je[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function pe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ge,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{Ie[o]=i}),!a}async function Ue(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ge,updated_at:new Date().toISOString()},{error:i}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(je[e]=o),!i}async function Oe(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function Ye(){const e=document.documentElement,t=F("visual.accent_color","#b8962e"),n=F("visual.primary_bg","#0f1c2e"),a=F("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=F("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=F("company.favicon_url","/favicon.ico"),s=document.querySelector('link[rel="shortcut icon"]');s&&(s.href=i);const l=F("visual.hero_bg_url","");if(l){const d=document.querySelector(".hero");d&&(d.style.backgroundImage=`url('${l}')`)}}function _t(e="pt"){const t=b=>He(b,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),s=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),s&&t("inst.bio_p2")&&(s.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),c=document.querySelector('[data-i18n="inst.stat2"]'),m=document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat2_num")&&(d.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),c&&t("inst.stat2_label")&&(c.innerHTML=t("inst.stat2_label")),m&&t("inst.stat3_label")&&(m.innerHTML=t("inst.stat3_label"));const f=He("seo.title_pt",e);f&&document.title&&(document.title=f);const u=He("seo.description_pt",e);if(u){const b=document.querySelector('meta[name="description"]');b&&(b.content=u)}}function Ct(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Tt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let ne="5547999701743";const ie=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],At=5.7;function ve(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/At).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],v=null,$e=[],bt=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(bt=!0)});async function qt(){const t=window.location.hostname.replace(/^www\./,"");let n=null;if(t&&t!=="localhost"&&t!=="127.0.0.1"){let{data:s}=await y.from("tenants").select("id").eq("domain",t).maybeSingle();s!=null&&s.id||(s=(await y.from("tenants").select("id").eq("domain","www."+t).maybeSingle()).data),s!=null&&s.id&&(n=s.id)}let a=y.from("properties").select("*").eq("published",!0);n&&(a=a.eq("tenant_id",n));const{data:o,error:i}=await a.order("created_at",{ascending:!1});return i?(console.error("Supabase select error:",i),[]):o||[]}async function Mt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="super_admin"||(v!=null&&v.tenant_id?e=e.eq("tenant_id",v.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ca(),ma(),_)}async function zt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(s=>s.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Nt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function jt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function Le(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,s=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(s);const l=document.createElement("canvas");let d=i.width,r=i.height;d>t&&(r=Math.round(r*t/d),d=t),l.width=d,l.height=r;const c=l.getContext("2d");c.drawImage(i,0,0,d,r);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const f=Math.round(d*.18),u=Math.round(m.naturalHeight*f/m.naturalWidth),b=Math.round(d*.02),h=d-f-b,E=r-u-b;c.globalAlpha=.45,c.drawImage(m,h,E,f,u),c.globalAlpha=1,l.toBlob(g=>g?a(g):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{l.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=s})}async function Rt(e){const t=await Le(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Ht(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Rt(n[o]));return a}async function Be(){var m,f,u,b,h,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await qt();_=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&Ut(n);const a=((f=document.getElementById("city-filter"))==null?void 0:f.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((b=document.getElementById("bedrooms-filter"))==null?void 0:b.value)||"",s=((h=document.getElementById("parking-filter"))==null?void 0:h.value)||"",l=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",{min:d,max:r}=Ot(),c=n.filter(g=>{if(a&&g.city!==a||o&&g.neighborhood!==o||i&&(i==="4+"&&Number(g.bedrooms)<4||i!=="4+"&&Number(g.bedrooms)!==Number(i))||s&&(s==="4+"&&Number(g.parking)<4||s!=="4+"&&Number(g.parking)!==Number(s))||l&&g.construction_status!==l)return!1;const w=String(g.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),$=parseInt(w,10)||0;return!($<d||r!==1/0&&$>r)});if(e){if(!c.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=c.map(g=>{var S;const w=g.cover_image||((S=g.images)==null?void 0:S[0])||ie[0],$=[g.neighborhood,g.city].filter(Boolean).join(", "),k=encodeURIComponent(`Olá! Tenho interesse no imóvel *${g.title}*${g.reference?` (Ref: ${g.reference})`:""}. Poderia me dar mais informações?`);return`
        <div class="selecao-card">
          <img src="${w}" alt="${p(g.title)}" class="selecao-card-img">
          <div class="selecao-card-body">
            <div class="selecao-card-title">${p(g.title)}</div>
            <div class="selecao-card-loc">${p($)}</div>
            <div class="selecao-card-price">${p(ve(g.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${g.id}" class="btn-det">Ver Detalhes</a>
              <a href="https://wa.me/${ne}?text=${k}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!c.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=c.map(g=>{var S;const w=(S=g.images)!=null&&S.length?g.images:ie,$=w.length,k=encodeURIComponent(`Olá! Tenho interesse no imóvel *${g.title}*${g.reference?` (Ref: ${g.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${$}" data-idx="0" data-pid="${g.id}">
          <img src="${g.cover_image||w[0]}" alt="${p(g.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${$>1?`
        ...
        <div class="property-info">
          <strong>${p(g.title)}</strong>
          <div class="muted">${p(g.neighborhood||"")}, ${p(g.city||"")}</div>
          <div><strong>${p(ve(g.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${g.bedrooms||"--"} | 🚗 ${g.parking||"--"} ${$>1?"| 📸 "+$:""}</div>
          <p class="muted">${p((g.description||"").slice(0,110))}</p>
          <div style="display:flex;gap:8px;margin-top:6px">
            <a class="btn btn-outline" href="property.html?id=${g.id}" style="flex:1;justify-content:center">Ver Detalhes</a>
            <a class="btn hero-whatsapp-btn" href="https://wa.me/${ne}?text=${k}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(g=>{g.removeEventListener("click",ot),g.addEventListener("click",ot)})}function Ut(e){var o,i,s;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var m;const d=l.cover_image||((m=l.images)==null?void 0:m[0])||ie[0],r=[l.neighborhood,l.city].filter(Boolean).join(", "),c=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="selecao-card">
        <img src="${d}" alt="${p(l.title)}" class="selecao-card-img">
        <div class="selecao-card-body">
          <div class="selecao-card-title">${p(l.title)}</div>
          <div class="selecao-card-loc">${p(r)}</div>
          <div class="selecao-card-price">${p(ve(l.price,window.currentLang||"pt"))}</div>
          <div class="selecao-card-actions">
    ...
    `}).join("");const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(s=a==null?void 0:a.querySelector(".selecao-next"))==null||s.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),Be()};function ot(e){var l;e.stopPropagation();const t=e.currentTarget.closest(".carousel-wrap");if(!t)return;const n=parseInt(t.dataset.total,10);if(!n)return;let a=parseInt(t.dataset.idx,10)||0;const o=e.currentTarget.classList.contains("carousel-next")?1:-1;a=(a+o+n)%n,t.dataset.idx=a;const i=parseInt(t.dataset.pid,10),s=_.find(d=>d.id===i);(l=s==null?void 0:s.images)!=null&&l.length&&(t.querySelector(".carousel-img").src=s.images[a])}function Ot(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Dt(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>Be())}function Pt(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=de();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=de().find(i=>i.name===e.value),o=a?Ze(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${p(i.name)}</option>`).join(""),Be()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",Be)})}function ke(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var s;const a=n.cover_image||((s=n.images)==null?void 0:s[0])||ie[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
    ...
    </tr>`}).join("")}}function Ft(){const e=document.getElementById("f-city");if(!e)return;const t=de(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${p(a.name)}</option>`).join(""),n&&(e.value=n)}function Xt(){var e,t,n,a,o,i,s,l,d,r,c,m,f,u,b;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((s=document.getElementById("f-price-min"))==null?void 0:s.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((d=document.getElementById("f-area-min"))==null?void 0:d.value)||0,areaMax:parseFloat((r=document.getElementById("f-area-max"))==null?void 0:r.value)||1/0,construction:((c=document.getElementById("f-construction"))==null?void 0:c.value)||"",published:((m=document.getElementById("f-published"))==null?void 0:m.value)||"",bedrooms:((f=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:f.dataset.val)||"",suites:((u=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:u.dataset.val)||"",parking:((b=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:b.dataset.val)||""}}function Ke(e){const t=Xt();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Ce(){if(!document.getElementById("admin-properties"))return;const e=await Mt(),t=e.length,n=e.filter(s=>s.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Ft(),ke(_)}let j=null,oe="";function Pe(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function _e(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow=""}function Te(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(!e.length){t.style.display="none";return}t.style.display="",n.innerHTML=e.map(a=>`
    <div class="cover-thumb-wrap${a===oe?" selected":""}" data-url="${a}">
      <img src="${a}" class="cover-thumb" alt="">
      <span class="cover-star">★</span>
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",()=>{oe=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(o=>o.classList.remove("selected")),a.classList.add("selected")})})}}function De(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var d;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const s=o.filter(r=>r.size>0);if(s.length){t.disabled=!0,t.textContent=`Enviando 0/${s.length} foto…`;try{i=await Ht(s,(r,c)=>{t.textContent=`Enviando ${r}/${c} foto…`})}catch(r){console.error("Erro no upload:",r),t.disabled=!1,t.textContent=j?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(j){const r=_.find(c=>c.id===j);r!=null&&r.images&&(i=r.images)}i.length||(i=[...ie]);const l={...j?{id:j}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:oe||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",tenant_id:j?((d=_.find(r=>r.id===j))==null?void 0:d.tenant_id)??(v==null?void 0:v.tenant_id)??null:(v==null?void 0:v.tenant_id)??null};try{await zt(l),j=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const r=document.getElementById("adminPublished");r&&(r.value="true");const c=document.getElementById("adminNeighborhood");c&&(c.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),oe="",Te([]),_e(),await Ce()}catch(r){console.error(r),t.disabled=!1,t.textContent=j?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((r==null?void 0:r.message)||JSON.stringify(r)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Nt(o),await Ce()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((v==null?void 0:v.role)!=="admin"&&(v==null?void 0:v.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(d=>d.id===o);if(!i)return;j=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const s=document.getElementById("adminPublished");s&&(s.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const d=document.getElementById("adminNeighborhood");d&&(d.value=i.neighborhood||"")},50)),oe=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Te(i.images||[]),Pe("Editar Imóvel")}})}function p(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Q=[],G=0;function Gt(e){var m,f;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||ie[0];document.getElementById("view-thumb-preview").src=i,Q=(f=e.images)!=null&&f.length?e.images:ie,G=0,Ae(),document.getElementById("view-price").textContent=ve(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,r=document.getElementById("share-link-input");r&&(r.value=d);const c=document.getElementById("share-panel");c&&(c.style.display="none",c.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Se(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ae(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Q[G],e.alt=`Foto ${G+1}`;const i=Q.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${G+1} / ${Q.length}`:"",o.innerHTML=i?Q.map((s,l)=>`<img src="${s}" class="view-thumb${l===G?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(s=>{s.addEventListener("click",()=>{G=+s.dataset.i,Ae()})})}async function it(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function qe(e){var m,f;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",s=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=s),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),c=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),d&&(d.textContent=s),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",c&&(c.style.display="none")):(c&&(c.textContent=((f=i[0])==null?void 0:f.toUpperCase())||"?",c.style.display=""),r&&(r.style.display="none"))}function se(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),W(),e==="contatos"&&ia(),e==="funil"&&Yt(),e==="tarefas"&&Qt()}function st(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ua,visual:ga,"site-config":va,"crm-config":fa,integracoes:ya,midia:ba}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>ha(),{once:!0}),window.lucide&&lucide.createIcons()}}function W(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Vt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",s=>{s.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var m,f;const s=((m=document.getElementById("cp-new"))==null?void 0:m.value)||"",l=((f=document.getElementById("cp-confirm"))==null?void 0:f.value)||"",d=document.getElementById("cp-msg"),r=document.getElementById("cp-save");if(d.style.display="none",s.length<6){d.style.color="#ef4444",d.textContent="Mínimo 6 caracteres.",d.style.display="";return}if(s!==l){d.style.color="#ef4444",d.textContent="As senhas não coincidem.",d.style.display="";return}r.disabled=!0,r.textContent="Salvando…";const{error:c}=await y.auth.updateUser({password:s});if(r.disabled=!1,r.textContent="Salvar Senha",c){d.style.color="#ef4444",d.textContent="Erro: "+c.message,d.style.display="";return}d.style.color="#16a34a",d.textContent="✅ Senha alterada com sucesso!",d.style.display="",setTimeout(n,1500)})}function Wt(){var i,s,l,d,r;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("ac-close"))==null||a.addEventListener("click",n),(o=document.getElementById("ac-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",s=>{s.target===t&&n()}),(i=document.getElementById("ac-save"))==null||i.addEventListener("click",async()=>{var c,m;const s=(c=document.getElementById("ac-email"))==null?void 0:c.value.trim(),l=(m=document.getElementById("ac-password"))==null?void 0:m.value.trim(),d=document.getElementById("ac-save"),r=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!l||l.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}d.disabled=!0,d.textContent="Criando…",r.style.display="none";try{const f=await ye({email:s,password:l,tenant_id:(v==null?void 0:v.tenant_id)||null});d.disabled=!1,d.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(r.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${p(s)}<br><strong>Senha:</strong> ${p(l)}`,r.style.color="#0f172a"):(r.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",r.style.color="#16a34a"),r.style.display=""):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(f){d.disabled=!1,d.textContent="+ Criar Acesso",alert("Erro: "+f.message)}})}function lt(){var i,s,l,d,r,c,m,f,u,b,h;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",E=>{var w;E.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(w=document.getElementById("notif-dropdown"))==null||w.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",E=>{E.stopPropagation(),W(),Wt()}),(s=document.getElementById("avatar-dd-change-pass"))==null||s.addEventListener("click",E=>{E.stopPropagation(),W(),Vt()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",E=>{E.stopPropagation(),W(),Jt()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",E=>{E.stopPropagation(),W(),se("settings")}),(r=document.getElementById("avatar-dd-logout"))==null||r.addEventListener("click",async E=>{E.stopPropagation(),await y.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",E=>{var w;E.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((w=document.getElementById("avatar-dropdown"))==null||w.classList.add("hidden"),ta())}),(c=document.getElementById("notif-mark-all"))==null||c.addEventListener("click",()=>{aa(),W()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var E,g;(E=document.getElementById("search-overlay"))==null||E.classList.remove("hidden"),(g=document.getElementById("search-input"))==null||g.focus()}),(f=document.getElementById("search-overlay-close"))==null||f.addEventListener("click",()=>{var E;(E=document.getElementById("search-overlay"))==null||E.classList.add("hidden")}),(u=document.getElementById("search-overlay"))==null||u.addEventListener("click",E=>{E.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(b=document.getElementById("search-input"))==null||b.addEventListener("input",E=>{clearTimeout(o),o=setTimeout(()=>ea(E.target.value.trim()),280)}),(h=document.getElementById("search-input"))==null||h.addEventListener("keydown",E=>{var g;E.key==="Escape"&&((g=document.getElementById("search-overlay"))==null||g.classList.add("hidden"))}),document.addEventListener("click",W)}let Fe=!1,ae=[],Qe=[],Me=[],Xe={},ht=[],Z=null,xe=null,P={search:"",tags:new Set,status:""};async function Yt(){var t;if(Fe){await dt();return}Fe=!0,await dt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>Ve());const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{Z=parseInt(e.value,10),await ze()})}function Ge(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+ht.map(s=>`<option value="${p(s.name)}">${p(s.name)}</option>`).join(""),n.value=P.status,n.onchange=()=>{P.status=n.value,ce()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML=e.map(s=>{const l=P.tags.has(s.name);return`<button class="kf-tag-btn" data-tag="${p(s.name)}"
        style="padding:4px 12px;border-radius:20px;border:1.5px solid ${s.color};
               background:${l?s.color:s.color+"18"};
               color:${l?"#fff":s.color};
               font-size:12px;font-weight:600;cursor:pointer;transition:all .15s;">
        ${p(s.name)}
      </button>`}).join(""),a.querySelectorAll(".kf-tag-btn").forEach(s=>{s.addEventListener("click",()=>{const l=s.dataset.tag;P.tags.has(l)?P.tags.delete(l):P.tags.add(l),Ge(e),ce()})})}const o=document.getElementById("kf-search");o&&(o.value=P.search,o.oninput=()=>{P.search=o.value.toLowerCase(),ce()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{P={search:"",tags:new Set,status:""},Ge(e),ce()})}async function dt(){const e=R(),[{data:t},{data:n},{data:a}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",e).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);ae=t||[],ht=a||[],Xe={},(n||[]).forEach(l=>{Xe[l.name]=l});const o=ae.map(l=>l.id),{data:i}=o.length?await y.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};Qe=i||[],Ge(n||[]);const s=document.getElementById("funil-pipe-sel");if(s){const l=Z;s.innerHTML=ae.length?ae.map(r=>`<option value="${r.id}">${p(r.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const d=ae.find(r=>r.id===l)||ae.find(r=>r.is_default)||ae[0];d?(s.value=d.id,Z=d.id):Z=null}await ze()}async function ze(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id)),Z&&(t=t.eq("pipeline_id",Z));const{data:n}=await t;Me=n||[],ce()}function ce(){const e=document.getElementById("kanban-board");if(!e)return;const t=Qe.filter(i=>i.pipeline_id===Z);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=P,a=Me.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const s=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>s.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,d,r,c;const s=i.stage||((l=t[0])==null?void 0:l.name);o[s]||(o[((d=t[0])==null?void 0:d.name)||""]=[]),(c=o[s]||o[(r=t[0])==null?void 0:r.name])==null||c.push(i)}),e.innerHTML=t.map(i=>{const s=o[i.name]||[],l=s.length?s.map(d=>{const r=(d.phone||"").replace(/\D/g,""),c=encodeURIComponent(`Olá ${d.name}! Aqui é da ${F("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
        <div class="kanban-card" draggable="true" data-id="${d.id}" data-stage="${p(i.name)}" style="cursor:pointer;">
          ...
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(d.tags)?d.tags.map(m=>{const f=Xe[m],u=(f==null?void 0:f.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${u}18;color:${u};border:1px solid ${u}44;">${p(m)}</span>`}).join(""):""}
          </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      ${s?(()=>{const m=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${F("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${s}?text=${m}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>{l.style.transform="translateX(0)"});const d=()=>{l.style.transform="translateX(100%)",setTimeout(()=>l.remove(),250)};document.getElementById("ldp-close").addEventListener("click",d),document.getElementById("ldp-save").addEventListener("click",async()=>{var g,w;const m=document.getElementById("ldp-save"),f=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){f.style.color="#ef4444",f.textContent="Nome é obrigatório.";return}m.disabled=!0,m.textContent="Salvando…";const b=[...l.querySelectorAll("input[type=checkbox]:checked")].map($=>$.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((g=document.getElementById("ldp-stage"))==null?void 0:g.value)||null,status:((w=document.getElementById("ldp-status"))==null?void 0:w.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:b,tenant_id:R()};let E;if(t?{error:E}=await y.from("leads").insert(h):{error:E}=await y.from("leads").update(h).eq("id",e.id),m.disabled=!1,m.textContent="💾 Salvar",E){f.style.color="#ef4444",f.textContent="Erro: "+E.message;return}f.style.color="#22c55e",f.textContent="✅ Salvo!",setTimeout(()=>{d(),ze()},700)}),(c=document.getElementById("ldp-delete"))==null||c.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await y.from("leads").delete().eq("id",e.id),d(),ze())})}let N=[],rt=!1,me="pending";async function Qt(){var e;rt||(rt=!0,await Zt(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Et()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),me=t.dataset.filter,fe()})}))}async function Zt(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=y.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=xt(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",s=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,s=a.checked?"done":"pending";await y.from("tasks").update({status:s}).eq("id",i);const l=N.find(d=>String(d.id)===i);l&&(l.status=s),fe()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),N=N.filter(i=>String(i.id)!==String(a.dataset.id)),fe())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,s=N.find(l=>String(l.id)===i);s&&Et(s)})})}function Et(e=null){var d,r,c,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=xt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",s=document.createElement("div");s.id="tarefa-modal-root",s.className="modal-backdrop",s.innerHTML=`
  ...
  `,document.body.appendChild(s);const l=()=>s.remove();(d=document.getElementById("tm-close"))==null||d.addEventListener("click",l),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",l),s.addEventListener("click",f=>{f.target===s&&l()}),(c=document.getElementById("tm-toggle-done"))==null||c.addEventListener("click",async()=>{const f=a?"pending":"done";await y.from("tasks").update({status:f}).eq("id",e.id);const u=N.find(b=>String(b.id)===String(e.id));u&&(u.status=f),l(),f==="done"&&(me="done",document.querySelectorAll(".tarefa-filter-btn").forEach(b=>{b.classList.toggle("active",b.dataset.filter==="done")})),fe()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var g,w;const f=document.getElementById("tarefa-form");if(!f.checkValidity()){f.reportValidity();return}const u=new FormData(f),b=document.getElementById("tm-save");b.disabled=!0,b.textContent="Salvando…";const h={title:(g=u.get("title"))==null?void 0:g.trim(),description:((w=u.get("description"))==null?void 0:w.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null};let E;if(n){if({error:E}=await y.from("tasks").update(h).eq("id",e.id),!E){const $=N.findIndex(k=>String(k.id)===String(e.id));$>=0&&(N[$]={...N[$],...h})}}else{const{data:$,error:k}=await y.from("tasks").insert(h).select();E=k,!E&&($!=null&&$[0])&&N.unshift($[0])}if(b.disabled=!1,b.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}l(),fe()})}async function ea(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;v==null||v.role,v==null||v.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(s=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,f=new Blob([m],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(f),u.download="modelo_contatos.csv",u.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",sa),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",la)))}async function wt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:a}=await t;X=a||[],le()}function le(){var l,d,r;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?X.filter(c=>(c.name||"").toLowerCase().includes(e)||(c.email||"").toLowerCase().includes(e)||(c.phone||"").toLowerCase().includes(e)):X,n=t.length,a=Math.max(1,Math.ceil(n/Ee));z>a&&(z=a);const o=t.slice((z-1)*Ee,z*Ee),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(c=>`
      <tr>
        ...
        <td style="display:flex;gap:6px;align-items:center;">
          ${(()=>{const m=(c.phone||"").replace(/\D/g,"");if(!m)return"";const f=encodeURIComponent(`Olá ${(c.name||"").split(" ")[0]}! Aqui é da ${F("company.name","nossa imobiliária")}. Podemos conversar sobre seu interesse em imóveis?`);return`<a href="https://wa.me/${m}?text=${f}" target="_blank" rel="noopener" title="WhatsApp"
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const s=document.getElementById("contatos-pagination");if(s){const c=n===0?0:(z-1)*Ee+1,m=Math.min(z*Ee,n);s.innerHTML=`
    ...
    `,(d=s.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{z--,le()}),(r=s.querySelector("#pag-next"))==null||r.addEventListener("click",()=>{z++,le()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(c=>{c.addEventListener("click",m=>{m.preventDefault();const f=c.dataset.id,u=X.find(b=>String(b.id)===String(f));u&&It(u)})})}async function It(e=null){var g,w,$,k,S,B;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=R(),[{data:o},{data:i},{data:s}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",a).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],d=i||[],r=s||[],c=l.map(I=>I.id),{data:m}=c.length?await y.from("crm_stages").select("*").in("pipeline_id",c).order("sort_order"):{data:[]},f=m||[],u=(e==null?void 0:e.pipeline_id)||((g=l[0])==null?void 0:g.id)||"";function b(I){const x=f.filter(L=>L.pipeline_id===I);return x.length?'<option value="">— Selecionar etapa —</option>'+x.map(L=>`<option value="${p(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${p(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${l.map(I=>`<option value="${I.id}" ${String(e==null?void 0:e.pipeline_id)===String(I.id)?"selected":""}>${p(I.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
          ...
          <div class="form-row single">
            <div class="form-group">
              ...
              <select name="status" class="form-control">
                <option value="">— Sem status —</option>
                ${r.map(I=>`<option value="${p(I.name)}" ${(e==null?void 0:e.status)===I.name?"selected":""}>${p(I.name)}</option>`).join("")}
              </select>
            </div>
          </div>`:""}
              ...
              <div style="display:flex;flex-wrap:wrap;gap:6px;margin-top:4px;">
                ${d.map(I=>`
                  <label style="display:flex;align-items:center;gap:5px;cursor:pointer;padding:5px 12px;border-radius:20px;background:${I.color}18;border:1.5px solid ${I.color}55;font-size:12px;font-weight:600;color:${I.color};transition:opacity .15s;">
                    <input type="checkbox" name="tag" value="${p(I.name)}" style="margin:0;accent-color:${I.color};" ${((e==null?void 0:e.tags)||[]).includes(I.name)?"checked":""}>
                    ${p(I.name)}
                  </label>`).join("")}
              </div>
            </div>
  ...
  `,document.body.appendChild(h);const E=()=>h.remove();(w=document.getElementById("cm-close"))==null||w.addEventListener("click",E),($=document.getElementById("cm-cancel"))==null||$.addEventListener("click",E),h.addEventListener("click",I=>{I.target===h&&E()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",I=>{const x=document.getElementById("cm-stage");x&&(x.innerHTML=b(I.target.value))}),(S=document.getElementById("cm-delete"))==null||S.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await y.from("leads").delete().eq("id",e.id);const I=X.findIndex(x=>String(x.id)===String(e.id));I>=0&&X.splice(I,1),E(),le()}),(B=document.getElementById("cm-save"))==null||B.addEventListener("click",async()=>{var D,H,U,Y,te,be,he;const I=document.getElementById("contato-form");if(!I.checkValidity()){I.reportValidity();return}const x=new FormData(I),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const T=x.getAll("tag"),C=x.get("pipeline_id")||null,M={name:(D=x.get("name"))==null?void 0:D.trim(),company:((H=x.get("company"))==null?void 0:H.trim())||null,email:((U=x.get("email"))==null?void 0:U.trim())||null,phone:((Y=x.get("phone"))==null?void 0:Y.trim())||null,job_title:((te=x.get("job_title"))==null?void 0:te.trim())||null,city_interest:((be=x.get("city_interest"))==null?void 0:be.trim())||null,notes:((he=x.get("notes"))==null?void 0:he.trim())||null,pipeline_id:C,stage:x.get("stage")||null,status:x.get("status")||null,tags:T,assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await y.from("leads").update(M).eq("id",e.id),!A){const O=X.findIndex(re=>String(re.id)===String(e.id));O>=0&&(X[O]={...X[O],...M})}}else{const{data:O,error:re}=await y.from("leads").insert(M).select();A=re,!A&&(O!=null&&O[0])&&X.unshift(O[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}E(),le()})}let ue=[];function sa(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{ue=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[d,r,c,m,f]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:d,email:r,phone:c,company:m,job_title:f}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${ue.length} contato(s) encontrados para importar.`);const s=document.getElementById("import-modal-confirm");s&&(s.disabled=ue.length===0)},n.readAsText(t)}async function la(){if(!ue.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=ue.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}We(),await wt(),alert(`${t.length} contato(s) importados com sucesso!`)}function da(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),ue=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function We(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ra="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ye(e){return(await fetch(ra,{method:"POST",headers:{Authorization:`Bearer ${Tt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function mt(e){var d,r,c,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),s=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:f}}=await y.auth.getUser();n.value=(f==null?void 0:f.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",f=>{const u=f.target.files[0];if(!u)return;const b=URL.createObjectURL(u);a&&(a.src=b,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var g,w;const f=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",u=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",b=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(b&&(b.style.display="none"),f.length<6){b&&(b.textContent="Mínimo 6 caracteres.",b.style.display="");return}if(f!==u){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:E}=await y.auth.updateUser({password:f});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),E?b&&(b.textContent="Erro: "+E.message,b.style.display=""):(b&&(b.style.color="#16a34a",b.textContent="Senha alterada com sucesso!",b.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),s==null||s.addEventListener("click",async()=>{var w;const f=t.value.trim();let u=(v==null?void 0:v.avatar_url)||"";const b=i==null?void 0:i.files[0],h=s.textContent;if(s.disabled=!0,s.textContent="Salvando…",b)try{const $=await Le(b,400,.85),k=`avatars/${v.id}-${Date.now()}.jpg`,{error:S}=await y.storage.from("imoveis").upload(k,$,{contentType:"image/jpeg",upsert:!0});if(!S){const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(k);u=B}}catch($){console.error("Avatar upload:",$)}const{error:E}=await y.from("profiles").update({name:f,avatar_url:u}).eq("id",v.id);if(s.disabled=!1,s.textContent=h,E){alert("Erro ao salvar perfil.");return}v={...v,name:f,avatar_url:u},qe(v);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=((w=f[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const f=document.getElementById("settings-corretores-section");f&&(f.style.display=""),await Ne(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var w,$;const b=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),h=($=document.getElementById("invite-password"))==null?void 0:$.value.trim(),E=document.getElementById("btn-invite-corretor"),g=document.getElementById("invite-note");if(!b){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),g&&(g.style.display="none");try{const k=await ye({email:b,password:h,tenant_id:(v==null?void 0:v.tenant_id)||null});if(k.success){const S=document.getElementById("invite-email"),B=document.getElementById("invite-password");S&&(S.value=""),B&&(B.value=""),await Ne(),g&&(k.email_sent===!1?(g.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${p(h)}`,g.style.color="#0f172a"):(g.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",g.style.color="#16a34a"),g.style.display="")}else alert("Erro: "+(k.error||"Falha desconhecida"))}catch(k){alert("Erro ao criar acesso: "+k.message)}finally{E&&(E.disabled=!1,E.textContent="+ Criar Acesso")}});const u=document.getElementById("settings-locations-section");u&&(u.style.display=""),await we(),(c=document.getElementById("loc-add-city-btn"))==null||c.addEventListener("click",async()=>{const b=document.getElementById("loc-new-city"),h=b==null?void 0:b.value.trim();if(!h)return;const{error:E}=await y.from("locations").insert({type:"cidade",name:h});if(E){alert("Erro ao adicionar cidade.");return}b&&(b.value=""),await we(),et()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var w;const b=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),h=document.getElementById("loc-new-neighborhood"),E=h==null?void 0:h.value.trim();if(!b||!E){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:g}=await y.from("locations").insert({type:"bairro",name:E,parent_id:b});if(g){alert("Erro ao adicionar bairro.");return}h&&(h.value=""),await we()})}}async function Ne(){const e=document.getElementById("corretores-list");if(!e)return;let t=y.from("profiles").select("*").order("created_at");v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),s=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${p(i)}</div>`,l=o.id===(v==null?void 0:v.id),d=o.active!==!1,r=d?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',c=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
           <option value="corretor"${o.role==="corretor"?" selected":""}>Corretor</option>
           <option value="admin"${o.role==="admin"?" selected":""}>Admin</option>
         </select>`,m=l?"":d?`<button class="corretor-toggle-btn" data-uid="${o.id}" data-active="true">Pausar acesso</button>`:`<button class="corretor-toggle-btn btn-liberar" data-uid="${o.id}" data-active="false">Liberar acesso</button>`,f=l?"":`<button class="corretor-del-btn icon-btn" data-uid="${o.id}" title="Excluir corretor">🗑️</button>`;return`<div class="corretor-item">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${p(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const s=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${s}" e todos os bairros vinculados?`))return;const{error:l}=await y.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await we(),et()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:s}=await y.from("locations").delete().eq("id",i.dataset.id);if(s){alert("Erro ao excluir.");return}await we()})})}function pt(){var n,a,o,i,s,l,d,r,c,m,f,u,b,h,E,g,w,$,k,S;document.querySelectorAll(".filter-btn").forEach(B=>{B.addEventListener("click",()=>{const I=B.closest(".filter-btns"),x=B.classList.contains("active");I.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),x||B.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var T;const B=(T=document.getElementById("f-city"))==null?void 0:T.value,I=de().find(C=>C.name===B),x=I?Ze(I.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+x.map(C=>`<option value="${C.name}">${p(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{ke(Ke(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const B=document.querySelector(".admin-filter-panel");if(B){B.querySelectorAll('input[type="text"], input[type="number"]').forEach(x=>{x.value=""}),B.querySelectorAll("select").forEach(x=>{x.selectedIndex=0});const I=document.getElementById("f-neighborhood");I&&(I.innerHTML='<option value="">Todos</option>'),B.querySelectorAll(".filter-btn.active").forEach(x=>x.classList.remove("active"))}ke(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(B=>{B.addEventListener("click",()=>{se(B.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(B=>{B.addEventListener("click",()=>{se(B.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(B=>{B.addEventListener("click",I=>{I.stopPropagation();const x=B.closest(".topnav-dropdown");x==null||x.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==x&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(B=>B.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",_e),(s=document.getElementById("modal-cancel"))==null||s.addEventListener("click",_e),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",B=>{B.target.id==="property-modal"&&_e()}),(d=document.getElementById("btn-new-property"))==null||d.addEventListener("click",()=>{j=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",oe="",Te([]),Pe("Novo Imóvel")}),(r=document.getElementById("logout-btn"))==null||r.addEventListener("click",async()=>{await y.auth.signOut(),location.reload()}),(c=document.getElementById("view-prev"))==null||c.addEventListener("click",()=>{G=(G-1+Q.length)%Q.length,Ae()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{G=(G+1)%Q.length,Ae()}),(f=document.getElementById("view-modal-close"))==null||f.addEventListener("click",Se),(u=document.getElementById("view-modal-close2"))==null||u.addEventListener("click",Se),(b=document.getElementById("view-modal"))==null||b.addEventListener("click",B=>{B.target.id==="view-modal"&&Se()}),(h=document.getElementById("view-modal-share"))==null||h.addEventListener("click",()=>{const B=document.getElementById("share-panel");if(!B)return;const I=B.style.display!=="none";B.style.display=I?"none":"block"}),(E=document.getElementById("share-whatsapp"))==null||E.addEventListener("click",()=>{var H,U,Y;const B=(H=document.getElementById("share-link-input"))==null?void 0:H.value;if(!B)return;const I=Number((U=document.getElementById("share-panel"))==null?void 0:U.dataset.pid),x=_.find(te=>te.id===I),L=(x==null?void 0:x.title)||((Y=document.getElementById("view-modal-title"))==null?void 0:Y.textContent)||"Imóvel",T=x!=null&&x.price?` — ${ve(x.price,"pt")}`:"",C=x!=null&&x.reference?` | Ref: ${x.reference}`:"",M=[x==null?void 0:x.neighborhood,x==null?void 0:x.city].filter(Boolean).join(", "),A=M?`
📍 ${M}`:"",D=encodeURIComponent(`Olha esse imóvel que encontrei: *${L}*${T}${C}${A}

${B}`);window.open("https://wa.me/?text="+D,"_blank")}),(g=document.getElementById("share-instagram"))==null||g.addEventListener("click",()=>{var I,x;const B=(I=document.getElementById("share-link-input"))==null?void 0:I.value;B&&((x=navigator.clipboard)==null||x.writeText(B),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(w=document.getElementById("share-email"))==null||w.addEventListener("click",()=>{var T,C;const B=(T=document.getElementById("share-link-input"))==null?void 0:T.value;if(!B)return;const I=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",x=encodeURIComponent("Imóvel: "+I),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+B);window.open("mailto:?subject="+x+"&body="+L,"_blank")}),($=document.getElementById("share-copy"))==null||$.addEventListener("click",()=>{var I;const B=document.getElementById("share-link-input");B&&((I=navigator.clipboard)==null||I.writeText(B.value).then(()=>{const x=document.getElementById("share-copy"),L=x.textContent;x.textContent="✅ Copiado!",setTimeout(()=>{x.textContent=L},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var M;if((v==null?void 0:v.role)!=="admin"&&(v==null?void 0:v.role)!=="super_admin")return;const B=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===B);if(!I)return;Se(),j=I.id;const x=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",x.querySelector('[name="title"]').value=I.title||"",x.querySelector('[name="rua"]').value=I.rua||"",x.querySelector('[name="numero"]').value=I.numero||"",x.querySelector('[name="city"]').value=I.city||"",x.querySelector('[name="price"]').value=I.price||"",x.querySelector('[name="bedrooms"]').value=I.bedrooms||"",x.querySelector('[name="suites"]').value=I.suites||"",x.querySelector('[name="parking"]').value=I.parking||"",x.querySelector('[name="description"]').value=I.description||"",x.querySelector('[name="construction_status"]').value=I.construction_status||"",x.querySelector('[name="owner_name"]').value=I.owner_name||"",x.querySelector('[name="owner_phone"]').value=I.owner_phone||"",x.querySelector('[name="owner_email"]').value=I.owner_email||"",x.querySelector('[name="owner_notes"]').value=I.owner_notes||"",x.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),oe=I.cover_image||((M=I.images)==null?void 0:M[0])||"",Te(I.images||[]),Pe("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(B=>{B.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(x=>x.classList.remove("active")),B.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(x=>x.classList.add("hidden")),(I=document.getElementById(`tab-${B.dataset.tab}`))==null||I.classList.remove("hidden")})}),(S=document.getElementById("admin-properties"))==null||S.addEventListener("click",B=>{if(B.target.closest(".action-btns"))return;const I=B.target.closest("tr");if(!I)return;const x=Number(I.dataset.id);if(!x)return;const L=_.find(T=>T.id===x);L&&Gt(L)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;const e=window.location.hostname;if(e&&e!=="localhost"&&e!=="127.0.0.1"){const{data:r}=await y.from("tenants").select("id").eq("domain",e).maybeSingle();r!=null&&r.id&&Re(r.id)}await Promise.all([St(),$t()]),ne=F("company.whatsapp",ne),Ye(),Dt(),Pt();const t=document.getElementById("adminCitySelect"),n=document.getElementById("adminNeighborhood");t&&n&&(et(),t.addEventListener("change",()=>{const r=de().find(m=>m.name===t.value),c=r?Ze(r.id):[];n.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${p(m.name)}</option>`).join("")}));const a=document.getElementById("admin-login"),o=document.getElementById("admin-root");if(a){const r=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=r.get("type")||c.get("type")||"",f=bt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),u=document.getElementById("password-reset-overlay");if(f){a.style.display="none",o&&o.classList.add("hidden"),u&&(u.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async h=>{var S,B;h.preventDefault();const E=((S=document.getElementById("new-password"))==null?void 0:S.value)||"",g=((B=document.getElementById("confirm-password"))==null?void 0:B.value)||"",w=document.getElementById("password-reset-msg"),$=h.target.querySelector('button[type="submit"]');if(w&&(w.style.display="none"),E!==g){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}$&&($.disabled=!0,$.textContent="Salvando…");const{error:k}=await y.auth.updateUser({password:E});if(k){w&&(w.textContent="Erro: "+k.message,w.style.display=""),$&&($.disabled=!1,$.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await y.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:b}}=await y.auth.getSession();if(b){if(a.classList.add("hidden"),o&&o.classList.remove("hidden"),De(),pt(),lt(),window.lucide&&lucide.createIcons(),v=await it(b.user.id),!v){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden");return}if(v.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){a.style.display="none",o&&o.classList.add("hidden");const h=document.getElementById("password-reset-overlay");h&&(h.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async E=>{var B,I;E.preventDefault();const g=((B=document.getElementById("new-password"))==null?void 0:B.value)||"",w=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",$=document.getElementById("password-reset-msg"),k=E.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),g!==w){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}if(g.length<6){$&&($.textContent="Mínimo 6 caracteres.",$.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:S}=await y.auth.updateUser({password:g});if(S){$&&($.textContent="Erro: "+S.message,$.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}Re((v==null?void 0:v.tenant_id)||null),qe(v),st(v.role),await Ce(),await mt(v),window.lucide&&lucide.createIcons(),oa()}else{o&&o.classList.add("hidden"),a.classList.remove("hidden");const h=document.getElementById("login-form");h&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var w,$;const E=($=(w=h.querySelector('input[name="email"]'))==null?void 0:w.value)==null?void 0:$.trim();if(!E){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:g}=await y.auth.resetPasswordForEmail(E,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(g?"Erro: "+g.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),h.addEventListener("submit",async E=>{E.preventDefault();const g=new FormData(h),w=g.get("email"),$=g.get("password");if(await jt(w,$)){a.classList.add("hidden"),o&&o.classList.remove("hidden"),De(),pt(),window.lucide&&lucide.createIcons();const{data:{session:S}}=await y.auth.getSession();if(v=S?await it(S.user.id):null,!v){await y.auth.signOut();return}if(v.active===!1){await y.auth.signOut(),a.classList.remove("hidden"),o&&o.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}lt(),Re((v==null?void 0:v.tenant_id)||null),qe(v),st(v.role),await Ce(),await mt(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else De();await Be();const i=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();_t(i),Ct(ne)});async function ca(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:s}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!s){const l=_.findIndex(d=>d.id===o.id);l>=0&&(_[l].reference=i),n++}}ke(Ke(_))}async function ma(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const s=await pa(i);a.push(s),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(s=>s.id===t.id);i>=0&&(_[i].images=a)}}ke(Ke(_))}}async function pa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,s=i?URL.createObjectURL(i):null;return new Promise(l=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),c=1200;let m=d.width,f=d.height;m>c&&(f=Math.round(f*c/m),m=c),r.width=m,r.height=f;const u=r.getContext("2d");u.drawImage(d,0,0,m,f);const b=h=>{if(h){const E=Math.round(m*.18),g=Math.round(h.naturalHeight*E/h.naturalWidth),w=Math.round(m*.02);u.globalAlpha=.45,u.drawImage(h,m-E-w,f-g-w,E,g),u.globalAlpha=1}r.toBlob(async E=>{try{const g=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await y.storage.from("imoveis").upload(g,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),l(e);return}const{data:{publicUrl:$}}=y.storage.from("imoveis").getPublicUrl(g);l($)}catch(g){console.error("Watermark upload exception:",g),l(e)}},"image/jpeg",.82)};if(s){const h=new Image;h.onload=()=>{URL.revokeObjectURL(s),b(h)},h.onerror=()=>{URL.revokeObjectURL(s),b(null)},h.src=s}else b(null)},d.onerror=()=>{URL.revokeObjectURL(a),l(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function tt(e,t="assets"){const n=await Le(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function ua(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",R()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>p(String(n[o]||""));e.innerHTML=`
  ...
  `,await K())}async function K(){const e=document.getElementById("crm-body");if(!e)return;const t=R(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),y.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",t).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),s=n||[],l=s.find(u=>u.is_default)||s[0],d=s.map(u=>`<option value="${u.id}"${u.id===(l==null?void 0:l.id)?" selected":""}>${p(u.name)}</option>`).join(""),c=(a||[]).filter(u=>u.pipeline_id===(l==null?void 0:l.id)).map(u=>`
  ...
  `,await Je(),document.getElementById("media-file-input").addEventListener("change",async n=>{var d,r;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),s=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const c of a){s.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const m=await tt(c,"media"),f=c.name.replace(/\.[^.]+$/,"").slice(0,60);await y.from("media_library").insert({name:f,url:m,type:"image",size:c.size,created_by:(r=(d=(await y.auth.getUser()).data)==null?void 0:d.user)==null?void 0:r.id})}catch(m){console.error("Media upload error:",m)}l++}i.style.width="100%",s.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await Je(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Je(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await y.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:r})=>{const c=document.getElementById("nt-plan");c&&r&&(c.innerHTML='<option value="">Sem plano</option>'+r.map(m=>`<option value="${m.id}">${p(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const c=document.getElementById("nt-slug");c&&!c.dataset.manual&&(c.value=wa(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(s=document.getElementById("sa-modal-close-btn"))==null||s.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(d=document.getElementById("nt-save"))==null||d.addEventListener("click",async()=>{var S,B,I,x,L,T,C,M,A,D,H,U;const r=(B=(S=document.getElementById("nt-name"))==null?void 0:S.value)==null?void 0:B.trim(),c=(x=(I=document.getElementById("nt-slug"))==null?void 0:I.value)==null?void 0:x.trim(),m=(T=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:T.trim(),f=(C=document.getElementById("nt-plan"))==null?void 0:C.value,u=(A=(M=document.getElementById("nt-admin-email"))==null?void 0:M.value)==null?void 0:A.trim(),b=(H=(D=document.getElementById("nt-admin-password"))==null?void 0:D.value)==null?void 0:H.trim(),h=document.getElementById("nt-msg"),E=document.getElementById("nt-save");if(!r||!c){h.textContent="❌ Nome e slug são obrigatórios.",h.style.color="#ef4444";return}if(!u){h.textContent="❌ Informe o e-mail do admin.",h.style.color="#ef4444";return}if(!b||b.length<6){h.textContent="❌ A senha precisa ter mínimo 6 caracteres.",h.style.color="#ef4444";return}E.disabled=!0,E.textContent="Criando…",h.textContent="⏳ Criando imobiliária…",h.style.color="#64748b";const{data:g,error:w}=await y.from("tenants").insert({name:r,slug:c,domain:m||null,plan_id:f||null,active:!0}).select();if(w){E.disabled=!1,E.textContent="Criar Imobiliária",h.textContent="❌ "+w.message,h.style.color="#ef4444";return}const $=(U=g==null?void 0:g[0])==null?void 0:U.id;h.textContent="⏳ Criando usuário admin…";const k=await ye({email:u,password:b,role:"admin",tenant_id:$});if(!(k!=null&&k.success)){E.disabled=!1,E.textContent="Criar Imobiliária",h.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+p((k==null?void 0:k.error)||"Desconhecido"),h.style.color="#f59e0b",setTimeout(()=>{n(),ee()},3e3);return}$&&(k!=null&&k.user_id)&&!(k!=null&&k.linked)&&await y.from("profiles").update({tenant_id:$}).eq("id",k.user_id),E.disabled=!1,E.textContent="Criar Imobiliária",k.email_sent===!1?(h.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>Bt(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ft(e,o.dataset.tab)})}),ft(e,"properties")}async function ft(e,t){var a,o,i;const n=document.getElementById("tp-content");if(n){if(n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;font-size:14px;">Carregando…</div>',t==="properties"){const{data:s}=await y.from("properties").select("*").eq("tenant_id",e.id).order("created_at",{ascending:!1});if(!(s!=null&&s.length)){n.innerHTML='<div style="text-align:center;padding:64px;color:#94a3b8;"><div style="font-size:48px;margin-bottom:12px;">🏠</div><p style="font-size:14px;">Nenhum imóvel cadastrado ainda.</p></div>';return}n.innerHTML=`
            ...
            <tr style="border-top:1px solid #f1f5f9;">
              <td style="padding:12px 16px;">
                <div style="display:flex;align-items:center;gap:10px;">
                  ...
                  <div><div style="font-weight:600;font-size:13px;color:#0f172a;">${p(l.title||"")}</div><div style="font-size:11px;color:#94a3b8;">${p(l.reference||"")}</div></div>
                </div>
              </td>
              <td style="padding:12px 16px;font-size:13px;color:#475569;">${p([l.neighborhood,l.city].filter(Boolean).join(", "))}</td>
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">R$ ${p(String(l.price||"—"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:500px;">
          ...
          <tbody>${s.map(r=>{const[c,m]=d(r.stage).split(",");return`<tr style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${c};color:${m};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${l(r.stage)}</span></td>
      ...
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          ...
          <a href="${p(l)}" target="_blank" style="display:inline-block;background:#c9a84c;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;">Abrir site demo →</a>
          <p style="font-size:11px;color:#94a3b8;margin:10px 0 0;word-break:break-all;">${p(l)}</p>
        </div>
      ...
      </div>`,(i=document.getElementById("tp-open-edit"))==null||i.addEventListener("click",()=>Bt(e))}}}function Bt(e){var r,c,m,f,u,b,h,E;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([g,w,$])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:g})=>{const w=document.getElementById("et-plan");w&&g&&(w.innerHTML='<option value="">Sem plano</option>'+g.map($=>`<option value="${$.id}"${String($.id)===String(e.plan_id)?" selected":""}>${p($.name)}</option>`).join(""))}),(r=document.getElementById("et-logo-input"))==null||r.addEventListener("change",g=>{const w=g.target.files[0];if(!w)return;const $=URL.createObjectURL(w),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${$}" style="width:100%;height:100%;object-fit:cover;">`)}),(c=document.getElementById("et-logo-preview"))==null||c.addEventListener("click",()=>{var g;(g=document.getElementById("et-logo-input"))==null||g.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const g=document.getElementById("et-admin-password");g.type=g.type==="password"?"text":"password"}),(f=document.getElementById("et-copy-key"))==null||f.addEventListener("click",()=>{var k,S;const g=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!g)return;(S=navigator.clipboard)==null||S.writeText(g);const w=document.getElementById("et-copy-key"),$=w.textContent;w.textContent="✅ Copiada!",setTimeout(()=>{w.textContent=$},2e3)});const o=["dados","config","api"];function i(g){o.forEach(w=>{document.getElementById(`et-pane-${w}`).style.display=w===g?"":"none";const $=document.getElementById(`et-tab-${w}`);$.style.borderBottomColor=w===g?"#2563eb":"transparent",$.style.color=w===g?"#2563eb":"#64748b",$.style.fontWeight=w===g?"600":"500"}),g==="config"&&l()}o.forEach(g=>{var w;return(w=document.getElementById(`et-tab-${g}`))==null?void 0:w.addEventListener("click",()=>i(g))});let s=!1;async function l(){var $;if(s)return;s=!0;const{data:g}=await y.from("settings").select("key,value").eq("tenant_id",e.id),w={};g==null||g.forEach(k=>{w[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${p(w["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${p(w["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${p(w["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${p(w["company.city"]||w["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${p(w["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
    ...
    `,($=document.getElementById("et-cfg-save"))==null||$.addEventListener("click",async()=>{const k=document.getElementById("et-cfg-save"),S=document.getElementById("et-cfg-msg");k.disabled=!0,k.textContent="Salvando…",S.textContent="",S.style.color="#64748b";const B=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),I=document.getElementById("et-cfg-phone").value.trim(),x=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),T=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await y.from("settings").upsert([{key:"company.whatsapp",value:B,tenant_id:e.id},{key:"company.phone",value:I,tenant_id:e.id},{key:"company.email",value:x,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:T,tenant_id:e.id}],{onConflict:"tenant_id,key"});k.disabled=!1,k.textContent="💾 Salvar configurações",C?(S.textContent="❌ "+C.message,S.style.color="#ef4444"):(S.textContent="✅ Configurações salvas!",S.style.color="#22c55e")})}const d=()=>n.remove();(u=document.getElementById("et-close"))==null||u.addEventListener("click",d),(b=document.getElementById("et-cancel"))==null||b.addEventListener("click",d),n.addEventListener("click",g=>{g.target===n&&d()}),(h=document.getElementById("et-delete"))==null||h.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const w=document.getElementById("et-delete");w.disabled=!0,w.textContent="Excluindo…";const{error:$}=await y.from("tenants").delete().eq("id",e.id);if($){alert("Erro ao excluir: "+$.message),w.disabled=!1,w.textContent="🗑️ Excluir";return}d(),ee()}),(E=document.getElementById("et-save"))==null||E.addEventListener("click",async()=>{var M,A,D,H,U,Y,te,be,he,O,re,at;const g=(A=(M=document.getElementById("et-name"))==null?void 0:M.value)==null?void 0:A.trim(),w=(H=(D=document.getElementById("et-slug"))==null?void 0:D.value)==null?void 0:H.trim(),$=(Y=(U=document.getElementById("et-domain"))==null?void 0:U.value)==null?void 0:Y.trim(),k=(te=document.getElementById("et-plan"))==null?void 0:te.value,S=(he=(be=document.getElementById("et-admin-email"))==null?void 0:be.value)==null?void 0:he.trim(),B=(re=(O=document.getElementById("et-admin-password"))==null?void 0:O.value)==null?void 0:re.trim(),I=(at=document.getElementById("et-logo-input"))==null?void 0:at.files[0],x=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!g){x.textContent="❌ Nome é obrigatório.",x.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",x.textContent="⏳ Salvando…",x.style.color="#64748b";let T=e.logo_url;if(I)try{const q=await Le(I,256,.85),nt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:kt}=await y.storage.from("imoveis").upload(nt,q,{contentType:"image/jpeg",upsert:!0});if(!kt){const{data:{publicUrl:Lt}}=y.storage.from("imoveis").getPublicUrl(nt);T=Lt}}catch(q){console.error("Logo upload:",q)}const{error:C}=await y.from("tenants").update({name:g,slug:w||e.slug,domain:$||null,plan_id:k||null,logo_url:T}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",x.textContent="❌ "+C.message,x.style.color="#ef4444";return}if(S&&B&&B.length>=6){x.textContent="⏳ Criando usuário admin…";const q=await ye({email:S,password:B,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),x.textContent="✅ Salvo e admin criado!",x.style.color="#22c55e"):(x.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),x.style.color="#f59e0b")}else x.textContent="✅ Imobiliária atualizada!",x.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{d(),ee()},1200)})}
