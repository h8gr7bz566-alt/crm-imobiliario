import{s as x}from"./supabase-BcuJ3xoD.js";const W="00000000-0000-0000-0000-000000000000";let pe={},Ee={},de=W;function xe(e){de=e||W,pe={},Ee={}}const N=()=>de;async function Ea(){const[e,t]=await Promise.all([x.from("settings").select("key,value").eq("tenant_id",de),x.from("site_content").select("*").eq("tenant_id",de)]);if(e.data&&e.data.forEach(n=>{pe[n.key]=n.value}),t.data&&t.data.forEach(n=>{Ee[n.key]=n}),(!t.data||t.data.length===0)&&de!==W){const[n,a]=await Promise.all([x.from("settings").select("key,value").eq("tenant_id",W),x.from("site_content").select("*").eq("tenant_id",W)]);n.data&&n.data.forEach(o=>{pe[o.key]===void 0&&(pe[o.key]=o.value)}),a.data&&a.data.forEach(o=>{Ee[o.key]||(Ee[o.key]=o)})}}const Y=(e,t=null)=>pe[e]!==void 0?pe[e]:t,Ce=(e,t="pt")=>{const n=Ee[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Ie(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:de,updated_at:t})),{error:a}=await x.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{pe[o]=i}),!a}async function Fe(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:de,updated_at:o},{error:r}=await x.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return r||(Ee[e]=i),de!==W&&await x.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:W,updated_at:o},{onConflict:"key,tenant_id"}),!r}async function et(e,t,n){const{error:a}=await x.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function vt(){const e=document.documentElement,t=Y("visual.accent_color","#b8962e"),n=Y("visual.primary_bg","#0f1c2e"),a=Y("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=Y("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=Y("company.favicon_url","/favicon.ico"),r=document.querySelector('link[rel="shortcut icon"]');r&&(r.href=i);const l=Y("visual.hero_bg_url","");if(l){const d=document.querySelector(".hero, .hero-v2");d&&(d.style.backgroundImage="url('"+l+"')")}}function St(e){e=e||"pt";const t=y=>Ce(y,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),r=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),r&&t("inst.bio_p2")&&(r.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),s=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),E=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat1_num")&&(d.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),s&&t("inst.stat3_num")&&(s.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),E&&t("inst.stat3_label")&&(E.innerHTML=t("inst.stat3_label"));const I=document.getElementById("dep-grid");if(I){const y=Ce("testimonials",e)||Ce("testimonials","pt");if(y)try{const $=JSON.parse(y);if(Array.isArray($)&&$.length>0){let S=function(p){return String(p||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},_=function(p){let v=0;for(const w of p||"?")v=v*31+w.charCodeAt(0)&4294967295;return k[Math.abs(v)%k.length]};const k=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];I.innerHTML=$.map(p=>`
            ...
            </div>`).join("")}}catch{}}const g=Ce("seo.title_pt",e);g&&(document.title=g);const h=Ce("seo.description_pt",e);if(h){const y=document.querySelector('meta[name="description"]');y&&(y.content=h)}}function _t(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const Ia="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let Me="5547999701743";const $a="onknpbzdcrhbfozzvxtz.supabase.co",Lt="/storage/v1/object/public/";function Ne(e){if(!e||typeof e!="string"||!window.__USE_CF_PROXY||!e.includes($a)||!e.includes(Lt))return e;const t=window.location.hostname;if(t!=="omarcorretor.com.br"&&t!=="www.omarcorretor.com.br")return e;try{const n=new URL(e);return"https://omarcorretor.com.br"+n.pathname.replace(Lt,"/img/")+n.search}catch{return e}}(function(){typeof window>"u"||window.location.hostname!=="omarcorretor.com.br"&&window.location.hostname!=="www.omarcorretor.com.br"||fetch("/img/healthz",{method:"HEAD",cache:"no-store"}).then(t=>{(t.headers.get("cf-ray")||t.headers.get("Cf-Ray"))&&(window.__USE_CF_PROXY=!0)}).catch(()=>{})})();function ka(e){return Array.isArray(e)?e.map(Ne):e}const ke=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Sa=5.7;function Oe(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Sa).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let q=[],b=null,De=[];const nt="imobi_lead_tracking",Xt=90*24*60*60*1e3;function We(e){try{const t=document.cookie?document.cookie.split("; "):[];for(const n of t){const a=n.indexOf("=");if(a<0)continue;if(n.slice(0,a)===e)return decodeURIComponent(n.slice(a+1))}return null}catch{return null}}function _a(){if(typeof window>"u")return null;try{const e=new URLSearchParams(window.location.search),t={utm_source:e.get("utm_source"),utm_medium:e.get("utm_medium"),utm_campaign:e.get("utm_campaign"),utm_content:e.get("utm_content"),utm_term:e.get("utm_term"),fbclid:e.get("fbclid"),gclid:e.get("gclid"),fbp:We("_fbp"),fbc:We("_fbc"),landing_url:window.location.href,captured_at:Date.now()};if(t.fbclid&&!t.fbc){const i=Math.floor(Date.now()/1e3);t.fbc=`fb.1.${i}.${t.fbclid}`}const n=t.utm_source||t.utm_campaign||t.fbclid||t.gclid,a=localStorage.getItem(nt);let o=t;if(a)try{const i=JSON.parse(a);i&&i.captured_at&&Date.now()-i.captured_at<Xt&&!n&&(o={...i,fbp:t.fbp||i.fbp,fbc:t.fbc||i.fbc})}catch{}return localStorage.setItem(nt,JSON.stringify(o)),o}catch{return null}}function Bt(){try{const e=localStorage.getItem(nt);if(!e)return{};const t=JSON.parse(e);if(!t||!t.captured_at||Date.now()-t.captured_at>Xt)return{};const n=We("_fbp"),a=We("_fbc");return{utm_source:t.utm_source||null,utm_medium:t.utm_medium||null,utm_campaign:t.utm_campaign||null,utm_content:t.utm_content||null,utm_term:t.utm_term||null,fbclid:t.fbclid||null,gclid:t.gclid||null,fbp:n||t.fbp||null,fbc:a||t.fbc||null,landing_url:t.landing_url||null}}catch{return{}}}typeof window<"u"&&setTimeout(_a,100);let Gt=!1;x.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Gt=!0)});function ot(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Ve(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function Wt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:s,error:m}=await x.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return m&&console.error("Supabase select error:",m),s||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=N();if(!o||o===W){const s=Ve(a);if(s)o=s,xe(o);else{const m=t.replace(/^www\./,"");for(const u of[m,"www."+m]){const{data:E}=await x.from("tenants").select("id").eq("domain",u).maybeSingle();if(E!=null&&E.id){o=E.id,xe(o);break}}o&&o!==W&&ot(a,o,24*60*60*1e3)}}if(!o||o===W)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,r=5*60*1e3;if(!e){const s=Ve(i);if(s)return setTimeout(()=>Wt({background:!0}),100),s}const{data:l,error:d}=await x.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(d)return console.error("Supabase select error:",d),Ve(i)||[];const c=l||[];return ot(i,c,r),e&&typeof ue=="function"&&ue().catch(()=>{}),c}async function Jt(){let e=x.from("properties").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="super_admin"||(b!=null&&b.tenant_id?e=e.eq("tenant_id",b.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(q=t||[],cn(),mn(),q)}async function La(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await x.from("properties").update(a).eq("id",t);if(o)throw o;const i=q.findIndex(r=>r.id===t);i>=0&&(q[i]={...q[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await x.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&q.unshift(t[0])}}async function Ba(e){const{error:t}=await x.from("properties").delete().eq("id",e);if(t)throw t;q=q.filter(n=>n.id!==e)}const Kt="imobi_sec_login_attempts",Yt=5,Ca=15*60*1e3,Qt=2*60*60*1e3;function Zt(){try{const e=localStorage.getItem(Kt);return e?JSON.parse(e):{count:0,blockedUntil:0}}catch{return{count:0,blockedUntil:0}}}function yt(e){try{localStorage.setItem(Kt,JSON.stringify(e))}catch{}}function Ta(){const e=Zt();return e.blockedUntil&&Date.now()<e.blockedUntil?{blocked:!0,minutesLeft:Math.ceil((e.blockedUntil-Date.now())/6e4)}:(e.blockedUntil&&Date.now()>=e.blockedUntil&&yt({count:0,blockedUntil:0}),{blocked:!1})}function qa(){const e=Zt();return e.count=(e.count||0)+1,e.count>=Yt&&(e.blockedUntil=Date.now()+Ca,e.count=0),yt(e),e}function Aa(){yt({count:0,blockedUntil:0})}function Ae(e,t="info"){if(typeof document>"u")return;const n={info:"#0f172a",success:"#16a34a",error:"#dc2626",warn:"#d97706"},a=document.createElement("div");a.textContent=e,a.style.cssText=`position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:${n[t]||n.info};color:#fff;padding:12px 22px;border-radius:24px;font-size:14px;font-weight:600;z-index:99999;box-shadow:0 6px 24px rgba(0,0,0,0.25);opacity:0;transition:opacity 0.2s, bottom 0.3s;pointer-events:none;max-width:90vw;text-align:center;`,document.body.appendChild(a),requestAnimationFrame(()=>{a.style.opacity="1",a.style.bottom="40px"}),setTimeout(()=>{a.style.opacity="0",a.style.bottom="24px",setTimeout(()=>a.remove(),300)},3e3)}typeof window<"u"&&(window.toast=Ae);typeof window<"u"&&!window._shortcutsAttached&&(window._shortcutsAttached=!0,document.addEventListener("keydown",e=>{if(e.key==="Escape"&&(["property-modal","view-modal","lead-modal","tarefa-modal","import-modal","property-modal-create"].forEach(t=>{const n=document.getElementById(t);n&&!n.classList.contains("hidden")&&n.classList.add("hidden")}),document.querySelectorAll('.side-panel.open, [data-panel-open="true"]').forEach(t=>{t.classList.remove("open"),t.dataset.panelOpen="false"}),document.body.style.overflow=""),(e.metaKey||e.ctrlKey)&&e.key==="k"){const t=document.getElementById("global-search")||document.querySelector('input[type="search"]');t&&(e.preventDefault(),t.focus())}if((e.metaKey||e.ctrlKey)&&e.key==="s"){const t=document.querySelector('.modal:not(.hidden) button[type="submit"], .modal:not(.hidden) .btn-primary, .side-panel.open .btn-primary');t&&(e.preventDefault(),t.click())}}));typeof window<"u"&&!window._globalErrHandlerAttached&&(window._globalErrHandlerAttached=!0,window.addEventListener("unhandledrejection",e=>{console.warn("[CRM] Promise sem catch:",e.reason)}),window.addEventListener("error",e=>{e.error&&e.error.message&&console.warn("[CRM] Erro:",e.error.message)}));async function Ma(e,t){const n=Ta();if(n.blocked)return alert(`🔒 Muitas tentativas falhas. Tente novamente em ${n.minutesLeft} minuto(s).`),!1;const{error:a}=await x.auth.signInWithPassword({email:e,password:t});if(a){const o=qa();if(o.blockedUntil)alert("🔒 Login bloqueado por 15 minutos após 5 tentativas erradas.");else{const i=Yt-o.count;console.warn(`[SEC] Login falhou. ${i} tentativa(s) restante(s) antes do bloqueio.`)}return!1}return Aa(),it(),!0}let tt=null;function it(){try{localStorage.setItem("imobi_sec_last_activity",String(Date.now()))}catch{}tt&&clearTimeout(tt),tt=setTimeout(async()=>{console.warn("[SEC] Inativo por 2h — fazendo logout automático.");try{await x.auth.signOut()}catch{}try{localStorage.removeItem("imobi_sec_last_activity")}catch{}alert("🔒 Sua sessão expirou por inatividade. Faça login de novo."),location.reload()},Qt)}function za(){if(!(typeof window>"u")){["click","keydown","mousemove","touchstart","scroll"].forEach(e=>{window.addEventListener(e,()=>it(),{passive:!0})});try{const e=parseInt(localStorage.getItem("imobi_sec_last_activity")||"0",10);if(e&&Date.now()-e>Qt){console.warn("[SEC] Sessão já estava expirada ao carregar — fazendo logout."),x.auth.signOut().finally(()=>location.reload());return}}catch{}it()}}x.auth.onAuthStateChange((e,t)=>{t&&t.user&&za()});function He(e,t=1e3,n=.7){return new Promise((a,o)=>{const i=new Image,r=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(r);const l=document.createElement("canvas");let d=i.width,c=i.height;d>t&&(c=Math.round(c*t/d),d=t),l.width=d,l.height=c;const s=l.getContext("2d");s.drawImage(i,0,0,d,c);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const u=Math.round(d*.18),E=Math.round(m.naturalHeight*u/m.naturalWidth),I=Math.round(d*.02),g=d-u-I,h=c-E-I;s.globalAlpha=.45,s.drawImage(m,g,h,u,E),s.globalAlpha=1,l.toBlob(y=>y?a(y):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{l.toBlob(u=>u?a(u):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=r})}async function Na(e){const t=await He(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await x.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=x.storage.from("imoveis").getPublicUrl(n);return o}async function Da(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Na(n[o]));return a}function ea(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function ta(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const r=a%i;o.dataset.idx=r;try{const d=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(d[r]){const c=o.querySelector(".carousel-img"),s=o.querySelector(".carousel-img-bg"),m=Ne(d[r]);c&&(c.src=m),s&&(s.src=m)}}catch{}const l=o.querySelectorAll(".icard-dot");if(l.length){const d=r%l.length;l.forEach((c,s)=>c.classList.toggle("active",s===d))}})}function Ra(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=d=>e.filter(c=>{if(c.collection){try{const m=JSON.parse(c.collection);if(Array.isArray(m))return m.includes(d)}catch{}if(c.collection===d)return!0}const s=((c.title||"")+" "+(c.description||"")).toLowerCase();return d==="frente-mar"?s.includes("frente mar")||s.includes("frente ao mar"):d==="decorados"?s.includes("decorad")||s.includes("mobiliado"):d==="casas-condominio"?(c.condominium||"").length>2:!1});function a(d,c,s,m){if(!s.length)return"";const u=s.slice(0,8).map(E=>xt(E)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),r=n("casas-condominio"),l=ea(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",r.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",r,"imoveis.html?collection=casas-condominio"):""].join(""),ta(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",bt),t.addEventListener("touchend",function(d){const c=d.target.closest(".carousel-btn");c&&(d.preventDefault(),d.stopPropagation(),aa(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function ue(){var E,I,g,h,y,$;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Wt();q=n,((E=document.getElementById("selecao-carousel"))==null?void 0:E.innerHTML)===""&&ja(n);const a=((I=document.getElementById("city-filter"))==null?void 0:I.value)||"",o=((g=document.getElementById("neighborhood-filter"))==null?void 0:g.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",r=((y=document.getElementById("parking-filter"))==null?void 0:y.value)||"",l=(($=document.getElementById("construction-filter"))==null?void 0:$.value)||"",{min:d,max:c}=Oa(),s=n.filter(k=>{if(a&&k.city!==a||o&&k.neighborhood!==o||i&&(i==="4+"&&Number(k.bedrooms)<4||i!=="4+"&&Number(k.bedrooms)!==Number(i))||r&&(r==="4+"&&Number(k.parking)<4||r!=="4+"&&Number(k.parking)!==Number(r))||l&&k.construction_status!==l)return!1;const S=String(k.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),_=parseInt(S,10)||0;return!(_<d||c!==1/0&&_>c)});if(e){Ra(n);return}if(!s.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=ea(t);t.innerHTML=s.map(k=>xt(k)).join(""),ta(t,m);const u=document.getElementById("properties");u&&!u._carouselDelegated&&(u._carouselDelegated=!0,u.addEventListener("click",bt))}function ja(e){var o,i,r;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>xt(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",bt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(r=a==null?void 0:a.querySelector(".selecao-next"))==null||r.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ue()};function aa(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const r=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(r.length&&r[a]){const l=Ne(r[a]),d=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");d&&(d.src=l),c&&(c.src=l)}}catch{const l=q.find(u=>String(u.id)===String(e.dataset.pid)),d=(i=l==null?void 0:l.images)!=null&&i.length?l.images:ke,c=e.querySelector(".carousel-img"),s=e.querySelector(".carousel-img-bg"),m=d[a]?Ne(d[a]):"";c&&m&&(c.src=m),s&&m&&(s.src=m)}const o=e.querySelectorAll(".icard-dot");if(o.length){const r=a%o.length;o.forEach((l,d)=>l.classList.toggle("active",d===r))}}function bt(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&aa(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Oa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Ha(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>ue())}function Ua(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ye();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ye().find(i=>i.name===e.value),o=a?wt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${f(i.name)}</option>`).join(""),ue()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ue)})}function Re(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var r;const a=n.cover_image||((r=n.images)==null?void 0:r[0])||ke[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
    ...
    </tr>`}).join("")}}function Pa(){const e=document.getElementById("f-city");if(!e)return;const t=ye(),n=e.value;e.innerHTML='<option value="">Todas</option>'+t.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),n&&(e.value=n)}function Fa(){var e,t,n,a,o,i,r,l,d,c,s,m,u,E,I;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((t=document.getElementById("f-title"))==null?void 0:t.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((a=document.getElementById("f-city"))==null?void 0:a.value)||"",neighborhood:((o=document.getElementById("f-neighborhood"))==null?void 0:o.value)||"",condominium:(((i=document.getElementById("f-condominium"))==null?void 0:i.value)||"").trim().toLowerCase(),priceMin:parseFloat((r=document.getElementById("f-price-min"))==null?void 0:r.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((d=document.getElementById("f-area-min"))==null?void 0:d.value)||0,areaMax:parseFloat((c=document.getElementById("f-area-max"))==null?void 0:c.value)||1/0,construction:((s=document.getElementById("f-construction"))==null?void 0:s.value)||"",published:((m=document.getElementById("f-published"))==null?void 0:m.value)||"",bedrooms:((u=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:u.dataset.val)||"",suites:((E=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:E.dataset.val)||"",parking:((I=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:I.dataset.val)||""}}function ht(e){const t=Fa();return Object.values(t).some(a=>a!==""&&a!==0&&a!==1/0)?e.filter(a=>{if(t.ref&&!(a.reference||"").toLowerCase().includes(t.ref)||t.title&&!(a.title||"").toLowerCase().includes(t.title)||t.type&&!(a.title||"").toLowerCase().includes(t.type.toLowerCase())||t.city&&a.city!==t.city||t.neighborhood&&a.neighborhood!==t.neighborhood||t.condominium&&!(a.condominium||"").toLowerCase().includes(t.condominium))return!1;const o=parseInt(String(a.price||"").replace(/[^0-9]/g,""),10)||0;if(t.priceMin>0&&o<t.priceMin||t.priceMax<1/0&&o>t.priceMax)return!1;const i=parseFloat(a.area)||0;return!(t.areaMin>0&&i<t.areaMin||t.areaMax<1/0&&i>t.areaMax||t.construction&&a.construction_status!==t.construction||t.published!==""&&String(a.published)!==t.published||t.bedrooms&&(t.bedrooms==="5+"&&Number(a.bedrooms)<5||t.bedrooms!=="5+"&&Number(a.bedrooms)!==Number(t.bedrooms))||t.suites&&(t.suites==="5+"&&Number(a.suites)<5||t.suites!=="5+"&&Number(a.suites)!==Number(t.suites))||t.parking&&(t.parking==="5+"&&Number(a.parking)<5||t.parking!=="5+"&&Number(a.parking)!==Number(t.parking)))}):e}async function Je(){if(!document.getElementById("admin-properties"))return;const e=await Jt(),t=e.length,n=e.filter(r=>r.published===!0).length,a=document.getElementById("stat-total"),o=document.getElementById("stat-published"),i=document.getElementById("stat-leads");a&&(a.textContent=t),o&&(o.textContent=n),i&&(i.textContent="—"),Pa(),Re(q)}let X=null,te="",ie=[];function st(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden",(!history.state||history.state.modal!=="property")&&history.pushState({modal:"property"},"")}function Xe(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow="",history.state&&history.state.modal==="property"&&history.back()}window._modalPopstateBound||(window._modalPopstateBound=!0,window.addEventListener("popstate",()=>{const e=document.getElementById("property-modal");e&&!e.classList.contains("hidden")&&(e.classList.add("hidden"),document.body.style.overflow="")}));function je(e){const t=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!t||!n)){if(ie=Array.isArray(e)?[...e]:[],!ie.length){t.style.display="none";return}t.style.display="",n.innerHTML=ie.map(a=>`
    ...
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(a=>{a.addEventListener("click",o=>{o.target.closest(".cover-delete")||(te=a.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(i=>i.classList.remove("selected")),a.classList.add("selected"))})}),n.querySelectorAll(".cover-delete").forEach(a=>{a.addEventListener("click",o=>{o.stopPropagation();const i=a.closest(".cover-thumb-wrap"),r=i==null?void 0:i.dataset.url;r&&confirm("Remover esta foto do imóvel?")&&(ie=ie.filter(l=>l!==r),te===r&&(te=ie[0]||""),je(ie))})})}}function at(){const e=document.getElementById("property-form");if(!e)return;const t=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{var d;n.preventDefault();const a=new FormData(e),o=a.getAll("images");let i=[];const r=o.filter(c=>c.size>0);if(X&&(i=[...ie]),r.length){t.disabled=!0,t.textContent=`Enviando 0/${r.length} foto…`;try{const c=await Da(r,(s,m)=>{t.textContent=`Enviando ${s}/${m} foto…`});i=[...i,...c]}catch(c){console.error("Erro no upload:",c),t.disabled=!1,t.textContent=X?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}i.length||(i=[...ke]);const l={...X?{id:X}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),state:a.get("state")||"",neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:i,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:te||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||"",furnishing_status:a.get("furnishing_status")||"",furnished:a.get("furnishing_status")==="mobiliado",collection:JSON.stringify(["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].filter(c=>a.get(c)).map(c=>a.get(c))),tenant_id:X?((d=q.find(c=>c.id===X))==null?void 0:d.tenant_id)??(b==null?void 0:b.tenant_id)??null:(b==null?void 0:b.tenant_id)??null};try{await La(l),X=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const c=document.getElementById("adminPublished");c&&(c.value="true");const s=document.getElementById("adminNeighborhood");s&&(s.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),te="",je([]),Xe(),await Je()}catch(c){console.error(c),t.disabled=!1,t.textContent=X?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao salvar imóvel:
`+((c==null?void 0:c.message)||JSON.stringify(c)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ba(o),await Je()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=q.find(s=>s.id===o);if(!i)return;X=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"";const r=e.querySelector('[name="state"]');r&&(r.value=i.state||""),e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const l=e.querySelector('[name="furnishing_status"]');if(l){const s=i.furnishing_status||(i.furnished===!0?"mobiliado":"vazio");l.value=s}try{const s=JSON.parse(i.collection||"[]");["col_frente_mar","col_decorados","col_casas","col_alto_padrao","col_lancamentos"].forEach(m=>{const u=e.querySelector('[name="'+m+'"]');u&&(u.checked=s.includes(u.value))})}catch{}const d=document.getElementById("adminPublished");d&&(d.value=i.published===!0?"true":"false");const c=document.getElementById("adminCitySelect");c&&(c.value=i.city||"",c.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),te=i.cover_image||((a=i.images)==null?void 0:a[0])||"",je(i.images||[]),st("Editar Imóvel")}})}function f(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function Va(e){return e?String(e).replace(/\s*\([A-Z]{2}\)\s*$/i,"").trim():""}function Xa(e,t,n,a,o){const i=[];e&&i.push(e),n&&i.push(n);const r=Va(a);return r&&i.push(r+(o?" - "+o:"")),i.join(", ")}function xt(e){var g;const t=(g=e.images)!=null&&g.length?e.images:ke,n=ka(t),a=n.length,o=Ne(e.cover_image||n[0]),i=Xa(e.rua,e.numero,e.neighborhood,e.city,e.state),r=Oe(e.price,window.currentLang||"pt"),l=`https://omarcorretor.com.br/property.html?id=${e.id}`,d=encodeURIComponent(`Olá! Tenho interesse no imóvel *${e.title}*${e.reference?` (Ref: ${e.reference})`:""}. Poderia me dar mais informações?
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",s=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",m=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",E=Math.max(1,Math.min(a,6)),I=`<div class="icard-dots">${Array.from({length:E},(h,y)=>`<span class="icard-dot${y===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ...
        <div class="icard-footer">
          ...
          <a href="https://wa.me/${Me}?text=${d}" target="_blank" rel="noopener" class="icard-wa" title="WhatsApp" onclick="fbq('track', 'Contact')">
  ...
  `}let se=[],Z=0;function Ga(e){var m,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||ke[0];document.getElementById("view-thumb-preview").src=i,se=(u=e.images)!=null&&u.length?e.images:ke,Z=0,Ke(),document.getElementById("view-price").textContent=Oe(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const r=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),r&&(r.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(E=>E.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(E=>E.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=d);const s=document.getElementById("share-panel");s&&(s.style.display="none",s.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ue(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ke(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=se[Z],e.alt=`Foto ${Z+1}`;const i=se.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Z+1} / ${se.length}`:"",o.innerHTML=i?se.map((r,l)=>`<img src="${r}" class="view-thumb${l===Z?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(r=>{r.addEventListener("click",()=>{Z=+r.dataset.i,Ke()})})}async function Ct(e){const{data:t}=await x.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ye(e){var m,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",r=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=r),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),d=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),s=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),d&&(d.textContent=r),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",s&&(s.style.display="none")):(s&&(s.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",s.style.display=""),c&&(c.style.display="none"))}async function Tt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||N(),a=n&&n!==W,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:r}=await x.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),d=((r==null?void 0:r.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();d&&d!==l&&(t.href=`https://${d}`)}catch{}}const Pe={dashboard:()=>Ln(),empresa:()=>la(),visual:()=>ca(),"site-config":()=>ma(),"crm-config":()=>pa(),integracoes:()=>ua(),midia:()=>ga(),depoimentos:()=>ra()};function ne(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Pe<"u"&&Pe[e]){const o=Pe[e];Pe[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),ee(),e==="contatos"&&on(),e==="funil"&&Ka(),e==="tarefas"&&Qa()}function qt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:la,visual:ca,"site-config":ma,"crm-config":pa,integracoes:ua,midia:ga,depoimentos:ra}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>un(),{once:!0}),window.lucide&&lucide.createIcons()}}function ee(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Wa(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(r=document.getElementById("ac-cancel"))==null||r.addEventListener("click",o),a.addEventListener("click",d=>{d.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var u,E,I;const d=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(E=document.getElementById("ac-password"))==null?void 0:E.value.trim(),s=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!d){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}s.disabled=!0,s.textContent="Criando…",m.style.display="none";try{const g=e||(b==null?void 0:b.tenant_id)||null,h=((I=document.getElementById("ac-role"))==null?void 0:I.value)||"corretor",y=await ve({email:d,password:c,role:h,tenant_id:g});s.disabled=!1,s.textContent="+ Criar Acesso",y.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",y.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${f(d)}<br><strong>Senha:</strong> ${f(c)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(y.error||"Falha desconhecida"))}catch(g){s.disabled=!1,s.textContent="+ Criar Acesso",alert("Erro: "+g.message)}})}function At(){var i,r,l,d,c,s,m,u,E,I,g;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",h=>{var $;h.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||($=document.getElementById("notif-dropdown"))==null||$.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",h=>{h.stopPropagation(),ee(),Ja()}),(r=document.getElementById("avatar-dd-change-pass"))==null||r.addEventListener("click",h=>{h.stopPropagation(),ee(),Wa()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",h=>{h.stopPropagation(),ee(),dt()}),(d=document.getElementById("avatar-dd-settings"))==null||d.addEventListener("click",h=>{h.stopPropagation(),ee(),ne("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async h=>{h.stopPropagation(),await x.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",h=>{var $;h.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||(($=document.getElementById("avatar-dropdown"))==null||$.classList.add("hidden"),en())}),(s=document.getElementById("notif-mark-all"))==null||s.addEventListener("click",()=>{tn(),ee()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var h,y;(h=document.getElementById("search-overlay"))==null||h.classList.remove("hidden"),(y=document.getElementById("search-input"))==null||y.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var h;(h=document.getElementById("search-overlay"))==null||h.classList.add("hidden")}),(E=document.getElementById("search-overlay"))==null||E.addEventListener("click",h=>{h.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(I=document.getElementById("search-input"))==null||I.addEventListener("input",h=>{clearTimeout(o),o=setTimeout(()=>Za(h.target.value.trim()),280)}),(g=document.getElementById("search-input"))==null||g.addEventListener("keydown",h=>{var y;h.key==="Escape"&&((y=document.getElementById("search-overlay"))==null||y.classList.add("hidden"))}),document.addEventListener("click",ee)}let rt=!1,P=[],Se=[],le=[],ge={},na=[],j=null,Te=null,K={search:"",tags:new Set,status:""};async function Ka(){var t;if(window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||G().catch(()=>{})},3e4),rt){await Mt();return}rt=!0,await Mt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>ct()),xn();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{j=parseInt(e.value,10),await G()})}function lt(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+na.map(r=>`<option value="${f(r.name)}">${f(r.name)}</option>`).join(""),n.value=K.status,n.onchange=()=>{K.status=n.value,me()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(r=>`<button class="kf-tag-btn${K.tags.has(r.name)?" active":""}" data-tag="${f(r.name)}"
          style="--kf-tc:${r.color}">
          ${f(r.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.tag;K.tags.has(l)?K.tags.delete(l):K.tags.add(l),lt(e),me()})})}const o=document.getElementById("kf-search");o&&(o.value=K.search,o.oninput=()=>{K.search=o.value.toLowerCase(),me()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{K={search:"",tags:new Set,status:""},lt(e),me()})}async function Mt(){const e=N(),[{data:t},{data:n},{data:a}]=await Promise.all([x.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),x.from("crm_tags").select("*").eq("tenant_id",e).order("name"),x.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);P=t||[],na=a||[],ge={},(n||[]).forEach(l=>{ge[l.name]=l});const o=P.map(l=>l.id),{data:i}=o.length?await x.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};Se=i||[],lt(n||[]);const r=document.getElementById("funil-pipe-sel");if(r){const l=j;r.innerHTML=P.length?P.map(c=>`<option value="${c.id}">${f(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const d=P.find(c=>c.id===l)||P.find(c=>c.is_default)||P[0];d?(r.value=d.id,j=d.id):j=null}await G()}async function G(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=x.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id)),j&&(t=t.eq("pipeline_id",j));const{data:n}=await t;le=n||[],me()}function me(){const e=document.getElementById("kanban-board");if(!e)return;const t=Se.filter(i=>i.pipeline_id===j);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=K,a=le.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const r=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>r.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,d,c,s;const r=i.stage||((l=t[0])==null?void 0:l.name);o[r]||(o[((d=t[0])==null?void 0:d.name)||""]=[]),(s=o[r]||o[(c=t[0])==null?void 0:c.name])==null||s.push(i)}),e.innerHTML=t.map(i=>{const r=o[i.name]||[],l=r.length?r.map(s=>{const m=(s.phone||"").replace(/\D/g,""),u=encodeURIComponent(`Olá ${s.name}! Aqui é da ${Y("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`),E=s.status==="quente"?"Quente":s.status==="frio"?"Frio":s.status==="morno"?"Morno":"Em andamento";s.interest;const I=Array.isArray(s.tags)?s.tags.length:0;return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          ...
          ${I>0||s.source?`<div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:2px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map(g=>{const h=ge[g],y=(h==null?void 0:h.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${y}18;color:${y};border:1px solid ${y}44;">${f(g)}</span>`}).join(""):""}
          </div>`:""}
  ...
  `;const m=typeof b<"u"&&(b==null?void 0:b.full_name)||"Não atribuído";document.getElementById("rd-lp-responsavel").textContent=m,n.querySelectorAll(".rd-leadpage-tab").forEach(g=>{g.onclick=()=>{var h;n.querySelectorAll(".rd-leadpage-tab").forEach(y=>y.classList.remove("active")),g.classList.add("active"),n.querySelectorAll(".rd-leadpage-tab-panel").forEach(y=>y.classList.remove("active")),(h=n.querySelector(`.rd-leadpage-tab-panel[data-panel="${g.dataset.tab}"]`))==null||h.classList.add("active")}});const u=document.getElementById("rd-lp-timeline"),E=[];t.notes&&E.push({author:m,text:t.notes,date:t.updated_at||t.created_at,kind:"note"}),E.push({author:"Sistema",text:`Lead criado na etapa "${t.stage||"—"}"`,date:t.created_at,kind:"system"}),u.innerHTML=E.map(g=>`
    <div class="rd-leadpage-timeline-item">
      <div class="rd-leadpage-timeline-author">${f(g.author)}</div>
      <div class="rd-leadpage-timeline-text">${f(g.text)}</div>
      <div class="rd-leadpage-timeline-date">${d(g.date)||""}</div>
    </div>
  `).join("")||'<p style="color:#94a3b8;font-size:13px">Sem histórico ainda.</p>',document.getElementById("rd-lp-mark-lost").onclick=async()=>{const g=prompt("Motivo da perda (opcional):")||"",{error:h}=await x.from("leads").update({lost_at:new Date().toISOString(),lost_reason:g}).eq("id",t.id);if(h)return alert("Erro: "+h.message);typeof Ae=="function"?Ae("Lead marcado como perda","warn"):alert("Lead marcado como perda"),window.closeLeadDetailPage(),typeof G=="function"&&G().catch(()=>{})},document.getElementById("rd-lp-mark-won").onclick=async()=>{if(!confirm("Marcar como venda fechada?"))return;const{error:g}=await x.from("leads").update({converted_at:new Date().toISOString()}).eq("id",t.id);if(g)return alert("Erro: "+g.message);typeof Ae=="function"?Ae("🎉 Venda confirmada!","success"):alert("Venda confirmada!"),window.closeLeadDetailPage(),typeof G=="function"&&G().catch(()=>{})},document.getElementById("rd-lp-add-task").onclick=()=>alert("Em breve: criar tarefa direto daqui"),document.getElementById("rd-lp-add-note").onclick=async()=>{const g=prompt("Nova anotação:",t.notes||"");if(g===null)return;const{error:h}=await x.from("leads").update({notes:g}).eq("id",t.id);if(h)return alert("Erro: "+h.message);t.notes=g,window.openLeadDetailPage(t.id)},window.scrollTo({top:0,behavior:"smooth"})};window.closeLeadDetailPage=function(){var t;const e=document.getElementById("section-lead-detail");e&&e.classList.add("hidden"),(t=document.getElementById("section-funil"))==null||t.classList.remove("hidden")};window.closeLeadSidePanel=function(){const e=document.getElementById("rd-lead-sidepanel"),t=document.getElementById("rd-lead-sidepanel-backdrop");e&&(e.classList.remove("open"),setTimeout(()=>e.remove(),250)),t&&(t.style.opacity="0",setTimeout(()=>t.remove(),250))};function Ya(){const e=document.getElementById("kanban-board");e&&(e._kanbanListenersAttached||(e._kanbanListenersAttached=!0,e.querySelectorAll(".kanban-add-btn").forEach(t=>{t.addEventListener("click",()=>ct())}),e.querySelectorAll(".kanban-card").forEach(t=>{t.addEventListener("click",()=>{const n=le.find(a=>String(a.id)===String(t.dataset.id));n&&ct(n)}),t.addEventListener("dragstart",n=>{Te=t.dataset.id,t.classList.add("dragging"),n.dataTransfer.effectAllowed="move"}),t.addEventListener("dragend",()=>t.classList.remove("dragging"))}),e.querySelectorAll(".kanban-cards").forEach(t=>{t.addEventListener("dragover",n=>{n.preventDefault(),t.closest(".kanban-col").classList.add("drag-over")}),t.addEventListener("dragleave",n=>{t.contains(n.relatedTarget)||t.closest(".kanban-col").classList.remove("drag-over")}),t.addEventListener("drop",async n=>{n.preventDefault(),t.closest(".kanban-col").classList.remove("drag-over");const a=t.dataset.stage;if(!Te||!a)return;const o=le.find(l=>String(l.id)===String(Te)),i=o==null?void 0:o.stage;o&&(o.stage=a,me());const{error:r}=await x.from("leads").update({stage:a}).eq("id",Te);r&&(console.warn("[Kanban] falha ao mover lead:",r),o&&(o.stage=i,me()),alert("Erro ao mover lead. Tente de novo.")),Te=null})})))}async function ct(e=null){var I,g,h;(I=document.getElementById("lead-detail-panel"))==null||I.remove();const t=!e,n=N(),{data:a}=await x.from("crm_tags").select("*").eq("tenant_id",n).order("name"),{data:o}=await x.from("crm_lead_statuses").select("*").eq("tenant_id",n).order("sort_order"),i=e!=null&&e.pipeline_id&&((g=P.find(y=>y.id===e.pipeline_id))==null?void 0:g.id)||j;function r(y){return Se.filter($=>$.pipeline_id===y).map($=>`<option value="${f($.name)}" ${(e==null?void 0:e.stage)===$.name?"selected":""}>${f($.name)}</option>`).join("")}const l=P.map(y=>`<option value="${y.id}" ${y.id===i?"selected":""}>${f(y.name)}</option>`).join(""),d=r(i),c=((e==null?void 0:e.phone)||"").replace(/\D/g,""),s=document.createElement("div");s.id="lead-detail-panel",s.style.cssText="position:fixed;top:0;right:0;bottom:0;width:420px;max-width:100vw;background:#fff;box-shadow:-4px 0 32px rgba(0,0,0,.15);z-index:1000;display:flex;flex-direction:column;transform:translateX(100%);transition:transform .25s ease;",s.innerHTML=`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div>
        ...
        <select id="ldp-status" class="form-input">
          ...
          ${o.map(y=>`<option value="${y.name}" ${(e==null?void 0:e.status)===y.name?"selected":""}>${f(y.name)}</option>`).join("")}
        </select>
      </div>`:""}
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(y=>{const k=(ge[y]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(y)}" style="background:${k}18;color:${k};border-color:${k}55;">${f(y)}<span class="ldp-tag-rm" data-tag="${f(y)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}U=n||[],_e()}function oa(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function _e(){const e=document.getElementById("tarefas-list");if(!e)return;let t=U;if(we==="pending"&&(t=U.filter(a=>a.status!=="done")),we==="done"&&(t=U.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${we==="done"?"✅":"📋"}</div>
      <p>${we==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=oa(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",r=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,r=a.checked?"done":"pending";await x.from("tasks").update({status:r}).eq("id",i);const l=U.find(d=>String(d.id)===i);l&&(l.status=r),_e()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await x.from("tasks").delete().eq("id",a.dataset.id),U=U.filter(i=>String(i.id)!==String(a.dataset.id)),_e())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,r=U.find(l=>String(l.id)===i);r&&ia(r)})})}function ia(e=null){var d,c,s,m;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=oa(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",r=document.createElement("div");r.id="tarefa-modal-root",r.className="modal-backdrop",r.innerHTML=`
  ...
  `,document.body.appendChild(r);const l=()=>r.remove();(d=document.getElementById("tm-close"))==null||d.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),r.addEventListener("click",u=>{u.target===r&&l()}),(s=document.getElementById("tm-toggle-done"))==null||s.addEventListener("click",async()=>{const u=a?"pending":"done";await x.from("tasks").update({status:u}).eq("id",e.id);const E=U.find(I=>String(I.id)===String(e.id));E&&(E.status=u),l(),u==="done"&&(we="done",document.querySelectorAll(".tarefa-filter-btn").forEach(I=>{I.classList.toggle("active",I.dataset.filter==="done")})),_e()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var y,$;const u=document.getElementById("tarefa-form");if(!u.checkValidity()){u.reportValidity();return}const E=new FormData(u),I=document.getElementById("tm-save");I.disabled=!0,I.textContent="Salvando…";const g={title:(y=E.get("title"))==null?void 0:y.trim(),description:(($=E.get("description"))==null?void 0:$.trim())||null,due_date:E.get("due_date")||null,priority:E.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null};let h;if(n){if({error:h}=await x.from("tasks").update(g).eq("id",e.id),!h){const k=U.findIndex(S=>String(S.id)===String(e.id));k>=0&&(U[k]={...U[k],...g})}}else{const{data:k,error:S}=await x.from("tasks").insert(g).select();h=S,!h&&(k!=null&&k[0])&&U.unshift(k[0])}if(I.disabled=!1,I.textContent=n?"Salvar":"Criar Tarefa",h){alert("Erro: "+h.message);return}l(),_e()})}async function Za(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;b==null||b.role,b==null||b.tenant_id;const[{data:a},{data:o}]=await Promise.all([x.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),x.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(r=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(r=>{r.addEventListener("click",()=>{var l;(l=document.getElementById("search-overlay"))==null||l.classList.add("hidden"),r.dataset.type==="lead"?ne("contatos"):ne("properties")})})}let ae=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function en(){var r;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=x.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(l=>!ae.includes(String(l.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(l=>{const d=an(l.created_at);return`
      <div class="notif-item${!ae.includes(String(l.id))?" unread":""}" data-id="${l.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${f(l.name||"—")}</div>
          <div class="notif-item-sub">${f(l.phone||l.source||"")} · ${d}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(r=document.getElementById("notif-see-all"))==null||r.addEventListener("click",l=>{l.preventDefault(),ee(),ne("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{ae.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(ae)),l.classList.remove("unread"),ee(),ne("contatos")})})}function tn(){var e;document.querySelectorAll(".notif-item").forEach(t=>ae.push(t.dataset.id)),ae=[...new Set(ae)],localStorage.setItem("crm_notifs_read",JSON.stringify(ae)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function an(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function nn(){let e=x.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);b!=null&&b.tenant_id&&(e=e.eq("tenant_id",b.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!ae.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let Q=[],H=1;const qe=10;let Dt=!1;async function on(){var t,n,a,o,i,r,l,d,c;window._contatosRefreshTimer&&clearInterval(window._contatosRefreshTimer),window._contatosRefreshTimer=setInterval(()=>{const s=document.querySelector('.section[data-section="contatos"]');!s||s.offsetParent===null||mt().catch(()=>{})},3e4),document.getElementById("section-contatos")&&(Dt||(Dt=!0,await mt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{H=1,fe()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",s=>{s.key==="Enter"&&(H=1,fe())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>sa()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",rn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",pt),(r=document.getElementById("import-modal-cancel"))==null||r.addEventListener("click",pt),(l=document.getElementById("download-template"))==null||l.addEventListener("click",s=>{s.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([m],{type:"text/csv"}),E=document.createElement("a");E.href=URL.createObjectURL(u),E.download="modelo_contatos.csv",E.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",sn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",dn)))}async function mt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=x.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;Q=a||[],fe()}function fe(){var l,d,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Q.filter(s=>(s.name||"").toLowerCase().includes(e)||(s.email||"").toLowerCase().includes(e)||(s.phone||"").toLowerCase().includes(e)):Q,n=t.length,a=Math.max(1,Math.ceil(n/qe));H>a&&(H=a);const o=t.slice((H-1)*qe,H*qe),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(s=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const r=document.getElementById("contatos-pagination");if(r){const s=n===0?0:(H-1)*qe+1,m=Math.min(H*qe,n);r.innerHTML=`
    ...
    `,(d=r.querySelector("#pag-prev"))==null||d.addEventListener("click",()=>{H--,fe()}),(c=r.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{H++,fe()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(s=>{s.addEventListener("click",m=>{m.preventDefault();const u=s.dataset.id,E=Q.find(I=>String(I.id)===String(u));E&&sa(E)})})}async function sa(e=null){var y,$,k,S,_,p;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=N(),[{data:o},{data:i},{data:r}]=await Promise.all([x.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),x.from("crm_tags").select("*").eq("tenant_id",a).order("name"),x.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],d=i||[],c=r||[],s=l.map(v=>v.id),{data:m}=s.length?await x.from("crm_stages").select("*").in("pipeline_id",s).order("sort_order"):{data:[]},u=m||[],E=(e==null?void 0:e.pipeline_id)||((y=l[0])==null?void 0:y.id)||"";function I(v){const w=u.filter(L=>L.pipeline_id===v);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(L=>`<option value="${f(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${f(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const g=document.createElement("div");g.id="contato-modal-root",g.className="modal-backdrop",g.innerHTML=`
  ...
  `,document.body.appendChild(g);const h=()=>g.remove();($=document.getElementById("cm-close"))==null||$.addEventListener("click",h),(k=document.getElementById("cm-cancel"))==null||k.addEventListener("click",h),g.addEventListener("click",v=>{v.target===g&&h()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",v=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=I(v.target.value))}),(_=document.getElementById("cm-delete"))==null||_.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await x.from("leads").delete().eq("id",e.id);const v=Q.findIndex(w=>String(w.id)===String(e.id));v>=0&&Q.splice(v,1),h(),fe()}),(p=document.getElementById("cm-save"))==null||p.addEventListener("click",async()=>{var M,O,F,oe,ce,Le,Be;const v=document.getElementById("contato-form");if(!v.checkValidity()){v.reportValidity();return}const w=new FormData(v),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const B=w.getAll("tag"),C=w.get("pipeline_id")||null,T={name:(M=w.get("name"))==null?void 0:M.trim(),company:((O=w.get("company"))==null?void 0:O.trim())||null,email:((F=w.get("email"))==null?void 0:F.trim())||null,phone:((oe=w.get("phone"))==null?void 0:oe.trim())||null,job_title:((ce=w.get("job_title"))==null?void 0:ce.trim())||null,city_interest:((Le=w.get("city_interest"))==null?void 0:Le.trim())||null,notes:((Be=w.get("notes"))==null?void 0:Be.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:B,assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await x.from("leads").update(T).eq("id",e.id),!A){const V=Q.findIndex(he=>String(he.id)===String(e.id));V>=0&&(Q[V]={...Q[V],...T})}}else{const{data:V,error:he}=await x.from("leads").insert(T).select();A=he,!A&&(V!=null&&V[0])&&Q.unshift(V[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}h(),fe()})}let $e=[];function sn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{$e=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[d,c,s,m,u]=l.split(",").map(E=>E.trim().replace(/^"|"$/g,""));return{name:d,email:c,phone:s,company:m,job_title:u}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${$e.length} contato(s) encontrados para importar.`);const r=document.getElementById("import-modal-confirm");r&&(r.disabled=$e.length===0)},n.readAsText(t)}async function dn(){if(!$e.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=$e.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(b==null?void 0:b.id)||null,tenant_id:(b==null?void 0:b.tenant_id)||null})),{error:n}=await x.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}pt(),await mt(),alert(`${t.length} contato(s) importados com sucesso!`)}function rn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),$e=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function pt(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ln="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ve(e){return(await fetch(ln,{method:"POST",headers:{Authorization:`Bearer ${Ia}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Rt(e){var d,c,s,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),r=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await x.auth.getUser();n.value=(u==null?void 0:u.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const E=u.target.files[0];if(!E)return;const I=URL.createObjectURL(E);a&&(a.src=I,a.style.display=""),o&&(o.style.display="none")}),(d=document.getElementById("btn-change-password"))==null||d.addEventListener("click",async()=>{var y,$;const u=((y=document.getElementById("change-password-new"))==null?void 0:y.value)||"",E=(($=document.getElementById("change-password-confirm"))==null?void 0:$.value)||"",I=document.getElementById("change-password-msg"),g=document.getElementById("btn-change-password");if(I&&(I.style.display="none"),u.length<12){I&&(I.textContent="Mínimo 6 caracteres.",I.style.display="");return}if(u!==E){I&&(I.textContent="As senhas não coincidem.",I.style.display="");return}g&&(g.disabled=!0,g.textContent="Salvando…");const{error:h}=await x.auth.updateUser({password:u});g&&(g.disabled=!1,g.textContent="Salvar Nova Senha"),h?I&&(I.textContent="Erro: "+h.message,I.style.display=""):(I&&(I.style.color="#16a34a",I.textContent="Senha alterada com sucesso!",I.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),r==null||r.addEventListener("click",async()=>{var $;const u=t.value.trim();let E=(b==null?void 0:b.avatar_url)||"";const I=i==null?void 0:i.files[0],g=r.textContent;if(r.disabled=!0,r.textContent="Salvando…",I)try{const k=await He(I,400,.85),S=`avatars/${b.id}-${Date.now()}.jpg`,{error:_}=await x.storage.from("imoveis").upload(S,k,{contentType:"image/jpeg",upsert:!0});if(!_){const{data:{publicUrl:p}}=x.storage.from("imoveis").getPublicUrl(S);E=p}}catch(k){console.error("Avatar upload:",k)}const{error:h}=await x.from("profiles").update({name:u,avatar_url:E}).eq("id",b.id);if(r.disabled=!1,r.textContent=g,h){alert("Erro ao salvar perfil.");return}b={...b,name:u,avatar_url:E},Ye(b);const y=document.getElementById("settings-avatar-initial");y&&(y.textContent=(($=u[0])==null?void 0:$.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await Qe(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var $,k;const I=($=document.getElementById("invite-email"))==null?void 0:$.value.trim(),g=(k=document.getElementById("invite-password"))==null?void 0:k.value.trim(),h=document.getElementById("btn-invite-corretor"),y=document.getElementById("invite-note");if(!I){alert("Informe o e-mail do corretor.");return}if(!g||g.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}h&&(h.disabled=!0,h.textContent="Criando…"),y&&(y.style.display="none");try{const S=await ve({email:I,password:g,tenant_id:(b==null?void 0:b.tenant_id)||null});if(S.success){const _=document.getElementById("invite-email"),p=document.getElementById("invite-password");_&&(_.value=""),p&&(p.value=""),await Qe(),y&&(S.email_sent===!1?(y.innerHTML=`
                ✅ Acesso criado!
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{var r;(r=o.options[o.selectedIndex])!=null&&r.text,o.disabled=!0;const{error:i}=await x.from("profiles").update({role:o.value}).eq("id",o.dataset.uid);o.disabled=!1,i&&(console.warn("[Profiles] erro ao trocar role:",i),alert("Erro ao salvar: "+i.message))})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,r=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const l=await ve({action:"toggle",userId:i,active:!r});l.success||alert("Erro: "+(l.error||"Falha desconhecida"))}catch(l){alert("Erro: "+l.message)}await Qe()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var l,d;const i=o.dataset.uid,r=((d=(l=o.closest(".corretor-item"))==null?void 0:l.querySelector(".corretor-name"))==null?void 0:d.textContent)||"este corretor";if(confirm(`Excluir "${r}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const c=await ve({action:"delete",userId:i});c.success||alert("Erro ao excluir: "+(c.error||"Falha desconhecida"))}catch(c){alert("Erro: "+c.message)}await Qe()}})})}async function da(){const{data:e,error:t}=await x.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(De=e||[],De)}function ye(){return De.filter(e=>e.type==="cidade")}function wt(e){return De.filter(t=>t.type==="bairro"&&t.parent_id===e)}function Et(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=ye();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${f(a.name)}</option>`).join(""),t&&(e.value=t)}async function ze(){await da();const e=ye(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
          <span class="loc-item-name">${f(i.name)}</span>
          <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const o=De.filter(i=>i.type==="bairro");n.innerHTML=o.length?o.map(i=>{const r=e.find(l=>l.id===i.parent_id);return`
          <div class="loc-item">
            <div>
            ...
            <button class="loc-del-btn" data-id="${i.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(i=>`<option value="${i.id}">${f(i.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${r}" e todos os bairros vinculados?`))return;const{error:l}=await x.from("locations").delete().eq("id",i.dataset.id);if(l){alert("Erro ao excluir.");return}await ze(),Et()})}),n.querySelectorAll(".loc-del-btn").forEach(i=>{i.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:r}=await x.from("locations").delete().eq("id",i.dataset.id);if(r){alert("Erro ao excluir.");return}await ze()})})}function jt(){var n,a,o,i,r,l,d,c,s,m,u,E,I,g,h,y,$,k,S,_;document.querySelectorAll(".filter-btn").forEach(p=>{p.addEventListener("click",()=>{const v=p.closest(".filter-btns"),w=p.classList.contains("active");v.querySelectorAll(".filter-btn").forEach(L=>L.classList.remove("active")),w||p.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var B;const p=(B=document.getElementById("f-city"))==null?void 0:B.value,v=ye().find(C=>C.name===p),w=v?wt(v.id):[],L=document.getElementById("f-neighborhood");L&&(L.innerHTML='<option value="">Todos</option>'+w.map(C=>`<option value="${C.name}">${f(C.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{Re(ht(q))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{const p=document.querySelector(".admin-filter-panel");if(p){p.querySelectorAll('input[type="text"], input[type="number"]').forEach(w=>{w.value=""}),p.querySelectorAll("select").forEach(w=>{w.selectedIndex=0});const v=document.getElementById("f-neighborhood");v&&(v.innerHTML='<option value="">Todos</option>'),p.querySelectorAll(".filter-btn.active").forEach(w=>w.classList.remove("active"))}Re(q)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(p=>{p.addEventListener("click",()=>{ne(p.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(p=>{p.addEventListener("click",()=>{ne(p.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(p=>{p.addEventListener("click",v=>{v.stopPropagation();const w=p.closest(".topnav-dropdown");w==null||w.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(L=>{L!==w&&L.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(p=>p.classList.remove("open"))}),(i=document.getElementById("modal-close"))==null||i.addEventListener("click",Xe),(r=document.getElementById("modal-cancel"))==null||r.addEventListener("click",Xe),(l=document.getElementById("property-modal"))==null||l.addEventListener("click",p=>{p.target.id==="property-modal"&&Xe()}),(d=document.getElementById("btn-new-property"))==null||d.addEventListener("click",()=>{X=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",te="",je([]),st("Novo Imóvel")}),(c=document.getElementById("logout-btn"))==null||c.addEventListener("click",async()=>{await x.auth.signOut(),location.reload()}),(s=document.getElementById("view-prev"))==null||s.addEventListener("click",()=>{Z=(Z-1+se.length)%se.length,Ke()}),(m=document.getElementById("view-next"))==null||m.addEventListener("click",()=>{Z=(Z+1)%se.length,Ke()}),(u=document.getElementById("view-modal-close"))==null||u.addEventListener("click",Ue),(E=document.getElementById("view-modal-close2"))==null||E.addEventListener("click",Ue),(I=document.getElementById("view-modal"))==null||I.addEventListener("click",p=>{p.target.id==="view-modal"&&Ue()}),(g=document.getElementById("view-modal-share"))==null||g.addEventListener("click",()=>{const p=document.getElementById("share-panel");if(!p)return;const v=p.style.display!=="none";p.style.display=v?"none":"block"}),(h=document.getElementById("share-whatsapp"))==null||h.addEventListener("click",()=>{var O,F,oe;const p=(O=document.getElementById("share-link-input"))==null?void 0:O.value;if(!p)return;const v=Number((F=document.getElementById("share-panel"))==null?void 0:F.dataset.pid),w=q.find(ce=>ce.id===v),L=(w==null?void 0:w.title)||((oe=document.getElementById("view-modal-title"))==null?void 0:oe.textContent)||"Imóvel",B=w!=null&&w.price?` — ${Oe(w.price,"pt")}`:"",C=w!=null&&w.reference?` | Ref: ${w.reference}`:"",T=[w==null?void 0:w.neighborhood,w==null?void 0:w.city].filter(Boolean).join(", "),A=T?`
📍 ${T}`:"",M=encodeURIComponent(`Olha esse imóvel que encontrei: *${L}*${B}${C}${A}

${p}`);window.open("https://wa.me/?text="+M,"_blank")}),(y=document.getElementById("share-instagram"))==null||y.addEventListener("click",()=>{var v,w;const p=(v=document.getElementById("share-link-input"))==null?void 0:v.value;p&&((w=navigator.clipboard)==null||w.writeText(p),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),($=document.getElementById("share-email"))==null||$.addEventListener("click",()=>{var B,C;const p=(B=document.getElementById("share-link-input"))==null?void 0:B.value;if(!p)return;const v=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",w=encodeURIComponent("Imóvel: "+v),L=encodeURIComponent(`Olá! Segue o link do imóvel:

`+p);window.open("mailto:?subject="+w+"&body="+L,"_blank")}),(k=document.getElementById("share-copy"))==null||k.addEventListener("click",()=>{var v;const p=document.getElementById("share-link-input");p&&((v=navigator.clipboard)==null||v.writeText(p.value).then(()=>{const w=document.getElementById("share-copy"),L=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=L},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var T;if((b==null?void 0:b.role)!=="admin"&&(b==null?void 0:b.role)!=="super_admin")return;const p=Number(document.getElementById("view-modal-edit").dataset.pid),v=q.find(A=>A.id===p);if(!v)return;Ue(),X=v.id;const w=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=v.title||"",w.querySelector('[name="rua"]').value=v.rua||"",w.querySelector('[name="numero"]').value=v.numero||"",w.querySelector('[name="city"]').value=v.city||"",w.querySelector('[name="price"]').value=v.price||"",w.querySelector('[name="bedrooms"]').value=v.bedrooms||"",w.querySelector('[name="suites"]').value=v.suites||"",w.querySelector('[name="parking"]').value=v.parking||"",w.querySelector('[name="description"]').value=v.description||"",w.querySelector('[name="construction_status"]').value=v.construction_status||"",w.querySelector('[name="owner_name"]').value=v.owner_name||"",w.querySelector('[name="owner_phone"]').value=v.owner_phone||"",w.querySelector('[name="owner_email"]').value=v.owner_email||"",w.querySelector('[name="owner_notes"]').value=v.owner_notes||"",w.querySelector('[name="condominium"]').value=v.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=v.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=v.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=v.neighborhood||"")},50)),te=v.cover_image||((T=v.images)==null?void 0:T[0])||"",je(v.images||[]),st("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(p=>{p.addEventListener("click",()=>{var v;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),p.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(v=document.getElementById(`tab-${p.dataset.tab}`))==null||v.classList.remove("hidden")})}),(_=document.getElementById("admin-properties"))==null||_.addEventListener("click",p=>{if(p.target.closest(".action-btns"))return;const v=p.target.closest("tr");if(!v)return;const w=Number(v.dataset.id);if(!w)return;const L=q.find(B=>B.id===w);L&&Ga(L)})}async function ra(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await x.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",N()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(r){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let d=0;for(const c of r||"?")d=d*31+c.charCodeAt(0)&4294967295;return l[Math.abs(d)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let r=-1;function l(d=-1){r=d;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=d>=0?"Editar Depoimento":"Novo Depoimento";const s=d>=0?n[d]:{};e.querySelector("#dep-stars").value=String(s.stars||5),e.querySelector("#dep-text").value=s.text||"",e.querySelector("#dep-name").value=s.name||"",e.querySelector("#dep-role").value=s.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",r=-1}),e.addEventListener("click",d=>{const c=d.target.closest("[data-edit]"),s=d.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),s){const m=parseInt(s.dataset.del);confirm("Remover este depoimento?")&&(n.splice(m,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const d=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),s=e.querySelector("#dep-text").value.trim(),m=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),E=parseInt(e.querySelector("#dep-stars").value);if(!s||!m){alert("Preencha o depoimento e o nome.");return}d.disabled=!0,d.textContent="Salvando…";const I={stars:E,text:s,name:m,role:u};r>=0?n[r]=I:n.push(I);const g=await i();d.disabled=!1,d.textContent="Salvar",J(c,g),g&&(e.querySelector("#dep-form-wrap").style.display="none",r=-1,o())})}async function i(){const r=JSON.stringify(n);return await Fe("testimonials",{pt:r,en:r,es:r})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,d,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const s=`imobi_tenant_${t}`,m=Ve(s);if(m)xe(m);else{let u=null;for(const E of[t,"www."+t]){const{data:I}=await x.from("tenants").select("id").eq("domain",E).maybeSingle();if(I!=null&&I.id){u=I;break}}u!=null&&u.id&&(xe(u.id),ot(s,u.id,24*60*60*1e3))}}await Promise.all([Ea(),da()]),Me=Y("company.whatsapp",Me),vt(),Ha(),Ua();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(Et(),n.addEventListener("change",()=>{const s=ye().find(u=>u.name===n.value),m=s?wt(s.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+m.map(u=>`<option value="${u.name}">${f(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const s=new URLSearchParams(window.location.hash.replace("#","")),m=new URLSearchParams(window.location.search),u=s.get("type")||m.get("type")||"",E=Gt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||m.has("code"),I=document.getElementById("password-reset-overlay");if(E){o.style.display="none",i&&i.classList.add("hidden"),I&&(I.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async h=>{var p,v;h.preventDefault();const y=((p=document.getElementById("new-password"))==null?void 0:p.value)||"",$=((v=document.getElementById("confirm-password"))==null?void 0:v.value)||"",k=document.getElementById("password-reset-msg"),S=h.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),y!==$){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:_}=await x.auth.updateUser({password:y});if(_){k&&(k.textContent="Erro: "+_.message,k.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}window.location.href=window.location.pathname}),m.has("code")&&await x.auth.exchangeCodeForSession(m.get("code")??"");return}const{data:{session:g}}=await x.auth.getSession();if(g){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),at(),jt(),At(),window.lucide&&lucide.createIcons(),b=await Ct(g.user.id),!b){await x.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(b.active===!1){await x.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(b.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const h=document.getElementById("password-reset-overlay");h&&(h.style.display="flex"),(d=document.getElementById("password-reset-form"))==null||d.addEventListener("submit",async y=>{var v,w;y.preventDefault();const $=((v=document.getElementById("new-password"))==null?void 0:v.value)||"",k=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",S=document.getElementById("password-reset-msg"),_=y.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),$!==k){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}if($.length<12){S&&(S.textContent="Mínimo 6 caracteres.",S.style.display="");return}_&&(_.disabled=!0,_.textContent="Salvando…");const{error:p}=await x.auth.updateUser({password:$});if(p){S&&(S.textContent="Erro: "+p.message,S.style.display=""),_&&(_.disabled=!1,_.textContent="Definir Senha");return}await x.from("profiles").update({needs_password_reset:!1}).eq("id",b.id),window.location.href=window.location.pathname});return}xe((b==null?void 0:b.tenant_id)||null),Ye(b),Tt(b),qt(b.role),await Je(),await Rt(b),window.lucide&&lucide.createIcons(),nn(),ne("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const h=document.getElementById("login-form");h&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var k,S;const y=(S=(k=h.querySelector('input[name="email"]'))==null?void 0:k.value)==null?void 0:S.trim();if(!y){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:$}=await x.auth.resetPasswordForEmail(y,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert($?"Erro: "+$.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),h.addEventListener("submit",async y=>{y.preventDefault();const $=h.querySelector('button[type="submit"]'),k=new FormData(h),S=k.get("email"),_=k.get("password");$&&($.disabled=!0,$.textContent="Entrando…");try{if(await Ma(S,_)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),at(),jt(),window.lucide&&lucide.createIcons();const{data:{session:v}}=await x.auth.getSession();if(b=v?await Ct(v.user.id):null,!b){await x.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(b.active===!1){await x.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}At(),xe((b==null?void 0:b.tenant_id)||null),Ye(b),Tt(b),qt(b.role),await Je(),await Rt(b),window.lucide&&lucide.createIcons(),ne("dashboard")}else alert("E-mail ou senha incorretos")}catch(p){alert("Erro ao fazer login: "+((p==null?void 0:p.message)||String(p)))}finally{$&&($.disabled=!1,$.textContent="Entrar")}}))}}else at();await ue();const r=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();St(r),_t(Me),window._applyDynamicContent=St,window._applyWhatsAppLinks=_t,document.querySelectorAll(".nav-dropdown-btn").forEach(s=>{var u;const m=(u=s.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");m&&s.addEventListener("click",E=>{E.stopPropagation(),m.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(I=>{I!==m&&I.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(s=>s.classList.remove("js-open"))})});async function cn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:r}=await x.from("properties").update({reference:i}).eq("id",o.id);if(!r){const l=q.findIndex(d=>d.id===o.id);l>=0&&(q[l].reference=i),n++}}Re(ht(q))}async function mn(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const r=await pn(i);a.push(r),o=!0}catch{a.push(i)}if(o){await x.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(r=>r.id===t.id);i>=0&&(q[i].images=a)}}Re(ht(q))}}async function pn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,r=i?URL.createObjectURL(i):null;return new Promise(l=>{const d=new Image;d.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),s=1200;let m=d.width,u=d.height;m>s&&(u=Math.round(u*s/m),m=s),c.width=m,c.height=u;const E=c.getContext("2d");E.drawImage(d,0,0,m,u);const I=g=>{if(g){const h=Math.round(m*.18),y=Math.round(g.naturalHeight*h/g.naturalWidth),$=Math.round(m*.02);E.globalAlpha=.45,E.drawImage(g,m-h-$,u-y-$,h,y),E.globalAlpha=1}c.toBlob(async h=>{try{const y=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:$}=await x.storage.from("imoveis").upload(y,h,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if($){console.error("Upload watermark error:",$),l(e);return}const{data:{publicUrl:k}}=x.storage.from("imoveis").getPublicUrl(y);l(k)}catch(y){console.error("Watermark upload exception:",y),l(e)}},"image/jpeg",.82)};if(r){const g=new Image;g.onload=()=>{URL.revokeObjectURL(r),I(g)},g.onerror=()=>{URL.revokeObjectURL(r),I(null)},g.src=r}else I(null)},d.onerror=()=>{URL.revokeObjectURL(a),l(e)},d.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function J(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function It(e,t="assets"){const n=await He(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await x.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=x.storage.from("imoveis").getPublicUrl(a);return i}async function la(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await x.from("settings").select("key,value").eq("tenant_id",N()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>f(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await D())}async function D(){var y,$,k,S,_;const e=document.getElementById("crm-body");if(!e)return;const t=N(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([x.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),x.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),x.from("crm_tags").select("*").eq("tenant_id",t).order("name"),x.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),r=n||[],d=(typeof j<"u"&&j?r.find(p=>p.id===j):null)||r.find(p=>p.is_default)||r[0],c=r.map(p=>`<option value="${p.id}"${p.id===(d==null?void 0:d.id)?" selected":""}>${f(p.name)}</option>`).join(""),s=(a||[]).filter(p=>p.pipeline_id===(d==null?void 0:d.id)).sort((p,v)=>(p.sort_order??0)-(v.sort_order??0)),m=s.map((p,v)=>`
  ...
  `;const E=document.getElementById("crm-pipe-sel");E&&E.addEventListener("change",async()=>{const p=parseInt(E.value,10);if(!isNaN(p))try{j=p}catch{}await D()});const I=d==null?void 0:d.id;(y=document.getElementById("crm-rename-pipeline"))==null||y.addEventListener("click",async()=>{if(!I)return;const p=prompt("Novo nome do funil:",(d==null?void 0:d.name)||"");if(!p||p.trim()===(d==null?void 0:d.name))return;const{error:v}=await x.from("crm_pipelines").update({name:p.trim()}).eq("id",I);if(v){alert("Erro: "+v.message);return}await D()}),($=document.getElementById("crm-set-default-pipeline"))==null||$.addEventListener("click",async()=>{if(I){if(d!=null&&d.is_default){alert("Este funil já é o padrão.");return}try{const p=N();await x.from("crm_pipelines").update({is_default:!1}).eq("tenant_id",p),await x.from("crm_pipelines").update({is_default:!0}).eq("id",I),await D()}catch(p){alert("Erro: "+p.message)}}}),(k=document.getElementById("crm-delete-pipeline"))==null||k.addEventListener("click",async()=>{if(I){if(r.length===1){alert("Não pode excluir o único funil. Crie outro antes.");return}confirm(`Excluir o funil "${d==null?void 0:d.name}" e todas as suas etapas?

Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await x.from("crm_stages").delete().eq("pipeline_id",I),await x.from("crm_pipelines").delete().eq("id",I),j=null,await D())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const p=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,w=parseInt(document.getElementById("crm-pipe-sel").value,10);p&&(await x.from("crm_stages").insert({pipeline_id:w,name:p,color:v,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-stage").value="",await D())}),e.querySelectorAll(".stage-del").forEach(p=>{p.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await x.from("crm_stages").delete().eq("id",p.dataset.id),await D())})}),e.querySelectorAll(".stage-name-input").forEach(p=>{p.addEventListener("blur",async()=>{const v=p.value.trim(),w=p.dataset.orig;if(!v||v===w){p.value=w;return}p.disabled=!0;const{error:L}=await x.from("crm_stages").update({name:v}).eq("id",p.dataset.sid);if(p.disabled=!1,L){console.warn("[Etapas] erro ao renomear:",L),p.value=w,alert("Erro ao renomear: "+L.message);return}p.dataset.orig=v,p.style.background="#dcfce7",setTimeout(()=>{p.style.background=""},800)}),p.addEventListener("keydown",v=>{v.key==="Enter"&&(v.preventDefault(),p.blur()),v.key==="Escape"&&(p.value=p.dataset.orig,p.blur())})}),document.getElementById("crm-stages-list");let g=null;e.querySelectorAll(".stage-draggable").forEach(p=>{p.addEventListener("dragstart",v=>{g=p,p.classList.add("stage-dragging"),v.dataTransfer.effectAllowed="move";try{v.dataTransfer.setData("text/plain",p.dataset.id)}catch{}}),p.addEventListener("dragend",()=>{p.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(v=>v.classList.remove("stage-drop-over"))}),p.addEventListener("dragover",v=>{v.preventDefault(),v.dataTransfer.dropEffect="move",p!==g&&(e.querySelectorAll(".stage-drop-over").forEach(w=>w.classList.remove("stage-drop-over")),p.classList.add("stage-drop-over"))}),p.addEventListener("dragleave",()=>{p.classList.remove("stage-drop-over")}),p.addEventListener("drop",async v=>{if(v.preventDefault(),!g||p===g)return;const w=g.dataset.id,L=p.dataset.id,B=s.findIndex(M=>String(M.id)===String(w)),C=s.findIndex(M=>String(M.id)===String(L));if(B<0||C<0)return;const T=s.splice(B,1)[0];s.splice(C,0,T);const A=s.map((M,O)=>x.from("crm_stages").update({sort_order:O}).eq("id",M.id));g=null,await Promise.all(A).catch(M=>console.warn("[stages] erro reordenar:",M)),await D()})}),e.querySelectorAll(".stage-color-pick").forEach(p=>{p.addEventListener("change",async v=>{await x.from("crm_stages").update({color:v.target.value}).eq("id",p.dataset.sid);const w=p.closest(".stage-item").querySelector(".stage-color-dot");w&&(w.style.background=v.target.value)})});const h=async()=>{const p=document.getElementById("crm-new-tag"),v=document.getElementById("crm-new-tag-color"),w=p==null?void 0:p.value.trim(),L=(v==null?void 0:v.value)||"#6366F1";if(!w){p==null||p.focus();return}await x.from("crm_tags").insert({name:w,color:L,tenant_id:N()}),p&&(p.value=""),await D()};(S=document.getElementById("crm-add-tag"))==null||S.addEventListener("click",h),(_=document.getElementById("crm-new-tag"))==null||_.addEventListener("keydown",p=>{p.key==="Enter"&&h()}),e.querySelectorAll(".tm-del-btn").forEach(p=>{p.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await x.from("crm_tags").delete().eq("id",p.dataset.id),await D())})}),e.querySelectorAll(".tm-name-input").forEach(p=>{const v=p.closest(".tm-row"),w=v==null?void 0:v.querySelector(".tm-save-btn");w&&(w.style.display="none"),p.addEventListener("input",()=>{const L=p.value.trim()!==p.dataset.orig;w&&(w.style.display=L?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(p=>{const v=p.closest(".tm-row"),w=v==null?void 0:v.querySelector(".tm-color-swatch"),L=v==null?void 0:v.querySelector(".tm-save-btn");p.addEventListener("input",B=>{w&&(w.style.background=B.target.value),L&&(L.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(p=>{p.style.display="none",p.addEventListener("click",async()=>{var B,C;const v=p.closest(".tm-row"),w=(B=v.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),L=(C=v.querySelector(".tm-color-input"))==null?void 0:C.value;w&&(p.disabled=!0,p.textContent="✓ Salvando…",await x.from("crm_tags").update({name:w,color:L}).eq("id",p.dataset.id),await D())})}),e.querySelectorAll(".tm-tpl-btn").forEach(p=>{p.addEventListener("click",async()=>{const v=p.dataset.name,w=p.dataset.color;p.disabled=!0,p.innerHTML="✓",await x.from("crm_tags").insert({name:v,color:w,tenant_id:N()}),await D()})}),e.querySelectorAll(".tag-chip-del").forEach(p=>{p.addEventListener("click",async()=>{await x.from("crm_tags").delete().eq("id",p.dataset.id),await D()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const p=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,w=document.getElementById("crm-new-status-final").checked;p&&(await x.from("crm_lead_statuses").insert({name:p,color:v,is_final:w,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-status").value="",await D())}),e.querySelectorAll(".status-del").forEach(p=>{p.addEventListener("click",async()=>{confirm("Remover este status?")&&(await x.from("crm_lead_statuses").delete().eq("id",p.dataset.id),await D())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var w;const p=(w=prompt("Nome do novo funil:"))==null?void 0:w.trim();if(!p)return;const{error:v}=await x.from("crm_pipelines").insert({name:p,sort_order:99,tenant_id:N()});if(v){alert("Erro ao criar funil: "+v.message);return}rt=!1,await D()})}async function ua(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await x.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var d;return f(((d=n[l])==null?void 0:d.value)||"")},o=l=>{var d;return(d=n[l])!=null&&d.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],r=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await ut(),document.getElementById("media-file-input").addEventListener("change",async n=>{var d,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),r=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const s of a){r.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const m=await It(s,"media"),u=s.name.replace(/\.[^.]+$/,"").slice(0,60);await x.from("media_library").insert({name:u,url:m,type:"image",size:s.size,created_by:(c=(d=(await x.auth.getUser()).data)==null?void 0:d.user)==null?void 0:c.id})}catch(m){console.error("Media upload error:",m)}l++}i.style.width="100%",r.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await ut(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function ut(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await x.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `).join(""),e.querySelectorAll(".media-copy-btn").forEach(a=>{a.addEventListener("click",o=>{var i;o.stopPropagation(),(i=navigator.clipboard)==null||i.writeText(a.dataset.url).then(()=>{const r=a.textContent;a.textContent="✓ Copiado!",setTimeout(()=>{a.textContent=r},1500)})})}),e.querySelectorAll(".media-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta imagem da biblioteca?")&&(await x.from("media_library").delete().eq("id",a.dataset.id),await ut())})})}async function un(){var t,n,a,o,i;const e=document.getElementById("section-super-admin");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="cfg-card">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(r=>{r.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(d=>d.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(d=>d.classList.add("hidden")),r.classList.add("active");const l=e.querySelector(`#sa-panel-${r.dataset.tab}`);l&&l.classList.remove("hidden"),r.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&re(),r.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&gn(),r.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ot(),r.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Ht(),r.dataset.tab==="platform"&&Ut()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ot),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",re),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",Ht),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>yn()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",fn),re(),Ut())}async function re(){var l,d;const e=document.getElementById("sa-tenants-list"),t=((d=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:d.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=x.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var s,m;return!t||((s=c.name)==null?void 0:s.toLowerCase().includes(t))||((m=c.slug)==null?void 0:m.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const r=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var s;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async s=>{s.stopPropagation();const m=c.dataset.active==="true";await x.from("tenants").update({active:!m}).eq("id",c.dataset.id),re()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const s=(i||[]).find(m=>String(m.id)===String(c.dataset.id));s&&bn(s)})})}async function gn(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await x.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),x.from("plans").select("id, name").then(({data:c})=>{const s=document.getElementById("nt-plan");s&&c&&(s.innerHTML='<option value="">Sem plano</option>'+c.map(m=>`<option value="${m.id}">${f(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const s=document.getElementById("nt-slug");s&&!s.dataset.manual&&(s.value=vn(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(r=document.getElementById("sa-modal-close-btn"))==null||r.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(d=document.getElementById("nt-save"))==null||d.addEventListener("click",async()=>{var _,p,v,w,L,B,C,T,A,M,O,F;const c=(p=(_=document.getElementById("nt-name"))==null?void 0:_.value)==null?void 0:p.trim(),s=(w=(v=document.getElementById("nt-slug"))==null?void 0:v.value)==null?void 0:w.trim(),m=(B=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:B.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,E=(A=(T=document.getElementById("nt-admin-email"))==null?void 0:T.value)==null?void 0:A.trim(),I=(O=(M=document.getElementById("nt-admin-password"))==null?void 0:M.value)==null?void 0:O.trim(),g=document.getElementById("nt-msg"),h=document.getElementById("nt-save");if(!c||!s){g.textContent="❌ Nome e slug são obrigatórios.",g.style.color="#ef4444";return}if(!E){g.textContent="❌ Informe o e-mail do admin.",g.style.color="#ef4444";return}if(!I||I.length<12){g.textContent="❌ A senha precisa ter mínimo 6 caracteres.",g.style.color="#ef4444";return}h.disabled=!0,h.textContent="Criando…",g.textContent="⏳ Criando imobiliária…",g.style.color="#64748b";const{data:y,error:$}=await x.from("tenants").insert({name:c,slug:s,domain:m||null,plan_id:u||null,active:!0}).select();if($){h.disabled=!1,h.textContent="Criar Imobiliária",g.textContent="❌ "+$.message,g.style.color="#ef4444";return}const k=(F=y==null?void 0:y[0])==null?void 0:F.id;g.textContent="⏳ Criando usuário admin…";const S=await ve({email:E,password:I,role:"admin",tenant_id:k});if(!(S!=null&&S.success)){h.disabled=!1,h.textContent="Criar Imobiliária",g.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+f((S==null?void 0:S.error)||"Desconhecido"),g.style.color="#f59e0b",n(),re().catch(()=>{});return}k&&(S!=null&&S.user_id)&&!(S!=null&&S.linked)&&await x.from("profiles").update({tenant_id:k}).eq("id",S.user_id),h.disabled=!1,h.textContent="Criar Imobiliária",S.email_sent===!1?(g.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>fa(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",gt(e,o.dataset.tab)})}),gt(e,"properties")}function hn(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,d,c,s="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${s.map(m=>{var u;return`
            <tr data-pid="${m.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${f(Oe(m.price,"pt"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${s.map(u=>{const[E,I]=m(u.stage||u.status||"").split(","),g=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${E};color:${I};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${f(u.stage||u.status||"Novo")}</span></td>
              <td style="padding:12px 16px;font-size:12px;color:#94a3b8;">${new Date(u.created_at).toLocaleDateString("pt-BR")}</td>
              <td style="padding:12px 16px;text-align:center;">
                <div style="display:flex;gap:6px;justify-content:center;align-items:center;">
                  ${g?`<a href="https://wa.me/${g}" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;background:#25d366;border-radius:6px;color:#fff;text-decoration:none;flex-shrink:0;" title="WhatsApp" onclick="fbq('track', 'Contact')"><svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.555 4.116 1.527 5.845L.057 23.882l6.199-1.625A11.934 11.934 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.818a9.793 9.793 0 01-4.992-1.368l-.358-.213-3.685.967.983-3.596-.234-.369A9.79 9.79 0 012.182 12C2.182 6.57 6.57 2.182 12 2.182S21.818 6.57 21.818 12 17.43 21.818 12 21.818z"/></svg></a>`:""}
      ...
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#fff;border-radius:12px;padding:24px;box-shadow:0 1px 6px rgba(0,0,0,.07);">
          ...
          <a href="${f(u)}" target="_blank" style="display:inline-block;background:#c9a84c;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-size:13px;font-weight:700;">${g}</a>
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>fa(e))}}function fa(e){var c,s,m,u,E,I,g,h;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),x.from("plans").select("id, name").then(({data:y})=>{const $=document.getElementById("et-plan");$&&y&&($.innerHTML='<option value="">Sem plano</option>'+y.map(k=>`<option value="${k.id}"${String(k.id)===String(e.plan_id)?" selected":""}>${f(k.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",y=>{const $=y.target.files[0];if(!$)return;const k=URL.createObjectURL($),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${k}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var y;(y=document.getElementById("et-logo-input"))==null||y.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const y=document.getElementById("et-admin-password");y.type=y.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var S,_;const y=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!y)return;(_=navigator.clipboard)==null||_.writeText(y);const $=document.getElementById("et-copy-key"),k=$.textContent;$.textContent="✅ Copiada!",setTimeout(()=>{$.textContent=k},2e3)});const o=["dados","config","api"];function i(y){o.forEach($=>{document.getElementById(`et-pane-${$}`).style.display=$===y?"":"none";const k=document.getElementById(`et-tab-${$}`);k.style.borderBottomColor=$===y?"#2563eb":"transparent",k.style.color=$===y?"#2563eb":"#64748b",k.style.fontWeight=$===y?"600":"500"}),y==="config"&&l()}o.forEach(y=>{var $;return($=document.getElementById(`et-tab-${y}`))==null?void 0:$.addEventListener("click",()=>i(y))});let r=!1;async function l(){var k;if(r)return;r=!0;const{data:y}=await x.from("settings").select("key,value").eq("tenant_id",e.id),$={};y==null||y.forEach(S=>{$[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
    ...
    `,(k=document.getElementById("et-cfg-save"))==null||k.addEventListener("click",async()=>{const S=document.getElementById("et-cfg-save"),_=document.getElementById("et-cfg-msg");S.disabled=!0,S.textContent="Salvando…",_.textContent="",_.style.color="#64748b";const p=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),v=document.getElementById("et-cfg-phone").value.trim(),w=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await x.from("settings").upsert([{key:"company.whatsapp",value:p,tenant_id:e.id},{key:"company.phone",value:v,tenant_id:e.id},{key:"company.email",value:w,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});S.disabled=!1,S.textContent="💾 Salvar configurações",C?(_.textContent="❌ "+C.message,_.style.color="#ef4444"):(_.textContent="✅ Configurações salvas!",_.style.color="#22c55e")})}const d=()=>n.remove();(E=document.getElementById("et-close"))==null||E.addEventListener("click",d),(I=document.getElementById("et-cancel"))==null||I.addEventListener("click",d),n.addEventListener("click",y=>{y.target===n&&d()}),(g=document.getElementById("et-delete"))==null||g.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const $=document.getElementById("et-delete");$.disabled=!0,$.textContent="Excluindo…";const{error:k}=await x.from("tenants").delete().eq("id",e.id);if(k){alert("Erro ao excluir: "+k.message),$.disabled=!1,$.textContent="🗑️ Excluir";return}d(),re()}),(h=document.getElementById("et-save"))==null||h.addEventListener("click",async()=>{var T,A,M,O,F,oe,ce,Le,Be,V,he,$t;const y=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),$=(O=(M=document.getElementById("et-slug"))==null?void 0:M.value)==null?void 0:O.trim(),k=(oe=(F=document.getElementById("et-domain"))==null?void 0:F.value)==null?void 0:oe.trim(),S=(ce=document.getElementById("et-plan"))==null?void 0:ce.value,_=(Be=(Le=document.getElementById("et-admin-email"))==null?void 0:Le.value)==null?void 0:Be.trim(),p=(he=(V=document.getElementById("et-admin-password"))==null?void 0:V.value)==null?void 0:he.trim(),v=($t=document.getElementById("et-logo-input"))==null?void 0:$t.files[0],w=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!y){w.textContent="❌ Nome é obrigatório.",w.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",w.textContent="⏳ Salvando…",w.style.color="#64748b";let B=e.logo_url;if(v)try{const z=await He(v,256,.85),kt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:xa}=await x.storage.from("imoveis").upload(kt,z,{contentType:"image/jpeg",upsert:!0});if(!xa){const{data:{publicUrl:wa}}=x.storage.from("imoveis").getPublicUrl(kt);B=wa}}catch(z){console.error("Logo upload:",z)}const{error:C}=await x.from("tenants").update({name:y,slug:$||e.slug,domain:k||null,plan_id:S||null,logo_url:B}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",w.textContent="❌ "+C.message,w.style.color="#ef4444";return}if(_&&p&&p.length>=6){w.textContent="⏳ Criando usuário admin…";const z=await ve({email:_,password:p,role:"admin",tenant_id:e.id});z!=null&&z.success?(z!=null&&z.user_id&&!(z!=null&&z.linked)&&await x.from("profiles").update({tenant_id:e.id}).eq("id",z.user_id),w.textContent="✅ Salvo e admin criado!",w.style.color="#22c55e"):(w.textContent="⚠️ Salvo, mas erro ao criar admin: "+((z==null?void 0:z.error)||"Tente novamente"),w.style.color="#f59e0b")}else w.textContent="✅ Imobiliária atualizada!",w.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{d(),re()},1200)})}const Pt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Ze=[],be=[],Ge={};function xn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",wn)}function wn(){Ze=[],be=[],Ge={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const d=[];let c="",s=!1;for(let m=0;m<l.length;m++){const u=l[m];u==='"'?s&&l[m+1]==='"'?(c+='"',m++):s=!s:u===n&&!s?(d.push(c.trim()),c=""):c+=u}return d.push(c.trim()),d}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),r=a.slice(1).map(o);return{headers:i,rows:r}}async function In(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,r)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=r,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}be=o[0].map(String),Ze=o.slice(1),ya()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function $n(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function ya(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+be.map((a,o)=>`<option value="${o}">${f(a)}</option>`).join("");e.innerHTML=Pt.map(a=>{const o=$n(be,t[a.key]||[]);return Ge[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join("")}function h(){i.classList.remove("hidden"),g(""),r.value="",c.classList.add("hidden"),r.focus()}function y(){i.classList.add("hidden")}o.addEventListener("click",k=>{k.stopPropagation(),i.classList.contains("hidden")?h():y()}),document.addEventListener("mousedown",function k(S){e.contains(S.target)||(y(),document.removeEventListener("mousedown",k))}),i.addEventListener("mousedown",k=>k.stopPropagation()),r.addEventListener("input",()=>g(r.value)),l.addEventListener("click",k=>{const S=k.target.closest(".ldp-tag-opt");if(!S)return;const _=S.dataset.tag,p=E();p.includes(_)?I(p.filter(v=>v!==_)):I([...p,_]),g(r.value)}),a.addEventListener("click",k=>{const S=k.target.closest(".ldp-tag-rm");if(!S)return;const _=S.dataset.tag;I(E().filter(p=>p!==_))}),d.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||s.focus()});async function $(){const k=s.value.trim();if(!k){s.focus();return}const S=m.value||"#6366F1";if(t.some(_=>_.name.toLowerCase()===k.toLowerCase())){s.style.borderColor="#ef4444",setTimeout(()=>{s.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:_,error:p}=await x.from("crm_tags").insert({name:k,color:S,tenant_id:b==null?void 0:b.tenant_id}).select().single();if(p)throw p;const v={id:_.id,name:_.name,color:_.color};t.push(v),n[v.name]=v,typeof ge<"u"&&(ge[v.name]=v),I([...E(),v.name]),g(r.value),s.value="",m.value="#6366F1",c.classList.add("hidden")}catch(_){console.error("Error creating tag:",_),alert("Erro ao criar tag: "+(_.message||_))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",$),s.addEventListener("keydown",k=>{k.key==="Enter"&&$()})}async function Ln(){var h;const e=document.getElementById("section-dashboard");if(!e)return;e.dataset.dbInit==="1"&&(window._dbLeadsChartInstance&&(window.window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null),window._dbOriginChartInstance&&(window.window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)),e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],r=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${r[n.getMonth()]} de ${n.getFullYear()}`,d=((h=b==null?void 0:b.name)==null?void 0:h.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${R(d)}</span> 👋`);const s=document.getElementById("db-subline");s&&(s.textContent=`Aqui está o resumo do seu negócio — ${l}`);let m=[],u=[];try{const[y,$]=await Promise.all([Jt(),Bn()]);m=y||[],u=$||[]}catch(y){console.warn("[Dashboard] Erro ao carregar dados:",y)}Cn(m,u,n);const E=m.filter(y=>y.published).length,I=u.filter(y=>ft(y.created_at)===ft(n.toISOString())).length,g=document.getElementById("db-header-chips");g&&(g.innerHTML=`
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-body">
        <div class="db-tl-title">${R(r.title)}</div>
        ${r.meta?`<div class="db-tl-meta">${R(r.meta)}</div>`:""}
      </div>
      <div class="db-tl-time">${ba(r.time,n)}</div>
    ...
    <div class="db-port-card">
      ...
      <div class="db-port-val">${ha(c.val)}</div>
