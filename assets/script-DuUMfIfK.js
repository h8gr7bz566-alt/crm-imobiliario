import{s as y}from"./supabase-BcuJ3xoD.js";const ve="00000000-0000-0000-0000-000000000000";let Be={},Ue={},he=ve;function ue(e){he=e||ve,Be={},Ue={}}const z=()=>he;async function At(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",he),y.from("site_content").select("*").eq("tenant_id",he)]);e.data&&e.data.forEach(n=>{Be[n.key]=n.value}),t.data&&t.data.forEach(n=>{Ue[n.key]=n})}const F=(e,t=null)=>Be[e]!==void 0?Be[e]:t,Oe=(e,t="pt")=>{const n=Ue[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function ye(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:he,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{Be[o]=i}),!a}async function De(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:he,updated_at:new Date().toISOString()},{error:i}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return i||(Ue[e]=o),!i}async function Pe(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function tt(){const e=document.documentElement,t=F("visual.accent_color","#b8962e"),n=F("visual.primary_bg","#0f1c2e"),a=F("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=F("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=F("company.favicon_url","/favicon.ico"),c=document.querySelector('link[rel="shortcut icon"]');c&&(c.href=i);const l=F("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero");s&&(s.style.backgroundImage=`url('${l}')`)}}function qt(e="pt"){const t=v=>Oe(v,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),c=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),c&&t("inst.bio_p2")&&(c.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n-num="inst.stat2num"]'),p=document.querySelector('[data-i18n="inst.stat1"]'),r=document.querySelector('[data-i18n="inst.stat2"]'),d=document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat2_num")&&(s.innerHTML=t("inst.stat2_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),r&&t("inst.stat2_label")&&(r.innerHTML=t("inst.stat2_label")),d&&t("inst.stat3_label")&&(d.innerHTML=t("inst.stat3_label"));const m=Oe("seo.title_pt",e);m&&document.title&&(document.title=m);const u=Oe("seo.description_pt",e);if(u){const v=document.querySelector('meta[name="description"]');v&&(v.content=u)}}function Mt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const zt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let oe="5547999701743";const te=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Nt=5.7;function se(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Nt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],f=null,Le=[],Et=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Et=!0)});function Xe(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function Te(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function wt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:r,error:d}=await y.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return d&&console.error("Supabase select error:",d),r||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=z();if(!o||o===ve){const r=Te(a);if(r)o=r,ue(o);else{const d=t.replace(/^www\./,"");for(const m of[d,"www."+d]){const{data:u}=await y.from("tenants").select("id").eq("domain",m).maybeSingle();if(u!=null&&u.id){o=u.id,ue(o);break}}o&&o!==ve&&Xe(a,o,24*60*60*1e3)}}if(!o||o===ve)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,c=5*60*1e3;if(!e){const r=Te(i);if(r)return setTimeout(()=>wt({background:!0}),100),r}const{data:l,error:s}=await y.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),Te(i)||[];const p=l||[];return Xe(i,p,c),e&&typeof le=="function"&&le().catch(()=>{}),p}async function jt(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="super_admin"||(f!=null&&f.tenant_id?e=e.eq("tenant_id",f.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],ua(),ga(),_)}async function Rt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(c=>c.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Ht(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Ut(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function _e(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,c=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(c);const l=document.createElement("canvas");let s=i.width,p=i.height;s>t&&(p=Math.round(p*t/s),s=t),l.width=s,l.height=p;const r=l.getContext("2d");r.drawImage(i,0,0,s,p);const d=new Image;d.crossOrigin="anonymous",d.onload=()=>{const m=Math.round(s*.18),u=Math.round(d.naturalHeight*m/d.naturalWidth),v=Math.round(s*.02),h=s-m-v,E=p-u-v;r.globalAlpha=.45,r.drawImage(d,h,E,m,u),r.globalAlpha=1,l.toBlob(x=>x?a(x):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},d.onerror=()=>{l.toBlob(m=>m?a(m):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},d.src="/logo.png"},i.onerror=o,i.src=c})}async function Ot(e){const t=await _e(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function Dt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Ot(n[o]));return a}async function le(){var m,u,v,h,E,x;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await wt();_=n,((m=document.getElementById("selecao-carousel"))==null?void 0:m.innerHTML)===""&&Pt(n);const a=((u=document.getElementById("city-filter"))==null?void 0:u.value)||"",o=((v=document.getElementById("neighborhood-filter"))==null?void 0:v.value)||"",i=((h=document.getElementById("bedrooms-filter"))==null?void 0:h.value)||"",c=((E=document.getElementById("parking-filter"))==null?void 0:E.value)||"",l=((x=document.getElementById("construction-filter"))==null?void 0:x.value)||"",{min:s,max:p}=Xt(),r=n.filter(b=>{if(a&&b.city!==a||o&&b.neighborhood!==o||i&&(i==="4+"&&Number(b.bedrooms)<4||i!=="4+"&&Number(b.bedrooms)!==Number(i))||c&&(c==="4+"&&Number(b.parking)<4||c!=="4+"&&Number(b.parking)!==Number(c))||l&&b.construction_status!==l)return!1;const B=String(b.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),k=parseInt(B,10)||0;return!(k<s||p!==1/0&&k>p)});if(e){if(!r.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=r.map(b=>{var $;const B=b.cover_image||(($=b.images)==null?void 0:$[0])||te[0],k=[b.neighborhood,b.city].filter(Boolean).join(", "),L=encodeURIComponent(`Olá! Tenho interesse no imóvel *${b.title}*${b.reference?` (Ref: ${b.reference})`:""}. Poderia me dar mais informações?`);return`
        <div class="selecao-card">
          <div class="img-wm-wrap"><img src="${B}" alt="${g(b.title)}" class="selecao-card-img"></div>
          <div class="selecao-card-body">
            <div class="selecao-card-title">${g(b.title)}</div>
            <div class="selecao-card-loc">${g(k)}</div>
            <div class="selecao-card-price">${g(se(b.price,window.currentLang||"pt"))}</div>
      ...
      `}).join("");return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=r.map(b=>{var $;const B=($=b.images)!=null&&$.length?b.images:te,k=B.length,L=encodeURIComponent(`Olá! Tenho interesse no imóvel *${b.title}*${b.reference?` (Ref: ${b.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${k}" data-idx="0" data-pid="${b.id}" data-images="${encodeURIComponent(JSON.stringify(B))}">
          <img src="${b.cover_image||B[0]}" alt="${g(b.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${k>1?`
        ...
        <div class="property-info">
          <strong>${g(b.title)}</strong>
          <div class="muted">${g(b.neighborhood||"")}, ${g(b.city||"")}</div>
          <div><strong>${g(se(b.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${b.bedrooms||"--"} | 🚗 ${b.parking||"--"} ${k>1?"| 📸 "+k:""}</div>
          <p class="muted">${g((b.description||"").slice(0,110))}</p>
    ...
    `}).join("");const d=document.getElementById("properties");d&&!d._carouselDelegated&&(d._carouselDelegated=!0,d.addEventListener("click",Ft))}function Pt(e){var o,i,c;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>{var d;const s=l.cover_image||((d=l.images)==null?void 0:d[0])||te[0],p=[l.neighborhood,l.city].filter(Boolean).join(", "),r=encodeURIComponent(`Olá! Tenho interesse no imóvel *${l.title}*${l.reference?` (Ref: ${l.reference})`:""}. Poderia me dar mais informações?`);return`
      <div class="selecao-card">
...
`+((p==null?void 0:p.message)||JSON.stringify(p)))}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Ht(o),await qe()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const o=Number(n.target.dataset.id);if(!o)return;const i=_.find(s=>s.id===o);if(!i)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=i.title||"",e.querySelector('[name="rua"]').value=i.rua||"",e.querySelector('[name="numero"]').value=i.numero||"",e.querySelector('[name="city"]').value=i.city||"",e.querySelector('[name="price"]').value=i.price||"",e.querySelector('[name="bedrooms"]').value=i.bedrooms||"",e.querySelector('[name="suites"]').value=i.suites||"",e.querySelector('[name="area"]').value=i.area||"",e.querySelector('[name="parking"]').value=i.parking||"",e.querySelector('[name="description"]').value=i.description||"",e.querySelector('[name="construction_status"]').value=i.construction_status||"",e.querySelector('[name="owner_name"]').value=i.owner_name||"",e.querySelector('[name="owner_phone"]').value=i.owner_phone||"",e.querySelector('[name="owner_email"]').value=i.owner_email||"",e.querySelector('[name="owner_notes"]').value=i.owner_notes||"",e.querySelector('[name="condominium"]').value=i.condominium||"";const c=document.getElementById("adminPublished");c&&(c.value=i.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=i.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const s=document.getElementById("adminNeighborhood");s&&(s.value=i.neighborhood||"")},50)),ie=i.cover_image||((a=i.images)==null?void 0:a[0])||"",Me(i.images||[]),Ge("Editar Imóvel")}})}function g(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let Q=[],G=0;function Yt(e){var d,m;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((d=e.images)==null?void 0:d[0])||te[0];document.getElementById("view-thumb-preview").src=i,Q=(m=e.images)!=null&&m.length?e.images:te,G=0,ze(),document.getElementById("view-price").textContent=se(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const c=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),c&&(c.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(u=>u.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(u=>u.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,p=document.getElementById("share-link-input");p&&(p.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ce(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function ze(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=Q[G],e.alt=`Foto ${G+1}`;const i=Q.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${G+1} / ${Q.length}`:"",o.innerHTML=i?Q.map((c,l)=>`<img src="${c}" class="view-thumb${l===G?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(c=>{c.addEventListener("click",()=>{G=+c.dataset.i,ze()})})}async function rt(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ne(e){var d,m;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",c=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=c),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((d=i[0])==null?void 0:d.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),p=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=c),e!=null&&e.avatar_url&&p?(p.src=e.avatar_url,p.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",r.style.display=""),p&&(p.style.display="none"))}async function ct(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||z(),a=n&&n!==ve,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:c}=await y.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((c==null?void 0:c.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}function de(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),W(),e==="contatos"&&da(),e==="funil"&&Zt(),e==="tarefas"&&ta()}function mt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:va,visual:ya,"site-config":ba,"crm-config":ha,integracoes:xa,midia:Ea}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>wa(),{once:!0}),window.lucide&&lucide.createIcons()}}function W(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Kt(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(l),requestAnimationFrame(()=>{l.style.transform="translateX(0)"});const s=()=>{l.style.transform="translateX(100%)",setTimeout(()=>l.remove(),250)};document.getElementById("ldp-close").addEventListener("click",s),document.getElementById("ldp-save").addEventListener("click",async()=>{var x,b;const d=document.getElementById("ldp-save"),m=document.getElementById("ldp-msg"),u=document.getElementById("ldp-name").value.trim();if(!u){m.style.color="#ef4444",m.textContent="Nome é obrigatório.";return}d.disabled=!0,d.textContent="Salvando…";const v=[...l.querySelectorAll("input[type=checkbox]:checked")].map(B=>B.value),h={name:u,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((x=document.getElementById("ldp-stage"))==null?void 0:x.value)||null,status:((b=document.getElementById("ldp-status"))==null?void 0:b.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:v,tenant_id:z()};let E;if(t?{error:E}=await y.from("leads").insert(h):{error:E}=await y.from("leads").update(h).eq("id",e.id),d.disabled=!1,d.textContent="💾 Salvar",E){m.style.color="#ef4444",m.textContent="Erro: "+E.message;return}m.style.color="#22c55e",m.textContent="✅ Salvo!",setTimeout(()=>{s(),Re()},700)}),(r=document.getElementById("ldp-delete"))==null||r.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await y.from("leads").delete().eq("id",e.id),s(),Re())})}let j=[],gt=!1,fe="pending";async function ta(){var e;gt||(gt=!0,await aa(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>kt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),fe=t.dataset.filter,xe()})}))}async function aa(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=y.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=$t(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",c=o&&a.status!=="done"&&o<n;return`
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const i=a.dataset.id,c=a.checked?"done":"pending";await y.from("tasks").update({status:c}).eq("id",i);const l=j.find(s=>String(s.id)===i);l&&(l.status=c),xe()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),j=j.filter(i=>String(i.id)!==String(a.dataset.id)),xe())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const i=a.dataset.id,c=j.find(l=>String(l.id)===i);c&&kt(c)})})}function kt(e=null){var s,p,r,d;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=$t(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const i=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",c=document.createElement("div");c.id="tarefa-modal-root",c.className="modal-backdrop",c.innerHTML=`
  ...
  `,document.body.appendChild(c);const l=()=>c.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(p=document.getElementById("tm-cancel"))==null||p.addEventListener("click",l),c.addEventListener("click",m=>{m.target===c&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const m=a?"pending":"done";await y.from("tasks").update({status:m}).eq("id",e.id);const u=j.find(v=>String(v.id)===String(e.id));u&&(u.status=m),l(),m==="done"&&(fe="done",document.querySelectorAll(".tarefa-filter-btn").forEach(v=>{v.classList.toggle("active",v.dataset.filter==="done")})),xe()}),(d=document.getElementById("tm-save"))==null||d.addEventListener("click",async()=>{var x,b;const m=document.getElementById("tarefa-form");if(!m.checkValidity()){m.reportValidity();return}const u=new FormData(m),v=document.getElementById("tm-save");v.disabled=!0,v.textContent="Salvando…";const h={title:(x=u.get("title"))==null?void 0:x.trim(),description:((b=u.get("description"))==null?void 0:b.trim())||null,due_date:u.get("due_date")||null,priority:u.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null};let E;if(n){if({error:E}=await y.from("tasks").update(h).eq("id",e.id),!E){const B=j.findIndex(k=>String(k.id)===String(e.id));B>=0&&(j[B]={...j[B],...h})}}else{const{data:B,error:k}=await y.from("tasks").insert(h).select();E=k,!E&&(B!=null&&B[0])&&j.unshift(B[0])}if(v.disabled=!1,v.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}l(),xe()})}async function na(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;f==null||f.role,f==null||f.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(c=>`
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,m=new Blob([d],{type:"text/csv"}),u=document.createElement("a");u.href=URL.createObjectURL(m),u.download="modelo_contatos.csv",u.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",ra),(p=document.getElementById("import-modal-confirm"))==null||p.addEventListener("click",ca)))}async function Bt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(f==null?void 0:f.role)==="corretor"?t=t.eq("assigned_to",f.id):f!=null&&f.tenant_id&&(t=t.eq("tenant_id",f.tenant_id));const{data:a}=await t;X=a||[],re()}function re(){var l,s,p;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?X.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):X,n=t.length,a=Math.max(1,Math.ceil(n/$e));N>a&&(N=a);const o=t.slice((N-1)*$e,N*$e),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
    ...
    `,(s=c.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{N--,re()}),(p=c.querySelector("#pag-next"))==null||p.addEventListener("click",()=>{N++,re()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",d=>{d.preventDefault();const m=r.dataset.id,u=X.find(v=>String(v.id)===String(m));u&&Lt(u)})})}async function Lt(e=null){var x,b,B,k,L,$;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=z(),[{data:o},{data:i},{data:c}]=await Promise.all([y.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),y.from("crm_tags").select("*").eq("tenant_id",a).order("name"),y.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],p=c||[],r=l.map(I=>I.id),{data:d}=r.length?await y.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},m=d||[],u=(e==null?void 0:e.pipeline_id)||((x=l[0])==null?void 0:x.id)||"";function v(I){const w=m.filter(S=>S.pipeline_id===I);return w.length?'<option value="">— Selecionar etapa —</option>'+w.map(S=>`<option value="${g(S.name)}" ${(e==null?void 0:e.stage)===S.name?"selected":""}>${g(S.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const h=document.createElement("div");h.id="contato-modal-root",h.className="modal-backdrop",h.innerHTML=`
  ...
  `,document.body.appendChild(h);const E=()=>h.remove();(b=document.getElementById("cm-close"))==null||b.addEventListener("click",E),(B=document.getElementById("cm-cancel"))==null||B.addEventListener("click",E),h.addEventListener("click",I=>{I.target===h&&E()}),(k=document.getElementById("cm-pipe"))==null||k.addEventListener("change",I=>{const w=document.getElementById("cm-stage");w&&(w.innerHTML=v(I.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await y.from("leads").delete().eq("id",e.id);const I=X.findIndex(w=>String(w.id)===String(e.id));I>=0&&X.splice(I,1),E(),re()}),($=document.getElementById("cm-save"))==null||$.addEventListener("click",async()=>{var D,H,U,Y,ae,Ee,we;const I=document.getElementById("contato-form");if(!I.checkValidity()){I.reportValidity();return}const w=new FormData(I),S=document.getElementById("cm-save");S.disabled=!0,S.textContent="Salvando…";const T=w.getAll("tag"),C=w.get("pipeline_id")||null,M={name:(D=w.get("name"))==null?void 0:D.trim(),company:((H=w.get("company"))==null?void 0:H.trim())||null,email:((U=w.get("email"))==null?void 0:U.trim())||null,phone:((Y=w.get("phone"))==null?void 0:Y.trim())||null,job_title:((ae=w.get("job_title"))==null?void 0:ae.trim())||null,city_interest:((Ee=w.get("city_interest"))==null?void 0:Ee.trim())||null,notes:((we=w.get("notes"))==null?void 0:we.trim())||null,pipeline_id:C,stage:w.get("stage")||null,status:w.get("status")||null,tags:T,assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await y.from("leads").update(M).eq("id",e.id),!A){const O=X.findIndex(pe=>String(pe.id)===String(e.id));O>=0&&(X[O]={...X[O],...M})}}else{const{data:O,error:pe}=await y.from("leads").insert(M).select();A=pe,!A&&(O!=null&&O[0])&&X.unshift(O[0])}if(S.disabled=!1,S.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}E(),re()})}let be=[];function ra(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{be=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,p,r,d,m]=l.split(",").map(u=>u.trim().replace(/^"|"$/g,""));return{name:s,email:p,phone:r,company:d,job_title:m}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${be.length} contato(s) encontrados para importar.`);const c=document.getElementById("import-modal-confirm");c&&(c.disabled=be.length===0)},n.readAsText(t)}async function ca(){if(!be.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=be.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(f==null?void 0:f.id)||null,tenant_id:(f==null?void 0:f.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Qe(),await Bt(),alert(`${t.length} contato(s) importados com sucesso!`)}function ma(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),be=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Qe(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const pa="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ce(e){return(await fetch(pa,{method:"POST",headers:{Authorization:`Bearer ${zt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function vt(e){var s,p,r,d;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),c=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:m}}=await y.auth.getUser();n.value=(m==null?void 0:m.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const v=URL.createObjectURL(u);a&&(a.src=v,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var x,b;const m=((x=document.getElementById("change-password-new"))==null?void 0:x.value)||"",u=((b=document.getElementById("change-password-confirm"))==null?void 0:b.value)||"",v=document.getElementById("change-password-msg"),h=document.getElementById("btn-change-password");if(v&&(v.style.display="none"),m.length<6){v&&(v.textContent="Mínimo 6 caracteres.",v.style.display="");return}if(m!==u){v&&(v.textContent="As senhas não coincidem.",v.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:E}=await y.auth.updateUser({password:m});h&&(h.disabled=!1,h.textContent="Salvar Nova Senha"),E?v&&(v.textContent="Erro: "+E.message,v.style.display=""):(v&&(v.style.color="#16a34a",v.textContent="Senha alterada com sucesso!",v.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),c==null||c.addEventListener("click",async()=>{var b;const m=t.value.trim();let u=(f==null?void 0:f.avatar_url)||"";const v=i==null?void 0:i.files[0],h=c.textContent;if(c.disabled=!0,c.textContent="Salvando…",v)try{const B=await _e(v,400,.85),k=`avatars/${f.id}-${Date.now()}.jpg`,{error:L}=await y.storage.from("imoveis").upload(k,B,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:$}}=y.storage.from("imoveis").getPublicUrl(k);u=$}}catch(B){console.error("Avatar upload:",B)}const{error:E}=await y.from("profiles").update({name:m,avatar_url:u}).eq("id",f.id);if(c.disabled=!1,c.textContent=h,E){alert("Erro ao salvar perfil.");return}f={...f,name:m,avatar_url:u},Ne(f);const x=document.getElementById("settings-avatar-initial");x&&(x.textContent=((b=m[0])==null?void 0:b.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const m=document.getElementById("settings-corretores-section");m&&(m.style.display=""),await He(),(p=document.getElementById("btn-invite-corretor"))==null||p.addEventListener("click",async()=>{var b,B;const v=(b=document.getElementById("invite-email"))==null?void 0:b.value.trim(),h=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),E=document.getElementById("btn-invite-corretor"),x=document.getElementById("invite-note");if(!v){alert("Informe o e-mail do corretor.");return}if(!h||h.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),x&&(x.style.display="none");try{const k=await ce({email:v,password:h,tenant_id:(f==null?void 0:f.tenant_id)||null});if(k.success){const L=document.getElementById("invite-email"),$=document.getElementById("invite-password");L&&(L.value=""),$&&($.value=""),await He(),x&&(k.email_sent===!1?(x.innerHTML=`
                ✅ Acesso criado!
...
`+$);window.open("mailto:?subject="+w+"&body="+S,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var I;const $=document.getElementById("share-link-input");$&&((I=navigator.clipboard)==null||I.writeText($.value).then(()=>{const w=document.getElementById("share-copy"),S=w.textContent;w.textContent="✅ Copiado!",setTimeout(()=>{w.textContent=S},2e3)}))}),(k=document.getElementById("view-modal-edit"))==null||k.addEventListener("click",()=>{var M;if((f==null?void 0:f.role)!=="admin"&&(f==null?void 0:f.role)!=="super_admin")return;const $=Number(document.getElementById("view-modal-edit").dataset.pid),I=_.find(A=>A.id===$);if(!I)return;Ce(),R=I.id;const w=document.getElementById("property-form"),S=document.getElementById("form-submit-btn");S.textContent="Salvar Alterações",w.querySelector('[name="title"]').value=I.title||"",w.querySelector('[name="rua"]').value=I.rua||"",w.querySelector('[name="numero"]').value=I.numero||"",w.querySelector('[name="city"]').value=I.city||"",w.querySelector('[name="price"]').value=I.price||"",w.querySelector('[name="bedrooms"]').value=I.bedrooms||"",w.querySelector('[name="suites"]').value=I.suites||"",w.querySelector('[name="parking"]').value=I.parking||"",w.querySelector('[name="description"]').value=I.description||"",w.querySelector('[name="construction_status"]').value=I.construction_status||"",w.querySelector('[name="owner_name"]').value=I.owner_name||"",w.querySelector('[name="owner_phone"]').value=I.owner_phone||"",w.querySelector('[name="owner_email"]').value=I.owner_email||"",w.querySelector('[name="owner_notes"]').value=I.owner_notes||"",w.querySelector('[name="condominium"]').value=I.condominium||"";const T=document.getElementById("adminPublished");T&&(T.value=I.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=I.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=I.neighborhood||"")},50)),ie=I.cover_image||((M=I.images)==null?void 0:M[0])||"",Me(I.images||[]),Ge("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach($=>{$.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(w=>w.classList.remove("active")),$.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(w=>w.classList.add("hidden")),(I=document.getElementById(`tab-${$.dataset.tab}`))==null||I.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",$=>{if($.target.closest(".action-btns"))return;const I=$.target.closest("tr");if(!I)return;const w=Number(I.dataset.id);if(!w)return;const S=_.find(T=>T.id===w);S&&Yt(S)})}document.addEventListener("DOMContentLoaded",async()=>{var l,s,p;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,d=Te(r);if(d)ue(d);else{let m=null;for(const u of[t,"www."+t]){const{data:v}=await y.from("tenants").select("id").eq("domain",u).maybeSingle();if(v!=null&&v.id){m=v;break}}m!=null&&m.id&&(ue(m.id),Xe(r,m.id,24*60*60*1e3))}}await Promise.all([At(),St()]),oe=F("company.whatsapp",oe),tt(),Gt(),Vt();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(it(),n.addEventListener("change",()=>{const r=me().find(m=>m.name===n.value),d=r?ot(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+d.map(m=>`<option value="${m.name}">${g(m.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),d=new URLSearchParams(window.location.search),m=r.get("type")||d.get("type")||"",u=Et||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||d.has("code"),v=document.getElementById("password-reset-overlay");if(u){o.style.display="none",i&&i.classList.add("hidden"),v&&(v.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async E=>{var $,I;E.preventDefault();const x=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",b=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",B=document.getElementById("password-reset-msg"),k=E.target.querySelector('button[type="submit"]');if(B&&(B.style.display="none"),x!==b){B&&(B.textContent="As senhas não coincidem.",B.style.display="");return}k&&(k.disabled=!0,k.textContent="Salvando…");const{error:L}=await y.auth.updateUser({password:x});if(L){B&&(B.textContent="Erro: "+L.message,B.style.display=""),k&&(k.disabled=!1,k.textContent="Definir Senha");return}window.location.href=window.location.pathname}),d.has("code")&&await y.auth.exchangeCodeForSession(d.get("code")??"");return}const{data:{session:h}}=await y.auth.getSession();if(h){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),yt(),pt(),window.lucide&&lucide.createIcons(),f=await rt(h.user.id),!f){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(f.active===!1){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(f.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const E=document.getElementById("password-reset-overlay");E&&(E.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async x=>{var I,w;x.preventDefault();const b=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",B=((w=document.getElementById("confirm-password"))==null?void 0:w.value)||"",k=document.getElementById("password-reset-msg"),L=x.target.querySelector('button[type="submit"]');if(k&&(k.style.display="none"),b!==B){k&&(k.textContent="As senhas não coincidem.",k.style.display="");return}if(b.length<6){k&&(k.textContent="Mínimo 6 caracteres.",k.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:$}=await y.auth.updateUser({password:b});if($){k&&(k.textContent="Erro: "+$.message,k.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",f.id),window.location.href=window.location.pathname});return}ue((f==null?void 0:f.tenant_id)||null),Ne(f),ct(f),mt(f.role),await qe(),await vt(f),window.lucide&&lucide.createIcons(),la()}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const E=document.getElementById("login-form");E&&((p=document.getElementById("forgot-password-btn"))==null||p.addEventListener("click",async()=>{var B,k;const x=(k=(B=E.querySelector('input[name="email"]'))==null?void 0:B.value)==null?void 0:k.trim();if(!x){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:b}=await y.auth.resetPasswordForEmail(x,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(b?"Erro: "+b.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),E.addEventListener("submit",async x=>{x.preventDefault();const b=E.querySelector('button[type="submit"]'),B=new FormData(E),k=B.get("email"),L=B.get("password");b&&(b.disabled=!0,b.textContent="Entrando…");try{if(await Ut(k,L)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),Fe(),yt(),window.lucide&&lucide.createIcons();const{data:{session:I}}=await y.auth.getSession();if(f=I?await rt(I.user.id):null,!f){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(f.active===!1){await y.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}pt(),ue((f==null?void 0:f.tenant_id)||null),Ne(f),ct(f),mt(f.role),await qe(),await vt(f),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}catch($){alert("Erro ao fazer login: "+(($==null?void 0:$.message)||String($)))}finally{b&&(b.disabled=!1,b.textContent="Entrar")}}))}}else Fe();await le();const c=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();qt(c),Mt(oe),document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var m;const d=(m=r.closest(".nav-dropdown"))==null?void 0:m.querySelector(".nav-dropdown-menu");d&&r.addEventListener("click",u=>{u.stopPropagation(),d.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(v=>{v!==d&&v.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function ua(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:c}=await y.from("properties").update({reference:i}).eq("id",o.id);if(!c){const l=_.findIndex(s=>s.id===o.id);l>=0&&(_[l].reference=i),n++}}Se(at(_))}async function ga(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const c=await fa(i);a.push(c),o=!0}catch{a.push(i)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const i=_.findIndex(c=>c.id===t.id);i>=0&&(_[i].images=a)}}Se(at(_))}}async function fa(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,c=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const p=document.createElement("canvas"),r=1200;let d=s.width,m=s.height;d>r&&(m=Math.round(m*r/d),d=r),p.width=d,p.height=m;const u=p.getContext("2d");u.drawImage(s,0,0,d,m);const v=h=>{if(h){const E=Math.round(d*.18),x=Math.round(h.naturalHeight*E/h.naturalWidth),b=Math.round(d*.02);u.globalAlpha=.45,u.drawImage(h,d-E-b,m-x-b,E,x),u.globalAlpha=1}p.toBlob(async E=>{try{const x=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:b}=await y.storage.from("imoveis").upload(x,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(b){console.error("Upload watermark error:",b),l(e);return}const{data:{publicUrl:B}}=y.storage.from("imoveis").getPublicUrl(x);l(B)}catch(x){console.error("Watermark upload exception:",x),l(e)}},"image/jpeg",.82)};if(c){const h=new Image;h.onload=()=>{URL.revokeObjectURL(c),v(h)},h.onerror=()=>{URL.revokeObjectURL(c),v(null)},h.src=c}else v(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function V(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function st(e,t="assets"){const n=await _e(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=y.storage.from("imoveis").getPublicUrl(a);return i}async function va(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",z()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>g(String(n[o]||""));e.innerHTML=`
  ...
  `).join(""),e.querySelectorAll(".media-copy-btn").forEach(a=>{a.addEventListener("click",o=>{var i;o.stopPropagation(),(i=navigator.clipboard)==null||i.writeText(a.dataset.url).then(()=>{const c=a.textContent;a.textContent="✓ Copiado!",setTimeout(()=>{a.textContent=c},1500)})})}),e.querySelectorAll(".media-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta imagem da biblioteca?")&&(await y.from("media_library").delete().eq("id",a.dataset.id),await Ze())})})}async function wa(){var t,n,a,o,i;const e=document.getElementById("section-super-admin");!e||e.dataset.loaded||(e.dataset.loaded="1",e.innerHTML=`
    <div class="cfg-card">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(c=>{c.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),c.classList.add("active");const l=e.querySelector(`#sa-panel-${c.dataset.tab}`);l&&l.classList.remove("hidden"),c.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&ee(),c.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Ia(),c.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&bt(),c.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&ht(),c.dataset.tab==="platform"&&xt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",bt),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",ee),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",ht),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Ba()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",$a),ee(),xt())}async function ee(){var l,s;const e=document.getElementById("sa-tenants-list"),t=((s=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=y.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(p=>{var r,d;return!t||((r=p.name)==null?void 0:r.toLowerCase().includes(t))||((d=p.slug)==null?void 0:d.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const c=p=>p.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(p=>{var r;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(p=>{p.addEventListener("click",async r=>{r.stopPropagation();const d=p.dataset.active==="true";await y.from("tenants").update({active:!d}).eq("id",p.dataset.id),ee()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(p=>{p.addEventListener("click",()=>{const r=(i||[]).find(d=>String(d.id)===String(p.dataset.id));r&&La(r)})})}async function Ia(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>_t(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",et(e,o.dataset.tab)})}),et(e,"properties")}function Sa(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,p,r="text",d="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var b;(b=navigator.clipboard)==null||b.writeText(e.id);const E=document.getElementById("tp-copy-key"),x=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=x},2e3)})}if(t==="config"){const{data:r}=await y.from("settings").select("key,value").eq("tenant_id",e.id),d={};r==null||r.forEach(u=>{d[u.key]=u.value});const m=(u,v)=>`
      ...
      </div>`,(p=document.getElementById("tp-open-edit"))==null||p.addEventListener("click",()=>_t(e))}}function _t(e){var p,r,d,m,u,v,h,E;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
    <div class="sa-modal" style="max-width:560px;">
      ...
      <div id="et-pane-api" class="sa-modal-body" style="display:none;">
        ...
        <div style="display:flex;flex-direction:column;gap:8px;">
          ${[["GET","properties","Lista imóveis publicados"],["GET","properties/ID","Detalhe de um imóvel"],["POST","leads","Registra lead / formulário de contato"],["GET","settings","Dados da empresa (nome, WhatsApp, logo…)"]].map(([x,b,B])=>`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:x})=>{const b=document.getElementById("et-plan");b&&x&&(b.innerHTML='<option value="">Sem plano</option>'+x.map(B=>`<option value="${B.id}"${String(B.id)===String(e.plan_id)?" selected":""}>${g(B.name)}</option>`).join(""))}),(p=document.getElementById("et-logo-input"))==null||p.addEventListener("change",x=>{const b=x.target.files[0];if(!b)return;const B=URL.createObjectURL(b),k=document.getElementById("et-logo-preview");k&&(k.innerHTML=`<img src="${B}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var x;(x=document.getElementById("et-logo-input"))==null||x.click()}),(d=document.getElementById("et-pwd-toggle"))==null||d.addEventListener("click",()=>{const x=document.getElementById("et-admin-password");x.type=x.type==="password"?"text":"password"}),(m=document.getElementById("et-copy-key"))==null||m.addEventListener("click",()=>{var k,L;const x=(k=document.getElementById("et-api-key"))==null?void 0:k.value;if(!x)return;(L=navigator.clipboard)==null||L.writeText(x);const b=document.getElementById("et-copy-key"),B=b.textContent;b.textContent="✅ Copiada!",setTimeout(()=>{b.textContent=B},2e3)});const o=["dados","config","api"];function i(x){o.forEach(b=>{document.getElementById(`et-pane-${b}`).style.display=b===x?"":"none";const B=document.getElementById(`et-tab-${b}`);B.style.borderBottomColor=b===x?"#2563eb":"transparent",B.style.color=b===x?"#2563eb":"#64748b",B.style.fontWeight=b===x?"600":"500"}),x==="config"&&l()}o.forEach(x=>{var b;return(b=document.getElementById(`et-tab-${x}`))==null?void 0:b.addEventListener("click",()=>i(x))});let c=!1;async function l(){var B;if(c)return;c=!0;const{data:x}=await y.from("settings").select("key,value").eq("tenant_id",e.id),b={};x==null||x.forEach(k=>{b[k.key]=k.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
        <label>WhatsApp <span style="font-size:11px;color:#94a3b8;">(DDI+DDD+número, sem espaços ou símbolos)</span></label>
        <input id="et-cfg-wa"     class="form-input" type="text"  value="${g(b["company.whatsapp"]||"")}" placeholder="5547999701743">
      </div>
      <div class="form-group">
        <label>Telefone</label>
        <input id="et-cfg-phone"  class="form-input" type="text"  value="${g(b["company.phone"]||"")}"    placeholder="(47) 9 9970-1743">
      </div>
      <div class="form-group">
        <label>E-mail de contato</label>
        <input id="et-cfg-email"  class="form-input" type="email" value="${g(b["company.email"]||"")}"    placeholder="contato@nicimobiliaria.com.br">
      </div>
      <div class="form-group">
        <label>Cidade</label>
        <input id="et-cfg-city"   class="form-input" type="text"  value="${g(b["company.city"]||b["company.address"]||"")}" placeholder="Blumenau, SC">
      </div>
      <div class="form-group">
        <label>Slogan</label>
        <input id="et-cfg-slogan" class="form-input" type="text"  value="${g(b["company.slogan"]||"")}"   placeholder="Os melhores imóveis da região">
      </div>
