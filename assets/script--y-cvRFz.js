import{s as y}from"./supabase-BcuJ3xoD.js";const st="00000000-0000-0000-0000-000000000000";let ue={},$e={},te=st;function Ve(e){te=e||st,ue={},$e={}}const Re=()=>te;async function ft(){const[e,t]=await Promise.all([y.from("settings").select("key,value").eq("tenant_id",te),y.from("site_content").select("*").eq("tenant_id",te)]);e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{$e[n.key]=n})}const V=(e,t=null)=>ue[e]!==void 0?ue[e]:t,_e=(e,t="pt")=>{const n=$e[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Z(e){const t=new Date().toISOString(),n=e.map(([o,s])=>({key:o,value:s,tenant_id:te,updated_at:t})),{error:a}=await y.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,s])=>{ue[o]=s}),!a}async function Ce(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:te,updated_at:new Date().toISOString()},{error:s}=await y.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return s||($e[e]=o),!s}async function Te(e,t,n){const{error:a}=await y.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function He(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=o});const s=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=s);const d=V("visual.hero_bg_url","");if(d){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${d}')`)}}function yt(e="pt"){const t=u=>_e(u,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const s=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');s&&t("inst.bio_p1")&&(s.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),p=document.querySelector('[data-i18n="inst.stat3"]');i&&t("inst.stat2_num")&&(i.innerHTML=t("inst.stat2_num")),r&&t("inst.stat1_label")&&(r.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),p&&t("inst.stat3_label")&&(p.innerHTML=t("inst.stat3_label"));const c=_e("seo.title_pt",e);c&&document.title&&(document.title=c);const g=_e("seo.description_pt",e);if(g){const u=document.querySelector('meta[name="description"]');u&&(u.content=g)}}function bt(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const ht="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let K="5547999701743",pe=`https://wa.me/${K}`;const W=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],Et=5.7;function ve(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/Et).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],v=null,ge=[],it=!1;y.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(it=!0)});async function wt(){const{data:e,error:t}=await y.from("properties").select("*").eq("published",!0).is("tenant_id",null).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function It(){let e=y.from("properties").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="super_admin"?e=e.is("tenant_id",null):v!=null&&v.tenant_id?e=e.eq("tenant_id",v.tenant_id):v!=null&&v.id&&(e=e.is("tenant_id",null));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],Qt(),Zt(),_)}async function xt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await y.from("properties").update(a).eq("id",t);if(o)throw o;const s=_.findIndex(l=>l.id===t);s>=0&&(_[s]={..._[s],...a})}else{if(!e.reference){const a=_.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await y.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function Bt(e){const{error:t}=await y.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function Lt(e,t){const{error:n}=await y.auth.signInWithPassword({email:e,password:t});return!n}function he(e,t=1200,n=.78){return new Promise((a,o)=>{const s=new Image,l=URL.createObjectURL(e);s.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let i=s.width,r=s.height;i>t&&(r=Math.round(r*t/i),i=t),d.width=i,d.height=r;const m=d.getContext("2d");m.drawImage(s,0,0,i,r);const p=new Image;p.crossOrigin="anonymous",p.onload=()=>{const c=Math.round(i*.18),g=Math.round(p.naturalHeight*c/p.naturalWidth),u=Math.round(i*.02),b=i-c-u,E=r-g-u;m.globalAlpha=.45,m.drawImage(p,b,E,c,g),m.globalAlpha=1,d.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.onerror=()=>{d.toBlob(c=>c?a(c):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},p.src="/logo.png"},s.onerror=o,s.src=l})}async function St(e){const t=await he(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await y.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=y.storage.from("imoveis").getPublicUrl(n);return o}async function kt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await St(n[o]));return a}async function fe(){var p,c,g,u,b,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await wt();_=n,((p=document.getElementById("selecao-carousel"))==null?void 0:p.innerHTML)===""&&$t(n);const a=((c=document.getElementById("city-filter"))==null?void 0:c.value)||"",o=((g=document.getElementById("neighborhood-filter"))==null?void 0:g.value)||"",s=((u=document.getElementById("bedrooms-filter"))==null?void 0:u.value)||"",l=((b=document.getElementById("parking-filter"))==null?void 0:b.value)||"",d=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",i=document.getElementById("price-slider"),r=i?parseInt(i.value,10):13e7,m=n.filter(f=>{if(a&&f.city!==a||o&&f.neighborhood!==o||s&&(s==="4+"&&Number(f.bedrooms)<4||s!=="4+"&&Number(f.bedrooms)!==Number(s))||l&&(l==="4+"&&Number(f.parking)<4||l!=="4+"&&Number(f.parking)!==Number(l))||d&&f.construction_status!==d)return!1;const w=String(f.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),L=parseInt(w,10)||0;return!(L<0||L>r)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(f=>{var I;const w=f.cover_image||((I=f.images)==null?void 0:I[0])||W[0],L=[f.neighborhood,f.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          <img src="${w}" alt="${h(f.title)}" class="selecao-card-img">
          <div class="selecao-card-body">
            <div class="selecao-card-title">${h(f.title)}</div>
            <div class="selecao-card-loc">${h(L)}</div>
            <div class="selecao-card-price">${h(ve(f.price,window.currentLang||"pt"))}</div>
      ...
      `}).join("");return}if(!m.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=m.map(f=>{var I;const w=(I=f.images)!=null&&I.length?f.images:W,L=w.length;return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${L}" data-idx="0" data-pid="${f.id}">
          <img src="${f.cover_image||w[0]}" alt="${h(f.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${L>1?`
        ...
        <div class="property-info">
          ...
          <div class="muted">${h(f.neighborhood||"")}, ${h(f.city||"")}</div>
          <div><strong>${h(ve(f.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${f.bedrooms||"--"} | 🚗 ${f.parking||"--"} ${L>1?"| 📸 "+L:""}</div>
          <p class="muted">${h((f.description||"").slice(0,110))}</p>
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(f=>{f.removeEventListener("click",Ge),f.addEventListener("click",Ge)})}function $t(e){var o,s,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(d=>{var m;const i=d.cover_image||((m=d.images)==null?void 0:m[0])||W[0],r=[d.neighborhood,d.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
...
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(R){const i=_.find(r=>r.id===R);i!=null&&i.images&&(s=i.images)}s.length||(s=[...W]);const d={...R?{id:R}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:s,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:G||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||""};try{await xt(d),R=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const i=document.getElementById("adminPublished");i&&(i.value="true");const r=document.getElementById("adminNeighborhood");r&&(r.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),G="",xe([]),we(),await Ie()}catch(i){console.error(i),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert("Erro ao salvar imóvel. Verifique o console.")}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await Bt(o),await Ie()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((v==null?void 0:v.role)!=="admin")return;const o=Number(n.target.dataset.id);if(!o)return;const s=_.find(i=>i.id===o);if(!s)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=s.title||"",e.querySelector('[name="rua"]').value=s.rua||"",e.querySelector('[name="numero"]').value=s.numero||"",e.querySelector('[name="city"]').value=s.city||"",e.querySelector('[name="price"]').value=s.price||"",e.querySelector('[name="bedrooms"]').value=s.bedrooms||"",e.querySelector('[name="suites"]').value=s.suites||"",e.querySelector('[name="area"]').value=s.area||"",e.querySelector('[name="parking"]').value=s.parking||"",e.querySelector('[name="description"]').value=s.description||"",e.querySelector('[name="construction_status"]').value=s.construction_status||"",e.querySelector('[name="owner_name"]').value=s.owner_name||"",e.querySelector('[name="owner_phone"]').value=s.owner_phone||"",e.querySelector('[name="owner_email"]').value=s.owner_email||"",e.querySelector('[name="owner_notes"]').value=s.owner_notes||"",e.querySelector('[name="condominium"]').value=s.condominium||"";const l=document.getElementById("adminPublished");l&&(l.value=s.published===!0?"true":"false");const d=document.getElementById("adminCitySelect");d&&(d.value=s.city||"",d.dispatchEvent(new Event("change")),setTimeout(()=>{const i=document.getElementById("adminNeighborhood");i&&(i.value=s.neighborhood||"")},50)),G=s.cover_image||((a=s.images)==null?void 0:a[0])||"",xe(s.images||[]),Ae("Editar Imóvel")}})}function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let P=[],H=0;function At(e){var m,p;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((m=e.images)==null?void 0:m[0])||W[0];document.getElementById("view-thumb-preview").src=o,P=(p=e.images)!=null&&p.length?e.images:W,H=0,Be(),document.getElementById("view-price").textContent=ve(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(c=>c.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(c=>c.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,i=document.getElementById("share-link-input");i&&(i.value=d);const r=document.getElementById("share-panel");r&&(r.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ee(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Be(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=P[H],e.alt=`Foto ${H+1}`;const s=P.length>1;n.style.display=s?"flex":"none",a.style.display=s?"flex":"none",t.textContent=s?`${H+1} / ${P.length}`:"",o.innerHTML=s?P.map((l,d)=>`<img src="${l}" class="view-thumb${d===H?" active":""}" data-i="${d}" alt="Foto ${d+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{H=+l.dataset.i,Be()})})}async function We(e){const{data:t}=await y.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Le(e){var p,c;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const s=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=s,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((p=s[0])==null?void 0:p.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const d=document.getElementById("avatar-dd-name"),i=document.getElementById("avatar-dd-role"),r=document.getElementById("avatar-dd-img"),m=document.getElementById("avatar-dd-initial");d&&(d.textContent=s),i&&(i.textContent=l),e!=null&&e.avatar_url&&r?(r.src=e.avatar_url,r.style.display="",m&&(m.style.display="none")):(m&&(m.textContent=((c=s[0])==null?void 0:c.toUpperCase())||"?",m.style.display=""),r&&(r.style.display="none"))}function Y(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),j(),e==="contatos"&&Gt(),e==="funil"&&Ut(),e==="tarefas"&&Ot()}function Ye(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ta,visual:aa,"site-config":na,"crm-config":oa,integracoes:sa,midia:ia}).forEach(([a,o])=>{const s=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);s&&s.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>la(),{once:!0}),window.lucide&&lucide.createIcons()}}function j(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Mt(){var a,o,s;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(l=document.getElementById("cph-close"))==null||l.addEventListener("click",o),(d=document.getElementById("cph-cancel"))==null||d.addEventListener("click",o),t.addEventListener("click",m=>{m.target===t&&o()}),(i=document.getElementById("cph-file"))==null||i.addEventListener("change",m=>{const p=m.target.files[0];if(!p)return;const c=URL.createObjectURL(p),g=document.getElementById("cph-preview"),u=document.getElementById("cph-initial");g&&(g.src=c,g.style.display=""),u&&(u.style.display="none"),document.getElementById("cph-save").disabled=!1}),(r=document.getElementById("cph-save"))==null||r.addEventListener("click",async()=>{var g;const m=(g=document.getElementById("cph-file"))==null?void 0:g.files[0];if(!m)return;const p=document.getElementById("cph-save"),c=document.getElementById("cph-msg");p.disabled=!0,p.textContent="Salvando…";try{const u=await he(m,400,.85),b=`avatars/${v.id}-${Date.now()}.jpg`,{error:E}=await y.storage.from("imoveis").upload(b,u,{contentType:"image/jpeg",upsert:!0});if(E)throw E;const{data:{publicUrl:f}}=y.storage.from("imoveis").getPublicUrl(b);await y.from("profiles").update({avatar_url:f}).eq("id",v.id),v={...v,avatar_url:f},Le(v),o()}catch(u){c.style.color="#ef4444",c.textContent="Erro: "+u.message,c.style.display="",p.disabled=!1,p.textContent="Salvar Foto"}})}function Rt(){var a,o,s;const e=document.getElementById("add-corretor-modal-root");e&&e.remove();const t=document.createElement("div");t.id="add-corretor-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("ac-close"))==null||a.addEventListener("click",n),(o=document.getElementById("ac-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",l=>{l.target===t&&n()}),(s=document.getElementById("ac-save"))==null||s.addEventListener("click",async()=>{var m,p;const l=(m=document.getElementById("ac-email"))==null?void 0:m.value.trim(),d=(p=document.getElementById("ac-password"))==null?void 0:p.value.trim(),i=document.getElementById("ac-save"),r=document.getElementById("ac-note");if(!l){alert("Informe o e-mail do corretor.");return}if(!d||d.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}i.disabled=!0,i.textContent="Criando…",r.style.display="none";try{const c=await oe({email:l,password:d,tenant_id:(v==null?void 0:v.tenant_id)||null});i.disabled=!1,i.textContent="+ Criar Acesso",c.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",c.email_sent===!1?(r.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${h(l)}<br><strong>Senha:</strong> ${h(d)}`,r.style.color="#0f172a"):(r.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",r.style.color="#16a34a"),r.style.display=""):alert("Erro: "+(c.error||"Falha desconhecida"))}catch(c){i.disabled=!1,i.textContent="+ Criar Acesso",alert("Erro: "+c.message)}})}function Ht(){var s,l,d,i,r,m,p,c,g,u,b;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",E=>{var w;E.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(w=document.getElementById("notif-dropdown"))==null||w.classList.add("hidden")}),(s=document.getElementById("avatar-dd-change-photo"))==null||s.addEventListener("click",E=>{E.stopPropagation(),j(),Nt()}),(l=document.getElementById("avatar-dd-change-pass"))==null||l.addEventListener("click",E=>{E.stopPropagation(),j(),Mt()}),(d=document.getElementById("avatar-dd-add-corretor"))==null||d.addEventListener("click",E=>{E.stopPropagation(),j(),Rt()}),(i=document.getElementById("avatar-dd-settings"))==null||i.addEventListener("click",E=>{E.stopPropagation(),j(),Y("settings")}),(r=document.getElementById("avatar-dd-logout"))==null||r.addEventListener("click",async E=>{E.stopPropagation(),await y.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",E=>{var w;E.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((w=document.getElementById("avatar-dropdown"))==null||w.classList.add("hidden"),Pt())}),(m=document.getElementById("notif-mark-all"))==null||m.addEventListener("click",()=>{Ft(),j()}),(p=document.getElementById("btn-search-open"))==null||p.addEventListener("click",()=>{var E,f;(E=document.getElementById("search-overlay"))==null||E.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(c=document.getElementById("search-overlay-close"))==null||c.addEventListener("click",()=>{var E;(E=document.getElementById("search-overlay"))==null||E.classList.add("hidden")}),(g=document.getElementById("search-overlay"))==null||g.addEventListener("click",E=>{E.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(u=document.getElementById("search-input"))==null||u.addEventListener("input",E=>{clearTimeout(o),o=setTimeout(()=>zt(E.target.value.trim()),280)}),(b=document.getElementById("search-input"))==null||b.addEventListener("keydown",E=>{var f;E.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",j)}let Je=!1,de=[],lt=[],Se=[],be=null,re=null;async function Ut(){var a;if(Je)return;Je=!0;const[{data:e},{data:t}]=await Promise.all([y.from("crm_pipelines").select("*").order("sort_order"),y.from("crm_stages").select("*").order("sort_order")]);de=e||[],lt=t||[];const n=document.getElementById("funil-pipe-sel");if(n){n.innerHTML=de.length?de.map(s=>`<option value="${s.id}">${h(s.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const o=de.find(s=>s.is_default)||de[0];o&&(n.value=o.id,be=o.id),n.addEventListener("change",async()=>{be=parseInt(n.value,10),await Ke()})}(a=document.getElementById("btn-funil-add-lead"))==null||a.addEventListener("click",()=>openLeadModal()),await Ke()}async function Ke(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id)),be&&(t=t.eq("pipeline_id",be));const{data:n}=await t;Se=n||[],dt()}function dt(){const e=document.getElementById("kanban-board");if(!e)return;const t=lt.filter(a=>a.pipeline_id===be);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n={};t.forEach(a=>{n[a.name]=[]}),Se.forEach(a=>{var s,l,d,i;const o=a.stage||((s=t[0])==null?void 0:s.name);n[o]||(n[((l=t[0])==null?void 0:l.name)||""]=[]),(i=n[o]||n[(d=t[0])==null?void 0:d.name])==null||i.push(a)}),e.innerHTML=t.map(a=>{const o=n[a.name]||[],s=o.length?o.map(l=>`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      ...
      </div>`}).join(""),e.querySelectorAll(".tarefa-check").forEach(a=>{a.addEventListener("change",async o=>{o.stopPropagation();const s=a.dataset.id,l=a.checked?"done":"pending";await y.from("tasks").update({status:l}).eq("id",s);const d=M.find(i=>String(i.id)===s);d&&(d.status=l),ae()})}),e.querySelectorAll(".tarefa-del-btn").forEach(a=>{a.addEventListener("click",async o=>{o.stopPropagation(),confirm("Excluir esta tarefa?")&&(await y.from("tasks").delete().eq("id",a.dataset.id),M=M.filter(s=>String(s.id)!==String(a.dataset.id)),ae())})}),e.querySelectorAll(".tarefa-item").forEach(a=>{a.addEventListener("click",o=>{if(o.target.closest(".tarefa-check")||o.target.closest(".tarefa-del-btn"))return;const s=a.dataset.id,l=M.find(d=>String(d.id)===s);l&&ct(l)})})}function ct(e=null){var i,r,m,p;const t=document.getElementById("tarefa-modal-root");t&&t.remove();const n=!!e,a=(e==null?void 0:e.status)==="done",o=rt(e==null?void 0:e.due_date);o&&o.toLocaleDateString("pt-BR");const s=e!=null&&e.due_date?e.due_date.includes("T")?e.due_date.split("T")[0]:e.due_date:"",l=document.createElement("div");l.id="tarefa-modal-root",l.className="modal-backdrop",l.innerHTML=`
  ...
  `,document.body.appendChild(l);const d=()=>l.remove();(i=document.getElementById("tm-close"))==null||i.addEventListener("click",d),(r=document.getElementById("tm-cancel"))==null||r.addEventListener("click",d),l.addEventListener("click",c=>{c.target===l&&d()}),(m=document.getElementById("tm-toggle-done"))==null||m.addEventListener("click",async()=>{const c=a?"pending":"done";await y.from("tasks").update({status:c}).eq("id",e.id);const g=M.find(u=>String(u.id)===String(e.id));g&&(g.status=c),d(),c==="done"&&(Q="done",document.querySelectorAll(".tarefa-filter-btn").forEach(u=>{u.classList.toggle("active",u.dataset.filter==="done")})),ae()}),(p=document.getElementById("tm-save"))==null||p.addEventListener("click",async()=>{var f,w;const c=document.getElementById("tarefa-form");if(!c.checkValidity()){c.reportValidity();return}const g=new FormData(c),u=document.getElementById("tm-save");u.disabled=!0,u.textContent="Salvando…";const b={title:(f=g.get("title"))==null?void 0:f.trim(),description:((w=g.get("description"))==null?void 0:w.trim())||null,due_date:g.get("due_date")||null,priority:g.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null};let E;if(n){if({error:E}=await y.from("tasks").update(b).eq("id",e.id),!E){const L=M.findIndex(I=>String(I.id)===String(e.id));L>=0&&(M[L]={...M[L],...b})}}else{const{data:L,error:I}=await y.from("tasks").insert(b).select();E=I,!E&&(L!=null&&L[0])&&M.unshift(L[0])}if(u.disabled=!1,u.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}d(),ae()})}async function zt(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;v==null||v.role,v==null||v.tenant_id;const[{data:a},{data:o}]=await Promise.all([y.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),y.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),s=[];a!=null&&a.length&&(s.push('<div class="search-group-label">Imóveis</div>'),s.push(...a.map(l=>`
      ...
      </div>`))),t.innerHTML=s.length?s.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(l=>{l.addEventListener("click",()=>{var d;(d=document.getElementById("search-overlay"))==null||d.classList.add("hidden"),l.dataset.type==="lead"?Y("contatos"):Y("properties")})})}let O=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function Pt(){var l;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=y.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(d=>!O.includes(String(d.id))),s=document.getElementById("notif-badge");if(s&&(s.textContent=o.length,o.length>0?s.classList.remove("hidden"):s.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(d=>{const i=Xt(d.created_at);return`
      <div class="notif-item${!O.includes(String(d.id))?" unread":""}" data-id="${d.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${h(d.name||"—")}</div>
          <div class="notif-item-sub">${h(d.phone||d.source||"")} · ${i}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",d=>{d.preventDefault(),j(),Y("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{O.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(O)),d.classList.remove("unread"),j(),Y("contatos")})})}function Ft(){var e;document.querySelectorAll(".notif-item").forEach(t=>O.push(t.dataset.id)),O=[...new Set(O)],localStorage.setItem("crm_notifs_read",JSON.stringify(O)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Xt(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Vt(){let e=y.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);v!=null&&v.tenant_id&&(e=e.eq("tenant_id",v.tenant_id));const{data:t}=await e,a=(t||[]).filter(s=>!O.includes(String(s.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let F=[],A=1;const ce=10;let Ze=!1;async function Gt(){var t,n,a,o,s,l,d,i,r;document.getElementById("section-contatos")&&(Ze||(Ze=!0,await mt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{A=1,ne()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",m=>{m.key==="Enter"&&(A=1,ne())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>ut()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Jt),(s=document.getElementById("import-modal-close"))==null||s.addEventListener("click",Me),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",Me),(d=document.getElementById("download-template"))==null||d.addEventListener("click",m=>{m.preventDefault();const p=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,c=new Blob([p],{type:"text/csv"}),g=document.createElement("a");g.href=URL.createObjectURL(c),g.download="modelo_contatos.csv",g.click()}),(i=document.getElementById("import-csv-file"))==null||i.addEventListener("change",Wt),(r=document.getElementById("import-modal-confirm"))==null||r.addEventListener("click",Yt)))}async function mt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=y.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:a}=await t;F=a||[],ne()}function ne(){var d,i,r;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?F.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):F,n=t.length,a=Math.max(1,Math.ceil(n/ce));A>a&&(A=a);const o=t.slice((A-1)*ce,A*ce),s=document.getElementById("contatos-tbody");if(!s)return;o.length?s.innerHTML=o.map(m=>`
      <tr>
  ...
  `,document.body.appendChild(a);const o=()=>a.remove();(s=document.getElementById("cm-close"))==null||s.addEventListener("click",o),(l=document.getElementById("cm-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",i=>{i.target===a&&o()}),(d=document.getElementById("cm-save"))==null||d.addEventListener("click",async()=>{var g,u,b,E,f,w,L;const i=document.getElementById("contato-form");if(!i.checkValidity()){i.reportValidity();return}const r=new FormData(i),m=document.getElementById("cm-save");m.disabled=!0,m.textContent="Salvando…";const p={name:(g=r.get("name"))==null?void 0:g.trim(),company:((u=r.get("company"))==null?void 0:u.trim())||null,email:((b=r.get("email"))==null?void 0:b.trim())||null,phone:((E=r.get("phone"))==null?void 0:E.trim())||null,job_title:((f=r.get("job_title"))==null?void 0:f.trim())||null,city_interest:((w=r.get("city_interest"))==null?void 0:w.trim())||null,notes:((L=r.get("notes"))==null?void 0:L.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null,source:"manual"};let c;if(n){if({error:c}=await y.from("leads").update(p).eq("id",e.id),!c){const I=F.findIndex($=>String($.id)===String(e.id));I>=0&&(F[I]={...F[I],...p})}}else{const{data:I,error:$}=await y.from("leads").insert(p).select();c=$,!c&&(I!=null&&I[0])&&F.unshift(I[0])}if(m.disabled=!1,m.textContent=n?"Salvar":"Criar Contato",c){alert("Erro: "+c.message);return}o(),ne()})}let ee=[];function Wt(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{ee=a.target.result.split(`
`).filter(d=>d.trim()).slice(1).map(d=>{const[i,r,m,p,c]=d.split(",").map(g=>g.trim().replace(/^"|"$/g,""));return{name:i,email:r,phone:m,company:p,job_title:c}}).filter(d=>d.name);const s=document.getElementById("import-preview");s&&(s.textContent=`${ee.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=ee.length===0)},n.readAsText(t)}async function Yt(){if(!ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await y.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Me(),await mt(),alert(`${t.length} contato(s) importados com sucesso!`)}function Jt(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Me(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Kt="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function oe(e){return(await fetch(Kt,{method:"POST",headers:{Authorization:`Bearer ${ht}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function et(e){var i,r,m,p;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),s=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:c}}=await y.auth.getUser();n.value=(c==null?void 0:c.email)||""}const d=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=d),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),s==null||s.addEventListener("change",c=>{const g=c.target.files[0];if(!g)return;const u=URL.createObjectURL(g);a&&(a.src=u,a.style.display=""),o&&(o.style.display="none")}),(i=document.getElementById("btn-change-password"))==null||i.addEventListener("click",async()=>{var f,w;const c=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",g=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",u=document.getElementById("change-password-msg"),b=document.getElementById("btn-change-password");if(u&&(u.style.display="none"),c.length<6){u&&(u.textContent="Mínimo 6 caracteres.",u.style.display="");return}if(c!==g){u&&(u.textContent="As senhas não coincidem.",u.style.display="");return}b&&(b.disabled=!0,b.textContent="Salvando…");const{error:E}=await y.auth.updateUser({password:c});b&&(b.disabled=!1,b.textContent="Salvar Nova Senha"),E?u&&(u.textContent="Erro: "+E.message,u.style.display=""):(u&&(u.style.color="#16a34a",u.textContent="Senha alterada com sucesso!",u.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var w;const c=t.value.trim();let g=(v==null?void 0:v.avatar_url)||"";const u=s==null?void 0:s.files[0],b=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",u)try{const L=await he(u,400,.85),I=`avatars/${v.id}-${Date.now()}.jpg`,{error:$}=await y.storage.from("imoveis").upload(I,L,{contentType:"image/jpeg",upsert:!0});if(!$){const{data:{publicUrl:x}}=y.storage.from("imoveis").getPublicUrl(I);g=x}}catch(L){console.error("Avatar upload:",L)}const{error:E}=await y.from("profiles").update({name:c,avatar_url:g}).eq("id",v.id);if(l.disabled=!1,l.textContent=b,E){alert("Erro ao salvar perfil.");return}v={...v,name:c,avatar_url:g},Le(v);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((w=c[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const c=document.getElementById("settings-corretores-section");c&&(c.style.display=""),await ke(),(r=document.getElementById("btn-invite-corretor"))==null||r.addEventListener("click",async()=>{var w,L;const u=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),b=(L=document.getElementById("invite-password"))==null?void 0:L.value.trim(),E=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!u){alert("Informe o e-mail do corretor.");return}if(!b||b.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),f&&(f.style.display="none");try{const I=await oe({email:u,password:b,tenant_id:(v==null?void 0:v.tenant_id)||null});if(I.success){const $=document.getElementById("invite-email"),x=document.getElementById("invite-password");$&&($.value=""),x&&(x.value=""),await ke(),f&&(I.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                <span style="color:#ef4444;">⚠️ E-mail não enviado automaticamente.</span><br>
                Compartilhe manualmente:<br>
                <strong>E-mail:</strong> ${h(u)}<br>
                <strong>Senha:</strong> ${h(b)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(I.error||"Falha desconhecida"))}catch(I){alert("Erro ao criar acesso: "+I.message)}finally{E&&(E.disabled=!1,E.textContent="+ Criar Acesso")}});const g=document.getElementById("settings-locations-section");g&&(g.style.display=""),await me(),(m=document.getElementById("loc-add-city-btn"))==null||m.addEventListener("click",async()=>{const u=document.getElementById("loc-new-city"),b=u==null?void 0:u.value.trim();if(!b)return;const{error:E}=await y.from("locations").insert({type:"cidade",name:b});if(E){alert("Erro ao adicionar cidade.");return}u&&(u.value=""),await me(),Oe()}),(p=document.getElementById("loc-add-neighborhood-btn"))==null||p.addEventListener("click",async()=>{var w;const u=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),b=document.getElementById("loc-new-neighborhood"),E=b==null?void 0:b.value.trim();if(!u||!E){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await y.from("locations").insert({type:"bairro",name:E,parent_id:u});if(f){alert("Erro ao adicionar bairro.");return}b&&(b.value=""),await me()})}}async function ke(){const e=document.getElementById("corretores-list");if(!e)return;let t=y.from("profiles").select("*").order("created_at");v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const s=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${h(s)}</div>`,d=o.id===(v==null?void 0:v.id),i=o.active!==!1,r=i?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',m=d?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
      ...
      <div class="corretor-actions">
        ...
        <div class="loc-item">
          ...
          <div class="loc-item">
            ...
            <button class="loc-del-btn" data-id="${s.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',a&&(a.innerHTML='<option value="">Cidade…</option>'+e.map(s=>`<option value="${s.id}">${h(s.name)}</option>`).join("")),t.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{const l=s.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${l}" e todos os bairros vinculados?`))return;const{error:d}=await y.from("locations").delete().eq("id",s.dataset.id);if(d){alert("Erro ao excluir.");return}await me(),Oe()})}),n.querySelectorAll(".loc-del-btn").forEach(s=>{s.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:l}=await y.from("locations").delete().eq("id",s.dataset.id);if(l){alert("Erro ao excluir.");return}await me()})})}function tt(){var n,a,o,s,l,d,i,r,m,p,c,g,u,b,E,f,w,L,I,$;document.querySelectorAll(".filter-btn").forEach(x=>{x.addEventListener("click",()=>{const B=x.closest(".filter-btns"),S=x.classList.contains("active");B.querySelectorAll(".filter-btn").forEach(k=>k.classList.remove("active")),S||x.classList.add("active")})}),(n=document.getElementById("f-city"))==null||n.addEventListener("change",()=>{var C;const x=(C=document.getElementById("f-city"))==null?void 0:C.value,B=J().find(T=>T.name===x),S=B?je(B.id):[],k=document.getElementById("f-neighborhood");k&&(k.innerHTML='<option value="">Todos</option>'+S.map(T=>`<option value="${T.name}">${h(T.name)}</option>`).join(""))}),(a=document.getElementById("f-search-btn"))==null||a.addEventListener("click",()=>{ye(Ue(_))}),(o=document.getElementById("f-clear-btn"))==null||o.addEventListener("click",()=>{["f-title","f-condominium","f-price-min","f-price-max","f-area-min","f-area-max"].forEach(k=>{const C=document.getElementById(k);C&&(C.value="")}),["f-type","f-city","f-construction","f-published"].forEach(k=>{const C=document.getElementById(k);C&&(C.value="")});const S=document.getElementById("f-neighborhood");S&&(S.innerHTML='<option value="">Todos</option>'),document.querySelectorAll(".filter-btn.active").forEach(k=>k.classList.remove("active")),ye(_)}),document.querySelectorAll(".topnav-link[data-section], .topnav-dropdown-item[data-section]").forEach(x=>{x.addEventListener("click",()=>{Y(x.dataset.section)})}),document.querySelectorAll(".nav-item[data-section]").forEach(x=>{x.addEventListener("click",()=>{Y(x.dataset.section)})});const e=document.getElementById("topnav-links"),t=document.getElementById("topnav-hamburger");t==null||t.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),document.querySelectorAll(".topnav-dropdown-btn").forEach(x=>{x.addEventListener("click",B=>{B.stopPropagation();const S=x.closest(".topnav-dropdown");S==null||S.classList.toggle("open"),document.querySelectorAll(".topnav-dropdown").forEach(k=>{k!==S&&k.classList.remove("open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".topnav-dropdown").forEach(x=>x.classList.remove("open"))}),(s=document.getElementById("modal-close"))==null||s.addEventListener("click",we),(l=document.getElementById("modal-cancel"))==null||l.addEventListener("click",we),(d=document.getElementById("property-modal"))==null||d.addEventListener("click",x=>{x.target.id==="property-modal"&&we()}),(i=document.getElementById("btn-new-property"))==null||i.addEventListener("click",()=>{R=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",G="",xe([]),Ae("Novo Imóvel")}),(r=document.getElementById("logout-btn"))==null||r.addEventListener("click",async()=>{await y.auth.signOut(),location.reload()}),(m=document.getElementById("view-prev"))==null||m.addEventListener("click",()=>{H=(H-1+P.length)%P.length,Be()}),(p=document.getElementById("view-next"))==null||p.addEventListener("click",()=>{H=(H+1)%P.length,Be()}),(c=document.getElementById("view-modal-close"))==null||c.addEventListener("click",Ee),(g=document.getElementById("view-modal-close2"))==null||g.addEventListener("click",Ee),(u=document.getElementById("view-modal"))==null||u.addEventListener("click",x=>{x.target.id==="view-modal"&&Ee()}),(b=document.getElementById("view-modal-share"))==null||b.addEventListener("click",()=>{const x=document.getElementById("share-panel");if(!x)return;const B=x.style.display!=="none";x.style.display=B?"none":"block"}),(E=document.getElementById("share-whatsapp"))==null||E.addEventListener("click",()=>{var k,C;const x=(k=document.getElementById("share-link-input"))==null?void 0:k.value;if(!x)return;const B=((C=document.getElementById("view-modal-title"))==null?void 0:C.textContent)||"Imóvel",S=encodeURIComponent("Olha esse imóvel que encontrei: "+B+`
`+x);window.open("https://wa.me/?text="+S,"_blank")}),(f=document.getElementById("share-instagram"))==null||f.addEventListener("click",()=>{var B,S;const x=(B=document.getElementById("share-link-input"))==null?void 0:B.value;x&&((S=navigator.clipboard)==null||S.writeText(x),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(w=document.getElementById("share-email"))==null||w.addEventListener("click",()=>{var C,T;const x=(C=document.getElementById("share-link-input"))==null?void 0:C.value;if(!x)return;const B=((T=document.getElementById("view-modal-title"))==null?void 0:T.textContent)||"Imóvel",S=encodeURIComponent("Imóvel: "+B),k=encodeURIComponent(`Olá! Segue o link do imóvel:

`+x);window.open("mailto:?subject="+S+"&body="+k,"_blank")}),(L=document.getElementById("share-copy"))==null||L.addEventListener("click",()=>{var B;const x=document.getElementById("share-link-input");x&&((B=navigator.clipboard)==null||B.writeText(x.value).then(()=>{const S=document.getElementById("share-copy"),k=S.textContent;S.textContent="✅ Copiado!",setTimeout(()=>{S.textContent=k},2e3)}))}),(I=document.getElementById("view-modal-edit"))==null||I.addEventListener("click",()=>{var D;if((v==null?void 0:v.role)!=="admin")return;const x=document.getElementById("view-modal-title").textContent,B=_.find(N=>N.title===x);if(!B)return;Ee(),R=B.id;const S=document.getElementById("property-form"),k=document.getElementById("form-submit-btn");k.textContent="Salvar Alterações",S.querySelector('[name="title"]').value=B.title||"",S.querySelector('[name="rua"]').value=B.rua||"",S.querySelector('[name="numero"]').value=B.numero||"",S.querySelector('[name="city"]').value=B.city||"",S.querySelector('[name="price"]').value=B.price||"",S.querySelector('[name="bedrooms"]').value=B.bedrooms||"",S.querySelector('[name="suites"]').value=B.suites||"",S.querySelector('[name="parking"]').value=B.parking||"",S.querySelector('[name="description"]').value=B.description||"",S.querySelector('[name="construction_status"]').value=B.construction_status||"",S.querySelector('[name="owner_name"]').value=B.owner_name||"",S.querySelector('[name="owner_phone"]').value=B.owner_phone||"",S.querySelector('[name="owner_email"]').value=B.owner_email||"",S.querySelector('[name="owner_notes"]').value=B.owner_notes||"",S.querySelector('[name="condominium"]').value=B.condominium||"";const C=document.getElementById("adminPublished");C&&(C.value=B.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=B.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=B.neighborhood||"")},50)),G=B.cover_image||((D=B.images)==null?void 0:D[0])||"",xe(B.images||[]),Ae("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(x=>{x.addEventListener("click",()=>{var B;document.querySelectorAll(".tab-btn").forEach(S=>S.classList.remove("active")),x.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(S=>S.classList.add("hidden")),(B=document.getElementById(`tab-${x.dataset.tab}`))==null||B.classList.remove("hidden")})}),($=document.getElementById("admin-properties"))==null||$.addEventListener("click",x=>{if(x.target.closest(".action-btns"))return;const B=x.target.closest("tr");if(!B)return;const S=Number(B.dataset.id);if(!S)return;const k=_.find(C=>C.id===S);k&&At(k)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;await Promise.all([ft(),pt()]),K=V("company.whatsapp",K),pe=`https://wa.me/${K}`,He(),_t(),Ct();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(Oe(),e.addEventListener("change",()=>{const i=J().find(m=>m.name===e.value),r=i?je(i.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+r.map(m=>`<option value="${m.name}">${h(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),r=new URLSearchParams(window.location.search),m=i.get("type")||r.get("type")||"",p=it||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||r.has("code"),c=document.getElementById("password-reset-overlay");if(p){n.style.display="none",a&&a.classList.add("hidden"),c&&(c.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async u=>{var I,$;u.preventDefault();const b=((I=document.getElementById("new-password"))==null?void 0:I.value)||"",E=(($=document.getElementById("confirm-password"))==null?void 0:$.value)||"",f=document.getElementById("password-reset-msg"),w=u.target.querySelector('button[type="submit"]');if(f&&(f.style.display="none"),b!==E){f&&(f.textContent="As senhas não coincidem.",f.style.display="");return}w&&(w.disabled=!0,w.textContent="Salvando…");const{error:L}=await y.auth.updateUser({password:b});if(L){f&&(f.textContent="Erro: "+L.message,f.style.display=""),w&&(w.disabled=!1,w.textContent="Definir Senha");return}window.location.href=window.location.pathname}),r.has("code")&&await y.auth.exchangeCodeForSession(r.get("code")??"");return}const{data:{session:g}}=await y.auth.getSession();if(g){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),tt(),Ht(),window.lucide&&lucide.createIcons(),v=await We(g.user.id),!v){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(v.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const u=document.getElementById("password-reset-overlay");u&&(u.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async b=>{var $,x;b.preventDefault();const E=(($=document.getElementById("new-password"))==null?void 0:$.value)||"",f=((x=document.getElementById("confirm-password"))==null?void 0:x.value)||"",w=document.getElementById("password-reset-msg"),L=b.target.querySelector('button[type="submit"]');if(w&&(w.style.display="none"),E!==f){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}if(E.length<6){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}L&&(L.disabled=!0,L.textContent="Salvando…");const{error:I}=await y.auth.updateUser({password:E});if(I){w&&(w.textContent="Erro: "+I.message,w.style.display=""),L&&(L.disabled=!1,L.textContent="Definir Senha");return}await y.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}Ve((v==null?void 0:v.tenant_id)||null),Le(v),Ye(v.role),await Ie(),await et(v),window.lucide&&lucide.createIcons(),Vt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const u=document.getElementById("login-form");u&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var f,w;const b=(w=(f=u.querySelector('input[name="email"]'))==null?void 0:f.value)==null?void 0:w.trim();if(!b){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:E}=await y.auth.resetPasswordForEmail(b,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(E?"Erro: "+E.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),u.addEventListener("submit",async b=>{b.preventDefault();const E=new FormData(u),f=E.get("email"),w=E.get("password");if(await Lt(f,w)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),qe(),tt(),window.lucide&&lucide.createIcons();const{data:{session:I}}=await y.auth.getSession();if(v=I?await We(I.user.id):null,!v){await y.auth.signOut();return}if(v.active===!1){await y.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Ve((v==null?void 0:v.tenant_id)||null),Le(v),Ye(v.role),await Ie(),await et(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else qe();await fe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();yt(o),bt(K)});async function Qt(){const e=_.filter(o=>!o.reference);if(!e.length)return;const t=_.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,s)=>o.id-s.id);for(const o of a){const s="IO-"+String(n).padStart(4,"0"),{error:l}=await y.from("properties").update({reference:s}).eq("id",o.id);if(!l){const d=_.findIndex(i=>i.id===o.id);d>=0&&(_[d].reference=s),n++}}ye(Ue(_))}async function Zt(){const e=_.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(s=>!s.includes("/wm-")))continue;const a=[];let o=!1;for(const s of t.images)if(s.includes("/wm-"))a.push(s);else try{const l=await ea(s);a.push(l),o=!0}catch{a.push(s)}if(o){await y.from("properties").update({images:a}).eq("id",t.id);const s=_.findIndex(l=>l.id===t.id);s>=0&&(_[s].images=a)}}ye(Ue(_))}}async function ea(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),s=o.ok?await o.blob():null,l=s?URL.createObjectURL(s):null;return new Promise(d=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(a);const r=document.createElement("canvas"),m=1200;let p=i.width,c=i.height;p>m&&(c=Math.round(c*m/p),p=m),r.width=p,r.height=c;const g=r.getContext("2d");g.drawImage(i,0,0,p,c);const u=b=>{if(b){const E=Math.round(p*.18),f=Math.round(b.naturalHeight*E/b.naturalWidth),w=Math.round(p*.02);g.globalAlpha=.45,g.drawImage(b,p-E-w,c-f-w,E,f),g.globalAlpha=1}r.toBlob(async E=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await y.storage.from("imoveis").upload(f,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),d(e);return}const{data:{publicUrl:L}}=y.storage.from("imoveis").getPublicUrl(f);d(L)}catch(f){console.error("Watermark upload exception:",f),d(e)}},"image/jpeg",.82)};if(l){const b=new Image;b.onload=()=>{URL.revokeObjectURL(l),u(b)},b.onerror=()=>{URL.revokeObjectURL(l),u(null)},b.src=l}else u(null)},i.onerror=()=>{URL.revokeObjectURL(a),d(e)},i.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function U(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function De(e,t="assets"){const n=await he(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await y.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:s}}=y.storage.from("imoveis").getPublicUrl(a);return s}async function ta(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("settings").select("key,value").eq("tenant_id",Re()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>h(String(n[o]||""));e.innerHTML=`
  ...
  `;function i(m,p,c){const g=document.getElementById(m),u=document.getElementById(p);g==null||g.addEventListener("input",b=>{u.value=b.target.value,c()}),u==null||u.addEventListener("input",b=>{/^#[0-9a-fA-F]{6}$/.test(b.target.value)&&(g.value=b.target.value,c())})}function r(){var p,c,g,u;const m=((p=document.getElementById("col-accent-hex"))==null?void 0:p.value)||"#b8962e";(c=document.getElementById("vp-bar"))==null||c.style.setProperty("background",m),(g=document.getElementById("vp-dot"))==null||g.style.setProperty("background",m),(u=document.getElementById("vp-btn"))==null||u.style.setProperty("background",m),document.documentElement.style.setProperty("--accent",m)}i("col-accent","col-accent-hex",r),i("col-primary","col-primary-hex",()=>{}),i("col-secondary","col-secondary-hex",()=>{}),r(),document.getElementById("vis-hero-file").addEventListener("change",async m=>{const p=m.target.files[0];if(p)try{const c=await De(p,"hero");document.getElementById("vis-hero-url").value=c;const g=document.getElementById("vis-hero-preview");g.innerHTML=`<img src="${c}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,g.style.display=""}catch(c){alert("Erro no upload: "+c.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const m=document.getElementById("visual-save-colors");m.disabled=!0,m.textContent="Salvando…";const p=await Z([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);p&&He(),m.disabled=!1,m.textContent="Salvar Cores",U(document.getElementById("visual-colors-msg"),p)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",r())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const m=document.getElementById("visual-save-images");m.disabled=!0,m.textContent="Salvando…";const p=await Z([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);m.disabled=!1,m.textContent="Salvar Imagens",U(document.getElementById("visual-images-msg"),p)})}async function na(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("site_content").select("*").eq("tenant_id",Re()),n={};t==null||t.forEach(i=>{n[i.key]=i});const a=(i,r)=>{var m;return h(((m=n[i])==null?void 0:m[`value_${r}`])||"")},o=["pt","en","es"],s={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},l=i=>o.map(r=>`<button class="content-tab${r===i?" active":""}" data-lang="${r}">${s[r]}</button>`).join(""),d=i=>`
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const c=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,u=parseInt(document.getElementById("crm-pipe-sel").value,10);c&&(await y.from("crm_stages").insert({pipeline_id:u,name:c,color:g,sort_order:99}),document.getElementById("crm-new-stage").value="",await z())}),e.querySelectorAll(".stage-del").forEach(c=>{c.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await y.from("crm_stages").delete().eq("id",c.dataset.id),await z())})}),e.querySelectorAll(".stage-color-pick").forEach(c=>{c.addEventListener("change",async g=>{await y.from("crm_stages").update({color:g.target.value}).eq("id",c.dataset.sid);const u=c.closest(".stage-item").querySelector(".stage-color-dot");u&&(u.style.background=g.target.value)})}),document.getElementById("crm-add-tag").addEventListener("click",async()=>{const c=document.getElementById("crm-new-tag").value.trim(),g=document.getElementById("crm-new-tag-color").value;c&&(await y.from("crm_tags").insert({name:c,color:g}),document.getElementById("crm-new-tag").value="",await z())}),e.querySelectorAll(".tag-chip-del").forEach(c=>{c.addEventListener("click",async()=>{await y.from("crm_tags").delete().eq("id",c.dataset.id),await z()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const c=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,u=document.getElementById("crm-new-status-final").checked;c&&(await y.from("crm_lead_statuses").insert({name:c,color:g,is_final:u,sort_order:99}),document.getElementById("crm-new-status").value="",await z())}),e.querySelectorAll(".status-del").forEach(c=>{c.addEventListener("click",async()=>{confirm("Remover este status?")&&(await y.from("crm_lead_statuses").delete().eq("id",c.dataset.id),await z())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var g;const c=(g=prompt("Nome do novo funil:"))==null?void 0:g.trim();c&&(await y.from("crm_pipelines").insert({name:c,sort_order:99}),await z())})}async function sa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await y.from("integrations").select("*"),n={};t==null||t.forEach(d=>{n[d.key]=d});const a=d=>{var i;return h(((i=n[d])==null?void 0:i.value)||"")},o=d=>{var i;return(i=n[d])!=null&&i.enabled?"checked":""},s=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],l=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await Ne(),document.getElementById("media-file-input").addEventListener("change",async n=>{var i,r;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),s=document.getElementById("media-progress-fill"),l=document.getElementById("media-progress-text");o.style.display="";let d=0;for(const m of a){l.textContent=`Enviando ${d+1}/${a.length}…`,s.style.width=`${Math.round(d/a.length*100)}%`;try{const p=await De(m,"media"),c=m.name.replace(/\.[^.]+$/,"").slice(0,60);await y.from("media_library").insert({name:c,url:p,type:"image",size:m.size,created_by:(r=(i=(await y.auth.getUser()).data)==null?void 0:i.user)==null?void 0:r.id})}catch(p){console.error("Media upload error:",p)}d++}s.style.width="100%",l.textContent=`✓ ${d} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",s.style.width="0"},2e3),await Ne(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function Ne(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await y.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(i=>i.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&X(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&da(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&at(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&nt(),l.dataset.tab==="platform"&&ot()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",at),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",X),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",nt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>ma()),(s=e.querySelector("#sa-plat-save"))==null||s.addEventListener("click",ra),X(),ot())}async function X(){var d,i;const e=document.getElementById("sa-tenants-list"),t=((i=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=y.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const s=(a||[]).filter(r=>{var m,p;return!t||((m=r.name)==null?void 0:m.toLowerCase().includes(t))||((p=r.slug)==null?void 0:p.toLowerCase().includes(t))});if(!s.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=r=>r.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=s.map(r=>{var m;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(r=>{r.addEventListener("click",async()=>{const m=r.dataset.active==="true";await y.from("tenants").update({active:!m}).eq("id",r.dataset.id),X()})}),e.querySelectorAll('[data-action="edit-tenant"]').forEach(r=>{r.addEventListener("click",()=>{const m=(s||[]).find(p=>String(p.id)===String(r.dataset.id));m&&ua(m)})})}async function da(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await y.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `}).join("")}async function ot(){const[e,t,n,a]=await Promise.all([y.from("tenants").select("id",{count:"exact",head:!0}),y.from("profiles").select("id",{count:"exact",head:!0}),y.from("subscriptions").select("id",{count:"exact",head:!0}).eq("status","active"),y.from("properties").select("id",{count:"exact",head:!0}).eq("published",!0)]),o=(s,l)=>{const d=document.getElementById(s);d&&(d.textContent=l??"—")};o("sa-stat-tenants",e.count),o("sa-stat-users",t.count),o("sa-stat-subs",n.count),o("sa-stat-props",a.count)}async function ra(){var n,a,o;const e=document.getElementById("sa-plat-save"),t=document.getElementById("sa-plat-msg");e&&(e.disabled=!0,e.textContent="Salvando…"),await Z([{key:"platform.name",value:((n=document.getElementById("sa-plat-name"))==null?void 0:n.value)||""},{key:"platform.support_email",value:((a=document.getElementById("sa-plat-email"))==null?void 0:a.value)||""},{key:"platform.trial_days",value:((o=document.getElementById("sa-plat-trial"))==null?void 0:o.value)||"14"}]),e&&(e.disabled=!1,e.textContent="Salvar Configurações"),U(t,!0)}function ca(e){return e.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}function ma(){var a,o,s,l,d,i;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const t=document.createElement("div");t.id="sa-new-tenant-modal",t.className="sa-modal-backdrop",t.innerHTML=`
  ...
  `,document.body.appendChild(t),y.from("plans").select("id, name").then(({data:r})=>{const m=document.getElementById("nt-plan");m&&r&&(m.innerHTML='<option value="">Sem plano</option>'+r.map(p=>`<option value="${p.id}">${h(p.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",r=>{const m=document.getElementById("nt-slug");m&&!m.dataset.manual&&(m.value=ca(r.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",r=>{r.target.dataset.manual="1"}),(s=document.getElementById("nt-pwd-toggle"))==null||s.addEventListener("click",()=>{const r=document.getElementById("nt-admin-password");r.type=r.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",r=>{r.target===t&&n()}),(i=document.getElementById("nt-save"))==null||i.addEventListener("click",async()=>{var $,x,B,S,k,C,T,D,N,se,ie,le;const r=(x=($=document.getElementById("nt-name"))==null?void 0:$.value)==null?void 0:x.trim(),m=(S=(B=document.getElementById("nt-slug"))==null?void 0:B.value)==null?void 0:S.trim(),p=(C=(k=document.getElementById("nt-domain"))==null?void 0:k.value)==null?void 0:C.trim(),c=(T=document.getElementById("nt-plan"))==null?void 0:T.value,g=(N=(D=document.getElementById("nt-admin-email"))==null?void 0:D.value)==null?void 0:N.trim(),u=(ie=(se=document.getElementById("nt-admin-password"))==null?void 0:se.value)==null?void 0:ie.trim(),b=document.getElementById("nt-msg"),E=document.getElementById("nt-save");if(!r||!m){b.textContent="❌ Nome e slug são obrigatórios.",b.style.color="#ef4444";return}if(!g){b.textContent="❌ Informe o e-mail do admin.",b.style.color="#ef4444";return}if(!u||u.length<6){b.textContent="❌ A senha precisa ter mínimo 6 caracteres.",b.style.color="#ef4444";return}E.disabled=!0,E.textContent="Criando…",b.textContent="⏳ Criando imobiliária…",b.style.color="#64748b";const{data:f,error:w}=await y.from("tenants").insert({name:r,slug:m,domain:p||null,plan_id:c||null,active:!0}).select();if(w){E.disabled=!1,E.textContent="Criar Imobiliária",b.textContent="❌ "+w.message,b.style.color="#ef4444";return}const L=(le=f==null?void 0:f[0])==null?void 0:le.id;b.textContent="⏳ Criando usuário admin…";const I=await oe({email:g,password:u,role:"admin",tenant_id:L});if(!(I!=null&&I.success)){E.disabled=!1,E.textContent="Criar Imobiliária",b.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+h((I==null?void 0:I.error)||"Desconhecido"),b.style.color="#f59e0b",setTimeout(()=>{n(),X()},3e3);return}L&&(I!=null&&I.user_id)&&!(I!=null&&I.linked)&&await y.from("profiles").update({tenant_id:L}).eq("id",I.user_id),E.disabled=!1,E.textContent="Criar Imobiliária",I.email_sent===!1?(b.innerHTML=`
        ✅ Imobiliária e admin criados!<br>
        <span style="color:#ef4444;">⚠️ E-mail não enviado (${h(I.email_error||"erro desconhecido")}).</span><br>
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px;margin-top:8px;font-size:12px;">
          E-mail: <strong>${h(g)}</strong><br>
          Senha: <strong>${h(u)}</strong>
        </div>`,b.style.color="#0f172a"):(b.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",b.style.color="#22c55e",setTimeout(()=>{n(),X()},1500))})}function ua(e){var o,s,l,d,i,r,m,p,c;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop",n.innerHTML=`
      ...
      <div class="sa-modal-body">
        ...
        <div style="display:flex;align-items:center;gap:16px;margin-bottom:20px;">
          <div id="et-logo-preview" style="width:72px;height:72px;border-radius:12px;border:2px dashed #e2e8f0;display:flex;align-items:center;justify-content:center;overflow:hidden;background:#f8fafc;flex-shrink:0;cursor:pointer;" title="Clique para alterar a logo">
            ${e.logo_url?`<img src="${h(e.logo_url)}" style="width:100%;height:100%;object-fit:cover;" id="et-logo-img">`:'<span style="font-size:28px;">🏢</span>'}
          </div>
          <div>
        ...
        <div style="height:1px;background:#e2e8f0;margin:16px 0;"></div>
        <div style="font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;color:#94a3b8;margin-bottom:10px;">🔑 Chave de API (Integração)</div>
        <p style="font-size:12px;color:#64748b;margin-bottom:10px;">Use esta chave para conectar qualquer site externo ao CRM desta imobiliária.</p>
        <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px;">
          <input id="et-api-key" class="form-input" type="text" value="${h(e.api_key||"Gerando…")}" readonly style="font-family:monospace;font-size:12px;background:#f8fafc;color:#374151;flex:1;">
          <button id="et-copy-key" class="btn-secondary-sm" style="white-space:nowrap;">📋 Copiar</button>
          <button id="et-regen-key" class="btn-secondary-sm" style="white-space:nowrap;" title="Gera nova chave (invalida a anterior)">🔄</button>
        </div>
        <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:8px;padding:12px;margin-bottom:4px;">
          <div style="font-size:11px;font-weight:700;color:#0369a1;margin-bottom:6px;">COMO USAR</div>
          <div style="font-size:11px;font-family:monospace;color:#0f172a;line-height:1.8;">
            <div style="color:#64748b">// Listar imóveis</div>
            GET ${`https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api/properties?key=${h(e.api_key||"SUA_CHAVE")}`}<br>
            <div style="color:#64748b;margin-top:6px">// Enviar lead (contato)</div>
            POST …/public-api/leads?key=CHAVE<br>
            <div style="color:#64748b;margin-top:6px">// Buscar configurações</div>
            GET …/public-api/settings?key=CHAVE
          </div>
        </div>
  ...
  `,document.body.appendChild(n),y.from("plans").select("id, name").then(({data:g})=>{const u=document.getElementById("et-plan");u&&g&&(u.innerHTML='<option value="">Sem plano</option>'+g.map(b=>`<option value="${b.id}"${String(b.id)===String(e.plan_id)?" selected":""}>${h(b.name)}</option>`).join(""))}),(o=document.getElementById("et-logo-input"))==null||o.addEventListener("change",g=>{const u=g.target.files[0];if(!u)return;const b=URL.createObjectURL(u),E=document.getElementById("et-logo-preview");E&&(E.innerHTML=`<img src="${b}" style="width:100%;height:100%;object-fit:cover;">`)}),(s=document.getElementById("et-logo-preview"))==null||s.addEventListener("click",()=>{var g;(g=document.getElementById("et-logo-input"))==null||g.click()}),(l=document.getElementById("et-pwd-toggle"))==null||l.addEventListener("click",()=>{const g=document.getElementById("et-admin-password");g.type=g.type==="password"?"text":"password"}),(d=document.getElementById("et-copy-key"))==null||d.addEventListener("click",()=>{var E,f;const g=(E=document.getElementById("et-api-key"))==null?void 0:E.value;if(!g)return;(f=navigator.clipboard)==null||f.writeText(g);const u=document.getElementById("et-copy-key"),b=u.textContent;u.textContent="✅ Copiada!",setTimeout(()=>{u.textContent=b},2e3)}),(i=document.getElementById("et-regen-key"))==null||i.addEventListener("click",async()=>{if(!confirm("Gerar nova chave? A chave atual será invalidada e sites integrados deixarão de funcionar até atualizar."))return;const g=document.getElementById("et-regen-key");g.disabled=!0,g.textContent="⏳";const u=crypto.randomUUID(),{error:b}=await y.from("tenants").update({api_key:u}).eq("id",e.id);if(g.disabled=!1,g.textContent="🔄",b){alert("Erro: "+b.message);return}const E=document.getElementById("et-api-key");E&&(E.value=u),e.api_key=u});const a=()=>n.remove();(r=document.getElementById("et-close"))==null||r.addEventListener("click",a),(m=document.getElementById("et-cancel"))==null||m.addEventListener("click",a),n.addEventListener("click",g=>{g.target===n&&a()}),(p=document.getElementById("et-delete"))==null||p.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const u=document.getElementById("et-delete");u.disabled=!0,u.textContent="Excluindo…";const{error:b}=await y.from("tenants").delete().eq("id",e.id);if(b){alert("Erro ao excluir: "+b.message),u.disabled=!1,u.textContent="🗑️ Excluir";return}a(),X()}),(c=document.getElementById("et-save"))==null||c.addEventListener("click",async()=>{var S,k,C,T,D,N,se,ie,le,ze,Pe,Fe;const g=(k=(S=document.getElementById("et-name"))==null?void 0:S.value)==null?void 0:k.trim(),u=(T=(C=document.getElementById("et-slug"))==null?void 0:C.value)==null?void 0:T.trim(),b=(N=(D=document.getElementById("et-domain"))==null?void 0:D.value)==null?void 0:N.trim(),E=(se=document.getElementById("et-plan"))==null?void 0:se.value,f=(le=(ie=document.getElementById("et-admin-email"))==null?void 0:ie.value)==null?void 0:le.trim(),w=(Pe=(ze=document.getElementById("et-admin-password"))==null?void 0:ze.value)==null?void 0:Pe.trim(),L=(Fe=document.getElementById("et-logo-input"))==null?void 0:Fe.files[0],I=document.getElementById("et-msg"),$=document.getElementById("et-save");if(!g){I.textContent="❌ Nome é obrigatório.",I.style.color="#ef4444";return}$.disabled=!0,$.textContent="Salvando…",I.textContent="⏳ Salvando…",I.style.color="#64748b";let x=e.logo_url;if(L)try{const q=await he(L,256,.85),Xe=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:vt}=await y.storage.from("imoveis").upload(Xe,q,{contentType:"image/jpeg",upsert:!0});if(!vt){const{data:{publicUrl:gt}}=y.storage.from("imoveis").getPublicUrl(Xe);x=gt}}catch(q){console.error("Logo upload:",q)}const{error:B}=await y.from("tenants").update({name:g,slug:u||e.slug,domain:b||null,plan_id:E||null,logo_url:x}).eq("id",e.id);if(B){$.disabled=!1,$.textContent="Salvar",I.textContent="❌ "+B.message,I.style.color="#ef4444";return}if(f&&w&&w.length>=6){I.textContent="⏳ Criando usuário admin…";const q=await oe({email:f,password:w,role:"admin",tenant_id:e.id});q!=null&&q.success?(q!=null&&q.user_id&&!(q!=null&&q.linked)&&await y.from("profiles").update({tenant_id:e.id}).eq("id",q.user_id),I.textContent="✅ Salvo e admin criado!",I.style.color="#22c55e"):(I.textContent="⚠️ Salvo, mas erro ao criar admin: "+((q==null?void 0:q.error)||"Tente novamente"),I.style.color="#f59e0b")}else I.textContent="✅ Imobiliária atualizada!",I.style.color="#22c55e";$.disabled=!1,$.textContent="Salvar",setTimeout(()=>{a(),X()},1200)})}
