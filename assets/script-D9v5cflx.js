import{s as b}from"./supabase-BcuJ3xoD.js";const V="00000000-0000-0000-0000-000000000000";let ce={},xe={},se=V;function be(e){se=e||V,ce={},xe={}}const N=()=>se;async function wa(){const[e,t]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",se),b.from("site_content").select("*").eq("tenant_id",se)]);if(e.data&&e.data.forEach(n=>{ce[n.key]=n.value}),t.data&&t.data.forEach(n=>{xe[n.key]=n}),(!t.data||t.data.length===0)&&se!==V){const[n,a]=await Promise.all([b.from("settings").select("key,value").eq("tenant_id",V),b.from("site_content").select("*").eq("tenant_id",V)]);n.data&&n.data.forEach(o=>{ce[o.key]===void 0&&(ce[o.key]=o.value)}),a.data&&a.data.forEach(o=>{xe[o.key]||(xe[o.key]=o)})}}const K=(e,t=null)=>ce[e]!==void 0?ce[e]:t,_e=(e,t="pt")=>{const n=xe[e];return n&&(n["value_"+t]||n.value_pt)||null};async function we(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:se,updated_at:t})),{error:a}=await b.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{ce[o]=i}),!a}async function He(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:se,updated_at:o},{error:d}=await b.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(xe[e]=i),se!==V&&await b.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:V,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Ze(e,t,n){const{error:a}=await b.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function ft(){const e=document.documentElement,t=K("visual.accent_color","#b8962e"),n=K("visual.primary_bg","#0f1c2e"),a=K("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=K("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=K("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const l=K("visual.hero_bg_url","");if(l){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+l+"')")}}function $t(e){e=e||"pt";const t=f=>_e(f,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),l&&t("inst.bio_p3")&&(l.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),r=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),w=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),r&&t("inst.stat3_num")&&(r.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),w&&t("inst.stat3_label")&&(w.innerHTML=t("inst.stat3_label"));const E=document.getElementById("dep-grid");if(E){const f=_e("testimonials",e)||_e("testimonials","pt");if(f)try{const I=JSON.parse(f);if(Array.isArray(I)&&I.length>0){let S=function(p){return String(p||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},_=function(p){let g=0;for(const h of p||"?")g=g*31+h.charCodeAt(0)&4294967295;return $[Math.abs(g)%$.length]};const $=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];E.innerHTML=I.map(p=>`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio"),l=Zt(t);t.innerHTML=[a("Imóveis Disponíveis","var(--navy, #0d2144)",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","var(--navy, #0d2144)",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","var(--navy, #0d2144)",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","var(--navy, #0d2144)",d,"imoveis.html?collection=casas-condominio"):""].join(""),ea(t,l),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",yt),t.addEventListener("touchend",function(s){const c=s.target.closest(".carousel-btn");c&&(s.preventDefault(),s.stopPropagation(),ta(c.closest(".icard-img-wrap"),c.classList.contains("carousel-next")?1:-1))},{passive:!1}))}async function me(){var w,E,x,k,f,I;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await Gt();q=n,((w=document.getElementById("selecao-carousel"))==null?void 0:w.innerHTML)===""&&ja(n);const a=((E=document.getElementById("city-filter"))==null?void 0:E.value)||"",o=((x=document.getElementById("neighborhood-filter"))==null?void 0:x.value)||"",i=((k=document.getElementById("bedrooms-filter"))==null?void 0:k.value)||"",d=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",l=((I=document.getElementById("construction-filter"))==null?void 0:I.value)||"",{min:s,max:c}=Oa(),r=n.filter($=>{if(a&&$.city!==a||o&&$.neighborhood!==o||i&&(i==="4+"&&Number($.bedrooms)<4||i!=="4+"&&Number($.bedrooms)!==Number(i))||d&&(d==="4+"&&Number($.parking)<4||d!=="4+"&&Number($.parking)!==Number(d))||l&&$.construction_status!==l)return!1;const S=String($.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),_=parseInt(S,10)||0;return!(_<s||c!==1/0&&_>c)});if(e){Da(n);return}if(!r.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=Zt(t);t.innerHTML=r.map($=>ht($)).join(""),ea(t,m);const u=document.getElementById("properties");u&&!u._carouselDelegated&&(u._carouselDelegated=!0,u.addEventListener("click",yt))}function ja(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(l=>ht(l)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",yt));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(d=a==null?void 0:a.querySelector(".selecao-next"))==null||d.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),me()};function ta(e,t){var i;const n=parseInt(e.dataset.total,10);if(!n||n<2)return;let a=parseInt(e.dataset.idx,10)||0;a=(a+t+n)%n,e.dataset.idx=a;try{const d=JSON.parse(decodeURIComponent(e.dataset.images||"[]"));if(d.length&&d[a]){const l=qe(d[a]),s=e.querySelector(".carousel-img"),c=e.querySelector(".carousel-img-bg");s&&(s.src=l),c&&(c.src=l)}}catch{const l=q.find(u=>String(u.id)===String(e.dataset.pid)),s=(i=l==null?void 0:l.images)!=null&&i.length?l.images:Ie,c=e.querySelector(".carousel-img"),r=e.querySelector(".carousel-img-bg"),m=s[a]?qe(s[a]):"";c&&m&&(c.src=m),r&&m&&(r.src=m)}const o=e.querySelectorAll(".icard-dot");if(o.length){const d=a%o.length;o.forEach((l,s)=>l.classList.toggle("active",s===d))}}function yt(e){const t=e.target.closest(".carousel-btn");if(t){e.preventDefault(),e.stopPropagation();const a=t.closest(".icard-img-wrap");a&&ta(a,t.classList.contains("carousel-next")?1:-1);return}if(e.target.closest(".icard-wa")||e.target.closest(".icard-heart"))return;const n=e.target.closest("[data-href]");if(n){e.preventDefault(),window.location.href=n.dataset.href;return}}function Oa(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function Ha(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>me())}function Ua(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=fe();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=fe().find(i=>i.name===e.value),o=a?xt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${v(i.name)}</option>`).join(""),me()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",me)})}function Me(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var d;const a=n.cover_image||((d=n.images)==null?void 0:d[0])||Ie[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
      ...
      <td class="cell-price">${v(Re(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
...
${l}`),c=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",r=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",m=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",u=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",w=Math.max(1,Math.min(a,6)),E=`<div class="icard-dots">${Array.from({length:w},(k,f)=>`<span class="icard-dot${f===0?" active":""}"></span>`).join("")}</div>`;return`
  ...
  `}let ie=[],Q=0;function Ga(e){var m,u;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||Ie[0];document.getElementById("view-thumb-preview").src=i,ie=(u=e.images)!=null&&u.length?e.images:Ie,Q=0,Ge(),document.getElementById("view-price").textContent=Re(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(w=>w.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(w=>w.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=s);const r=document.getElementById("share-panel");r&&(r.style.display="none",r.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function je(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Ge(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ie[Q],e.alt=`Foto ${Q+1}`;const i=ie.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Q+1} / ${ie.length}`:"",o.innerHTML=i?ie.map((d,l)=>`<img src="${d}" class="view-thumb${l===Q?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{Q=+d.dataset.i,Ge()})})}async function Bt(e){const{data:t}=await b.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Je(e){var m,u;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const l=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),r=document.getElementById("avatar-dd-initial");l&&(l.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",r&&(r.style.display="none")):(r&&(r.textContent=((u=i[0])==null?void 0:u.toUpperCase())||"?",r.style.display=""),c&&(c.style.display="none"))}async function Ct(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||N(),a=n&&n!==V,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await b.from("tenants").select("domain").eq("id",n).maybeSingle(),l=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==l&&(t.href=`https://${s}`)}catch{}}const Oe={dashboard:()=>Ln(),empresa:()=>ra(),visual:()=>la(),"site-config":()=>ca(),"crm-config":()=>ma(),integracoes:()=>pa(),midia:()=>ua(),depoimentos:()=>da()};function ae(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Oe<"u"&&Oe[e]){const o=Oe[e];Oe[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),Z(),e==="contatos"&&on(),e==="funil"&&Ka(),e==="tarefas"&&Qa()}function Tt(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:ra,visual:la,"site-config":ca,"crm-config":ma,integracoes:pa,midia:ua,depoimentos:da}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>un(),{once:!0}),window.lucide&&lucide.createIcons()}}function Z(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function Ja(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("cp-close"))==null||a.addEventListener("click",n),(o=document.getElementById("cp-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",d=>{d.target===t&&n()}),(i=document.getElementById("cp-save"))==null||i.addEventListener("click",async()=>{var m,u;const d=((m=document.getElementById("cp-new"))==null?void 0:m.value)||"",l=((u=document.getElementById("cp-confirm"))==null?void 0:u.value)||"",s=document.getElementById("cp-msg"),c=document.getElementById("cp-save");if(s.style.display="none",d.length<12){s.style.color="#ef4444",s.textContent="Mínimo 6 caracteres.",s.style.display="";return}if(d!==l){s.style.color="#ef4444",s.textContent="As senhas não coincidem.",s.style.display="";return}c.disabled=!0,c.textContent="Salvando…";const{error:r}=await b.auth.updateUser({password:d});if(c.disabled=!1,c.textContent="Salvar Senha",r){s.style.color="#ef4444",s.textContent="Erro: "+r.message,s.style.display="";return}s.style.color="#16a34a",s.textContent="✅ Senha alterada com sucesso!",s.style.display="",setTimeout(n,1500)})}function Wa(){var i,d,l,s,c;const e=document.getElementById("change-photo-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-photo-modal-root",t.className="modal-backdrop";const n=((i=document.getElementById("topnav-avatar-img"))==null?void 0:i.src)||"",a=n&&!n.endsWith("/");t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(d=document.getElementById("cph-close"))==null||d.addEventListener("click",o),(l=document.getElementById("cph-cancel"))==null||l.addEventListener("click",o),t.addEventListener("click",r=>{r.target===t&&o()}),(s=document.getElementById("cph-file"))==null||s.addEventListener("change",r=>{const m=r.target.files[0];if(!m)return;const u=URL.createObjectURL(m),w=document.getElementById("cph-preview"),E=document.getElementById("cph-initial");w&&(w.src=u,w.style.display=""),E&&(E.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var w;const r=(w=document.getElementById("cph-file"))==null?void 0:w.files[0];if(!r)return;const m=document.getElementById("cph-save"),u=document.getElementById("cph-msg");m.disabled=!0,m.textContent="Salvando…";try{const E=await De(r,400,.85),x=`avatars/${y.id}-${Date.now()}.jpg`,{error:k}=await b.storage.from("imoveis").upload(x,E,{contentType:"image/jpeg",upsert:!0});if(k)throw k;const{data:{publicUrl:f}}=b.storage.from("imoveis").getPublicUrl(x);await b.from("profiles").update({avatar_url:f}).eq("id",y.id),y={...y,avatar_url:f},Je(y),o()}catch(E){u.style.color="#ef4444",u.textContent="Erro: "+E.message,u.style.display="",m.disabled=!1,m.textContent="Salvar Foto"}})}function st(e,t){var i,d,l;const n=document.getElementById("add-corretor-modal-root");n&&n.remove();const a=document.createElement("div");a.id="add-corretor-modal-root",a.className="modal-backdrop",a.innerHTML=`
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(l=document.getElementById("ac-save"))==null||l.addEventListener("click",async()=>{var u,w,E;const s=(u=document.getElementById("ac-email"))==null?void 0:u.value.trim(),c=(w=document.getElementById("ac-password"))==null?void 0:w.value.trim(),r=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!c||c.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}r.disabled=!0,r.textContent="Criando…",m.style.display="none";try{const x=e||(y==null?void 0:y.tenant_id)||null,k=((E=document.getElementById("ac-role"))==null?void 0:E.value)||"corretor",f=await ge({email:s,password:c,role:k,tenant_id:x});r.disabled=!1,r.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${v(s)}<br><strong>Senha:</strong> ${v(c)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(x){r.disabled=!1,r.textContent="+ Criar Acesso",alert("Erro: "+x.message)}})}function qt(){var i,d,l,s,c,r,m,u,w,E,x;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",k=>{var I;k.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(I=document.getElementById("notif-dropdown"))==null||I.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",k=>{k.stopPropagation(),Z(),Wa()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",k=>{k.stopPropagation(),Z(),Ja()}),(l=document.getElementById("avatar-dd-add-corretor"))==null||l.addEventListener("click",k=>{k.stopPropagation(),Z(),st()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",k=>{k.stopPropagation(),Z(),ae("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async k=>{k.stopPropagation(),await b.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",k=>{var I;k.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((I=document.getElementById("avatar-dropdown"))==null||I.classList.add("hidden"),en())}),(r=document.getElementById("notif-mark-all"))==null||r.addEventListener("click",()=>{tn(),Z()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var k,f;(k=document.getElementById("search-overlay"))==null||k.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var k;(k=document.getElementById("search-overlay"))==null||k.classList.add("hidden")}),(w=document.getElementById("search-overlay"))==null||w.addEventListener("click",k=>{k.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(E=document.getElementById("search-input"))==null||E.addEventListener("input",k=>{clearTimeout(o),o=setTimeout(()=>Za(k.target.value.trim()),280)}),(x=document.getElementById("search-input"))==null||x.addEventListener("keydown",k=>{var f;k.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",Z)}let dt=!1,W=[],We=[],Ke=[],pe={},aa=[],j=null,Le=null,J={search:"",tags:new Set,status:""};async function Ka(){var t;if(window._kanbanRefreshTimer&&clearInterval(window._kanbanRefreshTimer),window._kanbanRefreshTimer=setInterval(()=>{const n=document.querySelector('.section[data-section="funil"]');!n||n.offsetParent===null||Ne().catch(()=>{})},3e4),dt){await At();return}dt=!0,await At(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>lt()),xn();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{j=parseInt(e.value,10),await Ne()})}function rt(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+aa.map(d=>`<option value="${v(d.name)}">${v(d.name)}</option>`).join(""),n.value=J.status,n.onchange=()=>{J.status=n.value,le()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(d=>`<button class="kf-tag-btn${J.tags.has(d.name)?" active":""}" data-tag="${v(d.name)}"
          style="--kf-tc:${d.color}">
          ${v(d.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const l=d.dataset.tag;J.tags.has(l)?J.tags.delete(l):J.tags.add(l),rt(e),le()})})}const o=document.getElementById("kf-search");o&&(o.value=J.search,o.oninput=()=>{J.search=o.value.toLowerCase(),le()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{J={search:"",tags:new Set,status:""},rt(e),le()})}async function At(){const e=N(),[{data:t},{data:n},{data:a}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",e).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);W=t||[],aa=a||[],pe={},(n||[]).forEach(l=>{pe[l.name]=l});const o=W.map(l=>l.id),{data:i}=o.length?await b.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};We=i||[],rt(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const l=j;d.innerHTML=W.length?W.map(c=>`<option value="${c.id}">${v(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=W.find(c=>c.id===l)||W.find(c=>c.is_default)||W[0];s?(d.value=s.id,j=s.id):j=null}await Ne()}async function Ne(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),j&&(t=t.eq("pipeline_id",j));const{data:n}=await t;Ke=n||[],le()}function le(){const e=document.getElementById("kanban-board");if(!e)return;const t=We.filter(i=>i.pipeline_id===j);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=J,a=Ke.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(l=>d.includes(l)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var l,s,c,r;const d=i.stage||((l=t[0])==null?void 0:l.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(r=o[d]||o[(c=t[0])==null?void 0:c.name])==null||r.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],l=d.length?d.map(s=>{const c=(s.phone||"").replace(/\D/g,""),r=encodeURIComponent(`Olá ${s.name}! Aqui é da ${K("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${v(i.name)}" style="cursor:pointer;">
          ...
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map(m=>{const u=pe[m],w=(u==null?void 0:u.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${w}18;color:${w};border:1px solid ${w}44;">${v(m)}</span>`}).join(""):""}
          </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(f=>{const $=(pe[f]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(f)}" style="background:${$}18;color:${$};border-color:${$}55;">${v(f)}<span class="ldp-tag-rm" data-tag="${v(f)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform="translateX(0)"}),_n(r,a||[],pe);const m=r.querySelector("#ldp-pipe"),u=r.querySelector("#ldp-stage");m&&u&&m.addEventListener("change",()=>{const f=m.value,I=We.filter($=>$.pipeline_id===f);u.innerHTML=I.map($=>`<option value="${$.name}">${$.name}</option>`).join("")||'<option value="">— sem etapas —</option>'});const w=()=>{r.style.transform="translateX(100%)",setTimeout(()=>r.remove(),250)};document.getElementById("ldp-close").addEventListener("click",w),document.getElementById("ldp-save").addEventListener("click",async()=>{var B,C;const f=document.getElementById("ldp-save"),I=document.getElementById("ldp-msg"),$=document.getElementById("ldp-name").value.trim();if(!$){I.style.color="#ef4444",I.textContent="Nome é obrigatório.";return}f.disabled=!0,f.textContent="Salvando…";const S=[...r.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(T=>T.dataset.tag),_=document.getElementById("ldp-pipe"),p=_?_.value:i||j,g=t?typeof Lt=="function"?Lt():{}:{},h={name:$,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,pipeline_id:p||null,stage:((B=document.getElementById("ldp-stage"))==null?void 0:B.value)||null,status:((C=document.getElementById("ldp-status"))==null?void 0:C.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:S,tenant_id:N(),...t?{utm_source:g.utm_source||null,utm_medium:g.utm_medium||null,utm_campaign:g.utm_campaign||null,utm_content:g.utm_content||null,utm_term:g.utm_term||null,fbclid:g.fbclid||null,gclid:g.gclid||null,fbp:g.fbp||null,fbc:g.fbc||null,landing_url:g.landing_url||null,user_agent:navigator.userAgent||null}:{}};let L;if(t?{error:L}=await b.from("leads").insert(h):{error:L}=await b.from("leads").update(h).eq("id",e.id),f.disabled=!1,f.textContent="💾 Salvar",L){I.style.color="#ef4444",I.textContent="Erro: "+L.message;return}I.style.color="#22c55e",I.textContent="✅ Salvo!",w(),Ne().catch(T=>console.warn("[Kanban] reload falhou:",T)),t&&typeof sendLeadToCAPI=="function"&&sendLeadToCAPI({name:h.name,email:h.email,phone:h.phone,tracking:g}).then(async T=>{if(T!=null&&T.ok){console.log("[CAPI] Lead enviado ao Meta:",T.event_id);try{await b.from("leads").update({capi_event_id:T.event_id,capi_sent_at:new Date().toISOString()}).eq("name",h.name).eq("phone",h.phone||"").order("created_at",{ascending:!1}).limit(1)}catch(A){console.warn("[CAPI] falha ao salvar event_id:",A)}}else console.warn("[CAPI] não confirmado pelo Meta:",T)}).catch(T=>console.warn("[CAPI] erro:",T))}),(k=document.getElementById("ldp-delete"))==null||k.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await b.from("leads").delete().eq("id",e.id),w(),Ne())})}let U=[],Mt=!1,he="pending";async function Qa(){var e;window._tarefasRefreshTimer&&clearInterval(window._tarefasRefreshTimer),window._tarefasRefreshTimer=setInterval(()=>{const t=document.querySelector('.section[data-section="tarefas"]');!t||t.offsetParent===null||zt().catch(()=>{})},3e4),!Mt&&(Mt=!0,await zt(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>oa()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),he=t.dataset.filter,ke()})}))}async function zt(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=b.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  `,document.body.appendChild(d);const l=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",l),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",l),d.addEventListener("click",u=>{u.target===d&&l()}),(r=document.getElementById("tm-toggle-done"))==null||r.addEventListener("click",async()=>{const u=a?"pending":"done";await b.from("tasks").update({status:u}).eq("id",e.id);const w=U.find(E=>String(E.id)===String(e.id));w&&(w.status=u),l(),u==="done"&&(he="done",document.querySelectorAll(".tarefa-filter-btn").forEach(E=>{E.classList.toggle("active",E.dataset.filter==="done")})),ke()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var f,I;const u=document.getElementById("tarefa-form");if(!u.checkValidity()){u.reportValidity();return}const w=new FormData(u),E=document.getElementById("tm-save");E.disabled=!0,E.textContent="Salvando…";const x={title:(f=w.get("title"))==null?void 0:f.trim(),description:((I=w.get("description"))==null?void 0:I.trim())||null,due_date:w.get("due_date")||null,priority:w.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null};let k;if(n){if({error:k}=await b.from("tasks").update(x).eq("id",e.id),!k){const $=U.findIndex(S=>String(S.id)===String(e.id));$>=0&&(U[$]={...U[$],...x})}}else{const{data:$,error:S}=await b.from("tasks").insert(x).select();k=S,!k&&($!=null&&$[0])&&U.unshift($[0])}if(E.disabled=!1,E.textContent=n?"Salvar":"Criar Tarefa",k){alert("Erro: "+k.message);return}l(),ke()})}async function Za(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([b.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),b.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",l=>{l.preventDefault(),Z(),ae("contatos")}),e.querySelectorAll(".notif-item").forEach(l=>{l.addEventListener("click",()=>{te.push(l.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(te)),l.classList.remove("unread"),Z(),ae("contatos")})})}function tn(){var e;document.querySelectorAll(".notif-item").forEach(t=>te.push(t.dataset.id)),te=[...new Set(te)],localStorage.setItem("crm_notifs_read",JSON.stringify(te)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function an(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function nn(){let e=b.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!te.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let Y=[],H=1;const Be=10;let Nt=!1;async function on(){var t,n,a,o,i,d,l,s,c;window._contatosRefreshTimer&&clearInterval(window._contatosRefreshTimer),window._contatosRefreshTimer=setInterval(()=>{const r=document.querySelector('.section[data-section="contatos"]');!r||r.offsetParent===null||ct().catch(()=>{})},3e4),document.getElementById("section-contatos")&&(Nt||(Nt=!0,await ct(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{H=1,ue()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",r=>{r.key==="Enter"&&(H=1,ue())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>ia()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",rn),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",mt),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",mt),(l=document.getElementById("download-template"))==null||l.addEventListener("click",r=>{r.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([m],{type:"text/csv"}),w=document.createElement("a");w.href=URL.createObjectURL(u),w.download="modelo_contatos.csv",w.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",sn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",dn)))}async function ct(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=b.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;Y=a||[],ue()}function ue(){var l,s,c;const e=(((l=document.getElementById("contato-search"))==null?void 0:l.value)||"").toLowerCase(),t=e?Y.filter(r=>(r.name||"").toLowerCase().includes(e)||(r.email||"").toLowerCase().includes(e)||(r.phone||"").toLowerCase().includes(e)):Y,n=t.length,a=Math.max(1,Math.ceil(n/Be));H>a&&(H=a);const o=t.slice((H-1)*Be,H*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(r=>`
      <tr>
    ...
    `,(s=d.querySelector("#pag-prev"))==null||s.addEventListener("click",()=>{H--,ue()}),(c=d.querySelector("#pag-next"))==null||c.addEventListener("click",()=>{H++,ue()})}document.querySelectorAll(".contato-edit-btn, .contato-name-link").forEach(r=>{r.addEventListener("click",m=>{m.preventDefault();const u=r.dataset.id,w=Y.find(E=>String(E.id)===String(u));w&&ia(w)})})}async function ia(e=null){var f,I,$,S,_,p;const t=document.getElementById("contato-modal-root");t&&t.remove();const n=!!e,a=N(),[{data:o},{data:i},{data:d}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",a).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",a).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",a).order("sort_order")]),l=o||[],s=i||[],c=d||[],r=l.map(g=>g.id),{data:m}=r.length?await b.from("crm_stages").select("*").in("pipeline_id",r).order("sort_order"):{data:[]},u=m||[],w=(e==null?void 0:e.pipeline_id)||((f=l[0])==null?void 0:f.id)||"";function E(g){const h=u.filter(L=>L.pipeline_id===g);return h.length?'<option value="">— Selecionar etapa —</option>'+h.map(L=>`<option value="${v(L.name)}" ${(e==null?void 0:e.stage)===L.name?"selected":""}>${v(L.name)}</option>`).join(""):'<option value="">— Nenhuma etapa —</option>'}const x=document.createElement("div");x.id="contato-modal-root",x.className="modal-backdrop",x.innerHTML=`
  ...
  `,document.body.appendChild(x);const k=()=>x.remove();(I=document.getElementById("cm-close"))==null||I.addEventListener("click",k),($=document.getElementById("cm-cancel"))==null||$.addEventListener("click",k),x.addEventListener("click",g=>{g.target===x&&k()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",g=>{const h=document.getElementById("cm-stage");h&&(h.innerHTML=E(g.target.value))}),(_=document.getElementById("cm-delete"))==null||_.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await b.from("leads").delete().eq("id",e.id);const g=Y.findIndex(h=>String(h.id)===String(e.id));g>=0&&Y.splice(g,1),k(),ue()}),(p=document.getElementById("cm-save"))==null||p.addEventListener("click",async()=>{var M,O,P,ne,re,$e,Se;const g=document.getElementById("contato-form");if(!g.checkValidity()){g.reportValidity();return}const h=new FormData(g),L=document.getElementById("cm-save");L.disabled=!0,L.textContent="Salvando…";const B=h.getAll("tag"),C=h.get("pipeline_id")||null,T={name:(M=h.get("name"))==null?void 0:M.trim(),company:((O=h.get("company"))==null?void 0:O.trim())||null,email:((P=h.get("email"))==null?void 0:P.trim())||null,phone:((ne=h.get("phone"))==null?void 0:ne.trim())||null,job_title:((re=h.get("job_title"))==null?void 0:re.trim())||null,city_interest:(($e=h.get("city_interest"))==null?void 0:$e.trim())||null,notes:((Se=h.get("notes"))==null?void 0:Se.trim())||null,pipeline_id:C,stage:h.get("stage")||null,status:h.get("status")||null,tags:B,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let A;if(n){if({error:A}=await b.from("leads").update(T).eq("id",e.id),!A){const F=Y.findIndex(ye=>String(ye.id)===String(e.id));F>=0&&(Y[F]={...Y[F],...T})}}else{const{data:F,error:ye}=await b.from("leads").insert(T).select();A=ye,!A&&(F!=null&&F[0])&&Y.unshift(F[0])}if(L.disabled=!1,L.textContent=n?"Salvar":"Criar Contato",A){alert("Erro: "+A.message);return}k(),ue()})}let Ee=[];function sn(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Ee=a.target.result.split(`
`).filter(l=>l.trim()).slice(1).map(l=>{const[s,c,r,m,u]=l.split(",").map(w=>w.trim().replace(/^"|"$/g,""));return{name:s,email:c,phone:r,company:m,job_title:u}}).filter(l=>l.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Ee.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=Ee.length===0)},n.readAsText(t)}async function dn(){if(!Ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await b.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}mt(),await ct(),alert(`${t.length} contato(s) importados com sucesso!`)}function rn(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function mt(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const ln="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function ge(e){return(await fetch(ln,{method:"POST",headers:{Authorization:`Bearer ${Ea}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Rt(e){var s,c,r,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:u}}=await b.auth.getUser();n.value=(u==null?void 0:u.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=l),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",u=>{const w=u.target.files[0];if(!w)return;const E=URL.createObjectURL(w);a&&(a.src=E,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var f,I;const u=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",w=((I=document.getElementById("change-password-confirm"))==null?void 0:I.value)||"",E=document.getElementById("change-password-msg"),x=document.getElementById("btn-change-password");if(E&&(E.style.display="none"),u.length<12){E&&(E.textContent="Mínimo 6 caracteres.",E.style.display="");return}if(u!==w){E&&(E.textContent="As senhas não coincidem.",E.style.display="");return}x&&(x.disabled=!0,x.textContent="Salvando…");const{error:k}=await b.auth.updateUser({password:u});x&&(x.disabled=!1,x.textContent="Salvar Nova Senha"),k?E&&(E.textContent="Erro: "+k.message,E.style.display=""):(E&&(E.style.color="#16a34a",E.textContent="Senha alterada com sucesso!",E.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var I;const u=t.value.trim();let w=(y==null?void 0:y.avatar_url)||"";const E=i==null?void 0:i.files[0],x=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",E)try{const $=await De(E,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:_}=await b.storage.from("imoveis").upload(S,$,{contentType:"image/jpeg",upsert:!0});if(!_){const{data:{publicUrl:p}}=b.storage.from("imoveis").getPublicUrl(S);w=p}}catch($){console.error("Avatar upload:",$)}const{error:k}=await b.from("profiles").update({name:u,avatar_url:w}).eq("id",y.id);if(d.disabled=!1,d.textContent=x,k){alert("Erro ao salvar perfil.");return}y={...y,name:u,avatar_url:w},Je(y);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((I=u[0])==null?void 0:I.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const u=document.getElementById("settings-corretores-section");u&&(u.style.display=""),await Ye(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var I,$;const E=(I=document.getElementById("invite-email"))==null?void 0:I.value.trim(),x=($=document.getElementById("invite-password"))==null?void 0:$.value.trim(),k=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!E){alert("Informe o e-mail do corretor.");return}if(!x||x.length<12){alert("A senha precisa ter no mínimo 6 caracteres.");return}k&&(k.disabled=!0,k.textContent="Criando…"),f&&(f.style.display="none");try{const S=await ge({email:E,password:x,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const _=document.getElementById("invite-email"),p=document.getElementById("invite-password");_&&(_.value=""),p&&(p.value=""),await Ye(),f&&(S.email_sent===!1?(f.innerHTML=`
                ✅ Acesso criado!
                ...
                <strong>Senha:</strong> ${v(x)}`,f.style.color="#0f172a"):(f.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",f.style.color="#16a34a"),f.style.display="")}else alert("Erro: "+(S.error||"Falha desconhecida"))}catch(S){alert("Erro ao criar acesso: "+S.message)}finally{k&&(k.disabled=!1,k.textContent="+ Criar Acesso")}});const w=document.getElementById("settings-locations-section");w&&(w.style.display=""),await Te(),(r=document.getElementById("loc-add-city-btn"))==null||r.addEventListener("click",async()=>{const E=document.getElementById("loc-new-city"),x=E==null?void 0:E.value.trim();if(!x)return;const{error:k}=await b.from("locations").insert({type:"cidade",name:x});if(k){alert("Erro ao adicionar cidade.");return}E&&(E.value=""),await Te(),wt()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var I;const E=parseInt((I=document.getElementById("loc-new-neighborhood-city"))==null?void 0:I.value,10),x=document.getElementById("loc-new-neighborhood"),k=x==null?void 0:x.value.trim();if(!E||!k){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:f}=await b.from("locations").insert({type:"bairro",name:k,parent_id:E});if(f){alert("Erro ao adicionar bairro.");return}x&&(x.value=""),await Te()})}}async function Ye(){const e=document.getElementById("corretores-list");if(!e)return;let t=b.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${v(i)}</div>`,l=o.id===(y==null?void 0:y.id),s=o.active!==!1,c=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',r=l?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
...
`+p);window.open("mailto:?subject="+h+"&body="+L,"_blank")}),($=document.getElementById("share-copy"))==null||$.addEventListener("click",()=>{var g;const p=document.getElementById("share-link-input");p&&((g=navigator.clipboard)==null||g.writeText(p.value).then(()=>{const h=document.getElementById("share-copy"),L=h.textContent;h.textContent="✅ Copiado!",setTimeout(()=>{h.textContent=L},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var T;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const p=Number(document.getElementById("view-modal-edit").dataset.pid),g=q.find(A=>A.id===p);if(!g)return;je(),X=g.id;const h=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",h.querySelector('[name="title"]').value=g.title||"",h.querySelector('[name="rua"]').value=g.rua||"",h.querySelector('[name="numero"]').value=g.numero||"",h.querySelector('[name="city"]').value=g.city||"",h.querySelector('[name="price"]').value=g.price||"",h.querySelector('[name="bedrooms"]').value=g.bedrooms||"",h.querySelector('[name="suites"]').value=g.suites||"",h.querySelector('[name="parking"]').value=g.parking||"",h.querySelector('[name="description"]').value=g.description||"",h.querySelector('[name="construction_status"]').value=g.construction_status||"",h.querySelector('[name="owner_name"]').value=g.owner_name||"",h.querySelector('[name="owner_phone"]').value=g.owner_phone||"",h.querySelector('[name="owner_email"]').value=g.owner_email||"",h.querySelector('[name="owner_notes"]').value=g.owner_notes||"",h.querySelector('[name="condominium"]').value=g.condominium||"";const B=document.getElementById("adminPublished");B&&(B.value=g.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=g.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const A=document.getElementById("adminNeighborhood");A&&(A.value=g.neighborhood||"")},50)),ee=g.cover_image||((T=g.images)==null?void 0:T[0])||"",ze(g.images||[]),it("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(p=>{p.addEventListener("click",()=>{var g;document.querySelectorAll(".tab-btn").forEach(h=>h.classList.remove("active")),p.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(h=>h.classList.add("hidden")),(g=document.getElementById(`tab-${p.dataset.tab}`))==null||g.classList.remove("hidden")})}),(_=document.getElementById("admin-properties"))==null||_.addEventListener("click",p=>{if(p.target.closest(".action-btns"))return;const g=p.target.closest("tr");if(!g)return;const h=Number(g.dataset.id);if(!h)return;const L=q.find(B=>B.id===h);L&&Ga(L)})}async function da(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",N()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const l=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return l[Math.abs(s)%l.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
    ...
    `,e.dataset.loaded="1";let d=-1;function l(s=-1){d=s;const c=e.querySelector("#dep-form-wrap");c.style.display="",e.querySelector("#dep-form-title").textContent=s>=0?"Editar Depoimento":"Novo Depoimento";const r=s>=0?n[s]:{};e.querySelector("#dep-stars").value=String(r.stars||5),e.querySelector("#dep-text").value=r.text||"",e.querySelector("#dep-name").value=r.name||"",e.querySelector("#dep-role").value=r.role||"",e.querySelector("#dep-text").focus()}e.querySelector("#dep-add-btn").addEventListener("click",()=>l(-1)),e.querySelector("#dep-form-cancel").addEventListener("click",()=>{e.querySelector("#dep-form-wrap").style.display="none",d=-1}),e.addEventListener("click",s=>{const c=s.target.closest("[data-edit]"),r=s.target.closest("[data-del]");if(c&&l(parseInt(c.dataset.edit)),r){const m=parseInt(r.dataset.del);confirm("Remover este depoimento?")&&(n.splice(m,1),i().then(()=>o()))}}),e.querySelector("#dep-form-save").addEventListener("click",async()=>{const s=e.querySelector("#dep-form-save"),c=e.querySelector("#dep-save-msg"),r=e.querySelector("#dep-text").value.trim(),m=e.querySelector("#dep-name").value.trim(),u=e.querySelector("#dep-role").value.trim(),w=parseInt(e.querySelector("#dep-stars").value);if(!r||!m){alert("Preencha o depoimento e o nome.");return}s.disabled=!0,s.textContent="Salvando…";const E={stars:w,text:r,name:m,role:u};d>=0?n[d]=E:n.push(E);const x=await i();s.disabled=!1,s.textContent="Salvar",G(c,x),x&&(e.querySelector("#dep-form-wrap").style.display="none",d=-1,o())})}async function i(){const d=JSON.stringify(n);return await He("testimonials",{pt:d,en:d,es:d})}o()}document.addEventListener("DOMContentLoaded",async()=>{var l,s,c;const t=window.location.hostname.replace(/^www\./,"");if(t&&t!=="localhost"&&t!=="127.0.0.1"){const r=`imobi_tenant_${t}`,m=Ue(r);if(m)be(m);else{let u=null;for(const w of[t,"www."+t]){const{data:E}=await b.from("tenants").select("id").eq("domain",w).maybeSingle();if(E!=null&&E.id){u=E;break}}u!=null&&u.id&&(be(u.id),nt(r,u.id,24*60*60*1e3))}}await Promise.all([wa(),sa()]),Ce=K("company.whatsapp",Ce),ft(),Ha(),Ua();const n=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");n&&a&&(wt(),n.addEventListener("change",()=>{const r=fe().find(u=>u.name===n.value),m=r?xt(r.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+m.map(u=>`<option value="${u.name}">${v(u.name)}</option>`).join("")}));const o=document.getElementById("admin-login"),i=document.getElementById("admin-root");if(o){const r=new URLSearchParams(window.location.hash.replace("#","")),m=new URLSearchParams(window.location.search),u=r.get("type")||m.get("type")||"",w=Vt||u==="recovery"||u==="invite"||window.location.hash.includes("access_token")||m.has("code"),E=document.getElementById("password-reset-overlay");if(w){o.style.display="none",i&&i.classList.add("hidden"),E&&(E.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async k=>{var p,g;k.preventDefault();const f=((p=document.getElementById("new-password"))==null?void 0:p.value)||"",I=((g=document.getElementById("confirm-password"))==null?void 0:g.value)||"",$=document.getElementById("password-reset-msg"),S=k.target.querySelector('button[type="submit"]');if($&&($.style.display="none"),f!==I){$&&($.textContent="As senhas não coincidem.",$.style.display="");return}S&&(S.disabled=!0,S.textContent="Salvando…");const{error:_}=await b.auth.updateUser({password:f});if(_){$&&($.textContent="Erro: "+_.message,$.style.display=""),S&&(S.disabled=!1,S.textContent="Definir Senha");return}window.location.href=window.location.pathname}),m.has("code")&&await b.auth.exchangeCodeForSession(m.get("code")??"");return}const{data:{session:x}}=await b.auth.getSession();if(x){if(o.classList.add("hidden"),i&&i.classList.remove("hidden"),tt(),Dt(),qt(),window.lucide&&lucide.createIcons(),y=await Bt(x.user.id),!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(y.needs_password_reset){o.style.display="none",i&&i.classList.add("hidden");const k=document.getElementById("password-reset-overlay");k&&(k.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async f=>{var g,h;f.preventDefault();const I=((g=document.getElementById("new-password"))==null?void 0:g.value)||"",$=((h=document.getElementById("confirm-password"))==null?void 0:h.value)||"",S=document.getElementById("password-reset-msg"),_=f.target.querySelector('button[type="submit"]');if(S&&(S.style.display="none"),I!==$){S&&(S.textContent="As senhas não coincidem.",S.style.display="");return}if(I.length<12){S&&(S.textContent="Mínimo 6 caracteres.",S.style.display="");return}_&&(_.disabled=!0,_.textContent="Salvando…");const{error:p}=await b.auth.updateUser({password:I});if(p){S&&(S.textContent="Erro: "+p.message,S.style.display=""),_&&(_.disabled=!1,_.textContent="Definir Senha");return}await b.from("profiles").update({needs_password_reset:!1}).eq("id",y.id),window.location.href=window.location.pathname});return}be((y==null?void 0:y.tenant_id)||null),Je(y),Ct(y),Tt(y.role),await Ve(),await Rt(y),window.lucide&&lucide.createIcons(),nn(),ae("dashboard")}else{i&&i.classList.add("hidden"),o.classList.remove("hidden");const k=document.getElementById("login-form");k&&((c=document.getElementById("forgot-password-btn"))==null||c.addEventListener("click",async()=>{var $,S;const f=(S=($=k.querySelector('input[name="email"]'))==null?void 0:$.value)==null?void 0:S.trim();if(!f){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:I}=await b.auth.resetPasswordForEmail(f,{redirectTo:"https://omarcorretor.com.br/ios.imobi.html"});alert(I?"Erro: "+I.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),k.addEventListener("submit",async f=>{f.preventDefault();const I=k.querySelector('button[type="submit"]'),$=new FormData(k),S=$.get("email"),_=$.get("password");I&&(I.disabled=!0,I.textContent="Entrando…");try{if(await Ma(S,_)){o.classList.add("hidden"),i&&i.classList.remove("hidden"),tt(),Dt(),window.lucide&&lucide.createIcons();const{data:{session:g}}=await b.auth.getSession();if(y=g?await Bt(g.user.id):null,!y){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Perfil não encontrado. Entre em contato com o administrador.");return}if(y.active===!1){await b.auth.signOut(),o.classList.remove("hidden"),i&&i.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}qt(),be((y==null?void 0:y.tenant_id)||null),Je(y),Ct(y),Tt(y.role),await Ve(),await Rt(y),window.lucide&&lucide.createIcons(),ae("dashboard")}else alert("E-mail ou senha incorretos")}catch(p){alert("Erro ao fazer login: "+((p==null?void 0:p.message)||String(p)))}finally{I&&(I.disabled=!1,I.textContent="Entrar")}}))}}else tt();await me();const d=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();$t(d),St(Ce),window._applyDynamicContent=$t,window._applyWhatsAppLinks=St,document.querySelectorAll(".nav-dropdown-btn").forEach(r=>{var u;const m=(u=r.closest(".nav-dropdown"))==null?void 0:u.querySelector(".nav-dropdown-menu");m&&r.addEventListener("click",w=>{w.stopPropagation(),m.classList.toggle("js-open"),document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(E=>{E!==m&&E.classList.remove("js-open")})})}),document.addEventListener("click",()=>{document.querySelectorAll(".nav-dropdown-menu.js-open").forEach(r=>r.classList.remove("js-open"))})});async function cn(){const e=q.filter(o=>!o.reference);if(!e.length)return;const t=q.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,i)=>o.id-i.id);for(const o of a){const i="IO-"+String(n).padStart(4,"0"),{error:d}=await b.from("properties").update({reference:i}).eq("id",o.id);if(!d){const l=q.findIndex(s=>s.id===o.id);l>=0&&(q[l].reference=i),n++}}Me(bt(q))}async function mn(){const e=q.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(i=>!i.includes("/wm-")))continue;const a=[];let o=!1;for(const i of t.images)if(i.includes("/wm-"))a.push(i);else try{const d=await pn(i);a.push(d),o=!0}catch{a.push(i)}if(o){await b.from("properties").update({images:a}).eq("id",t.id);const i=q.findIndex(d=>d.id===t.id);i>=0&&(q[i].images=a)}}Me(bt(q))}}async function pn(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),i=o.ok?await o.blob():null,d=i?URL.createObjectURL(i):null;return new Promise(l=>{const s=new Image;s.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),r=1200;let m=s.width,u=s.height;m>r&&(u=Math.round(u*r/m),m=r),c.width=m,c.height=u;const w=c.getContext("2d");w.drawImage(s,0,0,m,u);const E=x=>{if(x){const k=Math.round(m*.18),f=Math.round(x.naturalHeight*k/x.naturalWidth),I=Math.round(m*.02);w.globalAlpha=.45,w.drawImage(x,m-k-I,u-f-I,k,f),w.globalAlpha=1}c.toBlob(async k=>{try{const f=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:I}=await b.storage.from("imoveis").upload(f,k,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(I){console.error("Upload watermark error:",I),l(e);return}const{data:{publicUrl:$}}=b.storage.from("imoveis").getPublicUrl(f);l($)}catch(f){console.error("Watermark upload exception:",f),l(e)}},"image/jpeg",.82)};if(d){const x=new Image;x.onload=()=>{URL.revokeObjectURL(d),E(x)},x.onerror=()=>{URL.revokeObjectURL(d),E(null)},x.src=d}else E(null)},s.onerror=()=>{URL.revokeObjectURL(a),l(e)},s.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function G(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Et(e,t="assets"){const n=await De(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await b.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:i}}=b.storage.from("imoveis").getPublicUrl(a);return i}async function ra(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("settings").select("key,value").eq("tenant_id",N()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>v(String(n[o]||""));e.innerHTML=`
    <div class="section-topbar">
  ...
  `;function s(r,m,u){const w=document.getElementById(r),E=document.getElementById(m);w==null||w.addEventListener("input",x=>{E.value=x.target.value,u()}),E==null||E.addEventListener("input",x=>{/^#[0-9a-fA-F]{6}$/.test(x.target.value)&&(w.value=x.target.value,u())})}function c(){var m,u,w,E;const r=((m=document.getElementById("col-accent-hex"))==null?void 0:m.value)||"#b8962e";(u=document.getElementById("vp-bar"))==null||u.style.setProperty("background",r),(w=document.getElementById("vp-dot"))==null||w.style.setProperty("background",r),(E=document.getElementById("vp-btn"))==null||E.style.setProperty("background",r),document.documentElement.style.setProperty("--accent",r)}s("col-accent","col-accent-hex",c),s("col-primary","col-primary-hex",()=>{}),s("col-secondary","col-secondary-hex",()=>{}),c(),document.getElementById("vis-hero-file").addEventListener("change",async r=>{const m=r.target.files[0];if(m)try{const u=await Et(m,"hero");document.getElementById("vis-hero-url").value=u;const w=document.getElementById("vis-hero-preview");w.innerHTML=`<img src="${u}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">`,w.style.display=""}catch(u){alert("Erro no upload: "+u.message)}}),document.getElementById("visual-save-colors").addEventListener("click",async()=>{const r=document.getElementById("visual-save-colors");r.disabled=!0,r.textContent="Salvando…";const m=await we([["visual.accent_color",document.getElementById("col-accent-hex").value],["visual.primary_bg",document.getElementById("col-primary-hex").value],["visual.secondary_bg",document.getElementById("col-secondary-hex").value]]);m&&ft(),r.disabled=!1,r.textContent="Salvar Cores",G(document.getElementById("visual-colors-msg"),m)}),document.getElementById("visual-reset-colors").addEventListener("click",async()=>{confirm("Restaurar cores padrão?")&&(document.getElementById("col-accent").value="#b8962e",document.getElementById("col-accent-hex").value="#b8962e",document.getElementById("col-primary").value="#0f1c2e",document.getElementById("col-primary-hex").value="#0f1c2e",document.getElementById("col-secondary").value="#1a2f4a",document.getElementById("col-secondary-hex").value="#1a2f4a",c())}),document.getElementById("visual-save-images").addEventListener("click",async()=>{const r=document.getElementById("visual-save-images");r.disabled=!0,r.textContent="Salvando…";const m=await we([["visual.hero_bg_url",document.getElementById("vis-hero-url").value.trim()],["visual.price_max_slider",parseInt(document.getElementById("vis-price-max").value,10)||13e7]]);r.disabled=!1,r.textContent="Salvar Imagens",G(document.getElementById("visual-images-msg"),m)})}async function ca(){const e=document.getElementById("section-site-config");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("site_content").select("*").eq("tenant_id",N()),n={};t==null||t.forEach(s=>{n[s.key]=s});const a=(s,c)=>{var r;return v(((r=n[s])==null?void 0:r[`value_${c}`])||"")},o=["pt","en","es"],i={pt:"🇧🇷 Português",en:"🇺🇸 English",es:"🇪🇸 Español"},d=s=>o.map(c=>`<button class="content-tab${c===s?" active":""}" data-lang="${c}">${i[c]}</button>`).join(""),l=s=>`
  ...
  `,await R())}async function R(){var f,I,$,S,_;const e=document.getElementById("crm-body");if(!e)return;const t=N(),[{data:n},{data:a},{data:o},{data:i}]=await Promise.all([b.from("crm_pipelines").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_stages").select("*").eq("tenant_id",t).order("sort_order"),b.from("crm_tags").select("*").eq("tenant_id",t).order("name"),b.from("crm_lead_statuses").select("*").eq("tenant_id",t).order("sort_order")]),d=n||[],s=(typeof j<"u"&&j?d.find(p=>p.id===j):null)||d.find(p=>p.is_default)||d[0],c=d.map(p=>`<option value="${p.id}"${p.id===(s==null?void 0:s.id)?" selected":""}>${v(p.name)}</option>`).join(""),r=(a||[]).filter(p=>p.pipeline_id===(s==null?void 0:s.id)).sort((p,g)=>(p.sort_order??0)-(g.sort_order??0)),m=r.map((p,g)=>`
...
Leads associados ficarão sem funil — você pode movê-los depois.`)&&(await b.from("crm_stages").delete().eq("pipeline_id",E),await b.from("crm_pipelines").delete().eq("id",E),j=null,await R())}}),document.getElementById("crm-add-stage").addEventListener("click",async()=>{const p=document.getElementById("crm-new-stage").value.trim(),g=document.getElementById("crm-new-stage-color").value,h=parseInt(document.getElementById("crm-pipe-sel").value,10);p&&(await b.from("crm_stages").insert({pipeline_id:h,name:p,color:g,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-stage").value="",await R())}),e.querySelectorAll(".stage-del").forEach(p=>{p.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await b.from("crm_stages").delete().eq("id",p.dataset.id),await R())})}),e.querySelectorAll(".stage-name-input").forEach(p=>{p.addEventListener("blur",async()=>{const g=p.value.trim(),h=p.dataset.orig;if(!g||g===h){p.value=h;return}p.disabled=!0;const{error:L}=await b.from("crm_stages").update({name:g}).eq("id",p.dataset.sid);if(p.disabled=!1,L){console.warn("[Etapas] erro ao renomear:",L),p.value=h,alert("Erro ao renomear: "+L.message);return}p.dataset.orig=g,p.style.background="#dcfce7",setTimeout(()=>{p.style.background=""},800)}),p.addEventListener("keydown",g=>{g.key==="Enter"&&(g.preventDefault(),p.blur()),g.key==="Escape"&&(p.value=p.dataset.orig,p.blur())})}),document.getElementById("crm-stages-list");let x=null;e.querySelectorAll(".stage-draggable").forEach(p=>{p.addEventListener("dragstart",g=>{x=p,p.classList.add("stage-dragging"),g.dataTransfer.effectAllowed="move";try{g.dataTransfer.setData("text/plain",p.dataset.id)}catch{}}),p.addEventListener("dragend",()=>{p.classList.remove("stage-dragging"),e.querySelectorAll(".stage-drop-over").forEach(g=>g.classList.remove("stage-drop-over"))}),p.addEventListener("dragover",g=>{g.preventDefault(),g.dataTransfer.dropEffect="move",p!==x&&(e.querySelectorAll(".stage-drop-over").forEach(h=>h.classList.remove("stage-drop-over")),p.classList.add("stage-drop-over"))}),p.addEventListener("dragleave",()=>{p.classList.remove("stage-drop-over")}),p.addEventListener("drop",async g=>{if(g.preventDefault(),!x||p===x)return;const h=x.dataset.id,L=p.dataset.id,B=r.findIndex(M=>String(M.id)===String(h)),C=r.findIndex(M=>String(M.id)===String(L));if(B<0||C<0)return;const T=r.splice(B,1)[0];r.splice(C,0,T);const A=r.map((M,O)=>b.from("crm_stages").update({sort_order:O}).eq("id",M.id));x=null,await Promise.all(A).catch(M=>console.warn("[stages] erro reordenar:",M)),await R()})}),e.querySelectorAll(".stage-color-pick").forEach(p=>{p.addEventListener("change",async g=>{await b.from("crm_stages").update({color:g.target.value}).eq("id",p.dataset.sid);const h=p.closest(".stage-item").querySelector(".stage-color-dot");h&&(h.style.background=g.target.value)})});const k=async()=>{const p=document.getElementById("crm-new-tag"),g=document.getElementById("crm-new-tag-color"),h=p==null?void 0:p.value.trim(),L=(g==null?void 0:g.value)||"#6366F1";if(!h){p==null||p.focus();return}await b.from("crm_tags").insert({name:h,color:L,tenant_id:N()}),p&&(p.value=""),await R()};(S=document.getElementById("crm-add-tag"))==null||S.addEventListener("click",k),(_=document.getElementById("crm-new-tag"))==null||_.addEventListener("keydown",p=>{p.key==="Enter"&&k()}),e.querySelectorAll(".tm-del-btn").forEach(p=>{p.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await b.from("crm_tags").delete().eq("id",p.dataset.id),await R())})}),e.querySelectorAll(".tm-name-input").forEach(p=>{const g=p.closest(".tm-row"),h=g==null?void 0:g.querySelector(".tm-save-btn");h&&(h.style.display="none"),p.addEventListener("input",()=>{const L=p.value.trim()!==p.dataset.orig;h&&(h.style.display=L?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(p=>{const g=p.closest(".tm-row"),h=g==null?void 0:g.querySelector(".tm-color-swatch"),L=g==null?void 0:g.querySelector(".tm-save-btn");p.addEventListener("input",B=>{h&&(h.style.background=B.target.value),L&&(L.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(p=>{p.style.display="none",p.addEventListener("click",async()=>{var B,C;const g=p.closest(".tm-row"),h=(B=g.querySelector(".tm-name-input"))==null?void 0:B.value.trim(),L=(C=g.querySelector(".tm-color-input"))==null?void 0:C.value;h&&(p.disabled=!0,p.textContent="✓ Salvando…",await b.from("crm_tags").update({name:h,color:L}).eq("id",p.dataset.id),await R())})}),e.querySelectorAll(".tm-tpl-btn").forEach(p=>{p.addEventListener("click",async()=>{const g=p.dataset.name,h=p.dataset.color;p.disabled=!0,p.innerHTML="✓",await b.from("crm_tags").insert({name:g,color:h,tenant_id:N()}),await R()})}),e.querySelectorAll(".tag-chip-del").forEach(p=>{p.addEventListener("click",async()=>{await b.from("crm_tags").delete().eq("id",p.dataset.id),await R()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const p=document.getElementById("crm-new-status").value.trim(),g=document.getElementById("crm-new-status-color").value,h=document.getElementById("crm-new-status-final").checked;p&&(await b.from("crm_lead_statuses").insert({name:p,color:g,is_final:h,sort_order:99,tenant_id:N()}),document.getElementById("crm-new-status").value="",await R())}),e.querySelectorAll(".status-del").forEach(p=>{p.addEventListener("click",async()=>{confirm("Remover este status?")&&(await b.from("crm_lead_statuses").delete().eq("id",p.dataset.id),await R())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var h;const p=(h=prompt("Nome do novo funil:"))==null?void 0:h.trim();if(!p)return;const{error:g}=await b.from("crm_pipelines").insert({name:p,sort_order:99,tenant_id:N()});if(g){alert("Erro ao criar funil: "+g.message);return}dt=!1,await R()})}async function pa(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await b.from("integrations").select("*"),n={};t==null||t.forEach(l=>{n[l.key]=l});const a=l=>{var s;return v(((s=n[l])==null?void 0:s.value)||"")},o=l=>{var s;return(s=n[l])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
  ...
  `,await pt(),document.getElementById("media-file-input").addEventListener("change",async n=>{var s,c;const a=Array.from(n.target.files);if(!a.length)return;const o=document.getElementById("media-upload-progress"),i=document.getElementById("media-progress-fill"),d=document.getElementById("media-progress-text");o.style.display="";let l=0;for(const r of a){d.textContent=`Enviando ${l+1}/${a.length}…`,i.style.width=`${Math.round(l/a.length*100)}%`;try{const m=await Et(r,"media"),u=r.name.replace(/\.[^.]+$/,"").slice(0,60);await b.from("media_library").insert({name:u,url:m,type:"image",size:r.size,created_by:(c=(s=(await b.auth.getUser()).data)==null?void 0:s.user)==null?void 0:c.id})}catch(m){console.error("Media upload error:",m)}l++}i.style.width="100%",d.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{o.style.display="none",i.style.width="0"},2e3),await pt(),n.target.value=""});const t=document.getElementById("media-drop-area");t.addEventListener("dragover",n=>{n.preventDefault(),t.classList.add("drag-over")}),t.addEventListener("dragleave",()=>t.classList.remove("drag-over")),t.addEventListener("drop",n=>{n.preventDefault(),t.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function pt(){const e=document.getElementById("media-grid");if(!e)return;const{data:t,error:n}=await b.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(t!=null&&t.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=t.map(a=>`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async r=>{r.stopPropagation();const m=c.dataset.active==="true";await b.from("tenants").update({active:!m}).eq("id",c.dataset.id),de()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const r=(i||[]).find(m=>String(m.id)===String(c.dataset.id));r&&bn(r)})})}async function gn(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await b.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),b.from("plans").select("id, name").then(({data:c})=>{const r=document.getElementById("nt-plan");r&&c&&(r.innerHTML='<option value="">Sem plano</option>'+c.map(m=>`<option value="${m.id}">${v(m.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const r=document.getElementById("nt-slug");r&&!r.dataset.manual&&(r.value=vn(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(i=document.getElementById("nt-pwd-toggle"))==null||i.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(d=document.getElementById("sa-modal-close-btn"))==null||d.addEventListener("click",n),(l=document.getElementById("nt-cancel"))==null||l.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(s=document.getElementById("nt-save"))==null||s.addEventListener("click",async()=>{var _,p,g,h,L,B,C,T,A,M,O,P;const c=(p=(_=document.getElementById("nt-name"))==null?void 0:_.value)==null?void 0:p.trim(),r=(h=(g=document.getElementById("nt-slug"))==null?void 0:g.value)==null?void 0:h.trim(),m=(B=(L=document.getElementById("nt-domain"))==null?void 0:L.value)==null?void 0:B.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,w=(A=(T=document.getElementById("nt-admin-email"))==null?void 0:T.value)==null?void 0:A.trim(),E=(O=(M=document.getElementById("nt-admin-password"))==null?void 0:M.value)==null?void 0:O.trim(),x=document.getElementById("nt-msg"),k=document.getElementById("nt-save");if(!c||!r){x.textContent="❌ Nome e slug são obrigatórios.",x.style.color="#ef4444";return}if(!w){x.textContent="❌ Informe o e-mail do admin.",x.style.color="#ef4444";return}if(!E||E.length<12){x.textContent="❌ A senha precisa ter mínimo 6 caracteres.",x.style.color="#ef4444";return}k.disabled=!0,k.textContent="Criando…",x.textContent="⏳ Criando imobiliária…",x.style.color="#64748b";const{data:f,error:I}=await b.from("tenants").insert({name:c,slug:r,domain:m||null,plan_id:u||null,active:!0}).select();if(I){k.disabled=!1,k.textContent="Criar Imobiliária",x.textContent="❌ "+I.message,x.style.color="#ef4444";return}const $=(P=f==null?void 0:f[0])==null?void 0:P.id;x.textContent="⏳ Criando usuário admin…";const S=await ge({email:w,password:E,role:"admin",tenant_id:$});if(!(S!=null&&S.success)){k.disabled=!1,k.textContent="Criar Imobiliária",x.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+v((S==null?void 0:S.error)||"Desconhecido"),x.style.color="#f59e0b",n(),de().catch(()=>{});return}$&&(S!=null&&S.user_id)&&!(S!=null&&S.linked)&&await b.from("profiles").update({tenant_id:$}).eq("id",S.user_id),k.disabled=!1,k.textContent="Criar Imobiliária",S.email_sent===!1?(x.innerHTML=`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>ga(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",ut(e,o.dataset.tab)})}),ut(e,"properties")}function hn(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(l,s,c,r="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${r.map(m=>{var u;return`
            <tr data-pid="${m.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${v(Re(m.price,"pt"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${r.map(u=>{const[w,E]=m(u.stage||u.status||"").split(","),x=(u.phone||"").replace(/\D/g,"");return`<tr data-lid="${u.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${w};color:${E};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${v(u.stage||u.status||"Novo")}</span></td>
      ...
      </div>`,(l=document.getElementById("tp-copy-key"))==null||l.addEventListener("click",()=>{var I;(I=navigator.clipboard)==null||I.writeText(e.id);const k=document.getElementById("tp-copy-key"),f=k.textContent;k.textContent="✅ Copiada!",setTimeout(()=>{k.textContent=f},2e3)})}if(t==="config"){const{data:r}=await b.from("settings").select("key,value").eq("tenant_id",e.id),m={};r==null||r.forEach(w=>{m[w.key]=w.value});const u=(w,E)=>`
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>ga(e))}}function ga(e){var c,r,m,u,w,E,x,k;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),b.from("plans").select("id, name").then(({data:f})=>{const I=document.getElementById("et-plan");I&&f&&(I.innerHTML='<option value="">Sem plano</option>'+f.map($=>`<option value="${$.id}"${String($.id)===String(e.plan_id)?" selected":""}>${v($.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",f=>{const I=f.target.files[0];if(!I)return;const $=URL.createObjectURL(I),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${$}" style="width:100%;height:100%;object-fit:cover;">`)}),(r=document.getElementById("et-logo-preview"))==null||r.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(u=document.getElementById("et-copy-key"))==null||u.addEventListener("click",()=>{var S,_;const f=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!f)return;(_=navigator.clipboard)==null||_.writeText(f);const I=document.getElementById("et-copy-key"),$=I.textContent;I.textContent="✅ Copiada!",setTimeout(()=>{I.textContent=$},2e3)});const o=["dados","config","api"];function i(f){o.forEach(I=>{document.getElementById(`et-pane-${I}`).style.display=I===f?"":"none";const $=document.getElementById(`et-tab-${I}`);$.style.borderBottomColor=I===f?"#2563eb":"transparent",$.style.color=I===f?"#2563eb":"#64748b",$.style.fontWeight=I===f?"600":"500"}),f==="config"&&l()}o.forEach(f=>{var I;return(I=document.getElementById(`et-tab-${f}`))==null?void 0:I.addEventListener("click",()=>i(f))});let d=!1;async function l(){var $;if(d)return;d=!0;const{data:f}=await b.from("settings").select("key,value").eq("tenant_id",e.id),I={};f==null||f.forEach(S=>{I[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
    ...
    `,($=document.getElementById("et-cfg-save"))==null||$.addEventListener("click",async()=>{const S=document.getElementById("et-cfg-save"),_=document.getElementById("et-cfg-msg");S.disabled=!0,S.textContent="Salvando…",_.textContent="",_.style.color="#64748b";const p=document.getElementById("et-cfg-wa").value.trim().replace(/\D/g,""),g=document.getElementById("et-cfg-phone").value.trim(),h=document.getElementById("et-cfg-email").value.trim(),L=document.getElementById("et-cfg-city").value.trim(),B=document.getElementById("et-cfg-slogan").value.trim(),{error:C}=await b.from("settings").upsert([{key:"company.whatsapp",value:p,tenant_id:e.id},{key:"company.phone",value:g,tenant_id:e.id},{key:"company.email",value:h,tenant_id:e.id},{key:"company.city",value:L,tenant_id:e.id},{key:"company.address",value:L,tenant_id:e.id},{key:"company.slogan",value:B,tenant_id:e.id}],{onConflict:"tenant_id,key"});S.disabled=!1,S.textContent="💾 Salvar configurações",C?(_.textContent="❌ "+C.message,_.style.color="#ef4444"):(_.textContent="✅ Configurações salvas!",_.style.color="#22c55e")})}const s=()=>n.remove();(w=document.getElementById("et-close"))==null||w.addEventListener("click",s),(E=document.getElementById("et-cancel"))==null||E.addEventListener("click",s),n.addEventListener("click",f=>{f.target===n&&s()}),(x=document.getElementById("et-delete"))==null||x.addEventListener("click",async()=>{if(!confirm(`⚠️ Tem certeza que deseja EXCLUIR a imobiliária "${e.name}"?

Essa ação é irreversível e removerá o registro da plataforma.`))return;const I=document.getElementById("et-delete");I.disabled=!0,I.textContent="Excluindo…";const{error:$}=await b.from("tenants").delete().eq("id",e.id);if($){alert("Erro ao excluir: "+$.message),I.disabled=!1,I.textContent="🗑️ Excluir";return}s(),de()}),(k=document.getElementById("et-save"))==null||k.addEventListener("click",async()=>{var T,A,M,O,P,ne,re,$e,Se,F,ye,It;const f=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),I=(O=(M=document.getElementById("et-slug"))==null?void 0:M.value)==null?void 0:O.trim(),$=(ne=(P=document.getElementById("et-domain"))==null?void 0:P.value)==null?void 0:ne.trim(),S=(re=document.getElementById("et-plan"))==null?void 0:re.value,_=(Se=($e=document.getElementById("et-admin-email"))==null?void 0:$e.value)==null?void 0:Se.trim(),p=(ye=(F=document.getElementById("et-admin-password"))==null?void 0:F.value)==null?void 0:ye.trim(),g=(It=document.getElementById("et-logo-input"))==null?void 0:It.files[0],h=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!f){h.textContent="❌ Nome é obrigatório.",h.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",h.textContent="⏳ Salvando…",h.style.color="#64748b";let B=e.logo_url;if(g)try{const z=await De(g,256,.85),kt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:ha}=await b.storage.from("imoveis").upload(kt,z,{contentType:"image/jpeg",upsert:!0});if(!ha){const{data:{publicUrl:xa}}=b.storage.from("imoveis").getPublicUrl(kt);B=xa}}catch(z){console.error("Logo upload:",z)}const{error:C}=await b.from("tenants").update({name:f,slug:I||e.slug,domain:$||null,plan_id:S||null,logo_url:B}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",h.textContent="❌ "+C.message,h.style.color="#ef4444";return}if(_&&p&&p.length>=6){h.textContent="⏳ Criando usuário admin…";const z=await ge({email:_,password:p,role:"admin",tenant_id:e.id});z!=null&&z.success?(z!=null&&z.user_id&&!(z!=null&&z.linked)&&await b.from("profiles").update({tenant_id:e.id}).eq("id",z.user_id),h.textContent="✅ Salvo e admin criado!",h.style.color="#22c55e"):(h.textContent="⚠️ Salvo, mas erro ao criar admin: "+((z==null?void 0:z.error)||"Tente novamente"),h.style.color="#f59e0b")}else h.textContent="✅ Imobiliária atualizada!",h.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{s(),de()},1200)})}const Ut=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Qe=[],ve=[],Fe={};function xn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",wn)}function wn(){Qe=[],ve=[],Fe={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
`).map(l=>l.trimEnd()).filter(l=>l.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(l){const s=[];let c="",r=!1;for(let m=0;m<l.length;m++){const u=l[m];u==='"'?r&&l[m+1]==='"'?(c+='"',m++):r=!r:u===n&&!r?(s.push(c.trim()),c=""):c+=u}return s.push(c.trim()),s}const i=o(a[0]).map(l=>l.replace(/^["']+|["']+$/g,"")),d=a.slice(1).map(o);return{headers:i,rows:d}}async function In(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,d)=>{const l=document.createElement("script");l.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",l.onload=i,l.onerror=d,document.head.appendChild(l)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}ve=o[0].map(String),Qe=o.slice(1),va()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function kn(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function va(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+ve.map((a,o)=>`<option value="${o}">${v(a)}</option>`).join("");e.innerHTML=Ut.map(a=>{const o=kn(ve,t[a.key]||[]);return Fe[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join(""),Ut.forEach(a=>{const o=document.getElementById(`import-map-${a.key}`);o&&Fe[a.key]!==""&&(o.value=Fe[a.key])}),$n(),fa()}function $n(){const e=document.getElementById("import-preview-wrap");if(!e)return;const t=Qe.slice(0,5);if(!t.length){e.innerHTML='<p style="padding:10px;color:#94a3b8;font-size:.8rem;">Sem dados</p>';return}const n=`<tr>${ve.map(o=>`<th style="padding:6px 10px;background:#f1f5f9;font-size:.78rem;white-space:nowrap;border:1px solid #e2e8f0;">${v(o)}</th>`).join("")}</tr>`,a=t.map(o=>`<tr>${ve.map((i,d)=>`<td style="padding:5px 10px;font-size:.78rem;border:1px solid #e2e8f0;white-space:nowrap;max-width:160px;overflow:hidden;text-overflow:ellipsis;">${v(String(o[d]??""))}</td>`).join("")}</tr>`).join("");e.innerHTML=`<table style="border-collapse:collapse;min-width:100%;">${n}${a}</table>`}function Sn(){return window.Chart?Promise.resolve():new Promise((e,t)=>{const n=document.createElement("script");n.src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js",n.onload=e,n.onerror=t,document.head.appendChild(n)})}function _n(e,t,n){const a=e.querySelector("#ldp-tag-badge-area"),o=e.querySelector("#ldp-tag-add-btn"),i=e.querySelector("#ldp-tag-dropdown"),d=e.querySelector("#ldp-tag-search"),l=e.querySelector("#ldp-tag-opt-list"),s=e.querySelector("#ldp-tag-show-create"),c=e.querySelector("#ldp-tag-create-row"),r=e.querySelector("#ldp-tag-new-name"),m=e.querySelector("#ldp-tag-new-color"),u=e.querySelector("#ldp-tag-create-btn");if(!a||!o||!i)return;function w(){return[...a.querySelectorAll(".ldp-tag-badge[data-tag]")].map($=>$.dataset.tag)}function E($){if(!$.length){a.innerHTML='<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>';return}a.innerHTML=$.map(S=>{const p=(n[S]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${v(S)}" style="background:${p}18;color:${p};border-color:${p}55;">
        ${v(S)}<span class="ldp-tag-rm" data-tag="${v(S)}">×</span>
      </span>`}).join("")}function x($=""){const S=w(),_=$.toLowerCase().trim(),p=t.filter(g=>!_||g.name.toLowerCase().includes(_));if(!p.length){l.innerHTML='<div class="ldp-tag-opt-empty">Nenhuma tag encontrada</div>';return}l.innerHTML=p.map(g=>{const h=S.includes(g.name);return`<div class="ldp-tag-opt${h?" active":""}" data-tag="${v(g.name)}" style="--tc:${g.color}">
      ...
      </div>`}).join("")}function k(){i.classList.remove("hidden"),x(""),d.value="",c.classList.add("hidden"),d.focus()}function f(){i.classList.add("hidden")}o.addEventListener("click",$=>{$.stopPropagation(),i.classList.contains("hidden")?k():f()}),document.addEventListener("mousedown",function $(S){e.contains(S.target)||(f(),document.removeEventListener("mousedown",$))}),i.addEventListener("mousedown",$=>$.stopPropagation()),d.addEventListener("input",()=>x(d.value)),l.addEventListener("click",$=>{const S=$.target.closest(".ldp-tag-opt");if(!S)return;const _=S.dataset.tag,p=w();p.includes(_)?E(p.filter(g=>g!==_)):E([...p,_]),x(d.value)}),a.addEventListener("click",$=>{const S=$.target.closest(".ldp-tag-rm");if(!S)return;const _=S.dataset.tag;E(w().filter(p=>p!==_))}),s.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||r.focus()});async function I(){const $=r.value.trim();if(!$){r.focus();return}const S=m.value||"#6366F1";if(t.some(_=>_.name.toLowerCase()===$.toLowerCase())){r.style.borderColor="#ef4444",setTimeout(()=>{r.style.borderColor=""},1500);return}u.disabled=!0,u.textContent="Criando…";try{const{data:_,error:p}=await b.from("crm_tags").insert({name:$,color:S,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(p)throw p;const g={id:_.id,name:_.name,color:_.color};t.push(g),n[g.name]=g,typeof pe<"u"&&(pe[g.name]=g),E([...w(),g.name]),x(d.value),r.value="",m.value="#6366F1",c.classList.add("hidden")}catch(_){console.error("Error creating tag:",_),alert("Erro ao criar tag: "+(_.message||_))}finally{u.disabled=!1,u.textContent="Criar e adicionar"}}u.addEventListener("click",I),r.addEventListener("keydown",$=>{$.key==="Enter"&&I()})}async function Ln(){var k;const e=document.getElementById("section-dashboard");if(!e)return;e.dataset.dbInit==="1"&&(window._dbLeadsChartInstance&&(window.window._dbLeadsChartInstance.destroy(),window._dbLeadsChartInstance=null),window._dbOriginChartInstance&&(window.window._dbOriginChartInstance.destroy(),window._dbOriginChartInstance=null)),e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const n=new Date,a=n.getHours(),o=a<12?"Bom dia":a<18?"Boa tarde":"Boa noite",i=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],d=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],l=`${i[n.getDay()]}, ${n.getDate()} de ${d[n.getMonth()]} de ${n.getFullYear()}`,s=((k=y==null?void 0:y.name)==null?void 0:k.split(" ")[0])||"Corretor",c=e.querySelector(".db-greeting");c&&(c.innerHTML=`${o}, <span class="db-greeting-name">${D(s)}</span> 👋`);const r=document.getElementById("db-subline");r&&(r.textContent=`Aqui está o resumo do seu negócio — ${l}`);let m=[],u=[];try{const[f,I]=await Promise.all([Jt(),Bn()]);m=f||[],u=I||[]}catch(f){console.warn("[Dashboard] Erro ao carregar dados:",f)}Cn(m,u,n);const w=m.filter(f=>f.published).length,E=u.filter(f=>gt(f.created_at)===gt(n.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
    ...
    <span class="db-chip db-chip-gold">
      ...
      ${l.split(",")[0]}
    </span>`),qn(u,m),An(m),Mn(m,u,n),zn(m,u);try{await Sn(),Ft(u,7),Tn(u),document.querySelectorAll(".db-ptab").forEach(f=>{f.addEventListener("click",()=>{document.querySelectorAll(".db-ptab").forEach($=>$.classList.remove("active")),f.classList.add("active");const I=parseInt(f.dataset.p);window._dbSelectedDays=I,Ft(u,I)})})}catch(f){console.warn("[Dashboard] Chart.js não carregou:",f)}window.lucide&&lucide.createIcons(),window._dbRefreshTimer&&clearInterval(window._dbRefreshTimer),window._dbRefreshTimer=setInterval(()=>{const f=document.getElementById("dashboard-content")||document.querySelector(".db-dashboard");!f||f.offsetParent===null||typeof renderDashboard=="function"&&renderDashboard(!0)},3e4)}function D(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function gt(e){return(e||"").slice(0,10)}function ya(e,t){if(!e)return"—";const n=t-new Date(e),a=Math.floor(n/6e4);if(a<2)return"agora mesmo";if(a<60)return`há ${a}min`;const o=Math.floor(a/60);if(o<24)return`há ${o}h`;const i=Math.floor(o/24);return i===1?"ontem":i<7?`há ${i} dias`:new Date(e).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}function ba(e){return e>=1e6?(e/1e6).toFixed(1).replace(".",",")+"M":e>=1e3?(e/1e3).toFixed(0)+"k":String(e)}async function Bn(){let e=b.from("leads").select("*").order("created_at",{ascending:!1}).limit(500);(y==null?void 0:y.role)==="corretor"?e=e.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t,error:n}=await e;return n?(console.warn("[Dashboard] leads fetch error:",n.message),[]):t||[]}function Cn(e,t,n){const a=e.length,o=e.filter(x=>x.published).length,i=t.length,d=t.filter(x=>x.stage&&x.stage!=="perdido"&&x.stage!=="fechado").length,l=new Date(n);l.setDate(l.getDate()-30);const s=new Date(n);s.setDate(s.getDate()-60);const c=e.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,r=e.filter(x=>x.created_at&&new Date(x.created_at)>=s&&new Date(x.created_at)<l).length,m=t.filter(x=>x.created_at&&new Date(x.created_at)>=l).length,u=t.filter(x=>x.created_at&&new Date(x.created_at)>=s&&new Date(x.created_at)<l).length;function w(x,k,f){if(k===0&&x===0)return'<span class="db-kpi-trend db-trend-neu">Sem dados</span>';if(k===0)return'<span class="db-kpi-trend db-trend-up">▲ Novo</span>';const I=Math.round((x-k)/k*100);return I===0?'<span class="db-kpi-trend db-trend-neu">= Estável</span>':I>0?`<span class="db-kpi-trend db-trend-up">▲ +${I}% ${f}</span>`:`<span class="db-kpi-trend db-trend-down">▼ ${I}% ${f}</span>`}[{idx:0,val:a,label:"Total de Imóveis",trend:w(c,r,"este mês"),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>'},{idx:1,val:o,label:"Publicados no Site",trend:o===0?'<span class="db-kpi-trend db-trend-neu">Nenhum publicado</span>':`<span class="db-kpi-trend db-trend-up">${Math.round(o/Math.max(a,1)*100)}% do total</span>`,icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>'},{idx:2,val:i,label:"Leads Recebidos",trend:w(m,u,"vs. mês ant."),icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>'},{idx:3,val:d,label:"Em Negociação",trend:d===0?'<span class="db-kpi-trend db-trend-neu">Nenhum ativo</span>':'<span class="db-kpi-trend db-trend-up">▲ Ativos</span>',icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/></svg>'}].forEach(({idx:x,val:k,label:f,trend:I,icon:$})=>{const S=document.getElementById(`db-kpi-${x}`);S&&(S.innerHTML=`
      <div class="db-kpi-icon">${$}</div>
      <div class="db-kpi-body">
        <div class="db-kpi-val">${ba(k)}</div>
        <div class="db-kpi-lbl">${D(f)}</div>
        ${I}
      </div>`)})}function Ft(e,t){const n=document.getElementById("db-leads-chart");if(!n||!window.Chart)return;if(window._dbLeadsChartInstance){try{window._dbLeadsChartInstance.destroy()}catch{}window._dbLeadsChartInstance=null}const a=[],o=[],i=new Date;for(let l=t-1;l>=0;l--){const s=new Date(i);s.setDate(s.getDate()-l);const c=s.toISOString().slice(0,10),r=t<=7?s.toLocaleDateString("pt-BR",{weekday:"short"}).replace(".",""):t<=30?s.toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"}):s.toLocaleDateString("pt-BR",{day:"2-digit",month:"short"});a.push(r),o.push(e.filter(m=>gt(m.created_at)===c).length)}const d=Math.max(...o,1);window._dbLeadsChartInstance=new Chart(n,{type:"bar",data:{labels:a,datasets:[{label:"Leads",data:o,backgroundColor:o.map(l=>l===d&&d>0?"rgba(201,162,39,0.90)":"rgba(201,162,39,0.35)"),borderColor:"#C9A227",borderWidth:1.5,borderRadius:6,borderSkipped:!1}]},options:{responsive:!0,maintainAspectRatio:!0,plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:l=>` ${l.parsed.y} lead${l.parsed.y!==1?"s":""}`}}},scales:{x:{grid:{display:!1},ticks:{color:"#94A3B8",font:{size:11}}},y:{beginAtZero:!0,grid:{color:"rgba(226,232,240,0.6)",drawBorder:!1},ticks:{color:"#94A3B8",font:{size:11},precision:0,stepSize:Math.max(1,Math.ceil(d/4))}}}}})}window._dbOriginChartInstance=null;function Tn(e){const t=document.getElementById("db-origin-chart"),n=document.getElementById("db-origin-legend");if(!t||!window.Chart)return;window._dbOriginChartInstance&&(window._dbOriginChartInstance.destroy(),_dbOriginChartInstance=null);const a={};e.forEach(c=>{const r=c.source||"Direto",m=r.charAt(0).toUpperCase()+r.slice(1);a[m]=(a[m]||0)+1}),Object.keys(a).length===0&&(a.Site=0,a.WhatsApp=0,a.Indicação=0);const o=Object.keys(a),i=Object.values(a),d=["#6366F1","#10B981","#F59E0B","#0EA5E9","#EC4899","#8B5CF6","#14B8A6","#94A3B8"],l=o.map((c,r)=>d[r%d.length]),s=i.reduce((c,r)=>c+r,0);window._dbOriginChartInstance=new Chart(t,{type:"doughnut",data:{labels:o,datasets:[{data:i,backgroundColor:l,borderWidth:2,borderColor:"#fff",hoverOffset:4}]},options:{responsive:!0,cutout:"68%",plugins:{legend:{display:!1},tooltip:{backgroundColor:"#0F172A",padding:10,callbacks:{label:c=>{const r=s>0?Math.round(c.parsed/s*100):0;return` ${c.label}: ${c.parsed} (${r}%)`}}}}}}),n&&(s===0?n.innerHTML='<div class="db-empty" style="padding:12px 0"><div class="db-empty-text">Nenhum lead ainda<br><span style="font-size:11px;color:#CBD5E1">Os canais aparecerão aqui quando houver leads</span></div></div>':n.innerHTML=o.map((c,r)=>`
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-time">${ya(d.time,n)}</div>
