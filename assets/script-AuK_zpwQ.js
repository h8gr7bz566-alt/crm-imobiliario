import{s as h}from"./supabase-BcuJ3xoD.js";const F="00000000-0000-0000-0000-000000000000";let de={},he={},oe=F;function fe(e){oe=e||F,de={},he={}}const M=()=>oe;async function da(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",oe),h.from("site_content").select("*").eq("tenant_id",oe)]);if(e.data&&e.data.forEach(n=>{de[n.key]=n.value}),t.data&&t.data.forEach(n=>{he[n.key]=n}),(!t.data||t.data.length===0)&&oe!==F){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",F),h.from("site_content").select("*").eq("tenant_id",F)]);n.data&&n.data.forEach(o=>{de[o.key]===void 0&&(de[o.key]=o.value)}),a.data&&a.data.forEach(o=>{he[o.key]||(he[o.key]=o)})}}const J=(e,t=null)=>de[e]!==void 0?de[e]:t,Se=(e,t="pt")=>{const n=he[e];return n&&(n["value_"+t]||n.value_pt)||null};async function xe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:oe,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{de[o]=i}),!a}async function Re(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:oe,updated_at:o},{error:d}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(he[e]=i),oe!==F&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:F,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Qe(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function ct(){const e=document.documentElement,t=J("visual.accent_color","#b8962e"),n=J("visual.primary_bg","#0f1c2e"),a=J("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=J("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=J("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const r=J("visual.hero_bg_url","");if(r){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+r+"')")}}function ht(e){e=e||"pt";const t=g=>Se(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),r=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),r&&t("inst.bio_p3")&&(r.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),l=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),b=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),l&&t("inst.stat3_num")&&(l.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),b&&t("inst.stat3_label")&&(b.innerHTML=t("inst.stat3_label"));const x=document.getElementById("dep-grid");if(x){const g=Se("testimonials",e)||Se("testimonials","pt");if(g)try{const E=JSON.parse(g);if(Array.isArray(E)&&E.length>0){let S=function(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(k){let w=0;for(const $ of k||"?")w=w*31+$.charCodeAt(0)&4294967295;return I[Math.abs(w)%I.length]};const I=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];x.innerHTML=E.map(k=>`
      ...
      <td class="cell-price">${f(Ae(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
...
${d}`),s=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",c=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",l=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",m=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",p=Math.max(1,Math.min(n,6)),b=`<div class="icard-dots">${Array.from({length:p},(u,v)=>`<span class="icard-dot${v===0?" active":""}"></span>`).join("")}</div>`;return`
    <div class="imovel-card" data-pid="${e.id}">
      <div class="icard-img-wrap" data-total="${n}" data-idx="0" data-pid="${e.id}" data-images="${encodeURIComponent(JSON.stringify(t))}">
        <img src="${f(a)}" alt="" class="icard-img-bg carousel-img-bg" aria-hidden="true">
        <a href="property.html?id=${e.id}" class="icard-img-link">
          <img src="${f(a)}" alt="${f(e.title)}" class="icard-img carousel-img">
        </a>
        ${n>1?`
  ...
  `}let ne=[],K=0;function Ia(e){var m,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||we[0];document.getElementById("view-thumb-preview").src=i,ne=(p=e.images)!=null&&p.length?e.images:we,K=0,Xe(),document.getElementById("view-price").textContent=Ae(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),r=document.getElementById("view-condominium");r&&(r.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(b=>b.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(b=>b.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=s);const l=document.getElementById("share-panel");l&&(l.style.display="none",l.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function ze(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Xe(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=ne[K],e.alt=`Foto ${K+1}`;const i=ne.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${K+1} / ${ne.length}`:"",o.innerHTML=i?ne.map((d,r)=>`<img src="${d}" class="view-thumb${r===K?" active":""}" data-i="${r}" alt="Foto ${r+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{K=+d.dataset.i,Xe()})})}async function Et(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ve(e){var m,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const r=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),l=document.getElementById("avatar-dd-initial");r&&(r.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",l&&(l.style.display="none")):(l&&(l.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",l.style.display=""),c&&(c.style.display="none"))}async function wt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==F,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),r=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==r&&(t.href=`https://${s}`)}catch{}}const Ne={dashboard:()=>on(),empresa:()=>Wt(),visual:()=>Jt(),"site-config":()=>Yt(),"crm-config":()=>Kt(),integracoes:()=>Qt(),midia:()=>Zt(),depoimentos:()=>Gt()};function te(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Ne<"u"&&Ne[e]){const o=Ne[e];Ne[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),Z(),e==="contatos"&&za(),e==="funil"&&Sa(),e==="tarefas"&&Ba()}function It(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:Wt,visual:Jt,"site-config":Yt,"crm-config":Kt,integracoes:Qt,midia:Zt,depoimentos:Gt}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>Pa(),{once:!0}),window.lucide&&lucide.createIcons()}}function Z(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function $a(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    <div class="modal" style="max-width:440px;">
      ...
      <div class="modal-footer">
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(r=document.getElementById("ac-save"))==null||r.addEventListener("click",async()=>{var p,b,x;const s=(p=document.getElementById("ac-email"))==null?void 0:p.value.trim(),c=(b=document.getElementById("ac-password"))==null?void 0:b.value.trim(),l=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!c||c.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}l.disabled=!0,l.textContent="Criando…",m.style.display="none";try{const u=e||(y==null?void 0:y.tenant_id)||null,v=((x=document.getElementById("ac-role"))==null?void 0:x.value)||"corretor",g=await pe({email:s,password:c,role:v,tenant_id:u});l.disabled=!1,l.textContent="+ Criar Acesso",g.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",g.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${f(s)}<br><strong>Senha:</strong> ${f(c)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(g.error||"Falha desconhecida"))}catch(u){l.disabled=!1,l.textContent="+ Criar Acesso",alert("Erro: "+u.message)}})}function $t(){var i,d,r,s,c,l,m,p,b,x,u;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",v=>{var E;v.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(E=document.getElementById("notif-dropdown"))==null||E.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",v=>{v.stopPropagation(),Z(),ka()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",v=>{v.stopPropagation(),Z(),$a()}),(r=document.getElementById("avatar-dd-add-corretor"))==null||r.addEventListener("click",v=>{v.stopPropagation(),Z(),at()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",v=>{v.stopPropagation(),Z(),te("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async v=>{v.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",v=>{var E;v.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((E=document.getElementById("avatar-dropdown"))==null||E.classList.add("hidden"),qa())}),(l=document.getElementById("notif-mark-all"))==null||l.addEventListener("click",()=>{Ta(),Z()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var v,g;(v=document.getElementById("search-overlay"))==null||v.classList.remove("hidden"),(g=document.getElementById("search-input"))==null||g.focus()}),(p=document.getElementById("search-overlay-close"))==null||p.addEventListener("click",()=>{var v;(v=document.getElementById("search-overlay"))==null||v.classList.add("hidden")}),(b=document.getElementById("search-overlay"))==null||b.addEventListener("click",v=>{v.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(x=document.getElementById("search-input"))==null||x.addEventListener("input",v=>{clearTimeout(o),o=setTimeout(()=>Ca(v.target.value.trim()),280)}),(u=document.getElementById("search-input"))==null||u.addEventListener("keydown",v=>{var g;v.key==="Escape"&&((g=document.getElementById("search-overlay"))==null||g.classList.add("hidden"))}),document.addEventListener("click",Z)}let nt=!1,W=[],Ge=[],We=[],ce={},Ot=[],Q=null,Le=null,G={search:"",tags:new Set,status:""};async function Sa(){var t;if(nt){await kt();return}nt=!0,await kt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>it()),Ya();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{Q=parseInt(e.value,10),await Je()})}function ot(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+Ot.map(d=>`<option value="${f(d.name)}">${f(d.name)}</option>`).join(""),n.value=G.status,n.onchange=()=>{G.status=n.value,ye()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(d=>`<button class="kf-tag-btn${G.tags.has(d.name)?" active":""}" data-tag="${f(d.name)}"
          style="--kf-tc:${d.color}">
          ${f(d.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const r=d.dataset.tag;G.tags.has(r)?G.tags.delete(r):G.tags.add(r),ot(e),ye()})})}const o=document.getElementById("kf-search");o&&(o.value=G.search,o.oninput=()=>{G.search=o.value.toLowerCase(),ye()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{G={search:"",tags:new Set,status:""},ot(e),ye()})}async function kt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);W=t||[],Ot=a||[],ce={},(n||[]).forEach(r=>{ce[r.name]=r});const o=W.map(r=>r.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};Ge=i||[],ot(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const r=Q;d.innerHTML=W.length?W.map(c=>`<option value="${c.id}">${f(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=W.find(c=>c.id===r)||W.find(c=>c.is_default)||W[0];s?(d.value=s.id,Q=s.id):Q=null}await Je()}async function Je(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),Q&&(t=t.eq("pipeline_id",Q));const{data:n}=await t;We=n||[],ye()}function ye(){const e=document.getElementById("kanban-board");if(!e)return;const t=Ge.filter(i=>i.pipeline_id===Q);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=G,a=We.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(r=>d.includes(r)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var r,s,c,l;const d=i.stage||((r=t[0])==null?void 0:r.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(l=o[d]||o[(c=t[0])==null?void 0:c.name])==null||l.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],r=d.length?d.map(s=>{const c=(s.phone||"").replace(/\D/g,""),l=encodeURIComponent(`Olá ${s.name}! Aqui é da ${J("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          ...
          ${s.notes?`<div class="kanban-card-info" style="font-size:11px;color:#64748b;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:200px;">📝 ${f(s.notes)}</div>`:""}
          <div class="kanban-card-tags" style="display:flex;flex-wrap:wrap;gap:4px;margin-top:6px;">
            ...
            ${Array.isArray(s.tags)?s.tags.map(m=>{const p=ce[m],b=(p==null?void 0:p.color)||"#0369a1";return`<span class="kanban-card-tag" style="background:${b}18;color:${b};border:1px solid ${b}44;">${f(m)}</span>`}).join(""):""}
          </div>
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      <div id="ldp-tags-wrap" class="ldp-tags-section">
        ...
        <div class="ldp-tag-badge-area" id="ldp-tag-badge-area">
          ${((e==null?void 0:e.tags)||[]).map(g=>{const I=(ce[g]||{}).color||"#6366F1";return`<span class="ldp-tag-badge" data-tag="${f(g)}" style="background:${I}18;color:${I};border-color:${I}55;">${f(g)}<span class="ldp-tag-rm" data-tag="${f(g)}">×</span></span>`}).join("")||'<span class="ldp-tag-empty">Nenhuma tag — clique em + para adicionar</span>'}
        </div>
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),b=document.createElement("a");b.href=URL.createObjectURL(p),b.download="modelo_contatos.csv",b.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",Na),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",ja)))}async function Ft(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;Y=a||[],me()}function me(){var r,s,c;const e=(((r=document.getElementById("contato-search"))==null?void 0:r.value)||"").toLowerCase(),t=e?Y.filter(l=>(l.name||"").toLowerCase().includes(e)||(l.email||"").toLowerCase().includes(e)||(l.phone||"").toLowerCase().includes(e)):Y,n=t.length,a=Math.max(1,Math.ceil(n/Be));j>a&&(j=a);const o=t.slice((j-1)*Be,j*Be),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(l=>`
      <tr>
        ...
        <td>
          <a href="#" class="contato-name-link" data-id="${l.id}" style="color:#2563eb;font-weight:500;text-decoration:none;">${f(l.name||"—")}</a>
        </td>
        <td>${f(l.company||"")}</td>
        <td style="color:#64748b;font-size:13px;">${l.email?f(l.email):"—"}</td>
        <td style="font-size:13px;">${l.phone?f(l.phone):"—"}</td>
        <td style="font-size:13px;color:#64748b;">${f(l.job_title||"")}</td>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select id="cm-pipe" name="pipeline_id" class="form-control">
                  ...
                  ${r.map(w=>`<option value="${w.id}" ${String(e==null?void 0:e.pipeline_id)===String(w.id)?"selected":""}>${f(w.name)}</option>`).join("")}
                </select>
              </div>
              <div class="form-group">
  ...
  `,document.body.appendChild(u);const v=()=>u.remove();(E=document.getElementById("cm-close"))==null||E.addEventListener("click",v),(I=document.getElementById("cm-cancel"))==null||I.addEventListener("click",v),u.addEventListener("click",w=>{w.target===u&&v()}),(S=document.getElementById("cm-pipe"))==null||S.addEventListener("change",w=>{const $=document.getElementById("cm-stage");$&&($.innerHTML=x(w.target.value))}),(L=document.getElementById("cm-delete"))==null||L.addEventListener("click",async()=>{if(!confirm(`Excluir o contato "${e==null?void 0:e.name}"?`))return;await h.from("leads").delete().eq("id",e.id);const w=Y.findIndex($=>String($.id)===String(e.id));w>=0&&Y.splice(w,1),v(),me()}),(k=document.getElementById("cm-save"))==null||k.addEventListener("click",async()=>{var V,H,O,ae,se,$e,ke;const w=document.getElementById("contato-form");if(!w.checkValidity()){w.reportValidity();return}const $=new FormData(w),B=document.getElementById("cm-save");B.disabled=!0,B.textContent="Salvando…";const q=$.getAll("tag"),C=$.get("pipeline_id")||null,N={name:(V=$.get("name"))==null?void 0:V.trim(),company:((H=$.get("company"))==null?void 0:H.trim())||null,email:((O=$.get("email"))==null?void 0:O.trim())||null,phone:((ae=$.get("phone"))==null?void 0:ae.trim())||null,job_title:((se=$.get("job_title"))==null?void 0:se.trim())||null,city_interest:(($e=$.get("city_interest"))==null?void 0:$e.trim())||null,notes:((ke=$.get("notes"))==null?void 0:ke.trim())||null,pipeline_id:C,stage:$.get("stage")||null,status:$.get("status")||null,tags:q,assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null,source:(e==null?void 0:e.source)||"manual"};let T;if(n){if({error:T}=await h.from("leads").update(N).eq("id",e.id),!T){const U=Y.findIndex(ve=>String(ve.id)===String(e.id));U>=0&&(Y[U]={...Y[U],...N})}}else{const{data:U,error:ve}=await h.from("leads").insert(N).select();T=ve,!T&&(U!=null&&U[0])&&Y.unshift(U[0])}if(B.disabled=!1,B.textContent=n?"Salvar":"Criar Contato",T){alert("Erro: "+T.message);return}v(),me()})}let Ee=[];function Na(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Ee=a.target.result.split(`
`).filter(r=>r.trim()).slice(1).map(r=>{const[s,c,l,m,p]=r.split(",").map(b=>b.trim().replace(/^"|"$/g,""));return{name:s,email:c,phone:l,company:m,job_title:p}}).filter(r=>r.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Ee.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=Ee.length===0)},n.readAsText(t)}async function ja(){if(!Ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}st(),await Ft(),alert(`${t.length} contato(s) importados com sucesso!`)}function Da(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function st(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Ra="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function pe(e){return(await fetch(Ra,{method:"POST",headers:{Authorization:`Bearer ${la}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Bt(e){var s,c,l,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:p}}=await h.auth.getUser();n.value=(p==null?void 0:p.email)||""}const r=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=r),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",p=>{const b=p.target.files[0];if(!b)return;const x=URL.createObjectURL(b);a&&(a.src=x,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var g,E;const p=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",b=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",x=document.getElementById("change-password-msg"),u=document.getElementById("btn-change-password");if(x&&(x.style.display="none"),p.length<6){x&&(x.textContent="Mínimo 6 caracteres.",x.style.display="");return}if(p!==b){x&&(x.textContent="As senhas não coincidem.",x.style.display="");return}u&&(u.disabled=!0,u.textContent="Salvando…");const{error:v}=await h.auth.updateUser({password:p});u&&(u.disabled=!1,u.textContent="Salvar Nova Senha"),v?x&&(x.textContent="Erro: "+v.message,x.style.display=""):(x&&(x.style.color="#16a34a",x.textContent="Senha alterada com sucesso!",x.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var E;const p=t.value.trim();let b=(y==null?void 0:y.avatar_url)||"";const x=i==null?void 0:i.files[0],u=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",x)try{const I=await Me(x,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:L}=await h.storage.from("imoveis").upload(S,I,{contentType:"image/jpeg",upsert:!0});if(!L){const{data:{publicUrl:k}}=h.storage.from("imoveis").getPublicUrl(S);b=k}}catch(I){console.error("Avatar upload:",I)}const{error:v}=await h.from("profiles").update({name:p,avatar_url:b}).eq("id",y.id);if(d.disabled=!1,d.textContent=u,v){alert("Erro ao salvar perfil.");return}y={...y,name:p,avatar_url:b},Ve(y);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=((E=p[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const p=document.getElementById("settings-corretores-section");p&&(p.style.display=""),await Ye(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var E,I;const x=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),u=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),v=document.getElementById("btn-invite-corretor"),g=document.getElementById("invite-note");if(!x){alert("Informe o e-mail do corretor.");return}if(!u||u.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}v&&(v.disabled=!0,v.textContent="Criando…"),g&&(g.style.display="none");try{const S=await pe({email:x,password:u,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const L=document.getElementById("invite-email"),k=document.getElementById("invite-password");L&&(L.value=""),k&&(k.value=""),await Ye(),g&&(S.email_sent===!1?(g.innerHTML=`
                ✅ Acesso criado!
                <span style="color:#ef4444;">⚠️ E-mail não enviado automaticamente.</span><br>
                Compartilhe manualmente:<br>
                <strong>E-mail:</strong> ${f(x)}<br>
                <strong>Senha:</strong> ${f(u)}`,g.style.color="#0f172a"):(g.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",g.style.color="#16a34a"),g.style.display="")}else alert("Erro: "+(S.error||"Falha desconhecida"))}catch(S){alert("Erro ao criar acesso: "+S.message)}finally{v&&(v.disabled=!1,v.textContent="+ Criar Acesso")}});const b=document.getElementById("settings-locations-section");b&&(b.style.display=""),await Ce(),(l=document.getElementById("loc-add-city-btn"))==null||l.addEventListener("click",async()=>{const x=document.getElementById("loc-new-city"),u=x==null?void 0:x.value.trim();if(!u)return;const{error:v}=await h.from("locations").insert({type:"cidade",name:u});if(v){alert("Erro ao adicionar cidade.");return}x&&(x.value=""),await Ce(),vt()}),(m=document.getElementById("loc-add-neighborhood-btn"))==null||m.addEventListener("click",async()=>{var E;const x=parseInt((E=document.getElementById("loc-new-neighborhood-city"))==null?void 0:E.value,10),u=document.getElementById("loc-new-neighborhood"),v=u==null?void 0:u.value.trim();if(!x||!v){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:g}=await h.from("locations").insert({type:"bairro",name:v,parent_id:x});if(g){alert("Erro ao adicionar bairro.");return}u&&(u.value=""),await Ce()})}}async function Ye(){const e=document.getElementById("corretores-list");if(!e)return;let t=h.from("profiles").select("*").order("created_at");y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const i=(o.name||"?")[0].toUpperCase(),d=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${f(i)}</div>`,r=o.id===(y==null?void 0:y.id),s=o.active!==!1,c=s?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',l=r?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
...
`+k);window.open("mailto:?subject="+$+"&body="+B,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const k=document.getElementById("share-link-input");k&&((w=navigator.clipboard)==null||w.writeText(k.value).then(()=>{const $=document.getElementById("share-copy"),B=$.textContent;$.textContent="✅ Copiado!",setTimeout(()=>{$.textContent=B},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var N;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(T=>T.id===k);if(!w)return;ze(),R=w.id;const $=document.getElementById("property-form"),B=document.getElementById("form-submit-btn");B.textContent="Salvar Alterações",$.querySelector('[name="title"]').value=w.title||"",$.querySelector('[name="rua"]').value=w.rua||"",$.querySelector('[name="numero"]').value=w.numero||"",$.querySelector('[name="city"]').value=w.city||"",$.querySelector('[name="price"]').value=w.price||"",$.querySelector('[name="bedrooms"]').value=w.bedrooms||"",$.querySelector('[name="suites"]').value=w.suites||"",$.querySelector('[name="parking"]').value=w.parking||"",$.querySelector('[name="description"]').value=w.description||"",$.querySelector('[name="construction_status"]').value=w.construction_status||"",$.querySelector('[name="owner_name"]').value=w.owner_name||"",$.querySelector('[name="owner_phone"]').value=w.owner_phone||"",$.querySelector('[name="owner_email"]').value=w.owner_email||"",$.querySelector('[name="owner_notes"]').value=w.owner_notes||"",$.querySelector('[name="condominium"]').value=w.condominium||"";const q=document.getElementById("adminPublished");q&&(q.value=w.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=w.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const T=document.getElementById("adminNeighborhood");T&&(T.value=w.neighborhood||"")},50)),le=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Fe(w.images||[]),tt("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach($=>$.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach($=>$.classList.add("hidden")),(w=document.getElementById(`tab-${k.dataset.tab}`))==null||w.classList.remove("hidden")})}),(L=document.getElementById("admin-properties"))==null||L.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const w=k.target.closest("tr");if(!w)return;const $=Number(w.dataset.id);if(!$)return;const B=_.find(q=>q.id===$);B&&Ia(B)})}async function Gt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const r=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return r[Math.abs(s)%r.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
        ...
        ${n.length===0?'<p style="color:#94a3b8;font-size:14px">Nenhum depoimento cadastrado ainda.</p>':n.map((s,c)=>`
            <div class="dep-admin-card" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:16px 20px;display:flex;align-items:flex-start;gap:14px">
              ...
              <div style="flex:1;min-width:0">
                ...
                <p style="color:#374151;font-size:14px;line-height:1.5;margin:0 0 6px;font-style:italic">"${f(s.text||"")}"</p>
                <div style="font-weight:600;font-size:13px;color:#0f172a">${f(s.name||"")}</div>
                <div style="font-size:12px;color:#64748b">${f(s.role||"")}</div>
              </div>
  ...
  `,document.getElementById("co-logo-url").addEventListener("input",o=>{document.getElementById("co-logo-preview").src=o.target.value||"/logo.png"}),document.getElementById("co-logo-file").addEventListener("change",async o=>{const i=o.target.files[0];if(i)try{const d=await ft(i,"logos");document.getElementById("co-logo-url").value=d,document.getElementById("co-logo-preview").src=d}catch(d){alert("Erro no upload: "+d.message)}}),document.getElementById("co-save-identity").addEventListener("click",async()=>{const o=document.getElementById("co-save-identity");o.disabled=!0,o.textContent="Salvando…";const i=await xe([["company.name",document.getElementById("co-name").value.trim()],["company.creci",document.getElementById("co-creci").value.trim()],["company.logo_url",document.getElementById("co-logo-url").value.trim()],["company.favicon_url",document.getElementById("co-favicon-url").value.trim()]]);i&&ct(),o.disabled=!1,o.textContent="Salvar Identidade",X(document.getElementById("co-identity-msg"),i)}),document.getElementById("co-save-contacts").addEventListener("click",async()=>{const o=document.getElementById("co-save-contacts");o.disabled=!0,o.textContent="Salvando…";const i=document.getElementById("co-whatsapp").value.trim(),d=await xe([["company.whatsapp",i],["company.phone",document.getElementById("co-phone").value.trim()],["company.email",document.getElementById("co-email").value.trim()],["company.address",document.getElementById("co-address").value.trim()]]);d&&i&&(_e=i),o.disabled=!1,o.textContent="Salvar Contatos",X(document.getElementById("co-contacts-msg"),d)}),document.getElementById("co-save-social").addEventListener("click",async()=>{const o=document.getElementById("co-save-social");o.disabled=!0,o.textContent="Salvando…";const i=await xe([["company.instagram_url",document.getElementById("co-instagram").value.trim()],["company.facebook_url",document.getElementById("co-facebook").value.trim()],["company.youtube_url",document.getElementById("co-youtube").value.trim()],["company.tiktok_url",document.getElementById("co-tiktok").value.trim()],["company.linkedin_url",document.getElementById("co-linkedin").value.trim()]]);o.disabled=!1,o.textContent="Salvar Redes Sociais",X(document.getElementById("co-social-msg"),i)})}async function Jt(){const e=document.getElementById("section-visual");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("settings").select("key,value").eq("tenant_id",M()),n={};t==null||t.forEach(l=>{n[l.key]=l.value||""});const a=n["visual.accent_color"]||"#b8962e",o=n["visual.primary_bg"]||"#0f1c2e",i=n["visual.secondary_bg"]||"#1a2f4a",d=n["visual.hero_bg_url"]||"",r=n["visual.price_max_slider"]||13e7;e.innerHTML=`
    ...
    <div class="cfg-card">
      ...
      <div class="form-group" style="margin-bottom:16px">
        ...
        <div style="display:flex;gap:8px">
          <input id="vis-hero-url" class="form-control" value="${f(d)}" placeholder="https://... ou deixe vazio para padrão">
          <label class="btn-secondary" style="cursor:pointer;white-space:nowrap;padding:8px 14px;font-size:13px">
        ...
        <div id="vis-hero-preview" style="margin-top:10px;display:${d?"":"none"}">
          <img src="${f(d)}" style="max-width:100%;max-height:120px;border-radius:8px;object-fit:cover">
        </div>
      </div>
      <div class="form-group" style="margin-bottom:0">
  ...
  `,document.getElementById("crm-add-stage").addEventListener("click",async()=>{const u=document.getElementById("crm-new-stage").value.trim(),v=document.getElementById("crm-new-stage-color").value,g=parseInt(document.getElementById("crm-pipe-sel").value,10);u&&(await h.from("crm_stages").insert({pipeline_id:g,name:u,color:v,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-stage").value="",await P())}),e.querySelectorAll(".stage-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover esta etapa?")&&(await h.from("crm_stages").delete().eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".stage-color-pick").forEach(u=>{u.addEventListener("change",async v=>{await h.from("crm_stages").update({color:v.target.value}).eq("id",u.dataset.sid);const g=u.closest(".stage-item").querySelector(".stage-color-dot");g&&(g.style.background=v.target.value)})});const p=async()=>{const u=document.getElementById("crm-new-tag"),v=document.getElementById("crm-new-tag-color"),g=u==null?void 0:u.value.trim(),E=(v==null?void 0:v.value)||"#6366F1";if(!g){u==null||u.focus();return}await h.from("crm_tags").insert({name:g,color:E,tenant_id:M()}),u&&(u.value=""),await P()};(b=document.getElementById("crm-add-tag"))==null||b.addEventListener("click",p),(x=document.getElementById("crm-new-tag"))==null||x.addEventListener("keydown",u=>{u.key==="Enter"&&p()}),e.querySelectorAll(".tm-del-btn").forEach(u=>{u.addEventListener("click",async()=>{confirm("Excluir esta tag? Os leads que a possuem não serão afetados.")&&(await h.from("crm_tags").delete().eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".tm-name-input").forEach(u=>{const v=u.closest(".tm-row"),g=v==null?void 0:v.querySelector(".tm-save-btn");g&&(g.style.display="none"),u.addEventListener("input",()=>{const E=u.value.trim()!==u.dataset.orig;g&&(g.style.display=E?"":"none")})}),e.querySelectorAll(".tm-color-input").forEach(u=>{const v=u.closest(".tm-row"),g=v==null?void 0:v.querySelector(".tm-color-swatch"),E=v==null?void 0:v.querySelector(".tm-save-btn");u.addEventListener("input",I=>{g&&(g.style.background=I.target.value),E&&(E.style.display="")})}),e.querySelectorAll(".tm-save-btn").forEach(u=>{u.style.display="none",u.addEventListener("click",async()=>{var I,S;const v=u.closest(".tm-row"),g=(I=v.querySelector(".tm-name-input"))==null?void 0:I.value.trim(),E=(S=v.querySelector(".tm-color-input"))==null?void 0:S.value;g&&(u.disabled=!0,u.textContent="✓ Salvando…",await h.from("crm_tags").update({name:g,color:E}).eq("id",u.dataset.id),await P())})}),e.querySelectorAll(".tm-tpl-btn").forEach(u=>{u.addEventListener("click",async()=>{const v=u.dataset.name,g=u.dataset.color;u.disabled=!0,u.innerHTML="✓",await h.from("crm_tags").insert({name:v,color:g,tenant_id:M()}),await P()})}),e.querySelectorAll(".tag-chip-del").forEach(u=>{u.addEventListener("click",async()=>{await h.from("crm_tags").delete().eq("id",u.dataset.id),await P()})}),document.getElementById("crm-add-status").addEventListener("click",async()=>{const u=document.getElementById("crm-new-status").value.trim(),v=document.getElementById("crm-new-status-color").value,g=document.getElementById("crm-new-status-final").checked;u&&(await h.from("crm_lead_statuses").insert({name:u,color:v,is_final:g,sort_order:99,tenant_id:M()}),document.getElementById("crm-new-status").value="",await P())}),e.querySelectorAll(".status-del").forEach(u=>{u.addEventListener("click",async()=>{confirm("Remover este status?")&&(await h.from("crm_lead_statuses").delete().eq("id",u.dataset.id),await P())})}),document.getElementById("crm-add-pipeline").addEventListener("click",async()=>{var g;const u=(g=prompt("Nome do novo funil:"))==null?void 0:g.trim();if(!u)return;const{error:v}=await h.from("crm_pipelines").insert({name:u,sort_order:99,tenant_id:M()});if(v){alert("Erro ao criar funil: "+v.message);return}nt=!1,await P()})}async function Qt(){const e=document.getElementById("section-integracoes");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("integrations").select("*"),n={};t==null||t.forEach(r=>{n[r.key]=r});const a=r=>{var s;return f(((s=n[r])==null?void 0:s.value)||"")},o=r=>{var s;return(s=n[r])!=null&&s.enabled?"checked":""},i=[{key:"meta_pixel_id",icon:"📘",label:"Meta Pixel",desc:"ID do Pixel do Facebook/Instagram para rastreamento de conversões",placeholder:"123456789012345"},{key:"ga_measurement_id",icon:"📊",label:"Google Analytics 4",desc:"Measurement ID do GA4 (ex: G-XXXXXXXXXX)",placeholder:"G-XXXXXXXXXX"},{key:"gtm_container_id",icon:"🏷️",label:"Google Tag Manager",desc:"ID do container do GTM (ex: GTM-XXXXXXX)",placeholder:"GTM-XXXXXXX"},{key:"webhook_new_lead",icon:"🔔",label:"Webhook — Novo Lead",desc:"URL chamada quando um novo lead chega (POST com JSON)",placeholder:"https://..."},{key:"webhook_new_property",icon:"🏠",label:"Webhook — Novo Imóvel",desc:"URL chamada quando um imóvel é publicado",placeholder:"https://..."}],d=[{key:"smtp_host",label:"Host SMTP",placeholder:"smtp.gmail.com"},{key:"smtp_port",label:"Porta",placeholder:"587"},{key:"smtp_user",label:"Usuário",placeholder:"email@dominio.com"},{key:"smtp_from_name",label:"Nome do remetente",placeholder:"Omar Corretor"}];e.innerHTML=`
    <div class="section-topbar">
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const r=e.querySelector(`#sa-panel-${d.dataset.tab}`);r&&r.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&ie(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Fa(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ct(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&qt(),d.dataset.tab==="platform"&&Tt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ct),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",ie),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",qt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Ga()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",Xa),ie(),Tt())}async function ie(){var r,s;const e=document.getElementById("sa-tenants-list"),t=((s=(r=document.getElementById("sa-tenant-search"))==null?void 0:r.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=h.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var l,m;return!t||((l=c.name)==null?void 0:l.toLowerCase().includes(t))||((m=c.slug)==null?void 0:m.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var l;return`
    <div class="sa-list-row" data-action="open-panel" data-id="${c.id}" style="cursor:pointer;" title="Clique para gerenciar">
      <div class="sa-list-info">
        ...
        <div>
          ...
          <div class="sa-list-sub">${f(c.slug||"")} · ${f(((l=c.plans)==null?void 0:l.name)||"Sem plano")}</div>
        </div>
      </div>
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async l=>{l.stopPropagation();const m=c.dataset.active==="true";await h.from("tenants").update({active:!m}).eq("id",c.dataset.id),ie()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const l=(i||[]).find(m=>String(m.id)===String(c.dataset.id));l&&Wa(l)})})}async function Fa(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `).join("")}async function Ct(){var r;const e=document.getElementById("sa-subs-list"),t=((r=document.getElementById("sa-sub-filter"))==null?void 0:r.value)||"";if(!e)return;e.dataset.loaded="1";let n=h.from("subscriptions").select("*, tenants(name), plans(name, price_brl)").order("created_at",{ascending:!1});t&&(n=n.eq("status",t));const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro: ${o.message}</div>`;return}if(!(a!=null&&a.length)){e.innerHTML='<div class="sa-empty">Nenhuma assinatura encontrada.</div>';return}const i={active:"green",trialing:"blue",past_due:"orange",cancelled:"red",paused:"gray"},d={active:"Ativo",trialing:"Trial",past_due:"Inadimplente",cancelled:"Cancelado",paused:"Pausado"};e.innerHTML=a.map(s=>{var c,l,m;return`
    <div class="sa-list-row">
      <div class="sa-list-info">
        <div>
          <div class="sa-list-name">${f(((c=s.tenants)==null?void 0:c.name)||"—")}</div>
          <div class="sa-list-sub">${f(((l=s.plans)==null?void 0:l.name)||"—")} · R$ ${Number(((m=s.plans)==null?void 0:m.price_brl)||0).toLocaleString("pt-BR",{minimumFractionDigits:2})}/mês</div>
        </div>
      </div>
      <div class="sa-list-actions">
  ...
  `}).join("")}async function qt(){var d,r;const e=document.getElementById("sa-users-list"),t=((r=(d=document.getElementById("sa-user-search"))==null?void 0:d.value)==null?void 0:r.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";const{data:n,error:a}=await h.from("profiles").select("*, tenants(name)").order("created_at",{ascending:!1}).limit(100);if(a){e.innerHTML=`<div class="sa-error">Erro: ${a.message}</div>`;return}const o=(n||[]).filter(s=>{var c,l;return!t||((c=s.name)==null?void 0:c.toLowerCase().includes(t))||((l=s.email)==null?void 0:l.toLowerCase().includes(t))});if(!o.length){e.innerHTML='<div class="sa-empty">Nenhum usuário encontrado.</div>';return}const i={super_admin:"⚡ Super Admin",admin:"👑 Admin",corretor:"🔑 Corretor"};e.innerHTML=o.map(s=>{var c;return`
    <div class="sa-list-row">
      <div class="sa-list-info">
        ...
        <div>
          <div class="sa-list-name">${f(s.name||"—")}</div>
          <div class="sa-list-sub">${f(((c=s.tenants)==null?void 0:c.name)||"Sem imobiliária")} · ${i[s.role]||s.role}</div>
        </div>
      </div>
      <div class="sa-list-actions">
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>ea(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",lt(e,o.dataset.tab)})}),lt(e,"properties")}function Ja(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(r,s,c,l="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
      <label style="font-size:11px;font-weight:700;color:#64748b;letter-spacing:.05em;">${s}</label>
      <input id="${r}" type="${l}" value="${f(String(c||""))}" ${m}
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${l.map(m=>{var p;return`
            <tr data-pid="${m.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${f(Ae(m.price,"pt"))}</td>
      ...
      <div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 6px rgba(0,0,0,.07);">
        ...
        <table style="width:100%;border-collapse:collapse;min-width:560px;">
          ...
          <tbody>${l.map(p=>{const[b,x]=m(p.stage||p.status||"").split(","),u=(p.phone||"").replace(/\D/g,"");return`<tr data-lid="${p.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;"><span style="background:${b};color:${x};font-size:11px;font-weight:700;padding:3px 10px;border-radius:20px;">${f(p.stage||p.status||"Novo")}</span></td>
      ...
      <div style="display:grid;gap:20px;max-width:800px;">
        ...
        <div style="background:#0f172a;border-radius:12px;padding:24px;">
          ...
          <div style="font-family:monospace;font-size:12px;color:#94a3b8;line-height:2.2;">
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${l}/properties?key=${f(e.id)}</div>
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${l}/properties/{id}?key=${f(e.id)}</div>
            <div><span style="color:#fb923c;margin-right:8px;">POST</span>${l}/leads?key=${f(e.id)}</div>
            <div><span style="color:#4ade80;margin-right:8px;">GET</span>${l}/settings?key=${f(e.id)}</div>
          </div>
        </div>
      </div>`,(r=document.getElementById("tp-copy-key"))==null||r.addEventListener("click",()=>{var E;(E=navigator.clipboard)==null||E.writeText(e.id);const v=document.getElementById("tp-copy-key"),g=v.textContent;v.textContent="✅ Copiada!",setTimeout(()=>{v.textContent=g},2e3)})}if(t==="config"){const{data:l}=await h.from("settings").select("key,value").eq("tenant_id",e.id),m={};l==null||l.forEach(b=>{m[b.key]=b.value});const p=(b,x)=>`
      <div style="margin-bottom:14px;">
        <div style="font-size:11px;font-weight:700;color:#94a3b8;letter-spacing:.06em;margin-bottom:4px;">${b}</div>
        <div style="font-size:14px;color:#0f172a;">${f(String(x||"—"))}</div>
      </div>`;n.innerHTML=`
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>ea(e))}}function ea(e){var c,l,m,p,b,x,u,v;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:I}=await h.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}s(),ie()}),(v=document.getElementById("et-save"))==null||v.addEventListener("click",async()=>{var N,T,V,H,O,ae,se,$e,ke,U,ve,yt;const g=(T=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:T.trim(),E=(H=(V=document.getElementById("et-slug"))==null?void 0:V.value)==null?void 0:H.trim(),I=(ae=(O=document.getElementById("et-domain"))==null?void 0:O.value)==null?void 0:ae.trim(),S=(se=document.getElementById("et-plan"))==null?void 0:se.value,L=(ke=($e=document.getElementById("et-admin-email"))==null?void 0:$e.value)==null?void 0:ke.trim(),k=(ve=(U=document.getElementById("et-admin-password"))==null?void 0:U.value)==null?void 0:ve.trim(),w=(yt=document.getElementById("et-logo-input"))==null?void 0:yt.files[0],$=document.getElementById("et-msg"),B=document.getElementById("et-save");if(!g){$.textContent="❌ Nome é obrigatório.",$.style.color="#ef4444";return}B.disabled=!0,B.textContent="Salvando…",$.textContent="⏳ Salvando…",$.style.color="#64748b";let q=e.logo_url;if(w)try{const A=await Me(w,256,.85),bt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:ia}=await h.storage.from("imoveis").upload(bt,A,{contentType:"image/jpeg",upsert:!0});if(!ia){const{data:{publicUrl:sa}}=h.storage.from("imoveis").getPublicUrl(bt);q=sa}}catch(A){console.error("Logo upload:",A)}const{error:C}=await h.from("tenants").update({name:g,slug:E||e.slug,domain:I||null,plan_id:S||null,logo_url:q}).eq("id",e.id);if(C){B.disabled=!1,B.textContent="Salvar",$.textContent="❌ "+C.message,$.style.color="#ef4444";return}if(L&&k&&k.length>=6){$.textContent="⏳ Criando usuário admin…";const A=await pe({email:L,password:k,role:"admin",tenant_id:e.id});A!=null&&A.success?(A!=null&&A.user_id&&!(A!=null&&A.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",A.user_id),$.textContent="✅ Salvo e admin criado!",$.style.color="#22c55e"):($.textContent="⚠️ Salvo, mas erro ao criar admin: "+((A==null?void 0:A.error)||"Tente novamente"),$.style.color="#f59e0b")}else $.textContent="✅ Imobiliária atualizada!",$.style.color="#22c55e";B.disabled=!1,B.textContent="Salvar",setTimeout(()=>{s(),ie()},1200)})}const At=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Ke=[],ge=[],Ue={};function Ya(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ka)}function Ka(){Ke=[],ge=[],Ue={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
<div class="db-wrap">
  ...
  <!-- KPI Cards -->
  <div class="db-kpis">
    ${["db-kpi-indigo","db-kpi-emerald","db-kpi-amber","db-kpi-sky"].map((v,g)=>`
    <div class="db-kpi ${v}" id="db-kpi-${g}">
...
</div>`;const t=new Date,n=t.getHours(),a=n<12?"Bom dia":n<18?"Boa tarde":"Boa noite",o=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],i=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],d=`${o[t.getDay()]}, ${t.getDate()} de ${i[t.getMonth()]} de ${t.getFullYear()}`,r=((u=y==null?void 0:y.name)==null?void 0:u.split(" ")[0])||"Corretor",s=e.querySelector(".db-greeting");s&&(s.innerHTML=`${a}, <span class="db-greeting-name">${z(r)}</span> 👋`);const c=document.getElementById("db-subline");c&&(c.textContent=`Aqui está o resumo do seu negócio — ${d}`);let l=[],m=[];try{const v=y==null?void 0:y.tenant_id,[g,E]=await Promise.all([Dt(),sn(v)]);l=g||[],m=E||[]}catch(v){console.warn("[Dashboard] Erro ao carregar dados:",v)}dn(l,m,t);const p=l.filter(v=>v.published).length,b=m.filter(v=>rt(v.created_at)===rt(t.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
