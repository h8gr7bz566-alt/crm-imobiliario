import{s as h}from"./supabase-BcuJ3xoD.js";const K="00000000-0000-0000-0000-000000000000";let fe={},Se={},pe=K;function ke(e){pe=e||K,fe={},Se={}}const M=()=>pe;async function _a(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",pe),h.from("site_content").select("*").eq("tenant_id",pe)]);if(e.data&&e.data.forEach(n=>{fe[n.key]=n.value}),t.data&&t.data.forEach(n=>{Se[n.key]=n}),(!t.data||t.data.length===0)&&pe!==K){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",K),h.from("site_content").select("*").eq("tenant_id",K)]);n.data&&n.data.forEach(o=>{fe[o.key]===void 0&&(fe[o.key]=o.value)}),a.data&&a.data.forEach(o=>{Se[o.key]||(Se[o.key]=o)})}}const ee=(e,t=null)=>fe[e]!==void 0?fe[e]:t,ze=(e,t="pt")=>{const n=Se[e];return n&&(n["value_"+t]||n.value_pt)||null};async function Le(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:pe,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{fe[o]=i}),!a}async function We(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:pe,updated_at:o},{error:l}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return l||(Se[e]=i),pe!==K&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:K,updated_at:o},{onConflict:"key,tenant_id"}),!l}async function ot(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function xt(){const e=document.documentElement,t=ee("visual.accent_color","#b8962e"),n=ee("visual.primary_bg","#0f1c2e"),a=ee("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=ee("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(d=>{d.src=o});const i=ee("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=i);const r=ee("visual.hero_bg_url","");if(r){const d=document.querySelector(".hero, .hero-v2");d&&(d.style.backgroundImage="url('"+r+"')")}}function Ct(e){e=e||"pt";const t=g=>ze(g,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),r=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),r&&t("inst.bio_p3")&&(r.innerHTML=t("inst.bio_p3"));const d=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),s=document.querySelector('[data-i18n="inst.stat3_num"]'),p=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),u=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),w=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');d&&t("inst.stat1_num")&&(d.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),s&&t("inst.stat3_num")&&(s.innerHTML=t("inst.stat3_num")),p&&t("inst.stat1_label")&&(p.innerHTML=t("inst.stat1_label")),u&&t("inst.stat2_label")&&(u.innerHTML=t("inst.stat2_label")),w&&t("inst.stat3_label")&&(w.innerHTML=t("inst.stat3_label"));const I=document.getElementById("dep-grid");if(I){const g=ze("testimonials",e)||ze("testimonials","pt");if(g)try{const $=JSON.parse(g);if(Array.isArray($)&&$.length>0){let E=function(m){return String(m||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},L=function(m){let v=0;for(const x of m||"?")v=v*31+x.charCodeAt(0)&4294967295;return S[Math.abs(v)%S.length]};const S=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];I.innerHTML=$.map(m=>`
      ...
      <td class="cell-price">${f(Fe(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${i}</td>
      <td>
    ...
    <div class="imovel-card" data-pid="${e.id}">
      ...
      <div class="icard-body" data-href="property.html?id=${e.id}">
        ...
        <div class="icard-footer">
          ...
          <a href="https://wa.me/${Re}?text=${d}" target="_blank" rel="noopener" class="icard-wa" title="WhatsApp" onclick="fbq('track', 'Contact')">
    ...
    <div class="modal" style="max-width:440px;">
      ...
      <div class="modal-footer">
        ...
        <div class="kanban-card" draggable="true" data-id="${s.id}" data-stage="${f(i.name)}" style="cursor:pointer;">
          ...
          <button class="rd-card-task-btn" data-lead="${s.id}" onclick="event.stopPropagation();window.openTarefaModal?.(null,'${s.id}')">
...
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,u=new Blob([p],{type:"text/csv"}),w=document.createElement("a");w.href=URL.createObjectURL(u),w.download="modelo_contatos.csv",w.click()}),(d=document.getElementById("import-csv-file"))==null||d.addEventListener("change",mn),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",un)))}async function ft(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(b==null?void 0:b.role)==="corretor"?t=t.eq("assigned_to",b.id):b!=null&&b.tenant_id&&(t=t.eq("tenant_id",b.tenant_id));const{data:a}=await t;te=a||[],be()}function be(){var r,d,c;const e=(((r=document.getElementById("contato-search"))==null?void 0:r.value)||"").toLowerCase(),t=e?te.filter(s=>(s.name||"").toLowerCase().includes(e)||(s.email||"").toLowerCase().includes(e)||(s.phone||"").toLowerCase().includes(e)):te,n=t.length,a=Math.max(1,Math.ceil(n/Ne));U>a&&(U=a);const o=t.slice((U-1)*Ne,U*Ne),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(s=>`
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const l=document.getElementById("contatos-pagination");if(l){const s=n===0?0:(U-1)*Ne+1,p=Math.min(U*Ne,n);l.innerHTML=`
        ...
        <table style="width:100%;border-collapse:collapse;min-width:600px;">
          ...
          <tbody id="tp-prop-tbody">${s.map(p=>{var u;return`
            <tr data-pid="${p.id}" style="border-top:1px solid #f1f5f9;">
              ...
              <td style="padding:12px 16px;font-size:13px;font-weight:700;color:#0f172a;">${f(Fe(p.price,"pt"))}</td>
...
Essa ação é irreversível e removerá o registro da plataforma.`))return;const $=document.getElementById("et-delete");$.disabled=!0,$.textContent="Excluindo…";const{error:S}=await h.from("tenants").delete().eq("id",e.id);if(S){alert("Erro ao excluir: "+S.message),$.disabled=!1,$.textContent="🗑️ Excluir";return}d(),me()}),(y=document.getElementById("et-save"))==null||y.addEventListener("click",async()=>{var T,A,z,P,G,re,ge,Ae,Me,W,Ee,_t;const g=(A=(T=document.getElementById("et-name"))==null?void 0:T.value)==null?void 0:A.trim(),$=(P=(z=document.getElementById("et-slug"))==null?void 0:z.value)==null?void 0:P.trim(),S=(re=(G=document.getElementById("et-domain"))==null?void 0:G.value)==null?void 0:re.trim(),E=(ge=document.getElementById("et-plan"))==null?void 0:ge.value,L=(Me=(Ae=document.getElementById("et-admin-email"))==null?void 0:Ae.value)==null?void 0:Me.trim(),m=(Ee=(W=document.getElementById("et-admin-password"))==null?void 0:W.value)==null?void 0:Ee.trim(),v=(_t=document.getElementById("et-logo-input"))==null?void 0:_t.files[0],x=document.getElementById("et-msg"),_=document.getElementById("et-save");if(!g){x.textContent="❌ Nome é obrigatório.",x.style.color="#ef4444";return}_.disabled=!0,_.textContent="Salvando…",x.textContent="⏳ Salvando…",x.style.color="#64748b";let B=e.logo_url;if(v)try{const D=await Ve(v,256,.85),Bt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:Sa}=await h.storage.from("imoveis").upload(Bt,D,{contentType:"image/jpeg",upsert:!0});if(!Sa){const{data:{publicUrl:La}}=h.storage.from("imoveis").getPublicUrl(Bt);B=La}}catch(D){console.error("Logo upload:",D)}const{error:C}=await h.from("tenants").update({name:g,slug:$||e.slug,domain:S||null,plan_id:E||null,logo_url:B}).eq("id",e.id);if(C){_.disabled=!1,_.textContent="Salvar",x.textContent="❌ "+C.message,x.style.color="#ef4444";return}if(L&&m&&m.length>=6){x.textContent="⏳ Criando usuário admin…";const D=await he({email:L,password:m,role:"admin",tenant_id:e.id});D!=null&&D.success?(D!=null&&D.user_id&&!(D!=null&&D.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",D.user_id),x.textContent="✅ Salvo e admin criado!",x.style.color="#22c55e"):(x.textContent="⚠️ Salvo, mas erro ao criar admin: "+((D==null?void 0:D.error)||"Tente novamente"),x.style.color="#f59e0b")}else x.textContent="✅ Imobiliária atualizada!",x.style.color="#22c55e";_.disabled=!1,_.textContent="Salvar",setTimeout(()=>{d(),me()},1200)})}const Jt=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let nt=[],we=[],Ye={};function Sn(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ln)}function Ln(){nt=[],we=[],Ye={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
