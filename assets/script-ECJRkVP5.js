import{s as h}from"./supabase-BcuJ3xoD.js";const F="00000000-0000-0000-0000-000000000000";let de={},he={},ae=F;function fe(e){ae=e||F,de={},he={}}const M=()=>ae;async function da(){const[e,t]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",ae),h.from("site_content").select("*").eq("tenant_id",ae)]);if(e.data&&e.data.forEach(n=>{de[n.key]=n.value}),t.data&&t.data.forEach(n=>{he[n.key]=n}),(!t.data||t.data.length===0)&&ae!==F){const[n,a]=await Promise.all([h.from("settings").select("key,value").eq("tenant_id",F),h.from("site_content").select("*").eq("tenant_id",F)]);n.data&&n.data.forEach(o=>{de[o.key]===void 0&&(de[o.key]=o.value)}),a.data&&a.data.forEach(o=>{he[o.key]||(he[o.key]=o)})}}const W=(e,t=null)=>de[e]!==void 0?de[e]:t,Se=(e,t="pt")=>{const n=he[e];return n&&(n["value_"+t]||n.value_pt)||null};async function xe(e){const t=new Date().toISOString(),n=e.map(([o,i])=>({key:o,value:i,tenant_id:ae,updated_at:t})),{error:a}=await h.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,i])=>{de[o]=i}),!a}async function Re(e,{pt:t,en:n,es:a}){const o=new Date().toISOString(),i={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ae,updated_at:o},{error:d}=await h.from("site_content").upsert(i,{onConflict:"key,tenant_id"});return d||(he[e]=i),ae!==F&&await h.from("site_content").upsert({key:e,value_pt:t,value_en:n,value_es:a,tenant_id:F,updated_at:o},{onConflict:"key,tenant_id"}),!d}async function Ke(e,t,n){const{error:a}=await h.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function rt(){const e=document.documentElement,t=W("visual.accent_color","#b8962e"),n=W("visual.primary_bg","#0f1c2e"),a=W("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=W("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(s=>{s.src=o});const i=W("company.favicon_url","/favicon.ico"),d=document.querySelector('link[rel="shortcut icon"]');d&&(d.href=i);const r=W("visual.hero_bg_url","");if(r){const s=document.querySelector(".hero, .hero-v2");s&&(s.style.backgroundImage="url('"+r+"')")}}function ht(e){e=e||"pt";const t=f=>Se(f,e)||"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector('[data-i18n="hero.subtitle"]')||document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small, footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const i=document.querySelector('[data-i18n="inst.p1"]'),d=document.querySelector('[data-i18n="inst.p2"]'),r=document.querySelector('[data-i18n="inst.p3"]');i&&t("inst.bio_p1")&&(i.innerHTML=t("inst.bio_p1")),d&&t("inst.bio_p2")&&(d.innerHTML=t("inst.bio_p2")),r&&t("inst.bio_p3")&&(r.innerHTML=t("inst.bio_p3"));const s=document.querySelector('[data-i18n="inst.stat1_num"]'),c=document.querySelector('[data-i18n="inst.stat2_num"]')||document.querySelector('[data-i18n-num="inst.stat2num"]'),l=document.querySelector('[data-i18n="inst.stat3_num"]'),m=document.querySelector('[data-i18n="inst.stat1_label"]')||document.querySelector('[data-i18n="inst.stat1"]'),p=document.querySelector('[data-i18n="inst.stat2_label"]')||document.querySelector('[data-i18n="inst.stat2"]'),b=document.querySelector('[data-i18n="inst.stat3_label"]')||document.querySelector('[data-i18n="inst.stat3"]');s&&t("inst.stat1_num")&&(s.innerHTML=t("inst.stat1_num")),c&&t("inst.stat2_num")&&(c.innerHTML=t("inst.stat2_num")),l&&t("inst.stat3_num")&&(l.innerHTML=t("inst.stat3_num")),m&&t("inst.stat1_label")&&(m.innerHTML=t("inst.stat1_label")),p&&t("inst.stat2_label")&&(p.innerHTML=t("inst.stat2_label")),b&&t("inst.stat3_label")&&(b.innerHTML=t("inst.stat3_label"));const x=document.getElementById("dep-grid");if(x){const f=Se("testimonials",e)||Se("testimonials","pt");if(f)try{const E=JSON.parse(f);if(Array.isArray(E)&&E.length>0){let S=function(k){return String(k||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},B=function(k){let w=0;for(const $ of k||"?")w=w*31+$.charCodeAt(0)&4294967295;return I[Math.abs(w)%I.length]};const I=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];x.innerHTML=E.map(k=>`
            ...
            </div>`).join("")}}catch{}}const u=Se("seo.title_pt",e);u&&(document.title=u);const g=Se("seo.description_pt",e);if(g){const f=document.querySelector('meta[name="description"]');f&&(f.content=g)}}function xt(e){if(!e)return;const t="https://wa.me/"+e;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const la="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let _e="5547999701743";const we=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],ra=5.7;function Ae(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/ra).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let _=[],y=null,qe=[],Nt=!1;h.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Nt=!0)});function Ze(e,t,n){try{localStorage.setItem(e,JSON.stringify({v:t,exp:Date.now()+n}))}catch{}}function He(e){try{const t=localStorage.getItem(e);if(!t)return null;const n=JSON.parse(t);return Date.now()>n.exp?(localStorage.removeItem(e),null):n.v}catch{return null}}async function jt({background:e=!1}={}){const t=window.location.hostname;if(t==="localhost"||t==="127.0.0.1"){const{data:l,error:m}=await h.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return m&&console.error("Supabase select error:",m),l||[]}const a=`imobi_tenant_${t.replace(/^www\./,"")}`;let o=M();if(!o||o===F){const l=He(a);if(l)o=l,fe(o);else{const m=t.replace(/^www\./,"");for(const p of[m,"www."+m]){const{data:b}=await h.from("tenants").select("id").eq("domain",p).maybeSingle();if(b!=null&&b.id){o=b.id,fe(o);break}}o&&o!==F&&Ze(a,o,24*60*60*1e3)}}if(!o||o===F)return console.warn("[ImobiCRM] Tenant não encontrado para domínio:",t),[];const i=`imobi_props_${o}`,d=5*60*1e3;if(!e){const l=He(i);if(l)return setTimeout(()=>jt({background:!0}),100),l}const{data:r,error:s}=await h.from("properties").select("*").eq("published",!0).eq("tenant_id",o).order("created_at",{ascending:!1});if(s)return console.error("Supabase select error:",s),He(i)||[];const c=r||[];return Ze(i,c,d),e&&typeof re=="function"&&re().catch(()=>{}),c}async function Dt(){let e=h.from("properties").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="super_admin"||(y!=null&&y.tenant_id?e=e.eq("tenant_id",y.tenant_id):e=e.or("tenant_id.is.null,tenant_id.eq.00000000-0000-0000-0000-000000000000"));const{data:t,error:n}=await e;return n?(console.error("Supabase select error:",n),[]):(_=t||[],Ha(),Oa(),_)}async function ca(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await h.from("properties").update(a).eq("id",t);if(o)throw o;const i=_.findIndex(d=>d.id===t);i>=0&&(_[i]={..._[i],...a})}else{e.reference||(e.reference="IO-"+Date.now().toString(36).toUpperCase().slice(-5));const{data:t,error:n}=await h.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&_.unshift(t[0])}}async function ma(e){const{error:t}=await h.from("properties").delete().eq("id",e);if(t)throw t;_=_.filter(n=>n.id!==e)}async function pa(e,t){const{error:n}=await h.auth.signInWithPassword({email:e,password:t});return!n}function Me(e,t=1200,n=.78){return new Promise((a,o)=>{const i=new Image,d=URL.createObjectURL(e);i.onload=()=>{URL.revokeObjectURL(d);const r=document.createElement("canvas");let s=i.width,c=i.height;s>t&&(c=Math.round(c*t/s),s=t),r.width=s,r.height=c;const l=r.getContext("2d");l.drawImage(i,0,0,s,c);const m=new Image;m.crossOrigin="anonymous",m.onload=()=>{const p=Math.round(s*.18),b=Math.round(m.naturalHeight*p/m.naturalWidth),x=Math.round(s*.02),u=s-p-x,g=c-b-x;l.globalAlpha=.45,l.drawImage(m,u,g,p,b),l.globalAlpha=1,r.toBlob(f=>f?a(f):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.onerror=()=>{r.toBlob(p=>p?a(p):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},m.src="/logo.png"},i.onerror=o,i.src=d})}async function ua(e){const t=await Me(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await h.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=h.storage.from("imoveis").getPublicUrl(n);return o}async function ga(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await ua(n[o]));return a}function Rt(e){if(!e)return{};const t={};return e.querySelectorAll(".icard-img-wrap").forEach(n=>{const a=n.dataset.pid,o=n.dataset.idx;a&&o&&o!=="0"&&(t[a]=parseInt(o,10))}),t}function Ht(e,t){!e||!t||Object.entries(t).forEach(([n,a])=>{const o=e.querySelector('.icard-img-wrap[data-pid="'+n+'"]');if(!o)return;const i=parseInt(o.dataset.total,10);if(!i||i<2)return;const d=a%i;o.dataset.idx=d;try{const s=JSON.parse(decodeURIComponent(o.dataset.images||"[]"));if(s[d]){const c=o.querySelector(".carousel-img"),l=o.querySelector(".carousel-img-bg");c&&(c.src=s[d]),l&&(l.src=s[d])}}catch{}const r=o.querySelectorAll(".icard-dot");if(r.length){const s=d%r.length;r.forEach((c,l)=>c.classList.toggle("active",l===s))}})}function va(e){const t=document.getElementById("collections-wrap");if(!t)return;const n=s=>e.filter(c=>{if(c.collection){try{const m=JSON.parse(c.collection);if(Array.isArray(m))return m.includes(s)}catch{}if(c.collection===s)return!0}const l=((c.title||"")+" "+(c.description||"")).toLowerCase();return s==="frente-mar"?l.includes("frente mar")||l.includes("frente ao mar"):s==="decorados"?l.includes("decorad")||l.includes("mobiliado"):s==="casas-condominio"?(c.condominium||"").length>2:!1});function a(s,c,l,m){if(!l.length)return"";const p=l.slice(0,8).map(b=>pt(b)).join("");return`
      ...
      </div>`}const o=n("frente-mar"),i=n("decorados"),d=n("casas-condominio"),r=Rt(t);t.innerHTML=[a("Imóveis "+(document.title.split("|")[0].trim()||"Isaac Omar").split(" ").pop(),"#8B4513",e,"imoveis.html"),o.length?a("Coleção FRENTE MAR","#8B4513",o,"imoveis.html?collection=frente-mar"):"",i.length?a("Coleção DECORADOS","#8B4513",i,"imoveis.html?collection=decorados"):"",d.length?a("Coleção CASAS EM CONDOMÍNIO","#8B4513",d,"imoveis.html?collection=casas-condominio"):""].join(""),Ht(t,r),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",ct))}async function re(){var b,x,u,g,f,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await jt();_=n,((b=document.getElementById("selecao-carousel"))==null?void 0:b.innerHTML)===""&&fa(n);const a=((x=document.getElementById("city-filter"))==null?void 0:x.value)||"",o=((u=document.getElementById("neighborhood-filter"))==null?void 0:u.value)||"",i=((g=document.getElementById("bedrooms-filter"))==null?void 0:g.value)||"",d=((f=document.getElementById("parking-filter"))==null?void 0:f.value)||"",r=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",{min:s,max:c}=ya(),l=n.filter(I=>{if(a&&I.city!==a||o&&I.neighborhood!==o||i&&(i==="4+"&&Number(I.bedrooms)<4||i!=="4+"&&Number(I.bedrooms)!==Number(i))||d&&(d==="4+"&&Number(I.parking)<4||d!=="4+"&&Number(I.parking)!==Number(d))||r&&I.construction_status!==r)return!1;const S=String(I.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(S,10)||0;return!(B<s||c!==1/0&&B>c)});if(e){va(n);return}if(!l.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}const m=Rt(t);t.innerHTML=l.map(I=>pt(I)).join(""),Ht(t,m);const p=document.getElementById("properties");p&&!p._carouselDelegated&&(p._carouselDelegated=!0,p.addEventListener("click",ct))}function fa(e){var o,i,d;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(r=>pt(r)).join(""),t._carouselDelegated||(t._carouselDelegated=!0,t.addEventListener("click",ct));const a=t.closest(".selecao-carousel-wrap");(i=a==null?void 0:a.querySelector(".selecao-prev"))==null||i.addEventListener("click",()=>{t.scrollBy({left:-340,behavior:"smooth"})}),(d=a==null?void 0:a.querySelector(".selecao-next"))==null||d.addEventListener("click",()=>{t.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const t=document.getElementById("construction-filter");t&&(t.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),re()};function ct(e){var r;const t=e.target.closest(".carousel-btn");if(!t)return;e.preventDefault(),e.stopPropagation();const n=t.closest(".icard-img-wrap");if(!n)return;const a=parseInt(n.dataset.total,10);if(!a||a<2)return;let o=parseInt(n.dataset.idx,10)||0;const i=t.classList.contains("carousel-next")?1:-1;o=(o+i+a)%a,n.dataset.idx=o;try{const s=JSON.parse(decodeURIComponent(n.dataset.images||"[]"));if(s.length&&s[o]){const c=s[o],l=n.querySelector(".carousel-img"),m=n.querySelector(".carousel-img-bg");l&&(l.src=c),m&&(m.src=c)}}catch{const c=_.find(m=>String(m.id)===String(n.dataset.pid)),l=(r=c==null?void 0:c.images)!=null&&r.length?c.images:we;if(l[o]){const m=n.querySelector(".carousel-img"),p=n.querySelector(".carousel-img-bg");m&&(m.src=l[o]),p&&(p.src=l[o])}}const d=n.querySelectorAll(".icard-dot");if(d.length){const s=o%d.length;d.forEach((c,l)=>c.classList.toggle("active",l===s))}}function ya(){var a;const e=((a=document.getElementById("price-range"))==null?void 0:a.value)||"";if(!e)return{min:0,max:1/0};const[t,n]=e.split("-");return{min:parseInt(t,10)||0,max:n?parseInt(n,10):1/0}}function ba(){const e=document.getElementById("price-range");e&&e.addEventListener("change",()=>re())}function ha(){const e=document.getElementById("city-filter"),t=document.getElementById("neighborhood-filter");if(e&&t){const n=ue();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),e.addEventListener("change",()=>{const a=ue().find(i=>i.name===e.value),o=a?gt(a.id):[];t.innerHTML='<option value="">Todos os bairros</option>'+o.map(i=>`<option value="${i.name}">${v(i.name)}</option>`).join(""),re()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",re)})}function Te(e){const t=document.getElementById("admin-properties");if(t){if(!e.length){t.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}t.innerHTML=e.map(n=>{var d;const a=n.cover_image||((d=n.images)==null?void 0:d[0])||we[0],o=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",i=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
...
${d}`),s=e.area?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 3v18"/></svg>${e.area}m²</span>`:"",c=e.bedrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20v-6a2 2 0 012-2h16a2 2 0 012 2v6"/><path d="M2 14V8a2 2 0 012-2h4l2 3h8a2 2 0 012 2v3"/></svg>${e.bedrooms} quarto${e.bedrooms!=1?"s":""}</span>`:"",l=e.bathrooms?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 6 6.5 3.5a1.5 1.5 0 000-2.12L6 1.5a1.5 1.5 0 00-2.12 0L2 3.38a1.5 1.5 0 000 2.12L5.5 9"/><path d="M2 20h20M20 12H4a2 2 0 00-2 2v4a2 2 0 002 2h16a2 2 0 002-2v-4a2 2 0 00-2-2z"/></svg>${e.bathrooms} banheiro${e.bathrooms!=1?"s":""}</span>`:"",m=e.parking?`<span class="icard-spec"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="3" width="15" height="13" rx="2"/><path d="M16 8h4l3 5v3h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>${e.parking} vaga${e.parking!=1?"s":""}</span>`:"",p=Math.max(1,Math.min(n,6)),b=`<div class="icard-dots">${Array.from({length:p},(u,g)=>`<span class="icard-dot${g===0?" active":""}"></span>`).join("")}</div>`;return`
  ...
  `}let te=[],Y=0;function Ia(e){var m,p;const t=document.getElementById("view-modal-edit");t&&(t.dataset.pid=e.id),document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const n=document.getElementById("view-status-badge");e.published?(n.textContent="● Publicado",n.className="badge badge-green"):(n.textContent="○ Rascunho",n.className="badge badge-gray");const a=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=a.length?`📍 ${a.join(", ")}`:"";const o=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a.join(" "))}`;document.getElementById("view-map-link").href=o,document.getElementById("view-directions-link").href=o;const i=((m=e.images)==null?void 0:m[0])||we[0];document.getElementById("view-thumb-preview").src=i,te=(p=e.images)!=null&&p.length?e.images:we,Y=0,Xe(),document.getElementById("view-price").textContent=Ae(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const d=document.getElementById("view-condominium-item"),r=document.getElementById("view-condominium");r&&(r.textContent=e.condominium||""),d&&(d.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(b=>b.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(b=>b.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const s="https://omarcorretor.com.br/property.html?id="+e.id,c=document.getElementById("share-link-input");c&&(c.value=s);const l=document.getElementById("share-panel");l&&(l.style.display="none",l.dataset.pid=e.id),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function ze(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Xe(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=te[Y],e.alt=`Foto ${Y+1}`;const i=te.length>1;n.style.display=i?"flex":"none",a.style.display=i?"flex":"none",t.textContent=i?`${Y+1} / ${te.length}`:"",o.innerHTML=i?te.map((d,r)=>`<img src="${d}" class="view-thumb${r===Y?" active":""}" data-i="${r}" alt="Foto ${r+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(d=>{d.addEventListener("click",()=>{Y=+d.dataset.i,Xe()})})}async function Et(e){const{data:t}=await h.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Ve(e){var m,p;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const i=(e==null?void 0:e.name)||"Sem nome",d=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=i,o&&(o.textContent=d),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((m=i[0])==null?void 0:m.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const r=document.getElementById("avatar-dd-name"),s=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),l=document.getElementById("avatar-dd-initial");r&&(r.textContent=i),s&&(s.textContent=d),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",l&&(l.style.display="none")):(l&&(l.textContent=((p=i[0])==null?void 0:p.toUpperCase())||"?",l.style.display=""),c&&(c.style.display="none"))}async function wt(e){const t=document.getElementById("avatar-dd-ver-site");if(!t)return;const n=(e==null?void 0:e.tenant_id)||M(),a=n&&n!==F,o=window.location.origin,i=a?`${o}/demo.html?key=${n}`:`${o}/index.html`;if(t.href=i,!!a)try{const{data:d}=await h.from("tenants").select("domain").eq("id",n).maybeSingle(),r=window.location.hostname.replace(/^www\./,""),s=((d==null?void 0:d.domain)||"").replace(/^https?:\/\//,"").replace(/^www\./,"").replace(/\/.*$/,"").trim();s&&s!==r&&(t.href=`https://${s}`)}catch{}}const Ne={dashboard:()=>on(),empresa:()=>Wt(),visual:()=>Jt(),"site-config":()=>Yt(),"crm-config":()=>Kt(),integracoes:()=>Qt(),midia:()=>Zt(),depoimentos:()=>Gt()};function Z(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);if(t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),typeof Ne<"u"&&Ne[e]){const o=Ne[e];Ne[e]=null,setTimeout(o,0)}(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),K(),e==="contatos"&&za(),e==="funil"&&Sa(),e==="tarefas"&&La()}function It(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:Wt,visual:Jt,"site-config":Yt,"crm-config":Kt,integracoes:Qt,midia:Zt,depoimentos:Gt}).forEach(([a,o])=>{const i=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);i&&i.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>Pa(),{once:!0}),window.lucide&&lucide.createIcons()}}function K(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function $a(){var a,o,i;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(a);const o=()=>a.remove();(i=document.getElementById("ac-close"))==null||i.addEventListener("click",o),(d=document.getElementById("ac-cancel"))==null||d.addEventListener("click",o),a.addEventListener("click",s=>{s.target===a&&o()}),(r=document.getElementById("ac-save"))==null||r.addEventListener("click",async()=>{var p,b,x;const s=(p=document.getElementById("ac-email"))==null?void 0:p.value.trim(),c=(b=document.getElementById("ac-password"))==null?void 0:b.value.trim(),l=document.getElementById("ac-save"),m=document.getElementById("ac-note");if(!s){alert("Informe o e-mail do corretor.");return}if(!c||c.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}l.disabled=!0,l.textContent="Criando…",m.style.display="none";try{const u=e||(y==null?void 0:y.tenant_id)||null,g=((x=document.getElementById("ac-role"))==null?void 0:x.value)||"corretor",f=await pe({email:s,password:c,role:g,tenant_id:u});l.disabled=!1,l.textContent="+ Criar Acesso",f.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",f.email_sent===!1?(m.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${v(s)}<br><strong>Senha:</strong> ${v(c)}`,m.style.color="#0f172a"):(m.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",m.style.color="#16a34a"),m.style.display="",typeof t=="function"&&setTimeout(t,1500)):alert("Erro: "+(f.error||"Falha desconhecida"))}catch(u){l.disabled=!1,l.textContent="+ Criar Acesso",alert("Erro: "+u.message)}})}function $t(){var i,d,r,s,c,l,m,p,b,x,u;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",g=>{var E;g.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(E=document.getElementById("notif-dropdown"))==null||E.classList.add("hidden")}),(i=document.getElementById("avatar-dd-change-photo"))==null||i.addEventListener("click",g=>{g.stopPropagation(),K(),ka()}),(d=document.getElementById("avatar-dd-change-pass"))==null||d.addEventListener("click",g=>{g.stopPropagation(),K(),$a()}),(r=document.getElementById("avatar-dd-add-corretor"))==null||r.addEventListener("click",g=>{g.stopPropagation(),K(),tt()}),(s=document.getElementById("avatar-dd-settings"))==null||s.addEventListener("click",g=>{g.stopPropagation(),K(),Z("settings")}),(c=document.getElementById("avatar-dd-logout"))==null||c.addEventListener("click",async g=>{g.stopPropagation(),await h.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",g=>{var E;g.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((E=document.getElementById("avatar-dropdown"))==null||E.classList.add("hidden"),qa())}),(l=document.getElementById("notif-mark-all"))==null||l.addEventListener("click",()=>{Ta(),K()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var g,f;(g=document.getElementById("search-overlay"))==null||g.classList.remove("hidden"),(f=document.getElementById("search-input"))==null||f.focus()}),(p=document.getElementById("search-overlay-close"))==null||p.addEventListener("click",()=>{var g;(g=document.getElementById("search-overlay"))==null||g.classList.add("hidden")}),(b=document.getElementById("search-overlay"))==null||b.addEventListener("click",g=>{g.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(x=document.getElementById("search-input"))==null||x.addEventListener("input",g=>{clearTimeout(o),o=setTimeout(()=>Ca(g.target.value.trim()),280)}),(u=document.getElementById("search-input"))==null||u.addEventListener("keydown",g=>{var f;g.key==="Escape"&&((f=document.getElementById("search-overlay"))==null||f.classList.add("hidden"))}),document.addEventListener("click",K)}let at=!1,se=[],ut=[],Ge=[],ce={},Ot=[],ne=null,Be=null,G={search:"",tags:new Set,status:""};async function Sa(){var t;if(at){await kt();return}at=!0,await kt(),(t=document.getElementById("btn-funil-add-lead"))==null||t.addEventListener("click",()=>ot()),Ya();const e=document.getElementById("funil-pipe-sel");e==null||e.addEventListener("change",async()=>{ne=parseInt(e.value,10),await We()})}function nt(e){var i;const t=document.getElementById("kanban-filters");if(!t)return;t.style.display="block";const n=document.getElementById("kf-status");n&&(n.innerHTML='<option value="">Todos os status</option>'+Ot.map(d=>`<option value="${v(d.name)}">${v(d.name)}</option>`).join(""),n.value=G.status,n.onchange=()=>{G.status=n.value,ye()});const a=document.getElementById("kf-tags");if(a){if(!e.length){a.style.display="none";return}a.style.display="flex",a.innerHTML='<span class="kf-tags-label">Tags:</span>'+e.map(d=>`<button class="kf-tag-btn${G.tags.has(d.name)?" active":""}" data-tag="${v(d.name)}"
          style="--kf-tc:${d.color}">
          ${v(d.name)}
        </button>`).join(""),a.querySelectorAll(".kf-tag-btn").forEach(d=>{d.addEventListener("click",()=>{const r=d.dataset.tag;G.tags.has(r)?G.tags.delete(r):G.tags.add(r),nt(e),ye()})})}const o=document.getElementById("kf-search");o&&(o.value=G.search,o.oninput=()=>{G.search=o.value.toLowerCase(),ye()}),(i=document.getElementById("kf-clear"))==null||i.addEventListener("click",()=>{G={search:"",tags:new Set,status:""},nt(e),ye()})}async function kt(){const e=M(),[{data:t},{data:n},{data:a}]=await Promise.all([h.from("crm_pipelines").select("*").eq("tenant_id",e).order("sort_order"),h.from("crm_tags").select("*").eq("tenant_id",e).order("name"),h.from("crm_lead_statuses").select("*").eq("tenant_id",e).order("sort_order")]);se=t||[],Ot=a||[],ce={},(n||[]).forEach(r=>{ce[r.name]=r});const o=se.map(r=>r.id),{data:i}=o.length?await h.from("crm_stages").select("*").in("pipeline_id",o).order("sort_order"):{data:[]};ut=i||[],nt(n||[]);const d=document.getElementById("funil-pipe-sel");if(d){const r=ne;d.innerHTML=se.length?se.map(c=>`<option value="${c.id}">${v(c.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const s=se.find(c=>c.id===r)||se.find(c=>c.is_default)||se[0];s?(d.value=s.id,ne=s.id):ne=null}await We()}async function We(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id)),ne&&(t=t.eq("pipeline_id",ne));const{data:n}=await t;Ge=n||[],ye()}function ye(){const e=document.getElementById("kanban-board");if(!e)return;const t=ut.filter(i=>i.pipeline_id===ne);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n=G,a=Ge.filter(i=>{if(n.search&&!`${i.name||""} ${i.phone||""} ${i.email||""}`.toLowerCase().includes(n.search)||n.status&&i.status!==n.status)return!1;if(n.tags.size>0){const d=Array.isArray(i.tags)?i.tags:[];if(![...n.tags].every(r=>d.includes(r)))return!1}return!0}),o={};t.forEach(i=>{o[i.name]=[]}),a.forEach(i=>{var r,s,c,l;const d=i.stage||((r=t[0])==null?void 0:r.name);o[d]||(o[((s=t[0])==null?void 0:s.name)||""]=[]),(l=o[d]||o[(c=t[0])==null?void 0:c.name])==null||l.push(i)}),e.innerHTML=t.map(i=>{const d=o[i.name]||[],r=d.length?d.map(s=>{const c=(s.phone||"").replace(/\D/g,""),l=encodeURIComponent(`Olá ${s.name}! Aqui é da ${W("company.name","nossa imobiliária")}. Vi seu interesse e gostaria de ajudar. Posso falar agora?`);return`
    ...
    <div style="flex:1;overflow-y:auto;padding:20px 24px;display:flex;flex-direction:column;gap:14px;">
      ...
      ${d?(()=>{const m=encodeURIComponent(`Olá ${e!=null&&e.name?e.name.split(" ")[0]:""}! Aqui é da ${W("company.name","nossa imobiliária")}. Vi seu interesse em imóveis e gostaria de ajudá-lo. Posso falar agora?`);return`<a href="https://wa.me/${d}?text=${m}" target="_blank" rel="noopener"
  ...
  `,document.body.appendChild(r),requestAnimationFrame(()=>{r.style.transform="translateX(0)"}),nn(r,a||[],ce);const s=()=>{r.style.transform="translateX(100%)",setTimeout(()=>r.remove(),250)};document.getElementById("ldp-close").addEventListener("click",s),document.getElementById("ldp-save").addEventListener("click",async()=>{var f,E;const m=document.getElementById("ldp-save"),p=document.getElementById("ldp-msg"),b=document.getElementById("ldp-name").value.trim();if(!b){p.style.color="#ef4444",p.textContent="Nome é obrigatório.";return}m.disabled=!0,m.textContent="Salvando…";const x=[...r.querySelectorAll("#ldp-tag-badge-area .ldp-tag-badge[data-tag]")].map(I=>I.dataset.tag),u={name:b,phone:document.getElementById("ldp-phone").value.trim()||null,email:document.getElementById("ldp-email").value.trim()||null,source:document.getElementById("ldp-source").value.trim()||null,stage:((f=document.getElementById("ldp-stage"))==null?void 0:f.value)||null,status:((E=document.getElementById("ldp-status"))==null?void 0:E.value)||null,notes:document.getElementById("ldp-notes").value.trim()||null,tags:x,tenant_id:M()};let g;if(t?{error:g}=await h.from("leads").insert(u):{error:g}=await h.from("leads").update(u).eq("id",e.id),m.disabled=!1,m.textContent="💾 Salvar",g){p.style.color="#ef4444",p.textContent="Erro: "+g.message;return}p.style.color="#22c55e",p.textContent="✅ Salvo!",setTimeout(()=>{s(),We()},700)}),(l=document.getElementById("ldp-delete"))==null||l.addEventListener("click",async()=>{confirm(`Excluir o lead "${e==null?void 0:e.name}"?`)&&(await h.from("leads").delete().eq("id",e.id),s(),We())})}let D=[],St=!1,be="pending";async function La(){var e;St||(St=!0,await _a(),(e=document.getElementById("btn-nova-tarefa"))==null||e.addEventListener("click",()=>Pt()),document.querySelectorAll(".tarefa-filter-btn").forEach(t=>{t.addEventListener("click",()=>{document.querySelectorAll(".tarefa-filter-btn").forEach(n=>n.classList.remove("active")),t.classList.add("active"),be=t.dataset.filter,Ie()})}))}async function _a(){const e=document.getElementById("tarefas-list");e&&(e.innerHTML='<div class="empty-row" style="padding:40px;text-align:center;color:#94a3b8;">Carregando…</div>');let t=h.from("tasks").select("*").order("due_date",{ascending:!0,nullsFirst:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n,error:a}=await t;if(a){const o=document.getElementById("tarefas-list");o&&(o.innerHTML=`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
    ...
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=Ut(a.due_date),i=o?o.toLocaleDateString("pt-BR"):"",d=o&&a.status!=="done"&&o<n;return`
  ...
  `,document.body.appendChild(d);const r=()=>d.remove();(s=document.getElementById("tm-close"))==null||s.addEventListener("click",r),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",r),d.addEventListener("click",p=>{p.target===d&&r()}),(l=document.getElementById("tm-toggle-done"))==null||l.addEventListener("click",async()=>{const p=a?"pending":"done";await h.from("tasks").update({status:p}).eq("id",e.id);const b=D.find(x=>String(x.id)===String(e.id));b&&(b.status=p),r(),p==="done"&&(be="done",document.querySelectorAll(".tarefa-filter-btn").forEach(x=>{x.classList.toggle("active",x.dataset.filter==="done")})),Ie()}),(m=document.getElementById("tm-save"))==null||m.addEventListener("click",async()=>{var f,E;const p=document.getElementById("tarefa-form");if(!p.checkValidity()){p.reportValidity();return}const b=new FormData(p),x=document.getElementById("tm-save");x.disabled=!0,x.textContent="Salvando…";const u={title:(f=b.get("title"))==null?void 0:f.trim(),description:((E=b.get("description"))==null?void 0:E.trim())||null,due_date:b.get("due_date")||null,priority:b.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null};let g;if(n){if({error:g}=await h.from("tasks").update(u).eq("id",e.id),!g){const I=D.findIndex(S=>String(S.id)===String(e.id));I>=0&&(D[I]={...D[I],...u})}}else{const{data:I,error:S}=await h.from("tasks").insert(u).select();g=S,!g&&(I!=null&&I[0])&&D.unshift(I[0])}if(x.disabled=!1,x.textContent=n?"Salvar":"Criar Tarefa",g){alert("Erro: "+g.message);return}r(),Ie()})}async function Ca(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;y==null||y.role,y==null||y.tenant_id;const[{data:a},{data:o}]=await Promise.all([h.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),h.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),i=[];a!=null&&a.length&&(i.push('<div class="search-group-label">Imóveis</div>'),i.push(...a.map(d=>`
      ...
      </div>`))),t.innerHTML=i.length?i.join(""):'<div class="search-no-results">Nenhum resultado encontrado.</div>',t.querySelectorAll(".search-result-item").forEach(d=>{d.addEventListener("click",()=>{var r;(r=document.getElementById("search-overlay"))==null||r.classList.add("hidden"),d.dataset.type==="lead"?Z("contatos"):Z("properties")})})}let Q=JSON.parse(localStorage.getItem("crm_notifs_read")||"[]");async function qa(){var d;const e=document.getElementById("notif-list");if(!e)return;e.innerHTML='<div class="notif-empty">Carregando…</div>';let t=h.from("leads").select("id,name,phone,created_at,source").order("created_at",{ascending:!1}).limit(10);y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:n}=await t,a=n||[],o=a.filter(r=>!Q.includes(String(r.id))),i=document.getElementById("notif-badge");if(i&&(i.textContent=o.length,o.length>0?i.classList.remove("hidden"):i.classList.add("hidden")),!a.length){e.innerHTML='<div class="notif-empty">Nenhuma notificação.</div>';return}e.innerHTML=a.map(r=>{const s=Aa(r.created_at);return`
      <div class="notif-item${!Q.includes(String(r.id))?" unread":""}" data-id="${r.id}">
        <div class="notif-item-icon">👤</div>
        <div class="notif-item-body">
          <div class="notif-item-title">Novo lead: ${v(r.name||"—")}</div>
          <div class="notif-item-sub">${v(r.phone||r.source||"")} · ${s}</div>
        </div>
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(d=document.getElementById("notif-see-all"))==null||d.addEventListener("click",r=>{r.preventDefault(),K(),Z("contatos")}),e.querySelectorAll(".notif-item").forEach(r=>{r.addEventListener("click",()=>{Q.push(r.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(Q)),r.classList.remove("unread"),K(),Z("contatos")})})}function Ta(){var e;document.querySelectorAll(".notif-item").forEach(t=>Q.push(t.dataset.id)),Q=[...new Set(Q)],localStorage.setItem("crm_notifs_read",JSON.stringify(Q)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Aa(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function Ma(){let e=h.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);y!=null&&y.tenant_id&&(e=e.eq("tenant_id",y.tenant_id));const{data:t}=await e,a=(t||[]).filter(i=>!Q.includes(String(i.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let J=[],j=1;const Le=10;let Bt=!1;async function za(){var t,n,a,o,i,d,r,s,c;document.getElementById("section-contatos")&&(Bt||(Bt=!0,await Ft(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{j=1,me()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",l=>{l.key==="Enter"&&(j=1,me())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>Xt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Da),(i=document.getElementById("import-modal-close"))==null||i.addEventListener("click",it),(d=document.getElementById("import-modal-cancel"))==null||d.addEventListener("click",it),(r=document.getElementById("download-template"))==null||r.addEventListener("click",l=>{l.preventDefault();const m=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,p=new Blob([m],{type:"text/csv"}),b=document.createElement("a");b.href=URL.createObjectURL(p),b.download="modelo_contatos.csv",b.click()}),(s=document.getElementById("import-csv-file"))==null||s.addEventListener("change",Na),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",ja)))}async function Ft(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=h.from("leads").select("*").order("created_at",{ascending:!1});(y==null?void 0:y.role)==="corretor"?t=t.eq("assigned_to",y.id):y!=null&&y.tenant_id&&(t=t.eq("tenant_id",y.tenant_id));const{data:a}=await t;J=a||[],me()}function me(){var r,s,c;const e=(((r=document.getElementById("contato-search"))==null?void 0:r.value)||"").toLowerCase(),t=e?J.filter(l=>(l.name||"").toLowerCase().includes(e)||(l.email||"").toLowerCase().includes(e)||(l.phone||"").toLowerCase().includes(e)):J,n=t.length,a=Math.max(1,Math.ceil(n/Le));j>a&&(j=a);const o=t.slice((j-1)*Le,j*Le),i=document.getElementById("contatos-tbody");if(!i)return;o.length?i.innerHTML=o.map(l=>`
      <tr>
    ...
    `).join(""):i.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum contato encontrado.</td></tr>';const d=document.getElementById("contatos-pagination");if(d){const l=n===0?0:(j-1)*Le+1,m=Math.min(j*Le,n);d.innerHTML=`
...
`).filter(r=>r.trim()).slice(1).map(r=>{const[s,c,l,m,p]=r.split(",").map(b=>b.trim().replace(/^"|"$/g,""));return{name:s,email:c,phone:l,company:m,job_title:p}}).filter(r=>r.name);const i=document.getElementById("import-preview");i&&(i.textContent=`${Ee.length} contato(s) encontrados para importar.`);const d=document.getElementById("import-modal-confirm");d&&(d.disabled=Ee.length===0)},n.readAsText(t)}async function ja(){if(!Ee.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Ee.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(y==null?void 0:y.id)||null,tenant_id:(y==null?void 0:y.tenant_id)||null})),{error:n}=await h.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}it(),await Ft(),alert(`${t.length} contato(s) importados com sucesso!`)}function Da(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Ee=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function it(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Ra="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function pe(e){return(await fetch(Ra,{method:"POST",headers:{Authorization:`Bearer ${la}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Lt(e){var s,c,l,m;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),i=document.getElementById("settings-avatar-input"),d=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:p}}=await h.auth.getUser();n.value=(p==null?void 0:p.email)||""}const r=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=r),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),i==null||i.addEventListener("change",p=>{const b=p.target.files[0];if(!b)return;const x=URL.createObjectURL(b);a&&(a.src=x,a.style.display=""),o&&(o.style.display="none")}),(s=document.getElementById("btn-change-password"))==null||s.addEventListener("click",async()=>{var f,E;const p=((f=document.getElementById("change-password-new"))==null?void 0:f.value)||"",b=((E=document.getElementById("change-password-confirm"))==null?void 0:E.value)||"",x=document.getElementById("change-password-msg"),u=document.getElementById("btn-change-password");if(x&&(x.style.display="none"),p.length<6){x&&(x.textContent="Mínimo 6 caracteres.",x.style.display="");return}if(p!==b){x&&(x.textContent="As senhas não coincidem.",x.style.display="");return}u&&(u.disabled=!0,u.textContent="Salvando…");const{error:g}=await h.auth.updateUser({password:p});u&&(u.disabled=!1,u.textContent="Salvar Nova Senha"),g?x&&(x.textContent="Erro: "+g.message,x.style.display=""):(x&&(x.style.color="#16a34a",x.textContent="Senha alterada com sucesso!",x.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),d==null||d.addEventListener("click",async()=>{var E;const p=t.value.trim();let b=(y==null?void 0:y.avatar_url)||"";const x=i==null?void 0:i.files[0],u=d.textContent;if(d.disabled=!0,d.textContent="Salvando…",x)try{const I=await Me(x,400,.85),S=`avatars/${y.id}-${Date.now()}.jpg`,{error:B}=await h.storage.from("imoveis").upload(S,I,{contentType:"image/jpeg",upsert:!0});if(!B){const{data:{publicUrl:k}}=h.storage.from("imoveis").getPublicUrl(S);b=k}}catch(I){console.error("Avatar upload:",I)}const{error:g}=await h.from("profiles").update({name:p,avatar_url:b}).eq("id",y.id);if(d.disabled=!1,d.textContent=u,g){alert("Erro ao salvar perfil.");return}y={...y,name:p,avatar_url:b},Ve(y);const f=document.getElementById("settings-avatar-initial");f&&(f.textContent=((E=p[0])==null?void 0:E.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const p=document.getElementById("settings-corretores-section");p&&(p.style.display=""),await Je(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var E,I;const x=(E=document.getElementById("invite-email"))==null?void 0:E.value.trim(),u=(I=document.getElementById("invite-password"))==null?void 0:I.value.trim(),g=document.getElementById("btn-invite-corretor"),f=document.getElementById("invite-note");if(!x){alert("Informe o e-mail do corretor.");return}if(!u||u.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}g&&(g.disabled=!0,g.textContent="Criando…"),f&&(f.style.display="none");try{const S=await pe({email:x,password:u,tenant_id:(y==null?void 0:y.tenant_id)||null});if(S.success){const B=document.getElementById("invite-email"),k=document.getElementById("invite-password");B&&(B.value=""),k&&(k.value=""),await Je(),f&&(S.email_sent===!1?(f.innerHTML=`
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(o=>{o.addEventListener("change",async()=>{await h.from("profiles").update({role:o.value}).eq("id",o.dataset.uid)})}),e.querySelectorAll(".corretor-toggle-btn").forEach(o=>{o.addEventListener("click",async()=>{const i=o.dataset.uid,d=o.dataset.active==="true";o.disabled=!0,o.textContent="Aguarde…";try{const r=await pe({action:"toggle",userId:i,active:!d});r.success||alert("Erro: "+(r.error||"Falha desconhecida"))}catch(r){alert("Erro: "+r.message)}await Je()})}),e.querySelectorAll(".corretor-del-btn").forEach(o=>{o.addEventListener("click",async()=>{var r,s;const i=o.dataset.uid,d=((s=(r=o.closest(".corretor-item"))==null?void 0:r.querySelector(".corretor-name"))==null?void 0:s.textContent)||"este corretor";if(confirm(`Excluir "${d}"? Esta ação não pode ser desfeita.`)){o.disabled=!0;try{const c=await pe({action:"delete",userId:i});c.success||alert("Erro ao excluir: "+(c.error||"Falha desconhecida"))}catch(c){alert("Erro: "+c.message)}await Je()}})})}async function Vt(){const{data:e,error:t}=await h.from("locations").select("*").order("name");return t?(console.error("loadLocations:",t),[]):(qe=e||[],qe)}function ue(){return qe.filter(e=>e.type==="cidade")}function gt(e){return qe.filter(t=>t.type==="bairro"&&t.parent_id===e)}function vt(){const e=document.getElementById("adminCitySelect");if(!e)return;const t=e.value,n=ue();e.innerHTML='<option value="">Selecione</option>'+n.map(a=>`<option value="${a.name}">${v(a.name)}</option>`).join(""),t&&(e.value=t)}async function Ce(){await Vt();const e=ue(),t=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),a=document.getElementById("loc-new-neighborhood-city");if(!t||!n)return;t.innerHTML=e.length?e.map(i=>`
        <div class="loc-item">
...
`+k);window.open("mailto:?subject="+$+"&body="+L,"_blank")}),(I=document.getElementById("share-copy"))==null||I.addEventListener("click",()=>{var w;const k=document.getElementById("share-link-input");k&&((w=navigator.clipboard)==null||w.writeText(k.value).then(()=>{const $=document.getElementById("share-copy"),L=$.textContent;$.textContent="✅ Copiado!",setTimeout(()=>{$.textContent=L},2e3)}))}),(S=document.getElementById("view-modal-edit"))==null||S.addEventListener("click",()=>{var N;if((y==null?void 0:y.role)!=="admin"&&(y==null?void 0:y.role)!=="super_admin")return;const k=Number(document.getElementById("view-modal-edit").dataset.pid),w=_.find(T=>T.id===k);if(!w)return;ze(),R=w.id;const $=document.getElementById("property-form"),L=document.getElementById("form-submit-btn");L.textContent="Salvar Alterações",$.querySelector('[name="title"]').value=w.title||"",$.querySelector('[name="rua"]').value=w.rua||"",$.querySelector('[name="numero"]').value=w.numero||"",$.querySelector('[name="city"]').value=w.city||"",$.querySelector('[name="price"]').value=w.price||"",$.querySelector('[name="bedrooms"]').value=w.bedrooms||"",$.querySelector('[name="suites"]').value=w.suites||"",$.querySelector('[name="parking"]').value=w.parking||"",$.querySelector('[name="description"]').value=w.description||"",$.querySelector('[name="construction_status"]').value=w.construction_status||"",$.querySelector('[name="owner_name"]').value=w.owner_name||"",$.querySelector('[name="owner_phone"]').value=w.owner_phone||"",$.querySelector('[name="owner_email"]').value=w.owner_email||"",$.querySelector('[name="owner_notes"]').value=w.owner_notes||"",$.querySelector('[name="condominium"]').value=w.condominium||"";const q=document.getElementById("adminPublished");q&&(q.value=w.published===!0?"true":"false");const C=document.getElementById("adminCitySelect");C&&(C.value=w.city||"",C.dispatchEvent(new Event("change")),setTimeout(()=>{const T=document.getElementById("adminNeighborhood");T&&(T.value=w.neighborhood||"")},50)),le=w.cover_image||((N=w.images)==null?void 0:N[0])||"",Fe(w.images||[]),et("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(k=>{k.addEventListener("click",()=>{var w;document.querySelectorAll(".tab-btn").forEach($=>$.classList.remove("active")),k.classList.add("active"),document.querySelectorAll(".tab-panel").forEach($=>$.classList.add("hidden")),(w=document.getElementById(`tab-${k.dataset.tab}`))==null||w.classList.remove("hidden")})}),(B=document.getElementById("admin-properties"))==null||B.addEventListener("click",k=>{if(k.target.closest(".action-btns"))return;const w=k.target.closest("tr");if(!w)return;const $=Number(w.dataset.id);if(!$)return;const L=_.find(q=>q.id===$);L&&Ia(L)})}async function Gt(){const e=document.getElementById("section-depoimentos");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await h.from("site_content").select("value_pt").eq("key","testimonials").eq("tenant_id",M()).maybeSingle();let n=[];try{n=JSON.parse((t==null?void 0:t.value_pt)||"[]")}catch{n=[]}function a(d){const r=["#0d2144","#1a3a5c","#0a1628","#164a3c","#2d1b3d","#3d1a1a","#1a2f4a"];let s=0;for(const c of d||"?")s=s*31+c.charCodeAt(0)&4294967295;return r[Math.abs(s)%r.length]}function o(){e.querySelector("#dep-save-msg"),e.innerHTML=`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(d=>{d.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(s=>s.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(s=>s.classList.add("hidden")),d.classList.add("active");const r=e.querySelector(`#sa-panel-${d.dataset.tab}`);r&&r.classList.remove("hidden"),d.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&oe(),d.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&Fa(),d.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ct(),d.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&qt(),d.dataset.tab==="platform"&&Tt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ct),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",oe),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",qt),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Ga()),(i=e.querySelector("#sa-plat-save"))==null||i.addEventListener("click",Xa),oe(),Tt())}async function oe(){var r,s;const e=document.getElementById("sa-tenants-list"),t=((s=(r=document.getElementById("sa-tenant-search"))==null?void 0:r.value)==null?void 0:s.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=h.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const i=(a||[]).filter(c=>{var l,m;return!t||((l=c.name)==null?void 0:l.toLowerCase().includes(t))||((m=c.slug)==null?void 0:m.toLowerCase().includes(t))});if(!i.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const d=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=i.map(c=>{var l;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(c=>{c.addEventListener("click",async l=>{l.stopPropagation();const m=c.dataset.active==="true";await h.from("tenants").update({active:!m}).eq("id",c.dataset.id),oe()})}),e.querySelectorAll('[data-action="open-panel"]').forEach(c=>{c.addEventListener("click",()=>{const l=(i||[]).find(m=>String(m.id)===String(c.dataset.id));l&&Wa(l)})})}async function Fa(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:t,error:n}=await h.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(t||[]).map(a=>`
  ...
  `,document.body.appendChild(t),document.getElementById("tp-back").addEventListener("click",()=>t.remove()),document.getElementById("tp-edit-btn").addEventListener("click",()=>ea(e)),t.querySelectorAll(".tp-tab").forEach(o=>{o.addEventListener("click",()=>{t.querySelectorAll(".tp-tab").forEach(i=>{i.style.fontWeight="500",i.style.color="#64748b",i.style.borderBottomColor="transparent"}),o.style.fontWeight="700",o.style.color="#2563eb",o.style.borderBottomColor="#2563eb",dt(e,o.dataset.tab)})}),dt(e,"properties")}function Ja(e,t){const n=document.getElementById("tp-prop-edit-modal");n&&n.remove();const a=document.createElement("div");a.id="tp-prop-edit-modal",a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.55);z-index:10000;display:flex;align-items:center;justify-content:center;padding:16px;";const o=(r,s,c,l="text",m="")=>`<div style="display:flex;flex-direction:column;gap:4px;">
    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:680px;max-height:90vh;display:flex;flex-direction:column;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.25);">
      ...
      </div>`,(c=document.getElementById("tp-open-edit"))==null||c.addEventListener("click",()=>ea(e))}}function ea(e){var c,l,m,p,b,x,u,g;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop";const a="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/public-api";n.innerHTML=`
...
await fetch(\`\${API}/leads?key=\${KEY}\`, {
  ...
  `,document.body.appendChild(n),h.from("plans").select("id, name").then(({data:f})=>{const E=document.getElementById("et-plan");E&&f&&(E.innerHTML='<option value="">Sem plano</option>'+f.map(I=>`<option value="${I.id}"${String(I.id)===String(e.plan_id)?" selected":""}>${v(I.name)}</option>`).join(""))}),(c=document.getElementById("et-logo-input"))==null||c.addEventListener("change",f=>{const E=f.target.files[0];if(!E)return;const I=URL.createObjectURL(E),S=document.getElementById("et-logo-preview");S&&(S.innerHTML=`<img src="${I}" style="width:100%;height:100%;object-fit:cover;">`)}),(l=document.getElementById("et-logo-preview"))==null||l.addEventListener("click",()=>{var f;(f=document.getElementById("et-logo-input"))==null||f.click()}),(m=document.getElementById("et-pwd-toggle"))==null||m.addEventListener("click",()=>{const f=document.getElementById("et-admin-password");f.type=f.type==="password"?"text":"password"}),(p=document.getElementById("et-copy-key"))==null||p.addEventListener("click",()=>{var S,B;const f=(S=document.getElementById("et-api-key"))==null?void 0:S.value;if(!f)return;(B=navigator.clipboard)==null||B.writeText(f);const E=document.getElementById("et-copy-key"),I=E.textContent;E.textContent="✅ Copiada!",setTimeout(()=>{E.textContent=I},2e3)});const o=["dados","config","api"];function i(f){o.forEach(E=>{document.getElementById(`et-pane-${E}`).style.display=E===f?"":"none";const I=document.getElementById(`et-tab-${E}`);I.style.borderBottomColor=E===f?"#2563eb":"transparent",I.style.color=E===f?"#2563eb":"#64748b",I.style.fontWeight=E===f?"600":"500"}),f==="config"&&r()}o.forEach(f=>{var E;return(E=document.getElementById(`et-tab-${f}`))==null?void 0:E.addEventListener("click",()=>i(f))});let d=!1;async function r(){var I;if(d)return;d=!0;const{data:f}=await h.from("settings").select("key,value").eq("tenant_id",e.id),E={};f==null||f.forEach(S=>{E[S.key]=S.value}),document.getElementById("et-pane-config").innerHTML=`
      <div class="form-group">
...
Essa ação é irreversível e removerá o registro da plataforma.`))return;const E=document.getElementById("et-delete");E.disabled=!0,E.textContent="Excluindo…";const{error:I}=await h.from("tenants").delete().eq("id",e.id);if(I){alert("Erro ao excluir: "+I.message),E.disabled=!1,E.textContent="🗑️ Excluir";return}s(),oe()}),(g=document.getElementById("et-save"))==null||g.addEventListener("click",async()=>{var N,T,V,H,O,ee,ie,$e,ke,U,ve,yt;const f=(T=(N=document.getElementById("et-name"))==null?void 0:N.value)==null?void 0:T.trim(),E=(H=(V=document.getElementById("et-slug"))==null?void 0:V.value)==null?void 0:H.trim(),I=(ee=(O=document.getElementById("et-domain"))==null?void 0:O.value)==null?void 0:ee.trim(),S=(ie=document.getElementById("et-plan"))==null?void 0:ie.value,B=(ke=($e=document.getElementById("et-admin-email"))==null?void 0:$e.value)==null?void 0:ke.trim(),k=(ve=(U=document.getElementById("et-admin-password"))==null?void 0:U.value)==null?void 0:ve.trim(),w=(yt=document.getElementById("et-logo-input"))==null?void 0:yt.files[0],$=document.getElementById("et-msg"),L=document.getElementById("et-save");if(!f){$.textContent="❌ Nome é obrigatório.",$.style.color="#ef4444";return}L.disabled=!0,L.textContent="Salvando…",$.textContent="⏳ Salvando…",$.style.color="#64748b";let q=e.logo_url;if(w)try{const A=await Me(w,256,.85),bt=`tenant-logos/${e.id}-${Date.now()}.jpg`,{error:ia}=await h.storage.from("imoveis").upload(bt,A,{contentType:"image/jpeg",upsert:!0});if(!ia){const{data:{publicUrl:sa}}=h.storage.from("imoveis").getPublicUrl(bt);q=sa}}catch(A){console.error("Logo upload:",A)}const{error:C}=await h.from("tenants").update({name:f,slug:E||e.slug,domain:I||null,plan_id:S||null,logo_url:q}).eq("id",e.id);if(C){L.disabled=!1,L.textContent="Salvar",$.textContent="❌ "+C.message,$.style.color="#ef4444";return}if(B&&k&&k.length>=6){$.textContent="⏳ Criando usuário admin…";const A=await pe({email:B,password:k,role:"admin",tenant_id:e.id});A!=null&&A.success?(A!=null&&A.user_id&&!(A!=null&&A.linked)&&await h.from("profiles").update({tenant_id:e.id}).eq("id",A.user_id),$.textContent="✅ Salvo e admin criado!",$.style.color="#22c55e"):($.textContent="⚠️ Salvo, mas erro ao criar admin: "+((A==null?void 0:A.error)||"Tente novamente"),$.style.color="#f59e0b")}else $.textContent="✅ Imobiliária atualizada!",$.style.color="#22c55e";L.disabled=!1,L.textContent="Salvar",setTimeout(()=>{s(),oe()},1200)})}const At=[{key:"name",label:"Nome",required:!0},{key:"phone",label:"Telefone",required:!1},{key:"email",label:"E-mail",required:!1},{key:"notes",label:"Notas",required:!1}];let Ye=[],ge=[],Ue={};function Ya(){var e;(e=document.getElementById("btn-import-leads"))==null||e.addEventListener("click",Ka)}function Ka(){Ye=[],ge=[],Ue={};const e=document.createElement("div");e.id="import-leads-overlay",e.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.55);z-index:9000;display:flex;align-items:center;justify-content:center;",e.innerHTML=`
...
`).map(r=>r.trimEnd()).filter(r=>r.length);if(a.length<2)return{error:"Arquivo vazio ou sem dados."};function o(r){const s=[];let c="",l=!1;for(let m=0;m<r.length;m++){const p=r[m];p==='"'?l&&r[m+1]==='"'?(c+='"',m++):l=!l:p===n&&!l?(s.push(c.trim()),c=""):c+=p}return s.push(c.trim()),s}const i=o(a[0]).map(r=>r.replace(/^["']+|["']+$/g,"")),d=a.slice(1).map(o);return{headers:i,rows:d}}async function Za(e){const t=document.getElementById("import-upload-error");try{window.XLSX||await new Promise((i,d)=>{const r=document.createElement("script");r.src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.18.5/xlsx.full.min.js",r.onload=i,r.onerror=d,document.head.appendChild(r)});const n=window.XLSX.read(e,{type:"array"}),a=n.Sheets[n.SheetNames[0]],o=window.XLSX.utils.sheet_to_json(a,{header:1,defval:""});if(!o||o.length<2){t.textContent="Planilha vazia.",t.style.display="";return}ge=o[0].map(String),Ye=o.slice(1),aa()}catch(n){t.textContent="Erro ao ler o arquivo Excel: "+n.message,t.style.display=""}}function en(e,t){for(let n=0;n<e.length;n++){const a=e[n].toLowerCase();if(t.some(o=>a.includes(o)))return n}return""}function aa(){document.getElementById("import-step-upload").style.display="none",document.getElementById("import-step-map").style.display="";const e=document.getElementById("import-field-rows"),t={name:["nome","name","contact","cliente","contato"],phone:["tel","fone","celular","whatsapp","phone","mobile"],email:["email","e-mail","mail"],notes:["obs","nota","note","comment","coment","descri"]},n='<option value="">— ignorar —</option>'+ge.map((a,o)=>`<option value="${o}">${v(a)}</option>`).join("");e.innerHTML=At.map(a=>{const o=en(ge,t[a.key]||[]);return Ue[a.key]=o!==""?parseInt(o):"",`
      ...
      </div>`}).join("")}function g(){i.classList.remove("hidden"),u(""),d.value="",c.classList.add("hidden"),d.focus()}function f(){i.classList.add("hidden")}o.addEventListener("click",I=>{I.stopPropagation(),i.classList.contains("hidden")?g():f()}),document.addEventListener("mousedown",function I(S){e.contains(S.target)||(f(),document.removeEventListener("mousedown",I))}),i.addEventListener("mousedown",I=>I.stopPropagation()),d.addEventListener("input",()=>u(d.value)),r.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-opt");if(!S)return;const B=S.dataset.tag,k=b();k.includes(B)?x(k.filter(w=>w!==B)):x([...k,B]),u(d.value)}),a.addEventListener("click",I=>{const S=I.target.closest(".ldp-tag-rm");if(!S)return;const B=S.dataset.tag;x(b().filter(k=>k!==B))}),s.addEventListener("click",()=>{c.classList.toggle("hidden"),c.classList.contains("hidden")||l.focus()});async function E(){const I=l.value.trim();if(!I){l.focus();return}const S=m.value||"#6366F1";if(t.some(B=>B.name.toLowerCase()===I.toLowerCase())){l.style.borderColor="#ef4444",setTimeout(()=>{l.style.borderColor=""},1500);return}p.disabled=!0,p.textContent="Criando…";try{const{data:B,error:k}=await h.from("crm_tags").insert({name:I,color:S,tenant_id:y==null?void 0:y.tenant_id}).select().single();if(k)throw k;const w={id:B.id,name:B.name,color:B.color};t.push(w),n[w.name]=w,typeof ce<"u"&&(ce[w.name]=w),x([...b(),w.name]),u(d.value),l.value="",m.value="#6366F1",c.classList.add("hidden")}catch(B){console.error("Error creating tag:",B),alert("Erro ao criar tag: "+(B.message||B))}finally{p.disabled=!1,p.textContent="Criar e adicionar"}}p.addEventListener("click",E),l.addEventListener("keydown",I=>{I.key==="Enter"&&E()})}async function on(){var u;const e=document.getElementById("section-dashboard");if(!e||e.dataset.dbInit==="1")return;e.dataset.dbInit="1",e.innerHTML=`
<div class="db-wrap">
  ...
  <div class="db-row-third">
...
</div>`;const t=new Date,n=t.getHours(),a=n<12?"Bom dia":n<18?"Boa tarde":"Boa noite",o=["Domingo","Segunda-feira","Terça-feira","Quarta-feira","Quinta-feira","Sexta-feira","Sábado"],i=["janeiro","fevereiro","março","abril","maio","junho","julho","agosto","setembro","outubro","novembro","dezembro"],d=`${o[t.getDay()]}, ${t.getDate()} de ${i[t.getMonth()]} de ${t.getFullYear()}`,r=((u=y==null?void 0:y.name)==null?void 0:u.split(" ")[0])||"Corretor",s=e.querySelector(".db-greeting");s&&(s.innerHTML=`${a}, <span class="db-greeting-name">${z(r)}</span> 👋`);const c=document.getElementById("db-subline");c&&(c.textContent=`Aqui está o resumo do seu negócio — ${d}`);let l=[],m=[];try{const g=y==null?void 0:y.tenant_id,[f,E]=await Promise.all([Dt(),sn(g)]);l=f||[],m=E||[]}catch(g){console.warn("[Dashboard] Erro ao carregar dados:",g)}dn(l,m,t);const p=l.filter(g=>g.published).length,b=m.filter(g=>lt(g.created_at)===lt(t.toISOString())).length,x=document.getElementById("db-header-chips");x&&(x.innerHTML=`
    ...
    <div class="db-tl-item">
      ...
      <div class="db-tl-time">${na(d.time,n)}</div>
