import{s as v}from"./supabase-BcuJ3xoD.js";let Y={},ve={};async function Fe(){const[e,a]=await Promise.all([v.from("settings").select("key,value"),v.from("site_content").select("*")]);e.data&&e.data.forEach(n=>{Y[n.key]=n.value}),a.data&&a.data.forEach(n=>{ve[n.key]=n})}const T=(e,a=null)=>Y[e]!==void 0?Y[e]:a,ge=(e,a="pt")=>{const n=ve[e];return n?n[`value_${a}`]??n.value_pt??null:null},De=()=>({...ve});async function G(e,a){const{error:n}=await v.from("settings").upsert({key:e,value:a,updated_at:new Date().toISOString()},{onConflict:"key"});return n||(Y[e]=a),!n}async function V(e){const a=new Date().toISOString(),n=e.map(([s,o])=>({key:s,value:o,updated_at:a})),{error:t}=await v.from("settings").upsert(n,{onConflict:"key"});return t||e.forEach(([s,o])=>{Y[s]=o}),!t}async function ie(e,{pt:a,en:n,es:t}){const s={key:e,value_pt:a,value_en:n,value_es:t,updated_at:new Date().toISOString()},{error:o}=await v.from("site_content").upsert(s,{onConflict:"key"});return o||(ve[e]=s),!o}async function fe(e,a,n){const{error:t}=await v.from("integrations").upsert({key:e,value:a,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!t}function Ie(){const e=document.documentElement,a=T("visual.accent_color","#b8962e"),n=T("visual.primary_bg","#0f1c2e"),t=T("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",a),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",t);const s=T("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=s});const o=T("company.favicon_url","/favicon.ico"),r=document.querySelector('link[rel="shortcut icon"]');r&&(r.href=o);const l=T("visual.hero_bg_url","");if(l){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${l}')`)}}function Oe(e="pt"){const a=p=>ge(p,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&a("hero.title")&&(n.innerHTML=a("hero.title"));const t=document.querySelector(".hero-content > p");t&&a("hero.subtitle")&&(t.innerHTML=a("hero.subtitle"));const s=document.querySelector(".footer small");s&&a("footer.text")&&(s.innerHTML=a("footer.text"));const o=document.querySelector('[data-i18n="inst.p1"]'),r=document.querySelector('[data-i18n="inst.p2"]'),l=document.querySelector('[data-i18n="inst.p3"]');o&&a("inst.bio_p1")&&(o.innerHTML=a("inst.bio_p1")),r&&a("inst.bio_p2")&&(r.innerHTML=a("inst.bio_p2")),l&&a("inst.bio_p3")&&(l.innerHTML=a("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),d=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');i&&a("inst.stat2_num")&&(i.innerHTML=a("inst.stat2_num")),d&&a("inst.stat1_label")&&(d.innerHTML=a("inst.stat1_label")),m&&a("inst.stat2_label")&&(m.innerHTML=a("inst.stat2_label")),u&&a("inst.stat3_label")&&(u.innerHTML=a("inst.stat3_label"));const c=ge("seo.title_pt",e);c&&document.title&&(document.title=c);const f=ge("seo.description_pt",e);if(f){const p=document.querySelector('meta[name="description"]');p&&(p.content=f)}}function ze(e){if(!e)return;const a=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const t=n.getAttribute("href");if(t){const s=t.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=a+s}})}let j=null;async function Xe(){const{data:{user:e}}=await v.auth.getUser();if(!e)return;const{data:a}=await v.from("profiles").select("role").eq("id",e.id).single();!a||!["admin","super_admin"].includes(a.role)||(Ve(),Ge(),We(),document.addEventListener("click",Je,!0))}function Ve(){const e=document.createElement("style");e.textContent=`
    #em-bar {
  ...
  `,document.head.appendChild(e)}function Ge(){const e=T("visual.accent_color","#b8962e"),a=T("visual.primary_bg","#0f1c2e"),n=T("visual.secondary_bg","#1a2f4a"),t=document.createElement("div");t.id="em-bar",t.innerHTML=`
  ...
  `,document.body.prepend(t);let s=null;const o=async()=>{const r=document.getElementById("em-c-accent").value,l=document.getElementById("em-c-primary").value,i=document.getElementById("em-c-sec").value;document.documentElement.style.setProperty("--accent",r),document.documentElement.style.setProperty("--primary-bg",l),document.documentElement.style.setProperty("--secondary-bg",i),await Promise.all([G("visual.accent_color",r),G("visual.primary_bg",l),G("visual.secondary_bg",i)])};["em-c-accent","em-c-primary","em-c-sec"].forEach(r=>document.getElementById(r).addEventListener("input",()=>{clearTimeout(s),s=setTimeout(o,700)})),document.getElementById("em-exit").addEventListener("click",()=>{const r=new URL(location.href);r.searchParams.delete("edit"),location.href=r.toString()})}function We(){[[".logo-img","image:company.logo_url","Logo"],[".brand-name","setting:company.name","Nome da empresa"],[".brand-title","setting:company.tagline","Slogan / CRECI"],[".topbar-phone-bare","setting:company.whatsapp","Número WhatsApp"],['.social-icon-link[aria-label="Facebook"]',"setting:social.facebook_url","Link Facebook"],['.social-icon-link[aria-label="Instagram"]',"setting:social.instagram_url","Link Instagram"],[".hero","image:visual.hero_bg_url","Imagem de fundo (Hero)"],['[data-i18n="hero.title"]',"content:hero.title","Título do Hero"],[".hero-content > p","content:hero.subtitle","Subtítulo do Hero"],[".hero-whatsapp-btn","setting:hero.cta_text","Botão CTA"],[".planta-title","content:planta.title","Título — Seção Planta"],[".planta-card-title","content:planta.card_title","Card — Planta título"],[".planta-card-desc","content:planta.card_desc","Card — Planta descrição"],[".selecao-title","content:home.available_title","Título — Imóveis Disponíveis"],[".selecao-sub","content:home.available_sub","Subtítulo — Imóveis Disponíveis"],["#institucional h2","content:inst.title","Título — Institucional"],['[data-i18n="inst.p1"]',"content:inst.bio_p1","Bio — parágrafo 1"],['[data-i18n="inst.p2"]',"content:inst.bio_p2","Bio — parágrafo 2"],['[data-i18n="inst.p3"]',"content:inst.bio_p3","Bio — parágrafo 3"],['#institucional .planta-cta, #institucional a[href*="wa.me"]',"setting:company.whatsapp","WhatsApp CTA"],["#institucional img","image:company.photo_url","Foto do corretor"],[".footer small","content:footer.text","Rodapé"]].forEach(([a,n,t])=>{document.querySelectorAll(a).forEach(s=>{s.dataset.editable||(s.dataset.editable=n,s.dataset.editLabel=t)})})}function Je(e){if(j&&!j.contains(e.target)&&!e.target.closest("[data-editable]")){ce();return}const a=e.target.closest("[data-editable]");a&&(e.preventDefault(),e.stopPropagation(),ce(),document.querySelectorAll("[data-editable].em-on").forEach(n=>n.classList.remove("em-on")),a.classList.add("em-on"),Ye(a))}function Ye(e){const a=e.dataset.editable,n=e.dataset.editLabel||a,[t,s]=a.split(":"),o=document.createElement("div");o.id="em-pop",j=o,o.innerHTML=`<div class="ep-title">✏️ ${re(n)}</div>${Ke(t,s,e)}<div class="ep-row"><button class="ep-save" id="ep-save">Salvar</button><button class="ep-cancel" id="ep-cancel">Cancelar</button><span class="ep-msg" id="ep-msg"></span></div>`,document.body.appendChild(o),tt(e,o),Ze(o,t,s,e)}function Ke(e,a,n){if(e==="content"){const t=De()[a]||{},s=t.value_pt||n.innerText.trim(),o=t.value_en||"",r=t.value_es||"";return`
      ...
      <div id="epl-es" style="display:none"><div class="ep-lbl">Español</div><textarea id="epv-es" rows="3">${re(r)}</textarea></div>`}if(e==="setting"){const t=T(a,"");return`<div class="ep-lbl">Valor</div><input type="text" id="epv-setting" value="${oe(t)}" placeholder="${oe(label)}">`}if(e==="image"){const t=T(a,"");return`
      <div class="ep-lbl">URL da imagem</div>
      <input type="url" id="epv-image" value="${oe(t)}" placeholder="https://... ou /logo.png">
      <div class="ep-upload">
      ...
      ${t?`<img class="ep-preview" id="ep-prev" src="${oe(t)}" alt="">`:'<img class="ep-preview" id="ep-prev" style="display:none" alt="">'}`}return""}function Ze(e,a,n,t){if(e.querySelectorAll(".ep-tab").forEach(s=>{s.addEventListener("click",()=>{e.querySelectorAll(".ep-tab").forEach(o=>o.classList.remove("active")),s.classList.add("active"),["pt","en","es"].forEach(o=>{const r=e.querySelector(`#epl-${o}`);r&&(r.style.display=o===s.dataset.lang?"":"none")})})}),a==="image"){const s=e.querySelector("#epv-image"),o=e.querySelector("#ep-prev");s.addEventListener("input",()=>{o.src=s.value,o.style.display=s.value?"":"none"});const r=e.querySelector("#epv-file");e.querySelector("#ep-upbtn").addEventListener("click",()=>r.click()),r.addEventListener("change",async l=>{const i=l.target.files[0];if(!i)return;z(e,"Enviando…","#fbbf24");const d=`public/site/${n.replace(/\./g,"_")}_${Date.now()}.${i.name.split(".").pop()}`,{error:m}=await v.storage.from("media").upload(d,i,{upsert:!0});if(m){z(e,"Erro no upload","#f87171");return}const{data:{publicUrl:u}}=v.storage.from("media").getPublicUrl(d);s.value=u,o.src=u,o.style.display="",z(e,"Upload OK!","#4ade80")})}e.querySelector("#ep-save").addEventListener("click",async()=>{var o,r,l,i,d;z(e,"Salvando…","#fbbf24");let s=!1;if(a==="content"){const m=((o=e.querySelector("#epv-pt"))==null?void 0:o.value)||"",u=((r=e.querySelector("#epv-en"))==null?void 0:r.value)||"",c=((l=e.querySelector("#epv-es"))==null?void 0:l.value)||"";s=await ie(n,{pt:m,en:u,es:c}),s&&(t.innerHTML=m)}else if(a==="setting"){const m=((i=e.querySelector("#epv-setting"))==null?void 0:i.value)||"";s=await G(n,m),s&&Qe(n,m,t)}else if(a==="image"){const m=((d=e.querySelector("#epv-image"))==null?void 0:d.value)||"";s=await G(n,m),s&&et(n,m)}s?(z(e,"✓ Salvo!","#4ade80"),setTimeout(ce,700)):z(e,"✗ Erro","#f87171")}),e.querySelector("#ep-cancel").addEventListener("click",ce)}function Qe(e,a,n){if(e==="company.name"&&document.querySelectorAll(".brand-name").forEach(t=>t.textContent=a),e==="company.tagline"&&document.querySelectorAll(".brand-title").forEach(t=>t.textContent=a),e==="hero.cta_text"&&(n.textContent=a),e==="social.facebook_url"&&(n.href=a),e==="social.instagram_url"&&(n.href=a),e==="company.whatsapp"){const t=a.replace(/\D/g,"");document.querySelectorAll('a[href*="wa.me"]').forEach(s=>{const o=s.href.replace(/https:\/\/wa\.me\/[^?]+/,"");s.href=`https://wa.me/${t}${o}`}),document.querySelectorAll(".topbar-phone-bare").forEach(s=>s.textContent=a)}}function et(e,a){if(e==="company.logo_url"&&document.querySelectorAll(".logo-img").forEach(n=>n.src=a),e==="visual.hero_bg_url"){const n=document.querySelector(".hero");n&&(n.style.backgroundImage=`url('${a}')`)}if(e==="company.photo_url"){const n=document.querySelector("#institucional img");n&&(n.src=a)}}function tt(e,a){const n=e.getBoundingClientRect(),t=window.innerWidth,s=window.innerHeight;let o=n.left,r=n.bottom+8;o+360>t-8&&(o=t-368),o<8&&(o=8),r+320>s&&(r=Math.max(50,n.top-8-320)),a.style.left=`${o}px`,a.style.top=`${r}px`}function ce(){j==null||j.remove(),j=null,document.querySelectorAll("[data-editable].em-on").forEach(e=>e.classList.remove("em-on"))}function z(e,a,n){const t=e.querySelector("#ep-msg");t&&(t.textContent=a,t.style.color=n)}const re=e=>String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"),oe=e=>String(e).replace(/"/g,"&quot;"),at="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let X="5547999701743",K=`https://wa.me/${X}`;const D=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],nt=5.7;function Z(e,a){if(!e)return"—";const n=String(e).trim();let t;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?t=parseFloat(n.replace(/\./g,"").replace(",",".")):t=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(t)||t===0?n:a==="en"?"$ "+(t/nt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+t.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let L=[],E=null,Q=[],Ue=!1;v.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(Ue=!0)});async function ot(){const{data:e,error:a}=await v.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return a?(console.error("Supabase select error:",a),[]):e||[]}async function st(){const{data:e,error:a}=await v.from("properties").select("*").order("created_at",{ascending:!1});return a?(console.error("Supabase select error:",a),[]):(L=e||[],ht(),Et(),L)}async function it(e){if(e.id){const{id:a,created_at:n,...t}=e,{error:s}=await v.from("properties").update(t).eq("id",a);if(s)throw s;const o=L.findIndex(r=>r.id===a);o>=0&&(L[o]={...L[o],...t})}else{if(!e.reference){const t=L.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10)),s=t.length?Math.max(...t)+1:1;e.reference="IO-"+String(s).padStart(4,"0")}const{data:a,error:n}=await v.from("properties").insert(e).select();if(n)throw n;a!=null&&a[0]&&L.unshift(a[0])}}async function rt(e){const{error:a}=await v.from("properties").delete().eq("id",e);if(a)throw a;L=L.filter(n=>n.id!==e)}async function lt(e,a){const{error:n}=await v.auth.signInWithPassword({email:e,password:a});return!n}function xe(e,a=1200,n=.78){return new Promise((t,s)=>{const o=new Image,r=URL.createObjectURL(e);o.onload=()=>{URL.revokeObjectURL(r);const l=document.createElement("canvas");let i=o.width,d=o.height;i>a&&(d=Math.round(d*a/i),i=a),l.width=i,l.height=d;const m=l.getContext("2d");m.drawImage(o,0,0,i,d);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const c=Math.round(i*.18),f=Math.round(u.naturalHeight*c/u.naturalWidth),p=Math.round(i*.02),y=i-c-p,w=d-f-p;m.globalAlpha=.45,m.drawImage(u,y,w,c,f),m.globalAlpha=1,l.toBlob(g=>g?t(g):s(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{l.toBlob(c=>c?t(c):s(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},o.onerror=s,o.src=r})}async function ct(e){const a=await xe(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:t}=await v.storage.from("imoveis").upload(n,a,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(t)throw t;const{data:{publicUrl:s}}=v.storage.from("imoveis").getPublicUrl(n);return s}async function dt(e,a){const n=Array.from(e).filter(s=>s.size>0),t=[];for(let s=0;s<n.length;s++)a&&a(s+1,n.length),t.push(await ct(n[s]));return t}async function ee(){var u,c,f,p,y,w;const e=document.getElementById("vendas-carousel"),a=document.getElementById("properties");if(!e&&!a)return;const n=await ot();L=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&mt(n);const t=((c=document.getElementById("city-filter"))==null?void 0:c.value)||"",s=((f=document.getElementById("neighborhood-filter"))==null?void 0:f.value)||"",o=((p=document.getElementById("bedrooms-filter"))==null?void 0:p.value)||"",r=((y=document.getElementById("parking-filter"))==null?void 0:y.value)||"",l=((w=document.getElementById("construction-filter"))==null?void 0:w.value)||"",i=document.getElementById("price-slider"),d=i?parseInt(i.value,10):13e7,m=n.filter(g=>{if(t&&g.city!==t||s&&g.neighborhood!==s||o&&(o==="4+"&&Number(g.bedrooms)<4||o!=="4+"&&Number(g.bedrooms)!==Number(o))||r&&(r==="4+"&&Number(g.parking)<4||r!=="4+"&&Number(g.parking)!==Number(r))||l&&g.construction_status!==l)return!1;const h=String(g.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(h,10)||0;return!(B<0||B>d)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(g=>{var k;const h=g.cover_image||((k=g.images)==null?void 0:k[0])||D[0],B=[g.neighborhood,g.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          ...
          <div class="selecao-card-body">
            ...
            <div class="selecao-card-price">${b(Z(g.price,window.currentLang||"pt"))}</div>
            <div class="selecao-card-actions">
              <a href="property.html?id=${g.id}" class="btn-det">Ver Detalhes</a>
              <a href="${K}" target="_blank" rel="noopener" class="btn-wa">WhatsApp</a>
            </div>
          </div>
        </div>
      `}).join("");return}if(!m.length){a.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}a.innerHTML=m.map(g=>{var k;const h=(k=g.images)!=null&&k.length?g.images:D,B=h.length;return`
      <div class="card property-card">
        ...
        <div class="property-info">
          ...
          <div><strong>${b(Z(g.price,window.currentLang||"pt"))}</strong></div>
          ...
          <div style="display:flex;gap:8px;margin-top:6px">
            ...
            <a class="btn hero-whatsapp-btn" href="${K}" target="_blank" rel="noopener" style="flex:1;justify-content:center">WhatsApp</a>
          </div>
        </div>
      </div>
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(g=>{g.removeEventListener("click",Ce),g.addEventListener("click",Ce)})}function mt(e){var s,o,r;const a=document.getElementById("selecao-carousel");if(!a)return;const n=e.slice(0,6);if(!n.length){(s=a.closest(".selecao-section"))==null||s.classList.add("hidden");return}a.innerHTML=n.map(l=>{var m;const i=l.cover_image||((m=l.images)==null?void 0:m[0])||D[0],d=[l.neighborhood,l.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
        ...
        <div class="selecao-card-body">
          ...
          <div class="selecao-card-price">${b(Z(l.price,window.currentLang||"pt"))}</div>
          <div class="selecao-card-actions">
    ...
    `}).join("");const t=a.closest(".selecao-carousel-wrap");(o=t==null?void 0:t.querySelector(".selecao-prev"))==null||o.addEventListener("click",()=>{a.scrollBy({left:-340,behavior:"smooth"})}),(r=t==null?void 0:t.querySelector(".selecao-next"))==null||r.addEventListener("click",()=>{a.scrollBy({left:340,behavior:"smooth"})})}window.filterByStatus=function(e){var n;const a=document.getElementById("construction-filter");a&&(a.value=e),(n=document.getElementById("vendas-section"))==null||n.scrollIntoView({behavior:"smooth"}),ee()};function Ce(e){var l;e.stopPropagation();const a=e.currentTarget.closest(".carousel-wrap");if(!a)return;const n=parseInt(a.dataset.total,10);if(!n)return;let t=parseInt(a.dataset.idx,10)||0;const s=e.currentTarget.classList.contains("carousel-next")?1:-1;t=(t+s+n)%n,a.dataset.idx=t;const o=parseInt(a.dataset.pid,10),r=L.find(i=>i.id===o);(l=r==null?void 0:r.images)!=null&&l.length&&(a.querySelector(".carousel-img").src=r.images[t])}function ut(){const e=document.getElementById("price-slider"),a=document.getElementById("price-label");!e||!a||(e.min="0",e.max="130000000",e.step="1000000",e.value="130000000",a.textContent="Até R$ 130.000.000",e.addEventListener("input",()=>{const n=parseInt(e.value,10);a.textContent="Até R$ "+n.toLocaleString("pt-BR"),ee()}))}function pt(){const e=document.getElementById("city-filter"),a=document.getElementById("neighborhood-filter");if(e&&a){const n=O();e.innerHTML='<option value="">Todas as cidades</option>'+n.map(t=>`<option value="${t.name}">${b(t.name)}</option>`).join(""),e.addEventListener("change",()=>{const t=O().find(o=>o.name===e.value),s=t?Se(t.id):[];a.innerHTML='<option value="">Todos os bairros</option>'+s.map(o=>`<option value="${o.name}">${b(o.name)}</option>`).join(""),ee()})}document.querySelectorAll('[id$="-filter"]').forEach(n=>{n.addEventListener("change",ee)})}function te(e){const a=document.getElementById("admin-properties");if(a){if(!e.length){a.innerHTML='<tr><td colspan="8" class="empty-row">Nenhum imóvel encontrado.</td></tr>';return}a.innerHTML=e.map(n=>{var r;const t=n.cover_image||((r=n.images)==null?void 0:r[0])||D[0],s=[n.rua,n.numero?`nº ${n.numero}`:"",n.neighborhood,n.city].filter(Boolean).join(", ")||"—",o=n.published===!0?'<span class="badge badge-green">● Publicado</span>':'<span class="badge badge-gray">○ Rascunho</span>';return`<tr data-id="${n.id}">
      ...
      <td class="cell-price">${b(Z(n.price,"pt"))}</td>
      <td>${n.bedrooms??"—"}</td>
      <td>${n.parking??"—"}</td>
      <td>${o}</td>
      <td>
    ...
    </tr>`}).join("")}}function vt(){const e=document.getElementById("f-city");if(!e)return;const a=O(),n=e.value;e.innerHTML='<option value="">Todas</option>'+a.map(t=>`<option value="${t.name}">${b(t.name)}</option>`).join(""),n&&(e.value=n)}function gt(){var e,a,n,t,s,o,r,l,i,d,m,u,c,f,p;return{ref:(((e=document.getElementById("f-ref"))==null?void 0:e.value)||"").trim().toLowerCase(),title:(((a=document.getElementById("f-title"))==null?void 0:a.value)||"").trim().toLowerCase(),type:((n=document.getElementById("f-type"))==null?void 0:n.value)||"",city:((t=document.getElementById("f-city"))==null?void 0:t.value)||"",neighborhood:((s=document.getElementById("f-neighborhood"))==null?void 0:s.value)||"",condominium:(((o=document.getElementById("f-condominium"))==null?void 0:o.value)||"").trim().toLowerCase(),priceMin:parseFloat((r=document.getElementById("f-price-min"))==null?void 0:r.value)||0,priceMax:parseFloat((l=document.getElementById("f-price-max"))==null?void 0:l.value)||1/0,areaMin:parseFloat((i=document.getElementById("f-area-min"))==null?void 0:i.value)||0,areaMax:parseFloat((d=document.getElementById("f-area-max"))==null?void 0:d.value)||1/0,construction:((m=document.getElementById("f-construction"))==null?void 0:m.value)||"",published:((u=document.getElementById("f-published"))==null?void 0:u.value)||"",bedrooms:((c=document.querySelector("#f-bedrooms .filter-btn.active"))==null?void 0:c.dataset.val)||"",suites:((f=document.querySelector("#f-suites .filter-btn.active"))==null?void 0:f.dataset.val)||"",parking:((p=document.querySelector("#f-parking .filter-btn.active"))==null?void 0:p.dataset.val)||""}}function Be(e){const a=gt();return Object.values(a).some(t=>t!==""&&t!==0&&t!==1/0)?e.filter(t=>{if(a.ref&&!(t.reference||"").toLowerCase().includes(a.ref)||a.title&&!(t.title||"").toLowerCase().includes(a.title)||a.type&&!(t.title||"").toLowerCase().includes(a.type.toLowerCase())||a.city&&t.city!==a.city||a.neighborhood&&t.neighborhood!==a.neighborhood||a.condominium&&!(t.condominium||"").toLowerCase().includes(a.condominium))return!1;const s=parseInt(String(t.price||"").replace(/[^0-9]/g,""),10)||0;if(a.priceMin>0&&s<a.priceMin||a.priceMax<1/0&&s>a.priceMax)return!1;const o=parseFloat(t.area)||0;return!(a.areaMin>0&&o<a.areaMin||a.areaMax<1/0&&o>a.areaMax||a.construction&&t.construction_status!==a.construction||a.published!==""&&String(t.published)!==a.published||a.bedrooms&&(a.bedrooms==="5+"&&Number(t.bedrooms)<5||a.bedrooms!=="5+"&&Number(t.bedrooms)!==Number(a.bedrooms))||a.suites&&(a.suites==="5+"&&Number(t.suites)<5||a.suites!=="5+"&&Number(t.suites)!==Number(a.suites))||a.parking&&(a.parking==="5+"&&Number(t.parking)<5||a.parking!=="5+"&&Number(t.parking)!==Number(a.parking)))}):e}async function de(){if(!document.getElementById("admin-properties"))return;const e=await st(),a=e.length,n=e.filter(r=>r.published===!0).length,t=document.getElementById("stat-total"),s=document.getElementById("stat-published"),o=document.getElementById("stat-leads");t&&(t.textContent=a),s&&(s.textContent=n),o&&(o.textContent="—"),vt(),te(L)}let N=null,F="";function be(e){document.getElementById("modal-title").textContent=e||"Novo Imóvel",document.getElementById("property-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function le(){document.getElementById("property-modal").classList.add("hidden"),document.body.style.overflow=""}function me(e){const a=document.getElementById("cover-picker"),n=document.getElementById("cover-strip");if(!(!a||!n)){if(!e.length){a.style.display="none";return}a.style.display="",n.innerHTML=e.map(t=>`
    <div class="cover-thumb-wrap${t===F?" selected":""}" data-url="${t}">
      <img src="${t}" class="cover-thumb" alt="">
      <span class="cover-star">★</span>
    </div>`).join(""),n.querySelectorAll(".cover-thumb-wrap").forEach(t=>{t.addEventListener("click",()=>{F=t.dataset.url,n.querySelectorAll(".cover-thumb-wrap").forEach(s=>s.classList.remove("selected")),t.classList.add("selected")})})}}function ye(){const e=document.getElementById("property-form");if(!e)return;const a=document.getElementById("form-submit-btn");e.addEventListener("submit",async n=>{n.preventDefault();const t=new FormData(e),s=t.getAll("images");let o=[];const r=s.filter(i=>i.size>0);if(r.length){a.disabled=!0,a.textContent=`Enviando 0/${r.length} foto…`;try{o=await dt(r,(i,d)=>{a.textContent=`Enviando ${i}/${d} foto…`})}catch(i){console.error("Erro no upload:",i),a.disabled=!1,a.textContent=N?"Salvar Alterações":"Salvar Imóvel",alert(`Erro ao enviar fotos.
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(N){const i=L.find(d=>d.id===N);i!=null&&i.images&&(o=i.images)}o.length||(o=[...D]);const l={...N?{id:N}:{},title:t.get("title"),rua:t.get("rua")||"",numero:t.get("numero")||"",city:t.get("city"),neighborhood:t.get("neighborhood"),price:t.get("price"),bedrooms:parseInt(t.get("bedrooms"),10)||0,suites:parseInt(t.get("suites"),10)||0,area:parseFloat(t.get("area"))||0,parking:parseInt(t.get("parking"),10)||0,published:t.get("published")==="true",images:o,description:t.get("description")||"",owner_name:t.get("owner_name")||"",owner_phone:t.get("owner_phone")||"",owner_email:t.get("owner_email")||"",owner_notes:t.get("owner_notes")||"",cover_image:F||"",construction_status:t.get("construction_status")||"",condominium:t.get("condominium")||""};try{await it(l),N=null,a.disabled=!1,a.textContent="Salvar Imóvel",e.reset();const i=document.getElementById("adminPublished");i&&(i.value="true");const d=document.getElementById("adminNeighborhood");d&&(d.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),F="",me([]),le(),await de()}catch(i){console.error(i),a.disabled=!1,a.textContent=N?"Salvar Alterações":"Salvar Imóvel",alert("Erro ao salvar imóvel. Verifique o console.")}}),document.addEventListener("click",async n=>{var t;if(n.target.matches(".del-btn")){const s=Number(n.target.dataset.id);if(!s||!confirm("Remover este imóvel?"))return;try{await rt(s),await de()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((E==null?void 0:E.role)!=="admin")return;const s=Number(n.target.dataset.id);if(!s)return;const o=L.find(i=>i.id===s);if(!o)return;N=s,a.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=o.title||"",e.querySelector('[name="rua"]').value=o.rua||"",e.querySelector('[name="numero"]').value=o.numero||"",e.querySelector('[name="city"]').value=o.city||"",e.querySelector('[name="price"]').value=o.price||"",e.querySelector('[name="bedrooms"]').value=o.bedrooms||"",e.querySelector('[name="suites"]').value=o.suites||"",e.querySelector('[name="area"]').value=o.area||"",e.querySelector('[name="parking"]').value=o.parking||"",e.querySelector('[name="description"]').value=o.description||"",e.querySelector('[name="construction_status"]').value=o.construction_status||"",e.querySelector('[name="owner_name"]').value=o.owner_name||"",e.querySelector('[name="owner_phone"]').value=o.owner_phone||"",e.querySelector('[name="owner_email"]').value=o.owner_email||"",e.querySelector('[name="owner_notes"]').value=o.owner_notes||"",e.querySelector('[name="condominium"]').value=o.condominium||"";const r=document.getElementById("adminPublished");r&&(r.value=o.published===!0?"true":"false");const l=document.getElementById("adminCitySelect");l&&(l.value=o.city||"",l.dispatchEvent(new Event("change")),setTimeout(()=>{const i=document.getElementById("adminNeighborhood");i&&(i.value=o.neighborhood||"")},50)),F=o.cover_image||((t=o.images)==null?void 0:t[0])||"",me(o.images||[]),be("Editar Imóvel")}})}function b(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let U=[],P=0;function ft(e){var m,u;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const a=document.getElementById("view-status-badge");e.published?(a.textContent="● Publicado",a.className="badge badge-green"):(a.textContent="○ Rascunho",a.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const t=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=t,document.getElementById("view-directions-link").href=t;const s=((m=e.images)==null?void 0:m[0])||D[0];document.getElementById("view-thumb-preview").src=s,U=(u=e.images)!=null&&u.length?e.images:D,P=0,ue(),document.getElementById("view-price").textContent=Z(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const o=document.getElementById("view-condominium-item"),r=document.getElementById("view-condominium");r&&(r.textContent=e.condominium||""),o&&(o.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(c=>c.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(c=>c.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const l="https://omarcorretor.com.br/property.html?id="+e.id,i=document.getElementById("share-link-input");i&&(i.value=l);const d=document.getElementById("share-panel");d&&(d.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function se(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function ue(){const e=document.getElementById("view-main-img"),a=document.getElementById("view-counter"),n=document.getElementById("view-prev"),t=document.getElementById("view-next"),s=document.getElementById("view-thumbs");e.src=U[P],e.alt=`Foto ${P+1}`;const o=U.length>1;n.style.display=o?"flex":"none",t.style.display=o?"flex":"none",a.textContent=o?`${P+1} / ${U.length}`:"",s.innerHTML=o?U.map((r,l)=>`<img src="${r}" class="view-thumb${l===P?" active":""}" data-i="${l}" alt="Foto ${l+1}">`).join(""):"",s.querySelectorAll(".view-thumb").forEach(r=>{r.addEventListener("click",()=>{P=+r.dataset.i,ue()})})}async function qe(e){const{data:a}=await v.from("profiles").select("*").eq("id",e).maybeSingle();return a}function he(e){var r;const a=document.getElementById("sidebar-avatar"),n=document.getElementById("sidebar-avatar-initial"),t=document.getElementById("sidebar-name"),s=document.getElementById("sidebar-role");if(!t)return;const o=(e==null?void 0:e.name)||"Sem nome";t.textContent=o,s.textContent=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor",n&&(n.textContent=((r=o[0])==null?void 0:r.toUpperCase())||"?"),a&&(e!=null&&e.avatar_url)&&(a.src=e.avatar_url,a.style.display="",n&&(n.style.display="none"))}function Ae(e){const a=document.getElementById("admin-root");if(a&&(a.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(t=>{t.style.display=""}),Object.entries({empresa:It,visual:xt,"site-config":Bt,"crm-config":St,integracoes:Lt,midia:kt}).forEach(([t,s])=>{const o=document.querySelector(`.nav-item[data-section="${t}"]`);o&&o.addEventListener("click",()=>s(),{once:!0})})),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(t=>{t.style.display=""});const n=document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>$t(),{once:!0})}}function yt(){const e=document.getElementById("sidebar-user");e&&e.addEventListener("click",()=>{var t,s;document.querySelectorAll(".nav-item").forEach(o=>o.classList.remove("active"));const a=document.querySelector('.nav-item[data-section="settings"]');a&&a.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden"));const n=document.getElementById("section-settings");n&&n.classList.remove("hidden"),(t=document.getElementById("admin-sidebar"))==null||t.classList.remove("open"),(s=document.getElementById("sidebar-overlay"))==null||s.classList.remove("active")})}const bt="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function Ee(e){return(await fetch(bt,{method:"POST",headers:{Authorization:`Bearer ${at}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Te(e){var i,d,m,u;const a=document.getElementById("settings-name"),n=document.getElementById("settings-email"),t=document.getElementById("settings-avatar-preview"),s=document.getElementById("settings-avatar-initial"),o=document.getElementById("settings-avatar-input"),r=document.getElementById("settings-save-profile");if(!a)return;if(a.value=(e==null?void 0:e.name)||"",n){const{data:{user:c}}=await v.auth.getUser();n.value=(c==null?void 0:c.email)||""}const l=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(s&&(s.textContent=l),e!=null&&e.avatar_url&&t&&(t.src=e.avatar_url,t.style.display="",s&&(s.style.display="none")),o==null||o.addEventListener("change",c=>{const f=c.target.files[0];if(!f)return;const p=URL.createObjectURL(f);t&&(t.src=p,t.style.display=""),s&&(s.style.display="none")}),(i=document.getElementById("btn-change-password"))==null||i.addEventListener("click",async()=>{var g,h;const c=((g=document.getElementById("change-password-new"))==null?void 0:g.value)||"",f=((h=document.getElementById("change-password-confirm"))==null?void 0:h.value)||"",p=document.getElementById("change-password-msg"),y=document.getElementById("btn-change-password");if(p&&(p.style.display="none"),c.length<6){p&&(p.textContent="Mínimo 6 caracteres.",p.style.display="");return}if(c!==f){p&&(p.textContent="As senhas não coincidem.",p.style.display="");return}y&&(y.disabled=!0,y.textContent="Salvando…");const{error:w}=await v.auth.updateUser({password:c});y&&(y.disabled=!1,y.textContent="Salvar Nova Senha"),w?p&&(p.textContent="Erro: "+w.message,p.style.display=""):(p&&(p.style.color="#16a34a",p.textContent="Senha alterada com sucesso!",p.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),r==null||r.addEventListener("click",async()=>{var h;const c=a.value.trim();let f=(E==null?void 0:E.avatar_url)||"";const p=o==null?void 0:o.files[0],y=r.textContent;if(r.disabled=!0,r.textContent="Salvando…",p)try{const B=await xe(p,400,.85),k=`avatars/${E.id}-${Date.now()}.jpg`,{error:C}=await v.storage.from("imoveis").upload(k,B,{contentType:"image/jpeg",upsert:!0});if(!C){const{data:{publicUrl:H}}=v.storage.from("imoveis").getPublicUrl(k);f=H}}catch(B){console.error("Avatar upload:",B)}const{error:w}=await v.from("profiles").update({name:c,avatar_url:f}).eq("id",E.id);if(r.disabled=!1,r.textContent=y,w){alert("Erro ao salvar perfil.");return}E={...E,name:c,avatar_url:f},he(E);const g=document.getElementById("settings-avatar-initial");g&&(g.textContent=((h=c[0])==null?void 0:h.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"){const c=document.getElementById("settings-corretores-section");c&&(c.style.display=""),await pe(),(d=document.getElementById("btn-invite-corretor"))==null||d.addEventListener("click",async()=>{var g,h;const p=(g=document.getElementById("invite-email"))==null?void 0:g.value.trim(),y=(h=document.getElementById("invite-password"))==null?void 0:h.value.trim(),w=document.getElementById("btn-invite-corretor");if(!p){alert("Informe o e-mail do corretor.");return}if(!y||y.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}w&&(w.disabled=!0,w.textContent="Criando…");try{const B=await Ee({email:p,password:y});if(B.success){alert("Acesso criado! O corretor receberá um e-mail com o login e a senha que você definiu.");const k=document.getElementById("invite-email"),C=document.getElementById("invite-password");k&&(k.value=""),C&&(C.value=""),await pe()}else alert("Erro: "+(B.error||"Falha desconhecida"))}catch(B){alert("Erro ao criar acesso: "+B.message)}finally{w&&(w.disabled=!1,w.textContent="+ Criar Acesso")}});const f=document.getElementById("settings-locations-section");f&&(f.style.display=""),await W(),(m=document.getElementById("loc-add-city-btn"))==null||m.addEventListener("click",async()=>{const p=document.getElementById("loc-new-city"),y=p==null?void 0:p.value.trim();if(!y)return;const{error:w}=await v.from("locations").insert({type:"cidade",name:y});if(w){alert("Erro ao adicionar cidade.");return}p&&(p.value=""),await W(),Le()}),(u=document.getElementById("loc-add-neighborhood-btn"))==null||u.addEventListener("click",async()=>{var h;const p=parseInt((h=document.getElementById("loc-new-neighborhood-city"))==null?void 0:h.value,10),y=document.getElementById("loc-new-neighborhood"),w=y==null?void 0:y.value.trim();if(!p||!w){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:g}=await v.from("locations").insert({type:"bairro",name:w,parent_id:p});if(g){alert("Erro ao adicionar bairro.");return}y&&(y.value=""),await W()})}}async function pe(){const e=document.getElementById("corretores-list");if(!e)return;const{data:a,error:n}=await v.from("profiles").select("*").order("created_at");if(n||!a){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=a.map(t=>{const s=(t.name||"?")[0].toUpperCase(),o=t.avatar_url?`<img src="${t.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${b(s)}</div>`,r=t.id===(E==null?void 0:E.id),l=t.active!==!1,i=l?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',d=r?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${t.id}" style="width:110px;padding:6px 8px;font-size:13px">
    ...
    </div>`}).join(""),e.querySelectorAll(".corretor-role-sel").forEach(t=>{t.addEventListener("change",async()=>{await v.from("profiles").update({role:t.value}).eq("id",t.dataset.uid)})}),e.querySelectorAll(".corretor-toggle-btn").forEach(t=>{t.addEventListener("click",async()=>{const s=t.dataset.uid,o=t.dataset.active==="true";t.disabled=!0,t.textContent="Aguarde…";try{const r=await Ee({action:"toggle",userId:s,active:!o});r.success||alert("Erro: "+(r.error||"Falha desconhecida"))}catch(r){alert("Erro: "+r.message)}await pe()})}),e.querySelectorAll(".corretor-del-btn").forEach(t=>{t.addEventListener("click",async()=>{var r,l;const s=t.dataset.uid,o=((l=(r=t.closest(".corretor-item"))==null?void 0:r.querySelector(".corretor-name"))==null?void 0:l.textContent)||"este corretor";if(confirm(`Excluir "${o}"? Esta ação não pode ser desfeita.`)){t.disabled=!0;try{const i=await Ee({action:"delete",userId:s});i.success||alert("Erro ao excluir: "+(i.error||"Falha desconhecida"))}catch(i){alert("Erro: "+i.message)}await pe()}})})}async function He(){const{data:e,error:a}=await v.from("locations").select("*").order("name");return a?(console.error("loadLocations:",a),[]):(Q=e||[],Q)}function O(){return Q.filter(e=>e.type==="cidade")}function Se(e){return Q.filter(a=>a.type==="bairro"&&a.parent_id===e)}function Le(){const e=document.getElementById("adminCitySelect");if(!e)return;const a=e.value,n=O();e.innerHTML='<option value="">Selecione</option>'+n.map(t=>`<option value="${t.name}">${b(t.name)}</option>`).join(""),a&&(e.value=a)}async function W(){await He();const e=O(),a=document.getElementById("loc-cities-list"),n=document.getElementById("loc-neighborhoods-list"),t=document.getElementById("loc-new-neighborhood-city");if(!a||!n)return;a.innerHTML=e.length?e.map(o=>`
        <div class="loc-item">
          <span class="loc-item-name">${b(o.name)}</span>
          <button class="loc-del-btn" data-id="${o.id}" title="Excluir">✕</button>
        </div>`).join(""):'<p class="loc-empty">Nenhuma cidade cadastrada.</p>';const s=Q.filter(o=>o.type==="bairro");n.innerHTML=s.length?s.map(o=>{const r=e.find(l=>l.id===o.parent_id);return`
          <div class="loc-item">
            <div>
            ...
            <button class="loc-del-btn" data-id="${o.id}" title="Excluir">✕</button>
          </div>`}).join(""):'<p class="loc-empty">Nenhum bairro cadastrado.</p>',t&&(t.innerHTML='<option value="">Cidade…</option>'+e.map(o=>`<option value="${o.id}">${b(o.name)}</option>`).join("")),a.querySelectorAll(".loc-del-btn").forEach(o=>{o.addEventListener("click",async()=>{const r=o.closest(".loc-item").querySelector(".loc-item-name").textContent;if(!confirm(`Excluir "${r}" e todos os bairros vinculados?`))return;const{error:l}=await v.from("locations").delete().eq("id",o.dataset.id);if(l){alert("Erro ao excluir.");return}await W(),Le()})}),n.querySelectorAll(".loc-del-btn").forEach(o=>{o.addEventListener("click",async()=>{if(!confirm("Excluir este bairro?"))return;const{error:r}=await v.from("locations").delete().eq("id",o.dataset.id);if(r){alert("Erro ao excluir.");return}await W()})})}function Me(){var s,o,r,l,i,d,m,u,c,f,p,y,w,g,h,B,k,C,H,$e;document.querySelectorAll(".filter-btn").forEach(S=>{S.addEventListener("click",()=>{const I=S.closest(".filter-btns"),x=S.classList.contains("active");I.querySelectorAll(".filter-btn").forEach($=>$.classList.remove("active")),x||S.classList.add("active")})}),(s=document.getElementById("f-city"))==null||s.addEventListener("change",()=>{var _;const S=(_=document.getElementById("f-city"))==null?void 0:_.value,I=O().find(M=>M.name===S),x=I?Se(I.id):[],$=document.getElementById("f-neighborhood");$&&($.innerHTML='<option value="">Todos</option>'+x.map(M=>`<option value="${M.name}">${b(M.name)}</option>`).join(""))}),(o=document.getElementById("f-search-btn"))==null||o.addEventListener("click",()=>{te(Be(L))}),(r=document.getElementById("f-clear-btn"))==null||r.addEventListener("click",()=>{["f-title","f-condominium","f-price-min","f-price-max","f-area-min","f-area-max"].forEach($=>{const _=document.getElementById($);_&&(_.value="")}),["f-type","f-city","f-construction","f-published"].forEach($=>{const _=document.getElementById($);_&&(_.value="")});const x=document.getElementById("f-neighborhood");x&&(x.innerHTML='<option value="">Todos</option>'),document.querySelectorAll(".filter-btn.active").forEach($=>$.classList.remove("active")),te(L)}),document.querySelectorAll(".nav-item[data-section]").forEach(S=>{S.addEventListener("click",()=>{var x,$;document.querySelectorAll(".nav-item").forEach(_=>_.classList.remove("active")),S.classList.add("active"),document.querySelectorAll(".admin-section").forEach(_=>_.classList.add("hidden")),(x=document.getElementById(`section-${S.dataset.section}`))==null||x.classList.remove("hidden"),S.dataset.section==="funil"&&!(($=document.getElementById("section-funil"))!=null&&$.dataset.loaded)&&Tt(),window.lucide&&lucide.createIcons()})});const e=document.getElementById("admin-sidebar"),a=document.getElementById("sidebar-overlay"),n=document.getElementById("sidebar-toggle"),t=()=>{e==null||e.classList.remove("open"),a==null||a.classList.remove("open")};n==null||n.addEventListener("click",()=>{e==null||e.classList.toggle("open"),a==null||a.classList.toggle("open")}),a==null||a.addEventListener("click",t),(l=document.getElementById("modal-close"))==null||l.addEventListener("click",le),(i=document.getElementById("modal-cancel"))==null||i.addEventListener("click",le),(d=document.getElementById("property-modal"))==null||d.addEventListener("click",S=>{S.target.id==="property-modal"&&le()}),(m=document.getElementById("btn-new-property"))==null||m.addEventListener("click",()=>{N=null,document.getElementById("property-form").reset(),document.getElementById("adminPublished").value="true",document.getElementById("adminNeighborhood").innerHTML='<option value="">Selecione a cidade primeiro</option>',document.getElementById("form-submit-btn").textContent="Salvar Imóvel",F="",me([]),be("Novo Imóvel")}),(u=document.getElementById("logout-btn"))==null||u.addEventListener("click",async()=>{await v.auth.signOut(),location.reload()}),(c=document.getElementById("view-prev"))==null||c.addEventListener("click",()=>{P=(P-1+U.length)%U.length,ue()}),(f=document.getElementById("view-next"))==null||f.addEventListener("click",()=>{P=(P+1)%U.length,ue()}),(p=document.getElementById("view-modal-close"))==null||p.addEventListener("click",se),(y=document.getElementById("view-modal-close2"))==null||y.addEventListener("click",se),(w=document.getElementById("view-modal"))==null||w.addEventListener("click",S=>{S.target.id==="view-modal"&&se()}),(g=document.getElementById("view-modal-share"))==null||g.addEventListener("click",()=>{const S=document.getElementById("share-panel");if(!S)return;const I=S.style.display!=="none";S.style.display=I?"none":"block"}),(h=document.getElementById("share-whatsapp"))==null||h.addEventListener("click",()=>{var $,_;const S=($=document.getElementById("share-link-input"))==null?void 0:$.value;if(!S)return;const I=((_=document.getElementById("view-modal-title"))==null?void 0:_.textContent)||"Imóvel",x=encodeURIComponent("Olha esse imóvel que encontrei: "+I+`
`+S);window.open("https://wa.me/?text="+x,"_blank")}),(B=document.getElementById("share-instagram"))==null||B.addEventListener("click",()=>{var I,x;const S=(I=document.getElementById("share-link-input"))==null?void 0:I.value;S&&((x=navigator.clipboard)==null||x.writeText(S),alert("Link copiado! Cole na bio ou nos Stories do Instagram."))}),(k=document.getElementById("share-email"))==null||k.addEventListener("click",()=>{var _,M;const S=(_=document.getElementById("share-link-input"))==null?void 0:_.value;if(!S)return;const I=((M=document.getElementById("view-modal-title"))==null?void 0:M.textContent)||"Imóvel",x=encodeURIComponent("Imóvel: "+I),$=encodeURIComponent(`Olá! Segue o link do imóvel:

`+S);window.open("mailto:?subject="+x+"&body="+$,"_blank")}),(C=document.getElementById("share-copy"))==null||C.addEventListener("click",()=>{var I;const S=document.getElementById("share-link-input");S&&((I=navigator.clipboard)==null||I.writeText(S.value).then(()=>{const x=document.getElementById("share-copy"),$=x.textContent;x.textContent="✅ Copiado!",setTimeout(()=>{x.textContent=$},2e3)}))}),(H=document.getElementById("view-modal-edit"))==null||H.addEventListener("click",()=>{var _e;if((E==null?void 0:E.role)!=="admin")return;const S=document.getElementById("view-modal-title").textContent,I=L.find(ne=>ne.title===S);if(!I)return;se(),N=I.id;const x=document.getElementById("property-form"),$=document.getElementById("form-submit-btn");$.textContent="Salvar Alterações",x.querySelector('[name="title"]').value=I.title||"",x.querySelector('[name="rua"]').value=I.rua||"",x.querySelector('[name="numero"]').value=I.numero||"",x.querySelector('[name="city"]').value=I.city||"",x.querySelector('[name="price"]').value=I.price||"",x.querySelector('[name="bedrooms"]').value=I.bedrooms||"",x.querySelector('[name="suites"]').value=I.suites||"",x.querySelector('[name="parking"]').value=I.parking||"",x.querySelector('[name="description"]').value=I.description||"",x.querySelector('[name="construction_status"]').value=I.construction_status||"",x.querySelector('[name="owner_name"]').value=I.owner_name||"",x.querySelector('[name="owner_phone"]').value=I.owner_phone||"",x.querySelector('[name="owner_email"]').value=I.owner_email||"",x.querySelector('[name="owner_notes"]').value=I.owner_notes||"",x.querySelector('[name="condominium"]').value=I.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=I.published===!0?"true":"false");const M=document.getElementById("adminCitySelect");M&&(M.value=I.city||"",M.dispatchEvent(new Event("change")),setTimeout(()=>{const ne=document.getElementById("adminNeighborhood");ne&&(ne.value=I.neighborhood||"")},50)),F=I.cover_image||((_e=I.images)==null?void 0:_e[0])||"",me(I.images||[]),be("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(S=>{S.addEventListener("click",()=>{var I;document.querySelectorAll(".tab-btn").forEach(x=>x.classList.remove("active")),S.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(x=>x.classList.add("hidden")),(I=document.getElementById(`tab-${S.dataset.tab}`))==null||I.classList.remove("hidden")})}),($e=document.getElementById("admin-properties"))==null||$e.addEventListener("click",S=>{if(S.target.closest(".action-btns"))return;const I=S.target.closest("tr");if(!I)return;const x=Number(I.dataset.id);if(!x)return;const $=L.find(_=>_.id===x);$&&ft($)})}document.addEventListener("DOMContentLoaded",async()=>{var o,r,l;await Promise.all([Fe(),He()]),X=T("company.whatsapp",X),K=`https://wa.me/${X}`,Ie(),ut(),pt();const e=document.getElementById("adminCitySelect"),a=document.getElementById("adminNeighborhood");e&&a&&(Le(),e.addEventListener("change",()=>{const i=O().find(m=>m.name===e.value),d=i?Se(i.id):[];a.innerHTML='<option value="">Selecione a cidade primeiro</option>'+d.map(m=>`<option value="${m.name}">${b(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),t=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),d=new URLSearchParams(window.location.search),m=i.get("type")||d.get("type")||"",u=Ue||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||d.has("code"),c=document.getElementById("password-reset-overlay");if(u){n.style.display="none",t&&t.classList.add("hidden"),c&&(c.style.display="flex"),(o=document.getElementById("password-reset-form"))==null||o.addEventListener("submit",async p=>{var k,C;p.preventDefault();const y=((k=document.getElementById("new-password"))==null?void 0:k.value)||"",w=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",g=document.getElementById("password-reset-msg"),h=p.target.querySelector('button[type="submit"]');if(g&&(g.style.display="none"),y!==w){g&&(g.textContent="As senhas não coincidem.",g.style.display="");return}h&&(h.disabled=!0,h.textContent="Salvando…");const{error:B}=await v.auth.updateUser({password:y});if(B){g&&(g.textContent="Erro: "+B.message,g.style.display=""),h&&(h.disabled=!1,h.textContent="Definir Senha");return}window.location.href=window.location.pathname}),d.has("code")&&await v.auth.exchangeCodeForSession(d.get("code")??"");return}const{data:{session:f}}=await v.auth.getSession();if(f){if(n.classList.add("hidden"),t&&t.classList.remove("hidden"),await de(),ye(),Me(),yt(),E=await qe(f.user.id),!E){await v.auth.signOut(),n.classList.remove("hidden"),t&&t.classList.add("hidden");return}if(E.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),t&&t.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(E.needs_password_reset){n.style.display="none",t&&t.classList.add("hidden");const p=document.getElementById("password-reset-overlay");p&&(p.style.display="flex"),(r=document.getElementById("password-reset-form"))==null||r.addEventListener("submit",async y=>{var C,H;y.preventDefault();const w=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",g=((H=document.getElementById("confirm-password"))==null?void 0:H.value)||"",h=document.getElementById("password-reset-msg"),B=y.target.querySelector('button[type="submit"]');if(h&&(h.style.display="none"),w!==g){h&&(h.textContent="As senhas não coincidem.",h.style.display="");return}if(w.length<6){h&&(h.textContent="Mínimo 6 caracteres.",h.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:k}=await v.auth.updateUser({password:w});if(k){h&&(h.textContent="Erro: "+k.message,h.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}await v.from("profiles").update({needs_password_reset:!1}).eq("id",E.id),window.location.href=window.location.pathname});return}he(E),Ae(E.role),await Te(E)}else{t&&t.classList.add("hidden"),n.classList.remove("hidden");const p=document.getElementById("login-form");p&&((l=document.getElementById("forgot-password-btn"))==null||l.addEventListener("click",async()=>{var g,h;const y=(h=(g=p.querySelector('input[name="email"]'))==null?void 0:g.value)==null?void 0:h.trim();if(!y){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:w}=await v.auth.resetPasswordForEmail(y,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(w?"Erro: "+w.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),p.addEventListener("submit",async y=>{y.preventDefault();const w=new FormData(p),g=w.get("email"),h=w.get("password");if(await lt(g,h)){n.classList.add("hidden"),t&&t.classList.remove("hidden"),await de(),ye(),Me();const{data:{session:k}}=await v.auth.getSession();if(E=k?await qe(k.user.id):null,!E){await v.auth.signOut();return}if(E.active===!1){await v.auth.signOut(),n.classList.remove("hidden"),t&&t.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}he(E),Ae(E.role),await Te(E)}else alert("E-mail ou senha incorretos")}))}}else ye();await ee();const s=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();Oe(s),ze(X),new URLSearchParams(location.search).get("edit")==="1"&&Xe()});async function ht(){const e=L.filter(s=>!s.reference);if(!e.length)return;const a=L.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10));let n=a.length?Math.max(...a)+1:1;const t=[...e].sort((s,o)=>s.id-o.id);for(const s of t){const o="IO-"+String(n).padStart(4,"0"),{error:r}=await v.from("properties").update({reference:o}).eq("id",s.id);if(!r){const l=L.findIndex(i=>i.id===s.id);l>=0&&(L[l].reference=o),n++}}te(Be(L))}async function Et(){const e=L.filter(a=>{var n;return(n=a.images)==null?void 0:n.some(t=>!t.includes("/wm-"))});if(e.length){for(const a of e){if(!a.images.some(o=>!o.includes("/wm-")))continue;const t=[];let s=!1;for(const o of a.images)if(o.includes("/wm-"))t.push(o);else try{const r=await wt(o);t.push(r),s=!0}catch{t.push(o)}if(s){await v.from("properties").update({images:t}).eq("id",a.id);const o=L.findIndex(r=>r.id===a.id);o>=0&&(L[o].images=t)}}te(Be(L))}}async function wt(e){try{const a=await fetch(e);if(!a.ok)return e;const n=await a.blob(),t=URL.createObjectURL(n),s=await fetch("/logo.png"),o=s.ok?await s.blob():null,r=o?URL.createObjectURL(o):null;return new Promise(l=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(t);const d=document.createElement("canvas"),m=1200;let u=i.width,c=i.height;u>m&&(c=Math.round(c*m/u),u=m),d.width=u,d.height=c;const f=d.getContext("2d");f.drawImage(i,0,0,u,c);const p=y=>{if(y){const w=Math.round(u*.18),g=Math.round(y.naturalHeight*w/y.naturalWidth),h=Math.round(u*.02);f.globalAlpha=.45,f.drawImage(y,u-w-h,c-g-h,w,g),f.globalAlpha=1}d.toBlob(async w=>{try{const g=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:h}=await v.storage.from("imoveis").upload(g,w,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(h){console.error("Upload watermark error:",h),l(e);return}const{data:{publicUrl:B}}=v.storage.from("imoveis").getPublicUrl(g);l(B)}catch(g){console.error("Watermark upload exception:",g),l(e)}},"image/jpeg",.82)};if(r){const y=new Image;y.onload=()=>{URL.revokeObjectURL(r),p(y)},y.onerror=()=>{URL.revokeObjectURL(r),p(null)},y.src=r}else p(null)},i.onerror=()=>{URL.revokeObjectURL(t),l(e)},i.src=t})}catch(a){return console.error("applyWatermarkToUrl error:",a),e}}function A(e,a){e&&(e.textContent=a?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(a?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function ke(e,a="assets"){const n=await xe(e,1200,.85),t=`${a}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:s}=await v.storage.from("imoveis").upload(t,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(s)throw s;const{data:{publicUrl:o}}=v.storage.from("imoveis").getPublicUrl(t);return o}async function It(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:a}=await v.from("settings").select("key,value"),n={};a==null||a.forEach(s=>{n[s.key]=s.value||""});const t=s=>b(String(n[s]||""));e.innerHTML=`
  ...
  `,document.getElementById("co-logo-url").addEventListener("input",s=>{document.getElementById("co-logo-preview").src=s.target.value||"/logo.png"}),document.getElementById("co-logo-file").addEventListener("change",async s=>{const o=s.target.files[0];if(o)try{const r=await ke(o,"logos");document.getElementById("co-logo-url").value=r,document.getElementById("co-logo-preview").src=r}catch(r){alert("Erro no upload: "+r.message)}}),document.getElementById("co-save-identity").addEventListener("click",async()=>{const s=document.getElementById("co-save-identity");s.disabled=!0,s.textContent="Salvando…";const o=await V([["company.name",document.getElementById("co-name").value.trim()],["company.creci",document.getElementById("co-creci").value.trim()],["company.logo_url",document.getElementById("co-logo-url").value.trim()],["company.favicon_url",document.getElementById("co-favicon-url").value.trim()]]);o&&Ie(),s.disabled=!1,s.textContent="Salvar Identidade",A(document.getElementById("co-identity-msg"),o)}),document.getElementById("co-save-contacts").addEventListener("click",async()=>{const s=document.getElementById("co-save-contacts");s.disabled=!0,s.textContent="Salvando…";const o=document.getElementById("co-whatsapp").value.trim(),r=await V([["company.whatsapp",o],["company.phone",document.getElementById("co-phone").value.trim()],["company.email",document.getElementById("co-email").value.trim()],["company.address",document.getElementById("co-address").value.trim()]]);r&&o&&(X=o,K=`https://wa.me/${o}`),s.disabled=!1,s.textContent="Salvar Contatos",A(document.getElementById("co-contacts-msg"),r)}),document.getElementById("co-save-social").addEventListener("click",async()=>{const s=document.getElementById("co-save-social");s.disabled=!0,s.textContent="Salvando…";const o=await V([["company.instagram_url",document.getElementById("co-instagram").value.trim()],["company.facebook_url",document.getElementById("co-facebook").value.trim()],["company.youtube_url",document.getElementById("co-youtube").value.trim()],["company.tiktok_url",document.getElementById("co-tiktok").value.trim()],["company.linkedin_url",document.getElementById("co-linkedin").value.trim()]]);s.disabled=!1,s.textContent="Salvar Redes Sociais",A(document.getElementById("co-social-msg"),o)})}async function xt(){const e=document.getElementById("section-visual");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:a}=await v.from("settings").select("key,value"),n={};a==null||a.forEach(m=>{n[m.key]=m.value||""});const t=n["visual.accent_color"]||"#b8962e",s=n["visual.primary_bg"]||"#0f1c2e",o=n["visual.secondary_bg"]||"#1a2f4a",r=n["visual.hero_bg_url"]||"",l=n["visual.price_max_slider"]||13e7;e.innerHTML=`
    <div class="section-topbar">
  ...
  `,await we(),document.getElementById("media-file-input").addEventListener("change",async n=>{var i,d;const t=Array.from(n.target.files);if(!t.length)return;const s=document.getElementById("media-upload-progress"),o=document.getElementById("media-progress-fill"),r=document.getElementById("media-progress-text");s.style.display="";let l=0;for(const m of t){r.textContent=`Enviando ${l+1}/${t.length}…`,o.style.width=`${Math.round(l/t.length*100)}%`;try{const u=await ke(m,"media"),c=m.name.replace(/\.[^.]+$/,"").slice(0,60);await v.from("media_library").insert({name:c,url:u,type:"image",size:m.size,created_by:(d=(i=(await v.auth.getUser()).data)==null?void 0:i.user)==null?void 0:d.id})}catch(u){console.error("Media upload error:",u)}l++}o.style.width="100%",r.textContent=`✓ ${l} arquivo(s) enviado(s)`,setTimeout(()=>{s.style.display="none",o.style.width="0"},2e3),await we(),n.target.value=""});const a=document.getElementById("media-drop-area");a.addEventListener("dragover",n=>{n.preventDefault(),a.classList.add("drag-over")}),a.addEventListener("dragleave",()=>a.classList.remove("drag-over")),a.addEventListener("drop",n=>{n.preventDefault(),a.classList.remove("drag-over"),document.getElementById("media-file-input").files=n.dataTransfer.files,document.getElementById("media-file-input").dispatchEvent(new Event("change"))})}async function we(){const e=document.getElementById("media-grid");if(!e)return;const{data:a,error:n}=await v.from("media_library").select("*").order("created_at",{ascending:!1}).limit(100);if(n||!(a!=null&&a.length)){e.innerHTML='<div class="media-empty">Nenhuma imagem enviada ainda.</div>';return}e.innerHTML=a.map(t=>`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(d=>d.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(d=>d.classList.add("hidden")),l.classList.add("active");const i=e.querySelector(`#sa-panel-${l.dataset.tab}`);i&&i.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&J(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&_t(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ne(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&Pe(),l.dataset.tab==="platform"&&Re()})}),(a=e.querySelector("#sa-edit-site-btn"))==null||a.addEventListener("click",()=>{window.open(location.origin+"/?edit=1","_blank")}),(n=e.querySelector("#sa-sub-filter"))==null||n.addEventListener("change",Ne),(t=e.querySelector("#sa-tenant-search"))==null||t.addEventListener("input",J),(s=e.querySelector("#sa-user-search"))==null||s.addEventListener("input",Pe),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>Rt()),(r=e.querySelector("#sa-plat-save"))==null||r.addEventListener("click",Ct),J(),Re())}async function J(){var l,i;const e=document.getElementById("sa-tenants-list"),a=((i=(l=document.getElementById("sa-tenant-search"))==null?void 0:l.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=v.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:t,error:s}=await n;if(s){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${s.message}</div>`;return}const o=(t||[]).filter(d=>{var m,u;return!a||((m=d.name)==null?void 0:m.toLowerCase().includes(a))||((u=d.slug)==null?void 0:u.toLowerCase().includes(a))});if(!o.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const r=d=>d.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=o.map(d=>{var m;return`
  ...
  `}).join(""),e.querySelectorAll('[data-action="toggle-tenant"]').forEach(d=>{d.addEventListener("click",async()=>{const m=d.dataset.active==="true";await v.from("tenants").update({active:!m}).eq("id",d.dataset.id),J()})})}async function _t(){const e=document.getElementById("sa-plans-list");if(!e)return;e.dataset.loaded="1";const{data:a,error:n}=await v.from("plans").select("*").order("price_brl");if(n){e.innerHTML=`<div class="sa-error">Erro: ${n.message}</div>`;return}e.innerHTML=(a||[]).map(t=>`
  ...
  `,await Mt(),Nt(),(a=document.getElementById("btn-novo-lead"))==null||a.addEventListener("click",()=>Pt()))}let q=[];async function Mt(){let e=v.from("leads").select("*, profiles(name)").order("created_at",{ascending:!1});(E==null?void 0:E.role)==="corretor"?e=e.eq("assigned_to",E.id):E!=null&&E.tenant_id&&(e=e.eq("tenant_id",E.tenant_id));const{data:a,error:n}=await e;n?(console.error("Kanban load error:",n),q=[]):q=a||[],ae(q)}function ae(e){const a=e.length,n=e.filter(l=>l.stage==="ganho").length,t=e.filter(l=>l.stage==="perdido").length,s=document.getElementById("kpi-total"),o=document.getElementById("kpi-ganhos"),r=document.getElementById("kpi-perdidos");s&&(s.textContent=a),o&&(o.textContent=n),r&&(r.textContent=t),je.forEach(l=>{const i=e.filter(u=>(u.stage||"novo")===l.key),d=document.getElementById(`count-${l.key}`),m=document.getElementById(`cards-${l.key}`);if(d&&(d.textContent=i.length),!!m){if(!i.length){m.innerHTML='<div class="kanban-empty">Sem leads</div>';return}m.innerHTML=i.map(u=>{var p;const c=((p=u.profiles)==null?void 0:p.name)||"",f=(E==null?void 0:E.role)==="admin"||(E==null?void 0:E.role)==="super_admin";return`
        <div class="kanban-card" draggable="true" data-id="${u.id}" data-stage="${u.stage||"novo"}">
          ...
          ${u.property_interest?`<div class="kanban-card-prop">🏠 ${b(u.property_interest)}</div>`:""}
          ${u.value?`<div class="kanban-card-value">${b(qt(u.value))}</div>`:""}
          <div class="kanban-card-meta">
            <span class="kanban-card-date">${At(u.created_at)}</span>
            ${c?`<span class="kanban-card-corretor">${b(c)}</span>`:""}
          </div>
        </div>
      `}).join(""),m.querySelectorAll(".kanban-card-delete").forEach(u=>{u.addEventListener("click",async c=>{c.stopPropagation();const f=u.dataset.id;if(!confirm("Remover este lead?"))return;const{error:p}=await v.from("leads").delete().eq("id",f);if(p){alert("Erro ao remover: "+p.message);return}q=q.filter(y=>String(y.id)!==String(f)),ae(q)})})}})}function Nt(){let e=null,a=null;const n=document.getElementById("kanban-board");n&&(n.addEventListener("dragstart",t=>{const s=t.target.closest(".kanban-card");s&&(e=s.dataset.id,a=s.dataset.stage,s.classList.add("dragging"),t.dataTransfer.effectAllowed="move")}),n.addEventListener("dragend",t=>{const s=t.target.closest(".kanban-card");s&&s.classList.remove("dragging"),document.querySelectorAll(".kanban-col").forEach(o=>o.classList.remove("drag-over"))}),n.addEventListener("dragover",t=>{t.preventDefault();const s=t.target.closest(".kanban-col");s&&(document.querySelectorAll(".kanban-col").forEach(o=>o.classList.remove("drag-over")),s.classList.add("drag-over"))}),n.addEventListener("dragleave",t=>{const s=t.target.closest(".kanban-col");s&&!s.contains(t.relatedTarget)&&s.classList.remove("drag-over")}),n.addEventListener("drop",async t=>{t.preventDefault(),document.querySelectorAll(".kanban-col").forEach(d=>d.classList.remove("drag-over"));const s=t.target.closest(".kanban-col");if(!s||!e)return;const o=s.dataset.stage;if(!o||o===a)return;const r=a,l=q.find(d=>String(d.id)===String(e));l&&(l.stage=o),ae(q);const{error:i}=await v.from("leads").update({stage:o}).eq("id",e);i?(console.error("Kanban update error:",i),l&&(l.stage=r),ae(q)):v.from("lead_activities").insert({lead_id:e,action:"moved",from_stage:r,to_stage:o,user_id:E==null?void 0:E.id}).then(()=>{}).catch(()=>{}),e=null,a=null}))}function Pt(e=null){var o,r,l;const a=document.getElementById("lead-modal-root");a&&a.remove();const n=!!e,t=document.createElement("div");t.id="lead-modal-root",t.className="lead-modal-backdrop",t.innerHTML=`
        ...
        <form id="lead-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <input name="value" type="number" min="0" class="form-control" placeholder="Ex: 850000" value="${b(String((e==null?void 0:e.value)||""))}">
            </div>
          </div>
          <div class="form-row single">
            <div class="form-group">
              <label class="form-label">Imóvel de Interesse</label>
              <input name="property_interest" class="form-control" placeholder="Ex: Apartamento 3 quartos…" value="${b((e==null?void 0:e.property_interest)||"")}">
            </div>
          </div>
          <div class="form-row single">
            <div class="form-group">
              <label class="form-label">Observações</label>
              <textarea name="notes" class="form-control" placeholder="Notas sobre o lead…">${b((e==null?void 0:e.notes)||"")}</textarea>
            </div>
          </div>
        </form>
      </div>
  ...
  `,document.body.appendChild(t);const s=()=>t.remove();(o=document.getElementById("lead-modal-close"))==null||o.addEventListener("click",s),(r=document.getElementById("lead-modal-cancel"))==null||r.addEventListener("click",s),t.addEventListener("click",i=>{i.target===t&&s()}),(l=document.getElementById("lead-modal-save"))==null||l.addEventListener("click",async()=>{var f,p,y,w,g;const i=document.getElementById("lead-form");if(!i.checkValidity()){i.reportValidity();return}const d=new FormData(i),m=document.getElementById("lead-modal-save");m.disabled=!0,m.textContent="Salvando…";const u={name:(f=d.get("name"))==null?void 0:f.trim(),email:((p=d.get("email"))==null?void 0:p.trim())||null,phone:((y=d.get("phone"))==null?void 0:y.trim())||null,value:parseFloat(d.get("value"))||null,property_interest:((w=d.get("property_interest"))==null?void 0:w.trim())||null,notes:((g=d.get("notes"))==null?void 0:g.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(E==null?void 0:E.id)||null,tenant_id:(E==null?void 0:E.tenant_id)||null};let c;if(n){if({error:c}=await v.from("leads").update(u).eq("id",e.id),!c){const h=q.findIndex(B=>B.id===e.id);h>=0&&(q[h]={...q[h],...u})}}else{const{data:h,error:B}=await v.from("leads").insert(u).select("*, profiles(name)");c=B,!c&&(h!=null&&h[0])&&q.unshift(h[0])}if(m.disabled=!1,m.textContent=n?"Salvar Alterações":"Criar Lead",c){alert("Erro ao salvar lead: "+c.message);return}s(),ae(q)})}function Rt(){var t,s,o,r,l;const e=document.getElementById("sa-new-tenant-modal");e&&e.remove();const a=document.createElement("div");a.id="sa-new-tenant-modal",a.className="sa-modal-backdrop",a.innerHTML=`
    <div class="sa-modal">
  ...
  `,document.body.appendChild(a),v.from("plans").select("id, name").then(({data:i})=>{const d=document.getElementById("nt-plan");d&&i&&(d.innerHTML=i.map(m=>`<option value="${m.id}">${b(m.name)}</option>`).join(""))}),(t=document.getElementById("nt-name"))==null||t.addEventListener("input",i=>{const d=document.getElementById("nt-slug");d&&!d.dataset.manual&&(d.value=i.target.value.toLowerCase().normalize("NFD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,""))}),(s=document.getElementById("nt-slug"))==null||s.addEventListener("input",i=>{i.target.dataset.manual="1"});const n=()=>a.remove();(o=document.getElementById("sa-modal-close-btn"))==null||o.addEventListener("click",n),(r=document.getElementById("nt-cancel"))==null||r.addEventListener("click",n),a.addEventListener("click",i=>{i.target===a&&n()}),(l=document.getElementById("nt-save"))==null||l.addEventListener("click",async()=>{var y,w,g,h,B,k,C;const i=(w=(y=document.getElementById("nt-name"))==null?void 0:y.value)==null?void 0:w.trim(),d=(h=(g=document.getElementById("nt-slug"))==null?void 0:g.value)==null?void 0:h.trim(),m=(k=(B=document.getElementById("nt-domain"))==null?void 0:B.value)==null?void 0:k.trim(),u=(C=document.getElementById("nt-plan"))==null?void 0:C.value,c=document.getElementById("nt-msg"),f=document.getElementById("nt-save");if(!i||!d){A(c,!1),c.textContent="Nome e slug são obrigatórios.";return}f&&(f.disabled=!0,f.textContent="Criando…");const{error:p}=await v.from("tenants").insert({name:i,slug:d,domain:m||null,plan_id:u||null,active:!0});if(f&&(f.disabled=!1,f.textContent="Criar Imobiliária"),p){A(c,!1),c.textContent=p.message;return}A(c,!0),setTimeout(()=>{n(),J()},800)})}
