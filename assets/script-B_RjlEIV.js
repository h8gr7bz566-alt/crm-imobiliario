import{s as f}from"./supabase-BcuJ3xoD.js";const at="00000000-0000-0000-0000-000000000000";let ue={},$e={},ee=at;function pt(e){ee=e||at,ue={},$e={}}const Re=()=>ee;async function vt(){const[e,t]=await Promise.all([f.from("settings").select("key,value").eq("tenant_id",ee),f.from("site_content").select("*").eq("tenant_id",ee)]);e.data&&e.data.forEach(n=>{ue[n.key]=n.value}),t.data&&t.data.forEach(n=>{$e[n.key]=n})}const V=(e,t=null)=>ue[e]!==void 0?ue[e]:t,_e=(e,t="pt")=>{const n=$e[e];return n?n[`value_${t}`]??n.value_pt??null:null};async function Q(e){const t=new Date().toISOString(),n=e.map(([o,s])=>({key:o,value:s,tenant_id:ee,updated_at:t})),{error:a}=await f.from("settings").upsert(n,{onConflict:"key,tenant_id"});return a||e.forEach(([o,s])=>{ue[o]=s}),!a}async function Ce(e,{pt:t,en:n,es:a}){const o={key:e,value_pt:t,value_en:n,value_es:a,tenant_id:ee,updated_at:new Date().toISOString()},{error:s}=await f.from("site_content").upsert(o,{onConflict:"key,tenant_id"});return s||($e[e]=o),!s}async function Te(e,t,n){const{error:a}=await f.from("integrations").upsert({key:e,value:t,enabled:n,updated_at:new Date().toISOString()},{onConflict:"key"});return!a}function He(){const e=document.documentElement,t=V("visual.accent_color","#b8962e"),n=V("visual.primary_bg","#0f1c2e"),a=V("visual.secondary_bg","#1a2f4a");e.style.setProperty("--accent",t),e.style.setProperty("--primary-bg",n),e.style.setProperty("--secondary-bg",a);const o=V("company.logo_url","/logo.png");document.querySelectorAll(".logo-img").forEach(i=>{i.src=o});const s=V("company.favicon_url","/favicon.ico"),l=document.querySelector('link[rel="shortcut icon"]');l&&(l.href=s);const d=V("visual.hero_bg_url","");if(d){const i=document.querySelector(".hero");i&&(i.style.backgroundImage=`url('${d}')`)}}function gt(e="pt"){const t=p=>_e(p,e)??"",n=document.querySelector('[data-i18n="hero.title"]');n&&t("hero.title")&&(n.innerHTML=t("hero.title"));const a=document.querySelector(".hero-content > p");a&&t("hero.subtitle")&&(a.innerHTML=t("hero.subtitle"));const o=document.querySelector(".footer small");o&&t("footer.text")&&(o.innerHTML=t("footer.text"));const s=document.querySelector('[data-i18n="inst.p1"]'),l=document.querySelector('[data-i18n="inst.p2"]'),d=document.querySelector('[data-i18n="inst.p3"]');s&&t("inst.bio_p1")&&(s.innerHTML=t("inst.bio_p1")),l&&t("inst.bio_p2")&&(l.innerHTML=t("inst.bio_p2")),d&&t("inst.bio_p3")&&(d.innerHTML=t("inst.bio_p3"));const i=document.querySelector('[data-i18n-num="inst.stat2num"]'),c=document.querySelector('[data-i18n="inst.stat1"]'),m=document.querySelector('[data-i18n="inst.stat2"]'),u=document.querySelector('[data-i18n="inst.stat3"]');i&&t("inst.stat2_num")&&(i.innerHTML=t("inst.stat2_num")),c&&t("inst.stat1_label")&&(c.innerHTML=t("inst.stat1_label")),m&&t("inst.stat2_label")&&(m.innerHTML=t("inst.stat2_label")),u&&t("inst.stat3_label")&&(u.innerHTML=t("inst.stat3_label"));const r=_e("seo.title_pt",e);r&&document.title&&(document.title=r);const g=_e("seo.description_pt",e);if(g){const p=document.querySelector('meta[name="description"]');p&&(p.content=g)}}function ft(e){if(!e)return;const t=`https://wa.me/${e}`;document.querySelectorAll('a[href*="wa.me"]').forEach(n=>{const a=n.getAttribute("href");if(a){const o=a.replace(/^https:\/\/wa\.me\/[^?]+/,"");n.href=t+o}})}const yt="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9ua25wYnpkY3JoYmZvenp2eHR6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzg4NjY1NjYsImV4cCI6MjA5NDQ0MjU2Nn0.5yX05Y4Nhp8UJlhFblK4z_1TRxBqJKrwOLQ91KxsLMM";let J="5547999701743",pe=`https://wa.me/${J}`;const W=["https://images.unsplash.com/photo-1560184897-e6f6f0d0b1f8?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=1200&auto=format&fit=crop","https://images.unsplash.com/photo-1570129477492-45c003edd2be?q=80&w=1200&auto=format&fit=crop"],bt=5.7;function ve(e,t){if(!e)return"—";const n=String(e).trim();let a;return n.includes(",")&&n.lastIndexOf(",")>n.lastIndexOf(".")?a=parseFloat(n.replace(/\./g,"").replace(",",".")):a=parseFloat(n.replace(/[^\d.]/g,"")),isNaN(a)||a===0?n:t==="en"?"$ "+(a/bt).toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:0}):"R$ "+a.toLocaleString("pt-BR",{minimumFractionDigits:0,maximumFractionDigits:0})}window.currentLang=window.currentLang||"pt";let $=[],v=null,ge=[],nt=!1;f.auth.onAuthStateChange(e=>{e==="PASSWORD_RECOVERY"&&(nt=!0)});async function ht(){const{data:e,error:t}=await f.from("properties").select("*").eq("published",!0).order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):e||[]}async function Et(){const{data:e,error:t}=await f.from("properties").select("*").order("created_at",{ascending:!1});return t?(console.error("Supabase select error:",t),[]):($=e||[],Jt(),Kt(),$)}async function wt(e){if(e.id){const{id:t,created_at:n,...a}=e,{error:o}=await f.from("properties").update(a).eq("id",t);if(o)throw o;const s=$.findIndex(l=>l.id===t);s>=0&&($[s]={...$[s],...a})}else{if(!e.reference){const a=$.map(s=>s.reference||"").filter(s=>/^IO-\d+$/.test(s)).map(s=>parseInt(s.replace("IO-",""),10)),o=a.length?Math.max(...a)+1:1;e.reference="IO-"+String(o).padStart(4,"0")}const{data:t,error:n}=await f.from("properties").insert(e).select();if(n)throw n;t!=null&&t[0]&&$.unshift(t[0])}}async function It(e){const{error:t}=await f.from("properties").delete().eq("id",e);if(t)throw t;$=$.filter(n=>n.id!==e)}async function xt(e,t){const{error:n}=await f.auth.signInWithPassword({email:e,password:t});return!n}function he(e,t=1200,n=.78){return new Promise((a,o)=>{const s=new Image,l=URL.createObjectURL(e);s.onload=()=>{URL.revokeObjectURL(l);const d=document.createElement("canvas");let i=s.width,c=s.height;i>t&&(c=Math.round(c*t/i),i=t),d.width=i,d.height=c;const m=d.getContext("2d");m.drawImage(s,0,0,i,c);const u=new Image;u.crossOrigin="anonymous",u.onload=()=>{const r=Math.round(i*.18),g=Math.round(u.naturalHeight*r/u.naturalWidth),p=Math.round(i*.02),y=i-r-p,E=c-g-p;m.globalAlpha=.45,m.drawImage(u,y,E,r,g),m.globalAlpha=1,d.toBlob(b=>b?a(b):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.onerror=()=>{d.toBlob(r=>r?a(r):o(new Error("Canvas toBlob falhou")),"image/jpeg",n)},u.src="/logo.png"},s.onerror=o,s.src=l})}async function Bt(e){const t=await he(e),n=`${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:a}=await f.storage.from("imoveis").upload(n,t,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(a)throw a;const{data:{publicUrl:o}}=f.storage.from("imoveis").getPublicUrl(n);return o}async function Lt(e,t){const n=Array.from(e).filter(o=>o.size>0),a=[];for(let o=0;o<n.length;o++)t&&t(o+1,n.length),a.push(await Bt(n[o]));return a}async function fe(){var u,r,g,p,y,E;const e=document.getElementById("vendas-carousel"),t=document.getElementById("properties");if(!e&&!t)return;const n=await ht();$=n,((u=document.getElementById("selecao-carousel"))==null?void 0:u.innerHTML)===""&&St(n);const a=((r=document.getElementById("city-filter"))==null?void 0:r.value)||"",o=((g=document.getElementById("neighborhood-filter"))==null?void 0:g.value)||"",s=((p=document.getElementById("bedrooms-filter"))==null?void 0:p.value)||"",l=((y=document.getElementById("parking-filter"))==null?void 0:y.value)||"",d=((E=document.getElementById("construction-filter"))==null?void 0:E.value)||"",i=document.getElementById("price-slider"),c=i?parseInt(i.value,10):13e7,m=n.filter(b=>{if(a&&b.city!==a||o&&b.neighborhood!==o||s&&(s==="4+"&&Number(b.bedrooms)<4||s!=="4+"&&Number(b.bedrooms)!==Number(s))||l&&(l==="4+"&&Number(b.parking)<4||l!=="4+"&&Number(b.parking)!==Number(l))||d&&b.construction_status!==d)return!1;const w=String(b.price||"").replace(/,\d{0,2}$/,"").replace(/[^0-9]/g,""),B=parseInt(w,10)||0;return!(B<0||B>c)});if(e){if(!m.length){e.innerHTML='<div style="padding:20px;text-align:center;color:#6b7280">Nenhum imóvel encontrado.</div>';return}e.innerHTML=m.map(b=>{var x;const w=b.cover_image||((x=b.images)==null?void 0:x[0])||W[0],B=[b.neighborhood,b.city].filter(Boolean).join(", ");return`
        <div class="selecao-card">
          <img src="${w}" alt="${h(b.title)}" class="selecao-card-img">
          <div class="selecao-card-body">
            <div class="selecao-card-title">${h(b.title)}</div>
            <div class="selecao-card-loc">${h(B)}</div>
            <div class="selecao-card-price">${h(ve(b.price,window.currentLang||"pt"))}</div>
      ...
      `}).join("");return}if(!m.length){t.innerHTML='<div class="muted" style="padding:20px;text-align:center">Nenhum imóvel encontrado.</div>';return}t.innerHTML=m.map(b=>{var x;const w=(x=b.images)!=null&&x.length?b.images:W,B=w.length;return`
      <div class="card property-card">
        <div class="carousel-wrap" style="position:relative" data-total="${B}" data-idx="0" data-pid="${b.id}">
          <img src="${b.cover_image||w[0]}" alt="${h(b.title)}" class="carousel-img" style="width:100%;height:180px;object-fit:cover;border-radius:10px;display:block">
          ${B>1?`
        ...
        <div class="property-info">
          ...
          <div class="muted">${h(b.neighborhood||"")}, ${h(b.city||"")}</div>
          <div><strong>${h(ve(b.price,window.currentLang||"pt"))}</strong></div>
          <div class="muted">🛏️ ${b.bedrooms||"--"} | 🚗 ${b.parking||"--"} ${B>1?"| 📸 "+B:""}</div>
          <p class="muted">${h((b.description||"").slice(0,110))}</p>
    ...
    `}).join(""),document.querySelectorAll(".carousel-btn").forEach(b=>{b.removeEventListener("click",ze),b.addEventListener("click",ze)})}function St(e){var o,s,l;const t=document.getElementById("selecao-carousel");if(!t)return;const n=e.slice(0,6);if(!n.length){(o=t.closest(".selecao-section"))==null||o.classList.add("hidden");return}t.innerHTML=n.map(d=>{var m;const i=d.cover_image||((m=d.images)==null?void 0:m[0])||W[0],c=[d.neighborhood,d.city].filter(Boolean).join(", ");return`
      <div class="selecao-card">
        <img src="${i}" alt="${h(d.title)}" class="selecao-card-img">
        <div class="selecao-card-body">
          <div class="selecao-card-title">${h(d.title)}</div>
          <div class="selecao-card-loc">${h(c)}</div>
...
Verifique se o bucket "imoveis" existe no Supabase Storage e se as políticas de upload estão configuradas.`);return}}else if(R){const i=$.find(c=>c.id===R);i!=null&&i.images&&(s=i.images)}s.length||(s=[...W]);const d={...R?{id:R}:{},title:a.get("title"),rua:a.get("rua")||"",numero:a.get("numero")||"",city:a.get("city"),neighborhood:a.get("neighborhood"),price:a.get("price"),bedrooms:parseInt(a.get("bedrooms"),10)||0,suites:parseInt(a.get("suites"),10)||0,area:parseFloat(a.get("area"))||0,parking:parseInt(a.get("parking"),10)||0,published:a.get("published")==="true",images:s,description:a.get("description")||"",owner_name:a.get("owner_name")||"",owner_phone:a.get("owner_phone")||"",owner_email:a.get("owner_email")||"",owner_notes:a.get("owner_notes")||"",cover_image:G||"",construction_status:a.get("construction_status")||"",condominium:a.get("condominium")||""};try{await wt(d),R=null,t.disabled=!1,t.textContent="Salvar Imóvel",e.reset();const i=document.getElementById("adminPublished");i&&(i.value="true");const c=document.getElementById("adminNeighborhood");c&&(c.innerHTML='<option value="">Selecione a cidade primeiro</option>');const m=document.getElementById("adminConstructionStatus");m&&(m.value=""),G="",xe([]),we(),await Ie()}catch(i){console.error(i),t.disabled=!1,t.textContent=R?"Salvar Alterações":"Salvar Imóvel",alert("Erro ao salvar imóvel. Verifique o console.")}}),document.addEventListener("click",async n=>{var a;if(n.target.matches(".del-btn")){const o=Number(n.target.dataset.id);if(!o||!confirm("Remover este imóvel?"))return;try{await It(o),await Ie()}catch{alert("Erro ao remover imóvel.")}}if(n.target.matches(".edit-btn")){if((v==null?void 0:v.role)!=="admin")return;const o=Number(n.target.dataset.id);if(!o)return;const s=$.find(i=>i.id===o);if(!s)return;R=o,t.textContent="Salvar Alterações",e.querySelector('[name="title"]').value=s.title||"",e.querySelector('[name="rua"]').value=s.rua||"",e.querySelector('[name="numero"]').value=s.numero||"",e.querySelector('[name="city"]').value=s.city||"",e.querySelector('[name="price"]').value=s.price||"",e.querySelector('[name="bedrooms"]').value=s.bedrooms||"",e.querySelector('[name="suites"]').value=s.suites||"",e.querySelector('[name="area"]').value=s.area||"",e.querySelector('[name="parking"]').value=s.parking||"",e.querySelector('[name="description"]').value=s.description||"",e.querySelector('[name="construction_status"]').value=s.construction_status||"",e.querySelector('[name="owner_name"]').value=s.owner_name||"",e.querySelector('[name="owner_phone"]').value=s.owner_phone||"",e.querySelector('[name="owner_email"]').value=s.owner_email||"",e.querySelector('[name="owner_notes"]').value=s.owner_notes||"",e.querySelector('[name="condominium"]').value=s.condominium||"";const l=document.getElementById("adminPublished");l&&(l.value=s.published===!0?"true":"false");const d=document.getElementById("adminCitySelect");d&&(d.value=s.city||"",d.dispatchEvent(new Event("change")),setTimeout(()=>{const i=document.getElementById("adminNeighborhood");i&&(i.value=s.neighborhood||"")},50)),G=s.cover_image||((a=s.images)==null?void 0:a[0])||"",xe(s.images||[]),Ae("Editar Imóvel")}})}function h(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}let F=[],H=0;function Tt(e){var m,u;document.getElementById("view-code").textContent=e.id||"",document.getElementById("view-modal-title").textContent=e.title||"Imóvel";const t=document.getElementById("view-status-badge");e.published?(t.textContent="● Publicado",t.className="badge badge-green"):(t.textContent="○ Rascunho",t.className="badge badge-gray");const n=[e.rua,e.numero?`nº ${e.numero}`:"",e.neighborhood,e.city].filter(Boolean);document.getElementById("view-modal-address").textContent=n.length?`📍 ${n.join(", ")}`:"";const a=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(n.join(" "))}`;document.getElementById("view-map-link").href=a,document.getElementById("view-directions-link").href=a;const o=((m=e.images)==null?void 0:m[0])||W[0];document.getElementById("view-thumb-preview").src=o,F=(u=e.images)!=null&&u.length?e.images:W,H=0,Be(),document.getElementById("view-price").textContent=ve(e.price,"pt"),document.getElementById("view-bedrooms").textContent=e.bedrooms||"—",document.getElementById("view-suites").textContent=e.suites||"—",document.getElementById("view-parking").textContent=e.parking||"—",document.getElementById("view-area").textContent=e.area?`${e.area} m²`:"—";const s=document.getElementById("view-condominium-item"),l=document.getElementById("view-condominium");l&&(l.textContent=e.condominium||""),s&&(s.style.display=e.condominium?"":"none"),document.getElementById("view-description").textContent=e.description||"Sem descrição.",document.getElementById("conf-name").textContent=e.owner_name||"—",document.getElementById("conf-phone").textContent=e.owner_phone||"—",document.getElementById("conf-email").textContent=e.owner_email||"—",document.getElementById("conf-notes").textContent=e.owner_notes||"—",document.querySelectorAll("#view-modal .tab-btn").forEach(r=>r.classList.remove("active")),document.querySelectorAll("#view-modal .tab-panel").forEach(r=>r.classList.add("hidden")),document.querySelector('#view-modal .tab-btn[data-tab="principal"]').classList.add("active"),document.getElementById("tab-principal").classList.remove("hidden");const d="https://omarcorretor.com.br/property.html?id="+e.id,i=document.getElementById("share-link-input");i&&(i.value=d);const c=document.getElementById("share-panel");c&&(c.style.display="none"),document.getElementById("view-modal").classList.remove("hidden"),document.body.style.overflow="hidden"}function Ee(){document.getElementById("view-modal").classList.add("hidden"),document.body.style.overflow=""}function Be(){const e=document.getElementById("view-main-img"),t=document.getElementById("view-counter"),n=document.getElementById("view-prev"),a=document.getElementById("view-next"),o=document.getElementById("view-thumbs");e.src=F[H],e.alt=`Foto ${H+1}`;const s=F.length>1;n.style.display=s?"flex":"none",a.style.display=s?"flex":"none",t.textContent=s?`${H+1} / ${F.length}`:"",o.innerHTML=s?F.map((l,d)=>`<img src="${l}" class="view-thumb${d===H?" active":""}" data-i="${d}" alt="Foto ${d+1}">`).join(""):"",o.querySelectorAll(".view-thumb").forEach(l=>{l.addEventListener("click",()=>{H=+l.dataset.i,Be()})})}async function Xe(e){const{data:t}=await f.from("profiles").select("*").eq("id",e).maybeSingle();return t}function Le(e){var u,r;const t=document.getElementById("topnav-avatar-initial"),n=document.getElementById("topnav-avatar-img"),a=document.getElementById("topnav-name"),o=document.getElementById("topnav-role");if(!a)return;const s=(e==null?void 0:e.name)||"Sem nome",l=(e==null?void 0:e.role)==="super_admin"?"Super Admin":(e==null?void 0:e.role)==="admin"?"Administrador":"Corretor";a.textContent=s,o&&(o.textContent=l),e!=null&&e.avatar_url&&n?(n.src=e.avatar_url,n.style.display="",t&&(t.style.display="none")):(t&&(t.textContent=((u=s[0])==null?void 0:u.toUpperCase())||"?",t.style.display=""),n&&(n.style.display="none"));const d=document.getElementById("avatar-dd-name"),i=document.getElementById("avatar-dd-role"),c=document.getElementById("avatar-dd-img"),m=document.getElementById("avatar-dd-initial");d&&(d.textContent=s),i&&(i.textContent=l),e!=null&&e.avatar_url&&c?(c.src=e.avatar_url,c.style.display="",m&&(m.style.display="none")):(m&&(m.textContent=((r=s[0])==null?void 0:r.toUpperCase())||"?",m.style.display=""),c&&(c.style.display="none"))}function te(e){var n,a;document.querySelectorAll(".topnav-link, .topnav-dropdown-item").forEach(o=>o.classList.remove("active"));const t=document.querySelector(`.topnav-link[data-section="${e}"], .topnav-dropdown-item[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".admin-section").forEach(o=>o.classList.add("hidden")),(n=document.getElementById(`section-${e}`))==null||n.classList.remove("hidden"),(a=document.getElementById("topnav-links"))==null||a.classList.remove("open"),P(),e==="contatos"&&Xt(),e==="funil"&&Rt(),e==="tarefas"&&jt()}function Ve(e){const t=document.getElementById("admin-root");if(t&&(t.dataset.role=e||"corretor"),(e==="admin"||e==="super_admin")&&(document.querySelectorAll(".admin-only").forEach(a=>{a.style.display=""}),Object.entries({empresa:Zt,visual:ea,"site-config":ta,"crm-config":aa,integracoes:na,midia:oa}).forEach(([a,o])=>{const s=document.querySelector(`.topnav-dropdown-item[data-section="${a}"]`)||document.querySelector(`.nav-item[data-section="${a}"]`);s&&s.addEventListener("click",()=>o(),{once:!0})}),window.lucide&&lucide.createIcons()),e==="super_admin"){document.querySelectorAll(".super-admin-only").forEach(a=>{a.style.display=""});const n=document.querySelector('.topnav-link[data-section="super-admin"]')||document.querySelector('.nav-item[data-section="super-admin"]');n&&n.addEventListener("click",()=>sa(),{once:!0}),window.lucide&&lucide.createIcons()}}function P(){var e,t;(e=document.getElementById("avatar-dropdown"))==null||e.classList.add("hidden"),(t=document.getElementById("notif-dropdown"))==null||t.classList.add("hidden")}function qt(){var a,o,s;const e=document.getElementById("change-pass-modal-root");e&&e.remove();const t=document.createElement("div");t.id="change-pass-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const o=()=>t.remove();(l=document.getElementById("cph-close"))==null||l.addEventListener("click",o),(d=document.getElementById("cph-cancel"))==null||d.addEventListener("click",o),t.addEventListener("click",m=>{m.target===t&&o()}),(i=document.getElementById("cph-file"))==null||i.addEventListener("change",m=>{const u=m.target.files[0];if(!u)return;const r=URL.createObjectURL(u),g=document.getElementById("cph-preview"),p=document.getElementById("cph-initial");g&&(g.src=r,g.style.display=""),p&&(p.style.display="none"),document.getElementById("cph-save").disabled=!1}),(c=document.getElementById("cph-save"))==null||c.addEventListener("click",async()=>{var g;const m=(g=document.getElementById("cph-file"))==null?void 0:g.files[0];if(!m)return;const u=document.getElementById("cph-save"),r=document.getElementById("cph-msg");u.disabled=!0,u.textContent="Salvando…";try{const p=await he(m,400,.85),y=`avatars/${v.id}-${Date.now()}.jpg`,{error:E}=await f.storage.from("imoveis").upload(y,p,{contentType:"image/jpeg",upsert:!0});if(E)throw E;const{data:{publicUrl:b}}=f.storage.from("imoveis").getPublicUrl(y);await f.from("profiles").update({avatar_url:b}).eq("id",v.id),v={...v,avatar_url:b},Le(v),o()}catch(p){r.style.color="#ef4444",r.textContent="Erro: "+p.message,r.style.display="",u.disabled=!1,u.textContent="Salvar Foto"}})}function Mt(){var a,o,s;const e=document.getElementById("add-corretor-modal-root");e&&e.remove();const t=document.createElement("div");t.id="add-corretor-modal-root",t.className="modal-backdrop",t.innerHTML=`
    ...
    </div>`,document.body.appendChild(t);const n=()=>t.remove();(a=document.getElementById("ac-close"))==null||a.addEventListener("click",n),(o=document.getElementById("ac-cancel"))==null||o.addEventListener("click",n),t.addEventListener("click",l=>{l.target===t&&n()}),(s=document.getElementById("ac-save"))==null||s.addEventListener("click",async()=>{var m,u;const l=(m=document.getElementById("ac-email"))==null?void 0:m.value.trim(),d=(u=document.getElementById("ac-password"))==null?void 0:u.value.trim(),i=document.getElementById("ac-save"),c=document.getElementById("ac-note");if(!l){alert("Informe o e-mail do corretor.");return}if(!d||d.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}i.disabled=!0,i.textContent="Criando…",c.style.display="none";try{const r=await oe({email:l,password:d,tenant_id:(v==null?void 0:v.tenant_id)||null});i.disabled=!1,i.textContent="+ Criar Acesso",r.success?(document.getElementById("ac-email").value="",document.getElementById("ac-password").value="",r.email_sent===!1?(c.innerHTML=`✅ Acesso criado! <span style="color:#ef4444;">⚠️ E-mail não enviado.</span><br>Compartilhe manualmente:<br><strong>E-mail:</strong> ${h(l)}<br><strong>Senha:</strong> ${h(d)}`,c.style.color="#0f172a"):(c.textContent="✅ Acesso criado! O corretor receberá um e-mail com as credenciais.",c.style.color="#16a34a"),c.style.display=""):alert("Erro: "+(r.error||"Falha desconhecida"))}catch(r){i.disabled=!1,i.textContent="+ Criar Acesso",alert("Erro: "+r.message)}})}function Nt(){var s,l,d,i,c,m,u,r,g,p;const e=document.getElementById("topnav-avatar-wrap"),t=document.getElementById("avatar-dropdown");e==null||e.addEventListener("click",y=>{var b;y.stopPropagation(),(t==null?void 0:t.classList.toggle("hidden"))||(b=document.getElementById("notif-dropdown"))==null||b.classList.add("hidden")}),(s=document.getElementById("avatar-dd-change-photo"))==null||s.addEventListener("click",()=>{P(),At()}),(l=document.getElementById("avatar-dd-change-pass"))==null||l.addEventListener("click",()=>{P(),qt()}),(d=document.getElementById("avatar-dd-add-corretor"))==null||d.addEventListener("click",()=>{P(),Mt()}),(i=document.getElementById("avatar-dd-logout"))==null||i.addEventListener("click",async()=>{await f.auth.signOut(),location.reload()});const n=document.getElementById("topnav-notif-wrap"),a=document.getElementById("notif-dropdown");n==null||n.addEventListener("click",y=>{var b;y.stopPropagation(),(a==null?void 0:a.classList.toggle("hidden"))||((b=document.getElementById("avatar-dropdown"))==null||b.classList.add("hidden"),Ot())}),(c=document.getElementById("notif-mark-all"))==null||c.addEventListener("click",()=>{Pt(),P()}),(m=document.getElementById("btn-search-open"))==null||m.addEventListener("click",()=>{var y,E;(y=document.getElementById("search-overlay"))==null||y.classList.remove("hidden"),(E=document.getElementById("search-input"))==null||E.focus()}),(u=document.getElementById("search-overlay-close"))==null||u.addEventListener("click",()=>{var y;(y=document.getElementById("search-overlay"))==null||y.classList.add("hidden")}),(r=document.getElementById("search-overlay"))==null||r.addEventListener("click",y=>{y.target.id==="search-overlay"&&document.getElementById("search-overlay").classList.add("hidden")});let o;(g=document.getElementById("search-input"))==null||g.addEventListener("input",y=>{clearTimeout(o),o=setTimeout(()=>Dt(y.target.value.trim()),280)}),(p=document.getElementById("search-input"))==null||p.addEventListener("keydown",y=>{var E;y.key==="Escape"&&((E=document.getElementById("search-overlay"))==null||E.classList.add("hidden"))}),document.addEventListener("click",P)}let Ge=!1,de=[],ot=[],Se=[],be=null,re=null;async function Rt(){var a;if(Ge)return;Ge=!0;const[{data:e},{data:t}]=await Promise.all([f.from("crm_pipelines").select("*").order("sort_order"),f.from("crm_stages").select("*").order("sort_order")]);de=e||[],ot=t||[];const n=document.getElementById("funil-pipe-sel");if(n){n.innerHTML=de.length?de.map(s=>`<option value="${s.id}">${h(s.name)}</option>`).join(""):'<option value="">Sem funis cadastrados</option>';const o=de.find(s=>s.is_default)||de[0];o&&(n.value=o.id,be=o.id),n.addEventListener("change",async()=>{be=parseInt(n.value,10),await We()})}(a=document.getElementById("btn-funil-add-lead"))==null||a.addEventListener("click",()=>openLeadModal()),await We()}async function We(){const e=document.getElementById("kanban-board");if(!e)return;e.innerHTML='<div class="kanban-loading">Carregando…</div>';let t=f.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id)),be&&(t=t.eq("pipeline_id",be));const{data:n}=await t;Se=n||[],st()}function st(){const e=document.getElementById("kanban-board");if(!e)return;const t=ot.filter(a=>a.pipeline_id===be);if(!t.length){e.innerHTML='<div class="kanban-loading">Nenhuma etapa configurada para este funil. Crie etapas em Configurações → CRM Config.</div>';return}const n={};t.forEach(a=>{n[a.name]=[]}),Se.forEach(a=>{var s,l,d,i;const o=a.stage||((s=t[0])==null?void 0:s.name);n[o]||(n[((l=t[0])==null?void 0:l.name)||""]=[]),(i=n[o]||n[(d=t[0])==null?void 0:d.name])==null||i.push(a)}),e.innerHTML=t.map(a=>{const o=n[a.name]||[],s=o.length?o.map(l=>`
...
CREATE POLICY "tasks_access" ON public.tasks
  ...
  WITH CHECK (auth.uid() IS NOT NULL);</code>
      </div>`);return}M=n||[],ae()}function it(e){if(!e)return null;const t=e.includes("T")?new Date(e):new Date(e+"T00:00:00");return isNaN(t.getTime())?null:t}function ae(){const e=document.getElementById("tarefas-list");if(!e)return;let t=M;if(K==="pending"&&(t=M.filter(a=>a.status!=="done")),K==="done"&&(t=M.filter(a=>a.status==="done")),!t.length){e.innerHTML=`<div style="text-align:center;padding:40px;color:#94a3b8;">
      <div style="font-size:32px;margin-bottom:8px;">${K==="done"?"✅":"📋"}</div>
      <p>${K==="done"?"Nenhuma tarefa concluída.":"Nenhuma tarefa pendente."}</p>
    </div>`;return}const n=new Date;n.setHours(0,0,0,0),e.innerHTML=t.map(a=>{const o=it(a.due_date),s=o?o.toLocaleDateString("pt-BR"):"",l=o&&a.status!=="done"&&o<n;return`
  ...
  `,document.body.appendChild(l);const d=()=>l.remove();(i=document.getElementById("tm-close"))==null||i.addEventListener("click",d),(c=document.getElementById("tm-cancel"))==null||c.addEventListener("click",d),l.addEventListener("click",r=>{r.target===l&&d()}),(m=document.getElementById("tm-toggle-done"))==null||m.addEventListener("click",async()=>{const r=a?"pending":"done";await f.from("tasks").update({status:r}).eq("id",e.id);const g=M.find(p=>String(p.id)===String(e.id));g&&(g.status=r),d(),r==="done"&&(K="done",document.querySelectorAll(".tarefa-filter-btn").forEach(p=>{p.classList.toggle("active",p.dataset.filter==="done")})),ae()}),(u=document.getElementById("tm-save"))==null||u.addEventListener("click",async()=>{var b,w;const r=document.getElementById("tarefa-form");if(!r.checkValidity()){r.reportValidity();return}const g=new FormData(r),p=document.getElementById("tm-save");p.disabled=!0,p.textContent="Salvando…";const y={title:(b=g.get("title"))==null?void 0:b.trim(),description:((w=g.get("description"))==null?void 0:w.trim())||null,due_date:g.get("due_date")||null,priority:g.get("priority")||"medium",status:(e==null?void 0:e.status)||"pending",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null};let E;if(n){if({error:E}=await f.from("tasks").update(y).eq("id",e.id),!E){const B=M.findIndex(x=>String(x.id)===String(e.id));B>=0&&(M[B]={...M[B],...y})}}else{const{data:B,error:x}=await f.from("tasks").insert(y).select();E=x,!E&&(B!=null&&B[0])&&M.unshift(B[0])}if(p.disabled=!1,p.textContent=n?"Salvar":"Criar Tarefa",E){alert("Erro: "+E.message);return}d(),ae()})}async function Dt(e){const t=document.getElementById("search-results");if(!t)return;if(!e||e.length<2){t.innerHTML='<div class="search-hint">Digite para pesquisar…</div>';return}t.innerHTML='<div class="search-hint">Buscando…</div>';const n=`%${e}%`;v==null||v.role,v==null||v.tenant_id;const[{data:a},{data:o}]=await Promise.all([f.from("properties").select("id,title,reference,type,city").ilike("title",n).limit(5),f.from("leads").select("id,name,phone,email").or(`name.ilike.${n},phone.ilike.${n},email.ilike.${n}`).limit(5)]),s=[];a!=null&&a.length&&(s.push('<div class="search-group-label">Imóveis</div>'),s.push(...a.map(l=>`
      ...
      </div>`}).join(""),e.innerHTML+='<div class="notif-footer"><a href="#" id="notif-see-all">Ver todos os leads</a></div>',(l=document.getElementById("notif-see-all"))==null||l.addEventListener("click",d=>{d.preventDefault(),P(),te("contatos")}),e.querySelectorAll(".notif-item").forEach(d=>{d.addEventListener("click",()=>{U.push(d.dataset.id),localStorage.setItem("crm_notifs_read",JSON.stringify(U)),d.classList.remove("unread"),P(),te("contatos")})})}function Pt(){var e;document.querySelectorAll(".notif-item").forEach(t=>U.push(t.dataset.id)),U=[...new Set(U)],localStorage.setItem("crm_notifs_read",JSON.stringify(U)),(e=document.getElementById("notif-badge"))==null||e.classList.add("hidden"),document.querySelectorAll(".notif-item").forEach(t=>t.classList.remove("unread"))}function Ft(e){if(!e)return"";const t=(Date.now()-new Date(e).getTime())/1e3;return t<60?"agora":t<3600?`${Math.floor(t/60)}min atrás`:t<86400?`${Math.floor(t/3600)}h atrás`:`${Math.floor(t/86400)}d atrás`}async function zt(){let e=f.from("leads").select("id").order("created_at",{ascending:!1}).limit(20);v!=null&&v.tenant_id&&(e=e.eq("tenant_id",v.tenant_id));const{data:t}=await e,a=(t||[]).filter(s=>!U.includes(String(s.id))),o=document.getElementById("notif-badge");o&&(o.textContent=a.length,a.length>0?o.classList.remove("hidden"):o.classList.add("hidden"))}let z=[],A=1;const ce=10;let Je=!1;async function Xt(){var t,n,a,o,s,l,d,i,c;document.getElementById("section-contatos")&&(Je||(Je=!0,await dt(),(t=document.getElementById("btn-contato-search"))==null||t.addEventListener("click",()=>{A=1,ne()}),(n=document.getElementById("contato-search"))==null||n.addEventListener("keydown",m=>{m.key==="Enter"&&(A=1,ne())}),(a=document.getElementById("btn-novo-contato"))==null||a.addEventListener("click",()=>rt()),(o=document.getElementById("btn-import-contato"))==null||o.addEventListener("click",Wt),(s=document.getElementById("import-modal-close"))==null||s.addEventListener("click",Me),(l=document.getElementById("import-modal-cancel"))==null||l.addEventListener("click",Me),(d=document.getElementById("download-template"))==null||d.addEventListener("click",m=>{m.preventDefault();const u=`nome,email,telefone,empresa,cargo
João Silva,joao@email.com,(47)99999-0000,Imobiliária ABC,Diretor`,r=new Blob([u],{type:"text/csv"}),g=document.createElement("a");g.href=URL.createObjectURL(r),g.download="modelo_contatos.csv",g.click()}),(i=document.getElementById("import-csv-file"))==null||i.addEventListener("change",Vt),(c=document.getElementById("import-modal-confirm"))==null||c.addEventListener("click",Gt)))}async function dt(){const e=document.getElementById("contatos-tbody");e&&(e.innerHTML='<tr><td colspan="8" class="empty-row">Carregando…</td></tr>');let t=f.from("leads").select("*").order("created_at",{ascending:!1});(v==null?void 0:v.role)==="corretor"?t=t.eq("assigned_to",v.id):v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:a}=await t;z=a||[],ne()}function ne(){var d,i,c;const e=(((d=document.getElementById("contato-search"))==null?void 0:d.value)||"").toLowerCase(),t=e?z.filter(m=>(m.name||"").toLowerCase().includes(e)||(m.email||"").toLowerCase().includes(e)||(m.phone||"").toLowerCase().includes(e)):z,n=t.length,a=Math.max(1,Math.ceil(n/ce));A>a&&(A=a);const o=t.slice((A-1)*ce,A*ce),s=document.getElementById("contatos-tbody");if(!s)return;o.length?s.innerHTML=o.map(m=>`
      <tr>
  ...
  `,document.body.appendChild(a);const o=()=>a.remove();(s=document.getElementById("cm-close"))==null||s.addEventListener("click",o),(l=document.getElementById("cm-cancel"))==null||l.addEventListener("click",o),a.addEventListener("click",i=>{i.target===a&&o()}),(d=document.getElementById("cm-save"))==null||d.addEventListener("click",async()=>{var g,p,y,E,b,w,B;const i=document.getElementById("contato-form");if(!i.checkValidity()){i.reportValidity();return}const c=new FormData(i),m=document.getElementById("cm-save");m.disabled=!0,m.textContent="Salvando…";const u={name:(g=c.get("name"))==null?void 0:g.trim(),company:((p=c.get("company"))==null?void 0:p.trim())||null,email:((y=c.get("email"))==null?void 0:y.trim())||null,phone:((E=c.get("phone"))==null?void 0:E.trim())||null,job_title:((b=c.get("job_title"))==null?void 0:b.trim())||null,city_interest:((w=c.get("city_interest"))==null?void 0:w.trim())||null,notes:((B=c.get("notes"))==null?void 0:B.trim())||null,stage:(e==null?void 0:e.stage)||"novo",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null,source:"manual"};let r;if(n){if({error:r}=await f.from("leads").update(u).eq("id",e.id),!r){const x=z.findIndex(C=>String(C.id)===String(e.id));x>=0&&(z[x]={...z[x],...u})}}else{const{data:x,error:C}=await f.from("leads").insert(u).select();r=C,!r&&(x!=null&&x[0])&&z.unshift(x[0])}if(m.disabled=!1,m.textContent=n?"Salvar":"Criar Contato",r){alert("Erro: "+r.message);return}o(),ne()})}let Z=[];function Vt(e){const t=e.target.files[0];if(!t)return;const n=new FileReader;n.onload=a=>{Z=a.target.result.split(`
`).filter(d=>d.trim()).slice(1).map(d=>{const[i,c,m,u,r]=d.split(",").map(g=>g.trim().replace(/^"|"$/g,""));return{name:i,email:c,phone:m,company:u,job_title:r}}).filter(d=>d.name);const s=document.getElementById("import-preview");s&&(s.textContent=`${Z.length} contato(s) encontrados para importar.`);const l=document.getElementById("import-modal-confirm");l&&(l.disabled=Z.length===0)},n.readAsText(t)}async function Gt(){if(!Z.length)return;const e=document.getElementById("import-modal-confirm");e&&(e.disabled=!0,e.textContent="Importando…");const t=Z.map(a=>({...a,stage:"novo",source:"importado",assigned_to:(v==null?void 0:v.id)||null,tenant_id:(v==null?void 0:v.tenant_id)||null})),{error:n}=await f.from("leads").insert(t);if(e&&(e.disabled=!1,e.textContent="Importar"),n){alert("Erro na importação: "+n.message);return}Me(),await dt(),alert(`${t.length} contato(s) importados com sucesso!`)}function Wt(){const e=document.getElementById("import-modal");e&&e.classList.remove("hidden"),Z=[];const t=document.getElementById("import-preview");t&&(t.textContent="");const n=document.getElementById("import-modal-confirm");n&&(n.disabled=!0);const a=document.getElementById("import-csv-file");a&&(a.value="")}function Me(){const e=document.getElementById("import-modal");e&&e.classList.add("hidden")}const Yt="https://onknpbzdcrhbfozzvxtz.supabase.co/functions/v1/invite-user";async function oe(e){return(await fetch(Yt,{method:"POST",headers:{Authorization:`Bearer ${yt}`,"Content-Type":"application/json"},body:JSON.stringify(e)})).json()}async function Ke(e){var i,c,m,u;const t=document.getElementById("settings-name"),n=document.getElementById("settings-email"),a=document.getElementById("settings-avatar-preview"),o=document.getElementById("settings-avatar-initial"),s=document.getElementById("settings-avatar-input"),l=document.getElementById("settings-save-profile");if(!t)return;if(t.value=(e==null?void 0:e.name)||"",n){const{data:{user:r}}=await f.auth.getUser();n.value=(r==null?void 0:r.email)||""}const d=((e==null?void 0:e.name)||"?")[0].toUpperCase();if(o&&(o.textContent=d),e!=null&&e.avatar_url&&a&&(a.src=e.avatar_url,a.style.display="",o&&(o.style.display="none")),s==null||s.addEventListener("change",r=>{const g=r.target.files[0];if(!g)return;const p=URL.createObjectURL(g);a&&(a.src=p,a.style.display=""),o&&(o.style.display="none")}),(i=document.getElementById("btn-change-password"))==null||i.addEventListener("click",async()=>{var b,w;const r=((b=document.getElementById("change-password-new"))==null?void 0:b.value)||"",g=((w=document.getElementById("change-password-confirm"))==null?void 0:w.value)||"",p=document.getElementById("change-password-msg"),y=document.getElementById("btn-change-password");if(p&&(p.style.display="none"),r.length<6){p&&(p.textContent="Mínimo 6 caracteres.",p.style.display="");return}if(r!==g){p&&(p.textContent="As senhas não coincidem.",p.style.display="");return}y&&(y.disabled=!0,y.textContent="Salvando…");const{error:E}=await f.auth.updateUser({password:r});y&&(y.disabled=!1,y.textContent="Salvar Nova Senha"),E?p&&(p.textContent="Erro: "+E.message,p.style.display=""):(p&&(p.style.color="#16a34a",p.textContent="Senha alterada com sucesso!",p.style.display=""),document.getElementById("change-password-new").value="",document.getElementById("change-password-confirm").value="")}),l==null||l.addEventListener("click",async()=>{var w;const r=t.value.trim();let g=(v==null?void 0:v.avatar_url)||"";const p=s==null?void 0:s.files[0],y=l.textContent;if(l.disabled=!0,l.textContent="Salvando…",p)try{const B=await he(p,400,.85),x=`avatars/${v.id}-${Date.now()}.jpg`,{error:C}=await f.storage.from("imoveis").upload(x,B,{contentType:"image/jpeg",upsert:!0});if(!C){const{data:{publicUrl:I}}=f.storage.from("imoveis").getPublicUrl(x);g=I}}catch(B){console.error("Avatar upload:",B)}const{error:E}=await f.from("profiles").update({name:r,avatar_url:g}).eq("id",v.id);if(l.disabled=!1,l.textContent=y,E){alert("Erro ao salvar perfil.");return}v={...v,name:r,avatar_url:g},Le(v);const b=document.getElementById("settings-avatar-initial");b&&(b.textContent=((w=r[0])==null?void 0:w.toUpperCase())||"?")}),(e==null?void 0:e.role)==="admin"||(e==null?void 0:e.role)==="super_admin"){const r=document.getElementById("settings-corretores-section");r&&(r.style.display=""),await ke(),(c=document.getElementById("btn-invite-corretor"))==null||c.addEventListener("click",async()=>{var w,B;const p=(w=document.getElementById("invite-email"))==null?void 0:w.value.trim(),y=(B=document.getElementById("invite-password"))==null?void 0:B.value.trim(),E=document.getElementById("btn-invite-corretor"),b=document.getElementById("invite-note");if(!p){alert("Informe o e-mail do corretor.");return}if(!y||y.length<6){alert("A senha precisa ter no mínimo 6 caracteres.");return}E&&(E.disabled=!0,E.textContent="Criando…"),b&&(b.style.display="none");try{const x=await oe({email:p,password:y,tenant_id:(v==null?void 0:v.tenant_id)||null});if(x.success){const C=document.getElementById("invite-email"),I=document.getElementById("invite-password");C&&(C.value=""),I&&(I.value=""),await ke(),b&&(x.email_sent===!1?(b.innerHTML=`
                ✅ Acesso criado!
                <span style="color:#ef4444;">⚠️ E-mail não enviado automaticamente.</span><br>
                Compartilhe manualmente:<br>
                <strong>E-mail:</strong> ${h(p)}<br>
                <strong>Senha:</strong> ${h(y)}`,b.style.color="#0f172a"):(b.textContent="✅ Acesso criado! O corretor receberá um e-mail com o login e a senha.",b.style.color="#16a34a"),b.style.display="")}else alert("Erro: "+(x.error||"Falha desconhecida"))}catch(x){alert("Erro ao criar acesso: "+x.message)}finally{E&&(E.disabled=!1,E.textContent="+ Criar Acesso")}});const g=document.getElementById("settings-locations-section");g&&(g.style.display=""),await me(),(m=document.getElementById("loc-add-city-btn"))==null||m.addEventListener("click",async()=>{const p=document.getElementById("loc-new-city"),y=p==null?void 0:p.value.trim();if(!y)return;const{error:E}=await f.from("locations").insert({type:"cidade",name:y});if(E){alert("Erro ao adicionar cidade.");return}p&&(p.value=""),await me(),De()}),(u=document.getElementById("loc-add-neighborhood-btn"))==null||u.addEventListener("click",async()=>{var w;const p=parseInt((w=document.getElementById("loc-new-neighborhood-city"))==null?void 0:w.value,10),y=document.getElementById("loc-new-neighborhood"),E=y==null?void 0:y.value.trim();if(!p||!E){alert("Selecione a cidade e informe o nome do bairro.");return}const{error:b}=await f.from("locations").insert({type:"bairro",name:E,parent_id:p});if(b){alert("Erro ao adicionar bairro.");return}y&&(y.value=""),await me()})}}async function ke(){const e=document.getElementById("corretores-list");if(!e)return;let t=f.from("profiles").select("*").order("created_at");v!=null&&v.tenant_id&&(t=t.eq("tenant_id",v.tenant_id));const{data:n,error:a}=await t;if(a||!n){e.innerHTML='<p style="color:#6b7280;font-size:14px">Erro ao carregar.</p>';return}e.innerHTML=n.map(o=>{const s=(o.name||"?")[0].toUpperCase(),l=o.avatar_url?`<img src="${o.avatar_url}" class="corretor-avatar" alt="">`:`<div class="corretor-avatar-initial">${h(s)}</div>`,d=o.id===(v==null?void 0:v.id),i=o.active!==!1,c=i?'<span class="badge badge-green">Ativo</span>':'<span class="badge badge-gray">Pausado</span>',m=d?'<span class="corretor-you">Você</span>':`<select class="form-control corretor-role-sel" data-uid="${o.id}" style="width:110px;padding:6px 8px;font-size:13px">
...
`+I);window.open("mailto:?subject="+S+"&body="+k,"_blank")}),(B=document.getElementById("share-copy"))==null||B.addEventListener("click",()=>{var L;const I=document.getElementById("share-link-input");I&&((L=navigator.clipboard)==null||L.writeText(I.value).then(()=>{const S=document.getElementById("share-copy"),k=S.textContent;S.textContent="✅ Copiado!",setTimeout(()=>{S.textContent=k},2e3)}))}),(x=document.getElementById("view-modal-edit"))==null||x.addEventListener("click",()=>{var D;if((v==null?void 0:v.role)!=="admin")return;const I=document.getElementById("view-modal-title").textContent,L=$.find(N=>N.title===I);if(!L)return;Ee(),R=L.id;const S=document.getElementById("property-form"),k=document.getElementById("form-submit-btn");k.textContent="Salvar Alterações",S.querySelector('[name="title"]').value=L.title||"",S.querySelector('[name="rua"]').value=L.rua||"",S.querySelector('[name="numero"]').value=L.numero||"",S.querySelector('[name="city"]').value=L.city||"",S.querySelector('[name="price"]').value=L.price||"",S.querySelector('[name="bedrooms"]').value=L.bedrooms||"",S.querySelector('[name="suites"]').value=L.suites||"",S.querySelector('[name="parking"]').value=L.parking||"",S.querySelector('[name="description"]').value=L.description||"",S.querySelector('[name="construction_status"]').value=L.construction_status||"",S.querySelector('[name="owner_name"]').value=L.owner_name||"",S.querySelector('[name="owner_phone"]').value=L.owner_phone||"",S.querySelector('[name="owner_email"]').value=L.owner_email||"",S.querySelector('[name="owner_notes"]').value=L.owner_notes||"",S.querySelector('[name="condominium"]').value=L.condominium||"";const _=document.getElementById("adminPublished");_&&(_.value=L.published===!0?"true":"false");const T=document.getElementById("adminCitySelect");T&&(T.value=L.city||"",T.dispatchEvent(new Event("change")),setTimeout(()=>{const N=document.getElementById("adminNeighborhood");N&&(N.value=L.neighborhood||"")},50)),G=L.cover_image||((D=L.images)==null?void 0:D[0])||"",xe(L.images||[]),Ae("Editar Imóvel")}),document.querySelectorAll(".tab-btn[data-tab]").forEach(I=>{I.addEventListener("click",()=>{var L;document.querySelectorAll(".tab-btn").forEach(S=>S.classList.remove("active")),I.classList.add("active"),document.querySelectorAll(".tab-panel").forEach(S=>S.classList.add("hidden")),(L=document.getElementById(`tab-${I.dataset.tab}`))==null||L.classList.remove("hidden")})}),(C=document.getElementById("admin-properties"))==null||C.addEventListener("click",I=>{if(I.target.closest(".action-btns"))return;const L=I.target.closest("tr");if(!L)return;const S=Number(L.dataset.id);if(!S)return;const k=$.find(_=>_.id===S);k&&Tt(k)})}document.addEventListener("DOMContentLoaded",async()=>{var s,l,d;await Promise.all([vt(),ct()]),J=V("company.whatsapp",J),pe=`https://wa.me/${J}`,He(),kt(),$t();const e=document.getElementById("adminCitySelect"),t=document.getElementById("adminNeighborhood");e&&t&&(De(),e.addEventListener("change",()=>{const i=Y().find(m=>m.name===e.value),c=i?Ue(i.id):[];t.innerHTML='<option value="">Selecione a cidade primeiro</option>'+c.map(m=>`<option value="${m.name}">${h(m.name)}</option>`).join("")}));const n=document.getElementById("admin-login"),a=document.getElementById("admin-root");if(n){const i=new URLSearchParams(window.location.hash.replace("#","")),c=new URLSearchParams(window.location.search),m=i.get("type")||c.get("type")||"",u=nt||m==="recovery"||m==="invite"||window.location.hash.includes("access_token")||c.has("code"),r=document.getElementById("password-reset-overlay");if(u){n.style.display="none",a&&a.classList.add("hidden"),r&&(r.style.display="flex"),(s=document.getElementById("password-reset-form"))==null||s.addEventListener("submit",async p=>{var x,C;p.preventDefault();const y=((x=document.getElementById("new-password"))==null?void 0:x.value)||"",E=((C=document.getElementById("confirm-password"))==null?void 0:C.value)||"",b=document.getElementById("password-reset-msg"),w=p.target.querySelector('button[type="submit"]');if(b&&(b.style.display="none"),y!==E){b&&(b.textContent="As senhas não coincidem.",b.style.display="");return}w&&(w.disabled=!0,w.textContent="Salvando…");const{error:B}=await f.auth.updateUser({password:y});if(B){b&&(b.textContent="Erro: "+B.message,b.style.display=""),w&&(w.disabled=!1,w.textContent="Definir Senha");return}window.location.href=window.location.pathname}),c.has("code")&&await f.auth.exchangeCodeForSession(c.get("code")??"");return}const{data:{session:g}}=await f.auth.getSession();if(g){if(n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ie(),qe(),Qe(),Nt(),window.lucide&&lucide.createIcons(),v=await Xe(g.user.id),!v){await f.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden");return}if(v.active===!1){await f.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}if(v.needs_password_reset){n.style.display="none",a&&a.classList.add("hidden");const p=document.getElementById("password-reset-overlay");p&&(p.style.display="flex"),(l=document.getElementById("password-reset-form"))==null||l.addEventListener("submit",async y=>{var C,I;y.preventDefault();const E=((C=document.getElementById("new-password"))==null?void 0:C.value)||"",b=((I=document.getElementById("confirm-password"))==null?void 0:I.value)||"",w=document.getElementById("password-reset-msg"),B=y.target.querySelector('button[type="submit"]');if(w&&(w.style.display="none"),E!==b){w&&(w.textContent="As senhas não coincidem.",w.style.display="");return}if(E.length<6){w&&(w.textContent="Mínimo 6 caracteres.",w.style.display="");return}B&&(B.disabled=!0,B.textContent="Salvando…");const{error:x}=await f.auth.updateUser({password:E});if(x){w&&(w.textContent="Erro: "+x.message,w.style.display=""),B&&(B.disabled=!1,B.textContent="Definir Senha");return}await f.from("profiles").update({needs_password_reset:!1}).eq("id",v.id),window.location.href=window.location.pathname});return}pt((v==null?void 0:v.tenant_id)||null),Le(v),Ve(v.role),await Ke(v),window.lucide&&lucide.createIcons(),zt()}else{a&&a.classList.add("hidden"),n.classList.remove("hidden");const p=document.getElementById("login-form");p&&((d=document.getElementById("forgot-password-btn"))==null||d.addEventListener("click",async()=>{var b,w;const y=(w=(b=p.querySelector('input[name="email"]'))==null?void 0:b.value)==null?void 0:w.trim();if(!y){alert("Digite seu e-mail no campo acima primeiro.");return}const{error:E}=await f.auth.resetPasswordForEmail(y,{redirectTo:"https://omarcorretor.com.br/admin.html"});alert(E?"Erro: "+E.message:"E-mail de redefinição enviado! Verifique sua caixa de entrada.")}),p.addEventListener("submit",async y=>{y.preventDefault();const E=new FormData(p),b=E.get("email"),w=E.get("password");if(await xt(b,w)){n.classList.add("hidden"),a&&a.classList.remove("hidden"),await Ie(),qe(),Qe(),window.lucide&&lucide.createIcons();const{data:{session:x}}=await f.auth.getSession();if(v=x?await Xe(x.user.id):null,!v){await f.auth.signOut();return}if(v.active===!1){await f.auth.signOut(),n.classList.remove("hidden"),a&&a.classList.add("hidden"),alert("Seu acesso está pausado. Entre em contato com o administrador.");return}Le(v),Ve(v.role),await Ke(v),window.lucide&&lucide.createIcons()}else alert("E-mail ou senha incorretos")}))}}else qe();await fe();const o=(()=>{try{return localStorage.getItem("lang")||"pt"}catch{return"pt"}})();gt(o),ft(J)});async function Jt(){const e=$.filter(o=>!o.reference);if(!e.length)return;const t=$.map(o=>o.reference||"").filter(o=>/^IO-\d+$/.test(o)).map(o=>parseInt(o.replace("IO-",""),10));let n=t.length?Math.max(...t)+1:1;const a=[...e].sort((o,s)=>o.id-s.id);for(const o of a){const s="IO-"+String(n).padStart(4,"0"),{error:l}=await f.from("properties").update({reference:s}).eq("id",o.id);if(!l){const d=$.findIndex(i=>i.id===o.id);d>=0&&($[d].reference=s),n++}}ye(je($))}async function Kt(){const e=$.filter(t=>{var n;return(n=t.images)==null?void 0:n.some(a=>!a.includes("/wm-"))});if(e.length){for(const t of e){if(!t.images.some(s=>!s.includes("/wm-")))continue;const a=[];let o=!1;for(const s of t.images)if(s.includes("/wm-"))a.push(s);else try{const l=await Qt(s);a.push(l),o=!0}catch{a.push(s)}if(o){await f.from("properties").update({images:a}).eq("id",t.id);const s=$.findIndex(l=>l.id===t.id);s>=0&&($[s].images=a)}}ye(je($))}}async function Qt(e){try{const t=await fetch(e);if(!t.ok)return e;const n=await t.blob(),a=URL.createObjectURL(n),o=await fetch("/logo.png"),s=o.ok?await o.blob():null,l=s?URL.createObjectURL(s):null;return new Promise(d=>{const i=new Image;i.onload=()=>{URL.revokeObjectURL(a);const c=document.createElement("canvas"),m=1200;let u=i.width,r=i.height;u>m&&(r=Math.round(r*m/u),u=m),c.width=u,c.height=r;const g=c.getContext("2d");g.drawImage(i,0,0,u,r);const p=y=>{if(y){const E=Math.round(u*.18),b=Math.round(y.naturalHeight*E/y.naturalWidth),w=Math.round(u*.02);g.globalAlpha=.45,g.drawImage(y,u-E-w,r-b-w,E,b),g.globalAlpha=1}c.toBlob(async E=>{try{const b=`wm-${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:w}=await f.storage.from("imoveis").upload(b,E,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(w){console.error("Upload watermark error:",w),d(e);return}const{data:{publicUrl:B}}=f.storage.from("imoveis").getPublicUrl(b);d(B)}catch(b){console.error("Watermark upload exception:",b),d(e)}},"image/jpeg",.82)};if(l){const y=new Image;y.onload=()=>{URL.revokeObjectURL(l),p(y)},y.onerror=()=>{URL.revokeObjectURL(l),p(null)},y.src=l}else p(null)},i.onerror=()=>{URL.revokeObjectURL(a),d(e)},i.src=a})}catch(t){return console.error("applyWatermarkToUrl error:",t),e}}function j(e,t){e&&(e.textContent=t?"✓ Salvo com sucesso!":"✗ Erro ao salvar.",e.className="cfg-save-msg "+(t?"ok":"err"),e.style.display="",setTimeout(()=>{e.style.display="none"},3e3))}async function Oe(e,t="assets"){const n=await he(e,1200,.85),a=`${t}/${Date.now()}-${Math.random().toString(36).slice(2)}.jpg`,{error:o}=await f.storage.from("imoveis").upload(a,n,{contentType:"image/jpeg",cacheControl:"31536000",upsert:!1});if(o)throw o;const{data:{publicUrl:s}}=f.storage.from("imoveis").getPublicUrl(a);return s}async function Zt(){const e=document.getElementById("section-empresa");if(!e||e.dataset.loaded)return;e.dataset.loaded="1";const{data:t}=await f.from("settings").select("key,value").eq("tenant_id",Re()),n={};t==null||t.forEach(o=>{n[o.key]=o.value||""});const a=o=>h(String(n[o]||""));e.innerHTML=`
  ...
  `,e.querySelectorAll(".sa-tab").forEach(l=>{l.addEventListener("click",()=>{e.querySelectorAll(".sa-tab").forEach(i=>i.classList.remove("active")),e.querySelectorAll(".sa-panel").forEach(i=>i.classList.add("hidden")),l.classList.add("active");const d=e.querySelector(`#sa-panel-${l.dataset.tab}`);d&&d.classList.remove("hidden"),l.dataset.tab==="tenants"&&!e.querySelector("#sa-tenants-list").dataset.loaded&&X(),l.dataset.tab==="plans"&&!e.querySelector("#sa-plans-list").dataset.loaded&&ia(),l.dataset.tab==="subscriptions"&&!e.querySelector("#sa-subs-list").dataset.loaded&&Ze(),l.dataset.tab==="global-users"&&!e.querySelector("#sa-users-list").dataset.loaded&&et(),l.dataset.tab==="platform"&&tt()})}),(t=e.querySelector("#sa-sub-filter"))==null||t.addEventListener("change",Ze),(n=e.querySelector("#sa-tenant-search"))==null||n.addEventListener("input",X),(a=e.querySelector("#sa-user-search"))==null||a.addEventListener("input",et),(o=e.querySelector("#sa-tenant-new"))==null||o.addEventListener("click",()=>ra()),(s=e.querySelector("#sa-plat-save"))==null||s.addEventListener("click",la),X(),tt())}async function X(){var d,i;const e=document.getElementById("sa-tenants-list"),t=((i=(d=document.getElementById("sa-tenant-search"))==null?void 0:d.value)==null?void 0:i.toLowerCase())||"";if(!e)return;e.dataset.loaded="1";let n=f.from("tenants").select("*, plans(name, price_brl)").order("created_at",{ascending:!1});const{data:a,error:o}=await n;if(o){e.innerHTML=`<div class="sa-error">Erro ao carregar: ${o.message}</div>`;return}const s=(a||[]).filter(c=>{var m,u;return!t||((m=c.name)==null?void 0:m.toLowerCase().includes(t))||((u=c.slug)==null?void 0:u.toLowerCase().includes(t))});if(!s.length){e.innerHTML='<div class="sa-empty">Nenhuma imobiliária encontrada.</div>';return}const l=c=>c.active?'<span class="sa-badge sa-badge-green">Ativo</span>':'<span class="sa-badge sa-badge-red">Inativo</span>';e.innerHTML=s.map(c=>{var m;return`
    <div class="sa-list-row">
      <div class="sa-list-info">
        ${c.logo_url?`<img class="sa-tenant-logo" src="${h(c.logo_url)}" alt="">`:'<div class="sa-tenant-logo-placeholder">🏢</div>'}
        <div>
          <div class="sa-list-name">${h(c.name||"—")}</div>
          <div class="sa-list-sub">${h(c.slug||"")} · ${h(((m=c.plans)==null?void 0:m.name)||"Sem plano")}</div>
        </div>
      </div>
  ...
  `,document.body.appendChild(t),f.from("plans").select("id, name").then(({data:c})=>{const m=document.getElementById("nt-plan");m&&c&&(m.innerHTML='<option value="">Sem plano</option>'+c.map(u=>`<option value="${u.id}">${h(u.name)}</option>`).join(""))}),(a=document.getElementById("nt-name"))==null||a.addEventListener("input",c=>{const m=document.getElementById("nt-slug");m&&!m.dataset.manual&&(m.value=da(c.target.value))}),(o=document.getElementById("nt-slug"))==null||o.addEventListener("input",c=>{c.target.dataset.manual="1"}),(s=document.getElementById("nt-pwd-toggle"))==null||s.addEventListener("click",()=>{const c=document.getElementById("nt-admin-password");c.type=c.type==="password"?"text":"password"});const n=()=>t.remove();(l=document.getElementById("sa-modal-close-btn"))==null||l.addEventListener("click",n),(d=document.getElementById("nt-cancel"))==null||d.addEventListener("click",n),t.addEventListener("click",c=>{c.target===t&&n()}),(i=document.getElementById("nt-save"))==null||i.addEventListener("click",async()=>{var C,I,L,S,k,_,T,D,N,se,ie,le;const c=(I=(C=document.getElementById("nt-name"))==null?void 0:C.value)==null?void 0:I.trim(),m=(S=(L=document.getElementById("nt-slug"))==null?void 0:L.value)==null?void 0:S.trim(),u=(_=(k=document.getElementById("nt-domain"))==null?void 0:k.value)==null?void 0:_.trim(),r=(T=document.getElementById("nt-plan"))==null?void 0:T.value,g=(N=(D=document.getElementById("nt-admin-email"))==null?void 0:D.value)==null?void 0:N.trim(),p=(ie=(se=document.getElementById("nt-admin-password"))==null?void 0:se.value)==null?void 0:ie.trim(),y=document.getElementById("nt-msg"),E=document.getElementById("nt-save");if(!c||!m){y.textContent="❌ Nome e slug são obrigatórios.",y.style.color="#ef4444";return}if(!g){y.textContent="❌ Informe o e-mail do admin.",y.style.color="#ef4444";return}if(!p||p.length<6){y.textContent="❌ A senha precisa ter mínimo 6 caracteres.",y.style.color="#ef4444";return}E.disabled=!0,E.textContent="Criando…",y.textContent="⏳ Criando imobiliária…",y.style.color="#64748b";const{data:b,error:w}=await f.from("tenants").insert({name:c,slug:m,domain:u||null,plan_id:r||null,active:!0}).select();if(w){E.disabled=!1,E.textContent="Criar Imobiliária",y.textContent="❌ "+w.message,y.style.color="#ef4444";return}const B=(le=b==null?void 0:b[0])==null?void 0:le.id;y.textContent="⏳ Criando usuário admin…";const x=await oe({email:g,password:p,role:"admin",tenant_id:B});if(!(x!=null&&x.success)){E.disabled=!1,E.textContent="Criar Imobiliária",y.innerHTML="⚠️ Imobiliária criada, mas erro ao criar usuário: "+h((x==null?void 0:x.error)||"Desconhecido"),y.style.color="#f59e0b",setTimeout(()=>{n(),X()},3e3);return}B&&(x!=null&&x.user_id)&&!(x!=null&&x.linked)&&await f.from("profiles").update({tenant_id:B}).eq("id",x.user_id),E.disabled=!1,E.textContent="Criar Imobiliária",x.email_sent===!1?(y.innerHTML=`
        ...
        <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:10px;margin-top:8px;font-size:12px;">
          ...
          Senha: <strong>${h(p)}</strong>
        </div>`,y.style.color="#0f172a"):(y.textContent="✅ Imobiliária criada e e-mail enviado com sucesso!",y.style.color="#22c55e",setTimeout(()=>{n(),X()},1500))})}function ca(e){var o,s,l,d,i,c,m;const t=document.getElementById("sa-edit-tenant-modal");t&&t.remove();const n=document.createElement("div");n.id="sa-edit-tenant-modal",n.className="sa-modal-backdrop",n.innerHTML=`
